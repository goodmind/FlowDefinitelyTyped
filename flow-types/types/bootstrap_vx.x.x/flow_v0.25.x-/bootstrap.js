 ...
 */
    ...
    on(
      ...
      handler: JQuery.EventHandlerBase<TElement, CarouselEventHandler<TElement>>
    ): this;
    on(
    ...
    on(
      events: ModalEvent,
      handler: JQuery.EventHandlerBase<TElement, ModalEventHandler<TElement>>
    ): this;
    on(
      events: TapEvent,
      handler: JQuery.EventHandlerBase<TElement, TapEventHandler<TElement>>
    ): this;
    on(
      events:
        | AlertEvent
...
declare module "bootstrap" {
  ...
  declare export type Placement = "auto" | "top" | "bottom" | "left" | "right";
  ...
  declare export interface TooltipOption {
    ...
    placement?:
      | Placement
      | ((node: HTMLElement, trigger: Element) => Placement);
  ...
  declare export type CollapseEvent =
    | "show.bs.collapse"
    | "shown.bs.collapse"
    | "hide.bs.collapse"
    | "hidden.bs.collapse";
  declare export type DropdownEvent =
    | "show.bs.dropdown"
    | "shown.bs.dropdown"
    | "hide.bs.dropdown"
    | "hidden.bs.dropdown";
  declare export type ModalEvent =
    | "show.bs.modal"
    | "shown.bs.modal"
    | "hide.bs.modal"
    | "hidden.bs.modal";
  declare export type PopoverEvent =
    | "show.bs.popover"
    | "shown.bs.popover"
    | "hide.bs.popover"
    | "hidden.bs.popover"
  ...
  declare export type TapEvent =
    | "show.bs.tab"
    | "shown.bs.tab"
    | "hide.bs.tab"
    | "hidden.bs.tab";
  declare export type ToastEvent =
    | "show.bs.toast"
    | "shown.bs.toast"
    | "hide.bs.toast"
    | "hidden.bs.toast";
