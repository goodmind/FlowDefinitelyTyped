 ...
 */
declare export class InstantSearch mixins React.Component<InstantSearchProps> {}
 ...
 */
declare export class Hits<T> mixins React.Component<HitsProps<T>> {}
 ...
 */
declare export class Stats mixins React.Component<{
translations?: {
