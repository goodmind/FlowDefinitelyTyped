 ...
 */
declare export type CommonEvent = "init"
| "beforeDestroy"
| "slideChange"
 ...
 */
declare export type PaginationEvent = "paginationRender" | "paginationUpdate";
	
/**
 * Swiper autoplay event names.
 */
declare export type AutoplayEvent = "autoplayStart" | "autoplayStop" | "autoplay";
	
/**
 * Swiper lazy-loading event names.
 */
declare export type LazyLoadingEvent = "lazyImageLoad" | "lazyImageReady";
	
/**
 * Swiper event names.
 */
declare export type SwiperEvent = CommonEvent | PaginationEvent | AutoplayEvent | LazyLoadingEvent;
	
/**
 * Swiper module types.
 */
declare export type SwiperModule = Navigation
| Pagination
| Scrollbar
| Autoplay
| Parallax
...
| Controller
| A11y;
	declare export type DOM7Element = any;
	declare export type SelectableElement = string | HTMLElement;
	
/**
 * Main constructor options.
 */
declare export interface SwiperOptions {
 ...
 */
on?: $ObjMapi<{[k: SwiperEvent]: any}, <key>(key) => () => void>,
...
a11y?: A11yOptions | boolean
	...
	declare export interface EventsOptions {

/**
 * Fired right after Swiper initialization.
 * Note that with swiper.on('init') syntax it will
 * work only in case you set init: false parameter.
 * @example var swiper = new Swiper('.swiper-container', {
init: false,
// other parameters
});
 * @example swiper.on('init', function() {
// do something
});
 * @example // init Swiper
swiper.init();
 * @example // Otherwise use it as the parameter:
 ...
 * @example var mySwiper = new Swiper('.swiper-container', {
scrollbar: {
el: '.swiper-scrollbar',
draggable: true,
},
 ...
 */
declare export interface ScrollbarOptions {
 ...
 */
declare export interface AutoplayOptions {
 ...
 * @example <!-- hold this slide for 2 seconds -->
...
preloaderClass?: string
	...
	declare export interface FadeEffectOptions {
crossfade?: boolean
} 
	declare export interface CoverflowEffectOptions {
...
modifier?: number
	...
	declare export interface FlipEffectOptions {
slideShadows?: boolean,
limitRotation?: boolean
} 
	declare export interface CubeEffectOptions {
slideShadows?: boolean,
shadow?: boolean,
shadowOffset?: number,
shadowScale?: number
...
onlyInViewport?: boolean
	...
	declare export interface MousewheelOptions {
forceToAxis?: boolean,
...
eventsTarged?: SelectableElement
	...
	declare export interface VirtualOptions {
slides?: any[],
cache?: boolean,
renderSlide?: (slide: any, index: any) => any,
renderExternal?: (data: any) => any
} 
	declare export interface HashNavigationOptions {
...
replaceState?: boolean
	...
	declare export interface HistoryNavigationOptions {
 ...
 */
declare export interface ControllerOptions {
...
by?: "slide" | "container"
	...
	declare export interface A11yOptions {
...
notificationClass?: string
	...
	import type {
          Virtual,Keyboard,Mousewheel,Navigation,Pagination,Scrollbar,Parallax,Zoom,Lazy,Controller,A11y,History,HashNavigation,Autoplay,EffectFade,EffectCube,EffectFlip,EffectCoverflow
 ...
 */
constructor(container: SelectableElement, options?: SwiperOptions): this;
