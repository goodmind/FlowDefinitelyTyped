declare module "slideout" {
  ...
  declare class Slideout {
     ...
     */
    constructor(options: Slideout$Slideout$Options): this;
     ...
     * @param listener A listener function to add.
     */
    on(event: Slideout$Slideout$Events, listener: Function): Slideout;
     ...
     * @param listener A listener function to add.
     */
    once(event: Slideout$Slideout$Events, listener: Function): Slideout;
     ...
     * @param listener A listener function to remove.
     */
    off(event: Slideout$Slideout$Events, listener: Function): Slideout;
     ...
     */
    emit(event: Slideout$Slideout$Events, ...data: any[]): Slideout;
  }
}
