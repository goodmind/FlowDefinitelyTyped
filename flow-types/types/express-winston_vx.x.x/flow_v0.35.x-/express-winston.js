declare module 'express-winston' {
        import type {
          ErrorRequestHandler,Handler,Request,Response
        } from 'express';
	...
	declare export type DynamicMetaFunction = (req: Request, res: Response, err: Error) => {[key: string]: any};
	declare export type DynamicLevelFunction = (req: Request, res: Response, err: Error) => string;
	declare export type RequestFilter = (req: Request, propName: string) => boolean;
	declare export type ResponseFilter = (res: Response, propName: string) => boolean;
...
winstonInstance: winston.Logger
	...
	declare export type LoggerOptions = LoggerOptionsWithTransports | LoggerOptionsWithWinstonInstance;
...
winstonInstance: winston.Logger
	...
	declare export type ErrorLoggerOptions = ErrorLoggerOptionsWithTransports | ErrorLoggerOptionsWithWinstonInstance;
	declare export function errorLogger(options: ErrorLoggerOptions): ErrorRequestHandler
