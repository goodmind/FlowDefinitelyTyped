declare module "react-sortable-hoc" {
  ...
  declare export type SortStartHandler = (
    sort: SortStart,
    event: SortEvent
  ) => void;
  ...
  declare export type SortEndHandler = (
    sort: SortEnd,
    event: SortEvent
  ) => void;
  declare export type ContainerGetter = (
  ...
  declare export type WrappedComponent<P> =
  ...
  declare export function arrayMove<T>(
    collection: T[],
