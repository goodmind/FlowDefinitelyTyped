declare module "d3-quadtree" {
   ...
   */
  declare export interface QuadtreeLeaf<T> {
    /**
   ...
   */
  declare export type QuadtreeInternalNode<T> = {
    /**
     * The length property may be used to distinguish leaf nodes from internal nodes: it is undefined for leaf nodes, and 4 for internal nodes.
     */
    length: 4
  } & core$Array<QuadtreeInternalNode<T> | QuadtreeLeaf<T> | void>;
  ...
  declare export interface Quadtree<T> {
     ...
     */
    extent(): [[number, number], [number, number]] | void;
     ...
     */
    extent(tools$extend: [[number, number], [number, number]]): this;
     ...
     */
    find(x: number, y: number, radius?: number): T | void;
    ...
    visit(
      braintree$callback: (
        htmlParser$node: QuadtreeInternalNode<T> | QuadtreeLeaf<T>,
        x0: number,
        y0: number,
        x1: number,
        y1: number
   ...
   */
  declare export function quadtree<T>(): Quadtree<T>;
