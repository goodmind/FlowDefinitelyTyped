declare module "slate" {
  ...
  declare var Record: Immutable.Record.Class;
  declare export class Data mixins Record {
    [key: string]: any;
  ...
  declare export class Value mixins Record {
    document: Document;
    selection: Selection;
    data: Data;
    object: "value";
  ...
  declare export class Text mixins Record {
    object: "text";
    key: string;
    text: string;
  ...
  declare export class Leaf mixins Record {
    object: "leaf";
  ...
  declare export type NodeJSON =
    | DocumentJSON
    | BlockJSON
    | InlineJSON
    | TextJSON;
  declare export type NodeProperties =
    | DocumentProperties
    | BlockProperties
    | InlineProperties
    | TextProperties;
  ...
  declare export class Mark mixins Record {
    object: "mark";
    type: string;
  ...
  declare export type RangeTypeProperties =
    | RangeProperties
    | SelectionProperties
    | DecorationProperties;
  declare export type RangeTypeJSON =
    | RangeJSON
    | SelectionJSON
    | DecorationJSON;
  declare export type RangeType = Range | Selection | Decoration;
  declare class BaseRange mixins Record {
    isCollapsed: boolean;
    isExpanded: boolean;
    isBackward: boolean;
    isForward: boolean;
  ...
  declare export class Point mixins Record {
    object: "point";
    key: string | null;
    offset: number;
    path: Path | null;
