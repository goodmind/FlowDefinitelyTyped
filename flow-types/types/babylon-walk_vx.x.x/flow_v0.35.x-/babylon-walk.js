declare module 'babylon-walk' {
	...
	declare export type coreTypes = babelTypes.ArrayExpression
...
| babelTypes.WithStatement;
	declare export type es2015Types = babelTypes.AssignmentPattern
...
| babelTypes.ExportNamespaceSpecifier;
	declare export type flowTypes = babelTypes.AnyTypeAnnotation
...
| babelTypes.VoidTypeAnnotation;
	declare export type jsxTypes = babelTypes.JSXAttribute
...
| babelTypes.JSXText;
	declare export type miscTypes = babelTypes.Noop | babelTypes.ParenthesizedExpression;
	declare export type NodeTypes = coreTypes
| es2015Types
| flowTypes
| jsxTypes
| miscTypes;
...
ParenthesizedExpression?: V
	...
	declare export type visitors<V> = {} & coreVisitors<V> & es2015Visitors<V> & flowVisitors<V> & jsxVisitors<V> & miscVisitors<V>
	...
	declare export type AncestorVisitor = (node: NodeTypes, state: any, ancestors: babelTypes.Node[]) => void;
	declare export type AncestorStatelessVisitor = (node: NodeTypes, state: any, ancestors: babelTypes.Node[]) => void;
	declare export type RecursiveVisitor = (node: NodeTypes, state: any, next: (node: babelTypes.Node) => void) => void;
	declare export function simple(node: NodeTypes, visitors: visitors<SimpleVisitor>, state: any): void

	declare export function ancestor(node: NodeTypes, visitors: visitors<AncestorVisitor>, state: any): void

	declare export function recursive(node: NodeTypes, visitors: visitors<RecursiveVisitor>, state: any): void
