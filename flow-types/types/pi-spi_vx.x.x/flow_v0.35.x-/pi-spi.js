...
declare  class __PI_SPI$order {
  constructor(...args: empty): mixed;
static +MSB_FIRST: Class<__PI_SPI$order__MSB_FIRST> & __PI_SPI$order__MSB_FIRST & 0;// 0
static +LSB_FIRST: Class<__PI_SPI$order__LSB_FIRST> & __PI_SPI$order__LSB_FIRST & 1;// 1
