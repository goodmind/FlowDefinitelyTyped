 ...
 */
declare function SafariView$show(options: SafariViewOptions): Promise<boolean>
...
declare function SafariView$addEventListener(event: string, listener: () => void): EmitterSubscription


declare function SafariView$removeEventListener(event: string, listener: () => void): void
