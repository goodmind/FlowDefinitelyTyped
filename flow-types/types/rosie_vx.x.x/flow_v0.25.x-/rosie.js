declare module "rosie" {
  declare interface rosie$IFactoryStatic {
    ...
    define<T>(
      name: string,
      constructor?: ((...opts: any[]) => any) | ((...opts: any[]) => any)
    ): rosie$IFactory<T>;
  ...
  declare interface rosie$IFactory<T = any> {
    /**
    ...
    attr<K: $Keys<T>>(
      name: K,
      generatorFunction: () => $ElementType<T, K>
    ): rosie$IFactory<T>;
    attr<
      K: $Keys<T>,
      D1: $Keys<T>,
    ...
    attr<K: $Keys<T>, D: $Keys<T>>(
      name: K,
      dependencies: D[],
      generatorFunction: (value: $ElementType<T, D>) => $ElementType<T, K>
    ): rosie$IFactory<T>;
    attr<K: $Keys<T>, D: $Keys<T>>(
      name: K,
      dependencies: D[],
    ...
    attrs(
      attributes: $ObjMapi<
        T,
        <K>(K) => $ElementType<T, K> | ((opts?: any) => $ElementType<T, K>)
      >
    ): rosie$IFactory<T>;
     ...
     */
    inherits(
      functionArg: (parentFactory: rosie$IFactory<T>) => void
    ): rosie$IFactory<T>;
