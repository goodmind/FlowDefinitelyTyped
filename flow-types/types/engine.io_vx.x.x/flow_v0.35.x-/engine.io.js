...
fn: (err: string | null | void, success: boolean) => void) => void;
 ...
 */
handlePreflightRequest?: boolean | ((
server: engine$Server,
req: http.IncomingMessage,
res: http.ServerResponse) => void)
} 

declare type engine$ServerAttachOptions = {} & engine$ServerOptions & engine$AttachOptions
...
on(
ev: "flush",
fn: (socket: engine$Socket, buffer: engine$Packet[]) => void): this;
 ...
 */
handleUpgrade(req: http.IncomingMessage, socket: net.engine$Socket, head: Buffer): this;
 ...
 */
on(ev: "packet" | "packetCreate", fn: (packet: engine$Packet) => void): this
}

declare function engine$attach(http: net.engine$Server, opts?: engine$ServerAttachOptions): engine$Server


declare function engine$listen(port: number, opts?: engine$ServerOptions, fn?: () => void): engine$Server


declare var engine$protocol: number;
	declare function engine(
httpServer?: net.engine$Server,
opts?: engine$engine$ServerOptions): engine$engine$Server
