declare module "rss" {
  declare var factory: NodeRSS$NodeRSS$RSSFactory;
  ...
  declare interface NodeRSS$RSS {
    ...
    /**
 * Generate XML and return as a string for this feed.
 * @param {NodeRSS$XmlOptions} xmlOptions - You can use indent
 ...
 */
  ...
  declare interface NodeRSS$RSSFactory {
     ...
     * @param {NodeRSS$FeedOptions} feedOptions - Options for the RSS feed.
     * @returns {NodeRSS$RSS}
     */
