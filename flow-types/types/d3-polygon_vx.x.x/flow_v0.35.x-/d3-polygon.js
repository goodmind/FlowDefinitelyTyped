 ...
 */
declare export function polygonArea(polygon: Array<[number, number]>): number
 ...
 * @param polygon Array of coordinates <x0, y0>, <x1, y1> and so on.
 */
declare export function polygonCentroid(polygon: Array<[number, number]>): [number, number]
 ...
 */
declare export function polygonHull(points: Array<[number, number]>): Array<[number, number]> | null
 ...
 */
declare export function polygonContains(polygon: Array<[number, number]>, point: [number, number]): boolean
 ...
 * @param polygon Array of coordinates <x0, y0>, <x1, y1> and so on.
 */
declare export function polygonLength(polygon: Array<[number, number]>): number
