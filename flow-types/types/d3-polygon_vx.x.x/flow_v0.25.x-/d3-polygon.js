declare module "d3-polygon" {
   ...
   * @param polygon Array of coordinates <x0, y0>, <x1, y1> and so on.
   */
  declare export function polygonCentroid(
   ...
   */
  declare export function polygonHull(
   ...
   */
  declare export function polygonContains(
    polygon: Array<[number, number]>,
    point: [number, number]
  ): boolean;
   ...
   * @param polygon Array of coordinates <x0, y0>, <x1, y1> and so on.
   */
  declare export function polygonLength(
    polygon: Array<[number, number]>
  ): number;
}
