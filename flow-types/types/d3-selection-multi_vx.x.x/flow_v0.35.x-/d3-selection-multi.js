declare module 'd3-selection-multi' {
        import type {
          Selection,BaseType,ArrayLike,ValueFn
        } from 'd3-selection';
 ...
 */
declare export type ValueMap<T: BaseType, Datum> = {
[key: string]: number
| string
| boolean
| null
 ...
 */
declare interface Transition<GElement: BaseType, Datum, PElement: BaseType, PDatum> {
