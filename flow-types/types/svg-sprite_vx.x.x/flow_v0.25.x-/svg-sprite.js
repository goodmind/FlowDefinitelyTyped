declare module "svg-sprite" {
  ...
  declare interface sprite$SVGSpriter {
    ...
    compile(
      ...
      callback: sprite$CompileCallback
    ): sprite$SVGSpriter;
  ...
  declare interface sprite$Shape {
    ...
    transform?: (
      | string
      | sprite$CustomConfigurationTransform
      | sprite$CustomCallbackTransform
    )[];
  ...
  declare interface sprite$Mode {
    ...
    stack?: sprite$ModeConfig | boolean;
    [customConfigName: string]: sprite$ModeConfig | boolean;
  }
  ...
  declare var sprite: sprite$sprite$SVGSpriterConstructor;
