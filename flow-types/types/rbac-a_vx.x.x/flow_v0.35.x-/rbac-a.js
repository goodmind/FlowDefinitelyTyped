...
getAttributes(role: string): string[] | Promise<string[]>
	...
	declare export type AttributeFunction = (user: any, role: string, params: {[key: string]: any}) => any;
 ...
 */
declare export class AttributesManager  {
_attributes: {
[_: string]: AttributeFunction
};
 ...
 */
validate(attribute: string, user: any, role: string, params: {[key: string]: any}): any
}
	declare export class RBAC<P: Provider, AM: AttributesManager> mixins EventEmitter {
provider: P;
attributes: AM;
constructor(opts: {
provider: P,
...
params?: {[key: string]: any}): Promise<number>
}
	declare export var Providers: {

/**
 * Basic JSON permissions provider
 */
JsonProvider: {
new (roles: {[key: string]: any}): Provider
}
};
    }
