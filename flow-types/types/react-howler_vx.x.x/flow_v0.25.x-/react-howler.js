declare module "react-howler" {
  ...
  declare class HOWLER_STATE {
    ...
    static +UNLOADED: Class<HOWLER_STATE__UNLOADED> &
      HOWLER_STATE__UNLOADED &
      "unloaded"; // "unloaded"
    static +LOADING: Class<HOWLER_STATE__LOADING> &
      HOWLER_STATE__LOADING &
      "loading"; // "loading"
    static +LOADED: Class<HOWLER_STATE__LOADED> &
      HOWLER_STATE__LOADED &
      "loaded"; // "loaded"
  }
