...
static +healthCheckFailed: Class<Event__healthCheckFailed> & Event__healthCheckFailed & "health-check-failed";// "health-check-failed"
static +open: Class<Event__open> & Event__open & "open";// "open"
static +reject: Class<Event__reject> & Event__reject & "reject";// "reject"
static +semaphoreLocked: Class<Event__semaphoreLocked> & Event__semaphoreLocked & "semaphore-locked";// "semaphore-locked"
...
getHystrixStream(): stream.Transform
	...
	declare export function promisify(action: Action): (...args: any[]) => Promise<any>
