declare module "theming" {
  ...
  declare export type Theme =
    | { [key: string]: any }
    | ((outerTheme: { [key: string]: any }) => { [key: string]: any });
   ...
   */
  declare export class ThemeProvider
    mixins React.Component<ThemeProviderProps> {}
   ...
   */
  declare export function createTheming<C: string>(
    customChannel?: C
  ): Theming<C>;
}
