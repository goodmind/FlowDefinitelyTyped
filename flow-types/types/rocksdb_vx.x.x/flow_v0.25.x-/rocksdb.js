declare module "rocksdb" {
  ...
  declare type RocksDB = {
    ...
    get(
      ...
      cb: ErrorValueCallback<RocksDB$RocksDB$Bytes>
    ): void,
    get(
      key: RocksDB$RocksDB$Bytes,
    ...
    batch(
      array: AbstractBatch[],
      cb: ErrorCallback
    ): AbstractChainedBatch<RocksDB$RocksDB$Bytes, RocksDB$RocksDB$Bytes>,
    batch(
      array: AbstractBatch[],
    ...
    approximateSize(
      ...
      cb: RocksDB$RocksDB$ErrorSizeCallback
    ): void,
    compactRange(
      start: RocksDB$RocksDB$Bytes,
      end: RocksDB$RocksDB$Bytes,
    ...
    iterator(
      options?: RocksDB$RocksDB$IteratorOptions
    ): RocksDB$RocksDB$Iterator
  } & AbstractLevelDOWN<RocksDB$RocksDB$Bytes, RocksDB$RocksDB$Bytes>;

  declare type RocksDB$Bytes = string | Buffer;

  declare type RocksDB$ErrorSizeCallback = (
    err: Error | void,
    size: number
  ) => void;
