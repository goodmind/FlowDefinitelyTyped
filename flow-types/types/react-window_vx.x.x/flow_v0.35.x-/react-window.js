declare module 'react-window' {
        import type {
          Component,ComponentType,CSSProperties,Ref,Key
        } from 'react';

	declare export type Direction = "vertical" | "horizontal";
	declare export type ScrollDirection = "forward" | "backward";
	declare export type Align = "auto" | "center" | "end" | "start";
	declare export interface ListChildComponentProps {
index: number,
style: CSSProperties
} 
	declare export interface GridChildComponentProps {
columnIndex: number,
rowIndex: number,
style: CSSProperties
} 
...
useIsScrolling?: boolean
	...
	declare export type ListItemKeySelector = (index: number) => Key;
	declare export interface ListOnItemsRenderedProps {
overscanStartIndex: number,
overscanStopIndex: number,
visibleStartIndex: number,
visibleStopIndex: number
} 
	declare export interface ListOnScrollProps {
...
onScroll?: (props: ListOnScrollProps) => any
	...
	declare export type GridItemKeySelector = (params: {
columnIndex: number,
rowIndex: number
}) => Key;
	declare export interface GridOnItemsRenderedProps {
...
visibleRowStopIndex: number
	...
	declare export interface GridOnScrollProps {
...
width: number
	...
	declare export type FixedSizeListProps = {
...
itemSize: number
	...
	declare export type VariableSizeListProps = {
...
itemSize: (index: number) => number
	...
	declare export type FixedSizeGridProps = {
...
rowHeight: number
	...
	declare export type VariableSizeGridProps = {
...
rowHeight: (index: number) => number
	...
	declare export class FixedSizeList mixins Component<FixedSizeListProps> {
...
scrollToItem(index: number, align?: Align): void
	...
	declare export class VariableSizeList mixins Component<VariableSizeListProps> {
...
resetAfterIndex(index: number, shouldForceUpdate: boolean): void
	...
	declare export class FixedSizeGrid mixins Component<FixedSizeGridProps> {
...
rowIndex: number
	...
	declare export class VariableSizeGrid mixins Component<VariableSizeGridProps> {
