...
redraw(): void,
redrawGroup(): void,
hasFilterHandler: dc$IGetSet<(filters: Array<any>, filter: any) => boolean, T>,
...
} & dc$BaseMixin<T> & dc$MarginMixin<T> & dc$ColorMixin<T>
...
} & dc$CapMixin<dc$PieChart> & dc$ColorMixin<dc$PieChart> & dc$BaseMixin<dc$PieChart>
...
} & dc$StackMixin<dc$BarChart> & dc$CoordinateGridMixin<dc$BarChart>
...
} & dc$StackMixin<dc$LineChart> & dc$CoordinateGridMixin<dc$LineChart>
...
columns: dc$IGetSet<Array<string | dc$Accessor<any, any> | dc$Columns>, dc$DataTableWidget>,
...
} & dc$BubbleMixin<dc$BubbleChart> & dc$CoordinateGridMixin<dc$BubbleChart>
...
} & dc$ColorMixin<dc$GeoChoroplethChart> & dc$BaseMixin<dc$GeoChoroplethChart>


declare export type dc$BubbleOverlayChart = {
point(name: string, x: number, y: number): void
} & dc$BubbleMixin<dc$BubbleOverlayChart> & dc$BaseMixin<dc$BubbleOverlayChart>
...
} & dc$CapMixin<dc$RowChart> & dc$MarginMixin<dc$RowChart> & dc$ColorMixin<dc$RowChart> & dc$BaseMixin<dc$RowChart>
...
value(): string,
formatNumber: dc$IGetSet<dc$Accessor<number, string>, dc$NumberDisplayWidget>
...
} & dc$ColorMixin<dc$HeatMap> & dc$MarginMixin<dc$HeatMap> & dc$BaseMixin<dc$HeatMap>
...
filterDisplayed: dc$IGetSet<(a: {
value: any,
key: any
}, index: number) => boolean, dc$SelectMenu>,
...
barChart(parent: string | dc$CompositeChart, chartGroup?: string): dc$BarChart,
lineChart(parent: string | dc$CompositeChart, chartGroup?: string): dc$LineChart,
