...
optRootSelector?: string): webdriver.Locator
	...
	declare function $$data(hook: string): protractor$protractor$ElementArrayFinder
...
toMatchTranslated(translationId: string[], interpolateParams?: any): boolean
	...
	declare export function not(arg: webdriver.promise.IThenable<any>): webdriver.promise.IThenable<boolean>

	declare export function translate(
translationId: string,
interpolateParams?: any): webdriver.promise.IThenable<string>

	declare export function translate(
translationId: string[],
interpolateParams?: any): webdriver.promise.IThenable<{
[key: string]: string
}>
	...
	declare export function displayHover(element: protractor$protractor$ElementFinder): void

	declare export function waitForElement(element: protractor$protractor$ElementFinder, timeout?: number): void

	declare export function waitForElementToDisappear(element: protractor$protractor$ElementFinder, timeout?: number): void

	declare export function selectOptionByText(select: protractor$protractor$ElementFinder, text: string): void

	declare export function selectOptionByIndex(select: protractor$protractor$ElementFinder, index: number): void

	declare export function selectOption(option: protractor$protractor$ElementFinder): void

	declare export function isFirefox(): boolean

	declare export function isIE(): boolean

	declare export function createMessage(actual: string, message: string, isNot: any): string
...
isNot: any): string
	...
	declare export function clearAndSetValue(input: protractor$protractor$ElementFinder, value: string): void

	declare export function hasClass(
element: protractor$protractor$ElementFinder,
className: string): webdriver.promise.IThenable<boolean>

	declare export function hasValue(
element: protractor$protractor$ElementFinder,
expectedValue: string): webdriver.promise.IThenable<boolean>

	declare export function hasValue(
element: protractor$protractor$ElementFinder,
expectedValue: number): webdriver.promise.IThenable<boolean>

	declare export function hasLink(
element: protractor$protractor$ElementFinder,
url: string): webdriver.promise.IThenable<boolean>

	declare export function isDisabled(
element: protractor$protractor$ElementFinder): webdriver.promise.IThenable<boolean>

	declare export function isChecked(
element: protractor$protractor$ElementFinder): webdriver.promise.IThenable<boolean>

	declare export function getFilteredConsoleErrors(): webdriver.promise.IThenable<string[]>
