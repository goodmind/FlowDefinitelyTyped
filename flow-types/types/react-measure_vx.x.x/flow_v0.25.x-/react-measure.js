declare module "react-measure" {
  ...
  declare export type MeasurementType =
    | "client"
    | "offset"
    | "scroll"
    | "bounds"
  ...
  declare type MeasuredComponent<T> = React.ComponentType<
    T & MeasuredComponentProps
  >;
  ...
  ): <T: {}>(fn: MeasuredComponent<T>) => React.ComponentType<T>;
