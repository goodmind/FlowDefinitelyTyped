...
signupUrls: typeof client$signupUrls,
      }

/**
 * Load Android Management API v1
 */
declare function client$load(name: "androidmanagement", version: "v1"): PromiseLike<void>


declare function client$load(name: "androidmanagement", version: "v1", callback: () => any): void


declare var client$enterprises: androidmanagement$androidmanagement$EnterprisesResource;

declare var client$signupUrls: androidmanagement$androidmanagement$SignupUrlsResource;

declare interface androidmanagement$ApiLevelCondition {
...
declare interface androidmanagement$Application {
...
declare interface androidmanagement$ApplicationPermission {
...
declare interface androidmanagement$ApplicationPolicy {
...
declare interface androidmanagement$Command {
...
declare interface androidmanagement$Device {
...
declare interface androidmanagement$Display {
...
declare interface androidmanagement$EnrollmentToken {
...
declare interface androidmanagement$Enterprise {
...
declare interface androidmanagement$ExternalData {
...
declare interface androidmanagement$HardwareInfo {
...
declare interface androidmanagement$HardwareStatus {
...
declare interface androidmanagement$ListDevicesResponse {

/**
 * The list of devices.
 */
devices?: androidmanagement$Device[],
...
declare interface androidmanagement$ListOperationsResponse {
...
declare interface androidmanagement$ListPoliciesResponse {
...
declare interface androidmanagement$ManagedProperty {
 ...
 */
nestedProperties?: androidmanagement$ManagedProperty[],
...
declare interface androidmanagement$ManagedPropertyEntry {
...
declare interface androidmanagement$MemoryEvent {
...
declare interface androidmanagement$MemoryInfo {
...
declare interface androidmanagement$NetworkInfo {
...
declare interface androidmanagement$NonComplianceDetail {
...
declare interface androidmanagement$NonComplianceDetailCondition {
...
declare interface androidmanagement$Operation {
...
declare interface androidmanagement$PasswordRequirements {
...
declare interface androidmanagement$PermissionGrant {
...
declare interface androidmanagement$PersistentPreferredActivity {
...
declare interface androidmanagement$Policy {
 ...
 */
complianceRules?: androidmanagement$ComplianceRule[],
 ...
 */
passwordRequirements?: androidmanagement$PasswordRequirements,

/**
 * Default intent handler activities.
 */
persistentPreferredActivities?: androidmanagement$PersistentPreferredActivity[],
...
declare interface androidmanagement$PowerManagementEvent {
...
declare interface androidmanagement$SignupUrl {
...
declare interface androidmanagement$SoftwareInfo {
...
declare interface androidmanagement$Status {
...
declare interface androidmanagement$StatusReportingSettings {
...
declare interface androidmanagement$SystemUpdate {
...
declare interface androidmanagement$UserFacingMessage {
...
declare interface androidmanagement$WebToken {
...
declare interface androidmanagement$ApplicationsResource {
...
}): Request<androidmanagement$Application>
} 

declare interface androidmanagement$OperationsResource {
 ...
 */
upload_protocol?: string
}): Request<androidmanagement$Operation>,
 ...
 */
upload_protocol?: string
}): Request<androidmanagement$ListOperationsResponse>
} 

declare interface androidmanagement$DevicesResource {
 ...
 */
upload_protocol?: string
}): Request<androidmanagement$Device>,
 ...
 */
upload_protocol?: string
}): Request<androidmanagement$ListDevicesResponse>,
...
operations: androidmanagement$OperationsResource
} 

declare interface androidmanagement$EnrollmentTokensResource {
 ...
 */
upload_protocol?: string
}): Request<androidmanagement$EnrollmentToken>,
...
declare interface androidmanagement$PoliciesResource {
 ...
 */
upload_protocol?: string
}): Request<androidmanagement$Policy>,
 ...
 */
upload_protocol?: string
}): Request<androidmanagement$ListPoliciesResponse>,
...
declare interface androidmanagement$WebTokensResource {
 ...
 */
upload_protocol?: string
}): Request<androidmanagement$WebToken>
} 

declare interface androidmanagement$EnterprisesResource {
 ...
 */
upload_protocol?: string
}): Request<androidmanagement$Enterprise>,
...
applications: androidmanagement$ApplicationsResource,
devices: androidmanagement$DevicesResource,
enrollmentTokens: androidmanagement$EnrollmentTokensResource,
policies: androidmanagement$PoliciesResource,
webTokens: androidmanagement$WebTokensResource
} 

declare interface androidmanagement$SignupUrlsResource {
 ...
 */
upload_protocol?: string
}): Request<androidmanagement$SignupUrl>
} 
    }
