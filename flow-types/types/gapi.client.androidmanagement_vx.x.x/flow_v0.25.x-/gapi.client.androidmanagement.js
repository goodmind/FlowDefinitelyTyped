declare module "gapi.client.androidmanagement" {
  ...
  declare var npm$namespace$gapi$client: {
    ...
    signupUrls: typeof gapi$client$signupUrls
  };
  ...
  declare var gapi$client$enterprises: androidmanagement$EnterprisesResource;

  declare var gapi$client$signupUrls: androidmanagement$SignupUrlsResource;

  declare interface gapi$client$androidmanagement$ApiLevelCondition {
    /**
  ...
  declare interface gapi$client$androidmanagement$Application {
    /**
     * The set of managed properties available to be pre-configured for the application.
     */
    managedProperties?: androidmanagement$ManagedProperty[];
     ...
     */
    permissions?: androidmanagement$ApplicationPermission[];
  ...
  declare interface gapi$client$androidmanagement$ApplicationPermission {
    /**
  ...
  declare interface gapi$client$androidmanagement$ApplicationPolicy {
    /**
     ...
     */
    permissionGrants?: androidmanagement$PermissionGrant[];
  }

  declare interface gapi$client$androidmanagement$Command {
    /**
  ...
  declare interface gapi$client$androidmanagement$ComplianceRule {
    /**
     * A condition which is satisfied if the Android Framework API level on the device does not meet a minimum requirement.
     */
    apiLevelCondition?: gapi$client$androidmanagement$ApiLevelCondition;
     ...
     */
    nonComplianceDetailCondition?: androidmanagement$NonComplianceDetailCondition;
  }

  declare interface gapi$client$androidmanagement$Device {
    /**
     ...
     */
    hardwareStatusSamples?: androidmanagement$HardwareStatus[];
     ...
     * device's policy.
     */
    memoryEvents?: androidmanagement$MemoryEvent[];
     ...
     * device's policy.
     */
    powerManagementEvents?: androidmanagement$PowerManagementEvent[];
  ...
  declare interface gapi$client$androidmanagement$Display {
    /**
  ...
  declare interface gapi$client$androidmanagement$EnrollmentToken {
    /**
  ...
  declare interface gapi$client$androidmanagement$Enterprise {
    /**
  ...
  declare interface gapi$client$androidmanagement$ExternalData {
    /**
  ...
  declare interface gapi$client$androidmanagement$HardwareInfo {
    /**
  ...
  declare interface gapi$client$androidmanagement$HardwareStatus {
    /**
  ...
  declare interface gapi$client$androidmanagement$ListDevicesResponse {
    /**
     * The list of devices.
     */
    devices?: gapi$client$androidmanagement$Device[];
  ...
  declare interface gapi$client$androidmanagement$ListOperationsResponse {
    /**
     ...
     */
    operations?: androidmanagement$Operation[];
  }

  declare interface gapi$client$androidmanagement$ListPoliciesResponse {
    /**
     * If there are more results, a token to retrieve next page of results.
     */
    nextPageToken?: string;
     ...
     */
    policies?: androidmanagement$Policy[];
  }

  declare interface gapi$client$androidmanagement$ManagedProperty {
    /**
     ...
     */
    entries?: androidmanagement$ManagedPropertyEntry[];
     ...
     */
    nestedProperties?: gapi$client$androidmanagement$ManagedProperty[];
  ...
  declare interface gapi$client$androidmanagement$ManagedPropertyEntry {
    /**
  ...
  declare interface gapi$client$androidmanagement$MemoryEvent {
    /**
  ...
  declare interface gapi$client$androidmanagement$MemoryInfo {
    /**
  ...
  declare interface gapi$client$androidmanagement$NetworkInfo {
    /**
  ...
  declare interface gapi$client$androidmanagement$NonComplianceDetail {
    /**
  ...
  declare interface gapi$client$androidmanagement$NonComplianceDetailCondition {
    /**
  ...
  declare interface gapi$client$androidmanagement$Operation {
    /**
  ...
  declare interface gapi$client$androidmanagement$PasswordRequirements {
    /**
  ...
  declare interface gapi$client$androidmanagement$PermissionGrant {
    /**
  ...
  declare interface gapi$client$androidmanagement$PersistentPreferredActivity {
    /**
  ...
  declare interface gapi$client$androidmanagement$Policy {
    /**
     ...
     */
    applications?: gapi$client$androidmanagement$ApplicationPolicy[];
     ...
     */
    complianceRules?: gapi$client$androidmanagement$ComplianceRule[];
     ...
     */
    passwordRequirements?: gapi$client$androidmanagement$PasswordRequirements;

    /**
     * Default intent handler activities.
     */
    persistentPreferredActivities?: gapi$client$androidmanagement$PersistentPreferredActivity[];
  ...
  declare interface gapi$client$androidmanagement$PowerManagementEvent {
    /**
  ...
  declare interface gapi$client$androidmanagement$SignupUrl {
    /**
  ...
  declare interface gapi$client$androidmanagement$SoftwareInfo {
    /**
  ...
  declare interface gapi$client$androidmanagement$Status {
    /**
  ...
  declare interface gapi$client$androidmanagement$StatusReportingSettings {
    /**
  ...
  declare interface gapi$client$androidmanagement$SystemUpdate {
    /**
  ...
  declare interface gapi$client$androidmanagement$UserFacingMessage {
    /**
  ...
  declare interface gapi$client$androidmanagement$WebToken {
    /**
  ...
  declare interface gapi$client$androidmanagement$ApplicationsResource {
    /**
    ...
    }): Request<gapi$client$androidmanagement$Application>;
  }

  declare interface gapi$client$androidmanagement$OperationsResource {
    /**
    ...
    get(request: {
       ...
       */
      upload_protocol?: string
    }): Request<gapi$client$androidmanagement$Operation>;
    ...
    list(request: {
       ...
       */
      upload_protocol?: string
    }): Request<gapi$client$androidmanagement$ListOperationsResponse>;
  }

  declare interface gapi$client$androidmanagement$DevicesResource {
    /**
    ...
    get(request: {
       ...
       */
      upload_protocol?: string
    }): Request<gapi$client$androidmanagement$Device>;
    ...
    list(request: {
       ...
       */
      upload_protocol?: string
    }): Request<gapi$client$androidmanagement$ListDevicesResponse>;
    ...
    operations: gapi$client$androidmanagement$OperationsResource;
  }

  declare interface gapi$client$androidmanagement$EnrollmentTokensResource {
    /**
    ...
    create(request: {
       ...
       */
      upload_protocol?: string
    }): Request<gapi$client$androidmanagement$EnrollmentToken>;
  ...
  declare interface gapi$client$androidmanagement$PoliciesResource {
    /**
    ...
    get(request: {
       ...
       */
      upload_protocol?: string
    }): Request<gapi$client$androidmanagement$Policy>;
    ...
    list(request: {
       ...
       */
      upload_protocol?: string
    }): Request<gapi$client$androidmanagement$ListPoliciesResponse>;
  ...
  declare interface gapi$client$androidmanagement$WebTokensResource {
    /**
    ...
    create(request: {
       ...
       */
      upload_protocol?: string
    }): Request<gapi$client$androidmanagement$WebToken>;
  }

  declare interface gapi$client$androidmanagement$EnterprisesResource {
    /**
    ...
    create(request: {
       ...
       */
      upload_protocol?: string
    }): Request<gapi$client$androidmanagement$Enterprise>;
    ...
    applications: gapi$client$androidmanagement$ApplicationsResource;
    devices: gapi$client$androidmanagement$DevicesResource;
    enrollmentTokens: gapi$client$androidmanagement$EnrollmentTokensResource;
    policies: gapi$client$androidmanagement$PoliciesResource;
    webTokens: gapi$client$androidmanagement$WebTokensResource;
  }

  declare interface gapi$client$androidmanagement$SignupUrlsResource {
    /**
    ...
    create(request: {
       ...
       */
      upload_protocol?: string
    }): Request<gapi$client$androidmanagement$SignupUrl>;
  }
}
