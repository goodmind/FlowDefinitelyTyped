declare module 'react-native-mixpanel' {
	...
	declare export function trackWithProperties(event: string, property: {[key: string]: any}): void
	...
	declare export function registerSuperProperties(property: {[key: string]: any}): void

	declare export function registerSuperPropertiesOnce(property: {[key: string]: any}): void

	declare export function trackCharge(id: number): void

	declare export function trackChargeWithProperties(id: number, property: {[key: string]: any}): void
