...
declare type Qio$Reader = {
  QioFS$read(charset: string): Q.Promise<string>,
  QioFS$read(): Q.Promise<Buffer>,
  close(): void,
...
declare export function QioHTTP$request(
  QioHTTP$request: QioHTTP$Request
...
declare export function QioFS$listTree(
  path: string,
  guard?: (path: string, QioFS$stat: any) => boolean
): Q.Promise<string[]>;
...
declare export function QioFS$base(
  path: string,
  QioFS$extension: string
): string;
...
declare module "q-io" {
  declare interface QioBufferReader {
    new(): Qio$Qio$Reader;
    QioFS$read(stream: Qio$Qio$Reader, charset: string): string;
    QioFS$read(stream: Qio$Qio$Reader): Buffer;
