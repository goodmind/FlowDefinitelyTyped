 ...
 */
declare export function setDOMParser(parser: DOMParser): void
 ...
 */
declare export function setXMLSerializer(serializer: XMLSerializer): void
 ...
 */
declare export function setSafeMode(enabled: boolean): void
 ...
 */
declare export function setItexIdentifierMode(enabled: boolean): void
 ...
 */
declare export function getTeXSource(el: string | Element): string | null
 ...
 */
declare export function toMathMLString(
str: string,
displayMode?: boolean,
rightToLeft?: boolean,
throwOnError?: boolean): string
 ...
 * @param throwOnError - indicates whether TeXZilla should throw an exception when parsing fails
 */
declare export function toMathML(
str: string,
displayMode?: boolean,
rightToLeft?: boolean,
throwOnError?: boolean): Element
 ...
 */
declare export function toImage(
str: string,
rightToLeft?: boolean,
roundToPowerOfTwo?: boolean,
size?: number,
document?: Document): HTMLImageElement
 ...
 * @param throwOnError - indicates whether TeXZilla should throw an exception when parsing fails
 */
declare export function filterString(str: string, throwOnError?: boolean): string
 ...
 * @param throwOnError - indicates whether TeXZilla should throw an exception when parsing fails
 */
declare export function filterElement(el: Element, throwOnError?: boolean): void
