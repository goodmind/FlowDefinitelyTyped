...
declare module "@arangodb/foxx/sessions/storages/collection" {
  ...
  ): Foxx$Foxx$CollectionSessionStorage;
...
declare module "@arangodb/foxx/queues" {
  ...
  declare type JobCallback = (
    result: any,
    jobData: any,
    job: ArangoDB$ArangoDB$Document<Job>
  ) => void;
...
declare module "@arangodb" {
  declare function aql(
    ...
    ...args: any[]
  ): ArangoDB$ArangoDB$Query;

  declare function query(
    strings: TemplateStringsArray,
    ...args: any[]
  ): ArangoDB$ArangoDB$Cursor;
  ...
  declare var errors: $ObjMapi<
    { [k: ArangoDB$ArangoDB$ErrorName]: any },
    <Name>(
      Name
    ) => {
      code: number,
...
declare type ArangoDB$DocumentData<T: { [key: string]: any } = any> = $ObjMapi<
  T,
  <K>(K) => $ElementType<T, K>
> &
