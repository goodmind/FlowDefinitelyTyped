declare module 'kerberos' {
        declare export var GSS_C_DELEG_FLAG: number;
	declare export var GSS_C_MUTUAL_FLAG: number;
	declare export var GSS_C_REPLAY_FLAG: number;
	declare export var GSS_C_SEQUENCE_FLAG: number;
	declare export var GSS_C_CONF_FLAG: number;
	declare export var GSS_C_INTEG_FLAG: number;
	declare export var GSS_C_ANON_FLAG: number;
	declare export var GSS_C_PROT_READY_FLAG: number;
	declare export var GSS_C_TRANS_FLAG: number;
	declare export var GSS_C_NO_OID: number;
	declare export var GSS_MECH_OID_KRB5: number;
	declare export var GSS_MECH_OID_SPNEGO: number;
	
/**
 * @description Optional settings for *KerberosClient.wrap* method
 */
declare export interface WrapOptions {
 ...
 * @description Optional settings for *KerberosClient.wrap* method
 */
declare export interface InitializeClientOptions {
...
mechOID?: number
	...
	declare export class KerberosClient  {
...
step(
challenge: string,
callback: (err: string, clientResponse: string) => any): void;
...
wrap(
challenge: string,
callback: (err: string, challengeResponse: string) => any): void;
wrap(
challenge: string,
options: WrapOptions,
callback: (err: string, challengeResponse: string) => any): void;
...
callback: (err: string, challengeResponse: string) => any): void
	...
	declare export class KerberosServer  {
...
step(
challenge: string,
callback: (err: string, serverResponse: string) => any): void
}
 ...
 * @return returns Promise if no callback passed
 */
declare export function checkPassword(
name: string,
password: string,
service: string,
defaultRealm?: string): Promise<void>
 ...
 * @return returns Promise if no callback passed
 */
declare export function principalDetails(service: string, hostname: string): Promise<string>

	declare export function principalDetails(
service: string,
hostname: string,
callback: (err: string, details: string) => any): void
 ...
 * @return returns Promise if no callback passed
 */
declare export function initializeClient(service: string, options?: InitializeClientOptions): Promise<KerberosClient>

	declare export function initializeClient(service: string, callback: (err: string, client: KerberosClient) => any): void

	declare export function initializeClient(
service: string,
options: InitializeClientOptions,
callback: (err: string, client: KerberosClient) => any): void

	
/**
 * Initializes a context for server-side authentication with the given service principal.
 * @param service A string containing the service principal in the form 'type
 * @fqdn ' (e.g. 'imap
 * @mail .apple.com').
 * @param callback
 * @return returns Promise if no callback passed
 */
declare export function initializeServer(service: string): Promise<KerberosServer>

	declare export function initializeServer(service: string, callback: (err: string, server: KerberosServer) => any): void
