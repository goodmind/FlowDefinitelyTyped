...
name: string,
deps?: string[],
fn?: Orchestrator$Orchestrator$TaskFunc): Orchestrator;
task(name: string): Orchestrator$Orchestrator$Task;
task(name: string, fn: Orchestrator$Orchestrator$TaskFunc): void;
task(name: string, dep: string[], fn: Orchestrator$Orchestrator$TaskFunc): void;
...
cb: (e: Orchestrator$Orchestrator$OnCallbackEvent) => any): this;
...
meta: Orchestrator$Orchestrator$Meta): void;
_emitTaskDone(task: Orchestrator$Orchestrator$Task, message: string, err?: any): void;
...
done: (err: any, meta: Orchestrator$Orchestrator$Meta) => void) => void;
 ...
 */
declare type Orchestrator$TaskFunc = (callback: (err?: any) => void) => Q.Promise<any> | stream.Stream | any;
...
(task1: Orchestrator$Strings, task2: Orchestrator$Strings, cb?: (error?: any) => any): Orchestrator,
(task1: Orchestrator$Strings, task2: Orchestrator$Strings, task3: Orchestrator$Strings, cb?: (error?: any) => any): Orchestrator,
(task1: Orchestrator$Strings, task2: Orchestrator$Strings, task3: Orchestrator$Strings, task4: Orchestrator$Strings, cb?: (error?: any) => any): Orchestrator,
(task1: Orchestrator$Strings, task2: Orchestrator$Strings, task3: Orchestrator$Strings, task4: Orchestrator$Strings, task5: Orchestrator$Strings, cb?: (error?: any) => any): Orchestrator,
(task1: Orchestrator$Strings, task2: Orchestrator$Strings, task3: Orchestrator$Strings, task4: Orchestrator$Strings, task5: Orchestrator$Strings, task6: Orchestrator$Strings, cb?: (error?: any) => any): Orchestrator
} 
...
declare type Orchestrator$EventNames = ("start"
| "stop"
| "err"
| "task_start"
| "task_stop"
