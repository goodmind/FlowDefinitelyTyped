declare module 'auth0-angular' {
        declare interface angular$IAuth0ClientOptions {
...
declare interface angular$ITokenOptions {
targetClientId?: string,
api?: string
} 

declare interface angular$IAuth0Options {
...
declare interface angular$ISuccessCallback {
(profile?: string, idToken?: string, accessToken?: string, state?: string, refreshToken?: string): void
} 

declare interface angular$IErrorCallback {
(error: any): void
} 

declare interface angular$IAuth0Service {
 ...
 */
getToken(options?: angular$ITokenOptions): ng.IPromise<any>,
 ...
 */
signin(
options?: angular$IAuth0Options,
successCallback?: angular$ISuccessCallback,
errorCallback?: angular$IErrorCallback): void,
...
declare interface angular$IAuth0ServiceProvider {

/**
 * Configures the auth service
 * @param options Client options passed into Auth0
 */
init(options: angular$IAuth0ClientOptions): void,
