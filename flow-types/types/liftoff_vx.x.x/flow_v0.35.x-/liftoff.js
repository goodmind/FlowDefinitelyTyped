declare module 'liftoff' {
        import type {
          Extensions,Extension,ExtensionDescriptor
        } from 'interpret';
	...
	declare module.exports: typeof Liftoff

	declare class Liftoff mixins EventEmitter {

/**
 * Create an instance of Liftoff to invoke your application.
 */
constructor(options?: Liftoff$Liftoff$Options): this;
 ...
 */
launch(
opts: Liftoff$Liftoff$LaunchOptions,
callback: (env: Liftoff$Liftoff$LiftoffEnv) => void): void;
addListener(
event: "require",
listener: (name: string, module: ExtensionDescriptor) => void): this;
addListener(event: "requireFail", listener: (name: string, err: any) => void): this;
addListener(
event: "respawn",
listener: (flags: string[], child: NodeJS.Process) => void): this;
on(
event: "require",
listener: (name: string, module: ExtensionDescriptor) => void): this;
...
listeners(event: "require" | "requireFail" | "respawn"): Function[];
rawListeners(event: "require" | "requireFail" | "respawn"): Function[];
...
listenerCount(type: "require" | "requireFail" | "respawn"): number
	...
	declare interface Liftoff$Options {
...
declare interface Liftoff$LaunchOptions {
 ...
 * @default null
 */
forcedFlags?: string | string[] | ((env: Liftoff$LiftoffEnv) => string | string[]),
completion?: string
} 

declare interface Liftoff$LiftoffEnv {
