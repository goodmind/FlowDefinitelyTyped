declare module 'nightwatch' {
        declare export interface NightwatchCustomPageObjects {
page: {
[name: string]: () => EnhancedPageObject
}
} 
	declare export interface NightwatchDesiredCapabilities {
...
server?: string
	...
	declare export interface NightwatchScreenshotOptions {
enabled?: boolean,
on_failure?: boolean,
on_error?: boolean,
path?: string
} 
	declare export interface NightwatchTestRunner {
"type"?: string,
options?: {
ui?: string
}
} 
	declare export interface NightwatchTestWorker {
enabled: boolean,
workers: string
} 
	declare export interface NightwatchOptions {
...
test_runner?: string | NightwatchTestRunner
	...
	declare export interface NightwatchSeleniumOptions {
...
cli_args: any
	...
	declare export interface NightwatchTestSettingGeneric {
...
skip_testcases_on_fail: boolean
	...
	declare export type NightwatchTestSettingScreenshots = {
...
screenshots: NightwatchScreenshotOptions
	...
	declare export type NightwatchTestOptions = {
screenshots: boolean,
screenshotsPath: string
} & NightwatchTestSettingGeneric

	declare export interface NightwatchTestSuite {
name: string,
"module": string,
group: string,
results: any
} 
	declare export interface NightwatchAssertionsError {
name: string,
message: string,
showDiff: boolean,
stack: string
} 
	declare export interface NightwatchLanguageChains {
to: Expect,
be: Expect,
been: Expect,
is: Expect,
...
of: Expect
	...
	declare export interface NightwatchTestSettings {
[key: string]: NightwatchTestSettingScreenshots
} 
	declare export type Expect = {
 ...
 */
visible: this
} & NightwatchLanguageChains & NightwatchBrowser

	declare export type NightwatchAssertions = {
...
NightwatchAssertionsError: NightwatchAssertionsError
	...
	declare export interface NightwatchTypedCallbackResult<T> {
status: number,
value: T,
state: Error | string
} 
	declare export type NightwatchCallbackResult = {} & NightwatchTypedCallbackResult<any>

	declare export interface NightwatchLogEntry {
...
level: string
	...
	declare export interface NightwatchKeys {
...
"COMMAND": string
	...
	declare export type NightwatchAPI = {
 ...
 */
getTitle(callback?: (result?: string) => void): this,
...
scriptUrl: string,
id?: string,
callback?: (result: NightwatchCallbackResult) => void): this,
 ...
 * @param callback : Optional callback function to be called when the command finishes.
 */
frame(frameId: string | void | null, callback?: () => void): this,
...
screenshot(
log_screenshot_data: boolean,
callback?: (screenshotEncoded: string) => void): this,
...
launch_url: string
	...
	declare export interface NightwatchCustomCommands {} 
	declare export interface NightwatchCustomAssertions {} 
	declare export type NightwatchBrowser = {} & NightwatchAPI & NightwatchCustomCommands & NightwatchCustomAssertions & NightwatchCustomPageObjects

	declare export type NightwatchTest = (browser: NightwatchBrowser) => void;
	declare export interface NightwatchTestFunctions {
[key: string]: NightwatchTest
} 
	declare export type NightwatchTestHook = (browser: NightwatchBrowser, done: () => void) => void;
	declare export interface NightwatchTestHooks {
...
"@disabled"?: boolean
	...
	declare export type NightwatchTests = NightwatchTestFunctions | NightwatchTestHooks;
	
/**
 * Performs an assertion
 */
declare export type NightwatchAssert = (
passed: boolean,
receivedValue?: any,
expectedValue?: any,
message?: string,
abortOnFailure?: boolean,
originalStackTrace?: string) => void;
 ...
 */
declare export interface NightwatchAssertion {
...
api?: NightwatchAPI
	...
	declare export interface NightwatchClient {
api: NightwatchAPI,
assertion: NightwatchAssert
} 
	declare export interface Nightwatch {
api: NightwatchAPI,
 ...
 */
declare export interface EnhancedElementInstance {
 ...
 */
declare export type EnhancedPageObject = {
...
name: string
	...
	declare export interface SharedFunctions {
