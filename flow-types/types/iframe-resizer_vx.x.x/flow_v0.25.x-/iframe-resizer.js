declare module "iframe-resizer" {
  ...
  declare interface iframeResizer$IFramePageOptions {
    ...
    widthCalculationMethod?:
      | iframeResizer$WidthCalculationMethod
      | (() => number);
  }

  declare type iframeResizer$HeightCalculationMethod =
    | "bodyOffset"
    | "bodyScroll"
  ...
  declare type iframeResizer$WidthCalculationMethod =
    | "bodyOffset"
    | "bodyScroll"
    | "documentElementOffset"
    | "documentElementScroll"
  ...
  declare interface iframeResizer$IFramePage {
     ...
     */
    getPageInfo(
      callback: ((data: iframeResizer$PageInfo) => void) | false
    ): void;
    ...
    setHeightCalculationMethod(
      method: iframeResizer$HeightCalculationMethod
    ): void;
    ...
    setWidthCalculationMethod(
      method: iframeResizer$WidthCalculationMethod
    ): void;
  ...
  ): iframeResizer$iframeResizer$IFrameComponent[];
