declare module 'iframe-resizer' {
        declare interface iframeResizer$IFrameObject {
close(): void,
...
declare type iframeResizer$IFrameComponent = {
iFrameResizer: iframeResizer$IFrameObject
} & HTMLIFrameElement


declare interface iframeResizer$IFrameOptions {
 ...
 */
heightCalculationMethod?: iframeResizer$HeightCalculationMethod,
 ...
 */
widthCalculationMethod?: iframeResizer$WidthCalculationMethod,
 ...
 */
initCallback(iframe: iframeResizer$IFrameComponent): void,

/**
 * Receive message posted from iFrame with the parentIFrame.sendMessage() method.
 */
messageCallback(data: iframeResizer$IFrameMessageData): void,
 ...
 */
resizedCallback(data: iframeResizer$IFrameResizedData): void,
 ...
 */
scrollCallback(data: iframeResizer$IFrameScrollData): boolean
} 

declare interface iframeResizer$IFramePageOptions {
 ...
 */
heightCalculationMethod?: iframeResizer$HeightCalculationMethod | (() => number),

/**
 * These option can be used to override the option set in the parent page
 */
widthCalculationMethod?: iframeResizer$WidthCalculationMethod | (() => number)
} 

declare type iframeResizer$HeightCalculationMethod = "bodyOffset"
| "bodyScroll"
...
declare type iframeResizer$WidthCalculationMethod = "bodyOffset"
| "bodyScroll"
| "documentElementOffset"
| "documentElementScroll"
| "max"
...
declare interface iframeResizer$IFramePage {
 ...
 */
getPageInfo(callback: ((data: iframeResizer$PageInfo) => void) | false): void,
 ...
 */
setHeightCalculationMethod(method: iframeResizer$HeightCalculationMethod): void,

/**
 * Change the method use to workout the width of the iFrame.
 */
setWidthCalculationMethod(method: iframeResizer$WidthCalculationMethod): void,
...
declare interface iframeResizer$PageInfo {
...
declare interface iframeResizer$IFrameResizedData {
...
declare interface iframeResizer$IFrameMessageData {
iframe: iframeResizer$IFrameComponent,
message: any
} 

declare interface iframeResizer$IFrameScrollData {
x: number,
y: number
} 
	declare function iframeResizer(
options: iframeResizer$iframeResizer$IFrameOptions,
target: string | HTMLElement): iframeResizer$iframeResizer$IFrameComponent[]

	declare module.exports: typeof iframeResizer
