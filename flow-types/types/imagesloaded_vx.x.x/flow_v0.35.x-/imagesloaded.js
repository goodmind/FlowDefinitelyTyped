 ...
 */
(elem: ImagesLoaded$ElementSelector, options: ImagesLoaded$ImagesLoadedOptions, callback?: ImagesLoaded$ImagesLoadedCallback): ImagesLoaded$ImagesLoaded,
(elem: ImagesLoaded$ElementSelector, callback?: ImagesLoaded$ImagesLoadedCallback): ImagesLoaded$ImagesLoaded
} declare var imagesLoaded: ImagesLoaded$ImagesLoaded.ImagesLoaded$ImagesLoadedConstructor;declare module 'imagesloaded' {
        declare module.exports: typeof imagesLoaded

    }
declare interface JQuery {
imagesLoaded(
callback?: ImagesLoaded$ImagesLoaded.ImagesLoaded$ImagesLoadedCallback): JQueryDeferred<ImagesLoaded$ImagesLoaded.ImagesLoaded$ImagesLoaded>
} 