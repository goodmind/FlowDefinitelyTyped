...
info(title: string, content: string, userData: any): notifications$INotification,
error(title: string): notifications$INotification,
error(title: string, content: string): notifications$INotification,
error(title: string, content: string, userData: any): notifications$INotification,
success(title: string): notifications$INotification,
success(title: string, content: string): notifications$INotification,
success(title: string, content: string, userData: any): notifications$INotification,
warning(title: string): notifications$INotification,
warning(title: string, content: string): notifications$INotification,
warning(title: string, content: string, userData: any): notifications$INotification,
awesomeNotify(
type: string,
icon: string,
title: string,
content: string,
userData: any): notifications$INotification,
notify(
image: string,
title: string,
content: string,
