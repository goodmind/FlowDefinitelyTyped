declare module "d3-collection" {
   ...
   */
  declare export interface Stringifiable {
    toString(): string;
  }
   ...
   * @param obj An object.
   */
  declare export function keys(obj: { [key: string]: any }): string[];
   ...
   * @param obj An object.
   */
  declare export function values<T>(
    obj:
      | {
          [key: string]: T
        }
   ...
   * @param obj An object.
   */
  declare export function values(obj: { [key: string]: any }): any[];
   ...
   * @param obj An object.
   */
  declare export function entries(obj: { [key: string]: any }): core$Array<{
    key: string,
    value: any
  }>;
  ...
  declare export interface Map<T> {
     ...
     */
    Reflect$has(key: string): boolean;
     ...
     */
    Reflect$set(key: string, value: T): this;
 ...
 */
    each(func: (value: T, key: string, array$map: core$Map<T>) => void): void;
   ...
   * The generic refers to the data type of the map entry values.
   */
  declare export function map<T>(): core$Map<T>;
   ...
   */
  declare export function map<T>(d3Map: core$Map<T>): core$Map<T>;
   ...
   */
  declare export function map<T>(obj: {
    [key: string]: T
  }): core$Map<T>;
 ...
 */
   ...
   * @param obj Object to construct the map from.
   */
  declare export function map(obj: { [key: string]: any }): core$Map<any>;
 ...
 */
    each(
      func: (value: string, valueRepeat: string, Reflect$set: core$Set) => void
    ): void;
   ...
   */
  declare export function set(): core$Set;

  /**
   * Constructs a new set by copying an existing set.
   * @param set A D3 set.
   */
  declare export function set(d3Set: core$Set): core$Set;
  ...
  declare export function set(
    array: core$Array<string | Stringifiable>
  ): core$Set;
 ...
 */
   ...
   */
  declare export type NestedArray<Datum, RollupType> = {} & core$Array<{
    key: string,
    values: NestedArray<Datum, RollupType> | Datum[] | void,
    value: RollupType | void
  }>;
   ...
   * to use in practice.
   */
  declare export type NestedMap<Datum, RollupType> = {} & core$Map<
    NestedMap<Datum, RollupType> | Datum[] | RollupType
  >;
   ...
   * to use in practice.
   */
  declare export interface NestedObject<Datum, RollupType> {
   ...
   * nest operator.
   */
  declare export interface Nest<Datum, RollupType> {
    /**
 ...
 */
     ...
     */
    array$map(array: Datum[]): core$Map<any>;
   ...
   */
  declare export function nest<Datum, RollupType>(): Nest<Datum, RollupType>;
}
