 ...
 */
constructor(version: number, paymentRequest: ApplePayJS$ApplePayJS$ApplePayPaymentRequest): this;
 ...
 */
onpaymentauthorized: (event: ApplePayJS$ApplePayJS$ApplePayPaymentAuthorizedEvent) => void;

/**
 * A callback function that is automatically called when a new payment method is selected.
 */
onpaymentmethodselected: (event: ApplePayJS$ApplePayJS$ApplePayPaymentMethodSelectedEvent) => void;

/**
 * A callback function that is called when a shipping contact is selected in the payment sheet.
 */
onshippingcontactselected: (event: ApplePayJS$ApplePayJS$ApplePayShippingContactSelectedEvent) => void;

/**
 * A callback function that is automatically called when a shipping method is selected.
 */
onshippingmethodselected: (event: ApplePayJS$ApplePayJS$ApplePayShippingMethodSelectedEvent) => void;

/**
 * A callback function that is automatically called when the payment sheet is displayed.
 */
onvalidatemerchant: (event: ApplePayJS$ApplePayJS$ApplePayValidateMerchantEvent) => void;
 ...
 */
completePayment(
result: number | ApplePayJS$ApplePayJS$ApplePayPaymentAuthorizationResult): void;
...
newLineItems: ApplePayJS$ApplePayJS$ApplePayLineItem[]): void;
 ...
 */
completePaymentMethodSelection(update: ApplePayJS$ApplePayJS$ApplePayPaymentMethodUpdate): void;
 ...
 */
completeShippingContactSelection(update: ApplePayJS$ApplePayJS$ApplePayShippingContactUpdate): void;
 ...
 */
completeShippingMethodSelection(update: ApplePayJS$ApplePayJS$ApplePayShippingMethodUpdate): void;
 ...
 */
declare type ApplePayJS$ApplePayContactField = "email"
| "name"
| "phone"
| "postalAddress"
| "phoneticName";
 ...
 */
declare type ApplePayJS$ApplePayErrorCode = "shippingContactInvalid" | "billingContactInvalid" | "addressUnserviceable" | "unknown";


/**
 * Names of the fields in the shipping or billing contact information, used to locate errors in the payment sheet.
 */
declare type ApplePayJS$ApplePayErrorContactField = "phoneNumber"
| "emailAddress"
| "name"
| "phoneticName"
| "postalAddress"
 ...
 */
declare type ApplePayJS$ApplePayMerchantCapability = "supports3DS" | "supportsEMV" | "supportsCredit" | "supportsDebit";
 ...
 */
declare class ApplePayJS$ApplePayPaymentAuthorizedEvent mixins ApplePayJS$Event {
 ...
 */
declare type ApplePayJS$ApplePayPaymentMethodType = "debit" | "credit" | "prepaid" | "store";
 ...
 */
declare class ApplePayJS$ApplePayPaymentMethodSelectedEvent mixins ApplePayJS$Event {
 ...
 */
declare type ApplePayJS$ApplePayPaymentPassActivationState = "activated"
| "requiresActivation"
| "activating"
| "suspended"
| "deactivated";
 ...
 */
declare class ApplePayJS$ApplePayShippingContactSelectedEvent mixins ApplePayJS$Event {
 ...
 */
declare class ApplePayJS$ApplePayShippingMethodSelectedEvent mixins ApplePayJS$Event {
 ...
 */
declare type ApplePayJS$ApplePayShippingType = "shipping" | "delivery" | "storePickup" | "servicePickup";


/**
 * The attributes contained by the onvalidatemerchant callback function.
 */
declare class ApplePayJS$ApplePayValidateMerchantEvent mixins ApplePayJS$Event {
