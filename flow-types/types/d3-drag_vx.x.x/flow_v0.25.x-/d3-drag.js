declare module "d3-drag" {
  import type { ArrayLike, Selection, ValueFn } from "d3-selection";
   ...
   */
  declare export type DragContainerElement =
    | HTMLElement
    | SVGSVGElement
    | SVGGElement;
   ...
   */
  declare export type DragBehavior<
    GElement: DraggedElementBaseType,
    Datum,
    Subject
  > = {
    /**
 ...
 */
   ...
   * The third generic refers to the type of the drag behavior subject.
   */
  declare export interface D3DragEvent<
    GElement: DraggedElementBaseType,
    Datum,
    Subject
  > {
