 ...
 * be supported.
 */
declare export type DraggedElementBaseType = Element;
	
/**
 * Container element type usable for mouse/touch functions
 */
declare export type DragContainerElement = HTMLElement | SVGSVGElement | SVGGElement;
 ...
 */
declare export interface SubjectPosition {
 ...
 */
declare export type DragBehavior<GElement: DraggedElementBaseType, Datum, Subject> = {
 ...
 * The second generic refers to the type of the datum of the dragged element.
 */
declare export function drag<GElement: DraggedElementBaseType, Datum>(
 ...
 * The third generic refers to the type of the drag behavior subject.
 */
declare export function drag<GElement: DraggedElementBaseType, Datum, Subject>(
 ...
 * The third generic refers to the type of the drag behavior subject.
 */
declare export interface D3DragEvent<GElement: DraggedElementBaseType, Datum, Subject> {
 ...
 */
declare export function dragDisable(window: Window): void
 ...
 */
declare export function dragEnable(window: Window, noClick?: boolean): void
