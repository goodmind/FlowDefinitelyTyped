declare module "react-bootstrap-table" {
   ...
   */
  declare export type FilterType =
    | "TextFilter"
    | "RegexFilter"
    | "SelectFilter"
    | "NumberFilter"
   ...
   */
  declare export type EditCellType =
    | "textarea"
    | "select"
    | "checkbox"
    | "datetime";
   ...
   */
  declare export type DataAlignType =
    | "left"
    | "center"
    | "right"
    | "start"
   ...
   */
  declare export type SizePerPageList =
    | number[]
    | Array<{
        text: string,
        value: number
 ...
 */
  ...
  declare export interface SelectRow<TRow: { [key: string]: any } = any> {
    /**
   ...
   */
  declare export interface CellEdit<TRow: { [key: string]: any } = any> {
    /**
   ...
   */
  declare export interface Options<TRow: { [key: string]: any } = any> {
    /**
     ...
     */
    onSortChange?:
      | ((sortName: $Keys<TRow>, sortOrder: SortOrder) => void)
      | ((
          sortName: $ReadOnlyArray<$Keys<TRow>>,
          sortOrder: $ReadOnlyArray<SortOrder>
        ) => void);
     ...
     */
    sizePerPageDropDown?: (
      props: SizePerPageFunctionProps
    ) => ReactElement<any>;
 ...
 */
   ...
   */
  declare export type EditSelectOptionValue =
    | Array<{
        text: string,
        value: string
      }>
 ...
 */
   ...
   */
  declare export interface CustomFilterParameters<
   ...
   * Custom filter type.
   */
  declare export interface CustomFilter<
    FParams: { [key: string]: any } = any,
    FElement: CustomFilterElement = any
  > {
    /**
   ...
   */
  declare export type FilterValueData =
    | string
    | number
    | string[]
    | number[]
   ...
   */
  declare export type FilterValue =
    | TextFilterData
    | SelectFilterData
    | RegexFilterData
    | NumberFilterData
   ...
   */
  declare export interface FilterData<
    CustomFilterValue: { [key: string]: any } = any
  > {
   ...
   */
  declare export class TableHeaderColumn
    mixins Component<TableHeaderColumnProps> {
    /**
   ...
   */
  declare export interface ColumnDescription<
    TRow: { [key: string]: any } = any
  > {
    /**
     * Name of the column.
   ...
   */
  declare export type CustomEditorProps<
    TRow: { [key: string]: any },
    K: $Keys<TRow>
  > = {
    /**
   ...
   */
  declare export interface CustomEditor<
    TRow: { [key: string]: any },
    K: $Keys<TRow>
  > {
    /**
   ...
   */
  declare export interface InsertModalColumnDescription<
    TRow: { [key: string]: any } = any
  > {
    /**
    ...
    customInsertEditor(
      ...
      editorClass: string,
      ignoreEditable: boolean,
      defaultValue: $ElementType<TRow, $Keys<TRow>>
    ): ReactElement<any> | boolean;
   ...
   */
  declare export interface ModalBodyInterface<
    TRow: { [key: string]: any } = any
  > {
    /**
   ...
   */
  declare export class ShowSelectedOnlyButton
    mixins Component<ShowSelectedButtonProps> {}

  /**
   * Default SearchField component. Can be used to create custom toolbars, etc.
   */
  declare export class SearchField
    mixins Component<SearchFieldProps>, SearchFieldInterface {
    getValue(): string;
    setValue(search: string): void;
  }
   ...
   */
  declare export class InsertModalHeader
    mixins Component<InsertModalHeaderProps> {}

  /**
   * Default footer component used for the Insert modal. Can be used to customize the
   * insert row modal form.
   */
  declare export class InsertModalFooter
    mixins Component<InsertModalFooterProps> {}

  /**
   * Default size per page component used in the pagination row. Can be used to customize
   * the size per page dropdown.
   */
  declare export class SizePerPageDropDown
    mixins Component<SizePerPageDropDownProps> {}
}
