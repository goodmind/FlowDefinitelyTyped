declare module 'react-bootstrap-table' {
        import type {
          Component,CSSProperties,Props,ReactElement,SyntheticEvent
        } from 'react';
 ...
 */
declare export type ScrollPosition = "Top" | "Bottom";
 ...
 */
declare export type FilterCondition = "eq" | "like";
	
/**
 * Filter comparators used for NumberFilter/DateFilter filters
 */
declare export type FilterComparator = "="
| "<"
| "<="
| ">"
| ">="
 ...
 */
declare export type EditCellType = "textarea" | "select" | "checkbox" | "datetime";
 ...
 */
declare export type PaginationPostion = "top" | "bottom" | "both";
	
/**
 * Result type for validation when editing.
 */
declare export type EditValidatorType = "success" | "error";
 ...
 */
declare export type BootstrapVersion = "3" | "4";
	
/**
 * CSV Field types supported.
 */
declare export type CSVFieldType = "string" | "number";
	
/**
 * Custom attributes for a column/cell/etc.
 * Example: { 'data-attr': 'test' }
 */
declare export interface CustomAttrs {
 ...
 */
declare export type SizePerPageList = number[] | Array<{
text: string,
value: number
}>;
 ...
 * for more info
 */
declare export interface RemoteObjSpec {
 ...
 */
declare export interface FooterData {
...
formatter(tableData: any[]): string | number | ReactElement<any>
	...
	declare export interface SelectRow<TRow: {[key: string]: any}> {
 ...
 */
declare export interface CellEdit<TRow: {[key: string]: any}> {
 ...
 */
beforeSaveCell<K: $Keys<TRow>>(
row: TRow,
cellName: K,
cellValue: $ElementType<TRow, K>,
 ...
 */
declare export interface Options<TRow: {[key: string]: any}> {
 ...
 */
sortName?: $Keys<TRow> | Array<$Keys<TRow>>,
 ...
 */
onSortChange?: ((sortName: $Keys<TRow>, sortOrder: SortOrder) => void) | ((
sortName: $ReadOnlyArray<$Keys<TRow>>,
sortOrder: $ReadOnlyArray<SortOrder>) => void),
...
multiColumnSearch: boolean): void,
...
errorCallback: (message: string) => void): string | boolean,
...
showSelected: boolean): ReactElement<any>,
...
ignoreEditable: boolean): ReactElement<any>,
...
ignoreEditable: boolean): React.ReactElement<React.Component<any> & ModalBodyInterface<TRow>>,
 ...
 */
onCellEdit<K: string & $Keys<TRow>>(
row: TRow,
fieldName: K,
value: $ElementType<TRow, K>): $ElementType<TRow, K>,
 ...
 */
declare export interface FetchInfo {
 ...
 */
declare export class BootstrapTable mixins Component<BootstrapTableProps> {
...
row: any,
formatExtraData: any,
rowIndex: number): string | ReactElement<any>,
...
b: {[key: string]: any},
order: SortOrder,
sortField: $Keys<{[key: string]: any}>,
extraData: any): number,
 ...
 */
editable?: boolean | Editable<any, any> | ((
cell: any,
row: any,
rowIndex: number,
columnIndex: number) => boolean | string | EditValidatorObject),
...
editorClass: string,
ignoreEditable: boolean,
defaultValue: any): ReactElement<any> | boolean
},
 ...
 */
declare export type EditSelectOptionValue = Array<{
text: string,
value: string
}> | string[] | number[];
 ...
 * e.g. "Yes:No"
 */
declare export type EditCheckboxOptionValue = string;
	
/**
 * Object to use to customize the properties for an editable column.
 */
declare export interface Editable<TRow: {[key: string]: any}, K: $Keys<TRow>> {
 ...
 */
validator(cell: $ElementType<TRow, K>, row: TRow): boolean | string | EditValidatorObject,
 ...
 */
options?: {
values: EditSelectOptionValue | EditCheckboxOptionValue | ((row: TRow) => EditCheckboxOptionValue | EditSelectOptionValue)
},

/**
 * Default value to show in the edit field in the Insert Modal for this column.
 */
defaultValue?: $ElementType<TRow, K>,
 ...
 * Text filter type.
 */
declare export interface TextFilter {
...
style?: CSSProperties
	...
	declare export interface SelectFilterOptionsType {
 ...
 * Select filter type
 */
declare export interface SelectFilter {
 ...
 * Regex filter type
 */
declare export interface RegexFilter {
 ...
 * Number filter type
 */
declare export interface NumberFilter {
 ...
 * Date filter type
 */
declare export interface DateFilter {
 ...
 */
declare export interface CustomFilterParameters<Params: {[key: string]: any}> {
 ...
 */
declare export class CustomFilterElement mixins Component<any> {
cleanFiltered: () => void
}
 ...
 * Custom filter type.
 */
declare export interface CustomFilter<FParams: {[key: string]: any}, FElement: CustomFilterElement> {
...
customFilterParameters: CustomFilterParameters<FParams>): ReactElement<FElement>,
 ...
 */
declare export type Filter = TextFilter
| SelectFilter
| RegexFilter
| NumberFilter
| DateFilter
 ...
 */
declare export interface NumberFilterValue {
 ...
 */
declare export interface DateFilterValue {
date: Date | string,
comparator: FilterComparator
} 
 ...
 */
declare export interface TextFilterData {
type: "TextFilter",
value: string
} 
 ...
 */
declare export interface SelectFilterData {
type: "SelectFilter",
value: string
} 
 ...
 */
declare export interface RegexFilterData {
type: "RegexFilter",
value: string
} 
 ...
 */
declare export interface NumberFilterData {
type: "NumberFilter",
 ...
 */
declare export interface DateFilterData {
type: "DateFilter",
 ...
 */
declare export interface ArrayFilterData {
type: "ArrayFilter",
value: string[] | number[]
} 
 ...
 */
declare export type FilterValueData = string
| number
| string[]
| number[]
| DateFilterValue
 ...
 */
declare export type FilterValue = TextFilterData
| SelectFilterData
| RegexFilterData
| NumberFilterData
| DateFilterData
 ...
 */
declare export interface FilterData<CustomFilterValue: {[key: string]: any}> {
 ...
 */
declare export class TableHeaderColumn mixins Component<TableHeaderColumnProps> {
 ...
 */
declare export interface KeyboardNavigation {
 ...
 */
declare export interface ExpandColumnComponentProps {
 ...
 */
declare export interface ExpandedColumnHeaderProps {
anyExpand: boolean
} 
 ...
 */
declare export interface ExpandColumnOptions {
 ...
 */
declare export interface CustomSelectProps {
 ...
 */
declare export interface ColumnDescription<TRow: {[key: string]: any}> {
 ...
 */
editable: boolean | Editable<TRow, any> | ((
cell: any,
row: TRow,
rowIndex: number,
columnIndex: number) => boolean | string | EditValidatorObject),
 ...
 */
declare export interface SearchPanelProps {
 ...
 */
declare export interface PaginationPanelProps {
 ...
 */
declare export interface SizePerPageFunctionProps {
 ...
 */
declare export type CustomEditorProps<TRow: {[key: string]: any}, K: $Keys<TRow>> = {
 ...
 */
declare export interface CustomEditor<TRow: {[key: string]: any}, K: $Keys<TRow>> {
 ...
 */
getElement(
onUpdate: (updatedCell: $ElementType<TRow, K>) => void,
props: CustomEditorProps<TRow, K>): ReactElement<any>,

/**
 * Additional parameters to pass to the getElement function inside the props argument.
 */
customEditorParameters?: {[key: string]: any}
} 
	
/**
 * Validation object that can be returned from cell editing validation.
 */
declare export interface EditValidatorObject {
 ...
 */
declare export interface ShowSelectedButtonProps {
 ...
 */
declare export interface SearchFieldInterface {
 ...
 */
declare export interface InsertModalColumnDescription<TRow: {[key: string]: any}> {
 ...
 */
editable: boolean | Editable<TRow, $Keys<TRow>> | ((
cell: $ElementType<TRow, $Keys<TRow>>,
row: TRow,
rowIndex: number,
columnIndex: number) => boolean | string | EditValidatorObject),
...
editorClass: string,
ignoreEditable: boolean,
defaultValue: $ElementType<TRow, $Keys<TRow>>): ReactElement<any> | boolean,
 ...
 */
format?: boolean | ((cell: $ElementType<TRow, $Keys<TRow>>) => string)
} 
	
/**
 * Properties that can be passed to the InsertModalHeader component.
 */
declare export interface InsertModalHeaderProps {
 ...
 */
declare export interface InsertModalFooterProps {
 ...
 */
declare export interface ModalBodyInterface<TRow: {[key: string]: any}> {
 ...
 */
declare export interface SizePerPageDropDownProps {
 ...
 */
declare export class InsertButton mixins Component<ButtonProps> {}
	
/**
 * Default DeleteButton component. Can be used to create custom toolbars, etc.
 */
declare export class DeleteButton mixins Component<ButtonProps> {}
	
/**
 * Default ExportCSVButton component. Can be used to create custom toolbars, etc.
 */
declare export class ExportCSVButton mixins Component<ButtonProps> {}
 ...
 */
declare export class ShowSelectedOnlyButton mixins Component<ShowSelectedButtonProps> {}
	
/**
 * Default SearchField component. Can be used to create custom toolbars, etc.
 */
declare export class SearchField mixins Component<SearchFieldProps>, SearchFieldInterface {
getValue(): string;
setValue(search: string): void
}
 ...
 */
declare export class ClearSearchButton mixins Component<ButtonProps> {}
	
/**
 * Default header component used for the Insert modal. Can be used to customize the
 * insert row modal form.
 */
declare export class InsertModalHeader mixins Component<InsertModalHeaderProps> {}
	
/**
 * Default footer component used for the Insert modal. Can be used to customize the
 * insert row modal form.
 */
declare export class InsertModalFooter mixins Component<InsertModalFooterProps> {}
	
/**
 * Default size per page component used in the pagination row. Can be used to customize
 * the size per page dropdown.
 */
declare export class SizePerPageDropDown mixins Component<SizePerPageDropDownProps> {}
    }
