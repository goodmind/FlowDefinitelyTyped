...
addElementTransformer(route: string, transformer: Function): restangular$IProvider,
addElementTransformer(
route: string,
isCollection: boolean,
transformer: Function): restangular$IProvider,
...
isCollection: boolean,
what: string,
restangular: restangular$IService) => any): restangular$IProvider,
...
deferred: angular.IDeferred<any>) => any): restangular$IProvider,
...
requestInterceptor: (element: any, operation: string, what: string, url: string) => any): restangular$IProvider,
...
responseHandler: (response: restangular$restangular$IResponse) => any) => any): restangular$IProvider,
...
setDefaultRequestParams(methods: string[], params: any): restangular$IProvider,
...
extendModel(
route: string,
extender: (model: restangular$IElement) => any): restangular$IProvider,
extendCollection(
route: string,
extender: (collection: restangular$ICollection) => any): restangular$IProvider
} 
...
getRestangularUrl(): string,
getRequestedUrl(): string
} & restangular$IService & Array<any>
