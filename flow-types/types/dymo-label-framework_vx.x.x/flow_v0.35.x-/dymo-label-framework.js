...
static +AboveAddress: Class<framework$AddressBarcodePosition__AboveAddress> & framework$AddressBarcodePosition__AboveAddress & 0;// 0
static +BelowAddress: Class<framework$AddressBarcodePosition__BelowAddress> & framework$AddressBarcodePosition__BelowAddress & 1;// 1
static +Suppress: Class<framework$AddressBarcodePosition__Suppress> & framework$AddressBarcodePosition__Suppress & 2;// 2

}

declare class framework$AddressBarcodePosition__AboveAddress mixins framework$AddressBarcodePosition {}
declare class framework$AddressBarcodePosition__BelowAddress mixins framework$AddressBarcodePosition {}
declare class framework$AddressBarcodePosition__Suppress mixins framework$AddressBarcodePosition {}
...
declare  class framework$FlowDirection {
  constructor(...args: empty): mixed;
static +LeftToRight: Class<framework$FlowDirection__LeftToRight> & framework$FlowDirection__LeftToRight & 0;// 0
static +RightToLeft: Class<framework$FlowDirection__RightToLeft> & framework$FlowDirection__RightToLeft & 1;// 1

}

declare class framework$FlowDirection__LeftToRight mixins framework$FlowDirection {}
declare class framework$FlowDirection__RightToLeft mixins framework$FlowDirection {}
...
declare  class framework$LabelWriterPrintQuality {
  constructor(...args: empty): mixed;
static +Text: Class<framework$LabelWriterPrintQuality__Text> & framework$LabelWriterPrintQuality__Text & 0;// 0
static +BarcodeAndGraphics: Class<framework$LabelWriterPrintQuality__BarcodeAndGraphics> & framework$LabelWriterPrintQuality__BarcodeAndGraphics & 1;// 1
static +Auto: Class<framework$LabelWriterPrintQuality__Auto> & framework$LabelWriterPrintQuality__Auto & 2;// 2

}

declare class framework$LabelWriterPrintQuality__Text mixins framework$LabelWriterPrintQuality {}
declare class framework$LabelWriterPrintQuality__BarcodeAndGraphics mixins framework$LabelWriterPrintQuality {}
declare class framework$LabelWriterPrintQuality__Auto mixins framework$LabelWriterPrintQuality {}
...
declare  class framework$PrintJobStatus {
  constructor(...args: empty): mixed;
static +Error: Class<framework$PrintJobStatus__Error> & framework$PrintJobStatus__Error & 0;// 0
static +Finished: Class<framework$PrintJobStatus__Finished> & framework$PrintJobStatus__Finished & 1;// 1
static +InQueue: Class<framework$PrintJobStatus__InQueue> & framework$PrintJobStatus__InQueue & 2;// 2
static +InvalidJobId: Class<framework$PrintJobStatus__InvalidJobId> & framework$PrintJobStatus__InvalidJobId & 3;// 3
static +NotSpooled: Class<framework$PrintJobStatus__NotSpooled> & framework$PrintJobStatus__NotSpooled & 4;// 4
static +PaperOut: Class<framework$PrintJobStatus__PaperOut> & framework$PrintJobStatus__PaperOut & 5;// 5
static +PrinterBusy: Class<framework$PrintJobStatus__PrinterBusy> & framework$PrintJobStatus__PrinterBusy & 6;// 6
static +Printing: Class<framework$PrintJobStatus__Printing> & framework$PrintJobStatus__Printing & 7;// 7
static +ProcessingError: Class<framework$PrintJobStatus__ProcessingError> & framework$PrintJobStatus__ProcessingError & 8;// 8
static +Unknown: Class<framework$PrintJobStatus__Unknown> & framework$PrintJobStatus__Unknown & 9;// 9

}

declare class framework$PrintJobStatus__Error mixins framework$PrintJobStatus {}
declare class framework$PrintJobStatus__Finished mixins framework$PrintJobStatus {}
declare class framework$PrintJobStatus__InQueue mixins framework$PrintJobStatus {}
declare class framework$PrintJobStatus__InvalidJobId mixins framework$PrintJobStatus {}
declare class framework$PrintJobStatus__NotSpooled mixins framework$PrintJobStatus {}
declare class framework$PrintJobStatus__PaperOut mixins framework$PrintJobStatus {}
declare class framework$PrintJobStatus__PrinterBusy mixins framework$PrintJobStatus {}
declare class framework$PrintJobStatus__Printing mixins framework$PrintJobStatus {}
declare class framework$PrintJobStatus__ProcessingError mixins framework$PrintJobStatus {}
declare class framework$PrintJobStatus__Unknown mixins framework$PrintJobStatus {}
...
declare  class framework$TapeAlignment {
  constructor(...args: empty): mixed;
static +Center: Class<framework$TapeAlignment__Center> & framework$TapeAlignment__Center & 0;// 0
static +Left: Class<framework$TapeAlignment__Left> & framework$TapeAlignment__Left & 1;// 1
static +Right: Class<framework$TapeAlignment__Right> & framework$TapeAlignment__Right & 2;// 2

}

declare class framework$TapeAlignment__Center mixins framework$TapeAlignment {}
...
declare  class framework$TapeCutMode {
  constructor(...args: empty): mixed;
static +AutoCut: Class<framework$TapeCutMode__AutoCut> & framework$TapeCutMode__AutoCut & 0;// 0
static +ChainMarks: Class<framework$TapeCutMode__ChainMarks> & framework$TapeCutMode__ChainMarks & 1;// 1

}

declare class framework$TapeCutMode__AutoCut mixins framework$TapeCutMode {}
declare class framework$TapeCutMode__ChainMarks mixins framework$TapeCutMode {}
...
declare  class framework$TwinTurboRoll {
  constructor(...args: empty): mixed;
static +Left: Class<framework$TwinTurboRoll__Left> & framework$TwinTurboRoll__Left & 0;// 0
static +Right: Class<framework$TwinTurboRoll__Right> & framework$TwinTurboRoll__Right & 1;// 1
static +Auto: Class<framework$TwinTurboRoll__Auto> & framework$TwinTurboRoll__Auto & 2;// 2
 ...
 */
declare function framework$createLabelRenderParamsXml(params: framework$CreateLabelRenderParamsXmlParams): string
...
(not all properties must be defined; if a property is not defined, a default value is used)
 */
declare function framework$createLabelWriterPrintParamsXml(params: framework$CreateLabelWriterPrintParamsXmlParams): string
...
(not all properties must be defined; if a property is not defined, a default value is used)
 */
declare function framework$createTapePrintParamsXml(params: framework$CreateTapePrintParamsXmlParams): string
 ...
 */
getStatus(replyCallback: (printJobStatusInfo: framework$PrintJobStatusInfo) => any): void
} 
 ...
 */
getAddressBarcodePosition(addressIndex: number): framework$AddressBarcodePosition,
...
printJobStatusInfo: framework$PrintJobStatusInfo) => boolean,
pollInterval: number): framework$PrintJob,
...
addressIndex: number,
barcodePosition: framework$AddressBarcodePosition): framework$ILabel,
 ...
 * @returns self
 */
setBase64Image(objectName: string, base64Image: string): framework$ILabelSetRecord,
 ...
 * @returns self
 */
setTextMarkup(objectName: string, textMarkup: string): framework$ILabelSetRecord
} 
...
printParamsXml: string,
labelXml: string,
labelSetXml: string): framework$PrintJob
 ...
 */
declare function framework$renderLabel(labelXml: string, renderParamsXml: string, printerName: string): string
...
errorCallback?: framework$AddPrinterUriCallback): void
