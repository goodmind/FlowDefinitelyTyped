...
declare interface hapiAuthJwt2$Options {
  ...
  validate(
    ...
    request: Request,
    tk: ResponseToolkit
  ): hapiAuthJwt2$ValidationResult | Promise<hapiAuthJwt2$ValidationResult>;
...
declare module "hapi" {
  declare interface ServerAuth {
    strategy(
      name: string,
      scheme: "jwt",
      options?: hapiAuthJwt2$hapiAuthJwt2$Options
    ): void;
  }
}
declare module "hapi-auth-jwt2" {
  import type { Request, ResponseObject, Plugin, ResponseToolkit } from "hapi";
