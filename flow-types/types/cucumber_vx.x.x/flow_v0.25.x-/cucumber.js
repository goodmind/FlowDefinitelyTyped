declare module "cucumber" {
  declare export class Status {
    ...
    static +AMBIGUOUS: Class<Status__AMBIGUOUS> &
      Status__AMBIGUOUS &
      "ambiguous"; // "ambiguous"
    ...
    static +UNDEFINED: Class<Status__UNDEFINED> &
      Status__UNDEFINED &
      "undefined"; // "undefined"
  }
  ...
  declare export function AfterAll(
    options: HookOptions | string,
    code: GlobalHookCode
  ): void;
  ...
  declare export function BeforeAll(
    options: HookOptions | string,
    code: GlobalHookCode
  ): void;
  ...
  declare export function setDefinitionFunctionWrapper(
    fn: () => void,
    options?: {
      [key: string]: any
    }
  ...
  declare export type HookCode = (
    scenario: HookScenarioResult,
    callback?: CallbackStepDefinition
  ) => void;
  declare export type GlobalHookCode = (
    callback?: CallbackStepDefinition
  ) => void;
  ...
  declare export type SupportCodeConsumer = (
    stepDefinitions: StepDefinitions & Hooks
  ) => void;
  declare export function defineSupportCode(
    consumer: SupportCodeConsumer
  ): void;
