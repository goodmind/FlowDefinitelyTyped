...
compareValues?: $ElementType<IntervalConstructor<T>, "compareValues">): IntervalConstructor<T>

	declare export interface IntervalConstructor<T> {
...
singleton(value: T): Interval<T>
	...
	declare export interface Interval<T> {
function Object() { [native code] }: IntervalConstructor,
empty: boolean,
from: Endpoint<T>,
to: Endpoint<T>,
...
toComparator(a: Endpoint<T>, b: Endpoint<T>): number
	...
	declare export interface Endpoint<T> {
finite: boolean,
inclusive: boolean,
value: T
} 
