declare module 'promise-queue' {
        declare module.exports: typeof PromiseQueue
 ...
 */
constructor(maxPendingPromises?: number, maxQueuedPromises?: number, options?: PromiseQueue$PromiseQueue$QueueOptions): this;
...
static configure(GlobalPromise: PromiseConstructor): void
	...
	declare interface PromiseQueue$QueueOptions {
