...
declare function assert$fail(actual?: any, expected?: any, message?: string, operator?: string): void


declare function assert$ok(value: any, message?: string): void


declare function assert$equal(actual: any, expected: any, message?: string): void


declare function assert$notEqual(actual: any, expected: any, message?: string): void


declare function assert$deepEqual(actual: any, expected: any, message?: string): void


declare function assert$notDeepEqual(acutal: any, expected: any, message?: string): void


declare function assert$strictEqual(actual: any, expected: any, message?: string): void


declare function assert$notStrictEqual(actual: any, expected: any, message?: string): void
...
declare function assert$doesNotThrow(block: () => void, message?: string): void
