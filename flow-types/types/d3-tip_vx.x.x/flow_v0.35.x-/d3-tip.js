declare module 'd3-tip' {
	...
	declare module 'd3' {
        declare type TooltipDirection = ("n"
| "s"
| "e"
| "w"
| "nw"
...
attr<Datum>(
name: string,
value: (datum: Datum, index: number, outerIndex: number) => Primitive): Tooltip,
attr<Datum>(
obj: {
...
offset<Datum>(
func: (datum: Datum, index: number, outerIndex: number) => [number, number]): Tooltip,
direction(): TooltipDirection,
direction(direction: TooltipDirection): Tooltip,
direction<Datum>(
func: (datum: Datum, index: number, outerIndex: number) => TooltipDirection): Tooltip,
html(): string,
html(content: string): Tooltip,
html<Datum>(
func: (datum: Datum, index: number, outerIndex: number) => string): Tooltip,
rootElement(): HTMLElement,
rootElement(element: HTMLElement): Tooltip,
rootElement<Datum>(
func: (datum: Datum, index: number, outerIndex: number) => HTMLElement): Tooltip,
destroy(): Tooltip
} 
