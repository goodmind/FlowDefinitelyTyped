declare module "parse5-html-rewriting-stream" {
  import typeof * as parse5 from "parse5-sax-parser";
   ...
   */
  declare export default class RewritingStream mixins stream.Transform {
    ...
    on(
      type: "endTag",
      callback: (endTag: parse5.EndTagToken, rawHtml: string) => void
    ): this;
    ...
    on(
      type: "comment",
      callback: (comment: parse5.CommentToken, rawHtml: string) => void
    ): this;
    ...
    on(
      type: "text",
      callback: (text: parse5.TextToken, rawHtml: string) => void
    ): this;
    ...
    on(
      type: "doctype",
      callback: (doctype: parse5.DoctypeToken, rawHtml: string) => void
    ): this;
