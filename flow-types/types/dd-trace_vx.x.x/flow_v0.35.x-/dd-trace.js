 ...
 */
use<P: Plugin>(plugin: P, config: $ElementType<PluginConfiguration, P>): this;
...
splitByDomain?: boolean
	...
	declare type PluginConfiguration = $ObjMapi<{[k: Plugin]: any}, <K>(K) => BasePluginOptions> & {
