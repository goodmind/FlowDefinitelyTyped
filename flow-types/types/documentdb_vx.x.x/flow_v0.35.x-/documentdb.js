 ...
 */
declare export type FeedOptions = {
...
populateQuotaInfo?: boolean
	...
	declare export type DocumentOptions = {
 ...
 */
declare export interface SqlParameter {
 ...
 */
declare export interface SqlQuerySpec {
 ...
 */
declare export interface QueryError {
 ...
 */
declare export type RequestCallback<TResult> = (error: QueryError, resource: TResult, responseHeaders: any) => void;
	
/**
 * Reprents an object with a unique identifier.
 */
declare export interface UniqueId {
 ...
 */
declare export type AbstractMeta = {
 ...
 */
declare export type NewDocument = {
 ...
 */
declare export type RetrievedDocument = {} & NewDocument & AbstractMeta

	
/**
 * Represents the meta data for a database.
 */
declare export type DatabaseMeta = {} & AbstractMeta

	
/**
 * Represents the meta data for a collection.
 */
declare export type CollectionMeta = {} & Collection & AbstractMeta

	
/**
 * Represents the meta data for a stored procedure.
 */
declare export type ProcedureMeta = {
body: string
} & AbstractMeta
 ...
 */
declare export type UserDefinedFunctionMeta = {} & AbstractMeta

	
/**
 * Represents the meta data for a trigger.
 */
declare export type TriggerMeta = {
body: string,
triggerType: string,
 ...
 */
declare export type UserFunction = ((...params: any[]) => void) | string;
	declare export type UserScriptable = {
 ...
 */
declare export type Procedure = {} & UserScriptable

	
/**
 * Represents a DocumentDB user-defined function.
 */
declare export type UserDefinedFunction = {
...
[name: string]: any
	...
	declare export type AttachmentMeta = {} & Attachment & AbstractMeta
...
resource: string
	...
	declare export type PermissionMeta = {} & Permission & AbstractMeta

	
/**
 * The Indexing Policy represents the indexing policy configuration for a collection.
 */
declare export interface IndexingPolicy {
...
ExcludedPaths: ExcludedPath[]
	...
	declare export interface ExcludedPath {
Path: string
} 
	declare export interface IncludedPath {
 ...
 * ConnectionPolicy
 */
declare export interface ConnectionPolicy {
...
MaxWaitTimeInSeconds?: number
	...
	declare export type MediaOptions = {
...
contentType?: string
	...
	declare export type DatabaseAccountRequestOptions = {
...
urlConnection?: string
	...
	declare export interface DatabaseAccount {
...
ReadableLocations: string[]
	...
	declare export interface ConsistencyPolicy {
defaultConsistencyLevel: ConsistencyLevel,
maxStalenessPrefix: number,
maxStalenessIntervalInSeconds: number
} 
	declare export interface RangeOptions {
...
high: any
	...
	declare export interface PartitionKeyMap {
link: string,
range: Range
} 
	declare export interface CollectionPartitionKey {
...
kind: PartitionKind
	...
	declare export type DocumentQuery = SqlQuerySpec | string;
 ...
 * @deprecated
 */
declare export interface PartitionResolver {
 ...
 * @deprecated
 */
declare export interface ConsistentHashRingOptions {
 ...
 */
declare export class QueryIterator<TResultRow>  {
 ...
 */
constructor(documentclient: DocumentClient, query: DocumentQuery, options: FeedOptions, fetchFunctions: RequestCallback<TResultRow> | Array<RequestCallback<TResultRow>>, resourceLinkopt?: string): this;
 ...
 */
constructor(partitionKeyExtractor: string | ((obj: any) => any), collectionLinks: string[], options?: ConsistentHashRingOptions): this;
 ...
 */
constructor(options: RangeOptions): this
}
 ...
 */
constructor(partitionKeyExtractor: string | ((obj: any) => any), partitionKeyMap: PartitionKeyMap[], compareFunction?: (a: any, b: any) => number): this;
 ...
 */
constructor(urlConnection: string, auth: AuthOptions, connectionPolicy?: ConnectionPolicy, consistencyLevel?: ConsistencyLevel): this;
...
callback: RequestCallback<AttachmentMeta>): void;
createAttachment(
documentLink: string,
body: Attachment,
callback: RequestCallback<AttachmentMeta>): void;
...
options: RequestOptions,
callback: RequestCallback<UserDefinedFunctionMeta>): void;
createUserDefinedFunction(
collectionLink: string,
udf: UserDefinedFunction,
callback: RequestCallback<UserDefinedFunctionMeta>): void;
...
callback: RequestCallback<RetrievedDocument>): void;
createDocument<TDocument>(
documentsFeedOrDatabaseLink: string,
document: NewDocument,
callback: RequestCallback<RetrievedDocument>): void;
...
body: Permission,
options: RequestOptions,
callback: RequestCallback<PermissionMeta>): void;
createPermission(
userLink: string,
body: Permission,
callback: RequestCallback<PermissionMeta>): void;
...
body: UniqueId,
options: RequestOptions,
callback: RequestCallback<AbstractMeta>): void;
createUser(
databaseLink: string,
body: UniqueId,
callback: RequestCallback<AbstractMeta>): void;
...
params: any[],
options: RequestOptions,
callback: RequestCallback<TResult>): void;
executeStoredProcedure<TResult>(
procedureLink: string,
...
databaseLink: string,
query: DocumentQuery,
options?: FeedOptions): QueryIterator<CollectionMeta>;
...
collectionLink: string,
query: DocumentQuery,
options?: FeedOptions): QueryIterator<ProcedureMeta>;
...
collectionLink: string,
query: DocumentQuery,
options?: FeedOptions): QueryIterator<UserDefinedFunctionMeta>;
...
documentLink: string,
query: DocumentQuery,
options?: FeedOptions): QueryIterator<T>;
...
collectionLink: string,
query: DocumentQuery,
options?: FeedOptions): QueryIterator<any>;
...
userLink: string,
query: DocumentQuery,
options?: FeedOptions): QueryIterator<PermissionMeta>;
...
databaseLink: string,
query: DocumentQuery,
options?: FeedOptions): QueryIterator<AbstractMeta>;
...
conflictLink: string,
options: RequestOptions,
callback: RequestCallback<any>): void;
...
readDocuments(
collectionLink: string,
options?: FeedOptions): QueryIterator<RetrievedDocument>;
...
readMedia(
mediaLink: string,
callback: RequestCallback<Buffer | NodeJS.ReadableStream>): void;
...
callback: RequestCallback<DatabaseAccount>): void;
...
getWriteEndpoint(callback: RequestCallback<string>): void
      ...
      declare var npm$namespace$UriFactory: {
        createDatabaseUri: typeof UriFactory$createDatabaseUri,
createDocumentCollectionUri: typeof UriFactory$createDocumentCollectionUri,
createDocumentUri: typeof UriFactory$createDocumentUri,
createPermissionUri: typeof UriFactory$createPermissionUri,
createStoredProcedureUri: typeof UriFactory$createStoredProcedureUri,
createTriggerUri: typeof UriFactory$createTriggerUri,
createUserDefinedFunctionUri: typeof UriFactory$createUserDefinedFunctionUri,
createConflictUri: typeof UriFactory$createConflictUri,
createAttachmentUri: typeof UriFactory$createAttachmentUri,
createPartitionKeyRangesUri: typeof UriFactory$createPartitionKeyRangesUri,
 ...
 */
declare function UriFactory$createDocumentCollectionUri(databaseId: string, collectionId: string): string
 ...
 */
declare function UriFactory$createDocumentUri(databaseId: string, collectionId: string, documentId: string): string
 ...
 */
declare function UriFactory$createPermissionUri(databaseId: string, userId: string, permissionId: string): string
 ...
 */
declare function UriFactory$createStoredProcedureUri(databaseId: string, collectionId: string, storedProcedureId: string): string
 ...
 */
declare function UriFactory$createTriggerUri(databaseId: string, collectionId: string, triggerId: string): string
 ...
 */
declare function UriFactory$createUserDefinedFunctionUri(databaseId: string, collectionId: string, udfId: string): string
 ...
 */
declare function UriFactory$createConflictUri(databaseId: string, collectionId: string, conflictId: string): string
 ...
 */
declare function UriFactory$createPartitionKeyRangesUri(databaseId: string, collectionId: string): string

	declare export type MediaReadMode = "Buffered" | "Streamed";
	declare export type ConsistencyLevel = "Strong" | "BoundedStaleness" | "Session" | "Eventual";
	declare export type IndexingMode = "Consistent" | "Lazy";
	declare export type IndexKind = "Hash" | "Range" | "Spatial";
	declare export type PermissionMode = "None" | "Read" | "All";
	declare export type TriggerType = "Pre" | "Post" | "pre" | "post";
	declare export type TriggerOperation = "All"
| "Create"
| "Update"
| "Delete"
| "Replace"
...
| "delete"
| "replace";
	declare export type UserDefinedFunctionType = "Javascript";
	declare export type PartitionKind = "Hash";
    }
