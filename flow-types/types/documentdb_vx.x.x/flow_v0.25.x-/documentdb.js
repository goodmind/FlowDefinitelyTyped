declare module "documentdb" {
   ...
   */
  declare export type RequestCallback<TResult> = (
    error: QueryError,
    resource: TResult,
    responseHeaders: any
  ) => void;
 ...
 */
   ...
   */
  declare function UriFactory$createPermissionUri(
    databaseId: string,
    userId: string,
    permissionId: string
  ): string;
 ...
 */
   ...
   */
  declare function UriFactory$createUserDefinedFunctionUri(
    databaseId: string,
    collectionId: string,
    udfId: string
  ): string;
 ...
 */
   ...
   */
  declare function UriFactory$createPartitionKeyRangesUri(
    databaseId: string,
    collectionId: string
  ): string;

  declare export type MediaReadMode = "Buffered" | "Streamed";
  declare export type ConsistencyLevel =
    | "Strong"
    | "BoundedStaleness"
    | "Session"
    | "Eventual";
  ...
  declare export type TriggerOperation =
    | "All"
    | "Create"
    | "Update"
    | "Delete"
