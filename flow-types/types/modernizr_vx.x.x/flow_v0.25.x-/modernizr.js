...
declare type CssColumnsBoolean = {
  breakafter: boolean,
  breakbefore: boolean,
  breakinside: boolean,
  fill: boolean,
...
declare type FlashBoolean = {
  blocked: boolean
} & Boolean;
declare type IndexeddbBoolean = {
  deletedatabase: boolean
} & Boolean;
declare type WebglextensionsBoolean = {
...
declare type WebpBoolean = {
  alpha: boolean,
  animation: boolean,
  lossless: boolean
} & Boolean;
declare type DatauriBoolean = {
  over32kb: boolean
} & Boolean;
...
declare type ModernizrStatic = {} & ModernizrAPI & FeatureDetects;
declare var Modernizr: ModernizrStatic;
declare module "modernizr" {
  declare module.exports: typeof Modernizr;
}
