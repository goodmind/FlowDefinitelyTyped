 ...
 */
onContext(
contextCallback: <T: $Shape<TwitchExtContext>>(
context: T,
changed: $ReadOnlyArray<$Keys<T>>) => void): void,
 ...
 */
onPositionChanged(callback: (position: {
x: number,
y: number
}) => void): void,
 ...
 */
onVisibilityChanged(
callback: ((isVisible: false) => void) | ((isVisible: true, context: $Shape<TwitchExtContext>) => void)): void,
...
target: string,
contentType: string,
message: {[key: string]: any} | string): void,
...
listen(
target: string,
callback: (target: string, contentType: string, message: string) => void): void,
 ...
 */
declare interface TwitchExtActions {
...
requestIdShare(): void
	...
	declare interface TwitchExtFeatureFlags {
 ...
 */
declare type TwitchExtFeatures = {
 ...
 */
onChanged(
callback: (changed: $ReadOnlyArray<$Keys<TwitchExtFeatureFlags>>) => void): void
} & TwitchExtFeatureFlags

	declare interface TwitchExtBitsProductCost {
...
type: "bits"
	...
	declare interface TwitchExtBitsProduct {
...
sku: string
	...
	declare interface TwitchExtBitsTransaction {
 ...
 * @see TwitchExt.bits
 */
declare interface TwitchExtBits {
 ...
 * @see TwitchExt.rig
 */
declare interface TwitchExtRig {
 ...
 */
declare interface TwitchExtAuthorized {
 ...
 */
declare interface TwitchExtContext {
 ...
 */
declare interface TwitchExtClientQueryParams {
