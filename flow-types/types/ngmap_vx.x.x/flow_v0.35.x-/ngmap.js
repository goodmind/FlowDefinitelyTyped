 ...
 */
getMap(options?: map$IGetMapOptions): ng.IPromise<google.maps.Map>,
 ...
 */
observeAndSet(attrName: string, object: Object): map$IObserveAndSetFunc,
 ...
 */
setDefaultOptions(options: map$INgMapOptions): void
} 