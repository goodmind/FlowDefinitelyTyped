declare module 'facebook-instant-games' {
        
      declare var npm$namespace$FBInstant: {
        getLocale: typeof FBInstant$getLocale,
getPlatform: typeof FBInstant$getPlatform,
getSDKVersion: typeof FBInstant$getSDKVersion,
initializeAsync: typeof FBInstant$initializeAsync,
setLoadingProgress: typeof FBInstant$setLoadingProgress,
getSupportedAPIs: typeof FBInstant$getSupportedAPIs,
getEntryPointData: typeof FBInstant$getEntryPointData,
getEntryPointAsync: typeof FBInstant$getEntryPointAsync,
setSessionData: typeof FBInstant$setSessionData,
startGameAsync: typeof FBInstant$startGameAsync,
shareAsync: typeof FBInstant$shareAsync,
updateAsync: typeof FBInstant$updateAsync,
switchGameAsync: typeof FBInstant$switchGameAsync,
canCreateShortcutAsync: typeof FBInstant$canCreateShortcutAsync,
createShortcutAsync: typeof FBInstant$createShortcutAsync,
quit: typeof FBInstant$quit,
logEvent: typeof FBInstant$logEvent,
onPause: typeof FBInstant$onPause,
getInterstitialAdAsync: typeof FBInstant$getInterstitialAdAsync,
getRewardedVideoAsync: typeof FBInstant$getRewardedVideoAsync,
matchPlayerAsync: typeof FBInstant$matchPlayerAsync,
checkCanPlayerMatchAsync: typeof FBInstant$checkCanPlayerMatchAsync,
getLeaderboardAsync: typeof FBInstant$getLeaderboardAsync,
        player: typeof FBInstant$player,
context: typeof FBInstant$context,
payments: typeof FBInstant$payments,
      }

/**
 * Contains functions and properties related to the current player.
 */
declare var FBInstant$player: FBInstant$Player;


/**
 * Contains functions and properties related to the current game context.
 */
declare var FBInstant$context: FBInstant$Context;


/**
 * Contains functions and properties related to payments and purchases of game products.
 */
declare var FBInstant$payments: FBInstant$Payments;
 ...
 */
declare function FBInstant$getLocale(): string | null
 ...
 */
declare function FBInstant$getPlatform(): FBInstant$Platform | null
 ...
 */
declare function FBInstant$getSDKVersion(): string
 ...
 */
declare function FBInstant$initializeAsync(): Promise<void>
 ...
 */
declare function FBInstant$setLoadingProgress(percentage: number): void
 ...
 */
declare function FBInstant$getSupportedAPIs(): string[]
 ...
 */
declare function FBInstant$getEntryPointData(): any
 ...
 */
declare function FBInstant$getEntryPointAsync(): Promise<string>
 ...
 */
declare function FBInstant$setSessionData(sessionData: any): void
 ...
 */
declare function FBInstant$startGameAsync(): Promise<void>
 ...
 * @throws INVALID_OPERATION
 */
declare function FBInstant$shareAsync(payload: FBInstant$SharePayload): Promise<void>
 ...
 * @throws INVALID_OPERATION
 */
declare function FBInstant$updateAsync(
payload: FBInstant$CustomUpdatePayload | FBInstant$LeaderboardUpdatePayload): Promise<void>
 ...
 */
declare function FBInstant$switchGameAsync(appID: string, data?: any): Promise<void>
 ...
 * @throws INVALID_OPERATION
 */
declare function FBInstant$canCreateShortcutAsync(): Promise<boolean>
 ...
 * @throws INVALID_OPERATION
 */
declare function FBInstant$createShortcutAsync(): Promise<void>
 ...
 */
declare function FBInstant$onPause(func: () => void): void
 ...
 * @throws CLIENT_UNSUPPORTED_OPERATION
 */
declare function FBInstant$getInterstitialAdAsync(placementID: string): Promise<FBInstant$AdInstance>
 ...
 * @throws CLIENT_UNSUPPORTED_OPERATION
 */
declare function FBInstant$getRewardedVideoAsync(placementID: string): Promise<FBInstant$AdInstance>
 ...
 * @throws INVALID_OPERATION
 */
declare function FBInstant$matchPlayerAsync(matchTag?: string, switchContextWhenMatched?: boolean): Promise<void>
 ...
 * @throws CLIENT_UNSUPPORTED_OPERATION
 */
declare function FBInstant$checkCanPlayerMatchAsync(): Promise<boolean>
 ...
 * @throws INVALID_PARAM
 */
declare function FBInstant$getLeaderboardAsync(name: string): Promise<FBInstant$Leaderboard>


declare interface FBInstant$Player {
 ...
 * @throws CLIENT_UNSUPPORTED_OPERATION
 */
getSignedPlayerInfoAsync(requestPayload?: string): Promise<FBInstant$SignedPlayerInfo>,
 ...
 * @throws CLIENT_UNSUPPORTED_OPERATION
 */
incrementStatsAsync(increments: FBInstant$IncrementObject): Promise<FBInstant$StatsObject>,
 ...
 * @throws CLIENT_UNSUPPORTED_OPERATION
 */
getConnectedPlayersAsync(): Promise<FBInstant$ConnectedPlayer[]>
} 

declare interface FBInstant$Context {
 ...
 */
isSizeBetween(minSize?: number, maxSize?: number): FBInstant$ContextSizeResponse | null,
 ...
 * @throws CLIENT_UNSUPPORTED_OPERATION
 */
chooseAsync(options?: FBInstant$ContextOptions): Promise<void>,
 ...
 * @throws INVALID_OPERATION
 */
getPlayersAsync(): Promise<FBInstant$ContextPlayer[]>
} 
 ...
 */
declare interface FBInstant$Leaderboard {
 ...
 * @throws RATE_LIMITED
 */
setScoreAsync(score: number, extraData?: string): Promise<FBInstant$LeaderboardEntry>,
 ...
 * @throws RATE_LIMITED
 */
getPlayerEntryAsync(): Promise<FBInstant$LeaderboardEntry | null>,
 ...
 * @throws RATE_LIMITED
 */
getEntriesAsync(count: number, offset: number): Promise<FBInstant$LeaderboardEntry[]>,
 ...
 * @returns Resolves with the leaderboard entries that match the query.
 */
getConnectedPlayerEntriesAsync(count: number, offset: number): Promise<FBInstant$LeaderboardEntry[]>
} 
 ...
 */
declare interface FBInstant$LeaderboardEntry {
 ...
 */
getPlayer(): FBInstant$LeaderboardPlayer
} 
 ...
 */
declare interface FBInstant$LeaderboardPlayer {
 ...
 */
declare interface FBInstant$ConnectedPlayer {
 ...
 */
declare interface FBInstant$SignedPlayerInfo {
 ...
 */
declare interface FBInstant$ContextPlayer {
 ...
 */
declare interface FBInstant$AdInstance {
...
declare interface FBInstant$Payments {
 ...
 * @throws NETWORK_FAILURE
 */
getCatalogAsync(): Promise<FBInstant$Product[]>,
 ...
 * @throws INVALID_OPERATION
 */
purchaseAsync(purchaseConfig: FBInstant$PurchaseConfig): Promise<FBInstant$Purchase>,
 ...
 * @throws NETWORK_FAILURE
 */
getPurchasesAsync(): Promise<FBInstant$Purchase[]>,
 ...
 */
declare interface FBInstant$Product {
 ...
 */
declare interface FBInstant$ContextSizeResponse {
answer: boolean,
minSize?: number,
maxSize?: number
} 
 ...
 */
declare interface FBInstant$Purchase {
 ...
 */
signedRequest: FBInstant$SignedPurchaseRequest
} 

declare interface FBInstant$ContextOptions {

/**
 * The set of filters to apply to the context suggestions.
 */
filters?: FBInstant$ContextFilter[],
 ...
 */
declare interface FBInstant$SharePayload {

/**
 * Indicates the intent of the share.
 */
intent: FBInstant$Intent,
 ...
 */
declare interface FBInstant$APIError {

/**
 * The relevant error code
 */
code: FBInstant$ErrorCodeType,
 ...
 */
declare interface FBInstant$PurchaseConfig {
 ...
 */
declare interface FBInstant$CustomUpdatePayload {

/**
 * For custom updates, this should be 'CUSTOM'.
 */
action: FBInstant$UpdateAction,
 ...
 */
cta?: (string | FBInstant$LocalizableContent),
 ...
 */
text: (string | FBInstant$LocalizableContent),
 ...
 */
declare interface FBInstant$LeaderboardUpdatePayload {
 ...
 */
declare interface FBInstant$LocalizableContent {
 ...
 */
localizations: FBInstant$LocalizationsDict
} 

declare interface FBInstant$DataObject {
[key: string]: any
} 

declare interface FBInstant$StatsObject {
[key: string]: number
} 

declare interface FBInstant$IncrementObject {
[key: string]: number
} 
 ...
 */
declare interface FBInstant$LocalizationsDict {
[x: string]: string
} 

declare type FBInstant$SignedPurchaseRequest = string;
 ...
 */
declare type FBInstant$ContextFilter = "NEW_CONTEXT_ONLY" | "INCLUDE_EXISTING_CHALLENGES" | "NEW_PLAYERS_ONLY";
 ...
 */
declare type FBInstant$UpdateAction = "CUSTOM" | "LEADERBOARD";


/**
 * Represents the current platform that the user is playing on.
 */
declare type FBInstant$Platform = "IOS" | "ANDROID" | "WEB" | "MOBILE_WEB";

declare type FBInstant$Type = "POST" | "THREAD" | "GROUP" | "SOLO";

declare type FBInstant$Intent = "INVITE" | "REQUEST" | "CHALLENGE" | "SHARE";

declare type FBInstant$ErrorCodeType = "ADS_FREQUENT_LOAD"
| "ADS_NO_FILL"
| "ADS_NOT_LOADED"
