declare module "facebook-instant-games" {
   ...
   * @throws INVALID_OPERATION
   */
  declare function FBInstant$shareAsync(
    payload: FBInstant$SharePayload
  ): Promise<void>;
  ...
  declare function FBInstant$updateAsync(
    payload: FBInstant$CustomUpdatePayload | FBInstant$LeaderboardUpdatePayload
  ): Promise<void>;
   ...
   * @throws CLIENT_UNSUPPORTED_OPERATION
   */
  declare function FBInstant$getInterstitialAdAsync(
    placementID: string
   ...
   * @throws CLIENT_UNSUPPORTED_OPERATION
   */
  declare function FBInstant$getRewardedVideoAsync(
    placementID: string
  ): Promise<FBInstant$AdInstance>;
   ...
   * @throws INVALID_PARAM
   */
  declare function FBInstant$getLeaderboardAsync(
    name: string
  ): Promise<FBInstant$Leaderboard>;
  ...
  declare interface FBInstant$Player {
    ...
    ): Promise<FBInstant$SignedPlayerInfo>;
  ...
  declare interface FBInstant$Context {
    ...
    isSizeBetween(
      minSize?: number,
      maxSize?: number
    ): FBInstant$ContextSizeResponse | null;
  ...
  declare interface FBInstant$Leaderboard {
    ...
    setScoreAsync(
      score: number,
      extraData?: string
    ): Promise<FBInstant$LeaderboardEntry>;
  ...
  declare interface FBInstant$Payments {
     ...
     */
    purchaseAsync(
      purchaseConfig: FBInstant$PurchaseConfig
    ): Promise<FBInstant$Purchase>;
   ...
   */
  declare type FBInstant$ContextFilter =
    | "NEW_CONTEXT_ONLY"
  ...
  declare type FBInstant$ErrorCodeType =
    | "ADS_FREQUENT_LOAD"
    | "ADS_NO_FILL"
    | "ADS_NOT_LOADED"
