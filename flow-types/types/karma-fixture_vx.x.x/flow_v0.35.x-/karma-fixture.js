...
declare function fixture$load(file1: string, file2: string, append?: boolean): any


declare function fixture$load(file1: string, file2: string, file3: string, append?: boolean): any
...
declare function fixture$set(...htmlStrs: string[]): HTMLElement | HTMLElement[]


declare function fixture$set(htmlStr1: string, append?: boolean): HTMLElement | HTMLElement[]


declare function fixture$set(
htmlStr1: string,
htmlStr2: string,
append?: boolean): HTMLElement | HTMLElement[]
