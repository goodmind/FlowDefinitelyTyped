declare module 'raygun4js' {
        declare interface TracekitStackTrace {
message: string,
mode: string,
name: string,
stack: TracekitStack[],
...
useragent: string
	...
	declare interface TracekitStack {
column: number,
context: any,
func: string,
line: number,
url: string
	...
	declare interface RaygunStackTrace {
LineNumber: number,
ColumnNumber: number,
ClassName: string,
FileName: string,
MethodName: string
	...
	declare interface RaygunOptions {
...
from?: string | "onLoad"
	...
	declare interface RaygunPayload {
OccurredOn: Date,
Details: {
Error: {
ClassName: string,
...
options: any) => string | void): RaygunStatic,
 ...
 */
trackEvent(type: "pageView", options: {
path: string
}): void,
...
| "error"): void
	...
	declare interface RaygunV2UserDetails {
...
uuid?: string
	...
	declare type BreadcrumbLevel = "debug" | "error" | "warning" | "info";
	declare interface RaygunV2 {
...
(key: "groupingKey", value: (
payload: RaygunPayload,
stackTrace: TracekitStackTrace,
options: any) => string | void): void,
...
| "enablePulse"
| "noConflict"
| "saveIfOffline", value: boolean): void,
...
| "setAutoBreadcrumbsXHRIgnoredHosts"): void,
(key: "setBreadcrumbLevel", level: BreadcrumbLevel): void,
(key: "recordBreadcrumb", message: string | {
message: string,
metadata: any,
level: BreadcrumbLevel,
location: string
}, metadata: {[key: string]: any}): void
} 
...
Raygun: RaygunStatic
	...
	declare export {
          RaygunStatic,RaygunV2
        }

	declare export default typeof rg4js
