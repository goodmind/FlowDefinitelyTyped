declare module 'react-autocomplete' {
        import type {
          Component,ChangeEvent,ReactNode,CSSProperties,HTMLProps
        } from 'react';
 ...
 */
renderMenu?: (items: any[], value: string, styles: CSSProperties) => ReactNode,
...
declare interface Autocomplete$State {
...
menuWidth?: number
	...
	declare class Autocomplete mixins Component<Autocomplete$Autocomplete$Props, Autocomplete$Autocomplete$State> {
