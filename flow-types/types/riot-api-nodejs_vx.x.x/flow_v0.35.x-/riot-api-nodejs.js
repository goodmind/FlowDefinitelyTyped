declare module 'riot-api-nodejs' {
	...
	declare export  class region_e {
  constructor(...args: empty): mixed;
static +BR: Class<region_e__BR> & region_e__BR & 0;// 0
static +EUNE: Class<region_e__EUNE> & region_e__EUNE & 1;// 1
static +EUW: Class<region_e__EUW> & region_e__EUW & 2;// 2
static +KR: Class<region_e__KR> & region_e__KR & 3;// 3
static +LAN: Class<region_e__LAN> & region_e__LAN & 4;// 4
static +LAS: Class<region_e__LAS> & region_e__LAS & 5;// 5
static +NA: Class<region_e__NA> & region_e__NA & 6;// 6
static +OCE: Class<region_e__OCE> & region_e__OCE & 7;// 7
static +TR: Class<region_e__TR> & region_e__TR & 8;// 8
static +RU: Class<region_e__RU> & region_e__RU & 9;// 9
static +PBE: Class<region_e__PBE> & region_e__PBE & 10;// 10

}

declare class region_e__BR mixins region_e {}
declare class region_e__EUNE mixins region_e {}
declare class region_e__EUW mixins region_e {}
declare class region_e__KR mixins region_e {}
declare class region_e__LAN mixins region_e {}
declare class region_e__LAS mixins region_e {}
declare class region_e__NA mixins region_e {}
declare class region_e__OCE mixins region_e {}
declare class region_e__TR mixins region_e {}
declare class region_e__RU mixins region_e {}
declare class region_e__PBE mixins region_e {}
...
tournamentId: number,
count: number,
params: RiotGamesAPI.TournamentProvider.TournamentCodeParameters): Promise<number[]>;
 ...
 */
getTournamentByCode(
tournamentCode: string): Promise<RiotGamesAPI.TournamentProvider.TournamentCodeDto>;
...
params: RiotGamesAPI.TournamentProvider.TournamentCodeUpdateParameters): Promise<() => void>;
...
getChampionMastery(
summonerId: number,
championId: number): Promise<RiotGamesAPI.ChampionMastery.ChampionMasteryDto>;
