 ...
 */
declare function client$load(name: "adexchangebuyer", version: "v1.4"): PromiseLike<void>


declare function client$load(name: "adexchangebuyer", version: "v1.4", callback: () => any): void
