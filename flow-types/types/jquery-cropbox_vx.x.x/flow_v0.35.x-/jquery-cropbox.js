...
static +never: Class<jQueryCropBox$ShowControls__never> & jQueryCropBox$ShowControls__never & 0;// 0
static +always: Class<jQueryCropBox$ShowControls__always> & jQueryCropBox$ShowControls__always & 1;// 1
static +hover: Class<jQueryCropBox$ShowControls__hover> & jQueryCropBox$ShowControls__hover & 2;// 2
static +auto: Class<jQueryCropBox$ShowControls__auto> & jQueryCropBox$ShowControls__auto & 3;// 3

}

declare class jQueryCropBox$ShowControls__never mixins jQueryCropBox$ShowControls {}
declare class jQueryCropBox$ShowControls__always mixins jQueryCropBox$ShowControls {}
declare class jQueryCropBox$ShowControls__hover mixins jQueryCropBox$ShowControls {}
declare class jQueryCropBox$ShowControls__auto mixins jQueryCropBox$ShowControls {}
 ...
 */
on(event: string, callback: jQueryCropBox$jQueryCropBox$EventCallback): void
} 

declare type jQueryCropBox$EventCallback = (e: Event, data: any, img: jQueryCropBox$jQueryCropBox$Cropbox) => void;
	declare interface JQuery {
cropbox(
params?: jQueryCropBox$jQueryCropBox$CropboxOptions): jQueryCropBox$jQueryCropBox$Cropbox
} 
