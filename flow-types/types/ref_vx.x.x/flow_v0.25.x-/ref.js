declare module "ref" {
   ...
   */
  declare export function allocCString(
    string: string,
    encoding?: string
  ): Buffer;
   ...
   */
  declare export function readPointer(
    buffer: Buffer,
    offset?: number,
    length?: number
  ): Buffer;
   ...
   */
  declare export function reinterpret(
    buffer: Buffer,
    size: number,
    offset?: number
  ): Buffer;
   ...
   */
  declare export function reinterpretUntilZeros(
    buffer: Buffer,
    size: number,
    offset?: number
  ): Buffer;
   ...
   */
  declare export function writeCString(
    buffer: Buffer,
    offset: number,
    string: string,
    encoding?: string
   ...
   */
  declare export function writeInt64BE(
    buffer: Buffer,
    offset: number,
    input: number
  ): void;
   ...
   */
  declare export function writeInt64LE(
    buffer: Buffer,
    offset: number,
    input: number
  ): void;
   ...
   */
  declare export function writeObject(
    buffer: Buffer,
    offset: number,
    object: Object
  ): void;
   ...
   */
  declare export function writePointer(
    buffer: Buffer,
    offset: number,
    pointer: Buffer
  ): void;
   ...
   */
  declare export function writeUInt64BE(
    buffer: Buffer,
    offset: number,
    input: number
  ): void;
   ...
   */
  declare export function _reinterpret(
    buffer: Buffer,
    size: number,
    offset?: number
  ): Buffer;
   ...
   */
  declare export function _reinterpretUntilZeros(
    buffer: Buffer,
    size: number,
    offset?: number
  ): Buffer;
   ...
   */
  declare export function _writePointer(
    buffer: Buffer,
    offset: number,
    pointer: Buffer
  ): void;
   ...
   */
  declare export function _writeObject(
    buffer: Buffer,
    offset: number,
    object: Object
  ): void;
