declare module "d3-brush" {
     ...
     */
    declare export type BrushSelection =
     ...
     */
    declare export interface BrushBehavior<Datum> {
        /**
 ...
 */
        on(typenames: string): ValueFn<SVGGElement, Datum, void> | void;
 ...
 */
        on(
            typenames: string,
            listener: ValueFn<SVGGElement, Datum, void>
        ): this;
    }
     ...
     */
    declare export function brush<Datum>(): BrushBehavior<Datum>;
     ...
     * which the returned BrushBehavior will be applied.
     */
    declare export function brushX<Datum>(): BrushBehavior<Datum>;
     ...
     * which the returned BrushBehavior will be applied.
     */
    declare export function brushY<Datum>(): BrushBehavior<Datum>;
     ...
     */
    declare export function brushSelection(
        node: SVGGElement
    ): BrushSelection | null;
     ...
     */
    declare export interface D3BrushEvent<Datum> {
        /**
