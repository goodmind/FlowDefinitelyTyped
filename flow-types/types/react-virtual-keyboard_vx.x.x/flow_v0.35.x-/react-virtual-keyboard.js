declare module 'react-virtual-keyboard' {
	...
	import type {
          KeyboardOptions,NavigateOptions
...
accepted?: void
	...
	declare export type kbEvents = (event?: string | Event, keyboard?: Element, el?: Element) => void;
...
className: string
	...
	declare export default class Keyboard mixins Component<KeyboardProps, KeyboardState> {}
    }
