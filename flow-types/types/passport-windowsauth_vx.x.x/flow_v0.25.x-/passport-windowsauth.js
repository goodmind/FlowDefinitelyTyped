declare module "passport-windowsauth" {
  ...
  declare type windowsauth$Verify = (
    profile: passport.Profile,
    done: windowsauth$Verified
  ) => void;
  ...
  declare class windowsauth mixins passport.Strategy {
    constructor(
      options: windowsauth$windowsauth$Options & {
        passReqToCallback: true
      },
      verify: windowsauth$windowsauth$VerifyWithReq
    ): this;
    constructor(
      options: windowsauth$windowsauth$Options,
      verify: windowsauth$windowsauth$Verify
    ): this;
