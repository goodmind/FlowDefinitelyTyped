...
_: BlissNS$BlissNS$BlissBindedArray<T> & BlissNS$BlissNS$BlissCollectionArray<T>
} 
	declare export type BlissNS$BlissDecoratedElement<T> = Element & T;

declare export type BlissNS$BlissDecoratedArrayElement<T> = Array<T> & BlissNS$BlissNS$BlissCollectionArray<T>;
