declare module "blissfuljs" {
  declare interface Element {
    _: BlissNS$BlissNS$BlissBindedElement<Element>;
  }
  declare interface Array<T> {
    _: BlissNS$BlissNS$BlissBindedArray<T> &
      BlissNS$BlissNS$BlissCollectionArray<T>;
  }
  declare export type BlissNS$BlissDecoratedElement<T> = Element & T;

  declare export type BlissNS$BlissDecoratedArrayElement<T> = Array<T> &
    BlissNS$BlissNS$BlissCollectionArray<T>;

  declare interface BlissNS$BlissStatic {
    <T>(selector: string, context?: Element): BlissNS$BlissDecoratedElement<T>;
    classProps: Object;
  ...
  declare interface BlissNS$BlissNativeExtentions<T> {
    ...
    addEventListener(
      type: "ariarequest",
      listener: (ev: BlissNS$AriaRequestEvent) => any,
      useCapture?: boolean
    ): T;
    addEventListener(
      type: "beforeactivate",
    ...
    addEventListener(
      type: "command",
      listener: (ev: BlissNS$CommandEvent) => any,
      useCapture?: boolean
    ): T;
    addEventListener(
      type: "contextmenu",
  ...
  } & BlissNS$BlissNativeExtentions<T>;
  ...
  declare var Bliss: BlissNS$BlissNS$BlissStatic;
  declare var $: BlissNS$BlissNS$BlissStatic;
  declare var $$: BlissNS$BlissNS$BlissStaticCollection;
}
