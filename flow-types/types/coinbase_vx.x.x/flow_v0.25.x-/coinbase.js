declare module "coinbase" {
  declare export interface ClientConstructOpts {
    /**
  ...
  declare export interface CreateAccountOpts {
    /**
     * Account name
     */
    name?: string;
  }
  declare export interface GetExchangeRateOpts {
    /**
     * Base currency, default USD
     */
    currency?: string;
  }
  declare export interface GetBuyPriceOpts {
    /**
     * Currency pair, e.g. 'BTC-USD'
     */
    currencyPair: string;
  }
  declare export interface GetSellPriceOpts {
    /**
     * Currency pair, e.g. 'BTC-USD'
     */
    currencyPair: string;
  }
  declare export interface GetSpotPriceOpts {
    /**
     * Currency pair, e.g. 'BTC-USD'
     */
    currencyPair: string;
  ...
  declare export interface UpdateAccountOpts {
    /**
     * Account name
     */
    name?: string;
  }
  declare export interface CreateAddressOpts {
    /**
     * Address label
     */
    name?: string;
  }
  declare export interface SendMoneyOpts {
    /**
  ...
  declare export interface TransferMoneyOpts {
    /**
  ...
  declare export interface RequestMoneyOpts {
    /**
  ...
  declare export interface UpdateUserOpts {
    /**
     * User’s name
     */
    name?: string;
  ...
  declare export interface BuyOpts {
    /**
  ...
  declare export interface SellOpts {
    /**
  ...
  declare export interface DepositOpts {
    /**
     * Deposit amount
     */
    amount: string;
  ...
  declare export interface WithdrawOpts {
    /**
     * Withdrawal amount
     */
    amount: string;
   ...
   */
  declare export interface MoneyHash {
    /**
   ...
   * Price response
   */
  declare export interface Price {
    data: {
      /**
       * Currency e.g. "BTC" (see Client#getCurrencies() for available strings)
       */
  ...
  declare export class User mixins Resource {
    /**
    ...
    update(
      opts: UpdateUserOpts,
      cb: (error: Error, result: User) => void
    ): void;
  }
   ...
   */
  declare export class Address mixins Resource {
    /**
    ...
    getTransactions(
      opts: {},
      cb: (error: Error, result: Transaction[]) => void
    ): void;
  }
  declare export type AccountType =
    | "wallet"
    | "fiat"
    | "multisig"
    | "vault"
   ...
   */
  declare export class Account mixins Resource {
    /**
    ...
    update(
      ...
      cb: (error: Error, result: Account) => void
    ): void;
    ...
    createAddress(
      ...
      cb: (error: Error, result: Address) => void
    ): void;
    ...
    deposit(
      opts: DepositOpts,
      cb: (error: Error, result: Deposit) => void
    ): void;
    ...
    getWithdrawal(
      id: string,
      cb: (error: Error, result: Withdrawal) => void
    ): void;
  ...
  declare export class Transaction mixins Resource {
    /**
  ...
  declare export type BuyStatus = "created" | "completed" | "canceled";

  /**
   * Buy resource
   */
  declare export class Buy mixins Resource {
    /**
     * Constant "buy"
     */
    resource: "buy";
  ...
  declare export interface UnitPrice {
    /**
     * Amount as floating-point in a string
     */
    amount: string;
  ...
  declare export type SellStatus = "created" | "completed" | "canceled";

  /**
   * Sell resource
   */
  declare export class Sell mixins Resource {
    /**
     * Constant "sell"
     */
    resource: "sell";
  ...
  declare export type DepositStatus = "created" | "completed" | "canceled";
   ...
   */
  declare export class Deposit mixins Resource {
    resource: "deposit";
  ...
  declare export type WithdrawalStatus = "created" | "completed" | "canceled";
   ...
   */
  declare export class Withdrawal mixins Resource {
    resource: "deposit";
  ...
  declare export type PaymentMethodType =
    | "ach_bank_account"
    | "sepa_bank_account"
    | "ideal_bank_account"
    | "fiat_account"
   ...
   */
  declare export type PaymentMethod = {
    /**
  ...
  declare export interface ExchangeRate {
    /**
     * Base currency
     */
    currency: string;
  ...
  declare export class Client {
    constructor(opts: ClientConstructOpts): this;
     ...
     */
    getPaymentMethods(
      cb: (error: Error, result: PaymentMethod[]) => void
    ): void;
    ...
    getExchangeRates(
      ...
      cb: (error: Error, result: ExchangeRate) => void
    ): void;
    ...
    getBuyPrice(
      ...
      cb: (error: Error, result: Price) => void
    ): void;
