...
url: string
	...
	declare export type ResourceType = "account"
| "transaction"
| "address"
| "user"
| "buy"
...
getTransactions(opts: {}, cb: (error: Error, result: Transaction[]) => void): void
	...
	declare export type AccountType = "wallet"
| "fiat"
| "multisig"
| "vault"
| "multisig_vault";
...
cb: (error: Error, result: Address) => void): void;
...
resource_path: string
	...
	declare export type TransactionType = "send"
| "request"
| "transfer"
| "buy"
| "sell"
...
| "exchange_withdrawal"
| "vault_withdrawal";
	declare export type TransactionStatus = "pending"
| "completed"
| "failed"
| "expired"
| "canceled"
...
commit(cb: (error: Error, result: Withdrawal) => void): void
	...
	declare export type PaymentMethodType = "ach_bank_account"
| "sepa_bank_account"
| "ideal_bank_account"
| "fiat_account"
| "bank_wire"
...
cb: (error: Error, result: ExchangeRate) => void): void;
