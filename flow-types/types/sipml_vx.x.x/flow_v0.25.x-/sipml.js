declare module "sipml" {
  ...
  declare class SIPml$Session
    mixins SIPml$EventTarget<
        SIPml$Session.Stack$EventSubscriptionType,
        SIPml$Session.SIPml$Event
      > {
  ...
  declare class Session$Call
    mixins SIPml$Session,
      SIPml$EventTarget<
        Session$Call.Session$EventSubscriptionType,
        SIPml$Session.SIPml$Event
      > {
    acceptTransfer(configuration?: SIPml$Session.Session$Configuration): number;
    call(
      to: string,
      configuration?: SIPml$Session.Session$Configuration
    ): number;
    dtmf(): number;
  ...
  declare class Session$Subscribe
    mixins SIPml$Session,
      SIPml$EventTarget<
        Session$Subscribe.Call$EventSubscriptionType,
        SIPml$Session.Session$Event
      > {
    subscribe(
      to: string,
      configuration?: SIPml$Session.Session$Configuration
  ...
  declare class SIPml$Stack
    mixins SIPml$EventTarget<
        SIPml$Stack.Subscribe$EventSubscriptionType,
        SIPml$Stack.Session$Event
      > {
