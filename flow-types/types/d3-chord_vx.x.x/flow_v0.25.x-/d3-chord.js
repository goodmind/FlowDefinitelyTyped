 ...
 */
   ...
   */
  declare export interface RibbonGenerator<
    This,
    RibbonDatum,
    RibbonSubgroupDatum
  > {
     ...
     * @param d The datum representing the chord for which the ribbon is to be generated.
     */
    (d: RibbonDatum, ...args: any[]): string | null;
 ...
 */
     ...
     */
    balloontoolbar$context(): MSHTML$CanvasRenderingContext2D | null;
    ...
    balloontoolbar$context(
      balloontoolbar$context: MSHTML$CanvasRenderingContext2D
    ): this;
   ...
   */
  declare export function ribbon(): RibbonGenerator<
    any,
    Ribbon,
    RibbonSubgroup
  >;
   ...
   */
  declare export function ribbon<Datum, SubgroupDatum>(): RibbonGenerator<
    any,
    Datum,
    SubgroupDatum
  >;
   ...
   */
  declare export function ribbon<This, Datum, SubgroupDatum>(): RibbonGenerator<
    This,
    Datum,
    SubgroupDatum
  >;
