 ...
 */
declare type leadfoot$WebDriverError = {
  /**
 ...
 */
declare interface leadfoot$WebDriverCookie {
  /**
 ...
 */
declare interface leadfoot$Geolocation {
  /**
 ...
 * A remote log entry.
 */
declare interface leadfoot$LogEntry {
  /**
 ...
 */
declare interface leadfoot$Capabilities {
  /**
...
declare module "leadfoot/helpers/pollUntil" {
  import typeof * as Promise from "dojo/promise/Promise";
   ...
   * @returns A {@link module:leadfoot/Command#then} callback function that, when called, returns a promise that resolves to the
   * value returned by the poller function on success and rejects on failure.
   * @example var Command = require('leadfoot/Command');
  ...
  declare export default typeof pollUntil;
}
declare module "leadfoot/Command" {
  import typeof * as Element from "leadfoot/Element";

  import typeof * as Promise from "dojo/promise/Promise";

  import typeof * as Thenable from "dojo/promise/Thenable";

  import typeof * as Session from "leadfoot/Session";
   ...
   */
  declare class Command<T> mixins Thenable<T> {
    /**
     ...
     * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} initialiser A function that will be executed when all parent commands have completed execution. This function can create a
     ...
     * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} errback A function that will be executed if any parent commands failed to complete successfully. This function can create
     ...
     * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} callback
     * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} errback
     ...
     * @param script The code to execute. If a string value is passed, it will be converted to a function on the remote end.
     ...
     * @param name The name of the window to switch to. In most environments, this value corresponds to the `window.name`
     ...
     * @param windowHandle The name of the window to resize. See {@link module:leadfoot/Session#switchToWindow} to learn about valid
     ...
     * @param windowHandle The name of the window to query. See {@link module:leadfoot/Session#switchToWindow} to learn about valid
     ...
     * @param windowHandle The name of the window to move. See {@link module:leadfoot/Session#switchToWindow} to learn about valid
     ...
     * @param value The text to type in the remote environment. See {@link module:leadfoot/Session#pressKeys} for more information.
     */
     ...
     */
    getProperty<T: any>(name: string): Command<T>;
     ...
     * @param propertyName The CSS property to retrieve. This argument must be camel-case, *not* hyphenated.
     */
  ...
  declare export type Command$Context = {
    isSingle: boolean,
    depth: number
  } & Array<Element>;

  declare export interface Command$ContextSetter {
    (context: Element | Element[]): void;
  }
  declare export default typeof Command;
}
declare module "leadfoot/Element" {
  ...
  declare class Element {
     ...
     * data.
     * @param path The path-part of the JsonWireProtocol URL. May contain placeholders in the form `/\$\d/` that will be
     ...
     */
    _get(path: string, requestData: {}, pathParts?: string[]): Promise<{}>;
     ...
     * @param pathParts Optional placeholder values to inject into the path of the URL.
     */
    _post(path: string, requestData: {}, pathParts?: string[]): Promise<{}>;
    toJSON(): {
      ELEMENT: string
    };
...
declare module "leadfoot/Server" {
  ...
  declare class Server {
     ...
     * @param pathParts Optional placeholder values to inject into the path of the URL.
     */
    _delete(path: string, requestData: {}, pathParts?: string[]): Promise<{}>;
     ...
     */
    _fillCapabilities(session: Session): Session;
...
declare module "leadfoot/Session" {
  ...
  import typeof * as Server from "leadfoot/Server";
  ...
  declare export default typeof Session;
}
