declare module 'jquery.filtertable' {
        declare interface FilterTable$FilterTableOptions {
...
declare interface FilterTable$FilterTableStatic {
 ...
 * @returns {JQuery}
 */
(options: FilterTable$FilterTableOptions): JQuery
} 
 ...
 * $('table').filterTable()
 */
filterTable: FilterTable$FilterTable$FilterTableStatic
} 
    }
