...
declare class SteamID$Universe {
  ...
  static +INVALID: Class<SteamID$Universe__INVALID> &
    SteamID$Universe__INVALID &
    0; // 0
  static +PUBLIC: Class<SteamID$Universe__PUBLIC> &
    SteamID$Universe__PUBLIC &
    1; // 1
  static +BETA: Class<SteamID$Universe__BETA> & SteamID$Universe__BETA & 2; // 2
  static +INTERNAL: Class<SteamID$Universe__INTERNAL> &
    SteamID$Universe__INTERNAL &
    3; // 3
...
declare class SteamID$Type {
  ...
  static +INDIVIDUAL: Class<SteamID$Type__INDIVIDUAL> &
    SteamID$Type__INDIVIDUAL &
    1; // 1
  static +MULTISEAT: Class<SteamID$Type__MULTISEAT> &
    SteamID$Type__MULTISEAT &
    2; // 2
  static +GAMESERVER: Class<SteamID$Type__GAMESERVER> &
    SteamID$Type__GAMESERVER &
    3; // 3
  static +ANON_GAMESERVER: Class<SteamID$Type__ANON_GAMESERVER> &
    SteamID$Type__ANON_GAMESERVER &
    4; // 4
  static +PENDING: Class<SteamID$Type__PENDING> & SteamID$Type__PENDING & 5; // 5
  static +CONTENT_SERVER: Class<SteamID$Type__CONTENT_SERVER> &
    SteamID$Type__CONTENT_SERVER &
    6; // 6
  static +CLAN: Class<SteamID$Type__CLAN> & SteamID$Type__CLAN & 7; // 7
  static +CHAT: Class<SteamID$Type__CHAT> & SteamID$Type__CHAT & 8; // 8
  static +P2P_SUPER_SEEDER: Class<SteamID$Type__P2P_SUPER_SEEDER> &
    SteamID$Type__P2P_SUPER_SEEDER &
    9; // 9
  static +ANON_USER: Class<SteamID$Type__ANON_USER> &
    SteamID$Type__ANON_USER &
    10; // 10
}
...
declare class SteamID$Instance {
  ...
  static +DESKTOP: Class<SteamID$Instance__DESKTOP> &
    SteamID$Instance__DESKTOP &
    1; // 1
  static +CONSOLE: Class<SteamID$Instance__CONSOLE> &
    SteamID$Instance__CONSOLE &
    2; // 2
...
declare class SteamID$TypeChars {
  ...
  static +U: Class<SteamID$TypeChars__U> &
    SteamID$TypeChars__U &
    Type.INDIVIDUAL; // Type.INDIVIDUAL
  static +M: Class<SteamID$TypeChars__M> &
    SteamID$TypeChars__M &
    Type.MULTISEAT; // Type.MULTISEAT
  static +G: Class<SteamID$TypeChars__G> &
    SteamID$TypeChars__G &
    Type.GAMESERVER; // Type.GAMESERVER
  static +A: Class<SteamID$TypeChars__A> &
    SteamID$TypeChars__A &
    Type.ANON_GAMESERVER; // Type.ANON_GAMESERVER
  static +P: Class<SteamID$TypeChars__P> & SteamID$TypeChars__P & Type.PENDING; // Type.PENDING
  static +C: Class<SteamID$TypeChars__C> &
    SteamID$TypeChars__C &
    Type.CONTENT_SERVER; // Type.CONTENT_SERVER
...
declare class SteamID$ChatInstanceFlags {
  constructor(...args: empty): mixed;
  static +Clan: Class<SteamID$ChatInstanceFlags__Clan> &
    SteamID$ChatInstanceFlags__Clan &
    "NO PRINT IMPLEMENTED: BinaryExpression"; // "NO PRINT IMPLEMENTED: BinaryExpression"
  static +Lobby: Class<SteamID$ChatInstanceFlags__Lobby> &
    SteamID$ChatInstanceFlags__Lobby &
    "NO PRINT IMPLEMENTED: BinaryExpression"; // "NO PRINT IMPLEMENTED: BinaryExpression"
  static +MMSLobby: Class<SteamID$ChatInstanceFlags__MMSLobby> &
    SteamID$ChatInstanceFlags__MMSLobby &
    "NO PRINT IMPLEMENTED: BinaryExpression"; // "NO PRINT IMPLEMENTED: BinaryExpression"
}

declare class SteamID$ChatInstanceFlags__Clan
  mixins SteamID$ChatInstanceFlags {}
declare class SteamID$ChatInstanceFlags__Lobby
  mixins SteamID$ChatInstanceFlags {}
declare class SteamID$ChatInstanceFlags__MMSLobby
  mixins SteamID$ChatInstanceFlags {}
