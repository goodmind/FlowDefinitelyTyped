 ...
 */
declare function client$load(name: "groupssettings", version: "v1"): PromiseLike<void>


declare function client$load(name: "groupssettings", version: "v1", callback: () => any): void
