...
declare type payment$AuthorizationResponse = {} & AuthorizationResource & Response
...
data: QueryParameters | http.RequestOptions | CallbackFunction<payment$ListResponse>,
config?: http.RequestOptions | CallbackFunction<payment$ListResponse>,
cb?: CallbackFunction<payment$ListResponse>): void
...
data: QueryParameters | http.RequestOptions | CallbackFunction<webhook$WebhookListResponse>,
config?: http.RequestOptions | CallbackFunction<webhook$WebhookListResponse>,
cb?: CallbackFunction<webhook$WebhookListResponse>): void


declare function webhook$create(
data: webhook$Webhook,
config: http.RequestOptions | CallbackFunction<webhook$Webhook>,
cb?: CallbackFunction<webhook$Webhook>): void
...
id: string,
config: http.RequestOptions | CallbackFunction<notification$EventTypesResponse>,
cb?: CallbackFunction<notification$EventTypesResponse>): void
...
cb?: CallbackFunction<webhookEvent$WebhookEvent>): void
...
data: QueryParameters | http.RequestOptions | CallbackFunction<webhookEvent$WebhookEventListResponse>,
config?: http.RequestOptions | CallbackFunction<webhookEvent$WebhookEventListResponse>,
cb?: CallbackFunction<webhookEvent$WebhookEventListResponse>): void
...
body: webhookEvent$WebhookEvent,
id: string,
cb: CallbackFunction<webhookEvent$WebhookVerifyResponse>): void
...
data: QueryParameters | http.RequestOptions | CallbackFunction<notification$EventTypesResponse>,
config?: http.RequestOptions | CallbackFunction<notification$EventTypesResponse>,
cb?: CallbackFunction<notification$EventTypesResponse>): void
...
id: string,
data: authorization$CaptureRequest | http.RequestOptions | CallbackFunction<CaptureResource>,
...
id: string,
data: invoice$RefundRequest | http.RequestOptions | CallbackFunction<RefundResource>,
...
cb?: CallbackFunction<invoice$InvoiceResponse>): void
...
cb?: CallbackFunction<invoice$NumberResponse>): void
...
data: QueryParameters | http.RequestOptions | CallbackFunction<invoice$ListResponse>,
config?: http.RequestOptions | CallbackFunction<invoice$ListResponse>,
cb?: CallbackFunction<invoice$ListResponse>): void
...
cb?: CallbackFunction<invoice$QrResponse>): void
...
declare function billingAgreement$billBalance(id: string, data: any, config?: any, cb?: any): void


declare function billingAgreement$cancel(id: string, data: any, config?: any, cb?: any): void


declare function billingAgreement$create(data: any, config: any, cb?: any): void


declare function billingAgreement$execute(id: string, data: any, config?: any, cb?: any): void


declare function billingAgreement$get(id: string, config: any, cb?: any): void


declare function billingAgreement$reactivate(id: string, data: any, config?: any, cb?: any): void


declare function billingAgreement$searchTransactions(id: string, start_date: any, end_date?: any, config?: any, cb?: any): void


declare function billingAgreement$setBalance(id: string, data: any, config?: any, cb?: any): void


declare function billingAgreement$suspend(id: string, data: any, config?: any, cb?: any): void


declare function billingAgreement$update(id: string, data: any, config?: any, cb?: any): void
...
declare function billingPlan$activate(id: string, config: any, cb?: any): void
...
declare function billingPlan$update(id: string, data: any, config: any, cb?: any): void
...
declare function invoiceTemplate$create(data: any, config: any, cb?: any): void


declare function invoiceTemplate$get(id: string, config: any, cb?: any): void


declare function invoiceTemplate$list(data: any, config?: any, cb?: any): void


declare function invoiceTemplate$update(id: string, data: any, config: any, cb?: any): void
...
declare function order$authorize(id: string, data: any, config: any, cb?: any): void


declare function order$get(id: string, config: any, cb?: any): void


declare function order$capture(id: string, data: any, config: any, cb?: any): void
...
declare function payout$create(data: any, sync_mode: any, config?: any, cb?: any): void
...
declare function webProfile$replace(id: string, data: any, config: any, cb?: any): void


declare function webProfile$update(id: string, data: any, config: any, cb?: any): void
