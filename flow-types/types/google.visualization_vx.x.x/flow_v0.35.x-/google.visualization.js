...
declare export type visualization$ChartLegendPosition = "bottom"
| "left"
| "in"
| "none"
| "right"
...
declare export type visualization$ChartLegendAlignment = "start" | "center" | "end";
...
declare export class visualization$ScatterChart mixins visualization$CoreChartBase {
draw(
...
declare export class visualization$ColumnChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
options: visualization$ColumnChartOptions): void
}
...
declare export class visualization$LineChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
options: visualization$LineChartOptions): void
}
...
declare export class visualization$BarChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
options: visualization$BarChartOptions): void
}

declare export class visualization$Histogram mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
options: visualization$HistogramOptions): void
}
...
declare export class visualization$AreaChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
options: visualization$AreaChartOptions): void
}
...
declare export class visualization$AnnotationChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
...
declare export class visualization$SteppedAreaChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
...
declare export class visualization$PieChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
options: visualization$PieChartOptions): void
}
...
declare export class visualization$BubbleChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
...
draw(
data: visualization$DataTable | visualization$DataView,
options?: visualization$TreeMapOptions): void;
goUpAndDraw(): void;
...
draw(
data: visualization$DataTable | visualization$DataView,
options?: visualization$TableOptions): void
}
...
draw(
data: visualization$DataTable | visualization$DataView,
options?: visualization$TimelineOptions): void;
clearChart(): void
}
...
declare export class visualization$CandlestickChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
...
declare export class visualization$ComboChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
options: visualization$ComboChartOptions): void
}
...
declare function events$addListener(visualization: any, eventName: string, callback: (...args: any[]) => void): any


declare function events$addOneTimeListener(visualization: any, eventName: string, callback: Function): any


declare function events$addOneTimeListener(visualization: any, eventName: string, callback: (...args: any[]) => void): any
 ...
 */
declare export class visualization$ArrowFormat mixins visualization$DefaultFormatter {
 ...
 */
declare export class visualization$BarFormat mixins visualization$DefaultFormatter {
 ...
 */
declare export class visualization$ColorFormat mixins visualization$DefaultFormatter {
constructor(): this;
 ...
 */
declare export class visualization$DateFormat mixins visualization$DefaultFormatter {
 ...
 */
declare export class visualization$NumberFormat mixins visualization$DefaultFormatter {
...
declare export class visualization$OrgChart mixins visualization$CoreChartBase {
draw(
data: visualization$DataTable | visualization$DataView,
options: visualization$OrgChartOptions): void;
