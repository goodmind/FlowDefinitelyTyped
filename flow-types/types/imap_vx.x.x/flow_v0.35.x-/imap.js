declare module 'imap' {
        declare export interface Connection$Config {
...
declare export interface Connection$KeepAlive {
...
declare export interface Connection$Box {
...
declare export interface Connection$ImapMessageBodyInfo {
...
declare export interface Connection$ImapMessageAttributes {
 ...
 */
declare export type Connection$ImapMessage = {
on(event: string, listener: Function): this,
on(
event: "body",
listener: (stream: NodeJS.ReadableStream, info: Connection$ImapMessageBodyInfo) => void): this,
on(
event: "attributes",
listener: (attrs: Connection$ImapMessageAttributes) => void): this,
on(event: "end", listener: () => void): this
} & NodeJS.EventEmitter


declare export interface Connection$FetchOptions {
 ...
 * Returned from fetch()
 */
declare export type Connection$ImapFetch = {
on(event: string, listener: Function): this,
on(
event: "message",
listener: (message: Connection$ImapMessage, seqno: number) => void): this,
...
declare export interface Connection$Folder {
 ...
 */
children: Connection$MailBoxes,

/**
 * pointer to parent mailbox, null if at the top level
 */
parent: Connection$Folder
} 

declare export interface Connection$MailBoxes {
[name: string]: Connection$Folder
} 

declare export interface Connection$AppendOptions {
...
declare export interface Connection$MessageFunctions {
 ...
 */
fetch(source: any, options: Connection$FetchOptions): Connection$ImapFetch,

/**
 * Copies message(s) in the currently open mailbox to another mailbox.
 */
copy(source: any, mailboxName: string, callback: (error: Error) => void): void,
 ...
 */
move(source: any, mailboxName: string, callback: (error: Error) => void): void,

/**
 * Adds flag(s) to message(s).
 */
addFlags(source: any, flags: any, callback: (error: Error) => void): void,

/**
 * Removes flag(s) from message(s).
 */
delFlags(source: any, flags: any, callback: (error: Error) => void): void,

/**
 * Sets the flag(s) for message(s).
 */
setFlags(source: any, flags: any, callback: (error: Error) => void): void,

/**
 * Adds keyword(s) to message(s). keywords is either a single keyword or an array of keywords.
 */
addKeywords(source: any, keywords: any, callback: (error: Error) => void): void,

/**
 * Removes keyword(s) from message(s). keywords is either a single keyword or an array of keywords.
 */
delKeywords(source: any, keywords: any, callback: (error: Error) => void): void,

/**
 * Sets keyword(s) for message(s). keywords is either a single keyword or an array of keywords.
 */
setKeywords(source: any, keywords: any, callback: (error: Error) => void): void,
...
serverSupports(capability: string): boolean
	...
	declare class Connection mixins NodeJS.EventEmitter, Connection$Connection$MessageFunctions {

/**
 * @constructor
 */
constructor(config: Connection$Connection$Config): this;
...
fetch(
source: any,
options: Connection$Connection$FetchOptions): Connection$Connection$ImapFetch;
 ...
 */
static parseHeader(rawHeader: string, disableAutoDecode?: boolean): {
[index: string]: string[]
};
 ...
 */
seq: Connection$Connection$MessageFunctions;
...
openBox(
mailboxName: string,
callback: (error: Error, mailbox: Connection$Connection$Box) => void): void;
openBox(
mailboxName: string,
 ...
 */
getBoxes(
callback: (error: Error, mailboxes: Connection$Connection$MailBoxes) => void): void;
getBoxes(
nsPrefix: string,
callback: (error: Error, mailboxes: Connection$Connection$MailBoxes) => void): void;
...
expunge(uids: any, callback: (error: Error) => void): void;
...
append(
msgData: any,
options: Connection$Connection$AppendOptions,
