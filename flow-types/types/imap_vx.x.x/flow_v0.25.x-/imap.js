declare module "imap" {
  ...
  declare export type Connection$ImapMessage = {
    ...
    on(
      ...
      listener: (
        ...
        info: Connection$ImapMessageBodyInfo
      ) => void
    ): this,
    on(
      event: "attributes",
      listener: (attrs: Connection$ImapMessageAttributes) => void
    ): this,
  ...
  declare export type Connection$ImapFetch = {
    ...
    on(
      event: "message",
      listener: (message: Connection$ImapMessage, seqno: number) => void
    ): this,
  ...
  declare class Connection
    mixins NodeJS.EventEmitter, Connection$Connection$MessageFunctions {
    /**
     * @constructor
     */
    ...
    fetch(
      source: any,
      options: Connection$Connection$FetchOptions
    ): Connection$Connection$ImapFetch;
    ...
    openBox(
      mailboxName: string,
      callback: (error: Error, mailbox: Connection$Connection$Box) => void
    ): void;
    openBox(
      mailboxName: string,
    ...
    getBoxes(
      callback: (
        error: Error,
        mailboxes: Connection$Connection$MailBoxes
      ) => void
    ): void;
    getBoxes(
      nsPrefix: string,
