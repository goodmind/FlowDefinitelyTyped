 ...
 */
declare function client$load(name: "toolresults", version: "v1beta3"): PromiseLike<void>


declare function client$load(name: "toolresults", version: "v1beta3", callback: () => any): void
