...
scheme: string;
id: string;
constructor(scheme: string, id: string): this
}
	declare export class ACL  {
perms: number;
id: Id;
constructor(perms: number, id: Id): this
}
...
name: string;
code: number;
constructor(name: string, code: number): this;
toString(): string
}
...
name: string;
path: string;
constructor(type: number, name: string, path: string): this;
toString(): string;
getType(): number;
getName(): string;
getPath(): string
...
dataOrAclsOrmode3?: Buffer | ACL[] | number): this,
...
path: string,
version: number,
callback: (error: Error | Exception) => void): void,
exists(path: string, callback: (error: Error | Exception, stat: Stat) => void): void,
exists(
path: string,
watcher: (event: Event) => void,
callback: (error: Error | Exception, stat: Stat) => void): void,
getChildren(
path: string,
callback: (error: Error | Exception, children: string[], stat: Stat) => void): void,
getChildren(
path: string,
watcher: (event: Event) => void,
callback: (error: Error | Exception, children: string[], stat: Stat) => void): void,
getData(
path: string,
callback: (error: Error | Exception, data: Buffer, stat: Stat) => void): void,
getData(
path: string,
watcher: (event: Event) => void,
callback: (error: Error | Exception, data: Buffer, stat: Stat) => void): void,
...
getACL(
path: string,
callback: (error: Error | Exception, acls: ACL[], stat: Stat) => void): void,
setACL(
path: string,
acls: ACL[],
callback: (error: Error | Exception, stat: Stat) => void): void,
...
retries: number
	...
	declare export function createClient(connectionString: string, options?: $Shape<Option>): Client

	declare export var CreateMode: {
PERSISTENT: number,
...
name: string;
path: string;
constructor(code: number, name: string, path: string, ctor: Function): this;
constructor(code: number, name: string, ctor: Function): this;
toString(): string;
getCode(): number;
getName(): string;
getPath(): string
