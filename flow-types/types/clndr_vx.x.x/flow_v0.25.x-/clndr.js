...
declare module "clndr" {
  import typeof * as moment from "moment";

  /**
   * The clndr instance
   */
  declare export interface ClndrInstance {
    /**
     * Get clndr options
     */
  ...
  declare export interface ClndrOptions {
    /**
  ...
  declare export interface ClickEvents {
    /**
   ...
   * the target classnames that CLNDR will look for to bind events. these are the defaults.
   */
  declare export interface Targets {
    day?: string;
    empty?: string;
    nextButton?: string;
    todayButton?: string;
   ...
   * you wish to override. These are the defaults.
   */
  declare export interface Classes {
    past?: string;
    today?: string;
    event?: string;
    selected?: string;
   ...
   * instance of this.
   */
  declare export interface MultiDayEvents {
    endDate?: string;
    startDate?: string;
   ...
   */
  declare export interface LengthOfTime {
    /**
  ...
  declare export interface RenderData {
    days: CalendarDay[];
    daysOfTheWeek: string[];
    eventsLastMonth: any[];
    eventsNextMonth: any[];
  ...
  declare export interface Month {
    days: CalendarDay[];
    month: moment.Moment;
  }
  declare export interface CalendarDay {
    classes: string;
    date: moment.Moment;
    day: number;
    events: any[];
  ...
  declare export interface CalendarDayProperties {
    isToday: boolean;
    isInactive: boolean;
