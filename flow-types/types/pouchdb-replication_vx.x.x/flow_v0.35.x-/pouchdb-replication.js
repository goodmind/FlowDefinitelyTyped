...
declare type Replication$Replication<Content: {}> = {} & Replication$ReplicationEventEmitter<Content, Replication$ReplicationResult<Content>, Replication$ReplicationResultComplete<Content>> & Promise<Replication$ReplicationResultComplete<Content>>
...
declare type Replication$Sync<Content: {}> = {} & Replication$ReplicationEventEmitter<Content, Replication$SyncResult<Content>, Replication$SyncResultComplete<Content>> & Promise<Replication$SyncResultComplete<Content>>
...
callback?: Core.Callback<Replication$Replication.Replication$ReplicationResultComplete<Content>>): Replication$Replication.Replication$Replication<Content>,
...
callback?: Core.Callback<Replication$Replication.Replication$SyncResultComplete<Content>>): Replication$Replication.Replication$Sync<Content>
} 
