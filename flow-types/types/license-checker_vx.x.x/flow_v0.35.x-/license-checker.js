 ...
 */
declare export interface InitOpts {
 ...
 */
declare export interface ModuleInfo {
...
licenseModified?: string
	...
	declare export interface ModuleInfos {
 ...
 */
declare export function init(opts: InitOpts, callback: (err: Error, ret: ModuleInfos) => void): void
