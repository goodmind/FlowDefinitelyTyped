declare module "adm-zip" {
  declare class AdmZip {
     ...
     */
    constructor(fileNameOrRawData?: string | Buffer): this;
     ...
     */
    readFile(entry: string | AdmZip$AdmZip$IZipEntry): Buffer | null;
     ...
     */
    readFileAsync(
      entry: string | AdmZip$AdmZip$IZipEntry,
     ...
     */
    readAsText(
      fileName: string | AdmZip$AdmZip$IZipEntry,
      encoding?: string
    ): string;
     ...
     * @param entry The full path of the entry or a `IZipEntry` object.
     */
    deleteFile(entry: string | AdmZip$AdmZip$IZipEntry): void;
     ...
     */
    getZipEntryComment(entry: string | AdmZip$AdmZip$IZipEntry): string;
     ...
     */
    updateFile(entry: string | AdmZip$AdmZip$IZipEntry, content: Buffer): void;
 ...
 */
    extractEntryTo(
      entryPath: string | AdmZip$AdmZip$IZipEntry,
      targetPath: string,
