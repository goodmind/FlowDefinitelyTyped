...
constructor(rawData: Buffer): this;
 ...
 * @return Buffer or Null in case of error
 */
readFile(entry: AdmZip$AdmZip$IZipEntry): Buffer;
 ...
 */
readFileAsync(
entry: AdmZip$AdmZip$IZipEntry,
callback: (data: Buffer, err: string) => any): void;
 ...
 * @return String
 */
readAsText(fileName: AdmZip$AdmZip$IZipEntry, encoding?: string): string;
 ...
 */
readAsTextAsync(
fileName: AdmZip$AdmZip$IZipEntry,
 ...
 */
deleteFile(entry: AdmZip$AdmZip$IZipEntry): void;
 ...
 * @param comment The comment to add to the entry.
 */
addZipEntryComment(entry: AdmZip$AdmZip$IZipEntry, comment: string): void;
 ...
 * @return String The comment of the specified entry.
 */
getZipEntryComment(entry: AdmZip$AdmZip$IZipEntry): string;
 ...
 * @param content The entry's new contents.
 */
updateFile(entry: AdmZip$AdmZip$IZipEntry, content: Buffer): void;
 ...
 * inside the archive
 */
getEntries(): AdmZip$AdmZip$IZipEntry[];
 ...
 */
getEntry(name: string): AdmZip$AdmZip$IZipEntry;
 ...
 */
extractEntryTo(
entryPath: AdmZip$AdmZip$IZipEntry,
targetPath: string,
maintainEntryPath?: boolean,
overwrite?: boolean): boolean;
