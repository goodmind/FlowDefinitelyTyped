 ...
 */
declare export function query(obj: any, pathExpression: string, count?: number): any[]
 ...
 */
declare export function paths(obj: any, pathExpression: string, count?: number): PathComponent[][]
...
declare export function value(obj: any, pathExpression: string): any
	...
	declare export function value<T>(obj: any, pathExpression: string, newValue: T): T
