declare module "global" {
   ...
   */
  declare class HeatmapOverlay<V: string, TLat: string, TLng: string>
    mixins Leaflet.ILayer {
    /**
     * Initialization function
     */
    constructor(
      configuration: HeatmapOverlayConfiguration<V, TLat, TLng>
    ): this;
 ...
 */
   ...
   */
  declare export type HeatmapConfiguration<
    V: string = "value",
    X: string = "x",
    Y: string = "y"
  > = {
  ...
  declare export type HeatmapOverlayConfiguration<
    V: string = "value",
    TLat: string = "lat",
    TLong: string = "lng"
  > = {
