...
var heatmapInstance = h337.create(config);
 */
declare export function create<V: string, X: string, Y: string>(
 ...
 */
configure<Vn: string, Xn: string, Yn: string>(
...
repaint(): this
	...
	declare export interface BaseHeatmapConfiguration<V: string> {
 ...
 */
declare export type HeatmapConfiguration<V: string, X: string, Y: string> = {
...
yField?: Y
	...
	declare export type HeatmapOverlayConfiguration<V: string, TLat: string, TLong: string> = {
 ...
 * config object.
 */
declare export type DataPoint<V: string, X: string, Y: string> = Record<V | X | Y, number>;
