export interface connectMongo$DefaultOptions {
  /**
...
export type connectMongo$MongoUrlOptions = {
  url: string,
  mongoOptions?: mongoose.ConnectionOptions
} & connectMongo$DefaultOptions;

export type connectMongo$MogooseConnectionOptions = {
  mongooseConnection: mongoose.Connection
} & connectMongo$DefaultOptions;

export type connectMongo$NativeMongoOptions = {
  db: mongodb.Db
} & connectMongo$DefaultOptions;

export type connectMongo$NativeMongoPromiseOptions = {
  dbPromise: Promise<mongodb.Db>
} & connectMongo$DefaultOptions;

export interface connectMongo$MongoStoreFactory {
  new(
    options:
      | connectMongo$MongoUrlOptions
      | connectMongo$MogooseConnectionOptions
      | connectMongo$NativeMongoOptions
      | connectMongo$NativeMongoPromiseOptions
...
declare module "connect-mongo" {
  ...
  ): connectMongo$connectMongo$MongoStoreFactory;

  declare export default typeof connectMongo;
}
