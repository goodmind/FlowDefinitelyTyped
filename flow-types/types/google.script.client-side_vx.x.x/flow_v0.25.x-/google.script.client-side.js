declare module "google.script.client-side" {
   ...
   */
  declare function url$getLocation(
    callback: (location: script$UrlLocation) => void
  ): void;
...
If null or undefined, the current URL fragment is not changed. If empty, the URL fragment is cleared.
 */
  declare function history$replace(
    stateObject: history$State,
    params?: history$Query,
    hash?: string
  ): void;
   ...
   */
  declare function history$setChangeHandler(
    handler: (event: history$HistoryChangeEvent) => void
  ): void;
