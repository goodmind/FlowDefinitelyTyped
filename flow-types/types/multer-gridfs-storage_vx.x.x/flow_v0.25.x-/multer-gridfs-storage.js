...
declare module "multer-gridfs-storage" {
  ...
  declare class Cache {
    ...
    waitFor(cacheIndex: { [key: string]: any }): Promise<{
      [key: string]: any
    }>;
    connections(): number;
  ...
  declare class MulterGridfsStorage mixins EventEmitter, Multer$StorageEngine {
    ...
    connecting: boolean;
    configuration:
      | MulterGridfsStorage$MulterGridfsStorage$UrlStorageOptions
      | MulterGridfsStorage$MulterGridfsStorage$DbStorageOptions;
    error: Error;
    caching: boolean;
    cacheName: string;
    cacheIndex: { [key: string]: any };
    ...
    _handleFile(
      ...
      callback: (error?: any, info?: Express$Multer.Multer$File) => void
    ): void;
    _removeFile(
      req: Express$Request,
      file: Express$Multer.Multer$File,
