...
constructor(clientId: string, clientSecret: string, redirectUri: string, scope: string[]): this;
...
opts: {[key: string]: any},
credentials: AuthToken): Promise<ApiResponse>;
...
getBuckets(options: {[key: string]: any}, credentials: AuthToken): Promise<ApiResponse>
}
...
opts: {[key: string]: any},
credentials: AuthToken): Promise<ApiResponse>;
getHubs(opts: {[key: string]: any}, credentials: AuthToken): Promise<ApiResponse>;
getHubProjects(
hubId: string,
opts: {[key: string]: any},
credentials: AuthToken): Promise<ApiResponse>
...
opts: {[key: string]: any},
credentials: AuthToken): Promise<ApiResponse>;
getFormats(opts: {[key: string]: any}, credentials: AuthToken): Promise<ApiResponse>;
getManifest(
urn: string,
opts: {[key: string]: any},
credentials: AuthToken): Promise<ApiResponse>;
