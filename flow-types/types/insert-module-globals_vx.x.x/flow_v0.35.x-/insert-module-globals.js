 ...
 */
(file: string, opts?: InsertModuleGlobals$InsertModuleGlobals$Options): stream.Transform,
...
declare type InsertModuleGlobals$InsertFunction = (file: string, basedir: string) => InsertModuleGlobals$VariableConfig | string;
