...
callback: (err: Error, results: OSRM$OSRM$RouteResults) => void): void;
...
callback: (err: Error, results: OSRM$OSRM$NearestResults) => void): void;
...
callback: (err: Error, results: OSRM$OSRM$TableResults) => void): void;
...
callback: (err: Error, results: OSRM$OSRM$MatchResults) => void): void;
...
callback: (err: Error, results: OSRM$OSRM$TripResults) => void): void;
...
callback: (err: Error, results: Buffer) => void): void
}
	
      declare var npm$namespace$OSRM: {
        
        version: typeof OSRM$version,
      }
declare var OSRM$version: number;

declare type OSRM$GeometriesTypes = "polyline" | "geojson" | "polyline6";

declare type OSRM$OverviewTypes = "full" | "simplified" | "false";

declare type OSRM$Coordinate = number[];

declare type OSRM$Polyline = string;

declare type OSRM$Bearing = number[];

declare type OSRM$Radius = number;

declare type OSRM$Hint = string;

declare type OSRM$Duration = number;

declare type OSRM$Tile = [number, number, number];

declare type OSRM$StepManeuverTypes = "turn"
| "new name"
| "depart"
| "arrive"
| "merge"
...
declare type OSRM$Indication = "uturn"
| "sharp right"
| "right"
| "slight rigth"
| "straight"
...
declare interface OSRM$LineString {
type: "LineString",
coordinates: OSRM$Coordinate[]
} 

declare interface OSRM$Waypoint {
hint: string,
distance: number,
name: string,
 ...
 */
declare interface OSRM$Annotation {
 ...
 */
declare interface OSRM$RouteLeg {
 ...
 */
declare interface OSRM$RouteStep {
 ...
 */
geometry: OSRM$Polyline | OSRM$LineString,
 ...
 */
declare interface OSRM$StepManeuver {
 ...
 */
declare interface OSRM$Lane {
indications: OSRM$Indication[],
valid: boolean
} 
 ...
 */
declare interface OSRM$Intersection {
 ...
 */
declare type OSRM$RouteOptions = {
 ...
 */
geometries?: OSRM$GeometriesTypes,
 ...
 */
declare type OSRM$NearestOptions = {
 ...
 */
declare type OSRM$TableOptions = {
 ...
 * https://github.com/Project-OSRM/node-osrm/blob/master/docs/api.md#tile
 */
declare type OSRM$MatchOptions = {
...
declare interface OSRM$NearestResults {
waypoints: OSRM$Waypoint[]
} 

declare interface OSRM$TableResults {
durations: OSRM$Duration[][],
sources: OSRM$Waypoint[],
destinations: OSRM$Waypoint[]
} 

declare interface OSRM$MatchResults {
tracepoints: OSRM$MatchWaypoint[],
matchings: OSRM$MatchRoute[]
} 

declare interface OSRM$TripResults {
