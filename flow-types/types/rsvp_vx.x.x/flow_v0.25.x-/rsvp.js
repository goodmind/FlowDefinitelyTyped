...
declare class RSVP$State {
  ...
  static +fulfilled: Class<RSVP$State__fulfilled> &
    RSVP$State__fulfilled &
    "fulfilled"; // "fulfilled"
  static +rejected: Class<RSVP$State__rejected> &
    RSVP$State__rejected &
    "rejected"; // "rejected"
...
declare class RSVP$Promise<T> mixins PromiseLike<T> {
  ...
  then<TResult1, TResult2>(
    ...
    onRejected?:
      ...
      | null,
    label?: string
  ): RSVP$RSVP$Promise<TResult1 | TResult2>;
  catch<TResult>(
    onRejected?:
  ...
  static all<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
    ...
    label?: string
  ): RSVP$RSVP$Promise<[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10]>;
  static all<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
    ...
    label?: string
  ): RSVP$RSVP$Promise<[T1, T2, T3, T4, T5, T6, T7, T8, T9]>;
  static all<T1, T2, T3, T4, T5, T6, T7, T8>(
    ...
    label?: string
  ): RSVP$RSVP$Promise<[T1, T2, T3, T4, T5, T6, T7, T8]>;
  static all<T1, T2, T3, T4, T5, T6, T7>(
    ...
    label?: string
  ): RSVP$RSVP$Promise<[T1, T2, T3, T4, T5, T6, T7]>;
  static all<T1, T2, T3, T4, T5, T6>(
    ...
    label?: string
  ): RSVP$RSVP$Promise<[T1, T2, T3, T4, T5, T6]>;
...
declare function RSVP$denodeify<T1, T2, T3, A>(
  ...
  options: true
): (arg1: A) => RSVP$RSVP$Promise<[T1, T2, T3]>;
...
declare function RSVP$denodeify<T1, T2, A>(
  ...
  options: true
): (arg1: A) => RSVP$RSVP$Promise<[T1, T2]>;
...
declare function RSVP$denodeify<T, A, K1: string>(
  nodeFunc: (arg1: A, callback: (err: any, data: T) => void) => void,
  options: [K1]
): (arg1: A) => RSVP$RSVP$Promise<$ObjMapi<{ [k: K1]: any }, <K>(K) => T>>;
...
declare function RSVP$hashSettled<T>(
  ...
  $ObjMapi<T, <P>(P) => RSVP$PromiseState<$ElementType<T, P>>>
>;
...
declare function RSVP$allSettled<T1, T2>(
  ...
  label?: string
): RSVP$RSVP$Promise<[RSVP$PromiseState<T1>, RSVP$PromiseState<T2>]>;

declare function RSVP$allSettled<T>(
  entries: RSVP$Arg<T>[],
  label?: string
): RSVP$RSVP$Promise<[RSVP$PromiseState<T>]>;
...
declare function RSVP$filter<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
  ...
  label?: string
): RSVP$RSVP$Promise<Array<T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8 | T9 | T10>>;
...
declare function RSVP$filter<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
  ...
  label?: string
): RSVP$RSVP$Promise<Array<T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8 | T9>>;
...
declare function RSVP$filter<T1, T2, T3, T4, T5, T6, T7, T8>(
  ...
  label?: string
): RSVP$RSVP$Promise<Array<T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8>>;
...
declare function RSVP$filter<T1, T2, T3, T4, T5, T6, T7>(
  ...
  label?: string
): RSVP$RSVP$Promise<Array<T1 | T2 | T3 | T4 | T5 | T6 | T7>>;
