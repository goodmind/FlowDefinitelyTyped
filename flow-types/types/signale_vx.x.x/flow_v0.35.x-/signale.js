...
declare interface signale$SignaleOptions<TTypes: string> {
...
declare interface signale$SignaleBase<TTypes: string> {
...
declare type signale$Signale<TTypes: string> = signale$SignaleBase<TTypes> & Record<TTypes, signale$LoggerFunc> & Record<signale$DefaultMethods, signale$LoggerFunc>;
