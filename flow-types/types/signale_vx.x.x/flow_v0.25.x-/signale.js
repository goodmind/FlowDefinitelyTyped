declare module "signale" {
  declare type signale$DefaultMethods =
    | "await"
    | "complete"
    | "error"
    | "debug"
  ...
  declare interface signale$SignaleOptions<
    TTypes: string = signale$DefaultMethods
  > {
    /**
  ...
  declare interface signale$SignaleConstructor {
    new<TTypes: string>(
      options?: signale$SignaleOptions<TTypes>
    ): signale$Signale<TTypes>;
  }

  declare interface signale$SignaleBase<
    TTypes: string = signale$DefaultMethods
  > {
    /**
     * Sets the configuration of an instance overriding any existing global or local configuration.
  ...
  declare type signale$LoggerFunc = (
    message?: any,
    ...optionalArgs: any[]
  ) => void;

  declare type signale$Signale<
    TTypes: string = signale$DefaultMethods
  > = signale$SignaleBase<TTypes> &
    Record<TTypes, signale$LoggerFunc> &
