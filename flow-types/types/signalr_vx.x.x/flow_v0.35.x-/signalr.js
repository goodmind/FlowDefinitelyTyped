...
static +Connecting: Class<SignalR$ConnectionState__Connecting> & SignalR$ConnectionState__Connecting & 0;// 0
static +Connected: Class<SignalR$ConnectionState__Connected> & SignalR$ConnectionState__Connected & 1;// 1
static +Reconnecting: Class<SignalR$ConnectionState__Reconnecting> & SignalR$ConnectionState__Reconnecting & 2;// 2
static +Disconnected: Class<SignalR$ConnectionState__Disconnected> & SignalR$ConnectionState__Disconnected & 4;// 4

}

declare class SignalR$ConnectionState__Connecting mixins SignalR$ConnectionState {}
declare class SignalR$ConnectionState__Connected mixins SignalR$ConnectionState {}
declare class SignalR$ConnectionState__Reconnecting mixins SignalR$ConnectionState {}
declare class SignalR$ConnectionState__Disconnected mixins SignalR$ConnectionState {}
 ...
 */
start(options: SignalR$ConnectionOptions, callback: () => void): JQueryPromise<any>,
 ...
 */
stateChanged(callback: (change: SignalR$StateChanged) => void): Hub$Connection,
 ...
 */
isCrossDomain(url: string, against?: Location | SignalR$SimplifyLocation): boolean,
 ...
 * @param calback A callback function to execute when the connection state changes
 */
stateChanged(callback: (change: SignalR$StateChanged) => void): SignalR$Connection,

/**
 * Adds a callback that will be invoked after an error occurs with the connection
 * @param calback A callback function to execute when an error occurs on the connection
 */
error(callback: (error: SignalR$ConnectionError) => void): SignalR$Connection,
 ...
 */
(url: string, queryString?: string | Object, logging?: boolean): SignalR$SignalR$Connection,
