declare module "restify-plugins" {
   ...
   */
  declare export function auditLogger(
   ...
   */
  declare export function bodyParser(
   ...
   * error is logged.
   */
  declare export function urlEncodedBodyParser(
   ...
   */
  declare export function jsonBodyParser(options?: {
    mapParams?: boolean,
    reviver?: any,
    overrideParams?: boolean
  }): RequestHandler[];
   ...
   * Parses JSONP callback
   */
  declare export function multipartBodyParser(
   ...
   */
  declare export function queryParser(
   ...
   */
  declare export function requestLogger(
   ...
   */
  declare export function requestExpiry(
