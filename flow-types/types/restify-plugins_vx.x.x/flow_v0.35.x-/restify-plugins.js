declare module 'restify-plugins' {
        import type {
          RequestHandler,Server,Request,Response,Route
        } from 'restify';
 ...
 */
declare export function acceptParser(accepts: string[]): RequestHandler

	declare export interface AuditLoggerOptions {
 ...
 */
declare export function auditLogger(options: AuditLoggerOptions): (...args: any[]) => void

	
/**
 * Authorization header
 */
declare export function authorizationParser(options?: any): RequestHandler
...
declare export function fullResponse(): RequestHandler
	...
	declare export interface BodyParserOptions {
 ...
 */
declare export function bodyParser(options?: BodyParserOptions): RequestHandler[]

	
/**
 * Reads the body of the request.
 */
declare export function bodyReader(options?: {
maxBodySize?: number
}): RequestHandler

	declare export interface UrlEncodedBodyParser {
mapParams?: boolean,
overrideParams?: boolean
} 
 ...
 * error is logged.
 */
declare export function urlEncodedBodyParser(options?: UrlEncodedBodyParser): RequestHandler[]

	
/**
 * Parses JSON POST bodies
 */
declare export function jsonBodyParser(
options?: {
mapParams?: boolean,
reviver?: any,
overrideParams?: boolean
...
declare export function jsonp(): RequestHandler
	...
	declare export interface MultipartBodyParser {
overrideParams?: boolean,
multiples?: boolean,
keepExtensions?: boolean,
uploadDir?: string,
 ...
 * Parses JSONP callback
 */
declare export function multipartBodyParser(options?: MultipartBodyParser): RequestHandler

	declare export interface QueryParserOptions {
 ...
 */
declare export function queryParser(options?: QueryParserOptions): RequestHandler

	declare export interface RequestLogger {
properties?: any,
serializers?: any,
headers?: any,
log?: any
 ...
 */
declare export function requestLogger(options?: RequestLogger): RequestHandler
 ...
 */
declare export function dateParser(delta?: number): RequestHandler
 ...
 */
declare export function gzipResponse(options?: any): RequestHandler

	declare export interface ServeStatic {
 ...
 */
declare export function serveStatic(options?: ServeStatic): RequestHandler
...
overrides?: any
	...
	declare export interface MetricsCallback {
...
route: Route
	...
	declare export type TMetricsCallback = "close" | "aborted" | void;
	declare export interface MetricsCallbackOptions {
 ...
 *  * ```
 */
declare export function metrics(
opts: {
server: Server
},
callback: (options: MetricsCallback) => any): (...args: any[]) => void
 ...
 *  * ```
 */
declare export function oauth2TokenParser(): RequestHandler
...
declare export function throttle(options?: ThrottleOptions): RequestHandler
	...
	declare export interface RequestExpiryOptions {
 ...
 */
declare export function requestExpiry(options?: RequestExpiryOptions): RequestHandler
