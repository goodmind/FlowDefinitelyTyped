declare module "react-simple-maps" {
  ...
  declare export interface ProjectionConfig {
    scale: number;
    xOffset: number;
    yOffset: number;
  ...
  declare export type ProjectionFunction = (
    width: number,
    height: number,
  ...
  declare export interface ComposableMapProps {
    ...
    projectionConfig?: $Shape<ProjectionConfig>;
  ...
  declare export class ComposableMap
    mixins React.Component<ComposableMapProps> {}
  declare export class ZoomableGroup
    mixins React.Component<ZoomableGroupProps> {}
  declare export class ZoomableGlobe
    mixins React.Component<ZoomableGlobeProps> {}
