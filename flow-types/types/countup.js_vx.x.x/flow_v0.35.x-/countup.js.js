 ...
 */
constructor(target: string | HTMLElement, startVal: number | string, endVal: number | string, decimals?: number | string, duration?: number | string, options?: CountUp$CountUp$CountUpOptions): this;
countDown: boolean;
d: any;
dec: number;
decimals: number;
...
frameVal: number;
initialized: boolean;
options: CountUp$CountUp$CountUpOptions;
paused: boolean;
rAF: number;
remaining: number;
startTime: number;
...
version(): string
	...
	declare interface CountUp$CountUpOptions {
...
useGrouping?: boolean
	...
	declare module.exports: typeof CountUp
