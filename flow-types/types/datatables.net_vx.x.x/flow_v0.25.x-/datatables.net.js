declare module "datatables.net" {
  declare interface JQuery {
    DataTable(
      opts?: DataTables$DataTables.DataTables$Settings
    ): DataTables$DataTables.DataTables$Api;
  ...
  declare type DataTables$Api = {
    ...
    cell(
      cellSelector: any,
      modifier?: DataTables$ObjectSelectorModifier
    ): DataTables$CellMethods,
  ...
  declare type DataTables$CoreMethods = {
    ...
    off(
      event: string,
      callback?: (e: Event, ...args: any[]) => void
    ): DataTables$Api,
  ...
  declare interface DataTables$UtilityMethods {
     ...
     */
    each(
      fn: (value: any, index: number, dt: DataTables$Api) => void
    ): DataTables$Api;
     ...
     */
    filter(
      fn: (value: any, index: number, dt: DataTables$Api) => boolean
    ): DataTables$Api;
     ...
     */
    map(
      fn: (value: any, index: number, dt: DataTables$Api) => any
    ): DataTables$Api;
 ...
 */
    tables(
      visible?: boolean | DataTables$objectTablesStatic
  ...
  declare interface DataTables$ObjectColumnRender {
    display(
      d?: number | string | { [key: string]: any }
  ...
  declare type DataTables$FunctionColumnCreatedCell = (
    cell: Node,
    cellData: any,
    rowData: any,
    row: number,
  ...
  declare type DataTables$FunctionColumnRender = (
    data: any,
    type: any,
    row: any,
    meta: DataTables$CellMetaSettings
  ...
  declare type DataTables$FunctionCreateRow = (
    row: Node,
    data: any[] | { [key: string]: any },
    dataIndex: number
  ) => void;

  declare type DataTables$FunctionDrawCallback = (
    settings: DataTables$SettingsLegacy
  ) => void;

  declare type DataTables$FunctionFooterCallback = (
    tfoot: Node,
    data: any[],
    start: number,
    end: number,
  ...
  declare type DataTables$FunctionHeaderCallback = (
    thead: Node,
    data: any[],
    start: number,
    end: number,
  ...
  declare type DataTables$FunctionInitComplete = (
    settings: DataTables$SettingsLegacy,
    json: { [key: string]: any }
  ) => void;

  declare type DataTables$FunctionPreDrawCallback = (
    settings: DataTables$SettingsLegacy
  ) => void;

  declare type DataTables$FunctionRowCallback = (
    row: Node,
    data: any[] | { [key: string]: any },
    index: number
  ) => void;

  declare type DataTables$FunctionStateLoadCallback = (
    settings: DataTables$SettingsLegacy
  ) => void;

  declare type DataTables$FunctionStateLoaded = (
    settings: DataTables$SettingsLegacy,
    data: { [key: string]: any }
  ) => void;

  declare type DataTables$FunctionStateLoadParams = (
    settings: DataTables$SettingsLegacy,
    data: { [key: string]: any }
  ) => void;

  declare type DataTables$FunctionStateSaveCallback = (
    settings: DataTables$SettingsLegacy,
    data: { [key: string]: any }
  ) => void;

  declare type DataTables$FunctionStateSaveParams = (
    settings: DataTables$SettingsLegacy,
    data: { [key: string]: any }
  ) => void;
  ...
  declare type DataTables$CookieCallbackLegacy = (
    name: string,
    data: any,
    expires: string,
    path: string,
 ...
 */
   ...
   */
  declare type DataTables$FunctionExtTypeSettingsDetect = (
    data: any,
    settings: DataTables$Settings
  ) => string | null;
}
