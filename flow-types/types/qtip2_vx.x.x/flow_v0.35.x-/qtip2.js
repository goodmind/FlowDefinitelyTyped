...
(methodName: "option", propertyName: "position.target"): QTip2$QTip2$Target | boolean,
...
(methodName: "option", propertyName: "position.effect"): boolean | ((api: QTip2$QTip2$Api, pos: any, viewport: any) => void),
(methodName: "option", propertyName: "position.adjust"): QTip2$QTip2$PositionAdjust,
...
(methodName: "option", propertyName: "show.modal"): boolean | QTip2$QTip2$Modal,
...
(methodName: "option", propertyName: "style.tip"): string | boolean | QTip2$QTip2$Tip,
(methodName: "option", propertyName: "events"): QTip2$QTip2$Events,
(methodName: "option", propertyName: "events.render"): QTip2$QTip2$EventApiFunc,
(methodName: "option", propertyName: "events.show"): QTip2$QTip2$EventApiFunc,
(methodName: "option", propertyName: "events.hide"): QTip2$QTip2$EventApiFunc,
(methodName: "option", propertyName: "events.toggle"): QTip2$QTip2$EventApiFunc,
(methodName: "option", propertyName: "events.visible"): QTip2$QTip2$EventApiFunc,
(methodName: "option", propertyName: "events.hidden"): QTip2$QTip2$EventApiFunc,
(methodName: "option", propertyName: "events.move"): QTip2$QTip2$EventApiFunc,
(methodName: "option", propertyName: "events.focus"): QTip2$QTip2$EventApiFunc,
(methodName: "option", propertyName: "events.blur"): QTip2$QTip2$EventApiFunc,
(methodName: "option", properties: QTip2$QTip2$QTipOptions): QTip2$QTip2$Api,
(methodName: "option", propertyName: "id", value: string | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "prerender", value: boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "overwrite", value: boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "suppress", value: boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "metadata", value: any): QTip2$QTip2$Api,
(methodName: "option", propertyName: "content", value: QTip2$QTip2$Text | QTip2$QTip2$Content): QTip2$QTip2$Api,
(methodName: "option", propertyName: "content.title", value: QTip2$QTip2$Title | {
text: QTip2$QTip2$Title
}): QTip2$QTip2$Api,
(methodName: "option", propertyName: "content.text", value: QTip2$QTip2$Text): QTip2$QTip2$Api,
(methodName: "option", propertyName: "content.attr", value: string): QTip2$QTip2$Api,
(methodName: "option", propertyName: "content.button", value: string | JQuery | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "position", value: QTip2$QTip2$Position): QTip2$QTip2$Api,
(methodName: "option", propertyName: "position.my", value: string | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "position.at", value: string | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "position.target", value: QTip2$QTip2$Target | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "position.container", value: JQuery | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "position.viewport", value: JQuery | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "position.effect", value: boolean | ((api: QTip2$QTip2$Api, pos: any, viewport: any) => void)): QTip2$QTip2$Api,
(methodName: "option", propertyName: "position.adjust", value: QTip2$QTip2$PositionAdjust): QTip2$QTip2$Api,
(methodName: "option", propertyName: "show", value: QTip2$QTip2$Show): QTip2$QTip2$Api,
(methodName: "option", propertyName: "show.target", value: JQuery | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "show.event", value: string | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "show.delay", value: number): QTip2$QTip2$Api,
(methodName: "option", propertyName: "show.solo", value: JQuery | string | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "show.ready", value: boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "show.effect", value: boolean | ((offset: any) => void)): QTip2$QTip2$Api,
(methodName: "option", propertyName: "show.modal", value: boolean | QTip2$QTip2$Modal): QTip2$QTip2$Api,
(methodName: "option", propertyName: "hide", value: QTip2$QTip2$Hide): QTip2$QTip2$Api,
(methodName: "option", propertyName: "hide.target", value: JQuery | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "hide.event", value: string | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "hide.inactive", value: number | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "hide.fixed", value: boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "hide.leave", value: string | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "hide.distance", value: number | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "hide.effect", value: boolean | ((offset: any) => void)): QTip2$QTip2$Api,
(methodName: "option", propertyName: "style", value: QTip2$QTip2$Style): QTip2$QTip2$Api,
(methodName: "option", propertyName: "style.classes", value: string | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "style.def", value: boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "style.widget", value: boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "style.width", value: string | number | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "style.height", value: string | number | boolean): QTip2$QTip2$Api,
(methodName: "option", propertyName: "style.tip", value: string | boolean | QTip2$QTip2$Tip): QTip2$QTip2$Api,
(methodName: "option", propertyName: "events", value: QTip2$QTip2$Events): QTip2$QTip2$Api,
(methodName: "option", propertyName: "events.render", value: QTip2$QTip2$EventApiFunc): QTip2$QTip2$Api,
(methodName: "option", propertyName: "events.show", value: QTip2$QTip2$EventApiFunc): QTip2$QTip2$Api,
(methodName: "option", propertyName: "events.hide", value: QTip2$QTip2$EventApiFunc): QTip2$QTip2$Api,
(methodName: "option", propertyName: "events.toggle", value: QTip2$QTip2$EventApiFunc): QTip2$QTip2$Api,
(methodName: "option", propertyName: "events.visible", value: QTip2$QTip2$EventApiFunc): QTip2$QTip2$Api,
(methodName: "option", propertyName: "events.hidden", value: QTip2$QTip2$EventApiFunc): QTip2$QTip2$Api,
(methodName: "option", propertyName: "events.move", value: QTip2$QTip2$EventApiFunc): QTip2$QTip2$Api,
(methodName: "option", propertyName: "events.focus", value: QTip2$QTip2$EventApiFunc): QTip2$QTip2$Api,
(methodName: "option", propertyName: "events.blur", value: QTip2$QTip2$EventApiFunc): QTip2$QTip2$Api,
