...
parse_url?: boolean
	...
	declare export function image(text: string, level?: ec_level): NodeJS.ReadableStream

	declare export function image(text: string, options?: Options): NodeJS.ReadableStream

	declare export function imageSync(text: string, level?: ec_level): Buffer

	declare export function imageSync(text: string, options?: Options): string | Buffer
