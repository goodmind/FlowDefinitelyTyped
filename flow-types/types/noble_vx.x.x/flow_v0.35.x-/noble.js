...
listener: (peripheral: Peripheral) => void): events.EventEmitter
	...
	declare export function removeListener(event: "scanStart", listener: () => void): events.EventEmitter

	declare export function removeListener(event: "scanStop", listener: () => void): events.EventEmitter
