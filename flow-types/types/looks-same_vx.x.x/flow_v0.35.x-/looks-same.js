declare module 'looks-same' {
        declare type LooksSameCallback = (error: Error | null, equal: boolean) => any;
	
/**
 * The options passed to looksSame function
 */
declare interface LooksSameOptions {
 ...
 */
declare interface CreateDiffAsBufferOptions {
 ...
 */
declare type CreateDiffOptions = {
 ...
 */
declare interface LooksSameColor {
...
callback: LooksSameCallback): void
...
declare function looksSame(image1: string, image2: string, callback: LooksSameCallback): void
      ...
      declare var npm$namespace$looksSame: {
        createDiff: typeof looksSame$createDiff,
colors: typeof looksSame$colors,
        
      }
declare function looksSame$createDiff(options: CreateDiffOptions, callback: (error: Error | null) => any): void


declare function looksSame$createDiff(
options: CreateDiffAsBufferOptions,
callback: (error: Error | null, buffer: Buffer) => any): void
 ...
 */
declare function looksSame$colors(
