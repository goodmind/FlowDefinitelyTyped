declare module "zeromq" {
  declare export interface SocketTypes {
    pub: number;
    xpub: number;
    sub: number;
    xsub: number;
   ...
   */
  declare export function socket(type: string | number, options?: any): Socket;

  /**
   * Creates a ZeroMQ socket of the specified type.
   * @return The created socket in an unconnected state.
   */
  declare export function createSocket(type: string, options?: any): Socket;

  /**
   * Generates a CurveZMQ (Curve25519) key pair.
   * @return The public and secret portions of the key.
   */
  declare export function curveKeypair(): CurveKeyPair;
