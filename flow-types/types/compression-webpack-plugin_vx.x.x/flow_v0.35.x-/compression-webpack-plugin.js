declare module 'compression-webpack-plugin' {
	...
	declare class CompressionPlugin<O> mixins Plugin {
constructor(options?: CompressionPlugin$CompressionPlugin$Options<O>): this
}
	declare type CompressionPlugin$AlgorithmCallback = (error: Error | null, result: Buffer) => void;

declare type CompressionPlugin$Algorithm<O> = (
source: string,
options: O,
callback: CompressionPlugin$AlgorithmCallback) => void;

declare type CompressionPlugin$ZlibAlgorithm = "deflate" | "deflateRaw" | "gzip";

declare type CompressionPlugin$Pattern = string | RegExp | $ReadOnlyArray<RegExp> | $ReadOnlyArray<string>;
...
declare type CompressionPlugin$Options<O> = CompressionPlugin$ZlibOptions | CompressionPlugin$CustomOptions<O>;
    }
