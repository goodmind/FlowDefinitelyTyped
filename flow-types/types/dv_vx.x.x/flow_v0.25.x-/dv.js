declare module "dv" {
  ...
  declare export type Paragaph = Region;
  declare export interface Textline {
    box: Box;
  }
  declare export type Word = Region;
  ...
  declare export type Text = Choice;
  ...
  declare export interface Barcodeformat {
    QR_CODE: boolean;
    DATA_MATRIX: boolean;
    PDF_417: boolean;
    UPC_E: boolean;
  ...
  declare export interface BarCode {
    type: string;
    data: string;
    buffer: Buffer;
    points: Point[];
