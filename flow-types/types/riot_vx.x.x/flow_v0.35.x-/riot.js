...
asyncRenderTimeout: number
	...
	declare export type TemplateError = {
riotData: {
_riot_id: number,
tagName: string
}
...
inject(): void
	...
	declare export interface DOMUtil {
...
walkNodes(node: Node, fn: (node: Node, context: any) => any, context: any): void
	...
	declare export interface CheckUtil {
...
isReservedName(value: string): boolean
	...
	declare export interface MiscUtil {
...
extend(...args: any[]): any
	...
	declare export interface TagsUtil {
 ...
 */
inheritFrom(target: TagInstance, propsInSyncWithParent: string[]): void,
 ...
 */
makeVirtual(src: Node, target?: TagInstance): void,
 ...
 */
moveVirtual(src: Node, target: TagInstance): void,
...
tags: TagsUtil
	...
	declare export type ObservableCallback = (...args: any[]) => any;
 ...
 */
declare export function observable(el?: any): Observable
 ...
 */
declare export function mount(selector: string, opts?: TagOpts): TagInstance[]
 ...
 */
declare export function mount(selector: string | Element, tagName: string, opts?: TagOpts): TagInstance[]
 ...
 */
declare export function unregister(tagName: string): void
 ...
 * @param opts Optional object passed for the tag to consume.
 */
declare export function render(tagName: string, opts?: TagOpts): string
 ...
 * @returns Tag name
 */
declare export function require(tagPath: string, opts?: any): string
 ...
 */
declare export function renderAsync(tagName: string, opts?: TagOpts): Promise<string>
 ...
 */
declare export function update(): TagInstance[]
 ...
 */
declare export function mixin(mixinObject: TagMixin): void
 ...
 * @param mixinObject Mixin object
 */
declare export function mixin(mixinName: string, mixinObject: TagMixin): void
 ...
 */
declare export function tag<T: TagInterface>(
tagName: string,
html: string,
css?: string,
attrs?: string,
function Object() { [native code] }?: (opts?: TagOpts) => void): string
...
function Object() { [native code] }: (opts?: TagOpts) => void): string
	...
	declare export interface TagOpts {
[key: string]: any
} 
	declare export interface TagRefs {
[key: string]: TagInstance | Element
} 
	declare export interface NestedTags {
[key: string]: TagInstance | TagInstance[]
} 
	declare export type TagInterface = {
...
unmount(keepTheParent?: boolean): void
	...
	declare export type TagInstance = {
[key: string]: any
} & TagInterface
 ...
 */
declare export class Tag mixins TagInterface {
opts: TagOpts;
root: Element;
refs: TagRefs;
tags: NestedTags;
 ...
 * @param opts Tag opts
 */
constructor(element: Element, opts?: TagOpts): this;
update(data?: any): void;
 ...
 */
declare export interface TagMixin {
 ...
 */
declare export function compile(callback: () => void): void
 ...
 */
declare export function compile(tag: string, skipExecution?: boolean): string
 ...
 */
declare export function compile(url: string, callback: () => void): void
