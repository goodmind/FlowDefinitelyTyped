declare module "jquery.prettyphoto" {
  ...
  declare interface scaron_prettyPhoto$moduleJQueryStatic {
     ...
     * Opens the prettyPhoto modal box.
     * Note: Always returns false.
     * @param {String} image Full path to the image to be open, can also be an array containing full images paths.
     * @param {String} title The title to be displayed with the picture, can also be an array containing all the titles.
     * @param {String} description The description to be displayed with the picture, can also be an array containing all the descriptions.
     */
     ...
     * Opens the prettyPhoto modal box.
     * Note: Always returns false.
     * @param {Array} image Full path to the image to be open, can also be an array containing full images paths.
     * @param {Array} title The title to be displayed with the picture, can also be an array containing all the titles.
     * @param {Array} description The description to be displayed with the picture, can also be an array containing all the descriptions.
     */
    open(images: string[], titles: string[], descriptions: string[]): boolean;

    /**
     * Change page in the prettyPhoto modal box
     * @param {String} direction Direction of the paging, previous or next.
     */
  ...
  declare interface JQuery {
    prettyPhoto: scaron_prettyPhoto$scaron_prettyPhoto$moduleJQuery;
  }
  declare interface JQueryStatic {
    prettyPhoto: scaron_prettyPhoto$scaron_prettyPhoto$moduleJQueryStatic;
  }
}
