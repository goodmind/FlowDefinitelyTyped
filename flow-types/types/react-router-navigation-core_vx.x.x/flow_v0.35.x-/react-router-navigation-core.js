declare module 'react-router-navigation-core' {
        import type {
          PureComponent,ReactNode,ComponentClass,ReactElement
        } from 'react';

	import type {
          BackHandler,StyleProp,ViewStyle
        } from 'react-native';
...
render: (props: CardsRendererProps) => ReactNode
	...
	declare export class CardStack mixins PureComponent<CardStackProps, {
key: number,
navigationState: NavigationState<{
path?: string,
params?: {[key: string]: any}
...
style?: StyleProp<ViewStyle>
	...
	declare export class TabStack mixins PureComponent<TabStackProps, {
navigationState: NavigationState<{
title?: string,
testID?: string
}>,
...
nextLocation: Location) => boolean;
	...
	declare export var getRoute: (stack: RouteProps[], location: Location) => Route | void;
	declare export var renderSubView: (
render: (propsA: any, propsB: any) => ReactNode,
additionalProps?: any) => (ownProps: any) => ReactNode;
	declare export var build: <Item>(children: Array<ReactElement<Item>>, oldBuild?: Item[]) => Item[];
	declare export var runHistoryListenner: (history: History, onListenHistory: () => void) => () => void;
    }
