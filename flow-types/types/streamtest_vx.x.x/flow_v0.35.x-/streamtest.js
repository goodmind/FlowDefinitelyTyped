declare module 'streamtest' {
        import type {
          PassThrough,Readable,ReadableOptions,Writable,WritableOptions
        } from 'stream';
 ...
 * @returns A new readable stream
 */
declare function v2$fromObjects(objects: NonNull[], timeout?: number): Readable
 ...
 * @returns A new readable stream
 */
declare function v2$fromErroredChunks(err: Error, chunks: Chunk[], timeout?: number): Readable
 ...
 * @returns A new readable stream
 */
declare function v2$fromErroredObjects(err: Error, objects: NonNull[], timeout?: number): Readable
 ...
 */
declare function v2$toChunks(cb: (err: Error, chunks: Chunk[]) => any): Writable
 ...
 * @returns A new writable stream
 */
declare function v2$toObjects(cb: (err: Error, objects: NonNull[]) => any): Writable
 ...
 * @param chunks The chunks to write
 */
declare function v2$syncError(stream: Writable, err: Error, chunks: Chunk[]): void
