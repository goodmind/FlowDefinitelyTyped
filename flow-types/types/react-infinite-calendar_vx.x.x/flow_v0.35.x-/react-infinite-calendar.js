...
start: Date,
	...
	declare export type RangedSelectFunction = (rangedDate: RangedSelection) => void;
...
Component?: CalendarClass
	...
	declare export class Calendar mixins React.Component<ReactInfiniteCalendarProps> {}
	...
	declare export function withDateSelection(component: CalendarClass): CalendarClass

	declare export function withMultipleDates(component: CalendarClass): CalendarClass

	declare export function withKeyboardSupport(component: CalendarClass): CalendarClass

	declare export function defaultMultipleDateInterpolation(component: CalendarClass): CalendarClass

	declare export default class ReactInfiniteCalendar mixins React.Component<ReactInfiniteCalendarProps> {}
    }
