...
static +KeepAll: Class<DDS$HistoryKind__KeepAll> & DDS$HistoryKind__KeepAll & 0;// 0
static +KeepLast: Class<DDS$HistoryKind__KeepLast> & DDS$HistoryKind__KeepLast & 1;// 1
...
declare export  class DDS$ReliabilityKind {
  constructor(...args: empty): mixed;
static +Reliable: Class<DDS$ReliabilityKind__Reliable> & DDS$ReliabilityKind__Reliable & 0;// 0
static +BestEffort: Class<DDS$ReliabilityKind__BestEffort> & DDS$ReliabilityKind__BestEffort & 1;// 1
...
declare export  class DDS$DurabilityKind {
  constructor(...args: empty): mixed;
static +Volatile: Class<DDS$DurabilityKind__Volatile> & DDS$DurabilityKind__Volatile & 0;// 0
static +TransientLocal: Class<DDS$DurabilityKind__TransientLocal> & DDS$DurabilityKind__TransientLocal & 1;// 1
static +Transient: Class<DDS$DurabilityKind__Transient> & DDS$DurabilityKind__Transient & 2;// 2
static +Persistent: Class<DDS$DurabilityKind__Persistent> & DDS$DurabilityKind__Persistent & 3;// 3
 ...
 */
declare export var DDS$TopicQos: DDS$EntityQos;


/**
 * DataReader quality of service object
 */
declare export var DDS$DataReaderQos: DDS$EntityQos;


/**
 * DataWriter quality of service object
 */
declare export var DDS$DataWriterQos: DDS$EntityQos;

declare export class DDS$Topic  {
 ...
 * @param {DDS$TopicQos} qos - topic Qos
...
declare export class DDS$DataReader  {
...
declare export class DDS$DataWriter  {
...
declare export class DDS$DataCache  {
