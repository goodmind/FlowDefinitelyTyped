 ...
 */
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeMilliseconds(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeSeconds(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeMinutes(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeHours(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeDays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeWeeks(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeSundays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeMondays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeTuesdays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeWednesdays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeThursdays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeFridays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeSaturdays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeMonths(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function timeYears(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcMilliseconds(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcSeconds(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcMinutes(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcHours(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcDays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcWeeks(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcSundays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcMondays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcTuesdays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcWednesdays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcThursdays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcFridays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcSaturdays(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcMonths(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
   ...
   * @param step An optional number of steps to apply when calculating the dates in the range.
   */
  declare export function utcYears(
    start: Date,
    stop: Date,
    step?: number
  ): Date[];
