 ...
 * A D3 Time Interval
 */
declare export interface TimeInterval {
 ...
 */
declare export type CountableTimeInterval = {
 ...
 */
declare export function timeInterval(
floor: (date: Date) => void,
offset: (date: Date, step: number) => void): TimeInterval
...
count: (start: Date, end: Date) => number,
field?: (date: Date) => number): CountableTimeInterval

	
/**
 * Milliseconds Interval in Local Time; the shortest available time unit.
 */
declare export var timeMillisecond: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeMilliseconds(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Seconds Interval in Local Time; seconds (e.g., 01:23:45.0000 AM); 1,000 milliseconds.
 */
declare export var timeSecond: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeSeconds(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Minutes Interval in Local Time; minutes (e.g., 01:02:00 AM); 60 seconds. Note that ECMAScript ignores leap seconds.
 */
declare export var timeMinute: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeMinutes(start: Date, stop: Date, step?: number): Date[]
 ...
 */
declare export var timeHour: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeHours(start: Date, stop: Date, step?: number): Date[]
 ...
 */
declare export var timeDay: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeDays(start: Date, stop: Date, step?: number): Date[]
 ...
 */
declare export var timeWeek: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeWeeks(start: Date, stop: Date, step?: number): Date[]
 ...
 * Weeks in local time may range from 167 to 169 hours due on daylight saving.
 */
declare export var timeSunday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeSundays(start: Date, stop: Date, step?: number): Date[]
 ...
 * Weeks in local time may range from 167 to 169 hours due on daylight saving.
 */
declare export var timeMonday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeMondays(start: Date, stop: Date, step?: number): Date[]
 ...
 * Weeks in local time may range from 167 to 169 hours due on daylight saving.
 */
declare export var timeTuesday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeTuesdays(start: Date, stop: Date, step?: number): Date[]
 ...
 * Weeks in local time may range from 167 to 169 hours due on daylight saving.
 */
declare export var timeWednesday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeWednesdays(start: Date, stop: Date, step?: number): Date[]
 ...
 * Weeks in local time may range from 167 to 169 hours due on daylight saving.
 */
declare export var timeThursday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeThursdays(start: Date, stop: Date, step?: number): Date[]
 ...
 * Weeks in local time may range from 167 to 169 hours due on daylight saving.
 */
declare export var timeFriday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeFridays(start: Date, stop: Date, step?: number): Date[]
 ...
 * Weeks in local time may range from 167 to 169 hours due on daylight saving.
 */
declare export var timeSaturday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeSaturdays(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Month Interval in Local Time; months (e.g., February 1, 2012 at 12:00 AM); ranges from 28 to 31 days.
 */
declare export var timeMonth: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeMonths(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Year Interval in Local Time; years (e.g., January 1, 2012 at 12:00 AM); ranges from 365 to 366 days.
 */
declare export var timeYear: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function timeYears(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Milliseconds Interval in Coordinated Universal Time (UTC); the shortest available time unit.
 */
declare export var utcMillisecond: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcMilliseconds(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Seconds Interval in Coordinated Universal Time (UTC); seconds (e.g., 01:23:45.0000 AM); 1,000 milliseconds.
 */
declare export var utcSecond: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcSeconds(start: Date, stop: Date, step?: number): Date[]
 ...
 */
declare export var utcMinute: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcMinutes(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Hours Interval in Coordinated Universal Time (UTC); Hours (e.g., 01:00 AM); 60 minutes.
 */
declare export var utcHour: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcHours(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Days Interval in Coordinated Universal Time (UTC); days (e.g., February 7, 2012 at 12:00 AM); 24 hours.
 */
declare export var utcDay: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcDays(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Week Interval in Local Time. Alias for sunday; 7 days and 168 hours.
 */
declare export var utcWeek: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcWeeks(start: Date, stop: Date, step?: number): Date[]
 ...
 */
declare export var utcSunday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcSundays(start: Date, stop: Date, step?: number): Date[]
 ...
 * 7 days and 168 hours.
 */
declare export var utcMonday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcMondays(start: Date, stop: Date, step?: number): Date[]
 ...
 * 7 days and 168 hours.
 */
declare export var utcTuesday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcTuesdays(start: Date, stop: Date, step?: number): Date[]
 ...
 * 7 days and 168 hours.
 */
declare export var utcWednesday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcWednesdays(start: Date, stop: Date, step?: number): Date[]
 ...
 * 7 days and 168 hours.
 */
declare export var utcThursday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcThursdays(start: Date, stop: Date, step?: number): Date[]
 ...
 * 7 days and 168 hours.
 */
declare export var utcFriday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcFridays(start: Date, stop: Date, step?: number): Date[]
 ...
 * 7 days and 168 hours.
 */
declare export var utcSaturday: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcSaturdays(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Month Interval in Coordinated Universal Time (UTC); months (e.g., February 1, 2012 at 12:00 AM); ranges from 28 to 31 days.
 */
declare export var utcMonth: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcMonths(start: Date, stop: Date, step?: number): Date[]

	
/**
 * Year Interval in Coordinated Universal Time (UTC); years (e.g., January 1, 2012 at 12:00 AM); ranges from 365 to 366 days.
 */
declare export var utcYear: CountableTimeInterval;
 ...
 * @param step An optional number of steps to apply when calculating the dates in the range.
 */
declare export function utcYears(start: Date, stop: Date, step?: number): Date[]
