declare module "topojson-simplify" {
  ...
  import type { Objects, OrNull, Topology } from "topojson-specification";

  declare export type Triangle = [
    [number, number],
    [number, number],
    [number, number]
  ];
  ...
  declare export function presimplify<T: Objects>(
    topology: Topology<T>,
    weight?: TriangleWeighter
  ): Topology<T>;

  declare export function simplify<T: Objects>(
    topology: Topology<T>,
    minWeight?: number
  ): Topology<T>;
  ...
  declare export function filter<K: Objects>(
    topology: Topology<K>,
    filter: Filter
  ): Topology<OrNull<K>>;
  ...
  declare export function filterAttachedWeight(
    topology: Topology,
    minWeight?: number,
    weight?: RingWeighter
  ): Filter;

  declare export function filterWeight(
    topology: Topology,
    minWeight?: number,
    weight?: RingWeighter
  ): Filter;
  ...
  declare export function sphericalRingArea(
    ring: Ring,
    interior: boolean
  ): number;
