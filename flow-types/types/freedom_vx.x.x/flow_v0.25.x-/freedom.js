declare module "freedom" {
  ...
  declare type freedom$ParentModuleThing = {} & freedom$ModuleSelfConstructor &
  ...
  declare type freedom$FreedomInCoreEnv = {
    (
      manifestPath: string,
      options?: freedom$FreedomInCoreEnvOptions
    ): Promise<freedom$FreedomModuleFactoryManager<any>>
  } & freedom$OnAndEmit<any, any>;
  ...
  declare interface RTCPeerConnection$RTCPeerConnection {
    createOffer(
      options?: RTCPeerConnection$RTCOfferOptions
    ): Promise<RTCPeerConnection$RTCSessionDescription>;
    createAnswer(): Promise<RTCPeerConnection$RTCSessionDescription>;
    setLocalDescription(
      desc: RTCPeerConnection$RTCSessionDescription
    ): Promise<void>;
    ...
    createDataChannel(
      label: string,
      init: RTCPeerConnection$RTCDataChannelInit
    ): Promise<string>;
    ...
    on(
      t: "onicecandidate",
      f: (d: RTCPeerConnection$OnIceCandidateEvent) => void
    ): void;
  ...
  declare interface PgpProvider$PgpProvider {
    ...
    verifyDecrypt(
      data: ArrayBuffer,
      verifyKey?: string
    ): Promise<PgpProvider$VerifyDecryptResult>;
  ...
  declare interface Social$Social {
    ...
    on(
      eventType: "onMessage",
      f: (message: Social$IncomingMessage) => void
    ): void;
    on(
      eventType: "onUserProfile",
      f: (profile: Social$UserProfile) => void
    ): void;
    on(
      eventType: "onClientState",
      f: (status: Social$ClientState) => void
    ): void;
