...
FileCoverage: FileCoverage
	...
	declare export function createCoverageMap(data?: CoverageMap | CoverageMapData): CoverageMap

	declare export function createCoverageSummary(obj?: CoverageSummary): CoverageSummary

	declare export function createFileCoverage(pathOrObject: string | FileCoverageData): FileCoverage
