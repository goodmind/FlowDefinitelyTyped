declare module 'minio' {
	...
	declare export type Region = "us-east-1"
| "us-west-1"
| "us-west-2"
| "eu-west-1"
| "eu-central-1"
...
| string;
	...
	declare export type ResultCallback<T> = (error: Error | null, result: T) => void;
...
bucketName: string,
prefix?: string,
recursive?: boolean): BucketStream<BucketItem>;
listObjectsV2(
bucketName: string,
prefix?: string,
recursive?: boolean): BucketStream<BucketItem>;
...
bucketName: string,
prefix?: string,
recursive?: boolean): BucketStream<IncompleteUploadedBucketItem>;
...
objectName: string,
offset: number,
callback: ResultCallback<Stream>): void;
getPartialObject(
bucketName: string,
objectName: string,
offset: number,
...
objectName: string,
offset: number,
length?: number): Promise<Stream>;
fGetObject(
bucketName: string,
objectName: string,
filePath: string,
callback: NoResultCallback): void;
...
stream: Stream | Buffer | string,
size?: number,
metaData?: ItemBucketMetadata): Promise<string>;
fPutObject(
bucketName: string,
objectName: string,
filePath: string,
...
callback: ResultCallback<BucketItemCopy>): void;
copyObject(
bucketName: string,
objectName: string,
sourceObject: string,
conditions: CopyConditions): Promise<BucketItemCopy>;
statObject(
bucketName: string,
objectName: string,
callback: ResultCallback<BucketItemStat>): void;
...
setBucketNotification(
bucketName: string,
bucketNotificationConfig: NotificationConfig): Promise<void>;
