declare module "tiny-slider-react" {
  ...
  declare export interface ResponsiveOptions {
    [breakpoint: number]: CommonOptions;
  }
  declare export type TinySliderSettings = {
    /**
  ...
  declare export interface TinySliderInfo {
    cloneCount: number;
  ...
  declare export interface TinySliderProps {
  ...
  declare class TinySlider mixins React.Component<TinySliderProps> {}
  declare export default typeof TinySlider;
}
