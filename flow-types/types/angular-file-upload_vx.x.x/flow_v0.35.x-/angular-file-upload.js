 ...
 */
onWhenAddingFileFailed(item: FileItem, filter: Filter, options: {[key: string]: any}): void,
...
onComplete(response: Response, status: number, headers: Headers): void
	...
	declare export type SyncFilter = (item: File | FileLikeObject, options?: {[key: string]: any}) => boolean;
	declare export type AsyncFilter = (
item: File | FileLikeObject,
options: {[key: string]: any} | void,
deferred: angular.IDeferred<any>) => void;
