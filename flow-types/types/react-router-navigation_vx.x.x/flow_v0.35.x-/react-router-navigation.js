declare module 'react-router-navigation' {
        import type {
          Component,ReactNode,ReactElement,ComponentClass
        } from 'react';

	import type {
          StyleProp,ViewProps,ViewStyle,TextStyle
        } from 'react-native';
	...
	import type {
          NavigationTransitionProps,NavigationTransitionSpec
...
prevTransitionProps?: NavigationTransitionProps) => NavigationTransitionSpec,
...
style?: StyleProp<ViewStyle>
	...
	declare export class BottomNavigation mixins Component<BottomNavigationProps, {
key: string
}> {
static defaultProps: {
lazy: true
...
renderSceneComponent: (sceneProps: CardSubViewProps) => ComponentClass<any> | void
}
...
children?: Array<ReactElement<any>>
	...
	declare export class Tabs mixins Component<TabBarComponentProps, {
key: string
}> {
...
props: TabSubViewProps) => ReactElement<any> | null;
