declare module 'n3' {
	...
	declare export interface Prefixes<I> {
[key: string]: I
} 
...
object: $ElementType<Q_In, "object">): Q_Out
	...
	declare export type QuadCallback<Q: BaseQuad> = (result: Q) => void;
	declare export type QuadPredicate<Q: BaseQuad> = (result: Q) => boolean;
	declare export type OTerm = RDF.Term | string | null;
	declare export type Logger = (message?: any, ...optionalParams: any[]) => void;
	declare export interface BlankTriple<Q: RDF.BaseQuad> {
...
(options?: ParserOptions): N3Parser<Q>
} 
...
baseIRI?: string
	...
	declare export type ParseCallback<Q: BaseQuad> = (error: Error, DataFactory$quad: Q, Util$prefixes: Prefixes) => void;
	declare export interface N3Parser<Q: BaseQuad> {
...
(options?: ParserOptions): N3StreamParser<Q>
} 
	declare export var StreamParser: StreamParserConstructor;
	declare export type N3StreamParser<Q: BaseQuad> = {
readable: boolean,
...
(options?: WriterOptions): N3Writer<Q>,
(fd: any, options?: WriterOptions): N3Writer<Q>
} 
	declare export var Writer: WriterConstructor;
	declare export interface N3Writer<Q: RDF.BaseQuad> {
quadToString(
...
(options?: WriterOptions): N3StreamWriter<Q>,
(fd: any, options?: WriterOptions): N3StreamWriter<Q>
} 
	declare export var StreamWriter: StreamWriterConstructor;
	declare export type N3StreamWriter<Q: RDF.BaseQuad> = {} & NodeJS.ReadWriteStream & RDF.Source

	declare export type N3Store<Q_RDF: RDF.BaseQuad, Q_N3: BaseQuad> = {
+size: number,
addQuad(
...
(triples?: Q_RDF[], options?: StoreOptions): N3Store<Q_RDF, Q_N3>
} 
