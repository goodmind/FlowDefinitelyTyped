declare module 'socketcluster-client' {
	...
	declare export function create(options?: SCClientSocket.ClientOptions): SCClientSocket

	
/**
 * @deprecated
 */
declare export function connect(options?: SCClientSocket.ClientOptions): SCClientSocket
