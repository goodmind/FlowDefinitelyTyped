...
cb: (
whatever: null,
cookie: FileCookieStore$FileCookieStore$Cookie | null | void) => void): void;
findCookies(
domain: string,
path: string,
cb: (whatever: null, cookies: FileCookieStore$FileCookieStore$Cookie[]) => void): void;
putCookie(
cookie: FileCookieStore$FileCookieStore$Cookie,
path: string,
key: string,
cb: (whatever: null) => void): void;
updateCookie(
