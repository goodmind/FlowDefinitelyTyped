...
subscribe: (data: FormFields) => void
	...
	declare export type FormHooks<FormFields> = SubscribeArg<FormFields> & (ResponseArgs | PendingArgs);
	declare export interface Props<FormFields> {
render?: (hooks: FormHooks<FormFields>) => ReactNode,
url: string
} 
	declare export default class MailchimpSubscribe<FormFields> mixins Component<Props<FormFields>> {}
    }
