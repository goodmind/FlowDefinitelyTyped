...
constructor(accountID: string, uuid: ua$VisitorOptions | string, context?: {
[key: string]: any
}, persistentParams?: {
[key: string]: any
}): this;
...
pageview(path: ua$PageviewParams | string, callback?: ua$Callback): ua$Visitor;
pageview(path: string, hostname: string, callback?: ua$Callback): ua$Visitor;
pageview(
path: string,
hostname: string,
title: string,
callback?: ua$Callback): ua$Visitor;
pageview(
path: string,
hostname: string,
title: string,
...
screenview(screenName: string, appName: string, callback?: ua$Callback): ua$Visitor;
screenview(
screenName: string,
appName: string,
appVersion: string,
...
params: ua$EventParams,
callback?: ua$Callback): ua$Visitor;
transaction(id: ua$TransactionParams | string, callback?: ua$Callback): ua$Visitor;
transaction(id: string, revenue: string | number, callback?: ua$Callback): ua$Visitor;
transaction(
id: string,
...
params: ua$TransactionParams,
callback?: ua$Callback): ua$Visitor;
item(price: ua$ItemParams | string | number, callback?: ua$Callback): ua$Visitor;
item(
price: string | number,
...
callback?: ua$Callback): ua$Visitor;
i(price: ua$ItemParams | string | number, callback?: ua$Callback): ua$Visitor;
i(
price: string | number,
quantity: string | number,
callback?: ua$Callback): ua$Visitor;
...
params: ua$ItemParams,
callback?: ua$Callback): ua$Visitor;
exception(description: ua$ExceptionParams | string, callback?: ua$Callback): ua$Visitor;
exception(description: string, fatal: boolean, callback?: ua$Callback): ua$Visitor;
exception(
description: string,
fatal: boolean,
params: ua$ExceptionParams,
callback?: ua$Callback): ua$Visitor;
timing(category: ua$TimingParams | string, callback?: ua$Callback): ua$Visitor;
timing(category: string, variable: string, callback?: ua$Callback): ua$Visitor;
timing(
category: string,
variable: string,
time: string | number,
...
tid: string,
options?: ua$MiddlewareOptions): (req: any, res: any, next: (err: any) => void) => void

	declare function ua(accountID: ua$ua$VisitorOptions | string): ua$ua$Visitor

	declare function ua(accountID: string, uuid: ua$ua$VisitorOptions | string): ua$ua$Visitor

	declare function ua(accountID: string, uuid: string, options: ua$ua$VisitorOptions): ua$ua$Visitor
