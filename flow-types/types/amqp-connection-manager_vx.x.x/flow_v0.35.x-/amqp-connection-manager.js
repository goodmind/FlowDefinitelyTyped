declare module 'amqp-connection-manager' {
        import type {
          ConfirmChannel,Connection,Message,Options,Replies
        } from 'amqplib';
 ...
 * connect() options
 */
declare export interface AmqpConnectionManagerOptions {
 ...
 * @param options
 */
declare export function connect(urls: string[], options?: AmqpConnectionManagerOptions): AmqpConnectionManager

	declare export type SetupFunc = ((channel: ConfirmChannel, callback: (error?: Error) => void) => void) | ((channel: ConfirmChannel) => Promise<void>);
	declare export interface CreateChannelOpts {
...
json?: boolean
	...
	declare export type AmqpConnectionManager = {
...
close(): Promise<void>
	...
	declare export type ChannelWrapper = {
addListener(event: string, listener: (...args: any[]) => void): this,
...
callback?: (err: any, ok: Replies.Empty) => void): Promise<void>,
