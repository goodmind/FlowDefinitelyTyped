declare module "watch" {
  declare export type FileOrFiles =
    | fs.Stats
    | {
        [key: string]: fs.Stats
      };
  declare export type Monitor = {
    ...
    on(
      ...
      listener: (f: FileOrFiles, stat: fs.Stats) => void
    ): this,
    on(
      event: "changed",
      listener: (f: FileOrFiles, current: fs.Stats, prev: fs.Stats) => void
    ): this,
  ...
  declare export function createMonitor(
    root: string,
