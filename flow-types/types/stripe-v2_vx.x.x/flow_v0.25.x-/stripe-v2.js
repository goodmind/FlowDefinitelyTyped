declare module "stripe-v2" {
  ...
  declare interface stripe$StripeStatic {
    ...
    getToken(
      ...
      responseHandler: (
        status: number,
        response: stripe$StripeCardTokenResponse
      ) => void
    ): void;
  ...
  declare type stripe$StripeCardDataBrand =
    | "Visa"
    | "American Express"
    | "MasterCard"
    | "Discover"
  ...
  declare type stripe$StripeCardDataFunding =
    | "credit"
    | "debit"
    | "prepaid"
    | "unknown";
  ...
  declare interface stripe$StripeBankAccount {
    createToken(
      ...
      stripeResponseHandler: (
        status: number,
        response: stripe$StripeBankTokenResponse
      ) => void
    ): void;
  ...
  declare type stripe$StripeApplePayBillingContactField =
    | "postalAddress"
    | "name";

  declare type stripe$StripeApplePayShippingContactField =
    | stripe$StripeApplePayBillingContactField
    | "phone"
    | "email";

  declare type stripe$StripeApplePayShipping =
    | "shipping"
    | "delivery"
    | "storePickup"
    | "servicePickup";
