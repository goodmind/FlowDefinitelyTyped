export interface MediumEditor$MediumEditor {
  new(
  ...
  execAction(
    action: string,
    opts?: string | MediumEditor$CreateLinkOptions
  ): boolean;
...
export interface MediumEditor$CoreOptions {
...
export interface MediumEditor$ToolbarOptions {
  align?: string;
  allowMultiParagraphSelection?: boolean;
...
export interface MediumEditor$AnchorPreviewOptions {
  hideDelay?: number;
...
export interface MediumEditor$PlaceholderOptions {
  text?: string;
  hideOnClick?: boolean;
}

export interface MediumEditor$AnchorFormOptions {
...
export interface MediumEditor$PasteOptions {
...
export interface MediumEditor$KeyboardCommandsOptions {
  commands?: MediumEditor$KeyboardCommandOptions[];
}

export interface MediumEditor$KeyboardCommandOptions {
  command: string;
  key: string;
  meta: boolean;
  shift: boolean;
...
export interface MediumEditor$CreateLinkOptions {
  value: string;
  target?: string;
  buttonClass?: string;
}

export interface MediumEditor$PasteHTMLOptions {
  cleanAttrs?: string[];
  cleanTags?: string[];
  unwrapTags?: string[];
}

export interface MediumEditor$ButtonOptions {
  name?: string;
  action?: string;
  aria?: string;
  tagNames?: string[];
...
export type MediumEditor$Button = string | MediumEditor$ButtonOptions;

export type MediumEditor$elementType =
  | string
  | HTMLElement
  | HTMLElement[]
  | NodeList
...
export interface MediumEditor$selectionObject {
  start: number;
  end: number;
}
declare var MediumEditor$MediumEditor: MediumEditor$MediumEditor.MediumEditor$MediumEditor;
declare module "medium-editor" {
  declare export default typeof MediumEditor$MediumEditor;
}
