...
declare export function JsMockito$verify<T>(JsMockito$mock: T, verifier: JsMockito$Verifier): T
 ...
 */
declare export function JsMockito$verifyZeroInteractions(...JsMockito$mock: any[]): void
 ...
 * @param mock A mock object or mock anonymous function (multiple accepted)
 */
declare export function JsMockito$verifyNoMoreInteractions(...JsMockito$mock: any[]): void
...
declare export function JsMockito$mockFunction(funcName: string, delegate: Function): Function
...
declare function verify<T>(JsMockito$mock: T): T
	...
	declare function verify<T>(JsMockito$mock: T, verifier: JsMockito$JsMockito$Verifier): T
