declare module "jquery-typeahead" {
  ...
  declare interface RunningCoder$Typeahead$Options {
    /**
     ...
     * @default false
     */
    hint?: boolean | RunningCoder$Typeahead$CssObject;
     ...
     * @default false
     */
    accent?: boolean | RunningCoder$Typeahead$FromToPair;
     ...
     */
    multiselect?: RunningCoder$Typeahead$MultiSelectSettings;
     ...
     * @default false
     */
    group?: boolean | string | RunningCoder$Typeahead$GroupSetting;
    ...
    dropdownFilter?:
      | boolean
      | "string"
      | RunningCoder$Typeahead$DropdownFilterItem[];
     ...
     */
    dynamicFilter?: false | RunningCoder$Typeahead$DynamicFilterItem[];
     ...
     */
    backdrop?: boolean | RunningCoder$Typeahead$CssObject;
     ...
     */
    source?:
      | RunningCoder$Typeahead$Source
      | RunningCoder$Typeahead$Source[]
      | RunningCoder$Typeahead$SourceTable;
     ...
     */
    callback?: RunningCoder$Typeahead$Callback;
    ...
    selector?: RunningCoder$Typeahead$Selector;
  }

  declare interface RunningCoder$Typeahead$Source {
    /**
     ...
     */
    ajax?:
      | RunningCoder$Typeahead$AJaxSettings
      | ((query?: string) => RunningCoder$Typeahead$AJaxSettings);
  }

  declare type RunningCoder$Typeahead$AJaxSettings = {
    path?: string,
  ...
  declare interface RunningCoder$Typeahead$FromToPair {
    from: string;
    to: string;
  }

  declare interface RunningCoder$Typeahead$SourceTable {
    [key: string]: RunningCoder$Typeahead$Source;
  }

  declare interface RunningCoder$Typeahead$CssObject {
    [key: string]: string;
  }

  declare interface RunningCoder$Typeahead$DynamicFilterItem {
    selector: string;
    key: string;
  }

  declare interface RunningCoder$Typeahead$DropdownFilterItem {
    key: string;
  ...
  declare interface RunningCoder$Typeahead$GroupSetting {
    key: string;
    template: string | ((item: any) => string);
  }

  declare interface RunningCoder$Typeahead$MultiSelectSettings {
    /**
     ...
     */
    data?: any[] | (() => any);
    callback?: RunningCoder$Typeahead$MultiSelectSettingsCallback;
  }

  declare interface RunningCoder$Typeahead$MultiSelectSettingsCallback {
    /**
  ...
  declare interface RunningCoder$Typeahead$Callback {
    /**
  ...
  declare interface RunningCoder$Typeahead$Selector {
    container?: string;
    result?: string;
    list?: string;
    group?: string;
