...
root: {[key: string]: any}): React.ComponentClass<any>
 ...
 * @return a Index root
 */
declare export function createIndex(defaultRoot: {[key: string]: any}): React.ComponentClass<any>
...
connectorDesc: ConnectorDescription): (Composed: React.ComponentType<any>) => React.ComponentClass<any>
...
defaultTranslations: any): (Composed: React.ComponentType<any>) => React.ComponentClass<any>
...
declare export class Configure mixins React.Component<any, any> {}
	declare export function connectAutoComplete(Composed: React.ComponentType<any>): React.ComponentClass<any>

	declare export function connectBreadcrumb(Composed: React.ComponentType<any>): React.ComponentClass<any>

	declare export function connectConfigure(Composed: React.ComponentType<any>): React.ComponentClass<any>
...
currentRefinement: string[]
	...
	declare export type RefinementValue = (searchState: SearchState) => SearchState;
...
stateless: React.StatelessComponent<CurrentRefinementsProvided>): React.ComponentClass<CurrentRefinementsExposed>

	declare export function connectCurrentRefinements<TProps: $Shape<CurrentRefinementsProvided>>(
Composed: React.ComponentType<TProps>): ConnectedComponentClass<TProps, CurrentRefinementsProvided, CurrentRefinementsExposed>
...
defaultRefinement?: NESW
	...
	declare export interface GeoSearchProvided<THit> {
...
stateless: React.StatelessComponent<GeoSearchProvided>): React.ComponentClass<GeoSearchExposed>

	declare export function connectGeoSearch<TProps: $Shape<GeoSearchProvided<THit>>, THit>(
ctor: React.ComponentType<TProps>): ConnectedComponentClass<TProps, GeoSearchProvided<THit>, GeoSearchExposed>

	declare export function connectHierarchicalMenu(Composed: React.ComponentType<any>): React.ComponentClass<any>

	declare export function connectHighlight(Composed: React.ComponentType<any>): React.ComponentClass<any>
 ...
 */
declare export function connectHits<TProps: {
hits: THit[]
}, THit>(
ctor: React.ComponentType<TProps>): ConnectedComponentClass<TProps, {
hits?: THit[]
}>

	declare export function connectHitsPerPage(Composed: React.ComponentType<any>): React.ComponentClass<any>

	declare export interface InfiniteHitsProvided<THit> {
 ...
 */
declare export function connectInfiniteHits(Composed: React.ComponentType<InfiniteHitsProvided>): React.ComponentClass

	declare export function connectInfiniteHits<TProps: $Shape<InfiniteHitsProvided<THit>>, THit>(
ctor: React.ComponentType<TProps>): ConnectedComponentClass<TProps, InfiniteHitsProvided<THit>>
...
stateless: React.StatelessComponent<MenuProvided>): React.ComponentClass<MenuExposed>

	declare export function connectMenu<TProps: $Shape<MenuProvided>>(
ctor: React.ComponentType<TProps>): ConnectedComponentClass<TProps, MenuProvided, MenuExposed>
...
stateless: React.StatelessComponent<NumericMenuProvided>): React.ComponentClass<NumericMenuExposed>

	declare export function connectNumericMenu<TProps: $Shape<NumericMenuProvided>>(
ctor: React.ComponentType<TProps>): ConnectedComponentClass<TProps, NumericMenuProvided, NumericMenuExposed>

	declare export function connectPagination(Composed: React.ComponentType<any>): React.ComponentClass<any>

	declare export function connectPoweredBy(Composed: React.ComponentType<any>): React.ComponentClass<any>

	declare export function connectRange(Composed: React.ComponentType<any>): React.ComponentClass<any>
...
stateless: React.StatelessComponent<RefinementListProvided>): React.ComponentClass<RefinementListExposed>

	declare export function connectRefinementList<TProps: $Shape<RefinementListProvided>>(
ctor: React.ComponentType<TProps>): ConnectedComponentClass<TProps, RefinementListProvided, RefinementListExposed>

	declare export function connectScrollTo(Composed: React.ComponentType<any>): React.ComponentClass<any>
...
stateless: React.StatelessComponent<SearchBoxProvided>): React.ComponentClass<SearchBoxExposed>

	declare export function connectSearchBox<TProps: $Shape<SearchBoxProvided>>(
ctor: React.ComponentType<TProps>): ConnectedComponentClass<TProps, SearchBoxProvided, SearchBoxExposed>

	declare export function connectSortBy(Composed: React.ComponentType<any>): React.ComponentClass<any>

	declare export interface StateResultsProvided<TDoc> {
...
stateless: React.StatelessComponent<StateResultsProvided>): React.ComponentClass
	...
	declare export function connectStateResults<TProps: $Shape<StateResultsProvided<TDoc>>, TDoc>(
ctor: React.ComponentType<TProps>): ConnectedComponentClass<TProps, StateResultsProvided<TDoc>>

	declare export function connectStats(Composed: React.ComponentType<any>): React.ComponentClass<any>

	declare export function connectToggleRefinement(Composed: React.ComponentType<any>): React.ComponentClass<any>
...
statusCode: number
	...
	declare export type ConnectedComponentClass<TProps, TProvidedProps, TExposedProps> = React.ComponentClass<Omit<TProps, TProvidedProps> & TExposedProps>;
 ...
 */
declare export interface SearchResults<TDoc> {
query: string,
hits: Array<Hit<TDoc>>,
index: string,
hitsPerPage: number,
 ...
 */
declare export type Hit<TDoc> = TDoc & {
objectID: string,
...
"_highlightResult": HighlightResult<TDoc>
	...
	declare export type HighlightResult<TDoc> = "There was Conditional Type, use $Call utility type";
	declare type HighlightResultField<TField> = "There was Conditional Type, use $Call utility type";
	declare type HighlightResultArray<TItem> = "There was Conditional Type, use $Call utility type";
