...
declare type Spotify$ErrorTypes = "account_error" | "authentication_error" | "initialization_error" | "playback_error";
...
declare type Spotify$PlaybackInstanceListener = (inst: Spotify$WebPlaybackInstance) => void;

declare type Spotify$PlaybackStateListener = (s: Spotify$PlaybackState) => void;

declare type Spotify$AddListenerFn = ((event: "ready" | "not_ready", cb: Spotify$PlaybackInstanceListener) => void) & ((event: "player_state_changed", cb: Spotify$PlaybackStateListener) => void) & ((event: Spotify$ErrorTypes, cb: Spotify$ErrorListener) => void);
...
cb?: Spotify$ErrorListener | Spotify$PlaybackInstanceListener | Spotify$PlaybackStateListener): void;
pause(): Promise<void>;
