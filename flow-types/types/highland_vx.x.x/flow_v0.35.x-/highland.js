 ...
 * @api public
 */
(): Highland$Highland$Stream<R>,
(xs: Highland$Highland$Stream<R>[]): Highland$Highland$Stream<R>,
(xs: R[]): Highland$Highland$Stream<R>,
(xs: (
push: (err: Error | null, x?: R | Highland$Highland$Nil) => void,
next: () => void) => void): Highland$Highland$Stream<R>,
(xs: Highland$Highland$Stream<R>): Highland$Highland$Stream<R>,
(xs: NodeJS.ReadableStream): Highland$Highland$Stream<R>,
(eventName: string, xs: NodeJS.EventEmitter, mappingHint?: Highland$Highland$MappingHint): Highland$Highland$Stream<R>,
(xs: Highland$Highland$Thenable<Highland$Highland$Stream<R>>): Highland$Highland$Stream<R>,
(xs: Highland$Highland$Thenable<R>): Highland$Highland$Stream<R>,
 ...
 * @api public
 */
isNil<R>(x: R | Highland$Highland$Nil): boolean,
...
wrapCallback(
f: Function,
mappingHint?: Highland$Highland$MappingHint): (...args: any[]) => Highland$Highland$Stream<any>,
 ...
 * @api public
 */
keys(obj: Object): Highland$Highland$Stream<string>,
 ...
 * @api public
 */
pairs(obj: Object): Highland$Highland$Stream<any[]>,
pairs(obj: any[]): Highland$Highland$Stream<any[]>,
 ...
 * @api public
 */
values(obj: Object): Highland$Highland$Stream<any>,
 ...
 * @param - any number of arguments to pre-apply to the function
 * @returns Function
 * @api public
 */
 ...
 */
declare class Highland$StreamError  {
 ...
 */
declare class Highland$StreamRedirect<R>  {
 ...
 */
batch(n: number): Highland$Stream<R[]>,
...
// => [1, 2], [3], [4]
 */
batchWithTimeOrCount(ms: number, n: number): Highland$Stream<R[]>,
...
f: (
err: Error,
x: R | Highland$Highland$Nil,
push: (err: Error | null, value?: U | Highland$Highland$Nil) => void,
...
// => 1, 2, 3
 */
doto(f: (x: R) => void): Highland$Stream<R>,
 ...
 */
drop(n: number): Highland$Stream<R>,
 ...
 */
errors(
f: (err: Error, push: (err: Error | null, x?: R) => void) => void): Highland$Stream<R>,
...
// => {type: 'blogpost', title: 'foo'}
 */
findWhere(props: Object): Highland$Stream<R>,
 ...
 */
ratelimit(num: number, ms: number): Highland$Stream<R>,
 ...
 */
tap(f: (x: R) => void): Highland$Stream<R>,
 ...
 * @api public
 */
uniqBy(f: (a: R, b: R) => boolean): Highland$Stream<R>,
 ...
 * @param {Highland$Stream} ys - alternate stream to use if this stream is empty
 * @api public
 */
 ...
 * @api public
 */
parallel<U>(n: number): Highland$Stream<U>,
...
through(thru: NodeJS.ReadWriteStream): Highland$Stream<any>,
 ...
 * @section Streams
 * @name Stream.zip(ys)
 * @param {Array | Highland$Stream} ys - the other stream to combine values with
 * @api public
 */
 ...
 * @api public
 */
each(f: (x: R) => void): Pick<Highland$Stream<R>, "done">,
 ...
 */
toNodeStream(options?: {[key: string]: any}): NodeJS.ReadableStream,
...
declare type Highland$PipeableStream<T, R> = {} & Highland$Stream<R>


declare interface Highland$PipeOptions {
end: boolean
} 

declare type Highland$MappingHint = number | string[] | Function;declare var highland: HighlandStatic;declare module 'highland' {
