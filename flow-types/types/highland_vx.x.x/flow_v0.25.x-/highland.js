...
declare interface HighlandStatic {
   ...
   * @api public
   */
  <R>(): Highland$Highland$Stream<R>;
  <R>(xs: Highland$Highland$Stream<R>[]): Highland$Highland$Stream<R>;
  <R>(xs: R[]): Highland$Highland$Stream<R>;
  <R>(
    xs: (
  ...
  <R>(xs: Highland$Highland$Stream<R>): Highland$Highland$Stream<R>;
  <R>(xs: NodeJS.ReadableStream): Highland$Highland$Stream<R>;
  <R>(
    eventName: string,
    xs: NodeJS.EventEmitter,
    mappingHint?: Highland$Highland$MappingHint
  ): Highland$Highland$Stream<R>;
  <R>(
    xs: Highland$Highland$Thenable<Highland$Highland$Stream<R>>
  ): Highland$Highland$Stream<R>;
  <R>(xs: Highland$Highland$Thenable<R>): Highland$Highland$Stream<R>;
  ...
  wrapCallback(
    f: Function,
    mappingHint?: Highland$Highland$MappingHint
  ): (...args: any[]) => Highland$Highland$Stream<any>;
...
declare interface Highland$Thenable<R> {
  then<U>(
    ...
    onRejected: (error: any) => Highland$Thenable<U>
  ): Highland$Thenable<U>;
  then<U>(
    onFulfilled: (value: R) => Highland$Thenable<U>,
...
declare type Highland$MappingHint = number | string[] | Function;
