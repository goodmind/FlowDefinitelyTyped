...
static getOptionalFloatingPointField(msg: Message, fieldNumber: number): number | void;
...
fieldNumber: number,
required?: number): T;
static getRepeatedWrapperField<T: Message>(msg: Message, ctor: {
new (): T
...
static setRepeatedWrapperField<T: Message>(msg: Message, fieldNumber: number, value?: T[]): void;
...
static registerMessageType(id: number, function Object() { [native code] }: typeof Message): void;
...
declare type Message$StaticToObject = (includeInstance: boolean, msg: Message) => {};
...
[key: string]: number
}, ctor: typeof Message, toObjectFn: Message$Message$StaticToObject, isRepeated: number): this;
...
constructor(arr: Array<[K, V]>, valueCtor?: {
new (init: any): V
}): this;
toArray(): Array<[K, V]>;
...
value: T
	...
	declare type BinaryReadReader = (msg: any, binaryReader: BinaryReader) => void;
	declare type BinaryRead = (msg: any, reader: BinaryReadReader) => void;
	declare type BinaryWriteCallback = (value: any, binaryWriter: BinaryWriter) => void;
	declare type BinaryWrite = (fieldNumber: number, value: any, writerCallback: BinaryWriteCallback) => void;
...
constructor(decoder?: BinaryDecoder, next?: () => number | boolean | string | null, elements?: Array<number | boolean | string>): this;
static alloc(
...
static +INVALID: Class<BinaryConstants$FieldType__INVALID> & BinaryConstants$FieldType__INVALID & -1;// -1
static +DOUBLE: Class<BinaryConstants$FieldType__DOUBLE> & BinaryConstants$FieldType__DOUBLE & 1;// 1
static +FLOAT: Class<BinaryConstants$FieldType__FLOAT> & BinaryConstants$FieldType__FLOAT & 2;// 2
static +INT64: Class<BinaryConstants$FieldType__INT64> & BinaryConstants$FieldType__INT64 & 3;// 3
static +UINT64: Class<BinaryConstants$FieldType__UINT64> & BinaryConstants$FieldType__UINT64 & 4;// 4
static +INT32: Class<BinaryConstants$FieldType__INT32> & BinaryConstants$FieldType__INT32 & 5;// 5
static +FIXED64: Class<BinaryConstants$FieldType__FIXED64> & BinaryConstants$FieldType__FIXED64 & 6;// 6
static +FIXED32: Class<BinaryConstants$FieldType__FIXED32> & BinaryConstants$FieldType__FIXED32 & 7;// 7
static +BOOL: Class<BinaryConstants$FieldType__BOOL> & BinaryConstants$FieldType__BOOL & 8;// 8
static +STRING: Class<BinaryConstants$FieldType__STRING> & BinaryConstants$FieldType__STRING & 9;// 9
static +GROUP: Class<BinaryConstants$FieldType__GROUP> & BinaryConstants$FieldType__GROUP & 10;// 10
static +MESSAGE: Class<BinaryConstants$FieldType__MESSAGE> & BinaryConstants$FieldType__MESSAGE & 11;// 11
static +BYTES: Class<BinaryConstants$FieldType__BYTES> & BinaryConstants$FieldType__BYTES & 12;// 12
static +UINT32: Class<BinaryConstants$FieldType__UINT32> & BinaryConstants$FieldType__UINT32 & 13;// 13
static +ENUM: Class<BinaryConstants$FieldType__ENUM> & BinaryConstants$FieldType__ENUM & 14;// 14
static +SFIXED32: Class<BinaryConstants$FieldType__SFIXED32> & BinaryConstants$FieldType__SFIXED32 & 15;// 15
static +SFIXED64: Class<BinaryConstants$FieldType__SFIXED64> & BinaryConstants$FieldType__SFIXED64 & 16;// 16
static +SINT32: Class<BinaryConstants$FieldType__SINT32> & BinaryConstants$FieldType__SINT32 & 17;// 17
static +SINT64: Class<BinaryConstants$FieldType__SINT64> & BinaryConstants$FieldType__SINT64 & 18;// 18
static +FHASH64: Class<BinaryConstants$FieldType__FHASH64> & BinaryConstants$FieldType__FHASH64 & 30;// 30
static +VHASH64: Class<BinaryConstants$FieldType__VHASH64> & BinaryConstants$FieldType__VHASH64 & 31;// 31

}

declare class BinaryConstants$FieldType__INVALID mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__DOUBLE mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__FLOAT mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__INT64 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__UINT64 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__INT32 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__FIXED64 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__FIXED32 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__BOOL mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__STRING mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__GROUP mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__MESSAGE mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__BYTES mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__UINT32 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__ENUM mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__SFIXED32 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__SFIXED64 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__SINT32 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__SINT64 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__FHASH64 mixins BinaryConstants$FieldType {}
declare class BinaryConstants$FieldType__VHASH64 mixins BinaryConstants$FieldType {}


declare  class BinaryConstants$WireType {
  constructor(...args: empty): mixed;
static +INVALID: Class<BinaryConstants$WireType__INVALID> & BinaryConstants$WireType__INVALID & -1;// -1
static +VARINT: Class<BinaryConstants$WireType__VARINT> & BinaryConstants$WireType__VARINT & 0;// 0
static +FIXED64: Class<BinaryConstants$WireType__FIXED64> & BinaryConstants$WireType__FIXED64 & 1;// 1
static +DELIMITED: Class<BinaryConstants$WireType__DELIMITED> & BinaryConstants$WireType__DELIMITED & 2;// 2
static +START_GROUP: Class<BinaryConstants$WireType__START_GROUP> & BinaryConstants$WireType__START_GROUP & 3;// 3
static +END_GROUP: Class<BinaryConstants$WireType__END_GROUP> & BinaryConstants$WireType__END_GROUP & 4;// 4
static +FIXED32: Class<BinaryConstants$WireType__FIXED32> & BinaryConstants$WireType__FIXED32 & 5;// 5

}

declare class BinaryConstants$WireType__INVALID mixins BinaryConstants$WireType {}
declare class BinaryConstants$WireType__VARINT mixins BinaryConstants$WireType {}
declare class BinaryConstants$WireType__FIXED64 mixins BinaryConstants$WireType {}
declare class BinaryConstants$WireType__DELIMITED mixins BinaryConstants$WireType {}
declare class BinaryConstants$WireType__START_GROUP mixins BinaryConstants$WireType {}
declare class BinaryConstants$WireType__END_GROUP mixins BinaryConstants$WireType {}
declare class BinaryConstants$WireType__FIXED32 mixins BinaryConstants$WireType {}


declare var BinaryConstants$FieldTypeToWireType: (fieldType: BinaryConstants$FieldType) => BinaryConstants$WireType;
