...
filepath: string,
data: any,
options?: writeJsonFile$writeJsonFile$Options): Promise<void>
...
declare function writeJsonFile$sync(filepath: string, data: any, options?: writeJsonFile$Options): void
