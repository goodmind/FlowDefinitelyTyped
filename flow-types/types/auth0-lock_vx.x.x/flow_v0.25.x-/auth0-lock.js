...
declare type Auth0LockAdditionalSignUpFieldOptionsFunction = (
  callback: Auth0LockAdditionalSignUpFieldOptionsCallback
) => void;
declare type Auth0LockAdditionalSignUpFieldPrefillCallback = (
  error: auth0.Auth0Error,
  prefill: string
) => void;
declare type Auth0LockAdditionalSignUpFieldPrefillFunction = (
  callback: Auth0LockAdditionalSignUpFieldPrefillCallback
) => void;
declare interface Auth0LockAdditionalTextSignUpField {
  type?: "text";
  icon?: string;
  name: string;
  options?:
...
declare type Auth0LockAvatarUrlCallback = (
  error: auth0.Auth0Error,
  url: string
) => void;
declare type Auth0LockAvatarDisplayNameCallback = (
  error: auth0.Auth0Error,
  displayName: string
) => void;
...
declare interface Auth0LockStatic {
  ...
  getProfile(
    token: string,
    callback: (error: auth0.Auth0Error, profile: auth0.Auth0UserProfile) => void
  ): void;
  getUserInfo(
    token: string,
    callback: (error: auth0.Auth0Error, profile: auth0.Auth0UserProfile) => void
