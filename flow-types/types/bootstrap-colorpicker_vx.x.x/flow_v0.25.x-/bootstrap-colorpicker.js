declare module "bootstrap-colorpicker" {
  declare type ColorFormat = "hex" | "rgb" | "rgba";
  declare type ColorPickerAlignOptions = "right" | "left";
  declare type ColorPickerEvents =
    | "create"
    | "showPicker"
    | "hidePicker"
    | "changeColor"
  ...
  declare type ColorPickerEventObject = {
    color: Color
  } & JQueryEventObject;
