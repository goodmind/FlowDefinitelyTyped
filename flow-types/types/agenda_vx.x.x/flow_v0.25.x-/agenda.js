declare module "agenda" {
  ...
  declare class Agenda mixins EventEmitter {
     ...
     */
    constructor(
      config?: Agenda$Agenda$AgendaConfiguration,
      cb?: ResultCallback<Collection>
    ): this;
    ...
    define<T: Agenda$Agenda$JobAttributesData>(
      name: string,
      handler: (job: Agenda$Agenda$Job<T>, done: (err?: Error) => void) => void
    ): void;
    define<T: Agenda$Agenda$JobAttributesData>(
      name: string,
  ...
  declare interface Agenda$JobAttributes<
    T: Agenda$JobAttributesData = Agenda$JobAttributesData
  > {
    /**
     * The record identity.
     */
