 ...
 */
create<T: Agenda$Agenda$JobAttributesData>(
name: string,
 ...
 * @param query
 */
jobs<T: Agenda$Agenda$JobAttributesData>(
 ...
 */
define<T: Agenda$Agenda$JobAttributesData>(
name: string,
 ...
 */
every<T: Agenda$Agenda$JobAttributesData>(
 ...
 * @param data An optional argument that will be passed to the processing function under job.attrs.data.
 */
schedule<T: Agenda$Agenda$JobAttributesData>(
when: Date | string,
names: string,
 ...
 * @param data An optional argument that will be passed to the processing function under job.attrs.data.
 */
now<T: Agenda$Agenda$JobAttributesData>(
name: string,
data?: T): Promise<Agenda$Agenda$Job<T>>;
 ...
 */
declare interface Agenda$JobAttributes<T: Agenda$JobAttributesData> {
 ...
 * A scheduled job.
 */
declare interface Agenda$Job<T: Agenda$JobAttributesData> {
