declare module "d3-array" {
     ...
     */
    declare export type ThresholdCountGenerator<Value: number | void> = (
 ...
 */
    ...
    declare export interface HistogramCommon<
        Datum,
        Value: number | Date | void
    > {
        (data: ArrayLike<Datum>): Array<Bin<Datum, Value>>;
    ...
    declare export type HistogramGeneratorDate<Datum, Value: Date | void> = {
        ...
        domain(
            domainAccessor: (values: ArrayLike<Value>) => [Date, Date]
        ): this,
 ...
 */
    ...
    declare export type HistogramGeneratorNumber<
        Datum,
        Value: number | void
    > = {
 ...
 */
    ...
    declare export function histogram(): HistogramGeneratorNumber<
        number,
        number
    >;
