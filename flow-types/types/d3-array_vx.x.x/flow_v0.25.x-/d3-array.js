declare module "d3-array" {
   ...
   */
  declare export type Primitive = number | string | boolean | Date;
   ...
   */
  declare export function max(array: ArrayLike<string>): string | void;

  /**
   * Return the maximum value in the array of numbers using natural order.
   */
  declare export function max<T: Numeric>(array: ArrayLike<T>): T | void;
   ...
   */
  declare export function max<T, U: Numeric>(
    array: ArrayLike<T>,
    accessor: (datum: T, index: number, array: ArrayLike<T>) => U | void | null
  ): U | void;

  /**
   * Return the minimum value in the array using natural order.
   */
  declare export function min(array: ArrayLike<string>): string | void;

  /**
   * Return the minimum value in the array using natural order.
   */
  declare export function min<T: Numeric>(array: ArrayLike<T>): T | void;
   ...
   */
  declare export function extent(
   ...
   * Return the min and max simultaneously.
   */
  declare export function extent<T: Numeric>(
    array: ArrayLike<T>
  ): [T, T] | [void, void];
   ...
   */
  declare export function mean<T: Numeric>(
    array: ArrayLike<T | void | null>
  ): number | void;
   ...
   */
  declare export function median<T: Numeric>(
    array: ArrayLike<T | void | null>
  ): number | void;
   ...
   */
  declare export function quantile<T: Numeric>(
    array: ArrayLike<T | void | null>,
    p: number
  ): number | void;

  declare export function quantile<T>(
    array: ArrayLike<T>,
    p: number,
    accessor: (
      element: T,
   ...
   */
  declare export function sum<T: Numeric>(
    array: ArrayLike<T | void | null>
  ): number;
   ...
   */
  declare export function deviation<T: Numeric>(
    array: ArrayLike<T | void | null>
  ): number | void;
   ...
   */
  declare export function variance<T: Numeric>(
    array: ArrayLike<T | void | null>
  ): number | void;
  ...
  declare export function bisectLeft(
    array: ArrayLike<number>,
    x: number,
    lo?: number,
    hi?: number
  ...
  declare export function bisectRight(
    array: ArrayLike<number>,
    x: number,
    lo?: number,
    hi?: number
  ...
  declare export interface Bisector<T, U> {
  ...
  declare export function bisector<T, U>(accessor: (x: T) => U): Bisector<T, U>;

  /**
   * Compares two primitive values for sorting (in ascending order).
   */
  declare export function ascending(
    a: Primitive | void,
    b: Primitive | void
  ): number;
   ...
   */
  declare export function descending(
    a: Primitive | void,
    b: Primitive | void
  ): number;
   ...
   */
  declare export function cross<S, T>(
    a: ArrayLike<S>,
    b: ArrayLike<T>
  ): Array<[S, T]>;
   ...
   */
  declare export function cross<S, T, U>(
    a: ArrayLike<S>,
    b: ArrayLike<T>,
    reducer: (a: S, b: T) => U
  ): U[];
   ...
   */
  declare export function merge<T>(arrays: ArrayLike<ArrayLike<T>>): T[];
   ...
   */
  declare export function pairs<T>(array: ArrayLike<T>): Array<[T, T]>;
   ...
   */
  declare export function pairs<T, U>(
    array: ArrayLike<T>,
    reducer: (a: T, b: T) => U
  ): U[];
   ...
   */
  declare export function permute<T>(
    array: {
      [key: number]: T
    },
   ...
   */
  declare export function permute<T, K: $Keys<T>>(
    object: T,
    keys: ArrayLike<K>
  ): Array<$ElementType<T, K>>;
  ...
  declare export function shuffle(
    array: Int8Array,
    lo?: number,
    hi?: number
  ): Int8Array;
   ...
   * @param count count + 1 is the approximate number of ticks to be returned by d3.ticks.
   */
  declare export function tickIncrement(
    start: number,
    stop: number,
    count: number
  ): number;
   ...
   * @param count count + 1 is the approximate number of ticks to be returned by d3.ticks.
   */
  declare export function tickStep(
    start: number,
    stop: number,
    count: number
  ): number;
   ...
   */
  declare export function transpose<T>(matrix: ArrayLike<ArrayLike<T>>): T[][];
   ...
   */
  declare export function zip<T>(...arrays: Array<ArrayLike<T>>): T[][];

  declare export type Bin<Datum, Value: number | Date | void> = {
    x0: Value | void,
    x1: Value | void
  } & Array<Datum>;
   ...
   */
  declare export type ThresholdCountGenerator<
    Value: number | void = number | void
   ...
   */
  declare export type ThresholdNumberArrayGenerator<Value: number | void> = (
   ...
   */
  declare export type ThresholdDateArrayGenerator<Value: Date | void> = (
    values: ArrayLike<Value>,
    min: Date,
    max: Date
  ) => Value[];
   ...
   */
  declare export type ThresholdArrayGenerator = ThresholdNumberArrayGenerator<number>;
   ...
   *
   */
  declare export interface HistogramGenerator<
    Datum,
    Value: number | Date | void
  > {
    ...
    domain(): (values: ArrayLike<Value>) => [Value, Value] | [void, void];
 ...
 */
  ...
  declare export interface HistogramCommon<Datum, Value: number | Date | void> {
    (data: ArrayLike<Datum>): Array<Bin<Datum, Value>>;
    value(): (d: Datum, i: number, data: ArrayLike<Datum>) => Value;
    value(
      valueAccessor: (d: Datum, i: number, data: ArrayLike<Datum>) => Value
  ...
  declare export type HistogramGeneratorDate<Datum, Value: Date | void> = {
 ...
 */
  ...
  } & HistogramCommon<Datum, Date>;

  declare export type HistogramGeneratorNumber<Datum, Value: number | void> = {
    domain(): (values: ArrayLike<Value>) => [number, number] | [void, void],
 ...
 */
  ...
  } & HistogramCommon<Datum, Value>;

  declare export function histogram(): HistogramGeneratorNumber<number, number>;

  declare export function histogram<
    Datum,
    Value: number | void
 ...
 */
  declare export function histogram<
    Datum,
    Value: number | Date | void
  >(): HistogramGenerator<Datum, Value>;

  declare export function thresholdFreedmanDiaconis(
    values: ArrayLike<number | void>,
    min: number,
    max: number
  ): number;

  declare export function thresholdScott(
    values: ArrayLike<number | void>,
    min: number,
    max: number
  ): number;

  declare export function thresholdSturges(
    values: ArrayLike<number | void>
  ): number;
}
