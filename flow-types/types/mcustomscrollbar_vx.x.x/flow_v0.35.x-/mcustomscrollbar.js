declare module 'mcustomscrollbar' {
        declare type MCustomScrollbar$Factory = (jQuery: JQueryStatic) => void;
...
scrollTo: string,
parameter: any,
options?: MCustomScrollbar$MCustomScrollbar$ScrollToParameterOptions): JQuery,

/**
 * Creates a new mCustomScrollbar with the specified or default options
 * @param options Override default options
 */
mCustomScrollbar(options?: MCustomScrollbar$MCustomScrollbar$CustomScrollbarOptions): JQuery
} 
	declare module 'malihu-custom-scrollbar-plugin' {
        declare var factory: MCustomScrollbar$MCustomScrollbar$Factory;
