...
declare function BluetoothSerial$on(eventName: string, handler: () => void): void


declare function BluetoothSerial$removeListener(eventName: string, handler: () => void): void


declare function BluetoothSerial$write(data: Buffer | string): Promise<boolean>


declare function BluetoothSerial$list(): Promise<Array<{
id: string,
name: string
}>>
