...
send(
mail: MailMessage,
callback: (err: Error | null, info?: mailgunTransport$Information) => void): void
}
	declare function mailgunTransport(
options: mailgunTransport$mailgunTransport$Options): mailgunTransport$mailgunTransport$MailgunTransport
