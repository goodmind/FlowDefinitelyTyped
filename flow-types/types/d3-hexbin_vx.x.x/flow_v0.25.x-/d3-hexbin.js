declare module "d3-hexbin" {
  declare export type HexbinBin<T> = {
    /**
  ...
  declare export interface Hexbin<T> {
    /**
     ...
     */
    (points: T[]): core$Array<HexbinBin<T>>;
     ...
     */
    centers(): core$Array<[number, number]>;
   ...
   */
  declare export function hexbin<T>(): Hexbin<T>;
}
