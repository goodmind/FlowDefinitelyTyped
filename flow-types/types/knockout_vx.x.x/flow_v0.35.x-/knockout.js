...
} declare interface KnockoutComputedFunctions<T> {} declare interface KnockoutObservableFunctions<T> {
 ...
 */
(evaluatorFunction: () => T, context?: any, options?: KnockoutComputedOptions<T>): KnockoutComputed<T>,
 ...
 * @param context Defines the value of 'this' when evaluating the computed observable
 */
(options: KnockoutComputedDefine<T>, context?: any): KnockoutComputed<T>
...
} & KnockoutReadonlyComputed<T> & KnockoutObservable<T> & KnockoutComputedFunctions<T>
...
target: any,
event: string): KnockoutSubscription
} & KnockoutReadonlyObservable<$ReadOnlyArray<T>> & KnockoutReadonlyObservableArrayFunctions<T>
...
(value: null): KnockoutObservable<T | null>,
(): KnockoutObservable<T | void>
} 
/**
...
} declare interface KnockoutBindingHandler<E: Node, V, VM> {
after?: Array<string>,
init?: (
element: E,
valueAccessor: () => V,
...
} declare interface KnockoutVirtualElement {} declare interface KnockoutVirtualElements {
allowedBindings: {
...
callback: (result: KnockoutComponentTypes$Definition | null) => void): void,
loadTemplate(
componentName: string,
templateConfig: any,
callback: (result: Node[] | null) => void): void,
loadViewModel(
componentName: string,
viewModelConfig: any,
...
register(
componentName: string,
config: KnockoutComponentTypes$KnockoutComponentTypes$Config | KnockoutComponentTypes$KnockoutComponentTypes$EmptyConfig): void,
...
get(
componentName: string,
callback: (definition: KnockoutComponentTypes$KnockoutComponentTypes$Definition) => void): void,
...
} declare var ko: KnockoutStatic;declare module 'knockout' {
