declare module 'bunnymq' {
        declare function bunnymq(options?: bunnymq$bunnymq$Options): bunnymq$bunnymq$Instance
 ...
 * @param callback A callback.
 */
subscribe<T>(queueName: string, callback: bunnymq$ConsumerCallback<T>): void,
...
queueName: string,
message: any,
options?: bunnymq$ProducerOptions): Promise<T>
} 
 ...
 * @return The consumer response.
 */
produce<T>(queue: string, message: any, options?: bunnymq$ProducerOptions): Promise<T>
} 
