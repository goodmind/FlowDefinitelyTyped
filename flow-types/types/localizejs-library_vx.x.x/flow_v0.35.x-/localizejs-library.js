declare module 'localizejs-library' {
        declare interface Context$Options {
...
declare interface Context$RateData {
fromCurrency: string,
toCurrency: string,
rate: string
} 
 ...
 */
initialize(options: LocalizeJS$Context.Context$Options): void,
...
variables?: any,
callback?: (translation: string | HTMLElement) => void): void,
...
fromCurrency: string,
toCurrency: string,
callback: (error: any, rateData: LocalizeJS$Context.Context$RateData) => void): void
};
    }
