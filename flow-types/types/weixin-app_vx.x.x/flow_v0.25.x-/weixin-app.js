declare module "weixin-app" {
  ...
  declare function wx$downloadFile(
    options: wx$DownloadFileOptions
  ): wx$DownloadTask;
  ...
  declare function wx$sendSocketMessage(
    options: wx$SendSocketMessageOptions
  ): void;
  ...
  declare function wx$onSocketMessage(
    callback: (res: wx$DataResponse) => void
  ): void;
   ...
   * @version 1.2.0
   */
  declare function wx$saveImageToPhotosAlbum(
    options: wx$SaveImageToPhotosAlbumOptions
  ): void;
  ...
  declare interface wx$RecorderManager {
     ...
     */
    onFrameRecorded(
      callback?: (options: wx$OnFrameRecordedOptions) => void
    ): void;
   ...
   * @deprecated 1.2.0
   */
  declare function wx$getBackgroundAudioPlayerState(
    options: wx$GetBackgroundAudioPlayerStateOptions
  ): void;
   ...
   * @deprecated 1.2.0
   */
  declare function wx$playBackgroundAudio(
    options: wx$PlayBackgroundAudioOptions
  ): void;
   ...
   * @deprecated 1.2.0
   */
  declare function wx$pauseBackgroundAudio(
    options?: wx$PlayBackgroundAudioOptions
  ): void;
   ...
   * @deprecated 1.2.0
   */
  declare function wx$seekBackgroundAudio(
    options: wx$SeekBackgroundAudioOptions
  ): void;
   ...
   * @deprecated 1.2.0
   */
  declare function wx$stopBackgroundAudio(
    options?: wx$PlayBackgroundAudioOptions
  ): void;
   ...
   * @deprecated 1.6.0
   */
  declare function wx$createAudioContext(
    audioId: string,
    instance: any
  ): wx$AudioContext;
   ...
   */
  declare function wx$saveVideoToPhotosAlbum(
    options: wx$SaveVideoOptions
  ): void;
  ...
  declare interface wx$CameraContext {
     ...
     * 开始录像
     */
    startRecord(options: wx$StartRecordOptions): void;

    /**
     * 结束录像，成功则返回封面与视频
     */
    stopRecord(options: wx$StopRecordOptions): void;
  }
   ...
   * @version 1.7.0
   */
  declare function wx$createLivePlayerContext(
    id: string,
    instance: any
   ...
   * 获取本地已保存的文件列表
   */
  declare function wx$getSavedFileList(
    options: wx$GetSavedFileListOptions
  ): void;
   ...
   * 获取本地文件的文件信息
   */
  declare function wx$getSavedFileInfo(
    options: wx$GetSavedFileInfoOptions
  ): void;
  ...
  declare interface wx$MapContext {
     ...
     */
    getCenterLocation(
      options: wx$GetCenterLocationOptions
    ): wx$OpenLocationOptions;
  ...
  declare type wx$AccelerometerChangeCallback = (
    res: wx$AccelerometerData
  ) => void;
  ...
  declare function wx$onAccelerometerChange(
    callback: wx$AccelerometerChangeCallback
  ): void;
  ...
  declare function wx$startAccelerometer(
    options: wx$AccelerometerOptions
  ): void;
  ...
  declare function wx$setClipboardData(
    options: wx$SetClipboardDataOptions
  ): void;
   ...
   * @version 1.1.0
   */
  declare function wx$openBluetoothAdapter(
    options: wx$OpenBluetoothAdapterOptions
  ): void;
   ...
   * @version 1.1.0
   */
  declare function wx$closeBluetoothAdapter(
    options: wx$CloseBluetoothAdapterOptions
  ): void;
   ...
   * @version 1.1.0
   */
  declare function wx$getBluetoothAdapterState(
    options: wx$GetBluetoothAdapterStateOptions
  ): void;
   ...
   * @version 1.1.0
   */
  declare function wx$onBluetoothAdapterStateChange(
    callback: (res: wx$BluetoothAdapterState) => void
  ): void;
   ...
   * });
   */
  declare function wx$startBluetoothDevicesDiscovery(
    options: wx$StartBluetoothDevicesDiscoveryOptions
  ): void;
   ...
   * @version 1.1.0
   */
  declare function wx$stopBluetoothDevicesDiscovery(
    options: wx$StopBluetoothDevicesDiscoveryOptions
  ): void;
   ...
   */
  declare function wx$getBluetoothDevices(
    options: wx$GetBluetoothDevicesOptions
  ): void;
   ...
   * @version 1.1.0
   */
  declare function wx$onBluetoothDeviceFound(
    callback: (res: {
      devices: wx$BluetoothDevice[]
    }) => void
  ): void;
   ...
   * @version 1.1.0
   */
  declare function wx$getConnectedBluetoothDevices(
    options: wx$GetConnectedBluetoothDevicesOptions
  ): void;
   ...
   * @version 1.1.0
   */
  declare function wx$createBLEConnection(
    options: wx$CreateBLEConnectionOptions
  ): void;
   ...
   * @version 1.1.0
   */
  declare function wx$closeBLEConnection(
    options: wx$CloseBLEConnectionOptions
  ): void;
   ...
   * 获取蓝牙设备所有 service（服务）
   */
  declare function wx$getBLEDeviceServices(
    options: wx$GetBLEDeviceServicesOptions
  ): void;
   ...
   */
  declare function wx$getBLEDeviceCharacteristics(
    options: wx$GetBLEDeviceCharacteristicsOptions
  ): void;
   ...
   */
  declare function wx$readBLECharacteristicValue(
    options: wx$ReadBLECharacteristicValue
  ): void;
   ...
   */
  declare function wx$writeBLECharacteristicValue(
    options: wx$WriteBLECharacteristicValue
  ): void;
   ...
   */
  declare function wx$notifyBLECharacteristicValueChanged(
    options: wx$NotifyBLECharacteristicValueChanged
  ): void;
   ...
   * @version 1.2.0
   */
  declare function wx$startBeaconDiscovery(
    options: wx$StartBeaconDiscoveryOptions
  ): void;
   ...
   * @version 1.2.0
   */
  declare function wx$stopBeaconDiscovery(
    options: wx$StopBeaconDiscoveryOptions
  ): void;
   ...
   * @version 1.2.0
   */
  declare function wx$onBeaconUpdate(
    callback?: (beacons: wx$Beacon[]) => void
  ): void;
   ...
   * @version 1.2.0
   */
  declare function wx$onBeaconServiceChange(
  ...
  declare function wx$setScreenBrightness(
    options: wx$SetScreenBrightnessOptions
  ): void;
  ...
  declare function wx$getScreenBrightness(
    options?: wx$GetScreenBrightnessOptions
  ): void;
  ...
  declare function wx$setKeepScreenOn(
    options?: wx$SetKeepScreenOnOptions
  ): void;
   ...
   * @version 1.6.0
   */
  declare function wx$onGetWifiList(
    callback?: (res: wx$GetWifiListOptions) => void
  ): void;
   ...
   * @version 1.6.0
   */
  declare function wx$getConnectedWifi(
    options?: wx$GetConnectedWifiOptions
  ): void;
   ...
   * @version 1.4.3
   */
  declare function wx$setNavigationBarTitle(
    options: wx$SetNavigationBarTitleOptions
  ): void;
   ...
   * @version 1.4.3
   */
  declare function wx$setNavigationBarColor(
    options: wx$SetNavigationBarColorOptions
  ): void;
  ...
  declare type wx$TimingFunction =
    | "linear"
    | "ease"
    | "ease-in"
    | "ease-in-out"
   ...
   */
  declare function wx$createAnimation(
    options?: wx$CreateAnimationOptions
  ): wx$Animation;
  ...
  declare interface wx$IntersectionObserver {
    ...
    observe(
      selector?: string,
      callback?: (response: wx$ObserveResponse) => void
    ): wx$IntersectionObserver;
    disconnect(): void;
  }
  ...
  declare interface wx$SelectorQuery {
     ...
     */
    in(
      component: wx$Component<{ [key: string]: any }, { [key: string]: any }>
    ): wx$SelectorQuery;
   ...
   */
  declare function wx$canvasToTempFilePath(
    options: wx$CanvasToTempFilePathOptions
  ): void;
   ...
   * @version 1.9.0
   */
  declare function wx$canvasGetImageData(
    options: wx$CanvasImageDataOptions
  ): void;
   ...
   * @version 1.9.0
   */
  declare function wx$canvasPutImageData(
    options: wx$CanvasImageDataOptions
  ): void;
   ...
   * @version 1.2.0
   */
  declare function wx$updateShareMenu(
    options?: wx$UpdateShareMenuOptions
  ): void;
   ...
   */
  declare function wx$checkIsSupportSoterAuthentication(
    options: wx$CheckIsSupportSoterAuthenticationOptions
  ): void;
   ...
   * 开始 SOTER 生物认证
   */
  declare function wx$startSoterAuthentication(
    options: wx$StartSoterAuthenticationOptions
  ): void;
   ...
   */
  declare function wx$checkIsSoterEnrolledInDevice(
    options: wx$CheckIsSoterEnrolledInDeviceOptions
  ): void;
   ...
   * 选择用户的发票抬头。
   */
  declare function wx$chooseInvoiceTitle(
    options: wx$ChooseInvoiceTitleOptions
  ): void;
   ...
   * 打开同一公众号下关联的另一个小程序。
   */
  declare function wx$navigateToMiniProgram(
    options: wx$NavigateToMiniProgramOptions
  ): void;
   ...
   */
  declare function wx$navigateBackMiniProgram(
    options: wx$NavigateBackMiniProgramOptions
  ): void;
  ...
  declare type wx$TouchEventType =
    | "tap"
    | "touchstart"
    | "touchmove"
    | "touchcancel"
  ...
  declare type wx$TransitionEventType =
    | "transitionend"
    | "animationstart"
    | "animationiteration"
    | "animationend";

  declare type wx$EventType =
    | "input"
    | "form"
    | "submit"
    | "scroll"
  ...
  declare type wx$BuiltInEvent<T: wx$EventType, Detail> = {} & BaseEvent<
    T,
    Detail
  >;

  declare type wx$CustomEvent<T: string, Detail> = {} & BaseEvent<T, Detail>;

  /**
   * 指定focus时的光标位置
   * @version 1.5.0
   */
  declare type wx$InputEvent = {} & BuiltInEvent<
    "input",
    {
      value: string,
      cursor: number
  ...
  declare type wx$FormEvent = {} & BuiltInEvent<
    "form",
    {
      value: {
  ...
  declare type wx$ScrollEvent = {} & BuiltInEvent<"scroll", {}>;
  ...
  declare type wx$TapEvent = {} & TouchEvent<"tap">;

  declare type wx$TouchStartEvent = {} & TouchEvent<"touchstart">;

  declare type wx$TouchEndEvent = {} & TouchEvent<"touchend">;

  declare type wx$TouchMoveEvent = {} & TouchEvent<"touchmove">;

  declare type wx$TouchCancelEvent = {} & TouchEvent<"touchcancel">;

  declare type wx$TouchForceChangeEvent = {} & TouchEvent<"touchforcechange">;
   ...
   * @param data 上报的自定义数据
   */
  declare function wx$reportAnalytics(
    eventName: string,
    data: { [key: string]: any }
  ): void;
  ...
  declare type wx$UnboxBehaviorData<T> =
    "There was Conditional Type, use $Call utility type";

  declare type wx$UnboxBehaviorProps<T> =
    "There was Conditional Type, use $Call utility type";

  declare type wx$UnboxBehaviorMethod<T> =
    "There was Conditional Type, use $Call utility type";

  declare type wx$UnboxBehaviorsMethods<
    Behaviors: Array<wx$Behavior<{}, {}, {}> | string>
  > = wx$UnionToIntersection<wx$UnboxBehaviorMethod<wx$ArrayType<Behaviors>>>;

  declare type wx$UnboxBehaviorsData<
    Behaviors: Array<wx$Behavior<{}, {}, {}> | string>
  > = wx$UnionToIntersection<wx$UnboxBehaviorData<wx$ArrayType<Behaviors>>>;

  declare type wx$UnboxBehaviorsProps<
    Behaviors: Array<wx$Behavior<{}, {}, {}> | string>
  > = wx$UnionToIntersection<wx$UnboxBehaviorProps<wx$ArrayType<Behaviors>>>;

  declare type wx$CombinedInstance<
    Instance: wx$Component<Data, Props, Behaviors>,
    Data,
    Methods,
    Props,
    Behaviors: Array<wx$Behavior<{}, {}, {}> | string>
  > = Methods & Instance & wx$UnboxBehaviorsMethods<Behaviors>;

  declare type wx$Prop<T> =
    | (() => T)
    | {
        new(...args: any[]): T & { [key: string]: any }
      };

  declare type wx$PropValidator<T> =
    | wx$PropOptions<T>
    | wx$Prop<T>
    | Array<wx$Prop<T>>;
  ...
  declare type wx$RecordPropsDefinition<T> = $ObjMapi<
    T,
    <K>(K) => wx$PropValidator<$ElementType<T, K>>
  >;

  declare type wx$ArrayPropsDefinition<T> = Array<$Keys<T>>;

  declare type wx$PropsDefinition<T> =
    | wx$ArrayPropsDefinition<T>
    | wx$RecordPropsDefinition<T>;
  ...
  declare type wx$ThisTypedComponentOptionsWithRecordProps<
    V: wx$Component<Data, Props, Behaviors>,
    Data,
    Methods,
    Props,
    Behaviors: Array<wx$Behavior<{}, {}, {}> | string>
  > = { [key: string]: any } & wx$ComponentOptions<
    V,
    Data,
    Methods,
    Props,
  ...
  > &
    ThisType<
      wx$CombinedInstance<V, Data, Methods, $ReadOnly<Props>, Behaviors>
    >;
   ...
   * Component组件参数
   */
  declare type wx$ComponentOptions<
    Instance: wx$Component<Data, Props, Behaviors>,
    Data = wx$DefaultData<Instance>,
    Methods = wx$DefaultMethods<Instance>,
    Props = wx$PropsDefinition<wx$DefaultProps>,
    Behaviors: Array<wx$Behavior<{}, {}, {}> | string> = []
  > = {
    /**
   ...
   */
  declare type wx$PropValueType<Def> =
    "There was Conditional Type, use $Call utility type";

  /**
   * Component实例方法
   */
  declare interface wx$Component<
    D,
    P,
    B: Array<wx$Behavior<{}, {}, {}> | string> = []
  > {
    /**
     * 组件的文件路径
     */
    ...
    data: D &
      ...
      $ObjMapi<
        ...
        <key>(
          key
        ) => wx$PropValueType<$ElementType<P & wx$UnboxBehaviorsProps<B>, key>>
      >;
  ...
  declare interface wx$PageOptions {
     ...
     */
    onShareAppMessage?: (
      options?: wx$PageShareAppMessageOptions
    ) => wx$ShareAppMessage;
   ...
   */
  declare function App<T: wx$AppOptions>(app: T & ThisType<T & wx$App>): void;
   ...
   */
  declare function Page<T: wx$PageOptions & { [key: string]: any }>(
