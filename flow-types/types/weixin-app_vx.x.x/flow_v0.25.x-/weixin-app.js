...
declare type wx$networkType = "2g" | "3g" | "4g" | "wifi" | "unknown" | "none";
...
declare type wx$BuiltInEvent<T: wx$EventType, Detail> = {} & wx$BaseEvent<
  T,
  Detail
>;
 ...
 * @version 1.5.0
 */
declare type wx$InputEvent = {} & wx$BuiltInEvent<
  "input",
  {
    value: string,
    cursor: number
...
declare type wx$FormEvent = {} & wx$BuiltInEvent<
  "form",
  {
    value: {
...
> = { [key: string]: any } & wx$ComponentOptions<
  ...
  Behaviors
> &
  ThisType<wx$CombinedInstance<V, Data, Methods, $ReadOnly<Props>, Behaviors>>;
...
declare module "weixin-app" {
   ...
   */
  declare function App<T: wx$wx$AppOptions>(
    app: T & ThisType<T & wx$wx$App>
  ): void;
  ...
  declare function Component<
    ...
    M,
    P,
    B: Array<wx$wx$Behavior<{}, {}, {}> | string>
  >(
    options?: wx$wx$ThisTypedComponentOptionsWithRecordProps<
      wx$wx$Component<D, P, B>,
      D,
      M,
      P,
      B
  ...
  >(
    ...
    D & wx$wx$UnboxBehaviorsData<B>,
    P & wx$wx$UnboxBehaviorsProps<B>,
    M & wx$wx$UnboxBehaviorsMethods<B>
  >;
