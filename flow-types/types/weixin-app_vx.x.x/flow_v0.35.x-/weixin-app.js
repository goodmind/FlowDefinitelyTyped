...
declare interface wx$BaseOptions<R, E> {
...
declare interface wx$PropOptions<T> {
...
declare interface wx$ComponentRelation<D, P> {
 ...
 * Component组件参数
 */
declare type wx$ComponentOptions<Instance: wx$Component<Data, Props, Behaviors>, Data, Methods, Props, Behaviors: Array<wx$Behavior<{}, {}, {}> | string>> = {
 ...
 */
createIntersectionObserver(options?: wx$CreateIntersectionObserverOption): wx$IntersectionObserver,
