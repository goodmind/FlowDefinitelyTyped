 ...
 */
declare export interface Panel<T> {
 ...
 * detached elements.
 */
declare export type CommandEvent<CurrentTarget: EventTarget> = {
...
path: string
	...
	declare export interface FilesystemChangeBasic<Action: "created" | "modified" | "deleted" | "renamed"> {
...
dispose(): void
	...
	declare export type JQueryCompatible<Element: Node> = {
jquery: string
} & Iterable<Element>
