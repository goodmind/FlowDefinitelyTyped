declare module 'koa-helmet' {
        import type {
          IHelmetConfiguration,IHelmetFrameguardConfiguration,IHelmetHstsConfiguration,IHelmetXssFilterConfiguration,IHelmetDnsPrefetchControlConfiguration,IHelmetHpkpConfiguration,IHelmetReferrerPolicyConfiguration
        } from 'helmet';
	...
	declare type koaHelmet$KoaHelmetContentSecurityPolicyDirectiveFunction = (ctx: Context) => string;

declare type koaHelmet$KoaHelmetCspDirectiveValue = string | koaHelmet$KoaHelmetContentSecurityPolicyDirectiveFunction;
...
contentSecurityPolicy(options?: koaHelmet$KoaHelmetContentSecurityPolicyConfiguration): Middleware,
