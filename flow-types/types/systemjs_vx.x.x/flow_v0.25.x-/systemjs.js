declare interface SystemJSLoader$ModulesList {
  [bundleName: string]: string[];
}

declare interface SystemJSLoader$PackageList<T> {
 ...
 */
declare type SystemJSLoader$ModuleFormat =
  | "esm"
  | "cjs"
  | "amd"
  | "global"
 ...
 */
declare type SystemJSLoader$Transpiler =
  | "plugin-traceur"
  | "plugin-babel"
  | "plugin-typescript"
  | "traceur"
...
declare type SystemJSLoader$ConfigMap = SystemJSLoader$PackageList<
  string | SystemJSLoader$PackageList<string>
>;
...
declare type SystemJSLoader$System = {
   ...
   */
  getConfig(): SystemJSLoader$Config,
...
declare module "global" {
  declare var SystemJS: typeof SystemJSLoader;

  /**
   * @deprecated use SystemJS https://github.com/systemjs/systemjs/releases/tag/0.19.10
   */
  declare var SystemJSLoader$System: typeof SystemJSLoader;
  declare var __moduleName: string;
}
declare module "systemjs" {
  declare module.exports: typeof SystemJSLoader;

  declare var SystemJSLoader: SystemJSLoader$SystemJSLoader$System;
}
