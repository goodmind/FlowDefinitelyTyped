...
declare class Cesium$ArcGisImageServerTerrainProvider mixins Cesium$TerrainProvider {
constructor(options: {
url: string,
token?: string,
proxy?: any,
...
constructor(minimum?: Cesium$Cartesian3, maximum?: Cesium$Cartesian3, center?: Cesium$Cartesian3): this;
clone(result?: Cesium$AxisAlignedBoundingBox): Cesium$AxisAlignedBoundingBox;
intersect(plane: Cesium$Cartesian4): Cesium$Intersect;
equals(right?: Cesium$AxisAlignedBoundingBox): boolean;
static fromPoints(
positions: Cesium$Cartesian3[],
result?: Cesium$AxisAlignedBoundingBox): Cesium$AxisAlignedBoundingBox;
static clone(
box: Cesium$AxisAlignedBoundingBox,
result?: Cesium$AxisAlignedBoundingBox): Cesium$AxisAlignedBoundingBox;
static equals(
left?: Cesium$AxisAlignedBoundingBox,
right?: Cesium$AxisAlignedBoundingBox): boolean;
static intersect(box: Cesium$AxisAlignedBoundingBox, plane: Cesium$Cartesian4): Cesium$Intersect
}
...
result?: Cesium$BoundingRectangle): Cesium$BoundingRectangle;
...
static intersect(
left: Cesium$BoundingRectangle,
right: Cesium$BoundingRectangle): Cesium$Intersect;
static equals(left?: Cesium$BoundingRectangle, right?: Cesium$BoundingRectangle): boolean
}
...
static fromPoints(
positions: Cesium$Cartesian3[],
result?: Cesium$BoundingSphere): Cesium$BoundingSphere;
...
result?: Cesium$Cartesian2): Cesium$Interval;
static projectTo2D(
sphere: Cesium$BoundingSphere,
projection?: any,
result?: Cesium$BoundingSphere): Cesium$BoundingSphere;
...
array: number[],
startingIndex?: number,
result?: Cesium$BoxGeometry): Cesium$BoxGeometry;
...
array: number[],
startingIndex?: number,
result?: Cesium$BoxOutlineGeometry): Cesium$BoxOutlineGeometry;
static createGeometry(boxGeometry: Cesium$BoxOutlineGeometry): Cesium$Geometry
}
...
absoluteEpsilon?: number): boolean;
toString(): string;
...
static pack(value: Cesium$Cartesian2, array: number[], startingIndex?: number): number[];
static unpack(
array: number[],
startingIndex?: number,
result?: Cesium$Cartesian2): Cesium$Cartesian2;
static fromArray(
array: number[],
startingIndex?: number,
result?: Cesium$Cartesian2): Cesium$Cartesian2;
...
declare class Cesium$Cartesian3 mixins Cesium$Packable, Cesium$PositionProperty {
x: number;
y: number;
z: number;
...
static pack(value: Cesium$Cartesian3, array: number[], startingIndex?: number): number[];
static unpack(
array: number[],
startingIndex?: number,
...
z: number,
w: number,
result?: Cesium$Cartesian4): Cesium$Cartesian4;
...
static pack(value: Cesium$Cartesian4, array: number[], startingIndex?: number): number[];
static unpack(
array: number[],
startingIndex?: number,
result?: Cesium$Cartesian4): Cesium$Cartesian4;
...
latitude: number,
height?: number,
result?: Cesium$Cartographic): Cesium$Cartographic;
static fromDegrees(
longitude: number,
latitude: number,
height?: number,
...
array: number[],
startingIndex?: number,
result?: Cesium$CircleGeometry): number[];
static createGeometry(circleGeometry: Cesium$CircleGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$CircleOutlineGeometry): number[];
static createGeometry(circleGeometry: Cesium$CircleOutlineGeometry): Cesium$Geometry
}
...
static add(left: Cesium$Color, right: Cesium$Color, result?: Cesium$Color): Cesium$Color;
static byteToFloat(number: number): number;
static clone(color: Cesium$Color, result?: Cesium$Color): Cesium$Color;
static divide(left: Cesium$Color, right: Cesium$Color, result?: Cesium$Color): Cesium$Color;
static divideByScalar(color: Cesium$Color, scalar: number, result?: Cesium$Color): Cesium$Color;
...
blue?: number,
alpha?: number,
result?: Cesium$Color): Cesium$Color;
...
static mod(left: Cesium$Color, right: Cesium$Color, result?: Cesium$Color): Cesium$Color;
static multiply(left: Cesium$Color, right: Cesium$Color, result?: Cesium$Color): Cesium$Color;
static multiplyByScalar(color: Cesium$Color, scalar: number, result?: Cesium$Color): Cesium$Color;
static pack(value: Cesium$Color, array: number[], startingIndex?: number): number[];
static subtract(left: Cesium$Color, right: Cesium$Color, result?: Cesium$Color): Cesium$Color;
static unpack(array: number[], startingIndex?: number, result?: Cesium$Color): Cesium$Color;
...
normalize: boolean;
constructor(red?: number, green?: number, blue?: number, alpha?: number): this;
static fromColor(color: Cesium$Color): Cesium$ColorGeometryInstanceAttribute;
...
array: number[],
startingIndex?: number,
result?: Cesium$CorridorGeometry): Cesium$CorridorGeometry;
static createGeometry(corridorGeometry: Cesium$CorridorGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$CorridorOutlineGeometry): Cesium$CorridorOutlineGeometry;
static createGeometry(corridorOutlineGeometry: Cesium$CorridorOutlineGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$CylinderGeometry): Cesium$CylinderGeometry;
static createGeometry(cylinderGeometry: Cesium$CylinderGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$CylinderOutlineGeometry): Cesium$CylinderOutlineGeometry;
static createGeometry(cylinderGeometry: Cesium$CylinderOutlineGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$EllipseGeometry): Cesium$EllipseGeometry;
static createGeometry(ellipseGeometry: Cesium$EllipseGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$EllipseOutlineGeometry): Cesium$EllipseOutlineGeometry;
static createGeometry(ellipseGeometry: Cesium$EllipseOutlineGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$Ellipsoid): Cesium$Ellipsoid
}
...
startHeading: number;
endHeading: number;
constructor(start?: Cesium$Cartographic, end?: Cesium$Cartographic, ellipsoid?: Cesium$Ellipsoid): this;
...
array: number[],
startingIndex?: number,
result?: Cesium$EllipsoidGeometry): Cesium$EllipsoidGeometry;
static createGeometry(ellipsoidGeometry: Cesium$EllipsoidGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$EllipsoidOutlineGeometry): Cesium$EllipsoidOutlineGeometry;
static createGeometry(ellipsoidGeometry: Cesium$EllipsoidOutlineGeometry): Cesium$Geometry
}
...
projectPointOntoPlane(cartesian: Cesium$Cartesian3, result?: Cesium$Cartesian2): Cesium$Cartesian2;
...
static fromPoints(
ellipsoid: Cesium$Ellipsoid,
cartesians: Cesium$Cartesian3): Cesium$EllipsoidTangentPlane
}
...
addEventListener(listener: () => void, scope?: any): Cesium$Event.EventHelper$RemoveCallback;
...
event: Cesium$Event,
listener: () => void,
scope?: any): Cesium$EventHelper.Event$RemoveCallback;
removeAll(): void
}
...
result?: Cesium$HeadingPitchRoll): Cesium$HeadingPitchRoll;
static equals(
left: Cesium$HeadingPitchRoll | null | void,
right: Cesium$HeadingPitchRoll | null | void): boolean;
static equalsEpsilon(
left: Cesium$HeadingPitchRoll | null | void,
...
x: number,
y: number,
level: number): Promise<Cesium$TerrainMesh>;
...
descendantX: number,
descendantY: number,
descendantLevel: number): Promise<Cesium$HeightmapTerrainData>;
...
constructor(julianDayNumber?: number, secondsOfDay?: number, timeStandard?: Cesium$TimeStandard): this;
...
result?: Cesium$GregorianDate): Cesium$GregorianDate;
...
julianDate: Cesium$JulianDate,
seconds: number,
result: Cesium$JulianDate): Cesium$JulianDate;
static addMinutes(
julianDate: Cesium$JulianDate,
minutes: number,
result: Cesium$JulianDate): Cesium$JulianDate;
...
constructor(column0Row0?: number, column1Row0?: number, column0Row1?: number, column1Row1?: number): this;
...
toString(): string;
static pack(value: Cesium$Matrix2, array: number[], startingIndex?: number): number[];
static unpack(
array: number[],
startingIndex?: number,
result?: Cesium$Matrix2): Cesium$Matrix2;
static clone(matrix: Cesium$Matrix2, result?: Cesium$Matrix2): Cesium$Matrix2;
static fromArray(
array: number[],
startingIndex?: number,
result?: Cesium$Matrix2): Cesium$Matrix2;
static fromColumnMajorArray(values: number[], result?: Cesium$Matrix2): Cesium$Matrix2;
static fromRowMajorArray(values: number[], result?: Cesium$Matrix2): Cesium$Matrix2;
static fromScale(scale: Cesium$Cartesian2, result?: Cesium$Matrix2): Cesium$Matrix2;
static fromUniformScale(scale: number, result?: Cesium$Matrix2): Cesium$Matrix2;
...
index: number,
cartesian: Cesium$Cartesian2,
result: Cesium$Cartesian2): Cesium$Matrix2;
static getRow(
matrix: Cesium$Matrix2,
index: number,
result: Cesium$Cartesian2): Cesium$Cartesian2;
...
cartesian: Cesium$Cartesian2,
result: Cesium$Matrix2): Cesium$Matrix2;
static getScale(matrix: Cesium$Matrix2, result: Cesium$Cartesian2): Cesium$Cartesian2;
...
cartesian: Cesium$Cartesian2,
result: Cesium$Cartesian2): Cesium$Cartesian2;
static multiplyByScalar(matrix: Cesium$Matrix2, scalar: number, result: Cesium$Matrix2): Cesium$Matrix2;
static negate(matrix: Cesium$Matrix2, result: Cesium$Matrix2): Cesium$Matrix2;
static transpose(matrix: Cesium$Matrix2, result: Cesium$Matrix2): Cesium$Matrix2;
...
static equalsEpsilon(left: Cesium$Matrix2, right: Cesium$Matrix2, epsilon: number): boolean
}
...
constructor(column0Row0?: number, column1Row0?: number, column2Row0?: number, column0Row1?: number, column1Row1?: number, column2Row1?: number, column0Row2?: number, column1Row2?: number, column2Row2?: number): this;
...
toString(): string;
static pack(value: Cesium$Matrix3, array: number[], startingIndex?: number): number[];
static unpack(
array: number[],
startingIndex?: number,
result?: Cesium$Matrix3): Cesium$Matrix3;
static clone(matrix: Cesium$Matrix3, result?: Cesium$Matrix3): Cesium$Matrix3;
static fromArray(
array: number[],
startingIndex?: number,
result?: Cesium$Matrix3): Cesium$Matrix3;
static fromColumnMajorArray(values: number[], result?: Cesium$Matrix3): Cesium$Matrix3;
static fromRowMajorArray(values: number[], result?: Cesium$Matrix3): Cesium$Matrix3;
...
index: number,
cartesian: Cesium$Cartesian3,
result: Cesium$Cartesian3): Cesium$Matrix3;
static getRow(
matrix: Cesium$Matrix3,
index: number,
result: Cesium$Cartesian3): Cesium$Cartesian3;
...
constructor(column0Row0?: number, column1Row0?: number, column2Row0?: number, column3Row0?: number, column0Row1?: number, column1Row1?: number, column2Row1?: number, column3Row1?: number, column0Row2?: number, column1Row2?: number, column2Row2?: number, column3Row2?: number, column0Row3?: number, column1Row3?: number, column2Row3?: number, column3Row3?: number): this;
...
toString(): string;
static pack(value: Cesium$Matrix4, array: number[], startingIndex?: number): number[];
static unpack(
array: number[],
startingIndex?: number,
result?: Cesium$Matrix4): Cesium$Matrix4;
static clone(matrix: Cesium$Matrix4, result?: Cesium$Matrix4): Cesium$Matrix4;
static fromArray(
array: number[],
startingIndex?: number,
result?: Cesium$Matrix4): Cesium$Matrix4;
static fromColumnMajorArray(values: number[], result?: Cesium$Matrix4): Cesium$Matrix4;
static fromRowMajorArray(values: number[], result?: Cesium$Matrix4): Cesium$Matrix4;
...
result?: Cesium$Matrix4): Cesium$Matrix4;
static fromTranslation(translation: Cesium$Cartesian3, result?: Cesium$Matrix4): Cesium$Matrix4;
static fromScale(scale: Cesium$Cartesian3, result?: Cesium$Matrix4): Cesium$Matrix4;
static fromUniformScale(scale: number, result?: Cesium$Matrix4): Cesium$Matrix4;
static fromCamera(camera: Cesium$Camera, result?: Cesium$Matrix4): Cesium$Matrix4;
...
index: number,
cartesian: Cesium$Cartesian4,
result: Cesium$Cartesian4): Cesium$Matrix4;
static getRow(
matrix: Cesium$Matrix4,
index: number,
result: Cesium$Cartesian4): Cesium$Cartesian4;
...
far: number;
farValue: number;
constructor(near?: number, nearValue?: number, far?: number, farValue?: number): this;
...
result?: Cesium$NearFarScalar): Cesium$NearFarScalar;
static pack(value: Cesium$NearFarScalar, array: number[], startingIndex?: number): number[];
static unpack(
array: number[],
startingIndex?: number,
result?: Cesium$NearFarScalar): Cesium$NearFarScalar;
static equals(left?: Cesium$NearFarScalar, right?: Cesium$NearFarScalar): boolean
}
...
translation: Cesium$Cartesian3;
scale: Cesium$Cartesian3;
constructor(rotation?: Cesium$Matrix3, translation?: Cesium$Cartesian3, scale?: Cesium$Cartesian3): this;
clone(result?: Cesium$ObjectOrientedBoundingBox): Cesium$ObjectOrientedBoundingBox;
equals(right?: Cesium$ObjectOrientedBoundingBox): boolean;
static fromPoints(
positions: Cesium$Cartesian3[],
result?: Cesium$ObjectOrientedBoundingBox): Cesium$ObjectOrientedBoundingBox;
static fromBoundingRectangle(
boundingRectangle: Cesium$BoundingRectangle,
rotation?: number): Cesium$ObjectOrientedBoundingBox;
static clone(
box: Cesium$ObjectOrientedBoundingBox,
result?: Cesium$ObjectOrientedBoundingBox): Cesium$ObjectOrientedBoundingBox;
static intersect(
left: Cesium$ObjectOrientedBoundingBox,
right: Cesium$ObjectOrientedBoundingBox): boolean;
static equals(
left: Cesium$ObjectOrientedBoundingBox,
right: Cesium$ObjectOrientedBoundingBox): boolean
}
...
constructor(occluderBoundingSphere: Cesium$BoundingSphere, cameraPosition: Cesium$Cartesian3): this;
...
cameraPosition: Cesium$Cartesian3,
result?: Cesium$Occluder): Cesium$Occluder;
static computeOccludeePoint(
occluderBoundingSphere: Cesium$BoundingSphere,
occludeePosition: Cesium$Cartesian3,
positions: Cesium$Cartesian3[]): any;
static computeOccludeePointFromRectangle(rectangle: Cesium$Rectangle, ellipsoid?: Cesium$Ellipsoid): any
}
...
url: string,
color: Cesium$Color,
size: number): HTMLCanvasElement | Promise<HTMLCanvasElement>;
fromMakiIconId(
id: string,
color: Cesium$Color,
size: number): HTMLCanvasElement | Promise<HTMLCanvasElement>;
...
point: Cesium$Cartesian3,
normal: Cesium$Cartesian3,
result?: Cesium$Plane): Cesium$Plane;
...
array: number[],
startingIndex?: number,
result?: Cesium$PolygonGeometry): Cesium$PolygonGeometry;
static createGeometry(polygonGeometry: Cesium$PolygonGeometry): Cesium$Geometry
}

declare class Cesium$PolygonHierarchy mixins Cesium$Property {
positions: Cesium$Cartesian3[];
holes: Cesium$PolygonHierarchy[];
constructor(positions?: Cesium$Cartesian3[], holes?: Cesium$PolygonHierarchy[]): this
}
...
array: number[],
startingIndex?: number,
result?: Cesium$PolygonOutlineGeometry): Cesium$PolygonOutlineGeometry;
static fromPositions(
options?: {
positions: Cesium$Cartesian3[],
height?: number,
...
static createGeometry(polygonGeometry: Cesium$PolygonOutlineGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$PolylineGeometry): Cesium$PolylineGeometry;
static createGeometry(polylineGeometry: Cesium$PolylineGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$PolylineVolumeGeometry): Cesium$PolylineVolumeGeometry;
static createGeometry(polylineVolumeGeometry: Cesium$PolylineVolumeGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$PolylineVolumeOutlineGeometry): Cesium$PolylineVolumeOutlineGeometry;
static createGeometry(
polylineVolumeOutlineGeometry: Cesium$PolylineVolumeOutlineGeometry): Cesium$Geometry
}
...
descendantX: number,
descendantY: number,
descendantLevel: number): Promise<Cesium$QuantizedMeshTerrainData>;
interpolateHeight(rectangle: Cesium$Rectangle, longitude: number, latitude: number): number;
isChildAvailable(thisX: number, thisY: number, childX: number, childY: number): boolean;
wasCreatedByUpsampling(): boolean
}
...
headingPitchRoll: Cesium$HeadingPitchRoll,
result?: Cesium$Quaternion): Cesium$Quaternion;
static pack(value: Cesium$Quaternion, array: number[], startingIndex?: number): number[];
static unpack(
array: number[],
startingIndex?: number,
result?: Cesium$Quaternion): Cesium$Quaternion;
...
origin: Cesium$Cartesian3;
direction: Cesium$Cartesian3;
constructor(origin?: Cesium$Cartesian3, direction?: Cesium$Cartesian3): this;
...
constructor(west?: number, south?: number, east?: number, north?: number): this;
...
static pack(value: Cesium$Rectangle, array: number[], startingIndex?: number): number[];
static unpack(
array: number[],
startingIndex?: number,
result?: Cesium$Rectangle): Cesium$Rectangle;
...
array: number[],
startingIndex?: number,
result?: Cesium$RectangleGeometry): Cesium$RectangleGeometry;
static createGeometry(rectangleGeometry: Cesium$RectangleGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$RectangleGeometry): Cesium$RectangleOutlineGeometry;
static createGeometry(rectangleGeometry: Cesium$RectangleOutlineGeometry): Cesium$Geometry
}
...
response: any;
responseHeaders: any;
constructor(statusCode?: number, response?: any, responseHeaders?: string | {[key: string]: any}): this;
toString(): string
}
...
array: number[],
startingIndex?: number,
result?: Cesium$SimplePolylineGeometry): Cesium$SimplePolylineGeometry;
static createGeometry(simplePolylineGeometry: Cesium$SimplePolylineGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$SphereGeometry): Cesium$SphereGeometry;
static createGeometry(sphereGeometry: Cesium$SphereGeometry): Cesium$Geometry
}
...
array: number[],
startingIndex?: number,
result?: Cesium$SphereOutlineGeometry): Cesium$SphereOutlineGeometry;
static createGeometry(sphereGeometry: Cesium$SphereOutlineGeometry): Cesium$Geometry
}
...
toString(): string;
static fromCartesian3(cartesian3: Cesium$Cartesian3, spherical?: Cesium$Spherical): Cesium$Spherical;
static clone(spherical: Cesium$Spherical, result?: Cesium$Spherical): Cesium$Spherical;
static normalize(spherical: Cesium$Spherical, result?: Cesium$Spherical): Cesium$Spherical;
static equals(left: Cesium$Spherical, right: Cesium$Spherical): boolean;
static equalsEpsilon(left: Cesium$Spherical, right: Cesium$Spherical, epsilon?: number): boolean
}
...
evaluate(
time: number,
result?: Cesium$Cartesian3 | Cesium$Quaternion): Cesium$Cartesian3 | Cesium$Quaternion;
...
descendantX: number,
descendantY: number,
descendantLevel: number): Promise<Cesium$TerrainData>;
wasCreatedByUpsampling(): boolean
}
...
constructor(center: Cesium$Cartesian3, vertices: Float32Array, indices: Uint16Array | Uint32Array, minimumHeight: number, maximumHeight: number, boundingSphere3D: Cesium$BoundingSphere, occludeePointInScaledSpace: Cesium$Cartesian3, vertexStride?: number): this
}
...
numberOfTilesAtLevelZero: number): number;
...
y: number,
level: number,
throttleRequests?: boolean): Promise<Cesium$TerrainData>
}
...
retry: boolean;
error: Error;
constructor(provider: Cesium$ImageryProvider | Cesium$TerrainProvider, message: string, x?: number, y?: number, level?: number, timesRetried?: number, error?: Error): this;
static handleError(
...
errorDetails?: Error): Cesium$TileProviderError;
...
dataComparer?: Cesium$TimeInterval.TimeInterval$DataComparer): boolean;
equalsEpsilon(
right: Cesium$TimeInterval,
epsilon: number,
dataComparer?: Cesium$TimeInterval.TimeInterval$DataComparer): boolean;
...
result?: Cesium$TimeInterval): Cesium$TimeInterval;
...
mergeCallback?: Cesium$TimeInterval.TimeInterval$MergeCallback): Cesium$TimeInterval;
static contains(timeInterval: Cesium$TimeInterval, julianDate: Cesium$JulianDate): boolean
}

declare type TimeInterval$MergeCallback = (leftData: any, rightData: any) => any;

declare type TimeInterval$DataComparer = (leftData: any, rightData: any) => boolean;
...
removeAll(): void;
findIntervalContainingDate(date: Cesium$JulianDate): Cesium$TimeInterval | void;
...
dataComparer?: Cesium$TimeInterval.TimeInterval$DataComparer): void;
...
mergeCallback?: Cesium$TimeInterval.TimeInterval$MergeCallback): Cesium$TimeIntervalCollection
}
...
array: number[],
startingIndex?: number,
result?: Cesium$VertexFormat): Cesium$VertexFormat;
static clone(
...
array: number[],
startingIndex?: number,
result?: Cesium$WallGeometry): Cesium$WallGeometry;
static fromConstantHeights(
positions: Cesium$Cartesian3[],
maximumHeight?: number,
minimumHeight?: number,
ellipsoid?: Cesium$Ellipsoid): Cesium$WallGeometry;
...
array: number[],
startingIndex?: number,
result?: Cesium$WallOutlineGeometry): Cesium$WallOutlineGeometry;
static fromConstantHeights(
positions: Cesium$Cartesian3[],
maximumHeight?: number,
minimumHeight?: number,
ellipsoid?: Cesium$Ellipsoid): Cesium$WallOutlineGeometry;
static createGeometry(wallGeometry: Cesium$WallOutlineGeometry): Cesium$Geometry
}
...
constructor(entityCluster: Cesium$EntityCluster, entityCollection: Cesium$EntityCollection): this
}
...
constructor(callback: Cesium$CallbackProperty.requestAnimationFrame$Callback, isConstant: boolean): this;
setCallback(
callback: Cesium$CallbackProperty.requestAnimationFrame$Callback,
isConstant: boolean): void
}

declare type CallbackProperty$Callback = (time?: Cesium$JulianDate, result?: any) => any;

declare class Cesium$CheckerboardMaterialProperty mixins Cesium$MaterialProperty {
...
declare class Cesium$CompositeMaterialProperty mixins Cesium$MaterialProperty {
...
definitionChanged: Cesium$Event;
referenceFrame: Cesium$ReferenceFrame;
constructor(value?: Cesium$Cartesian3, referenceFrame?: Cesium$ReferenceFrame): this;
getValue(time: Cesium$JulianDate, result?: any): any;
setValue(value: Cesium$Cartesian3, referenceFrame?: Cesium$ReferenceFrame): void;
getValueInReferenceFrame(
time: Cesium$JulianDate,
referenceFrame: Cesium$ReferenceFrame,
result?: Cesium$Cartesian3): Cesium$Cartesian3;
...
interval: Cesium$TimeInterval,
sourceUri: string,
entityCollection: Cesium$EntityCollection): void;
...
add(
dataSource: Cesium$DataSource | Promise<Cesium$DataSource>): Promise<Cesium$DataSource>;
...
declare type DataSourceDisplay$VisualizersCallback = (scene: Cesium$Scene, dataSource: Cesium$DataSource) => Cesium$Visualizer[];
...
modelMatrixResult?: Cesium$Matrix4): Cesium$GeometryInstance;
...
computeModelMatrix(time: Cesium$JulianDate, result?: Cesium$Matrix4): Cesium$Matrix4;
...
changed: Cesium$Entity[]): void;
constructor(owner: Cesium$DataSource | Cesium$CompositeEntityCollection): this;
...
constructor(entity: Cesium$Entity, scene: Cesium$Scene, ellipsoid?: Cesium$Ellipsoid, boundingSphere?: Cesium$BoundingSphere): this;
update(time: Cesium$JulianDate): void
}
...
groundPrimitives: Cesium$PrimitiveCollection): Cesium$DynamicGeometryUpdater;
destroy(): void;
isDestroyed(): boolean;
isFilled(time: Cesium$JulianDate): boolean;
isOutlineVisible(time: Cesium$JulianDate): boolean;
createFillGeometryInstance(time: Cesium$JulianDate): Cesium$GeometryInstance;
createOutlineGeometryInstance(time: Cesium$JulianDate): Cesium$GeometryInstance
}

declare class Cesium$GeometryVisualizer mixins Cesium$Visualizer {
constructor(scene: Cesium$Scene, entityCollection: Cesium$EntityCollection, primitives?: Cesium$PrimitiveCollection, groundPrimitives?: Cesium$PrimitiveCollection): this
}
...
constructor(scene: Cesium$Scene, entityCollection: Cesium$EntityCollection): this
}
...
declare class Cesium$PolylineArrowMaterialProperty mixins Cesium$MaterialProperty {
color: Cesium$Property;
...
declare class Cesium$PolylineGlowMaterialProperty mixins Cesium$MaterialProperty {
color: Cesium$Color;
...
declare class Cesium$PolylineOutlineMaterialProperty mixins Cesium$MaterialProperty {
color: Cesium$Color;
outlineColor: Cesium$Color;
outlineWidth: Cesium$Property;
constructor(options?: {
...
declare class Cesium$PolylineVolumeGeometryUpdater mixins Cesium$GeometryUpdater {
constructor(entity: Cesium$Entity, scene: Cesium$Scene): this
}
...
constructor(targetCollection: Cesium$EntityCollection, targetId: string, targetPropertyNames: string): this;
getValueInReferenceFrame(
time: Cesium$JulianDate,
referenceFrame: Cesium$ReferenceFrame,
result?: Cesium$Cartesian3): Cesium$Cartesian3;
...
referenceString: string): Cesium$ReferenceProperty
}

declare class Cesium$SampledPositionProperty mixins Cesium$SampledProperty {
numberOfDerivatives: boolean;
constructor(referenceFrame?: Cesium$ReferenceFrame, numberOfDerivatives?: number): this;
addSample(
time: Cesium$JulianDate,
position: Cesium$Cartesian3,
derivatives?: Cesium$Cartesian3[]): void;
addSamples(
times: Cesium$JulianDate[],
positions: Cesium$Cartesian3[],
derivatives?: any[][]): void;
addSamplesPackedArray(packedSamples: number[], epoch?: Cesium$JulianDate): void
}
...
constructor(type: number | Cesium$Packable, derivativeTypes?: Cesium$Packable[]): this;
...
derivatives?: Cesium$Packable[]): void;
addSamples(
times: Cesium$JulianDate[],
values: Cesium$Packable[],
derivativeValues?: any[][]): void;
addSamplesPackedArray(packedSamples: number[], epoch?: Cesium$JulianDate): void
}
...
declare class Cesium$TimeIntervalCollectionPositionProperty mixins Cesium$PositionProperty {
intervals: Cesium$TimeIntervalCollection;
...
getValue(time?: Cesium$JulianDate, result?: Cesium$Quaternion): Cesium$Quaternion
}
...
declare class Cesium$ArcGisMapServerImageryProvider mixins Cesium$ImageryProvider {
url: string;
...
result?: Cesium$DistanceDisplayCondition): Cesium$DistanceDisplayCondition;
static equals(
left: Cesium$DistanceDisplayCondition,
right: Cesium$DistanceDisplayCondition): boolean;
static pack(
value: Cesium$DistanceDisplayCondition,
array: number[],
startingIndex: number): number[];
...
startingIndex: number,
result: Cesium$DistanceDisplayCondition): Cesium$DistanceDisplayCondition;
clone(result: Cesium$DistanceDisplayCondition): Cesium$DistanceDisplayCondition;
...
width: number;
computeScreenSpacePosition(scene: Cesium$Scene, result?: Cesium$Cartesian2): Cesium$Cartesian2;
equals(other: Cesium$Billboard): boolean;
setImage(
id: string,
image: HTMLImageElement | HTMLCanvasElement | string | Cesium$Billboard.Billboard$CreateImageCallback): void;
setImageSubRegion(id: string, subRegion: Cesium$BoundingRectangle): void
}

declare type Billboard$CreateImageCallback = (
id: string) => HTMLImageElement | HTMLCanvasElement | Promise<HTMLImageElement | HTMLCanvasElement>;
...
declare type EasingFunction$Callback = (time?: Cesium$JulianDate, result?: any) => any;
...
ellipsoid?: Cesium$Ellipsoid,
result?: Cesium$Rectangle): Cesium$Rectangle | void;
...
drawingBufferHeight: number): number;
...
offset: Cesium$Cartesian3 | Cesium$HeadingPitchRange): void;
lookAtTransform(
transform: Cesium$Matrix4,
offset: Cesium$Cartesian3 | Cesium$HeadingPitchRange): void;
...
constructor(element?: HTMLCanvasElement): this;
isMoving(type: Cesium$CameraEventType, modifier?: Cesium$KeyboardEventModifier): boolean;
getMovement(type: Cesium$CameraEventType, modifier?: Cesium$KeyboardEventModifier): any;
getLastMovement(type: Cesium$CameraEventType, modifier?: Cesium$KeyboardEventModifier): any;
isButtonDown(type: Cesium$CameraEventType, modifier?: Cesium$KeyboardEventModifier): boolean;
getStartMousePosition(
type: Cesium$CameraEventType,
modifier?: Cesium$KeyboardEventModifier): Cesium$Cartesian2;
getButtonPressTime(type: Cesium$CameraEventType, modifier?: Cesium$KeyboardEventModifier): Date;
getButtonReleaseTime(type: Cesium$CameraEventType, modifier?: Cesium$KeyboardEventModifier): Date;
reset(): void;
isDestroyed(): boolean;
destroy(): void
}
...
constructor(container: HTMLElement, delimiter?: string, viewport?: HTMLElement): this;
...
constructor(type: string, format?: string, callback?: (res: any) => any): this
}
...
declare class Cesium$GoogleEarthEnterpriseImageryProvider mixins Cesium$ImageryProvider {
url: string;
constructor(options: {
...
declare class Cesium$GoogleEarthEnterpriseMapsProvider mixins Cesium$ImageryProvider {
channel: number;
path: string;
requestType: string;
url: string;
...
declare class Cesium$GoogleEarthEnterpriseTerrainData mixins Cesium$TerrainData {
constructor(options: {
buffer: ArrayBuffer,
negativeAltitudeExponentBias: number,
...
y: number,
level: number,
request?: Request): Promise<Cesium$TerrainData>
}
...
tileHeight?: number,
canvasSize?: number
}, backgroundColor?: Cesium$Color): this
}
...
result?: Cesium$HeadingPitchRange): Cesium$HeadingPitchRange
}
...
constructor(imageryProvider: Cesium$ImageryProvider, options?: {
rectangle?: Cesium$Rectangle,
...
ray: Cesium$Ray,
scene: Cesium$Scene): Promise<Cesium$ImageryLayerFeatureInfo[]> | void;
isDestroyed(): boolean;
destroy(): void
}
...
x: number,
y: number,
level: number): Promise<HTMLImageElement | HTMLCanvasElement>;
pickFeatures(
x: number,
y: number,
level: number,
longitude: number,
latitude: number): Promise<Cesium$ImageryLayerFeatureInfo[]>;
...
static +BASIC: Class<MaterialAppearance$MaterialSupport__BASIC> & MaterialAppearance$MaterialSupport__BASIC & 0;// 0
static +TEXTURED: Class<MaterialAppearance$MaterialSupport__TEXTURED> & MaterialAppearance$MaterialSupport__TEXTURED & 1;// 1
static +ALL: Class<MaterialAppearance$MaterialSupport__ALL> & MaterialAppearance$MaterialSupport__ALL & 2;// 2

}

declare class MaterialAppearance$MaterialSupport__BASIC mixins MaterialAppearance$MaterialSupport {}
declare class MaterialAppearance$MaterialSupport__TEXTURED mixins MaterialAppearance$MaterialSupport {}
declare class MaterialAppearance$MaterialSupport__ALL mixins MaterialAppearance$MaterialSupport {}
...
position: Cesium$Cartesian3,
direction: Cesium$Cartesian3,
up: Cesium$Cartesian3): Cesium$CullingVolume;
getPixelDimensions(
drawingBufferWidth: number,
...
array: number[],
startingIndex: number,
result: Cesium$OrthographicFrustum): Cesium$OrthographicFrustum;
...
array: number[],
startingIndex: number,
result: Cesium$PerspectiveFrustum): Cesium$PerspectiveFrustum;
...
clone(
result?: Cesium$PerspectiveOffCenterFrustum): Cesium$PerspectiveOffCenterFrustum;
...
cartesianToCanvasCoordinates(position: Cesium$Cartesian3, result?: Cesium$Cartesian2): Cesium$Cartesian2;
completeMorph(): void;
destroy(): void;
...
pick(windowPosition: Cesium$Cartesian2, width?: number, height?: number): any;
pickPosition(
windowPosition: Cesium$Cartesian2,
result?: Cesium$Cartesian3): Cesium$Cartesian3;
requestRender(): void
...
declare class Cesium$TileCoordinatesImageryProvider mixins Cesium$ImageryProvider {
constructor(options?: {
tilingScheme?: Cesium$TilingScheme,
ellipsoid?: Cesium$Ellipsoid,
color?: Cesium$Color,
...
declare class Cesium$TileMapServiceImageryProvider mixins Cesium$ImageryProvider {
url: string;
constructor(options?: {
url?: string,
...
rectangle: Cesium$BoundingRectangle;
material: Cesium$Material;
constructor(rectangle?: Cesium$BoundingRectangle, material?: Cesium$Material): this;
update(): void;
isDestroyed(): boolean;
destroy(): void
}

declare class Cesium$WebMapServiceImageryProvider mixins Cesium$ImageryProvider {
url: string;
...
declare class Cesium$WebMapTileServiceImageryProvider mixins Cesium$ImageryProvider {
clock: Cesium$Clock;
dimensions: any;
format: string;
...
constructor(container: Element | string, viewModel: Cesium$AnimationViewModel): this;
isDestroyed(): boolean;
destroy(): void;
resize(): void;
...
declare type AnimationViewModel$DateFormatter = (date: Cesium$JulianDate, viewModel: Cesium$AnimationViewModel) => string;

declare type AnimationViewModel$TimeFormatter = (date: Cesium$JulianDate, viewModel: Cesium$AnimationViewModel) => string;
...
tooltip: string,
iconUrl: string,
creationFunction: Cesium$ProviderViewModel.ProviderViewModel$CreationFunction | Cesium$Command
}): this
}

declare type ProviderViewModel$CreationFunction = (
) => Cesium$ImageryProvider | Cesium$TerrainProvider | Cesium$ImageryProvider[] | Cesium$TerrainProvider[];
...
constructor(container: Element | string, fullscreenElement?: Element | string): this;
isDestroyed(): boolean;
destroy(): void
}
...
constructor(container: Element | string, scene: Cesium$Scene, duration?: number): this;
isDestroyed(): boolean;
destroy(): void
}
...
constructor(container: Element | string, scene: Cesium$Scene, vrElement: Element | string): this;
destroy(): void;
isDestroyed(): boolean
}
...
scene: Cesium$Scene;
constructor(scene: Cesium$Scene, selectionIndicatorElement: Element, container: Element): this;
update(): void;
animateAppear(): void;
animateDepart(): void
}

declare type SelectionIndicatorViewModel$ComputeScreenSpacePosition = (position: Cesium$Cartesian3, result: Cesium$Cartesian2) => Cesium$Cartesian2;
...
tooltip: string;
command: Cesium$Command;
constructor(command: Cesium$Command, options?: {
toggled?: boolean,
tooltip?: string
}): this
}
...
| Cesium$DataSource
| Promise<Cesium$Entity | Cesium$Entity[] | Cesium$EntityCollection | Cesium$DataSource>,
offset?: Cesium$HeadingPitchRange): Promise<boolean>;
flyTo(
target: Cesium$Entity
| Cesium$Entity[]
| Cesium$EntityCollection
...
declare type Viewer$ViewerMixin = (viewer: Cesium$Viewer, options: any) => void;
...
array: any[],
itemToFind: any,
comparator: Cesium$binarySearch.Queue$Comparator): number
...
declare function Cesium$combine(object1?: any, object2?: any, deep?: boolean): any
...
declare function Cesium$loadArrayBuffer(url: string | Promise<string>, headers?: any): Promise<ArrayBuffer>


declare function Cesium$loadBlob(url: string | Promise<string>, headers?: any): Promise<Blob>


declare function Cesium$loadImage(
url: string | Promise<string>,
allowCrossOrigin?: boolean): Promise<HTMLImageElement>


declare function Cesium$loadImageViaBlob(url: string | Promise<string>): Promise<HTMLImageElement>


declare function Cesium$loadJson(url: string | Promise<string>, headers?: any): Promise<any>


declare function Cesium$loadText(url: string | Promise<string>, headers?: any): Promise<string>


declare function Cesium$loadWithXhr(
options: {
url: string | Promise<string>,
responseType?: string,
method?: string,
...
declare function Cesium$loadXML(url: string | Promise<string>, headers?: any): Promise<XMLDocument>


declare function Cesium$mergeSort(
array: any[],
comparator: Cesium$mergeSort.binarySearch$Comparator,
userDefinedObject?: any): void
...
p0: Cesium$Cartesian2 | Cesium$Cartesian3,
p1: Cesium$Cartesian2 | Cesium$Cartesian3,
p2: Cesium$Cartesian2 | Cesium$Cartesian3): boolean


declare function Cesium$queryToObject(queryString: string): any


declare function Cesium$requestAnimationFrame(callback: Cesium$requestAnimationFrame.EasingFunction$Callback): number


declare type requestAnimationFrame$Callback = (time?: Cesium$JulianDate, result?: any) => any;

declare function Cesium$sampleTerrain(
terrainProvider: Cesium$TerrainProvider,
level: number,
positions: Cesium$Cartographic[]): Promise<Cesium$Cartographic[]>


declare function Cesium$subdivideArray(array: any[], numberOfArrays: number): void


declare function Cesium$throttleRequestByServer(
url: string,
requestFunction: Cesium$throttleRequestByServer.throttleRequestByServer$RequestFunction): Promise<any>


declare type throttleRequestByServer$RequestFunction = (url: string) => Promise<any>;

declare function Cesium$createTangentSpaceDebugPrimitive(
options: {
geometry: Cesium$Geometry,
length?: number,
modelMatrix?: Cesium$Matrix4
...
declare function Cesium$viewerCesiumInspectorMixin(viewer: Cesium$Viewer): void
...
declare function Cesium$viewerPerformanceWatchdogMixin(viewer: Cesium$Viewer): void


declare function Cesium$createCommand(func: () => any, canExecute?: boolean): Cesium$Command


declare function Cesium$createTaskProcessorWorker(
workerFunction: Cesium$createTaskProcessorWorker.createTaskProcessorWorker$WorkerFunction): Cesium$createTaskProcessorWorker.createTaskProcessorWorker$TaskProcessorWorkerFunction


declare type createTaskProcessorWorker$WorkerFunction = (parameters: any, transferableObjects: any[]) => any;

declare type createTaskProcessorWorker$TaskProcessorWorkerFunction = (event: any) => void;

declare  class Cesium$ClockRange {
  constructor(...args: empty): mixed;
static +UNBOUNDED: Class<Cesium$ClockRange__UNBOUNDED> & Cesium$ClockRange__UNBOUNDED & 0;// 0
static +CLAMPED: Class<Cesium$ClockRange__CLAMPED> & Cesium$ClockRange__CLAMPED & 1;// 1
static +LOOP_STOP: Class<Cesium$ClockRange__LOOP_STOP> & Cesium$ClockRange__LOOP_STOP & 2;// 2
...
declare  class Cesium$ClockStep {
  constructor(...args: empty): mixed;
static +TICK_DEPENDENT: Class<Cesium$ClockStep__TICK_DEPENDENT> & Cesium$ClockStep__TICK_DEPENDENT & 0;// 0
static +SYSTEM_CLOCK_MULTIPLIER: Class<Cesium$ClockStep__SYSTEM_CLOCK_MULTIPLIER> & Cesium$ClockStep__SYSTEM_CLOCK_MULTIPLIER & 1;// 1
static +SYSTEM_CLOCK: Class<Cesium$ClockStep__SYSTEM_CLOCK> & Cesium$ClockStep__SYSTEM_CLOCK & 2;// 2

}

declare class Cesium$ClockStep__TICK_DEPENDENT mixins Cesium$ClockStep {}
declare class Cesium$ClockStep__SYSTEM_CLOCK_MULTIPLIER mixins Cesium$ClockStep {}
declare class Cesium$ClockStep__SYSTEM_CLOCK mixins Cesium$ClockStep {}


declare  class Cesium$ComponentDatatype {
  constructor(...args: empty): mixed;
static +BYTE: Class<Cesium$ComponentDatatype__BYTE> & Cesium$ComponentDatatype__BYTE & 0;// 0
static +UNSIGNED_BYTE: Class<Cesium$ComponentDatatype__UNSIGNED_BYTE> & Cesium$ComponentDatatype__UNSIGNED_BYTE & 1;// 1
static +SHORT: Class<Cesium$ComponentDatatype__SHORT> & Cesium$ComponentDatatype__SHORT & 2;// 2
static +UNSIGNED_SHORT: Class<Cesium$ComponentDatatype__UNSIGNED_SHORT> & Cesium$ComponentDatatype__UNSIGNED_SHORT & 3;// 3
static +FLOAT: Class<Cesium$ComponentDatatype__FLOAT> & Cesium$ComponentDatatype__FLOAT & 4;// 4
static +DOUBLE: Class<Cesium$ComponentDatatype__DOUBLE> & Cesium$ComponentDatatype__DOUBLE & 5;// 5

}

declare class Cesium$ComponentDatatype__BYTE mixins Cesium$ComponentDatatype {}
declare class Cesium$ComponentDatatype__UNSIGNED_BYTE mixins Cesium$ComponentDatatype {}
declare class Cesium$ComponentDatatype__SHORT mixins Cesium$ComponentDatatype {}
declare class Cesium$ComponentDatatype__UNSIGNED_SHORT mixins Cesium$ComponentDatatype {}
declare class Cesium$ComponentDatatype__FLOAT mixins Cesium$ComponentDatatype {}
declare class Cesium$ComponentDatatype__DOUBLE mixins Cesium$ComponentDatatype {}
...
declare function ComponentDatatype$getSizeInBytes(componentDatatype: Cesium$ComponentDatatype): number
...
| Uint16Array
| Float32Array
| Float64Array): Cesium$ComponentDatatype


declare function ComponentDatatype$validate(componentDatatype: Cesium$ComponentDatatype): boolean


declare function ComponentDatatype$createTypedArray(
componentDatatype: Cesium$ComponentDatatype,
valuesOrLength: number | any[]): Int8Array
| Uint8Array
| Int16Array
| Uint16Array
| Float32Array
...
declare  class Cesium$CornerType {
  constructor(...args: empty): mixed;
static +ROUNDED: Class<Cesium$CornerType__ROUNDED> & Cesium$CornerType__ROUNDED & 0;// 0
static +MITERED: Class<Cesium$CornerType__MITERED> & Cesium$CornerType__MITERED & 1;// 1
static +BEVELED: Class<Cesium$CornerType__BEVELED> & Cesium$CornerType__BEVELED & 2;// 2
...
declare function CubicRealPolynomial$computeDiscriminant(a: number, b: number, c: number, d: number): number


declare function CubicRealPolynomial$computeRealRoots(a: number, b: number, c: number, d: number): number[]


declare  class Cesium$ExtrapolationType {
  constructor(...args: empty): mixed;
static +NONE: Class<Cesium$ExtrapolationType__NONE> & Cesium$ExtrapolationType__NONE & 0;// 0
static +HOLD: Class<Cesium$ExtrapolationType__HOLD> & Cesium$ExtrapolationType__HOLD & 1;// 1
static +EXTRAPOLATE: Class<Cesium$ExtrapolationType__EXTRAPOLATE> & Cesium$ExtrapolationType__EXTRAPOLATE & 2;// 2

}

declare class Cesium$ExtrapolationType__NONE mixins Cesium$ExtrapolationType {}
declare class Cesium$ExtrapolationType__HOLD mixins Cesium$ExtrapolationType {}
declare class Cesium$ExtrapolationType__EXTRAPOLATE mixins Cesium$ExtrapolationType {}
...
declare  class Cesium$Fullscreen {
  constructor(...args: empty): mixed;
static +element: Class<Cesium$Fullscreen__element> & Cesium$Fullscreen__element & 0;// 0
static +changeEventName: Class<Cesium$Fullscreen__changeEventName> & Cesium$Fullscreen__changeEventName & 1;// 1
static +errorEventName: Class<Cesium$Fullscreen__errorEventName> & Cesium$Fullscreen__errorEventName & 2;// 2
static +enabled: Class<Cesium$Fullscreen__enabled> & Cesium$Fullscreen__enabled & 3;// 3
static +fullscreen: Class<Cesium$Fullscreen__fullscreen> & Cesium$Fullscreen__fullscreen & 4;// 4
...
declare function GeometryPipeline$toWireframe(geometry: Cesium$Geometry): Cesium$Geometry


declare function GeometryPipeline$createLineSegmentsForVectors(
geometry: Cesium$Geometry,
attributeName?: string,
length?: number): Cesium$Geometry


declare function GeometryPipeline$createAttributeLocations(geometry: Cesium$Geometry): any


declare function GeometryPipeline$reorderForPreVertexCache(geometry: Cesium$Geometry): Cesium$Geometry


declare function GeometryPipeline$reorderForPostVertexCache(geometry: Cesium$Geometry, cacheCapacity?: number): Cesium$Geometry


declare function GeometryPipeline$fitToUnsignedShortIndices(geometry: Cesium$Geometry): Cesium$Geometry[]
...
projection?: any): Cesium$Geometry
...
attributeLowName: string): Cesium$Geometry


declare function GeometryPipeline$transformToWorldCoordinates(instance: Cesium$GeometryInstance): Cesium$GeometryInstance


declare function GeometryPipeline$computeNormal(geometry: Cesium$Geometry): Cesium$Geometry


declare function GeometryPipeline$computeBinormalAndTangent(geometry: Cesium$Geometry): Cesium$Geometry


declare function GeometryPipeline$compressVertices(geometry: Cesium$Geometry): Cesium$Geometry


declare  class Cesium$HeightmapTessellator {
  constructor(...args: empty): mixed;
static +DEFAULT_STRUCTURE: Class<Cesium$HeightmapTessellator__DEFAULT_STRUCTURE> & Cesium$HeightmapTessellator__DEFAULT_STRUCTURE & 0;// 0

}

declare class Cesium$HeightmapTessellator__DEFAULT_STRUCTURE mixins Cesium$HeightmapTessellator {}
...
declare function HeightmapTessellator$computeVertices(
options: {
...
declare  class Cesium$HeightReference {
  constructor(...args: empty): mixed;
static +CLAMP_TO_GROUND: Class<Cesium$HeightReference__CLAMP_TO_GROUND> & Cesium$HeightReference__CLAMP_TO_GROUND & 0;// 0
static +NONE: Class<Cesium$HeightReference__NONE> & Cesium$HeightReference__NONE & 1;// 1
static +RELATIVE_TO_GROUND: Class<Cesium$HeightReference__RELATIVE_TO_GROUND> & Cesium$HeightReference__RELATIVE_TO_GROUND & 2;// 2

}

declare class Cesium$HeightReference__CLAMP_TO_GROUND mixins Cesium$HeightReference {}
declare class Cesium$HeightReference__NONE mixins Cesium$HeightReference {}
declare class Cesium$HeightReference__RELATIVE_TO_GROUND mixins Cesium$HeightReference {}


declare class Cesium$HermitePolynomialApproximation mixins Cesium$InterpolationAlgorithm {
static getRequiredDataPoints(degree: number, inputOrder?: number): number
}

declare  class Cesium$IndexDatatype {
  constructor(...args: empty): mixed;
static +UNSIGNED_BYTE: Class<Cesium$IndexDatatype__UNSIGNED_BYTE> & Cesium$IndexDatatype__UNSIGNED_BYTE & 0;// 0
static +UNSIGNED_SHORT: Class<Cesium$IndexDatatype__UNSIGNED_SHORT> & Cesium$IndexDatatype__UNSIGNED_SHORT & 1;// 1
static +UNSIGNED_INT: Class<Cesium$IndexDatatype__UNSIGNED_INT> & Cesium$IndexDatatype__UNSIGNED_INT & 2;// 2

}

declare class Cesium$IndexDatatype__UNSIGNED_BYTE mixins Cesium$IndexDatatype {}
declare class Cesium$IndexDatatype__UNSIGNED_SHORT mixins Cesium$IndexDatatype {}
declare class Cesium$IndexDatatype__UNSIGNED_INT mixins Cesium$IndexDatatype {}
...
declare function IndexDatatype$getSizeInBytes(indexDatatype: Cesium$IndexDatatype): number


declare function IndexDatatype$validate(indexDatatype: Cesium$IndexDatatype): boolean


declare function IndexDatatype$createTypedArray(numberOfVertices: number, indicesLengthOrArray: any): Uint16Array | Uint32Array
...
byteOffset: number,
length: number): Uint16Array | Uint32Array
...
declare  class Cesium$Intersect {
  constructor(...args: empty): mixed;
static +OUTSIDE: Class<Cesium$Intersect__OUTSIDE> & Cesium$Intersect__OUTSIDE & 0;// 0
static +INTERSECTING: Class<Cesium$Intersect__INTERSECTING> & Cesium$Intersect__INTERSECTING & 1;// 1
static +INSIDE: Class<Cesium$Intersect__INSIDE> & Cesium$Intersect__INSIDE & 2;// 2
...
declare function IntersectionTests$raySphere(ray: Cesium$Ray, sphere: Cesium$BoundingSphere, result?: any): any
...
declare function IntersectionTests$rayEllipsoid(ray: Cesium$Ray, ellipsoid: Cesium$Ellipsoid): any


declare function IntersectionTests$grazingAltitudeLocation(ray: Cesium$Ray, ellipsoid: Cesium$Ellipsoid): Cesium$Cartesian3
...
declare  class Cesium$Iso8601 {
  constructor(...args: empty): mixed;
static +MINIMUM_VALUE: Class<Cesium$Iso8601__MINIMUM_VALUE> & Cesium$Iso8601__MINIMUM_VALUE & 0;// 0
static +MAXIMUM_VALUE: Class<Cesium$Iso8601__MAXIMUM_VALUE> & Cesium$Iso8601__MAXIMUM_VALUE & 1;// 1
static +MAXIMUM_INTERVAL: Class<Cesium$Iso8601__MAXIMUM_INTERVAL> & Cesium$Iso8601__MAXIMUM_INTERVAL & 2;// 2
...
declare  class Cesium$KeyboardEventModifier {
  constructor(...args: empty): mixed;
static +SHIFT: Class<Cesium$KeyboardEventModifier__SHIFT> & Cesium$KeyboardEventModifier__SHIFT & 0;// 0
static +CTRL: Class<Cesium$KeyboardEventModifier__CTRL> & Cesium$KeyboardEventModifier__CTRL & 1;// 1
static +ALT: Class<Cesium$KeyboardEventModifier__ALT> & Cesium$KeyboardEventModifier__ALT & 2;// 2

}

declare class Cesium$KeyboardEventModifier__SHIFT mixins Cesium$KeyboardEventModifier {}
declare class Cesium$KeyboardEventModifier__CTRL mixins Cesium$KeyboardEventModifier {}
declare class Cesium$KeyboardEventModifier__ALT mixins Cesium$KeyboardEventModifier {}


declare class Cesium$LagrangePolynomialApproximation mixins Cesium$InterpolationAlgorithm {}

declare class Cesium$LinearApproximation mixins Cesium$InterpolationAlgorithm {}

declare  class Cesium$MapMode2D {
  constructor(...args: empty): mixed;
static +INFINITE_SCROLL: Class<Cesium$MapMode2D__INFINITE_SCROLL> & Cesium$MapMode2D__INFINITE_SCROLL & 0;// 0
static +ROTATE: Class<Cesium$MapMode2D__ROTATE> & Cesium$MapMode2D__ROTATE & 1;// 1
...
static +EPSILON10: Class<Cesium$Math__EPSILON10> & Cesium$Math__EPSILON10 & 9;// 9
static +EPSILON11: Class<Cesium$Math__EPSILON11> & Cesium$Math__EPSILON11 & 10;// 10
static +EPSILON12: Class<Cesium$Math__EPSILON12> & Cesium$Math__EPSILON12 & 11;// 11
static +EPSILON13: Class<Cesium$Math__EPSILON13> & Cesium$Math__EPSILON13 & 12;// 12
static +EPSILON14: Class<Cesium$Math__EPSILON14> & Cesium$Math__EPSILON14 & 13;// 13
static +EPSILON15: Class<Cesium$Math__EPSILON15> & Cesium$Math__EPSILON15 & 14;// 14
static +EPSILON16: Class<Cesium$Math__EPSILON16> & Cesium$Math__EPSILON16 & 15;// 15
static +EPSILON17: Class<Cesium$Math__EPSILON17> & Cesium$Math__EPSILON17 & 16;// 16
static +EPSILON18: Class<Cesium$Math__EPSILON18> & Cesium$Math__EPSILON18 & 17;// 17
static +EPSILON19: Class<Cesium$Math__EPSILON19> & Cesium$Math__EPSILON19 & 18;// 18
static +EPSILON20: Class<Cesium$Math__EPSILON20> & Cesium$Math__EPSILON20 & 19;// 19
static +GRAVITATIONALPARAMETER: Class<Cesium$Math__GRAVITATIONALPARAMETER> & Cesium$Math__GRAVITATIONALPARAMETER & 20;// 20
static +SOLAR_RADIUS: Class<Cesium$Math__SOLAR_RADIUS> & Cesium$Math__SOLAR_RADIUS & 21;// 21
static +LUNAR_RADIUS: Class<Cesium$Math__LUNAR_RADIUS> & Cesium$Math__LUNAR_RADIUS & 22;// 22
static +SIXTY_FOUR_KILOBYTES: Class<Cesium$Math__SIXTY_FOUR_KILOBYTES> & Cesium$Math__SIXTY_FOUR_KILOBYTES & 23;// 23
static +PI: Class<Cesium$Math__PI> & Cesium$Math__PI & 24;// 24
static +ONE_OVER_PI: Class<Cesium$Math__ONE_OVER_PI> & Cesium$Math__ONE_OVER_PI & 25;// 25
static +PI_OVER_TWO: Class<Cesium$Math__PI_OVER_TWO> & Cesium$Math__PI_OVER_TWO & 26;// 26
static +PI_OVER_THREE: Class<Cesium$Math__PI_OVER_THREE> & Cesium$Math__PI_OVER_THREE & 27;// 27
static +PI_OVER_FOUR: Class<Cesium$Math__PI_OVER_FOUR> & Cesium$Math__PI_OVER_FOUR & 28;// 28
static +PI_OVER_SIX: Class<Cesium$Math__PI_OVER_SIX> & Cesium$Math__PI_OVER_SIX & 29;// 29
static +THREE_PI_OVER_TWO: Class<Cesium$Math__THREE_PI_OVER_TWO> & Cesium$Math__THREE_PI_OVER_TWO & 30;// 30
static +TWO_PI: Class<Cesium$Math__TWO_PI> & Cesium$Math__TWO_PI & 31;// 31
static +ONE_OVER_TWO_PI: Class<Cesium$Math__ONE_OVER_TWO_PI> & Cesium$Math__ONE_OVER_TWO_PI & 32;// 32
static +RADIANS_PER_DEGREE: Class<Cesium$Math__RADIANS_PER_DEGREE> & Cesium$Math__RADIANS_PER_DEGREE & 33;// 33
static +DEGREES_PER_RADIAN: Class<Cesium$Math__DEGREES_PER_RADIAN> & Cesium$Math__DEGREES_PER_RADIAN & 34;// 34
static +RADIANS_PER_ARCSECOND: Class<Cesium$Math__RADIANS_PER_ARCSECOND> & Cesium$Math__RADIANS_PER_ARCSECOND & 35;// 35
...
declare function Math$incrementWrap(n?: number, maximumValue?: number, minimumValue?: number): number
...
static unpack(array: number[], startingIndex?: number, result?: any): Cesium$Packable
}

declare  class Cesium$PackableForInterpolation {
  constructor(...args: empty): mixed;
static +packedInterpolationLength: Class<Cesium$PackableForInterpolation__packedInterpolationLength> & Cesium$PackableForInterpolation__packedInterpolationLength & 0;// 0

}

declare class Cesium$PackableForInterpolation__packedInterpolationLength mixins Cesium$PackableForInterpolation {}
...
declare  class Cesium$PixelFormat {
  constructor(...args: empty): mixed;
static +DEPTH_COMPONENT: Class<Cesium$PixelFormat__DEPTH_COMPONENT> & Cesium$PixelFormat__DEPTH_COMPONENT & 0;// 0
static +DEPTH_STENCIL: Class<Cesium$PixelFormat__DEPTH_STENCIL> & Cesium$PixelFormat__DEPTH_STENCIL & 1;// 1
static +ALPHA: Class<Cesium$PixelFormat__ALPHA> & Cesium$PixelFormat__ALPHA & 2;// 2
static +RGB: Class<Cesium$PixelFormat__RGB> & Cesium$PixelFormat__RGB & 3;// 3
static +RGBA: Class<Cesium$PixelFormat__RGBA> & Cesium$PixelFormat__RGBA & 4;// 4
static +LUMINANCE: Class<Cesium$PixelFormat__LUMINANCE> & Cesium$PixelFormat__LUMINANCE & 5;// 5
static +LUMINANCE_ALPHA: Class<Cesium$PixelFormat__LUMINANCE_ALPHA> & Cesium$PixelFormat__LUMINANCE_ALPHA & 6;// 6
...
declare  class Cesium$PrimitiveType {
  constructor(...args: empty): mixed;
static +POINTS: Class<Cesium$PrimitiveType__POINTS> & Cesium$PrimitiveType__POINTS & 0;// 0
static +LINES: Class<Cesium$PrimitiveType__LINES> & Cesium$PrimitiveType__LINES & 1;// 1
static +LINE_LOOP: Class<Cesium$PrimitiveType__LINE_LOOP> & Cesium$PrimitiveType__LINE_LOOP & 2;// 2
static +LINE_STRIP: Class<Cesium$PrimitiveType__LINE_STRIP> & Cesium$PrimitiveType__LINE_STRIP & 3;// 3
static +TRIANGLES: Class<Cesium$PrimitiveType__TRIANGLES> & Cesium$PrimitiveType__TRIANGLES & 4;// 4
static +TRIANGLE_STRIP: Class<Cesium$PrimitiveType__TRIANGLE_STRIP> & Cesium$PrimitiveType__TRIANGLE_STRIP & 5;// 5
static +TRIANGLE_FAN: Class<Cesium$PrimitiveType__TRIANGLE_FAN> & Cesium$PrimitiveType__TRIANGLE_FAN & 6;// 6
...
declare class Cesium$PrimitiveType__TRIANGLE_STRIP mixins Cesium$PrimitiveType {}
declare class Cesium$PrimitiveType__TRIANGLE_FAN mixins Cesium$PrimitiveType {}
...
declare function QuadraticRealPolynomial$computeDiscriminant(a: number, b: number, c: number): number


declare function QuadraticRealPolynomial$computeRealRoots(a: number, b: number, c: number): number[]
...
declare function QuarticRealPolynomial$computeDiscriminant(a: number, b: number, c: number, d: number, e: number): number


declare function QuarticRealPolynomial$computeRealRoots(a: number, b: number, c: number, d: number, e: number): number[]


declare  class Cesium$ReferenceFrame {
  constructor(...args: empty): mixed;
static +FIXED: Class<Cesium$ReferenceFrame__FIXED> & Cesium$ReferenceFrame__FIXED & 0;// 0
static +INERTIAL: Class<Cesium$ReferenceFrame__INERTIAL> & Cesium$ReferenceFrame__INERTIAL & 1;// 1
...
declare  class Cesium$ScreenSpaceEventType {
  constructor(...args: empty): mixed;
static +LEFT_DOWN: Class<Cesium$ScreenSpaceEventType__LEFT_DOWN> & Cesium$ScreenSpaceEventType__LEFT_DOWN & 0;// 0
static +LEFT_UP: Class<Cesium$ScreenSpaceEventType__LEFT_UP> & Cesium$ScreenSpaceEventType__LEFT_UP & 1;// 1
static +LEFT_CLICK: Class<Cesium$ScreenSpaceEventType__LEFT_CLICK> & Cesium$ScreenSpaceEventType__LEFT_CLICK & 2;// 2
static +LEFT_DOUBLE_CLICK: Class<Cesium$ScreenSpaceEventType__LEFT_DOUBLE_CLICK> & Cesium$ScreenSpaceEventType__LEFT_DOUBLE_CLICK & 3;// 3
static +RIGHT_DOWN: Class<Cesium$ScreenSpaceEventType__RIGHT_DOWN> & Cesium$ScreenSpaceEventType__RIGHT_DOWN & 4;// 4
static +RIGHT_UP: Class<Cesium$ScreenSpaceEventType__RIGHT_UP> & Cesium$ScreenSpaceEventType__RIGHT_UP & 5;// 5
static +RIGHT_CLICK: Class<Cesium$ScreenSpaceEventType__RIGHT_CLICK> & Cesium$ScreenSpaceEventType__RIGHT_CLICK & 6;// 6
static +RIGHT_DOUBLE_CLICK: Class<Cesium$ScreenSpaceEventType__RIGHT_DOUBLE_CLICK> & Cesium$ScreenSpaceEventType__RIGHT_DOUBLE_CLICK & 7;// 7
static +MIDDLE_DOWN: Class<Cesium$ScreenSpaceEventType__MIDDLE_DOWN> & Cesium$ScreenSpaceEventType__MIDDLE_DOWN & 8;// 8
static +MIDDLE_UP: Class<Cesium$ScreenSpaceEventType__MIDDLE_UP> & Cesium$ScreenSpaceEventType__MIDDLE_UP & 9;// 9
static +MIDDLE_CLICK: Class<Cesium$ScreenSpaceEventType__MIDDLE_CLICK> & Cesium$ScreenSpaceEventType__MIDDLE_CLICK & 10;// 10
static +MIDDLE_DOUBLE_CLICK: Class<Cesium$ScreenSpaceEventType__MIDDLE_DOUBLE_CLICK> & Cesium$ScreenSpaceEventType__MIDDLE_DOUBLE_CLICK & 11;// 11
static +MOUSE_MOVE: Class<Cesium$ScreenSpaceEventType__MOUSE_MOVE> & Cesium$ScreenSpaceEventType__MOUSE_MOVE & 12;// 12
static +WHEEL: Class<Cesium$ScreenSpaceEventType__WHEEL> & Cesium$ScreenSpaceEventType__WHEEL & 13;// 13
static +PINCH_START: Class<Cesium$ScreenSpaceEventType__PINCH_START> & Cesium$ScreenSpaceEventType__PINCH_START & 14;// 14
static +PINCH_END: Class<Cesium$ScreenSpaceEventType__PINCH_END> & Cesium$ScreenSpaceEventType__PINCH_END & 15;// 15
static +PINCH_MOVE: Class<Cesium$ScreenSpaceEventType__PINCH_MOVE> & Cesium$ScreenSpaceEventType__PINCH_MOVE & 16;// 16

}

declare class Cesium$ScreenSpaceEventType__LEFT_DOWN mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__LEFT_UP mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__LEFT_CLICK mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__LEFT_DOUBLE_CLICK mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__RIGHT_DOWN mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__RIGHT_UP mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__RIGHT_CLICK mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__RIGHT_DOUBLE_CLICK mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__MIDDLE_DOWN mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__MIDDLE_UP mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__MIDDLE_CLICK mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__MIDDLE_DOUBLE_CLICK mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__MOUSE_MOVE mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__WHEEL mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__PINCH_START mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__PINCH_END mixins Cesium$ScreenSpaceEventType {}
declare class Cesium$ScreenSpaceEventType__PINCH_MOVE mixins Cesium$ScreenSpaceEventType {}
...
declare function Simon1994PlanetaryPositions$computeSunPositionInEarthInertialFrame(julianDate?: Cesium$JulianDate, result?: Cesium$Cartesian3): Cesium$Cartesian3


declare function Simon1994PlanetaryPositions$computeMoonPositionInEarthInertialFrame(julianDate?: Cesium$JulianDate, result?: Cesium$Cartesian3): Cesium$Cartesian3
...
declare  class Cesium$ShadowMode {
  constructor(...args: empty): mixed;
static +CAST_ONLY: Class<Cesium$ShadowMode__CAST_ONLY> & Cesium$ShadowMode__CAST_ONLY & 0;// 0
static +DISABLED: Class<Cesium$ShadowMode__DISABLED> & Cesium$ShadowMode__DISABLED & 1;// 1
static +ENABLED: Class<Cesium$ShadowMode__ENABLED> & Cesium$ShadowMode__ENABLED & 2;// 2
static +RECEIVE_ONLY: Class<Cesium$ShadowMode__RECEIVE_ONLY> & Cesium$ShadowMode__RECEIVE_ONLY & 3;// 3
...
declare function Transforms$computeTemeToPseudoFixedMatrix(date: Cesium$JulianDate, result?: Cesium$Matrix3): Cesium$Matrix3


declare function Transforms$preloadIcrfFixed(timeInterval: Cesium$TimeInterval): Promise<void>


declare function Transforms$computeIcrfToFixedMatrix(date: Cesium$JulianDate, result?: Cesium$Matrix3): Cesium$Matrix3


declare function Transforms$computeFixedToIcrfMatrix(date: Cesium$JulianDate, result?: Cesium$Matrix3): Cesium$Matrix3
...
lower: number[],
upper: number[],
right: Cesium$Cartesian3[]): Cesium$Cartesian3[]


declare  class Cesium$Visibility {
  constructor(...args: empty): mixed;
static +NONE: Class<Cesium$Visibility__NONE> & Cesium$Visibility__NONE & 0;// 0
static +PARTIAL: Class<Cesium$Visibility__PARTIAL> & Cesium$Visibility__PARTIAL & 1;// 1
...
declare  class Cesium$WindingOrder {
  constructor(...args: empty): mixed;
static +CLOCKWISE: Class<Cesium$WindingOrder__CLOCKWISE> & Cesium$WindingOrder__CLOCKWISE & 0;// 0
static +COUNTER_CLOCKWISE: Class<Cesium$WindingOrder__COUNTER_CLOCKWISE> & Cesium$WindingOrder__COUNTER_CLOCKWISE & 1;// 1

}

declare class Cesium$WindingOrder__CLOCKWISE mixins Cesium$WindingOrder {}
declare class Cesium$WindingOrder__COUNTER_CLOCKWISE mixins Cesium$WindingOrder {}


declare  class Cesium$StripeOrientation {
  constructor(...args: empty): mixed;
static +HORIZONTAL: Class<Cesium$StripeOrientation__HORIZONTAL> & Cesium$StripeOrientation__HORIZONTAL & 0;// 0
static +VERTICAL: Class<Cesium$StripeOrientation__VERTICAL> & Cesium$StripeOrientation__VERTICAL & 1;// 1

}

declare class Cesium$StripeOrientation__HORIZONTAL mixins Cesium$StripeOrientation {}
declare class Cesium$StripeOrientation__VERTICAL mixins Cesium$StripeOrientation {}


declare  class Cesium$BingMapsStyle {
  constructor(...args: empty): mixed;
static +AERIAL: Class<Cesium$BingMapsStyle__AERIAL> & Cesium$BingMapsStyle__AERIAL & 0;// 0
static +AERIAL_WITH_LABELS: Class<Cesium$BingMapsStyle__AERIAL_WITH_LABELS> & Cesium$BingMapsStyle__AERIAL_WITH_LABELS & 1;// 1
static +ROAD: Class<Cesium$BingMapsStyle__ROAD> & Cesium$BingMapsStyle__ROAD & 2;// 2
static +ORDNANCE_SURVEY: Class<Cesium$BingMapsStyle__ORDNANCE_SURVEY> & Cesium$BingMapsStyle__ORDNANCE_SURVEY & 3;// 3
static +COLLINS_BART: Class<Cesium$BingMapsStyle__COLLINS_BART> & Cesium$BingMapsStyle__COLLINS_BART & 4;// 4

}

declare class Cesium$BingMapsStyle__AERIAL mixins Cesium$BingMapsStyle {}
declare class Cesium$BingMapsStyle__AERIAL_WITH_LABELS mixins Cesium$BingMapsStyle {}
declare class Cesium$BingMapsStyle__ROAD mixins Cesium$BingMapsStyle {}
declare class Cesium$BingMapsStyle__ORDNANCE_SURVEY mixins Cesium$BingMapsStyle {}
declare class Cesium$BingMapsStyle__COLLINS_BART mixins Cesium$BingMapsStyle {}


declare  class Cesium$BlendEquation {
  constructor(...args: empty): mixed;
static +ADD: Class<Cesium$BlendEquation__ADD> & Cesium$BlendEquation__ADD & 0;// 0
static +SUBTRACT: Class<Cesium$BlendEquation__SUBTRACT> & Cesium$BlendEquation__SUBTRACT & 1;// 1
static +REVERSE_SUBTRACT: Class<Cesium$BlendEquation__REVERSE_SUBTRACT> & Cesium$BlendEquation__REVERSE_SUBTRACT & 2;// 2
...
declare class Cesium$BlendEquation__REVERSE_SUBTRACT mixins Cesium$BlendEquation {}


declare  class Cesium$BlendFunction {
  constructor(...args: empty): mixed;
static +ZERO: Class<Cesium$BlendFunction__ZERO> & Cesium$BlendFunction__ZERO & 0;// 0
static +ONE: Class<Cesium$BlendFunction__ONE> & Cesium$BlendFunction__ONE & 1;// 1
static +SOURCE_COLOR: Class<Cesium$BlendFunction__SOURCE_COLOR> & Cesium$BlendFunction__SOURCE_COLOR & 2;// 2
static +ONE_MINUS_SOURCE_COLOR: Class<Cesium$BlendFunction__ONE_MINUS_SOURCE_COLOR> & Cesium$BlendFunction__ONE_MINUS_SOURCE_COLOR & 3;// 3
static +DESTINATION_COLOR: Class<Cesium$BlendFunction__DESTINATION_COLOR> & Cesium$BlendFunction__DESTINATION_COLOR & 4;// 4
static +ONE_MINUS_DESTINATION_COLOR: Class<Cesium$BlendFunction__ONE_MINUS_DESTINATION_COLOR> & Cesium$BlendFunction__ONE_MINUS_DESTINATION_COLOR & 5;// 5
static +SOURCE_ALPHA: Class<Cesium$BlendFunction__SOURCE_ALPHA> & Cesium$BlendFunction__SOURCE_ALPHA & 6;// 6
static +ONE_MINUS_SOURCE_ALPHA: Class<Cesium$BlendFunction__ONE_MINUS_SOURCE_ALPHA> & Cesium$BlendFunction__ONE_MINUS_SOURCE_ALPHA & 7;// 7
static +DESTINATION_ALPHA: Class<Cesium$BlendFunction__DESTINATION_ALPHA> & Cesium$BlendFunction__DESTINATION_ALPHA & 8;// 8
static +ONE_MINUS_DESTINATION_ALPHA: Class<Cesium$BlendFunction__ONE_MINUS_DESTINATION_ALPHA> & Cesium$BlendFunction__ONE_MINUS_DESTINATION_ALPHA & 9;// 9
static +CONSTANT_COLOR: Class<Cesium$BlendFunction__CONSTANT_COLOR> & Cesium$BlendFunction__CONSTANT_COLOR & 10;// 10
static +ONE_MINUS_CONSTANT_COLOR: Class<Cesium$BlendFunction__ONE_MINUS_CONSTANT_COLOR> & Cesium$BlendFunction__ONE_MINUS_CONSTANT_COLOR & 11;// 11
static +CONSTANT_ALPHA: Class<Cesium$BlendFunction__CONSTANT_ALPHA> & Cesium$BlendFunction__CONSTANT_ALPHA & 12;// 12
static +ONE_MINUS_CONSTANT_ALPHA: Class<Cesium$BlendFunction__ONE_MINUS_CONSTANT_ALPHA> & Cesium$BlendFunction__ONE_MINUS_CONSTANT_ALPHA & 13;// 13
static +SOURCE_ALPHA_SATURATE: Class<Cesium$BlendFunction__SOURCE_ALPHA_SATURATE> & Cesium$BlendFunction__SOURCE_ALPHA_SATURATE & 14;// 14
...
declare class Cesium$BlendFunction__SOURCE_COLOR mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__ONE_MINUS_SOURCE_COLOR mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__DESTINATION_COLOR mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__ONE_MINUS_DESTINATION_COLOR mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__SOURCE_ALPHA mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__ONE_MINUS_SOURCE_ALPHA mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__DESTINATION_ALPHA mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__ONE_MINUS_DESTINATION_ALPHA mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__CONSTANT_COLOR mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__ONE_MINUS_CONSTANT_COLOR mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__CONSTANT_ALPHA mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__ONE_MINUS_CONSTANT_ALPHA mixins Cesium$BlendFunction {}
declare class Cesium$BlendFunction__SOURCE_ALPHA_SATURATE mixins Cesium$BlendFunction {}


declare  class Cesium$BlendingState {
  constructor(...args: empty): mixed;
static +DISABLED: Class<Cesium$BlendingState__DISABLED> & Cesium$BlendingState__DISABLED & 0;// 0
static +ALPHA_BLEND: Class<Cesium$BlendingState__ALPHA_BLEND> & Cesium$BlendingState__ALPHA_BLEND & 1;// 1
static +PRE_MULTIPLIED_ALPHA_BLEND: Class<Cesium$BlendingState__PRE_MULTIPLIED_ALPHA_BLEND> & Cesium$BlendingState__PRE_MULTIPLIED_ALPHA_BLEND & 2;// 2
static +ADDITIVE_BLEND: Class<Cesium$BlendingState__ADDITIVE_BLEND> & Cesium$BlendingState__ADDITIVE_BLEND & 3;// 3
...
declare class Cesium$BlendingState__PRE_MULTIPLIED_ALPHA_BLEND mixins Cesium$BlendingState {}
declare class Cesium$BlendingState__ADDITIVE_BLEND mixins Cesium$BlendingState {}


declare  class Cesium$BlendOption {
  constructor(...args: empty): mixed;
static +OPAQUE: Class<Cesium$BlendOption__OPAQUE> & Cesium$BlendOption__OPAQUE & 0;// 0
static +OPAQUE_AND_TRANSLUCENT: Class<Cesium$BlendOption__OPAQUE_AND_TRANSLUCENT> & Cesium$BlendOption__OPAQUE_AND_TRANSLUCENT & 1;// 1
static +TRANSLUCENT: Class<Cesium$BlendOption__TRANSLUCENT> & Cesium$BlendOption__TRANSLUCENT & 2;// 2

}

declare class Cesium$BlendOption__OPAQUE mixins Cesium$BlendOption {}
declare class Cesium$BlendOption__OPAQUE_AND_TRANSLUCENT mixins Cesium$BlendOption {}
declare class Cesium$BlendOption__TRANSLUCENT mixins Cesium$BlendOption {}


declare  class Cesium$CameraEventType {
  constructor(...args: empty): mixed;
static +LEFT_DRAG: Class<Cesium$CameraEventType__LEFT_DRAG> & Cesium$CameraEventType__LEFT_DRAG & 0;// 0
static +RIGHT_DRAG: Class<Cesium$CameraEventType__RIGHT_DRAG> & Cesium$CameraEventType__RIGHT_DRAG & 1;// 1
static +MIDDLE_DRAG: Class<Cesium$CameraEventType__MIDDLE_DRAG> & Cesium$CameraEventType__MIDDLE_DRAG & 2;// 2
static +WHEEL: Class<Cesium$CameraEventType__WHEEL> & Cesium$CameraEventType__WHEEL & 3;// 3
static +PINCH: Class<Cesium$CameraEventType__PINCH> & Cesium$CameraEventType__PINCH & 4;// 4

}

declare class Cesium$CameraEventType__LEFT_DRAG mixins Cesium$CameraEventType {}
declare class Cesium$CameraEventType__RIGHT_DRAG mixins Cesium$CameraEventType {}
declare class Cesium$CameraEventType__MIDDLE_DRAG mixins Cesium$CameraEventType {}
...
static +FRONT_AND_BACK: Class<Cesium$CullFace__FRONT_AND_BACK> & Cesium$CullFace__FRONT_AND_BACK & 2;// 2
...
declare  class Cesium$DepthFunction {
  constructor(...args: empty): mixed;
static +NEVER: Class<Cesium$DepthFunction__NEVER> & Cesium$DepthFunction__NEVER & 0;// 0
static +LESS: Class<Cesium$DepthFunction__LESS> & Cesium$DepthFunction__LESS & 1;// 1
static +EQUAL: Class<Cesium$DepthFunction__EQUAL> & Cesium$DepthFunction__EQUAL & 2;// 2
static +LESS_OR_EQUAL: Class<Cesium$DepthFunction__LESS_OR_EQUAL> & Cesium$DepthFunction__LESS_OR_EQUAL & 3;// 3
static +GREATER: Class<Cesium$DepthFunction__GREATER> & Cesium$DepthFunction__GREATER & 4;// 4
static +NOT_EQUAL: Class<Cesium$DepthFunction__NOT_EQUAL> & Cesium$DepthFunction__NOT_EQUAL & 5;// 5
static +GREATER_OR_EQUAL: Class<Cesium$DepthFunction__GREATER_OR_EQUAL> & Cesium$DepthFunction__GREATER_OR_EQUAL & 6;// 6
static +ALWAYS: Class<Cesium$DepthFunction__ALWAYS> & Cesium$DepthFunction__ALWAYS & 7;// 7
...
declare class Cesium$DepthFunction__LESS_OR_EQUAL mixins Cesium$DepthFunction {}
...
declare class Cesium$DepthFunction__GREATER_OR_EQUAL mixins Cesium$DepthFunction {}
declare class Cesium$DepthFunction__ALWAYS mixins Cesium$DepthFunction {}


declare  class Cesium$HorizontalOrigin {
  constructor(...args: empty): mixed;
static +CENTER: Class<Cesium$HorizontalOrigin__CENTER> & Cesium$HorizontalOrigin__CENTER & 0;// 0
static +LEFT: Class<Cesium$HorizontalOrigin__LEFT> & Cesium$HorizontalOrigin__LEFT & 1;// 1
static +RIGHT: Class<Cesium$HorizontalOrigin__RIGHT> & Cesium$HorizontalOrigin__RIGHT & 2;// 2

}

declare class Cesium$HorizontalOrigin__CENTER mixins Cesium$HorizontalOrigin {}
...
static +OUTLINE: Class<Cesium$LabelStyle__OUTLINE> & Cesium$LabelStyle__OUTLINE & 1;// 1
static +FILL_AND_OUTLINE: Class<Cesium$LabelStyle__FILL_AND_OUTLINE> & Cesium$LabelStyle__FILL_AND_OUTLINE & 2;// 2
...
declare  class Cesium$ModelAnimationLoop {
  constructor(...args: empty): mixed;
static +NONE: Class<Cesium$ModelAnimationLoop__NONE> & Cesium$ModelAnimationLoop__NONE & 0;// 0
static +REPEAT: Class<Cesium$ModelAnimationLoop__REPEAT> & Cesium$ModelAnimationLoop__REPEAT & 1;// 1
static +MIRRORED_REPEAT: Class<Cesium$ModelAnimationLoop__MIRRORED_REPEAT> & Cesium$ModelAnimationLoop__MIRRORED_REPEAT & 2;// 2

}

declare class Cesium$ModelAnimationLoop__NONE mixins Cesium$ModelAnimationLoop {}
declare class Cesium$ModelAnimationLoop__REPEAT mixins Cesium$ModelAnimationLoop {}
declare class Cesium$ModelAnimationLoop__MIRRORED_REPEAT mixins Cesium$ModelAnimationLoop {}


declare  class Cesium$SceneMode {
  constructor(...args: empty): mixed;
static +MORPHING: Class<Cesium$SceneMode__MORPHING> & Cesium$SceneMode__MORPHING & 0;// 0
static +COLUMBUS_VIEW: Class<Cesium$SceneMode__COLUMBUS_VIEW> & Cesium$SceneMode__COLUMBUS_VIEW & 1;// 1
static +SCENE2D: Class<Cesium$SceneMode__SCENE2D> & Cesium$SceneMode__SCENE2D & 2;// 2
static +SCENE3D: Class<Cesium$SceneMode__SCENE3D> & Cesium$SceneMode__SCENE3D & 3;// 3
...
declare  class Cesium$StencilFunction {
  constructor(...args: empty): mixed;
static +NEVER: Class<Cesium$StencilFunction__NEVER> & Cesium$StencilFunction__NEVER & 0;// 0
static +LESS: Class<Cesium$StencilFunction__LESS> & Cesium$StencilFunction__LESS & 1;// 1
static +EQUAL: Class<Cesium$StencilFunction__EQUAL> & Cesium$StencilFunction__EQUAL & 2;// 2
static +LESS_OR_EQUAL: Class<Cesium$StencilFunction__LESS_OR_EQUAL> & Cesium$StencilFunction__LESS_OR_EQUAL & 3;// 3
static +GREATER: Class<Cesium$StencilFunction__GREATER> & Cesium$StencilFunction__GREATER & 4;// 4
static +NOT_EQUAL: Class<Cesium$StencilFunction__NOT_EQUAL> & Cesium$StencilFunction__NOT_EQUAL & 5;// 5
static +GREATER_OR_EQUAL: Class<Cesium$StencilFunction__GREATER_OR_EQUAL> & Cesium$StencilFunction__GREATER_OR_EQUAL & 6;// 6
static +ALWAYS: Class<Cesium$StencilFunction__ALWAYS> & Cesium$StencilFunction__ALWAYS & 7;// 7
...
declare class Cesium$StencilFunction__LESS_OR_EQUAL mixins Cesium$StencilFunction {}
declare class Cesium$StencilFunction__GREATER mixins Cesium$StencilFunction {}
declare class Cesium$StencilFunction__NOT_EQUAL mixins Cesium$StencilFunction {}
declare class Cesium$StencilFunction__GREATER_OR_EQUAL mixins Cesium$StencilFunction {}
declare class Cesium$StencilFunction__ALWAYS mixins Cesium$StencilFunction {}


declare  class Cesium$StencilOperation {
  constructor(...args: empty): mixed;
static +ZERO: Class<Cesium$StencilOperation__ZERO> & Cesium$StencilOperation__ZERO & 0;// 0
static +KEEP: Class<Cesium$StencilOperation__KEEP> & Cesium$StencilOperation__KEEP & 1;// 1
static +REPLACE: Class<Cesium$StencilOperation__REPLACE> & Cesium$StencilOperation__REPLACE & 2;// 2
static +INCREMENT: Class<Cesium$StencilOperation__INCREMENT> & Cesium$StencilOperation__INCREMENT & 3;// 3
static +DECREMENT: Class<Cesium$StencilOperation__DECREMENT> & Cesium$StencilOperation__DECREMENT & 4;// 4
static +INVERT: Class<Cesium$StencilOperation__INVERT> & Cesium$StencilOperation__INVERT & 5;// 5
static +INCREMENT_WRAP: Class<Cesium$StencilOperation__INCREMENT_WRAP> & Cesium$StencilOperation__INCREMENT_WRAP & 6;// 6
static +DECREMENT_WRAP: Class<Cesium$StencilOperation__DECREMENT_WRAP> & Cesium$StencilOperation__DECREMENT_WRAP & 7;// 7
...
declare class Cesium$StencilOperation__REPLACE mixins Cesium$StencilOperation {}
declare class Cesium$StencilOperation__INCREMENT mixins Cesium$StencilOperation {}
declare class Cesium$StencilOperation__DECREMENT mixins Cesium$StencilOperation {}
declare class Cesium$StencilOperation__INVERT mixins Cesium$StencilOperation {}
declare class Cesium$StencilOperation__INCREMENT_WRAP mixins Cesium$StencilOperation {}
declare class Cesium$StencilOperation__DECREMENT_WRAP mixins Cesium$StencilOperation {}


declare  class Cesium$VerticalOrigin {
  constructor(...args: empty): mixed;
static +CENTER: Class<Cesium$VerticalOrigin__CENTER> & Cesium$VerticalOrigin__CENTER & 0;// 0
static +BOTTOM: Class<Cesium$VerticalOrigin__BOTTOM> & Cesium$VerticalOrigin__BOTTOM & 1;// 1
static +TOP: Class<Cesium$VerticalOrigin__TOP> & Cesium$VerticalOrigin__TOP & 2;// 2
...
declare function Cesium$createOpenStreetMapImageryProvider(
options: {
url?: string,
fileExtension?: string,
rectangle?: Cesium$Rectangle,
...
declare function Cesium$createTileMapServiceImageryProvider(
options: {
url?: string,
fileExtension?: string,
credit?: Cesium$Credit | string,
...
declare function Cesium$createWorldTerrain(
options: {
requestVertexNormals?: boolean,
requestWaterMask?: boolean
...
declare class Cesium$UrlTemplateImageryProvider mixins Cesium$ImageryProvider {
url: string;
...
reinitialize(options: Promise<{[key: string]: any}> | {[key: string]: any}): void
}
...
declare type Resource$RetryCallback = (resource: Cesium$Resource, error: Error) => void;
