declare module 'react-grid-layout' {
	...
	declare class ReactGridLayout mixins React.Component<ReactGridLayout$ReactGridLayout$ReactGridLayoutProps> {}
...
allLayouts: ReactGridLayout$Layouts): void,
...
margin: [number, number],
cols: number,
containerPadding: [number, number]): void
} & ReactGridLayout$CoreProps


declare class ReactGridLayout$Responsive mixins React.Component<ReactGridLayout$ResponsiveProps> {}
...
component: React.ComponentClass<P>): React.ComponentClass<P & ReactGridLayout$WidthProviderProps>
