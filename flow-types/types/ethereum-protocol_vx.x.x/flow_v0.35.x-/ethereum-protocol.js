declare module 'ethereum-protocol' {
	...
	declare export type JSONRPCErrorCallback = (err: Error | null, result?: JSONRPCResponsePayload) => void;
...
sendAsync(payload: JSONRPCRequestPayload, callback: JSONRPCErrorCallback): void
	...
	declare export type StateMutability = "pure" | "view" | ConstructorStateMutability;
	declare export  class AbiType {
  constructor(...args: empty): mixed;
static +Function: Class<AbiType__Function> & AbiType__Function & "function";// "function"
static +Constructor: Class<AbiType__Constructor> & AbiType__Constructor & "constructor";// "constructor"
...
components?: DataItem[]
  ...
  constructor(...args: empty): mixed;
static +DelegateCall: Class<OpCode__DelegateCall> & OpCode__DelegateCall & "DELEGATECALL";// "DELEGATECALL"
...
static +StaticCall: Class<OpCode__StaticCall> & OpCode__StaticCall & "STATICCALL";// "STATICCALL"
static +Return: Class<OpCode__Return> & OpCode__Return & "RETURN";// "RETURN"
static +Call: Class<OpCode__Call> & OpCode__Call & "CALL";// "CALL"
static +SelfDestruct: Class<OpCode__SelfDestruct> & OpCode__SelfDestruct & "SELFDESTRUCT";// "SELFDESTRUCT"
...
[argName: string]: ContractEventArg
	...
	declare export type LogWithDecodedArgs<ArgsType: DecodedLogArgs> = {} & DecodedLogEntry<ArgsType>

	declare export type RawLog = LogEntry;
	declare export  class BlockParamLiteral {
  constructor(...args: empty): mixed;
static +Earliest: Class<BlockParamLiteral__Earliest> & BlockParamLiteral__Earliest & "earliest";// "earliest"
static +Latest: Class<BlockParamLiteral__Latest> & BlockParamLiteral__Latest & "latest";// "latest"
static +Pending: Class<BlockParamLiteral__Pending> & BlockParamLiteral__Pending & "pending";// "pending"
...
topics: string[]
  ...
  constructor(...args: empty): mixed;
static +Address: Class<SolidityTypes__Address> & SolidityTypes__Address & "address";// "address"
static +Uint256: Class<SolidityTypes__Uint256> & SolidityTypes__Uint256 & "uint256";// "uint256"
