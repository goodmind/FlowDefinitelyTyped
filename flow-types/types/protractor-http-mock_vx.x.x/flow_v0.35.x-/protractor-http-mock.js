 ...
 */
(mocks?: Array<requests$requests$AllRequests<TResponse, TPayload>>, plugins?: Array<mock$Plugin>, skipDefaults?: boolean): mock$ProtractorHttpMock,
 ...
 * @param skipDefaults Set true to skip loading of default mocks.
 */
(mocks?: Array<requests$requests$AllRequests<TResponse, TPayload>>, plugins?: Array<string>, skipDefaults?: boolean): mock$ProtractorHttpMock,
 ...
 */
add<T1, T2>(
mocks: Array<requests$requests$AllRequests<T1, T2>>): webdriver.promise.Promise<boolean>,
...
requestConfig: requests$requests$AllRequests<T1, T2>): boolean,
