 ...
 */
mmenu(): JQuery,
mmenu(options: JQueryMmenu$JQueryMmenu$Options): JQuery,
mmenu(
options: JQueryMmenu$JQueryMmenu$Options,
configurations: JQueryMmenu$JQueryMmenu$Configurations): JQuery,

/**
 * Return the mmenu object
 * @param element
 */
data(element: "mmenu"): JQueryMmenu$JQueryMmenu$API
} 
    }
