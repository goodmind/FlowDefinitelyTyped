...
_operator: string
	...
	declare type UnaryOperation = {
new (operator: string, value: any): Expression,
toAQL(): string,
_operator: string
} & Expression

	declare type SimpleReference = {
...
_keys: Expression[]
	...
	declare type TernaryOperation = {
new (
operator1: string,
operator2: string,
value1: Expression,
value2: any,
value3: any): Operation,
toAQL(): string,
_operator1: string,
_operator2: string
} & Operation
...
_dfns: Definitions
	...
	declare type CollectExpression = {
new (
...
withCountInto(newVarname: any): CollectWithCountIntoExpression
	...
	declare type CollectWithCountIntoExpression = {
new (
prev: PartialStatement,
dfns: any[],
varname: any,
...
options(newOpts: any): UpdateExpression
	...
	declare type ReplaceExpression = {
new (
prev: PartialStatement,
expr: any,
withExpr: any,
...
replace(expr: any): ReplaceRetWithRet
	...
	declare interface RemoveRet {
into(collection: any): RemoveExpression,
in: $ElementType<RemoveRet, "into">,
in_: $ElementType<RemoveRet, "into">,
into(collection: any): RemoveExpression,
in: $ElementType<RemoveRet, "into">,
in_: $ElementType<RemoveRet, "into">
} 
	declare interface UpsertRet {
insert(insertExpr: any): UpsertRetInsertRet,
insert(insertExpr: any): UpsertRetInsertRet
} 
	declare interface UpsertRetInsertRet {
update(updateOrReplaceExpr: any): UpsertRetInsertRetUpdateRet,
replace: $ElementType<UpsertRetInsertRet, "update">,
update(updateOrReplaceExpr: any): UpsertRetInsertRetUpdateRet,
replace: $ElementType<UpsertRetInsertRet, "update">
} 
	declare interface UpsertRetInsertRetUpdateRet {
into(inCollection: any): UpsertExpression,
in: $ElementType<UpsertRetInsertRetUpdateRet, "into">,
in_: $ElementType<UpsertRetInsertRetUpdateRet, "into">,
into(inCollection: any): UpsertExpression,
in: $ElementType<UpsertRetInsertRetUpdateRet, "into">,
in_: $ElementType<UpsertRetInsertRetUpdateRet, "into">
} 
	declare interface InsertRet {
into(collection: any): InsertExpression,
in: $ElementType<InsertRet, "into">,
in_: $ElementType<InsertRet, "into">,
into(collection: any): InsertExpression,
in: $ElementType<InsertRet, "into">,
in_: $ElementType<InsertRet, "into">
} 
	declare interface UpdateRetWithRet {
into(collection: any): UpdateExpression,
in: $ElementType<UpdateRetWithRet, "into">,
in_: $ElementType<UpdateRetWithRet, "into">,
into(collection: any): UpdateExpression,
with(collection: any): UpdateRetWithRet,
in: $ElementType<UpdateRetWithRet, "into">,
in_: $ElementType<UpdateRetWithRet, "into">
} 
	declare interface ReplaceRetWithRet {
into(collection: any): ReplaceExpression,
in: $ElementType<ReplaceRetWithRet, "into">,
in_: $ElementType<ReplaceRetWithRet, "into">,
into(collection: any): ReplaceExpression,
 ...
 */
obj(obj: {[key: string]: any}): ObjectLiteral,
...
fn(functionName: string): (...arity: any[]) => FunctionCall
	...
	declare type QBfunc = (obj: any) => AQLfunctions;
	declare var QB: AQLfunctions & QBfunc;
	declare module.exports: typeof QB
