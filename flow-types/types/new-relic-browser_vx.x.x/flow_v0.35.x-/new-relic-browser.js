declare module 'new-relic-browser' {
        declare interface NewRelic$Browser {
 ...
 */
addPageAction(name: string, attributes: {
 ...
 */
addToTrace(eventObject: NewRelic$EventObject): void,
...
declare interface NewRelic$EventObject {
...
declare interface NewRelic$BrowserInteraction {
 ...
 */
end(): NewRelic$BrowserInteraction,
 ...
 */
getContext(callback: (contextObject: any) => void): NewRelic$BrowserInteraction,
 ...
 */
ignore(): NewRelic$BrowserInteraction,
 ...
 */
onEnd(callback: (contextObject: any) => void): NewRelic$BrowserInteraction,
 ...
 */
save(): NewRelic$BrowserInteraction,
 ...
 */
setAttribute(key: string, value: any): NewRelic$BrowserInteraction,
 ...
 */
setName(name: string, trigger?: string): NewRelic$BrowserInteraction
} 
	declare var api: NewRelic$NewRelic$Browser;
