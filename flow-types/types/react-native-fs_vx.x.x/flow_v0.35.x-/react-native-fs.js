...
bytesWritten: number
	...
	declare export type DownloadCallbackBegin = (res: DownloadBeginCallbackResult) => void;
	declare export type DownloadCallbackProgress = (res: DownloadProgressCallbackResult) => void;
...
headers: Headers
	...
	declare export type UploadCallbackBegin = (res: UploadBeginCallbackResult) => void;
	declare export type UploadCallbackProgress = (res: UploadProgressCallbackResult) => void;
...
promise: Promise<Result>
	...
	declare export type EncodingOrOptions = Encoding | {
encoding?: Encoding
};
	declare export type HashAlgorithm = "md5"
| "sha1"
| "sha224"
| "sha256"
| "sha384"
| "sha512";
	...
	declare export function readDirAssets(dirpath: string): Promise<ReadDirItem[]>
...
length?: number,
position?: number,
encodingOrOptions?: EncodingOrOptions): Promise<string>

	declare export function readFile(filepath: string, encodingOrOptions?: EncodingOrOptions): Promise<string>

	declare export function readFileAssets(filepath: string, encodingOrOptions?: EncodingOrOptions): Promise<string>
...
contents: string,
position?: number,
encodingOrOptions?: EncodingOrOptions): Promise<void>
...
encodingOrOptions?: EncodingOrOptions): Promise<void>
	...
	declare export function moveFile(filepath: string, destPath: string): Promise<void>

	declare export function copyFile(filepath: string, destPath: string): Promise<void>

	declare export function copyFileAssets(filepath: string, destPath: string): Promise<void>
...
scale?: number,
compression?: number,
resizeMode?: string): Promise<string>

	declare export function copyAssetsVideoIOS(imageUri: string, destPath: string): Promise<string>

	declare export function exists(filepath: string): Promise<boolean>

	declare export function hash(filepath: string, algorithm: HashAlgorithm): Promise<string>

	declare export function mkdir(filepath: string, options?: MkdirOptions): Promise<void>

	declare export function touch(filepath: string, mtime?: Date, ctime?: Date): Promise<void>

	declare export function downloadFile(options: DownloadFileOptions): JobReturnValue<DownloadResult>

	declare export function stopDownload(jobId: number): void

	declare export function uploadFiles(options: UploadFileOptions): JobReturnValue<UploadResult>
	...
	declare export function setReadable(filepath: string, readable: boolean, ownerOnly: boolean): Promise<boolean>
