declare module "clui" {
  import typeof * as clc from "cli-color";

  declare export interface LineBufferOptions {
    x?: number;
    y?: number;
  ...
  declare export class Line {
     ...
     */
    constructor(buffer?: LineBuffer): this;
   ...
   */
  declare export function Sparkline(values: number[], suffix: string): string;

  declare export class Progress {
    /**
  ...
  declare export class Spinner {
     ...
     */
    constructor(statusText: string, style?: string[]): this;
