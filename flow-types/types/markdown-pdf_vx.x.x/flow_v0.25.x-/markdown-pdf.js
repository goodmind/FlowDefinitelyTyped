declare module "markdown-pdf" {
  ...
  declare function MarkdownPDF(
    options?: MarkdownPDF$MarkdownPDF$Options
  ): MarkdownPDF$MarkdownPDF$OptionsBuilder;
  ...
  declare type MarkdownPDF$PaperFormat =
    | "A3"
    | "A4"
    | "A5"
    | "Legal"
  ...
  declare type MarkdownPDF$FromFunction = (
    path: string | string[]
  ) => MarkdownPDF$ToOptionsBuilder;
  ...
  declare type MarkdownPDF$ToFunction = (
    path: string,
    callback?: () => void
  ) => void;
}
