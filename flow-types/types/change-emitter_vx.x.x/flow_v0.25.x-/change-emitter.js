declare module "change-emitter" {
  ...
  declare type ListenerOf3<T1, T2, T3> = (
    value1: T1,
    value2: T2,
    value3: T3
  ) => void;
  declare type ListenerOf4<T1, T2, T3, T4> = (
    value1: T1,
    value2: T2,
    value3: T3,
    value4: T4
  ) => void;
  declare type ListenerOf5<T1, T2, T3, T4, T5> = (
    value1: T1,
    value2: T2,
    value3: T3,
    value4: T4,
  ...
  declare export function createChangeEmitter<T1, T2>(): ChangeEmitterOf2<
    T1,
    T2
  >;

  declare export function createChangeEmitter<T1, T2, T3>(): ChangeEmitterOf3<
    T1,
    T2,
    T3
  >;

  declare export function createChangeEmitter<
    T1,
    T2,
    T3,
    T4
