declare module 'gapi.client.discovery' {
      ...
      declare var npm$namespace$client: {
        ...
        apis: typeof client$apis,
      }

/**
 * Load APIs Discovery Service v1
 */
declare function client$load(name: "discovery", version: "v1"): PromiseLike<void>


declare function client$load(name: "discovery", version: "v1", callback: () => any): void


declare var client$apis: discovery$discovery$ApisResource;

declare interface discovery$DirectoryList {
...
declare interface discovery$JsonSchema {
 ...
 */
properties?: Record<string, discovery$JsonSchema>,
...
declare interface discovery$RestDescription {
 ...
 */
methods?: Record<string, discovery$RestMethod>,
 ...
 */
parameters?: Record<string, discovery$JsonSchema>,
 ...
 */
resources?: Record<string, discovery$RestResource>,
 ...
 */
schemas?: Record<string, discovery$JsonSchema>,
...
declare interface discovery$RestMethod {
...
declare interface discovery$RestResource {
...
declare interface discovery$ApisResource {
 ...
 */
version: string
}): Request<discovery$RestDescription>,
 ...
 */
userIp?: string
}): Request<discovery$DirectoryList>
} 
    }
