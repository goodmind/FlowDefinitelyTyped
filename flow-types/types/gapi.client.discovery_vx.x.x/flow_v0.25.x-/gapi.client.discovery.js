declare module "gapi.client.discovery" {
  ...
  declare var gapi$client$apis: discovery$ApisResource;

  declare interface gapi$client$discovery$DirectoryList {
    /**
  ...
  declare interface gapi$client$discovery$JsonSchema {
    /**
     ...
     */
    additionalProperties?: gapi$client$discovery$JsonSchema;
     ...
     */
    properties?: Record<string, gapi$client$discovery$JsonSchema>;
  ...
  declare interface gapi$client$discovery$RestDescription {
    /**
  ...
  declare interface gapi$client$discovery$RestMethod {
    /**
  ...
  declare interface gapi$client$discovery$RestResource {
    /**
     * Methods on this resource.
     */
    methods?: Record<string, gapi$client$discovery$RestMethod>;
  ...
  declare interface gapi$client$discovery$ApisResource {
    /**
    ...
    getRest(request: {
       ...
       */
      version: string
    }): Request<gapi$client$discovery$RestDescription>;
    ...
    list(request: {
       ...
       */
      userIp?: string
    }): Request<gapi$client$discovery$DirectoryList>;
  }
}
