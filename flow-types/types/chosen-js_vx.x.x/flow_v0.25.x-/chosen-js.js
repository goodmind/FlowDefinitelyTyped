declare module "chosen-js" {
  ...
  declare type Chosen$TriggerEvent =
    | "chosen:updated"
    | "chosen:activate"
    | "chosen:open"
    | "chosen:close";
  ...
  declare interface JQuery {
    chosen(options?: Chosen$Chosen$Options | "destroy"): JQuery;
    ...
    on(
      ...
      handler: (
        ...
        args: Chosen$Chosen$SelectedData
      ) => any
    ): JQuery;
     ...
     */
    trigger(eventType: Chosen$Chosen$TriggerEvent): JQuery;
  }
}
