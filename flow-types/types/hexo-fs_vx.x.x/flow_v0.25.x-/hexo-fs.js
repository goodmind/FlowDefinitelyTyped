declare module "hexo-fs" {
  ...
  declare export var access:
    | ((path: PathLike, mode?: number) => Promise<void>)
    | void;
  declare export var accessSync:
    | ((path: PathLike, mode?: number) => void)
    | void;
  ...
  declare export { chmodSync, fchmodSync, lchmodSync };
  ...
  declare export { chownSync, fchownSync, lchownSync };

  declare export function close(fd: number): Promise<void>;

  declare export { closeSync };
  ...
  declare export { createReadStream, createWriteStream };
   ...
   */
  declare export function ensurePath(
    path: string,
    callback?: (err: any, value?: string) => void
  ): Promise<string>;
   ...
   */
  declare export function listDirSync(
    path: string,
    options?: DirectoryOptions,
    parent?: string
  ): string | string[];
  ...
  declare export { statSync, fstatSync, lstatSync };
  ...
  declare export { truncateSync, ftruncateSync };

  declare export function unlink(path: PathLike): Promise<void>;

  declare export { unlinkSync };
  ...
  declare export { utimesSync, futimesSync };
  ...
  declare export { watchFile, unwatchFile };
  ...
  declare export { Stats, ReadStream, WriteStream } from "graceful-fs";
