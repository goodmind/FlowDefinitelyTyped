 ...
 */
  declare function browserTrigger(
    ...
    eventType?: string,
    eventData?: angular.mock.mock$IBrowserTriggerEventData
  ): void;
}
 ...
 */
  respond(
    ...
    ) => [number, string | { [key: string]: any }, mock$IHttpHeaders, string]
 ...
 */
    ...
    expect(
      ...
      data?:
        ...
        | ((data: string) => boolean),
      headers?:
        | mock$mock$IHttpHeaders
        | ((headers: mock$mock$IHttpHeaders) => boolean),
      keys?: string[]
