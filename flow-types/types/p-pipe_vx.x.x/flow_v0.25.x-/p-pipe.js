declare module "p-pipe" {
  ...
  declare type Tasks3<T1, T2, T3, R> = [
    Task<T1, T2>,
    Task<T2, T3>,
    Task<T3, R>
  ];
  declare type Tasks4<T1, T2, T3, T4, R> = [
    Task<T1, T2>,
    Task<T2, T3>,
    Task<T3, T4>,
    Task<T4, R>
  ];
  declare type Tasks5<T1, T2, T3, T4, T5, R> = [
    Task<T1, T2>,
    Task<T2, T3>,
    Task<T3, T4>,
    Task<T4, T5>,
  ...
  declare type Tasks6<T1, T2, T3, T4, T5, T6, R> = [
    Task<T1, T2>,
    Task<T2, T3>,
    Task<T3, T4>,
    Task<T4, T5>,
  ...
  declare type Tasks7<T1, T2, T3, T4, T5, T6, T7, R> = [
    Task<T1, T2>,
    Task<T2, T3>,
    Task<T3, T4>,
    Task<T4, T5>,
  ...
  declare type Tasks8<T1, T2, T3, T4, T5, T6, T7, T8, R> = [
    Task<T1, T2>,
    Task<T2, T3>,
    Task<T3, T4>,
    Task<T4, T5>,
