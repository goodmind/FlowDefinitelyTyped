declare var Velocity: jquery$velocity.velocity$VelocityStatic;declare module 'velocity-animate' {
...
velocity(
name: string,
options: jquery$velocity.velocity$RegisteredEffectOptions): JQuery,
velocity(
options: {
...
velocity(
properties: jquery$velocity.velocity$Properties,
options: jquery$velocity.velocity$Options): JQuery,
velocity(
properties: jquery$velocity.velocity$Properties,
duration: number,
easing: jquery$velocity.velocity$Easing,
complete?: jquery$velocity.velocity$ElementCallback): JQuery,
velocity(
properties: jquery$velocity.velocity$Properties,
duration: number,
complete?: jquery$velocity.velocity$ElementCallback): JQuery,
...
declare type velocity$ElementCallback = (elements: NodeListOf<HTMLElement>) => void;
...
declare type velocity$EffectCall = [velocity$Properties] | [velocity$Properties, number] | [velocity$Properties, velocity$EffectCallOptions] | [velocity$Properties, number, velocity$EffectCallOptions];
...
properties: velocity$Properties,
options: velocity$Options): any,
RegisterEffect(name: string, options: velocity$RegisterEffectOptions): velocity$VelocityStatic,
