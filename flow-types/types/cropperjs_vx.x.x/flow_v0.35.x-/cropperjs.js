declare module 'cropperjs' {
        declare  class cropperjs$CropperViewMods {
  constructor(...args: empty): mixed;
static +CropBoxIsJustWithInTheContainer: Class<cropperjs$CropperViewMods__CropBoxIsJustWithInTheContainer> & cropperjs$CropperViewMods__CropBoxIsJustWithInTheContainer & 0;// 0
static +CropBoxShouldBeWithInTheCanvas: Class<cropperjs$CropperViewMods__CropBoxShouldBeWithInTheCanvas> & cropperjs$CropperViewMods__CropBoxShouldBeWithInTheCanvas & 1;// 1
static +CanvasShouldNotBeWithInTheContainer: Class<cropperjs$CropperViewMods__CanvasShouldNotBeWithInTheContainer> & cropperjs$CropperViewMods__CanvasShouldNotBeWithInTheContainer & 2;// 2
static +ContainerSshouldBeWithInTheCanvas: Class<cropperjs$CropperViewMods__ContainerSshouldBeWithInTheCanvas> & cropperjs$CropperViewMods__ContainerSshouldBeWithInTheCanvas & 3;// 3

}

declare class cropperjs$CropperViewMods__CropBoxIsJustWithInTheContainer mixins cropperjs$CropperViewMods {}
declare class cropperjs$CropperViewMods__CropBoxShouldBeWithInTheCanvas mixins cropperjs$CropperViewMods {}
declare class cropperjs$CropperViewMods__CanvasShouldNotBeWithInTheContainer mixins cropperjs$CropperViewMods {}
declare class cropperjs$CropperViewMods__ContainerSshouldBeWithInTheCanvas mixins cropperjs$CropperViewMods {}


declare type cropperjs$CropperReadyEvent = CustomEvent;

declare type cropperjs$CropperCropEvent = {
detail: cropperjs$Data
} & CustomEvent


declare type cropperjs$CropperCropStepEvent = {
detail: cropperjs$CropStepData
} & CustomEvent


declare type cropperjs$CropperZoomEvent = {
detail: cropperjs$ZoomData
} & CustomEvent


declare interface cropperjs$CropperOptions {

/**
 * Function called when crop box is ready
 */
ready(event: cropperjs$CropperReadyEvent): void,

/**
 * Function called when crop box is moved or resized
 */
crop(event: cropperjs$CropperCropEvent): void,

/**
 * Function called at start of crop box being moved or resized
 */
cropstart(event: cropperjs$CropperCropStepEvent): void,

/**
 * Function called when crop box is moved
 */
cropmove(event: cropperjs$CropperCropStepEvent): void,

/**
 * Function called when crop box is finished being moved or resized
 */
cropend(event: cropperjs$CropperCropStepEvent): void,

/**
 * Function called when a cropper instance starts to zoom in or zoom out its canvas (image wrapper).
 */
zoom(event: cropperjs$CropperZoomEvent): void,

/**
 * Define the view mode of the cropper.
 * @default 0
 */
viewMode?: cropperjs$CropperViewMods,
...
declare interface cropperjs$Data {
...
declare interface cropperjs$CropStepData {
...
declare interface cropperjs$ZoomData {
...
declare interface cropperjs$ContainerData {
...
declare interface cropperjs$CropBoxData {
...
declare interface cropperjs$CanvasData {
...
declare interface cropperjs$ImageData {
...
declare interface cropperjs$CroppedCanvasOptions {
...
constructor(element: HTMLImageElement, options: cropperjs$cropperjs$CropperOptions): this;
 ...
 */
getData(rounded?: boolean): cropperjs$cropperjs$Data;

/**
 * Change the cropped area position and size with new data (base on the original image).
 */
setData(data: $Shape<cropperjs$cropperjs$Data>): void;

/**
 * Output the container size data.
 */
getContainerData(): cropperjs$cropperjs$ContainerData;

/**
 * Output the image position, size and other related data.
 */
getImageData(): cropperjs$cropperjs$ImageData;

/**
 * Output the canvas (image wrapper) position and size data.
 */
getCanvasData(
): cropperjs$cropperjs$CanvasData & {
 ...
 */
setCanvasData(data: $Shape<cropperjs$cropperjs$CanvasData>): void;

/**
 * Output the crop box position and size data.
 */
getCropBoxData(): cropperjs$cropperjs$CropBoxData;

/**
 * Change the crop box position and size with new data.
 */
setCropBoxData(data: $Shape<cropperjs$cropperjs$CropBoxData>): void;

/**
 * Get a canvas drawn the cropped image.
 */
getCroppedCanvas(options?: cropperjs$cropperjs$CroppedCanvasOptions): HTMLCanvasElement;
...
setDragMode(mode?: "none" | "crop" | "move"): void
	...
	declare module.exports: typeof cropperjs
