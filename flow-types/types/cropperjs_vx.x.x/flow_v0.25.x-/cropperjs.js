declare module "cropperjs" {
  declare class cropperjs$CropperViewMods {
    ...
    static +CropBoxIsJustWithInTheContainer: Class<cropperjs$CropperViewMods__CropBoxIsJustWithInTheContainer> &
      cropperjs$CropperViewMods__CropBoxIsJustWithInTheContainer &
      0; // 0
    static +CropBoxShouldBeWithInTheCanvas: Class<cropperjs$CropperViewMods__CropBoxShouldBeWithInTheCanvas> &
      cropperjs$CropperViewMods__CropBoxShouldBeWithInTheCanvas &
      1; // 1
    static +CanvasShouldNotBeWithInTheContainer: Class<cropperjs$CropperViewMods__CanvasShouldNotBeWithInTheContainer> &
      cropperjs$CropperViewMods__CanvasShouldNotBeWithInTheContainer &
      2; // 2
    static +ContainerSshouldBeWithInTheCanvas: Class<cropperjs$CropperViewMods__ContainerSshouldBeWithInTheCanvas> &
      cropperjs$CropperViewMods__ContainerSshouldBeWithInTheCanvas &
      3; // 3
  }

  declare class cropperjs$CropperViewMods__CropBoxIsJustWithInTheContainer
    mixins cropperjs$CropperViewMods {}
  declare class cropperjs$CropperViewMods__CropBoxShouldBeWithInTheCanvas
    mixins cropperjs$CropperViewMods {}
  declare class cropperjs$CropperViewMods__CanvasShouldNotBeWithInTheContainer
    mixins cropperjs$CropperViewMods {}
  declare class cropperjs$CropperViewMods__ContainerSshouldBeWithInTheCanvas
    mixins cropperjs$CropperViewMods {}
  ...
  declare class cropperjs {
    constructor(
      ...
      options: cropperjs$cropperjs$CropperOptions
    ): this;
 ...
 */
     ...
     */
    getCanvasData(): cropperjs$cropperjs$CanvasData & {
      /**
     ...
     */
    getCroppedCanvas(
      options?: cropperjs$cropperjs$CroppedCanvasOptions
    ): HTMLCanvasElement;
