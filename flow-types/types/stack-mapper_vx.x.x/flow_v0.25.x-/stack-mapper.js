declare export class stackMapper$StackMapper {
  /**
...
export interface stackMapper$Callsite {
  filename: string;
  line: number;
  column: number;
}
declare module "stack-mapper" {
   ...
   * @return {stackMapper$StackMapper} stack mapper for the particular source map
   */
  declare function stackMapper(
    sourcemap: any
  ): stackMapper$stackMapper$StackMapper;

  declare export default typeof stackMapper;
}
