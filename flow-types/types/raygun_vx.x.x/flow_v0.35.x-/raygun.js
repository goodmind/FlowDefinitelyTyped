...
declare interface raygun$RaygunOfflineStorageProvider<TTransportItem, TStorageItem> {
init(options: any): raygun$RaygunOfflineStorageProvider,
save(item: TTransportItem, callback: (error?: Error) => void): void,
retrieve(
callback: (error: Error, storageItems: $ReadOnlyArray<TStorageItem>) => void): void,
send(
callback: (error: Error, sendItems: $ReadOnlyArray<TStorageItem>) => void): void
} 
...
request: raygun$RaygunRequest,
tags: $ReadOnlyArray<string>) => boolean | raygun$RaygunPayload;
...
tags?: $ReadOnlyArray<string>): raygun$raygun$RaygunPayload;
expressHandler(error: Error, request: raygun$raygun$RaygunRequest, res: any, next: any): void
}
