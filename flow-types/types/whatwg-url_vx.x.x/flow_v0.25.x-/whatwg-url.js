declare module "whatwg-url" {
   ...
   */
  declare export type IPv6Address = [
    number,
    number,
    number,
    number,
   ...
   */
  declare export type StateOverride =
    | "scheme start"
    | "scheme"
    | "no scheme"
   ...
   */
  declare export function serializeURL(
    urlRecord: URLRecord,
   ...
   */
  declare export function serializeHost(
    host: string | number | IPv6Address
  ): string;
   ...
   */
  declare export function setTheUsername(
    urlRecord: URLRecord,
    username: string
  ): void;
   ...
   */
  declare export function setThePassword(
    urlRecord: URLRecord,
    password: string
  ): void;
   ...
   */
  declare export function cannotHaveAUsernamePasswordPort(
    urlRecord: URLRecord
  ): boolean;
