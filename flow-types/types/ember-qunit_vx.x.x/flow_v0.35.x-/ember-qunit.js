 ...
 */
declare export function moduleFor(fullName: string, description: string, callbacks?: QUnitModuleCallbacks): void

	declare export function moduleFor(fullName: string, callbacks?: QUnitModuleCallbacks): void
 ...
 * @param description The description of the module
 */
declare export function moduleForComponent(fullName: string, description: string, callbacks?: QUnitModuleCallbacks): void

	declare export function moduleForComponent(fullName: string, callbacks?: QUnitModuleCallbacks): void
 ...
 * @param description The description of the module
 */
declare export function moduleForModel(fullName: string, description: string, callbacks?: QUnitModuleCallbacks): void

	declare export function moduleForModel(fullName: string, callbacks?: QUnitModuleCallbacks): void
...
declare export function setResolver(resolver: Ember.Resolver): void
	...
	declare interface SetupTestOptions {
 ...
 */
declare export function setupApplicationTest(hooks: NestedHooks, options?: SetupTestOptions): void
 ...
 */
declare export function setupRenderingTest(hooks: NestedHooks, options?: SetupTestOptions): void
 ...
 */
declare export function setupTest(hooks: NestedHooks, options?: SetupTestOptions): void

	declare export class QUnitAdapter mixins undefined.Adapter {}
	declare export {
          module,test,skip,only,todo
        }from 'qunit';
...
setupTestIsolationValidation?: boolean
	...
	declare export function start(options?: QUnitStartOptions): void
 ...
 */
declare export function test(name: string, callback: (assert: Assert) => void): void
 ...
 * @param callback Function to close over assertions
 */
declare export function only(name: string, callback: (assert: Assert) => void): void
 ...
 * @param callback Function to close over assertions
 */
declare export function todo(name: string, callback: (assert: Assert) => void): void
 ...
 * @param callback Function to close over assertions
 */
declare export function skip(name: string, callback?: (assert: Assert) => void): void

	declare export default typeof QUnit
