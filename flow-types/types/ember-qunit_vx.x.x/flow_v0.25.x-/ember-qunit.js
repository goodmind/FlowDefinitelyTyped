declare module "ember-qunit" {
  ...
  import type { ModuleCallbacks } from "ember-test-helpers";
   ...
   */
  declare export function moduleFor(
    fullName: string,
    description: string,
   ...
   * @param description The description of the module
   */
  declare export function moduleForComponent(
    fullName: string,
    description: string,
    callbacks?: QUnitModuleCallbacks
  ): void;
   ...
   * @param description The description of the module
   */
  declare export function moduleForModel(
    fullName: string,
    description: string,
    callbacks?: QUnitModuleCallbacks
  ): void;
   ...
   */
  declare export function setupApplicationTest(
    hooks: NestedHooks,
   ...
   */
  declare export function setupRenderingTest(
    hooks: NestedHooks,
    options?: SetupTestOptions
  ): void;
   ...
   */
  declare export function setupTest(
    hooks: NestedHooks,
    options?: SetupTestOptions
  ): void;
