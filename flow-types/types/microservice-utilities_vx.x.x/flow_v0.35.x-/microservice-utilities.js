...
constructor(logFunction: (msg: any) => void, configuration: AuthorizerConfiguration): this;
...
constructor(logFunction: (msg: any) => void, tokenResolverFunction?: () => Promise<string>, configuration?: PlatformClientConfiguration): this;
get<T>(
url: string,
headers?: {
[s: string]: string
},
type?: string): Promise<PlatformClientResponse<T>>;
post<T>(
url: string,
data: {[key: string]: any},
headers?: {
...
constructor(httpClient: {[key: string]: any}, kmsClient: {[key: string]: any}, configuration?: ServiceTokenProviderConfiguration): this;
