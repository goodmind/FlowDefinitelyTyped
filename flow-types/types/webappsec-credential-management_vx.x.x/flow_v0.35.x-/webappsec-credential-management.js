...
id: string
	...
	declare type Credential = PasswordCredential | FederatedCredential | PublicKeyCredential;
 ...
 */
declare type CredentialMediationRequirement = "silent" | "optional" | "required";
 ...
 */
declare type PasswordCredentialInit = PasswordCredentialData | HTMLFormElement;
