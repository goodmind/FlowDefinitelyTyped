 ...
 * Reducer
 */
declare export function i18nReducer(state?: any, options?: any): redux.Reducer<I18nState>

	
/**
 * Reducer init
 */
declare export function syncTranslationWithStore(store: redux.Store<any>): void

	
/**
 * Redux Actions
 */
declare export function loadTranslations(translationsObject: TranslationObjects): DispatchCallback<any>
