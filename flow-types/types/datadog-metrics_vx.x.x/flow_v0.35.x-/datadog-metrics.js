declare module 'datadog-metrics' {
        declare export interface BufferedMetricsLoggerOptions {
...
prefix?: string
	...
	declare export class BufferedMetricsLogger  {
constructor(options: BufferedMetricsLoggerOptions): this;
...
flush(onSuccess?: () => void, onError?: (err: Error) => void): void
	...
	declare export function init(options: BufferedMetricsLoggerOptions): void
 ...
 * process uptime, total number of active users, or number of rows in a database table.
 */
declare export function gauge(key: string, value: number, tags?: string[], timestamp?: number): void
 ...
 * as incrementing a counter each time a page is requested.
 */
declare export function increment(key: string, value?: number, tags?: string[], timestamp?: number): void
 ...
 * 95th and 99th percentiles. Optionally, specify a list of tags to associate with the metric.
 */
declare export function histogram(key: string, value: number, tags?: string[], timestamp?: number): void
 ...
 * metrics have been sent before you quit the application process, for example.
 */
declare export function flush(onSuccess?: () => void, onError?: (err: Error) => void): void
