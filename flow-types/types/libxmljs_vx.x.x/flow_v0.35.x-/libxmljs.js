...
[key: string]: string
	...
	declare export function parseXml(source: string, options?: StringMap): Document

	declare export function parseXmlString(source: string, options?: StringMap): Document

	declare export function parseHtml(source: string, options?: StringMap): Document

	declare export function parseHtmlString(source: string, options?: StringMap): Document

	declare export function parseHtmlFragment(source: string, options?: StringMap): Document
