declare module "redux-pack" {
  import type { Action as ReduxAction, Middleware, Reducer } from "redux";
  ...
  declare export interface Handlers<
    S,
    TSuccessPayload,
    TErrorPayload,
    TStartPayload,
  ...
  > {
    ...
    success?: handlerReducer<
      S,
      PackActionPayload<TSuccessPayload, TMetaPayload>
    >;
    always?: handlerReducer<S, ReduxAction>;
  }
  declare export type GetState<S> = () => S;
  declare export interface ActionMeta<
    TFullState = {},
    TSuccessPayload = {},
    TErrorPayload = {},
    TStartPayload = {}
  > {
    ...
    onSuccess?: (
      response: TSuccessPayload,
      getState: GetState<TFullState>
    ) => void;
