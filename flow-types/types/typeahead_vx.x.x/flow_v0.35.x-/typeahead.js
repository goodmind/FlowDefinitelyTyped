 ...
 */
typeahead<T>(
options: Twitter$Typeahead.Typeahead$Options,
datasets: Twitter$Typeahead.Typeahead$Dataset<T>[]): JQuery,
...
typeahead<T>(
options: Twitter$Typeahead.Typeahead$Options,
dataset: Twitter$Typeahead.Typeahead$Dataset<T>,
...datasets: Twitter$Typeahead.Typeahead$Dataset<T>[]): JQuery,
...
handler: (eventObject: JQueryEventObject) => any): JQuery
	...
	declare interface Typeahead$Options {
 ...
 */
classNames?: Typeahead$ClassNames
} 
 ...
 * multiple datasets.
 */
declare interface Typeahead$Dataset<T> {
 ...
 */
templates?: Typeahead$Templates<T>
} 
 ...
 * its first argument and returns a HTML string.
 */
declare interface Typeahead$Templates<T> {
 ...
 * Used for overriding the default class names.
 */
declare interface Typeahead$ClassNames {
 ...
 */
constructor(options: Bloodhound$Bloodhound$BloodhoundOptions<T>): this;
 ...
 */
static noConflict(): Bloodhound<any>;
 ...
 */
static tokenizers: Bloodhound$Bloodhound$Tokenizers;
