declare module "torrent-search-api" {
  ...
  declare export function loadProvider(
    providerParam: string | TorrentProvider
  ): void;
  ...
  declare export function enableProvider(
    providerName: string,
    args?: string[]
  ): void;
  ...
  declare export function downloadTorrent(
    torrent: Torrent,
    filenamePath?: string
  ): Promise<string>;

  declare export function overrideConfig(
    providerName: string,
  ...
  declare export function getProvider(
    name: string,
