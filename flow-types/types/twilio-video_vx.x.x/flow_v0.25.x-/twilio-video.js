declare module "twilio-video" {
  ...
  declare export class RemoteAudioTrackPublication
    mixins RemoteTrackPublication {
    kind: "audio";
  ...
  declare export class RemoteDataTrackPublication
    mixins RemoteTrackPublication {
    kind: "data";
  ...
  declare export class RemoteVideoTrackPublication
    mixins RemoteTrackPublication {
    kind: "video";
  ...
  declare export class RoomSubscriptionOperationNotSupportedError
    mixins TwilioError {
    code: 53117;
  ...
  declare export type LogLevel = "debug" | "info" | "warn" | "error" | "off";
  ...
  declare export function createLocalAudioTrack(
    options?: CreateLocalTrackOptions
  ): Promise<LocalAudioTrack>;

  declare export function createLocalTracks(
    options?: CreateLocalTracksOptions
  ): Promise<LocalTrack[]>;

  declare export function createLocalVideoTrack(
    options?: CreateLocalTrackOptions
  ): Promise<LocalVideoTrack>;

  declare export function isSupported(): boolean;

  declare export function rewriteLocalTrackIds(
    room: Room,
  ...
  declare export type AudioTrackPublication =
  ...
  declare export type DataTrackPublication =
  ...
  declare export type LocalTrack =
    | LocalAudioTrack
    | LocalVideoTrack
    | LocalDataTrack;
  ...
  declare export type RemoteTrack =
    | RemoteAudioTrack
    | RemoteVideoTrack
    | RemoteDataTrack;
  ...
  declare export type VideoTrackPublication =
