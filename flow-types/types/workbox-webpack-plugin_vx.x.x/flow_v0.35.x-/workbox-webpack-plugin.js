declare module 'workbox-webpack-plugin' {
        declare export type ChacheStrategy = "cacheFirst"
| "cacheOnly"
| "networkFirst"
| "networkOnly"
| "staleWhileRevalidate";
	declare export interface ManifestEntry {
revision: string,
url: string
} 
	declare export interface RuntimeCacheOptions {
...
matchOptions?: any
	...
	declare export interface RuntimeCacheRule {
...
warnings?: string[]
	...
	declare export type GenerateSWOptions = {
...
offlineGoogleAnalytics?: boolean
	...
	declare export type InjectManifestOptions = {
 ...
 */
declare export class GenerateSW  {
constructor(opts?: GenerateSWOptions): this;
apply(...args: any[]): void
}
 ...
 * @see https://developers.google.com/web/tools/workbox/modules/workbox-webpack-plugin
 */
declare export class InjectManifest  {
constructor(opts?: InjectManifestOptions): this;
apply(...args: any[]): void
}
    }
