...
declare function wu$count(start?: number, step?: number): wu$WuIterable<number>


declare function wu$curryable(fun: (...x: any[]) => any, expected?: number): any
...
declare function wu$asyncEach(fn: wu$Consumer<any>, maxBlock?: number, timeout?: number): void


declare function wu$drop<T>(n: number, iter: Iterable<T>): wu$WuIterable<T>


declare function wu$dropWhile<T>(fn: wu$Filter<T>, iter: Iterable<T>): wu$WuIterable<T>


declare function wu$cycle<T>(iter: Iterable<T>): wu$WuIterable<T>


declare function wu$chunk<T>(n: number, iter: Iterable<T>): wu$WuIterable<T[]>


declare function wu$concatMap<T, U>(fn: (t: T) => Iterable<U>, iter: Iterable<T>): wu$WuIterable<U>


declare function wu$enumerate<T>(iter: Iterable<T>): wu$WuIterable<[T, number]>


declare function wu$every<T>(fn: wu$Filter<T>, iter: Iterable<T>): boolean


declare function wu$filter<T>(fn: wu$Filter<T>, iter: Iterable<T>): wu$WuIterable<T>
...
declare function wu$flatten(shallow: boolean, iter: Iterable<any>): wu$WuIterable<any>
...
declare function wu$map<T, U>(fn: (t: T) => U, iter: Iterable<T>): wu$WuIterable<U>


declare function wu$pluck(attribute: string, iter: Iterable<any>): wu$WuIterable<any>


declare function wu$reduce<T>(fn: (a: T, b: T) => T, iter: Iterable<T>): T


declare function wu$reduce<T>(fn: (a: T, b: T) => T, initial: T, iter: Iterable<T>): T


declare function wu$reduce<T, U>(fn: (a: U, b: T) => U, iter: Iterable<T>): U


declare function wu$reduce<T, U>(fn: (a: U, b: T) => U, initial: U, iter: Iterable<T>): U


declare function wu$reductions<T>(fn: (a: T, b: T) => T, iter: Iterable<T>): wu$WuIterable<T>


declare function wu$reductions<T>(fn: (a: T, b: T) => T, initial: T, iter: Iterable<T>): wu$WuIterable<T>


declare function wu$reductions<T, U>(fn: (a: U, b: T) => U, iter: Iterable<T>): wu$WuIterable<U>


declare function wu$reductions<T, U>(fn: (a: U, b: T) => U, initial: U, iter: Iterable<T>): wu$WuIterable<U>


declare function wu$reject<T>(fn: wu$Filter<T>, iter: Iterable<T>): wu$WuIterable<T>


declare function wu$slice<T>(iter: Iterable<T>): wu$WuIterable<T>


declare function wu$slice<T>(start: number, iter: Iterable<T>): wu$WuIterable<T>


declare function wu$slice<T>(start: number, stop: number, iter: Iterable<T>): wu$WuIterable<T>


declare function wu$some<T>(fn: wu$Filter<T>, iter: Iterable<T>): boolean


declare function wu$spreadMap<T>(fn: (...x: any[]) => T, iter: Iterable<any[]>): wu$WuIterable<T>


declare function wu$take<T>(n: number, iter: Iterable<T>): wu$WuIterable<T>


declare function wu$takeWhile<T>(fn: wu$Filter<T>, iter: Iterable<T>): wu$WuIterable<T>


declare function wu$tap<T>(fn: wu$Consumer<T>, iter: Iterable<T>): wu$WuIterable<T>


declare function wu$unique<T>(iter: Iterable<T>): wu$WuIterable<T>


declare function wu$zip<T, U>(iter2: Iterable<T>, iter: Iterable<U>): wu$WuIterable<[T, U]>


declare function wu$zipLongest<T, U>(iter2: Iterable<T>, iter: Iterable<U>): wu$WuIterable<[T, U]>
...
declare function wu$tee<T>(n: number, iter: Iterable<T>): Array<wu$WuIterable<T>>
