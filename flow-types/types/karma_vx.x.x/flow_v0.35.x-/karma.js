 ...
 * @deprecated
 */
declare export var server: DeprecatedServer;
	declare export var runner: Runner;
	declare export var stopper: Stopper;
 ...
 * @deprecated
 */
declare export interface DeprecatedServer {
...
stop(options?: ConfigOptions, callback?: ServerCallback): void
	...
	declare export interface TestResults {
...
success: number
	...
	declare export class Server mixins NodeJS.EventEmitter {
constructor(options?: ConfigOptions | ConfigFile, callback?: ServerCallback): this;
...
on(
event: "run_complete",
listener: (browsers: any, results: TestResults) => void): this
}
	declare export type ServerCallback = (exitCode: number) => void;
...
LOG_DEBUG: string
	...
	declare export interface ConfigFile {
configFile: string
} 
...
nocache?: boolean
	...
	declare export interface CustomLauncher {
base: string,
browserName?: string,
flags?: string[],
platform?: string
...
declare function config$parseConfig(configFilePath: string, cliOptions: ConfigOptions): Config
