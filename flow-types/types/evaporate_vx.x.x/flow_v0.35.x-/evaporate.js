...
options?: Evaporate$Evaporate$AddOverrideOptions): Promise<string>;
...
declare function Evaporate$create(config: Evaporate$CreateConfig): Promise<Evaporate>
...
canonicalRequest: string) => Promise<string>),
maxFileSize?: number,
signResponseHandler?: null | ((
response: any,
stringToSign: string,
signatureDateTime: string) => Promise<string>),
...
xhr: XMLHttpRequest,
awsObjectKey: string,
stats: Evaporate$TransferStats) => void,
...
declare type Evaporate$ImmutableOptionKeys = "maxConcurrentParts"
| "logging"
| "cloudfront"
| "encodeFilename"
| "computeContentMd5"
...
declare type Evaporate$AddOverrideOptionKeys = Exclude<$Keys<Evaporate$CreateConfig>, Evaporate$ImmutableOptionKeys>;

declare type Evaporate$AddOverrideOptions = {} & Pick<Evaporate$CreateConfig, Evaporate$AddOverrideOptionKeys>
