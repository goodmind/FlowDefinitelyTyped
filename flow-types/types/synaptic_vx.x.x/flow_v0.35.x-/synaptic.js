declare module "synaptic" {
    ...
    declare class Layer$connectionType__ALL_TO_ALL
        mixins Layer$connectionType {}
    declare class Layer$connectionType__ONE_TO_ONE
        mixins Layer$connectionType {}
    declare class Layer$connectionType__ALL_TO_ELSE
        mixins Layer$connectionType {}
    ...
    declare class Layer$gateType {
        ...
        static +OUTPUT: Class<Layer$gateType__OUTPUT> &
            Layer$gateType__OUTPUT &
            1; // 1
    ...
    declare export class Trainer {
         ...
         */
        XOR(
            options?: Trainer$Trainer$XOROptions
        ): Trainer$Trainer$TrainingResult;
