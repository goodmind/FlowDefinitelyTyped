...
declare class Layer$connectionType {
  ...
  static +ALL_TO_ALL: Class<Layer$connectionType__ALL_TO_ALL> &
    Layer$connectionType__ALL_TO_ALL &
    0; // 0
  static +ONE_TO_ONE: Class<Layer$connectionType__ONE_TO_ONE> &
    Layer$connectionType__ONE_TO_ONE &
    1; // 1
  static +ALL_TO_ELSE: Class<Layer$connectionType__ALL_TO_ELSE> &
    Layer$connectionType__ALL_TO_ELSE &
    2; // 2
}
...
declare class Layer$gateType {
  ...
  static +ONE_TO_ONE: Class<Layer$gateType__ONE_TO_ONE> &
    Layer$gateType__ONE_TO_ONE &
    2; // 2
}
...
declare module "synaptic" {
  ...
  declare export class Layer {
    ...
    project(
      ...
      weights?: any
    ): Layer$Layer$LayerConnection;

    /**
     * A layer can gate a connection between two other layers, or a layers's self-connection.
     */
    gate(
      Neuron$connection: Layer$Layer$LayerConnection,
      Layer$gateType: Layer$Layer$gateType
    ): void;
  ...
  declare export class Network {
    layers: Network$Layer$Options;
    optimized: Network$Network$Optimized;

    /**
     * Networks are basically an array of layers. They have an input layer, a number of hidden layers, and an output layer.
     */
    constructor(options?: Network$Layer$Options): this;
     ...
     */
    set(options: Network$Layer$Options): void;
  ...
  declare export class Trainer {
    ...
    train(
      ...
      trainingOptions?: Trainer$Trainer$TrainingOptions
    ): Trainer$Trainer$TrainingResult;
    ...
    trainAsync(
      trainingSet: Trainer$Trainer$TrainingSet,
      trainingOptions?: Trainer$Trainer$TrainingOptions
    ): Promise<Trainer$Trainer$TrainingResult>;
     ...
     */
    DSR(
      options?: Trainer$Trainer$DSROptions
    ): Trainer$Trainer$DSRTrainingResult;

    /**
     * This method trains the network to pass an Embedded Reber Grammar test.
     */
    ERG(
      options?: Trainer$Trainer$ERGOptions
    ): Trainer$Trainer$ERGTrainingResult;
