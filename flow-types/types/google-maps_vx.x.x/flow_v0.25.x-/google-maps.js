declare module "google-maps" {
  ...
  declare interface GoogleMapsLoader$CallBack {
    (google: GoogleMapsLoader$google): void;
  }
  ...
  declare export function GoogleMapsLoader$onLoad(
    callBack?: GoogleMapsLoader$CallBack
  ): void;

  declare export function GoogleMapsLoader$load(
    callBack?: GoogleMapsLoader$CallBack
  ): void;
  ...
  declare export default typeof GoogleMapsLoader;
}
