declare var multiplex: multiplex$multiplex$MultiplexStatic;declare module 'multiplexjs' {
        declare module.exports: typeof multiplex

    }
declare type Array<T> = {} & multiplex$multiplex$Iterable<T>
declare type String = {} & multiplex$multiplex$Iterable<string>
...
seed: TAccumulate,
func: (accumulate: TAccumulate, item: T) => TAccumulate): TAccumulate,
 ...
 */
asEnumerable(): multiplex$Enumerable<T>,
 ...
 */
concat(second: multiplex$Iterable<T>): multiplex$Enumerable<T>,
 ...
 */
contains(value: T, comparer: multiplex$EqualityComparer<T>): boolean,
 ...
 */
defaultIfEmpty(): multiplex$Enumerable<T>,

/**
 * Returns the elements of the specified sequence or the specified value in  a singleton collection if the sequence is empty.
 * @param defaultValue The value to return if the sequence is empty.
 */
defaultIfEmpty(defaultValue: T): multiplex$Enumerable<T>,

/**
 * Returns distinct elements from a sequence by using the default equality comparer to compare values.
 */
distinct(): multiplex$Enumerable<T>,
 ...
 */
distinct(comparer: multiplex$EqualityComparer<T>): multiplex$Enumerable<T>,
 ...
 */
except(second: multiplex$Iterable<T>): multiplex$Enumerable<T>,
...
second: multiplex$Iterable<T>,
comparer: multiplex$EqualityComparer<T>): multiplex$Enumerable<T>,
 ...
 */
groupBy<TKey>(
keySelector: (item: T) => TKey): multiplex$Enumerable<multiplex$Grouping<TKey, T>>,
...
comparer: multiplex$EqualityComparer<TKey>): multiplex$Enumerable<multiplex$Grouping<TKey, T>>,
...
keySelector: (item: T) => TKey,
elementSelector: (item: T) => TElement): multiplex$Enumerable<multiplex$Grouping<TKey, TElement>>,
...
comparer: multiplex$EqualityComparer<TKey>): multiplex$Enumerable<multiplex$Grouping<TKey, TElement>>,
...
keySelector: (item: T) => TKey,
elementSelector: (item: T) => TElement,
resultSelector: (key: TKey, elements: multiplex$Iterable<TElement>) => TResult): multiplex$Enumerable<TResult>,
...
keySelector: (item: T) => TKey,
elementSelector: (item: T) => TElement,
resultSelector: (key: TKey, elements: multiplex$Iterable<TElement>) => TResult,
comparer: multiplex$EqualityComparer<TKey>): multiplex$Enumerable<TResult>,
...
inner: multiplex$Iterable<TInner>,
outerKeySelector: (item: T) => TKey,
innerKeySelector: (item: TInner) => TKey,
resultSelector: (outer: T, inner: multiplex$Enumerable<TInner>) => TResult): multiplex$Enumerable<TResult>,
...
outerKeySelector: (item: T) => TKey,
innerKeySelector: (item: TInner) => TKey,
resultSelector: (outer: T, inner: multiplex$Enumerable<TInner>) => TResult,
comparer: multiplex$EqualityComparer<TKey>): multiplex$Enumerable<TResult>,
 ...
 */
intersect(second: multiplex$Iterable<T>): multiplex$Enumerable<T>,
...
outerKeySelector: (item: T) => TKey,
innerKeySelector: (item: TInner) => TKey,
resultSelector: (outer: T, inner: TInner) => TResult): multiplex$Enumerable<TResult>,
...
}): multiplex$Enumerable<TResult>,

/**
 * Sorts the elements of a sequence in ascending order by using a specified comparer.
 * @param keySelector A function to extract a key from each element.
 */
orderBy<TKey>(keySelector: (item: T) => TKey): multiplex$OrderedEnumerable<T>,
...
orderBy<TKey>(
keySelector: (item: T) => TKey,
comparer: multiplex$EqualityComparer<TKey>): multiplex$OrderedEnumerable<T>,
 ...
 * @param keySelector A function to extract a key from each element.
 */
orderByDescending<TKey>(keySelector: (item: T) => TKey): multiplex$OrderedEnumerable<T>,
...
sequenceEqual(
second: multiplex$Iterable<T>,
comparer: multiplex$EqualityComparer<T>): boolean,
 ...
 */
select<TResult>(
selector: (item: T, index: number) => TResult): multiplex$Enumerable<TResult>,
...
collectionSelector: (item: T, index: number) => multiplex$Iterable<TCollection>,
resultSelector?: (item: T, collection: TCollection) => TResult): multiplex$Enumerable<TResult>,
 ...
 */
skip(count: number): multiplex$Enumerable<T>,

/**
 * Bypasses elements in a sequence as long as a specified condition is true and then returns the remaining elements.
 * @param predicate A function to test each source element for a condition.
 */
skipWhile(predicate: (item: T) => boolean): multiplex$Enumerable<T>,

/**
 * Bypasses elements in a sequence as long as a specified condition is true and then returns the remaining elements. The element's index is used in the logic of the predicate function.
 * @param predicate A function to test each source element for a condition; the second parameter of the function represents the index of the source element.
 */
skipWhile(predicate: (item: T, index: number) => boolean): multiplex$Enumerable<T>,
 ...
 */
take(count: number): multiplex$Enumerable<T>,

/**
 * Returns elements from a sequence as long as a specified condition is true.
 * @param predicate A function to test each source element for a condition.
 */
takeWhile(predicate: (item: T) => boolean): multiplex$Enumerable<T>,

/**
 * Returns elements from a sequence as long as a specified condition is true. The element's index is used in the logic of the predicate function.
 * @param predicate A function to test each source element for a condition; the second parameter of the function represents the index of the source element.
 */
takeWhile(predicate: (item: T, index: number) => boolean): multiplex$Enumerable<T>,
 ...
 * @param keySelector A function to extract a key from each element.
 */
toDictionary<TKey>(keySelector: (item: T) => TKey): multiplex$Dictionary<TKey, T>,
...
toDictionary<TKey>(
keySelector: (item: T) => TKey,
comparer: multiplex$EqualityComparer<TKey>): multiplex$Dictionary<TKey, T>,
...
keySelector: (item: T) => TKey,
elementSelector: (item: T) => TElement): multiplex$Dictionary<TKey, TElement>,
...
keySelector: (item: T) => TKey,
elementSelector: (item: T) => TElement,
comparer: multiplex$EqualityComparer<TKey>): multiplex$Dictionary<TKey, TElement>,

/**
 * Creates a List from an Enumerable.
 */
toList(): multiplex$List<T>,

/**
 * Creates a Lookup from an Enumerable according to a specified key selector function.
 * @param keySelector A function to extract a key from each element.
 */
toLookup<TKey>(keySelector: (item: T) => TKey): multiplex$Lookup<TKey, T>,
...
toLookup<TKey>(
keySelector: (item: T) => TKey,
comparer: multiplex$EqualityComparer<TKey>): multiplex$Lookup<TKey, T>,
...
keySelector: (item: T) => TKey,
elementSelector: (item: T) => TElement): multiplex$Lookup<TKey, TElement>,
...
keySelector: (item: T) => TKey,
elementSelector: (item: T) => TElement,
comparer: multiplex$EqualityComparer<TKey>): multiplex$Lookup<TKey, TElement>,

/**
 * Produces the set union of two sequences by using the default equality comparer.
 * @param second An Iterable whose distinct elements form the second set for the union.
 */
union(second: multiplex$Iterable<T>): multiplex$Enumerable<T>,
 ...
 * @param predicate A function to test each source element for a condition.
 */
where(predicate: (item: T) => boolean): multiplex$Enumerable<T>,

/**
 * Filters a sequence of values based on a predicate. Each element's index is used in the logic of the predicate function.
 * @param predicate A function to test each source element for a condition; the second parameter of the function represents the index of the source element.
 */
where(predicate: (item: T, index: number) => boolean): multiplex$Enumerable<T>,
 ...
 */
zip<TSecond, TResult>(
second: multiplex$Iterable<TSecond>,
resultSelector: (first: T, second: TSecond) => TResult): multiplex$Enumerable<TResult>
} & multiplex$Iterable<T>
...
} & multiplex$Collection<multiplex$KeyValuePair<TKey, TValue>>
...
} & multiplex$Collection<multiplex$Grouping<TKey, TElement>>
 ...
 * Supports a simple iteration over a collection.
 */
multiplex$Enumerator: multiplex$EnumeratorConstructor,

/**
 * Exposes the enumerator, which supports a simple iteration over a collection of a specified type.
 */
multiplex$Enumerable: multiplex$EnumerableConstructor,

/**
 * Provides a base class for implementations of Comparer<T> generic interface.
 */
multiplex$Comparer: multiplex$ComparerConstructor,

/**
 * Provides a base class for implementations of the EqualityComparer.
 */
multiplex$EqualityComparer: multiplex$EqualityComparerConstructor,

/**
 * Initializes a new instance of the abstract Collection class.
 */
multiplex$Collection: multiplex$CollectionConstructor,

/**
 * Initializes a new instance of the abstract Collection class.
 */
multiplex$ReadOnlyCollection: multiplex$ReadOnlyCollectionConstructor,

/**
 * Represents a strongly typed list of objects that can be accessed by index.
 */
multiplex$List: multiplex$ListConstructor,

/**
 * Represents a collection of key/value pairs that are sorted by key based on the associated Comparer implementation.
 */
multiplex$SortedList: multiplex$SortedListConstructor,

/**
 * Defines a key/value pair that can be set or retrieved.
 */
multiplex$KeyValuePair: multiplex$KeyValuePairConstructor,

/**
 * Represents a collection of keys and values.
 */
multiplex$Dictionary: multiplex$DictionaryConstructor,

/**
 * Represents a set of values.
 */
multiplex$HashSet: multiplex$HashSetConstructor,

/**
 * Represents a node in a LinkedList.
 */
multiplex$LinkedListNode: multiplex$LinkedListNodeConstructor,

/**
 * Represents a doubly linked list.
 */
multiplex$LinkedList: multiplex$LinkedListConstructor,

/**
 * Represents a first-in, first-out collection of objects.
 */
multiplex$Queue: multiplex$QueueConstructor,

/**
 * Represents a variable size last-in-first-out (LIFO) collection of instances of the same arbitrary type.
 */
multiplex$Stack: multiplex$StackConstructor
} 