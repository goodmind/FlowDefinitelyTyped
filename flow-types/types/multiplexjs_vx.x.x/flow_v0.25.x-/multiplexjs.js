declare var multiplex: multiplex$multiplex$MultiplexStatic;
...
declare type multiplex$Enumerable<T> = {
  ...
  ): multiplex$Enumerable<multiplex$Grouping<TKey, T>>,
  ...
  groupBy<TKey>(
    keySelector: (item: T) => TKey,
    comparer: multiplex$EqualityComparer<TKey>
  ): multiplex$Enumerable<multiplex$Grouping<TKey, T>>,
  ...
  ): multiplex$Enumerable<multiplex$Grouping<TKey, TElement>>,
  ...
  groupBy<TKey, TElement, TResult>(
    ...
    resultSelector: (
      key: TKey,
      elements: multiplex$Iterable<TElement>
    ) => TResult
  ...
  selectMany<TCollection, TResult>(
    collectionSelector: (
      item: T,
      index: number
    ) => multiplex$Iterable<TCollection>,
  ...
  toDictionary<TKey, TElement>(
    keySelector: (item: T) => TKey,
    elementSelector: (item: T) => TElement
  ): multiplex$Dictionary<TKey, TElement>,
  ...
  toLookup<TKey, TElement>(
    keySelector: (item: T) => TKey,
    elementSelector: (item: T) => TElement
  ): multiplex$Lookup<TKey, TElement>,
...
declare interface multiplex$SortedListConstructor {
  ...
  ): multiplex$SortedList<TKey, TValue>;
...
declare interface multiplex$KeyValuePairConstructor {
  ...
  new<TKey, TValue>(
    key: TKey,
    value: TValue
  ): multiplex$KeyValuePair<TKey, TValue>;
}
...
declare type multiplex$Dictionary<TKey, TValue> = {
  ...
  copyTo(
    array: multiplex$KeyValuePair<TKey, TValue>[],
    arrayIndex: number
  ): void,
...
declare interface multiplex$DictionaryConstructor {
  ...
  new<TKey, TValue>(
    dictionary: multiplex$Dictionary<TKey, TValue>
  ): multiplex$Dictionary<TKey, TValue>;
...
declare type multiplex$LinkedList<T> = {
  ...
  addAfter(
    ...
    newNode: multiplex$LinkedListNode<T>
  ): multiplex$LinkedListNode<T>,
...
declare type multiplex$OrderedEnumerable<TElement> = {
  ...
  createOrderedEnumerable<TKey>(
    ...
    comparer: multiplex$Comparer<TKey>,
    descending: boolean
  ): multiplex$OrderedEnumerable<TElement>,
...
declare interface multiplex$MultiplexStatic {
   ...
   * @param obj An Iterable object. eg. Enumerable, Array, String, Set, Map, Iterable & Generators
   */
  <T>(obj: multiplex$Iterable<T>): multiplex$Enumerable<T>;

  /**
   * Defines an enumerator, which supports an iteration over the specified Generator function.
   * @param factory An Enumerator factory function.
   */
  <T>(factory: () => multiplex$Enumerator<T>): multiplex$Enumerable<T>;
   ...
   * @param obj An Array-like object.
   */
  <T>(obj: multiplex$ArrayLike<T>): multiplex$Enumerable<T>;
  ...
  equals(
    objA: any,
    objB: any,
    comparer: multiplex$EqualityComparer<any>
  ): boolean;
