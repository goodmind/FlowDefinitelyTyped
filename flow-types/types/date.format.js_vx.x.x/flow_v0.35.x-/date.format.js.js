 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} mask
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} utc
 */
 ...
 * The mask defaults to dateFormat.masks.default.
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} date
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} mask
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} utc
 */
