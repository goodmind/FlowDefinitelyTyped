declare module 'aframe' {
	...
	declare export interface ObjectMap<T> {
[key: string]: T
} 
...
tick(): void
	...
	declare export interface Component<T: {[key: string]: any}, S: System> {
attrName?: string,
data: T,
dependencies?: string[],
el: Entity,
...
pause(): void
	...
	declare export interface ComponentDescriptor<T: Component> {
...
componentName: string
	...
	declare export interface Geometry<T> {
data: T,
name: string,
...
init(data: any): void
	...
	declare export interface GeometryConstructor<T: {[key: string]: any}> {
new (): T & Geometry
} 
	declare export interface GeometryDescriptor<T: Geometry> {
Geometry: GeometryConstructor<T>,
schema: Schema
} 
	declare export type MultiPropertySchema<T: {[key: string]: any}> = $ObjMapi<T, <P>(P) => SinglePropertySchema<$ElementType<T, P>> | $ElementType<T, P>>;
	declare export type PropertyTypes = "array"
| "asset"
| "audio"
| "boolean"
| "color"
...
| "vec3"
| "vec4";
	declare export type SceneEvents = "enter-vr" | "exit-vr" | "loaded" | "renderstart";
...
addEventListener(type: SceneEvents, listener: EventListener, useCapture?: boolean): void
	...
	declare export type Schema<T: {[key: string]: any}> = SinglePropertySchema<T> | MultiPropertySchema<T>;
...
new (): T
	...
	declare export interface ShaderDescriptor<T: Shader> {
...
stringify(value: T): string
	...
	declare export interface System<T: {[key: string]: any}> {
data: T,
schema: Schema<T>,
init(): void,
pause(): void,
...
tick(t: number, dt: number): void
	...
	declare export interface SystemConstructor<T: {[key: string]: any}> {
...
diff(a: {[key: string]: any}, b: {[key: string]: any}): {[key: string]: any},
extend(
...
optionalContext?: {}): (t: number, dt: number) => void,
throttleTick(
tickFunction: (t: number, dt: number) => void,
minimumInterval: number,
optionalContext?: {}): (t: number, dt: number) => void
} 
	declare export type ComponentDefinition<T: {[key: string]: any}> = T & $Shape<Component> & ThisType<T & Component>;
	declare export type GeometryDefinition<T: {[key: string]: any}, U> = T & $Shape<Geometry<U>>;
	declare export type NodeDefinition<T: {[key: string]: any}> = T & $Shape<ANode>;
...
schema: $ElementType<Shader, "schema">
	...
	declare export type ShaderDefinition<T: {[key: string]: any}> = T & $Shape<Shader>;
	declare export type SystemDefinition<T: {[key: string]: any}> = T & $Shape<System>;
...
name: string,
component: ComponentDefinition<T>): ComponentConstructor<T>,
registerElement(name: string, element: {[key: string]: any}): void,
registerGeometry<T: {[key: string]: any}>(
name: string,
geometry: GeometryDefinition<T>): GeometryConstructor<T>,
registerPrimitive(name: string, primitive: PrimitiveDefinition): void,
registerShader<T: MinimalShaderDefinition & {[key: string]: any}>(
name: string,
shader: ShaderDefinition<T>): ShaderConstructor<T>,
registerSystem<T: {[key: string]: any}>(
name: string,
definition: SystemDefinition<T>): SystemConstructor<T>
} 
	declare export var AComponent: $ElementType<AFrame, "AComponent">;
	declare export var AEntity: $ElementType<AFrame, "AEntity">;
	declare export var ANode: $ElementType<AFrame, "ANode">;
	declare export var AScene: $ElementType<AFrame, "AScene">;
	declare export var components: $ElementType<AFrame, "components">;
	declare export var geometries: $ElementType<AFrame, "geometries">;
	declare export var primitives: $ElementType<AFrame, "primitives">;
	declare export var scenes: $ElementType<AFrame, "scenes">;
	declare export var schema: $ElementType<AFrame, "schema">;
	declare export var shaders: $ElementType<AFrame, "shaders">;
	declare export var systems: $ElementType<AFrame, "systems">;
	declare export var THREE: $ElementType<AFrame, "THREE">;
	declare export var TWEEN: $ElementType<AFrame, "TWEEN">;
	declare export var utils: $ElementType<AFrame, "utils">;
	declare export var version: $ElementType<AFrame, "version">;
	declare export var registerComponent: $ElementType<AFrame, "registerComponent">;
	declare export var registerElement: $ElementType<AFrame, "registerElement">;
	declare export var registerGeometry: $ElementType<AFrame, "registerGeometry">;
	declare export var registerPrimitive: $ElementType<AFrame, "registerPrimitive">;
	declare export var registerShader: $ElementType<AFrame, "registerShader">;
	declare export var registerSystem: $ElementType<AFrame, "registerSystem">;
