 ...
 */
declare export function setUpTestDirectory(dir: string): (done: (...args: any[]) => void) => void
 ...
 */
declare export function gruntfile(options: Dictionary<any>, done?: (...args: any[]) => void): void
 ...
 */
declare export function testDirectory(dir: string, cb?: (error?: any) => void): void
 ...
 */
declare export function mockPrompt(generator: Generator, answers: Generator.Answers): void
 ...
 */
declare export function mockLocalConfig(generator: Generator, localConfig: Dictionary<any>): void
...
args?: string | string[],
options?: Dictionary<any>): Generator
 ...
 * @param dependencies - paths to the generators dependencies
 */
declare export function registerDependencies(env: Env, dependencies: Dependency[]): void
...
settings?: RunContextSettings): RunContext
...
} & RunContextConstructor & EventEmitter
