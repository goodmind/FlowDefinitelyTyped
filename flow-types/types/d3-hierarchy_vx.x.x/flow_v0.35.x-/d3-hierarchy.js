declare module 'd3-hierarchy' {
        declare export interface HierarchyLink<Datum> {
...
target: HierarchyNode<Datum>
	...
	declare export interface HierarchyNode<Datum> {
 ...
 */
declare export function hierarchy<Datum>(
data: Datum,
children?: (d: Datum) => (Datum[] | null | void)): HierarchyNode<Datum>

	declare export interface StratifyOperator<Datum> {
 ...
 */
id(): (d: Datum, i: number, data: Datum[]) => (string | null | "" | void),
 ...
 */
id(id: (d: Datum, i: number, data: Datum[]) => (string | null | "" | void)): this,

/**
 * Returns the current parent id accessor, which defaults to: `(d) => d.parentId`.
 */
parentId(): (d: Datum, i: number, data: Datum[]) => (string | null | "" | void),
 ...
 */
parentId(
parentId: (d: Datum, i: number, data: Datum[]) => (string | null | "" | void)): this
} 
	
/**
 * Constructs a new stratify operator with the default settings.
 */
declare export function stratify<Datum>(): StratifyOperator<Datum>

	declare export interface HierarchyPointLink<Datum> {
...
target: HierarchyPointNode<Datum>
	...
	declare export type HierarchyPointNode<Datum> = {
...
links(): Array<HierarchyPointLink<Datum>>
	...
	declare export interface ClusterLayout<Datum> {
 ...
 */
separation(
separation: (a: HierarchyPointNode<Datum>, b: HierarchyPointNode<Datum>) => number): this
} 
	
/**
 * Creates a new cluster layout with default settings.
 */
declare export function cluster<Datum>(): ClusterLayout<Datum>

	declare export interface TreeLayout<Datum> {
 ...
 */
declare export function tree<Datum>(): TreeLayout<Datum>

	declare export interface HierarchyRectangularLink<Datum> {
...
target: HierarchyRectangularNode<Datum>
	...
	declare export type HierarchyRectangularNode<Datum> = {
...
links(): Array<HierarchyRectangularLink<Datum>>
	...
	declare export interface TreemapLayout<Datum> {
 ...
 */
declare export function treemap<Datum>(): TreemapLayout<Datum>
 ...
 */
declare export function treemapBinary(
 ...
 */
declare export function treemapDice(
node: HierarchyRectangularNode<any>,
x0: number,
y0: number,
x1: number,
 ...
 */
declare export function treemapSlice(
node: HierarchyRectangularNode<any>,
x0: number,
y0: number,
x1: number,
 ...
 */
declare export function treemapSliceDice(
node: HierarchyRectangularNode<any>,
x0: number,
y0: number,
x1: number,
y1: number): void
	...
	declare export interface RatioSquarifyTilingFactory {
 ...
 */
declare export var treemapSquarify: RatioSquarifyTilingFactory;
 ...
 */
declare export var treemapResquarify: RatioSquarifyTilingFactory;
	declare export interface PartitionLayout<Datum> {
 ...
 */
declare export function partition<Datum>(): PartitionLayout<Datum>

	declare export interface HierarchyCircularLink<Datum> {
...
target: HierarchyCircularNode<Datum>
	...
	declare export type HierarchyCircularNode<Datum> = {
...
links(): Array<HierarchyCircularLink<Datum>>
	...
	declare export interface PackLayout<Datum> {
 ...
 */
declare export function pack<Datum>(): PackLayout<Datum>

	declare export interface PackRadius {
...
y?: number
	...
	declare export interface PackCircle {
 ...
 */
declare export function packSiblings<Datum: PackRadius>(circles: Datum[]): Array<Datum & PackCircle>
 ...
 * @param circles The specified array of circles to pack.
 */
declare export function packEnclose<Datum: PackCircle>(circles: Datum[]): PackCircle
