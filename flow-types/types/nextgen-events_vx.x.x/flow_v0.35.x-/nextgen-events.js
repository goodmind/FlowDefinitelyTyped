...
eventName: string,
fn?: any,
options?: NextGenEvents$NextGenEvents$AddListenerOptions): this;
on(
eventName: string,
fn?: any,
options?: NextGenEvents$NextGenEvents$AddListenerOptions): this;
...
emit(nice: number, name: string, ...args: any[]): NextGenEvents$NextGenEvents$Event;
...
addListenerContext(contextName: string, options: NextGenEvents$NextGenEvents$ContextOptions): this;
...
static emitEvent(event: NextGenEvents$NextGenEvents$Event): NextGenEvents$NextGenEvents$Event;
static init(): void;
static initFrom(from: NextGenEvents): void;
static mergeListeners(foreigners: NextGenEvents$NextGenEvents$Listeners): void;
static filterOutCallback(what: any, currentElement: any): boolean;
static listenerWrapper(listener: any, event: any, contextScope: string, serial: any): void;
static emitToOneListener(
event: NextGenEvents$NextGenEvents$Event,
listener: any,
removedListeners: any): void;
...
options?: NextGenEvents$NextGenEvents$AddListenerOptions): any;
static groupOn(
emitters: NextGenEvents[],
eventName: string,
fn?: NextGenEvents$NextGenEvents$Func,
...
eventName: string,
fn?: NextGenEvents$NextGenEvents$Func,
options?: NextGenEvents$NextGenEvents$AddListenerOptions): void;
static groupWaitFor(emitters: NextGenEvents[], eventName: string): Promise<void>;
static groupWaitForAll(emitters: NextGenEvents[], eventName: string): Promise<void>;
...
fn?: NextGenEvents$NextGenEvents$Func,
options?: NextGenEvents$NextGenEvents$AddListenerOptions): void;
static groupWaitForFirst(emitters: NextGenEvents[], eventName: string): Promise<void>;
static groupWaitForFirstAll(emitters: NextGenEvents[], eventName: string): Promise<void>;
...
fn?: NextGenEvents$NextGenEvents$Func,
options?: NextGenEvents$NextGenEvents$AddListenerOptions): void;
static groupWaitForLast(emitters: NextGenEvents[], eventName: string): Promise<void>;
static groupWaitForLastAll(emitters: NextGenEvents[], eventName: string): Promise<void>;
static groupRemoveListener(emitters: NextGenEvents[], eventName: string, id: number): void;
static groupRemoveAllListeners(emitters: NextGenEvents[], eventName: string): void;
static groupEmit(emitters: NextGenEvents[], nice?: number, ...args: any[]): void;
static groupWaitForEmit(emitters: NextGenEvents[], nice?: number, ...args: any[]): Promise<void>;
...
scopeName: string): NextGenEvents$NextGenEvents$Scope;
static processScopeQueue(
self: NextGenEvents,
contextScope: NextGenEvents$NextGenEvents$Scope,
serial: boolean,
isCompletionCallback: boolean): void
}
...
declare type NextGenEvents$AddListenerOptions = boolean | {
fn: any,
id?: any,
once: any,
async: any,
