declare module 'react-native-popup-dialog' {
	...
	import type {
          GestureResponderEvent,StyleProp,ViewStyle,TextStyle
        } from 'react-native';
...
createAnimations(): {[key: string]: any}
	...
	declare export class DialogContent mixins React.Component<DialogContentProps, any> {}
	declare export class DialogActionList mixins React.Component<DialogActionListProps, any> {}
	declare export class DialogButton mixins React.Component<DialogButtonProps, any> {}
	declare export class DialogTitle mixins React.Component<DialogTitleProps, any> {}
