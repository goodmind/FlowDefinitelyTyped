declare module 'es6-promisify' {
	...
	declare export function promisify<T>(original: (cb: Callback<T>) => any): () => Promise<T>

	declare export function promisify<T, U>(original: (param1: U, cb: Callback<T>) => any): (param1: U) => Promise<T>

	declare export function promisify<T, U, V>(
original: (param1: U, param2: V, cb: Callback<T>) => any): (param1: U, param2: V) => Promise<T>

	declare export function promisify<T, U, V, W>(
original: (param1: U, param2: V, param3: W, cb: Callback<T>) => any): (param1: U, param2: V, param3: W) => Promise<T>

	declare export function promisify(original: CallbackFunction): PromiseFunction
