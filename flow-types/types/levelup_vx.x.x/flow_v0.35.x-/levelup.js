declare module 'levelup' {
	...
	declare export type LevelUp<DB> = {
open(): Promise<void>,
...
new <DB: AbstractLevelDOWN>(db: DB, options: any, cb?: ErrorCallback): LevelUp<DB>,
new <DB: AbstractLevelDOWN>(db: DB, cb?: ErrorCallback): LevelUp<DB>,
errors: any
} 
	declare export interface LevelUpChain<K, V> {
+length: number,
