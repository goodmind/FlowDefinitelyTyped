declare module "appletvjs" {
  declare var AppleTVJS$App: AppleTVJS$AppleTVJS$App;
  declare var AppleTVJS$Device: AppleTVJS$AppleTVJS$Device;
  declare var navigationDocument: AppleTVJS$AppleTVJS$NavigationDocument;
  declare var AppleTVJS$Settings: AppleTVJS$AppleTVJS$Settings;
  declare function evaluateScripts(
    scripts: string[],
    complete: (success: boolean) => void
  ): void;

  declare interface AppleTVJS$App {
    /**
  ...
  declare class AppleTVJS$Highlight {
    /**
  ...
  declare class AppleTVJS$HighlightGroup {
    /**
  ...
  declare class AppleTVJS$Interstitial {
    /**
  ...
  declare class AppleTVJS$MediaItem {
    /**
  ...
  declare class AppleTVJS$Player {
    /**
  ...
  declare class AppleTVJS$Playlist {
    /**
  ...
  declare class AppleTVJS$TVError {
    /**
     * The error code.
     */
    code: string;
