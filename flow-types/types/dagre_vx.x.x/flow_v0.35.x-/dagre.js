...
setDefaultEdgeLabel(callback: string | ((edge: Edge) => string | Label)): graphlib$Graph;
setEdge(params: Edge, value?: string | {
[key: string]: any
}): graphlib$Graph;
setEdge(
sourceId: string,
...
setDefaultNodeLabel(callback: string | ((nodeId: string) => string | Label)): graphlib$Graph;
...
declare function alg$dijkstraAll(graph: graphlib$Graph, weightFn?: WeightFn, edgeFn?: EdgeFn): any


declare function alg$findCycles(graph: graphlib$Graph): string[][]


declare function alg$floydWarchall(graph: graphlib$Graph, weightFn?: WeightFn, edgeFn?: EdgeFn): any


declare function alg$isAcyclic(graph: graphlib$Graph): boolean


declare function alg$postorder(graph: graphlib$Graph, nodeNames: string | string[]): string[]


declare function alg$preorder(graph: graphlib$Graph, nodeNames: string | string[]): string[]


declare function alg$prim(graph: graphlib$Graph, weightFn?: WeightFn): graphlib$Graph
...
layout?: GraphLabel & NodeConfig & EdgeConfig): void
