declare module 'fixed-data-table' {
	...
	declare module.exports: typeof FixedDataTable
      ...
      declare var npm$namespace$FixedDataTable: {
        
        version: typeof FixedDataTable$version,
      }
declare export var FixedDataTable$version: string;
 ...
 */
onRowClick?: (event: React.SyntheticEvent<FixedDataTable$Table>, rowIndex: number) => void,

/**
 * Callback that is called when a row is double clicked.
 */
onRowDoubleClick?: (event: React.SyntheticEvent<FixedDataTable$Table>, rowIndex: number) => void,

/**
 * Callback that is called when a mouse-down event happens
 * on a row.
 */
onRowMouseDown?: (event: React.SyntheticEvent<FixedDataTable$Table>, rowIndex: number) => void,

/**
 * Callback that is called when a mouse-enter event happens
 * on a row.
 */
onRowMouseEnter?: (event: React.SyntheticEvent<FixedDataTable$Table>, rowIndex: number) => void,

/**
 * Callback that is called when a mouse-leave event happens
 * on a row.
 */
onRowMouseLeave?: (event: React.SyntheticEvent<FixedDataTable$Table>, rowIndex: number) => void,
...
} & React.Props<FixedDataTable$Table>
 ...
 */
header?: string | React.ReactElement<any> | ((props: FixedDataTable$CellProps) => (string | React.ReactElement<any>)),
 ...
 */
cell?: string | React.ReactElement<any> | ((props: FixedDataTable$CellProps) => (string | React.ReactElement<any>)),
 ...
 * props object as the first argument.
 */
footer?: string | React.ReactElement<any> | ((props: FixedDataTable$CellProps) => (string | React.ReactElement<any>)),
...
} & React.Props<FixedDataTable$Column>
 ...
 */
header: string | React.ReactElement<any> | ((props: FixedDataTable$CellProps) => (string | React.ReactElement<any>))
} & React.Props<FixedDataTable$ColumnGroup>
 ...
 */
columnKey?: string | number
} & React.HTMLAttributes<FixedDataTable$Cell>


declare export class FixedDataTable$Table mixins React.Component<FixedDataTable$TableProps> {}

declare export class FixedDataTable$Column mixins React.Component<FixedDataTable$ColumnProps> {}

declare export class FixedDataTable$ColumnGroup mixins React.Component<FixedDataTable$ColumnGroupProps> {}

declare export class FixedDataTable$Cell mixins React.Component<FixedDataTable$CellProps> {}
    }
