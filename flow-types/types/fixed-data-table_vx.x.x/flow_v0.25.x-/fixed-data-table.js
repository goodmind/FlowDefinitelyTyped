declare module "fixed-data-table" {
  ...
  declare export default typeof FixedDataTable;

  declare var npm$namespace$FixedDataTable: {
    version: typeof FixedDataTable$version,

    Table: typeof FixedDataTable$Table,
    Column: typeof FixedDataTable$Column,
    ColumnGroup: typeof FixedDataTable$ColumnGroup,
    Cell: typeof FixedDataTable$Cell
  };
  ...
  declare export type FixedDataTable$TableProps = {
     ...
     */
    onRowClick?: (
      event: React.SyntheticEvent<FixedDataTable$Table>,
      rowIndex: number
    ) => void,
  ...
  declare type FixedDataTable$ColumnProps = {
    ...
    header?:
      ...
      | ((props: FixedDataTable$CellProps) => string | React.ReactElement<any>),
  ...
  declare export class FixedDataTable$Table
    mixins React.Component<FixedDataTable$TableProps> {}

  declare export class FixedDataTable$Column
    mixins React.Component<FixedDataTable$ColumnProps> {}

  declare export class FixedDataTable$ColumnGroup
    mixins React.Component<FixedDataTable$ColumnGroupProps> {}

  declare export class FixedDataTable$Cell
    mixins React.Component<FixedDataTable$CellProps> {}
}
