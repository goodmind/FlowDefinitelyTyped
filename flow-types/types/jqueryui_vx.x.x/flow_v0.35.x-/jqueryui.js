 ...
 */
beforeShow?: (input: Element, inst: any) => JQueryUI$JQueryUI$DatepickerOptions,
...
(name: string, prototype: T & ThisType<T & JQueryUI$WidgetCommonProperties>): JQuery,
(name: string, base: Function, prototype: T & ThisType<T & JQueryUI$WidgetCommonProperties>): JQuery
} 
...
accordion(optionLiteral: string, options: JQueryUI$JQueryUI$AccordionOptions): any,
...
autocomplete(optionLiteral: string, options: JQueryUI$JQueryUI$AutocompleteOptions): any,
...
button(optionLiteral: string, options: JQueryUI$JQueryUI$ButtonOptions): any,
...
buttonset(optionLiteral: string, options: JQueryUI$JQueryUI$ButtonOptions): any,
...
datepicker(
methodName: "option",
optionName: "beforeShow"): (input: Element, inst: any) => JQueryUI$JQueryUI$DatepickerOptions,
...
beforeShowValue: (input: Element, inst: any) => JQueryUI$JQueryUI$DatepickerOptions): JQuery,
...
dialog(optionLiteral: string, options: JQueryUI$JQueryUI$DialogOptions): any,
...
draggable(optionLiteral: string, options: JQueryUI$JQueryUI$DraggableOptions): any,
...
droppable(optionLiteral: string, options: JQueryUI$JQueryUI$DraggableOptions): any,
...
progressbar(optionLiteral: string, options: JQueryUI$JQueryUI$ProgressbarOptions): any,
...
resizable(optionLiteral: string, options: JQueryUI$JQueryUI$ResizableOptions): any,
...
selectable(optionLiteral: string, options: JQueryUI$JQueryUI$SelectableOptions): any,
...
selectmenu(optionLiteral: string, options: JQueryUI$JQueryUI$SelectMenuOptions): any,
...
slider(optionLiteral: string, options: JQueryUI$JQueryUI$SliderOptions): any,
...
sortable(methodName: "toArray", options?: {
attribute?: string
}): string[],
...
sortable(optionLiteral: string, options: JQueryUI$JQueryUI$SortableOptions): any,
...
spinner(optionLiteral: string, options: JQueryUI$JQueryUI$SpinnerOptions): any,
...
tooltip(optionLiteral: string, options: JQueryUI$JQueryUI$TooltipOptions): any,
