declare module "intercomjs" {
  declare interface intercom$Intercom {
     ...
     */
    bind(socket: any, options?: intercom$intercom$SocketBindingOptions): void;
  }
  ...
  declare interface IntercomStatic {
     ...
     */
    getInstance(): intercom$intercom$Intercom;
  ...
  declare var intercom$Intercom: IntercomStatic;
}
