declare module 'ip-address' {
        declare export interface TeredoProperties {
prefix: string,
server4: Address4,
client4: Address4,
flags: string,
...
udpPort: string
	...
	declare export interface SixToFourProperties {
prefix: string,
gateway: string
} 
	declare export function group(): string

	declare export function href(port?: number): string

	declare export function link(options: any): string

	declare export function simpleGroup(addressString: string, offset: number): string

	declare export function spanAll(s: string, offset?: number): string

	declare export function spanLeadingZeroes(address: string): string

	declare export function spanAllZeroes(s: string): string

	declare export type IPv6Scope = "Reserved"
| "Interface local"
| "Link local"
| "Admin local"
| "Site local"
...
| "Global"
| "Reserved";
	declare export type IPv6Type = "Multicast (All nodes on this interface)"
 ...
 */
constructor(address: string, groups?: number): this;
groups: number;
subnet: string;
subnetMask: number;
v4: boolean;
