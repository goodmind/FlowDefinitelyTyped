declare module "ndarray" {
  declare function ndarray<T>(
    main$data: ndarray$ndarray$Data<T>,
    shape?: number[],
    stride?: number[],
    offset?: number
  ): ndarray<T>;

  declare interface ndarray<T = number> {
    main$data: ndarray$ndarray$Data<T>;
    shape: number[];
    stride: number[];
    offset: number;
