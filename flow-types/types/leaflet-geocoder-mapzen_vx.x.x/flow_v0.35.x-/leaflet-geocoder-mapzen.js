declare module 'leaflet-geocoder-mapzen' {
	...
	declare module 'leaflet' {
        declare type Control$GeocoderStatic = {
...
declare type Control$Geocoder = {} & Control


declare interface Control$GeocoderOptions {
 ...
 * Creates a geocoder control.
 */
declare function control$geocoder(
api_key: string,
options?: Control$Control$GeocoderOptions): Control$Control$Geocoder
