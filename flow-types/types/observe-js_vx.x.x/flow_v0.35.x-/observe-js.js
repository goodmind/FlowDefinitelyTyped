...
open(
onChange: (splices: Array<observejs$splice>, oldSplices: Array<observejs$splice>) => any): void
} & observejs$Observable
...
getValueFrom(object: any, newValue: any): any
	...
	declare export {
          PathObserver,ArrayObserver,ObjectObserver,CompoundObserver,ObserverTransform,Path
        }
