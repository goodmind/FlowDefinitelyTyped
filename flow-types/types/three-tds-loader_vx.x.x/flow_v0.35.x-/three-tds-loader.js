declare module 'three-tds-loader' {
        import typeof * as THREE from 'three';

	declare module.exports: typeof TDSLoader

	declare class TDSLoader  {
constructor(three: typeof THREE): this;
 ...
 */
readMaterialGroup: (data: DataView) => {[key: string]: any};
 ...
 */
readChunk: (data: DataView) => {[key: string]: any};

/**
 * Set position to the end of the current chunk of data.
 * @param chunk Data chunk.
 */
endChunk: (chunk: {[key: string]: any}) => void;
 ...
 * @param chunk Data chunk.
 */
nextChunk: (data: DataView, chunk: {[key: string]: any}) => number;
