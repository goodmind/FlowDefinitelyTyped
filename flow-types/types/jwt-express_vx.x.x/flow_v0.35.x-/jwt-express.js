 ...
 * @return this
 */
store(res: express.Express$Response): JWT,
...
verify(token: string): JWT
	...
	declare export interface JWTExpressOptions {
...
verifyOptions?: jsonwebtoken.VerifyOptions
	...
	declare export type JWTExpressError = {
name: string,
message: string
} & Error

	declare export var options: JWTExpressOptions;
 ...
 */
declare export function active(): express.RequestHandler
 ...
 * @return Express middleware
 */
declare export function clear(): express.RequestHandler

	
/**
 * Returns a newly created / signed JWT Object from the payload.
 * @param secret If secret is a string, that string will be used to verify / sign with.
 ...
 * @return JWT
 */
declare export function create(secret: string | ((payload: any) => string), payload: any): JWT
...
secret: string | ((req: express.Express$Request) => string),
options?: JWTExpressOptions): express.RequestHandler
 ...
 * @param key This is they key used to look up the value in the payload.
 ...
 * @return Express middleware
 */
declare export function require(key: string, operator?: string, value?: any): express.RequestHandler
 ...
 * @return Express middleware
 */
declare export function valid(): express.RequestHandler
