declare module "tryer" {
  declare var tryer: tryer$tryer$TryerStatic;
  declare module.exports: typeof tryer;

  declare interface tryer$Options {
    /**
  ...
  declare type tryer$TryerStatic = (options: $ReadOnly<tryer$Options>) => void;
}
