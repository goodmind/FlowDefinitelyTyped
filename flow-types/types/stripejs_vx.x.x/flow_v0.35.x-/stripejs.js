declare module 'stripejs' {
        import type {
          StripeElement,ElementCreatorOptions,ElementFactory
        } from './element';

	import type {
          StripePaymentOptions,StripePaymentRequest
        } from './payment';

	import type {
          BankTokenData,PiiTokenData,TokenData,IBANTokenData,TokenResult
        } from './token';
	...
	declare export interface StripeJS {
...
client_secret: string
	...
	declare export interface StripeConfigOptions {
 ...
 */
declare export interface StripeError {
...
param?: string
	...
	declare export type errorType = "api_connection_error"
| "api_error"
