...
downstreamRes?: any,
agent?: $ElementType<WreckObject, "agents"> | false,
...
payload: any
	...
	declare type RequestCallback = (uri: string, options: RequestOptions & {
payload?: any
}) => void;
...
method: string,
uri: string,
options: RequestOptions) => Promise<http.IncomingMessage> & {
req: http.ClientRequest
},
