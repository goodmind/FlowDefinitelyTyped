...
constructor(login: PlugAPI$PlugAPI$PlugLogin, callback?: (error: Error, bot: PlugAPI) => void | ((bot: PlugAPI) => void)): this;
...
on(
event: "boothCycle",
callback: (data: PlugAPI$Event.Event$BoothCycle) => void): void;
on(
event: "boothLocked",
callback: (data: PlugAPI$Event.Event$BoothLocked) => void): void;
on(event: "chat", callback: (data: PlugAPI$Event.Event$Chat) => void): void;
on(
event: "chatDelete",
callback: (data: PlugAPI$Event.Event$ChatDelete) => void): void;
on(event: "grab", callback: (data: PlugAPI$Event.Event$Grab) => void): void;
on(event: "advance", callback: (data: PlugAPI$Event.Event$Advance) => void): void;
on(
event: "djListUpdate",
callback: (data: PlugAPI$Event.Event$DJListUpdate) => void): void;
on(event: "emote", callback: (data: PlugAPI$Event.Event$Emote) => void): void;
on(
event: "followJoin",
callback: (data: PlugAPI$Event.Event$FollowJoin) => void): void;
on(
event: "modAddDJ",
callback: (data: PlugAPI$Event.Event$ModAddDJ) => void): void;
on(event: "modBan", callback: (data: PlugAPI$Event.Event$ModBan) => void): void;
on(
event: "modMoveDJ",
callback: (data: PlugAPI$Event.Event$ModMoveDJ) => void): void;
on(
event: "modRemoveDJ",
callback: (data: PlugAPI$Event.Event$ModRemoveDJ) => void): void;
on(event: "modSkip", callback: (data: PlugAPI$Event.Event$ModSkip) => void): void;
on(
event: "roomMinChatLevelUpdate",
callback: (data: PlugAPI$Event.Event$RoomMinChatLevelUpdate) => void): void;
on(
event: "roomJoin",
callback: (data: PlugAPI$Event.Event$RoomJoin) => void): void;
on(
event: "userJoin",
callback: (data: PlugAPI$Event.Event$UserJoin) => void): void;
on(
event: "userLeave",
callback: (data: PlugAPI$Event.Event$UserLeave) => void): void;
on(
event: "userUpdate",
callback: (data: PlugAPI$Event.Event$UserUpdate) => void): void;
on(event: "vote", callback: (data: PlugAPI$Event.Event$Vote) => void): void;
on(event: "command", callback: (data: PlugAPI$Event.Event$Command) => void): void;
