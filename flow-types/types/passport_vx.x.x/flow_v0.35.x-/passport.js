...
declare interface passport$Authenticator<InitializeRet, AuthenticateRet, AuthorizeRet, AuthorizeOptions> {
...
declare type passport$StrategyCreated<T, O> = $ObjMapi<O, <P>(P) => $ElementType<O, P>>;
...
declare interface passport$Framework<InitializeRet, AuthenticateRet, AuthorizeRet> {
initialize(
