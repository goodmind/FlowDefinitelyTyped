...
id: string
	...
	declare export interface TableState<Item, Meta> {
items: string[],
itemsById: {
[index: string]: Item
},
...
[index: string]: any
	...
	declare export class ORM<State: ORMCommonState>  {
...
updater?: Updater<State>): (state: State, action: any) => State
	...
	declare export type ORMSelector<State: ORMCommonState, Result> = (session: SessionWithModels<State>, ...args: any[]) => Result;
