declare module "redux-orm" {
  ...
  declare export type SessionWithModels<
    State: ORMCommonState
  > = Session<State> & $ObjMapi<State, <P>(P) => typeof Model>;
  declare export type ModelWithFields<
    Fields,
    Additional = {},
    VirtualFields = {}
  ...
  declare export class Model<Fields, Additional = {}, VirtualFields = {}> {
    ...
    static get(lookupObj: { [key: string]: any }): ModelWithFields<
      any,
      any,
      any
    >;
  ...
  declare export class QuerySet<Fields, Additional = {}, VirtualFields = {}> {
    ...
    at(
      index: string
    ): ModelWithFields<Fields, Additional, VirtualFields> | void;
    ...
    filter(lookupObj: { [key: string]: any }): QuerySet<
      Fields,
      Additional,
      VirtualFields
    >;
    exclude(lookupObj: { [key: string]: any }): QuerySet<
      Fields,
      Additional,
      VirtualFields
    >;
  ...
  declare export type Updater<State: ORMCommonState> = (
    session: SessionWithModels<State>,
    action: any
  ) => any;
  declare export function createReducer<State: ORMCommonState>(
    orm: ORM<State>,
    updater?: Updater<State>
  ): (state: State, action: any) => State;

  declare export type ORMSelector<State: ORMCommonState, Result = any> = (
    session: SessionWithModels<State>,
    ...args: any[]
  ) => Result;
  declare export function createSelector<State: ORMCommonState>(
    orm: ORM<State>,
