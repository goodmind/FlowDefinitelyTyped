declare module "d3-voronoi" {
   ...
   */
  declare export type VoronoiPointPair = {
    0: [number, number],
    1: [number, number]
  } & core$Array<[number, number]>;
   ...
   */
  declare export type VoronoiPolygon<T> = {
    /**
   ...
   * The generic refers to the type of the data for the corresponding element.
   */
  declare export type VoronoiTriangle<T> = [T, T, T];
   ...
   * The generic refers to the type of the data for the corresponding element.
   */
  declare export type VoronoiSite<T> = {
    /**
   ...
   * The generic refers to the type of the data for the corresponding element.
   */
  declare export interface VoronoiCell<T> {
    /**
   ...
   * The generic refers to the type of the data for the corresponding element.
   */
  declare export type VoronoiEdge<T> = {
    /**
   ...
   * The generic refers to the type of the data for the corresponding element.
   */
  declare export interface VoronoiLayout<T> {
    /**
 ...
 */
     ...
     */
    __esri$size(): [number, number] | null;
...
where the minimum x and y of the extent are ⟨0,0⟩.
 */
    __esri$size(__esri$size: [number, number]): this;
     ...
     */
    polygons(data: T[]): core$Array<VoronoiPolygon<T>>;
     ...
     * @param data Array of data points.
     */
    triangles(data: T[]): core$Array<VoronoiTriangle<T>>;
     ...
     * @param data Array of data points.
     */
    links(data: T[]): core$Array<VoronoiLink<T>>;
  }
   ...
   * The generic refers to the type of the data for the corresponding element.
   */
  declare export interface VoronoiDiagram<T> {
    /**
     * Array of Voronoi Edges
     */
    edges: core$Array<VoronoiEdge<T>>;

    /**
     * Array of Voronoi Cells, one per input point; a cell may be null for a coincident point.
     */
    cells: core$Array<VoronoiCell<T> | null>;
     ...
     * If the cell’s site is coincident with an earlier site, the associated polygon is null.
     */
    polygons(): core$Array<VoronoiPolygon<T>>;
     ...
     */
    triangles(): core$Array<VoronoiTriangle<T>>;
     ...
     */
    links(): core$Array<VoronoiLink<T>>;
   ...
   */
  declare export function voronoi<T>(): VoronoiLayout<T>;
}
