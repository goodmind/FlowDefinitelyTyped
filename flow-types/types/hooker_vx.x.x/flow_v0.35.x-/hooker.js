declare type HookerPostHookFunction = (result: any, ...args: any[]) => IHookerPostHookResult | void;declare type HookerPreHookFunction = (...args: any[]) => IHookerPreHookResult | void;declare module 'hooker' {
        declare function hook(object: any, props: string | string[], options: IHookerOptions): void

	declare function hook(
object: any,
props: string | string[],
prehookFunction: HookerPreHookFunction): void
...
context: any;
args: any[]
}declare interface IHookerPostHookResult {} declare interface IHookerPreHookResult {} declare interface IHookerOptions {
