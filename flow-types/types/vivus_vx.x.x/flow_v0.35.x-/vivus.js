declare module 'vivus' {
        declare module.exports: typeof Vivus

	declare class Vivus  {
static LINEAR: Vivus$Vivus$TimingFunction;
static EASE: Vivus$Vivus$TimingFunction;
static EASE_OUT: Vivus$Vivus$TimingFunction;
static EASE_IN: Vivus$Vivus$TimingFunction;
static EASE_OUT_BOUNCE: Vivus$Vivus$TimingFunction;
 ...
 */
constructor(element: string | HTMLElement, options?: Vivus$Vivus$VivusOptions, callback?: (vivusInstance: Vivus) => void): this;
...
destroy(): void
	...
	declare export type Vivus$TimingFunction = (input: number) => number;

declare export interface Vivus$VivusOptions {
 ...
 */
pathTimingFunction?: Vivus$Vivus$TimingFunction,
 ...
 * See the [timing function documentation](https://github.com/maxwellito/vivus#timing-function).
 */
animTimingFunction?: Vivus$Vivus$TimingFunction,
