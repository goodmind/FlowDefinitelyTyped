...
children: VirtualDOM$VTree[],
key?: string,
namespace?: string): VirtualDOM$VNode
} 
...
renderOptions: VirtualDOM$VPatchOptions<T>) => T;
...
declare function VirtualDOM$h(tagName: string, children: string | VirtualDOM$VChild[]): VirtualDOM$VNode
