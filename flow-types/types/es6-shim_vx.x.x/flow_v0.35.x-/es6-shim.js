declare type KeyOfProperty = string | number | Symbol;declare interface IteratorResult<T> {
done: boolean,
value?: T
...
} declare var Promise: PromiseConstructor;declare interface Map<K, V> {
clear(): void,
...
} declare var Map: MapConstructor;declare interface Set<T> {
add(value: T): Set<T>,
clear(): void,
...
prototype: Set<any>
} declare var Set: SetConstructor;declare interface WeakMap<K: {[key: string]: any}, V> {
delete(key: K): boolean,
get(key: K): V | void,
has(key: K): boolean,
...
new <K: {[key: string]: any}, V>(iterable: IterableShim<[K, V]>): WeakMap<K, V>,
prototype: WeakMap<any, any>
} declare var WeakMap: WeakMapConstructor;declare interface WeakSet<T> {
...
declare function Reflect$defineProperty(
target: any,
propertyKey: KeyOfProperty,
attributes: PropertyDescriptor): boolean


declare function Reflect$deleteProperty(target: any, propertyKey: KeyOfProperty): boolean


declare function Reflect$enumerate(target: any): IterableIteratorShim<any>


declare function Reflect$get(target: any, propertyKey: KeyOfProperty, receiver?: any): any


declare function Reflect$getOwnPropertyDescriptor(target: any, propertyKey: KeyOfProperty): PropertyDescriptor


declare function Reflect$getPrototypeOf(target: any): any


declare function Reflect$has(target: any, propertyKey: KeyOfProperty): boolean


declare function Reflect$isExtensible(target: any): boolean


declare function Reflect$ownKeys(target: any): Array<KeyOfProperty>


declare function Reflect$preventExtensions(target: any): boolean


declare function Reflect$set(target: any, propertyKey: KeyOfProperty, value: any, receiver?: any): boolean
...
declare function Reflect$enumerate(target: any): Iterator<any>
