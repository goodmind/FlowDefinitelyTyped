declare module "google-maps-react" {
  ...
  declare type markerEventHandler = (
    props?: MarkerProps,
  ...
  declare export class InfoWindow
    mixins React.Component<InfoWindowProps, any> {}
  declare export {};
}
