declare module 'idyll-ast' {
        import type {
          AST,Node,TreeNode,PropValue,Property,PropType
        } from 'idyll-compiler';
 ...
 */
declare export function walkNodes(ast: AST | null, func: (n: Node) => void): void
 ...
 * given filter
 */
declare export function findNodes(ast: AST, filter: (n: Node) => boolean): Node[]

	
/**
 * visits each child of the node and modifies them using the modifier
 */
declare export function modifyChildren(node: Node, modifier: (n: Node) => void): Node
 ...
 */
declare export function filterChildren(node: Node, filter: (child: Node) => boolean): Node
 ...
 * satisfy the given filter
 */
declare export function filterNodes(ast: AST, filter: (node: Node) => boolean): AST
 ...
 */
declare export function modifyNodesByName(ast: AST, name: string, modifier: (node: Node) => void): AST
 ...
 */
declare export function getProperty(node: Node, key: string): PropValue | null
 ...
 */
declare export function getPropertiesByType(node: Node, type: PropType): Property[]
 ...
 */
declare export function setProperty(node: Node, key: string, value: PropValue | $ElementType<PropValue, 1>): Node
...
node: Node,
properties: Record<string, PropValue | $ElementType<PropValue, 1>>): Node
