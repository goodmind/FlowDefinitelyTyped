 ...
 */
declare function mount(element: Element, component: Mithril$Mithril$ComponentTypes<any, any>): void
 ...
 */
declare function request<T>(options: Mithril$Mithril$RequestOptions<T> & {
url: string
}): Promise<T>
 ...
 * Makes an XHR request and returns a promise.
 */
declare function request<T>(url: string, options?: Mithril$Mithril$RequestOptions<T>): Promise<T>

	
/**
 * Makes a JSON-P request and returns a promise.
 */
declare function jsonp<T>(options: Mithril$Mithril$JsonpOptions & {
url: string
}): Promise<T>
 ...
 * Makes a JSON-P request and returns a promise.
 */
declare function jsonp<T>(url: string, options?: Mithril$Mithril$JsonpOptions): Promise<T>
 ...
 */
onbeforeremove(vnode: Mithril$VnodeDOM<Attrs, State>): Promise<any> | void,
...
old: Mithril$VnodeDOM<Attrs, State>): boolean | void,
 ...
 */
(selector: string, ...children: Mithril$Children[]): Mithril$Vnode<any, any>,

/**
 * Creates a virtual element (Vnode).
 */
(selector: string, attributes: Mithril$Attributes, ...children: Mithril$Children[]): Mithril$Vnode<any, any>,

/**
 * Creates a virtual element (Vnode).
 */
(component: Mithril$ComponentTypes<Attrs, State>, ...args: Mithril$Children[]): Mithril$Vnode<Attrs, State>,

/**
 * Creates a virtual element (Vnode).
 */
(component: Mithril$ComponentTypes<Attrs, State>, attributes: Attrs & Mithril$Lifecycle<Attrs, State> & {
key?: string | number
}, ...args: Mithril$Children[]): Mithril$Vnode<Attrs, State>,
...
children: Mithril$ChildArrayOrPrimitive): Mithril$Vnode<any, any>,
...
onmatch(
args: Attrs,
requestedPath: string): Mithril$ComponentTypes<any, any> | Promise<any> | void,
 ...
 */
[url: string]: Mithril$ComponentTypes<any, any> | Mithril$RouteResolver<any, any>
} 
...
declare type Mithril$ChildArrayOrPrimitive = Mithril$ChildArray | string | number | boolean;


/**
 * Virtual DOM nodes, or vnodes, are Javascript objects that represent an element (or parts of the DOM).
 */
declare interface Mithril$Vnode<Attrs, State: Mithril$Lifecycle<Attrs, State>> {
...
declare type Mithril$VnodeDOM<Attrs, State: Mithril$Lifecycle<Attrs, State>> = {
...
declare type Mithril$CVnode<A> = {} & Mithril$Vnode<A, Mithril$ClassComponent<A>>


declare type Mithril$CVnodeDOM<A> = {} & Mithril$VnodeDOM<A, Mithril$ClassComponent<A>>
 ...
 */
declare type Mithril$Component<Attrs, State: Mithril$Lifecycle<Attrs, State>> = {
 ...
 * Components can be consumed via the m() utility.
 */
declare type Mithril$FactoryComponent<A> = (vnode: Mithril$Vnode<A>) => Mithril$Component<A>;
 ...
 */
declare type Mithril$Comp<Attrs, State: Mithril$Lifecycle<Attrs, State>> = Mithril$Component<Attrs, State> & State;
 ...
 */
declare type Mithril$ComponentTypes<A, S: Mithril$Lifecycle<A, S>> = Mithril$Component<A, S> | {
