declare module "agora-rtc-sdk" {
  ...
  declare export type VideoProfile =
    | "120p"
    | "120p_1"
    | "120p_3"
    | "180p"
    ...
    | "4K_1"
    | "4K_3";
  declare export type FirefoxVideoProfile =
    | "480p"
    | "480p_1"
    | "480p_2"
    | "480p_3"
    ...
    | "720p_5"
    | "720p_6";
  declare export type SafariVideoProfile =
    | "480p"
    | "480p_1"
    | "480p_2"
    | "480p_3"
    ...
    | "4K_1"
    | "4K_3";
  declare export type ScreenSharingProfile =
    | "480p_1"
    | "480p_2"
    | "720p_1"
    | "720p_2"
    | "1080p_1"
    | "1080p_2";
  declare export type ClientEvent =
    | "stream-published"
    | "stream-added"
    | "stream-removed"
    | "stream-subscribed"
  ...
  declare export interface Client {
    ...
    setProxyServer(
      proxyServer: $ElementType<ClientConfig, "proxyServer">
    ): void;
  ...
  declare function Logger$setLogLevel(
    level: Logger$DEBUG | Logger$INFO | Logger$WARNING | Logger$NONE
  ): void;
