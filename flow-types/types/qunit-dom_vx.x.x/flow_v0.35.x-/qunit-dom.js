declare module 'qunit-dom' {
        declare interface QUnitDom$Options {
count?: number
} 

declare interface QUnitDom$Matchers {
 ...
 * @param message
 */
exists(options?: QUnitDom$Options, message?: string): void,
...
hasAttribute(
name: string,
value: string | RegExp | {[key: string]: any},
message?: string): void,
...
hasNoAttribute: $ElementType<QUnitDom$Matchers, "doesNotHaveAttribute">,
lacksAttribute: $ElementType<QUnitDom$Matchers, "doesNotHaveAttribute">,
...
hasNoClass: $ElementType<QUnitDom$Matchers, "doesNotHaveClass">,
lacksClass: $ElementType<QUnitDom$Matchers, "doesNotHaveClass">,
...
matchesText: $ElementType<QUnitDom$Matchers, "hasText">,
...
containsText: $ElementType<QUnitDom$Matchers, "includesText">,
hasTextContaining: $ElementType<QUnitDom$Matchers, "includesText">,
...
doesNotContainText: $ElementType<QUnitDom$Matchers, "doesNotIncludeText">,
doesNotHaveTextContaining: $ElementType<QUnitDom$Matchers, "doesNotIncludeText">,
 ...
 * @param message
 */
hasValue(expected: string | RegExp | {[key: string]: any}, message?: string): void,
...
lacksValue: $ElementType<QUnitDom$Matchers, "hasNoValue">
} 
	declare interface Assert {
dom(selector?: string): QUnitDom$QUnitDom$Matchers
} 
    }
