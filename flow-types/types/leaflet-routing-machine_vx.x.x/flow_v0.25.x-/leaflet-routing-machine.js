...
declare function routing$control(
  options?: Routing$Routing$RoutingControlOptions
): Routing$Routing$Control;

declare function routing$itinerary(
  options?: Routing$Routing$ItineraryOptions
): Routing$Routing$Itinerary;

declare function routing$line(
  route: Routing$Routing$IRoute,
  options?: Routing$Routing$LineOptions
): Routing$Routing$Line;

declare function routing$plan(
  waypoints: Routing$Routing$Waypoint[] | LatLng[],
  options?: Routing$Routing$PlanOptions
): Routing$Routing$Plan;

declare function routing$osrmv1(
  options?: Routing$Routing$OSRMOptions
): Routing$Routing$OSRMv1;

declare function routing$formatter(
  options?: Routing$Routing$FormatterOptions
): Routing$Routing$Formatter;

declare function routing$waypoint(
  latLng: LatLng,
  name?: string,
  options?: Routing$Routing$WaypointOptions
): Routing$Routing$Waypoint;
