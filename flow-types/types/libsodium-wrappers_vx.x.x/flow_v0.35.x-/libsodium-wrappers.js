...
static +ORIGINAL: Class<base64_variants__ORIGINAL> & base64_variants__ORIGINAL & 0;// 0
static +ORIGINAL_NO_PADDING: Class<base64_variants__ORIGINAL_NO_PADDING> & base64_variants__ORIGINAL_NO_PADDING & 1;// 1
static +URLSAFE: Class<base64_variants__URLSAFE> & base64_variants__URLSAFE & 2;// 2
static +URLSAFE_NO_PADDING: Class<base64_variants__URLSAFE_NO_PADDING> & base64_variants__URLSAFE_NO_PADDING & 3;// 3
...
key?: Uint8Array,
outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array
...
public_nonce?: Uint8Array,
key?: Uint8Array,
outputFormat?: StringOutputFormat | null): string
...
public_nonce?: Uint8Array,
key?: Uint8Array,
outputFormat?: Uint8ArrayOutputFormat | null): CryptoBox
...
public_nonce?: Uint8Array,
key?: Uint8Array,
outputFormat?: StringOutputFormat | null): StringCryptoBox
...
outputFormat?: StringOutputFormat | null): StringCryptoBox
	...
	declare export function crypto_aead_chacha20poly1305_ietf_keygen(outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_aead_chacha20poly1305_ietf_keygen(outputFormat?: StringOutputFormat | null): string

	declare export function crypto_aead_chacha20poly1305_keygen(outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_aead_chacha20poly1305_keygen(outputFormat?: StringOutputFormat | null): string
...
outputFormat?: StringOutputFormat | null): StringCryptoBox
	...
	declare export function crypto_aead_xchacha20poly1305_ietf_keygen(outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_aead_xchacha20poly1305_ietf_keygen(outputFormat?: StringOutputFormat | null): string
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_auth_keygen(outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_auth_keygen(outputFormat?: StringOutputFormat | null): string

	declare export function crypto_auth_verify(tag: Uint8Array, message: string | Uint8Array, key: Uint8Array): boolean
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_box_keypair(outputFormat?: Uint8ArrayOutputFormat | null): KeyPair

	declare export function crypto_box_keypair(outputFormat?: StringOutputFormat | null): StringKeyPair
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_box_seed_keypair(seed: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): KeyPair

	declare export function crypto_box_seed_keypair(seed: Uint8Array, outputFormat?: StringOutputFormat | null): StringKeyPair
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_generichash_init(key?: string | Uint8Array | null, hash_length?: number): state_address

	declare export function crypto_generichash_keygen(outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_generichash_keygen(outputFormat?: StringOutputFormat | null): string

	declare export function crypto_generichash_update(
state_address: generichash_state_address,
message_chunk: string | Uint8Array): void

	declare export function crypto_hash(
message: string | Uint8Array,
outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_hash(message: string | Uint8Array, outputFormat?: StringOutputFormat | null): string
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_kdf_keygen(outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_kdf_keygen(outputFormat?: StringOutputFormat | null): string

	declare export function crypto_kx_client_session_keys(
clientPublicKey: Uint8Array,
clientSecretKey: Uint8Array,
serverPublicKey: Uint8Array,
outputFormat?: Uint8ArrayOutputFormat | null): CryptoKX

	declare export function crypto_kx_client_session_keys(
clientPublicKey: Uint8Array,
clientSecretKey: Uint8Array,
serverPublicKey: Uint8Array,
outputFormat?: StringOutputFormat | null): StringCryptoKX

	declare export function crypto_kx_keypair(outputFormat?: Uint8ArrayOutputFormat | null): KeyPair

	declare export function crypto_kx_keypair(outputFormat?: StringOutputFormat | null): StringKeyPair

	declare export function crypto_kx_seed_keypair(seed: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): KeyPair

	declare export function crypto_kx_seed_keypair(seed: Uint8Array, outputFormat?: StringOutputFormat | null): StringKeyPair
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_pwhash_str(password: string | Uint8Array, opsLimit: number, memLimit: number): string

	declare export function crypto_pwhash_str_verify(hashed_password: string, password: string | Uint8Array): boolean
...
outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array
	...
	declare export function crypto_scalarmult_base(privateKey: Uint8Array, outputFormat?: StringOutputFormat | null): string

	declare export function crypto_secretbox_detached(
message: string | Uint8Array,
nonce: Uint8Array,
key: Uint8Array,
outputFormat?: Uint8ArrayOutputFormat | null): SecretBox

	declare export function crypto_secretbox_detached(
message: string | Uint8Array,
nonce: Uint8Array,
key: Uint8Array,
outputFormat?: StringOutputFormat | null): StringSecretBox
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_secretbox_keygen(outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_secretbox_keygen(outputFormat?: StringOutputFormat | null): string
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_secretstream_xchacha20poly1305_init_pull(header: Uint8Array, key: Uint8Array): state_address
...
header: string
	...
	declare export function crypto_secretstream_xchacha20poly1305_keygen(outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_secretstream_xchacha20poly1305_keygen(outputFormat?: StringOutputFormat | null): string
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_secretstream_xchacha20poly1305_rekey(state_address: secretstream_xchacha20poly1305_state_address): true
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_shorthash_keygen(outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_shorthash_keygen(outputFormat?: StringOutputFormat | null): string
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_sign_ed25519_pk_to_curve25519(edPk: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_sign_ed25519_pk_to_curve25519(edPk: Uint8Array, outputFormat?: StringOutputFormat | null): string

	declare export function crypto_sign_ed25519_sk_to_curve25519(edSk: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_sign_ed25519_sk_to_curve25519(edSk: Uint8Array, outputFormat?: StringOutputFormat | null): string
...
publicKey: Uint8Array): boolean
	...
	declare export function crypto_sign_keypair(outputFormat?: Uint8ArrayOutputFormat | null): KeyPair

	declare export function crypto_sign_keypair(outputFormat?: StringOutputFormat | null): StringKeyPair
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function crypto_sign_seed_keypair(seed: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): KeyPair

	declare export function crypto_sign_seed_keypair(seed: Uint8Array, outputFormat?: StringOutputFormat | null): StringKeyPair

	declare export function crypto_sign_update(state_address: sign_state_address, message_chunk: string | Uint8Array): void
...
publicKey: Uint8Array): boolean
	...
	declare export function crypto_stream_keygen(outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function crypto_stream_keygen(outputFormat?: StringOutputFormat | null): string

	declare export function from_base64(input: string, variant?: base64_variants): Uint8Array
	...
	declare export function randombytes_buf(length: number, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array

	declare export function randombytes_buf(length: number, outputFormat?: StringOutputFormat | null): string
...
outputFormat?: StringOutputFormat | null): string
	...
	declare export function randombytes_set_implementation(implementation: Uint8Array): void
	...
	declare export function to_base64(input: string | Uint8Array, variant?: base64_variants): string
