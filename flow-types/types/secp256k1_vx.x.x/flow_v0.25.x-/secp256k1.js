declare module "secp256k1" {
   ...
   */
  declare export function privateKeyExport(
    privateKey: Buffer,
    compressed?: boolean
  ): Buffer;
   ...
   */
  declare export function privateKeyTweakAdd(
    privateKey: Buffer,
    tweak: Buffer
  ): Buffer;
   ...
   */
  declare export function privateKeyTweakMul(
    privateKey: Buffer,
    tweak: Buffer
  ): Buffer;
   ...
   */
  declare export function publicKeyCreate(
    privateKey: Buffer,
    compressed?: boolean
  ): Buffer;
   ...
   */
  declare export function publicKeyConvert(
    publicKey: Buffer,
    compressed?: boolean
  ): Buffer;
   ...
   */
  declare export function publicKeyTweakAdd(
    publicKey: Buffer,
    tweak: Buffer,
    compressed?: boolean
  ): Buffer;
   ...
   */
  declare export function publicKeyTweakMul(
    publicKey: Buffer,
    tweak: Buffer,
    compressed?: boolean
  ): Buffer;
   ...
   */
  declare export function publicKeyCombine(
    publicKeys: Buffer[],
    compressed?: boolean
  ): Buffer;
   ...
   */
  declare export function ecdhUnsafe(
    publicKey: Buffer,
    privateKey: Buffer,
    compressed?: boolean
  ): Buffer;
