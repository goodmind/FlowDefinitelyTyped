declare module 'assert-plus' {
	...
	declare export function optionalArray(arr: any[] | void, message?: string): void

	declare export function optionalBool(bool: boolean | void, message?: string): void

	declare export function optionalBuffer(buffer: Buffer | void, message?: string): void

	declare export function optionalFunc(options: any, message?: string): void

	declare export function optionalNumber(options: number | void, message?: string): void

	declare export function optionalFinite(options: number | void, message?: string): void

	declare export function optionalObject(options: any, message?: string): void

	declare export function optionalString(options: string | void, message?: string): void

	declare export function optionalStream(options: Stream | void, message?: string): void

	declare export function optionalDate(options: Date | void, message?: string): void

	declare export function optionalRegexp(options: RegExp | void, message?: string): void

	declare export function optionalUuid(options: string | void, message?: string): void

	declare export function optionalArrayOfArray(arr: any[][] | void, message?: string): void

	declare export function optionalArrayOfBool(arr: boolean[] | void, message?: string): void

	declare export function optionalArrayOfBuffer(arr: Buffer[] | void, message?: string): void

	declare export function optionalArrayOfFunc(arr: any[] | void, message?: string): void

	declare export function optionalArrayOfNumber(arr: number[] | void, message?: string): void

	declare export function optionalArrayOfFinite(arr: number[] | void, message?: string): void

	declare export function optionalArrayOfObject(arr: any[] | void, message?: string): void

	declare export function optionalArrayOfString(arr: string[] | void, message?: string): void

	declare export function optionalArrayOfStream(arr: Stream[] | void, message?: string): void

	declare export function optionalArrayOfDate(arr: Date[] | void, message?: string): void

	declare export function optionalArrayOfRegexp(arr: RegExp[] | void, message?: string): void

	declare export function optionalArrayOfUuid(arr: string[] | void, message?: string): void
 ...
 *  * ```
 */
declare export function fail(actual: any, expected: any, message: any, operator: any): void
 ...
 */
declare export function deepEqual<T>(actual: T, expected: T, message?: string): void
 ...
 * If the `message` parameter is undefined, a default error message is assigned.
 */
declare export function notDeepEqual(actual: any, expected: any, message?: string): void
 ...
 * If the `message` parameter is undefined, a default error message is assigned.
 */
declare export function strictEqual<T>(actual: T, expected: T, message?: string): void
...
declare export function notStrictEqual(actual: any, expected: any, message?: string): void
	...
	declare export function throws(block: any, error?: any, message?: string): void
 ...
 *  * ```
 */
declare export function doesNotThrow(block: any, error?: any, message?: string): void
