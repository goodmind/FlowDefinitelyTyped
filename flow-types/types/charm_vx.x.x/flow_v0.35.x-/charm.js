declare module 'charm' {
        declare type charm$CharmColorName = "red"
| "yellow"
| "green"
| "blue"
| "cyan"
...
declare type charm$CharmColorHex = number;

declare type charm$CharmColor = charm$CharmColorName | charm$CharmColorHex;

declare type charm$CharmAnyStream = NodeJS.WritableStream | NodeJS.ReadableStream | NodeJS.Process;

declare type charm$CharmInstance = {
 ...
 */
foreground(color: charm$CharmColor): this,
 ...
 *   - or `color` can be an integer from 0 to 255, inclusive.
 */
background(color: charm$CharmColor): this,
 ...
 */
declare function charm(param?: charm$charm$CharmAnyStream): charm$charm$CharmInstance

	declare module.exports: typeof charm
