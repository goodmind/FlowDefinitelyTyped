declare module "evernote" {
  ...
  declare interface Evernote$Callback<T> {
    (
      err:
        ...
        | Evernote$EDAMNotFoundException,
      v: T
    ): void;
  }
  ...
  declare class Evernote$EDAMErrorCode {
    ...
    static +UNKNOWN: Class<Evernote$EDAMErrorCode__UNKNOWN> &
      Evernote$EDAMErrorCode__UNKNOWN &
      1; // 1
    static +BAD_DATA_FORMAT: Class<Evernote$EDAMErrorCode__BAD_DATA_FORMAT> &
      Evernote$EDAMErrorCode__BAD_DATA_FORMAT &
      2; // 2
    static +PERMISSION_DENIED: Class<Evernote$EDAMErrorCode__PERMISSION_DENIED> &
      Evernote$EDAMErrorCode__PERMISSION_DENIED &
      3; // 3
    static +INTERNAL_ERROR: Class<Evernote$EDAMErrorCode__INTERNAL_ERROR> &
      Evernote$EDAMErrorCode__INTERNAL_ERROR &
      4; // 4
    static +DATA_REQUIRED: Class<Evernote$EDAMErrorCode__DATA_REQUIRED> &
      Evernote$EDAMErrorCode__DATA_REQUIRED &
      5; // 5
    static +LIMIT_REACHED: Class<Evernote$EDAMErrorCode__LIMIT_REACHED> &
      Evernote$EDAMErrorCode__LIMIT_REACHED &
      6; // 6
    static +QUOTA_REACHED: Class<Evernote$EDAMErrorCode__QUOTA_REACHED> &
      Evernote$EDAMErrorCode__QUOTA_REACHED &
      7; // 7
    static +INVALID_AUTH: Class<Evernote$EDAMErrorCode__INVALID_AUTH> &
      Evernote$EDAMErrorCode__INVALID_AUTH &
      8; // 8
    static +AUTH_EXPIRED: Class<Evernote$EDAMErrorCode__AUTH_EXPIRED> &
      Evernote$EDAMErrorCode__AUTH_EXPIRED &
      9; // 9
    static +DATA_CONFLICT: Class<Evernote$EDAMErrorCode__DATA_CONFLICT> &
      Evernote$EDAMErrorCode__DATA_CONFLICT &
      10; // 10
    static +ENML_VALIDATION: Class<Evernote$EDAMErrorCode__ENML_VALIDATION> &
      Evernote$EDAMErrorCode__ENML_VALIDATION &
      11; // 11
    static +SHARD_UNAVAILABLE: Class<Evernote$EDAMErrorCode__SHARD_UNAVAILABLE> &
      Evernote$EDAMErrorCode__SHARD_UNAVAILABLE &
      12; // 12
    static +LEN_TOO_SHORT: Class<Evernote$EDAMErrorCode__LEN_TOO_SHORT> &
      Evernote$EDAMErrorCode__LEN_TOO_SHORT &
      13; // 13
    static +LEN_TOO_LONG: Class<Evernote$EDAMErrorCode__LEN_TOO_LONG> &
      Evernote$EDAMErrorCode__LEN_TOO_LONG &
      14; // 14
    static +TOO_FEW: Class<Evernote$EDAMErrorCode__TOO_FEW> &
      Evernote$EDAMErrorCode__TOO_FEW &
      15; // 15
    static +TOO_MANY: Class<Evernote$EDAMErrorCode__TOO_MANY> &
      Evernote$EDAMErrorCode__TOO_MANY &
      16; // 16
    static +UNSUPPORTED_OPERATION: Class<Evernote$EDAMErrorCode__UNSUPPORTED_OPERATION> &
      Evernote$EDAMErrorCode__UNSUPPORTED_OPERATION &
      17; // 17
    static +TAKEN_DOWN: Class<Evernote$EDAMErrorCode__TAKEN_DOWN> &
      Evernote$EDAMErrorCode__TAKEN_DOWN &
      18; // 18
    static +RATE_LIMIT_REACHED: Class<Evernote$EDAMErrorCode__RATE_LIMIT_REACHED> &
      Evernote$EDAMErrorCode__RATE_LIMIT_REACHED &
      19; // 19
  }

  declare class Evernote$EDAMErrorCode__UNKNOWN mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__BAD_DATA_FORMAT
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__PERMISSION_DENIED
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__INTERNAL_ERROR
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__DATA_REQUIRED
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__LIMIT_REACHED
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__QUOTA_REACHED
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__INVALID_AUTH
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__AUTH_EXPIRED
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__DATA_CONFLICT
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__ENML_VALIDATION
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__SHARD_UNAVAILABLE
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__LEN_TOO_SHORT
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__LEN_TOO_LONG
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__TOO_FEW mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__TOO_MANY
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__UNSUPPORTED_OPERATION
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__TAKEN_DOWN
    mixins Evernote$EDAMErrorCode {}
  declare class Evernote$EDAMErrorCode__RATE_LIMIT_REACHED
    mixins Evernote$EDAMErrorCode {}
 ...
 */
    getSyncStateWithMetrics(
      ...
      cb: Evernote$Callback<Evernote$SyncState>
    ): void;
 ...
 */
    getLinkedNotebookSyncChunk(
      ...
      cb: Evernote$Callback<Evernote$SyncChunk>
    ): void;
 ...
 */
    createNotebook(
      ...
      cb: Evernote$Callback<Evernote$Notebook>
    ): void;
 ...
 */
    listTagsByNotebook(
      notebookGuid: string,
      cb: Evernote$Callback<Evernote$Tag[]>
    ): void;
 ...
 */
    createSearch(
      ...
      cb: Evernote$Callback<Evernote$SavedSearch>
    ): void;
 ...
 */
    ...
    findNotes(
      ...
      offset: number,
      maxNotes: number,
      cb: Evernote$Callback<Evernote$NoteList>
    ): void;
 ...
 */
    findNotesMetadata(
      ...
      cb: Evernote$Callback<Evernote$NotesMetadataList>
    ): void;
 ...
 */
    findNoteCounts(
      filter: Evernote$NoteFilter,
      withTrash: boolean,
      cb: Evernote$Callback<Evernote$NoteCollectionCounts>
    ): void;
 ...
 */
    getNote(
      ...
      cb: Evernote$Callback<Evernote$Note>
    ): void;
    ...
    getNoteApplicationData(
      guid: string,
      cb: Evernote$Callback<Evernote$LazyMap>
    ): void;
 ...
 */
    listNoteVersions(
      noteGuid: string,
      cb: Evernote$Callback<Evernote$NoteVersionId[]>
    ): void;
 ...
 */
    getResource(
      ...
      cb: Evernote$Callback<Evernote$Resource>
    ): void;
 ...
 */
    getResourceAttributes(
      guid: string,
      cb: Evernote$Callback<Evernote$ResourceAttributes>
    ): void;
 ...
 */
    createSharedNotebook(
      ...
      cb: Evernote$Callback<Evernote$SharedNotebook>
    ): void;
 ...
 */
    createLinkedNotebook(
      linkedNotebook: Evernote$LinkedNotebook,
      cb: Evernote$Callback<Evernote$LinkedNotebook>
    ): void;
 ...
 */
    authenticateToSharedNotebook(
      shareKey: string,
      cb: Evernote$Callback<Evernote$AuthenticationResult>
    ): void;
 ...
 */
    emailNote(
      parameters: Evernote$NoteEmailParameters,
      cb: Evernote$Callback<void>
    ): void;
 ...
 */
    findRelated(
      ...
      cb: Evernote$Callback<Evernote$RelatedResult>
    ): void;
  }
  ...
  declare class Evernote$PrivilegeLevel {
    constructor(...args: empty): mixed;
    static +NORMAL: Class<Evernote$PrivilegeLevel__NORMAL> &
      Evernote$PrivilegeLevel__NORMAL &
      1; // 1
    static +PREMIUM: Class<Evernote$PrivilegeLevel__PREMIUM> &
      Evernote$PrivilegeLevel__PREMIUM &
      3; // 3
    static +VIP: Class<Evernote$PrivilegeLevel__VIP> &
      Evernote$PrivilegeLevel__VIP &
      5; // 5
    static +MANAGER: Class<Evernote$PrivilegeLevel__MANAGER> &
      Evernote$PrivilegeLevel__MANAGER &
      7; // 7
    static +SUPPORT: Class<Evernote$PrivilegeLevel__SUPPORT> &
      Evernote$PrivilegeLevel__SUPPORT &
      8; // 8
    static +ADMIN: Class<Evernote$PrivilegeLevel__ADMIN> &
      Evernote$PrivilegeLevel__ADMIN &
      9; // 9
  }

  declare class Evernote$PrivilegeLevel__NORMAL
    mixins Evernote$PrivilegeLevel {}
  declare class Evernote$PrivilegeLevel__PREMIUM
    mixins Evernote$PrivilegeLevel {}
  declare class Evernote$PrivilegeLevel__VIP mixins Evernote$PrivilegeLevel {}
  declare class Evernote$PrivilegeLevel__MANAGER
    mixins Evernote$PrivilegeLevel {}
  declare class Evernote$PrivilegeLevel__SUPPORT
    mixins Evernote$PrivilegeLevel {}
  ...
  declare class Evernote$QueryFormat {
    constructor(...args: empty): mixed;
    static +USER: Class<Evernote$QueryFormat__USER> &
      Evernote$QueryFormat__USER &
      1; // 1
    static +SEXP: Class<Evernote$QueryFormat__SEXP> &
      Evernote$QueryFormat__SEXP &
      2; // 2
  }
  ...
  declare class Evernote$NoteSortOrder {
    constructor(...args: empty): mixed;
    static +CREATED: Class<Evernote$NoteSortOrder__CREATED> &
      Evernote$NoteSortOrder__CREATED &
      1; // 1
    static +UPDATED: Class<Evernote$NoteSortOrder__UPDATED> &
      Evernote$NoteSortOrder__UPDATED &
      2; // 2
    static +RELEVANCE: Class<Evernote$NoteSortOrder__RELEVANCE> &
      Evernote$NoteSortOrder__RELEVANCE &
      3; // 3
    static +UPDATE_SEQUENCE_NUMBER: Class<Evernote$NoteSortOrder__UPDATE_SEQUENCE_NUMBER> &
      Evernote$NoteSortOrder__UPDATE_SEQUENCE_NUMBER &
      4; // 4
    static +TITLE: Class<Evernote$NoteSortOrder__TITLE> &
      Evernote$NoteSortOrder__TITLE &
      5; // 5
  }
  ...
  declare class Evernote$NoteSortOrder__RELEVANCE
    mixins Evernote$NoteSortOrder {}
  declare class Evernote$NoteSortOrder__UPDATE_SEQUENCE_NUMBER
    mixins Evernote$NoteSortOrder {}
  ...
  declare class Evernote$PremiumOrderStatus {
    constructor(...args: empty): mixed;
    static +NONE: Class<Evernote$PremiumOrderStatus__NONE> &
      Evernote$PremiumOrderStatus__NONE &
      0; // 0
    static +PENDING: Class<Evernote$PremiumOrderStatus__PENDING> &
      Evernote$PremiumOrderStatus__PENDING &
      1; // 1
    static +ACTIVE: Class<Evernote$PremiumOrderStatus__ACTIVE> &
      Evernote$PremiumOrderStatus__ACTIVE &
      2; // 2
    static +FAILED: Class<Evernote$PremiumOrderStatus__FAILED> &
      Evernote$PremiumOrderStatus__FAILED &
      3; // 3
    static +CANCELLATION_PENDING: Class<Evernote$PremiumOrderStatus__CANCELLATION_PENDING> &
      Evernote$PremiumOrderStatus__CANCELLATION_PENDING &
      4; // 4
    static +CANCELED: Class<Evernote$PremiumOrderStatus__CANCELED> &
      Evernote$PremiumOrderStatus__CANCELED &
      5; // 5
  }

  declare class Evernote$PremiumOrderStatus__NONE
    mixins Evernote$PremiumOrderStatus {}
  declare class Evernote$PremiumOrderStatus__PENDING
    mixins Evernote$PremiumOrderStatus {}
  declare class Evernote$PremiumOrderStatus__ACTIVE
    mixins Evernote$PremiumOrderStatus {}
  declare class Evernote$PremiumOrderStatus__FAILED
    mixins Evernote$PremiumOrderStatus {}
  declare class Evernote$PremiumOrderStatus__CANCELLATION_PENDING
    mixins Evernote$PremiumOrderStatus {}
  declare class Evernote$PremiumOrderStatus__CANCELED
    mixins Evernote$PremiumOrderStatus {}
  ...
  declare class Evernote$SharedNotebookPrivilegeLevel {
    constructor(...args: empty): mixed;
    static +READ_NOTEBOOK: Class<Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK> &
      Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK &
      0; // 0
    static +MODIFY_NOTEBOOK_PLUS_ACTIVITY: Class<Evernote$SharedNotebookPrivilegeLevel__MODIFY_NOTEBOOK_PLUS_ACTIVITY> &
      Evernote$SharedNotebookPrivilegeLevel__MODIFY_NOTEBOOK_PLUS_ACTIVITY &
      1; // 1
    static +READ_NOTEBOOK_PLUS_ACTIVITY: Class<Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK_PLUS_ACTIVITY> &
      Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK_PLUS_ACTIVITY &
      2; // 2
    static +GROUP: Class<Evernote$SharedNotebookPrivilegeLevel__GROUP> &
      Evernote$SharedNotebookPrivilegeLevel__GROUP &
      3; // 3
    static +FULL_ACCESS: Class<Evernote$SharedNotebookPrivilegeLevel__FULL_ACCESS> &
      Evernote$SharedNotebookPrivilegeLevel__FULL_ACCESS &
      4; // 4
    static +BUSINESS_FULL_ACCESS: Class<Evernote$SharedNotebookPrivilegeLevel__BUSINESS_FULL_ACCESS> &
      Evernote$SharedNotebookPrivilegeLevel__BUSINESS_FULL_ACCESS &
      5; // 5
  }

  declare class Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK
    mixins Evernote$SharedNotebookPrivilegeLevel {}
  declare class Evernote$SharedNotebookPrivilegeLevel__MODIFY_NOTEBOOK_PLUS_ACTIVITY
    mixins Evernote$SharedNotebookPrivilegeLevel {}
  declare class Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK_PLUS_ACTIVITY
    mixins Evernote$SharedNotebookPrivilegeLevel {}
  declare class Evernote$SharedNotebookPrivilegeLevel__GROUP
    mixins Evernote$SharedNotebookPrivilegeLevel {}
  declare class Evernote$SharedNotebookPrivilegeLevel__FULL_ACCESS
    mixins Evernote$SharedNotebookPrivilegeLevel {}
  declare class Evernote$SharedNotebookPrivilegeLevel__BUSINESS_FULL_ACCESS
    mixins Evernote$SharedNotebookPrivilegeLevel {}
  ...
  declare class Evernote$SponsoredGroupRole {
    constructor(...args: empty): mixed;
    static +GROUP_MEMBER: Class<Evernote$SponsoredGroupRole__GROUP_MEMBER> &
      Evernote$SponsoredGroupRole__GROUP_MEMBER &
      1; // 1
    static +GROUP_ADMIN: Class<Evernote$SponsoredGroupRole__GROUP_ADMIN> &
      Evernote$SponsoredGroupRole__GROUP_ADMIN &
      2; // 2
    static +GROUP_OWNER: Class<Evernote$SponsoredGroupRole__GROUP_OWNER> &
      Evernote$SponsoredGroupRole__GROUP_OWNER &
      3; // 3
  }

  declare class Evernote$SponsoredGroupRole__GROUP_MEMBER
    mixins Evernote$SponsoredGroupRole {}
  declare class Evernote$SponsoredGroupRole__GROUP_ADMIN
    mixins Evernote$SponsoredGroupRole {}
  declare class Evernote$SponsoredGroupRole__GROUP_OWNER
    mixins Evernote$SponsoredGroupRole {}
  ...
  declare class Evernote$BusinessUserRole {
    constructor(...args: empty): mixed;
    static +ADMIN: Class<Evernote$BusinessUserRole__ADMIN> &
      Evernote$BusinessUserRole__ADMIN &
      1; // 1
    static +NORMAL: Class<Evernote$BusinessUserRole__NORMAL> &
      Evernote$BusinessUserRole__NORMAL &
      2; // 2
  }

  declare class Evernote$BusinessUserRole__ADMIN
    mixins Evernote$BusinessUserRole {}
  declare class Evernote$BusinessUserRole__NORMAL
    mixins Evernote$BusinessUserRole {}
  ...
  declare class Evernote$SharedNotebookInstanceRestrictions {
    constructor(...args: empty): mixed;
    static +ONLY_JOINED_OR_PREVIEW: Class<Evernote$SharedNotebookInstanceRestrictions__ONLY_JOINED_OR_PREVIEW> &
      Evernote$SharedNotebookInstanceRestrictions__ONLY_JOINED_OR_PREVIEW &
      1; // 1
    static +NO_SHARED_NOTEBOOKS: Class<Evernote$SharedNotebookInstanceRestrictions__NO_SHARED_NOTEBOOKS> &
      Evernote$SharedNotebookInstanceRestrictions__NO_SHARED_NOTEBOOKS &
      2; // 2
  }

  declare class Evernote$SharedNotebookInstanceRestrictions__ONLY_JOINED_OR_PREVIEW
    mixins Evernote$SharedNotebookInstanceRestrictions {}
  declare class Evernote$SharedNotebookInstanceRestrictions__NO_SHARED_NOTEBOOKS
    mixins Evernote$SharedNotebookInstanceRestrictions {}
  ...
  declare class Evernote$ReminderEmailConfig {
    constructor(...args: empty): mixed;
    static +DO_NOT_SEND: Class<Evernote$ReminderEmailConfig__DO_NOT_SEND> &
      Evernote$ReminderEmailConfig__DO_NOT_SEND &
      1; // 1
    static +SEND_DAILY_EMAIL: Class<Evernote$ReminderEmailConfig__SEND_DAILY_EMAIL> &
      Evernote$ReminderEmailConfig__SEND_DAILY_EMAIL &
      2; // 2
  }

  declare class Evernote$ReminderEmailConfig__DO_NOT_SEND
    mixins Evernote$ReminderEmailConfig {}
  declare class Evernote$ReminderEmailConfig__SEND_DAILY_EMAIL
    mixins Evernote$ReminderEmailConfig {}
 ...
 */
    getBootstrapInfo(
      locale: string,
      cb: Evernote$Callback<Evernote$BootstrapInfo>
    ): void;
 ...
 */
    getPublicUserInfo(
      username: string,
      cb: Evernote$Callback<Evernote$PublicUserInfo>
    ): void;
