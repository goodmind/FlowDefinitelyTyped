declare module "evernote" {
  ...
  declare var npm$namespace$Evernote: {
    ...
    EDAMErrorCode: typeof Evernote$EDAMErrorCode,
    PrivilegeLevel: typeof Evernote$PrivilegeLevel,
    QueryFormat: typeof Evernote$QueryFormat,
    NoteSortOrder: typeof Evernote$NoteSortOrder,
    PremiumOrderStatus: typeof Evernote$PremiumOrderStatus,
    SharedNotebookPrivilegeLevel: typeof Evernote$SharedNotebookPrivilegeLevel,
    SponsoredGroupRole: typeof Evernote$SponsoredGroupRole,
    BusinessUserRole: typeof Evernote$BusinessUserRole,
    SharedNotebookInstanceRestrictions: typeof Evernote$SharedNotebookInstanceRestrictions,
    ReminderEmailConfig: typeof Evernote$ReminderEmailConfig,
    Client: typeof Evernote$Client,
    EDAMUserException: typeof Evernote$EDAMUserException,
    EDAMSystemException: typeof Evernote$EDAMSystemException,
    EDAMNotFoundException: typeof Evernote$EDAMNotFoundException,
    NoteStoreClient: typeof Evernote$NoteStoreClient,
    SyncState: typeof Evernote$SyncState,
    SyncChunk: typeof Evernote$SyncChunk,
    SyncChunkFilter: typeof Evernote$SyncChunkFilter,
    NoteFilter: typeof Evernote$NoteFilter,
    NoteList: typeof Evernote$NoteList,
    NoteMetadata: typeof Evernote$NoteMetadata,
    NotesMetadataList: typeof Evernote$NotesMetadataList,
    NotesMetadataResultSpec: typeof Evernote$NotesMetadataResultSpec,
    NoteCollectionCounts: typeof Evernote$NoteCollectionCounts,
    NoteEmailParameters: typeof Evernote$NoteEmailParameters,
    NoteVersionId: typeof Evernote$NoteVersionId,
    ClientUsageMetrics: typeof Evernote$ClientUsageMetrics,
    RelatedQuery: typeof Evernote$RelatedQuery,
    RelatedResult: typeof Evernote$RelatedResult,
    RelatedResultSpec: typeof Evernote$RelatedResultSpec,
    Data: typeof Evernote$Data,
    UserAttributes: typeof Evernote$UserAttributes,
    Accounting: typeof Evernote$Accounting,
    BusinessUserInfo: typeof Evernote$BusinessUserInfo,
    PremiumInfo: typeof Evernote$PremiumInfo,
    User: typeof Evernote$User,
    Tag: typeof Evernote$Tag,
    LazyMap: typeof Evernote$LazyMap,
    ResourceAttributes: typeof Evernote$ResourceAttributes,
    Resource: typeof Evernote$Resource,
    NoteAttributes: typeof Evernote$NoteAttributes,
    Note: typeof Evernote$Note,
    Publishing: typeof Evernote$Publishing,
    BusinessNotebook: typeof Evernote$BusinessNotebook,
    SavedSearchScope: typeof Evernote$SavedSearchScope,
    SavedSearch: typeof Evernote$SavedSearch,
    SharedNotebookRecipientSettings: typeof Evernote$SharedNotebookRecipientSettings,
    SharedNotebook: typeof Evernote$SharedNotebook,
    NotebookRestrictions: typeof Evernote$NotebookRestrictions,
    Notebook: typeof Evernote$Notebook,
    LinkedNotebook: typeof Evernote$LinkedNotebook,
    NotebookDescriptor: typeof Evernote$NotebookDescriptor,
    UserStoreClient: typeof Evernote$UserStoreClient,
    PublicUserInfo: typeof Evernote$PublicUserInfo,
    AuthenticationResult: typeof Evernote$AuthenticationResult,
    BootstrapSettings: typeof Evernote$BootstrapSettings,
    BootstrapProfile: typeof Evernote$BootstrapProfile,
    BootstrapInfo: typeof Evernote$BootstrapInfo
  };
  ...
  declare var Evernote$EDAMErrorCode: {|
    +UNKNOWN: 1, // 1
    +BAD_DATA_FORMAT: 2, // 2
    ...
    +AUTH_EXPIRED: 9, // 9
    +DATA_CONFLICT: 10, // 10
    +ENML_VALIDATION: 11, // 11
    +SHARD_UNAVAILABLE: 12, // 12
    +LEN_TOO_SHORT: 13, // 13
    +LEN_TOO_LONG: 14, // 14
    +TOO_FEW: 15, // 15
    +TOO_MANY: 16, // 16
    +UNSUPPORTED_OPERATION: 17, // 17
    +TAKEN_DOWN: 18, // 18
    +RATE_LIMIT_REACHED: 19 // 19
  |};
  ...
  declare var Evernote$PrivilegeLevel: {|
    +NORMAL: 1, // 1
    +PREMIUM: 3, // 3
    +VIP: 5, // 5
    +MANAGER: 7, // 7
  ...
  declare var Evernote$QueryFormat: {|
    +USER: 1, // 1
    +SEXP: 2 // 2
  |};
  ...
  declare var Evernote$NoteSortOrder: {|
    +CREATED: 1, // 1
    +UPDATED: 2, // 2
    +RELEVANCE: 3, // 3
    +UPDATE_SEQUENCE_NUMBER: 4, // 4
    +TITLE: 5 // 5
  |};
  ...
  declare var Evernote$PremiumOrderStatus: {|
    +NONE: 0, // 0
    +PENDING: 1, // 1
    +ACTIVE: 2, // 2
    +FAILED: 3, // 3
    +CANCELLATION_PENDING: 4, // 4
    +CANCELED: 5 // 5
  |};
  ...
  declare var Evernote$SharedNotebookPrivilegeLevel: {|
    +READ_NOTEBOOK: 0, // 0
    +MODIFY_NOTEBOOK_PLUS_ACTIVITY: 1, // 1
    +READ_NOTEBOOK_PLUS_ACTIVITY: 2, // 2
    +GROUP: 3, // 3
    +FULL_ACCESS: 4, // 4
    +BUSINESS_FULL_ACCESS: 5 // 5
  |};
  ...
  declare var Evernote$SponsoredGroupRole: {|
    +GROUP_MEMBER: 1, // 1
    +GROUP_ADMIN: 2, // 2
    +GROUP_OWNER: 3 // 3
  |};
  ...
  declare var Evernote$BusinessUserRole: {|
    +ADMIN: 1, // 1
    +NORMAL: 2 // 2
  |};
  ...
  declare var Evernote$SharedNotebookInstanceRestrictions: {|
    +ONLY_JOINED_OR_PREVIEW: 1, // 1
    +NO_SHARED_NOTEBOOKS: 2 // 2
  |};
  ...
  declare var Evernote$ReminderEmailConfig: {|
    +DO_NOT_SEND: 1, // 1
    +SEND_DAILY_EMAIL: 2 // 2
  |};
