declare module 'evernote' {
      ...
      declare var npm$namespace$Evernote: {
        
        EDAM_ATTRIBUTE_LEN_MIN: typeof Evernote$EDAM_ATTRIBUTE_LEN_MIN,
EDAM_ATTRIBUTE_LEN_MAX: typeof Evernote$EDAM_ATTRIBUTE_LEN_MAX,
EDAM_ATTRIBUTE_REGEX: typeof Evernote$EDAM_ATTRIBUTE_REGEX,
EDAM_ATTRIBUTE_LIST_MAX: typeof Evernote$EDAM_ATTRIBUTE_LIST_MAX,
EDAM_ATTRIBUTE_MAP_MAX: typeof Evernote$EDAM_ATTRIBUTE_MAP_MAX,
EDAM_GUID_LEN_MIN: typeof Evernote$EDAM_GUID_LEN_MIN,
EDAM_GUID_LEN_MAX: typeof Evernote$EDAM_GUID_LEN_MAX,
EDAM_GUID_REGEX: typeof Evernote$EDAM_GUID_REGEX,
EDAM_EMAIL_LEN_MIN: typeof Evernote$EDAM_EMAIL_LEN_MIN,
EDAM_EMAIL_LEN_MAX: typeof Evernote$EDAM_EMAIL_LEN_MAX,
EDAM_EMAIL_LOCAL_REGEX: typeof Evernote$EDAM_EMAIL_LOCAL_REGEX,
EDAM_EMAIL_DOMAIN_REGEX: typeof Evernote$EDAM_EMAIL_DOMAIN_REGEX,
EDAM_EMAIL_REGEX: typeof Evernote$EDAM_EMAIL_REGEX,
EDAM_VAT_REGEX: typeof Evernote$EDAM_VAT_REGEX,
EDAM_TIMEZONE_LEN_MIN: typeof Evernote$EDAM_TIMEZONE_LEN_MIN,
EDAM_TIMEZONE_LEN_MAX: typeof Evernote$EDAM_TIMEZONE_LEN_MAX,
EDAM_TIMEZONE_REGEX: typeof Evernote$EDAM_TIMEZONE_REGEX,
EDAM_MIME_LEN_MIN: typeof Evernote$EDAM_MIME_LEN_MIN,
EDAM_MIME_LEN_MAX: typeof Evernote$EDAM_MIME_LEN_MAX,
EDAM_MIME_REGEX: typeof Evernote$EDAM_MIME_REGEX,
EDAM_MIME_TYPE_GIF: typeof Evernote$EDAM_MIME_TYPE_GIF,
EDAM_MIME_TYPE_JPEG: typeof Evernote$EDAM_MIME_TYPE_JPEG,
EDAM_MIME_TYPE_PNG: typeof Evernote$EDAM_MIME_TYPE_PNG,
EDAM_MIME_TYPE_WAV: typeof Evernote$EDAM_MIME_TYPE_WAV,
EDAM_MIME_TYPE_MP3: typeof Evernote$EDAM_MIME_TYPE_MP3,
EDAM_MIME_TYPE_AMR: typeof Evernote$EDAM_MIME_TYPE_AMR,
EDAM_MIME_TYPE_AAC: typeof Evernote$EDAM_MIME_TYPE_AAC,
EDAM_MIME_TYPE_M4A: typeof Evernote$EDAM_MIME_TYPE_M4A,
EDAM_MIME_TYPE_MP4_VIDEO: typeof Evernote$EDAM_MIME_TYPE_MP4_VIDEO,
EDAM_MIME_TYPE_INK: typeof Evernote$EDAM_MIME_TYPE_INK,
EDAM_MIME_TYPE_PDF: typeof Evernote$EDAM_MIME_TYPE_PDF,
EDAM_MIME_TYPE_DEFAULT: typeof Evernote$EDAM_MIME_TYPE_DEFAULT,
EDAM_MIME_TYPES: typeof Evernote$EDAM_MIME_TYPES,
EDAM_INDEXABLE_RESOURCE_MIME_TYPES: typeof Evernote$EDAM_INDEXABLE_RESOURCE_MIME_TYPES,
EDAM_SEARCH_QUERY_LEN_MIN: typeof Evernote$EDAM_SEARCH_QUERY_LEN_MIN,
EDAM_SEARCH_QUERY_LEN_MAX: typeof Evernote$EDAM_SEARCH_QUERY_LEN_MAX,
EDAM_SEARCH_QUERY_REGEX: typeof Evernote$EDAM_SEARCH_QUERY_REGEX,
EDAM_HASH_LEN: typeof Evernote$EDAM_HASH_LEN,
EDAM_USER_USERNAME_LEN_MIN: typeof Evernote$EDAM_USER_USERNAME_LEN_MIN,
EDAM_USER_USERNAME_LEN_MAX: typeof Evernote$EDAM_USER_USERNAME_LEN_MAX,
EDAM_USER_USERNAME_REGEX: typeof Evernote$EDAM_USER_USERNAME_REGEX,
EDAM_USER_NAME_LEN_MIN: typeof Evernote$EDAM_USER_NAME_LEN_MIN,
EDAM_USER_NAME_LEN_MAX: typeof Evernote$EDAM_USER_NAME_LEN_MAX,
EDAM_USER_NAME_REGEX: typeof Evernote$EDAM_USER_NAME_REGEX,
EDAM_TAG_NAME_LEN_MIN: typeof Evernote$EDAM_TAG_NAME_LEN_MIN,
EDAM_TAG_NAME_LEN_MAX: typeof Evernote$EDAM_TAG_NAME_LEN_MAX,
EDAM_TAG_NAME_REGEX: typeof Evernote$EDAM_TAG_NAME_REGEX,
EDAM_NOTE_TITLE_LEN_MIN: typeof Evernote$EDAM_NOTE_TITLE_LEN_MIN,
EDAM_NOTE_TITLE_LEN_MAX: typeof Evernote$EDAM_NOTE_TITLE_LEN_MAX,
EDAM_NOTE_TITLE_REGEX: typeof Evernote$EDAM_NOTE_TITLE_REGEX,
EDAM_NOTE_CONTENT_LEN_MIN: typeof Evernote$EDAM_NOTE_CONTENT_LEN_MIN,
EDAM_NOTE_CONTENT_LEN_MAX: typeof Evernote$EDAM_NOTE_CONTENT_LEN_MAX,
EDAM_APPLICATIONDATA_NAME_LEN_MIN: typeof Evernote$EDAM_APPLICATIONDATA_NAME_LEN_MIN,
EDAM_APPLICATIONDATA_NAME_LEN_MAX: typeof Evernote$EDAM_APPLICATIONDATA_NAME_LEN_MAX,
EDAM_APPLICATIONDATA_VALUE_LEN_MIN: typeof Evernote$EDAM_APPLICATIONDATA_VALUE_LEN_MIN,
EDAM_APPLICATIONDATA_VALUE_LEN_MAX: typeof Evernote$EDAM_APPLICATIONDATA_VALUE_LEN_MAX,
EDAM_APPLICATIONDATA_ENTRY_LEN_MAX: typeof Evernote$EDAM_APPLICATIONDATA_ENTRY_LEN_MAX,
EDAM_APPLICATIONDATA_NAME_REGEX: typeof Evernote$EDAM_APPLICATIONDATA_NAME_REGEX,
EDAM_APPLICATIONDATA_VALUE_REGEX: typeof Evernote$EDAM_APPLICATIONDATA_VALUE_REGEX,
EDAM_NOTEBOOK_NAME_LEN_MIN: typeof Evernote$EDAM_NOTEBOOK_NAME_LEN_MIN,
EDAM_NOTEBOOK_NAME_LEN_MAX: typeof Evernote$EDAM_NOTEBOOK_NAME_LEN_MAX,
EDAM_NOTEBOOK_NAME_REGEX: typeof Evernote$EDAM_NOTEBOOK_NAME_REGEX,
EDAM_NOTEBOOK_STACK_LEN_MIN: typeof Evernote$EDAM_NOTEBOOK_STACK_LEN_MIN,
EDAM_NOTEBOOK_STACK_LEN_MAX: typeof Evernote$EDAM_NOTEBOOK_STACK_LEN_MAX,
EDAM_NOTEBOOK_STACK_REGEX: typeof Evernote$EDAM_NOTEBOOK_STACK_REGEX,
EDAM_PUBLISHING_URI_LEN_MIN: typeof Evernote$EDAM_PUBLISHING_URI_LEN_MIN,
EDAM_PUBLISHING_URI_LEN_MAX: typeof Evernote$EDAM_PUBLISHING_URI_LEN_MAX,
EDAM_PUBLISHING_URI_REGEX: typeof Evernote$EDAM_PUBLISHING_URI_REGEX,
EDAM_PUBLISHING_URI_PROHIBITED: typeof Evernote$EDAM_PUBLISHING_URI_PROHIBITED,
EDAM_PUBLISHING_DESCRIPTION_LEN_MIN: typeof Evernote$EDAM_PUBLISHING_DESCRIPTION_LEN_MIN,
EDAM_PUBLISHING_DESCRIPTION_LEN_MAX: typeof Evernote$EDAM_PUBLISHING_DESCRIPTION_LEN_MAX,
EDAM_PUBLISHING_DESCRIPTION_REGEX: typeof Evernote$EDAM_PUBLISHING_DESCRIPTION_REGEX,
EDAM_SAVED_SEARCH_NAME_LEN_MIN: typeof Evernote$EDAM_SAVED_SEARCH_NAME_LEN_MIN,
EDAM_SAVED_SEARCH_NAME_LEN_MAX: typeof Evernote$EDAM_SAVED_SEARCH_NAME_LEN_MAX,
EDAM_SAVED_SEARCH_NAME_REGEX: typeof Evernote$EDAM_SAVED_SEARCH_NAME_REGEX,
EDAM_USER_PASSWORD_LEN_MIN: typeof Evernote$EDAM_USER_PASSWORD_LEN_MIN,
EDAM_USER_PASSWORD_LEN_MAX: typeof Evernote$EDAM_USER_PASSWORD_LEN_MAX,
EDAM_USER_PASSWORD_REGEX: typeof Evernote$EDAM_USER_PASSWORD_REGEX,
EDAM_BUSINESS_URI_LEN_MAX: typeof Evernote$EDAM_BUSINESS_URI_LEN_MAX,
EDAM_NOTE_TAGS_MAX: typeof Evernote$EDAM_NOTE_TAGS_MAX,
EDAM_NOTE_RESOURCES_MAX: typeof Evernote$EDAM_NOTE_RESOURCES_MAX,
EDAM_USER_TAGS_MAX: typeof Evernote$EDAM_USER_TAGS_MAX,
EDAM_BUSINESS_TAGS_MAX: typeof Evernote$EDAM_BUSINESS_TAGS_MAX,
EDAM_USER_SAVED_SEARCHES_MAX: typeof Evernote$EDAM_USER_SAVED_SEARCHES_MAX,
EDAM_USER_NOTES_MAX: typeof Evernote$EDAM_USER_NOTES_MAX,
EDAM_BUSINESS_NOTES_MAX: typeof Evernote$EDAM_BUSINESS_NOTES_MAX,
EDAM_USER_NOTEBOOKS_MAX: typeof Evernote$EDAM_USER_NOTEBOOKS_MAX,
EDAM_BUSINESS_NOTEBOOKS_MAX: typeof Evernote$EDAM_BUSINESS_NOTEBOOKS_MAX,
EDAM_USER_RECENT_MAILED_ADDRESSES_MAX: typeof Evernote$EDAM_USER_RECENT_MAILED_ADDRESSES_MAX,
EDAM_USER_MAIL_LIMIT_DAILY_FREE: typeof Evernote$EDAM_USER_MAIL_LIMIT_DAILY_FREE,
EDAM_USER_MAIL_LIMIT_DAILY_PREMIUM: typeof Evernote$EDAM_USER_MAIL_LIMIT_DAILY_PREMIUM,
EDAM_USER_UPLOAD_LIMIT_FREE: typeof Evernote$EDAM_USER_UPLOAD_LIMIT_FREE,
EDAM_USER_UPLOAD_LIMIT_PREMIUM: typeof Evernote$EDAM_USER_UPLOAD_LIMIT_PREMIUM,
EDAM_USER_UPLOAD_LIMIT_BUSINESS: typeof Evernote$EDAM_USER_UPLOAD_LIMIT_BUSINESS,
EDAM_NOTE_SIZE_MAX_FREE: typeof Evernote$EDAM_NOTE_SIZE_MAX_FREE,
EDAM_NOTE_SIZE_MAX_PREMIUM: typeof Evernote$EDAM_NOTE_SIZE_MAX_PREMIUM,
EDAM_RESOURCE_SIZE_MAX_FREE: typeof Evernote$EDAM_RESOURCE_SIZE_MAX_FREE,
EDAM_RESOURCE_SIZE_MAX_PREMIUM: typeof Evernote$EDAM_RESOURCE_SIZE_MAX_PREMIUM,
EDAM_USER_LINKED_NOTEBOOK_MAX: typeof Evernote$EDAM_USER_LINKED_NOTEBOOK_MAX,
EDAM_USER_LINKED_NOTEBOOK_MAX_PREMIUM: typeof Evernote$EDAM_USER_LINKED_NOTEBOOK_MAX_PREMIUM,
EDAM_NOTEBOOK_SHARED_NOTEBOOK_MAX: typeof Evernote$EDAM_NOTEBOOK_SHARED_NOTEBOOK_MAX,
EDAM_NOTE_CONTENT_CLASS_LEN_MIN: typeof Evernote$EDAM_NOTE_CONTENT_CLASS_LEN_MIN,
EDAM_NOTE_CONTENT_CLASS_LEN_MAX: typeof Evernote$EDAM_NOTE_CONTENT_CLASS_LEN_MAX,
EDAM_NOTE_CONTENT_CLASS_REGEX: typeof Evernote$EDAM_NOTE_CONTENT_CLASS_REGEX,
EDAM_HELLO_APP_CONTENT_CLASS_PREFIX: typeof Evernote$EDAM_HELLO_APP_CONTENT_CLASS_PREFIX,
EDAM_FOOD_APP_CONTENT_CLASS_PREFIX: typeof Evernote$EDAM_FOOD_APP_CONTENT_CLASS_PREFIX,
EDAM_CONTENT_CLASS_HELLO_ENCOUNTER: typeof Evernote$EDAM_CONTENT_CLASS_HELLO_ENCOUNTER,
EDAM_CONTENT_CLASS_HELLO_PROFILE: typeof Evernote$EDAM_CONTENT_CLASS_HELLO_PROFILE,
EDAM_CONTENT_CLASS_FOOD_MEAL: typeof Evernote$EDAM_CONTENT_CLASS_FOOD_MEAL,
EDAM_CONTENT_CLASS_SKITCH_PREFIX: typeof Evernote$EDAM_CONTENT_CLASS_SKITCH_PREFIX,
EDAM_CONTENT_CLASS_SKITCH: typeof Evernote$EDAM_CONTENT_CLASS_SKITCH,
EDAM_CONTENT_CLASS_SKITCH_PDF: typeof Evernote$EDAM_CONTENT_CLASS_SKITCH_PDF,
EDAM_CONTENT_CLASS_PENULTIMATE_PREFIX: typeof Evernote$EDAM_CONTENT_CLASS_PENULTIMATE_PREFIX,
EDAM_CONTENT_CLASS_PENULTIMATE_NOTEBOOK: typeof Evernote$EDAM_CONTENT_CLASS_PENULTIMATE_NOTEBOOK,
EDAM_RELATED_PLAINTEXT_LEN_MIN: typeof Evernote$EDAM_RELATED_PLAINTEXT_LEN_MIN,
EDAM_RELATED_PLAINTEXT_LEN_MAX: typeof Evernote$EDAM_RELATED_PLAINTEXT_LEN_MAX,
EDAM_RELATED_MAX_NOTES: typeof Evernote$EDAM_RELATED_MAX_NOTES,
EDAM_RELATED_MAX_NOTEBOOKS: typeof Evernote$EDAM_RELATED_MAX_NOTEBOOKS,
EDAM_RELATED_MAX_TAGS: typeof Evernote$EDAM_RELATED_MAX_TAGS,
EDAM_BUSINESS_NOTEBOOK_DESCRIPTION_LEN_MIN: typeof Evernote$EDAM_BUSINESS_NOTEBOOK_DESCRIPTION_LEN_MIN,
EDAM_BUSINESS_NOTEBOOK_DESCRIPTION_LEN_MAX: typeof Evernote$EDAM_BUSINESS_NOTEBOOK_DESCRIPTION_LEN_MAX,
EDAM_BUSINESS_NOTEBOOK_DESCRIPTION_REGEX: typeof Evernote$EDAM_BUSINESS_NOTEBOOK_DESCRIPTION_REGEX,
EDAM_BUSINESS_PHONE_NUMBER_LEN_MAX: typeof Evernote$EDAM_BUSINESS_PHONE_NUMBER_LEN_MAX,
EDAM_PREFERENCE_NAME_LEN_MIN: typeof Evernote$EDAM_PREFERENCE_NAME_LEN_MIN,
EDAM_PREFERENCE_NAME_LEN_MAX: typeof Evernote$EDAM_PREFERENCE_NAME_LEN_MAX,
EDAM_PREFERENCE_VALUE_LEN_MIN: typeof Evernote$EDAM_PREFERENCE_VALUE_LEN_MIN,
EDAM_PREFERENCE_VALUE_LEN_MAX: typeof Evernote$EDAM_PREFERENCE_VALUE_LEN_MAX,
EDAM_MAX_PREFERENCES: typeof Evernote$EDAM_MAX_PREFERENCES,
EDAM_MAX_VALUES_PER_PREFERENCE: typeof Evernote$EDAM_MAX_VALUES_PER_PREFERENCE,
EDAM_PREFERENCE_NAME_REGEX: typeof Evernote$EDAM_PREFERENCE_NAME_REGEX,
EDAM_PREFERENCE_VALUE_REGEX: typeof Evernote$EDAM_PREFERENCE_VALUE_REGEX,
EDAM_PREFERENCE_SHORTCUTS: typeof Evernote$EDAM_PREFERENCE_SHORTCUTS,
EDAM_PREFERENCE_SHORTCUTS_MAX_VALUES: typeof Evernote$EDAM_PREFERENCE_SHORTCUTS_MAX_VALUES,
EDAM_DEVICE_ID_LEN_MAX: typeof Evernote$EDAM_DEVICE_ID_LEN_MAX,
EDAM_DEVICE_ID_REGEX: typeof Evernote$EDAM_DEVICE_ID_REGEX,
EDAM_DEVICE_DESCRIPTION_LEN_MAX: typeof Evernote$EDAM_DEVICE_DESCRIPTION_LEN_MAX,
EDAM_DEVICE_DESCRIPTION_REGEX: typeof Evernote$EDAM_DEVICE_DESCRIPTION_REGEX,
EDAM_SEARCH_SUGGESTIONS_MAX: typeof Evernote$EDAM_SEARCH_SUGGESTIONS_MAX,
EDAM_SEARCH_SUGGESTIONS_PREFIX_LEN_MAX: typeof Evernote$EDAM_SEARCH_SUGGESTIONS_PREFIX_LEN_MAX,
EDAM_SEARCH_SUGGESTIONS_PREFIX_LEN_MIN: typeof Evernote$EDAM_SEARCH_SUGGESTIONS_PREFIX_LEN_MIN,
CLASSIFICATION_RECIPE_USER_NON_RECIPE: typeof Evernote$CLASSIFICATION_RECIPE_USER_NON_RECIPE,
CLASSIFICATION_RECIPE_USER_RECIPE: typeof Evernote$CLASSIFICATION_RECIPE_USER_RECIPE,
CLASSIFICATION_RECIPE_SERVICE_RECIPE: typeof Evernote$CLASSIFICATION_RECIPE_SERVICE_RECIPE,
EDAM_NOTE_SOURCE_WEB_CLIP: typeof Evernote$EDAM_NOTE_SOURCE_WEB_CLIP,
EDAM_NOTE_SOURCE_MAIL_CLIP: typeof Evernote$EDAM_NOTE_SOURCE_MAIL_CLIP,
EDAM_NOTE_SOURCE_MAIL_SMTP_GATEWAY: typeof Evernote$EDAM_NOTE_SOURCE_MAIL_SMTP_GATEWAY,
EDAM_VERSION_MAJOR: typeof Evernote$EDAM_VERSION_MAJOR,
EDAM_VERSION_MINOR: typeof Evernote$EDAM_VERSION_MINOR,
      }
...
declare class Evernote$Client  {
static new: (config: Evernote$ClientConfig) => Evernote$Client;
 ...
 * </dl>
 */
declare  class Evernote$EDAMErrorCode {
  constructor(...args: empty): mixed;
static +UNKNOWN: Class<Evernote$EDAMErrorCode__UNKNOWN> & Evernote$EDAMErrorCode__UNKNOWN & 1;// 1
static +BAD_DATA_FORMAT: Class<Evernote$EDAMErrorCode__BAD_DATA_FORMAT> & Evernote$EDAMErrorCode__BAD_DATA_FORMAT & 2;// 2
static +PERMISSION_DENIED: Class<Evernote$EDAMErrorCode__PERMISSION_DENIED> & Evernote$EDAMErrorCode__PERMISSION_DENIED & 3;// 3
static +INTERNAL_ERROR: Class<Evernote$EDAMErrorCode__INTERNAL_ERROR> & Evernote$EDAMErrorCode__INTERNAL_ERROR & 4;// 4
static +DATA_REQUIRED: Class<Evernote$EDAMErrorCode__DATA_REQUIRED> & Evernote$EDAMErrorCode__DATA_REQUIRED & 5;// 5
static +LIMIT_REACHED: Class<Evernote$EDAMErrorCode__LIMIT_REACHED> & Evernote$EDAMErrorCode__LIMIT_REACHED & 6;// 6
static +QUOTA_REACHED: Class<Evernote$EDAMErrorCode__QUOTA_REACHED> & Evernote$EDAMErrorCode__QUOTA_REACHED & 7;// 7
static +INVALID_AUTH: Class<Evernote$EDAMErrorCode__INVALID_AUTH> & Evernote$EDAMErrorCode__INVALID_AUTH & 8;// 8
static +AUTH_EXPIRED: Class<Evernote$EDAMErrorCode__AUTH_EXPIRED> & Evernote$EDAMErrorCode__AUTH_EXPIRED & 9;// 9
static +DATA_CONFLICT: Class<Evernote$EDAMErrorCode__DATA_CONFLICT> & Evernote$EDAMErrorCode__DATA_CONFLICT & 10;// 10
static +ENML_VALIDATION: Class<Evernote$EDAMErrorCode__ENML_VALIDATION> & Evernote$EDAMErrorCode__ENML_VALIDATION & 11;// 11
static +SHARD_UNAVAILABLE: Class<Evernote$EDAMErrorCode__SHARD_UNAVAILABLE> & Evernote$EDAMErrorCode__SHARD_UNAVAILABLE & 12;// 12
static +LEN_TOO_SHORT: Class<Evernote$EDAMErrorCode__LEN_TOO_SHORT> & Evernote$EDAMErrorCode__LEN_TOO_SHORT & 13;// 13
static +LEN_TOO_LONG: Class<Evernote$EDAMErrorCode__LEN_TOO_LONG> & Evernote$EDAMErrorCode__LEN_TOO_LONG & 14;// 14
static +TOO_FEW: Class<Evernote$EDAMErrorCode__TOO_FEW> & Evernote$EDAMErrorCode__TOO_FEW & 15;// 15
static +TOO_MANY: Class<Evernote$EDAMErrorCode__TOO_MANY> & Evernote$EDAMErrorCode__TOO_MANY & 16;// 16
static +UNSUPPORTED_OPERATION: Class<Evernote$EDAMErrorCode__UNSUPPORTED_OPERATION> & Evernote$EDAMErrorCode__UNSUPPORTED_OPERATION & 17;// 17
static +TAKEN_DOWN: Class<Evernote$EDAMErrorCode__TAKEN_DOWN> & Evernote$EDAMErrorCode__TAKEN_DOWN & 18;// 18
static +RATE_LIMIT_REACHED: Class<Evernote$EDAMErrorCode__RATE_LIMIT_REACHED> & Evernote$EDAMErrorCode__RATE_LIMIT_REACHED & 19;// 19

}

declare class Evernote$EDAMErrorCode__UNKNOWN mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__BAD_DATA_FORMAT mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__PERMISSION_DENIED mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__INTERNAL_ERROR mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__DATA_REQUIRED mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__LIMIT_REACHED mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__QUOTA_REACHED mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__INVALID_AUTH mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__AUTH_EXPIRED mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__DATA_CONFLICT mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__ENML_VALIDATION mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__SHARD_UNAVAILABLE mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__LEN_TOO_SHORT mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__LEN_TOO_LONG mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__TOO_FEW mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__TOO_MANY mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__UNSUPPORTED_OPERATION mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__TAKEN_DOWN mixins Evernote$EDAMErrorCode {}
declare class Evernote$EDAMErrorCode__RATE_LIMIT_REACHED mixins Evernote$EDAMErrorCode {}
 ...
 */
declare class Evernote$EDAMUserException mixins Thrift.TException {
errorCode: Evernote$EDAMErrorCode;
parameter: string;
constructor(args?: {
errorCode: Evernote$EDAMErrorCode,
parameter?: string
 ...
 */
declare class Evernote$EDAMSystemException mixins Thrift.TException {
errorCode: Evernote$EDAMErrorCode;
message: string;
 ...
 */
declare class Evernote$EDAMNotFoundException mixins Thrift.TException {
identifier: string;
key: string;
constructor(args?: {
identifier?: string,
 ...
 */
declare var Evernote$EDAM_ATTRIBUTE_LEN_MIN: number;


/**
 * Maximum length of any string-based attribute, in Unicode chars
 */
declare var Evernote$EDAM_ATTRIBUTE_LEN_MAX: number;
 ...
 */
declare var Evernote$EDAM_ATTRIBUTE_REGEX: string;
 ...
 */
declare var Evernote$EDAM_ATTRIBUTE_LIST_MAX: number;
 ...
 */
declare var Evernote$EDAM_ATTRIBUTE_MAP_MAX: number;


/**
 * The minimum length of a GUID generated by the Evernote service
 */
declare var Evernote$EDAM_GUID_LEN_MIN: number;


/**
 * The maximum length of a GUID generated by the Evernote service
 */
declare var Evernote$EDAM_GUID_LEN_MAX: number;


/**
 * GUIDs generated by the Evernote service will match the provided pattern
 */
declare var Evernote$EDAM_GUID_REGEX: string;


/**
 * The minimum length of any email address
 */
declare var Evernote$EDAM_EMAIL_LEN_MIN: number;


/**
 * The maximum length of any email address
 */
declare var Evernote$EDAM_EMAIL_LEN_MAX: number;
 ...
 * the '@' symbol.
 */
declare var Evernote$EDAM_EMAIL_LOCAL_REGEX: string;
 ...
 * the '@' symbol.
 */
declare var Evernote$EDAM_EMAIL_DOMAIN_REGEX: string;
 ...
 */
declare var Evernote$EDAM_EMAIL_REGEX: string;
 ...
 */
declare var Evernote$EDAM_VAT_REGEX: string;


/**
 * The minimum length of a timezone specification string
 */
declare var Evernote$EDAM_TIMEZONE_LEN_MIN: number;


/**
 * The maximum length of a timezone specification string
 */
declare var Evernote$EDAM_TIMEZONE_LEN_MAX: number;
 ...
 * </ul>
 */
declare var Evernote$EDAM_TIMEZONE_REGEX: string;


/**
 * The minimum length of any MIME type string given to Evernote
 */
declare var Evernote$EDAM_MIME_LEN_MIN: number;


/**
 * The maximum length of any MIME type string given to Evernote
 */
declare var Evernote$EDAM_MIME_LEN_MAX: number;
 ...
 * E.g.:    image/gif
 */
declare var Evernote$EDAM_MIME_REGEX: string;


/**
 * Canonical MIME type string for GIF image resources
 */
declare var Evernote$EDAM_MIME_TYPE_GIF: string;


/**
 * Canonical MIME type string for JPEG image resources
 */
declare var Evernote$EDAM_MIME_TYPE_JPEG: string;


/**
 * Canonical MIME type string for PNG image resources
 */
declare var Evernote$EDAM_MIME_TYPE_PNG: string;


/**
 * Canonical MIME type string for WAV audio resources
 */
declare var Evernote$EDAM_MIME_TYPE_WAV: string;


/**
 * Canonical MIME type string for MP3 audio resources
 */
declare var Evernote$EDAM_MIME_TYPE_MP3: string;


/**
 * Canonical MIME type string for AMR audio resources
 */
declare var Evernote$EDAM_MIME_TYPE_AMR: string;


/**
 * Canonical MIME type string for AAC audio resources
 */
declare var Evernote$EDAM_MIME_TYPE_AAC: string;


/**
 * Canonical MIME type string for MP4 audio resources
 */
declare var Evernote$EDAM_MIME_TYPE_M4A: string;


/**
 * Canonical MIME type string for MP4 video resources
 */
declare var Evernote$EDAM_MIME_TYPE_MP4_VIDEO: string;


/**
 * Canonical MIME type string for Evernote Ink resources
 */
declare var Evernote$EDAM_MIME_TYPE_INK: string;


/**
 * Canonical MIME type string for PDF resources
 */
declare var Evernote$EDAM_MIME_TYPE_PDF: string;


/**
 * MIME type used for attachments of an unspecified type
 */
declare var Evernote$EDAM_MIME_TYPE_DEFAULT: string;
 ...
 */
declare var Evernote$EDAM_MIME_TYPES: string[];
 ...
 */
declare var Evernote$EDAM_INDEXABLE_RESOURCE_MIME_TYPES: string[];


/**
 * The minimum length of a user search query string in Unicode chars
 */
declare var Evernote$EDAM_SEARCH_QUERY_LEN_MIN: number;


/**
 * The maximum length of a user search query string in Unicode chars
 */
declare var Evernote$EDAM_SEARCH_QUERY_LEN_MAX: number;
 ...
 */
declare var Evernote$EDAM_SEARCH_QUERY_REGEX: string;
 ...
 * value.
 */
declare var Evernote$EDAM_HASH_LEN: number;


/**
 * The minimum length of an Evernote username
 */
declare var Evernote$EDAM_USER_USERNAME_LEN_MIN: number;


/**
 * The maximum length of an Evernote username
 */
declare var Evernote$EDAM_USER_USERNAME_LEN_MAX: number;
 ...
 */
declare var Evernote$EDAM_USER_USERNAME_REGEX: string;


/**
 * Minimum length of the User.name field
 */
declare var Evernote$EDAM_USER_NAME_LEN_MIN: number;


/**
 * Maximum length of the User.name field
 */
declare var Evernote$EDAM_USER_NAME_LEN_MAX: number;
 ...
 */
declare var Evernote$EDAM_USER_NAME_REGEX: string;


/**
 * The minimum length of a Tag.name, in Unicode characters
 */
declare var Evernote$EDAM_TAG_NAME_LEN_MIN: number;


/**
 * The maximum length of a Tag.name, in Unicode characters
 */
declare var Evernote$EDAM_TAG_NAME_LEN_MAX: number;
 ...
 */
declare var Evernote$EDAM_TAG_NAME_REGEX: string;


/**
 * The minimum length of a Note.title, in Unicode characters
 */
declare var Evernote$EDAM_NOTE_TITLE_LEN_MIN: number;


/**
 * The maximum length of a Note.title, in Unicode characters
 */
declare var Evernote$EDAM_NOTE_TITLE_LEN_MAX: number;
 ...
 * The string may not begin or end with whitespace.
 */
declare var Evernote$EDAM_NOTE_TITLE_REGEX: string;
 ...
 */
declare var Evernote$EDAM_NOTE_CONTENT_LEN_MIN: number;
 ...
 * Note.content fields must comply with the ENML DTD.
 */
declare var Evernote$EDAM_NOTE_CONTENT_LEN_MAX: number;
 ...
 * Notes.
 */
declare var Evernote$EDAM_APPLICATIONDATA_NAME_LEN_MIN: number;
 ...
 * Notes.
 */
declare var Evernote$EDAM_APPLICATIONDATA_NAME_LEN_MAX: number;
 ...
 */
declare var Evernote$EDAM_APPLICATIONDATA_VALUE_LEN_MIN: number;
 ...
 */
declare var Evernote$EDAM_APPLICATIONDATA_VALUE_LEN_MAX: number;
 ...
 */
declare var Evernote$EDAM_APPLICATIONDATA_ENTRY_LEN_MAX: number;
 ...
 */
declare var Evernote$EDAM_APPLICATIONDATA_NAME_REGEX: string;
 ...
 * against EDAM_APPLICATIONDATA_ENTRY_LEN_MAX.
 */
declare var Evernote$EDAM_APPLICATIONDATA_VALUE_REGEX: string;


/**
 * The minimum length of a Notebook.name, in Unicode characters
 */
declare var Evernote$EDAM_NOTEBOOK_NAME_LEN_MIN: number;


/**
 * The maximum length of a Notebook.name, in Unicode characters
 */
declare var Evernote$EDAM_NOTEBOOK_NAME_LEN_MAX: number;
 ...
 * The string may not begin or end with whitespace.
 */
declare var Evernote$EDAM_NOTEBOOK_NAME_REGEX: string;


/**
 * The minimum length of a Notebook.stack, in Unicode characters
 */
declare var Evernote$EDAM_NOTEBOOK_STACK_LEN_MIN: number;


/**
 * The maximum length of a Notebook.stack, in Unicode characters
 */
declare var Evernote$EDAM_NOTEBOOK_STACK_LEN_MAX: number;
 ...
 * The string may not begin or end with whitespace.
 */
declare var Evernote$EDAM_NOTEBOOK_STACK_REGEX: string;


/**
 * The minimum length of a public notebook URI component
 */
declare var Evernote$EDAM_PUBLISHING_URI_LEN_MIN: number;


/**
 * The maximum length of a public notebook URI component
 */
declare var Evernote$EDAM_PUBLISHING_URI_LEN_MAX: number;


/**
 * A public notebook URI component must match the provided pattern
 */
declare var Evernote$EDAM_PUBLISHING_URI_REGEX: string;


/**
 * The set of strings that may not be used as a publishing URI
 */
declare var Evernote$EDAM_PUBLISHING_URI_PROHIBITED: string[];


/**
 * The minimum length of a Publishing.publicDescription field.
 */
declare var Evernote$EDAM_PUBLISHING_DESCRIPTION_LEN_MIN: number;


/**
 * The maximum length of a Publishing.publicDescription field.
 */
declare var Evernote$EDAM_PUBLISHING_DESCRIPTION_LEN_MAX: number;
 ...
 * end with whitespace.
 */
declare var Evernote$EDAM_PUBLISHING_DESCRIPTION_REGEX: string;


/**
 * The minimum length of a SavedSearch.name field
 */
declare var Evernote$EDAM_SAVED_SEARCH_NAME_LEN_MIN: number;


/**
 * The maximum length of a SavedSearch.name field
 */
declare var Evernote$EDAM_SAVED_SEARCH_NAME_LEN_MAX: number;
 ...
 * end with whitespace.
 */
declare var Evernote$EDAM_SAVED_SEARCH_NAME_REGEX: string;


/**
 * The minimum length of an Evernote user password
 */
declare var Evernote$EDAM_USER_PASSWORD_LEN_MIN: number;


/**
 * The maximum length of an Evernote user password
 */
declare var Evernote$EDAM_USER_PASSWORD_LEN_MAX: number;


/**
 * Evernote user passwords must match this regular expression
 */
declare var Evernote$EDAM_USER_PASSWORD_REGEX: string;


/**
 * The maximum length of an Evernote Business URI
 */
declare var Evernote$EDAM_BUSINESS_URI_LEN_MAX: number;


/**
 * The maximum number of Tags per Note
 */
declare var Evernote$EDAM_NOTE_TAGS_MAX: number;


/**
 * The maximum number of Resources per Note
 */
declare var Evernote$EDAM_NOTE_RESOURCES_MAX: number;


/**
 * Maximum number of Tags per account
 */
declare var Evernote$EDAM_USER_TAGS_MAX: number;


/**
 * Maximum number of Tags per business account.
 */
declare var Evernote$EDAM_BUSINESS_TAGS_MAX: number;


/**
 * Maximum number of SavedSearches per account
 */
declare var Evernote$EDAM_USER_SAVED_SEARCHES_MAX: number;


/**
 * Maximum number of Notes per user
 */
declare var Evernote$EDAM_USER_NOTES_MAX: number;


/**
 * Maximum number of Notes per business account
 */
declare var Evernote$EDAM_BUSINESS_NOTES_MAX: number;


/**
 * Maximum number of Notebooks per user
 */
declare var Evernote$EDAM_USER_NOTEBOOKS_MAX: number;


/**
 * Maximum number of Notebooks in a business account
 */
declare var Evernote$EDAM_BUSINESS_NOTEBOOKS_MAX: number;
 ...
 */
declare var Evernote$EDAM_USER_RECENT_MAILED_ADDRESSES_MAX: number;
 ...
 */
declare var Evernote$EDAM_USER_MAIL_LIMIT_DAILY_FREE: number;
 ...
 * recipients, this counts as two emails.
 */
declare var Evernote$EDAM_USER_MAIL_LIMIT_DAILY_PREMIUM: number;
 ...
 * account each month.
 */
declare var Evernote$EDAM_USER_UPLOAD_LIMIT_FREE: number;
 ...
 * account each month.
 */
declare var Evernote$EDAM_USER_UPLOAD_LIMIT_PREMIUM: number;
 ...
 */
declare var Evernote$EDAM_USER_UPLOAD_LIMIT_BUSINESS: number;
 ...
 * sizes (in bytes).
 */
declare var Evernote$EDAM_NOTE_SIZE_MAX_FREE: number;
 ...
 * sizes (in bytes).
 */
declare var Evernote$EDAM_NOTE_SIZE_MAX_PREMIUM: number;


/**
 * Maximum size of a resource, in bytes, for Free accounts
 */
declare var Evernote$EDAM_RESOURCE_SIZE_MAX_FREE: number;


/**
 * Maximum size of a resource, in bytes, for Premium accounts
 */
declare var Evernote$EDAM_RESOURCE_SIZE_MAX_PREMIUM: number;
 ...
 * account.
 */
declare var Evernote$EDAM_USER_LINKED_NOTEBOOK_MAX: number;
 ...
 */
declare var Evernote$EDAM_USER_LINKED_NOTEBOOK_MAX_PREMIUM: number;


/**
 * Maximum number of shared notebooks per notebook
 */
declare var Evernote$EDAM_NOTEBOOK_SHARED_NOTEBOOK_MAX: number;


/**
 * The minimum length of the content class attribute of a note.
 */
declare var Evernote$EDAM_NOTE_CONTENT_CLASS_LEN_MIN: number;


/**
 * The maximum length of the content class attribute of a note.
 */
declare var Evernote$EDAM_NOTE_CONTENT_CLASS_LEN_MAX: number;
 ...
 * to be valid.
 */
declare var Evernote$EDAM_NOTE_CONTENT_CLASS_REGEX: string;
 ...
 */
declare var Evernote$EDAM_HELLO_APP_CONTENT_CLASS_PREFIX: string;
 ...
 * search strings, the * character must be appended to this constant.
 */
declare var Evernote$EDAM_FOOD_APP_CONTENT_CLASS_PREFIX: string;
 ...
 */
declare var Evernote$EDAM_CONTENT_CLASS_HELLO_ENCOUNTER: string;
 ...
 * character must be appended to this constant.
 */
declare var Evernote$EDAM_CONTENT_CLASS_HELLO_PROFILE: string;
 ...
 */
declare var Evernote$EDAM_CONTENT_CLASS_FOOD_MEAL: string;
 ...
 */
declare var Evernote$EDAM_CONTENT_CLASS_SKITCH_PREFIX: string;
 ...
 * Skitch.
 */
declare var Evernote$EDAM_CONTENT_CLASS_SKITCH: string;
 ...
 * Skitch.
 */
declare var Evernote$EDAM_CONTENT_CLASS_SKITCH_PDF: string;
 ...
 * or search strings, the * character must be appended to this constant.
 */
declare var Evernote$EDAM_CONTENT_CLASS_PENULTIMATE_PREFIX: string;
 ...
 */
declare var Evernote$EDAM_CONTENT_CLASS_PENULTIMATE_NOTEBOOK: string;
 ...
 */
declare var Evernote$EDAM_RELATED_PLAINTEXT_LEN_MIN: number;
 ...
 * plaintext is being provided.
 */
declare var Evernote$EDAM_RELATED_PLAINTEXT_LEN_MAX: number;
 ...
 * query.
 */
declare var Evernote$EDAM_RELATED_MAX_NOTES: number;
 ...
 * query.
 */
declare var Evernote$EDAM_RELATED_MAX_NOTEBOOKS: number;


/**
 * The maximum number of tags that will be returned from a findRelated() query.
 */
declare var Evernote$EDAM_RELATED_MAX_TAGS: number;
 ...
 * notebook.
 */
declare var Evernote$EDAM_BUSINESS_NOTEBOOK_DESCRIPTION_LEN_MIN: number;
 ...
 * notebook.
 */
declare var Evernote$EDAM_BUSINESS_NOTEBOOK_DESCRIPTION_LEN_MAX: number;
 ...
 * The string may not begin or end with whitespace.
 */
declare var Evernote$EDAM_BUSINESS_NOTEBOOK_DESCRIPTION_REGEX: string;


/**
 * The maximum length of a business phone number.
 */
declare var Evernote$EDAM_BUSINESS_PHONE_NUMBER_LEN_MAX: number;


/**
 * Minimum length of a preference name
 */
declare var Evernote$EDAM_PREFERENCE_NAME_LEN_MIN: number;


/**
 * Maximum length of a preference name
 */
declare var Evernote$EDAM_PREFERENCE_NAME_LEN_MAX: number;


/**
 * Minimum length of a preference value
 */
declare var Evernote$EDAM_PREFERENCE_VALUE_LEN_MIN: number;


/**
 * Maximum length of a preference value
 */
declare var Evernote$EDAM_PREFERENCE_VALUE_LEN_MAX: number;


/**
 * Maximum number of name/value pairs allowed
 */
declare var Evernote$EDAM_MAX_PREFERENCES: number;


/**
 * Maximum number of values per preference name
 */
declare var Evernote$EDAM_MAX_VALUES_PER_PREFERENCE: number;


/**
 * A preference name must match this regex.
 */
declare var Evernote$EDAM_PREFERENCE_NAME_REGEX: string;


/**
 * A preference value must match this regex.
 */
declare var Evernote$EDAM_PREFERENCE_VALUE_REGEX: string;


/**
 * The name of the preferences entry that contains shortcuts.
 */
declare var Evernote$EDAM_PREFERENCE_SHORTCUTS: string;


/**
 * The maximum number of shortcuts that a user may have.
 */
declare var Evernote$EDAM_PREFERENCE_SHORTCUTS_MAX_VALUES: number;


/**
 * Maximum length of the device identifier string associated with long sessions.
 */
declare var Evernote$EDAM_DEVICE_ID_LEN_MAX: number;


/**
 * Regular expression for device identifier strings associated with long sessions.
 */
declare var Evernote$EDAM_DEVICE_ID_REGEX: string;


/**
 * Maximum length of the device description string associated with long sessions.
 */
declare var Evernote$EDAM_DEVICE_DESCRIPTION_LEN_MAX: number;


/**
 * Regular expression for device description strings associated with long sessions.
 */
declare var Evernote$EDAM_DEVICE_DESCRIPTION_REGEX: string;


/**
 * Maximum number of search suggestions that can be returned
 */
declare var Evernote$EDAM_SEARCH_SUGGESTIONS_MAX: number;


/**
 * Maximum length of the search suggestion prefix
 */
declare var Evernote$EDAM_SEARCH_SUGGESTIONS_PREFIX_LEN_MAX: number;


/**
 * Minimum length of the search suggestion prefix
 */
declare var Evernote$EDAM_SEARCH_SUGGESTIONS_PREFIX_LEN_MIN: number;

declare class Evernote$NoteStoreClient  {
seqid: number;
 ...
 * Calls will result in an EDAMUserException with the error code
 * PERMISSION_DENIED.
 * @param sharedNotebookIds - a list of ShardNotebook.id longs identifying the
 ...
 * </dl>
 */
declare class Evernote$SyncState  {
currentTime: number;
 ...
 * </dl>
 */
declare class Evernote$SyncChunk  {
currentTime: number;
chunkHighUSN: number;
updateCount: number;
notes: Evernote$Note[];
 ...
 * </dl>
 */
declare class Evernote$SyncChunkFilter  {
 ...
 * </dl>
 */
declare class Evernote$NoteFilter  {
order: number;
ascending: boolean;
words: string;
notebookGuid: string;
 ...
 * </dl>
 */
declare class Evernote$NoteList  {
startIndex: number;
totalNotes: number;
notes: Evernote$Note[];
stoppedWords: string[];
 ...
 * </dl>
 */
declare class Evernote$NoteMetadata  {
guid: string;
title: string;
 ...
 * </dl>
 */
declare class Evernote$NotesMetadataList  {
startIndex: number;
totalNotes: number;
 ...
 */
declare class Evernote$NotesMetadataResultSpec  {
 ...
 * </dl>
 */
declare class Evernote$NoteCollectionCounts  {
notebookCounts: {
[k: string]: number
};
tagCounts: {
 ...
 * </dl>
 */
declare class Evernote$NoteEmailParameters  {
guid: string;
note: Evernote$Note;
toAddresses: string[];
ccAddresses: string[];
 ...
 * </dl>
 */
declare class Evernote$NoteVersionId  {
updateSequenceNum: number;
updated: number;
saved: number;
title: string;
 ...
 * </dl>
 */
declare class Evernote$ClientUsageMetrics  {
sessions: number;
constructor(args?: {
sessions?: number
}): this
 ...
 * </dl>
 */
declare class Evernote$RelatedQuery  {
noteGuid: string;
plainText: string;
filter: Evernote$NoteFilter;
referenceUri: string;
 ...
 * </dl>
 */
declare class Evernote$RelatedResult  {
notes: Evernote$Note[];
notebooks: Evernote$Notebook[];
tags: Evernote$Tag[];
 ...
 * </dl>
 */
declare class Evernote$RelatedResultSpec  {
maxNotes: number;
maxNotebooks: number;
maxTags: number;
 ...
 */
declare  class Evernote$PrivilegeLevel {
  constructor(...args: empty): mixed;
static +NORMAL: Class<Evernote$PrivilegeLevel__NORMAL> & Evernote$PrivilegeLevel__NORMAL & 1;// 1
static +PREMIUM: Class<Evernote$PrivilegeLevel__PREMIUM> & Evernote$PrivilegeLevel__PREMIUM & 3;// 3
static +VIP: Class<Evernote$PrivilegeLevel__VIP> & Evernote$PrivilegeLevel__VIP & 5;// 5
static +MANAGER: Class<Evernote$PrivilegeLevel__MANAGER> & Evernote$PrivilegeLevel__MANAGER & 7;// 7
static +SUPPORT: Class<Evernote$PrivilegeLevel__SUPPORT> & Evernote$PrivilegeLevel__SUPPORT & 8;// 8
static +ADMIN: Class<Evernote$PrivilegeLevel__ADMIN> & Evernote$PrivilegeLevel__ADMIN & 9;// 9

}

declare class Evernote$PrivilegeLevel__NORMAL mixins Evernote$PrivilegeLevel {}
declare class Evernote$PrivilegeLevel__PREMIUM mixins Evernote$PrivilegeLevel {}
declare class Evernote$PrivilegeLevel__VIP mixins Evernote$PrivilegeLevel {}
declare class Evernote$PrivilegeLevel__MANAGER mixins Evernote$PrivilegeLevel {}
declare class Evernote$PrivilegeLevel__SUPPORT mixins Evernote$PrivilegeLevel {}
declare class Evernote$PrivilegeLevel__ADMIN mixins Evernote$PrivilegeLevel {}
 ...
 */
declare  class Evernote$QueryFormat {
  constructor(...args: empty): mixed;
static +USER: Class<Evernote$QueryFormat__USER> & Evernote$QueryFormat__USER & 1;// 1
static +SEXP: Class<Evernote$QueryFormat__SEXP> & Evernote$QueryFormat__SEXP & 2;// 2

}

declare class Evernote$QueryFormat__USER mixins Evernote$QueryFormat {}
declare class Evernote$QueryFormat__SEXP mixins Evernote$QueryFormat {}
 ...
 */
declare  class Evernote$NoteSortOrder {
  constructor(...args: empty): mixed;
static +CREATED: Class<Evernote$NoteSortOrder__CREATED> & Evernote$NoteSortOrder__CREATED & 1;// 1
static +UPDATED: Class<Evernote$NoteSortOrder__UPDATED> & Evernote$NoteSortOrder__UPDATED & 2;// 2
static +RELEVANCE: Class<Evernote$NoteSortOrder__RELEVANCE> & Evernote$NoteSortOrder__RELEVANCE & 3;// 3
static +UPDATE_SEQUENCE_NUMBER: Class<Evernote$NoteSortOrder__UPDATE_SEQUENCE_NUMBER> & Evernote$NoteSortOrder__UPDATE_SEQUENCE_NUMBER & 4;// 4
static +TITLE: Class<Evernote$NoteSortOrder__TITLE> & Evernote$NoteSortOrder__TITLE & 5;// 5

}

declare class Evernote$NoteSortOrder__CREATED mixins Evernote$NoteSortOrder {}
declare class Evernote$NoteSortOrder__UPDATED mixins Evernote$NoteSortOrder {}
declare class Evernote$NoteSortOrder__RELEVANCE mixins Evernote$NoteSortOrder {}
declare class Evernote$NoteSortOrder__UPDATE_SEQUENCE_NUMBER mixins Evernote$NoteSortOrder {}
declare class Evernote$NoteSortOrder__TITLE mixins Evernote$NoteSortOrder {}
 ...
 */
declare  class Evernote$PremiumOrderStatus {
  constructor(...args: empty): mixed;
static +NONE: Class<Evernote$PremiumOrderStatus__NONE> & Evernote$PremiumOrderStatus__NONE & 0;// 0
static +PENDING: Class<Evernote$PremiumOrderStatus__PENDING> & Evernote$PremiumOrderStatus__PENDING & 1;// 1
static +ACTIVE: Class<Evernote$PremiumOrderStatus__ACTIVE> & Evernote$PremiumOrderStatus__ACTIVE & 2;// 2
static +FAILED: Class<Evernote$PremiumOrderStatus__FAILED> & Evernote$PremiumOrderStatus__FAILED & 3;// 3
static +CANCELLATION_PENDING: Class<Evernote$PremiumOrderStatus__CANCELLATION_PENDING> & Evernote$PremiumOrderStatus__CANCELLATION_PENDING & 4;// 4
static +CANCELED: Class<Evernote$PremiumOrderStatus__CANCELED> & Evernote$PremiumOrderStatus__CANCELED & 5;// 5

}

declare class Evernote$PremiumOrderStatus__NONE mixins Evernote$PremiumOrderStatus {}
declare class Evernote$PremiumOrderStatus__PENDING mixins Evernote$PremiumOrderStatus {}
declare class Evernote$PremiumOrderStatus__ACTIVE mixins Evernote$PremiumOrderStatus {}
declare class Evernote$PremiumOrderStatus__FAILED mixins Evernote$PremiumOrderStatus {}
declare class Evernote$PremiumOrderStatus__CANCELLATION_PENDING mixins Evernote$PremiumOrderStatus {}
declare class Evernote$PremiumOrderStatus__CANCELED mixins Evernote$PremiumOrderStatus {}
 ...
 */
declare  class Evernote$SharedNotebookPrivilegeLevel {
  constructor(...args: empty): mixed;
static +READ_NOTEBOOK: Class<Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK> & Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK & 0;// 0
static +MODIFY_NOTEBOOK_PLUS_ACTIVITY: Class<Evernote$SharedNotebookPrivilegeLevel__MODIFY_NOTEBOOK_PLUS_ACTIVITY> & Evernote$SharedNotebookPrivilegeLevel__MODIFY_NOTEBOOK_PLUS_ACTIVITY & 1;// 1
static +READ_NOTEBOOK_PLUS_ACTIVITY: Class<Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK_PLUS_ACTIVITY> & Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK_PLUS_ACTIVITY & 2;// 2
static +GROUP: Class<Evernote$SharedNotebookPrivilegeLevel__GROUP> & Evernote$SharedNotebookPrivilegeLevel__GROUP & 3;// 3
static +FULL_ACCESS: Class<Evernote$SharedNotebookPrivilegeLevel__FULL_ACCESS> & Evernote$SharedNotebookPrivilegeLevel__FULL_ACCESS & 4;// 4
static +BUSINESS_FULL_ACCESS: Class<Evernote$SharedNotebookPrivilegeLevel__BUSINESS_FULL_ACCESS> & Evernote$SharedNotebookPrivilegeLevel__BUSINESS_FULL_ACCESS & 5;// 5

}

declare class Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK mixins Evernote$SharedNotebookPrivilegeLevel {}
declare class Evernote$SharedNotebookPrivilegeLevel__MODIFY_NOTEBOOK_PLUS_ACTIVITY mixins Evernote$SharedNotebookPrivilegeLevel {}
declare class Evernote$SharedNotebookPrivilegeLevel__READ_NOTEBOOK_PLUS_ACTIVITY mixins Evernote$SharedNotebookPrivilegeLevel {}
declare class Evernote$SharedNotebookPrivilegeLevel__GROUP mixins Evernote$SharedNotebookPrivilegeLevel {}
declare class Evernote$SharedNotebookPrivilegeLevel__FULL_ACCESS mixins Evernote$SharedNotebookPrivilegeLevel {}
declare class Evernote$SharedNotebookPrivilegeLevel__BUSINESS_FULL_ACCESS mixins Evernote$SharedNotebookPrivilegeLevel {}
 ...
 */
declare  class Evernote$SponsoredGroupRole {
  constructor(...args: empty): mixed;
static +GROUP_MEMBER: Class<Evernote$SponsoredGroupRole__GROUP_MEMBER> & Evernote$SponsoredGroupRole__GROUP_MEMBER & 1;// 1
static +GROUP_ADMIN: Class<Evernote$SponsoredGroupRole__GROUP_ADMIN> & Evernote$SponsoredGroupRole__GROUP_ADMIN & 2;// 2
static +GROUP_OWNER: Class<Evernote$SponsoredGroupRole__GROUP_OWNER> & Evernote$SponsoredGroupRole__GROUP_OWNER & 3;// 3

}

declare class Evernote$SponsoredGroupRole__GROUP_MEMBER mixins Evernote$SponsoredGroupRole {}
declare class Evernote$SponsoredGroupRole__GROUP_ADMIN mixins Evernote$SponsoredGroupRole {}
declare class Evernote$SponsoredGroupRole__GROUP_OWNER mixins Evernote$SponsoredGroupRole {}
 ...
 */
declare  class Evernote$BusinessUserRole {
  constructor(...args: empty): mixed;
static +ADMIN: Class<Evernote$BusinessUserRole__ADMIN> & Evernote$BusinessUserRole__ADMIN & 1;// 1
static +NORMAL: Class<Evernote$BusinessUserRole__NORMAL> & Evernote$BusinessUserRole__NORMAL & 2;// 2

}

declare class Evernote$BusinessUserRole__ADMIN mixins Evernote$BusinessUserRole {}
declare class Evernote$BusinessUserRole__NORMAL mixins Evernote$BusinessUserRole {}
 ...
 */
declare  class Evernote$SharedNotebookInstanceRestrictions {
  constructor(...args: empty): mixed;
static +ONLY_JOINED_OR_PREVIEW: Class<Evernote$SharedNotebookInstanceRestrictions__ONLY_JOINED_OR_PREVIEW> & Evernote$SharedNotebookInstanceRestrictions__ONLY_JOINED_OR_PREVIEW & 1;// 1
static +NO_SHARED_NOTEBOOKS: Class<Evernote$SharedNotebookInstanceRestrictions__NO_SHARED_NOTEBOOKS> & Evernote$SharedNotebookInstanceRestrictions__NO_SHARED_NOTEBOOKS & 2;// 2

}

declare class Evernote$SharedNotebookInstanceRestrictions__ONLY_JOINED_OR_PREVIEW mixins Evernote$SharedNotebookInstanceRestrictions {}
declare class Evernote$SharedNotebookInstanceRestrictions__NO_SHARED_NOTEBOOKS mixins Evernote$SharedNotebookInstanceRestrictions {}
 ...
 */
declare  class Evernote$ReminderEmailConfig {
  constructor(...args: empty): mixed;
static +DO_NOT_SEND: Class<Evernote$ReminderEmailConfig__DO_NOT_SEND> & Evernote$ReminderEmailConfig__DO_NOT_SEND & 1;// 1
static +SEND_DAILY_EMAIL: Class<Evernote$ReminderEmailConfig__SEND_DAILY_EMAIL> & Evernote$ReminderEmailConfig__SEND_DAILY_EMAIL & 2;// 2

}

declare class Evernote$ReminderEmailConfig__DO_NOT_SEND mixins Evernote$ReminderEmailConfig {}
declare class Evernote$ReminderEmailConfig__SEND_DAILY_EMAIL mixins Evernote$ReminderEmailConfig {}
 ...
 * </dl>
 */
declare class Evernote$UserAttributes  {
...
reminderEmailConfig: Evernote$ReminderEmailConfig;
constructor(args?: {
defaultLocationName?: string,
defaultLatitude?: number,
defaultLongitude?: number,
 ...
 * </dl>
 */
declare class Evernote$Accounting  {
uploadLimit: number;
uploadLimitEnd: number;
uploadLimitNextMonth: number;
premiumServiceStatus: Evernote$PremiumOrderStatus;
...
businessId: number;
businessName: string;
businessRole: Evernote$BusinessUserRole;
unitDiscount: number;
 ...
 * </dl>
 */
declare class Evernote$BusinessUserInfo  {
businessId: number;
businessName: string;
role: Evernote$BusinessUserRole;
email: string;
constructor(args?: {
businessId?: number,
businessName?: string,
 ...
 * </dl>
 */
declare class Evernote$PremiumInfo  {
currentTime: number;
premium: boolean;
...
sponsoredGroupRole: Evernote$SponsoredGroupRole;
 ...
 * </dl>
 */
declare class Evernote$User  {
id: number;
username: string;
email: string;
name: string;
timezone: string;
privilege: Evernote$PrivilegeLevel;
created: number;
updated: number;
deleted: number;
active: boolean;
 ...
 * </dl>
 */
declare class Evernote$LazyMap  {
keysOnly: string[];
fullMap: {
[k: string]: string
};
 ...
 * </dl>
 */
declare class Evernote$ResourceAttributes  {
sourceURL: string;
timestamp: number;
latitude: number;
longitude: number;
 ...
 * </dl>
 */
declare class Evernote$Resource  {
guid: string;
noteGuid: string;
data: Evernote$Data;
mime: string;
 ...
 * </dl>
 */
declare class Evernote$NoteAttributes  {
subjectDate: number;
latitude: number;
longitude: number;
altitude: number;
 ...
 * </dl>
 */
declare class Evernote$Publishing  {
uri: string;
order: Evernote$NoteSortOrder;
ascending: boolean;
 ...
 * </dl>
 */
declare class Evernote$BusinessNotebook  {
notebookDescription: string;
privilege: Evernote$SharedNotebookPrivilegeLevel;
recommended: boolean;
constructor(args?: {
notebookDescription?: string,
privilege?: Evernote$SharedNotebookPrivilegeLevel,
 ...
 * </dl>
 */
declare class Evernote$SavedSearchScope  {
 ...
 * </dl>
 */
declare class Evernote$SavedSearch  {
guid: string;
name: string;
query: string;
format: Evernote$QueryFormat;
updateSequenceNum: number;
 ...
 * </dl>
 */
declare class Evernote$SharedNotebookRecipientSettings  {
 ...
 * </dl>
 */
declare class Evernote$SharedNotebook  {
id: number;
userId: number;
notebookGuid: string;
email: string;
 ...
 *      </dd>
 */
declare class Evernote$NotebookRestrictions  {
noReadNotes: boolean;
...
updateWhichSharedNotebookRestrictions: Evernote$SharedNotebookInstanceRestrictions;
expungeWhichSharedNotebookRestrictions: Evernote$SharedNotebookInstanceRestrictions;
constructor(args?: {
noReadNotes?: boolean,
noCreateNotes?: boolean,
noUpdateNotes?: boolean,
 ...
 * </dl>
 */
declare class Evernote$Notebook  {
guid: string;
name: string;
updateSequenceNum: number;
 ...
 * </dl>
 */
declare class Evernote$LinkedNotebook  {
shareName: string;
username: string;
shardId: string;
shareKey: string;
 ...
 * </dl>
 */
declare class Evernote$NotebookDescriptor  {
guid: string;
 ...
 */
declare var Evernote$CLASSIFICATION_RECIPE_USER_NON_RECIPE: string;
 ...
 */
declare var Evernote$CLASSIFICATION_RECIPE_USER_RECIPE: string;
 ...
 */
declare var Evernote$CLASSIFICATION_RECIPE_SERVICE_RECIPE: string;
 ...
 */
declare var Evernote$EDAM_NOTE_SOURCE_WEB_CLIP: string;
 ...
 */
declare var Evernote$EDAM_NOTE_SOURCE_MAIL_CLIP: string;
 ...
 */
declare var Evernote$EDAM_NOTE_SOURCE_MAIL_SMTP_GATEWAY: string;
 ...
 * </ul>
 */
declare class Evernote$UserStoreClient  {
seqid: number;
 ...
 * </dl>
 */
declare class Evernote$PublicUserInfo  {
userId: number;
shardId: string;
privilege: Evernote$PrivilegeLevel;
username: string;
 ...
 * </dl>
 */
declare class Evernote$AuthenticationResult  {
currentTime: number;
 ...
 * </dl>
 */
declare class Evernote$BootstrapSettings  {
serviceHost: string;
marketingUrl: string;
supportUrl: string;
 ...
 * </dl>
 */
declare class Evernote$BootstrapProfile  {
name: string;
 ...
 * </dl>
 */
declare class Evernote$BootstrapInfo  {
 ...
 */
declare var Evernote$EDAM_VERSION_MAJOR: number;
 ...
 * beginning of a session to confirm that they are not out of date.
 */
declare var Evernote$EDAM_VERSION_MINOR: number;
    }
