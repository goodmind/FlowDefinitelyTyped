...
options?: Options$Options$Humanize): string,
...
transliterate(sentence: string, options?: Options$Options$Transliterate): string,
parameterize(sentence: string, options?: Options$Options$Parameterize): string
} 
