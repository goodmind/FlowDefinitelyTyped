...
declare function Domain$defineContext(options: Domain$DefineAggregateOptions): void
 ...
 */
declare type Domain$defineSnapshotNeedHandler = (loadingTime: number, events: any[], aggregateData: any) => boolean;
 ...
 */
defineSnapshotNeed(cb: Domain$defineSnapshotNeedHandler): Domain$DefineAggregateResult,
...
cb?: ((data: any) => boolean) | boolean): Domain$DefineAggregateResult,
...
version: Domain$AggregateVersion,
cb: (data: any, aggregate: Domain$AggregateModel) => void): Domain$DefineAggregateResult,

/**
 * optionally, define idGenerator function for new aggregate ids
 */
defineAggregateIdGenerator(
cb: (() => string) | ((callback: Domain$generateIdCallback) => string)): Domain$DefineAggregateResult,
...
cb: (cmd: Domain$Command, callback?: Domain$generateIdCallback) => string): Domain$DefineAggregateResult
} 

declare function Domain$defineAggregate(
options: Domain$DefineAggregateOptions,
initializationData?: any): Domain$DefineAggregateResult
...
data: any,
callback?: (err: string | Error) => string | Error) => void | string | Error;

declare function Domain$definePreLoadCondition(
options: Domain$DefinePreLoadConditionOptions,
handler: Domain$preLoadConditionHandler): void
...
handler: Domain$preConditionHandler): void
...
declare type Domain$commandHandler = (data: any, aggregate: Domain$AggregateModel) => void;

declare type Domain$defineEventStreamsToLoadHandler = (cmd: any) => Array<{
context: string,
aggregate: string,
aggregateId: string
}>;
...
handler: Domain$commandHandler): Domain$DefineCommandResult
...
declare type Domain$eventHandler = (data: any, aggregate: Domain$AggregateModel) => void;

declare function Domain$defineEvent(options: Domain$DefineEventOptions, handler: Domain$eventHandler): void
...
handler: Domain$businessRuleHandler): void
...
handler: Domain$commandHandlerHandler): void
...
events: any[],
aggregateData: any,
metaInfos: Domain$HandleMetaInfos) => void)): void,
 ...
 */
onEvent(
cb: ((evt: any) => void) | ((evt: any, callback: () => void) => void)): Domain$CqrsDomain,
 ...
 */
idGenerator(
cb: (() => string) | ((callback: Domain$generateIdCallback) => string)): Domain$CqrsDomain,
...
aggregateData: any,
meta: any,
callback: (err: Error, evts: any[], aggregateData: any, meta: any) => void): void
} 

declare type Domain$SupportedDBTypes = "mongodb"
| "redis"
| "tingodb"
| "azuretable"
| "inmemory";
...
useLoaderExtensions?: true
	...
	declare function Domain(options: Domain$Domain$CreateDomainOptions): Domain$Domain$CqrsDomain
