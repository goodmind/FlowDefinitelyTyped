declare module "stampit" {
   ...
   * @returns A new Stamp
   */
  declare function stampit$deepProperties(
    ...deepObjects: Array<{}>
  ): stampit$Stamp;
   ...
   * @returns A new Stamp
   */
  declare function stampit$deepConfiguration(
    ...deepConfs: Array<{}>
  ): stampit$Stamp;
   ...
   * @returns A new Stamp
   */
  declare function stampit$propertyDescriptors(
    ...descriptors: Array<{}>
  ): stampit$Stamp;
   ...
   * @returns A new Stamp
   */
  declare function stampit$staticPropertyDescriptors(
    ...descriptors: Array<{}>
  ): stampit$Stamp;
