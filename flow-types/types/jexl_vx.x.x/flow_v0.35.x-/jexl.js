declare module 'jexl' {
        declare type TransformFunction = (value: any, ...args: any[]) => any;
	declare type BinaryOpFunction = (left: any, right: any) => any;
	declare type UnaryOpFunction = (right: any) => any;
	declare type EvalCallbackFunction = (err: Error | null, result: any) => void;
...
cb?: EvalCallbackFunction): Promise<any>;
 ...
 * xpath-like drilldown into native Javascript objects.
 */
declare class BuildableJexl mixins Jexl {
Jexl: {
new (): Jexl
}
}
	declare var exportJexl: BuildableJexl;
	declare module.exports: typeof exportJexl
