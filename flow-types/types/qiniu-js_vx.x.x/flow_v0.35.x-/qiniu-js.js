...
next: (obj: Next) => void,
error?: (err: Error | string) => void,
complete?: (obj: CompletedResult) => void): Subscription
} 
...
config: $Shape<Config>): Observable
 ...
 * @returns
 */
declare export function createMkFileUrl(url: string, size: number, key: string, putExtra: $Shape<Extra>): string
 ...
 * @returns
 */
declare export function getUploadUrl(config: $Shape<Config>, token: string): Promise<string>
...
file: Blob,
options: $Shape<CompressOptions>): Promise<{
dist: Blob,
width: number,
height: number
}>
 ...
 * @returns 返回处理后的图片url
 */
declare export function imageView2(options: $Shape<ImageView2Options>, key: string, domain: string): string
 ...
 * @returns 返回处理后的图片url
 */
declare export function imageMogr2(optoins: $Shape<ImageMogr2Options>, key: string, domain: string): string
 ...
 * @returns
 */
declare export function imageInfo(key: string, domain: string): Promise<ImageInfo>
 ...
 * @returns
 */
declare export function exif(key: string, domain: string): Promise<ExtentInfo>
