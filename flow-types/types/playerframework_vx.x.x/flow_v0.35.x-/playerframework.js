...
static +none: Class<PlayerFramework$AdvertisingState__none> & PlayerFramework$AdvertisingState__none & 0;// 0
static +loading: Class<PlayerFramework$AdvertisingState__loading> & PlayerFramework$AdvertisingState__loading & 1;// 1
static +linear: Class<PlayerFramework$AdvertisingState__linear> & PlayerFramework$AdvertisingState__linear & 2;// 2
static +nonLinear: Class<PlayerFramework$AdvertisingState__nonLinear> & PlayerFramework$AdvertisingState__nonLinear & 3;// 3

}

declare class PlayerFramework$AdvertisingState__none mixins PlayerFramework$AdvertisingState {}
declare class PlayerFramework$AdvertisingState__loading mixins PlayerFramework$AdvertisingState {}
declare class PlayerFramework$AdvertisingState__linear mixins PlayerFramework$AdvertisingState {}
declare class PlayerFramework$AdvertisingState__nonLinear mixins PlayerFramework$AdvertisingState {}


declare  class PlayerFramework$AutohideBehavior {
  constructor(...args: empty): mixed;
static +none: Class<PlayerFramework$AutohideBehavior__none> & PlayerFramework$AutohideBehavior__none & 0;// 0
static +allowDuringPlaybackOnly: Class<PlayerFramework$AutohideBehavior__allowDuringPlaybackOnly> & PlayerFramework$AutohideBehavior__allowDuringPlaybackOnly & 1;// 1
static +preventDuringInteractiveHover: Class<PlayerFramework$AutohideBehavior__preventDuringInteractiveHover> & PlayerFramework$AutohideBehavior__preventDuringInteractiveHover & 2;// 2
static +all: Class<PlayerFramework$AutohideBehavior__all> & PlayerFramework$AutohideBehavior__all & 3;// 3

}

declare class PlayerFramework$AutohideBehavior__none mixins PlayerFramework$AutohideBehavior {}
declare class PlayerFramework$AutohideBehavior__allowDuringPlaybackOnly mixins PlayerFramework$AutohideBehavior {}
declare class PlayerFramework$AutohideBehavior__preventDuringInteractiveHover mixins PlayerFramework$AutohideBehavior {}
declare class PlayerFramework$AutohideBehavior__all mixins PlayerFramework$AutohideBehavior {}


declare  class PlayerFramework$InteractionType {
  constructor(...args: empty): mixed;
static +none: Class<PlayerFramework$InteractionType__none> & PlayerFramework$InteractionType__none & 0;// 0
static +soft: Class<PlayerFramework$InteractionType__soft> & PlayerFramework$InteractionType__soft & 1;// 1
static +hard: Class<PlayerFramework$InteractionType__hard> & PlayerFramework$InteractionType__hard & 2;// 2
static +all: Class<PlayerFramework$InteractionType__all> & PlayerFramework$InteractionType__all & 3;// 3

}

declare class PlayerFramework$InteractionType__none mixins PlayerFramework$InteractionType {}
declare class PlayerFramework$InteractionType__soft mixins PlayerFramework$InteractionType {}
declare class PlayerFramework$InteractionType__hard mixins PlayerFramework$InteractionType {}
declare class PlayerFramework$InteractionType__all mixins PlayerFramework$InteractionType {}


declare  class PlayerFramework$NetworkState {
  constructor(...args: empty): mixed;
static +empty: Class<PlayerFramework$NetworkState__empty> & PlayerFramework$NetworkState__empty & 0;// 0
static +idle: Class<PlayerFramework$NetworkState__idle> & PlayerFramework$NetworkState__idle & 1;// 1
static +loading: Class<PlayerFramework$NetworkState__loading> & PlayerFramework$NetworkState__loading & 2;// 2
static +noSource: Class<PlayerFramework$NetworkState__noSource> & PlayerFramework$NetworkState__noSource & 3;// 3

}

declare class PlayerFramework$NetworkState__empty mixins PlayerFramework$NetworkState {}
declare class PlayerFramework$NetworkState__idle mixins PlayerFramework$NetworkState {}
declare class PlayerFramework$NetworkState__loading mixins PlayerFramework$NetworkState {}
declare class PlayerFramework$NetworkState__noSource mixins PlayerFramework$NetworkState {}


declare  class PlayerFramework$MediaQuality {
  constructor(...args: empty): mixed;
static +standardDefinition: Class<PlayerFramework$MediaQuality__standardDefinition> & PlayerFramework$MediaQuality__standardDefinition & 0;// 0
static +highDefinition: Class<PlayerFramework$MediaQuality__highDefinition> & PlayerFramework$MediaQuality__highDefinition & 1;// 1

}

declare class PlayerFramework$MediaQuality__standardDefinition mixins PlayerFramework$MediaQuality {}
declare class PlayerFramework$MediaQuality__highDefinition mixins PlayerFramework$MediaQuality {}


declare  class PlayerFramework$PlayerState {
  constructor(...args: empty): mixed;
static +unloaded: Class<PlayerFramework$PlayerState__unloaded> & PlayerFramework$PlayerState__unloaded & 0;// 0
static +pending: Class<PlayerFramework$PlayerState__pending> & PlayerFramework$PlayerState__pending & 1;// 1
static +loading: Class<PlayerFramework$PlayerState__loading> & PlayerFramework$PlayerState__loading & 2;// 2
static +loaded: Class<PlayerFramework$PlayerState__loaded> & PlayerFramework$PlayerState__loaded & 3;// 3
static +opened: Class<PlayerFramework$PlayerState__opened> & PlayerFramework$PlayerState__opened & 4;// 4
static +starting: Class<PlayerFramework$PlayerState__starting> & PlayerFramework$PlayerState__starting & 5;// 5
static +started: Class<PlayerFramework$PlayerState__started> & PlayerFramework$PlayerState__started & 6;// 6
static +ending: Class<PlayerFramework$PlayerState__ending> & PlayerFramework$PlayerState__ending & 7;// 7
static +ended: Class<PlayerFramework$PlayerState__ended> & PlayerFramework$PlayerState__ended & 8;// 8
static +failed: Class<PlayerFramework$PlayerState__failed> & PlayerFramework$PlayerState__failed & 9;// 9

}

declare class PlayerFramework$PlayerState__unloaded mixins PlayerFramework$PlayerState {}
declare class PlayerFramework$PlayerState__pending mixins PlayerFramework$PlayerState {}
declare class PlayerFramework$PlayerState__loading mixins PlayerFramework$PlayerState {}
declare class PlayerFramework$PlayerState__loaded mixins PlayerFramework$PlayerState {}
declare class PlayerFramework$PlayerState__opened mixins PlayerFramework$PlayerState {}
declare class PlayerFramework$PlayerState__starting mixins PlayerFramework$PlayerState {}
declare class PlayerFramework$PlayerState__started mixins PlayerFramework$PlayerState {}
declare class PlayerFramework$PlayerState__ending mixins PlayerFramework$PlayerState {}
declare class PlayerFramework$PlayerState__ended mixins PlayerFramework$PlayerState {}
declare class PlayerFramework$PlayerState__failed mixins PlayerFramework$PlayerState {}


declare  class PlayerFramework$ReadyState {
  constructor(...args: empty): mixed;
static +nothing: Class<PlayerFramework$ReadyState__nothing> & PlayerFramework$ReadyState__nothing & 0;// 0
static +metadata: Class<PlayerFramework$ReadyState__metadata> & PlayerFramework$ReadyState__metadata & 1;// 1
static +currentData: Class<PlayerFramework$ReadyState__currentData> & PlayerFramework$ReadyState__currentData & 2;// 2
static +futureData: Class<PlayerFramework$ReadyState__futureData> & PlayerFramework$ReadyState__futureData & 3;// 3
static +enoughData: Class<PlayerFramework$ReadyState__enoughData> & PlayerFramework$ReadyState__enoughData & 4;// 4

}

declare class PlayerFramework$ReadyState__nothing mixins PlayerFramework$ReadyState {}
declare class PlayerFramework$ReadyState__metadata mixins PlayerFramework$ReadyState {}
declare class PlayerFramework$ReadyState__currentData mixins PlayerFramework$ReadyState {}
declare class PlayerFramework$ReadyState__futureData mixins PlayerFramework$ReadyState {}
declare class PlayerFramework$ReadyState__enoughData mixins PlayerFramework$ReadyState {}


declare  class PlayerFramework$MediaErrorCode {
  constructor(...args: empty): mixed;
static +unknown: Class<PlayerFramework$MediaErrorCode__unknown> & PlayerFramework$MediaErrorCode__unknown & 0;// 0
static +aborted: Class<PlayerFramework$MediaErrorCode__aborted> & PlayerFramework$MediaErrorCode__aborted & 1;// 1
static +network: Class<PlayerFramework$MediaErrorCode__network> & PlayerFramework$MediaErrorCode__network & 2;// 2
static +decode: Class<PlayerFramework$MediaErrorCode__decode> & PlayerFramework$MediaErrorCode__decode & 3;// 3
static +notSupported: Class<PlayerFramework$MediaErrorCode__notSupported> & PlayerFramework$MediaErrorCode__notSupported & 4;// 4

}

declare class PlayerFramework$MediaErrorCode__unknown mixins PlayerFramework$MediaErrorCode {}
declare class PlayerFramework$MediaErrorCode__aborted mixins PlayerFramework$MediaErrorCode {}
declare class PlayerFramework$MediaErrorCode__network mixins PlayerFramework$MediaErrorCode {}
declare class PlayerFramework$MediaErrorCode__decode mixins PlayerFramework$MediaErrorCode {}
declare class PlayerFramework$MediaErrorCode__notSupported mixins PlayerFramework$MediaErrorCode {}


declare  class PlayerFramework$ImageErrorCode {
  constructor(...args: empty): mixed;
static +unknown: Class<PlayerFramework$ImageErrorCode__unknown> & PlayerFramework$ImageErrorCode__unknown & 0;// 0
static +aborted: Class<PlayerFramework$ImageErrorCode__aborted> & PlayerFramework$ImageErrorCode__aborted & 1;// 1

}

declare class PlayerFramework$ImageErrorCode__unknown mixins PlayerFramework$ImageErrorCode {}
declare class PlayerFramework$ImageErrorCode__aborted mixins PlayerFramework$ImageErrorCode {}
...
declare  class PlayerFramework$TextTrackDisplayMode {
  constructor(...args: empty): mixed;
static +none: Class<PlayerFramework$TextTrackDisplayMode__none> & PlayerFramework$TextTrackDisplayMode__none & 0;// 0
static +custom: Class<PlayerFramework$TextTrackDisplayMode__custom> & PlayerFramework$TextTrackDisplayMode__custom & 1;// 1
static +native: Class<PlayerFramework$TextTrackDisplayMode__native> & PlayerFramework$TextTrackDisplayMode__native & 2;// 2
static +all: Class<PlayerFramework$TextTrackDisplayMode__all> & PlayerFramework$TextTrackDisplayMode__all & 3;// 3

}

declare class PlayerFramework$TextTrackDisplayMode__none mixins PlayerFramework$TextTrackDisplayMode {}
declare class PlayerFramework$TextTrackDisplayMode__custom mixins PlayerFramework$TextTrackDisplayMode {}
declare class PlayerFramework$TextTrackDisplayMode__native mixins PlayerFramework$TextTrackDisplayMode {}
declare class PlayerFramework$TextTrackDisplayMode__all mixins PlayerFramework$TextTrackDisplayMode {}


declare  class PlayerFramework$TextTrackReadyState {
  constructor(...args: empty): mixed;
static +none: Class<PlayerFramework$TextTrackReadyState__none> & PlayerFramework$TextTrackReadyState__none & 0;// 0
static +loading: Class<PlayerFramework$TextTrackReadyState__loading> & PlayerFramework$TextTrackReadyState__loading & 1;// 1
static +loaded: Class<PlayerFramework$TextTrackReadyState__loaded> & PlayerFramework$TextTrackReadyState__loaded & 2;// 2
static +error: Class<PlayerFramework$TextTrackReadyState__error> & PlayerFramework$TextTrackReadyState__error & 3;// 3

}

declare class PlayerFramework$TextTrackReadyState__none mixins PlayerFramework$TextTrackReadyState {}
declare class PlayerFramework$TextTrackReadyState__loading mixins PlayerFramework$TextTrackReadyState {}
declare class PlayerFramework$TextTrackReadyState__loaded mixins PlayerFramework$TextTrackReadyState {}
declare class PlayerFramework$TextTrackReadyState__error mixins PlayerFramework$TextTrackReadyState {}


declare  class PlayerFramework$ViewModelState {
  constructor(...args: empty): mixed;
static +unloaded: Class<PlayerFramework$ViewModelState__unloaded> & PlayerFramework$ViewModelState__unloaded & 0;// 0
static +loading: Class<PlayerFramework$ViewModelState__loading> & PlayerFramework$ViewModelState__loading & 1;// 1
static +paused: Class<PlayerFramework$ViewModelState__paused> & PlayerFramework$ViewModelState__paused & 2;// 2
static +playing: Class<PlayerFramework$ViewModelState__playing> & PlayerFramework$ViewModelState__playing & 3;// 3

}

declare class PlayerFramework$ViewModelState__unloaded mixins PlayerFramework$ViewModelState {}
declare class PlayerFramework$ViewModelState__loading mixins PlayerFramework$ViewModelState {}
declare class PlayerFramework$ViewModelState__paused mixins PlayerFramework$ViewModelState {}
declare class PlayerFramework$ViewModelState__playing mixins PlayerFramework$ViewModelState {}
...
declare class Plugins$PlayTimeTrackingPlugin mixins PlayerFramework$PluginBase {
playTime: number;
playTimePercentage: number
}

declare class Plugins$PositionTrackingPlugin mixins PlayerFramework$PluginBase {
evaluateOnForwardOnly: boolean;
position: number;
positionPercentage: number
}

declare class Plugins$SystemTransportControlsPlugin mixins PlayerFramework$PluginBase {
...
declare class Plugins$CaptionSelectorPlugin mixins PlayerFramework$PluginBase {
hide(): void;
show(): void;
...
declare class Advertising$PrerollAdvertisement mixins Advertising$AdvertisementBase {
source: any
}

declare class Advertising$MidrollAdvertisement mixins Advertising$AdvertisementBase {
source: any;
time: number;
