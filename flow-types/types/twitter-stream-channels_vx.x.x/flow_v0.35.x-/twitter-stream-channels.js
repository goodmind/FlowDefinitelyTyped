declare module 'twitter-stream-channels' {
	...
	declare export interface StreamChannels$Channels {} 

declare export interface StreamChannels$StreamChannelsOptions {
track?: {},
follow?: string,
locations?: string,
...
declare export class TwitterStreamChannels$StreamChannels mixins NodeJS.EventEmitter {

/**
 * @see https://github.com/topheman/twitter-stream-channels/blob/master/lib/StreamChannels.js#L25
 */
constructor(apiClient: Twit, options: TwitterStreamChannels$StreamChannels.StreamChannels$StreamChannelsOptions): this;
 ...
 */
streamChannels(
options: TwitterStreamChannels$TwitterStreamChannels$StreamChannels.StreamChannels$StreamChannelsOptions): TwitterStreamChannels$TwitterStreamChannels$StreamChannels
}
	declare module.exports: typeof TwitterStreamChannels
