declare module "relay-runtime" {
  ...
  declare export interface ConcreteFragment {
    kind: string;
    name: string;
    type: string;
    metadata: {
  ...
  declare export interface ConcreteRequest {
    kind: string;
  ...
  declare export interface ConcreteBatchRequest {
    kind: string;
    operationKind: string;
    name: string;
    metadata: {
  ...
  declare export function getRequest(
   ...
   */
  declare export type SelectorStoreUpdater<T = any> = (
  ...
  declare export type RelayMutationTransactionCommitFailureCallback = (
  ...
  declare export type RelayContainerErrorEventType =
    | "CACHE_RESTORE_FAILED"
    | "NETWORK_QUERY_ERROR";
  declare export type RelayContainerLoadingEventType =
    | "ABORT"
  ...
  declare export type HandlerProvider = (
    name: string
  ...
  declare export class RecordSourceInspector
    mixins RelayRecordSourceInspector {}
  ...
  declare export type ObservableFromValue<T> =
    | RelayObservable<T>
    | Promise<T>
    | T;
  ...
  declare export function requestRelaySubscription(
    environment: Environment,
