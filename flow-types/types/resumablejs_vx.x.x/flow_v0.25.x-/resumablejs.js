...
declare class Resumable$Resumable {
  ...
  on(
    event: "fileSuccess",
    callback: (file: Resumable$ResumableFile) => void
  ): void;
  ...
  on(
    event: "fileAdded",
    callback: (file: Resumable$ResumableFile, event: DragEvent) => void
  ): void;
  ...
  on(
    event: "filesAdded",
    callback: (files: Resumable$ResumableFile[]) => void
  ): void;
  ...
  on(
    event: "fileError",
    callback: (file: Resumable$ResumableFile, message: string) => void
  ): void;
  ...
  on(
    event: "error",
    callback: (message: string, file: Resumable$ResumableFile) => void
  ): void;
  ...
  on(
    ...
    callback: (file: Resumable$ResumableFile, ratio: number) => void
  ): void;
...
declare module "resumablejs" {
  declare module.exports: typeof Resumable$Resumable;
}
