declare interface WebpackServe$Result {
  ...
  on<K: $Keys<WebpackServe$EventMap>>(
    type: K,
    callback: (args: $ElementType<WebpackServe$EventMap, K>) => void
  ): void;
...
declare type WebpackServe$OnOptions = $ObjMapi<
  WebpackServe$EventMap,
  <K>(K) => (args: $ElementType<WebpackServe$EventMap, K>) => void
>;
...
declare module "webpack-serve" {
  ...
  declare function WebpackServe(
    argv: { [key: string]: any },
    options: WebpackServe$WebpackServe$Options
  ): Promise<WebpackServe$WebpackServe$Result>;
