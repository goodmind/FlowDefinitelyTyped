 ...
 */
declare export function compile(template: string, options?: Options): compileTemplate

	
/**
 * Compile a Pug template from a file to a function which can be rendered multiple times with different locals.
 */
declare export function compileFile(path: string, options?: Options): compileTemplate

	
/**
 * Compile a Pug template to a string of JavaScript that can be used client side along with the Pug runtime.
 */
declare export function compileClient(template: string, options?: Options): string
 ...
 */
declare export function compileClientWithDependenciesTracked(template: string, options?: Options): {
body: string,
dependencies: string[]
}
 ...
 */
declare export function compileFileClient(path: string, options?: Options): string

	
/**
 * Compile a Pug template and render it without locals to html string.
 */
declare export function render(template: string): string
 ...
 */
declare export function render(template: string, options: Options & LocalsObject): string
 ...
 */
declare export function render(template: string, callback: (err: Error | null, html: string) => void): void
...
callback: (err: Error | null, html: string) => void): void

	
/**
 * Compile a Pug template from a file and render it without locals to html string.
 */
declare export function renderFile(path: string): string
 ...
 * @param {(Options & LocalsObject)} options Pug Options and rendering locals
 */
declare export function renderFile(path: string, options: Options & LocalsObject): string
 ...
 * @param {((err: Error | null, html: string) => void)} callback Node.js-style callback receiving the rendered results. This callback is called synchronously.
 */
declare export function renderFile(path: string, callback: (err: Error | null, html: string) => void): void
 ...
 */
declare export type compileTemplate = (locals?: LocalsObject) => string;
	
/**
 * An object that can have multiple properties of any type.
 */
declare export interface LocalsObject {
[propName: string]: any
} 
    }
