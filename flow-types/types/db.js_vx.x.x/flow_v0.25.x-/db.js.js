declare module "DbJs" {
  ...
  declare type KeysQuery<T> = {} & DescableQuery<T> &
    ExecutableQuery<T> &
    FilterableQuery<T> &
    DistinctableQuery<T> &
    MappableQuery<T>;
  ...
  declare type FilterQuery<T> = {} & KeyableQuery<T> &
    ExecutableQuery<T> &
    FilterableQuery<T> &
    DescableQuery<T> &
    DistinctableQuery<T> &
  ...
  declare type DescQuery<T> = {} & KeyableQuery<T> &
    CountableQuery<T> &
    ExecutableQuery<T> &
    FilterableQuery<T> &
    DescableQuery<T> &
  ...
  declare type DistinctQuery<T> = {} & KeyableQuery<T> &
    ExecutableQuery<T> &
    FilterableQuery<T> &
    DescableQuery<T> &
    ModifiableQuery<T> &
  ...
  declare type Query<T> = {} & Promise<T> &
    KeyableQuery<T> &
    ExecutableQuery<T> &
    FilterableQuery<T> &
    DescableQuery<T> &
  ...
  declare type Server = DbJs.IndexAccessibleServer &
