declare module 'react-native-permissions' {
        declare export type Status = "authorized" | "denied" | "restricted" | "undetermined";
	declare export interface Rationale {
title: string,
message: string
} 
	declare export type CheckOptions = string | {
type: string
};
	declare export type RequestOptions = string | {
type: string,
rationale?: Rationale
};
...
checkMultiple: (permissions: string[]) => Promise<{
[key: string]: string
}>
} 
