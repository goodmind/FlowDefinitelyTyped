 ...
 */
declare function client$load(name: "youtubeanalytics", version: "v1"): PromiseLike<void>


declare function client$load(name: "youtubeanalytics", version: "v1", callback: () => any): void
