declare module 'webpack-bundle-analyzer' {
	...
	declare type BundleAnalyzerPlugin$ExcludeAssetsPatternFn = (assetName: string) => boolean;

declare type BundleAnalyzerPlugin$ExcludeAssetsPattern = string | RegExp | BundleAnalyzerPlugin$ExcludeAssetsPatternFn;

declare interface BundleAnalyzerPlugin$Options {
 ...
 */
excludeAssets?: null | BundleAnalyzerPlugin$ExcludeAssetsPattern | BundleAnalyzerPlugin$ExcludeAssetsPattern[],
...
logLevel?: "info" | "warn" | "error" | "silent"
	...
	declare export class BundleAnalyzerPlugin mixins webpack.Plugin {
constructor(options?: BundleAnalyzerPlugin$BundleAnalyzerPlugin$Options): this
}
    }
