...
callback: (err: Error | null, stats: Stat) => void): void

	declare function pidusage(
pids: Array<number | string>,
callback: (err: Error | null, stats: {
[key: string]: Stat
}) => void): void
...
[key: string]: Stat
	...
	declare function pidusage(pid: number | string, options?: {
[key: string]: any
}): Promise<Stat>
...
[key: string]: Stat
      ...
      declare var npm$namespace$pidusage: {
        clear: typeof pidusage$clear,
        
      }
declare type pidusage$Status = Stat;
