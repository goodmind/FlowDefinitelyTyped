declare module 'session-file-store' {
	...
	declare function f(
options: (options?: session.SessionOptions) => express.RequestHandler): f$f$FileStore

	declare interface f$FileStore {
new (options?: f$Options): session.Store
} 
