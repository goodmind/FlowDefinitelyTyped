...
translate(translation: Vector3, relativeTo?: Transform$Transform$Space): Transform;
rotate(
x: number,
y: number,
z: number,
relativeTo?: Transform$Transform$Space): Transform
}
	declare  class Transform$Space {
  constructor(...args: empty): mixed;
static +Self: Class<Transform$Space__Self> & Transform$Space__Self & 0;// 0
static +World: Class<Transform$Space__World> & Transform$Space__World & 1;// 1

}

declare class Transform$Space__Self mixins Transform$Space {}
declare class Transform$Space__World mixins Transform$Space {}
