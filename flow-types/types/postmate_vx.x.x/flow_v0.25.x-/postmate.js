declare module "postmate" {
   ...
   */
  declare class Postmate mixins Promise<Postmate$ParentAPI> {
    /**
     ...
     */
    constructor(options: Postmate$PostmateOptions): this;
  }
  declare var Postmate: typeof npm$namespace$Postmate;

  declare var npm$namespace$Postmate: {
    Model: typeof Postmate$Model
  };

  /**
   * Options passed to the Postmate constructor
   */
  declare interface Postmate$PostmateOptions {
    /**
   ...
   */
  declare interface Postmate$ParentAPI {
    /**
   ...
   */
  declare interface Postmate$ChildAPI {
    /**
   ...
   */
  declare class Postmate$Model mixins Promise<Postmate$ChildAPI> {
    /**
  ...
  declare export default typeof Postmate;
}
