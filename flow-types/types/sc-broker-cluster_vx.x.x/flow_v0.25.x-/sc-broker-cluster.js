declare module "sc-broker-cluster" {
  import type { SCServerSocket, SCServer } from "socketcluster-server";

  import type { BrokerStartInfo, BrokerExitInfo } from "socketcluster";

  import type { SpliceOptions, QueryOptions } from "sc-broker";
  ...
  import type { Keys } from "expirymanager";

  import type { ClientCluster } from "./clientcluster";
  ...
  declare export type mapperFunction = (
    keyChain: KeyChain,
    method: string,
    clientIds: number[]
  ) => number | number[];
