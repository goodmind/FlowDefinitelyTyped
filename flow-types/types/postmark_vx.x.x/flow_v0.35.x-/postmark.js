...
declare type Postmark$PostmarkCallback<T: {[key: string]: any}> = ((e: Postmark$PostmarkError, ret: T) => void) | void;
...
callback?: Postmark$PostmarkCallback) => any
...
callback: Postmark$PostmarkCallback<Postmark$SendStatus>): void;
sendEmailWithTemplate(message: Postmark$PostmarkMessageWithTemplate): Promise<Postmark$SendStatus>;
...
message: Postmark$PostmarkMessage,
callback: Postmark$PostmarkCallback<Postmark$SendStatus>): void;
sendEmailBatch(message: Postmark$PostmarkMessage[]): Promise<Postmark$SendStatus[]>;
sendEmailBatch(
message: Postmark$PostmarkMessage[],
callback: Postmark$PostmarkCallback<Postmark$SendStatus[]>): void;
getDeliveryStatistics(): Promise<Postmark$DeliveryStats>;
getDeliveryStatistics(callback: Postmark$PostmarkCallback<Postmark$DeliveryStats>): void;
getBounces(filter: Postmark$BounceFilter): Promise<Postmark$BouncesResult>;
getBounces(
filter: Postmark$BounceFilter,
callback?: Postmark$PostmarkCallback<Postmark$BouncesResult>): void;
getBounce(id: number): Promise<Postmark$Bounce>;
getBounce(id: number, callback?: Postmark$PostmarkCallback<Postmark$Bounce>): void;
getBounceDump(id: number): Promise<Postmark$BounceDump>;
getBounceDump(id: number, callback?: Postmark$PostmarkCallback<Postmark$BounceDump>): void;
activateBounce(id: number): Promise<Postmark$ActivatedBounceResult>;
activateBounce(
id: number,
callback?: Postmark$PostmarkCallback<Postmark$ActivatedBounceResult>): void;
...
callback?: Postmark$PostmarkCallback<Postmark$Server>): void;
getOutboundMessages(
filter: Postmark$OutboundMessageFilter): Promise<Postmark$OutboundMessagesResult>;
getOutboundMessages(
filter: Postmark$OutboundMessageFilter,
callback?: Postmark$PostmarkCallback<Postmark$OutboundMessagesResult>): void;
getOutboundMessageDetails(id: number): Promise<Postmark$OutboundMessage>;
getOutboundMessageDetails(
id: number,
callback?: Postmark$PostmarkCallback<Postmark$OutboundMessage>): void;
getMessageOpens(filter: Postmark$OpenMessageFilter): Promise<Postmark$MessageOpensResult>;
getMessageOpens(
filter: Postmark$OpenMessageFilter,
callback?: Postmark$PostmarkCallback<Postmark$MessageOpensResult>): void;
getMessageOpensForSingleMessage(id: number, filter: Postmark$Filter): Promise<Postmark$MessageOpensResult>;
getMessageOpensForSingleMessage(
id: number,
filter: Postmark$Filter,
callback?: Postmark$PostmarkCallback<Postmark$MessageOpensResult>): void;
getInboundMessages(filter: Postmark$InboundMessageFilter): Promise<Postmark$InboundMessagesResult>;
getInboundMessages(
filter: Postmark$InboundMessageFilter,
callback?: Postmark$PostmarkCallback<Postmark$InboundMessagesResult>): void;
getInboundMessageDetails(id: number): Promise<Postmark$InboundMessage>;
getInboundMessageDetails(
id: number,
callback?: Postmark$PostmarkCallback<Postmark$InboundMessage>): void;
bypassBlockedInboundMessage(id: number): Promise<Postmark$GenericResult>;
bypassBlockedInboundMessage(id: number, callback?: Postmark$PostmarkCallback<Postmark$GenericResult>): void;
getOuboundOverview(filter: Postmark$BaseFilter): Promise<Postmark$OutboundOverview>;
getOuboundOverview(
filter: Postmark$BaseFilter,
callback?: Postmark$PostmarkCallback<Postmark$OutboundOverview>): void;
retryInboundHookForMessage(id: number): Promise<Postmark$GenericResult>;
retryInboundHookForMessage(id: number, callback?: Postmark$PostmarkCallback<Postmark$GenericResult>): void;
getTemplate(id: number): Promise<Postmark$Template>;
getTemplate(id: number, callback?: Postmark$PostmarkCallback<Postmark$Template>): void;
createTemplate(template: $Shape<Postmark$Template>): Promise<Postmark$TemplateBase>;
createTemplate(
template: $Shape<Postmark$Template>,
callback?: Postmark$PostmarkCallback<Postmark$TemplateBase>): void;
editTemplate(template: $Shape<Postmark$Template>): Promise<Postmark$TemplateBase>;
editTemplate(
template: $Shape<Postmark$Template>,
callback?: Postmark$PostmarkCallback<Postmark$TemplateBase>): void;
...
getTemplates(
filter: Postmark$Filter,
callback?: Postmark$PostmarkCallback<Postmark$TemplatesResult>): void;
deleteTemplate(id: number): Promise<Postmark$GenericResult>;
deleteTemplate(id: number, callback?: Postmark$PostmarkCallback<Postmark$GenericResult>): void;
validateTemplate<T: {[key: string]: any}>(
templateObject: Postmark$TemplateValidator<T>): Promise<Postmark$TemplateValidationResult<T>>;
validateTemplate<T: {[key: string]: any}>(
templateObject: Postmark$TemplateValidator<T>,
callback?: Postmark$PostmarkCallback<Postmark$TemplateValidationResult<T>>): void
}
...
listSenderSignatures(query: Postmark$Filter): Promise<Postmark$SenderSignaturesResults>;
listSenderSignatures(
query: Postmark$Filter,
callback?: Postmark$PostmarkCallback<Postmark$SenderSignaturesResults>): void;
createSenderSignature(options: Postmark$CreateSignature): Promise<Postmark$SenderSignature>;
createSenderSignature(
options: Postmark$CreateSignature,
callback?: Postmark$PostmarkCallback<Postmark$SenderSignature>): void;
editSenderSignature(
id: number,
options: Postmark$UpdateSignature): Promise<Postmark$SenderSignature>;
editSenderSignature(
id: number,
options: Postmark$UpdateSignature,
callback?: Postmark$PostmarkCallback<Postmark$SenderSignature>): void;
deleteSenderSignature(id: number): Promise<Postmark$GenericResult>;
deleteSenderSignature(id: number, callback?: Postmark$PostmarkCallback<Postmark$GenericResult>): void;
resendSenderSignatureConfirmation(id: number): Promise<Postmark$GenericResult>;
resendSenderSignatureConfirmation(id: number, callback?: Postmark$PostmarkCallback<Postmark$GenericResult>): void;
verifySenderSignatureSPF(id: number): Promise<Postmark$SenderSignature>;
verifySenderSignatureSPF(
id: number,
callback?: Postmark$PostmarkCallback<Postmark$SenderSignature>): void;
requestNewDKIMForSenderSignature(id: number): Promise<Postmark$GenericResult>;
requestNewDKIMForSenderSignature(id: number, callback?: Postmark$PostmarkCallback<Postmark$GenericResult>): void;
getServer(id: number): Promise<Postmark$Server>;
getServer(id: number, callback?: Postmark$PostmarkCallback<Postmark$Server>): void;
createServer(options: Postmark$CreateServer): Promise<Postmark$Server>;
createServer(
options: Postmark$CreateServer,
callback?: Postmark$PostmarkCallback<Postmark$Server>): void;
editServer(id: number, options: $Shape<Postmark$CreateServer>): Promise<Postmark$Server>;
editServer(
id: number,
options: $Shape<Postmark$CreateServer>,
callback?: Postmark$PostmarkCallback<Postmark$Server>): void;
deleteServer(id: number): Promise<Postmark$GenericResult>;
deleteServer(id: number, callback?: Postmark$PostmarkCallback<Postmark$GenericResult>): void;
listServers(query: Postmark$ServerFilter): Promise<Postmark$ServersResult>;
listServers(
query: Postmark$ServerFilter,
callback?: Postmark$PostmarkCallback<Postmark$ServersResult>): void;
listDomains(query: Postmark$Filter): Promise<Postmark$DomainsResult>;
listDomains(
query: Postmark$Filter,
callback?: Postmark$PostmarkCallback<Postmark$DomainsResult>): void;
getDomain(id: number): Promise<Postmark$Domain>;
getDomain(id: number, callback?: Postmark$PostmarkCallback<Postmark$Domain>): void;
createDomain(options: Postmark$CreateDomain): Promise<Postmark$Domain>;
createDomain(
options: Postmark$CreateDomain,
callback?: Postmark$PostmarkCallback<Postmark$Domain>): void;
editDomain(id: number, options: $Shape<Postmark$CreateDomain>): Promise<Postmark$Domain>;
editDomain(
id: number,
options: $Shape<Postmark$CreateDomain>,
callback?: Postmark$PostmarkCallback<Postmark$Domain>): void;
deleteDomain(id: number): Promise<Postmark$GenericResult>;
deleteDomain(id: number, callback?: Postmark$PostmarkCallback<Postmark$GenericResult>): void;
...
rotateDKIMForDomain(
id: number,
callback?: Postmark$PostmarkCallback<Postmark$RotateDKIMResult>): void
}
...
new (apiKey: string, options: $Shape<Postmark$Options>): Postmark$AdminClient
} 
...
declare interface Postmark$TemplateValidationResult<T: {[key: string]: any}> {
...
} & Postmark$SPFRecord & Postmark$DKIMKey


declare type Postmark$SenderSignature = {
ReturnPathDomainVerified: boolean
} & Postmark$SenderSignatureBase & Postmark$VerificationDetails
...
declare type Postmark$Domain = {} & Postmark$DomainBase & Postmark$VerificationDetails
...
apiKey: string,
options: $Shape<Postmark$Postmark.Postmark$Options>): Postmark$Postmark.Postmark$Client
