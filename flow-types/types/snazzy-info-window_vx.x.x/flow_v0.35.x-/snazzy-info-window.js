declare module 'snazzy-info-window' {
        declare type SnazzyInfoWindow$PlacementOptions = "top" | "bottom" | "left" | "right";

declare interface SnazzyInfoWindow$Offset {
top?: string,
bottom?: string,
left?: string,
right?: string
...
declare interface SnazzyInfoWindow$EdgeOffset {
top?: number,
bottom?: number,
left?: number,
right?: number
...
declare interface SnazzyInfoWindow$Border {
width: string,
color?: string
} 

declare interface SnazzyInfoWindow$Shadow {
h?: string,
v?: string,
blur?: string,
spread?: string,
...
declare interface SnazzyInfoWindow$Callbacks {
...
declare interface SnazzyInfoWindow$InfoWindowOptions {
 ...
 */
placement?: SnazzyInfoWindow$PlacementOptions,
...
constructor(opts: SnazzyInfoWindow$SnazzyInfoWindow$InfoWindowOptions): this;
