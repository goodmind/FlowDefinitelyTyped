declare module 'amqp' {
	...
	declare export type Callback<T> = (value: T) => void;
	declare export type AMQPClient = {
publish(
routingKey: string,
body: any,
options: {},
callback: (err?: boolean, msg?: string) => void): void,
disconnect(): void,
queue(queueName: string, callback?: Callback<QueueCallback>): AMQPQueue,
queue(
queueName: string,
options: QueueOptions,
callback?: Callback<QueueCallback>): AMQPQueue,
exchange(callback?: Callback<void>): AMQPExchange,
exchange(exchangeName: string, callback?: Callback<void>): AMQPExchange,
exchange(
exchangeName: string,
options: ExchangeOptions,
callback?: Callback<void>): AMQPExchange
} & net.Socket

	declare export type AMQPQueue = {
...
destroy(options?: DestroyOptions): void
	...
	declare export type AMQPExchange = {
on(
event: "open"
| "ack"
| "error"
...
bind_headers(exchange: string, routing: string, callback?: Callback<void>): void
	...
	declare export function createConnection(options: ConnectionOptions): AMQPClient

	declare export interface DeliveryInfo {
contentType: string,
consumerTag: string,
...
closeChannelOnUnsubscribe?: boolean
	...
	declare export interface ExchangeOptions {
...
deliveryKeyInPayload?: boolean
	...
	declare export interface DestroyOptions {
...
ifEmpty?: boolean
	...
	declare export type SubscribeCallback = (
message: any,
headers: {
[key: string]: any
},
...
ack: Ack) => void;
	declare export interface QueueCallback {
name: string,
...
channel: number
	...
	declare export interface ExchangePublishOptions {
