...
setFormState(state: FormState): void
	...
	declare export type ValidateValuesFunction = (values: FormValues) => FormErrors;
...
componentWillReceiveProps(nextProps: $ReadOnly<$Shape<FormProps>>, nextContext: any): void;
componentWillUmount(): void;
render(): RenderReturn
}
	declare export var NestedForm: React.StatelessComponent<FieldProps>;
	declare export function FormField(component: React.ComponentType<any>): React.ComponentClass<any>
...
placeholder?: string
	...
	declare export var Text: React.StatelessComponent<FieldProps & React.InputHTMLAttributes<HTMLInputElement>>;
	declare export var TextArea: React.StatelessComponent<FieldProps & React.TextareaHTMLAttributes<HTMLTextAreaElement>>;
	declare export interface RadioGroupContext {
group: FieldApi
} 
	declare export class RadioGroup mixins React.Component<FieldProps & {
...
group: FieldApi
	...
	declare export var Radio: React.StatelessComponent<FieldProps & React.InputHTMLAttributes<HTMLInputElement> & {
group: FieldApi
}>;
	declare export var Checkbox: React.StatelessComponent<FieldProps & React.InputHTMLAttributes<HTMLInputElement>>;
...
touchValidation?: boolean
	...
	declare export var StyledCheckbox: React.StatelessComponent<StyledProps & React.InputHTMLAttributes<HTMLInputElement> & {
label: string
}>;
	declare export var StyledTextArea: React.StatelessComponent<StyledProps & React.TextareaHTMLAttributes<HTMLTextAreaElement>>;
	declare export var StyledSelect: React.StatelessComponent<StyledProps & SelectProps & React.InputHTMLAttributes<HTMLSelectElement>>;
	declare export var StyledText: React.StatelessComponent<StyledProps & React.InputHTMLAttributes<HTMLInputElement>>;
	declare export var StyledRadio: React.StatelessComponent<StyledProps & React.InputHTMLAttributes<HTMLInputElement> & {
group: FieldApi,
label: string
}>;
	declare export class StyledRadioGroup mixins React.Component<StyledProps & {
children?: ((props: FieldApi) => RenderReturn) | RenderReturn
}>, React.ChildContextProvider<RadioGroupContext> {
getChildContext(): {
group: FieldApi
