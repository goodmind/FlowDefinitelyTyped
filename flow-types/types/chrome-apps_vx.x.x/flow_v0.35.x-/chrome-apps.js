 ...
 */
declare type chrome$IDict<T, K, F> = F;

declare type chrome$ToStringLiteral<C: Object, K, V> = chrome$IDict<C, V>;
...
declare type accessibilityFeatures$LevelOfControl = "not_controllable" | "controlled_by_other_extensions" | "controllable_by_this_extension" | "controlled_by_this_extension";
...
declare type accessibilityFeatures$Scope = "regular" | "regular_only" | "incognito_persistent" | "incognito_session_only";
...
callback: (details: accessibilityFeatures$AccessibilityFeaturesCallbackArg) => void): void,
...
declare type alarms$AlarmEvent = {} & undefined.events$Event<(alarm: alarms$Alarm) => void>
 ...
 * @param alarmInfo Describes when the alarm should fire. The initial time must be specified by either when or delayInMinutes (but not both). If periodInMinutes is set, the alarm will repeat every periodInMinutes minutes after the initial event. If neither when or delayInMinutes is set for a repeating alarm, periodInMinutes is used as the default for delayInMinutes.
 */
declare function alarms$create(name: string, alarmInfo: alarms$AlarmCreateInfo): void
 ...
 */
declare function alarms$getAll(callback: (alarms: alarms$Alarm[]) => void): void
 ...
 */
declare function alarms$clearAll(callback?: (wasCleared: boolean) => void): void
 ...
 * @example function(boolean wasCleared) {...};
 */
declare function alarms$clear(name?: string, callback?: (wasCleared: boolean) => void): void
 ...
 * @example function( Alarm alarm) {...};
 */
declare function alarms$get(name: string, callback: (alarm: alarms$Alarm) => void): void
 ...
 */
declare var runtime$onEmbedRequested: chrome$events.events$Event<(permissions$request: AppView$AppView$EmbedRequest) => void>;


/**
 * Fired when an app is launched from the launcher.
 */
declare var runtime$onLaunched: chrome$events.events$Event<(launchData: runtime$LaunchData) => void>;
...
minHeight: chrome$integer | null | void): void,
...
maxHeight: chrome$integer | null | void): void,
...
callback?: (created_window: app$AppWindow) => void): void,
...
declare type audio$DeviceType = "HEADPHONE"
| "MIC"
| "USB"
| "BLUETOOTH"
| "HDMI"
...
filter: audio$Filter,
callback: (devices: audio$AudioDeviceInfo[]) => void): void


declare function audio$getDevices(callback: (devices: audio$AudioDeviceInfo[]) => void): void
 ...
 */
declare function audio$setDevices(ids: audio$DeviceIdLists[] | string[], callback: () => void): void
 ...
 */
declare function audio$setProperties(id: string, properties: audio$SetDeviceProperties, callback: () => void): void
 ...
 */
declare function audio$getMute(streamType: audio$StreamType, callback: (value: boolean) => void): void
 ...
 */
declare function audio$setMute(streamType: audio$StreamType, isMuted: boolean, callback?: () => void): void
 ...
 */
declare var audio$onLevelChanged: chrome$events.events$Event<(deviceId: string, level: chrome$integer) => void>;
 ...
 */
declare var audio$onMuteChanged: chrome$events.events$Event<(streamType: audio$StreamType[], isMuted: boolean) => void>;
 ...
 */
declare var audio$onDeviceListChanged: chrome$events.events$Event<(devices: audio$AudioDeviceInfo[]) => void>;
...
declare type bluetooth$DeviceType = "HEADPHONE"
| "MIC"
| "USB"
| "BLUETOOTH"
| "HDMI"
 ...
 */
declare function bluetooth$getAdapterState(callback: (adapterInfo: bluetooth$AdapterState) => void): void
 ...
 */
declare function bluetooth$getDevice(deviceAddress: string, callback: (deviceInfo: bluetooth$Device) => void): void
 ...
 */
declare function bluetooth$getDevices(callback: (devices: bluetooth$Device[]) => void): void
...
callback: (devices: bluetooth$Device[]) => void): void
...
declare type bluetoothLowEnergy$CharacteristicProperties = "broadcast"
| "read"
...
declare type bluetoothLowEnergy$DescriptorPermissions = "read"
| "write"
| "encryptedRead"
| "encryptedWrite"
...
declare type bluetoothLowEnergy$AdvertisementType = "broadcast" | "peripheral";
 ...
 */
declare function bluetoothLowEnergy$connect(deviceAddress: string, callback: () => void): void
 ...
 */
declare function bluetoothLowEnergy$disconnect(deviceAddress: string, callback?: () => void): void
...
serviceId: string,
callback: (result: bluetoothLowEnergy$Service) => void): void
 ...
 */
declare function bluetoothLowEnergy$createService(service: bluetoothLowEnergy$Service, callback: () => void): void
...
callback: (result: bluetoothLowEnergy$Characteristic) => void): void
...
characteristic: bluetoothLowEnergy$Characteristic,
serviceId: string,
callback: (characteristicId: string) => void): void
...
descriptorId: string,
callback: (result: bluetoothLowEnergy$Descriptor) => void): void
...
characteristicId: string,
callback: (descriptorId: string) => void): void
 ...
 */
declare function bluetoothLowEnergy$writeCharacteristicValue(characteristicId: string, value: ArrayBuffer, callback: () => void): void
 ...
 */
declare function bluetoothLowEnergy$startCharacteristicNotifications(characteristicId: string, callback: () => void): void
 ...
 */
declare function bluetoothLowEnergy$stopCharacteristicNotifications(characteristicId: string, callback?: () => void): void
 ...
 * @param callback Called when the write request has completed.
 */
declare function bluetoothLowEnergy$writeDescriptorValue(descriptorId: string, value: ArrayBuffer, callback: () => void): void
 ...
 */
declare function bluetoothLowEnergy$registerService(serviceId: string, callback: (result: any) => void): void
 ...
 * @param callback Callback with the result of the register operation.
 */
declare function bluetoothLowEnergy$unregisterService(serviceId: string, callback: (result: any) => void): void
 ...
 */
declare function bluetoothLowEnergy$removeService(serviceId: string, callback?: () => void): void
...
callback: (advertisementId: chrome$integer) => void): void
 ...
 */
declare function bluetoothLowEnergy$unregisterAdvertisement(advertisementId: chrome$integer, callback: () => void): void
 ...
 */
declare function bluetoothLowEnergy$resetAdvertising(callback: () => void): void
 ...
 */
declare function bluetoothLowEnergy$sendRequestResponse(response: bluetoothLowEnergy$IResponse): void
 ...
 */
declare var bluetoothLowEnergy$onServiceAdded: chrome$events.events$Event<(service: bluetoothLowEnergy$Service) => void>;
 ...
 */
declare var bluetoothLowEnergy$onServiceChanged: chrome$events.events$Event<(service: bluetoothLowEnergy$Service) => void>;


/**
 * Fired when a GATT service that was previously discovered on a remote device has been removed.
 */
declare var bluetoothLowEnergy$onServiceRemoved: chrome$events.events$Event<(service: bluetoothLowEnergy$Service) => void>;
 ...
 */
declare var bluetoothLowEnergy$onCharacteristicValueChanged: chrome$events.events$Event<(characteristic: bluetoothLowEnergy$Characteristic) => void>;
 ...
 */
declare var bluetoothLowEnergy$onDescriptorValueChanged: chrome$events.events$Event<(descriptor: bluetoothLowEnergy$Descriptor) => void>;
 ...
 * @since Chrome 52.
 */
declare var bluetoothLowEnergy$onCharacteristicReadRequest: chrome$events.events$Event<(characteristic: bluetoothLowEnergy$Characteristic) => void>;
 ...
 * @since Chrome 52.
 */
declare var bluetoothLowEnergy$onCharacteristicWriteRequest: chrome$events.events$Event<(characteristic: bluetoothLowEnergy$Characteristic) => void>;
 ...
 * @since Chrome 52.
 */
declare var bluetoothLowEnergy$onDescriptorReadRequest: chrome$events.events$Event<(descriptor: bluetoothLowEnergy$Descriptor) => void>;
 ...
 * The peripheral permission may not be available to all apps.
 */
declare var bluetoothLowEnergy$onDescriptorWriteRequest: chrome$events.events$Event<(descriptor: bluetoothLowEnergy$Descriptor) => void>;
...
declare type bluetoothSocket$OnAcceptErrorCode = "system_error" | "not_listening";
...
declare type bluetoothSocket$OnReceiveErrorCode = "disconnected" | "system_error" | "not_connected";
...
declare type bluetoothSocket$OnAcceptEvent = {} & undefined.events$Event<(info: bluetoothSocket$OnAcceptInfoData) => void>


declare type bluetoothSocket$OnAcceptErrorEvent = {} & undefined.events$Event<(info: bluetoothSocket$OnAcceptErrorEventData) => void>


declare type bluetoothSocket$OnReceiveEvent = {} & undefined.events$Event<(info: bluetoothSocket$OnReceiveEventData) => void>


declare type bluetoothSocket$OnReceiveErrorEvent = {} & undefined.events$Event<(info: bluetoothSocket$OnReceiveErrorEventData) => void>
 ...
 */
declare function bluetoothSocket$create(callback: (createInfo: bluetoothSocket$CreateInfo) => void): void
...
callback: (createInfo: bluetoothSocket$CreateInfo) => void): void
 ...
 */
declare function bluetoothSocket$setPaused(socketId: chrome$integer, paused: boolean, callback?: () => void): void
 ...
 */
declare function bluetoothSocket$listenUsingRfcomm(socketId: chrome$integer, uuid: string, callback: () => void): void
 ...
 * @param callback Called when listen operation completes.
 */
declare function bluetoothSocket$listenUsingL2cap(socketId: chrome$integer, uuid: string, callback: () => void): void
 ...
 */
declare function bluetoothSocket$disconnect(socketId: chrome$integer, callback?: () => void): void
 ...
 */
declare function bluetoothSocket$close(socketId: chrome$integer, callback: () => void): void
...
socketId: chrome$integer,
data: ArrayBuffer,
callback?: (bytesSent: chrome$integer) => void): void
...
socketId: chrome$integer,
callback: (socketInfo: bluetoothSocket$SocketInfo) => void): void
 ...
 */
declare function bluetoothSocket$getSockets(callback: (sockets: bluetoothSocket$SocketInfo[]) => void): void
 ...
 */
declare function browser$openTab(options: browser$Options, callback: () => void): void
 ...
 * Hash type
 */
declare type certificateProvider$Hash = "MD5_SHA1"
| "SHA1"
| "SHA256"
| "SHA384"
| "SHA512";
...
callback: (details?: certificateProvider$PinResponseDetails) => void): void
 ...
 */
declare function certificateProvider$stopPinRequest(details: certificateProvider$StopRequestPinDetails, callback: () => void): void
...
callback: (rejectedCertificates: ArrayBuffer[]) => void) => any>;
...
signCallback: (signature?: ArrayBuffer) => void) => any>;
 ...
 */
declare var clipboard$onClipboardDataChanged: chrome$events.events$Event<() => void>;
...
declare type commands$CommandEvent = {} & undefined.events$Event<(command: string) => void>
 ...
 */
declare function commands$getAll(callback: (commands: commands$Command[]) => void): void
...
declare type contextMenus$MenuClickedEvent = {} & undefined.events$Event<(info: contextMenus$OnClickData) => void>
 ...
 */
declare function contextMenus$create(createProperties: contextMenus$CreateProperties, callback?: () => void): void
 ...
 */
declare function contextMenus$remove(menuItemId: chrome$integer | string, callback?: () => void): void
...
callback: (streamId: string) => void): chrome$integer
 ...
 */
declare function desktopCapture$cancelChooseDesktopMedia(desktopMediaRequestId: chrome$integer): void
 ...
 */
declare function diagnostics$sendPacket(options: Object, callback: () => void): void
...
hostname: string,
callback: (resolveInfo: dns$ResolveCallbackResolveInfo) => void): void
...
callback: (result: documentScan$DocumentScanCallbackArg) => void): void
 ...
 */
declare function deviceAttributes$getDirectoryDeviceId(callback: (deviceId: string) => void): void
 ...
 */
declare function deviceAttributes$getDeviceSerialNumber(callback: (serialNumber: string) => void): void
 ...
 */
declare function deviceAttributes$getDeviceAssetId(callback: (assetId: string) => void): void
 ...
 */
declare function deviceAttributes$getDeviceAnnotatedLocation(callback: (annotatedLocation: string) => void): void
 ...
 */
declare function platformKeys$getTokens(callback: (tokens: platformKeys$Token[]) => void): void
 ...
 */
declare function platformKeys$getCertificates(tokenId: string, callback: (certificates: ArrayBuffer[]) => void): void
 ...
 */
declare function platformKeys$importCertificate(tokenId: string, certificate: ArrayBuffer, callback: () => void): void
 ...
 * @param callback Called back when this operation is finished.
 */
declare function platformKeys$removeCertificate(tokenId: string, certificate: ArrayBuffer, callback: () => void): void
 ...
 */
declare function platformKeys$challengeMachineKey(challenge: ArrayBuffer, callback: (response: ArrayBuffer) => void): void
...
registerKey: boolean,
callback: (response: ArrayBuffer) => void): void
 ...
 */
declare type events$FilteredEvent<T: Function, F> = {
 ...
 */
declare interface events$Rule<T: {[key: string]: any}, K: {[key: string]: any}> {
 ...
 */
declare type extensionTypes$ImageDetails = extensionTypes$ImageDetailsJpeg | extensionTypes$ImageDetailsPng;
...
declare type fileBrowserHandler$FileBrowserHandleExecuteId = "ReadOnly" | "ReadWrite";
...
callback: (result: fileBrowserHandler$SelectionResult) => void): void
...
declare type fileSystem$ChooseEntryOptions = fileSystem$ChooseFileEntryOptions
 ...
 * @private
 */
declare type fileSystem$FileEntryCallback<T: fileSystem$ChooseEntryOptions, E> = (selectedEntries: E) => void;
...
callback: (displayPath: string) => void): void
 ...
 */
declare function fileSystem$getWritableEntry<T: FileEntry | DirectoryEntry>(entry: T, callback: (entry: T) => void): void
...
entry: FileEntry | DirectoryEntry,
callback: (isWritable: boolean) => void): void
...
callback: fileSystem$FileEntryCallback<fileSystem$ChooseFileEntryOptions>): void
...
callback: fileSystem$FileEntryCallback<fileSystem$ChooseEntryOptionsBase>): void
...
callback: fileSystem$FileEntryCallback<fileSystem$ChooseSaveFileEntryOptions>): void


declare function fileSystem$chooseEntry(
options: fileSystem$ChooseMultipleFilesEntryOptions,
callback: fileSystem$FileEntryCallback<fileSystem$ChooseMultipleFilesEntryOptions>): void


declare function fileSystem$chooseEntry(
options: fileSystem$ChooseDirectoryEntryOptions,
callback: fileSystem$FileEntryCallback<fileSystem$ChooseDirectoryEntryOptions>): void
 ...
 */
declare function fileSystem$restoreEntry(id: string, callback: (entry: FileEntry) => void): void
 ...
 * @since Chrome 29.
 */
declare function fileSystem$isRestorable(id: string, callback: (fileSystem$isRestorable: boolean) => void): void
 ...
 * @since Chrome 29.
 */
declare function fileSystem$retainEntry(entry: FileEntry | DirectoryEntry): string
 ...
 * @since Chrome 44.
 */
declare function fileSystem$requestFileSystem(options: fileSystem$Volume, callback: (fileSystem: FileSystem) => void): void
 ...
 * @since Chrome 44.
 */
declare function fileSystem$getVolumeList(callback: (volumes: fileSystem$Volume[]) => void): void
 ...
 * @since Chrome 44.
 */
declare var fileSystem$onVolumeListChanged: chrome$events.events$Event<(object: fileSystem$Volume[]) => void>;
 ...
 */
declare function fileSystemProvider$mount(options: fileSystemProvider$MountOptions, callback?: () => void): void
 ...
 * @param callback A generic result callback to indicate success or failure.
 */
declare function fileSystemProvider$unmount(options: fileSystemProvider$UnmountOptions, callback?: () => void): void
 ...
 */
declare function fileSystemProvider$getAll(callback: (fileSystems: fileSystemProvider$FileSystemInfo[]) => void): void
...
fileSystemId: string,
callback: (fileSystem: fileSystemProvider$FileSystemInfo) => void): void
 ...
 * @since Chrome 45.
 */
declare function fileSystemProvider$notify(options: fileSystemProvider$NotificationOptions, callback: () => void): void
...
errorCallback: (error: chrome$ToStringLiteral<typeof ProviderError>) => void) => void>;
...
successCallback: (entries: fileSystemProvider$EntryMetadata[], hasMore: boolean) => void,
errorCallback: (error: chrome$ToStringLiteral<typeof ProviderError>) => void) => void>;
...
declare type gcm$DisallowedKeys = "collapse_key"
| "goog"
| "goog."
| "GOOG"
| "GOOG."
...
declare type gcm$IGCMDataSend = Record<Exclude<gcm$DisallowedKeys, string>, any>;
 ...
 */
declare function gcm$register(senderIds: string[], callback: (registrationId: string) => void): void
 ...
 */
declare function gcm$send(message: gcm$OutgoingMessage, callback: (messageId: string) => void): void
 ...
 */
declare var gcm$onMessage: chrome$events.events$Event<(message: gcm$IncomingMessage) => void>;
 ...
 */
declare var gcm$onSendError: chrome$events.events$Event<(error: gcm$GcmError) => void>;
...
callback: (devices: hid$HidDeviceInfo[]) => void): void
 ...
 */
declare function hid$getUserSelectedDevices(callback: (devices: hid$HidDeviceInfo) => void): void
 ...
 * @param callback
 */
declare function hid$disconnect(connectionId: chrome$integer, callback?: () => void): void
...
connectionId: chrome$integer,
callback: (reportId: chrome$integer, data: ArrayBuffer) => void): void
...
connectionId: chrome$integer,
reportId: chrome$integer,
callback: (data: ArrayBuffer) => void): void
 ...
 */
declare var hid$onDeviceAdded: chrome$events.events$Event<(device: hid$HidDeviceInfo) => void>;
 ...
 */
declare var hid$onDeviceRemoved: chrome$events.events$Event<(deviceId: chrome$integer) => void>;
 ...
 */
declare type i18n$kLanguageInfoTable = "af"
| "am"
| "an"
| "ar"
| "ast"
 ...
 */
declare type i18n$StringSubstitutions = [string]
| [string, string]
 ...
 */
declare function i18n$getAcceptLanguages(callback: (languages: i18n$LanguageCode[]) => void): void
 ...
 */
declare function i18n$getMessage(messageName: string, substitutions?: i18n$StringSubstitutions): string | void
 ...
 * @since Chrome 47.
 */
declare function i18n$detectLanguage(text: string, callback: (result: i18n$LanguageDetectionResult) => void): void
 ...
 */
declare function identity$getAccounts(callback: (accounts: identity$AccountInfo[]) => void): void
 ...
 */
declare function identity$getAuthToken(details: identity$TokenDetails, callback?: (token: string) => void): void
 ...
 * @since Chrome 37.
 */
declare function identity$getProfileUserInfo(callback: (userInfo: identity$UserInfo) => void): void
 ...
 */
declare function identity$removeCachedAuthToken(details: identity$TokenInformation, callback?: () => void): void
 ...
 * @since Chrome 33.
 */
declare var identity$onSignInChanged: chrome$events.events$Event<(account: identity$AccountInfo, signedIn: boolean) => void>;
...
callback: (newState: idle$IdleState) => void): void
 ...
 */
declare function idle$setDetectionInterval(intervalInSeconds: chrome$integer): void
 ...
 */
declare var idle$onStateChanged: chrome$events.events$Event<(newState: idle$IdleState) => void>;
 ...
 */
declare function instanceID$getID(callback: (instanceId: string) => void): void
 ...
 */
declare function instanceID$getCreationTime(callback: (creationTime: chrome$integer) => void): void
 ...
 */
declare function instanceID$deleteToken(deleteTokenParams: instanceID$DeleteTokenParams, callback: () => void): void
 ...
 */
declare function management$getPermissionWarningsByManifest(manifestStr: string, callback?: (permissionWarnings: string[]) => void): void
 ...
 */
declare function management$getSelf(callback?: (result: management$ExtensionInfo) => void): void
 ...
 * @param callback
 */
declare function management$uninstallSelf(options?: management$UninstallOptions, callback?: () => void): void
 ...
 */
declare var mdns$onServiceList: chrome$events.events$FilteredEvent<(services: mdns$Service[]) => void, mdns$ServiceTypes>;
...
declare type mediaGalleries$MetadataOptionsType = "all" | "mimeTypeAndTags" | "mimeTypeOnly";
...
declare type mediaGalleries$GalleryChangedType = "contents_changed" | "watch_dropped";
...
declare type mediaGalleries$ScanProgressType = "start" | "cancel" | "finish" | "error";
 ...
 */
declare function mediaGalleries$getMediaFileSystems(callback: (mediaFileSystems: FileSystem[]) => void): void
...
callback: (mediaFileSystems: FileSystem[]) => void): void
...
callback: (mediaFileSystems: FileSystem[], selectedFileSystemName: string) => void): void
 ...
 */
declare function mediaGalleries$dropPermissionForMediaFileSystem(galleryId: string, callback?: () => void): void
 ...
 */
declare function mediaGalleries$addScanResults(callback: (mediaFileSystems: FileSystem[]) => void): void
 ...
 * @since Chrome 26.
 */
declare function mediaGalleries$getMediaFileSystemMetadata(mediaFileSystem: FileSystem): mediaGalleries$MediaFileSystemMetadata
 ...
 */
declare function mediaGalleries$getAllMediaFileSystemMetadata(callback: (metadatas: mediaGalleries$MediaFileSystemMetadata[]) => void): void
 ...
 * @since Chrome 38.
 */
declare function mediaGalleries$getMetadata(mediaFile: Blob, callback: (metadata: mediaGalleries$Metadata) => void): void
...
callback: (metadata: mediaGalleries$Metadata) => void): void
...
galleryId: string,
callback: (result: mediaGalleries$GalleryWatchResult) => void): void
 ...
 */
declare function mediaGalleries$getAllGalleryWatch(callback: (galleryIds: string[]) => void): void
 ...
 * @since Chrome 38.
 */
declare var mediaGalleries$onGalleryChanged: chrome$events.events$Event<(args: mediaGalleries$GalleryChangedEventArgs) => void>;
 ...
 */
declare var mediaGalleries$onScanProgress: chrome$events.events$Event<(args: mediaGalleries$ScanProgressEventArgs) => void>;
...
networks: Array<config$NetworkInfoFilterHexSSID | config$NetworkInfoFilterSSID>,
callback: () => void): void
 ...
 */
declare var config$onCaptivePortalDetected: chrome$events.events$Event<(networkInfo: config$NetworkInfo) => void>;
...
declare type onc$ActivationStateType = "Activated" | "Activating" | "NotActivated" | "PartiallyActivated";

declare type onc$CaptivePortalStatus = "Unknown"
| "Offline"
| "Online"
| "Portal"
| "ProxyAuthRequired";

declare type onc$ConnectionStateType = "Connected" | "Connecting" | "NotConnected";

declare type onc$IPConfigType = "DHCP" | "Static";

declare type onc$NetworkType = "All"
| "Cellular"
| "Ethernet"
| "VPN"
| "Wireless"
...
declare interface _internal_$NetworkConfigBase<M: onc$ManagedObject, IF: onc$InterfaceType, OF: _internal_$ObjectFunction> {
...
declare type onc$ManagedIPConfigType = {} & onc$ManagedType<onc$IPConfigType[]>
...
declare interface onc$IPConfigProperties<M: onc$ManagedObject, B, S, SL, L> {
...
declare interface onc$ManualProxySettings<M, P> {
...
declare interface onc$ProxySettings<M, S, SL> {
...
declare type onc$CellularProperties<M: onc$ManagedObject> = {
...
declare interface onc$EthernetProperties<M: onc$ManagedObject> {
...
declare interface onc$VPNProperties<M: onc$ManagedObject, B, S> {
...
declare interface onc$WiFiPropertiesBase<M: onc$ManagedObject, S> {
...
declare type onc$WiFiProperties<M: onc$ManagedObject, OF: _internal_$_internal_$ObjectFunction, B, S, L> = {
...
declare interface onc$WiMAXProperties<M: onc$ManagedObject, B> {
...
declare type onc$NetworkConfigProperties<OF: _internal_$_internal_$ObjectFunction> = {} & _internal_$_internal_$NetworkConfigBase<"unmanaged", "full", OF>


declare type onc$NetworkProperties<M: onc$ManagedObject, IF: onc$InterfaceType> = {
...
declare type onc$NetworkStateProperties = {} & onc$NetworkProperties<"unmanaged", "partial">
...
declare type onc$DeviceState = "Uninitialized"
| "Disabled"
| "Enabling"
| "Enabled"
| "Prohibited";
 ...
 */
declare function onc$getProperties(networkGuid: string, callback: (result: onc$NetworkProperties) => void): void
 ...
 */
declare function onc$getManagedProperties(networkGuid: string, callback: (result: onc$ManagedProperties) => void): void
...
networkGuid: string,
callback: (result: onc$NetworkStateProperties) => void): void
 ...
 * @param callback Called when the operation has completed.
 */
declare function onc$forgetNetwork(networkGuid: string, callback?: () => void): void
 ...
 */
declare function onc$getDeviceStates(callback: (result: onc$DeviceStates[]) => void): void
...
Otherwise returns the GUID of the new network.
 */
declare function onc$startConnect(networkGuid: string, callback?: () => void): void
 ...
 */
declare function onc$startDisconnect(networkGuid: string, callback?: () => void): void
 ...
 */
declare function onc$getCaptivePortalStatus(networkGuid: string, callback: (result: onc$CaptivePortalStatus) => void): void
 ...
 */
declare function onc$getGlobalPolicy(callback: (result: onc$GlobalPolicy) => void): void
 ...
 */
declare var onc$onNetworksChanged: chrome$events.events$Event<(changes: string[]) => void>;


/**
 * Fired when the list of networks has changed. Sends a complete list of GUIDs for all the current networks.
 */
declare var onc$onNetworkListChanged: chrome$events.events$Event<(changes: string[]) => void>;


/**
 * Fired when the list of devices has changed or any device state properties have changed.
 */
declare var onc$onDeviceStateListChanged: chrome$events.events$Event<() => void>;
 ...
 */
declare var onc$onPortalDetectionCompleted: chrome$events.events$Event<(networkGuid: string, status: onc$CaptivePortalStatus) => void>;
 ...
 */
declare var notifications$onClosed: chrome$events.events$Event<(notificationId: string, byUser: boolean) => void>;


/**
 * The user clicked in a non-button area of the notification.
 */
declare var notifications$onClicked: chrome$events.events$Event<(notificationId: string) => void>;


/**
 * The user pressed a button in the notification.
 */
declare var notifications$onButtonClicked: chrome$events.events$Event<(notificationId: string, buttonIndex: chrome$integer) => void>;
 ...
 * @since Chrome 32.
 */
declare var notifications$onPermissionLevelChanged: chrome$events.events$Event<(level: string) => void>;
 ...
 */
declare var notifications$onShowSettings: chrome$events.events$Event<() => void>;
...
callback?: (wasUpdated: boolean) => void): void
 ...
 * @param callback Called to indicate whether a matching notification existed.
 */
declare function notifications$clear(notificationId: string, callback?: (wasCleared: boolean) => void): void
 ...
 */
declare function notifications$getAll(callback: (notifications: {
...
callback: (level: chrome$ToStringLiteral<typeof PermissionLevel>) => void): void
...
declare type permissions$PermissionEvent = {} & undefined.events$Event<(permissions: permissions$Permissions) => void>
 ...
 */
declare function permissions$getAll(callback: (permissions: permissions$Permissions) => void): void
...
permissions: permissions$Permissions,
callback?: (removed: boolean) => void): void
...
callback: (matches: platformKeys$Match[]) => void): void
...
callback: (result: platformKeys$VerificationResult) => void): void
 ...
 */
declare function power$requestKeepAwake(level: chrome$ToStringLiteral<typeof Level>): void
 ...
 */
declare var printerProvider$onGetPrintersRequested: chrome$events.events$Event<(resultCallback: (printerInfo: printerProvider$PrinterInfo[]) => void) => void>;
...
device: any,
resultCallback: (printerInfo?: printerProvider$PrinterInfo) => void) => void>;
...
printerId: string,
resultCallback: (capabilities: printerProvider$PrinterCapabilities) => void) => void>;
...
resultCallback: (result: string) => void) => void>;
 ...
 * An object which allows the addition and removal of listeners for a Chrome event.
 */
gcm$onMessage: chrome$events.events$Event<(message: any, port: runtime$Port) => void>,
name: string
} 
...
declare type runtime$UrlMatches = "https://www.google-analytics.com/*"
...
declare type runtime$ChromeOSOnlyPermissions = "certificateProvider"
| "clipboard"
| "dns"
| "documentScan"
...
declare type runtime$DevOnly = "app.window.alpha" | "diagnostics" | "displaySource" | "signedInDevices";

declare type runtime$KioskOnlyPermissions = "audio" | "networking.onc" | "system.powerSource" | "virtualKeyboard";


/**
 * Undocumented but used permissions
 */
declare type runtime$UndocumentedPermissions = "app.window.ime" | "fullscreen" | "overrideEscFullscreen";

declare type runtime$NotAllowedAsOptionalPermissions = "debugger"
| "experimental"
| "geolocation"
| "mdns"
| "proxy"
 ...
 */
declare type runtime$OptionalPermission = Exclude<runtime$Permission, runtime$NotAllowedAsOptionalPermissions>;

declare type runtime$Permission = "alarms"
| "appview"
| "audio"
| "alwaysOnTopWindows"
...
type: "array",
runtime$id?: string,
items: runtime$JSONSchemaBasicType | runtime$JSONSchemaObjectType | runtime$JSONSchemaRefType
} 
 ...
 */
properties?: {
[key: string]: runtime$JSONSchemaBasicType | runtime$JSONSchemaArrayType | runtime$JSONSchemaObjectType | runtime$JSONSchemaRefType
}
} 
...
declare type runtime$AutomationOptions = boolean | runtime$AutomationDesktop | runtime$AutomationNonInteractive;
 ...
 */
optional_permissions?: runtime$OptionalPermission[] | Array<runtime$OptionalPermission | chrome$runtime.runtime$UrlMatches[]> | Array<runtime$OptionalPermission | chrome$runtime.runtime$UrlMatches[] | string>,
...
declare type runtime$Manifest = runtime$ValidKioskManifest | runtime$ValidNonKioskManifest | runtime$InvalidManifest;
 ...
 * @since Chrome 26.
 */
declare function runtime$connect(connectInfo?: runtime$ConnectInfo): runtime$Port
 ...
 */
declare function runtime$connect(extensionId: string, connectInfo?: runtime$ConnectInfo): runtime$Port
 ...
 */
declare function runtime$getBackgroundPage(callback: (backgroundPage?: Window) => void): void
 ...
 * @since Chrome 29.
 */
declare function runtime$getPackageDirectoryEntry(callback: (directoryEntry: DirectoryEntry) => void): void
 ...
 */
declare function runtime$getPlatformInfo(callback: (platformInfo: runtime$PlatformInfo) => void): void
...
details?: runtime$UpdateCheckDetails) => void): void
 ...
 */
declare function runtime$sendMessage(message: any, responseCallback?: (response: any) => void): void
 ...
 */
declare function runtime$setUninstallURL(url: string, callback?: () => void): void
...
declare type runtime$ExtensionConnectEvent = {} & undefined.events$Event<(port: runtime$Port) => void>
 ...
 */
declare var runtime$onInstalled: chrome$events.events$Event<(details: runtime$InstalledDetails) => void>;
 ...
 * @since Chrome 29.
 */
declare var runtime$onRestartRequired: chrome$events.events$Event<(reason: chrome$ToStringLiteral<typeof OnRestartRequiredReason>) => void>;
 ...
 * @since Chrome 25.
 */
declare var runtime$onUpdateAvailable: chrome$events.events$Event<(details: runtime$UpdateAvailableDetails) => void>;
...
declare type signedInDevices$OS = "win"
| "mac"
| "linux"
| "chrome_os"
| "android"
...
declare type signedInDevices$DeviceType = "HEADPHONE"
| "MIC"
| "USB"
| "BLUETOOTH"
| "HDMI"
...
isLocal: boolean,
callback: (devices: signedInDevices$DeviceInfo[]) => void): void
 ...
 * @param callback The callback to be invoked with the array of DeviceInfo objects.
 */
declare function signedInDevices$get(callback: (devices: signedInDevices$DeviceInfo[]) => void): void
 ...
 */
declare var signedInDevices$onDeviceInfoChange: chrome$events.events$Event<(devices: signedInDevices$DeviceInfo[]) => void>;
 ...
 */
declare function tcp$create(callback: (createInfo: sockets$CreateInfo) => void): void
...
callback: (createInfo: sockets$CreateInfo) => void): void
 ...
 */
declare function tcp$setPaused(socketId: chrome$integer, paused: boolean, callback?: () => void): void
...
socketId: chrome$integer,
enable: boolean,
callback: (result: chrome$integer) => void): void
 ...
 * @param callback Called when the disconnect attempt is complete.
 */
declare function tcp$disconnect(socketId: chrome$integer, callback?: () => void): void
 ...
 */
declare function tcp$secure(socketId: chrome$integer, callback: (result: chrome$integer) => void): void
...
socketId: chrome$integer,
data: ArrayBuffer,
callback: (sendInfo: sockets$SendInfo) => void): void
 ...
 * @param callback Called when the close operation completes.
 */
declare function tcp$close(socketId: chrome$integer, callback?: () => void): void
...
socketId: chrome$integer,
callback: (socketInfo: sockets$SocketInfo) => void): void
 ...
 */
declare function tcp$getSockets(callback: (socketInfos: sockets$SocketInfo[]) => void): void
 ...
 * Event raised when data has been received for a given socket.
 */
declare var tcp$onReceive: chrome$events.events$Event<(args: sockets$ReceiveEventArgs) => void>;
 ...
 */
declare var tcp$onReceiveError: chrome$events.events$Event<(args: sockets$ReceiveErrorEventArgs) => void>;
 ...
 * @param callback Called when the socket has been created.
 */
declare function tcpServer$create(callback: (createInfo: sockets$CreateInfo) => void): void
 ...
 * @param callback Callback from the setPaused method.
 */
declare function tcpServer$setPaused(socketId: chrome$integer, paused: boolean, callback?: () => void): void
 ...
 * @param callback Called when the disconnect attempt is complete.
 */
declare function tcpServer$disconnect(socketId: chrome$integer, callback?: () => void): void
 ...
 * @param callback Called when the close operation completes.
 */
declare function tcpServer$close(socketId: chrome$integer, callback?: () => void): void
...
socketId: chrome$integer,
callback: (socketInfo: tcpServer$SocketInfo) => void): void
 ...
 * @param callback Called when the list of sockets is available.
 */
declare function tcpServer$getSockets(callback: (socketInfos: tcpServer$SocketInfo[]) => void): void
 ...
 */
declare var tcpServer$onAccept: chrome$events.events$Event<(args: sockets$AcceptEventArgs) => void>;
 ...
 */
declare var tcpServer$onAcceptError: chrome$events.events$Event<(args: sockets$AcceptErrorEventArgs) => void>;
 ...
 */
declare function udp$create(callback: (createInfo: sockets$CreateInfo) => void): void
...
unpaused.
 */
declare function udp$setPaused(socketId: chrome$integer, paused: boolean, callback?: () => void): void
 ...
 * @param callback Called when the close operation completes.
 */
declare function udp$close(socketId: chrome$integer, callback?: () => void): void
 ...
 * @param callback Called when the list of sockets is available.
 */
declare function udp$getSockets(callback: (socketInfos: tcpServer$SocketInfo[]) => void): void
 ...
 */
declare function udp$getJoinedGroups(socketId: chrome$integer, callback: (groups: string[]) => void): void
 ...
 */
declare var udp$onReceive: chrome$events.events$Event<(args: sockets$ReceiveEventArgs) => void>;
 ...
 */
declare var udp$onReceiveError: chrome$events.events$Event<(args: sockets$ReceiveErrorEventArgs) => void>;
...
callback: (bytesInUse: chrome$integer) => void): void
} 
...
declare type storage$StorageArea = {} & storage$StorageAreaRead & storage$StorageAreaWrite
...
areaName: storage$StorageAreas) => void>;
 ...
 */
declare function syncFileSystem$requestFileSystem(callback: (fileSystem: FileSystem) => void): void
...
callback: (policy: chrome$ToStringLiteral<typeof ConflictResolutionPolicy>) => void): void
...
fileEntry: FileEntry,
callback: (status: chrome$ToStringLiteral<typeof FileStatus>) => void): void
...
callback: (status: syncFileSystem$FileStatusInfo[]) => void): void
 ...
 * @see ServiceStatus
 */
declare function syncFileSystem$getServiceStatus(callback: (status: chrome$ToStringLiteral<typeof ServiceStatus>) => void): void
 ...
 */
declare var syncFileSystem$onFileStatusChanged: chrome$events.events$Event<(detail: syncFileSystem$FileStatusChangedDetail) => void>;
 ...
 */
declare function display$getInfo(callback: (info: display$DisplayInfo[]) => void): void
...
callback: (info: display$DisplayInfo[]) => void): void
 ...
 * @param callback The callback to invoke with the results.
 */
declare function display$getDisplayLayout(callback: (layouts: display$DisplayLayout[]) => void): void
 ...
 */
declare function display$setDisplayLayout(layouts: display$DisplayLayout[], callback?: () => void): void
 ...
 */
declare function display$overscanCalibrationAdjust(runtime$id: string, delta: display$Insets): void
 ...
 * @param id The display's unique identifier.
 */
declare function display$overscanCalibrationComplete(runtime$id: string): void
 ...
 */
declare function display$showNativeTouchCalibration(runtime$id: string, callback: (success: boolean) => void): void
 ...
 * @param id The display's unique identifier.
 */
declare function display$startCustomTouchCalibration(runtime$id: string): void
 ...
 * @throws Error
 */
declare function display$completeCustomTouchCalibration(pairs: display$TouchCalibrationPairs, bounds: display$Bounds): void
 ...
 */
declare function memory$getInfo(callback: (info: memory$MemoryInfo) => void): void
 ...
 */
declare function network$getNetworkInterfaces(callback: (networkInterfaces: network$NetworkInterface[]) => void): void
...
static +unknown: Class<powerSource$PowerSourceType__unknown> & powerSource$PowerSourceType__unknown & "unknown";// "unknown"
static +mains: Class<powerSource$PowerSourceType__mains> & powerSource$PowerSourceType__mains & "mains";// "mains"
static +usb: Class<powerSource$PowerSourceType__usb> & powerSource$PowerSourceType__usb & "usb";// "usb"

}

declare class powerSource$PowerSourceType__unknown mixins powerSource$PowerSourceType {}
declare class powerSource$PowerSourceType__mains mixins powerSource$PowerSourceType {}
declare class powerSource$PowerSourceType__usb mixins powerSource$PowerSourceType {}
 ...
 */
declare function powerSource$getPowerSourceInfo(callback: (powerSourceInfo?: powerSource$PowerSourceInfo[]) => void): void
 ...
 */
declare var powerSource$onPowerChanged: chrome$events.events$Event<(powerSourceInfo: powerSource$PowerSourceInfo[]) => void>;
 ...
 */
declare function storage$getInfo(callback: (info: storage$StorageUnitInfo[]) => void): void
...
runtime$id: string,
callback: (result: chrome$ToStringLiteral<typeof EjectDeviceResultCode>) => void): void
...
runtime$id: string,
callback: (info: storage$StorageCapacityInfo) => void): void
 ...
 */
declare var storage$onAttached: chrome$events.events$Event<(info: storage$StorageUnitInfo) => void>;


/**
 * Fired when a removable storage is detached from the system.
 */
declare var storage$onDetached: chrome$events.events$Event<(runtime$id: string) => void>;
 ...
 */
declare function tts$getVoices(callback?: (voices: tts$TtsVoice[]) => void): void
 ...
 * @param callback Called right away, before speech finishes. Check chrome.runtime.lastError to make sure there were no errors. Use options.onEvent to get more detailed feedback.
 */
declare function tts$speak(utterance: string, options: tts$SpeakOptions, callback?: Function): void
 ...
 */
declare type types$ChromeSettingScope = "regular" | "regular_only" | "incognito_persistent" | "incognito_session_only";
 ...
 */
declare type types$DetailsCallback = (details: types$ChromeSettingGetResultDetails) => void;
 ...
 * @param details Which setting to consider.
 */
get(details: types$ChromeSettingGetDetails, callback?: types$DetailsCallback): void,
 ...
 * @param callback Called at the completion of the clear operation.
 */
clear(details: types$ChromeSettingClearDetails, callback?: () => void): void,
...
callback: (devices: usb$Device[]) => void): void
 ...
 * @param callback
 */
declare function usb$getConfigurations(device: usb$Device, callback: (configs: usb$ConfigDescriptor[]) => void): void
 ...
 * @param callback
 */
declare function usb$openDevice(device: usb$Device, callback: (handle: usb$ConnectionHandle) => void): void
...
callback: (handles: usb$ConnectionHandle[]) => void): void
 ...
 * @param callback
 */
declare function usb$closeDevice(handle: usb$ConnectionHandle, callback?: () => void): void
...
handle: usb$ConnectionHandle,
callback: (config: usb$ConfigDescriptor) => void): void
...
handle: usb$ConnectionHandle,
callback: (descriptors: usb$InterfaceDescriptor[]) => void): void
...
callback: (info: usb$TransferResultInfo) => void): void
 ...
 * @param callback
 */
declare function usb$resetDevice(handle: usb$ConnectionHandle, callback: (success: boolean) => void): void


declare type usb$DeviceEvent = {} & undefined.events$Event<(device: usb$Device) => void>
...
callback?: (udp$update: virtualKeyboard$FeatureRestrictions) => void): void
 ...
 */
declare function vpnProvider$createConfig(name: string, callback: (runtime$id: string) => void): void
 ...
 */
declare function vpnProvider$destroyConfig(runtime$id: string, callback?: () => void): void
 ...
 */
declare function vpnProvider$setParameters(parameters: vpnProvider$VpnSessionParameters, callback: () => void): void
 ...
 */
declare function vpnProvider$sendPacket(data: ArrayBuffer, callback?: () => void): void
 ...
 */
declare var vpnProvider$onPacketReceived: chrome$events.events$Event<(data: ArrayBuffer) => void>;


/**
 * Triggered when a configuration created by the extension is removed by the platform.
 */
declare var vpnProvider$onConfigRemoved: chrome$events.events$Event<(runtime$id: string) => void>;


/**
 * Triggered when a configuration is created by the platform for the extension.
 */
declare var vpnProvider$onConfigCreated: chrome$events.events$Event<(runtime$id: string, name: string, data: Object) => void>;
 ...
 */
declare var vpnProvider$onUIEvent: chrome$events.events$Event<(event: chrome$ToStringLiteral<typeof UIEvent>, runtime$id?: string) => void>;
...
declare  class wallpaper$WallpaperLayout {
  constructor(...args: empty): mixed;
static +STRETCH: Class<wallpaper$WallpaperLayout__STRETCH> & wallpaper$WallpaperLayout__STRETCH & "STRETCH";// "STRETCH"
static +CENTER: Class<wallpaper$WallpaperLayout__CENTER> & wallpaper$WallpaperLayout__CENTER & "CENTER";// "CENTER"
static +CENTER_CROPPED: Class<wallpaper$WallpaperLayout__CENTER_CROPPED> & wallpaper$WallpaperLayout__CENTER_CROPPED & "CENTER_CROPPED";// "CENTER_CROPPED"

}

declare class wallpaper$WallpaperLayout__STRETCH mixins wallpaper$WallpaperLayout {}
declare class wallpaper$WallpaperLayout__CENTER mixins wallpaper$WallpaperLayout {}
declare class wallpaper$WallpaperLayout__CENTER_CROPPED mixins wallpaper$WallpaperLayout {}


declare type wallpaper$WallpaperLayoutType = "STRETCH" | "CENTER" | "CENTER_CROPPED";
...
callback: (thumbnail?: string) => void): void
...
declare type webViewRequest$Stage = "onBeforeRequest" | "onBeforeSendHeaders" | "onHeadersReceived" | "onAuthRequired";

declare type webViewRequest$DeclarativeWebRequestEventList = "declarativeContent.onBeforeRequest"
...
declare type webViewRequest$DeclarativeWebRequestConditionsList = "declarativeContent.PageStateMatcher";

declare type webViewRequest$DeclarativeWebRequestActionsList = "declarativeWebRequest.AddRequestCookie"
...
constructor(parameters: webViewRequest$AddCookie<webViewRequest$RequestCookie>): this;
instanceType: string
}
...
constructor(parameters: webViewRequest$AddCookie<webViewRequest$ResponseCookie>): this;
instanceType: string
}
...
Attributes that are set to an empty string are removed.
 */
constructor(parameters: webViewRequest$EditCookieParams<webViewRequest$RequestCookie, webViewRequest$RequestCookie>): this;
instanceType: string
}
 ...
 * @param modification
 */
constructor(parameter: webViewRequest$EditCookieParams<webViewRequest$FilterResponseCookie, webViewRequest$ResponseCookie>): this;
instanceType: string
}
...
constructor(parameters: webViewRequest$RemoveCookieParams<webViewRequest$RequestCookie>): this;
instanceType: string
}
...
constructor(parameters: webViewRequest$RemoveCookieParams<webViewRequest$FilterResponseCookie>): this;
instanceType: string
}
 ...
 * Supported actions
 */
declare type webViewRequest$OnRequestActions = webViewRequest$AddRequestCookie
 ...
 */
declare type webViewRequest$OnRequestRule = {} & undefined.events$Rule<webViewRequest$OnRequestConditions, webViewRequest$OnRequestActions>
...
callback?: (rules: webViewRequest$OnRequestRule[]) => void): void,
 ...
 */
declare type webViewRequest$OnMessageEvent = {} & undefined.events$Event<(details: webViewRequest$OnMessageEventDetails) => void>
 ...
 * @since Chrome 44.
 */
addContentScripts(contentScriptList: WebView$WebView$ContentScriptDetails[]): void;
...
callback?: (results?: WebView$WebView$FindCallbackResults) => void): void;
 ...
 * @since Chrome 43.
 */
getZoomMode(callback: (WebView$ZoomMode: WebView$WebView$ZoomMode) => void): void;
 ...
 */
insertCSS(details: WebView$WebView$InjectDetails, callback?: () => void): void;
 ...
 * @since Chrome 43.
 */
setZoomMode(WebView$ZoomMode: WebView$WebView$ZoomMode, callback?: () => void): void;
 ...
 */
onconsolemessage: ((ev: WebView$Events.Events$ConsoleMessageEvent) => any) | null;
 ...
 */
onloadredirect: ((ev: WebView$Events.Events$LoadRedirectEvent) => any) | null;
 ...
 */
onpermissionrequest: ((ev: WebView$Events.Events$PermissionRequestEvent) => any) | null;
 ...
 */
onunresponsive: ((ev: WebView$Events.Events$UnresponsiveEvent) => any) | null;
...
type: K,
listener: (ev: $ElementType<WebView$Events.Events$WebViewElementEventMap, K>) => any,
 ...
 */
declare type Events$LoadAbortReason = "ERR_ABORTED"
| "ERR_INVALID_URL"
 ...
 */
declare type Events$ExitEventReason = "normal" | "abnormal" | "crash" | "kill";
 ...
 */
declare type Events$WindowOpenDisposition = "ignore"
| "save_to_disk"
| "current_tab"
| "new_background_tab"
| "new_foreground_tab"
...
declare type Events$RequestedPermission = "media"
| "geolocation"
| "pointerLock"
| "download"
| "loadplugin"
 ...
 */
declare type WebView$ContextType = "all"
| "page"
| "frame"
| "selection"
| "link"
 ...
 * @param callback
 */
create(createProperties: {[key: string]: any}, callback?: () => void): void,
 ...
 * @param callback
 */
remove(menuItemId: chrome$chrome$integer | string, callback?: () => void): void,
...
declare type WebView$WebRequestFullDetails = {} & WebView$WebRequestHeadersDetails & WebView$WebRequestBodyDetails
...
filter?: WebView$RequestFilter,
opt_extraInfoSpec?: string[]): void
} & undefined.chrome$Event<(details: WebView$WebRequestHeadersDetails) => void>


declare type WebView$_WebResponseHeadersEvent<T: WebView$WebResponseHeadersDetails> = {
addListener(
...
callback?: (response: WebView$BlockingResponse) => void) => void,
filter?: WebView$RequestFilter,
opt_extraInfoSpec?: string[]): void
