...
static +length: Class<CSSNumericBaseType__length> & CSSNumericBaseType__length & 0;// 0
static +angle: Class<CSSNumericBaseType__angle> & CSSNumericBaseType__angle & 1;// 1
static +time: Class<CSSNumericBaseType__time> & CSSNumericBaseType__time & 2;// 2
static +frequency: Class<CSSNumericBaseType__frequency> & CSSNumericBaseType__frequency & 3;// 3
static +resolution: Class<CSSNumericBaseType__resolution> & CSSNumericBaseType__resolution & 4;// 4
static +flex: Class<CSSNumericBaseType__flex> & CSSNumericBaseType__flex & 5;// 5
static +percent: Class<CSSNumericBaseType__percent> & CSSNumericBaseType__percent & 6;// 6
...
static +product: Class<CSSMathOperator__product> & CSSMathOperator__product & 1;// 1
static +negate: Class<CSSMathOperator__negate> & CSSMathOperator__negate & 2;// 2
static +invert: Class<CSSMathOperator__invert> & CSSMathOperator__invert & 3;// 3
...
constructor(x: CSSNumericValue, y: CSSNumericValue, z?: CSSNumericValue): this;
x: CSSNumericValue;
y: CSSNumericValue;
z: CSSNumericValue
}
...
constructor(x: CSSNumberish, y: CSSNumberish, z: CSSNumberish, angle: CSSNumericValue): this;
x: CSSNumberish;
y: CSSNumberish;
z: CSSNumberish;
...
constructor(matrix: DOMMatrixReadOnly, options?: CSSMatrixComponentOptions): this;
matrix: DOMMatrix
}
