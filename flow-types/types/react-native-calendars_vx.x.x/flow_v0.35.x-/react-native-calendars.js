...
"stylesheet.day.period"?: CalendarThemeIdStyle
	...
	declare export type TCalendarDate = Date
| DateObject
| number
| string
| XDate;
...
disabled?: boolean
	...
	declare export type Marking = CustomMarking
| DotMarking
| MultiDotMarking
| MultiPeriodMarking
| PeriodMarking;
...
[date: string]: PeriodMarking
	...
	declare export type CalendarMarkingProps = MultiDotMarkingProps
| DotMarkingProps
| PeriodMarkingProps
...
theme?: CalendarTheme
	...
	declare export class Calendar mixins React.Component<CalendarMarkingProps & CalendarBaseProps> {}
...
selected?: string
	...
	declare export class CalendarList mixins React.Component<CalendarMarkingProps & CalendarListBaseProps> {}
...
theme?: AgendaThemeStyle
	...
	declare export class Agenda<TItem> mixins React.Component<AgendaProps<TItem> & CalendarMarkingProps> {}
    }
