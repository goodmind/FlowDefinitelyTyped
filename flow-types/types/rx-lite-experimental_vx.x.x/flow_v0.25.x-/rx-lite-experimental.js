 ...
 */
   ...
   */
  forkJoin<T>(sources: Array<Rx$Observable<T>>): Rx$Observable<T[]>;
  forkJoin<T>(sources: Array<IPromise<T>>): Rx$Observable<T[]>;
   ...
   * @returns An observable sequence with an array collecting the last elements of all the input sequences.
   */
  forkJoin<T>(...args: Array<Rx$Observable<T>>): Rx$Observable<T[]>;
  forkJoin<T>(...args: Array<IPromise<T>>): Rx$Observable<T[]>;
}
