 ...
 */
declare export interface FormatLocaleDefinition {
 ...
 */
declare export interface FormatLocaleObject {
 ...
 */
declare export interface FormatSpecifier {
 ...
 */
declare export function formatLocale(locale: FormatLocaleDefinition): FormatLocaleObject
 ...
 */
declare export function formatDefaultLocale(defaultLocale: FormatLocaleDefinition): FormatLocaleObject
 ...
 * @throws Error on invalid format specifier.
 */
declare export function format(specifier: string): (n: number | {
valueOf(): number
}) => string
 ...
 * @throws Error on invalid format specifier.
 */
declare export function formatPrefix(
specifier: string,
value: number): (n: number | {
valueOf(): number
}) => string
 ...
 * @throws Error on invalid format specifier.
 */
declare export function formatSpecifier(specifier: string): FormatSpecifier
 ...
 */
declare export function precisionFixed(step: number): number
 ...
 */
declare export function precisionPrefix(step: number, value: number): number
 ...
 */
declare export function precisionRound(step: number, max: number): number
