declare module 'react-native-autocomplete-input' {
	...
	import type {
          GestureResponderHandlers,ListViewProperties,StyleProp,TextInputProperties,ViewStyle
        } from 'react-native';
 ...
 */
onStartShouldSetResponderCapture?: $ElementType<GestureResponderHandlers, "onStartShouldSetResponderCapture">,
...
renderTextInput(props: TextInputProperties): ReactNode
	...
	declare export default class Autocomplete<T> mixins Component<AutocompleteProps<T>> {}
    }
