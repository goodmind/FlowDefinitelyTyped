 ...
 */
declare export function expect<T>(value: T | T[], prefix?: string): AssertionChain<T>
 ...
 */
declare export function incomplete(): string[] | null

	
/**
 * Returns the filename, line number, and column number of where the error was created.
 */
declare export function thrownAt(error?: Error): CodeError
...
declare export var settings: Settings;
	declare export type AssertionChain<T> = Assertion<T> & Expectation<T>;
	declare export type Assertion<T> = Grammar<T> & Flags<T>;
	declare export type Expectation<T> = Types<T> & Values<T>;
	declare export interface Grammar<T> {
...
to: AssertionChain<T>
	...
	declare export interface Flags<T> {
...
shallow: AssertionChain<T>
	...
	declare export interface Types<T> {
...
object(): AssertionChain<T>
	...
	declare export interface Values<T> {
...
comparePrototypes?: boolean
	...
	declare export interface CodeError {
filename: string,
line: string,
column: string
} 
