...
declare type NodeSpriteGenerator$BuiltinStylesheetFormats = "stylus"
| "less"
| "sass"
| "scss"
| "css"
...
declare type NodeSpriteGenerator$BuiltinLayouts = "packed" | "vertical" | "horizontal" | "diagonal";

declare type NodeSpriteGenerator$BuiltinCompositors = "canvas" | "gm" | "jimp";
...
declare type NodeSpriteGenerator$CompositorFilters = "all"
| "none"
| "sub"
| "up"
| "average"
...
readImages(
files: string[],
callback: (error: Error, images: NodeSpriteGenerator$Image[]) => void): void,
render(
...
callback: (error: Error, layout: NodeSpriteGenerator$Layout) => void) => void;
...
spritePath?: string,
stylesheetPath?: string,
stylesheet?: NodeSpriteGenerator$BuiltinStylesheetFormats | NodeSpriteGenerator$StylesheetFunc | string,
stylesheetOptions?: NodeSpriteGenerator$StylesheetOption,
layout?: NodeSpriteGenerator$BuiltinLayouts | NodeSpriteGenerator$LayoutFunc,
layoutOptions?: NodeSpriteGenerator$LayoutOption,
compositor?: NodeSpriteGenerator$BuiltinCompositors | NodeSpriteGenerator$Compositor,
compositorOptions?: NodeSpriteGenerator$CompositorOption
} 

declare function NodeSpriteGenerator$middleware(option: NodeSpriteGenerator$Option): e.RequestHandler
