...
gcollections?: number
	...
	declare export function iterate(iteratorFn: () => void, options?: IterateOptions): Result
...
declare function iterate$async(iteratorFn: () => Promise<void>, options?: IterateOptions): Promise<Result>
