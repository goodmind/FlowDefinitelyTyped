declare var echarts: typeof npm$namespace$echarts;
...
declare var npm$namespace$echarts: {
  ...
  EChartOption: typeof npm$namespace$echarts$EChartOption
};
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocTypeLiteral"} opts Chart configurations.
 */
 ...
 */
declare function echarts$connect(group: string | echarts$ECharts[]): void;
 ...
 */
declare function echarts$dispose(
  target: echarts$ECharts | HTMLDivElement | HTMLCanvasElement
): void;
 ...
 */
declare function echarts$getInstanceByDom(
 ...
 * component or
 * [map](https://echarts.apache.org/option.html#series-map).
 * @param {{[key: string]: any}} geoJson Data in GeoJson format. See
 * [http://geojson.org/](http://geojson.org/) for more format information.
 * @param {{[key: string]: any}} specialAreas Zoomed part of a specific area in the map
 ...
 */
declare function echarts$registerMap(
  mapName: string,
  geoJson: { [key: string]: any },
  specialAreas?: { [key: string]: any }
): void;
 ...
 * @param {{[key: string]: any}} theme Theme configurations.
 */
declare function echarts$registerTheme(
  themeName: string,
  theme: { [key: string]: any }
): void;

declare interface echarts$MapObj {
  /**
 ...
 * @return {echarts$MapObj} Map data.
 */
declare function echarts$getMap(mapName: string): echarts$MapObj;

/**
 * Util methods about graphics.
 */
declare var echarts$graphic: echarts$Graphic;

declare interface echarts$Graphic {
  /**
   ...
   * like [[23, 44], [12, 15], ...].
   * @param {echarts$ERectangle} rect The rectangular that is used to clip points.
   */
  clipPointsByRect(points: number[][], rect: echarts$ERectangle): number[][];

  /**
   * Clip the first input rectangular by the second input rectangular.
   * @param {echarts$ERectangle} targetRect The rectangular to be clipped.
   * @param {echarts$ERectangle} rect The rectangular that is used to clip
   * targetRect.
   */
  clipRectByRect(
    targetRect: echarts$ERectangle,
    rect: echarts$ERectangle
  ): echarts$ERectangle;
}

declare interface echarts$ECharts {
  /**
   ...
   * @param {echarts$EChartOption} option Configuration item and data. Please
   * refer to [configuration item manual](https://echarts.apache.org/option.html)
   * for more information.
   * @param {boolean} notMerge Whether not to merge with previous
   * `option`
   * @param {boolean} lazyUpdate Whether not to update chart
   * immediately
   */
  setOption(
   ...
   * refer to [configuration item manual](https://echarts.apache.org/option.html)
   * for more information.
   * @param {echarts$EChartsOptionConfig} opts Options about how to setOption
   */
  setOption(
   ...
   * @param {echarts$EChartsResizeOption} opts Specify parameters explicitly.
   */
  resize(opts?: echarts$EChartsResizeOption): void;
   ...
   */
  dispatchAction(payload: { [key: string]: any }): void;
   ...
   *             (event: object)
   *             ```
   * @param {{[key: string]: any}} context context of callback function, what
   * `this` refers to.
   */
  on(
    eventName: string,
   ...
   * @param {echarts$EChartsConvertFinder} finder Indicate in which coordinate
   ...
   */
  convertToPixel(
    finder: echarts$EChartsConvertFinder,
    value: string | any[]
  ): string | any[];
   ...
   * coordinate system.
   */
  containPixel(finder: echarts$EChartsConvertFinder, value: any[]): boolean;
   ...
   * @param {string} type
   * @param {echarts$EChartsLoadingOption} opts
   */
  showLoading(type?: string, opts?: echarts$EChartsLoadingOption): void;
...
declare type echarts$TypedArray =
  | Int8Array
  | Uint8Array
  | Int16Array
  | Uint16Array
...
declare interface echarts$EChartsConvertFinder {
  seriesIndex?: number;
  seriesId?: string;
  seriesName?: string;
  geoIndex?: number;
...
declare interface echarts$ERectangle {
  x: number;
  y: number;
  width: number;
  height: number;
...
declare type echarts$EChartsSeriesType =
  | "line"
  | "bar"
  | "pie"
  | "scatter"
...
declare interface echarts$EChartOption<TSeries = echarts$EChartOption$Series> {
  /**
   ...
   */
  xAxis?: echarts$EChartOption$XAxis | echarts$EChartOption$XAxis[];
   ...
   */
  yAxis?: echarts$EChartOption$YAxis | echarts$EChartOption$YAxis[];
   ...
   */
  axisPointer?: echarts$EChartOption$AxisPointer;
   ...
   */
  graphic?: { [key: string]: any } | { [key: string]: any }[];
   ...
   */
  textStyle?: echarts$EChartOption$TextStyle;
   ...
   * @example animationDuration: function (idx) {
   ...
   * @example animationDelay: function (idx) {
   * // delay for later data is larger
   * return idx * 100;
   * }
   ...
   * for different data to have different animation effect
   * @example animationDurationUpdate: function (idx) {
   * // delay for later data is larger
   * return idx * 100;
   * }
   ...
   * for different data to have different animation effect.
   * @example animationDelayUpdate: function (idx) {
   * // delay for later data is larger
   * return idx * 100;
   * }
...
declare type echarts$EChartsMediaOption = {
  query: {
    width?: number,
    height?: number,
    aspectRatio?: number,
...
declare interface echarts$EChartsResponsiveOption {
  baseOption?: echarts$EChartOption;
  media?: echarts$EChartsMediaOption[];
}

declare interface echarts$EChartsOptionConfig {
  notMerge?: boolean;
  lazyUpdate?: boolean;
  silent?: boolean;
}

declare interface echarts$EChartsResizeOption {
  /**
   * Chart width.
   */
  width?: number | string;
...
declare interface echarts$EChartsLoadingOption {
  /**
   * Loading text.
   * @default 'loading'
   */
...
declare var npm$namespace$echarts$EChartOption: {
  BasicComponents: typeof npm$namespace$echarts$EChartOption$BasicComponents
};
declare type echarts$EChartOption$Series =
  | echarts$EChartOption$SeriesLine
  | echarts$EChartOption$SeriesBar
  | echarts$EChartOption$SeriesPie
  | echarts$EChartOption$SeriesScatter
  | echarts$EChartOption$SeriesEffectScatter
  | echarts$EChartOption$SeriesRadar
  | echarts$EChartOption$SeriesTree
  | echarts$EChartOption$SeriesTreemap
  | echarts$EChartOption$SeriesSunburst
  | echarts$EChartOption$SeriesBoxplot
  | echarts$EChartOption$SeriesCandlestick
  | echarts$EChartOption$SeriesHeatmap
  | echarts$EChartOption$SeriesMap
  | echarts$EChartOption$SeriesParallel
  | echarts$EChartOption$SeriesLines
  | echarts$EChartOption$SeriesGraph
  | echarts$EChartOption$SeriesSankey
  | echarts$EChartOption$SeriesFunnel
  | echarts$EChartOption$SeriesGauge
  | echarts$EChartOption$SeriesPictorialBar
  | echarts$EChartOption$SeriesThemeRiver
  | echarts$EChartOption$SeriesCustom;

/**
 * @todo describe
 */
declare interface echarts$EChartOption$BasicComponents$Line {
  show?: boolean;
  onZero?: boolean;
...
declare interface echarts$EChartOption$BasicComponents$CartesianAxis {
  /**
   ...
   */
  nameTextStyle?: echarts$EChartOption$BasicComponents$CartesianAxis$TextStyle;
  ...
  data?: (
    | string
    | echarts$EChartOption$BasicComponents$CartesianAxis$DataObject
  )[];
   ...
   */
  axisPointer?: echarts$EChartOption$BasicComponents$CartesianAxis$Pointer;
...
declare type echarts$EChartOption$BasicComponents$CartesianAxis$Type =
  | "value"
  | "category"
  | "time"
  | "log";
 ...
 * @todo describe
 */
declare interface echarts$EChartOption$BasicComponents$CartesianAxis$Style {
  color?: string;
 ...
 * @todo describe
 */
declare interface echarts$EChartOption$BasicComponents$CartesianAxis$RichStyle {
  [userStyleName: string]: echarts$EChartOption$BasicComponents$CartesianAxis$Style;
}

declare type echarts$EChartOption$BasicComponents$CartesianAxis$TextStyle = {
  /**
   * @see https://ecomfe.github.io/echarts-doc/public/en/option.html#yAxis.data.textStyle.rich
   */
  rich?: echarts$EChartOption$BasicComponents$CartesianAxis$RichStyle
} & echarts$EChartOption$BasicComponents$CartesianAxis$Style;

/**
 * @todo describe
 */
declare interface echarts$EChartOption$BasicComponents$CartesianAxis$Tick {
  show?: boolean;
 ...
 * @todo describe
 */
declare type echarts$EChartOption$BasicComponents$CartesianAxis$Label = {
  show?: boolean,
  interval?: number | Function,
  inside?: boolean,
  rotate?: number,
...
} & echarts$EChartOption$BasicComponents$CartesianAxis$TextStyle;

/**
 * @todo describe
 */
declare interface echarts$EChartOption$BasicComponents$CartesianAxis$SplitLine {
  show?: boolean;
  interval?: number | Function;
  lineStyle?: {
    color?: string | string[],
 ...
 * @todo describe
 */
declare interface echarts$EChartOption$BasicComponents$CartesianAxis$SplitArea {
  interval?: number | Function;
  show?: boolean;
  areaStyle?: {
    color?: string[],
 ...
 * @todo describe
 */
declare interface echarts$EChartOption$BasicComponents$CartesianAxis$DataObject {
  value?: string;
  textStyle?: echarts$EChartOption$BasicComponents$CartesianAxis$TextStyle;
}

/**
 * @todo describe
 */
declare interface echarts$EChartOption$BasicComponents$CartesianAxis$Pointer {
  show?: boolean;
  type?: "line" | "shadow" | "none";
  snap?: boolean;
  z?: number;
  label?: echarts$EChartOption$BasicComponents$CartesianAxis$PointerLabel;
  lineStyle?: {
    color?: string,
    width?: number,
    type?: string,
...
declare interface echarts$EChartOption$BasicComponents$CartesianAxis$PointerLabel {
  show?: boolean;
...
declare module "echarts" {
  declare export default typeof echarts;
}
