declare module 'express-ws-routes' {
        import type {
          exExpress,Request,NextFunction
        } from 'express';
...
declare type expressWsRoutes$CbHandler = (connectHandler: expressWsRoutes$WebSocketHandler | boolean) => void;
...
websocket(
route: string,
handler: expressWsRoutes$WebSocketRouteHandler): expressWsRoutes$Express
} & exExpress
...
websocket(
route: string,
handler: expressWsRoutes$WebSocketRouteHandler): expressWsRoutes$Router
} & coreRouter
