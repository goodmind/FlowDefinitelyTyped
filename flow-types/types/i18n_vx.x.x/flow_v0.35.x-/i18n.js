 ...
 */
declare function i18n$__(phraseOrOptions: string | i18n$TranslateOptions, ...replace: string[]): string
...
replacements: i18n$Replacements): string
 ...
 * @returns The translated phrase
 */
declare function i18n$__n(singular: string, plural: string, count: number | string): string
 ...
 * @returns The translated phrase
 */
declare function i18n$__mf(phraseOrOptions: string | i18n$TranslateOptions, ...replace: any[]): string
 ...
 * @param inheritance - Disables inheritance if true
 */
declare function i18n$setLocale(objects: any | any[], locale: string, inheritance?: boolean): void
 ...
 */
declare function i18n$getCatalog(request: Express$Express$Request, locale?: string): i18n$LocaleCatalog
 ...
 */
declare function i18n$overrideLocaleFromQuery(request?: Express$Express$Request): void
 ...
 */
declare var i18n$version: string;declare interface i18nAPI {
locale: string,
...
__(
phraseOrOptions: string | i18n$i18n$TranslateOptions,
replacements: i18n$i18n$Replacements): string,
 ...
 * @returns The translated phrase
 */
__n(options: i18n$i18n$PluralOptions, count?: number): string,
 ...
 * @returns The phrase in each language
 */
__h(phrase: string): i18n$i18n$HashedList[],
 ...
 * @returns The current global catalog
 */
getCatalog(): i18n$i18n$GlobalCatalog,
 ...
 * @returns The specified locale catalog
 */
getCatalog(locale?: string): i18n$i18n$LocaleCatalog
} declare module 'i18n' {
