declare module 'atlassian-crowd-client' {
        import type {
          Settings
        } from './settings';

	declare module.exports: typeof CrowdClient

	declare class CrowdClient mixins CrowdApi {
settings: Settings;
...
nested?: boolean,
startIndex?: number,
maxResults?: number) => Promise<string[]>,
...
startIndex?: number,
maxResults?: number,
expand?: boolean) => Promise<string[] | User[]>,
...
expand?: boolean,
startIndex?: number,
maxResults?: number) => Promise<string[] | User[]>,
group: (
restriction: string,
expand?: boolean,
startIndex?: number,
maxResults?: number) => Promise<string[] | Group[]>
};
session: {
...
duration?: number) => Promise<Session>,
createUnvalidated: (
username: string,
validationFactors?: ValidationFactors,
duration?: number) => Promise<Session>,
