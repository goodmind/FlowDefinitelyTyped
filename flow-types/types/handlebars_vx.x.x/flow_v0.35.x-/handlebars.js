...
declare export interface Handlebars$TemplateDelegate<T> {
(context: T, options?: Handlebars$RuntimeOptions): string
} 

declare export type Handlebars$Template<T> = Handlebars$TemplateDelegate<T> | string;
...
declare export function Handlebars$compile<T>(input: any, options?: CompileOptions): HandlebarsTemplateDelegate<T>


declare export function Handlebars$precompile(input: any, options?: PrecompileOptions): TemplateSpecification


declare export function Handlebars$template<T>(precompilation: TemplateSpecification): HandlebarsTemplateDelegate<T>
...
} declare type HandlebarsTemplateDelegate<T> = Handlebars$Handlebars$TemplateDelegate<T>;declare interface HandlebarsTemplates {
