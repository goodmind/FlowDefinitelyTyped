declare module 'react-native-fetch-blob' {
        declare export var RNFetchBlob: RNFetchBlobStatic;
	declare export type RNFetchBlob = RNFetchBlobStatic;
	declare export default typeof RNFetchBlob

	declare interface RNFetchBlobStatic {
fetch(
method: Methods,
url: string,
headers?: {
...
body?: any | null): StatefulPromise<FetchBlobResponse>,
base64: {
...
Fetch: PolyfillFetch
	...
	declare export class PolyfillFetch mixins RNFetchBlobFetchPolyfill {
constructor(config: RNFetchBlobConfig): this
}
	declare export class RNFetchBlobFetchPolyfill  {
constructor(config: RNFetchBlobConfig): this;
build(
): (
url: string,
options: RNFetchBlobConfig) => StatefulPromise<RNFetchBlobFetchRepsonse>
}
	declare export interface RNFetchBlobFetchRepsonse {
 ...
 */
declare export interface FetchBlobResponse {
taskId: string,
...
readStream(encode: Encoding): RNFetchBlobStream | null
	...
	declare export type PolyfillFileReader = {
...
result: number
      ...
      declare var npm$namespace$PolyfillFileReader: {
        
        EMPTY: typeof PolyfillFileReader$EMPTY,
LOADING: typeof PolyfillFileReader$LOADING,
DONE: typeof PolyfillFileReader$DONE,
      }
declare var PolyfillFileReader$EMPTY: number;

declare var PolyfillFileReader$LOADING: number;

declare var PolyfillFileReader$DONE: number;
	declare export class PolyfillEvent  {}
	declare export type PolyfillProgressEvent = {
lengthComputable: boolean,
loaded: number,
total: number
} & EventTarget

	declare export class PolyfillBlob mixins EventTarget {
 ...
 */
constructor(data: any, cType: any, defer: boolean): this;
...
close(): Promise<void>
      ...
      declare var npm$namespace$PolyfillBlob: {
        clearCache: typeof PolyfillBlob$clearCache,
build: typeof PolyfillBlob$build,
setLog: typeof PolyfillBlob$setLog,
        
      }
declare function PolyfillBlob$clearCache(): void


declare function PolyfillBlob$build(data: any, cType: any): Promise<PolyfillBlob>


declare function PolyfillBlob$setLog(level: number): void

	declare export class PolyfillFile mixins PolyfillBlob {}
	declare export type PolyfillXMLHttpRequest = {
...
responseType: string
      ...
      declare var npm$namespace$PolyfillXMLHttpRequest: {
        setLog: typeof PolyfillXMLHttpRequest$setLog,
addBinaryContentType: typeof PolyfillXMLHttpRequest$addBinaryContentType,
removeBinaryContentType: typeof PolyfillXMLHttpRequest$removeBinaryContentType,
        binaryContentTypes: typeof PolyfillXMLHttpRequest$binaryContentTypes,
UNSENT: typeof PolyfillXMLHttpRequest$UNSENT,
OPENED: typeof PolyfillXMLHttpRequest$OPENED,
HEADERS_RECEIVED: typeof PolyfillXMLHttpRequest$HEADERS_RECEIVED,
LOADING: typeof PolyfillXMLHttpRequest$LOADING,
DONE: typeof PolyfillXMLHttpRequest$DONE,
      }
declare var PolyfillXMLHttpRequest$binaryContentTypes: string[];

declare var PolyfillXMLHttpRequest$UNSENT: number;

declare var PolyfillXMLHttpRequest$OPENED: number;

declare var PolyfillXMLHttpRequest$HEADERS_RECEIVED: number;

declare var PolyfillXMLHttpRequest$LOADING: number;

declare var PolyfillXMLHttpRequest$DONE: number;

declare function PolyfillXMLHttpRequest$setLog(level: number): void


declare function PolyfillXMLHttpRequest$addBinaryContentType(substr: string): void


declare function PolyfillXMLHttpRequest$removeBinaryContentType(): void

	declare export type PolyfillXMLHttpRequestEventTarget = {
onabort(e: Event): void,
onerror(e: Event): void,
onload(e: Event): void,
onloadstart(e: Event): void,
...
encoding: Encoding,
bufferSize?: number,
tick?: number): Promise<RNFetchBlobReadStream>,
...
path: string,
encoding: Encoding,
append?: boolean): Promise<RNFetchBlobWriteStream>,
...
MainBundleDir: string
	...
	declare export interface RNFetchBlobWriteStream {
id: string,
encoding: string,
append: boolean,
...
close(): void
	...
	declare export interface RNFetchBlobReadStream {
path: string,
encoding: Encoding,
bufferSize?: number,
closed: boolean,
...
onEnd(fn: () => void): void
	...
	declare type Encoding = "utf8" | "ascii" | "base64";
	declare export interface IOSApi {
...
openDocument(path: string): void
	...
	declare export interface AndroidApi {
 ...
 */
declare export type StatefulPromise<T> = {
 ...
 */
progress(
callback: (received: number, total: number) => void): StatefulPromise<FetchBlobResponse>,
 ...
 */
uploadProgress(
callback: (sent: number, total: number) => void): StatefulPromise<FetchBlobResponse>,
...
expire(callback: () => void): StatefulPromise<void>
	...
	declare export class RNFetchBlobSession  {
constructor(name: string, list: string[]): this;
 ...
 */
declare export interface RNFetchBlobConfig {
...
IOSBackgroundTask?: boolean
	...
	declare export interface AddAndroidDownloads {
...
notification?: boolean
	...
	declare export interface RNFetchBlobResponseInfo {
taskId: string,
state: number,
headers: any,
status: number,
...
rnfbEncode: "path" | "base64" | "ascii" | "utf8"
	...
	declare export interface RNFetchBlobStream {
onData(): void,
onError(): void,
onEnd(): void
} 
	declare export class RNFetchBlobFile  {}
	declare export class RNFetchBlobStat  {
lastModified: string;
size: string;
type: "directory" | "file";
path: string;
