...
static +LessThan: Class<CompareOperator__LessThan> & CompareOperator__LessThan & 0;// 0
static +LessThanEqual: Class<CompareOperator__LessThanEqual> & CompareOperator__LessThanEqual & 1;// 1
static +Equal: Class<CompareOperator__Equal> & CompareOperator__Equal & 2;// 2
static +NotEqual: Class<CompareOperator__NotEqual> & CompareOperator__NotEqual & 3;// 3
static +GreaterThanEqual: Class<CompareOperator__GreaterThanEqual> & CompareOperator__GreaterThanEqual & 4;// 4
static +GreaterThan: Class<CompareOperator__GreaterThan> & CompareOperator__GreaterThan & 5;// 5
