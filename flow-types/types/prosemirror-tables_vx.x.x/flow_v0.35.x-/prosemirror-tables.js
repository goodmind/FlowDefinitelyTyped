declare module 'prosemirror-tables' {
	...
	import type {
          ProsemirrorNode,NodeSpec,Slice,ResolvedPos,Schema
...
head: number
	...
	declare export class CellSelection<S: Schema>  {
...
static colSelection<S: Schema>(
anchorCell: ResolvedPos<S>,
headCell?: ResolvedPos<S>): CellSelection<S>;
static rowSelection<S: Schema>(
anchorCell: ResolvedPos<S>,
headCell?: ResolvedPos<S>): CellSelection<S>;
...
static fromJSON<S: Schema>(doc: ProsemirrorNode<S>, json: CellSelectionJSON): CellSelection<S>
}
...
static get(table: ProsemirrorNode): TableMap
	...
	declare export function deleteTable<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function goToNextCell<S: Schema>(
direction: number): (state: EditorState<S>, dispatch?: (tr: Transaction<S>) => void) => boolean

	declare export function toggleHeaderCell<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function toggleHeaderColumn<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function toggleHeaderRow<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function setCellAttr<S: Schema>(
name: string,
value: any): (state: EditorState<S>, dispatch?: (tr: Transaction<S>) => void) => boolean

	declare export function splitCell<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function mergeCells<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function deleteRow<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function addRowAfter<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function addRowBefore<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function deleteColumn<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function addColumnAfter<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function addColumnBefore<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean

	declare export function columnResizing<S: Schema>(
props: {
handleWidth?: number,
cellMinWidth?: number,
View?: NodeView<S>
...
overrideValue?: number): void
	...
	declare export function cellAround<S: Schema>(pos: ResolvedPos<S>): ResolvedPos<S> | null

	declare export function isInTable(state: EditorState): boolean

	declare export function selectionCell<S: Schema>(state: EditorState<S>): ResolvedPos<S> | null | void

	declare export function moveCellForward<S: Schema>(pos: ResolvedPos<S>): ResolvedPos<S>

	declare export function inSameTable<S: Schema>($a: ResolvedPos<S>, $b: ResolvedPos<S>): boolean
...
buttom: number
	...
	declare export function nextCell<S: Schema>(
pos: ResolvedPos<S>,
axis: string,
