declare module "screeps" {
  ...
  declare var CONTROLLER_STRUCTURES: Record<
  ...
  declare type ConstructionSite<
    T: BuildableStructureConstant = BuildableStructureConstant
  > = {
  ...
  declare type ConstructionSiteConstructor = {} & _Constructor<ConstructionSite> &
  ...
  declare type CreepConstructor = {} & _Constructor<Creep> &
 ...
 */
  ...
  declare type StoreDefinition = $Shape<
    Record<_ResourceConstantSansEnergy, number>
  > & {
    energy: number
  };
  ...
  declare type LookAtResult<K: LookConstant = LookConstant> = Pick<
    LookAtTypes,
    K
  > & {
    type: K
  };
  declare type LookAtResultWithPos<
    K: LookConstant = LookConstant
  > = LookAtResult<K> & {
    x: number,
    y: number
  };
  declare interface LookAtResultMatrix<K: LookConstant = LookConstant> {
    [y: number]: {
      [x: number]: Array<LookAtResult<K>>
    };
  }
  declare interface LookForAtAreaResultMatrix<
    T,
    K: $Keys<LookAtTypes> = $Keys<LookAtTypes>
  > {
    [y: number]: {
      [x: number]: Array<LookForAtAreaResult<T, K>>
    };
  }
  declare type LookForAtAreaResult<
    T,
    K: $Keys<LookAtTypes> = $Keys<LookAtTypes>
  > = {
    type: K
  } & $ObjMapi<{ [k: K]: any }, <P>(P) => T>;
  declare type LookForAtAreaResultWithPos<
    T,
    K: $Keys<LookAtTypes> = $Keys<LookAtTypes>
  ...
  declare type LookForAtAreaResultArray<
    T,
    K: $Keys<LookAtTypes> = $Keys<LookAtTypes>
  ...
  declare type ScreepsReturnCode =
    | OK
    | ERR_NOT_OWNER
    | ERR_NO_PATH
    | ERR_BUSY
  ...
  declare type CreepActionReturnCode =
    | OK
    | ERR_NOT_OWNER
    | ERR_BUSY
    | ERR_INVALID_TARGET
    ...
    | ERR_NO_BODYPART
    | ERR_TIRED;
  declare type CreepMoveReturnCode =
    | OK
    | ERR_NOT_OWNER
    | ERR_BUSY
    | ERR_TIRED
    | ERR_NO_BODYPART;
  declare type ExitConstant =
    | FIND_EXIT_TOP
    | FIND_EXIT_RIGHT
    | FIND_EXIT_BOTTOM
    | FIND_EXIT_LEFT;
  ...
  declare type FilterFunction<T: FindConstant> = (
    object: $ElementType<FindTypes, T>
  ) => boolean;
  declare interface FilterObject {
    [key: string]: any;
  }
  declare type BodyPartConstant =
    | MOVE
    | WORK
    | CARRY
    | ATTACK
  ...
  declare type DirectionConstant =
    | TOP
    | TOP_RIGHT
    | RIGHT
    | BOTTOM_RIGHT
  ...
  declare type BuildableStructureConstant =
    ...
    | STRUCTURE_CONTAINER
    | STRUCTURE_NUKER;
  declare type StructureConstant =
    | BuildableStructureConstant
  ...
  declare type _ResourceConstantSansEnergy =
    | RESOURCE_POWER
    | RESOURCE_UTRIUM
    | RESOURCE_LEMERGIUM
    | RESOURCE_KEANIUM
  ...
  declare interface EventItem<T: EventConstant = EventConstant> {
    event: T;
    objectId: string;
 ...
 */
   ...
   */
  declare type Mineral<T: MineralConstant = MineralConstant> = {
    /**
  ...
  declare type MineralConstructor = {} & _Constructor<Mineral> &
   ...
   */
  declare type Resource<T: ResourceConstant = ResourceConstant> = {
    +prototype: Resource,
 ...
 */
     ...
     */
    lookFor<T: $Keys<AllLookAtTypes>>(
      type: T
    ): Array<$ElementType<AllLookAtTypes, T>>;
  }
 ...
 */
    ...
    lookForAtArea<T: $Keys<AllLookAtTypes>>(
      ...
      right: number,
      asArray?: false
    ): LookForAtAreaResultMatrix<$ElementType<AllLookAtTypes, T>, T>;
    ...
    lookForAtArea<T: $Keys<AllLookAtTypes>>(
      ...
      right: number,
      asArray: true
    ): LookForAtAreaResultArray<$ElementType<AllLookAtTypes, T>, T>;
  }
  ...
  declare type SourceConstructor = {} & _Constructor<Source> &
 ...
 */
  ...
  declare type SpawningConstructor = {} & _Constructor<Spawning> &
    _ConstructorById<Spawning>;

  /**
   * Parent object for structure classes
   */
  declare type Structure<T: StructureConstant = StructureConstant> = {
    +prototype: Structure,
  ...
  declare type StructureConstructor = {} & _Constructor<Structure> &
   ...
   */
  declare type OwnedStructure<T: StructureConstant = StructureConstant> = {
  ...
  declare type OwnedStructureConstructor = {} & _Constructor<OwnedStructure> &
  ...
  declare type StructureControllerConstructor = {} & _Constructor<StructureController> &
  ...
  declare type StructureExtensionConstructor = {} & _Constructor<StructureExtension> &
  ...
  declare type StructureLinkConstructor = {} & _Constructor<StructureLink> &
  ...
  declare type StructureKeeperLairConstructor = {} & _Constructor<StructureKeeperLair> &
  ...
  declare type StructureObserverConstructor = {} & _Constructor<StructureObserver> &
  ...
  declare type StructurePowerBankConstructor = {} & _Constructor<StructurePowerBank> &
  ...
  declare type StructurePowerSpawnConstructor = {} & _Constructor<StructurePowerSpawn> &
  ...
  declare type StructureRampartConstructor = {} & _Constructor<StructureRampart> &
  ...
  declare type StructureRoadConstructor = {} & _Constructor<StructureRoad> &
  ...
  declare type StructureStorageConstructor = {} & _Constructor<StructureStorage> &
  ...
  declare type StructureTowerConstructor = {} & _Constructor<StructureTower> &
  ...
  declare type StructureWallConstructor = {} & _Constructor<StructureWall> &
  ...
  declare type StructureExtractorConstructor = {} & _Constructor<StructureExtractor> &
 ...
 */
  ...
  declare type StructureLabConstructor = {} & _Constructor<StructureLab> &
  ...
  declare type StructureTerminalConstructor = {} & _Constructor<StructureTerminal> &
  ...
  declare type StructureContainerConstructor = {} & _Constructor<StructureContainer> &
  ...
  declare type StructureNukerConstructor = {} & _Constructor<StructureNuker> &
  ...
  declare type StructurePortalConstructor = {} & _Constructor<StructurePortal> &
  ...
  declare type TombstoneConstructor = {} & _Constructor<Tombstone> &
