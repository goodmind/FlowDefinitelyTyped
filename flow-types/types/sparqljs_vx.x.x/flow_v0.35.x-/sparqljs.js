...
stringify(query: SparqlQuery): string
	...
	declare export type Query = SelectQuery | ConstructQuery | AskQuery | DescribeQuery;
...
updates: UpdateOperation[]
	...
	declare export type UpdateOperation = InsertDeleteOperation | ManagementOperation;
...
where?: Pattern[]
	...
	declare export type ManagementOperation = CopyMoveAddOperation | LoadOperation | CreateOperation | ClearDropOperation;
...
variable: Term
	...
	declare export type Pattern = BgpPattern
| BlockPattern
| GraphPattern
| ServicePattern
| FilterPattern
...
items: Array<PropertyPath | Term>
	...
	declare export type Expression = OperationExpression
