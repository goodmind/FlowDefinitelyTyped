declare module 'heroku-logger' {
        declare export function trace(message: string, data?: {[key: string]: any}): void

	declare export function debug(message: string, data?: {[key: string]: any}): void

	declare export function info(message: string, data?: {[key: string]: any}): void

	declare export function warn(message: string, data?: {[key: string]: any}): void

	declare export function error(message: string, data?: {[key: string]: any}): void

	declare export function fatal(message: string, data?: {[key: string]: any}): void
