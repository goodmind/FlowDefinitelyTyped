declare module 'require-directory' {
      ...
      declare var npm$namespace$requireDirectory: {
        
        defaults: typeof requireDirectory$defaults,
      }
 ...
 */
declare type requireDirectory$CheckPathFn = (path: string) => boolean;

declare interface requireDirectory$RequireDirectoryResult<T> {

/**
 * @description module itself or hash of modules in subdirectory with name of this directory
 */
[index: string]: requireDirectory$RequireDirectoryResult<T> | T
} 

declare interface requireDirectory$RequireDirectoryOptions<T, U> {
 ...
 * @default undefined
 */
include?: RegExp | requireDirectory$CheckPathFn,

/**
 * @description RegExp or function for blacklisting modules
 * @default undefined
 */
exclude?: RegExp | requireDirectory$CheckPathFn,
 ...
 */
declare var requireDirectory$defaults: requireDirectory$RequireDirectoryOptions<any>;
...
m: NodeModule,
path?: string | requireDirectory$requireDirectory$RequireDirectoryOptions<T, U>,
options?: requireDirectory$requireDirectory$RequireDirectoryOptions<T, U>): requireDirectory$requireDirectory$RequireDirectoryResult<U>
