...
declare function Filter$matchString(data: string | string[], filter: Filter): boolean


declare function Filter$matchSubstring(data: string | string[], filter: Filter): boolean


declare function Filter$matchApprox(data: string | string[], filter: Filter): boolean


declare function Filter$matchGTE(data: string | string[], filter: Filter): boolean


declare function Filter$matchLTE(data: string | string[], filter: Filter): boolean
