...
zzz: string
	...
	declare export interface Emoji {
emoji: string,
key: string
} 
	declare export function emojify(
str: string,
on_missing?: (emoji_name: string) => string,
format?: (code: string, name: string) => string): string

	declare export function get(emoji: string): string

	declare export function random(): Emoji

	declare export function search(searchTerm: string): Emoji[]

	declare export function which(emoji_code: string): string

	declare export function unemojify(str: string): string

	declare export function find(emoji: string): Emoji

	declare export function hasEmoji(str: string): boolean

	declare export function strip(str: string): string

	declare export function replace(
str: string,
replacement: ((emoji: Emoji) => string) | string,
cleanSpaces?: boolean): string
