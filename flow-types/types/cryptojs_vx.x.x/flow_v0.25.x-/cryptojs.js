declare module "cryptojs" {
  ...
  declare type lib$BlockCipherMode = {
    createEncryptor(
      cipher: lib$Cipher,
      iv: number[]
    ): mode$mode$IBlockCipherEncryptor,
    createDecryptor(
      cipher: lib$Cipher,
      iv: number[]
    ): mode$mode$IBlockCipherDecryptor,
  ...
  declare type algo$IBlockCipherImpl = {
    ...
    createEncryptor(
      key: lib$lib$WordArray,
      cfg?: lib$lib$CipherParamsData
    ): algo$IBlockCipherImpl,
    createDecryptor(
      key: lib$lib$WordArray,
      cfg?: lib$lib$CipherParamsData
    ): algo$IBlockCipherImpl,
