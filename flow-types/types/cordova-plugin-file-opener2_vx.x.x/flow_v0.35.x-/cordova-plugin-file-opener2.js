declare module 'cordova-plugin-file-opener2' {
        declare interface CordovaPluginsFileOpener2Result {
status: number,
message: string
} 
	declare interface CordovaPluginsFileOpener2CallbackContext {
success(): void,
error(error: CordovaPluginsFileOpener2Result): void
} 
	declare interface CordovaPluginsFileOpener2 {
...
fileName: string,
contentType: string,
callbackContext?: CordovaPluginsFileOpener2CallbackContext): void,
