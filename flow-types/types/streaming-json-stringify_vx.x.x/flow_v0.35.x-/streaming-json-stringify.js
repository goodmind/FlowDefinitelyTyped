...
(options?: Stringify$Stringify$Options): Stringify$Stringify$Instance & stream.Transform,
new (
options?: Stringify$Stringify$Options): Stringify$Stringify$Instance & stream.Transform
} 
...
seperator: string,
closer: string,
stringifier(value: any, replacer: Stringify$Replacer, space: string | number): string
} 

declare type Stringify$Replacer = (key: string, value: any) => any;

declare type Stringify$Options = $Shape<Stringify$Instance> & stream.TransformOptions;
    }
