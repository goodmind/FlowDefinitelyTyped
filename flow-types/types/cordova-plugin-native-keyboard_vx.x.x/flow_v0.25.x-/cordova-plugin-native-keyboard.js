declare module "cordova-plugin-native-keyboard" {
  declare interface NativeKeyboard {
    /**
  ...
  declare interface NativeKeyboardUpdateOptions {
    /**
  ...
  declare interface NativeKeyboardHideOptions {
    /**
     * A boolean flag inidicating if the keyboard should be shown/hidden with an animation
     */
    animated?: boolean;
  }
  declare interface NativeKeyboardShowOptions {
    /**
  ...
  declare type LeftButtonOptions = {
    /**
