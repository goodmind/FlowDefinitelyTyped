 ...
 */
declare function orientjs(config: orientjs$orientjs$ServerConfig): orientjs$orientjs$Server

	declare type orientjs$Version = number | string;

declare type orientjs$PropertyType = "Boolean"
| "Integer"
| "Short"
| "Long"
| "Float"
...
static +Boolean: Class<orientjs$DataTypes__Boolean> & orientjs$DataTypes__Boolean & 0;// 0
static +Integer: Class<orientjs$DataTypes__Integer> & orientjs$DataTypes__Integer & 1;// 1
static +Short: Class<orientjs$DataTypes__Short> & orientjs$DataTypes__Short & 2;// 2
static +Long: Class<orientjs$DataTypes__Long> & orientjs$DataTypes__Long & 3;// 3
static +Float: Class<orientjs$DataTypes__Float> & orientjs$DataTypes__Float & 4;// 4
static +Double: Class<orientjs$DataTypes__Double> & orientjs$DataTypes__Double & 5;// 5
static +Datetime: Class<orientjs$DataTypes__Datetime> & orientjs$DataTypes__Datetime & 6;// 6
static +string: Class<orientjs$DataTypes__string> & orientjs$DataTypes__string & 7;// 7
static +Binary: Class<orientjs$DataTypes__Binary> & orientjs$DataTypes__Binary & 8;// 8
static +Embedded: Class<orientjs$DataTypes__Embedded> & orientjs$DataTypes__Embedded & 9;// 9
static +EmbeddedList: Class<orientjs$DataTypes__EmbeddedList> & orientjs$DataTypes__EmbeddedList & 10;// 10
static +EmbeddedSet: Class<orientjs$DataTypes__EmbeddedSet> & orientjs$DataTypes__EmbeddedSet & 11;// 11
static +EmbeddedMap: Class<orientjs$DataTypes__EmbeddedMap> & orientjs$DataTypes__EmbeddedMap & 12;// 12
static +Link: Class<orientjs$DataTypes__Link> & orientjs$DataTypes__Link & 13;// 13
static +LinkList: Class<orientjs$DataTypes__LinkList> & orientjs$DataTypes__LinkList & 14;// 14
static +LinkSet: Class<orientjs$DataTypes__LinkSet> & orientjs$DataTypes__LinkSet & 15;// 15
static +LinkMap: Class<orientjs$DataTypes__LinkMap> & orientjs$DataTypes__LinkMap & 16;// 16
static +Byte: Class<orientjs$DataTypes__Byte> & orientjs$DataTypes__Byte & 17;// 17
static +Transient: Class<orientjs$DataTypes__Transient> & orientjs$DataTypes__Transient & 18;// 18
static +Date: Class<orientjs$DataTypes__Date> & orientjs$DataTypes__Date & 19;// 19
static +Custom: Class<orientjs$DataTypes__Custom> & orientjs$DataTypes__Custom & 20;// 20
static +Decimal: Class<orientjs$DataTypes__Decimal> & orientjs$DataTypes__Decimal & 21;// 21
static +LinkBag: Class<orientjs$DataTypes__LinkBag> & orientjs$DataTypes__LinkBag & 22;// 22
...
reload?: boolean): Promise<orientjs$Property>;
create(
 ...
 */
list(limit: number | boolean | any, offset?: number): Promise<orientjs$Class[]>;
 ...
 */
find(attributes: any, limit?: number, offset?: number): Promise<orientjs$Record[]>;
...
cluster?: string,
isAbstract?: boolean,
ifnotexist?: boolean): Promise<orientjs$Class>;
...
create(name: string, location?: string): Promise<orientjs$Cluster> & Promise<any>;
get(nameOrId: string, refresh?: boolean): Promise<orientjs$Cluster> & Promise<any>;
getByName(name: string, refresh?: boolean): Promise<orientjs$Cluster> & Promise<any>;
getById(id: string, refresh?: boolean): Promise<orientjs$Cluster> & Promise<any>;
...
start?: number,
incerement?: number,
cache?: number): Promise<orientjs$Sequence>;
...
options?: any): Promise<orientjs$Record>;
 ...
 */
create(
records: orientjs$ODocument[] | orientjs$Record[] | orientjs$BinaryRecord[],
options?: any): Promise<orientjs$Record[]>;
...
options?: any): Promise<orientjs$Record | Buffer>;
...
options?: any): Promise<orientjs$RecordMeta>;
...
type: string,
configure(config: any): void,
add(idx: orientjs$IndexEntry | orientjs$IndexEntry[]): Promise<orientjs$Index[]>,
...
create(config: orientjs$IndexConfig | orientjs$IndexConfig[]): Promise<orientjs$Index>,
drop(name: string): Promise<orientjs$Db>,
get(name: string, refresh?: boolean): Promise<orientjs$Index>,
cacheData(indices: any[]): Promise<orientjs$Db>
} 

declare type orientjs$SqlExpression = string | orientjs$RawExpression | orientjs$SqlFunction;
...
upsert(condition?: any, params?: any, comparisonOperator?: string): orientjs$Statement,
...
statements: orientjs$Statement[]): orientjs$Statement,
if(
condition: orientjs$SqlExpression,
...statements: orientjs$Statement[]): orientjs$Statement,
...
longitude: number,
latitude?: number,
maxDistanceInKms?: number): orientjs$Statement,
within(
latitudeProperty: string,
longitudeProperty: string,
box: number[]): orientjs$Statement,
 ...
 */
registerTransformer<T>(className: string, transformer: (item: orientjs$Record) => T): orientjs$Db;
...
password?: string
	...
	declare module.exports: typeof orientjs
