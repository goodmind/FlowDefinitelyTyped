...
declare type mapboxgl$Expression = any[];
...
declare export class mapboxgl$VideoSource mixins mapboxgl$Source {
type: "video";
...
declare export class mapboxgl$ImageSource mixins mapboxgl$Source {
type: "image";
 ...
 * CanvasSource
 */
declare export class mapboxgl$CanvasSource mixins mapboxgl$Source, mapboxgl$CanvasSourceOptions {
type: "canvas";
coordinates: number[][];
...
declare export class mapboxgl$MapboxEvent<TOrig>  {
type: string;
target: mapboxgl$Map;
originalEvent: TOrig
}
...
"icon-allow-overlap"?: boolean | mapboxgl$StyleFunction,
...
"text-field"?: string | mapboxgl$StyleFunction,
