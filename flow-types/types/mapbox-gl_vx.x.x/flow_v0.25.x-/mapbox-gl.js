...
declare export class mapboxgl$Map mixins mapboxgl$Evented {
  ...
  setCenter(
    ...
    eventData?: mapboxgl$mapboxgl$EventData
  ): this;
  panBy(
  ...
  easeTo(
    options: mapboxgl$mapboxgl$CameraOptions &
      mapboxgl$mapboxgl$AnimationOptions & {
...
export type mapboxgl$ResourceType =
  | "Unknown"
  | "Style"
  | "Source"
  | "Tile"
...
export interface mapboxgl$RequestParameters {
  /**
...
export type mapboxgl$TransformRequestFunction = (
  url: string,
  resourceType: mapboxgl$ResourceType
) => mapboxgl$RequestParameters;

export interface mapboxgl$PaddingOptions {
  top: number;
  bottom: number;
  left: number;
  right: number;
...
export interface mapboxgl$IControl {
...
export interface mapboxgl$Light {
  anchor?: "map" | "viewport";
  position?: number[];
...
export interface mapboxgl$Sources {
  [sourceName: string]: mapboxgl$AnySourceData;
}

export type mapboxgl$AnySourceData =
...
export type mapboxgl$AnySourceImpl =
 ...
 * VideoSource
 */
export type mapboxgl$VideoSourceRaw = {
  type: "video"
} & mapboxgl$Source &
 ...
 * ImageSource
 */
export type mapboxgl$ImageSourceRaw = {
  type: "image"
} & mapboxgl$Source &
 ...
 * CanvasSource
 */
export type mapboxgl$CanvasSourceRaw = {
  type: "canvas"
} & mapboxgl$Source &
...
export interface mapboxgl$CanvasSourceOptions {
  coordinates: number[][];
  animate?: boolean;
  canvas: string | HTMLCanvasElement;
}
...
declare export class mapboxgl$LngLatBounds {
   ...
   */
  static convert(
    input: mapboxgl$LngLatBoundsLike
  ): mapboxgl$mapboxgl$LngLatBounds;
}
...
declare export class mapboxgl$Marker mixins mapboxgl$Evented {
  ...
  constructor(
    element?: HTMLElement,
    options?: mapboxgl$mapboxgl$MarkerOptions
  ): this;
...
export interface mapboxgl$MarkerOptions {
  element?: HTMLElement;
  offset?: mapboxgl$PointLike;
  anchor?: mapboxgl$Anchor;
  color?: string;
...
export type mapboxgl$MapboxGeoJSONFeature = GeoJSON.Feature<GeoJSON.Geometry> & {
...
export type mapboxgl$EventData = {
  [key: string]: any
};
...
export type mapboxgl$MapLayerMouseEvent = mapboxgl$MapMouseEvent & {
...
export type mapboxgl$MapLayerTouchEvent = mapboxgl$MapTouchEvent & {
  features?: mapboxgl$MapboxGeoJSONFeature[]
};
...
export interface mapboxgl$Coordinate {
  canonical: mapboxgl$CanonicalCoordinate;
  wrap: number;
  key: number;
}

export interface mapboxgl$CanonicalCoordinate {
  x: number;
  y: number;
  z: number;
  key: number;
...
export type mapboxgl$MapContextEvent = {
...
export type mapboxgl$CameraForBoundsOptions = {
...
export type mapboxgl$FitBoundsOptions = {
  linear?: boolean,
 ...
 * MapEvent
 */
export type mapboxgl$MapEventType = {
...
export type mapboxgl$MapLayerEventType = {
...
export interface mapboxgl$FillExtrusionLayout {
  visibility?: "visible" | "none";
}

export interface mapboxgl$FillExtrusionPaint {
...
export interface mapboxgl$HeatmapLayout {
  visibility?: "visible" | "none";
}

export interface mapboxgl$HeatmapPaint {
...
export interface mapboxgl$HillshadeLayout {
  visibility?: "visible" | "none";
}

export interface mapboxgl$HillshadePaint {
