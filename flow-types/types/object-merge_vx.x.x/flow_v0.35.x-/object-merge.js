declare module 'object-merge' {
        declare interface ObjectMergeOptions {
depth: number | boolean,
throwOnCircularRef: boolean
} 
	declare interface ObjectMerge {

/**
 * Merges JavaScript objects recursively without altering the objects merged.
 * @author <a href="mailto:matthewkastor
 * @gmail .com">Matthew Kastor</a>
...
input objects.
 * @example var objectMerge = require('object-merge');
var x = {
a : 'a',
b : 'b',
c : {
...
//         d : '`d',
     ...
     *
 */
(opts: ObjectMergeOptions, ...shadows: {[key: string]: any}[]): {[key: string]: any},
 ...
 */
createOptions: (options: {[key: string]: any}) => ObjectMergeOptions
} 
	declare var objectMerge: ObjectMerge;
	declare module.exports: typeof objectMerge
