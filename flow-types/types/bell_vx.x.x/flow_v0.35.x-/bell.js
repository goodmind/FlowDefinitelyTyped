declare module 'bell' {
        import type {
          Server,Request,Plugin,AuthCredentials
        } from 'hapi';
...
options: BellOptions): void
} 
    }

	declare export interface StringLikeMap {
[key: string]: string | number
} 
	declare export type Provider = "arcgisonline"
| "auth0"
| "azuread"
| "bitbucket"
| "digitalocean"
...
| "wordpress"
| "yahoo";
	declare export type RequestPassThrough = (request: Request) => PromiseLike<AuthCredentials> | AuthCredentials;
	declare export interface OptionalOptions {
...
location?: string | ((req: Request) => string)
	...
	declare export interface RequiredProviderOptions {
...
clientSecret: string
	...
	declare export type KnownProviderOptions = {
provider: Provider
} & RequiredProviderOptions & OptionalOptions
 ...
 */
declare export type AuthedRequest = (
uri: string,
params?: {
[key: string]: string
...
profile?: {[key: string]: any}
	...
	declare export type Credentials1 = {
secret: string
} & Credentials

	declare export type Credentials2 = {
refreshToken?: string,
expiresIn?: number
} & Credentials

	declare export interface CustomProtocol {
 ...
 */
declare export type ProfileGetter<C: Credentials> = (
credentials: C,
params: {
[key: string]: string
},
get: AuthedRequest) => Promise<void>;
	declare export type CustomProtocol1 = {
...
profile: ProfileGetter<Credentials1>
	...
	declare export type CustomProtocol2 = {
...
profile: ProfileGetter<Credentials2>
	...
	declare export type CustomProviderOptions = {
provider: CustomProtocol1 | CustomProtocol2
} & RequiredProviderOptions & OptionalOptions

	declare export type BellOptions = CustomProviderOptions | KnownProviderOptions;
	declare export var plugin: Plugin<BellOptions>;
	
/**
 * Enables simulation mode.
 */
declare export function simulate(credentialsFunc: RequestPassThrough): void
 ...
 */
declare export function simulate(state: false): void
