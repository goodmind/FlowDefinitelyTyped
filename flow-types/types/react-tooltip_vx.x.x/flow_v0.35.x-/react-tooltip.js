declare module 'react-tooltip' {
	...
	declare class ReactTooltip mixins React.Component<ReactTooltip$ReactTooltip$Props> {}
...
declare type ReactTooltip$GetContentCallback = (dataTip: string) => React.ReactNode;

declare type ReactTooltip$GetContent = ReactTooltip$GetContentCallback | [ReactTooltip$GetContentCallback, number];

declare type ReactTooltip$Place = "top" | "right" | "bottom" | "left";

declare type ReactTooltip$Type = "dark"
| "success"
| "warning"
| "error"
| "info"
