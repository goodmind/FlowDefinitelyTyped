declare module "web-resource-inliner" {
  import type { CoreOptions, RequiredUriUrl } from "request";

  declare export function html(options: Options, callback: Callback): string;

  declare export function css(options: Options, callback: Callback): string;

  declare export type Callback = (error: any, result: any) => void;
