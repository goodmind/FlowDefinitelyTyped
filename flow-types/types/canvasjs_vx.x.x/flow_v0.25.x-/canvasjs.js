declare module "canvasjs" {
   ...
   */
  declare function CanvasJS$addColorSet(
    colorSetName: string,
    colorSetArray: string[]
  ): void;
   ...
   */
  declare function CanvasJS$addCultureInfo(
    culture: string,
    info: CanvasJS$CultureInfo
  ): void;
   ...
   */
  declare function CanvasJS$formatNumber(
    number: number,
    formatString?: string,
    culture?: string
  ): string;
   ...
   * @param culture Default culture is “en”.
   */
  declare function CanvasJS$formatDate(
    date: Date | number,
    formatString?: string,
    culture?: string
  ): void;
  ...
  declare type CanvasJS$ChartDataSeries = {
    ...
    get(
      propertyName: string
    ): boolean | string | number | CanvasJS$ChartDataPoint,
