 ...
 */
subtitles: CanvasJS$ChartTitle[];

/**
 * The toolTip of the chart.
 */
toolTip: CanvasJS$ChartToolTip;
axisX: CanvasJS$ChartAxisX[];
axisX2: CanvasJS$ChartAxisX[];
axisY: CanvasJS$ChartAxisY[];
axisY2: CanvasJS$ChartAxisY[];
stripLines: CanvasJS$ChartStrip[];
data: CanvasJS$ChartDataSeries[];
...
set(
propertyName: string,
value: CanvasJS$ChartOptions,
updateChart?: boolean): void;
...
addTo(
propertyName: string,
options: CanvasJS$ChartAxisXOptions | CanvasJS$ChartAxisYOptions | CanvasJS$ChartDataSeriesOptions,
index?: number,
updateChart?: boolean): void;
 ...
 */
declare function CanvasJS$formatNumber(number: number, formatString?: string, culture?: string): string
 ...
 * @param culture Default culture is “en”.
 */
declare function CanvasJS$formatDate(date: Date | number, formatString?: string, culture?: string): void
 ...
 */
axisX?: CanvasJS$ChartAxisXOptions | CanvasJS$ChartAxisXOptions[],
 ...
 */
axisX2?: CanvasJS$ChartAxisXOptions | CanvasJS$ChartAxisXOptions[],
 ...
 */
axisY?: CanvasJS$ChartAxisYOptions | CanvasJS$ChartAxisYOptions[],
 ...
 */
axisY2?: CanvasJS$ChartAxisYOptions | CanvasJS$ChartAxisYOptions[],
 ...
 */
data: CanvasJS$ChartDataSeriesOptions[],
 ...
 */
subtitles?: CanvasJS$ChartTitleOptions[]
} 
...
declare type CanvasJS$ChartTitle = {
...
declare type CanvasJS$ChartLegend = {
...
declare interface CanvasJS$ChartStripLinesOptions {
...
e?: {
chart: CanvasJS$Chart,
axis: CanvasJS$ChartAxisYOptions,
stripline: CanvasJS$ChartStripLinesOptions
}): string
} 

declare type CanvasJS$ChartStrip = {
 ...
 */
stripLines?: CanvasJS$ChartStripLinesOptions | CanvasJS$ChartStripLinesOptions[]
...
addTo(
propertyName: string,
options: CanvasJS$ChartStripLinesOptions,
index?: number,
updateChart?: boolean): void,
...
declare type CanvasJS$ChartToolTip = {
...
declare type CanvasJS$ChartDataSeriesOptions = {
 ...
 * @param propertyName Name of the property.
 */
get(propertyName: string): boolean | string | number | CanvasJS$ChartDataPoint,
...
set(
propertyName: string,
value: boolean | string | number | CanvasJS$ChartDataPoint,
updateChart: boolean): void,
...
addTo(
propertyName: string,
options: CanvasJS$ChartDataPoint,
index?: number,
updateChart?: boolean): void,
