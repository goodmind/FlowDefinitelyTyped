declare module "d3-delaunay" {
  ...
  declare export class Delaunay<P> {
    ...
    static from(
      points:
        | ArrayLike<Delaunay$Delaunay$Point>
        | Iterable<Delaunay$Delaunay$Point>
     ...
     */
    render(
      context: Delaunay$Delaunay$MoveContext & Delaunay$Delaunay$LineContext
    ): void;
    ...
    renderTriangle(
      i: number,
      context: Delaunay$Delaunay$MoveContext &
        Delaunay$Delaunay$LineContext &
        Delaunay$Delaunay$ClosableContext
    ): void;
   ...
   */
  declare type Delaunay$GetCoordinate<P, PS> = (
    point: P,
    i: number,
    points: PS
  ) => number;
