 ...
 */
declare export class Delaunay<P>  {
 ...
 */
constructor(points: ArrayLike<number>): this;
 ...
 */
static from(
points: ArrayLike<Delaunay$Delaunay$Point> | Iterable<Delaunay$Delaunay$Point>): Delaunay<Delaunay$Delaunay$Point>;
...
getX: Delaunay$Delaunay$GetCoordinate<P, ArrayLike<P> | Iterable<P>>,
getY: Delaunay$Delaunay$GetCoordinate<P, ArrayLike<P> | Iterable<P>>,
that?: any): Delaunay<P>;
 ...
 */
hullPolygon(): Delaunay$Delaunay$Polygon;

/**
 * Returns the closed polygon [[x0, y0], [x1, y1], [x2, y2], [x0, y0]] representing the triangle i.
 */
trianglePolygon(i: number): Delaunay$Delaunay$Triangle;

/**
 * Returns an iterable over the polygons for each triangle, in order.
 */
trianglePolygons(): IterableIterator<Delaunay$Delaunay$Triangle>;
 ...
 */
render(context: Delaunay$Delaunay$MoveContext & Delaunay$Delaunay$LineContext): void;
 ...
 * The specified context must implement the context.moveTo and context.lineTo methods from the CanvasPathMethods API.
 */
renderHull(context: Delaunay$Delaunay$MoveContext & Delaunay$Delaunay$LineContext): void;
...
renderTriangle(
i: number,
context: Delaunay$Delaunay$MoveContext & Delaunay$Delaunay$LineContext & Delaunay$Delaunay$ClosableContext): void;
 ...
 */
renderPoints(context: void, radius: number): string;
 ...
 */
renderPoints(
context: Delaunay$Delaunay$MoveContext & Delaunay$Delaunay$ArcContext,
radius?: number): void;
 ...
 */
voronoi(bounds?: Delaunay$Delaunay$Bounds): Voronoi<P>
}
	
/**
 * A point represented as an array tuple [x, y].
 */
declare type Delaunay$Point = number[];


/**
 * A closed polygon [[x0, y0], [x1, y1], [x2, y2], [x0, y0]] representing a triangle.
 */
declare type Delaunay$Triangle = Delaunay$Point[];


/**
 * A closed polygon [[x0, y0], [x1, y1], ..., [x0, y0]].
 */
declare type Delaunay$Polygon = Delaunay$Point[];


/**
 * A rectangular area [x, y, width, height].
 */
declare type Delaunay$Bounds = number[];


/**
 * A function to extract a x- or y-coordinate from the specified point.
 */
declare type Delaunay$GetCoordinate<P, PS> = (point: P, i: number, points: PS) => number;


/**
 * A point node on a convex hull (represented as a circular linked list).
 */
declare interface Delaunay$Node {
 ...
 */
declare interface Delaunay$RectContext {
 ...
 */
declare interface Delaunay$MoveContext {
 ...
 */
declare interface Delaunay$LineContext {
 ...
 */
declare interface Delaunay$ArcContext {
 ...
 */
declare interface Delaunay$ClosableContext {
 ...
 * Voronoi regions
 */
declare export class Voronoi<P>  {
 ...
 */
constructor(delaunay: Delaunay<P>, bounds: Delaunay$Delaunay$Bounds): this;
 ...
 */
cellPolygon(i: number): Delaunay$Delaunay$Polygon;

/**
 * Returns an iterable over the polygons for each cell, in order.
 */
cellPolygons(): IterableIterator<Delaunay$Delaunay$Polygon>;
 ...
 */
renderBounds(context: Delaunay$Delaunay$RectContext): void;
