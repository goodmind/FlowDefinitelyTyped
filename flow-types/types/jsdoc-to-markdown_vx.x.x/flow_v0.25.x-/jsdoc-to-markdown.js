declare module "jsdoc-to-markdown" {
  declare export type StyleListFormat = "none" | "grouped" | "table" | "dl";
  declare export type RenderListFormat = "list" | "table";
  declare export type MemberIndexFormat = "grouped" | "list";
  ...
  declare export interface JsdocOptions {
    /**
  ...
  declare export class JsdocToMarkdown {
    /**
     ...
     */
    getTemplateData(options: JsdocOptions): Promise<{ [key: string]: any }[]>;

    /**
     * Sync version of getTemplateData.
     */
    getTemplateDataSync(options: JsdocOptions): { [key: string]: any }[];

    /**
     * Returns raw data direct from the underlying jsdoc3.
     */
    getJsdocData(options: JsdocOptions): Promise<{ [key: string]: any }[]>;

    /**
     * Sync version of getJsdocData.
     */
    getJsdocDataSync(options: JsdocOptions): { [key: string]: any }[];
     ...
     */
    getNamepaths(options: JsdocOptions): Promise<{ [key: string]: any }>;
  }
}
