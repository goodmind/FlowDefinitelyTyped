...
type: T,
onUpdate?: OnUpdateCallback): Promise<$ElementType<OutputByType, T>>,
...
declare interface JSZip$JSZipGeneratorOptions<T: JSZip$OutputType> {
compression?: Compression,
...
path: string,
data: $ElementType<InputByType, T> | Promise<$ElementType<InputByType, T>>,
options?: JSZip$JSZip$JSZipFileOptions): this,
file<T: JSZip$JSZip$InputType>(
path: string,
data: null,
 ...
 */
forEach(callback: (relativePath: string, file: JSZip$JSZip$JSZipObject) => void): void,
 ...
 */
filter(
predicate: (relativePath: string, file: JSZip$JSZip$JSZipObject) => boolean): JSZip$JSZip$JSZipObject[],
...
onUpdate?: OnUpdateCallback): NodeJS.ReadableStream,
 ...
 */
loadAsync(data: InputFileFormat, options?: JSZip$JSZip$JSZipLoadOptions): Promise<JSZip>,
