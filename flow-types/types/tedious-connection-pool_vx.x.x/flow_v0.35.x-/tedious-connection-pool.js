 ...
 */
declare type tcp$ConnectionCallback = (err: Error, connection: tcp$PooledConnection) => void;
 ...
 */
constructor(poolConfig: tcp$tcp$PoolConfig, connectionConfig: tedious.ConnectionConfig): this;
