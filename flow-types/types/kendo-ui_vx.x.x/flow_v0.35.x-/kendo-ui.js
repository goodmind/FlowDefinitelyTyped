...
declare function kendo$fx(element: drawing$Element): kendo$effects.drawing$Element
...
declare function kendo$init(element: drawing$Element, ...namespaces: any[]): void


declare function kendo$observable(kendo$data: any): kendo$kendo$data.data$ObservableObject


declare function kendo$observableHierarchy(array: any[]): kendo$kendo$data.data$ObservableArray


declare function kendo$render(kendo$template: (kendo$data: any) => string, kendo$data: any[]): string


declare function kendo$template(
kendo$template: string,
options?: kendo$TemplateOptions): (kendo$data: any) => string


declare function kendo$guid(): string


declare function kendo$widgetInstance(element: JQuery, suite?: typeof undefined): kendo$kendo$ui.ui$Widget
...
declare function effects$fillScale(firstElement: HTMLElement, secondElement: HTMLElement): number


declare function effects$fitScale(firstElement: HTMLElement, secondElement: HTMLElement): number


declare function effects$transformOrigin(firstElement: HTMLElement, secondElement: HTMLElement): any
...
constructor(element: drawing$Element, options?: ui$AutoCompleteOptions): this;
close(): void;
...
constructor(element: drawing$Element, options?: ui$ButtonGroupOptions): this;
...
constructor(element: drawing$Element, options?: ui$ColorPaletteOptions): this;
value(): string;
...
constructor(element: drawing$Element, options?: ui$ColorPickerOptions): this;
close(): void;
open(): void;
toggle(): void;
value(): string;
...
constructor(element: drawing$Element, options?: ui$ContextMenuOptions): this;
...
destroy(): void;
enable(element: string, effects$enable: boolean): kendo$kendo$ui.ui$ContextMenu;
enable(
element: drawing$Element,
effects$enable: boolean): kendo$kendo$ui.ui$ContextMenu;
enable(element: JQuery, effects$enable: boolean): kendo$kendo$ui.ui$ContextMenu;
insertAfter(item: any, referenceItem: string): kendo$kendo$ui.ui$ContextMenu;
insertAfter(item: any, referenceItem: drawing$Element): kendo$kendo$ui.ui$ContextMenu;
insertAfter(item: any, referenceItem: JQuery): kendo$kendo$ui.ui$ContextMenu;
insertBefore(item: any, referenceItem: string): kendo$kendo$ui.ui$ContextMenu;
insertBefore(item: any, referenceItem: drawing$Element): kendo$kendo$ui.ui$ContextMenu;
insertBefore(item: any, referenceItem: JQuery): kendo$kendo$ui.ui$ContextMenu;
...
constructor(element: drawing$Element, options?: ui$DateRangePickerOptions): this;
close(): void;
destroy(): void;
enable(effects$enable: boolean): void;
readonly(readonly: boolean): void;
...
constructor(element: drawing$Element, options?: ui$DateTimePickerOptions): this;
...
constructor(element: drawing$Element, options?: ui$DropDownListOptions): this;
close(): void;
dataItem(index?: JQuery): any;
dataItem(index?: number): any;
destroy(): void;
...
constructor(element: drawing$Element, options?: ui$DropDownTreeOptions): this;
close(): void;
destroy(): void;
enable(effects$enable: boolean): void;
focus(): void;
...
refresh(): void;
search(word: string): void;
setDataSource(dataSource: kendo$kendo$data.data$HierarchicalDataSource): void;
toggle(toggle?: boolean): void;
value(): any;
...
constructor(element: drawing$Element, options?: ui$FlatColorPickerOptions): this;
focus(): void;
value(): string;
value(color?: string): void;
color(): kendo$kendo$Color;
...
setDependenciesDataSource(dataSource: kendo$kendo$data.data$GanttDependencyDataSource): void;
...
attributes?: any,
columns?: any,
command?: string | string[] | ui$GridColumnCommandItem | ui$GridColumnCommandItem[],
editable?: Function,
encoded?: boolean,
field?: string,
...
constructor(element: drawing$Element, options?: ui$MaskedTextBoxOptions): this;
destroy(): void;
enable(effects$enable: boolean): void;
readonly(readonly: boolean): void;
raw(): string;
...
constructor(element: drawing$Element, options?: ui$MediaPlayerOptions): this;
fullScreen(): boolean;
...
enable(element: drawing$Element, effects$enable: boolean): kendo$kendo$ui.ui$Menu;
...
insertAfter(item: any, referenceItem: drawing$Element): kendo$kendo$ui.ui$Menu;
...
insertBefore(item: any, referenceItem: drawing$Element): kendo$kendo$ui.ui$Menu;
...
constructor(element: drawing$Element, options?: ui$MultiColumnComboBoxOptions): this;
close(): void;
dataItem(index?: number): any;
destroy(): void;
enable(effects$enable: boolean): void;
...
constructor(element: drawing$Element, options?: ui$MultiSelectOptions): this;
close(): void;
dataItems(): any;
destroy(): void;
enable(effects$enable: boolean): void;
...
constructor(element: drawing$Element, options?: ui$MultiViewCalendarOptions): this;
current(): Date;
destroy(): void;
max(): Date;
max(value: Date): void;
...
constructor(element: drawing$Element, options?: ui$NotificationOptions): this;
...
constructor(element: drawing$Element, options?: ui$NumericTextBoxOptions): this;
destroy(): void;
enable(effects$enable: boolean): void;
readonly(readonly: boolean): void;
focus(): void;
...
append(item: string, referenceItem?: drawing$Element): kendo$kendo$ui.ui$PanelBar;
append(item: string, referenceItem?: JQuery): kendo$kendo$ui.ui$PanelBar;
append(item: drawing$Element, referenceItem?: string): kendo$kendo$ui.ui$PanelBar;
append(
item: drawing$Element,
referenceItem?: drawing$Element): kendo$kendo$ui.ui$PanelBar;
append(item: drawing$Element, referenceItem?: JQuery): kendo$kendo$ui.ui$PanelBar;
append(item: JQuery, referenceItem?: string): kendo$kendo$ui.ui$PanelBar;
append(item: JQuery, referenceItem?: drawing$Element): kendo$kendo$ui.ui$PanelBar;
...
append(item: any, referenceItem?: drawing$Element): kendo$kendo$ui.ui$PanelBar;
append(item: any, referenceItem?: JQuery): kendo$kendo$ui.ui$PanelBar;
clearSelection(): void;
collapse(element: string, useAnimation: boolean): kendo$kendo$ui.ui$PanelBar;
collapse(element: drawing$Element, useAnimation: boolean): kendo$kendo$ui.ui$PanelBar;
collapse(element: JQuery, useAnimation: boolean): kendo$kendo$ui.ui$PanelBar;
destroy(): void;
enable(element: string, effects$enable: boolean): void;
enable(element: drawing$Element, effects$enable: boolean): void;
enable(element: JQuery, effects$enable: boolean): void;
expand(element: string, useAnimation: boolean): kendo$kendo$ui.ui$PanelBar;
expand(element: drawing$Element, useAnimation: boolean): kendo$kendo$ui.ui$PanelBar;
...
insertBefore(item: string, referenceItem: string): kendo$kendo$ui.ui$PanelBar;
insertBefore(item: string, referenceItem: drawing$Element): kendo$kendo$ui.ui$PanelBar;
insertBefore(item: string, referenceItem: JQuery): kendo$kendo$ui.ui$PanelBar;
insertBefore(item: drawing$Element, referenceItem: string): kendo$kendo$ui.ui$PanelBar;
insertBefore(
item: drawing$Element,
referenceItem: drawing$Element): kendo$kendo$ui.ui$PanelBar;
insertBefore(item: drawing$Element, referenceItem: JQuery): kendo$kendo$ui.ui$PanelBar;
insertBefore(item: JQuery, referenceItem: string): kendo$kendo$ui.ui$PanelBar;
insertBefore(item: JQuery, referenceItem: drawing$Element): kendo$kendo$ui.ui$PanelBar;
insertBefore(item: JQuery, referenceItem: JQuery): kendo$kendo$ui.ui$PanelBar;
insertBefore(item: any, referenceItem: string): kendo$kendo$ui.ui$PanelBar;
insertBefore(item: any, referenceItem: drawing$Element): kendo$kendo$ui.ui$PanelBar;
...
constructor(element: drawing$Element, options?: ui$PivotConfiguratorOptions): this;
destroy(): void;
refresh(): void;
...
constructor(element: drawing$Element, options?: ui$ProgressBarOptions): this;
enable(effects$enable: boolean): void;
value(): number;
value(value: number): void
}
...
constructor(element: drawing$Element, options?: ui$RangeSliderOptions): this;
destroy(): void;
enable(effects$enable: boolean): void;
value(): any;
...
constructor(element: drawing$Element, options?: ui$ResponsivePanelOptions): this;
close(): void;
destroy(): void;
open(): void
}
...
constructor(element: drawing$Element, options?: ui$SpreadsheetOptions): this;
...
moveSheetToIndex(sheet: kendo$kendo$spreadsheet.spreadsheet$Sheet, index: number): void;
refresh(): void;
removeSheet(sheet: kendo$kendo$spreadsheet.spreadsheet$Sheet): void;
renameSheet(
sheet: kendo$kendo$spreadsheet.spreadsheet$Sheet,
newSheetName: string): kendo$kendo$spreadsheet.spreadsheet$Sheet;
toJSON(): any;
...
enable(element: string, effects$enable?: boolean): kendo$kendo$ui.ui$TabStrip;
enable(element: drawing$Element, effects$enable?: boolean): kendo$kendo$ui.ui$TabStrip;
enable(element: JQuery, effects$enable?: boolean): kendo$kendo$ui.ui$TabStrip;
insertAfter(item: any, referenceTab: string): kendo$kendo$ui.ui$TabStrip;
insertAfter(item: any, referenceTab: drawing$Element): kendo$kendo$ui.ui$TabStrip;
...
insertAfter(item: string, referenceTab: drawing$Element): kendo$kendo$ui.ui$TabStrip;
insertAfter(item: string, referenceTab: JQuery): kendo$kendo$ui.ui$TabStrip;
insertAfter(item: drawing$Element, referenceTab: string): kendo$kendo$ui.ui$TabStrip;
insertAfter(
item: drawing$Element,
referenceTab: drawing$Element): kendo$kendo$ui.ui$TabStrip;
insertAfter(item: drawing$Element, referenceTab: JQuery): kendo$kendo$ui.ui$TabStrip;
insertAfter(item: JQuery, referenceTab: string): kendo$kendo$ui.ui$TabStrip;
insertAfter(item: JQuery, referenceTab: drawing$Element): kendo$kendo$ui.ui$TabStrip;
...
insertBefore(item: any, referenceTab: drawing$Element): kendo$kendo$ui.ui$TabStrip;
insertBefore(item: any, referenceTab: JQuery): kendo$kendo$ui.ui$TabStrip;
insertBefore(item: string, referenceTab: string): kendo$kendo$ui.ui$TabStrip;
insertBefore(item: string, referenceTab: drawing$Element): kendo$kendo$ui.ui$TabStrip;
insertBefore(item: string, referenceTab: JQuery): kendo$kendo$ui.ui$TabStrip;
insertBefore(item: drawing$Element, referenceTab: string): kendo$kendo$ui.ui$TabStrip;
insertBefore(
item: drawing$Element,
referenceTab: drawing$Element): kendo$kendo$ui.ui$TabStrip;
insertBefore(item: drawing$Element, referenceTab: JQuery): kendo$kendo$ui.ui$TabStrip;
insertBefore(item: JQuery, referenceTab: string): kendo$kendo$ui.ui$TabStrip;
insertBefore(item: JQuery, referenceTab: drawing$Element): kendo$kendo$ui.ui$TabStrip;
insertBefore(item: JQuery, referenceTab: JQuery): kendo$kendo$ui.ui$TabStrip;
...
constructor(element: drawing$Element, options?: drawing$TooltipOptions): this;
...
constructor(element: drawing$Element, options?: ui$ActionSheetOptions): this;
close(): void;
destroy(): void;
...
constructor(element: drawing$Element, options?: ui$CollapsibleOptions): this;
...
constructor(element: drawing$Element, options?: ui$DetailButtonOptions): this;
destroy(): void
}
...
constructor(element: drawing$Element, options?: drawing$LayoutOptions): this
}
...
radiusY: number;
startAngle: number;
constructor(center: any | kendo$kendo$geometry.geometry$Point, options?: geometry$ArcOptions): this;
bbox(
matrix: kendo$kendo$geometry.geometry$Matrix): kendo$kendo$geometry.geometry$Rect;
...
setCenter(value: kendo$kendo$geometry.geometry$Point): kendo$kendo$geometry.geometry$Arc;
...
center: kendo$kendo$geometry.geometry$Point;
radius: number;
constructor(center: any | kendo$kendo$geometry.geometry$Point, radius: number): this;
bbox(
matrix: kendo$kendo$geometry.geometry$Matrix): kendo$kendo$geometry.geometry$Rect;
...
pointAt(angle: number): kendo$kendo$geometry.geometry$Point;
setCenter(
value: kendo$kendo$geometry.geometry$Point): kendo$kendo$geometry.geometry$Point;
...
e: number;
f: number;
static rotate(angle: number, x: number, y: number): kendo$kendo$geometry.geometry$Matrix;
static scale(scaleX: number, scaleY: number): kendo$kendo$geometry.geometry$Matrix;
static translate(x: number, y: number): kendo$kendo$geometry.geometry$Matrix;
...
multiplyCopy(
matrix: kendo$kendo$geometry.geometry$Matrix): kendo$kendo$geometry.geometry$Matrix;
...
y: number): kendo$kendo$geometry.geometry$Point;
...
rotate(
angle: number,
center: kendo$kendo$geometry.geometry$Point): kendo$kendo$geometry.geometry$Point;
...
scaleCopy(scaleX: number, scaleY: number): kendo$kendo$geometry.geometry$Point;
setX(value: number): kendo$kendo$geometry.geometry$Point;
setY(value: number): kendo$kendo$geometry.geometry$Point;
toArray(digits: number): any;
toString(digits: number, separator: string): string;
transform(
tansformation: kendo$kendo$geometry.geometry$Transformation): kendo$kendo$geometry.geometry$Point;
transformCopy(
tansformation: kendo$kendo$geometry.geometry$Transformation): kendo$kendo$geometry.geometry$Point;
translate(dx: number, dy: number): kendo$kendo$geometry.geometry$Point;
translateWith(
vector: kendo$kendo$geometry.geometry$Point): kendo$kendo$geometry.geometry$Point;
...
constructor(origin: kendo$kendo$geometry.geometry$Point | any, size: kendo$kendo$geometry.geometry$Size | any): this;
static fromPoints(
pointA: kendo$kendo$geometry.geometry$Point,
pointB: kendo$kendo$geometry.geometry$Point): kendo$kendo$geometry.geometry$Rect;
static union(
rectA: kendo$kendo$geometry.geometry$Rect,
rectB: kendo$kendo$geometry.geometry$Rect): kendo$kendo$geometry.geometry$Rect;
bbox(
matrix: kendo$kendo$geometry.geometry$Matrix): kendo$kendo$geometry.geometry$Rect;
...
height(): number;
setOrigin(value: kendo$kendo$geometry.geometry$Point): kendo$kendo$geometry.geometry$Rect;
setOrigin(value: any): kendo$kendo$geometry.geometry$Rect;
setSize(value: kendo$kendo$geometry.geometry$Size): kendo$kendo$geometry.geometry$Rect;
...
width: number;
height: number;
static create(width: number, height: number): kendo$kendo$geometry.geometry$Size;
static create(width: any, height: number): kendo$kendo$geometry.geometry$Size;
static create(
width: kendo$kendo$geometry.geometry$Size,
height: number): kendo$kendo$geometry.geometry$Size;
...
multiply(
transformation: kendo$kendo$geometry.geometry$Transformation): kendo$kendo$geometry.geometry$Transformation;
rotate(angle: number, center: any): kendo$kendo$geometry.geometry$Transformation;
rotate(
angle: number,
center: kendo$kendo$geometry.geometry$Point): kendo$kendo$geometry.geometry$Transformation;
scale(scaleX: number, scaleY: number): kendo$kendo$geometry.geometry$Transformation;
translate(x: number, y: number): kendo$kendo$geometry.geometry$Transformation
}
...
declare function drawing$drawDOM(element: JQuery, options: any): JQueryPromise<any>


declare function drawing$exportImage(group: kendo$kendo$drawing.drawing$Group, options: any): JQueryPromise<any>


declare function drawing$exportPDF(
group: kendo$kendo$drawing.drawing$Group,
options: kendo$kendo$drawing.drawing$PDFOptions): JQueryPromise<any>


declare function drawing$exportSVG(group: kendo$kendo$drawing.drawing$Group, options: any): JQueryPromise<any>


declare function drawing$fit(
element: kendo$kendo$drawing.drawing$Element,
rect: kendo$kendo$geometry.geometry$Rect): void
...
declare function drawing$vWrap(elements: any, rect: kendo$kendo$geometry.geometry$Rect): any


declare function drawing$wrap(elements: any, rect: kendo$kendo$geometry.geometry$Rect): any
...
declare function date$setDayOfWeek(targetDate: Date, date$dayOfWeek: number, direction: number): void


declare function date$dayOfWeek(targetDate: Date, date$dayOfWeek: number, direction: number): Date


declare function date$weekInYear(kendo$date: Date, weekStart?: number): number


declare function date$getDate(kendo$date: Date): Date


declare function date$isInDateRange(targetDate: Date, lowerLimitDate: Date, upperLimitDate: Date): boolean


declare function date$isInTimeRange(targetDate: Date, lowerLimitDate: Date, upperLimitDate: Date): boolean
...
declare function date$setTime(targetDate: Date, millisecondsToAdd: number, ignoreDST: boolean): void


declare function date$setHours(targetDate: Date, sourceDate: number): Date


declare function date$addDays(targetDate: Date, numberOfDaysToAdd: number): Date
...
declare function kendo$bind(element: string, viewModel: any, namespace?: any): void
...
declare function kendo$bind(element: JQuery, viewModel: any, namespace?: any): void
...
declare function kendo$bind(element: drawing$Element, viewModel: any, namespace?: any): void
...
declare function kendo$parseDate(value: string, formats?: string, kendo$culture?: string): Date


declare function kendo$parseDate(value: string, formats?: any, kendo$culture?: string): Date


declare function kendo$parseExactDate(value: string, formats?: string, kendo$culture?: string): Date


declare function kendo$parseExactDate(value: string, formats?: any, kendo$culture?: string): Date


declare function kendo$parseFloat(value: string, kendo$culture?: string): number


declare function kendo$parseInt(value: string, kendo$culture?: string): number


declare function kendo$parseColor(color: string, noerror: boolean): kendo$kendo$Color


declare function kendo$prompt(text: string, defaultValue: string): JQueryPromise<any>


declare function kendo$proxyModelSetters(): void


declare function kendo$proxyModelSetters(kendo$data: kendo$kendo$data.data$Model): void
...
declare function kendo$toString(value: number, kendo$format: string, kendo$culture?: string): string
...
declare function timezone$offset(utcTime: Date, kendo$timezone: string): number


declare function timezone$offset(utcTime: number, kendo$timezone: string): number


declare function timezone$convert(targetDate: Date, fromOffset: number, toOffset: number): Date


declare function timezone$convert(targetDate: Date, fromOffset: number, toOffset: string): Date


declare function timezone$convert(targetDate: Date, fromOffset: string, toOffset: number): Date


declare function timezone$convert(targetDate: Date, fromOffset: string, toOffset: string): Date


declare function timezone$apply(targetDate: Date, timezone$offset: number): Date


declare function timezone$apply(targetDate: Date, timezone$offset: string): Date


declare function timezone$remove(targetDate: Date, timezone$offset: number): Date


declare function timezone$remove(targetDate: Date, timezone$offset: string): Date


declare function timezone$abbr(targetDate: Date, kendo$timezone: string): string
...
columnIndex: number,
rowCount?: number,
columnCount?: number): kendo$kendo$spreadsheet.spreadsheet$Range;
rowHeight(): void;
rowHeight(index: number, width?: number): void;
selection(): kendo$kendo$spreadsheet.spreadsheet$Range;
setDataSource(dataSource: kendo$kendo$data.data$DataSource, columns?: any): void;
showGridLines(): boolean;
...
data(key: "kendoAlert"): kendo$kendo$ui.ui$Alert,
kendoArcGauge(): JQuery,
kendoArcGauge(options: kendo$kendo$dataviz.kendo$ui.ui$ArcGaugeOptions): JQuery,
data(key: "kendoArcGauge"): kendo$kendo$dataviz.kendo$ui.ui$ArcGauge,
kendoAutoComplete(): JQuery,
kendoAutoComplete(options: kendo$kendo$ui.ui$AutoCompleteOptions): JQuery,
data(key: "kendoAutoComplete"): kendo$kendo$ui.ui$AutoComplete,
kendoBarcode(): JQuery,
kendoBarcode(options: kendo$kendo$dataviz.kendo$ui.ui$BarcodeOptions): JQuery,
data(key: "kendoBarcode"): kendo$kendo$dataviz.kendo$ui.ui$Barcode,
kendoButton(): JQuery,
kendoButton(options: kendo$kendo$ui.ui$ButtonOptions): JQuery,
data(key: "kendoButton"): kendo$kendo$ui.ui$Button,
kendoButtonGroup(): JQuery,
kendoButtonGroup(options: kendo$kendo$ui.ui$ButtonGroupOptions): JQuery,
data(key: "kendoButtonGroup"): kendo$kendo$ui.ui$ButtonGroup,
kendoCalendar(): JQuery,
kendoCalendar(options: kendo$kendo$ui.ui$CalendarOptions): JQuery,
data(key: "kendoCalendar"): kendo$kendo$ui.ui$Calendar,
kendoChart(): JQuery,
kendoChart(options: kendo$kendo$dataviz.kendo$ui.ui$ChartOptions): JQuery,
data(key: "kendoChart"): kendo$kendo$dataviz.kendo$ui.ui$Chart,
kendoChat(): JQuery,
kendoChat(options: kendo$kendo$ui.ui$ChatOptions): JQuery,
data(key: "kendoChat"): kendo$kendo$ui.ui$Chat,
kendoColorPalette(): JQuery,
kendoColorPalette(options: kendo$kendo$ui.ui$ColorPaletteOptions): JQuery,
data(key: "kendoColorPalette"): kendo$kendo$ui.ui$ColorPalette,
kendoColorPicker(): JQuery,
kendoColorPicker(options: kendo$kendo$ui.ui$ColorPickerOptions): JQuery,
data(key: "kendoColorPicker"): kendo$kendo$ui.ui$ColorPicker,
kendoComboBox(): JQuery,
kendoComboBox(options: kendo$kendo$ui.ui$ComboBoxOptions): JQuery,
data(key: "kendoComboBox"): kendo$kendo$ui.ui$ComboBox,
kendoConfirm(): JQuery,
kendoConfirm(options: kendo$kendo$ui.ui$ConfirmOptions): JQuery,
data(key: "kendoConfirm"): kendo$kendo$ui.ui$Confirm,
kendoContextMenu(): JQuery,
kendoContextMenu(options: kendo$kendo$ui.ui$ContextMenuOptions): JQuery,
data(key: "kendoContextMenu"): kendo$kendo$ui.ui$ContextMenu,
kendoDateInput(): JQuery,
kendoDateInput(options: kendo$kendo$ui.ui$DateInputOptions): JQuery,
data(key: "kendoDateInput"): kendo$kendo$ui.ui$DateInput,
kendoDatePicker(): JQuery,
kendoDatePicker(options: kendo$kendo$ui.ui$DatePickerOptions): JQuery,
data(key: "kendoDatePicker"): kendo$kendo$ui.ui$DatePicker,
kendoDateRangePicker(): JQuery,
kendoDateRangePicker(options: kendo$kendo$ui.ui$DateRangePickerOptions): JQuery,
data(key: "kendoDateRangePicker"): kendo$kendo$ui.ui$DateRangePicker,
kendoDateTimePicker(): JQuery,
kendoDateTimePicker(options: kendo$kendo$ui.ui$DateTimePickerOptions): JQuery,
data(key: "kendoDateTimePicker"): kendo$kendo$ui.ui$DateTimePicker,
kendoDiagram(): JQuery,
kendoDiagram(options: kendo$kendo$dataviz.kendo$ui.ui$DiagramOptions): JQuery,
data(key: "kendoDiagram"): kendo$kendo$dataviz.kendo$ui.ui$Diagram,
kendoDialog(): JQuery,
kendoDialog(options: kendo$kendo$ui.ui$DialogOptions): JQuery,
data(key: "kendoDialog"): kendo$kendo$ui.ui$Dialog,
kendoDraggable(): JQuery,
kendoDraggable(options: kendo$kendo$ui.ui$DraggableOptions): JQuery,
data(key: "kendoDraggable"): kendo$kendo$ui.ui$Draggable,
kendoDropDownList(): JQuery,
kendoDropDownList(options: kendo$kendo$ui.ui$DropDownListOptions): JQuery,
data(key: "kendoDropDownList"): kendo$kendo$ui.ui$DropDownList,
kendoDropDownTree(): JQuery,
kendoDropDownTree(options: kendo$kendo$ui.ui$DropDownTreeOptions): JQuery,
data(key: "kendoDropDownTree"): kendo$kendo$ui.ui$DropDownTree,
kendoDropTarget(): JQuery,
kendoDropTarget(options: kendo$kendo$ui.ui$DropTargetOptions): JQuery,
data(key: "kendoDropTarget"): kendo$kendo$ui.ui$DropTarget,
kendoDropTargetArea(): JQuery,
kendoDropTargetArea(options: kendo$kendo$ui.ui$DropTargetAreaOptions): JQuery,
data(key: "kendoDropTargetArea"): kendo$kendo$ui.ui$DropTargetArea,
kendoEditor(): JQuery,
kendoEditor(options: kendo$kendo$ui.ui$EditorOptions): JQuery,
data(key: "kendoEditor"): kendo$kendo$ui.ui$Editor,
kendoFilterMenu(): JQuery,
kendoFilterMenu(options: kendo$kendo$ui.ui$FilterMenuOptions): JQuery,
data(key: "kendoFilterMenu"): kendo$kendo$ui.ui$FilterMenu,
kendoFlatColorPicker(): JQuery,
kendoFlatColorPicker(options: kendo$kendo$ui.ui$FlatColorPickerOptions): JQuery,
data(key: "kendoFlatColorPicker"): kendo$kendo$ui.ui$FlatColorPicker,
kendoGantt(): JQuery,
kendoGantt(options: kendo$kendo$ui.ui$GanttOptions): JQuery,
data(key: "kendoGantt"): kendo$kendo$ui.ui$Gantt,
kendoGrid(): JQuery,
kendoGrid(options: kendo$kendo$ui.ui$GridOptions): JQuery,
data(key: "kendoGrid"): kendo$kendo$ui.ui$Grid,
kendoLinearGauge(): JQuery,
kendoLinearGauge(options: kendo$kendo$dataviz.kendo$ui.ui$LinearGaugeOptions): JQuery,
data(key: "kendoLinearGauge"): kendo$kendo$dataviz.kendo$ui.ui$LinearGauge,
kendoListBox(): JQuery,
kendoListBox(options: kendo$kendo$ui.ui$ListBoxOptions): JQuery,
data(key: "kendoListBox"): kendo$kendo$ui.ui$ListBox,
kendoListView(): JQuery,
kendoListView(options: kendo$kendo$ui.ui$ListViewOptions): JQuery,
data(key: "kendoListView"): kendo$kendo$ui.ui$ListView,
kendoMap(): JQuery,
kendoMap(options: kendo$kendo$dataviz.kendo$ui.ui$MapOptions): JQuery,
data(key: "kendoMap"): kendo$kendo$dataviz.kendo$ui.ui$Map,
kendoMaskedTextBox(): JQuery,
kendoMaskedTextBox(options: kendo$kendo$ui.ui$MaskedTextBoxOptions): JQuery,
data(key: "kendoMaskedTextBox"): kendo$kendo$ui.ui$MaskedTextBox,
kendoMediaPlayer(): JQuery,
kendoMediaPlayer(options: kendo$kendo$ui.ui$MediaPlayerOptions): JQuery,
data(key: "kendoMediaPlayer"): kendo$kendo$ui.ui$MediaPlayer,
kendoMenu(): JQuery,
kendoMenu(options: kendo$kendo$ui.ui$MenuOptions): JQuery,
data(key: "kendoMenu"): kendo$kendo$ui.ui$Menu,
kendoMobileActionSheet(): JQuery,
kendoMobileActionSheet(options: kendo$kendo$mobile.kendo$ui.ui$ActionSheetOptions): JQuery,
data(key: "kendoMobileActionSheet"): kendo$kendo$mobile.kendo$ui.ui$ActionSheet,
kendoMobileBackButton(): JQuery,
kendoMobileBackButton(options: kendo$kendo$mobile.kendo$ui.ui$BackButtonOptions): JQuery,
data(key: "kendoMobileBackButton"): kendo$kendo$mobile.kendo$ui.ui$BackButton,
kendoMobileButton(): JQuery,
kendoMobileButton(options: kendo$kendo$mobile.kendo$ui.ui$ButtonOptions): JQuery,
data(key: "kendoMobileButton"): kendo$kendo$mobile.kendo$ui.ui$Button,
kendoMobileButtonGroup(): JQuery,
kendoMobileButtonGroup(options: kendo$kendo$mobile.kendo$ui.ui$ButtonGroupOptions): JQuery,
data(key: "kendoMobileButtonGroup"): kendo$kendo$mobile.kendo$ui.ui$ButtonGroup,
kendoMobileCollapsible(): JQuery,
kendoMobileCollapsible(options: kendo$kendo$mobile.kendo$ui.ui$CollapsibleOptions): JQuery,
data(key: "kendoMobileCollapsible"): kendo$kendo$mobile.kendo$ui.ui$Collapsible,
kendoMobileDetailButton(): JQuery,
kendoMobileDetailButton(options: kendo$kendo$mobile.kendo$ui.ui$DetailButtonOptions): JQuery,
data(key: "kendoMobileDetailButton"): kendo$kendo$mobile.kendo$ui.ui$DetailButton,
kendoMobileDrawer(): JQuery,
kendoMobileDrawer(options: kendo$kendo$mobile.kendo$ui.ui$DrawerOptions): JQuery,
data(key: "kendoMobileDrawer"): kendo$kendo$mobile.kendo$ui.ui$Drawer,
kendoMobileLayout(): JQuery,
kendoMobileLayout(options: kendo$kendo$mobile.kendo$ui.ui$LayoutOptions): JQuery,
data(key: "kendoMobileLayout"): kendo$kendo$mobile.kendo$ui.ui$Layout,
kendoMobileListView(): JQuery,
kendoMobileListView(options: kendo$kendo$mobile.kendo$ui.ui$ListViewOptions): JQuery,
data(key: "kendoMobileListView"): kendo$kendo$mobile.kendo$ui.ui$ListView,
kendoMobileLoader(): JQuery,
kendoMobileLoader(options: kendo$kendo$mobile.kendo$ui.ui$LoaderOptions): JQuery,
data(key: "kendoMobileLoader"): kendo$kendo$mobile.kendo$ui.ui$Loader,
kendoMobileModalView(): JQuery,
kendoMobileModalView(options: kendo$kendo$mobile.kendo$ui.ui$ModalViewOptions): JQuery,
data(key: "kendoMobileModalView"): kendo$kendo$mobile.kendo$ui.ui$ModalView,
kendoMobileNavBar(): JQuery,
kendoMobileNavBar(options: kendo$kendo$mobile.kendo$ui.ui$NavBarOptions): JQuery,
data(key: "kendoMobileNavBar"): kendo$kendo$mobile.kendo$ui.ui$NavBar,
kendoMobilePane(): JQuery,
kendoMobilePane(options: kendo$kendo$mobile.kendo$ui.ui$PaneOptions): JQuery,
data(key: "kendoMobilePane"): kendo$kendo$mobile.kendo$ui.ui$Pane,
kendoMobilePopOver(): JQuery,
kendoMobilePopOver(options: kendo$kendo$mobile.kendo$ui.ui$PopOverOptions): JQuery,
data(key: "kendoMobilePopOver"): kendo$kendo$mobile.kendo$ui.ui$PopOver,
kendoMobileScrollView(): JQuery,
kendoMobileScrollView(options: kendo$kendo$mobile.kendo$ui.ui$ScrollViewOptions): JQuery,
data(key: "kendoMobileScrollView"): kendo$kendo$mobile.kendo$ui.ui$ScrollView,
kendoMobileScroller(): JQuery,
kendoMobileScroller(options: kendo$kendo$mobile.kendo$ui.ui$ScrollerOptions): JQuery,
data(key: "kendoMobileScroller"): kendo$kendo$mobile.kendo$ui.ui$Scroller,
kendoMobileSplitView(): JQuery,
kendoMobileSplitView(options: kendo$kendo$mobile.kendo$ui.ui$SplitViewOptions): JQuery,
data(key: "kendoMobileSplitView"): kendo$kendo$mobile.kendo$ui.ui$SplitView,
kendoMobileSwitch(): JQuery,
kendoMobileSwitch(options: kendo$kendo$mobile.kendo$ui.ui$SwitchOptions): JQuery,
data(key: "kendoMobileSwitch"): kendo$kendo$mobile.kendo$ui.ui$Switch,
kendoMobileTabStrip(): JQuery,
kendoMobileTabStrip(options: kendo$kendo$mobile.kendo$ui.ui$TabStripOptions): JQuery,
data(key: "kendoMobileTabStrip"): kendo$kendo$mobile.kendo$ui.ui$TabStrip,
kendoMobileView(): JQuery,
kendoMobileView(options: kendo$kendo$mobile.kendo$ui.ui$ViewOptions): JQuery,
data(key: "kendoMobileView"): kendo$kendo$mobile.kendo$ui.ui$View,
kendoMultiColumnComboBox(): JQuery,
kendoMultiColumnComboBox(options: kendo$kendo$ui.ui$MultiColumnComboBoxOptions): JQuery,
data(key: "kendoMultiColumnComboBox"): kendo$kendo$ui.ui$MultiColumnComboBox,
kendoMultiSelect(): JQuery,
kendoMultiSelect(options: kendo$kendo$ui.ui$MultiSelectOptions): JQuery,
data(key: "kendoMultiSelect"): kendo$kendo$ui.ui$MultiSelect,
kendoMultiViewCalendar(): JQuery,
kendoMultiViewCalendar(options: kendo$kendo$ui.ui$MultiViewCalendarOptions): JQuery,
data(key: "kendoMultiViewCalendar"): kendo$kendo$ui.ui$MultiViewCalendar,
kendoNotification(): JQuery,
kendoNotification(options: kendo$kendo$ui.ui$NotificationOptions): JQuery,
data(key: "kendoNotification"): kendo$kendo$ui.ui$Notification,
kendoNumericTextBox(): JQuery,
kendoNumericTextBox(options: kendo$kendo$ui.ui$NumericTextBoxOptions): JQuery,
data(key: "kendoNumericTextBox"): kendo$kendo$ui.ui$NumericTextBox,
kendoPager(): JQuery,
kendoPager(options: kendo$kendo$ui.ui$PagerOptions): JQuery,
data(key: "kendoPager"): kendo$kendo$ui.ui$Pager,
kendoPanelBar(): JQuery,
kendoPanelBar(options: kendo$kendo$ui.ui$PanelBarOptions): JQuery,
data(key: "kendoPanelBar"): kendo$kendo$ui.ui$PanelBar,
kendoPivotConfigurator(): JQuery,
kendoPivotConfigurator(options: kendo$kendo$ui.ui$PivotConfiguratorOptions): JQuery,
data(key: "kendoPivotConfigurator"): kendo$kendo$ui.ui$PivotConfigurator,
kendoPivotGrid(): JQuery,
kendoPivotGrid(options: kendo$kendo$ui.ui$PivotGridOptions): JQuery,
data(key: "kendoPivotGrid"): kendo$kendo$ui.ui$PivotGrid,
kendoPopup(): JQuery,
kendoPopup(options: kendo$kendo$ui.ui$PopupOptions): JQuery,
data(key: "kendoPopup"): kendo$kendo$ui.ui$Popup,
kendoProgressBar(): JQuery,
kendoProgressBar(options: kendo$kendo$ui.ui$ProgressBarOptions): JQuery,
data(key: "kendoProgressBar"): kendo$kendo$ui.ui$ProgressBar,
kendoPrompt(): JQuery,
kendoPrompt(options: kendo$kendo$ui.ui$PromptOptions): JQuery,
data(key: "kendoPrompt"): kendo$kendo$ui.ui$Prompt,
kendoQRCode(): JQuery,
kendoQRCode(options: kendo$kendo$dataviz.kendo$ui.ui$QRCodeOptions): JQuery,
data(key: "kendoQRCode"): kendo$kendo$dataviz.kendo$ui.ui$QRCode,
kendoRadialGauge(): JQuery,
kendoRadialGauge(options: kendo$kendo$dataviz.kendo$ui.ui$RadialGaugeOptions): JQuery,
data(key: "kendoRadialGauge"): kendo$kendo$dataviz.kendo$ui.ui$RadialGauge,
kendoRangeSlider(): JQuery,
kendoRangeSlider(options: kendo$kendo$ui.ui$RangeSliderOptions): JQuery,
data(key: "kendoRangeSlider"): kendo$kendo$ui.ui$RangeSlider,
kendoResponsivePanel(): JQuery,
kendoResponsivePanel(options: kendo$kendo$ui.ui$ResponsivePanelOptions): JQuery,
data(key: "kendoResponsivePanel"): kendo$kendo$ui.ui$ResponsivePanel,
kendoScheduler(): JQuery,
kendoScheduler(options: kendo$kendo$ui.ui$SchedulerOptions): JQuery,
data(key: "kendoScheduler"): kendo$kendo$ui.ui$Scheduler,
kendoScrollView(): JQuery,
kendoScrollView(options: kendo$kendo$ui.ui$ScrollViewOptions): JQuery,
data(key: "kendoScrollView"): kendo$kendo$ui.ui$ScrollView,
kendoSlider(): JQuery,
kendoSlider(options: kendo$kendo$ui.ui$SliderOptions): JQuery,
data(key: "kendoSlider"): kendo$kendo$ui.ui$Slider,
kendoSortable(): JQuery,
kendoSortable(options: kendo$kendo$ui.ui$SortableOptions): JQuery,
data(key: "kendoSortable"): kendo$kendo$ui.ui$Sortable,
kendoSparkline(): JQuery,
kendoSparkline(options: kendo$kendo$dataviz.kendo$ui.ui$SparklineOptions): JQuery,
data(key: "kendoSparkline"): kendo$kendo$dataviz.kendo$ui.ui$Sparkline,
kendoSplitter(): JQuery,
kendoSplitter(options: kendo$kendo$ui.ui$SplitterOptions): JQuery,
data(key: "kendoSplitter"): kendo$kendo$ui.ui$Splitter,
kendoSpreadsheet(): JQuery,
kendoSpreadsheet(options: kendo$kendo$ui.ui$SpreadsheetOptions): JQuery,
data(key: "kendoSpreadsheet"): kendo$kendo$ui.ui$Spreadsheet,
kendoStockChart(): JQuery,
kendoStockChart(options: kendo$kendo$dataviz.kendo$ui.ui$StockChartOptions): JQuery,
data(key: "kendoStockChart"): kendo$kendo$dataviz.kendo$ui.ui$StockChart,
kendoSwitch(): JQuery,
kendoSwitch(options: kendo$kendo$ui.ui$SwitchOptions): JQuery,
data(key: "kendoSwitch"): kendo$kendo$ui.ui$Switch,
kendoTabStrip(): JQuery,
kendoTabStrip(options: kendo$kendo$ui.ui$TabStripOptions): JQuery,
data(key: "kendoTabStrip"): kendo$kendo$ui.ui$TabStrip,
kendoTimePicker(): JQuery,
kendoTimePicker(options: kendo$kendo$ui.ui$TimePickerOptions): JQuery,
data(key: "kendoTimePicker"): kendo$kendo$ui.ui$TimePicker,
kendoToolBar(): JQuery,
kendoToolBar(options: kendo$kendo$ui.ui$ToolBarOptions): JQuery,
data(key: "kendoToolBar"): kendo$kendo$ui.ui$ToolBar,
kendoTooltip(): JQuery,
kendoTooltip(options: kendo$kendo$ui.ui$TooltipOptions): JQuery,
data(key: "kendoTooltip"): kendo$kendo$ui.ui$Tooltip,
kendoTouch(): JQuery,
kendoTouch(options: kendo$kendo$ui.ui$TouchOptions): JQuery,
data(key: "kendoTouch"): kendo$kendo$ui.ui$Touch,
kendoTreeList(): JQuery,
kendoTreeList(options: kendo$kendo$ui.ui$TreeListOptions): JQuery,
data(key: "kendoTreeList"): kendo$kendo$ui.ui$TreeList,
kendoTreeMap(): JQuery,
kendoTreeMap(options: kendo$kendo$dataviz.kendo$ui.ui$TreeMapOptions): JQuery,
data(key: "kendoTreeMap"): kendo$kendo$dataviz.kendo$ui.ui$TreeMap,
kendoTreeView(): JQuery,
kendoTreeView(options: kendo$kendo$ui.ui$TreeViewOptions): JQuery,
data(key: "kendoTreeView"): kendo$kendo$ui.ui$TreeView,
kendoUpload(): JQuery,
kendoUpload(options: kendo$kendo$ui.ui$UploadOptions): JQuery,
data(key: "kendoUpload"): kendo$kendo$ui.ui$Upload,
kendoValidator(): JQuery,
kendoValidator(options: kendo$kendo$ui.ui$ValidatorOptions): JQuery,
data(key: "kendoValidator"): kendo$kendo$ui.ui$Validator,
kendoWindow(): JQuery,
kendoWindow(options: kendo$kendo$ui.ui$WindowOptions): JQuery,
data(key: "kendoWindow"): kendo$kendo$ui.ui$Window
} 
    }
