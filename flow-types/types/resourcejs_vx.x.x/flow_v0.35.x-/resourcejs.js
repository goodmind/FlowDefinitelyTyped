...
route: string,
modelName: string,
model: mongoose.Model<mongoose.Document>): resourcejs$resourcejs$ResourceEndpoint
...
declare type resourcejs$MethodBuild<T> = (options?: T) => resourcejs$ResourceEndpoint;
...
getMethodOptions: (method: string, options: {[key: string]: any}) => {[key: string]: any},
