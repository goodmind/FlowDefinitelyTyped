declare module "fs-plus" {
   ...
   */
  declare export function isSymbolicLink(
    symlinkPath: string,
    callback: (result: boolean) => void
  ): void;
   ...
   */
  declare export function listSync(
    rootPath: string,
    extensions?: string[]
  ): string[];
   ...
   */
  declare export function copyFileSync(
    source: string,
    target: string,
    bufferSize?: number
  ): void;
   ...
   */
  declare export function makeTree(
    directoryPath: string,
    callback: (err: any) => void
  ): void;
   ...
   */
  declare export function resolveOnLoadPath(
    pathToResolve: string,
    extensions?: string[]
  ): string | void;
   ...
   */
  declare export function resolveExtension(
    pathToResolve: string,
    extensions: string[]
  ): string | void;
