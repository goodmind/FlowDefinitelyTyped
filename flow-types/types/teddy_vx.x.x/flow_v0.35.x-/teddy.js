declare module 'teddy' {
	...
	declare export function render(template: string, model: {[key: string]: any}): string
	...
	declare export function setCacheBlacklist(templateArray: $ReadOnlyArray<string>): void

	declare export function setDefaultParams(): void

	declare export function flushCache(template: string, model?: {[key: string]: any}): void
