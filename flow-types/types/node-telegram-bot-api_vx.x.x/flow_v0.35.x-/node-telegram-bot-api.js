...
declare type TelegramBot$ChatType = "private" | "group" | "supergroup" | "channel";

declare type TelegramBot$ChatAction = "typing"
| "upload_photo"
| "record_video"
| "upload_video"
| "record_audio"
...
declare type TelegramBot$ChatMemberStatus = "creator"
| "administrator"
| "member"
| "restricted"
| "left"
...
declare type TelegramBot$DocumentMimeType = "application/pdf" | "application/zip";

declare type TelegramBot$MessageType = "text"
| "animation"
| "audio"
...
declare type TelegramBot$MessageEntityType = "mention"
| "hashtag"
| "bot_command"
| "url"
| "email"
...
declare type TelegramBot$InputMedia = TelegramBot$InputMediaPhoto | TelegramBot$InputMediaVideo;
...
declare type TelegramBot$InlineQueryResult = TelegramBot$InlineQueryResultCachedAudio
...
constructor(token: string, options?: TelegramBot$TelegramBot$ConstructorOptions): this;
startPolling(options?: TelegramBot$TelegramBot$StartPollingOptions): Promise<any>;
stopPolling(options?: TelegramBot$TelegramBot$StopPollingOptions): Promise<any>;
isPolling(): boolean;
openWebHook(): Promise<any>;
closeWebHook(): Promise<any>;
hasOpenWebHook(): boolean;
getMe(): Promise<TelegramBot$TelegramBot$User>;
setWebHook(url: string, options?: TelegramBot$TelegramBot$SetWebHookOptions): Promise<any>;
deleteWebHook(): Promise<boolean>;
getWebHookInfo(): Promise<TelegramBot$TelegramBot$WebhookInfo>;
getUpdates(
options?: TelegramBot$TelegramBot$GetUpdatesOptions): Promise<TelegramBot$TelegramBot$Update[]>;
processUpdate(update: TelegramBot$TelegramBot$Update): void;
sendMessage(
chatId: number | string,
text: string,
options?: TelegramBot$TelegramBot$SendMessageOptions): Promise<TelegramBot$TelegramBot$Message>;
answerInlineQuery(
inlineQueryId: string,
results: $ReadOnlyArray<TelegramBot$TelegramBot$InlineQueryResult>,
options?: TelegramBot$TelegramBot$AnswerInlineQueryOptions): Promise<boolean>;
forwardMessage(
chatId: number | string,
fromChatId: number | string,
messageId: number | string,
options?: TelegramBot$TelegramBot$ForwardMessageOptions): Promise<TelegramBot$TelegramBot$Message>;
sendPhoto(
chatId: number | string,
photo: string | Stream | Buffer,
options?: TelegramBot$TelegramBot$SendPhotoOptions): Promise<TelegramBot$TelegramBot$Message>;
sendAudio(
chatId: number | string,
audio: string | Stream | Buffer,
options?: TelegramBot$TelegramBot$SendAudioOptions): Promise<TelegramBot$TelegramBot$Message>;
sendDocument(
chatId: number | string,
doc: string | Stream | Buffer,
options?: TelegramBot$TelegramBot$SendDocumentOptions,
fileOpts?: any): Promise<TelegramBot$TelegramBot$Message>;
sendMediaGroup(
chatId: number | string,
media: $ReadOnlyArray<TelegramBot$TelegramBot$InputMedia>,
options?: TelegramBot$TelegramBot$SendMediaGroupOptions): Promise<TelegramBot$TelegramBot$Message>;
sendSticker(
chatId: number | string,
sticker: string | Stream | Buffer,
options?: TelegramBot$TelegramBot$SendStickerOptions): Promise<TelegramBot$TelegramBot$Message>;
sendVideo(
chatId: number | string,
video: string | Stream | Buffer,
options?: TelegramBot$TelegramBot$SendVideoOptions): Promise<TelegramBot$TelegramBot$Message>;
sendVideoNote(
chatId: number | string,
videoNote: string | Stream | Buffer,
options?: TelegramBot$TelegramBot$SendVideoNoteOptions): Promise<TelegramBot$TelegramBot$Message>;
sendVoice(
chatId: number | string,
voice: string | Stream | Buffer,
options?: TelegramBot$TelegramBot$SendVoiceOptions): Promise<TelegramBot$TelegramBot$Message>;
sendChatAction(
chatId: number | string,
action: TelegramBot$TelegramBot$ChatAction): Promise<boolean>;
...
chatId: number | string,
userId: string,
options?: TelegramBot$TelegramBot$RestrictChatMemberOptions): Promise<boolean>;
promoteChatMember(
chatId: number | string,
userId: string,
options?: TelegramBot$TelegramBot$PromoteChatMemberOptions): Promise<boolean>;
...
options?: $Shape<TelegramBot$TelegramBot$AnswerCallbackQueryOptions>): Promise<boolean>;

/**
 * @deprecated since version 0.30.0
 */
answerCallbackQuery(options?: TelegramBot$TelegramBot$AnswerCallbackQueryOptions): Promise<boolean>;
editMessageText(
text: string,
options?: TelegramBot$TelegramBot$EditMessageTextOptions): Promise<TelegramBot$TelegramBot$Message | boolean>;
editMessageCaption(
caption: string,
options?: TelegramBot$TelegramBot$EditMessageCaptionOptions): Promise<TelegramBot$TelegramBot$Message | boolean>;
editMessageReplyMarkup(
replyMarkup: TelegramBot$TelegramBot$InlineKeyboardMarkup,
options?: TelegramBot$TelegramBot$EditMessageReplyMarkupOptions): Promise<TelegramBot$TelegramBot$Message | boolean>;
getUserProfilePhotos(
userId: number | string,
options?: TelegramBot$TelegramBot$GetUserProfilePhotosOptions): Promise<TelegramBot$TelegramBot$UserProfilePhotos>;
sendLocation(
chatId: number | string,
latitude: number,
longitude: number,
options?: TelegramBot$TelegramBot$SendLocationOptions): Promise<TelegramBot$TelegramBot$Message>;
editMessageLiveLocation(
latitude: number,
longitude: number,
options?: TelegramBot$TelegramBot$EditMessageLiveLocationOptions): Promise<TelegramBot$TelegramBot$Message | boolean>;
stopMessageLiveLocation(
options?: TelegramBot$TelegramBot$StopMessageLiveLocationOptions): Promise<TelegramBot$TelegramBot$Message | boolean>;
sendVenue(
chatId: number | string,
latitude: number,
longitude: number,
title: string,
address: string,
options?: TelegramBot$TelegramBot$SendVenueOptions): Promise<TelegramBot$TelegramBot$Message>;
sendContact(
chatId: number | string,
phoneNumber: string,
firstName: string,
options?: TelegramBot$TelegramBot$SendContactOptions): Promise<TelegramBot$TelegramBot$Message>;
...
onText(
regexp: RegExp,
callback: ((msg: TelegramBot$TelegramBot$Message, match: RegExpExecArray | null) => void)): void;
removeTextListener(regexp: RegExp): TelegramBot$TelegramBot$TextListener | null;
onReplyToMessage(
chatId: number | string,
messageId: number | string,
callback: ((msg: TelegramBot$TelegramBot$Message) => void)): number;
removeReplyListener(replyListenerId: number): TelegramBot$TelegramBot$ReplyListener;
getChat(chatId: number | string): Promise<TelegramBot$TelegramBot$Chat>;
getChatAdministrators(chatId: number | string): Promise<TelegramBot$TelegramBot$ChatMember[]>;
getChatMembersCount(chatId: number | string): Promise<number>;
getChatMember(
chatId: number | string,
userId: string): Promise<TelegramBot$TelegramBot$ChatMember>;
...
options?: TelegramBot$TelegramBot$SendGameOptions): Promise<TelegramBot$TelegramBot$Message>;
setGameScore(
userId: string,
score: number,
options?: TelegramBot$TelegramBot$SetGameScoreOptions): Promise<TelegramBot$TelegramBot$Message | boolean>;
getGameHighScores(
userId: string,
options?: TelegramBot$TelegramBot$GetGameHighScoresOptions): Promise<TelegramBot$TelegramBot$GameHighScore[]>;
...
options?: TelegramBot$TelegramBot$SendInvoiceOptions): Promise<TelegramBot$TelegramBot$Message>;
answerShippingQuery(
shippingQueryId: string,
ok: boolean,
options?: TelegramBot$TelegramBot$AnswerShippingQueryOptions): Promise<boolean>;
answerPreCheckoutQuery(
preCheckoutQueryId: string,
ok: boolean,
options?: TelegramBot$TelegramBot$AnswerPreCheckoutQueryOptions): Promise<boolean>;
addListener(
event: TelegramBot$TelegramBot$MessageType | "message",
listener: (
message: TelegramBot$TelegramBot$Message,
metadata: TelegramBot$TelegramBot$Metadata) => void): this;
addListener(
event: "callback_query",
listener: (query: TelegramBot$TelegramBot$CallbackQuery) => void): this;
addListener(
event: "inline_query",
listener: (query: TelegramBot$TelegramBot$InlineQuery) => void): this;
addListener(
event: "chosen_inline_result",
listener: (result: TelegramBot$TelegramBot$ChosenInlineResult) => void): this;
addListener(
event: "channel_post"
| "edited_message"
| "edited_message_text"
...
listener: (message: TelegramBot$TelegramBot$Message) => void): this;
addListener(
event: "shipping_query",
listener: (query: TelegramBot$TelegramBot$ShippingQuery) => void): this;
addListener(
event: "pre_checkout_query",
listener: (query: TelegramBot$TelegramBot$PreCheckoutQuery) => void): this;
addListener(
...
listener: (error: Error) => void): this;
removeAllListeners(
event: TelegramBot$TelegramBot$MessageType
| "message"
| "callback_query"
| "inline_query"
...
| "polling_error"
| "webhook_error"
| "error"): Array<(data: any, metadata?: TelegramBot$TelegramBot$Metadata) => void>;
rawListeners(
event: TelegramBot$TelegramBot$MessageType
| "message"
| "callback_query"
...
| "error"): Array<(data: any, metadata?: TelegramBot$TelegramBot$Metadata) => void>;
eventNames(
): Array<TelegramBot$TelegramBot$MessageType
| "message"
| "callback_query"
| "inline_query"
| "chosen_inline_result"
