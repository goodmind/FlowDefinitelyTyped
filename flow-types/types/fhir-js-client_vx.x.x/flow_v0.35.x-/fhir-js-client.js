...
Reject: (error:any) => { console.log(error); }
 */
fetchAllWithReferences(params: SMART$SearchParams, resolveParams: string[]): any,
 ...
 */
declare type SMART$ResolveFn = (resource: SMART$Resource, reference: SMART$Reference) => SMART$Resource;
...
...property: string[]): (...codes: string[]) => SMART$Resource[],
...
byCode(
observations: SMART$Resource | SMART$Resource[],
property: string): SMART$ObservationsByCode,
 ...
 */
authorize(params: SMART$OAuth2Configuration, errback?: (...args: any[]) => void): void,
 ...
 */
declare function FHIR$client(context: SMART$SMART$Context): SMART$SMART$Client
