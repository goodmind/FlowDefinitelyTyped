declare module "mjml-react" {
  ...
  declare class extensions$MjmlConditionalComment
    mixins React.Component<{
        children: string,
        condition: string
      }> {}

  declare class extensions$MjmlTrackingPixel
    mixins React.Component<{
        src: string
      }> {}

  declare class extensions$MjmlYahooStyle
    mixins React.Component<{
        children: string
      }> {}
  ...
  declare function utils$fixConditionalComment(
    html: string,
  ...
  declare function utils$addQueryParams(
    url: string,
    params: {
      [key: string]: any
    }
  ...
  declare type utils$TextAlignment =
    | "left"
    | "right"
    | "center"
    | "justify"
  ...
  declare function utils$getTextAlign(
    value: string,
    fallback?: utils$TextAlignment
  ): utils$TextAlignment;
  ...
  declare export class Mjml
    mixins React.Component<MjmlProps & RequiredChildrenProps> {}
  declare export class MjmlHead mixins React.Component<RequiredChildrenProps> {}
  declare export class MjmlAttributes
    mixins React.Component<RequiredChildrenProps> {}
  declare export class MjmlAll
    mixins React.Component<{
        [key: string]: any,
        children?: React.ReactNode
      }> {}
  declare export class MjmlClass
    mixins React.Component<{
        [key: string]: any,
        children?: React.ReactNode,
        name: string
  ...
  declare export class MjmlBreakpoint
    mixins React.Component<MjmlBreakpointProps> {}
  declare export interface MjmlBodyProps {
    width?: number;
    backgroundColor?: $ElementType<React.CSSProperties, "backgroundColor">;
  }
  declare export class MjmlBody
    mixins React.Component<
        RequiredChildrenProps & MjmlBodyProps & ClassNameProps
      > {}
  ...
  declare export class MjmlPreview
    mixins React.Component<{
        children: string
      }> {}
  declare export class MjmlStyle
    mixins React.Component<{
        children: string,
        inline?: boolean
      }> {}
  declare export class MjmlTitle
    mixins React.Component<{
        children: string
      }> {}
  declare export class MjmlAccordion
    mixins React.Component<RequiredChildrenProps & MjmlAccordionElementProps> {}
  ...
  declare export class MjmlAccordionElement
    mixins React.Component<
  ...
  declare export class MjmlAccordionText
    mixins React.Component<
  ...
  declare export class MjmlAccordionTitle
    mixins React.Component<
        RequiredChildrenProps &
  ...
  declare export interface MjmlButtonProps {
    backgroundColor?: $ElementType<React.CSSProperties, "backgroundColor">;
    containerBackgroundColor?: $ElementType<
      React.CSSProperties,
      "backgroundColor"
    >;
    fontStyle?: string;
  ...
  declare export class MjmlButton
    mixins React.Component<
        RequiredChildrenProps &
          MjmlButtonProps &
          PaddingProps &
  ...
  declare export class MjmlCarousel
    mixins React.Component<
        RequiredChildrenProps & MjmlCarouselProps & ClassNameProps
      > {}
  ...
  declare export class MjmlCarouselImage
    mixins React.Component<
  ...
  declare export class MjmlColumn
    mixins React.Component<
        RequiredChildrenProps &
          MjmlColumnProps &
          PaddingProps &
  ...
  declare export class MjmlDivider
    mixins React.Component<MjmlDividerProps & ClassNameProps & PaddingProps> {}
  declare export interface MjmlGroupProps {
    width?: string | number;
    verticalAlign?: $ElementType<React.CSSProperties, "verticalAlign">;
    backgroundColor?: $ElementType<React.CSSProperties, "backgroundColor">;
  }
  declare export class MjmlGroup
    mixins React.Component<
        MjmlGroupProps & RequiredChildrenProps & ClassNameProps
      > {}
  declare export interface MjmlHeroProps {
    ...
    backgroundPosition?: $ElementType<
      React.CSSProperties,
      "backgroundPosition"
    >;
    verticalAlign?: $ElementType<React.CSSProperties, "verticalAlign">;
  ...
  declare export class MjmlHero
    mixins React.Component<MjmlHeroProps & ClassNameProps & PaddingProps> {}
  ...
  declare export class MjmlImage
    mixins React.Component<
  ...
  declare export class MjmlNavbar
    mixins React.Component<MjmlNavbarProps & RequiredChildrenProps> {}
  ...
  declare export class MjmlNavbarLink
    mixins React.Component<MjmlNavbarLinkProps & HrefProps & PaddingProps> {}
  ...
  declare export class MjmlSection
    mixins React.Component<
        MjmlSectionProps &
          RequiredChildrenProps &
          BorderProps &
  ...
  declare export class MjmlSocial
    mixins React.Component<MjmlSocialProps & PaddingProps> {}
  ...
  declare export class MjmlSocialElement
    mixins React.Component<
  ...
  declare export class MjmlSpacer
    mixins React.Component<
  ...
  declare export class MjmlTable
    mixins React.Component<
        MjmlTableProps & RequiredChildrenProps & PaddingProps
      > {}
  ...
  declare export class MjmlWrapper
    mixins React.Component<
        MjmlWrapperProps &
          RequiredChildrenProps &
          BorderProps &
