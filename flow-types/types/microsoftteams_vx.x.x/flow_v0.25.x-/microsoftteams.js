declare module "microsoftteams" {
   ...
   */
  declare function microsoftTeams$getContext(
    callback: (context: microsoftTeams$Context) => void
  ): void;
   ...
   */
  declare function microsoftTeams$registerOnThemeChangeHandler(
   ...
   */
  declare function microsoftTeams$registerFullScreenHandler(
  ...
  declare function microsoftTeams$getTabInstances(
    ...
    tabInstanceParameters?: microsoftTeams$TabInstanceParameters
  ): void;
   ...
   */
  declare function microsoftTeams$shareDeepLink(
    deepLinkParameters: microsoftTeams$DeepLinkParameters
  ): void;
   ...
   */
  declare function microsoftTeams$navigateToTab(
