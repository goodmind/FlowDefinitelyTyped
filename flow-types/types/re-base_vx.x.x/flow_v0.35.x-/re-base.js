declare module 're-base' {
        declare export interface RebaseBinding {
context: {[key: string]: any},
endpoint: string,
id: number,
method: string
} 
	declare export interface SyncStateOptions {
 ...
 * empty array)
 */
defaultValue?: string | boolean | number | {[key: string]: any},
...
onFailure?: () => void
	...
	declare export interface BindToStateOptions {
...
onFailure?: () => void
	...
	declare export interface ListenToOptions {
...
queries?: {[key: string]: any}
	...
	declare export interface PostOptions {
...
then?: (result: any) => void
	...
	declare export interface bindDocOptions {
...
onFailure?: () => void
	...
	declare export interface listenToDocOptions {
...
onFailure?: () => void
	...
	declare export interface bindCollectionOptions {
...
onFailure?: () => void
	...
	declare export interface listenToCollectionOptions {
...
withRefs?: boolean
	...
	declare export interface removeFromCollectionOptions {
...
query?: () => void
	...
	declare export interface syncDocOptions {
...
onFailure?: () => void
	...
	declare export interface Rebase {
 ...
 */
bindDoc(
refOrPath: {[key: string]: any} | string,
options: bindDocOptions): {[key: string]: any},
...
listenToDoc(
refOrPath: {[key: string]: any} | string,
options: listenToDocOptions): {[key: string]: any},
...
bindCollection(
refOrPath: {[key: string]: any} | string,
options: bindCollectionOptions): RebaseBinding,
...
listenToCollection(
refOrPath: {[key: string]: any} | string,
options: listenToCollectionOptions): RebaseBinding,
 ...
 */
get(
refOrPath: {[key: string]: any} | {[key: string]: any} | string,
options: listenToCollectionOptions): Promise<any>,
...
refOrPath: {[key: string]: any} | string,
options: removeFromCollectionOptions): Promise<any>,
...
syncDoc(
refOrPath: {[key: string]: any} | string,
options: syncDocOptions): {[key: string]: any},
 ...
 * @param ref The return value of syncState`, `bindToState`, `listenTo`,
     ...
     *
 */
removeBinding(ref: {[key: string]: any}): void,
 ...
 */
declare export function createClass(database: {[key: string]: any}): Rebase
