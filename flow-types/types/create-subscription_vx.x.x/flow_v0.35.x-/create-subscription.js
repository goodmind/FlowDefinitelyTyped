...
source: S
	...
	declare export type Subscription<S, T> = {} & React.ComponentClass<SubscriptionProps<S, T>>

	declare export function createSubscription<S, T>(config: SubscriptionConfig<S, T>): Subscription<S, T>
