declare module 'react-bootstrap-typeahead' {
	...
	declare export type StringPropertyNames<T: {[key: string]: any}> = $ElementType<$ObjMapi<T, <K>(K) => "There was Conditional Type, use $Call utility type">, $Keys<T>>;
	...
	declare export type TypeaheadLabelKey<T: TypeaheadModel> = "There was Conditional Type, use $Call utility type";
	declare export type InputProps = {} & Omit<React.InputHTMLAttributes<"input">, "onBlur" | "onChange" | "onFocus" | "onKeyDown">
...
selected: T[]
	...
	declare export type HintedInputContextKeys = "hintText" | "initialItem" | "onAdd" | "selectHintOnEnter";
	declare export type HintedInputContext<T: TypeaheadModel> = {} & Pick<TypeaheadContext<T>, HintedInputContextKeys>

	declare export type MenuItemContextKeys = "activeIndex"
| "isOnlyResult"
| "onActiveItemChange"
| "onInitialItemChange"
| "onMenuItemClick";
	declare export type MenuItemContext<T: TypeaheadModel> = {} & Pick<TypeaheadContext<T>, MenuItemContextKeys>
...
selectHintOnEnter?: boolean
	...
	declare export type AllTypeaheadOwnAndInjectedProps<T: TypeaheadModel> = TypeaheadProps<T> & TypeaheadContainerProps<T>;
	declare export class Typeahead<T: TypeaheadModel> mixins React.Component<TypeaheadProps<T>> {}
...
useCache?: boolean
	...
	declare export class AsyncTypeahead<T: TypeaheadModel> mixins React.Component<AsyncTypeaheadProps<T>> {}
	declare export type BaseTypeaheadInputProps = {
type: "text"
} & React.InputHTMLAttributes<"input">

	declare export type TypeaheadSingleInputWithHocProps<T: TypeaheadModel> = {} & Omit<BaseTypeaheadInputProps, $Keys<InputContainerPropsSingle<T>>> & InputContainerPropsSingle<T>

	declare export type TypeaheadMulitInputWithHocProps<T: TypeaheadModel> = {} & Omit<BaseTypeaheadInputProps, $Keys<InputContainerPropsMultiple<T>>> & HintedInputContext<T> & InputContainerPropsMultiple<T>

	declare export type TypeaheadInputPropKeys = "bsSize"
| "disabled"
| "inputProps"
| "labelKey"
| "multiple"
...
| "renderToken"
| "selected";
	declare export type TypeaheadInputProps<T: TypeaheadModel> = Pick<TypeaheadProps<T>, TypeaheadInputPropKeys>;
	declare export class TypeaheadInputSingle<T: TypeaheadModel> mixins React.Component<TypeaheadSingleInputWithHocProps<T>> {}
	declare export class TypeaheadInputMulti<T: TypeaheadModel> mixins React.Component<TypeaheadMulitInputWithHocProps<T>> {}
	declare export interface HighligherProps {
children: React.ReactNode,
search: string
} 
	declare export class Highlighter mixins React.PureComponent<HighligherProps> {}
...
style: React.CSSProperties
	...
	declare export class AutosizeInput mixins React.Component<AutosizeInputProps> {}
...
text?: string
	...
	declare export type MenuHeaderProps = Omit<React.HTMLProps<"li">, "className">;
...
static Header: React.FunctionComponent<MenuHeaderProps>
	...
	declare export type TypeaheadMenuPropsPick = "labelKey" | "newSelectionPrefix" | "options" | "renderMenuItemChildren";
	declare export type TypeaheadMenuProps<T: TypeaheadModel> = {} & MenuProps & Pick<AllTypeaheadOwnAndInjectedProps<T>, TypeaheadMenuPropsPick>

	declare export class TypeaheadMenu<T: TypeaheadModel> mixins React.Component<TypeaheadMenuProps<T>> {}
...
label?: string
	...
	declare export class MenuItem<T: TypeaheadModel> mixins React.Component<MenuItemProps<T>> {}
	declare export type OverlayTypeaheadProps = Pick<TypeaheadProps<any>, "align"
| "dropup"
| "flip"
| "onMenuHide"
| "onMenuShow"
