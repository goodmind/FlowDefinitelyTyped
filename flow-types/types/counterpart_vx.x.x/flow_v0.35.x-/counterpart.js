declare module 'counterpart' {
        declare type NotFoundHandler = (locale: string, key: string, fallback: string, scope: string) => void;
	declare type LocaleChangeHandler = (newLocale: string, oldLocale: string) => void;
...
setKeyTransformer(callback: (value: string, options: {[key: string]: any}) => string): string,
