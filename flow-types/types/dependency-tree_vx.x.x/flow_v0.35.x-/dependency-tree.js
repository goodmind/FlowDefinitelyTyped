...
declare function dependencyTree$toList(options: dependencyTree$Options): string[]

	declare function dependencyTree(
options: dependencyTree$dependencyTree$Options): dependencyTree$dependencyTree$DependencyObj
