...
relative(ratio: number): (ms: number) => Promise<void>
	...
	declare export type MatchBy<T, R> = (input: T) => R;
...
passthrough(): void
	...
	declare export type RequestEventListener = (req: Request) => EventListenerResponse;
	declare export type RecordingEventListener = (req: Request, recording: any) => EventListenerResponse;
	declare export type ResponseEventListener = (req: Request, res: Response) => EventListenerResponse;
	declare export type InterceptHandler = (req: Request, res: Response, intercept: Intercept) => EventListenerResponse;
...
intercept(
fn: (req: Request, res: Response, intercept: Intercept) => EventListenerResponse): RouteHandler;
