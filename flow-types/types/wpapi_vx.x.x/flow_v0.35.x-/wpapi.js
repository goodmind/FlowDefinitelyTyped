...
namespace: string,
restBase: string,
options?: WPAPI$WPAPI$RegisterRouteOptions): WPAPI$WPAPI$WPRequestFactory;
...
value?: string | number | any[]): WPAPI$WPRequest;
 ...
 */
setPathPart(level: number | string, value: number | string): WPAPI$WPRequest;
...
failureCallback?: (error: Error) => void): Promise<any>;
...
declare type WPAPI$TransportFunction = (wpreq: WPAPI$WPRequest, cb?: WPAPI$WPRequestCallback) => Promise<any>;
...
declare type WPAPI$HTTPMethod = "GET"
| "POST"
| "PUT"
| "PATCH"
| "DELETE";
...
declare type WPAPI$HTTPArgumentType = "string"
| "integer"
| "number"
| "boolean"
| "object"
