declare module 'assets-webpack-plugin' {
	...
	declare interface AssetsWebpackPlugin$Assets {
[name: string]: {
[ext: string]: string
}
} 

declare type AssetsWebpackPlugin$ProcessOutputFn = (assets: AssetsWebpackPlugin$Assets) => string;

declare interface AssetsWebpackPlugin$Options {
 ...
 */
processOutput?: AssetsWebpackPlugin$ProcessOutputFn,
...
update?: boolean
	...
	declare class AssetsWebpackPlugin mixins webpack.Plugin {
constructor(options?: AssetsWebpackPlugin$AssetsWebpackPlugin$Options): this
}
	declare module.exports: typeof AssetsWebpackPlugin
