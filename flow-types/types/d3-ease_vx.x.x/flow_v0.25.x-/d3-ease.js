declare module "d3-ease" {
   ...
   */
  declare export function easeLinear(normalizedTime: number): number;

  /**
   * Symmetric quadratic easing; scales quadIn for t in [0, 0.5] and quadOut for t in [0.5, 1]. Also equivalent to poly.exponent(2).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeQuad(normalizedTime: number): number;

  /**
   * Quadratic easing; equivalent to polyIn.exponent(2).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeQuadIn(normalizedTime: number): number;

  /**
   * Reverse quadratic easing; equivalent to 1 - quadIn(1 - t). Also equivalent to polyOut.exponent(2).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeQuadOut(normalizedTime: number): number;

  /**
   * Symmetric quadratic easing; scales quadIn for t in [0, 0.5] and quadOut for t in [0.5, 1]. Also equivalent to poly.exponent(2).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeQuadInOut(normalizedTime: number): number;

  /**
   * Symmetric cubic easing; scales cubicIn for t in [0, 0.5] and cubicOut for t in [0.5, 1]. Also equivalent to poly.exponent(3).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeCubic(normalizedTime: number): number;

  /**
   * Cubic easing; equivalent to polyIn.exponent(3).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeCubicIn(normalizedTime: number): number;

  /**
   * Reverse cubic easing; equivalent to 1 - cubicIn(1 - t). Also equivalent to polyOut.exponent(3).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeCubicOut(normalizedTime: number): number;

  /**
   * Symmetric cubic easing; scales cubicIn for t in [0, 0.5] and cubicOut for t in [0.5, 1]. Also equivalent to poly.exponent(3).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeCubicInOut(normalizedTime: number): number;

  /**
   * Polynomial easing function factory
   */
  declare export interface PolynomialEasingFactory {
    /**
   ...
   * If the exponent is not specified, it defaults to 3, equivalent to cubic.
   */
  declare export var easePoly: PolynomialEasingFactory;
   ...
   */
  declare export var easePolyIn: PolynomialEasingFactory;
   ...
   */
  declare export var easePolyOut: PolynomialEasingFactory;

  /**
   * Symmetric polynomial easing/easing factory; scales polyIn for t in [0, 0.5] and polyOut for t in [0.5, 1].
   * If the exponent is not specified, it defaults to 3, equivalent to cubic.
   */
  declare export var easePolyInOut: PolynomialEasingFactory;

  /**
   * Symmetric sinusoidal easing; scales sinIn for t in [0, 0.5] and sinOut for t in [0.5, 1].
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeSin(normalizedTime: number): number;

  /**
   * Sinusoidal easing; returns sin(t).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeSinIn(normalizedTime: number): number;

  /**
   * Reverse sinusoidal easing; equivalent to 1 - sinIn(1 - t).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeSinOut(normalizedTime: number): number;

  /**
   * Symmetric sinusoidal easing; scales sinIn for t in [0, 0.5] and sinOut for t in [0.5, 1].
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeSinInOut(normalizedTime: number): number;

  /**
   * Symmetric exponential easing; scales expIn for t in [0, 0.5] and expOut for t in [0.5, 1].
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeExp(normalizedTime: number): number;

  /**
   * Exponential easing; raises 2 to the exponent 10 * (t - 1).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeExpIn(normalizedTime: number): number;

  /**
   * Reverse exponential easing; equivalent to 1 - expIn(1 - t).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeExpOut(normalizedTime: number): number;

  /**
   * Symmetric exponential easing; scales expIn for t in [0, 0.5] and expOut for t in [0.5, 1].
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeExpInOut(normalizedTime: number): number;

  /**
   * Symmetric circular easing; scales circleIn for t in [0, 0.5] and circleOut for t in [0.5, 1].
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeCircle(normalizedTime: number): number;

  /**
   * Circular easing.
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeCircleIn(normalizedTime: number): number;

  /**
   * Reverse circular easing; equivalent to 1 - circleIn(1 - t).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeCircleOut(normalizedTime: number): number;

  /**
   * Symmetric circular easing; scales circleIn for t in [0, 0.5] and circleOut for t in [0.5, 1].
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeCircleInOut(normalizedTime: number): number;

  /**
   * Reverse bounce easing; equivalent to 1 - bounceIn(1 - t).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeBounce(normalizedTime: number): number;

  /**
   * Bounce easing, like a rubber ball.
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeBounceIn(normalizedTime: number): number;

  /**
   * Reverse bounce easing; equivalent to 1 - bounceIn(1 - t).
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeBounceOut(normalizedTime: number): number;

  /**
   * Symmetric bounce easing; scales bounceIn for t in [0, 0.5] and bounceOut for t in [0.5, 1].
   * @param normalizedTime Normalized time typically in the range [0, 1]
   */
  declare export function easeBounceInOut(normalizedTime: number): number;

  /**
   * Anticipatory easing function factory
   */
  declare export interface BackEasingFactory {
    /**
     * Calculate eased time.
     * @param normalizedTime Normalized time typically in the range [0, 1]
     */
   ...
   */
  declare export var easeBack: BackEasingFactory;

  /**
   * Anticipatory easing, like a dancer bending his knees before jumping off the floor.
   * The degree of overshoot is configurable; it not specified, it defaults to 1.70158.
   */
  declare export var easeBackIn: BackEasingFactory;

  /**
   * Reverse anticipatory easing; equivalent to 1 - backIn(1 - t).
   * The degree of overshoot is configurable; it not specified, it defaults to 1.70158.
   */
  declare export var easeBackOut: BackEasingFactory;

  /**
   * Symmetric anticipatory easing; scales backIn for t in [0, 0.5] and backOut for t in [0.5, 1].
   * The degree of overshoot is configurable; it not specified, it defaults to 1.70158.
   */
  declare export var easeBackInOut: BackEasingFactory;

  /**
   * Elastic easing function factory
   */
  declare export interface ElasticEasingFactory {
    /**
     * Calculate eased time.
     * @param normalizedTime Normalized time typically in the range [0, 1]
     */
   ...
   */
  declare export var easeElastic: ElasticEasingFactory;
   ...
   * if not specified, they default to 1 and 0.3, respectively.
   */
  declare export var easeElasticIn: ElasticEasingFactory;
   ...
   * if not specified, they default to 1 and 0.3, respectively.
   */
  declare export var easeElasticOut: ElasticEasingFactory;
   ...
   * if not specified, they default to 1 and 0.3, respectively.
   */
  declare export var easeElasticInOut: ElasticEasingFactory;
}
