declare module "gapi.people" {
  ...
  declare function people$getBatchGet(
    parameters: people$GetBatchGetParameters
  ...
  declare type people$SourceType =
  ...
  declare type people$ObjectType =
  ...
  declare type people$NicknameType =
    | "DEFAULT"
    | "MAIDEN_NAME"
    | "INITIALS"
    | "GPLUS"
