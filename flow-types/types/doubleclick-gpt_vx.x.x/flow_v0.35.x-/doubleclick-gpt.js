...
declare type googletag$SingleSize = googletag$SingleSizeArray | googletag$NamedSize;

declare type googletag$MultiSize = googletag$SingleSize[];

declare type googletag$GeneralSize = googletag$SingleSize | googletag$MultiSize;
...
eventType: string,
listener: (
event: events$events$ImpressionViewableEvent | events$events$SlotOnloadEvent | events$events$SlotRenderEndedEvent | events$events$slotVisibilityChangedEvent) => void): void,
...
definePassback(adUnitPath: string, size: googletag$GeneralSize): googletag$PassbackSlot,
disableInitialLoad(): void,
display(
adUnitPath: string,
size: googletag$GeneralSize,
opt_div?: string | Element,
opt_clickUrl?: string): googletag$Slot,
...
opt_radius?: number): googletag$PubAdsService,
setPublisherProvidedId(ppid: string): googletag$PubAdsService,
setRequestNonPersonalizedAds(nonPersonalizedAds: 0 | 1): googletag$PubAdsService,
setSafeFrameConfig(config: googletag$SafeFrameConfig): googletag$PubAdsService,
...
setTargeting(key: string, value: string | string[]): googletag$PubAdsService,
...
slotSize: googletag$GeneralSize): googletag$SizeMappingBuilder,
