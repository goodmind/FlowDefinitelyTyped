...
announce: Announce
	...
	declare export type OnDragStartResponder = (start: DragStart, provided: ResponderProvided) => void;
	declare export type OnDragUpdateResponder = (update: DragUpdate, provided: ResponderProvided) => void;
	declare export type OnDragEndResponder = (result: DropResult, provided: ResponderProvided) => void;
...
onDragEnd(result: DropResult, provided: ResponderProvided): void
	...
	declare export class DragDropContext mixins React.Component<DragDropContextProps> {}
...
snapshot: DroppableStateSnapshot): React.ReactElement<any>
} 
...
snapshot: DraggableStateSnapshot): React.ReactElement<any>,
type?: TypeId
} 
