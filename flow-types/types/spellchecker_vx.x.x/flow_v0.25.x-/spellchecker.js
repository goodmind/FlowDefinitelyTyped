declare module "spellchecker" {
   ...
   */
  declare export interface MisspelledLocation {
    start: number;
    end: number;
  }
   ...
   */
  declare export function isMisspelled(word: string): boolean;
   ...
   */
  declare export function getCorrectionsForMisspelling(word: string): string[];
   ...
   */
  declare export function checkSpelling(corpus: string): MisspelledLocation[];
   ...
   */
  declare export function checkSpellingAsync(
    corpus: string
   ...
   * @returns void
   */
  declare export function add(word: string): void;
}
