declare module "emscripten" {
  ...
  declare function Module$getPreloadedPackage(
  ...
  declare function Module$cwrap(
    ident: string,
    returnType: string | null,
    argTypes: string[]
  ): any;

  declare function Module$setValue(
    ptr: number,
    value: any,
    type: string,
    noSafe?: boolean
  ...
  declare function Module$getValue(
    ptr: number,
    type: string,
    noSafe?: boolean
  ): number;
  ...
  declare function Module$allocate(
    slab: any,
    types: string,
    allocator: number,
    ptr: number
  ...
  declare function Module$Pointer_stringify(
    ptr: number,
    length?: number
  ): string;
  ...
  declare function Module$intArrayFromString(
    stringy: string,
    dontAddNull?: boolean,
    length?: number
  ): number[];
  ...
  declare function Module$writeStringToMemory(
    str: string,
    buffer: number,
    dontAddNull: boolean
  ): void;

  declare function Module$writeArrayToMemory(
    array: number[],
    buffer: number
  ): void;

  declare function Module$writeAsciiToMemory(
    str: string,
    buffer: number,
    dontAddNull: boolean
  ): void;
