 ...
 */
declare export type Stream<Q: BaseQuad> = {
 ...
 */
declare export interface Source<Q: BaseQuad> {
 ...
 */
declare export interface Sink<Q: BaseQuad> {
 ...
 */
declare export type Store<Q: BaseQuad> = {
