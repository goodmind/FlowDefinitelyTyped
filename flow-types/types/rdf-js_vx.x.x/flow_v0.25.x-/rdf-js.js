declare module "rdf-js" {
  ...
  import type { p2$EventEmitter } from "events";
   ...
   * Contains an IRI.
   */
  declare export interface NamedNode {
    /**
   ...
   */
  declare export interface BlankNode {
    /**
 ...
 */
   ...
   */
  declare export interface BaseQuad {
    /**
     * The subject.
     * @see Quad_Subject
     */
   ...
   */
  declare export type Triple = {} & Quad;

  /**
   * A factory for instantiating RDF terms, triples and quads.
   */
  declare export interface DataFactory {
    /**
 ...
 */
   ...
   */
  declare export type Stream<Q: BaseQuad = Quad> = {
    /**
   ...
   */
  declare export interface Source<Q: BaseQuad = Quad> {
    /**
     ...
     */
    match(
      subject?: Term | core$RegExp,
      predicate?: Term | core$RegExp,
      object?: Term | core$RegExp,
      graph?: Term | core$RegExp
    ): Qio$Stream<Sdk$Q>;
  }
   ...
   */
  declare export interface Sink<Q: BaseQuad = Quad> {
    /**
     ...
     */
    import(stream: Qio$Stream<Sdk$Q>): p2$EventEmitter;
  }
   ...
   */
  declare export type Store<Q: BaseQuad = Quad> = {
    /**
     ...
     * @return The resulting event emitter.
     */
    QioFS$remove(stream: Qio$Stream<Sdk$Q>): p2$EventEmitter,
     ...
     * @return The resulting event emitter.
     */
    deleteGraph(graph: $ElementType<Sdk$Q, "graph"> | string): p2$EventEmitter
  } & AddinCommands$Source &
    Sink;
}
