...
isMergeArrays?: boolean): T1 & T2

	
/**
 * Apply options to a copy of the defaults.
 */
declare export function applyToDefaults<T1, T2>(defaults: T1, options: T2, isNullOverride?: boolean): T1 & T2

	
/**
 * Apply options to a copy of the defaults.
 */
declare export function applyToDefaultsWithShallow<T1, T2>(defaults: T1, options: T2, keys?: string[]): T1 & T2
 ...
 */
declare export function contain(ref: any, values: any, options?: ContainOptions): boolean
 ...
 */
declare export function reach(obj: any, chain: any, options?: ReachOptions): any

	
/**
 * Replace string parameters ({name}) with their corresponding object key values.
 */
declare export function reachTemplate(obj: any, template: string, options?: ReachOptions): any

	
/**
 * Transform an existing object into a new one based on the supplied obj and transform map.
 */
declare export function transform(obj: any, transform: any, options?: ReachOptions): any
 ...
 */
declare export function assert(condition: boolean, message: string | Error): void | Error
 ...
 */
declare export function uniqueFilename(path: string, extension?: string): string
