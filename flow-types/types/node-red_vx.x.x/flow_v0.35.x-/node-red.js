 ...
 * object.
 */
declare export interface NodeProperties {
 ...
 */
declare export type NodeId = string;
	
/**
 * Node type name.
 */
declare export type NodeType = string;
	
/**
 * Node status icon color choices.
 */
declare export type StatusFill = "red"
| "green"
| "yellow"
| "blue"
| "grey";
 ...
 */
declare export type StatusShape = "ring" | "dot";
	
/**
 * Object used to set the nodes status flag.
 */
declare export interface NodeStatus {
 ...
 */
declare export interface ClearNodeStatus {
fill?: void,
shape?: void,
text?: void
} 
	declare export interface Nodes {
 ...
 */
addCredentials(id: NodeId, creds: {[key: string]: any}): void,
 ...
 */
getCredentials(id: NodeId): {[key: string]: any},
 ...
 */
registerType<T: NodeProperties>(
type: string,
function Object() { [native code] }: (props: T) => any,
opts?: any): void
} 
    }
