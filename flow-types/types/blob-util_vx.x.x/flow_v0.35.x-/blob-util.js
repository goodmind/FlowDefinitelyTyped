 ...
 */
declare export function createBlob(parts: any[], options?: {
type: string
}): Blob
 ...
 * @param quality a number between 0 and 1 indicating image quality if the requested type is 'image/jpeg' or 'image/webp'
 */
declare export function canvasToBlob(canvas: HTMLCanvasElement, type?: string, quality?: number): Promise<Blob>
