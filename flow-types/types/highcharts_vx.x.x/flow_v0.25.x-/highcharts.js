declare module "global" {
  declare interface JQuery {
    ...
    highcharts(
      ...
      callback?: (chart: Highcharts$Highcharts$ChartObject) => void
    ): JQuery;
  }
}
...
declare type Highcharts$PieStates = {} & Highcharts$BarStates &
...
declare type Highcharts$SeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$SeriesChart;

declare type Highcharts$AreaChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$AreaChart;

declare type Highcharts$AreaRangeChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$AreaRangeChart;

declare type Highcharts$AreaSplineChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$AreaSplineChart;

declare type Highcharts$AreaSplineRangeChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$AreaSplineRangeChart;

declare type Highcharts$BarChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$BarChart;

declare type Highcharts$BoxPlotChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$BoxPlotChart;

declare type Highcharts$BubbleChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$BubbleChart;

declare type Highcharts$ColumnChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$ColumnChart;

declare type Highcharts$ColumnRangeChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$ColumnRangeChart;

declare type Highcharts$ErrorBarChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$ErrorBarChart;

declare type Highcharts$FunnelChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$FunnelChart;

declare type Highcharts$GaugeChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$GaugeChart;

declare type Highcharts$HeatMapSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$HeatMapChart;

declare type Highcharts$LineChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$LineChart;

declare type Highcharts$PieChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$PieChart;

declare type Highcharts$PolygonChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$PolygonChart;

declare type Highcharts$PyramidChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$PyramidChart;

declare type Highcharts$ScatterChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$ScatterChart;

declare type Highcharts$SolidGaugeChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$SolidGaugeChart;

declare type Highcharts$SplineChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$SplineChart;

declare type Highcharts$TreeMapChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$TreeMapChart;

declare type Highcharts$WaterFallChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$WaterFallChart;

declare type Highcharts$WordCloudChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions &
  Highcharts$WordCloudChart;
 ...
 */
  ...
  get(
    id: string
  ): Highcharts$AxisObject | Highcharts$SeriesObject | Highcharts$PointObject;
 ...
 */
  update(
    ...
    redraw?: boolean,
    oneToOne?: boolean,
    animation?: boolean | Highcharts$AnimationOptions
  ): void;
...
declare interface Highcharts$RendererObject {
  ...
  fontMetrics(
    fontSize: string,
    elem: Highcharts$ElementObject
  ): Highcharts$FontMetrics;
