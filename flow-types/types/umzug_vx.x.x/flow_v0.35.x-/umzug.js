 ...
 */
storageOptions?: umzug$JSONStorageOptions | umzug$SequelizeStorageOptions | umzug$MongoDBStorageOptions | Object,
...
up(
options?: umzug$UpToOptions | umzug$UpDownMigrationsOptions): Promise<umzug$Migration[]>,
...
down(
options?: umzug$DownToOptions | umzug$UpDownMigrationsOptions): Promise<umzug$Migration[]>,
on(
eventName: "migrating" | "reverting" | "migrated" | "reverted",
cb?: (name: string, migration: umzug$Migration) => void): this,
addListener(
eventName: "migrating" | "reverting" | "migrated" | "reverted",
cb?: (name: string, migration: umzug$Migration) => void): this,
removeListener(
