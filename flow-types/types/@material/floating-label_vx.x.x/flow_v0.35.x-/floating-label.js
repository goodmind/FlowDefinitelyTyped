declare module '@material/floating-label' {
	...
	declare export {
          MDCFloatingLabelFoundation,MDCFloatingLabelAdapter
        }

	declare export class MDCFloatingLabel mixins MDCComponent<MDCFloatingLabelAdapter, MDCFloatingLabelFoundation> {
