declare module "@material/textfield" {
  ...
  import type MDCTextFieldAdapter, { FoundationMapType } from "./adapter";
  ...
  import type { MDCRipple, MDCRippleFoundation } from "material__ripple";

  import type { MDCLineRipple } from "material__line-ripple";

  import type { MDCFloatingLabel } from "material__floating-label";

  import type { MDCNotchedOutline } from "material__notched-outline";
  ...
  declare export { MDCTextFieldIconFoundation, MDCTextFieldIconAdapter };

  declare export class MDCTextField
    mixins MDCComponent<MDCTextFieldAdapter, MDCTextFieldFoundation> {
