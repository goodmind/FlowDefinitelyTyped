declare module '@material/checkbox' {
	...
	declare export {
          MDCCheckboxAdapter,MDCCheckboxFoundation
        }

	declare export class MDCCheckbox mixins MDCComponent<MDCCheckboxAdapter, MDCCheckboxFoundation>, MDCSelectionControl {
