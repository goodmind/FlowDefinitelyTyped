declare module "@material/notched-outline" {
  ...
  declare export { MDCNotchedOutlineFoundation, MDCNotchedOutlineAdapter };

  declare export class MDCNotchedOutline
    mixins MDCComponent<MDCNotchedOutlineAdapter, MDCNotchedOutlineFoundation> {
