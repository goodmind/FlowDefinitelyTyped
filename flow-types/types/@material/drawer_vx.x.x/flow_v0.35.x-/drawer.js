declare module '@material/drawer' {
	...
	import type {
        ...
        } from './dismissible/foundation';

	import type {
          MDCModalDrawerFoundation
        } from './modal/foundation';
	...
	import type {
          MDCList,MDCListFoundation
        } from 'material__list/index';
	...
	import type createFocusTrap, {
          FocusTrap
        } from './focus-trap';

	declare export class MDCDrawer mixins MDCComponent<MDCDrawer, MDCDismissibleDrawerFoundation | MDCModalDrawerFoundation> {
...
getDefaultFoundation(): MDCDismissibleDrawerFoundation | MDCModalDrawerFoundation
	...
	declare export {
          MDCDismissibleDrawerFoundation,MDCModalDrawerFoundation,util
        }
