declare module "@material/icon-toggle" {
  ...
  declare export { MDCIconToggleAdapter, MDCIconToggleFoundation };

  declare export class MDCIconToggle
    mixins MDCComponent<MDCIconToggleAdapter, MDCIconToggleFoundation> {
