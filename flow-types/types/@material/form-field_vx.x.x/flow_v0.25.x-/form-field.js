declare module "@material/form-field" {
  ...
  declare export { MDCFormFieldAdapter, MDCFormFieldFoundation };

  declare export class MDCFormField
    mixins MDCComponent<MDCFormFieldAdapter, MDCFormFieldFoundation> {
