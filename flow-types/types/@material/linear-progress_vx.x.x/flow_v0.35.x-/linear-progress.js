declare module '@material/linear-progress' {
	...
	declare export {
          MDCLinearProgressAdapter,MDCLinearProgressFoundation
        }

	declare export class MDCLinearProgress mixins MDCComponent<MDCLinearProgressAdapter, MDCLinearProgressFoundation> {
