declare module "@material/list" {
  ...
  import type { MDCListFoundation } from "./foundation";

  import type { MDCListAdapter } from "./adapter";

  import type { matches } from "material__dom/ponyfill";

  import type { cssClasses, strings, Index } from "./constants";
  ...
  declare export { MDCListFoundation };
}
