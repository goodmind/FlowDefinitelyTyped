declare module "@material/menu" {
  ...
  import type MDCMenuFoundation, { AnchorMargin } from "./foundation";

  import typeof MDCMenuAdapter from "./adapter";

  import type { Corner, CornerBit } from "./constants";
  ...
  declare export class MDCMenu
    mixins MDCComponent<MDCMenuAdapter, MDCMenuFoundation> {
