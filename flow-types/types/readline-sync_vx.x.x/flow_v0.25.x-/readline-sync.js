declare module "readline-sync" {
  ...
  declare export function setDefaultOptions(
    options?: BasicOptions
  ): BasicOptions;

  declare export function questionEMail(
    query?: any,
    options?: BasicOptions
  ): string;

  declare export function questionNewPassword(
    query?: any,
    options?: BasicOptions
  ): string;

  declare export function questionInt(
    query?: any,
    options?: BasicOptions
  ): number;

  declare export function questionFloat(
    query?: any,
    options?: BasicOptions
  ): number;

  declare export function questionPath(
    query?: any,
    options?: BasicOptions
  ): string;
  ...
  declare export function promptLoop(
  ...
  declare export function keyInYN(
    query?: any,
    options?: BasicOptions
  ): boolean | string;

  declare export function keyInYNStrict(
    query?: any,
    options?: BasicOptions
  ): boolean;
  ...
  declare export function keyInSelect(
    items: string[],
    query?: any,
    options?: BasicOptions
  ): number;
   ...
   */
  declare export function setPrint(
