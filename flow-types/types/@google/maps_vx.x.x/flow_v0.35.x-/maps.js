 ...
 */
declare export interface CreateClientOptions {
...
retryOptions?: RetryOptions
	...
	declare export interface RateOptions {
...
interval?: number
	...
	declare export function createClient(options: CreateClientOptions): GoogleMapsClient
 ...
 */
declare export type ResponseCallback<T> = (err: "timeout" | ClientResponse<T>, response: ClientResponse<T>) => void;
	
/**
 * The object given to the ResponseCallback, containing the HTTP status and headers, as well as the response JSON.
 */
declare export interface ClientResponse<T> {
 ...
 */
declare export interface RequestHandle<T> {
 ...
 */
	...
	declare export type LatLngArray = [number, number];
	declare export type LatLngString = string;
	declare export interface LatLngLiteral {
lat: number,
lng: number
} 
	declare export interface LatLngLiteralVerbose {
latitude: number,
longitude: number
} 
 ...
 */
declare export type LatLng = (LatLngArray | LatLngString | LatLngLiteral | LatLngLiteralVerbose);
 ...
 */
declare export type Language = ("ar"
| "be"
| "bg"
| "bn"
| "ca"
...
| "zh-CN"
| "zh-TW");
	declare export type GoogleMapsClientEndpoint<Request, Response> = (
query: Request,
callback?: ResponseCallback<Response>) => RequestHandle<Response>;
	declare export interface GoogleMapsClient {
 ...
 */
declare export type TravelMode = ("driving" | "walking" | "bicycling" | "transit");
	declare export type TravelRestriction = ("tolls" | "highways" | "ferries" | "indoor");
 ...
 */
declare export type UnitSystem = ("metric" | "imperial");
	declare export interface DirectionsResponse {
...
available_travel_modes: string[]
	...
	declare export type TrafficModel = ("best_guess" | "pessimistic" | "optimistic");
	declare export type TransitMode = ("bus"
| "subway"
| "train"
| "tram"
| "rail");
	declare export type TransitRoutingPreference = ("less_walking" | "fewer_transfers");
 ...
 */
declare export type DirectionsReponseStatus = ("OK"
| "NOT_FOUND"
| "ZERO_RESULTS"
 ...
 */
declare export interface GeocodedWaypoint {
...
types: AddressType[]
	...
	declare export type GeocodedWaypointStatus = ("OK" | "ZERO_RESULTS");
	declare export type AddressType = ("street_address"
| "route"
| "intersection"
| "political"
| "country"
...
time_zone: string
	...
	declare export type Maneuver = ("turn-slight-left"
| "turn-sharp-left"
| "uturn-left"
| "turn-left"
| "turn-slight-right"
 ...
 */
declare export type VehicleType = ("RAIL"
| "METRO_RAIL"
| "SUBWAY"
| "TRAM"
| "MONORAIL"
 ...
 */
declare export type DistanceMatrixResponseTopLevelStatus = ("OK"
| "INVALID_REQUEST"
...
| "REQUEST_DENIED"
| "UNKNOWN_ERROR");
	declare export type DistanceMatrixResponseElementLevelStatus = ("OK" | "NOT_FOUND" | "ZERO_RESULTS" | "MAX_ROUTE_LENGTH_EXCEEDED");
 ...
 */
declare export interface DistanceMatrixRow {
 ...
 */
declare export interface DistanceMatrixRowElement {
...
fare: TransitFare
	...
	declare export interface ElevationRequest {
...
locations: LatLng[]
	...
	declare export interface ElevationResponse {
...
results: ElevationResult[]
	...
	declare export type ElevationResponseStatus = ("OK"
| "INVALID_REQUEST"
| "OVER_DAILY_LIMIT"
| "OVER_QUERY_LIMIT"
| "REQUEST_DENIED"
...
resolution: number
	...
	declare export interface ElevationAlongPathRequest {
...
samples: number
	...
	declare export interface FindPlaceRequest {
 ...
 */
fields?: Array<$Keys<PlaceSearchResult>>,
 ...
 */
declare export interface FindPlaceFromTextResponse {
status: SearchResponseStatus,
candidates: Array<$Shape<PlaceSearchResult>>
} 
	declare export interface PlaceSearchResponse {
 ...
 */
declare export type SearchResponseStatus = ("OK"
| "ZERO_RESULTS"
| "OVER_QUERY_LIMIT"
| "REQUEST_DENIED"
| "INVALID_REQUEST"
 ...
 */
declare export interface PlaceSearchResult {
...
html_attributions: string[]
	...
	declare export type PlaceIdScope = ("APP" | "GOOGLE");
	declare export interface AlternativePlaceId {
 ...
 */
declare export type PlaceType1 = ("accounting"
| "airport"
| "amusement_park"
| "aquarium"
| "art_gallery"
 ...
 */
declare export type PlaceType2 = ("administrative_area_level_1"
| "administrative_area_level_2"
| "administrative_area_level_3"
| "administrative_area_level_4"
| "administrative_area_level_5"
...
| "sublocality_level_1"
| "subpremise");
	declare export interface GeocodingRequest {
 ...
 */
declare export interface GeocodingComponents {
...
administrativeArea?: string
	...
	declare export interface GeocodingResponse<STATUSES> {
 ...
 */
declare export type GeocodingResponseStatus = ("OK"
| "ZERO_RESULTS"
| "OVER_DAILY_LIMIT"
| "OVER_QUERY_LIMIT"
| "REQUEST_DENIED"
 ...
 * (XML responses consist of zero or more `<result>` elements.)
 */
declare export interface GeocodingResult {
...
place_id: string
	...
	declare export type GeocodingAddressComponentType = ("floor"
| "establishment"
| "point_of_interest"
| "parking"
| "post_box"
...
| "train_station"
| "transit_station");
	declare export interface AddressComponent {
...
short_name: string
	...
	declare export interface AddressGeometry {
...
bounds: LatLngBounds
	...
	declare export type LocationType = ("ROOFTOP" | "RANGE_INTERPOLATED" | "GEOMETRIC_CENTER" | "APPROXIMATE");
	declare export interface PlusCode {
...
compound_code: string
	...
	declare export interface GeolocationRequest {
...
wifiAccessPoints?: WifiAccessPoint[]
	...
	declare export type RadioType = ("lte" | "gsm" | "cdma" | "wcdma");
	declare export interface CellTower {
...
timingAdvance?: number
	...
	declare export interface WifiAccessPoint {
...
signalToNoiseRatio?: number
	...
	declare export interface GeolocationResponse {
 ...
 */
declare export interface GeolocationError {
error: {
...
message: string
	...
	declare export type GeolocationErrorReason = ("dailyLimitExceeded"
| "keyInvalid"
| "userRateLimitExceeded"
| "notFound"
| "parseError");
	declare export interface NearestRoadsRequest {
...
points: LatLng[]
	...
	declare export interface NearestRoadsResponse {
 ...
 */
fields?: Array<$Keys<PlaceDetailsResult>>
} 
	declare export interface PlaceDetailsResponse {
 ...
 */
declare export type PlaceDetailsResponseStatus = ("OK"
| "UNKNOWN_ERROR"
| "ZERO_RESULTS"
| "OVER_QUERY_LIMIT"
| "REQUEST_DENIED"
 ...
 */
declare export interface PlaceDetailsResult {
...
time: string
	...
	declare export interface AspectRating {
...
rating: number
	...
	declare export type AspectRatingType = ("appeal"
| "atmosphere"
| "decor"
| "facilities"
| "food"
...
| "quality"
| "service");
	declare export interface PlacesRequest {
 ...
 */
declare export interface PlaceAutocompleteRequest {
 ...
 */
declare export type PlaceAutocompleteType = ("geocode"
| "address"
| "establishment"
| "(regions)"
| "(cities)");
	declare export interface PlaceAutocompleteResponse {
 ...
 */
declare export type PlaceAutocompleteResponseStatus = ("OK"
| "ZERO_RESULTS"
| "OVER_QUERY_LIMIT"
| "REQUEST_DENIED"
| "INVALID_REQUEST"
 ...
 */
declare export interface PlaceAutocompleteResult {
...
length: number
	...
	declare export interface StructuredFormatting {
...
secondary_text: string
	...
	declare export interface PlacesNearbyRequest {
...
pagetoken?: string
	...
	declare export type PlacesNearbyRanking = ("prominence" | "distance");
	declare export interface PlacePhotoRequest {
 ...
 */
declare export type PlacePhotoResponse = string;
	declare export interface QueryAutocompleteRequest {
...
language?: Language
	...
	declare export interface QueryAutocompleteResponse {
 ...
 * and may contain debugging information to help you track down why the request failed.
 */
declare export type QueryAutocompleteResponseStatus = ("OK"
| "ZERO_RESULTS"
| "OVER_QUERY_LIMIT"
| "REQUEST_DENIED"
| "INVALID_REQUEST"
 ...
 */
declare export interface QueryAutocompleteResult {
 ...
 */
declare export interface PlaceRadarRequest {
 ...
 */
declare export interface ReverseGeocodingRequest {
...
location_type?: ReverseGeocodingLocationType
	...
	declare export type ReverseGeocodingLocationType = ("ROOFTOP" | "RANGE_INTERPOLATED" | "GEOMETRIC_CENTER" | "APPROXIMATE");
	declare export type ReverseGeocodingResponse = GeocodingResponse<ReverseGeocodingResponseStatus>;
	
/**
 * The `"status"` field within the Geocoding response object contains the status of the request,
 * and may contain debugging information to help you track down why reverse geocoding is not working.
 */
declare export type ReverseGeocodingResponseStatus = ("OK"
| "ZERO_RESULTS"
| "OVER_QUERY_LIMIT"
| "REQUEST_DENIED"
| "INVALID_REQUEST"
| "UNKNOWN_ERROR");
	declare export interface SnappedSpeedLimitsRequest {
...
units?: SpeedLimitUnit
	...
	declare export interface SpeedLimitsRequest {
...
units?: SpeedLimitUnit
	...
	declare export type SpeedLimitUnit = ("KPH" | "MPH");
	declare export interface SpeedLimitsResponse {
...
snappedPoints: SnappedPoint[]
	...
	declare export interface SpeedLimit {
...
units: SpeedLimitUnit
	...
	declare export interface SnappedPoint {
...
placeId: string
	...
	declare export interface SnapToRoadsRequest {
...
interpolate?: boolean
	...
	declare export interface SnapToRoadsResponse {
 ...
 */
declare export interface TimeZoneRequest {
 ...
 */
declare export interface TimeZoneResponse {
...
errorMessage: string
	...
	declare export type TimeZoneResponseStatus = ("OK"
| "INVALID_REQUEST"
| "OVER_DAILY_LIMIT"
| "OVER_QUERY_LIMIT"
| "REQUEST_DENIED"
