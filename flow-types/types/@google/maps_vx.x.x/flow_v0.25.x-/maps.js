declare module "@google/maps" {
   ...
   */
  declare export type ResponseCallback<T> = (
   ...
   */
  declare export type TravelMode =
    | "driving"
    | "walking"
    | "bicycling"
    | "transit";
  declare export type TravelRestriction =
    | "tolls"
    | "highways"
    | "ferries"
    | "indoor";
  ...
  declare export type TrafficModel =
    | "best_guess"
    | "pessimistic"
    | "optimistic";
  declare export type TransitMode =
    | "bus"
    | "subway"
    | "train"
    | "tram"
    | "rail";
  declare export type TransitRoutingPreference =
    | "less_walking"
    | "fewer_transfers";
   ...
   */
  declare export type DirectionsReponseStatus =
    | "OK"
    | "NOT_FOUND"
    | "ZERO_RESULTS"
  ...
  declare export type AddressType =
    | "street_address"
    | "route"
    | "intersection"
    | "political"
   ...
   */
  declare export type VehicleType =
    | "RAIL"
    | "METRO_RAIL"
    | "SUBWAY"
    | "TRAM"
   ...
   */
  declare export type DistanceMatrixResponseTopLevelStatus =
    | "OK"
    | "INVALID_REQUEST"
    ...
    | "REQUEST_DENIED"
    | "UNKNOWN_ERROR";
  declare export type DistanceMatrixResponseElementLevelStatus =
    | "OK"
    | "NOT_FOUND"
    | "ZERO_RESULTS"
    | "MAX_ROUTE_LENGTH_EXCEEDED";
  ...
  declare export type ElevationResponseStatus =
    | "OK"
    | "INVALID_REQUEST"
    | "OVER_DAILY_LIMIT"
    | "OVER_QUERY_LIMIT"
   ...
   */
  declare export type SearchResponseStatus =
    | "OK"
    | "ZERO_RESULTS"
    | "OVER_QUERY_LIMIT"
    | "REQUEST_DENIED"
   ...
   */
  declare export type PlaceType1 =
    | "accounting"
    | "airport"
    | "amusement_park"
    | "aquarium"
   ...
   */
  declare export type PlaceType2 =
    | "administrative_area_level_1"
    | "administrative_area_level_2"
    | "administrative_area_level_3"
    | "administrative_area_level_4"
  ...
  declare export interface GeocodingResponse<
    STATUSES = GeocodingResponseStatus
  > {
    /**
     * contains metadata on the request.
     */
   ...
   */
  declare export type GeocodingResponseStatus =
    | "OK"
    | "ZERO_RESULTS"
    | "OVER_DAILY_LIMIT"
    | "OVER_QUERY_LIMIT"
  ...
  declare export type GeocodingAddressComponentType =
    | "floor"
    | "establishment"
    | "point_of_interest"
    | "parking"
  ...
  declare export type GeolocationErrorReason =
    | "dailyLimitExceeded"
    | "keyInvalid"
   ...
   */
  declare export type PlaceDetailsResponseStatus =
    | "OK"
    | "UNKNOWN_ERROR"
    | "ZERO_RESULTS"
    | "OVER_QUERY_LIMIT"
  ...
  declare export type AspectRatingType =
    | "appeal"
    | "atmosphere"
    | "decor"
    | "facilities"
   ...
   */
  declare export type PlaceAutocompleteType =
    | "geocode"
    | "address"
    | "establishment"
    | "(regions)"
   ...
   */
  declare export type PlaceAutocompleteResponseStatus =
    | "OK"
    | "ZERO_RESULTS"
    | "OVER_QUERY_LIMIT"
    | "REQUEST_DENIED"
   ...
   * and may contain debugging information to help you track down why the request failed.
   */
  declare export type QueryAutocompleteResponseStatus =
    | "OK"
    | "ZERO_RESULTS"
    | "OVER_QUERY_LIMIT"
    | "REQUEST_DENIED"
  ...
  declare export type ReverseGeocodingLocationType =
    | "ROOFTOP"
    | "RANGE_INTERPOLATED"
    | "GEOMETRIC_CENTER"
    | "APPROXIMATE";
   ...
   */
  declare export type ReverseGeocodingResponseStatus =
    | "OK"
    | "ZERO_RESULTS"
    | "OVER_QUERY_LIMIT"
    | "REQUEST_DENIED"
  ...
  declare export type TimeZoneResponseStatus =
    | "OK"
    | "INVALID_REQUEST"
    | "OVER_DAILY_LIMIT"
    | "OVER_QUERY_LIMIT"
