...
static +OK: Class<PromiseSftp$ERROR_CODES__OK> & PromiseSftp$ERROR_CODES__OK & 0;// 0
static +EOF: Class<PromiseSftp$ERROR_CODES__EOF> & PromiseSftp$ERROR_CODES__EOF & 1;// 1
static +NO_SUCH_FILE: Class<PromiseSftp$ERROR_CODES__NO_SUCH_FILE> & PromiseSftp$ERROR_CODES__NO_SUCH_FILE & 2;// 2
static +PERMISSION_DENIED: Class<PromiseSftp$ERROR_CODES__PERMISSION_DENIED> & PromiseSftp$ERROR_CODES__PERMISSION_DENIED & 3;// 3
static +FAILURE: Class<PromiseSftp$ERROR_CODES__FAILURE> & PromiseSftp$ERROR_CODES__FAILURE & 4;// 4
static +BAD_MESSAGE: Class<PromiseSftp$ERROR_CODES__BAD_MESSAGE> & PromiseSftp$ERROR_CODES__BAD_MESSAGE & 5;// 5
static +NO_CONNECTION: Class<PromiseSftp$ERROR_CODES__NO_CONNECTION> & PromiseSftp$ERROR_CODES__NO_CONNECTION & 6;// 6
static +CONNECTION_LOST: Class<PromiseSftp$ERROR_CODES__CONNECTION_LOST> & PromiseSftp$ERROR_CODES__CONNECTION_LOST & 7;// 7
static +OP_UNSUPPORTED: Class<PromiseSftp$ERROR_CODES__OP_UNSUPPORTED> & PromiseSftp$ERROR_CODES__OP_UNSUPPORTED & 8;// 8
static +INVALID_HANDLE: Class<PromiseSftp$ERROR_CODES__INVALID_HANDLE> & PromiseSftp$ERROR_CODES__INVALID_HANDLE & 9;// 9
static +NO_SUCH_PATH: Class<PromiseSftp$ERROR_CODES__NO_SUCH_PATH> & PromiseSftp$ERROR_CODES__NO_SUCH_PATH & 10;// 10
static +FILE_ALREADY_EXISTS: Class<PromiseSftp$ERROR_CODES__FILE_ALREADY_EXISTS> & PromiseSftp$ERROR_CODES__FILE_ALREADY_EXISTS & 11;// 11
static +WRITE_PROTECT: Class<PromiseSftp$ERROR_CODES__WRITE_PROTECT> & PromiseSftp$ERROR_CODES__WRITE_PROTECT & 12;// 12
static +NO_MEDIA: Class<PromiseSftp$ERROR_CODES__NO_MEDIA> & PromiseSftp$ERROR_CODES__NO_MEDIA & 13;// 13
static +NO_SPACE_ON_FILESYSTEM: Class<PromiseSftp$ERROR_CODES__NO_SPACE_ON_FILESYSTEM> & PromiseSftp$ERROR_CODES__NO_SPACE_ON_FILESYSTEM & 14;// 14
static +QUOTA_EXCEEDED: Class<PromiseSftp$ERROR_CODES__QUOTA_EXCEEDED> & PromiseSftp$ERROR_CODES__QUOTA_EXCEEDED & 15;// 15
static +UNKNOWN_PRINCIPAL: Class<PromiseSftp$ERROR_CODES__UNKNOWN_PRINCIPAL> & PromiseSftp$ERROR_CODES__UNKNOWN_PRINCIPAL & 16;// 16
static +LOCK_CONFLICT: Class<PromiseSftp$ERROR_CODES__LOCK_CONFLICT> & PromiseSftp$ERROR_CODES__LOCK_CONFLICT & 17;// 17
static +DIR_NOT_EMPTY: Class<PromiseSftp$ERROR_CODES__DIR_NOT_EMPTY> & PromiseSftp$ERROR_CODES__DIR_NOT_EMPTY & 18;// 18
static +NOT_A_DIRECTORY: Class<PromiseSftp$ERROR_CODES__NOT_A_DIRECTORY> & PromiseSftp$ERROR_CODES__NOT_A_DIRECTORY & 19;// 19
static +INVALID_FILENAME: Class<PromiseSftp$ERROR_CODES__INVALID_FILENAME> & PromiseSftp$ERROR_CODES__INVALID_FILENAME & 20;// 20
static +LINK_LOOP: Class<PromiseSftp$ERROR_CODES__LINK_LOOP> & PromiseSftp$ERROR_CODES__LINK_LOOP & 21;// 21
static +CANNOT_DELETE: Class<PromiseSftp$ERROR_CODES__CANNOT_DELETE> & PromiseSftp$ERROR_CODES__CANNOT_DELETE & 22;// 22
static +INVALID_PARAMETER: Class<PromiseSftp$ERROR_CODES__INVALID_PARAMETER> & PromiseSftp$ERROR_CODES__INVALID_PARAMETER & 23;// 23
static +FILE_IS_A_DIRECTORY: Class<PromiseSftp$ERROR_CODES__FILE_IS_A_DIRECTORY> & PromiseSftp$ERROR_CODES__FILE_IS_A_DIRECTORY & 24;// 24
static +BYTE_RANGE_LOCK_CONFLICT: Class<PromiseSftp$ERROR_CODES__BYTE_RANGE_LOCK_CONFLICT> & PromiseSftp$ERROR_CODES__BYTE_RANGE_LOCK_CONFLICT & 25;// 25
static +BYTE_RANGE_LOCK_REFUSED: Class<PromiseSftp$ERROR_CODES__BYTE_RANGE_LOCK_REFUSED> & PromiseSftp$ERROR_CODES__BYTE_RANGE_LOCK_REFUSED & 26;// 26
static +DELETE_PENDING: Class<PromiseSftp$ERROR_CODES__DELETE_PENDING> & PromiseSftp$ERROR_CODES__DELETE_PENDING & 27;// 27
static +FILE_CORRUPT: Class<PromiseSftp$ERROR_CODES__FILE_CORRUPT> & PromiseSftp$ERROR_CODES__FILE_CORRUPT & 28;// 28
static +OWNER_INVALID: Class<PromiseSftp$ERROR_CODES__OWNER_INVALID> & PromiseSftp$ERROR_CODES__OWNER_INVALID & 29;// 29
static +GROUP_INVALID: Class<PromiseSftp$ERROR_CODES__GROUP_INVALID> & PromiseSftp$ERROR_CODES__GROUP_INVALID & 30;// 30
static +NO_MATCHING_BYTE_RANGE_LOCK: Class<PromiseSftp$ERROR_CODES__NO_MATCHING_BYTE_RANGE_LOCK> & PromiseSftp$ERROR_CODES__NO_MATCHING_BYTE_RANGE_LOCK & 31;// 31
...
declare class PromiseSftp$ERROR_CODES__NO_SUCH_FILE mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__PERMISSION_DENIED mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__FAILURE mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__BAD_MESSAGE mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__NO_CONNECTION mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__CONNECTION_LOST mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__OP_UNSUPPORTED mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__INVALID_HANDLE mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__NO_SUCH_PATH mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__FILE_ALREADY_EXISTS mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__WRITE_PROTECT mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__NO_MEDIA mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__NO_SPACE_ON_FILESYSTEM mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__QUOTA_EXCEEDED mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__UNKNOWN_PRINCIPAL mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__LOCK_CONFLICT mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__DIR_NOT_EMPTY mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__NOT_A_DIRECTORY mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__INVALID_FILENAME mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__LINK_LOOP mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__CANNOT_DELETE mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__INVALID_PARAMETER mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__FILE_IS_A_DIRECTORY mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__BYTE_RANGE_LOCK_CONFLICT mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__BYTE_RANGE_LOCK_REFUSED mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__DELETE_PENDING mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__FILE_CORRUPT mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__OWNER_INVALID mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__GROUP_INVALID mixins PromiseSftp$ERROR_CODES {}
declare class PromiseSftp$ERROR_CODES__NO_MATCHING_BYTE_RANGE_LOCK mixins PromiseSftp$ERROR_CODES {}
...
path: string,
recursive?: boolean,
attributes?: ssh2Streams.InputAttributes): Promise<void>;
...
remotePath: string,
localPath: string,
options?: PromiseSftp$PromiseSftp$FastOptions): Promise<void>;
...
filename: string,
mode: string | number,
attributes?: ssh2Streams.InputAttributes): Promise<Buffer>;
 ...
 */
readdir(
location: Buffer | string): Promise<{
filename: string,
longname: string,
 ...
 * @param handle - A resource handle returned from `#open()` or `#fopen()`.
 */
ext_openssh_fstatvfs(handle: Buffer): Promise<PromiseSftp$PromiseSftp$Statvfs>;
