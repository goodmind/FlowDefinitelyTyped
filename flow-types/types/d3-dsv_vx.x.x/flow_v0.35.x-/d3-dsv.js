 ...
 */
declare export type DSVRowString<Columns: string> = $ObjMapi<{[k: Columns]: any}, <key>(key) => string | void>;
	
/**
 * An object in raw format before parsing, that is with only string values.
 * When the DSV content is not well-structured and some column-values are missing, `undefined` is used as value.
 */
declare export type DSVRaw<T: {[key: string]: any}> = $ObjMapi<T, <key>(key) => string | void>;
 ...
 */
declare export type DSVRowArray<Columns: string> = {
 ...
 */
declare export function csvParse<Columns: string>(csvString: string): DSVRowArray<Columns>
 ...
 */
declare export function csvParse<ParsedRow: {[key: string]: any}, Columns: string>(
csvString: string,
row: (
rawRow: DSVRowString<Columns>,
index: number,
columns: Columns[]) => ParsedRow | void | null): DSVParsedArray<ParsedRow>
...
csvString: string,
row: (rawRow: string[], index: number) => ParsedRow | void | null): ParsedRow[]
 ...
 */
declare export function csvFormat<T: {[key: string]: any}>(rows: T[], columns?: Array<$Keys<T>>): string
 ...
 */
declare export function tsvParse<Columns: string>(tsvString: string): DSVRowArray<Columns>
...
In effect, row is similar to applying a map and filter operator to the returned rows.
 */
declare export function tsvParse<ParsedRow: {[key: string]: any}, Columns: string>(
tsvString: string,
row: (
rawRow: DSVRowString<Columns>,
index: number,
 ...
 * @param columns An array of strings representing the column names.
 */
declare export function tsvFormat<T: {[key: string]: any}>(rows: T[], columns?: Array<$Keys<T>>): string
 ...
 * @param columns An array of strings representing the column names.
 */
format<T: {[key: string]: any}>(rows: T[], columns?: Array<$Keys<T>>): string,
