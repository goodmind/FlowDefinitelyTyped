declare module "ffmpeg" {
  declare type WatermarkSettings = $Shape<{
  ...
  declare type SaveCallback = (err: Error, files: string) => void;
  declare type FrameToJPGSettings = $Shape<{
  ...
  declare type StandardVideoMetadata = $Shape<{
    title: string,
    author: string,
    album_artist: string,
    album: string,
  ...
  declare type WMVMetadata = $Shape<{
    title: string,
    author: string,
    copyright: string,
    comment: string,
  ...
  declare type AVIMetadata = $Shape<{
    IARL: string,
    IART: string,
    ICMS: string,
    ICMT: string,
  ...
  declare type FLVMetadata = $Shape<{
    duration: number,
    filesize: string,
    encoder: string,
    width: number,
