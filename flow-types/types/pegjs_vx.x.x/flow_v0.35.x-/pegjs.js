 ...
 */
declare export function generate(grammar: string, options?: ParserBuildOptions): Parser
 ...
 */
declare export function generate(grammar: string, options: OutputFormatAmdCommonjs): string

	
/**
 * Returns the generated source code as a `string`. It will throw an exception if the grammar is invalid. The exception will contain `message` property with more details about the error.
 */
declare export function generate(grammar: string, options: OutputFormatUmd): string

	
/**
 * Returns the generated source code as a `string`. It will throw an exception if the grammar is invalid. The exception will contain `message` property with more details about the error.
 */
declare export function generate(grammar: string, options: OutputFormatGlobals): string

	
/**
 * Returns the generated source code as a `string`. It will throw an exception if the grammar is invalid. The exception will contain `message` property with more details about the error.
 */
declare export function generate(grammar: string, options: OutputFormatBare): string
