declare module "detective" {
    import typeof * as acorn from "acorn";

    declare interface detective$Detective {
        /**
         * Give some source body src, return an array of all the require() calls with string arguments.
         * The options parameter opts is passed along to detective.find().
         */
        (src: string, opts?: detective$Options): string[];

        /**
         * Give some source body 'src', return 'found' DetectiveResults
         */
        find(src: string, opts?: detective$Options): detective$DetectiveResults;
    }

    declare interface detective$Options {
        /**
    ...
    declare interface detective$DetectiveResults {
        /**
    ...
    declare var detective: detective$detective$Detective;
    declare module.exports: typeof detective;
}
