declare module "pebblekitjs" {
  ...
  declare interface PebbleKit$Pebble {
    ...
    addEventListener(
      type: string,
      callback: (e: PebbleKit$Event) => void
    ): void;
 ...
 */
    sendAppMessage(
      ...
      callbackForNack?: (e: PebbleKit$AppMessageEvent) => void
    ): string;
    ...
    appGlanceReload(
      ...
      onFailure: (appGlanceSlices: PebbleKit$AppGlanceSlice[]) => void
    ): void;
  ...
  declare var PebbleKit$Pebble: PebbleKit$PebbleKit$Pebble;
}
