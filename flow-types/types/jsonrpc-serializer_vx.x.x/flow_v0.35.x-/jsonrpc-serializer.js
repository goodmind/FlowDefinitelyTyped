declare module 'jsonrpc-serializer' {
        declare export type PayloadType = "request" | "notification" | "success" | "error";
...
data?: any[]
	...
	declare export function request(id: string | number, method: string, params?: any): string
	...
	declare export function error(id: string | number, error: err$err$JsonRpcError): string

	declare export function deserialize(msg: string): DeserializeObject

	declare export function requestObject(id: string | number, method: string, params?: any): PayloadObject

	declare export function notificationObject(method: string, params?: any): PayloadObject

	declare export function successObject(id: string | number, result: any): PayloadObject

	declare export function errorObject(id: string | number, error: SerializerError): PayloadObject

	declare export function deserializeObject(msg: PayloadObject): DeserializeObject

	declare export type errorHandler = (errors: string[] | null) => void;
	declare type err$ErrorName = "JsonRpcError"
| "ParseError"
| "InvalidRequestError"
| "MethodNotFoundError"
| "InvalidParamsError";

declare type err$ErrorCode = -32603
| -32700
| -32600
| -32601
| -32602;
