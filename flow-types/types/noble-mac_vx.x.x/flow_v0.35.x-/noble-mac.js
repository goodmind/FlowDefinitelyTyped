declare module 'noble-mac' {
        declare export function startScanning(callback?: (error?: Error) => void): void

	declare export function startScanning(serviceUUIDs: string[], callback?: (error?: Error) => void): void
...
callback?: (error?: Error) => void): void
	...
	declare export function on(event: "scanStart" | "scanStop", listener: () => void): events.EventEmitter

	declare export function on(
event: "discover",
listener: (peripheral: Peripheral) => void): events.EventEmitter

	declare export function on(event: string, listener: Function): events.EventEmitter

	declare export function removeListener(event: "stateChange", listener: (state: string) => void): events.EventEmitter

	declare export function removeListener(event: "scanStart" | "scanStop", listener: () => void): events.EventEmitter

	declare export function removeListener(
event: "discover",
listener: (peripheral: Peripheral) => void): events.EventEmitter

	declare export function removeListener(event: string, listener: Function): events.EventEmitter

	declare export function removeAllListeners(event?: string): events.EventEmitter
