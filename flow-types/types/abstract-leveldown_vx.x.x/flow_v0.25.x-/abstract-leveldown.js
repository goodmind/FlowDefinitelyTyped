declare module "abstract-leveldown" {
  ...
  declare export type ErrorValueCallback<V> = (
    err: Error | void,
    value: V
  ) => void;
  declare export type ErrorKeyValueCallback<K, V> = (
    err: Error | void,
    key: K,
    value: V
  ) => void;
  ...
  declare export type AbstractBatch<K = any, V = any> =
    | PutBatch<K, V>
    | DelBatch<K, V>;
  ...
  declare export interface AbstractChainedBatchConstructor {
    ...
    <K, V>(db: any): AbstractChainedBatch<K, V>;
  }
  ...
  declare export interface AbstractIteratorConstructor {
    ...
    <K, V>(db: any): AbstractIterator<K, V>;
  }
