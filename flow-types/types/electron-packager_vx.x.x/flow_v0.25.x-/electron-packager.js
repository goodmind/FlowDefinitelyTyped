declare module "electron-packager" {
   ...
   */
  declare function electronPackager(
    opts: electronPackager$electronPackager$Options
   ...
   */
  declare type electronPackager$finalCallback = (
    err: Error,
  ...
  declare type electronPackager$arch =
    | "ia32"
    | "x64"
    | "armv7l"
    | "arm64"
  ...
  declare type electronPackager$platform =
    | "linux"
    | "win32"
    | "darwin"
    | "mas"
