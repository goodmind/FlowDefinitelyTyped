declare module "d3-zoom" {
  ...
  import type { ZoomView, ZoomInterpolator } from "d3-interpolate";
   ...
   */
  declare export type ZoomBehavior<
    ZoomRefElement: ZoomedElementBaseType,
    Datum
  > = {
    /**
 ...
 */
   ...
   * The second generic refers to the type of the datum of the reference element.
   */
  declare export interface D3ZoomEvent<
    ZoomRefElement: ZoomedElementBaseType,
    Datum
  > {
    /**
   ...
   */
  declare export function zoomTransform(
    node: ZoomedElementBaseType
  ): ZoomTransform;
