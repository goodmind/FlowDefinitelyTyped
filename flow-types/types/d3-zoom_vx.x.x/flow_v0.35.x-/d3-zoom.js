declare module 'd3-zoom' {
        import type {
          ArrayLike,Selection,TransitionLike,ValueFn
        } from 'd3-selection';

	import type {
          ZoomView,ZoomInterpolator
        } from 'd3-interpolate';
 ...
 * be supported.
 */
declare export type ZoomedElementBaseType = Element;
 ...
 */
declare export type ZoomBehavior<ZoomRefElement: ZoomedElementBaseType, Datum> = {
...
transform(
selection: Selection<ZoomRefElement, Datum, any, any>,
transform: ValueFn<ZoomRefElement, Datum, ZoomTransform>): void,
...
selection: Selection<ZoomRefElement, Datum, any, any>,
x: number,
y: ValueFn<ZoomRefElement, Datum, number>): void,
...
scaleBy(
selection: Selection<ZoomRefElement, Datum, any, any>,
k: ValueFn<ZoomRefElement, Datum, number>): void,
...
transform: ZoomTransform,
extent: [[number, number], [number, number]],
translateExtent: [[number, number], [number, number]]) => ZoomTransform)): this,
 ...
 */
extent(
extent: ValueFn<ZoomRefElement, Datum, [[number, number], [number, number]]>): this,
 ...
 */
interpolate<InterpolationFactory: (a: ZoomView, b: ZoomView) => ((t: number) => ZoomView)>(
 ...
 */
interpolate(
interpolatorFactory: (a: ZoomView, b: ZoomView) => ((t: number) => ZoomView)): this,
 ...
 */
on(typenames: string): ValueFn<ZoomRefElement, Datum, void> | void,
 ...
 * The second generic refers to the type of the datum of the reference element.
 */
declare export function zoom<ZoomRefElement: ZoomedElementBaseType, Datum>(
 ...
 * The second generic refers to the type of the datum of the reference element.
 */
declare export interface D3ZoomEvent<ZoomRefElement: ZoomedElementBaseType, Datum> {
 ...
 */
declare export interface ZoomTransform {
 ...
 */
rescaleX<S: ZoomScale>(xScale: S): S,
 ...
 */
rescaleY<S: ZoomScale>(yScale: S): S,
 ...
 */
declare export function zoomTransform(node: ZoomedElementBaseType): ZoomTransform

	
/**
 * The identity transform, where k = 1, tx = ty = 0.
 */
declare export var zoomIdentity: ZoomTransform;
    }
