declare module "cli-table2" {
  declare type CliTable2$CharName =
    | "top"
    | "top-mid"
    | "top-left"
    | "top-right"
  ...
  declare type CliTable2$CellValue = boolean | number | string | null | void;
  ...
  declare interface CliTable2 {
    new(
      options?: CliTable2$CliTable2$TableConstructorOptions
    ): CliTable2$CliTable2$Table;
