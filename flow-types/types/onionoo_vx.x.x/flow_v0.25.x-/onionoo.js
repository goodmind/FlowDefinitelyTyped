declare module "onionoo" {
  import type { Cache, GotPromise } from "got";

  declare module.exports: typeof Oninoo;

  declare var Oninoo: Onionoo;
  declare interface Onionoo {
    new(
      options?: Onionoo$Onionoo$Options
    ): Onionoo$Onionoo$Instance & Onionoo$Onionoo$Endpoints;
    new(
      options: Onionoo$Onionoo$OptionsWithEndpoints
    ): Onionoo$Onionoo$Instance & $Shape<Onionoo$Onionoo$Endpoints>;
  }
  declare interface Onionoo$Instance {
    get(
      endpoint: "summary",
      query?: Onionoo$QueryParameters
    ): GotPromise<Onionoo$Summary>;
    get(
      endpoint: "details",
      query?: Onionoo$QueryParameters
    ): GotPromise<Onionoo$Details>;
    get(
      endpoint: "bandwidth",
      query?: Onionoo$QueryParameters
    ): GotPromise<Onionoo$Bandwidth>;
    get(
      endpoint: "weights",
      query?: Onionoo$QueryParameters
    ): GotPromise<Onionoo$Weights>;
    get(
      endpoint: "clients",
      query?: Onionoo$QueryParameters
    ): GotPromise<Onionoo$Clients>;
    get(
      endpoint: "uptime",
      query?: Onionoo$QueryParameters
    ): GotPromise<Onionoo$Uptime>;
  }

  declare interface Onionoo$Endpoints {
    summary(query?: Onionoo$QueryParameters): GotPromise<Onionoo$Summary>;
    details(query?: Onionoo$QueryParameters): GotPromise<Onionoo$Details>;
    bandwidth(query?: Onionoo$QueryParameters): GotPromise<Onionoo$Bandwidth>;
    weights(query?: Onionoo$QueryParameters): GotPromise<Onionoo$Weights>;
    clients(query?: Onionoo$QueryParameters): GotPromise<Onionoo$Clients>;
    uptime(query?: Onionoo$QueryParameters): GotPromise<Onionoo$Uptime>;
  }

  declare interface Onionoo$Options {
    /**
  ...
  declare type Onionoo$OptionsWithEndpoints = {
    /**
  ...
  declare interface Onionoo$QueryParameters {
    /**
  ...
  declare type Onionoo$Summary = Onionoo$Response<
    Onionoo$RelaySummary,
    Onionoo$BridgeSummary
  >;

  declare type Onionoo$Details = Onionoo$Response<
    Onionoo$Relay,
    Onionoo$Bridge
  >;

  declare type Onionoo$Bandwidth = Onionoo$Response<
    Onionoo$NodeBandwidth,
    Onionoo$NodeBandwidth
  >;

  declare type Onionoo$Weights = Onionoo$Response<Onionoo$RelayWeights, void>;

  declare type Onionoo$Clients = Onionoo$Response<void, Onionoo$BridgeClients>;

  declare type Onionoo$Uptime = Onionoo$Response<
    Onionoo$RelayUptime,
    Onionoo$BridgeUptime
  >;

  declare interface Onionoo$Response<TRelay, TBridge> {
    /**
  ...
  declare interface Onionoo$RelaySummary {
    /**
  ...
  declare interface Onionoo$Relay {
    /**
     * Relay nickname consisting of 1–19 alphanumerical characters.
     */
    nickname: string;
  ...
  declare interface Onionoo$BridgeSummary {
    /**
  ...
  declare interface Onionoo$Bridge {
    /**
     * Bridge nickname consisting of 1–19 alphanumerical characters.
     */
    nickname: string;
  ...
  declare interface Onionoo$NodeBandwidth {
    /**
    ...
    write_history?: $Shape<
      Record<
        "3_days" | "1_week" | "1_month" | "6_months" | "1_year" | "5_years",
        Onionoo$Histogram
      >
    >;
  ...
  declare interface Onionoo$RelayWeights {
    /**
     * Node fingerprint consisting of 40 upper-case hexadecimal characters.
     */
    fingerprint: string;
     ...
     */
    consensus_weight_fraction?: $Shape<
      Record<
  ...
  declare interface Onionoo$BridgeClients {
    /**
     * SHA-1 hash of the bridge fingerprint consisting of 40 upper-case hexadecimal characters.
     */
    fingerprint: string;
     ...
     */
    average_clients?: $Shape<
      Record<"6_months" | "1_year" | "5_years", Onionoo$Histogram>
    >;
  }

  declare interface Onionoo$RelayUptime {
    /**
     * Relay fingerprint consisting of 40 upper-case hexadecimal characters.
     */
    fingerprint: string;
  ...
  declare interface Onionoo$BridgeUptime {
    /**
     * SHA-1 hash of the bridge fingerprint consisting of 40 upper-case hexadecimal characters.
     */
    fingerprint: string;
  ...
  declare interface Onionoo$Histogram {
    first: string;
    last: string;
    interval: number;
    factor: number;
