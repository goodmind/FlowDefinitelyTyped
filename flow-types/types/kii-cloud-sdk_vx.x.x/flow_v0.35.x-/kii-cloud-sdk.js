declare module 'kii-cloud-sdk' {
        declare  class KiiCloud$KiiACLAction {
  constructor(...args: empty): mixed;
static +KiiACLBucketActionCreateObjects: Class<KiiCloud$KiiACLAction__KiiACLBucketActionCreateObjects> & KiiCloud$KiiACLAction__KiiACLBucketActionCreateObjects & 0;// 0
static +KiiACLBucketActionQueryObjects: Class<KiiCloud$KiiACLAction__KiiACLBucketActionQueryObjects> & KiiCloud$KiiACLAction__KiiACLBucketActionQueryObjects & 1;// 1
static +KiiACLBucketActionDropBucket: Class<KiiCloud$KiiACLAction__KiiACLBucketActionDropBucket> & KiiCloud$KiiACLAction__KiiACLBucketActionDropBucket & 2;// 2
static +KiiACLObjectActionRead: Class<KiiCloud$KiiACLAction__KiiACLObjectActionRead> & KiiCloud$KiiACLAction__KiiACLObjectActionRead & 3;// 3
static +KiiACLObjectActionWrite: Class<KiiCloud$KiiACLAction__KiiACLObjectActionWrite> & KiiCloud$KiiACLAction__KiiACLObjectActionWrite & 4;// 4
static +KiiACLBucketActionReadObjects: Class<KiiCloud$KiiACLAction__KiiACLBucketActionReadObjects> & KiiCloud$KiiACLAction__KiiACLBucketActionReadObjects & 5;// 5
static +KiiACLSubscribeToTopic: Class<KiiCloud$KiiACLAction__KiiACLSubscribeToTopic> & KiiCloud$KiiACLAction__KiiACLSubscribeToTopic & 6;// 6
static +KiiACLSendMessageToTopic: Class<KiiCloud$KiiACLAction__KiiACLSendMessageToTopic> & KiiCloud$KiiACLAction__KiiACLSendMessageToTopic & 7;// 7

}

declare class KiiCloud$KiiACLAction__KiiACLBucketActionCreateObjects mixins KiiCloud$KiiACLAction {}
declare class KiiCloud$KiiACLAction__KiiACLBucketActionQueryObjects mixins KiiCloud$KiiACLAction {}
declare class KiiCloud$KiiACLAction__KiiACLBucketActionDropBucket mixins KiiCloud$KiiACLAction {}
declare class KiiCloud$KiiACLAction__KiiACLObjectActionRead mixins KiiCloud$KiiACLAction {}
declare class KiiCloud$KiiACLAction__KiiACLObjectActionWrite mixins KiiCloud$KiiACLAction {}
declare class KiiCloud$KiiACLAction__KiiACLBucketActionReadObjects mixins KiiCloud$KiiACLAction {}
declare class KiiCloud$KiiACLAction__KiiACLSubscribeToTopic mixins KiiCloud$KiiACLAction {}
declare class KiiCloud$KiiACLAction__KiiACLSendMessageToTopic mixins KiiCloud$KiiACLAction {}


declare  class KiiCloud$KiiSite {
  constructor(...args: empty): mixed;
static +US: Class<KiiCloud$KiiSite__US> & KiiCloud$KiiSite__US & 0;// 0
static +JP: Class<KiiCloud$KiiSite__JP> & KiiCloud$KiiSite__JP & 1;// 1
static +CN: Class<KiiCloud$KiiSite__CN> & KiiCloud$KiiSite__CN & 2;// 2
static +SG: Class<KiiCloud$KiiSite__SG> & KiiCloud$KiiSite__SG & 3;// 3
static +CN3: Class<KiiCloud$KiiSite__CN3> & KiiCloud$KiiSite__CN3 & 4;// 4
static +EU: Class<KiiCloud$KiiSite__EU> & KiiCloud$KiiSite__EU & 5;// 5

}

declare class KiiCloud$KiiSite__US mixins KiiCloud$KiiSite {}
declare class KiiCloud$KiiSite__JP mixins KiiCloud$KiiSite {}
declare class KiiCloud$KiiSite__CN mixins KiiCloud$KiiSite {}
declare class KiiCloud$KiiSite__SG mixins KiiCloud$KiiSite {}
declare class KiiCloud$KiiSite__CN3 mixins KiiCloud$KiiSite {}
declare class KiiCloud$KiiSite__EU mixins KiiCloud$KiiSite {}


declare  class KiiCloud$KiiAnalyticsSite {
  constructor(...args: empty): mixed;
static +US: Class<KiiCloud$KiiAnalyticsSite__US> & KiiCloud$KiiAnalyticsSite__US & 0;// 0
static +JP: Class<KiiCloud$KiiAnalyticsSite__JP> & KiiCloud$KiiAnalyticsSite__JP & 1;// 1
static +CN: Class<KiiCloud$KiiAnalyticsSite__CN> & KiiCloud$KiiAnalyticsSite__CN & 2;// 2
static +SG: Class<KiiCloud$KiiAnalyticsSite__SG> & KiiCloud$KiiAnalyticsSite__SG & 3;// 3
static +CN3: Class<KiiCloud$KiiAnalyticsSite__CN3> & KiiCloud$KiiAnalyticsSite__CN3 & 4;// 4
static +EU: Class<KiiCloud$KiiAnalyticsSite__EU> & KiiCloud$KiiAnalyticsSite__EU & 5;// 5

}

declare class KiiCloud$KiiAnalyticsSite__US mixins KiiCloud$KiiAnalyticsSite {}
declare class KiiCloud$KiiAnalyticsSite__JP mixins KiiCloud$KiiAnalyticsSite {}
declare class KiiCloud$KiiAnalyticsSite__CN mixins KiiCloud$KiiAnalyticsSite {}
declare class KiiCloud$KiiAnalyticsSite__SG mixins KiiCloud$KiiAnalyticsSite {}
declare class KiiCloud$KiiAnalyticsSite__CN3 mixins KiiCloud$KiiAnalyticsSite {}
declare class KiiCloud$KiiAnalyticsSite__EU mixins KiiCloud$KiiAnalyticsSite {}


declare  class KiiCloud$KiiSocialNetworkName {
  constructor(...args: empty): mixed;
static +FACEBOOK: Class<KiiCloud$KiiSocialNetworkName__FACEBOOK> & KiiCloud$KiiSocialNetworkName__FACEBOOK & 1;// 1
static +TWITTER: Class<KiiCloud$KiiSocialNetworkName__TWITTER> & KiiCloud$KiiSocialNetworkName__TWITTER & 2;// 2
static +QQ: Class<KiiCloud$KiiSocialNetworkName__QQ> & KiiCloud$KiiSocialNetworkName__QQ & 3;// 3
static +GOOGLEPLUS: Class<KiiCloud$KiiSocialNetworkName__GOOGLEPLUS> & KiiCloud$KiiSocialNetworkName__GOOGLEPLUS & 4;// 4
static +RENREN: Class<KiiCloud$KiiSocialNetworkName__RENREN> & KiiCloud$KiiSocialNetworkName__RENREN & 5;// 5

}

declare class KiiCloud$KiiSocialNetworkName__FACEBOOK mixins KiiCloud$KiiSocialNetworkName {}
declare class KiiCloud$KiiSocialNetworkName__TWITTER mixins KiiCloud$KiiSocialNetworkName {}
declare class KiiCloud$KiiSocialNetworkName__QQ mixins KiiCloud$KiiSocialNetworkName {}
declare class KiiCloud$KiiSocialNetworkName__GOOGLEPLUS mixins KiiCloud$KiiSocialNetworkName {}
declare class KiiCloud$KiiSocialNetworkName__RENREN mixins KiiCloud$KiiSocialNetworkName {}
...
createdAt: number,
provider: KiiCloud$KiiSocialNetworkName,
...
declare interface KiiCloud$KiiError {
status: number,
code: string,
message: string
} 
...
appID: string,
appKey: string,
site: KiiCloud$KiiSite,
analyticsOption?: any): void;
 ...
 */
static bucketWithName(bucketName: string): KiiCloud$KiiBucket;
 ...
 */
static encryptedBucketWithName(bucketName: string): KiiCloud$KiiBucket;
 ...
 */
static groupWithName(groupName: string): KiiCloud$KiiGroup;
 ...
 */
static groupWithNameAndMembers(groupName: string, members: KiiCloud$KiiUser[]): KiiCloud$KiiGroup;
 ...
 */
static serverCodeEntry(entryName: string): KiiCloud$KiiServerCodeEntry;
 ...
 */
static serverCodeEntryWithVersion(entryName: string, version: string): KiiCloud$KiiServerCodeEntry;
 ...
 */
static topicWithName(topicName: string): KiiCloud$KiiTopic;
 ...
 */
declare class KiiCloud$KiiACLEntry  {
 ...
 */
setAction(value: KiiCloud$KiiACLAction): void;

/**
 * Get the action that is being permitted/restricted in this entry
 */
getAction(): KiiCloud$KiiACLAction;
 ...
 */
getSubject<T: KiiCloud$KiiACLSubject>(): T;
...
Subject: KiiCloud$KiiACLSubject,
action: KiiCloud$KiiACLAction): KiiCloud$KiiACLEntry
}
 ...
 * The main SDK class
 */
declare class KiiCloud$KiiAnalytics  {
...
appID: string,
appKey: string,
site: KiiCloud$KiiAnalyticsSite,
 ...
 */
declare class KiiCloud$KiiAnonymousUser  {
 ...
 */
declare class KiiCloud$KiiAnyAuthenticatedUser  {
 ...
 */
declare class KiiCloud$KiiAppAdminContext  {
 ...
 */
registerOwnerWithThingID<T: KiiCloud$KiiUser | KiiCloud$KiiGroup>(
thingID: string,
owner: T,
callbacks?: {
success(group: T): any,
 ...
 */
registerOwnerWithVendorThingID<T: KiiCloud$KiiUser | KiiCloud$KiiGroup>(
vendorThingID: string,
owner: T,
callbacks?: {
success(group: T): any,
 ...
 */
declare class KiiCloud$KiiBucket  {
 ...
 */
declare class KiiCloud$KiiClause  {
 ...
 */
static and(...A: KiiCloud$KiiClause[]): KiiCloud$KiiClause;
 ...
 */
static or(...A: KiiCloud$KiiClause[]): KiiCloud$KiiClause;
 ...
 */
static not(clause: KiiCloud$KiiClause): KiiCloud$KiiClause;
 ...
 */
static equals(key: string, value: any): KiiCloud$KiiClause;
 ...
 * @param value the value to compare
 */
static notEquals(key: string, value: any): KiiCloud$KiiClause;
 ...
 * @param value the value to compare
 */
static greaterThan(key: string, value: any): KiiCloud$KiiClause;
 ...
 * @param value the value to compare
 */
static greaterThanOrEqual(key: string, value: any): KiiCloud$KiiClause;
 ...
 * @param value the value to compare
 */
static lessThan(key: string, value: any): KiiCloud$KiiClause;
 ...
 * @param value the value to compare
 */
static lessThanOrEqual(key: string, value: any): KiiCloud$KiiClause;
 ...
 */
static inClause(key: string, values: any[]): KiiCloud$KiiClause;
 ...
 * @param value the value to compare
 */
static startsWith(key: string, value: any): KiiCloud$KiiClause;
 ...
 */
static hasField(key: string, fieldType: string): KiiCloud$KiiClause
}
 ...
 */
declare class KiiCloud$KiiErrorParser  {
 ...
 * @example var err = KiiErrorParser.parse(errorString);
 ...
 */
static parse<T: string | Error>(error: T): KiiCloud$KiiError
}
 ...
 */
declare class KiiCloud$KiiGeoPoint  {
 ...
 */
static geoPoint(latitude: number, longitude: number): KiiCloud$KiiGeoPoint
}
 ...
 */
declare class KiiCloud$KiiGroup  {
 ...
 */
static groupWithID(groupId: string): KiiCloud$KiiGroup;
 ...
 */
static groupWithURI(uri: string): KiiCloud$KiiGroup;
 ...
 */
declare class KiiCloud$KiiObject  {
 ...
 */
setGeoPoint(key: string, KiiCloud$KiiGeoPoint: KiiCloud$KiiGeoPoint): void;
 ...
 */
static objectWithURI(uri: string): KiiCloud$KiiObject;
 ...
 */
declare class KiiCloud$KiiPushInstallation  {
 ...
 */
declare class KiiCloud$KiiPushMessageBuilder  {
 ...
 */
declare class KiiCloud$KiiPushSubscription  {
 ...
 */
subscribe<T: KiiCloud$KiiBucket | KiiCloud$KiiTopic>(
target: T,
callbacks?: {
 ...
 */
unsubscribe<T: KiiCloud$KiiBucket | KiiCloud$KiiTopic>(
target: T,
callbacks?: {
success(subscription: KiiCloud$KiiPushSubscription, topic: T): any,
failure(error: Error): any
 ...
 */
isSubscribed<T: KiiCloud$KiiBucket | KiiCloud$KiiTopic>(
target: T,
callbacks?: {
success(
 ...
 */
declare class KiiCloud$KiiQuery  {
 ...
 */
static queryWithClause(clause: KiiCloud$KiiClause): KiiCloud$KiiQuery;
 ...
 */
declare class KiiCloud$KiiServerCodeEntry  {
 ...
 */
declare class KiiCloud$KiiServerCodeExecResult  {
 ...
 */
declare class KiiCloud$KiiSocialConnect  {
 ...
 */
static setupNetwork(
networkName: KiiCloud$KiiSocialNetworkName,
apiKey: string,
apiSecret: string,
extras: any): void;
...
callbacks?: {
success(user: KiiCloud$KiiUser, network: KiiCloud$KiiSocialNetworkName): any,
failure(
user: KiiCloud$KiiUser,
network: KiiCloud$KiiSocialNetworkName,
anErrorString: string): any
}): Promise<[KiiCloud$KiiUser, KiiCloud$KiiSocialNetworkName]>;
 ...
 */
static getAccessTokenForNetwork(networkName: KiiCloud$KiiSocialNetworkName): string;
 ...
 */
static getAccessTokenExpirationForNetwork(networkName: KiiCloud$KiiSocialNetworkName): string;
 ...
 */
static getAccessTokenObjectForNetwork(networkName: KiiCloud$KiiSocialNetworkName): any
}
 ...
 */
declare class KiiCloud$KiiThing  {
 ...
 */
isOwner<T: KiiCloud$KiiUser | KiiCloud$KiiGroup>(
owner: T,
callbacks?: {
 ...
 */
registerOwner<T: KiiCloud$KiiUser | KiiCloud$KiiGroup>(
owner: T,
callbacks?: {
 ...
 */
static registerOwnerWithThingID<T: KiiCloud$KiiUser | KiiCloud$KiiGroup>(
thingID: string,
owner: T,
callbacks?: {
success(group: T): any,
 ...
 */
static registerOwnerWithVendorThingID<T: KiiCloud$KiiUser | KiiCloud$KiiGroup>(
vendorThingID: string,
owner: T,
callbacks?: {
success(group: T): any,
 ...
 */
unregisterOwner<T: KiiCloud$KiiUser | KiiCloud$KiiGroup>(
owner: T,
callbacks?: {
success(thing: KiiCloud$KiiThing, group: T): any,
failure(error: Error): any
 ...
 */
declare class KiiCloud$KiiThingContext  {
 ...
 */
declare class KiiCloud$KiiTopic  {
 ...
 */
declare class KiiCloud$KiiUser  {
 ...
 */
static getCurrentUser(): KiiCloud$KiiUser;
 ...
 */
static userWithUsername(username: string, password: string): KiiCloud$KiiUser;
 ...
 */
static userWithPhoneNumber(phoneNumber: string, password: string): KiiCloud$KiiUser;
 ...
 */
static userWithPhoneNumberAndUsername(phoneNumber: string, username: string, password: string): KiiCloud$KiiUser;
 ...
 */
static userWithEmailAddress(emailAddress: string, password: string): KiiCloud$KiiUser;
 ...
 */
static userWithEmailAddressAndUsername(emailAddress: string, username: string, password: string): KiiCloud$KiiUser;
 ...
 */
static userWithEmailAddressAndPhoneNumber(emailAddress: string, phoneNumber: string, password: string): KiiCloud$KiiUser;
 ...
 */
static userWithID(userID: string): KiiCloud$KiiUser;
 ...
 */
static userWithURI(uri: string): KiiCloud$KiiUser;
 ...
 */
putIdentity(
KiiCloud$identityData: KiiCloud$identityData,
password: string,
callbacks?: {
 ...
 * @example // Example using callback
KiiUser.completeResetPassword("john.doe
 * @kii .com", "new-password", "223789",
{
success: function() {
   // Succeeded.
},
...
"john.doe
 * @kii .com", "new-password", "223789").then(function() {
  // Succeeded.
 ...
 */
declare class KiiCloud$KiiUserBuilder  {
...
proper format
 */
static builderWithIdentifier(identifier: string, password: string): KiiCloud$KiiUserBuilder;
...
proper format
 */
static builderWithEmailAddress(emailAddress: string, password: string): KiiCloud$KiiUserBuilder;
 ...
 * @throws If the phone number is not in the proper format
 */
static builderWithGlobalPhoneNumber(phoneNumber: string, password: string): KiiCloud$KiiUserBuilder;
...
proper format
 */
static builderWithUsername(username: string, password: string): KiiCloud$KiiUserBuilder;
