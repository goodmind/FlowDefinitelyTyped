declare module "kii-cloud-sdk" {
  declare class KiiCloud$KiiACLAction {
    ...
    static +KiiACLBucketActionCreateObjects: Class<KiiCloud$KiiACLAction__KiiACLBucketActionCreateObjects> &
      KiiCloud$KiiACLAction__KiiACLBucketActionCreateObjects &
      0; // 0
    static +KiiACLBucketActionQueryObjects: Class<KiiCloud$KiiACLAction__KiiACLBucketActionQueryObjects> &
      KiiCloud$KiiACLAction__KiiACLBucketActionQueryObjects &
      1; // 1
    static +KiiACLBucketActionDropBucket: Class<KiiCloud$KiiACLAction__KiiACLBucketActionDropBucket> &
      KiiCloud$KiiACLAction__KiiACLBucketActionDropBucket &
      2; // 2
    static +KiiACLObjectActionRead: Class<KiiCloud$KiiACLAction__KiiACLObjectActionRead> &
      KiiCloud$KiiACLAction__KiiACLObjectActionRead &
      3; // 3
    static +KiiACLObjectActionWrite: Class<KiiCloud$KiiACLAction__KiiACLObjectActionWrite> &
      KiiCloud$KiiACLAction__KiiACLObjectActionWrite &
      4; // 4
    static +KiiACLBucketActionReadObjects: Class<KiiCloud$KiiACLAction__KiiACLBucketActionReadObjects> &
      KiiCloud$KiiACLAction__KiiACLBucketActionReadObjects &
      5; // 5
    static +KiiACLSubscribeToTopic: Class<KiiCloud$KiiACLAction__KiiACLSubscribeToTopic> &
      KiiCloud$KiiACLAction__KiiACLSubscribeToTopic &
      6; // 6
    static +KiiACLSendMessageToTopic: Class<KiiCloud$KiiACLAction__KiiACLSendMessageToTopic> &
      KiiCloud$KiiACLAction__KiiACLSendMessageToTopic &
      7; // 7
  }

  declare class KiiCloud$KiiACLAction__KiiACLBucketActionCreateObjects
    mixins KiiCloud$KiiACLAction {}
  declare class KiiCloud$KiiACLAction__KiiACLBucketActionQueryObjects
    mixins KiiCloud$KiiACLAction {}
  declare class KiiCloud$KiiACLAction__KiiACLBucketActionDropBucket
    mixins KiiCloud$KiiACLAction {}
  declare class KiiCloud$KiiACLAction__KiiACLObjectActionRead
    mixins KiiCloud$KiiACLAction {}
  declare class KiiCloud$KiiACLAction__KiiACLObjectActionWrite
    mixins KiiCloud$KiiACLAction {}
  declare class KiiCloud$KiiACLAction__KiiACLBucketActionReadObjects
    mixins KiiCloud$KiiACLAction {}
  declare class KiiCloud$KiiACLAction__KiiACLSubscribeToTopic
    mixins KiiCloud$KiiACLAction {}
  declare class KiiCloud$KiiACLAction__KiiACLSendMessageToTopic
    mixins KiiCloud$KiiACLAction {}
  ...
  declare class KiiCloud$KiiAnalyticsSite {
    constructor(...args: empty): mixed;
    static +US: Class<KiiCloud$KiiAnalyticsSite__US> &
      KiiCloud$KiiAnalyticsSite__US &
      0; // 0
    static +JP: Class<KiiCloud$KiiAnalyticsSite__JP> &
      KiiCloud$KiiAnalyticsSite__JP &
      1; // 1
    static +CN: Class<KiiCloud$KiiAnalyticsSite__CN> &
      KiiCloud$KiiAnalyticsSite__CN &
      2; // 2
    static +SG: Class<KiiCloud$KiiAnalyticsSite__SG> &
      KiiCloud$KiiAnalyticsSite__SG &
      3; // 3
    static +CN3: Class<KiiCloud$KiiAnalyticsSite__CN3> &
      KiiCloud$KiiAnalyticsSite__CN3 &
      4; // 4
    static +EU: Class<KiiCloud$KiiAnalyticsSite__EU> &
      KiiCloud$KiiAnalyticsSite__EU &
      5; // 5
  }

  declare class KiiCloud$KiiAnalyticsSite__US
    mixins KiiCloud$KiiAnalyticsSite {}
  declare class KiiCloud$KiiAnalyticsSite__JP
    mixins KiiCloud$KiiAnalyticsSite {}
  declare class KiiCloud$KiiAnalyticsSite__CN
    mixins KiiCloud$KiiAnalyticsSite {}
  declare class KiiCloud$KiiAnalyticsSite__SG
    mixins KiiCloud$KiiAnalyticsSite {}
  declare class KiiCloud$KiiAnalyticsSite__CN3
    mixins KiiCloud$KiiAnalyticsSite {}
  declare class KiiCloud$KiiAnalyticsSite__EU
    mixins KiiCloud$KiiAnalyticsSite {}

  declare class KiiCloud$KiiSocialNetworkName {
    constructor(...args: empty): mixed;
    static +FACEBOOK: Class<KiiCloud$KiiSocialNetworkName__FACEBOOK> &
      KiiCloud$KiiSocialNetworkName__FACEBOOK &
      1; // 1
    static +TWITTER: Class<KiiCloud$KiiSocialNetworkName__TWITTER> &
      KiiCloud$KiiSocialNetworkName__TWITTER &
      2; // 2
    static +QQ: Class<KiiCloud$KiiSocialNetworkName__QQ> &
      KiiCloud$KiiSocialNetworkName__QQ &
      3; // 3
    static +GOOGLEPLUS: Class<KiiCloud$KiiSocialNetworkName__GOOGLEPLUS> &
      KiiCloud$KiiSocialNetworkName__GOOGLEPLUS &
      4; // 4
    static +RENREN: Class<KiiCloud$KiiSocialNetworkName__RENREN> &
      KiiCloud$KiiSocialNetworkName__RENREN &
      5; // 5
  }

  declare class KiiCloud$KiiSocialNetworkName__FACEBOOK
    mixins KiiCloud$KiiSocialNetworkName {}
  declare class KiiCloud$KiiSocialNetworkName__TWITTER
    mixins KiiCloud$KiiSocialNetworkName {}
  declare class KiiCloud$KiiSocialNetworkName__QQ
    mixins KiiCloud$KiiSocialNetworkName {}
  declare class KiiCloud$KiiSocialNetworkName__GOOGLEPLUS
    mixins KiiCloud$KiiSocialNetworkName {}
  declare class KiiCloud$KiiSocialNetworkName__RENREN
    mixins KiiCloud$KiiSocialNetworkName {}
  ...
  declare type KiiCloud$KiiACLSubject =
    | KiiCloud$KiiGroup
    | KiiCloud$KiiUser
 ...
 */
    ...
    ): Promise<[KiiCloud$KiiTopic[], string]>;
 ...
 */
    static entryWithSubject(
      ...
      action: KiiCloud$KiiACLAction
    ): KiiCloud$KiiACLEntry;
  }
    ...
    registerGroupWithOwnerAndID(
      ...
      callbacks?: {
        ...
        failure(
          ...
          removeMembersArray: KiiCloud$KiiUser[]
        ): any
      }
    ): Promise<KiiCloud$KiiAppAdminContext>;
    ...
    findUserByEmail(
      ...
      callbacks?: {
        success(
          ...
          theMatchedUser: KiiCloud$KiiUser
        ): any,
        failure(
          adminContext: KiiCloud$KiiAppAdminContext,
          anErrorString: string
 ...
 */
    static geoBox(
      ...
      southWest: KiiCloud$KiiGeoPoint
    ): KiiCloud$KiiClause;
 ...
 */
     ...
     */
    apnsAlert(
      alert: string | KiiCloud$APNSAlert
    ): KiiCloud$KiiPushMessageBuilder;
 ...
 */
    execute<T>(
      ...
      [KiiCloud$KiiServerCodeEntry, T, KiiCloud$KiiServerCodeExecResult]
    >;
 ...
 */
    static registerOwnerWithVendorThingID<
      T: KiiCloud$KiiUser | KiiCloud$KiiGroup
    >(
      vendorThingID: string,
      owner: T,
      callbacks?: {
