declare module 'gulp-responsive-images' {
	...
	import type {
          ParsedPath,RenameOptions
        } from 'gulp-rename';

	declare module.exports: typeof GulpResponsiveImage

	declare function GulpResponsiveImage(configs: GulpResponsiveImage$GulpResponsiveImage$Matchers): stream.Transform

	declare type GulpResponsiveImage$SamplingFactor = [number, number];

declare type GulpResponsiveImage$Rename = string | ((path: ParsedPath) => any) | RenameOptions;
