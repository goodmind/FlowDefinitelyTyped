declare module "react-event-listener" {
  declare export interface EventOptions {
    /**
     * @default false
     */
    passive?: boolean;
  ...
  declare export function withOptions<T>(
    handler: (ev: T) => any,
    options: EventOptions
  ): (ev: T) => any;

  declare export interface EventListenerProps {
  ...
  declare export default class EventListener
    mixins React.Component<EventListenerProps> {}
}
