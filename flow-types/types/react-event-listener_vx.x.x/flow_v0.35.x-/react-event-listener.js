...
capture?: boolean
	...
	declare export function withOptions<T>(handler: (ev: T) => any, options: EventOptions): (ev: T) => any
...
target: Window | Document | string
	...
	declare export default class EventListener mixins React.Component<EventListenerProps> {}
    }
