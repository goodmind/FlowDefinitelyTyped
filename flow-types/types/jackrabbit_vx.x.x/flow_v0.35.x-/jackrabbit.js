...
static +direct: Class<jackrabbit$exchangeType__direct> & jackrabbit$exchangeType__direct & "direct";// "direct"
static +fanout: Class<jackrabbit$exchangeType__fanout> & jackrabbit$exchangeType__fanout & "fanout";// "fanout"
static +topic: Class<jackrabbit$exchangeType__topic> & jackrabbit$exchangeType__topic & "topic";// "topic"

}

declare class jackrabbit$exchangeType__direct mixins jackrabbit$exchangeType {}
declare class jackrabbit$exchangeType__fanout mixins jackrabbit$exchangeType {}
...
publish(message: any, options?: jackrabbit$PublishOptions): jackrabbit$Exchange
} & NodeJS.EventEmitter
...
consume: (
callback: (data: any, ack: jackrabbit$AckCallback, nack: () => void, msg: Message) => void,
options?: Options.Consume) => void,
