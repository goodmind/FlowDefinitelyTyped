declare module 'react-native-star-rating' {
	...
	import type {
          ImageURISource,StyleProp,ViewStyle
        } from 'react-native';

	declare export interface StarRatingProps {
...
selectedStar(rating: number): void
	...
	declare export default class StarRating mixins React.Component<StarRatingProps> {}
    }
