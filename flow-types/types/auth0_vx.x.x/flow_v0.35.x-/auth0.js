...
scope: string[]
	...
	declare export type UpdateClientGrant = Pick<$Shape<CreateClientGrant>, "scope">;
...
id?: string
	...
	declare export type Strategy = "ad"
| "adfs"
| "amazon"
| "dropbox"
| "bitbucket"
...
client_id: string
	...
	declare export type DeleteDeleteMultifactorParamsProvider = "duo" | "google-authenticator";
	declare export interface DeleteMultifactorParams {
id: string,
provider: DeleteDeleteMultifactorParamsProvider
} 
	declare export type UnlinkAccountsParamsProvider = "ad"
| "adfs"
| "amazon"
| "dropbox"
| "bitbucket"
...
clientId?: string
	...
	declare export type ClientAppType = "native"
| "spa"
| "regular_web"
| "non_interactive"
| "rms"
...
cb: (err: Error, response: any) => void): void;
...
cb: (err: Error, connection: Connection) => void): void;
...
params: ClientParams,
data: Data,
cb: (err: Error, client: Client) => void): void;
...
cb: (err: Error, data: ClientGrant) => void): void;
...
params: ObjectWithId,
data: UpdateUserData,
cb: (err: Error, data: User) => void): void;
...
cb: (err: Error, data: UnlinkAccountsResponse) => void): void;
...
cb?: (err: Error, data: PasswordChangeTicketResponse) => void): void;
...
cb?: (err: Error, data: ResourceServer) => void): void;
...
constructor(options: DatabaseClientOptions, oauth: OAuthAuthenticator): this;
changePassword(data: ResetPasswordOptions): Promise<any>;
changePassword(data: ResetPasswordOptions, cb: (err: Error, message: string) => void): void;
requestChangePasswordEmail(data: ResetPasswordEmailOptions): Promise<any>;
requestChangePasswordEmail(
...
cb: (err: Error, response: SignInToken) => void): void;
signIn(data: SignInOptions): Promise<SignInToken>;
signIn(data: SignInOptions, cb: (err: Error, data: SignInToken) => void): void;
...
constructor(options: PasswordLessClientOptions, oauth: OAuthAuthenticator): this;
signIn(data: SignInOptions): Promise<SignInToken>;
signIn(data: SignInOptions, cb: (err: Error, data: SignInToken) => void): void;
