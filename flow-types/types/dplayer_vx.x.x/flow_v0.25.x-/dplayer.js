declare module "dplayer" {
  ...
  declare export class DPlayerEvents {
    ...
    static +canplay: Class<DPlayerEvents__canplay> &
      DPlayerEvents__canplay &
      "canplay"; // "canplay"
    static +canplaythrough: Class<DPlayerEvents__canplaythrough> &
      DPlayerEvents__canplaythrough &
      "canplaythrough"; // "canplaythrough"
    static +durationchange: Class<DPlayerEvents__durationchange> &
      DPlayerEvents__durationchange &
      "durationchange"; // "durationchange"
    static +emptied: Class<DPlayerEvents__emptied> &
      DPlayerEvents__emptied &
      "emptied"; // "emptied"
    ...
    static +loadeddata: Class<DPlayerEvents__loadeddata> &
      DPlayerEvents__loadeddata &
      "loadeddata"; // "loadeddata"
    static +loadedmetadata: Class<DPlayerEvents__loadedmetadata> &
      DPlayerEvents__loadedmetadata &
      "loadedmetadata"; // "loadedmetadata"
    static +loadstart: Class<DPlayerEvents__loadstart> &
      DPlayerEvents__loadstart &
      "loadstart"; // "loadstart"
    static +mozaudioavailable: Class<DPlayerEvents__mozaudioavailable> &
      DPlayerEvents__mozaudioavailable &
    ...
    static +playing: Class<DPlayerEvents__playing> &
      DPlayerEvents__playing &
      "playing"; // "playing"
    static +progress: Class<DPlayerEvents__progress> &
      DPlayerEvents__progress &
      "progress"; // "progress"
    static +ratechange: Class<DPlayerEvents__ratechange> &
      DPlayerEvents__ratechange &
      "ratechange"; // "ratechange"
    static +seeked: Class<DPlayerEvents__seeked> &
      DPlayerEvents__seeked &
      "seeked"; // "seeked"
    static +seeking: Class<DPlayerEvents__seeking> &
      DPlayerEvents__seeking &
      "seeking"; // "seeking"
    static +stalled: Class<DPlayerEvents__stalled> &
      DPlayerEvents__stalled &
      "stalled"; // "stalled"
    static +suspend: Class<DPlayerEvents__suspend> &
      DPlayerEvents__suspend &
      "suspend"; // "suspend"
    static +timeupdate: Class<DPlayerEvents__timeupdate> &
      DPlayerEvents__timeupdate &
      "timeupdate"; // "timeupdate"
    static +volumechange: Class<DPlayerEvents__volumechange> &
      DPlayerEvents__volumechange &
      "volumechange"; // "volumechange"
    static +waiting: Class<DPlayerEvents__waiting> &
      DPlayerEvents__waiting &
      "waiting"; // "waiting"
    static +screenshot: Class<DPlayerEvents__screenshot> &
      DPlayerEvents__screenshot &
      "screenshot"; // "screenshot"
    static +thumbnails_show: Class<DPlayerEvents__thumbnails_show> &
      DPlayerEvents__thumbnails_show &
      "thumbnails_show"; // "thumbnails_show"
    static +thumbnails_hide: Class<DPlayerEvents__thumbnails_hide> &
      DPlayerEvents__thumbnails_hide &
      "thumbnails_hide"; // "thumbnails_hide"
    static +danmaku_show: Class<DPlayerEvents__danmaku_show> &
      DPlayerEvents__danmaku_show &
      "danmaku_show"; // "danmaku_show"
    static +danmaku_hide: Class<DPlayerEvents__danmaku_hide> &
      DPlayerEvents__danmaku_hide &
      "danmaku_hide"; // "danmaku_hide"
    static +danmaku_clear: Class<DPlayerEvents__danmaku_clear> &
      DPlayerEvents__danmaku_clear &
      "danmaku_clear"; // "danmaku_clear"
    static +danmaku_loaded: Class<DPlayerEvents__danmaku_loaded> &
      DPlayerEvents__danmaku_loaded &
      "danmaku_loaded"; // "danmaku_loaded"
    static +danmaku_send: Class<DPlayerEvents__danmaku_send> &
      DPlayerEvents__danmaku_send &
      "danmaku_send"; // "danmaku_send"
    static +danmaku_opacity: Class<DPlayerEvents__danmaku_opacity> &
      DPlayerEvents__danmaku_opacity &
      "danmaku_opacity"; // "danmaku_opacity"
    static +contextmenu_show: Class<DPlayerEvents__contextmenu_show> &
      DPlayerEvents__contextmenu_show &
      "contextmenu_show"; // "contextmenu_show"
    static +contextmenu_hide: Class<DPlayerEvents__contextmenu_hide> &
      DPlayerEvents__contextmenu_hide &
      "contextmenu_hide"; // "contextmenu_hide"
    static +notice_show: Class<DPlayerEvents__notice_show> &
      DPlayerEvents__notice_show &
      "notice_show"; // "notice_show"
    static +notice_hide: Class<DPlayerEvents__notice_hide> &
      DPlayerEvents__notice_hide &
      "notice_hide"; // "notice_hide"
    static +quality_start: Class<DPlayerEvents__quality_start> &
      DPlayerEvents__quality_start &
      "quality_start"; // "quality_start"
    static +quality_end: Class<DPlayerEvents__quality_end> &
      DPlayerEvents__quality_end &
      "quality_end"; // "quality_end"
    static +destroy: Class<DPlayerEvents__destroy> &
      DPlayerEvents__destroy &
      "destroy"; // "destroy"
    static +resize: Class<DPlayerEvents__resize> &
      DPlayerEvents__resize &
      "resize"; // "resize"
    static +fullscreen: Class<DPlayerEvents__fullscreen> &
      DPlayerEvents__fullscreen &
      "fullscreen"; // "fullscreen"
    static +fullscreen_cancel: Class<DPlayerEvents__fullscreen_cancel> &
      DPlayerEvents__fullscreen_cancel &
      "fullscreen_cancel"; // "fullscreen_cancel"
    static +subtitle_show: Class<DPlayerEvents__subtitle_show> &
      DPlayerEvents__subtitle_show &
      "subtitle_show"; // "subtitle_show"
    static +subtitle_hide: Class<DPlayerEvents__subtitle_hide> &
      DPlayerEvents__subtitle_hide &
      "subtitle_hide"; // "subtitle_hide"
    static +subtitle_change: Class<DPlayerEvents__subtitle_change> &
      DPlayerEvents__subtitle_change &
