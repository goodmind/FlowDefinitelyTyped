declare module 'request' {
	...
	declare interface request$RequestAPI<TRequest: request$Request, TOptions: request$CoreOptions, TUriUrlOptions> {
defaults(
options: TOptions): request$RequestAPI<TRequest, TOptions, request$RequiredUriUrl>,
defaults(
options: request$RequiredUriUrl & TOptions): request$DefaultUriUrlRequestApi<TRequest, TOptions, request$OptionalUriUrl>,
...
options: TUriUrlOptions & TOptions,
callback?: request$RequestCallback): TRequest,
delete(uri: string, options?: TOptions, callback?: request$RequestCallback): TRequest,
...
uri: string,
options?: TOptions,
callback?: request$RequestCallback): request$RequiredUriUrl & TOptions,
initParams(
...
declare type request$DefaultUriUrlRequestApi<TRequest: request$Request, TOptions: request$CoreOptions, TUriUrlOptions> = {
defaults(
options: TOptions): request$DefaultUriUrlRequestApi<TRequest, TOptions, request$OptionalUriUrl>,
(callback?: request$RequestCallback): TRequest,
get(uri: string, options?: TOptions, callback?: request$RequestCallback): TRequest,
get(uri: string, callback?: request$RequestCallback): TRequest,
get(
...
declare type request$RequestCallback = (error: any, response: request$Response, body: any) => void;
...
on(
event: "complete",
listener: (resp: request$Response, body?: string | Buffer) => void): this,
...
} & caseless.Httpified & stream.Stream
...
uri: string | Url,
options?: tough.request$CookieJar.SetCookieOptions): void,
getCookieString(uri: string | Url): string,
getCookies(uri: string | Url): request$Cookie[]
} 
	declare var request: request$request$RequestAPI<request$request$Request, request$request$CoreOptions, request$request$RequiredUriUrl>;
