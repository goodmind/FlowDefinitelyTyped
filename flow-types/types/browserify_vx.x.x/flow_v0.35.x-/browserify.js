 ...
 */
external(file: string[], opts?: browserify$CustomOptions): browserify$BrowserifyObject,
external(file: string, opts?: browserify$CustomOptions): browserify$BrowserifyObject,
 ...
 */
ignore(file: string, opts?: browserify$CustomOptions): browserify$BrowserifyObject,

/**
 * Prevent the module name or file at file from showing up in the output bundle.
 * If your code tries to require() that file it will throw unless you've provided another mechanism for loading it.
 */
exclude(file: string, opts?: browserify$CustomOptions): browserify$BrowserifyObject,
 ...
 */
transform<T: browserify$CustomOptions>(tr: string, opts?: T): browserify$BrowserifyObject,
