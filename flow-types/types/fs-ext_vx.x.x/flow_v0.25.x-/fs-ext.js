 ...
 */
  declare export function fcntlSync(
    fd: number,
    cmd: string,
    arg?: number
  ): number;
 ...
 */
  declare export function seek(
    ...
    offset: number,
    whence: number,
    callback: (err: Error, currFilePos: number) => void
  ): void;
 ...
 */
  declare export function seekSync(
    fd: number,
    offset: number,
    whence: number
  ): number;
...
Just like for utime(2), the absence of the atime and mtime means 'now'.
 */
  declare export function utimeSync(
    path: string,
    atime: number,
    mtime: number
  ): void;
