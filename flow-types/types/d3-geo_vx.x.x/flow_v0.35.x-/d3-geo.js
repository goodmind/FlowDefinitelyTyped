 ...
 */
declare export interface ExtendedGeometryCollection<GeometryType: GeoGeometryObjects> {
type: string,
bbox?: number[],
crs?: {
type: string,
 ...
 */
declare export type ExtendedFeature<GeometryType: GeoGeometryObjects | null, Properties: GeoJSON.GeoJsonProperties> = {
 ...
 */
declare export type ExtendedFeatureCollection<FeatureType: ExtendedFeature> = {
 ...
 */
declare export interface GeoCircleGenerator<This, Datum> {
 ...
 */
declare export interface GeoPath<This, DatumObject: GeoPermissibleObjects> {
