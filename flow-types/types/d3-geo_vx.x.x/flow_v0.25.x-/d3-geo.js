declare module "d3-geo" {
   ...
   */
  declare export type ExtendedFeature<
    GeometryType: GeoGeometryObjects | null = GeoGeometryObjects | null,
   ...
   */
  declare export function geoDistance(
    a: [number, number],
    b: [number, number]
  ): number;
   ...
   * @param b Point specified as a two-element array [longitude, latitude] in degrees.
   */
  declare export function geoInterpolate(
    a: [number, number],
    b: [number, number]
   ...
   */
  declare export function geoCircle<This, Datum>(): GeoCircleGenerator<
    This,
    Datum
  >;
   ...
   */
  declare export interface GeoPath<
    This = any,
    DatumObject: GeoPermissibleObjects = GeoPermissibleObjects
  > {
    /**
     ...
     */
    (object: DatumObject, ...args: any[]): string | null;
     ...
     * @param object An object to be rendered.
     */
    (object: DatumObject, ...args: any[]): void;
   ...
   */
  declare export function geoProjection(
    project: GeoRawProjection
  ): GeoProjection;
   ...
   */
  declare export function geoProjectionMutator(
   ...
   */
  declare export function geoConicConformalRaw(
    phi0: number,
    phi1: number
  ): GeoRawProjection;
   ...
   */
  declare export function geoConicEqualAreaRaw(
    phi0: number,
    phi1: number
  ): GeoRawProjection;
   ...
   */
  declare export function geoConicEquidistantRaw(
    phi0: number,
    phi1: number
  ): GeoRawProjection;
   ...
   */
  declare export function geoTransform<T: GeoTransformPrototype>(
    methods: T
  ): {
   ...
   */
  declare export function geoClipCircle(
    angle: number
