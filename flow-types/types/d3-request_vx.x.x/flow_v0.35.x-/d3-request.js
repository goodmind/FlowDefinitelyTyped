...
data: RequestData,
callback: (error: any, d: ResponseData) => void): this,
 ...
 */
on(type: "beforesend", listener: (xhr: XMLHttpRequest) => void): this,
 ...
 */
on(type: "progress", listener: (progressEvent: ProgressEvent) => void): this,
 ...
 */
on<ResponseData>(type: "load", listener: (data: ResponseData) => void): this,
 ...
 */
response<ResponseData>(callback: (response: XMLHttpRequest) => ResponseData): this,

/**
 * Returns the current response type, which defaults to `` (the empty string).
 */
responseType(): XMLHttpRequestResponseType | void,
...
send<ResponseData>(
method: string,
callback: (error: any | null, d: ResponseData | null) => void): this,
...
user(value: string | null): this
	...
	declare export type DsvRequest = {
row<ParsedRow: {[key: string]: any}>(
value: (rawRow: DSVRowString, index: number, columns: string[]) => ParsedRow): DsvRequest
} & Request
 ...
 */
declare export function csv(url: string): DsvRequest
 ...
 */
declare export function csv(
url: string,
callback: (error: any, d: DSVParsedArray<DSVRowString>) => void): DsvRequest
 ...
 */
declare export function csv<ParsedRow: {[key: string]: any}>(
url: string,
row: (rawRow: DSVRowString, index: number, columns: string[]) => ParsedRow,
callback: (error: any, d: DSVParsedArray<ParsedRow>) => void): DsvRequest
 ...
 */
declare export function html(url: string): Request
 ...
 * And send a GET request.
 */
declare export function html(url: string, callback: (error: any, d: DocumentFragment) => void): Request

	
/**
 * Returns a new request to get the JSON file at the specified url with the default mime type `application/json`.
 */
declare export function json(url: string): Request
 ...
 * And send a GET request.
 */
declare export function json<ParsedObject: {
[key: string]: any
}>(
url: string,
callback: (error: any, d: ParsedObject) => void): Request
 ...
 */
declare export function request(url: string): Request
 ...
 * See `d3.json`, `d3.csv`, `d3.tsv`, `d3.text`, `d3.html` and `d3.xml` for content-specific convenience constructors.
 */
declare export function request(url: string, callback: (error: any, d: XMLHttpRequest) => void): Request

	
/**
 * Returns a new request to get the text file at the specified url with the default mime type `text/plain`.
 */
declare export function text(url: string): Request
 ...
 * And send a GET request.
 */
declare export function text(url: string, callback: (error: any, d: string) => void): Request

	
/**
 * Returns a new request for a TSV file at the specified url with the default mime type `text/tab-separated-values`.
 */
declare export function tsv(url: string): DsvRequest
 ...
 * Use a row conversion function to map and filter row objects to a more-specific representation; see `dsv.parse` for details.
 */
declare export function tsv<ParsedRow: {[key: string]: any}>(
url: string,
row: (rawRow: DSVRowString, index: number, columns: string[]) => ParsedRow,
callback: (error: any, d: DSVParsedArray<ParsedRow>) => void): DsvRequest
 ...
 */
declare export function xml(url: string): Request
 ...
 * And send a GET request.
 */
declare export function xml(url: string, callback: (error: any, d: any) => void): Request
