declare module "d3-request" {
  ...
  declare export interface Request {
    ...
    on(
      type: "progress",
      listener: (progressEvent: ProgressEvent) => void
    ): this;
    ...
    on<ResponseData>(
      type: "load",
      listener: (data: ResponseData) => void
    ): this;
    ...
    response<ResponseData>(
      callback: (response: XMLHttpRequest) => ResponseData
    ): this;
    ...
    send<ResponseData>(
      method: string,
      callback: (error: any | null, d: ResponseData | null) => void
    ): this;
  ...
  declare export function csv(
    url: string,
    callback: (error: any, d: DSVParsedArray<DSVRowString>) => void
  ): DsvRequest;
  ...
  declare export function csv<ParsedRow: { [key: string]: any }>(
    ...
    callback: (error: any, d: DSVParsedArray<ParsedRow>) => void
  ): DsvRequest;
  ...
  declare export function html(
    url: string,
    callback: (error: any, d: DocumentFragment) => void
  ): Request;
  ...
  >(
    url: string,
    callback: (error: any, d: ParsedObject) => void
  ): Request;
  ...
  declare export function request(
    url: string,
    callback: (error: any, d: XMLHttpRequest) => void
  ): Request;
  ...
  declare export function text(
    url: string,
    callback: (error: any, d: string) => void
  ): Request;
