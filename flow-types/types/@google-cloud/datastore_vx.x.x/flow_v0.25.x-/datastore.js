declare module "@google-cloud/datastore" {
  ...
  import type { DatastoreTransaction } from "@google-cloud/datastore/transaction";
  ...
  declare class Datastore mixins DatastoreRequest_ {
    ...
    save(
      entities: OneOrMany<{ [key: string]: any }>,
...
declare module "@google-cloud/datastore/query" {
  import type { DatastoreKey } from "@google-cloud/datastore/entity";
...
declare module "@google-cloud/datastore/request" {
  import type { DatastoreKey, OneOrMany } from "@google-cloud/datastore/entity";
  ...
  declare class DatastoreRequest {
    ...
    get(
      key: DatastoreKey,
      options: QueryOptions,
      callback: GetCallback<{ [key: string]: any }>
    ): void;
    get(
...
declare module "@google-cloud/datastore/transaction" {
  ...
  import type { Query } from "@google-cloud/datastore/query";
