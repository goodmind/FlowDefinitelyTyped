declare module "@google-cloud/tasks" {
  ...
  declare export type EnhancedPick<T, Req: $Keys<T>, Opt: $Keys<T>> = Required<
    Pick<T, Req>
  > &
    $Shape<Pick<T, Req>>;
  declare export type ProjectIdCallback = (
    err?: Error | null,
  ...
  declare export type APIPaginatedCallback<T = any, U = any, V = any> = (
    err: GoogleError | null,
    response?: T,
    next?: U | null,
    rawResponse?: V
  ...
  declare export interface PaginatedMethodOverload<T, R, U, V = T> {
  ...
  declare export type CreateNamedRequest<N: string, T> = ParentRequest &
    $ObjMapi<{ [k: N]: any }, <P>(P) => T>;
  declare export type UpdateNamedRequest<N: string, T> = ParentRequest &
    $ObjMapi<{ [k: N]: any }, <P>(P) => T>;
 ...
 */
    createQueue: MethodOverload<
      CreateNamedRequest<"queue", $Shape<Queue>>,
      Queue
    >;
