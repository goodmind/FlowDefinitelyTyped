declare module '@google-cloud/tasks' {
	...
	declare export type GoogleAuthOptions = any;
	declare export type CallOptions = any;
	declare export type GoogleAuth = any;
	declare export type CloudTasksConfig = {
key?: string,
autoRetry?: boolean,
maxRetries?: number,
libName?: string,
...
promise?: PromiseConstructor
	...
	declare export interface AppEngineHttpQueue {
appEngineRoutingOverride: AppEngineRouting
} 
	declare export interface AppEngineHttpRequest {
...
relativeUri: string
	...
	declare export interface AppEngineRouting {
host: string,
instance: string,
service: string,
version: string
...
role: string
	...
	declare export interface CreateTaskRequest {
responseView: View,
task: $Shape<Task>
} 
	declare export interface Expr {
description: string,
expression: string,
location: string,
title: string
} 
	declare export interface ListLocationsResponse {
locations: Location[],
nextPageToken?: string
} 
	declare export interface ListQueuesResponse {
nextPageToken?: string,
queues: Queue[]
} 
	declare export interface ListTasksResponse {
nextPageToken?: string,
tasks: Task[]
} 
...
state: string
	...
	declare export interface RateLimits {
maxBurstSize: number,
maxConcurrentDispatches: number,
maxDispatchesPerSecond: number
} 
	declare export interface RetryConfig {
maxAttempts: number,
maxBackoff: string,
maxDoublings: number,
...
minBackoff: string
	...
	declare export interface RunTaskRequest {
responseView?: View
} 
	declare export interface SetIamPolicyRequest {
policy: $Shape<Policy>
} 
 ...
 */
declare export type View = 0 | 1 | 2;
...
view: View
	...
	declare export interface TestIamPermissionsRequest {
permissions?: string[]
} 
	declare export interface TestIamPermissionsResponse {
permissions?: string[]
} 
...
cancel(): void
	...
	declare export type Keys<T> = $Keys<T>;
	declare export type EnhancedPick<T, Req: $Keys<T>, Opt: $Keys<T>> = Required<Pick<T, Req>> & $Shape<Pick<T, Req>>;
	declare export type ProjectIdCallback = (err?: Error | null, projectId?: string | null) => void;
	declare export type APICallback<T> = (err: GoogleError | null, response?: T) => void;
	declare export type APIPaginatedCallback<T, U, V> = (
err: GoogleError | null,
response?: T,
next?: U | null,
rawResponse?: V) => void;
	declare export type CallOptionsWithPagination = {
autoPaginate: false
} & CallOptions
...
(data: T, callback: APICallback<R>): void
	...
	declare export interface PaginatedMethodOverload<T, R, U, V> {
...
(data: T, callback: APICallback<R>): void
	...
	declare export interface ParentRequest {
...
parent: string
	...
	declare export interface ResourceRequest {
...
resource: string
	...
	declare export type ListRequestObject = {
...
pageSize?: number
	...
	declare export interface NamedRequest {
...
name: string
	...
	declare export type CreateNamedRequest<N: string, T> = ParentRequest & $ObjMapi<{[k: N]: any}, <P>(P) => T>;
	declare export type UpdateNamedRequest<N: string, T> = ParentRequest & $ObjMapi<{[k: N]: any}, <P>(P) => T>;
	
/**
 * Cloud Tasks allows developers to manage the execution of background
 * work in their applications.
 */
declare export default class CloudTasksClient  {
 ...
 * @param
 * @param
 * @param - Account email address. Required when
using a .pem or .p12 keyFilename.
 * @param - Full path to the a .json, .pem, or
.p12 key downloaded from the Google Developers Console. If you provide
a path to a JSON file, the projectId option below is not necessary.
NOTE: .pem and .p12 require you to specify options.email as well.
 * @param - The port on which to connect to
the remote host.
 * @param - The project ID from the Google
Developer's Console, e.g. 'grape-spaceship-123'. We will also check
the environment variable GCLOUD_PROJECT for your project ID. If your
app is running in an environment which supports
{@link https://developers.google.com/identity/protocols/application-default-credentials Application Default Credentials},
your project ID will be detected automatically.
 * @param - Custom promise module to use instead
of native Promises.
 * @param - The domain name of the
API remote host.
 */
constructor(config: CloudTasksConfig): this;
 ...
 * @param `filter` can be used to specify a subset of queues. Any Queue
 ...
 * @param The maximum number of resources contained in the underlying API
response. If page streaming is performed per-resource, this
parameter does not affect the return value. If page streaming is
performed per-page, this determines the maximum number of
resources in a page.
 * @param options Optional parameters. You can override the default settings for this call, e.g, timeout,
retries, paginations, etc. See [gax.CallOptions]{@link https://googleapis.github.io/gax-nodejs/global.html#CallOptions} for the details.
 * @param callback The function which will be called with the result of the API call.
 ...
 * @example import CloudTasks from '
 * @google -cloud/tasks';
 ...
 */
createQueue: MethodOverload<CreateNamedRequest<"queue", $Shape<Queue>>, Queue>;
...
This object should have the same structure as [Queue]{@link google.cloud.tasks.v2beta3.Queue}
 * @param A mask used to specify which fields of the queue are being updated.
 ...
 */
updateQueue: MethodOverload<UpdateNamedRequest<"queue", EnhancedPick<Queue, "name", "appEngineHttpQueue" | "rateLimits" | "retryConfig">>, Queue>;
 ...
 * @param request The request object that will be sent.
 * @param REQUIRED: The resource for which the policy is being requested.
 ...
 * @param request The request object that will be sent.
 * @param REQUIRED: The resource for which the policy is being specified.
`resource` is usually specified as a path. For example, a Project
resource is specified as `projects/{project}`.
 * @param REQUIRED: The complete policy to be applied to the `resource`. The size of
 ...
 * @param request The request object that will be sent.
 * @param REQUIRED: The resource for which the policy detail is being requested.
`resource` is usually specified as a path. For example, a Project
resource is specified as `projects/{project}`.
 * @param The set of permissions to check for the `resource`. Permissions with
...
The queue name. For example:
`projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
 * @param The response_view specifies which subset of the Task will be
returned.
 ...
 * @param projectName A fully-qualified path representing a project resources.
 */
matchProjectFromProjectName(projectName: string): string;

/**
 * Parse the locationName from a location resource.
 * @param locationName A fully-qualified path representing a location resources.
 */
 ...
 * @param queueName A fully-qualified path representing a queue resources.
 */
 ...
 * @param taskName A fully-qualified path representing a task resources.
 */
