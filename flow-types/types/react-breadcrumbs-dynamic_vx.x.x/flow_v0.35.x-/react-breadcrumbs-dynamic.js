declare module 'react-breadcrumbs-dynamic' {
	...
	declare export class BreadcrumbsProvider mixins React.Component<BreadcrumbsProviderProps> {}
	declare export class Breadcrumbs mixins React.Component<BreadcrumbsProps> {}
	declare export class BreadcrumbsItem mixins React.Component<BreadcrumbsItemProps> {}
