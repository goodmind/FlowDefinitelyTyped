declare module 'pem' {
        declare export interface ModuleConfiguration {
...
pathOpenSSL: string
	...
	declare export type PrivateKeyCipher = "aes128"
| "aes192"
| "aes256"
| "camellia128"
| "camellia192"
...
| "idea"
| string;
	declare export interface PrivateKeyCreationOptions {
cipher: PrivateKeyCipher,
password: string
} 
	declare export interface Pkcs12CreationOptions {
cipher?: PrivateKeyCipher,
clientKeyPassword?: string,
certFiles?: string[]
} 
	declare export interface Pkcs12ReadOptions {
p12Password?: string,
clientKeyPassword?: string
} 
	declare export type HashFunction = "md5" | "sha1" | "sha256" | string;
	declare export interface CSRCreationOptions {
...
altNames?: string[]
	...
	declare export type CertificateCreationOptions = {
...
config?: string
	...
	declare export interface CertificateCreationResult {
certificate: any,
csr: string,
clientKey: string,
serviceKey: string
} 
	declare export interface CertificateSubjectReadResult {
country: string,
state: string,
locality: string,
organization: string,
...
emailAddress: string
	...
	declare export interface Pkcs12ReadResult {
key: string,
cert: string,
ca: string[]
} 
	declare export type Callback<T> = (error: any, result: T) => any;
	
/**
 * Creates a private key
 * @param keyBitsize Size of the key, defaults to 2048bit (can also be a function)
 ...
 */
declare export function createPrivateKey(
keyBitsize: number,
...
key: string
	...
	declare export function createPrivateKey(callback: Callback<{
key: string
}>): void
 ...
 * @param keyBitsize Size of the key, defaults to 512bit
 * @param callback Callback function with an error object and {dhparam}
 */
declare export function createDhparam(keyBitsize: number, callback: Callback<{
dhparam: any
}>): void

	declare export function createDhparam(callback: Callback<{
dhparam: any
}>): void
 ...
 */
declare export function createCSR(
...
clientKey: string
	...
	declare export function createCSR(callback: Callback<{
csr: string,
clientKey: string
}>): void
 ...
 */
declare export function createCertificate(
options: CertificateCreationOptions,
callback: Callback<CertificateCreationResult>): void

	declare export function createCertificate(callback: Callback<CertificateCreationResult>): void
 ...
 */
declare export function readCertificateInfo(certificate: string, callback: Callback<CertificateSubjectReadResult>): void

	declare export function readCertificateInfo(callback: Callback<CertificateSubjectReadResult>): void
 ...
 */
declare export function getPublicKey(certificate: string, callback: Callback<{
publicKey: string
}>): void

	declare export function getPublicKey(callback: Callback<{
publicKey: string
}>): void
 ...
 */
declare export function getFingerprint(
certificate: string,
hash: HashFunction,
callback: Callback<{
fingerprint: string
	...
	declare export function getFingerprint(certificate: string, callback: Callback<{
fingerprint: string
}>): void

	declare export function getFingerprint(callback: Callback<{
fingerprint: string
}>): void
 ...
 */
declare export function getModulus(
certificate: string,
password: string,
callback: Callback<{
modulus: any
	...
	declare export function getModulus(certificate: string, callback: Callback<{
modulus: any
}>): void
 ...
 */
declare export function getDhparamInfo(dh: string, callback: Callback<{
size: any,
prime: any
}>): void
 ...
 */
declare export function createPkcs12(
key: string,
certificate: string,
password: string,
 ...
 */
declare export function readPkcs12(
bufferOrPath: Buffer | string,
options: Pkcs12ReadOptions,
callback: Callback<Pkcs12ReadResult>): any

	declare export function readPkcs12(bufferOrPath: Buffer | string, callback: Callback<Pkcs12ReadResult>): any
 ...
 */
declare export function verifySigningChain(certificate: string, ca: string[], callback: Callback<boolean>): void

	
/**
 * config the pem module
 */
declare export function config(options: ModuleConfiguration): void
