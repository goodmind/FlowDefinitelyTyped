declare module "pem" {
  ...
  declare export type PrivateKeyCipher =
    | "aes128"
    | "aes192"
    | "aes256"
    | "camellia128"
   ...
   */
  declare export function createDhparam(
    keyBitsize: number,
    callback: Callback<{
      dhparam: any
    }>
   ...
   */
  declare export function readCertificateInfo(
    certificate: string,
   ...
   */
  declare export function getPublicKey(
    certificate: string,
    callback: Callback<{
      publicKey: string
    }>
   ...
   */
  declare export function getDhparamInfo(
    dh: string,
    callback: Callback<{
      size: any,
      prime: any
   ...
   */
  declare export function verifySigningChain(
    certificate: string,
    ca: string[],
