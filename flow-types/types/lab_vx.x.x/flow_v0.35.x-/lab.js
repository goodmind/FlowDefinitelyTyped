 ...
 * The test script.
 */
declare export function script(options?: ScriptOptions): Lab & ExperimentAlt & TestAlt
...
note: (text: string) => void
	...
	declare type TestCallback = (done: DoneFunction & DoneNote, onCleanup?: CleanupFunction) => void;
	...
	declare type ExperimentWithOptionsArgs = (desc: string, options: ExperimentOptions, cb: EmptyCallback) => {};
	declare type TestArgs = (desc: string, cb: TestCallback) => {};
	declare type TestWithOptionsArgs = (desc: string, options: TestOptions, cb: TestCallback) => {};
    }
