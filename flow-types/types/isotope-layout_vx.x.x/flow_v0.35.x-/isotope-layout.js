declare module 'isotope-layout' {
        declare module.exports: typeof Isotope

	declare type Isotope$LayoutModes = "masonry"
| "fitRows"
| "cellsByRow"
| "vertical"
| "packery"
...
declare type Isotope$Elements = HTMLElement[] | HTMLElement | JQuery | NodeList;

declare interface Isotope$IsotopeOptions {
 ...
 */
cellsByColumn?: Isotope$CellsByColumn,
 ...
 */
cellsByRow?: Isotope$CellsByRow,

/**
 * CSS styles that are applied to the container element.
 */
containerStyle?: Isotope$Style,
 ...
 */
layoutMode?: Isotope$LayoutModes,
 ...
 */
masontryHorizontal?: Isotope$MasonryHorizontal,
 ...
 */
sortAscending?: boolean | Isotope$SortOrder,
 ...
 */
vertical?: Isotope$Vertical,

/**
 * The styles applied to reveal items when filtering.
 */
visibleStyle?: Isotope$Style
} 

declare interface Isotope$Sorter {
[key: string]: ((itemElm: JQuery) => number | string) | string
} 

declare interface Isotope$SortOrder {
[key: string]: boolean
} 

declare interface Isotope$Style {
[key: string]: number | string
} 

declare interface Isotope$CellsByColumn {
columnWidth?: number | string,
rowHeight?: number | string
} 

declare interface Isotope$CellsByRow {
columnWidth?: number | string,
rowHeight?: number | string
} 

declare interface Isotope$FitRows {
gutter?: number | string
} 

declare interface Isotope$Horizontal {
verticalAligment?: number
} 

declare interface Isotope$Masonry {
columnWidth?: number | string,
fitWidth?: boolean,
gutter?: number | string
} 

declare interface Isotope$MasonryHorizontal {
gutter?: number | string,
rowHeight?: number | string
} 

declare interface Isotope$Packery {
columnWidth?: number | string,
gutter?: number | string,
horizontal?: boolean,
rowHeight?: number
...
declare interface Isotope$Vertical {
horizontalAlignment?: number
} 
	declare interface Isotope {
 ...
 */
addItems(elements: Isotope$Isotope$Elements): void,

/**
 * Adds and lays out newly appended item elements to the end of the layout.
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
appended(elements: Isotope$Isotope$Elements): void,
 ...
 */
arrange(options: Isotope$Isotope$IsotopeOptions): void,
 ...
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
prepended(elements: Isotope$Isotope$Elements): void,
 ...
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
remove(elements: Isotope$Isotope$Elements): void,

/**
 * Reveals hidden items.
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
revealItemElements(elements: Isotope$Isotope$Elements): void,
 ...
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
stamp(elements: Isotope$Isotope$Elements): void,

/**
 * Un-stamps elements in the layout, so that Isotope will no longer layout item elements around them.
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
unstamp(elements: Isotope$Isotope$Elements): void,

/**
 * Updates sort data
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
updateSortData(elements: Isotope$Isotope$Elements): void
} 
	declare var Isotope: {
prototype: Isotope,
new (
elementOrSelector: HTMLElement | string,
options: Isotope$Isotope$IsotopeOptions): Isotope,
 ...
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
isotope(methodName: "addItems", elements: Isotope$Isotope$Elements): JQuery,

/**
 * Adds and lays out newly appended item elements to the end of the layout.
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
isotope(methodName: "appended", elements: Isotope$Isotope$Elements): JQuery,

/**
 * Hide items.
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
isotope(methodName: "hideItemElements", elements: Isotope$Isotope$Elements): JQuery,

/**
 * Appends elements into container element, adds elements as items, and arranges items with filtering and sorting.
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
isotope(methodName: "insert", elements: Isotope$Isotope$Elements): JQuery,

/**
 * Adds and lays out newly prepended item elements at the beginning of layout.
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
isotope(methodName: "prepended", elements: Isotope$Isotope$Elements): JQuery,

/**
 * Removes elements from the Isotope instance and DOM.
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
isotope(methodName: "remove", elements: Isotope$Isotope$Elements): JQuery,

/**
 * Reveals hidden items.
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
isotope(methodName: "revealItemElements", elements: Isotope$Isotope$Elements): JQuery,
 ...
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
isotope(methodName: "stamp", elements: Isotope$Isotope$Elements): JQuery,

/**
 * Un-stamps elements in the layout, so that Isotope will no longer layout item elements around them.
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
isotope(methodName: "unstamp", elements: Isotope$Isotope$Elements): JQuery,

/**
 * Updates sort data
 * @param elements Element, jQuery Object, NodeList, or Array of Elements
 */
isotope(methodName: "updateSortData", elements: Isotope$Isotope$Elements): JQuery,
 ...
 * @param options All options are optional, but itemSelector is recommended. Layout modes have their own separate options.
 */
isotope(options: Isotope$Isotope$IsotopeOptions): JQuery
} 
    }
