declare module "flexmonster" {
  ...
  declare interface Flexmonster$Pivot {
    ...
    exportTo(
      ...
      callbackHandler?: ((result: { [key: string]: any }) => void) | string
    ): void;
    ...
    getData(
      ...
      updateHandler?: ((rawData: any) => void) | string
    ): void;
    ...
    getMembers(
      ...
      memberName: string,
      callbackHandler: ((members: Flexmonster$Member[]) => void) | string
    ): Flexmonster$Member[];
