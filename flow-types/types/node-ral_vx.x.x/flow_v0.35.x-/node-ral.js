...
retry: string
	...
	declare export function RAL(serviceName: string, options?: {}): RAL$RAL$RalRunner
...
port: string | number
	...
	declare export type buildInConverter = "form"
| "formData"
| "json"
| "protobuf"
| "querystring"
...
path?: string
	...
	declare export type BalanceContextConstructor = (serviceID: string, service: Service) => Balance$Balance$BalanceContextClass;
	declare export class Balance  {
constructor(): this;
fetchServer(
balanceContext: Balance$Balance$BalanceContextClass,
conf: any,
prevBackend: Server): Server;
getCategory(): any;
...
needUpdate(config?: any): boolean
	...
	declare export function Middleware(options?: Service): (req: Request, resp: Response, next: NextFunction) => void
