...
options: WordCloud$WordCloud$Options): void

	
      declare var npm$namespace$WordCloud: {
        
        isSupported: typeof WordCloud$isSupported,
miniumFontSize: typeof WordCloud$miniumFontSize,
      }
declare var WordCloud$isSupported: boolean;

declare var WordCloud$miniumFontSize: number;
