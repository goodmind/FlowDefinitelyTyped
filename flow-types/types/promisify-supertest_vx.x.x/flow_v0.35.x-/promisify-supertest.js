declare module 'promisify-supertest' {
	...
	declare type CallbackHandler = (err: any, res: supertest$supertest$Response) => void;
	declare function supertest(app: express.Express): supertest$supertest$SuperTest
