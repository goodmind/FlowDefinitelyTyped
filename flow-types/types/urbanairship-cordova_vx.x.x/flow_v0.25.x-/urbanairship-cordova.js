declare module "urbanairship-cordova" {
  declare interface UrbanAirshipPlugin$UrbanAirshipStatic {
    ...
    getLaunchNotification(
      clear: boolean,
      callback: (push: UrbanAirshipPlugin$UrbanAirshipPlugin$PushEvent) => void
    ): void;
    ...
    getQuietTime(
      callback: (
        quietTime: UrbanAirshipPlugin$UrbanAirshipPlugin$QuietTimeTimeSpan
      ) => void
    ): void;
     ...
     */
    editNamedUserTagGroups(): UrbanAirshipPlugin$UrbanAirshipPlugin$EditNamedUserTagGroupsApi;
     ...
     *       .apply()
     */
    editChannelTagGroups(): UrbanAirshipPlugin$UrbanAirshipPlugin$EditChannelTagGroupsApi;
    ...
    runAction(
      ...
      actionValue: string,
      callback: (
        result: UrbanAirshipPlugin$UrbanAirshipPlugin$RunActionResult
      ) => void
    ): void;
  ...
  declare interface UrbanAirshipPlugin$EditNamedUserTagGroupsApi {
    ...
    addTags: (
      tagGroup: string,
      tags: string[]
    ) => UrbanAirshipPlugin$EditNamedUserTagGroupsApi;
  ...
  declare interface UrbanAirshipPlugin$EditChannelTagGroupsApi {
    ...
    addTags: (
      tagGroup: string,
      tags: string[]
    ) => UrbanAirshipPlugin$EditChannelTagGroupsApi;
  ...
  declare var UAirship: UrbanAirshipPlugin$UrbanAirshipPlugin$UrbanAirshipStatic;
  declare interface Document {
    addEventListener(
      type: "urbanairship.push",
      listener: (ev: UrbanAirshipPlugin$UrbanAirshipPlugin$PushEvent) => void,
      useCapture?: boolean
    ): void;
    addEventListener(
      type: "urbanairship.registration",
      listener: (
        ev: UrbanAirshipPlugin$UrbanAirshipPlugin$RegistrationEvent
      ) => void,
      useCapture?: boolean
    ): void;
  }
