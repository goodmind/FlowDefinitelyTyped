...
clear: boolean,
callback: (push: UrbanAirshipPlugin$UrbanAirshipPlugin$PushEvent) => void): void,
 ...
 */
getQuietTime(
callback: (quietTime: UrbanAirshipPlugin$UrbanAirshipPlugin$QuietTimeTimeSpan) => void): void,
...
actionName: string,
actionValue: string,
callback: (result: UrbanAirshipPlugin$UrbanAirshipPlugin$RunActionResult) => void): void,
...
listener: (ev: UrbanAirshipPlugin$UrbanAirshipPlugin$RegistrationEvent) => void,
useCapture?: boolean): void
} 
    }
