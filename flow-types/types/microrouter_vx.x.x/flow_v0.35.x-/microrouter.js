...
[key: string]: string
	...
	declare export type AugmentedRequestHandler = (req: ServerRequest, res: ServerResponse) => any;
	declare export type RouteHandler = (path: string, handler: AugmentedRequestHandler) => RequestHandler;
	declare export function router(...routes: RequestHandler[]): RequestHandler

	declare export function withNamespace(namespace: string): (...routes: RequestHandler[]) => RequestHandler
