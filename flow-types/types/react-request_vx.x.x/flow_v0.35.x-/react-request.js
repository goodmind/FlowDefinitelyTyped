...
url: string
	...
	declare export type FetchProps<T> = {
...
res: Response
	...
	declare export function fetchDedupe(input: any, init?: any, dedupeOptions?: any): Promise<ProxyRequest>
	...
	declare export class Fetch<T> mixins React.Component<FetchProps<T>> {}
    }
