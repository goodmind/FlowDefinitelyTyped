declare module 'react-swf' {
	...
	declare var self: typeof undefined;
...
declare export class rswf$ReactSWF mixins React.Component<rswf$Props, rswf$State> {

/**
 * Returns the Flash Player object DOM node.
 * Should be prefered over `React.findDOMNode`.
 * @return {"NO PRINT IMPLEMENTED: JSDocNullableType"} Flash Player object DOM node.
 */
getFPDOMNode(): Node;
 ...
 * @return {"NO PRINT IMPLEMENTED: JSDocNullableType"} 'X.Y.Z'-version or null.
 */
