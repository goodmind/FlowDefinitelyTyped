declare module "twitter" {
  ...
  declare class Twitter {
    ...
    constructor(
      options:
        | Twitter$Twitter$AccessTokenOptions
        | Twitter$Twitter$BearerTokenOptions
    ): this;
    get(
      path: string,
      params: Twitter$Twitter$RequestParams,
      callback: Twitter$Twitter$Callback
    ): void;
    get(path: string, callback: Twitter$Twitter$Callback): void;
    get(
      path: string,
      params?: Twitter$Twitter$RequestParams
    ): Promise<Twitter$Twitter$ResponseData>;
    post(
      path: string,
      params: Twitter$Twitter$RequestParams,
      callback: Twitter$Twitter$Callback
