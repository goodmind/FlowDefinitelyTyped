declare module "blessed" {
  ...
  declare type Widgets$NodeEventType =
    | "adopt"
    | "remove"
    | "reparent"
    | "attach"
  ...
  declare class Widgets$Node
    mixins EventEmitter,
      Widgets$IHasOptions<Widgets$INodeOptions>,
      Widgets$IDestroyable {
    ...
    on(
      event: Widgets$NodeEventType,
      callback: (arg: Widgets$Node) => void
    ): this;
  }

  declare type Widgets$NodeScreenEventType =
    | "focus"
    | "blur"
    | "click"
    | "element click"
  ...
  declare type Widgets$NodeMouseEventType =
    | "mouse"
    | "mouseout"
    | "mouseover"
    | "mousedown"
  ...
  declare type Widgets$NodeGenericEventType =
    | "resize"
    | "prerender"
    | "render"
    | "destroy"
  ...
  declare class Widgets$NodeWithEvents mixins Widgets$Node {
    ...
    key(
      name: string | string[],
      listener: (ch: any, key: Events$Events$IKeyEventArg) => void
    ): void;
    ...
    on(
      ...
      callback: (arg: Events$Events$IMouseEventArg) => void
    ): this;
    ...
    on(
      event: "keypress",
      callback: (ch: string, key: Events$Events$IKeyEventArg) => void
    ): this;
    on(
      event: Widgets$NodeScreenEventType,
      callback: (arg: Widgets$Screen) => void
    ): this;
  ...
  declare class Widgets$Screen
    mixins Widgets$NodeWithEvents, Widgets$IHasOptions<Widgets$IScreenOptions> {
  ...
  declare class Widgets$BlessedElement
    mixins Widgets$NodeWithEvents, Widgets$IHasOptions<Widgets$ElementOptions> {
   ...
   */
  declare class Widgets$ScrollableTextElement
    mixins Widgets$ScrollableBoxElement {}

  /**
   * A box element which draws a simple box containing content or other elements.
   */
  declare class Widgets$BoxElement
    mixins Widgets$ScrollableTextElement,
      Widgets$IHasOptions<Widgets$BoxOptions> {
   ...
   */
  declare class Widgets$TextElement
    mixins Widgets$BlessedElement, Widgets$IHasOptions<Widgets$TextOptions> {
   ...
   * A simple line which can be line or bg styled.
   */
  declare class Widgets$LineElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$LineOptions> {
   ...
   */
  declare class Widgets$BigTextElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$BigTextOptions> {
  ...
  declare type Widgets$ListElementEventType =
    | "cancel"
    | "action"
    | "create item"
    | "add item"
  ...
  declare class Widgets$ListElement
    mixins Widgets$BoxElement,
      Widgets$IHasOptions<Widgets$ListOptions<Widgets$ListElementStyle>> {
    ...
    setItem(
      ...
      content: Widgets$BlessedElement | string
    ): void;
    ...
    on(
      event: "select",
      callback: (item: Widgets$BoxElement, index: number) => void
    ): this;
    on(event: Widgets$ListElementEventType, callback: () => void): this;
    on(
      event: "select item",
      callback: (item: Widgets$BlessedElement, index: number) => void
    ): this;
  }
  ...
  declare class Widgets$FileManagerElement
    mixins Widgets$ListElement,
      Widgets$IHasOptions<Widgets$FileManagerOptions> {
  ...
  declare class Widgets$ListTableElement
    mixins Widgets$ListElement, Widgets$IHasOptions<Widgets$ListTableOptions> {
 ...
 */
  ...
  declare class Widgets$ListbarElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$ListbarOptions> {
  ...
  declare class Widgets$FormElement<TFormData>
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$FormOptions> {
  ...
  declare type Widgets$TextareaElementEventType =
    | "error"
    | "submit"
    | "cancel"
    | "action";

  declare class Widgets$TextareaElement
    mixins Widgets$InputElement, Widgets$IHasOptions<Widgets$TextareaOptions> {
    ...
    on(event: string, listener: (...args: any[]) => void): this;
    on(
      event: Widgets$TextareaElementEventType,
  ...
  declare class Widgets$TextboxElement
    mixins Widgets$TextareaElement,
      Widgets$IHasOptions<Widgets$TextboxOptions> {
  ...
  declare class Widgets$ButtonElement
    mixins Widgets$InputElement, Widgets$IHasOptions<Widgets$ButtonOptions> {
   ...
   */
  declare class Widgets$CheckboxElement
    mixins Widgets$InputElement, Widgets$IHasOptions<Widgets$CheckboxOptions> {
   ...
   */
  declare class Widgets$PromptElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$PromptOptions> {
   ...
   */
  declare class Widgets$QuestionElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$QuestionOptions> {
   ...
   */
  declare class Widgets$MessageElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$MessageOptions> {
   ...
   */
  declare class Widgets$LoadingElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$LoadingOptions> {
   ...
   */
  declare class Widgets$ProgressBarElement
    mixins Widgets$InputElement,
      Widgets$IHasOptions<Widgets$ProgressBarOptions> {
   ...
   */
  declare class Widgets$Log
    mixins Widgets$ScrollableTextElement,
      Widgets$IHasOptions<Widgets$LogOptions> {
   ...
   */
  declare class Widgets$TableElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$TableOptions> {
  ...
  declare class Widgets$TerminalElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$TerminalOptions> {
   ...
   */
  declare class Widgets$ImageElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$ImageOptions> {
   ...
   */
  declare class Widgets$ANSIImageElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$ANSIImageOptions> {
   ...
   * Convert any .png file (or .gif, see below) to an ANSI image and display it as an element.
   */
  declare class Widgets$OverlayImageElement
    mixins Widgets$BoxElement,
      Widgets$IHasOptions<Widgets$OverlayImageOptions> {
  ...
  declare class Widgets$VideoElement
    mixins Widgets$BoxElement, Widgets$IHasOptions<Widgets$VideoOptions> {
  ...
  declare class Widgets$LayoutElement
    mixins Widgets$BlessedElement, Widgets$IHasOptions<Widgets$LayoutOptions> {
  ...
  declare export function screen(
    options?: Widgets$Widgets$IScreenOptions
  ): Widgets$Widgets$Screen;

  declare export function box(
    options?: Widgets$Widgets$BoxOptions
  ): Widgets$Widgets$BoxElement;

  declare export function text(
    options?: Widgets$Widgets$TextOptions
  ): Widgets$Widgets$TextElement;

  declare export function line(
    options?: Widgets$Widgets$LineOptions
  ): Widgets$Widgets$LineElement;

  declare export function scrollablebox(
    options?: Widgets$Widgets$BoxOptions
  ): Widgets$Widgets$BoxElement;

  declare export function scrollabletext(
    options?: Widgets$Widgets$BoxOptions
  ): Widgets$Widgets$BoxElement;

  declare export function bigtext(
    options?: Widgets$Widgets$BigTextOptions
  ): Widgets$Widgets$BigTextElement;

  declare export function list(
    options?: Widgets$Widgets$ListOptions<Widgets$Widgets$ListElementStyle>
  ): Widgets$Widgets$ListElement;

  declare export function filemanager(
    options?: Widgets$Widgets$FileManagerOptions
  ): Widgets$Widgets$FileManagerElement;

  declare export function listtable(
    options?: Widgets$Widgets$ListTableOptions
  ): Widgets$Widgets$ListTableElement;

  declare export function listbar(
    options?: Widgets$Widgets$ListbarOptions
  ): Widgets$Widgets$ListbarElement;

  declare export function form<TFormData>(
    options?: Widgets$Widgets$FormOptions
  ): Widgets$Widgets$FormElement<TFormData>;

  declare export function input(
    options?: Widgets$Widgets$InputOptions
  ): Widgets$Widgets$InputElement;

  declare export function textarea(
    options?: Widgets$Widgets$TextareaOptions
  ): Widgets$Widgets$TextareaElement;

  declare export function textbox(
    options?: Widgets$Widgets$TextboxOptions
  ): Widgets$Widgets$TextboxElement;

  declare export function button(
    options?: Widgets$Widgets$ButtonOptions
  ): Widgets$Widgets$ButtonElement;

  declare export function checkbox(
    options?: Widgets$Widgets$CheckboxOptions
  ): Widgets$Widgets$CheckboxElement;

  declare export function radioset(
    options?: Widgets$Widgets$RadioSetOptions
  ): Widgets$Widgets$RadioSetElement;

  declare export function radiobutton(
    options?: Widgets$Widgets$RadioButtonOptions
  ): Widgets$Widgets$RadioButtonElement;

  declare export function table(
    options?: Widgets$Widgets$TableOptions
  ): Widgets$Widgets$TableElement;

  declare export function prompt(
    options?: Widgets$Widgets$PromptOptions
  ): Widgets$Widgets$PromptElement;

  declare export function question(
    options?: Widgets$Widgets$QuestionOptions
  ): Widgets$Widgets$QuestionElement;

  declare export function message(
    options?: Widgets$Widgets$MessageOptions
  ): Widgets$Widgets$MessageElement;

  declare export function loading(
    options?: Widgets$Widgets$LoadingOptions
  ): Widgets$Widgets$LoadingElement;

  declare export function log(
    options?: Widgets$Widgets$LogOptions
  ): Widgets$Widgets$Log;

  declare export function progressbar(
    options?: Widgets$Widgets$ProgressBarOptions
  ): Widgets$Widgets$ProgressBarElement;

  declare export function program(
    options?: Widgets$Widgets$IScreenOptions
  ): BlessedProgram;

  declare export function terminal(
    options?: Widgets$Widgets$TerminalOptions
  ): Widgets$Widgets$TerminalElement;

  declare export function layout(
    options?: Widgets$Widgets$LayoutOptions
  ): Widgets$Widgets$LayoutElement;
