declare module 'novnc-core' {
        import typeof Display from './lib/display';

	import type {
          Keyboard,Mouse
        } from './lib/input/devices';

	declare export default class RFB  {
constructor(defaults?: NvRFBDefaults): this;
...
set_onUpdateState(
handler: (rfb: this, state: NvConnectionState, oldstate: NvConnectionState) => void): void;
get_onNotification(
): (
rfb: this,
msg: string,
...
requestDesktopSize(width: number, height: number): boolean
	...
	declare export interface NvRFBDefaults {
...
onXvpInit(version: number): void
	...
	declare export interface NvFBU {
x: number,
y: number,
width: number,
height: number,
...
encodingName: string
	...
	declare export type NvConnectionState = "connecting" | "connected" | "disconnecting" | "disconnected";
	declare export  class NvXvpOperation {
  constructor(...args: empty): mixed;
static +shutdown: Class<NvXvpOperation__shutdown> & NvXvpOperation__shutdown & 2;// 2
static +reboot: Class<NvXvpOperation__reboot> & NvXvpOperation__reboot & 1;// 1
static +reset: Class<NvXvpOperation__reset> & NvXvpOperation__reset & 2;// 2

}

declare class NvXvpOperation__shutdown mixins NvXvpOperation {}
declare class NvXvpOperation__reboot mixins NvXvpOperation {}
declare class NvXvpOperation__reset mixins NvXvpOperation {}
