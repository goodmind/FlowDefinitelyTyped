declare module "novnc-core" {
  ...
  import type { Keyboard, Mouse } from "./lib/input/devices";
  ...
  declare export type NvConnectionState =
    | "connecting"
    | "connected"
    | "disconnecting"
    | "disconnected";
  declare export class NvXvpOperation {
    ...
    static +shutdown: Class<NvXvpOperation__shutdown> &
      NvXvpOperation__shutdown &
      2; // 2
