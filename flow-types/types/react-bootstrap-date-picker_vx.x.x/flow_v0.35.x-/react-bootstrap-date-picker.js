declare module 'react-bootstrap-date-picker' {
        import type {
          ComponentClass,StatelessComponent,ReactNode,FocusEventHandler,HTMLAttributes
        } from 'react';
	...
	declare type DatePicker$ChangeCallback = (value: string, formattedValue: string) => void;
