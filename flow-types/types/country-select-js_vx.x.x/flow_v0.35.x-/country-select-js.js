 ...
 */
countrySelect(method: "getSelectedCountryData"): CountrySelectJs$CountrySelectJs$CountryData,
countrySelect(method: string, value: string): void,

/**
 * initialize the plugin with optional options.
 */
countrySelect(options?: CountrySelectJs$CountrySelectJs$Options): JQueryDeferred<any>
} 
    }
