...
constructor(name: string, message: string, comment?: string): this
	...
	declare export function createDidYouMeanMessage(unrecognized: string, allowedOptions: string[]): string

	declare export function format(value: any): string

	declare export function logValidationWarning(name: string, message: string, commant?: string): void
