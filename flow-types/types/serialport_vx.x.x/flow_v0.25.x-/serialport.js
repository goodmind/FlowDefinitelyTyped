declare module "serialport" {
  ...
  declare class SerialPort mixins Stream.Duplex {
    constructor(
      path: string,
      callback?: SerialPort$SerialPort$ErrorCallback
    ): this;
    constructor(
      path: string,
      options?: SerialPort$SerialPort$OpenOptions,
      callback?: SerialPort$SerialPort$ErrorCallback
    ): this;
    baudRate: number;
    ...
    static list(
      callback?: SerialPort$SerialPort$ListCallback
    ): Promise<SerialPort$SerialPort$PortInfo[]>;
  }
  declare type SerialPort$ErrorCallback = (error: Error) => void;

  declare type SerialPort$ModemBitsCallback = (
    error: Error,
    status: {
      cts: boolean,
      dsr: boolean,
