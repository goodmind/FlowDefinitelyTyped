declare module 'sumo-logger' {
        declare interface SumoLogger$SumoLoggerOptions {
...
declare interface SumoLogger$PerMessageOptions {
...
constructor(options: SumoLogger$SumoLogger$SumoLoggerOptions): this;
 ...
 */
config(options: SumoLogger$SumoLogger$SumoLoggerOptions): void;
 ...
 */
log(message: string, options?: SumoLogger$SumoLogger$PerMessageOptions): void;
 ...
 * Fields called `sessionId`, `url`, and `timestamp` are sent in both cases.
 */
log<T: {[key: string]: any}>(
event: $Shape<SumoLogger$SumoLogger$PerMessageOptions> & T): void;
...
emptyLogQueue(): void
	...
	declare module.exports: typeof SumoLogger
