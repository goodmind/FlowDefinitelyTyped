declare module 'openlayers' {
        declare export interface GlobalObject {
[key: string]: any
} 
 ...
 * @api
 */
declare function color$asArray(color: (ol.Color | string)): ol.Color
 ...
 * @api
 */
declare function color$asString(color: (ol.Color | string)): string

	
      declare var npm$namespace$colorlike: {
        asColorLike: typeof colorlike$asColorLike,
 ...
 * @api
 */
declare function colorlike$asColorLike(color: (ol.Color | ol.ColorLike)): ol.ColorLike
...
opt_options?: olx$control.interaction$DefaultsOptions): ol.Collection<control$Control>
 ...
 * @api stable
 */
declare function coordinate$createStringXY(opt_fractionDigits?: number): ol.CoordinateFormatType
 ...
 * @api stable
 */
declare function coordinate$rotate(coordinate: ol.Coordinate, angle: number): ol.Coordinate
 ...
 * @api stable
 */
declare function coordinate$toStringHDMS(coordinate?: ol.Coordinate, opt_fractionDigits?: number): string
 ...
 * @api stable
 */
declare function coordinate$toStringXY(coordinate?: ol.Coordinate, opt_fractionDigits?: number): string
 ...
 * @api stable
 */
declare function condition$altShiftKeysOnly(mapBrowserEvent: ol.MapBrowserEvent): boolean
 ...
 * @api
 */
declare function condition$primaryAction(mapBrowserEvent: ol.MapBrowserEvent): boolean
...
constructor(): this
	...
	declare export type EventsListenerFunctionType = ((evt: ol.events.events$Event) => void) | ((evt: ol.events.events$Event) => boolean);
 ...
 * @api stable
 */
declare function extent$boundingExtent(coordinates: ol.Coordinate[]): ol.interaction$Extent
...
value: number,
opt_extent?: ol.interaction$Extent): ol.interaction$Extent
 ...
 * @api stable
 */
declare function extent$containsCoordinate(extent: ol.interaction$Extent, coordinate: ol.Coordinate): boolean
 ...
 * @api stable
 */
declare function extent$containsExtent(extent1: ol.interaction$Extent, extent2: ol.interaction$Extent): boolean
 ...
 * @api stable
 */
declare function extent$containsXY(extent: ol.interaction$Extent, x: number, y: number): boolean
 ...
 * @api stable
 */
declare function extent$equals(extent1: ol.interaction$Extent, extent2: ol.interaction$Extent): boolean
...
extent2: ol.interaction$Extent): ol.interaction$Extent
 ...
 * @api stable
 */
declare function extent$getBottomLeft(extent: ol.interaction$Extent): ol.Coordinate
 ...
 * @api stable
 */
declare function extent$getBottomRight(extent: ol.interaction$Extent): ol.Coordinate
 ...
 * @api stable
 */
declare function extent$getCenter(extent: ol.interaction$Extent): ol.Coordinate
 ...
 * @api stable
 */
declare function extent$getTopLeft(extent: ol.interaction$Extent): ol.Coordinate
 ...
 * @api stable
 */
declare function extent$getTopRight(extent: ol.interaction$Extent): ol.Coordinate
 ...
 * @api stable
 */
declare function extent$intersects(extent1: ol.interaction$Extent, extent2: ol.interaction$Extent): boolean
 ...
 * @api stable
 */
constructor(opt_geometryOrProperties?: (ol.geom.geom$Geometry | {
[k: string]: any
})): this;
 ...
 */
getStyle(
): (ol.style.style$Style | ol.style.style$Style[] | ol.FeatureStyleFunction | ol.StyleFunction);
...
setGeometryName(name: string): void
      ...
      declare var npm$namespace$featureloader: {
        tile: typeof featureloader$tile,
...
coordinate$format: ol.coordinate$format.render$Feature): ol.FeatureLoader
 ...
 * @api
 */
constructor(opt_options?: olx$coordinate$format.format$EsriJSONOptions): this;
...
| GlobalObject
| string),
opt_options?: olx$coordinate$format.format$ReadOptions): ol.render$Feature;
...
| GlobalObject
| string),
opt_options?: olx$coordinate$format.format$ReadOptions): ol.geom.geom$Geometry;
...
| Node
| GlobalObject
| string)): ol.proj.proj$Projection;
...
opt_options?: olx$coordinate$format.format$WriteOptions): string;
...
writeGeometryObject(
geometry: ol.geom.geom$Geometry,
opt_options?: olx$coordinate$format.format$WriteOptions): format$EsriJSONGeometry;
...
writeFeatureObject(
feature: ol.render$Feature,
opt_options?: olx$coordinate$format.format$WriteOptions): GlobalObject;
...
declare type format$GeoJSONFeature = JSON;

declare type format$GeoJSONFeatureCollection = JSON;

declare type format$GeoJSONGeometry = JSON;

declare type format$GeoJSONGeometryCollection = JSON;
 ...
 * @api stable
 */
constructor(opt_options?: olx$coordinate$format.format$GeoJSONOptions): this;
...
opt_options?: olx$coordinate$format.format$ReadOptions): ol.format$Feature;
 ...
 * @api stable
 */
readProjection(source: (Document | Node | GlobalObject | string)): ol.proj.proj$Projection;
...
writeFeatureObject(
feature: ol.format$Feature,
opt_options?: olx$coordinate$format.format$WriteOptions): format$GeoJSONFeature;
...
writeFeaturesObject(
features: ol.format$Feature[],
opt_options?: olx$coordinate$format.format$WriteOptions): format$GeoJSONFeatureCollection;
...
writeGeometryObject(
geometry: ol.geom.geom$Geometry,
opt_options?: olx$coordinate$format.format$WriteOptions): (format$GeoJSONGeometry | format$GeoJSONGeometryCollection)
}
...
writeFeaturesNode(
features: ol.format$Feature[],
opt_options?: olx$coordinate$format.format$WriteOptions): Node
}
 ...
 */
declare type format$IGCZ = "barometric" | "gps" | "none";
...
geometryName: string,
geometry: ol.geom.geom$Geometry,
opt_srsName?: string): filter$Intersects
...
geometryName: string,
extent: ol.interaction$Extent,
opt_srsName?: string): filter$Bbox
...
geometryName: string,
geometry: ol.geom.geom$Geometry,
opt_srsName?: string): filter$Within
...
opt_matchCase?: boolean): filter$EqualTo
...
propertyName: string,
expression: string | number,
opt_matchCase?: boolean): filter$NotEqualTo
 ...
 * @api
 */
declare function filter$lessThan(propertyName: string, expression: number): filter$LessThan
 ...
 * @api
 */
declare function filter$lessThanOrEqualTo(propertyName: string, expression: number): filter$LessThanOrEqualTo
 ...
 * @api
 */
declare function filter$greaterThan(propertyName: string, expression: number): filter$GreaterThan
 ...
 * @api
 */
declare function filter$greaterThanOrEqualTo(propertyName: string, expression: number): filter$GreaterThanOrEqualTo
...
upperBoundary: number): filter$IsBetween
...
opt_matchCase?: boolean): filter$IsLike
 ...
 * @api
 */
declare function filter$during(propertyName: string, begin: string, end: string): filter$During
 ...
 * @api
 */
constructor(tagName: string, geometryName: string, geometry: ol.geom.geom$Geometry, opt_srsName?: string): this
}
 ...
 * @api
 */
constructor(geometryName: string, geometry: ol.geom.geom$Geometry, opt_srsName?: string): this
}
 ...
 * @api
 */
constructor(tagName: string, propertyName: string, expression: string | number, opt_matchCase?: boolean): this
}
 ...
 * @api
 */
constructor(propertyName: string, expression: string | number, opt_matchCase?: boolean): this
}
 ...
 * @api
 */
constructor(propertyName: string, expression: number): this
}
 ...
 * @api
 */
constructor(propertyName: string, begin: string, end: string): this
}
 ...
 * @api
 */
constructor(propertyName: string, lowerBoundary: number, upperBoundary: number): this
}
 ...
 * @api
 */
constructor(propertyName: string, pattern: string, opt_wildCard?: string, opt_singleChar?: string, opt_escapeChar?: string, opt_matchCase?: boolean): this
}
 ...
 * @api
 */
constructor(geometryName: string, extent: ol.interaction$Extent, opt_srsName?: string): this
}
 ...
 * @api stable
 */
constructor(opt_options?: olx$coordinate$format.format$PolylineOptions): this;
 ...
 * @api stable
 */
constructor(opt_options?: olx$coordinate$format.format$TopoJSONOptions): this;
 ...
 * @api stable
 */
readFeatures(source: (Document | Node | GlobalObject | string)): ol.format$Feature[];
 ...
 * @api stable
 */
readProjection(object: (Document | Node | GlobalObject | string)): ol.proj.proj$Projection
}
 ...
 * @api stable
 */
writeGetFeature(options: olx$coordinate$format.format$WFSWriteGetFeatureOptions): Node;
...
options: olx$coordinate$format.format$WFSWriteTransactionOptions): Node;
 ...
 * @api
 */
constructor(opt_options?: olx$coordinate$format.format$WMSGetFeatureInfoOptions): this;
 ...
 * @api
 */
constructor(center: ol.Coordinate, opt_radius?: number, opt_layout?: geom$GeometryLayout): this;
 ...
 */
declare type geom$GeometryType = "Point"
| "LineString"
| "LinearRing"
| "Polygon"
| "MultiPoint"
 ...
 * @api stable
 */
transform(source: ol.ProjectionLike, destination: ol.ProjectionLike): geom$Geometry;
 ...
 * @api stable
 */
constructor(opt_geometries?: geom$Geometry[]): this;
 ...
 * @api stable
 */
constructor(coordinates: ol.Coordinate[], opt_layout?: geom$GeometryLayout): this;
...
setMap(map: ol.Map): void
      ...
      declare var npm$namespace$has: {
        
        DEVICE_PIXEL_RATIO: typeof has$DEVICE_PIXEL_RATIO,
CANVAS: typeof has$CANVAS,
DEVICE_ORIENTATION: typeof has$DEVICE_ORIENTATION,
GEOLOCATION: typeof has$GEOLOCATION,
TOUCH: typeof has$TOUCH,
WEBGL: typeof has$WEBGL,
      }
 ...
 * @api stable
 */
declare var has$DEVICE_PIXEL_RATIO: number;
 ...
 * @api stable
 */
declare var has$CANVAS: boolean;
 ...
 * @api stable
 */
declare var has$DEVICE_ORIENTATION: boolean;
 ...
 * @api stable
 */
declare var has$GEOLOCATION: boolean;
 ...
 * @param imageLoadFunction Image load function.
 */
constructor(extent: ol.interaction$Extent, resolution: (number), pixelRatio: number, attributions: ol.control$Attribution[], src: string, crossOrigin?: string, imageLoadFunction?: ol.ImageLoadFunctionType): this;
 ...
 */
getImage(
opt_context?: GlobalObject): (HTMLCanvasElement | style$Image | HTMLVideoElement);
 ...
 * @param attributions Attributions.
 */
constructor(extent: ol.interaction$Extent, resolution: (number), pixelRatio: number, state: ol.ImageState, attributions: ol.control$Attribution[]): this
}
 ...
 * @param tileLoadFunction Tile load function.
 */
constructor(tileCoord: ol.TileCoord, state: ol.source$Tile.Tile$State, src: string, crossOrigin?: string, tileLoadFunction?: ol.TileLoadFunctionType): this;
 ...
 * @api
 */
declare export function inherits(childCtor: (() => any), parentCtor: (() => any)): void
 ...
 * @api stable
 */
constructor(opt_options?: olx$interaction.interaction$DoubleClickZoomOptions): this;
 ...
 * @api stable
 */
constructor(opt_options?: olx$interaction.interaction$DragAndDropOptions): this;
 ...
 * @param opt_projection Projection.
 */
constructor(type: interaction$DragAndDropEventType, file: File, opt_features?: ol.format$Feature[], opt_projection?: ol.proj.proj$Projection): this;
...
declare type interaction$DragBoxEventType = string;
 ...
 * @api stable
 */
constructor(opt_options?: olx$interaction.interaction$DragRotateOptions): this
}
 ...
 * @api stable
 */
constructor(opt_options?: olx$interaction.interaction$DragRotateAndZoomOptions): this
}
 ...
 * @api stable
 */
constructor(opt_options?: olx$interaction.interaction$DragZoomOptions): this
}
 ...
 * @param feature The feature drawn.
 */
constructor(type: interaction$DrawEventType, feature: ol.format$Feature): this;
 ...
 * @param feature The feature drawn.
 */
constructor(type: interaction$ExtentEventType, extent: ol.interaction$Extent): this;
...
opt_options?: olx$interaction.interaction$DefaultsOptions): ol.Collection<interaction$Interaction>
 ...
 * @api stable
 */
constructor(opt_options?: olx$interaction.interaction$KeyboardPanOptions): this;
 ...
 * @api stable
 */
constructor(opt_options?: olx$interaction.interaction$KeyboardZoomOptions): this;
...
{@link ol.MapBrowserPointerEvent}.
 */
constructor(type: ol.ModifyEventType, features: ol.Collection<ol.format$Feature>, mapBrowserPointerEvent: ol.MapBrowserPointerEvent): this;
 ...
 * @api stable
 */
constructor(opt_options?: olx$interaction.interaction$MouseWheelZoomOptions): this;
 ...
 * @api stable
 */
constructor(opt_options?: olx$interaction.interaction$PinchRotateOptions): this
}
 ...
 * @api stable
 */
constructor(opt_options?: olx$interaction.interaction$PinchZoomOptions): this
}
...
{@link ol.MapBrowserEvent}.
 */
constructor(type: string, selected: ol.format$Feature[], deselected: ol.format$Feature[], mapBrowserEvent: ol.MapBrowserEvent): this;
 ...
 */
getLayer(
feature: (ol.format$Feature | ol.render.format$Feature)): ol.layer.source$Vector;
 ...
 * @param coordinate The event coordinate.
 */
constructor(type: interaction$TranslateEventType, features: ol.Collection<ol.format$Feature>, coordinate: ol.Coordinate): this;
...
declare type interaction$TranslateEventType = string;
 ...
 * @api stable
 */
getStyle(): (ol.style.style$Style | ol.style.style$Style[] | ol.StyleFunction);
 ...
 * @api stable
 */
getStyleFunction(): (ol.StyleFunction | void);
 ...
 * @api
 */
declare function loadingstrategy$all(extent: ol.interaction$Extent, resolution: number): ol.interaction$Extent[]
 ...
 * @api
 */
declare function loadingstrategy$bbox(extent: ol.interaction$Extent, resolution: number): ol.interaction$Extent[]
...
tileGrid: ol.tilegrid.tilegrid$TileGrid): ((extent: ol.interaction$Extent, i: number) => ol.interaction$Extent[])
...
layer: ol.layer.layer$Layer) => T),
opt_options?: olx$olx$AtPixelOptions): (T);
...
getFeaturesAtPixel(
pixel: ol.Pixel,
opt_options?: olx$olx$AtPixelOptions): (Array<ol.format$Feature | ol.render.format$Feature> | null);
 ...
 * @api
 */
hasFeatureAtPixel(pixel: ol.Pixel, opt_options?: olx$olx$AtPixelOptions): boolean;
 ...
 * @api stable
 */
removeControl(control: ol.control.control$Control): (ol.control.control$Control);
 ...
 */
removeInteraction(
interaction: ol.interaction.interaction$Interaction): (ol.interaction.interaction$Interaction);
 ...
 * @param opt_frameState Frame state.
 */
constructor(type: string, map: ol.Map, browserEvent: Translate$Event, opt_dragging?: boolean, opt_frameState?: olx$olx$FrameState): this;
 ...
 * @param opt_frameState Frame state.
 */
constructor(type: string, map: ol.Map, opt_frameState?: olx$olx$FrameState): this;
 ...
 * @api
 */
dispatchEvent(event: (GlobalObject | ol.events.Translate$Event | string)): void;
 ...
 */
declare export type OverlayPositioning = "bottom-left"
| "bottom-center"
| "bottom-right"
| "center-left"
| "center-center"
...
get: typeof proj$get,
equivalent: typeof proj$equivalent,
 ...
 * @api stable
 */
declare var proj$METERS_PER_UNIT: {
[k: string]: number
};
 ...
 * @api
 */
declare function proj$setProj4(proj4: any): void
 ...
 * @api
 */
declare function proj$addEquivalentProjections(projections: proj$Projection[]): void
 ...
 * @api stable
 */
declare function proj$fromLonLat(coordinate: ol.Coordinate, opt_projection?: ol.ProjectionLike): ol.Coordinate
 ...
 * @api stable
 */
declare function proj$toLonLat(coordinate: ol.Coordinate, opt_projection?: ol.ProjectionLike): ol.Coordinate
 ...
 * @api
 */
declare function proj$equivalent(projection1: proj$Projection, projection2: proj$Projection): boolean
...
extent: ol.interaction$Extent,
source: ol.ProjectionLike,
destination: ol.ProjectionLike): ol.interaction$Extent
 ...
 */
declare function proj$getPointResolution(projection: proj$Projection, resolution: number, point: ol.Coordinate): number
 ...
 * @struct
 */
constructor(context: CanvasRenderingContext2D, pixelRatio: number, extent: ol.interaction$Extent, proj$transform: any, viewRotation: number): this;
 ...
 * @param opt_glContext WebGL Context.
 */
constructor(type: Collection$EventType, opt_vectorContext?: render$VectorContext, opt_frameState?: olx$olx$FrameState, opt_context?: CanvasRenderingContext2D, opt_glContext?: any): this;
 ...
 * @param properties Properties.
 */
constructor(type: ol.geom.geom$GeometryType, flatCoordinates: number[], ends: (number[] | number[][]), properties: {
[k: string]: any
}): this;
 ...
 * @api
 */
declare class render$VectorContext  {
...
context: CanvasRenderingContext2D,
opt_options?: olx$render.render$ToContextOptions): canvas$canvas$Immediate

	
/**
 * Available renderers: `'canvas'`, `'dom'` or `'webgl'`.
 */
declare export type RendererType = "canvas" | "dom" | "webgl";
 ...
 * @param data An object made available to operations.
 */
constructor(type: string, frameState: olx$olx$FrameState, data: GlobalObject): this;
 ...
 * @api
 */
setTileGridForProjection(projection: ol.ProjectionLike, tilegrid: ol.tilegrid.tilegrid$TileGrid): void
}
 ...
 * @api stable
 */
forEachFeature<S>(callback: ((feature: ol.render$Feature) => S), opt_this?: any): (S);
...
coordinate: ol.Coordinate,
opt_filter?: ((feature: ol.render$Feature) => boolean)): ol.render$Feature;
 ...
 */
declare type wms$ServerType = "carmentaserver" | "geoserver" | "mapserver" | "qgis";


/**
 * Request encoding. One of 'KVP', 'REST'.
 */
declare type source$WMTSRequestEncoding = "KVP" | "REST";
 ...
 * @api
 */
static optionsFromCapabilities(wmtsCap: GlobalObject, config: GlobalObject): olx$source.tilegrid$WMTSOptions
}
 ...
 */
declare export interface SphereMetricOptions {
 ...
 * @api
 */
static getArea(geometry: geom$geom$Geometry, opt_options?: SphereMetricOptions): number;
 ...
 * @api
 */
static getLength(geometry: geom$geom$Geometry, opt_options?: SphereMetricOptions): number
}
 ...
 * @param opt_options Options.
 */
declare class style$AtlasManager  {
 ...
 */
declare type style$IconAnchorUnits = "fraction" | "pixels";


/**
 * Icon origin. One of 'bottom-left', 'bottom-right', 'top-left', 'top-right'.
 */
declare type style$IconOrigin = "bottom-left" | "bottom-right" | "top-left" | "top-right";
 ...
 * @api
 */
getImage(pixelRatio: number): (source$Image | HTMLCanvasElement);
 ...
 * @api
 */
getImage(pixelRatio: number): (HTMLCanvasElement | HTMLVideoElement | style$Image);
 ...
 * @api
 */
setGeometry(geometry: (string | ol.geom.geom$Geometry | ol.StyleGeometryFunction)): void;
 ...
 * @param state State.
 */
constructor(tileCoord: ol.TileCoord, state: ol.source$Tile.source$State): this;
 ...
 * @api
 */
declare function tilegrid$createXYZ(opt_options?: olx$tilegrid.tilegrid$XYZOptions): tilegrid$TileGrid
 ...
 * @api
 */
static createFromCapabilitiesMatrixSet(matrixSet: GlobalObject, opt_extent?: ol.interaction$Extent): tilegrid$WMTS
}
	declare export type AttributionLike = (string | string[] | ol.control$Attribution | ol.control$Attribution[]);
...
pixelRatio: number,
size: ol.Size,
proj: ol.proj.proj$Projection) => HTMLCanvasElement;
 ...
 */
declare export type Color = ([number, number, number, number] | Uint8Array | Uint8ClampedArray);
	
/**
 * A type accepted by CanvasRenderingContext2D.fillStyle.
 * Represents a color, pattern, or gradient.
 */
declare export type ColorLike = (string | CanvasPattern | CanvasGradient);
	
/**
 * An array of numbers representing an xy coordinate. Example: `[16, 48]`.
 */
declare export type Coordinate = [number, number];
	
/**
 * A function that takes a {@link ol.Coordinate} and transforms it into a
 * `{string}`.
 */
declare export type CoordinateFormatType = (coords?: ol.Coordinate) => string;
 ...
 */
declare export type DragBoxEndConditionType = (event: ol.MapBrowserEvent, pixel1: ol.Pixel, pixel2: ol.Pixel) => boolean;
...
geo?: ol.geom.geom$SimpleGeometry) => ol.geom.geom$SimpleGeometry;
	
/**
 * A function that takes an {@link ol.MapBrowserEvent} and returns a
 * `{boolean}`. If the condition is met, true should be returned.
 */
declare export type EventsConditionType = (event: ol.MapBrowserEvent) => boolean;
	
/**
 * Key to use with {@link ol.Observable#unByKey}.
 */
declare export type EventsKey = GlobalObject;
	
/**
 * An array of numbers representing an extent: `[minx, miny, maxx, maxy]`.
 */
declare export type Extent = [number, number, number, number];
...
extent: ol.interaction$Extent,
resolution: number,
proj: ol.proj.proj$Projection) => void;
 ...
 */
declare export type FeatureStyleFunction = (resolution: number) => (ol.style.style$Style | ol.style.style$Style[] | null);
...
extent: ol.interaction$Extent,
resolution: number,
proj: ol.proj.proj$Projection) => string;
 ...
 */
declare export type ImageLoadFunctionType = (image: ol.style$Image, url: string) => void;
 ...
 */
declare export type LoadingStrategy = (extent: ol.interaction$Extent, resolution: number) => ol.interaction$Extent[];
 ...
 */
declare export type Pixel = [number, number];
 ...
 * `false` to remove it.
 */
declare export type PreRenderFunction = (map: ol.Map, state?: olx$olx$FrameState) => boolean;
 ...
 */
declare export type RasterOperation = (data: (number[][] | ImageData[]), obj: GlobalObject) => (number[] | ImageData);
...
feature: (ol.render$Feature | ol.render.render$Feature),
resolution: number) => (ol.style.style$Style | ol.style.style$Style[] | null);
...
feature: (ol.render$Feature | ol.render.render$Feature)) => (ol.geom.geom$Geometry | ol.render.render$Feature);
	
/**
 * An array of three numbers representing the location of a tile in a tile
 * grid. The order is `z`, `x`, and `y`. `z` is the zoom level.
 */
declare export type TileCoord = [number, number, number];
	
/**
 * A function that takes an {@link ol.Tile} for the tile and a `{string}` for
 * the url as arguments.
 */
declare export type TileLoadFunctionType = (loadingstrategy$tile: ol.source$Tile, url: string) => void;
 ...
 */
declare export type TransformFunction = (array: number[], out?: number[], dimension?: number) => number[];
	
/**
 * Number of features; bounds/extent.
 */
declare export type WFSFeatureCollectionMetadata = GlobalObject;
	
/**
 * Total deleted; total inserted; total updated; array of insert ids.
 */
declare export type WFSTransactionResponse = GlobalObject;
 ...
 * @param tileLoadFunction Tile load function.
 */
constructor(tileCoord: ol.TileCoord, state: ol.source$Tile.Tile$State, src: string, coordinate$format: ol.coordinate$format.render$Feature, tileLoadFunction: ol.TileLoadFunctionType): this;
 ...
 */
animate(
...var_args: Array<olx$animation.animation$AnimateOptions | olx$animation.animation$AnimateCallback>): void;
 ...
 * @api
 */
getResolutionForExtent(extent: ol.interaction$Extent, opt_size?: ol.Size): number;
...
opt_options?: olx$view.view$FitOptions): void;
...
featureClass?: (((geom: (ol.geom.geom$Geometry | {
[k: string]: any
})) => any) | ((
...
pointerStyle?: (ol.style.style$Style | ol.style.style$Style[] | ol.StyleFunction),
wrapX?: boolean
} 

declare interface interaction$TranslateOptions {
features?: ol.Collection<ol.render$Feature>,
layers?: (ol.layer.layer$Layer[] | ((layer: ol.layer.layer$Layer) => boolean))
} 
...
renderOrder?: (feature1: ol.render$Feature, feature2: ol.render$Feature) => number,
map?: ol.Map,
extent?: ol.interaction$Extent,
minResolution?: number,
maxResolution?: number,
...
controls?: (ol.Collection<ol.control.control$Control> | ol.control.control$Control[]),
pixelRatio?: number,
interactions?: (ol.Collection<ol.interaction.interaction$Interaction> | ol.interaction.interaction$Interaction[]),
...
proj$getPointResolution?: ((resolution: number, coords: ol.Coordinate) => number)
} 
