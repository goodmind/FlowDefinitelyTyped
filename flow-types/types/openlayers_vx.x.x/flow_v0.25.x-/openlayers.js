declare module "openlayers" {
   ...
   * @api
   */
  declare function colorlike$asColorLike(
   ...
   * @api stable
   */
  declare function coordinate$add(
   ...
   * @api stable
   */
  declare function coordinate$rotate(
    coordinate: ol.Coordinate,
    angle: number
  ): ol.Coordinate;
   ...
   */
  declare type geom$GeometryType =
    | "Point"
    | "LineString"
    | "LinearRing"
    | "Polygon"
  ...
  declare export class Image mixins ImageBase {
    ...
    ): HTMLCanvasElement | style$Image | HTMLVideoElement;
   ...
   * @api
   */
  declare export function inherits(
    childCtor: () => any,
    parentCtor: () => any
  ): void;
   ...
   */
  declare export type OverlayPositioning =
    | "bottom-left"
    | "bottom-center"
    | "bottom-right"
    | "center-left"
   ...
   * @api
   */
  declare function proj$addEquivalentProjections(
   ...
   * @api
   */
  declare function proj$equivalent(
    projection1: proj$Projection,
    projection2: proj$Projection
  ): boolean;
   ...
   */
  declare function proj$getPointResolution(
  ...
  declare class style$RegularShape mixins Image {
    ...
    getImage(
      pixelRatio: number
    ): HTMLCanvasElement | HTMLVideoElement | style$Image;
   ...
   */
  declare export type DragBoxEndConditionType = (
   ...
   */
  declare export type EventsConditionType = (
    event: ol.MapBrowserEvent
  ) => boolean;
   ...
   */
  declare export type RasterOperation = (
