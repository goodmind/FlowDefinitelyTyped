...
remove: (key: string) => void,
clearAll: () => void
} declare var store: StoreJsAPI;declare module 'store' {
...
declare var engine: StoreJsEngine;declare module 'store/src/store-engine' {
...
declare var storage: StoreJsStorage;declare module 'store/storages/cookieStorage' {
