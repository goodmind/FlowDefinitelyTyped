declare module "alexa-voice-service" {
  ...
  declare class AVS$EventTypes {
    ...
    static +RECORD_STOP: Class<AVS$EventTypes__RECORD_STOP> &
      AVS$EventTypes__RECORD_STOP &
      0; // 0
    static +RECORD_START: Class<AVS$EventTypes__RECORD_START> &
      AVS$EventTypes__RECORD_START &
      1; // 1
    static +ERROR: Class<AVS$EventTypes__ERROR> & AVS$EventTypes__ERROR & 2; // 2
    static +TOKEN_INVALID: Class<AVS$EventTypes__TOKEN_INVALID> &
      AVS$EventTypes__TOKEN_INVALID &
      3; // 3
    ...
    static +TOKEN_SET: Class<AVS$EventTypes__TOKEN_SET> &
      AVS$EventTypes__TOKEN_SET &
      7; // 7
    static +REFRESH_TOKEN_SET: Class<AVS$EventTypes__REFRESH_TOKEN_SET> &
      AVS$EventTypes__REFRESH_TOKEN_SET &
      8; // 8
  }
  ...
  declare class Player$EventTypes {
    ...
    static +ERROR: Class<Player$EventTypes__ERROR> &
      Player$EventTypes__ERROR &
      1; // 1
    static +PLAY: Class<Player$EventTypes__PLAY> & Player$EventTypes__PLAY & 2; // 2
    static +REPLAY: Class<Player$EventTypes__REPLAY> &
      Player$EventTypes__REPLAY &
      3; // 3
    static +PAUSE: Class<Player$EventTypes__PAUSE> &
      Player$EventTypes__PAUSE &
      4; // 4
    static +STOP: Class<Player$EventTypes__STOP> & Player$EventTypes__STOP & 5; // 5
    static +ENQUEUE: Class<Player$EventTypes__ENQUEUE> &
      Player$EventTypes__ENQUEUE &
      6; // 6
    static +DEQUE: Class<Player$EventTypes__DEQUE> &
      Player$EventTypes__DEQUE &
      7; // 7
  }
