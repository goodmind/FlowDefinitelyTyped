declare module "ultra-strftime" {
  ...
  declare type strftime$StrftimeFunction = (
    fmt: string,
    d?: Date,
    options?: strftime$Options
  ) => string;
  ...
  declare function strftime$strftimeUTC(
    fmt: string,
    d?: Date,
    locale?: strftime$Locale
  ): string;

  declare function strftime$strftimeTZ(
    fmt: string,
    d: Date,
    locale: strftime$Locale,
    timezone: number
  ...
  declare function strftime$localizedStrftime(
    locale: strftime$Locale
