 ...
 */
declare function client$load(name: "cloudmonitoring", version: "v2beta2"): PromiseLike<void>


declare function client$load(name: "cloudmonitoring", version: "v2beta2", callback: () => any): void
