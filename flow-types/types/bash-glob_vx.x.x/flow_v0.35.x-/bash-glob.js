...
declare function bashGlob$on(event: "match" | "files", callback: (files: string, cwd: string) => void): void


declare function bashGlob$on(event: "end", callback: (files: string) => void): void


declare function bashGlob$each(patterns: Patterns, callback: Callback): void


declare function bashGlob$each(patterns: Patterns, options: bashGlob$Options, callback: Callback): void


declare function bashGlob$promise(patterns: Patterns, options?: bashGlob$Options): Promise<string[]>


declare function bashGlob$sync(patterns: Patterns, options?: bashGlob$Options): string[]
