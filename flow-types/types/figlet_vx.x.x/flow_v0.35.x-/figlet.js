...
declare type figlet$Fonts = "1Row"
| "3-D"
| "3D Diagonal"
| "3D-ASCII"
| "3x5"
...
declare type figlet$KerningMethods = "default"
| "full"
| "fitted"
| "controlled smushing"
| "universal smushing";
...
declare function figlet$text(txt: string, cb: (error: Error | null, result?: string) => void): void


declare function figlet$text(
txt: string,
font: figlet$Fonts,
cb: (error: Error | null, result?: string) => void): void
 ...
 * @desc This `unified-signatures` is disabled because `Fonts` type is too long
 */
declare function figlet$textSync(txt: string, options: figlet$Options): string
...
headerComment?: string) => void): void


declare function figlet$defaults(opt?: $Shape<figlet$Defaults>): figlet$Defaults


declare function figlet$loadFont(
font: figlet$Fonts,
cb: (error: Error | null, fontOptions?: figlet$FontOptions) => void): void
 ...
 */
declare function figlet$fonts(cb: (error: Error | null, fontList?: figlet$Fonts[]) => void): void
