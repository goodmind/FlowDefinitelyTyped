...
declare module "openjscad" {
  declare var npm$namespace$OpenJsCad: {
    ...
    Viewer: typeof OpenJsCad$Viewer,
    Processor: typeof OpenJsCad$Processor
  };
  ...
  declare class CSG mixins CxG, ICenter {
    ...
    setShared(shared: CSG$PolygonShared): CSG;
  ...
  declare var npm$namespace$CSG: {
    ...
    Vector3D: typeof CSG$Vector3D,
    Vertex: typeof CSG$Vertex,
    Plane: typeof CSG$Plane,
    Polygon: typeof CSG$Polygon,
    PolygonTreeNode: typeof CSG$PolygonTreeNode,
    Tree: typeof CSG$Tree,
    Node: typeof CSG$Node,
    Matrix4x4: typeof CSG$Matrix4x4,
    Vector2D: typeof CSG$Vector2D,
    Line2D: typeof CSG$Line2D,
    Line3D: typeof CSG$Line3D,
    OrthoNormalBasis: typeof CSG$OrthoNormalBasis,
    fuzzyFactory: typeof CSG$fuzzyFactory,
    fuzzyCSGFactory: typeof CSG$fuzzyCSGFactory,
    Properties: typeof CSG$Properties,
    Connector: typeof CSG$Connector,
    ConnectorList: typeof CSG$ConnectorList,
    Path2D: typeof CSG$Path2D,
    Polygon2D: typeof CSG$Polygon2D,
    Polygon: typeof npm$namespace$CSG$Polygon
  };
  ...
  declare class CSG$Polygon mixins CxG {
    ...
    cachedBoundingBox: CSG$Vector3D[];
    static defaultShared: CSG$PolygonShared;
    constructor(
     ...
     */
    _addWalls(walls: any, bottom: any, top: any, bFlipped: any): void;
  ...
  declare var npm$namespace$CSG$Polygon: {
    Shared: typeof CSG$Polygon$Shared
  };
  declare class CSG$Polygon$Shared {
    color: any;
    tag: any;
    constructor(color: any): this;
    static fromObject(obj: any): CSG$Polygon$Shared;
    static fromColor(args: any): CSG$Polygon$Shared;
    getTag(): any;
    getHash(): any;
  }
  ...
  declare var npm$namespace$CAG: {
    Vertex: typeof CAG$Vertex,
    Side: typeof CAG$Side,
    fuzzyCAGFactory: typeof CAG$fuzzyCAGFactory
  };
  ...
  declare class CAG$Side mixins CxG {
    ...
    static _fromFakePolygon(polygon: CSG$Polygon): CAG$Side;
    toString(): string;
