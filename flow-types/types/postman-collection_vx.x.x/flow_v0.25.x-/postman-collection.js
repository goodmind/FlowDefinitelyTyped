declare module "postman-collection" {
  ...
  declare export class Property<TDefinition>
    mixins PropertyBase<TDefinition>, PropertyDefinition {
    disabled: boolean;
    id: string;
    name: string;
    constructor(
  ...
  declare export class Certificate
    mixins Property<CertificateDefinition>, CertificateDefinition {
    cert: {
      src?: string
    };
    key: {
  ...
  declare export class PropertyList<TElement>
    mixins PropertyBase<PropertyBaseDefinition> {
  ...
  declare export class Cookie
    mixins PropertyBase<CookieDefinition>, CookieDefinition {
    domain: string;
    expires: Date;
    extensions: Array<{
      key: string,
  ...
  declare export class FormParam
    mixins Property<FormParamDefinition>, FormParamDefinition {
    key: string;
    value: any;
  ...
  declare export class Header
    mixins Property<HeaderDefinition>, HeaderDefinition {
    key: string;
    value: string;
  ...
  declare export class ProxyConfig
    mixins Property<ProxyConfigDefinition>, ProxyConfigDefinition {
    host: string;
  ...
  declare export class QueryParam
    mixins Property<QueryParamDefinition>, QueryParamDefinition {
  ...
  declare export class Request
    mixins Property<RequestDefinition>, RequestDefinition {
    auth: RequestAuth;
    body: RequestBody;
  ...
  declare export class RequestAuth
    mixins Property<RequestAuthDefinition>, RequestAuthDefinition {
    type: string;
    constructor(
  ...
  declare export class RequestBody
    mixins PropertyBase<RequestBodyDefinition>, RequestBodyDefinition {
    static MODES: {
      raw: string,
      formdata: string,
      urlencoded: string,
  ...
  declare export class Response
    mixins Property<ResponseDefinition>, ResponseDefinition {
    body: string;
    code: number;
    cookies: CookieList;
    headers: HeaderList;
  ...
  declare export class Script
    mixins Property<ScriptDefinition>, ScriptDefinition {
    exec: string[];
    src: Url;
    type: string;
  ...
  declare export class UrlMatchPatternList
    mixins PropertyList<UrlMatchPattern> {
  ...
  declare export class Variable
    mixins Property<VariableDefinition>, VariableDefinition {
    key: string;
    type: string;
    value: any;
    constructor(
  ...
  declare export class VariableList mixins PropertyList<Variable> {
    constructor(
      parent: Property<PropertyDefinition>,
      populate: Variable[]
    ): this;
  ...
  declare export class VariableScope
    mixins Property<VariableScopeDefinition>, VariableScopeDefinition {
    values: VariableDefinition[];
    constructor(
  ...
  declare export class Version
    mixins PropertyBase<VersionDefinition>, VersionDefinition {
    build: string;
    major: string;
    minor: string;
    patch: string;
