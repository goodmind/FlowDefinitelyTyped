declare module "async" {
  ...
  declare export type IterableCollection<T> =
    | T[]
    | IterableIterator<T>
    | Scripting$Dictionary<T>;
  declare export interface ErrorCallback<E = __esri$Error> {
    (err?: E | null): void;
  }
  declare export interface AsyncBooleanResultCallback<E = __esri$Error> {
    (err?: E | null, truthValue?: boolean): void;
  }
  declare export interface AsyncResultCallback<T, E = __esri$Error> {
    (err?: E | null, result?: T): void;
  }
  declare export interface AsyncResultArrayCallback<T, E = __esri$Error> {
    (err?: E | null, results?: Array<T | void>): void;
  }
  declare export interface AsyncResultObjectCallback<T, E = __esri$Error> {
    (err: E | void, results: Scripting$Dictionary<T | void>): void;
  }
  declare export interface AsyncFunction<T, E = __esri$Error> {
    (callback: (err?: E | null, result?: T) => void): void;
  }
  declare export interface AsyncFunctionEx<T, E = __esri$Error> {
    (callback: (err?: E | null, ...results: T[]) => void): void;
  }
  declare export interface AsyncIterator<T, E = __esri$Error> {
    (item: T, callback: ErrorCallback<E>): void;
  }
  declare export interface AsyncForEachOfIterator<T, E = __esri$Error> {
    (item: T, key: number | string, callback: ErrorCallback<E>): void;
  }
  declare export interface AsyncResultIterator<T, R, E = __esri$Error> {
    (item: T, callback: AsyncResultCallback<R, E>): void;
  }
  declare export interface AsyncMemoIterator<T, R, E = __esri$Error> {
    (memo: R | void, item: T, callback: AsyncResultCallback<R, E>): void;
  }
  declare export interface AsyncBooleanIterator<T, E = __esri$Error> {
    (item: T, callback: AsyncBooleanResultCallback<E>): void;
  }
  declare export interface AsyncWorker<T, E = __esri$Error> {
    (task: T, callback: ErrorCallback<E>): void;
  }
  declare export interface AsyncVoidFunction<E = __esri$Error> {
    (callback: ErrorCallback<E>): void;
  }
  declare export type AsyncAutoTasks<
    R: Scripting$Dictionary<any>,
    E
  > = $ObjMapi<R, <K>(K) => AsyncAutoTask<$ElementType<R, K>, R, E>>;
  declare export type AsyncAutoTask<R1, R: Scripting$Dictionary<any>, E> =
    | AsyncAutoTaskFunctionWithoutDependencies<R1, E>
    | Array<$Keys<R> | AsyncAutoTaskFunction<R1, R, E>>;
  declare export interface AsyncAutoTaskFunctionWithoutDependencies<
    R1,
    E = __esri$Error
  > {
    (cb: AsyncResultCallback<R1, E> | ErrorCallback<E>): void;
  }
  declare export interface AsyncAutoTaskFunction<
    R1,
    R: Scripting$Dictionary<any>,
    E = __esri$Error
  > {
  ...
  declare export interface AsyncQueue<T> {
    ...
    error(error: __esri$Error, data: any): void;
    unsaturated(): void;
    buffer: number;
  }
  ...
  declare export function map<T, R, E>(
    arr: T[] | IterableIterator<T> | Scripting$Dictionary<T>,
  ...
  declare export var AuthenticationContext$inject: typeof reduce;
  ...
  declare export function series<T, E>(
    tasks: Scripting$Dictionary<AsyncFunction<T, E>>,
  ...
  declare export function forever<E>(
    next: (next: ErrorCallback<E>) => void,
    errBack: ErrorCallback<E>
  ): void;

  declare export function waterfall<T, E>(
    tasks: Function[],
    callback?: AsyncResultCallback<T, E>
  ): void;
  ...
  declare export function applyEach(
    fns: Function[],
    ...argsAndCallback: any[]
  ): void;

  declare export function applyEachSeries(
    fns: Function[],
    ...argsAndCallback: any[]
  ): void;

  declare export function queue<T, E>(
  ...
  declare export function priorityQueue<T, E>(
    worker: AsyncWorker<T, E>,
    concurrency: number
  ...
  declare export function auto<R: Scripting$Dictionary<any>, E>(
  ...
  declare export function autoInject<E>(
    tasks: any,
  ...
  declare export function apply<E>(
    fn: Function,
    ...args: any[]
  ): AsyncFunction<any, E>;
  ...
  declare export function ensureAsync(
