...
event: RequestBody<T>,
context: Context,
callback?: (err: any, response: any) => void): AlexaObject<T>
	...
	declare export type ImageSourceSize = "X_SMALL"
| "SMALL"
| "MEDIUM"
| "LARGE"
| "X_LARGE";
	declare export type TemplateBackButtonVisibility = "HIDDEN" | "VISIBLE";
	declare export type TemplateType = "BodyTemplate1"
| "BodyTemplate2"
| "BodyTemplate3"
| "BodyTemplate6"
| "BodyTemplate6"
| "ListTemplate1"
| "ListTemplate2";
	declare export type AudioPlayerActivity = "IDLE"
| "PAUSED"
| "PLAYING"
| "BUFFER_UNDERRUN"
| "FINISHED"
| "STOPPED";
	declare export type CardType = "Standard" | "Simple" | "LinkAccount" | "AskForPermissionsConsent";
	declare export type HintType = "PlainText";
	declare export type DirectiveTypes = "AudioPlayer.Play"
| "AudioPlayer.Stop"
...
| "VideoApp.Launch";
	...
	declare export type MediaErrorType = "MEDIA_ERROR_UNKNOWN"
| "MEDIA_ERROR_INVALID_REQUEST"
| "MEDIA_ERROR_SERVICE_UNAVAILABLE"
| "MEDIA_ERROR_INTERNAL_SERVER_ERROR"
| "MEDIA_ERROR_INTERNAL_DEVICE_ERROR";
	declare export type SystemErrorType = "INVALID_RESPONSE" | "DEVICE_COMMUNICATION_ERROR" | "INTERNAL_ERROR";
...
version: number
	...
	declare interface templateBuilders$SetTextContent<T: templateBuilders$TemplateBuilder<T>> {
setTextContent(primaryText: TextField, secondaryText?: TextField, tertiaryText?: TextField): T
} 

declare interface templateBuilders$SetListItems<T: templateBuilders$TemplateBuilder<T>> {
 ...
 */
declare class templateBuilders$TemplateBuilder<T: templateBuilders$TemplateBuilder<T>>  {
template: Template;
constructor(): this;
...
primaryText: TextField,
secondaryText?: TextField,
tertiaryText?: TextField): templateBuilders$ListItemBuilder;
build(): ListItem[]
}
 ...
 */
declare class templateBuilders$BodyTemplate1Builder mixins templateBuilders$TemplateBuilder<templateBuilders$BodyTemplate1Builder>, templateBuilders$SetTextContent<templateBuilders$BodyTemplate1Builder> {
constructor(): this;
...
primaryText: TextField,
secondaryText?: TextField,
tertiaryText?: TextField): templateBuilders$BodyTemplate1Builder
}
 ...
 */
declare class templateBuilders$BodyTemplate2Builder mixins templateBuilders$TemplateBuilder<templateBuilders$BodyTemplate2Builder>, templateBuilders$SetTextContent<templateBuilders$BodyTemplate2Builder> {
constructor(): this;
...
primaryText: TextField,
secondaryText?: TextField,
tertiaryText?: TextField): templateBuilders$BodyTemplate2Builder
}
 ...
 */
declare class templateBuilders$BodyTemplate3Builder mixins templateBuilders$TemplateBuilder<templateBuilders$BodyTemplate3Builder>, templateBuilders$SetTextContent<templateBuilders$BodyTemplate3Builder> {
constructor(): this;
...
primaryText: TextField,
secondaryText?: TextField,
tertiaryText?: TextField): templateBuilders$BodyTemplate3Builder
}
 ...
 */
declare class templateBuilders$BodyTemplate6Builder mixins templateBuilders$TemplateBuilder<templateBuilders$BodyTemplate6Builder>, templateBuilders$SetTextContent<templateBuilders$BodyTemplate6Builder> {
constructor(): this;
...
primaryText: TextField,
secondaryText?: TextField,
tertiaryText?: TextField): templateBuilders$BodyTemplate6Builder
}
 ...
 */
declare class templateBuilders$BodyTemplate7Builder mixins templateBuilders$TemplateBuilder<templateBuilders$BodyTemplate7Builder> {
constructor(): this;
 ...
 */
declare class templateBuilders$ListTemplate1Builder mixins templateBuilders$TemplateBuilder<templateBuilders$ListTemplate1Builder>, templateBuilders$SetListItems<templateBuilders$ListTemplate1Builder> {
constructor(): this;
 ...
 */
declare class templateBuilders$ListTemplate2Builder mixins templateBuilders$TemplateBuilder<templateBuilders$ListTemplate2Builder>, templateBuilders$SetListItems<templateBuilders$ListTemplate2Builder> {
constructor(): this;
...
uri: string,
headers: {[key: string]: any},
body?: string): Promise<ApiClientResponse>;
 ...
 * @returns Promise<ApiClientResponse>
 */
get(uri: string, headers: {[key: string]: any}): Promise<ApiClientResponse>;
 ...
 * @returns Promise<ApiClientResponse>
 */
delete(uri: string, headers: {[key: string]: any}): Promise<ApiClientResponse>
}
...
token: string): Promise<ListObject>;
...
token: string): Promise<ListItemObject>;
...
offsetInMilliseconds: number): ResponseBuilder;
