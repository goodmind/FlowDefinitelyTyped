declare module "imperium" {
  declare export type GetAcl = (
    req: express.Request
  ) => Promise<boolean> | Promise<{ [key: string]: any }>;
  ...
  declare export function evaluateRouteActions(
    req: express.Request,
    action: Action[],
    context: Context
  ): Actions;

  declare export function evaluateRouteAction(
    req: express.Request,
    expr: string,
    key: string,
    context: Context
  ...
  declare export function evaluateUserActions(
    req: express.Request,
    roles: Role[]
  ): Promise<Action[]>;
