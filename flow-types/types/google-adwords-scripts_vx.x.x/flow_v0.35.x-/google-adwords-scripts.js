...
dateTo: AdWordsDate | string): AdWordsSelector<E>,
...
} & AdWordsEntity & hasMobilePreferred & hasStartAndEndDate & hasSchedules
...
withTargetAdGroup(
campaignName: string,
adGroup: string): AdCustomizerItemBuilder<AdCustomizerItem>,
...
} & AdWordsBuilder<AdCustomizerItem> & hasMobilePreferredBuilder<AdCustomizerItemBuilder<AdCustomizerItem>> & hasSchedulesBuilder<AdCustomizerItemBuilder<AdCustomizerItem>> & hasStartAndEndDateBuilder<AdCustomizerItemBuilder<AdCustomizerItem>>
...
} & AdWordsEntity & hasMobilePreferred & hasStartAndEndDate & hasSchedules & hasStats & isAdGroupChild

	declare type CalloutBuilder<Callout> = {
withText(text: string): CalloutBuilder<Callout>
} & AdWordsBuilder<Callout> & hasMobilePreferredBuilder<CalloutBuilder<Callout>> & hasSchedulesBuilder<CalloutBuilder<Callout>> & hasStartAndEndDateBuilder<CalloutBuilder<Callout>>
...
} & AdWordsBuilder<Message> & hasMobilePreferredBuilder<MessageBuilder<Message>> & hasStartAndEndDateBuilder<MessageBuilder<Message>> & hasSchedulesBuilder<MessageBuilder<Message>>
...
} & AdWordsUrls & hasGetFinalUrl & hasSetFinalUrl & hasSetTrackingTemplate
...
} & AdWordsBuilder<MobileApp> & hasMobilePreferredBuilder<MobileAppBuilder<MobileApp>> & hasStartAndEndDateBuilder<MobileAppBuilder<MobileApp>> & hasSchedulesBuilder<MobileAppBuilder<MobileApp>> & hasTrackingTemplateBuilder<MobileAppBuilder<MobileApp>> & hasFinalUrlBuilder<MobileAppBuilder<MobileApp>>
...
setPhoneNumber(phoneNumber: string): void
} & AdWordsEntity & hasMobilePreferred & hasSchedules & hasStartAndEndDate & hasStats & isAdGroupChild
...
} & AdWordsBuilder<PhoneNumber> & hasMobilePreferredBuilder<PhoneNumberBuilder<PhoneNumber>> & hasStartAndEndDateBuilder<PhoneNumberBuilder<PhoneNumber>> & hasSchedulesBuilder<PhoneNumberBuilder<PhoneNumber>>
...
} & AdWordsBuilder<Review> & hasMobilePreferredBuilder<ReviewBuilder<Review>> & hasStartAndEndDateBuilder<ReviewBuilder<Review>> & hasSchedulesBuilder<ReviewBuilder<Review>>
...
clearMobileFinalUrl(): void
} & AdWordsUrls & hasSetTrackingTemplate & hasGetFinalUrl & hasSetFinalUrl
...
} & AdWordsBuilder<Sitelink> & hasMobilePreferredBuilder<SitelinkBuilder<Sitelink>> & hasStartAndEndDateBuilder<SitelinkBuilder<Sitelink>> & hasSchedulesBuilder<SitelinkBuilder<Sitelink>> & hasTrackingTemplateBuilder<SitelinkBuilder<Sitelink>> & hasFinalUrlBuilder<SitelinkBuilder<Sitelink>>
...
} & AdWordsBuilder<Snippet> & hasMobilePreferredBuilder<SnippetBuilder<Snippet>> & hasStartAndEndDateBuilder<SnippetBuilder<Snippet>> & hasSchedulesBuilder<SnippetBuilder<Snippet>>
...
urls(): AdGroupUrls
} & AdWordsEntity & canBeEnabled & hasExtensions & hasLabels & hasStats & isCampaignChild

	declare type AdGroupUrls = {
clearTrackingTemplate(): void
} & AdWordsUrls & hasSetTrackingTemplate
...
} & AdWordsBuilder<AdGroup> & hasBiddingStrategyBuilder<AdGroupBuilder<AdGroup>> & hasTrackingTemplateBuilder<AdGroupBuilder<AdGroup>>
...
setTabletBidModifier(modifier: number): void
	...
	declare type AdGroupTargeting<SearchAdGroupAudience, SearchAdGroupExcludedAudience> = {
...
targetingSetting: TargetingSetting): void
...
remove(): void,
urls(): AdUrls
} & AdWordsEntity & canBeEnabled & hasLabels & hasStats & isAdGroupChild

	declare type AdBuilder<T> = {} & AdWordsBuilder<T> & hasFinalUrlBuilder<T> & hasTrackingTemplateBuilder<T>
...
itemButtonFinalMobileUrls: string[]): GmailMultiProductAdBuilder<GmailMultiProductAd>,
...
itemButtonTrackingTemplates: string[]): GmailMultiProductAdBuilder<GmailMultiProductAd>,
...
callToActionButtonColor: string): GmailSinglePromotionAdBuilder<GmailSinglePromotionAd>,
withCallToActionTextColor(
callToActionTextColor: string): GmailSinglePromotionAdBuilder<GmailSinglePromotionAd>,
...
optArgs: FileUploadArguments): FileUpload
} 
...
addLocation(
locationId: number | TargetedLocation | LocationObject): AdWordsOperation<TargetedLocation>,
...
addProximity(
proximity: ProximityObject | TargetedProximity): AdWordsOperation<TargetedProximity>,
addProximity(
latitude: number,
longitude: number,
radius: number,
...
excludeLocation(
location: ExcludedLocation | number | {
id: number
...
urls(): CampaignUrls
} & AdWordsEntity & canBeEnabled & hasLabels & hasStartAndEndDate & hasStats

	declare type CampaignBidding = {} & AdWordsBidding & canSetBiddingStrategy

	declare type CampaignTargeting<SearchCampaignAudience, SearchCampaignExcludedAudience> = {
...
} & ExcludedDisplayKeyword & hasStats
...
clearStrategy(): void
} & DisplayBidding & canSetBiddingStrategy
...
setCpc(cpc: number): void,
setCpm(cpm: number): void
} & AdWordsBidding & canSetBiddingStrategy
...
} & AdWordsBuilder<Keyword> & hasBiddingStrategyBuilder<KeywordBuilder<Keyword>> & hasTrackingTemplateBuilder<KeywordBuilder<Keyword>> & hasFinalUrlBuilder<KeywordBuilder<Keyword>>

	declare type KeywordUrls = {
clearFinalUrl(): void,
clearMobileFinalUrl(): void,
clearTrackingTemplate(): void
} & AdWordsUrls & hasGetFinalUrl & hasSetTrackingTemplate & hasSetFinalUrl
...
remove(): void
} & AdWordsEntity & canSetBidModifier & hasStats & isCampaignChild

	declare type SearchAdGroupAudience = {
bidding(): SearchAudienceBidding,
isEnabled(): boolean,
isPaused(): boolean
} & SearchAdGroupExcludedAudience & hasStats
...
remove(): void
	...
	declare type TargetedLocation = {} & ExcludedLocation & canSetBidModifier & hasStats
...
| "LAST_MONTH"
| "ALL_TIME";
	declare type DayOfWeekString = "MONDAY"
| "TUESDAY"
| "WEDNESDAY"
| "THURSDAY"
| "FRIDAY"
...
| "SUNDAY";
	...
	declare type ApprovalStatus = "APPROVED"
| "DISAPPROVED"
| "FAMILY_SAFE"
| "NON_FAMILY_SAFE"
| "PORN"
| "UNCHECKED";
	declare type PolicyApprovalStatus = "UNKNOWN"
| "APPROVED"
| "APPROVED_LIMITED"
| "ELIGIBLE"
| "UNDER_REVIEW"
| "DISAPPROVED"
| "SITE_SUSPENDED";
	declare type AdType = "EXPANDED_TEXT_AD"
| "IMAGE_AD"
| "MOBILE_AD"
| "MOBILE_IMAGE_AD"
| "PRODUCT_AD"
...
| "TEXT_AD";
	...
	declare type BiddingStrategyString = "MANUAL_CPC"
| "MANUAL_CPM"
| "BUDGET_OPTIMIZER"
...
| "MEDIA_BUNDLE";
	...
	declare type TargetType = "Airport"
...
| "University";
	...
	declare type UserListType = "UNKNOWN0"
| "REMARKETING"
| "LOGICAL"
...
| "SIMILAR"
| "CRM_BASED";
	declare type UserListSizeRange = "LESS_THAN_FIVE_HUNDRED"
...
declare function AdWordsApp$adGroupTargeting(): AdWordsTargeting<SearchAdGroupAudience, SearchAdGroupExcludedAudience>
...
declare function AdWordsApp$createLabel(name: string, description?: string, backgroundColor?: string): void
...
declare function AdWordsApp$report(query: string, options?: ReportOptionArguments): AdWordsReport
