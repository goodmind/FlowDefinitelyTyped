 ...
 */
results: any[];
constructor(grammar: Grammar, options?: ParserOptions): this;
...
constructor(name: string, symbols: any[], postprocess?: Postprocessor): this;
...
lexer: Lexer;
constructor(rules: Rule[]): this
}
	declare export interface CompiledRules {
Lexer?: Lexer,
ParserStart: string,
ParserRules: ParserRule[]
} 
	declare export interface ParserRule {
name: string,
symbols: any[],
postprocess?: Postprocessor
} 
	declare export type Postprocessor = (data: any[], reference: number, wantedBy: {}) => void;
