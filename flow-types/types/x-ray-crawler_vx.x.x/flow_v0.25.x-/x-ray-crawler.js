declare module "x-ray-crawler" {
  ...
  declare function XRayCrawler(
    driver?: XRayCrawler$XRayCrawler$Driver
  ): XRayCrawler$XRayCrawler$Instance;

  declare type XRayCrawler$Callback<T> = (err: Error, obj: T) => void;

  declare type XRayCrawler$Driver = (
    context: HttpContext.Context,
    callback: XRayCrawler$Callback<HttpContext.Context>
  ) => void;

  declare type XRayCrawler$RequestHook = (request: HttpContext.Request) => void;

  declare type XRayCrawler$ResponseHook = (
