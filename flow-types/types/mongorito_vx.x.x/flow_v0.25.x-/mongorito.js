declare module "mongorito" {
  ...
  declare export class ActionTypes {
    ...
    static +UNSET: Class<ActionTypes__UNSET> &
      ActionTypes__UNSET &
      "@@mongorito/UNSET"; // "@@mongorito/UNSET"
    static +REFRESH: Class<ActionTypes__REFRESH> &
      ActionTypes__REFRESH &
      "@@mongorito/REFRESH"; // "@@mongorito/REFRESH"
    static +REFRESHED: Class<ActionTypes__REFRESHED> &
      ActionTypes__REFRESHED &
      "@@mongorito/REFRESHED"; // "@@mongorito/REFRESHED"
    static +SAVE: Class<ActionTypes__SAVE> &
      ActionTypes__SAVE &
      "@@mongorito/SAVE"; // "@@mongorito/SAVE"
    static +CREATE: Class<ActionTypes__CREATE> &
      ActionTypes__CREATE &
      "@@mongorito/CREATE"; // "@@mongorito/CREATE"
    static +CREATED: Class<ActionTypes__CREATED> &
      ActionTypes__CREATED &
      "@@mongorito/CREATED"; // "@@mongorito/CREATED"
    static +UPDATE: Class<ActionTypes__UPDATE> &
      ActionTypes__UPDATE &
      "@@mongorito/UPDATE"; // "@@mongorito/UPDATE"
    static +UPDATED: Class<ActionTypes__UPDATED> &
      ActionTypes__UPDATED &
      "@@mongorito/UPDATED"; // "@@mongorito/UPDATED"
    static +REMOVE: Class<ActionTypes__REMOVE> &
      ActionTypes__REMOVE &
      "@@mongorito/REMOVE"; // "@@mongorito/REMOVE"
    static +REMOVED: Class<ActionTypes__REMOVED> &
      ActionTypes__REMOVED &
      "@@mongorito/REMOVED"; // "@@mongorito/REMOVED"
    static +INCREMENT: Class<ActionTypes__INCREMENT> &
      ActionTypes__INCREMENT &
      "@@mongorito/INCREMENT"; // "@@mongorito/INCREMENT"
    static +CREATE_INDEX: Class<ActionTypes__CREATE_INDEX> &
      ActionTypes__CREATE_INDEX &
      "@@mongorito/CREATE_INDEX"; // "@@mongorito/CREATE_INDEX"
    static +DROP_INDEX: Class<ActionTypes__DROP_INDEX> &
      ActionTypes__DROP_INDEX &
      "@@mongorito/DROP_INDEX"; // "@@mongorito/DROP_INDEX"
    static +LIST_INDEXES: Class<ActionTypes__LIST_INDEXES> &
      ActionTypes__LIST_INDEXES &
      "@@mongorito/LIST_INDEXES"; // "@@mongorito/LIST_INDEXES"
    static +QUERY: Class<ActionTypes__QUERY> &
      ActionTypes__QUERY &
      "@@mongorito/QUERY"; // "@@mongorito/QUERY"
    static +CALL: Class<ActionTypes__CALL> &
      ActionTypes__CALL &
      "@@mongorito/CALL"; // "@@mongorito/CALL"
  }
  ...
  declare export type Reducer<S = any> = (state: S, action: Action) => Reducer;
  ...
  declare export class DatabaseState {
    constructor(...args: empty): mixed;
    static +STATE_CONNECTED: Class<DatabaseState__STATE_CONNECTED> &
      DatabaseState__STATE_CONNECTED &
      0; // 0
    static +STATE_CONNECTING: Class<DatabaseState__STATE_CONNECTING> &
      DatabaseState__STATE_CONNECTING &
      1; // 1
    static +STATE_DISCONNECTED: Class<DatabaseState__STATE_DISCONNECTED> &
      DatabaseState__STATE_DISCONNECTED &
      2; // 2
  }
