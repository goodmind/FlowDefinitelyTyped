declare module "firmata" {
  ...
  declare class Board mixins NodeJS.EventEmitter {
    constructor(
      serialPort: any,
      optionsOrCallback?: Board$Board$Options | ((error: any) => void),
    ...
    digitalRead(
      pin: number,
      callback: (val: Board$Board$PIN_STATE) => void
    ): void;
    ...
    static requestPort(
      callback: (error: any, port: Board$Board$Port) => any
    ): void;
  ...
  declare class Board$PIN_MODE {
    ...
    static +ONEWIRE: Class<Board$PIN_MODE__ONEWIRE> &
      Board$PIN_MODE__ONEWIRE &
      7; // 7
    static +STEPPER: Class<Board$PIN_MODE__STEPPER> &
      Board$PIN_MODE__STEPPER &
      8; // 8
    ...
    static +IGNORE: Class<Board$PIN_MODE__IGNORE> &
      Board$PIN_MODE__IGNORE &
      127; // 127
    static +PING_READ: Class<Board$PIN_MODE__PING_READ> &
      Board$PIN_MODE__PING_READ &
      117; // 117
    static +UNKNOWN: Class<Board$PIN_MODE__UNKNOWN> &
      Board$PIN_MODE__UNKNOWN &
      16; // 16
  }
  ...
  declare class Board$PULLUP_STATE {
    constructor(...args: empty): mixed;
    static +ENABLED: Class<Board$PULLUP_STATE__ENABLED> &
      Board$PULLUP_STATE__ENABLED &
      1; // 1
    static +DISABLED: Class<Board$PULLUP_STATE__DISABLED> &
      Board$PULLUP_STATE__DISABLED &
      0; // 0
  }
  ...
  declare class Board$STEPPER_TYPE {
    constructor(...args: empty): mixed;
    static +DRIVER: Class<Board$STEPPER_TYPE__DRIVER> &
      Board$STEPPER_TYPE__DRIVER &
      1; // 1
    static +TWO_WIRE: Class<Board$STEPPER_TYPE__TWO_WIRE> &
      Board$STEPPER_TYPE__TWO_WIRE &
      2; // 2
    static +FOUR_WIRE: Class<Board$STEPPER_TYPE__FOUR_WIRE> &
      Board$STEPPER_TYPE__FOUR_WIRE &
      4; // 4
  }
  ...
  declare class Board$STEPPER_RUN_STATE {
    constructor(...args: empty): mixed;
    static +STOP: Class<Board$STEPPER_RUN_STATE__STOP> &
      Board$STEPPER_RUN_STATE__STOP &
      0; // 0
    static +ACCEL: Class<Board$STEPPER_RUN_STATE__ACCEL> &
      Board$STEPPER_RUN_STATE__ACCEL &
      1; // 1
    static +DECEL: Class<Board$STEPPER_RUN_STATE__DECEL> &
      Board$STEPPER_RUN_STATE__DECEL &
      2; // 2
    static +RUN: Class<Board$STEPPER_RUN_STATE__RUN> &
      Board$STEPPER_RUN_STATE__RUN &
      3; // 3
  }
  ...
  declare class Board$STEPPER_DIRECTION {
    constructor(...args: empty): mixed;
    static +CCW: Class<Board$STEPPER_DIRECTION__CCW> &
      Board$STEPPER_DIRECTION__CCW &
      0; // 0
    static +CW: Class<Board$STEPPER_DIRECTION__CW> &
      Board$STEPPER_DIRECTION__CW &
      1; // 1
  }
  ...
  declare class Board$I2C_MODE {
    ...
    static +CONTINUOUS_READ: Class<Board$I2C_MODE__CONTINUOUS_READ> &
      Board$I2C_MODE__CONTINUOUS_READ &
      2; // 2
    static +STOP_READING: Class<Board$I2C_MODE__STOP_READING> &
      Board$I2C_MODE__STOP_READING &
      3; // 3
  }
  ...
  declare class Board$SERIAL_MODE {
    constructor(...args: empty): mixed;
    static +CONTINUOUS_READ: Class<Board$SERIAL_MODE__CONTINUOUS_READ> &
      Board$SERIAL_MODE__CONTINUOUS_READ &
      0; // 0
    static +STOP_READING: Class<Board$SERIAL_MODE__STOP_READING> &
      Board$SERIAL_MODE__STOP_READING &
      1; // 1
  }
  ...
  declare class Board$SERIAL_PORT_ID {
    constructor(...args: empty): mixed;
    static +HW_SERIAL0: Class<Board$SERIAL_PORT_ID__HW_SERIAL0> &
      Board$SERIAL_PORT_ID__HW_SERIAL0 &
      0; // 0
    static +HW_SERIAL1: Class<Board$SERIAL_PORT_ID__HW_SERIAL1> &
      Board$SERIAL_PORT_ID__HW_SERIAL1 &
      1; // 1
    static +HW_SERIAL2: Class<Board$SERIAL_PORT_ID__HW_SERIAL2> &
      Board$SERIAL_PORT_ID__HW_SERIAL2 &
      2; // 2
    static +HW_SERIAL3: Class<Board$SERIAL_PORT_ID__HW_SERIAL3> &
      Board$SERIAL_PORT_ID__HW_SERIAL3 &
      3; // 3
    static +SW_SERIAL0: Class<Board$SERIAL_PORT_ID__SW_SERIAL0> &
      Board$SERIAL_PORT_ID__SW_SERIAL0 &
      8; // 8
    static +SW_SERIAL1: Class<Board$SERIAL_PORT_ID__SW_SERIAL1> &
      Board$SERIAL_PORT_ID__SW_SERIAL1 &
      9; // 9
    static +SW_SERIAL2: Class<Board$SERIAL_PORT_ID__SW_SERIAL2> &
      Board$SERIAL_PORT_ID__SW_SERIAL2 &
      16; // 16
    static +SW_SERIAL3: Class<Board$SERIAL_PORT_ID__SW_SERIAL3> &
      Board$SERIAL_PORT_ID__SW_SERIAL3 &
      17; // 17
    static +DEFAULT: Class<Board$SERIAL_PORT_ID__DEFAULT> &
      Board$SERIAL_PORT_ID__DEFAULT &
      8; // 8
  }
  ...
  declare class Board$SERIAL_PIN_TYPE {
    constructor(...args: empty): mixed;
    static +RES_RX0: Class<Board$SERIAL_PIN_TYPE__RES_RX0> &
      Board$SERIAL_PIN_TYPE__RES_RX0 &
      0; // 0
    static +RES_TX0: Class<Board$SERIAL_PIN_TYPE__RES_TX0> &
      Board$SERIAL_PIN_TYPE__RES_TX0 &
      1; // 1
    static +RES_RX1: Class<Board$SERIAL_PIN_TYPE__RES_RX1> &
      Board$SERIAL_PIN_TYPE__RES_RX1 &
      2; // 2
    static +RES_TX1: Class<Board$SERIAL_PIN_TYPE__RES_TX1> &
      Board$SERIAL_PIN_TYPE__RES_TX1 &
      3; // 3
    static +RES_RX2: Class<Board$SERIAL_PIN_TYPE__RES_RX2> &
      Board$SERIAL_PIN_TYPE__RES_RX2 &
      4; // 4
    static +RES_TX2: Class<Board$SERIAL_PIN_TYPE__RES_TX2> &
      Board$SERIAL_PIN_TYPE__RES_TX2 &
      5; // 5
    static +RES_RX3: Class<Board$SERIAL_PIN_TYPE__RES_RX3> &
      Board$SERIAL_PIN_TYPE__RES_RX3 &
      6; // 6
    static +RES_TX3: Class<Board$SERIAL_PIN_TYPE__RES_TX3> &
      Board$SERIAL_PIN_TYPE__RES_TX3 &
      7; // 7
  }
