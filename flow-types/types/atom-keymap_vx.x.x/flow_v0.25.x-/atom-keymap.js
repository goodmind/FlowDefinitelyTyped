...
declare interface AtomKeymap$KeymapManager {
   ...
   */
  onDidMatchBinding(
    callback: (event: Events$Events$FullKeybindingMatch) => void
  ): Disposable;
  ...
  onDidPartiallyMatchBindings(
    callback: (event: Events$Events$PartialKeybindingMatch) => void
  ): Disposable;
  ...
  onDidFailToMatchBinding(
    callback: (event: Events$Events$FailedKeybindingMatch) => void
  ): Disposable;
   ...
   */
  onDidReloadKeymap(
    callback: (event: Events$Events$KeymapLoaded) => void
  ): Disposable;
   ...
   */
  onDidFailToReadFile(
    callback: (error: Events$Events$FailedKeymapFileRead) => void
  ): Disposable;
  ...
  addKeystrokeResolver(
    resolver: (event: Events$Events$AddedKeystrokeResolver) => string
  ): Disposable;
