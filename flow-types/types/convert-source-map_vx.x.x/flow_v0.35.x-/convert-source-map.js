 ...
 */
declare export function fromMapFileComment(comment: string, commentFileDir: string): SourceMapConverter

	
/**
 * Finds last sourcemap comment in file and returns source map converter or returns null if no source map comment was found.
 */
declare export function fromSource(content: string): SourceMapConverter | null
 ...
 */
declare export function fromMapFileSource(content: string, commentFileDir: string): SourceMapConverter | null
 ...
 * When options.multiline == true, the comment is formatted like: /*# sourceMappingURL=... *\/, which you would find in a CSS source file.
 */
declare export function generateMapFileComment(file: string, options?: {
multiline?: boolean
}): string
