...
onoverlayremove(event: Leaflet.LayersControlEvent): void
	...
	declare export type LeafletEvents = MapEvents & MarkerEvents & TileLayerEvents & PathEvents & FeatureGroupEvents & LayersControlEvents;
	declare export class MapComponent<P, E: Leaflet.Class> mixins React.Component<P> {
...
useFlyTo?: boolean,
zoom?: number
} & MapEvents & Leaflet.MapOptions & Leaflet.LocateOptions & Leaflet.FitBoundsOptions

	declare export class Map<P: MapProps, E: Leaflet.Map> mixins MapComponent<P, E> {
className: string;
...
prev: Leaflet.LatLngBoundsExpression): boolean
}
...
name?: string
	...
	declare export class Pane<P: PaneProps, S: PaneState> mixins React.Component<P, S> {
getChildContext(): {
pane: string
};
...
removeLayer(layer: number | Leaflet.Layer): this
	...
	declare export class MapLayer<P: MapLayerProps, E: Leaflet.Class> mixins MapComponent<P, E> {
createLeafletElement(props: P): E;
updateLeafletElement(fromProps: P, toProps: P): void;
...
children?: Children
	...
	declare export class GridLayer<P: GridLayerProps, E: Leaflet.GridLayer> mixins MapLayer<P, E> {}
	declare export type TileLayerProps = {
children?: Children,
url: string
} & TileLayerEvents & Leaflet.TileLayerOptions

	declare export class TileLayer<P: TileLayerProps, E: Leaflet.TileLayer> mixins GridLayer<P, E> {}
	declare export type WMSTileLayerProps = {
children?: Children,
url: string
} & TileLayerEvents & Leaflet.WMSOptions

	declare export class WMSTileLayer<P: WMSTileLayerProps, E: Leaflet.TileLayer.WMS> mixins GridLayer<P, E> {}
...
url: string
	...
	declare export class ImageOverlay<P: ImageOverlayProps, E: Leaflet.ImageOverlay> mixins MapLayer<P, E> {
getChildContext(): {
popupContainer: E
}
}
...
children?: Children
	...
	declare export class LayerGroup<P: LayerGroupProps, E: Leaflet.LayerGroup> mixins MapLayer<P, E> {
getChildContext(): {
layerContainer: E
}
}
...
} & MarkerEvents & Leaflet.MarkerOptions

	declare export class Marker<P: MarkerProps, E: Leaflet.Marker> mixins MapLayer<P, E> {
getChildContext(): {
popupContainer: E
}
}
	declare export type PathProps = {} & PathEvents & Leaflet.PathOptions & MapLayerProps
...
children?: Children,
radius: number
} & PathEvents & Leaflet.CircleMarkerOptions

	declare export class Circle<P: CircleProps, E: Leaflet.Circle> mixins Path<P, E> {}
...
radius: number
	...
	declare export class CircleMarker<P: CircleMarkerProps, E: Leaflet.CircleMarker> mixins Path<P, E> {}
	declare export type FeatureGroupProps = {
children?: Children
} & FeatureGroupEvents & Leaflet.PathOptions

	declare export class FeatureGroup<P: FeatureGroupProps, E: Leaflet.FeatureGroup> mixins Path<P, E> {
getChildContext(): {
layerContainer: E,
popupContainer: E
}
...
} & FeatureGroupEvents & Leaflet.GeoJSONOptions

	declare export class GeoJSON<P: GeoJSONProps, E: Leaflet.GeoJSON> mixins Path<P, E> {}
	declare export type PolylineProps = {
children?: Children,
positions: Leaflet.LatLngExpression[] | Leaflet.LatLngExpression[][]
} & PathEvents & Leaflet.PolylineOptions

	declare export class Polyline<P: PolylineProps, E: Leaflet.Polyline> mixins Path<P, E> {}
...
positions: Leaflet.LatLngExpression[] | Leaflet.LatLngExpression[][] | Leaflet.LatLngExpression[][][]
	...
	declare export class Polygon<P: PolygonProps, E: Leaflet.Polygon> mixins Path<P, E> {}
...
popupContainer?: Leaflet.FeatureGroup
	...
	declare export class Rectangle<P: RectangleProps, E: Leaflet.Rectangle> mixins Path<P, E> {}
	declare export type PopupProps = {
children?: Children,
position?: Leaflet.LatLngExpression
} & Leaflet.PopupOptions

	declare export class Popup<P: PopupProps, E: Leaflet.Popup> mixins MapComponent<P, E> {
onPopupOpen(arg: {
popup: E
}): void;
onPopupClose(arg: {
...
children?: Children
	...
	declare export class Tooltip<P: TooltipProps, E: Leaflet.Tooltip> mixins MapComponent<P, E> {
onTooltipOpen(arg: {
tooltip: E
}): void;
onTooltipClose(arg: {
...
removeTooltipContent(): void
	...
	declare export class MapControl<P: MapControlProps, E: Leaflet.Control> mixins React.Component<P> {
leafletElement: E;
createLeafletElement(props: P): E;
updateLeafletElement(fromProps: P, toProps: P): void
}
	declare export type AttributionControlProps = Leaflet.Control.AttributionOptions;
	declare export class AttributionControl<P: AttributionControlProps, E: Leaflet.Control.Attribution> mixins MapControl<P, E> {}
	declare export type LayersControlProps = {
baseLayers?: Leaflet.Control.LayersObject,
children?: Children,
overlays?: Leaflet.Control.LayersObject
} & LayersControlEvents & undefined.LayersOptions

	declare export class LayersControl<P: LayersControlProps, E: Leaflet.Control.Layers> mixins MapControl<P, E> {}
...
declare class LayersControl$ControlledLayer<P: LayersControl$BaseControlledLayerProps> mixins React.Component<P> {
layer: Leaflet.Layer;
getChildContext(): {
...
declare class LayersControl$BaseLayer<P: LayersControl$ControlledLayerProps> mixins LayersControl$ControlledLayer<P> {}

declare class LayersControl$Overlay<P: LayersControl$ControlledLayerProps> mixins LayersControl$ControlledLayer<P> {}
	declare export type ScaleControlProps = Leaflet.Control.ScaleOptions;
	declare export class ScaleControl<P: ScaleControlProps, E: Leaflet.Control.Scale> mixins MapControl<P, E> {}
	declare export type ZoomControlProps = Leaflet.Control.ZoomOptions;
	declare export class ZoomControl<P: ZoomControlProps, E: Leaflet.Control.Zoom> mixins MapControl<P, E> {}
    }
