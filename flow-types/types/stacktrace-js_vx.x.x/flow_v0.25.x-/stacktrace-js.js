...
export interface StackTrace$RequestOptions {
  headers: {
    [id: string]: string
  };
}
 ...
 */
declare export function StackTrace$get(
  options?: StackTrace$StackTraceOptions
 ...
 * @return Array[StackFrame]
 */
declare export function StackTrace$getSync(
  options?: StackTrace$StackTraceOptions
): StackTrace$StackFrame[];
 ...
 */
declare export function StackTrace$generateArtificially(
  options?: StackTrace$StackTraceOptions
): Promise<StackTrace$StackFrame[]>;
 ...
 */
declare export function StackTrace$deinstrument<TFunc: Function>(
  fn: TFunc
): TFunc;
...
declare export function StackTrace$report(
  ...
  url: string,
  message?: string,
  requestOptions?: StackTrace$RequestOptions
): Promise<string>;
declare module "stacktrace-js" {
  declare export default typeof StackTrace;
}
