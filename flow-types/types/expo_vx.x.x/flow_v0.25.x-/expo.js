...
declare function Haptic$notification(
  notificationType?: Haptic$NotificationType
): void;
...
declare class Haptic$ImpactStyles {
  ...
  static +Light: Class<Haptic$ImpactStyles__Light> &
    Haptic$ImpactStyles__Light &
    "light"; // "light"
  static +Medium: Class<Haptic$ImpactStyles__Medium> &
    Haptic$ImpactStyles__Medium &
    "medium"; // "medium"
  static +Heavy: Class<Haptic$ImpactStyles__Heavy> &
    Haptic$ImpactStyles__Heavy &
    "heavy"; // "heavy"
}
...
declare class Haptic$NotificationType {
  constructor(...args: empty): mixed;
  static +Success: Class<Haptic$NotificationType__Success> &
    Haptic$NotificationType__Success &
    "success"; // "success"
  static +Warning: Class<Haptic$NotificationType__Warning> &
    Haptic$NotificationType__Warning &
    "warning"; // "warning"
  static +Error: Class<Haptic$NotificationType__Error> &
    Haptic$NotificationType__Error &
    "error"; // "error"
}
...
declare class MediaLibrary$MediaType {
  constructor(...args: empty): mixed;
  static +audio: Class<MediaLibrary$MediaType__audio> &
    MediaLibrary$MediaType__audio &
    "audio"; // "audio"
  static +photo: Class<MediaLibrary$MediaType__photo> &
    MediaLibrary$MediaType__photo &
    "photo"; // "photo"
  static +video: Class<MediaLibrary$MediaType__video> &
    MediaLibrary$MediaType__video &
    "video"; // "video"
  static +unknow: Class<MediaLibrary$MediaType__unknow> &
    MediaLibrary$MediaType__unknow &
    "unknow"; // "unknow"
}
...
declare class MediaLibrary$SortBy {
  constructor(...args: empty): mixed;
  static +default: Class<MediaLibrary$SortBy__default> &
    MediaLibrary$SortBy__default &
    "default"; // "default"
  static +id: Class<MediaLibrary$SortBy__id> & MediaLibrary$SortBy__id & "id"; // "id"
  static +creationTime: Class<MediaLibrary$SortBy__creationTime> &
    MediaLibrary$SortBy__creationTime &
    "creationTime"; // "creationTime"
  static +modificationTime: Class<MediaLibrary$SortBy__modificationTime> &
    MediaLibrary$SortBy__modificationTime &
    "modificationTime"; // "modificationTime"
  static +mediaType: Class<MediaLibrary$SortBy__mediaType> &
    MediaLibrary$SortBy__mediaType &
    "mediaType"; // "mediaType"
  static +width: Class<MediaLibrary$SortBy__width> &
    MediaLibrary$SortBy__width &
    "width"; // "width"
  static +height: Class<MediaLibrary$SortBy__height> &
    MediaLibrary$SortBy__height &
    "height"; // "height"
  static +duration: Class<MediaLibrary$SortBy__duration> &
    MediaLibrary$SortBy__duration &
    "duration"; // "duration"
}
...
declare class MediaLibrary$SortBy__modificationTime
  mixins MediaLibrary$SortBy {}
...
declare type MediaLibrary$Asset = {
  ...
  duration: number,
  localUri?: string,
  location?: LocationLocation$LocationProps,
  exif?: { [key: string]: any }
} & MediaLibrary$AssetAndroid &
  MediaLibrary$AssetIos;
...
declare interface MediaLibrary$AlbumIos {
  ...
  startTime: number;
  endTime: number;
  approximateLocation?: LocationLocation$LocationProps;
 ...
 */
declare type EventType$Error = "error";
...
declare interface Updates$UpdateCheck {
   ...
   */
  manifest?: ConstantsConstants$Manifest;
}
...
declare interface Updates$UpdateEvent {
   ...
   */
  type:
    | EventTypeEventType$DownloadStart
    | EventTypeEventType$DownloadProgress
    | EventTypeEventType$DownloadFinished
    | EventTypeEventType$NoUpdateAvailable
    | EventTypeEventType$Error;
...
declare class Calendar$EntityTypes {
  constructor(...args: empty): mixed;
  static +EVENT: Class<Calendar$EntityTypes__EVENT> &
    Calendar$EntityTypes__EVENT &
    "event"; // "event"
  static +REMINDER: Class<Calendar$EntityTypes__REMINDER> &
    Calendar$EntityTypes__REMINDER &
    "reminder"; // "reminder"
}
...
declare class Calendar$CalendarType {
  constructor(...args: empty): mixed;
  static +LOCAL: Class<Calendar$CalendarType__LOCAL> &
    Calendar$CalendarType__LOCAL &
    "local"; // "local"
  static +CALDAV: Class<Calendar$CalendarType__CALDAV> &
    Calendar$CalendarType__CALDAV &
    "caldav"; // "caldav"
  static +EXCHANGE: Class<Calendar$CalendarType__EXCHANGE> &
    Calendar$CalendarType__EXCHANGE &
    "exchange"; // "exchange"
  static +SUBSCRIBED: Class<Calendar$CalendarType__SUBSCRIBED> &
    Calendar$CalendarType__SUBSCRIBED &
    "subscribed"; // "subscribed"
  static +BIRTHDAYS: Class<Calendar$CalendarType__BIRTHDAYS> &
    Calendar$CalendarType__BIRTHDAYS &
    "birthdays"; // "birthdays"
}
...
declare class Calendar$Availability {
  constructor(...args: empty): mixed;
  static +NOT_SUPPORTED: Class<Calendar$Availability__NOT_SUPPORTED> &
    Calendar$Availability__NOT_SUPPORTED &
    "notSupported"; // "notSupported"
  static +BUSY: Class<Calendar$Availability__BUSY> &
    Calendar$Availability__BUSY &
    "busy"; // "busy"
  static +FREE: Class<Calendar$Availability__FREE> &
    Calendar$Availability__FREE &
    "free"; // "free"
  static +TENTATIVE: Class<Calendar$Availability__TENTATIVE> &
    Calendar$Availability__TENTATIVE &
    "tentative"; // "tentative"
  static +UNAVAILABLE: Class<Calendar$Availability__UNAVAILABLE> &
    Calendar$Availability__UNAVAILABLE &
    "unavailable"; // "unavailable"
}

declare class Calendar$Availability__NOT_SUPPORTED
  mixins Calendar$Availability {}
...
declare class Calendar$AlarmMethod {
  constructor(...args: empty): mixed;
  static +ALARM: Class<Calendar$AlarmMethod__ALARM> &
    Calendar$AlarmMethod__ALARM &
    "alarm"; // "alarm"
  static +ALERT: Class<Calendar$AlarmMethod__ALERT> &
    Calendar$AlarmMethod__ALERT &
    "alert"; // "alert"
  static +EMAIL: Class<Calendar$AlarmMethod__EMAIL> &
    Calendar$AlarmMethod__EMAIL &
    "email"; // "email"
  static +SMS: Class<Calendar$AlarmMethod__SMS> &
    Calendar$AlarmMethod__SMS &
    "sms"; // "sms"
  static +DEFAULT: Class<Calendar$AlarmMethod__DEFAULT> &
    Calendar$AlarmMethod__DEFAULT &
    "default"; // "default"
}
...
declare class Calendar$AttendeeType {
  constructor(...args: empty): mixed;
  static +UNKNOWN: Class<Calendar$AttendeeType__UNKNOWN> &
    Calendar$AttendeeType__UNKNOWN &
    "unknown"; // "unknown"
  static +PERSON: Class<Calendar$AttendeeType__PERSON> &
    Calendar$AttendeeType__PERSON &
    "person"; // "person"
  static +ROOM: Class<Calendar$AttendeeType__ROOM> &
    Calendar$AttendeeType__ROOM &
    "room"; // "room"
  static +GROUP: Class<Calendar$AttendeeType__GROUP> &
    Calendar$AttendeeType__GROUP &
    "group"; // "group"
  static +RESOURCE: Class<Calendar$AttendeeType__RESOURCE> &
    Calendar$AttendeeType__RESOURCE &
    "resource"; // "resource"
  static +OPTIONAL: Class<Calendar$AttendeeType__OPTIONAL> &
    Calendar$AttendeeType__OPTIONAL &
    "optional"; // "optional"
  static +REQUIRED: Class<Calendar$AttendeeType__REQUIRED> &
    Calendar$AttendeeType__REQUIRED &
    "required"; // "required"
  static +NONE: Class<Calendar$AttendeeType__NONE> &
    Calendar$AttendeeType__NONE &
    "none"; // "none"
}
...
declare class Calendar$CalendarAccessLevel {
  constructor(...args: empty): mixed;
  static +CONTRIBUTOR: Class<Calendar$CalendarAccessLevel__CONTRIBUTOR> &
    Calendar$CalendarAccessLevel__CONTRIBUTOR &
    "contributor"; // "contributor"
  static +EDITOR: Class<Calendar$CalendarAccessLevel__EDITOR> &
    Calendar$CalendarAccessLevel__EDITOR &
    "editor"; // "editor"
  static +FREEBUSY: Class<Calendar$CalendarAccessLevel__FREEBUSY> &
    Calendar$CalendarAccessLevel__FREEBUSY &
    "freebusy"; // "freebusy"
  static +OVERRIDE: Class<Calendar$CalendarAccessLevel__OVERRIDE> &
    Calendar$CalendarAccessLevel__OVERRIDE &
    "override"; // "override"
  static +OWNER: Class<Calendar$CalendarAccessLevel__OWNER> &
    Calendar$CalendarAccessLevel__OWNER &
    "owner"; // "owner"
  static +READ: Class<Calendar$CalendarAccessLevel__READ> &
    Calendar$CalendarAccessLevel__READ &
    "read"; // "read"
  static +RESPOND: Class<Calendar$CalendarAccessLevel__RESPOND> &
    Calendar$CalendarAccessLevel__RESPOND &
    "respond"; // "respond"
  static +ROOT: Class<Calendar$CalendarAccessLevel__ROOT> &
    Calendar$CalendarAccessLevel__ROOT &
    "root"; // "root"
  static +NONE: Class<Calendar$CalendarAccessLevel__NONE> &
    Calendar$CalendarAccessLevel__NONE &
    "none"; // "none"
}

declare class Calendar$CalendarAccessLevel__CONTRIBUTOR
  mixins Calendar$CalendarAccessLevel {}
declare class Calendar$CalendarAccessLevel__EDITOR
  mixins Calendar$CalendarAccessLevel {}
declare class Calendar$CalendarAccessLevel__FREEBUSY
  mixins Calendar$CalendarAccessLevel {}
declare class Calendar$CalendarAccessLevel__OVERRIDE
  mixins Calendar$CalendarAccessLevel {}
declare class Calendar$CalendarAccessLevel__OWNER
  mixins Calendar$CalendarAccessLevel {}
declare class Calendar$CalendarAccessLevel__READ
  mixins Calendar$CalendarAccessLevel {}
declare class Calendar$CalendarAccessLevel__RESPOND
  mixins Calendar$CalendarAccessLevel {}
declare class Calendar$CalendarAccessLevel__ROOT
  mixins Calendar$CalendarAccessLevel {}
declare class Calendar$CalendarAccessLevel__NONE
  mixins Calendar$CalendarAccessLevel {}

declare class Calendar$EventAccessLevel {
  constructor(...args: empty): mixed;
  static +CONFIDENTIAL: Class<Calendar$EventAccessLevel__CONFIDENTIAL> &
    Calendar$EventAccessLevel__CONFIDENTIAL &
    "confidential"; // "confidential"
  static +PRIVATE: Class<Calendar$EventAccessLevel__PRIVATE> &
    Calendar$EventAccessLevel__PRIVATE &
    "private"; // "private"
  static +PUBLIC: Class<Calendar$EventAccessLevel__PUBLIC> &
    Calendar$EventAccessLevel__PUBLIC &
    "public"; // "public"
  static +DEFAULT: Class<Calendar$EventAccessLevel__DEFAULT> &
    Calendar$EventAccessLevel__DEFAULT &
    "default"; // "default"
}

declare class Calendar$EventAccessLevel__CONFIDENTIAL
  mixins Calendar$EventAccessLevel {}
declare class Calendar$EventAccessLevel__PRIVATE
  mixins Calendar$EventAccessLevel {}
declare class Calendar$EventAccessLevel__PUBLIC
  mixins Calendar$EventAccessLevel {}
declare class Calendar$EventAccessLevel__DEFAULT
  mixins Calendar$EventAccessLevel {}

declare class Calendar$EventStatus {
  constructor(...args: empty): mixed;
  static +NONE: Class<Calendar$EventStatus__NONE> &
    Calendar$EventStatus__NONE &
    "none"; // "none"
  static +CONFIRMED: Class<Calendar$EventStatus__CONFIRMED> &
    Calendar$EventStatus__CONFIRMED &
    "confirmed"; // "confirmed"
  static +TENTATIVE: Class<Calendar$EventStatus__TENTATIVE> &
    Calendar$EventStatus__TENTATIVE &
    "tentative"; // "tentative"
  static +CANCELED: Class<Calendar$EventStatus__CANCELED> &
    Calendar$EventStatus__CANCELED &
    "canceled"; // "canceled"
}
...
declare class Calendar$AttendeeRole {
  constructor(...args: empty): mixed;
  static +UNKNOWN: Class<Calendar$AttendeeRole__UNKNOWN> &
    Calendar$AttendeeRole__UNKNOWN &
    "unknown"; // "unknown"
  static +REQUIRED: Class<Calendar$AttendeeRole__REQUIRED> &
    Calendar$AttendeeRole__REQUIRED &
    "required"; // "required"
  static +OPTIONAL: Class<Calendar$AttendeeRole__OPTIONAL> &
    Calendar$AttendeeRole__OPTIONAL &
    "optional"; // "optional"
  static +CHAIR: Class<Calendar$AttendeeRole__CHAIR> &
    Calendar$AttendeeRole__CHAIR &
    "chair"; // "chair"
  static +NON_PARTICIPANT: Class<Calendar$AttendeeRole__NON_PARTICIPANT> &
    Calendar$AttendeeRole__NON_PARTICIPANT &
    "nonParticipant"; // "nonParticipant"
  static +ATTENDEE: Class<Calendar$AttendeeRole__ATTENDEE> &
    Calendar$AttendeeRole__ATTENDEE &
    "attendee"; // "attendee"
  static +ORGANIZER: Class<Calendar$AttendeeRole__ORGANIZER> &
    Calendar$AttendeeRole__ORGANIZER &
    "organizer"; // "organizer"
  static +PERFORMER: Class<Calendar$AttendeeRole__PERFORMER> &
    Calendar$AttendeeRole__PERFORMER &
    "performer"; // "performer"
  static +SPEAKER: Class<Calendar$AttendeeRole__SPEAKER> &
    Calendar$AttendeeRole__SPEAKER &
    "speaker"; // "speaker"
  static +NONE: Class<Calendar$AttendeeRole__NONE> &
    Calendar$AttendeeRole__NONE &
    "none"; // "none"
}
...
declare class Calendar$AttendeeRole__NON_PARTICIPANT
  mixins Calendar$AttendeeRole {}
...
declare class Calendar$AttendeeStatus {
  constructor(...args: empty): mixed;
  static +UNKNOWN: Class<Calendar$AttendeeStatus__UNKNOWN> &
    Calendar$AttendeeStatus__UNKNOWN &
    "unknown"; // "unknown"
  static +PENDING: Class<Calendar$AttendeeStatus__PENDING> &
    Calendar$AttendeeStatus__PENDING &
    "pending"; // "pending"
  static +ACCEPTED: Class<Calendar$AttendeeStatus__ACCEPTED> &
    Calendar$AttendeeStatus__ACCEPTED &
    "accepted"; // "accepted"
  static +DECLINED: Class<Calendar$AttendeeStatus__DECLINED> &
    Calendar$AttendeeStatus__DECLINED &
    "declined"; // "declined"
  static +TENTATIVE: Class<Calendar$AttendeeStatus__TENTATIVE> &
    Calendar$AttendeeStatus__TENTATIVE &
    "tentative"; // "tentative"
  static +DELEGATED: Class<Calendar$AttendeeStatus__DELEGATED> &
    Calendar$AttendeeStatus__DELEGATED &
    "delegated"; // "delegated"
  static +COMPLETED: Class<Calendar$AttendeeStatus__COMPLETED> &
    Calendar$AttendeeStatus__COMPLETED &
    "completed"; // "completed"
  static +IN_PROCESS: Class<Calendar$AttendeeStatus__IN_PROCESS> &
    Calendar$AttendeeStatus__IN_PROCESS &
    "inProcess"; // "inProcess"
  static +INVITED: Class<Calendar$AttendeeStatus__INVITED> &
    Calendar$AttendeeStatus__INVITED &
    "invited"; // "invited"
  static +NONE: Class<Calendar$AttendeeStatus__NONE> &
    Calendar$AttendeeStatus__NONE &
    "none"; // "none"
}
...
declare class Calendar$AttendeeStatus__ACCEPTED
  mixins Calendar$AttendeeStatus {}
declare class Calendar$AttendeeStatus__DECLINED
  mixins Calendar$AttendeeStatus {}
declare class Calendar$AttendeeStatus__TENTATIVE
  mixins Calendar$AttendeeStatus {}
declare class Calendar$AttendeeStatus__DELEGATED
  mixins Calendar$AttendeeStatus {}
declare class Calendar$AttendeeStatus__COMPLETED
  mixins Calendar$AttendeeStatus {}
declare class Calendar$AttendeeStatus__IN_PROCESS
  mixins Calendar$AttendeeStatus {}
...
declare class Calendar$Frequency {
  constructor(...args: empty): mixed;
  static +DAILY: Class<Calendar$Frequency__DAILY> &
    Calendar$Frequency__DAILY &
    "daily"; // "daily"
  static +WEEKLY: Class<Calendar$Frequency__WEEKLY> &
    Calendar$Frequency__WEEKLY &
    "weekly"; // "weekly"
  static +MONTHLY: Class<Calendar$Frequency__MONTHLY> &
    Calendar$Frequency__MONTHLY &
    "monthly"; // "monthly"
  static +YEARLY: Class<Calendar$Frequency__YEARLY> &
    Calendar$Frequency__YEARLY &
    "yearly"; // "yearly"
}
...
declare class Calendar$ReminderStatus {
  constructor(...args: empty): mixed;
  static +COMPLETED: Class<Calendar$ReminderStatus__COMPLETED> &
    Calendar$ReminderStatus__COMPLETED &
    "completed"; // "completed"
  static +INCOMPLETE: Class<Calendar$ReminderStatus__INCOMPLETE> &
    Calendar$ReminderStatus__INCOMPLETE &
    "incomplete"; // "incomplete"
}

declare class Calendar$ReminderStatus__COMPLETED
  mixins Calendar$ReminderStatus {}
declare class Calendar$ReminderStatus__INCOMPLETE
  mixins Calendar$ReminderStatus {}
...
declare interface Speech$SpeechOptions {
  ...
  onStopped?: () => void;
  onDone?: () => void;
  onError?: (error: SQLite$Error) => void;
}
...
declare function Notifications$addListener(
  listener: (Haptic$notification: Notifications$Notification) => any
): EventSubscription;
...
declare type AdSettings$SDKLogLevel =
  | "none"
  | "debug"
  | "verbose"
  | "warning"
...
declare function InterstitialAdManager$showAd(
  placementId: string
): Promise<boolean>;
...
declare type FacebookAds$AdTriggerViewProps<P> = {
  renderInteractiveComponent?: (props: P) => ReactReactElement<P>
} & P;
...
declare type Contacts$Field =
  | FieldsFields$ID
  | FieldsFields$Name
  | FieldsFields$FirstName
  | FieldsFields$MiddleName
  | FieldsFields$LastName
  | FieldsFields$NamePrefix
  | FieldsFields$NameSuffix
  | FieldsFields$PhoneticFirstName
  | FieldsFields$PhoneticMiddleName
  | FieldsFields$PhoneticLastName
  | FieldsFields$Birthday
  | FieldsFields$Emails
  | FieldsFields$PhoneNumbers
  | FieldsFields$Addresses
  | FieldsFields$InstantMessageAddresses
  | FieldsFields$UrlAddresses
  | FieldsFields$Company
  | FieldsFields$JobTitle
  | FieldsFields$Department
  | FieldsFields$ImageAvailable
  | FieldsFields$Image
  | FieldsFields$Note
  | FieldsFields$Dates
  | FieldsFields$Relationships
  | FieldsFields$Nickname
  | FieldsFields$RawImage
  | FieldsFields$MaidenName
  | FieldsFields$ContactType
  | FieldsFields$SocialProfiles
  | FieldsFields$NonGregorianBirthday;

declare type Contacts$FormType =
  | FormTypesFormTypes$New
  | FormTypesFormTypes$Unknown
  | FormTypesFormTypes$Default;

declare type Contacts$ContactType =
  | ContactTypesContactTypes$Person
  | ContactTypesFields$Company;

declare type Contacts$SortType =
  | SortTypesFields$FirstName
  | SortTypesFields$LastName
  | SortTypesSortTypes$UserDefault;

declare type Contacts$ContainerType =
  | ContainerTypesContainerTypes$Local
  | ContainerTypesContainerTypes$Exchange
  | ContainerTypesContainerTypes$CardDAV
  | ContainerTypesContainerTypes$Unassigned;

declare type Contacts$CalendarFormat =
  | CalendarFormatsCalendarFormats$Gregorian
  | CalendarFormatsCalendarFormats$Chinese
  | CalendarFormatsCalendarFormats$Hebrew
  | CalendarFormatsCalendarFormats$Islamic;
...
declare class Audio$InterruptionModeIos {
  constructor(...args: empty): mixed;
  static +INTERRUPTION_MODE_IOS_MIX_WITH_OTHERS: Class<Audio$InterruptionModeIos__INTERRUPTION_MODE_IOS_MIX_WITH_OTHERS> &
    Audio$InterruptionModeIos__INTERRUPTION_MODE_IOS_MIX_WITH_OTHERS &
    0; // 0
  static +INTERRUPTION_MODE_IOS_DO_NOT_MIX: Class<Audio$InterruptionModeIos__INTERRUPTION_MODE_IOS_DO_NOT_MIX> &
    Audio$InterruptionModeIos__INTERRUPTION_MODE_IOS_DO_NOT_MIX &
    1; // 1
  static +INTERRUPTION_MODE_IOS_DUCK_OTHERS: Class<Audio$InterruptionModeIos__INTERRUPTION_MODE_IOS_DUCK_OTHERS> &
    Audio$InterruptionModeIos__INTERRUPTION_MODE_IOS_DUCK_OTHERS &
    2; // 2
}

declare class Audio$InterruptionModeIos__INTERRUPTION_MODE_IOS_MIX_WITH_OTHERS
  mixins Audio$InterruptionModeIos {}
declare class Audio$InterruptionModeIos__INTERRUPTION_MODE_IOS_DO_NOT_MIX
  mixins Audio$InterruptionModeIos {}
declare class Audio$InterruptionModeIos__INTERRUPTION_MODE_IOS_DUCK_OTHERS
  mixins Audio$InterruptionModeIos {}
...
declare class Audio$InterruptionModeAndroid {
  constructor(...args: empty): mixed;
  static +INTERRUPTION_MODE_ANDROID_DO_NOT_MIX: Class<Audio$InterruptionModeAndroid__INTERRUPTION_MODE_ANDROID_DO_NOT_MIX> &
    Audio$InterruptionModeAndroid__INTERRUPTION_MODE_ANDROID_DO_NOT_MIX &
    1; // 1
  static +INTERRUPTION_MODE_ANDROID_DUCK_OTHERS: Class<Audio$InterruptionModeAndroid__INTERRUPTION_MODE_ANDROID_DUCK_OTHERS> &
    Audio$InterruptionModeAndroid__INTERRUPTION_MODE_ANDROID_DUCK_OTHERS &
    2; // 2
}

declare class Audio$InterruptionModeAndroid__INTERRUPTION_MODE_ANDROID_DO_NOT_MIX
  mixins Audio$InterruptionModeAndroid {}
declare class Audio$InterruptionModeAndroid__INTERRUPTION_MODE_ANDROID_DUCK_OTHERS
  mixins Audio$InterruptionModeAndroid {}
...
declare module "expo" {
  ...
  declare export class Camera mixins Component<CameraProps> {
    static FaceDetector$Constants: CameraConstants;
  }
  ...
  declare export function takeSnapshotAsync(
    node: number | ReactReactElement<any> | ReactRefObject<any>,
    options?: {
      width?: number,
      height?: number,
  ...
  declare export class FullscreenUpdateVariants {
    constructor(...args: empty): mixed;
    static +IOS_FULLSCREEN_UPDATE_PLAYER_WILL_PRESENT: Class<FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_WILL_PRESENT> &
      FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_WILL_PRESENT &
      0; // 0
    static +IOS_FULLSCREEN_UPDATE_PLAYER_DID_PRESENT: Class<FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_DID_PRESENT> &
      FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_DID_PRESENT &
      1; // 1
    static +IOS_FULLSCREEN_UPDATE_PLAYER_WILL_DISMISS: Class<FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_WILL_DISMISS> &
      FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_WILL_DISMISS &
      2; // 2
    static +IOS_FULLSCREEN_UPDATE_PLAYER_DID_DISMISS: Class<FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_DID_DISMISS> &
      FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_DID_DISMISS &
      3; // 3
  }

  declare class FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_WILL_PRESENT
    mixins FullscreenUpdateVariants {}
  declare class FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_DID_PRESENT
    mixins FullscreenUpdateVariants {}
  declare class FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_WILL_DISMISS
    mixins FullscreenUpdateVariants {}
  declare class FullscreenUpdateVariants__IOS_FULLSCREEN_UPDATE_PLAYER_DID_DISMISS
    mixins FullscreenUpdateVariants {}
  ...
  declare export class Video mixins Component<VideoProps, VideoState> {
    ...
    static IOS_FULLSCREEN_UPDATE_PLAYER_WILL_PRESENT: FullscreenUpdateVariantsIOS_FULLSCREEN_UPDATE_PLAYER_WILL_PRESENT;
    static IOS_FULLSCREEN_UPDATE_PLAYER_DID_PRESENT: FullscreenUpdateVariantsIOS_FULLSCREEN_UPDATE_PLAYER_DID_PRESENT;
    static IOS_FULLSCREEN_UPDATE_PLAYER_WILL_DISMISS: FullscreenUpdateVariantsIOS_FULLSCREEN_UPDATE_PLAYER_WILL_DISMISS;
    static IOS_FULLSCREEN_UPDATE_PLAYER_DID_DISMISS: FullscreenUpdateVariantsIOS_FULLSCREEN_UPDATE_PLAYER_DID_DISMISS;
  }
}
