declare module 'expo' {
	...
	import type {
          Component,ComponentClass,ComponentType,Ref
        } from 'react';

	import type {
          ImageRequireSource,ImageURISource,ReactNativeLinkingStatic,StyleProp,ViewProps,ViewStyle
        } from 'react-native';

	declare export type Axis = number;
	declare export type BarCodeScannedCallback = (params: {
type: string,
data: string
}) => void;
...
declare function FacebookAds$withNativeAd(
component: Component<{
icon?: string,
coverImage?: string,
title?: string,
...
declare function FileSystem$readAsStringAsync(fileUri: string): Promise<string>


declare function FileSystem$writeAsStringAsync(fileUri: string, contents: string): Promise<void>
...
declare function Gyroscope$setUpdateInterval(intervalMs: number): void
      ...
      declare var npm$namespace$ImageManipulator: {
        manipulate: typeof ImageManipulator$manipulate,
...
declare function ImageManipulator$manipulate(
uri: string,
...
declare interface Notifications$SchedulingOptions {
time: Date | number,
repeat?: "minute"
| "hour"
| "day"
...
declare interface Notifications$ChannelAndroid {
name: string,
description?: string,
sound?: boolean,
priority?: "min"
...
localNotification: Notifications$LocalNotification): Promise<Notifications$LocalNotificationId>


declare function Notifications$scheduleLocalNotificationAsync(
localNotification: Notifications$LocalNotification,
schedulingOptions: Notifications$SchedulingOptions): Promise<Notifications$LocalNotificationId>


declare function Notifications$dismissNotificationAsync(localNotificationId: Notifications$LocalNotificationId): Promise<void>


declare function Notifications$dismissAllNotificationsAsync(): Promise<void>


declare function Notifications$cancelScheduledNotificationAsync(localNotificationId: Notifications$LocalNotificationId): Promise<void>


declare function Notifications$cancelAllScheduledNotificationsAsync(): Promise<void>


declare function Notifications$createChannelAndroidAsync(id: string, channel: Notifications$ChannelAndroid): Promise<void>
