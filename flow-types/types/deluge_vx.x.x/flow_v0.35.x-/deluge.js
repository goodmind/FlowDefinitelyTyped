declare module 'deluge' {
	...
	declare function deluge(deluge_url: string, password: string): deluge$deluge$Deluge
...
callback: (error: string, result: boolean, response: http.ServerResponse) => void): void,
 ...
 */
getHosts(
callback: (error: string, result: deluge$Host[], response: http.ServerResponse) => void): void,
...
response: http.ServerResponse) => void): void,
