...
export interface Babelify$BabelifyConstructor {
  (
    filename: string,
    opts: Babelify$Babelify$BabelifyOptions
  ): Babelify$Babelify$BabelifyObject;
}
 ...
 */
export type Babelify$BabelifyOptions = {
  /**
...
declare export function Babelify$configure(
  opts: Babelify$Babelify$BabelifyOptions
): (filename: string) => Babelify$Babelify$BabelifyObject;
