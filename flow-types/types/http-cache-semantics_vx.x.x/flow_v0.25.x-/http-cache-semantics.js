declare module "http-cache-semantics" {
  ...
  declare class CachePolicy {
    constructor(
      req: CachePolicy$CachePolicy$Request,
      res: CachePolicy$CachePolicy$Response,
      options?: CachePolicy$CachePolicy$Options
    ): this;
    ...
    satisfiesWithoutRevalidation(
      newRequest: CachePolicy$CachePolicy$Request
    ): boolean;
     ...
     */
    static fromObject(
      obj: CachePolicy$CachePolicy$CachePolicyObject
    ): CachePolicy;
    ...
    revalidationHeaders(
      newRequest: CachePolicy$CachePolicy$Request
    ): CachePolicy$CachePolicy$Headers;
    ...
    revalidatedPolicy(
      ...
      revalidationResponse: CachePolicy$CachePolicy$Response
    ): CachePolicy$CachePolicy$RevalidationPolicy;
  }
