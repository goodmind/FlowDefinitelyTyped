declare module 'http-cache-semantics' {
        declare module.exports: typeof CachePolicy

	declare class CachePolicy  {
constructor(req: CachePolicy$CachePolicy$Request, res: CachePolicy$CachePolicy$Response, options?: CachePolicy$CachePolicy$Options): this;
 ...
 */
satisfiesWithoutRevalidation(newRequest: CachePolicy$CachePolicy$Request): boolean;
 ...
 * @example cachedResponse.headers = cachePolicy.responseHeaders(cachedResponse);
 */
responseHeaders(): CachePolicy$CachePolicy$Headers;
 ...
 */
toObject(): CachePolicy$CachePolicy$CachePolicyObject;

/**
 * `policy = CachePolicy.fromObject(obj)` creates an instance from object created by `toObject()`.
 */
static fromObject(obj: CachePolicy$CachePolicy$CachePolicyObject): CachePolicy;
 ...
 * @example updateRequest.headers = cachePolicy.revalidationHeaders(updateRequest);
 */
revalidationHeaders(newRequest: CachePolicy$CachePolicy$Request): CachePolicy$CachePolicy$Headers;

/**
 * Use this method to update the cache after receiving a new response from the origin server.
 */
revalidatedPolicy(
revalidationRequest: CachePolicy$CachePolicy$Request,
revalidationResponse: CachePolicy$CachePolicy$Response): CachePolicy$CachePolicy$RevalidationPolicy
}
	declare interface CachePolicy$Request {
url?: string,
method?: string,
headers: CachePolicy$Headers
} 

declare interface CachePolicy$Response {
status?: number,
headers: CachePolicy$Headers
} 

declare interface CachePolicy$Options {
...
declare interface CachePolicy$CachePolicyObject {
v: number,
t: number,
sh: boolean,
ch: number,
...
h?: string,
a: boolean,
reqh: CachePolicy$Headers | null,
reqcc: {
[key: string]: string
}
} 

declare interface CachePolicy$Headers {
[header: string]: string | string[] | void
} 

declare interface CachePolicy$RevalidationPolicy {
