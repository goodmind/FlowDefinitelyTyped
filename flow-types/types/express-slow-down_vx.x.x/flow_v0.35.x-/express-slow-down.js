declare module 'express-slow-down' {
        declare type SlowDown$StoreIncrementCallback = (err?: {}, hits?: number) => void;
...
optionsUsed: SlowDown$Options): void,
...
store?: SlowDown$Store
	...
	declare function SlowDown(options: SlowDown$SlowDown$Options): express.RequestHandler
