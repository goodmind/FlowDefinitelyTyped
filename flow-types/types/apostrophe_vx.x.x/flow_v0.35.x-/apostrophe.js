declare module 'apostrophe' {
	...
	declare function apostrophe(options: apostrophe$apostrophe$AposConstructor, ...args: any[]): any
...
baseUrl?: string,
modules: $ObjMapi<{[k: apostrophe$AposCoreModules & M]: any}, <K>(K) => apostrophe$AposModuleOptions | O>,
prefix?: string,
root?: string,
rootDir?: string,
shortName: string
...
declare function apostrophe$create(type: string, options: any, callback?: () => any): any
...
declare function apostrophe$define(type: string | string[], definition: any, extending?: any): any
...
declare function apostrophe$notify(message: string | {[key: string]: any}, options: apostrophe$AposObject): any
...
subset(schema: apostrophe$Schema, fields: apostrophe$Fields): apostrophe$Schema,
newInstance(schema: apostrophe$Schema): any,
subsetInstance(schema: apostrophe$Schema, instance: apostrophe$AposObject): any,
empty(schema: apostrophe$Schema, object: apostrophe$AposObject): void,
indexFields(schema: apostrophe$Schema, object: apostrophe$AposObject, texts: any): void,
convert(
req: any,
schema: apostrophe$Schema,
to: any,
...
output: any,
callback: () => any): void,
isVisible(schema: apostrophe$Schema, object: apostrophe$AposObject, name: string): void,
export(
req: any,
schema: apostrophe$Schema,
to: any,
...
declare type apostrophe$AposCoreModules = "apostrophe-admin-bar"
