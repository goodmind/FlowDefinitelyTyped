declare module 'socketty' {
        declare var socketty: socketty$socketty$Socketty;
	declare module.exports: typeof socketty

	declare interface socketty$Socketty {
...
connect(
url: string,
callback: (socket: socketty$SockettySocket) => void): socketty$SockettySocket,
 ...
 */
createServer(httpServer: any): socketty$SockettyServer
} 

declare interface socketty$SockettySocket {
...
declare interface socketty$SockettyServer {

/**
 * Specify a callback to be run when a new socket connects to the server.
 * @param callback The callback
 */
connection(callback: (socket: socketty$SockettySocket) => void): void
} 
    }
