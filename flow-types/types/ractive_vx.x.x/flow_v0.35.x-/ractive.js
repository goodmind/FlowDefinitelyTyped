declare type _RactiveEvent = Ractive$Event;declare export type Ractive$Node = {
_ractive: any
} & HTMLElement
...
off(
eventName?: string,
handler?: (event?: Ractive$Ractive.Ractive$Event | any, ...args: any[]) => any): Ractive$Ractive,
on(
eventName: string,
handler: (event?: Ractive$Ractive.Ractive$Event | any, ...args: any[]) => any): Ractive$Observe,
on(
map: {
[eventName: string]: (event?: Ractive$Ractive.Ractive$Event | any, ...args: any[]) => any
}): Ractive$Observe,
once(
eventName: string,
handler: (event?: Ractive$Ractive.Ractive$Event | any, ...args: any[]) => any): Ractive$Observe,
...
transitions: Object
        ...
        declare module.exports: typeof Ractive$Ractive
