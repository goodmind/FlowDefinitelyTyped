declare module 'gfc' {
        import type {
          ExecOptions,ExecException,ExecSyncOptions
        } from 'child_process';

	declare module.exports: typeof gitFirstCommit

	declare function gitFirstCommit(
options?: gitFirstCommit$gitFirstCommit$Options<gitFirstCommit$gitFirstCommit$ExecOptionsWithEncoding>): Promise<{
...
stdout: string | Buffer,
stderr: string | Buffer) => void): void
...
declare function gitFirstCommit$sync(options?: gitFirstCommit$Options<ExecSyncOptions>): string | Buffer


declare function gitFirstCommit$sync(
cwd: string,
options?: gitFirstCommit$Options<ExecSyncOptions>): string | Buffer
