declare module "react-native-fbsdk" {
   ...
   */
  declare export type Permissions =
    | "public_profile"
    | "user_friends"
    | "email"
    | "user_about_me"
  ...
  declare export type OpenGraphValueType =
    | "number"
    | "open-graph-object"
    | "photo"
    | "string";
   ...
   */
  declare export class ShareOpenGraphAction
    mixins ShareOpenGraphValueContainer {
    /**
     * The action type.
     */
    actionType: string;
   ...
   */
  declare export class ShareOpenGraphObject
    mixins ShareOpenGraphValueContainer {}
  ...
  declare var npm$namespace$AppEventsLogger: {
    ...
    setUserID: typeof AppEventsLogger$setUserID,
   ...
   */
  declare function AppEventsLogger$setFlushBehavior(
    flushBehavior: AppEventsFlushBehavior
  ): void;
   ...
   */
  declare function AppEventsLogger$logEvent(
    eventName: string,
   ...
   */
  declare function AppEventsLogger$logPushNotificationOpen(payload?: {
    [key: string]: any
  }): void;
   ...
   */
  declare function AppEventsLogger$setUserID(userID: string | null): void;

  /**
   * For iOS only, sets and sends device token to register the current application for push notifications.
   * @platform ios
   */
  declare function AppEventsLogger$setPushNotificationsDeviceToken(
    deviceToken: string
  ): void;
   ...
   * @platform Android
   */
  declare function AppEventsLogger$setPushNotificationsRegistrationId(
   ...
   */
  declare function AppInviteDialog$show(
   ...
   * Shows the dialog using the specified content.
   */
  declare function GameRequestDialog$show(
    gameRequestContent: GameRequestContent
  ): Promise<any>;

  declare export type GraphRequestCallback = (
   ...
   */
  declare export type LoginBehaviorAndroid =
   ...
   */
  declare export type LoginBehaviorIOS =
    | "native"
    | "browser"
    | "system_account"
    | "web";
   ...
   */
  declare function LoginManager$logInWithReadPermissions(
    permissions: Permissions[]
  ): Promise<LoginResult>;
   ...
   */
  declare function LoginManager$logInWithPublishPermissions(
    permissions: Permissions[]
  ): Promise<LoginResult>;
   ...
   */
  declare function LoginManager$setLoginBehavior(
   ...
   */
  declare function LoginManager$setDefaultAudience(
    defaultAudience: DefaultAudience
  ): void;
   ...
   * Check if the dialog can be shown.
   */
  declare function MessageDialog$canShow(
   ...
   */
  declare function MessageDialog$setShouldFailOnDataError(
   ...
   */
  declare function ShareApi$canShare(
    shareContent: ShareContent
  ): Promise<boolean>;
   ...
   * @platform ios
   */
  declare function ShareApi$createOpenGraphObject(
   ...
   * NOTE: Only one share action can be performed at a time.
   */
  declare function ShareApi$share(
    shareContent: ShareContent,
    graphNode: string,
    message: string
  ): Promise<any>;
  ...
  declare export type ShareDialogMode =
    | ShareDialogModeIOS
    | ShareDialogModeAndroid;
  declare export type ShareDialogModeAndroid =
    | "automatic"
    | "native"
    | "web"
    | "feed";
   ...
   * Check if the dialog can be shown.
   */
  declare function ShareDialog$canShow(
    shareContent: ShareContent
  ): Promise<boolean>;
   ...
   */
  declare function ShareDialog$setShouldFailOnDataError(
    shouldFailOnDataError: boolean
  ): void;
}
