declare module "styled-system" {
  ...
  declare export function cloneFunc(
    fn: (...args: any[]) => any
  ): (...args: any[]) => any;
  ...
  declare export type ResponsiveValue<T> =
    | T
    | Array<T | null>
    | {
        [key: string]: T
   ...
   */
  declare export interface SpaceProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export type ObjectOrArray<T> =
    | T[]
    | {
        [K: string]: T
      };
  declare export interface BaseTheme {
    breakpoints?: string[] | number[] | { [key: string]: any };
   ...
   * Font Size
   */
  declare export interface FontSizeProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface BgColorProps<TLength = TLengthStyledSystem> {
    /**
     * The color utility parses a component's `color` and `bg` props and converts them into CSS declarations.
     * By default the raw value of the prop is returned.
     *
  ...
  declare export interface LineHeightProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface LetterSpacingProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface MaxWidthProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface MinWidthProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface WidthProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface MaxHeightProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface MinHeightProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface HeightProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface SizeWidthProps<TLength = TLengthStyledSystem> {
    size?: ResponsiveValue<CSS.WidthProperty<TLength>>;
  }
  declare export function sizeWidth(...args: any[]): any;

  declare export interface SizeHeightProps<TLength = TLengthStyledSystem> {
  ...
  declare export interface VerticalAlignProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface FlexBasisProps<TLength = TLengthStyledSystem> {
  ...
  declare export interface FlexProps<TLength = TLengthStyledSystem> {
    /**
   ...
   * Grid Layout
   */
  declare export interface GridGapProps<TLength = TLengthStyledSystem> {
    /**
 ...
 */
  ...
  declare export interface GridColumnGapProps<TLength = TLengthStyledSystem> {
    /**
 ...
 */
  ...
  declare export interface GridRowGapProps<TLength = TLengthStyledSystem> {
    /**
 ...
 */
  ...
  declare export interface GridAutoColumnsProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface GridAutoRowsProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface GridTemplatesColumnsProps<
    TLength = TLengthStyledSystem
  > {
    /**
  ...
  declare export interface GridTemplatesRowsProps<
    TLength = TLengthStyledSystem
  > {
    /**
   ...
   * Borders
   */
  declare export interface BorderProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface BorderTopProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface BorderRightProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface BorderBottomProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface BorderLeftProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export type BordersProps = {} & BorderTopProps &
    BorderRightProps &
    BorderBottomProps &
    BorderLeftProps;
  ...
  declare export interface BorderRadiusProps<TLength = TLengthStyledSystem> {
    /**
   ...
   * Background
   */
  declare export interface BackgroundProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface BackgroundSizeProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface BackgroundPositionProps<
    TLength = TLengthStyledSystem
  > {
    /**
  ...
  declare export interface TopProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface RightProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface BottomProps<TLength = TLengthStyledSystem> {
    /**
  ...
  declare export interface LeftProps<TLength = TLengthStyledSystem> {
    /**
