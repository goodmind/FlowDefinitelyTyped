declare module 'webidl2' {
        declare export function parse(str: string, options?: ParseOptions): IDLRootType[]

	declare export type IDLRootType = InterfaceType
| InterfaceMixinType
| NamespaceType
| CallbackType
| DictionaryType
...
| ImplementsType
| IncludesType;
	declare export type IDLInterfaceMemberType = OperationMemberType | AttributeMemberType | ConstantMemberType | DeclarationMemberType;
	declare export type IDLNamespaceMemberType = OperationMemberType | AttributeMemberType;
...
allowNestedTypedefs?: boolean
	...
	declare export interface WebIDLParseError {
...
toString(): string
	...
	declare export interface IDLTypeDescription {
...
idlType: string | IDLTypeDescription | IDLTypeDescription[]
	...
	declare export interface InterfaceType {
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface InterfaceMixinType {
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface NamespaceType {
type: "namespace",
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface CallbackType {
type: "callback",
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface DictionaryType {
type: "dictionary",
...
extAttrs: ExtendedAttributes[]
	...
	declare export type DictionaryMemberType = {
...
default: ValueDescription | null
	...
	declare export interface EnumType {
type: "enum",
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface TypedefType {
type: "typedef",
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface ImplementsType {
type: "implements",
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface IncludesType {
type: "includes",
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface OperationMemberType {
type: "operation",
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface AttributeMemberType {
type: "attribute",
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface ConstantMemberType {
type: "const",
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface Argument {
...
extAttrs: ExtendedAttributes[]
	...
	declare export interface ExtendedAttributes {
...
value: string
	...
	declare export interface ExtendedAttributeRightHandSideIdentifier {
type: "identifier",
value: string
} 
	declare export interface ExtendedAttributeRightHandSideIdentifierList {
type: "identifier-list",
value: string[]
} 
	declare export interface ValueDescription {
type: "string"
| "number"
| "boolean"
| "null"
...
negative: boolean | null
	...
	declare export interface DeclarationMemberType {
