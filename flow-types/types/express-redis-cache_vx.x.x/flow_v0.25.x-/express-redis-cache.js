declare class expressRedisCache$ExpressRedisCache mixins events.EventEmitter {
  ...
  add(
    ...
    callback: (error: any, added: expressRedisCache$Entry) => void
  ): void;
  add(
    name: string,
    body: string,
...
declare type expressRedisCache$ExpireOption =
  | number
  | expressRedisCache$ExpirationConfig;

declare type expressRedisCache$ExpirationPolicy = (
  req: express.Request,
...
declare module "express-redis-cache" {
  declare function expressRedisCache(
    options?: expressRedisCache$expressRedisCache$Options
  ): expressRedisCache$expressRedisCache$ExpressRedisCache;
