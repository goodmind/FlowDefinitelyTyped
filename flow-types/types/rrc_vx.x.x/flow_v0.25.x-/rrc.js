declare module "rrc" {
  ...
  declare export class ScrollIntoView
    mixins React.Component<ScrollIntoViewProps> {}
  ...
  declare export type WhenActiveReturnType<Props> = (
    component: ComponentConstructor<Props>
  ) => ComponentConstructor<Props>;
  declare export function whenActive<Props>(
