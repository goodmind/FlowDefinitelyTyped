declare module "Sylvester" {
  ...
  declare interface MatrixStatic {
     ...
     */
    create(
      elements: Array<number> | Array<Array<number>> | Vector | Matrix
    ): Matrix;
...
declare module "sylvester" {
  ...
  declare interface Matrix {
     ...
     */
    setElements(
      matrix: Array<number> | Array<Array<number>> | Vector | Matrix
    ): Matrix;
  }
