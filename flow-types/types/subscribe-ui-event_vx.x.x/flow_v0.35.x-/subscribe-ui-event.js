declare module 'subscribe-ui-event' {
        declare export type UIEventType = "resize"
| "resizeEnd"
| "resizeStart"
| "scroll"
| "scrollEnd"
| "scrollStart"
| "visibilitychange";
	declare export type TouchEventType = "touchend"
| "touchmove"
| "touchmoveEnd"
| "touchmoveStart"
| "touchstart";
...
startY: number
	...
	declare export type UIEventCallback<T: UIEventType> = (event: UIEvent, payload: ArgmentedEvent<T>) => any;
	declare export type TouchEventCallback<T: TouchEventType> = (event: TouchEvent, payload: ArgmentedEvent<T>) => any;
...
options?: SubscribeOptions): Subscription
	...
	declare export function unsubscribe<T: UIEventType>(eventType: T, callback: UIEventCallback<T>): void

	declare export function unsubscribe<T: TouchEventType>(eventType: T, callback: TouchEventCallback<T>): void
