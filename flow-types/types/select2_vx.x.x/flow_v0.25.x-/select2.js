...
declare module "select2" {
  declare export type Sub<O: string, D: string> = $ElementType<
    $ObjMapi<
      { [k: O]: any },
      <K>(K) => $ElementType<Record<D, empty> & Record<string, K>, K>
    >,
    O
  >;
   ...
   */
  declare export type JQueryAjaxSettingsBase = Pick<
    JQueryAjaxSettings,
    Sub<$Keys<JQueryAjaxSettings>, "url">
  >;

  /**
   * Same as jQuery v3 `JQuery.EventHandlerBase`.
   */
  declare export type JQueryEventHandlerBase<TContext, T> = (
    t: T,
    ...args: any[]
  ) => void | false;
   ...
   */
  declare export interface PlainObject<T = any> {
    [key: string]: T;
  }
  ...
  declare export interface ProcessedResult<
  ...
  declare export type AjaxOptions<
    Result = DataFormat | GroupedDataFormat,
    RemoteResult = any
  > = {
    delay?: number,
  ...
  declare export interface Select2Plugin<TElement = HTMLElement> {
    amd: {
      require: Require
    };
    defaults: {
