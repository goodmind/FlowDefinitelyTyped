...
static fetchAll<T>(list: AV$Object[], options: AV$SuccessFailureOptions): AV$Promise<T>;
static fetchAllIfNeeded<T>(list: AV$Object[], options: AV$SuccessFailureOptions): AV$Promise<T>;
static destroyAll<T>(
list: AV$Object[],
options?: AV$Object.Object$DestroyAllOptions): AV$Promise<T>;
static saveAll<T>(list: AV$Object[], options?: AV$Object.Object$SaveAllOptions): AV$Promise<T>;
initialize(): void;
...
arg2?: any,
arg3?: any): AV$Promise<T>;
set(key: string, value: any, options?: AV$Object.Object$SetOptions): boolean;
...
constructor(models?: AV$Object[], options?: AV$Collection.Collection$Options): this;
static extend(instanceProps: any, classProps: any): any;
initialize(): void;
add(models: any[], options?: AV$Collection.Collection$AddOptions): AV$Collection<T>;
at(index: number): AV$Object;
fetch(options?: AV$Collection.Object$FetchOptions): AV$Promise<T>;
create(model: AV$Object, options?: AV$Collection.Collection$CreateOptions): AV$Object;
get(id: string): AV$Object;
getByCid(cid: any): any;
pluck(attr: string): any[];
remove(model: any, options?: AV$Collection.Collection$RemoveOptions): AV$Collection<T>;
remove(
models: any[],
options?: AV$Collection.Collection$RemoveOptions): AV$Collection<T>;
reset(
models: any[],
options?: AV$Collection.Collection$ResetOptions): AV$Collection<T>;
...
collection(
items?: AV$Object[],
options?: AV$Collection.Collection$Options): AV$Collection<AV$Object>;
...
static become<T>(sessionToken: string, options?: AV$SuccessFailureOptions): AV$Promise<T>;
static requestPasswordReset<T>(email: string, options?: AV$SuccessFailureOptions): AV$Promise<T>;
...
static +OTHER_CAUSE: Class<AV$ErrorCode__OTHER_CAUSE> & AV$ErrorCode__OTHER_CAUSE & -1;// -1
static +INTERNAL_SERVER_ERROR: Class<AV$ErrorCode__INTERNAL_SERVER_ERROR> & AV$ErrorCode__INTERNAL_SERVER_ERROR & 1;// 1
static +CONNECTION_FAILED: Class<AV$ErrorCode__CONNECTION_FAILED> & AV$ErrorCode__CONNECTION_FAILED & 100;// 100
static +OBJECT_NOT_FOUND: Class<AV$ErrorCode__OBJECT_NOT_FOUND> & AV$ErrorCode__OBJECT_NOT_FOUND & 101;// 101
static +INVALID_QUERY: Class<AV$ErrorCode__INVALID_QUERY> & AV$ErrorCode__INVALID_QUERY & 102;// 102
static +INVALID_CLASS_NAME: Class<AV$ErrorCode__INVALID_CLASS_NAME> & AV$ErrorCode__INVALID_CLASS_NAME & 103;// 103
static +MISSING_OBJECT_ID: Class<AV$ErrorCode__MISSING_OBJECT_ID> & AV$ErrorCode__MISSING_OBJECT_ID & 104;// 104
static +INVALID_KEY_NAME: Class<AV$ErrorCode__INVALID_KEY_NAME> & AV$ErrorCode__INVALID_KEY_NAME & 105;// 105
static +INVALID_POINTER: Class<AV$ErrorCode__INVALID_POINTER> & AV$ErrorCode__INVALID_POINTER & 106;// 106
static +INVALID_JSON: Class<AV$ErrorCode__INVALID_JSON> & AV$ErrorCode__INVALID_JSON & 107;// 107
static +COMMAND_UNAVAILABLE: Class<AV$ErrorCode__COMMAND_UNAVAILABLE> & AV$ErrorCode__COMMAND_UNAVAILABLE & 108;// 108
static +NOT_INITIALIZED: Class<AV$ErrorCode__NOT_INITIALIZED> & AV$ErrorCode__NOT_INITIALIZED & 109;// 109
static +INCORRECT_TYPE: Class<AV$ErrorCode__INCORRECT_TYPE> & AV$ErrorCode__INCORRECT_TYPE & 111;// 111
static +INVALID_CHANNEL_NAME: Class<AV$ErrorCode__INVALID_CHANNEL_NAME> & AV$ErrorCode__INVALID_CHANNEL_NAME & 112;// 112
static +PUSH_MISCONFIGURED: Class<AV$ErrorCode__PUSH_MISCONFIGURED> & AV$ErrorCode__PUSH_MISCONFIGURED & 115;// 115
static +OBJECT_TOO_LARGE: Class<AV$ErrorCode__OBJECT_TOO_LARGE> & AV$ErrorCode__OBJECT_TOO_LARGE & 116;// 116
static +OPERATION_FORBIDDEN: Class<AV$ErrorCode__OPERATION_FORBIDDEN> & AV$ErrorCode__OPERATION_FORBIDDEN & 119;// 119
static +CACHE_MISS: Class<AV$ErrorCode__CACHE_MISS> & AV$ErrorCode__CACHE_MISS & 120;// 120
static +INVALID_NESTED_KEY: Class<AV$ErrorCode__INVALID_NESTED_KEY> & AV$ErrorCode__INVALID_NESTED_KEY & 121;// 121
static +INVALID_FILE_NAME: Class<AV$ErrorCode__INVALID_FILE_NAME> & AV$ErrorCode__INVALID_FILE_NAME & 122;// 122
static +INVALID_ACL: Class<AV$ErrorCode__INVALID_ACL> & AV$ErrorCode__INVALID_ACL & 123;// 123
static +TIMEOUT: Class<AV$ErrorCode__TIMEOUT> & AV$ErrorCode__TIMEOUT & 124;// 124
static +INVALID_EMAIL_ADDRESS: Class<AV$ErrorCode__INVALID_EMAIL_ADDRESS> & AV$ErrorCode__INVALID_EMAIL_ADDRESS & 125;// 125
static +MISSING_CONTENT_TYPE: Class<AV$ErrorCode__MISSING_CONTENT_TYPE> & AV$ErrorCode__MISSING_CONTENT_TYPE & 126;// 126
static +MISSING_CONTENT_LENGTH: Class<AV$ErrorCode__MISSING_CONTENT_LENGTH> & AV$ErrorCode__MISSING_CONTENT_LENGTH & 127;// 127
static +INVALID_CONTENT_LENGTH: Class<AV$ErrorCode__INVALID_CONTENT_LENGTH> & AV$ErrorCode__INVALID_CONTENT_LENGTH & 128;// 128
static +FILE_TOO_LARGE: Class<AV$ErrorCode__FILE_TOO_LARGE> & AV$ErrorCode__FILE_TOO_LARGE & 129;// 129
static +FILE_SAVE_ERROR: Class<AV$ErrorCode__FILE_SAVE_ERROR> & AV$ErrorCode__FILE_SAVE_ERROR & 130;// 130
static +DUPLICATE_VALUE: Class<AV$ErrorCode__DUPLICATE_VALUE> & AV$ErrorCode__DUPLICATE_VALUE & 137;// 137
static +INVALID_ROLE_NAME: Class<AV$ErrorCode__INVALID_ROLE_NAME> & AV$ErrorCode__INVALID_ROLE_NAME & 139;// 139
static +EXCEEDED_QUOTA: Class<AV$ErrorCode__EXCEEDED_QUOTA> & AV$ErrorCode__EXCEEDED_QUOTA & 140;// 140
static +SCRIPT_FAILED: Class<AV$ErrorCode__SCRIPT_FAILED> & AV$ErrorCode__SCRIPT_FAILED & 141;// 141
static +VALIDATION_ERROR: Class<AV$ErrorCode__VALIDATION_ERROR> & AV$ErrorCode__VALIDATION_ERROR & 142;// 142
static +INVALID_IMAGE_DATA: Class<AV$ErrorCode__INVALID_IMAGE_DATA> & AV$ErrorCode__INVALID_IMAGE_DATA & 150;// 150
static +UNSAVED_FILE_ERROR: Class<AV$ErrorCode__UNSAVED_FILE_ERROR> & AV$ErrorCode__UNSAVED_FILE_ERROR & 151;// 151
static +INVALID_PUSH_TIME_ERROR: Class<AV$ErrorCode__INVALID_PUSH_TIME_ERROR> & AV$ErrorCode__INVALID_PUSH_TIME_ERROR & 152;// 152
static +FILE_DELETE_ERROR: Class<AV$ErrorCode__FILE_DELETE_ERROR> & AV$ErrorCode__FILE_DELETE_ERROR & 153;// 153
static +REQUEST_LIMIT_EXCEEDED: Class<AV$ErrorCode__REQUEST_LIMIT_EXCEEDED> & AV$ErrorCode__REQUEST_LIMIT_EXCEEDED & 155;// 155
static +INVALID_EVENT_NAME: Class<AV$ErrorCode__INVALID_EVENT_NAME> & AV$ErrorCode__INVALID_EVENT_NAME & 160;// 160
static +USERNAME_MISSING: Class<AV$ErrorCode__USERNAME_MISSING> & AV$ErrorCode__USERNAME_MISSING & 200;// 200
static +PASSWORD_MISSING: Class<AV$ErrorCode__PASSWORD_MISSING> & AV$ErrorCode__PASSWORD_MISSING & 201;// 201
static +USERNAME_TAKEN: Class<AV$ErrorCode__USERNAME_TAKEN> & AV$ErrorCode__USERNAME_TAKEN & 202;// 202
static +EMAIL_TAKEN: Class<AV$ErrorCode__EMAIL_TAKEN> & AV$ErrorCode__EMAIL_TAKEN & 203;// 203
static +EMAIL_MISSING: Class<AV$ErrorCode__EMAIL_MISSING> & AV$ErrorCode__EMAIL_MISSING & 204;// 204
static +EMAIL_NOT_FOUND: Class<AV$ErrorCode__EMAIL_NOT_FOUND> & AV$ErrorCode__EMAIL_NOT_FOUND & 205;// 205
static +SESSION_MISSING: Class<AV$ErrorCode__SESSION_MISSING> & AV$ErrorCode__SESSION_MISSING & 206;// 206
static +MUST_CREATE_USER_THROUGH_SIGNUP: Class<AV$ErrorCode__MUST_CREATE_USER_THROUGH_SIGNUP> & AV$ErrorCode__MUST_CREATE_USER_THROUGH_SIGNUP & 207;// 207
static +ACCOUNT_ALREADY_LINKED: Class<AV$ErrorCode__ACCOUNT_ALREADY_LINKED> & AV$ErrorCode__ACCOUNT_ALREADY_LINKED & 208;// 208
static +INVALID_SESSION_TOKEN: Class<AV$ErrorCode__INVALID_SESSION_TOKEN> & AV$ErrorCode__INVALID_SESSION_TOKEN & 209;// 209
static +LINKED_ID_MISSING: Class<AV$ErrorCode__LINKED_ID_MISSING> & AV$ErrorCode__LINKED_ID_MISSING & 250;// 250
static +INVALID_LINKED_SESSION: Class<AV$ErrorCode__INVALID_LINKED_SESSION> & AV$ErrorCode__INVALID_LINKED_SESSION & 251;// 251
static +UNSUPPORTED_SERVICE: Class<AV$ErrorCode__UNSUPPORTED_SERVICE> & AV$ErrorCode__UNSUPPORTED_SERVICE & 252;// 252
static +AGGREGATE_ERROR: Class<AV$ErrorCode__AGGREGATE_ERROR> & AV$ErrorCode__AGGREGATE_ERROR & 600;// 600
static +FILE_READ_ERROR: Class<AV$ErrorCode__FILE_READ_ERROR> & AV$ErrorCode__FILE_READ_ERROR & 601;// 601
static +X_DOMAIN_REQUEST: Class<AV$ErrorCode__X_DOMAIN_REQUEST> & AV$ErrorCode__X_DOMAIN_REQUEST & 602;// 602
...
declare class AV$ErrorCode__MUST_CREATE_USER_THROUGH_SIGNUP mixins AV$ErrorCode {}
