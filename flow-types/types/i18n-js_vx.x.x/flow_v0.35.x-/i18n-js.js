...
declare var I18n$missingTranslation: (scope: string, options?: I18n$TranslateOptions) => string | null | void;

declare var I18n$missingPlaceholder: (
I18n$placeholder: string,
message: string,
options?: I18n$InterpolateOptions) => string | null | void;
...
[key: string]: string | string[] | ((I18n$locale: string) => string | string[])
};
...
declare function I18n$translate(scope: I18n$Scope, options?: I18n$TranslateOptions): string


declare function I18n$t(scope: I18n$Scope, options?: I18n$TranslateOptions): string


declare function I18n$localize(
scope: "currency" | "number" | "percentage",
value: number,
options?: I18n$InterpolateOptions): string
...
declare function I18n$toNumber(num: number, options?: I18n$ToNumberOptions): string


declare type I18n$ToPercentageOptions = I18n$ToNumberOptions;

declare function I18n$toPercentage(num: number, options?: I18n$ToPercentageOptions): string
...
declare function I18n$toCurrency(num: number, options?: I18n$ToCurrencyOptions): string


declare function I18n$toTime(scope: I18n$Scope, value: string | number | Date): string
...
declare function I18n$toHumanSize(num: number, options?: I18n$ToHumanSizeOptions): string
