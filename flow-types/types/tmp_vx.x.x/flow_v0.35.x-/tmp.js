...
callback?: (err: any, path: string, fd: number, cleanupCallback: () => void) => void): void
	...
	declare export function dir(callback: (err: any, path: string, cleanupCallback: () => void) => void): void

	declare export function dir(
config: Options,
callback?: (err: any, path: string, cleanupCallback: () => void) => void): void

	declare export function dirSync(config?: Options): SynchrounousResult

	declare export function tmpName(callback: (err: any, path: string) => void): void

	declare export function tmpName(config: SimpleOptions, callback?: (err: any, path: string) => void): void
