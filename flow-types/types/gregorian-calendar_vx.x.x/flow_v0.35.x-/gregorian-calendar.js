...
declare module 'gregorian-calendar-format' {
        declare  class DateTimeStyle {
  constructor(...args: empty): mixed;
static +FULL: Class<DateTimeStyle__FULL> & DateTimeStyle__FULL & 0;// 0
static +LONG: Class<DateTimeStyle__LONG> & DateTimeStyle__LONG & 1;// 1
static +MEDIUM: Class<DateTimeStyle__MEDIUM> & DateTimeStyle__MEDIUM & 2;// 2
static +SHORT: Class<DateTimeStyle__SHORT> & DateTimeStyle__SHORT & 3;// 3

}

declare class DateTimeStyle__FULL mixins DateTimeStyle {}
declare class DateTimeStyle__LONG mixins DateTimeStyle {}
declare class DateTimeStyle__MEDIUM mixins DateTimeStyle {}
declare class DateTimeStyle__SHORT mixins DateTimeStyle {}
 ...
 */
parse(dateString: String, {locale}: {
locale: Object
}): GregorianCalendar;
