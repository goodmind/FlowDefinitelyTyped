 ...
 */
declare export function csv<ParsedRow: {[key: string]: any}, Columns: string>(
url: string,
row: (
...
In effect, row is similar to applying a map and filter operator to the returned rows.
 */
declare export function dsv<ParsedRow: {[key: string]: any}, Columns: string>(
delimiter: string,
url: string,
row: (
rawRow: DSVRowString<Columns>,
...
In effect, row is similar to applying a map and filter operator to the returned rows.
 */
declare export function tsv<ParsedRow: {[key: string]: any}, Columns: string>(
url: string,
row: (
rawRow: DSVRowString<Columns>,
index: number,
