declare module "d3-fetch" {
  import type { DSVParsedArray, DSVRowArray, DSVRowString } from "d3-dsv";
  ...
  declare export function csv<Columns: string>(
    url: string,
    init?: RequestInit
  ): core$Promise<DSVRowArray<Columns>>;
 ...
 */
  ...
  ): core$Promise<DSVParsedArray<ParsedRow>>;
 ...
 */
  ...
  declare export function html(
    url: string,
    init?: RequestInit
  ): core$Promise<ArangoDB$Document>;
  ...
  declare export function image(
    url: string,
    init?: $Shape<HTMLImageElement>
  ): core$Promise<HTMLImageElement>;
