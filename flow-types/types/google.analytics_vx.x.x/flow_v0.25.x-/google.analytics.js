declare module "google.analytics" {
  ...
  declare type UniversalAnalytics$HitType =
    | "pageview"
    | "screenview"
    | "event"
    | "transaction"
  ...
  declare interface UniversalAnalytics$FieldsObject {
    affiliation?: string;
    allowAnchor?: boolean;
    allowLinker?: boolean;
  ...
  declare interface UniversalAnalytics$ga {
    ...
    (command: "send", fieldsObject: UniversalAnalytics$FieldsObject): void;
    (
      command: string,
      hitType: UniversalAnalytics$HitType,
      ...fields: any[]
    ...
    (
      ...
      pluginName: string,
      pluginConstructor: (
        tracker: UniversalAnalytics$Tracker,
    ...
    (
      readyCallback: (defaultTracker?: UniversalAnalytics$Tracker) => void
    ): void;
    create(
      trackingId: string,
      cookieDomain: string,
  ...
  declare interface UniversalAnalytics$Model {
    get(fieldName: string): any;
  ...
  declare var UniversalAnalytics$ga: UniversalAnalytics$UniversalAnalytics$ga;
