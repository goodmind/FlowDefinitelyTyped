...
async: boolean
	...
	declare type UniversalAnalytics$HitType = "pageview"
| "screenview"
| "event"
| "transaction"
| "item"
...
l: number,
q: any[],
(command: "send", hitType: "event", eventCategory: string, eventAction: string, eventLabel?: string, eventValue?: number, fieldsObject?: UniversalAnalytics$FieldsObject): void,
...
(command: string, hitType: UniversalAnalytics$HitType, ...fields: any[]): void,
(command: "require", pluginName: string, pluginOptions?: any): void,
(command: "provide", pluginName: string, pluginConstructor: (tracker: UniversalAnalytics$Tracker, pluginOptions?: Object) => void): void,
(command: "create", trackingId: string, cookieDomain?: string, name?: string, fieldsObject?: UniversalAnalytics$FieldsObject): void,
(command: "remove"): void,
...
cookieDomain: string,
name: string,
fieldsObject?: UniversalAnalytics$FieldsObject): UniversalAnalytics$Tracker,
create(
trackingId: string,
cookieDomain: string,
fieldsObject?: UniversalAnalytics$FieldsObject): UniversalAnalytics$Tracker,
