 ...
 */
detect(
options: Options$FaceResponses$Detect): Promise<[FaceResponses$FaceResponses$Detect]>;
...
similar(
sourceFaceId: string,
candidateFacesIds: string[]): Promise<FaceResponses$FaceResponses$Similar>;
...
identify(
faceIDs: string[],
options: Options$FaceResponses$Identify): Promise<FaceResponses$FaceResponses$Identify[]>;
 ...
 */
analyzeImage(
options: Options$VisionResponses$Analyze): Promise<VisionResponses$VisionResponses$Analyze>;
 ...
 */
ocr(
options: Options$VisionResponses$Ocr): Promise<VisionResponses$VisionResponses$Ocr>
}
 ...
 */
get(
personGroupId: string): Promise<PersonGroupResponses$PersonGroupResponses$PersonGroup>;
 ...
 */
trainingStatus(
personGroupId: string): Promise<PersonGroupResponses$PersonGroupResponses$TrainingStatus>;
...
personGroupId: string,
personId: string,
faceId: string): Promise<PersonResponses$PersonResponses$Face>;
...
get(
personGroupId: string,
personId: string): Promise<PersonResponses$PersonResponses$Person>;
 ...
 * @return {Promise} - Promise resolving with the resulting JSON
 */
list(personGroupId: string): Promise<PersonResponses$PersonResponses$Person[]>
}
