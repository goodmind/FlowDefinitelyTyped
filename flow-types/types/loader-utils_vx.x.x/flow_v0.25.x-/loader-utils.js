declare module "loader-utils" {
  ...
  declare export type DigestType =
    | "hex"
    | "base26"
    | "base32"
    | "base36"
  ...
  declare export function stringifyRequest(
    loaderContext: loader.LoaderContext,
    resource: string
  ): string;

  declare export function getRemainingRequest(
    loaderContext: loader.LoaderContext
  ): string;

  declare export function getCurrentRequest(
    loaderContext: loader.LoaderContext
  ): string;
  ...
  declare export function interpolateName(
    loaderContext: loader.LoaderContext,
    name: string,
    options?: any
  ): string;
