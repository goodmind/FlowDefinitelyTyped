declare module 'jest-matcher-utils' {
	...
	declare export function highlightTrailingWhitespace(text: string, bgColor: Chalk): string

	declare export function printReceived(object: any): string

	declare export function printExpected(value: any): string

	declare export function printWithType(name: string, received: any, print: (value: any) => string): string

	declare export function ensureNoExpected(actual: any, matcherName?: string): void

	declare export function ensureActualIsNumber(actual: any, matcherName?: string): void

	declare export function ensureExpectedIsNumber(actual: any, matcherName?: string): void

	declare export function ensureNumbers(actual: any, expected: any, matcherName?: string): void
