declare module 'jquery-editable-select' {
        declare interface JQueryEditableSelect$EditableSelectOptions {
 ...
 */
editableSelect(
options?: JQueryEditableSelect$JQueryEditableSelect$EditableSelectOptions): JQuery,

/**
 * Manually shows/hide/filters/clears/destorys the dropdown list.
 * @param action Action to apply
 */
editableSelect(action: "show"
| "hide"
| "filter"
| "clear"
| "destroy"): void,
