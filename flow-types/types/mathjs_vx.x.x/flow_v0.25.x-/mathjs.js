...
declare type math$MathExpression =
  | string
  | string[]
  | math$MathArray
  | math$Matrix;
 ...
 */
   ...
   */
  boolean(
    x: string | number | boolean | math$MathArray | math$Matrix | null
  ): boolean | math$MathArray | math$Matrix;
 ...
 */
  createUnit(
    ...
    options?: math$CreateUnitOptions
  ): math$Unit;
 ...
 */
  fraction(
    args: math$Fraction | math$MathArray | math$Matrix
  ): math$Fraction | math$MathArray | math$Matrix;
 ...
 */
  fraction(
    ...
    denominator?: number | string | math$MathArray | math$Matrix
  ): math$Fraction | math$MathArray | math$Matrix;
  ...
  number(
    value?:
      ...
      | math$Unit
      | null
  ): number | math$MathArray | math$Matrix;
 ...
 */
  simplify(
    ...
    rules?: Array<
      ...
      | string
      | ((node: math$MathNode) => math$MathNode)
    >,
    scope?: { [key: string]: any }
  ): math$MathNode;
 ...
 */
  log(
    x: number | math$BigNumber | math$Complex | math$MathArray | math$Matrix,
    base?: number | math$BigNumber | math$Complex
  ): number | math$BigNumber | math$Complex | math$MathArray | math$Matrix;
   ...
   */
  mod(
    x: number | math$BigNumber | math$Fraction | math$MathArray | math$Matrix,
    y: number | math$BigNumber | math$Fraction | math$MathArray | math$Matrix
  ): number | math$BigNumber | math$Fraction | math$MathArray | math$Matrix;
 ...
 */
  norm(
    x: number | math$BigNumber | math$Complex | math$MathArray | math$Matrix,
    p?: number | math$BigNumber | string
   ...
   */
  nthRoot(
    a: number | math$BigNumber | math$MathArray | math$Matrix | math$Complex,
    root?: number | math$BigNumber
  ): number | math$Complex | math$MathArray | math$Matrix;
  ...
  pow(
    x: math$MathType,
    y: number | math$BigNumber | math$Complex
  ): math$MathType;
  ...
  round(
    x:
      ...
      | math$MathArray
      | math$Matrix,
    n?: number | math$BigNumber | math$MathArray
  ):
    | number
    | math$BigNumber
    | math$Fraction
 ...
 */
  ...
  bitAnd(
    ...
    y: number | math$BigNumber | math$MathArray | math$Matrix
  ): number | math$BigNumber | math$MathArray | math$Matrix;
  ...
  distance(
    ...
    y: math$MathArray | math$Matrix | { [key: string]: any }
  ): number | math$BigNumber;
 ...
 */
   ...
   */
  concat(
    ...args: Array<math$MathArray | math$Matrix>
  ): math$MathArray | math$Matrix;
 ...
 */
  ...
  identity(
    ...
    format?: string
  ): math$Matrix | math$MathArray | number;
 ...
 */
   ...
   */
  inv(
    x: number | math$Complex | math$MathArray | math$Matrix
  ): number | math$Complex | math$MathArray | math$Matrix;
 ...
 */
  subset(
    ...
    replacement?: any,
    defaultValue?: any
  ): math$MathArray | math$Matrix | string;
   ...
   */
  factorial(
    n: number | math$BigNumber | math$MathArray | math$Matrix
  ): number | math$BigNumber | math$MathArray | math$Matrix;
   ...
   */
  gamma(
    n: number | math$MathArray | math$Matrix
  ): number | math$MathArray | math$Matrix;
 ...
 */
  compareText(
    ...
    y: string | math$MathArray | math$Matrix
  ): number | math$MathArray | math$Matrix;
 ...
 */
  quantileSeq(
    ...
    sorted?: boolean
  ): number | math$BigNumber | math$Unit | math$MathArray;
 ...
 */
  to(
    ...
    unit: math$Unit | string
  ): math$Unit | math$MathArray | math$Matrix;
...
declare interface math$Matrix {
  ...
  format(
    options?: math$FormatOptions | number | ((value: any) => string)
  ): string;
  toString(): string;
  toJSON(): any;
...
declare interface math$MathNode {
   ...
   */
  filter(
    callback: (node: math$MathNode, path: string, parent: math$MathNode) => any
  ): math$MathNode[];
   ...
   */
  traverse(
    callback: (node: math$MathNode, path: string, parent: math$MathNode) => void
  ): any;
}
 ...
 */
   ...
   */
  lcm(
    b: number | math$BigNumber | math$MathArray | math$Matrix
  ): math$MathJsChain;
