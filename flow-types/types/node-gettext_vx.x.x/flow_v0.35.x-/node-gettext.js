...
addTranslations(locale: string, domain: string, translations: {[key: string]: any}): void;
...
getComment(domain: string, msgctxt: string, msgid: string): {[key: string]: any} | boolean;
