 ...
 * @param defaultValue
 */
declare function PvUtils$getParametersValue<T>(parameters: any, name: string, defaultValue?: T): T
 ...
 * @returns {string}
 */
declare function PvUtils$bufferToHexCodes(inputBuffer: ArrayBuffer, inputOffset?: number, inputLength?: number): string
 ...
 * @returns {number}
 */
declare function PvUtils$utilFromBase(inputBuffer: Uint8Array, inputBase: number): number
 ...
 * @returns {ArrayBuffer}
 */
declare function PvUtils$utilToBase(value: number, base: number, reserved?: number): ArrayBuffer
 ...
 * @returns {boolean}
 */
declare function PvUtils$isEqualBuffer(inputBuffer1: ArrayBuffer, inputBuffer2: ArrayBuffer): boolean
 ...
 * @returns {string}
 */
declare function PvUtils$padNumber(inputNumber: number, fullLength: number): string
 ...
 * @returns {string}
 */
declare function PvUtils$toBase64(input: string, useUrlTemplate?: boolean, skipPadding?: boolean): string
 ...
 * @returns {string}
 */
declare function PvUtils$fromBase64(input: string, useUrlTemplate?: boolean, cutTailZeros?: boolean): string
