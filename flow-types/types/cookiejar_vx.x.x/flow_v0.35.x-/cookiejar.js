 ...
 */
constructor(domain: string, path?: string, secure?: boolean, script?: boolean): this;
 ...
 */
constructor(cookie: string | Cookie, requestDomain?: string, requestPath?: string): this;
...
requestPath?: string): Cookie | false;
...
requestDomain?: string,
requestPath?: string): $ReadOnlyArray<Cookie> | false;
 ...
 */
getCookies(
accessInfo: CookieAccessInfo): $ReadOnlyArray<Cookie> & {
toValueString(): string
}
}
    }
