...
new (
dt: DataTables$Api,
settings: boolean | string[] | DataTables$ButtonsSettings | DataTables$ButtonSettings[]): void,
version: string,
 ...
 */
exportInfo(
options?: DataTables$ButtonsApiExportInfoParameter): DataTables$ButtonsApiExportInfoReturn,

/**
 * Obtain data from a DataTable that is suitable for exporting by saving into a file or copying to clipboard.
 */
exportData(
options?: DataTables$ButtonsApiExportDataParameter): DataTables$ButtonsApiExportDataReturn
} 
...
add(
index: number | string,
config: string | DataTables$FunctionButtom | DataTables$ButtonSettings): DataTables$Api,
...
name?: string,
tabIndex?: number,
buttons: Array<string | DataTables$FunctionButtom | DataTables$ButtonSettings>,
 ...
 */
declare type DataTables$FunctionButtom = (dt: DataTables$Api) => DataTables$ButtomSettingsCommon;

declare type DataTables$FunctionButtonText = (dt: DataTables$Api, node: JQuery, config: any) => string;

declare type DataTables$FunctionButtonAvailable = (dt: DataTables$Api, config: any) => boolean;

declare type DataTables$FunctionButtonInit = (dt: DataTables$Api, node: JQuery, config: any) => void;

declare type DataTables$FunctionButtonAction = (
e: any,
dt: DataTables$Api,
node: JQuery,
config: DataTables$ButtonSettings) => void;

declare type DataTables$FunctionButtonCustomize = (win: Window | string) => void;
...
declare type DataTables$FunctionButtonColvisColumnText = (dt: DataTables$Api, i: number, title: string) => string;
    }
