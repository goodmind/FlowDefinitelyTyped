declare module 'react-rte' {
	...
	import type {
          ContentBlock,EditorState
        } from 'draft-js';

	declare type CustomBlockFn = (element: Element) => void | null | CustomBlockObject;
	declare type CustomInlineFn = (
element: Element,
inlineCreators: InlineCreators) => void | null | Style | draftjs.EntityInstance;
...
Entity: (type: string, data?: {[key: string]: any}) => draftjs.EntityInstance
} 
...
format: string,
decorator?: any,
options?: ImportOptions): EditorValue
}
...
className?: string
	...
	declare type CustControlFunc = (set: SetControlState, get: GetControlState, state: EditorState) => ReactNode;
	declare type CustomControl = ReactNode | CustControlFunc;
	declare type GroupName = "INLINE_STYLE_BUTTONS"
| "BLOCK_TYPE_BUTTONS"
| "LINK_BUTTONS"
| "BLOCK_TYPE_DROPDOWN"
| "HISTORY_BUTTONS"
