declare module "cote" {
   ...
   * Configuration which controls the data being advertised for auto-discovery.
   */
  declare export type SockendAdvertisement = {} & ResponderAdvertisement &
   ...
   */
  declare export function MonitoringTool(
    port: number
  ): {
    monitor: Monitor,
    server: Server
   ...
   */
  declare export type StatusAdvertisement = {} & RequesterAdvertisement &
