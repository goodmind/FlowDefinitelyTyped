declare module 'react-numeric-input' {
	...
	declare type NumericInput$BoundsFunctionProp = number | ((component: NumericInput) => number | void);
...
snap?: boolean,
step?: number | ((component: NumericInput, direction: string) => number | void),
strict?: boolean,
style?: {
[key: string]: React.CSSProperties
} | boolean,
value?: number | string
} & NumericInput$Omit<React.InputHTMLAttributes<HTMLInputElement>, "min"
| "max"
| "step"
| "onChange"
| "defaultValue"
...
value?: number | null
	...
	declare class NumericInput mixins React.Component<NumericInput$NumericInput$NumericInputProps, NumericInput$NumericInput$NumericInputState> {
