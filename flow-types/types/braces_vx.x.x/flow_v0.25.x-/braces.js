declare module "braces" {
  declare interface braces$Options {
    /**
  ...
  declare interface Braces {
    (pattern: string, options?: braces$braces$Options): string[];
    expand(pattern: string): string[];
  }
  declare var braces: Braces;
  declare module.exports: typeof braces;
}
