 ...
 */
declare export interface JsonStyle {
 ...
 */
declare export function parse(text: string, options?: ParseOptions): any
...
If a member contains nested objects, the nested objects are transformed before the parent object is.
 */
declare export function parse(text: string, reviver?: (key: any, value: any) => any): any
 ...
 */
declare export function stringify(value: any, options?: StringifyOptions): string
 ...
 * @param options Parser options
 */
declare export function tokenize(text: string, options?: ParseOptions): Token[]
 ...
 * @param options Parser options
 */
declare export function analyze(text: string, options?: ParseOptions): JsonStyle
 ...
 * @example // here is your original JSON document:
...
text: string,
new_value: any,
options?: ParseOptions & StringifyOptions): string
