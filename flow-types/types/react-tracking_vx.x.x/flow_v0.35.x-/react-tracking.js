...
trackEvent({}: <<UNKNOWN PARAM FORMAT>>): any,
...
process(ownTrackingData: T): T | Falsy
	...
	declare export type TrackingInfo<T, P, S> = T | ((props: P, state: S, args: $ElementType<any, any>) => T);
 ...
 */
declare export interface Track<T, P, S> {
(trackingInfo?: TrackingInfo<Pick<T, K>, P, S>, options?: Options<$Shape<T>>): Decorator
} 
