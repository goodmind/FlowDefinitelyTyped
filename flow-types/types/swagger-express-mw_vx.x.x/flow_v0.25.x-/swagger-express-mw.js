declare module "swagger-express-mw" {
  import type { Config, ConnectMiddleware } from "swagger-node-runner";

  declare export { Config, ConnectMiddleware } from "swagger-node-runner";
  ...
  declare export function create(
    config: Config,
    cb: (err: Error | void, runner: ConnectMiddleware) => void
  ): void;
}
