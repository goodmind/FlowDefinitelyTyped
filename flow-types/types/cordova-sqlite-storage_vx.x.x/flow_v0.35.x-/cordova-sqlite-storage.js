...
sqlitePlugin: SQLitePlugin$SQLitePlugin$SQLite
	...
	declare type SQLitePlugin$TransactionFunction = (tx: SQLitePlugin$Transaction) => void;

declare type SQLitePlugin$SuccessCallback = () => void;

declare type SQLitePlugin$DatabaseSuccessCallback = (db: SQLitePlugin$Database) => void;

declare type SQLitePlugin$StatementSuccessCallback = (results: SQLitePlugin$Results) => void;

declare type SQLitePlugin$TransactionStatementSuccessCallback = (tx: SQLitePlugin$Transaction, results: SQLitePlugin$Results) => void;

declare type SQLitePlugin$ErrorCallback = (err: Error) => void;

declare type SQLitePlugin$TransactionStatementErrorCallback = (tx: SQLitePlugin$Transaction, err: Error) => boolean | void;
...
error?: SQLitePlugin$TransactionStatementErrorCallback): void
} 
...
success?: SQLitePlugin$SuccessCallback): void,
readTransaction(
fn: SQLitePlugin$TransactionFunction,
error?: SQLitePlugin$ErrorCallback,
success?: SQLitePlugin$SuccessCallback): void,
...
error?: SQLitePlugin$ErrorCallback): void,
sqlBatch(
...
error?: SQLitePlugin$ErrorCallback): SQLitePlugin$Database,
deleteDatabase(
