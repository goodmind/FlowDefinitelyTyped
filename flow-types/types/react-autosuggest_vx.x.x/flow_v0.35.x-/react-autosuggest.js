declare module 'react-autosuggest' {
	...
	declare class Autosuggest<T> mixins React.Component<Autosuggest$Autosuggest$AutosuggestProps<T>> {}
 ...
 * @internal
 */
declare type Autosuggest$Omit<T, K: $Keys<T>> = Pick<T, $ElementType<($ObjMapi<T, <P>(P) => P> & $ObjMapi<{[k: K]: any}, <P>(P) => empty> & {
[x: string]: empty,
[x: number]: empty
}), $Keys<T>>>;
...
onBlur(event: React.FormEvent<any>, params?: Autosuggest$BlurEvent<TSuggestion>): void,
value: string,
[key: string]: any
...
declare type Autosuggest$ThemeKey = "container"
| "containerOpen"
| "input"
| "inputOpen"
| "inputFocused"
...
declare type Autosuggest$Theme = Record<string, string | React.CSSProperties> | $Shape<Record<Autosuggest$ThemeKey, string | React.CSSProperties>>;
...
declare type Autosuggest$GetSectionSuggestions<TSuggestion> = (section: any) => TSuggestion[];

declare type Autosuggest$GetSuggestionValue<TSuggestion> = (suggestion: TSuggestion) => string;

declare type Autosuggest$OnSuggestionHighlighted = (params: Autosuggest$SuggestionHighlightedParams) => void;

declare type Autosuggest$SuggestionsFetchRequested = (request: Autosuggest$SuggestionsFetchRequestedParams) => void;

declare type Autosuggest$OnSuggestionsClearRequested = () => void;

declare type Autosuggest$OnSuggestionSelected<TSuggestion> = (
event: React.FormEvent<any>,
data: Autosuggest$SuggestionSelectedEventData<TSuggestion>) => void;

declare type Autosuggest$RenderInputComponent<TSuggestion> = (inputProps: Autosuggest$InputProps<TSuggestion>) => React.ReactNode;

declare type Autosuggest$RenderSuggestionsContainer = (params: Autosuggest$RenderSuggestionsContainerParams) => React.ReactNode;

declare type Autosuggest$RenderSectionTitle = (section: any) => React.ReactNode;

declare type Autosuggest$RenderSuggestion<TSuggestion> = (
suggestion: TSuggestion,
params: Autosuggest$RenderSuggestionParams) => React.ReactNode;
