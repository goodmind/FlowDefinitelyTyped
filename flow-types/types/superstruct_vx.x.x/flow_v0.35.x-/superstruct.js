...
[type: string]: CustomType
	...
	declare export type CustomType = (value: any) => boolean | string;
	declare export function isStruct(value: any): boolean

	declare export class Kind  {
constructor(name: string, type: string, validate: (value?: any, data?: any) => any[]): this;
name: string;
type: string;
validate: (value?: any, data?: any) => any[]
}
	declare export var struct: struct;
	declare export interface struct {
(schema: Types, defaults?: {[key: string]: any}, options?: {}): Struct,
 ...
 */
function(
type: (value: any, data?: any) => boolean | string | {[key: string]: any}): Kind,
 ...
 * @throws {StructError}
 */
assert(value: {[key: string]: any}): any,
test(value: {[key: string]: any}): boolean,
validate(value: {[key: string]: any}): [StructError] | [void, any]
} 
	declare export type StructError = {
data: any,
path: string[],
value: any,
reason: any,
...
errors: StructError[]
	...
	declare export function superstruct(config?: Config): struct

	declare export type Type = any;
	declare export interface Types {
[type: string]: Type
} 
    }
