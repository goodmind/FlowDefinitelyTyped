 ...
 */
    ...
    ): Graphviz<GElement, Datum, BaseType, PDatum>;
     ...
     */
    selectWithoutDataPropagation(): Selection<
      GElement,
      Datum,
      PElement,
      PDatum
...
declare module "d3-graphviz" {
  ...
  import type { Selection, BaseType, ValueFn } from "d3-selection";
   ...
   */
  declare export interface Graphviz<
    GElement: BaseType,
    Datum,
    PElement: BaseType,
    PDatum
