...
verified?: boolean
	...
	declare export type UnsignedUpTo12 = 0
| 1
| 2
| 3
| 4
...
| 11
| 12;
	declare export type SignedUpTo12 = -12
| -11
| -10
| -9
| -8
...
onTouch: (
args: {
event: React.SyntheticEvent<React.MouseEvent<HTMLDivElement>> | React.SyntheticEvent<React.KeyboardEvent<HTMLDivElement>>
}) => void,
children?: React.ReactNode,
fullHeight?: boolean,
fullWidth?: boolean,
...
volume: number
	...
	declare export class GroupAvatar mixins React.Component<GroupAvatarProps, any> {}
	...
	declare export class IconButton mixins React.Component<IconButtonProps, any> {}
	...
	declare export class RadioButton mixins React.Component<RadioButtonProps, any> {}
	declare export class SearchField mixins React.Component<SearchFieldProps, any> {}
	declare export class SegmentedControl mixins React.Component<SearchFieldProps, any> {}
	declare export class SelectList mixins React.Component<SelectListProps, any> {}
