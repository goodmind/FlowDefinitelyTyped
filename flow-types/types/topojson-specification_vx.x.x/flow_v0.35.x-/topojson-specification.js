...
bbox?: GeoJSON.BBox
	...
	declare export type Topology<T: Objects<Properties>> = {
type: "Topology",
objects: T,
arcs: Arc[],
transform?: Transform
...
properties?: P
	...
	declare export type GeometryObject<P: Properties> = Point<P>
| MultiPoint<P>
| LineString<P>
| MultiLineString<P>
| Polygon<P>
...
type: null
	...
	declare export type OrNull<T: Objects> = $ObjMapi<T, <P>(P) => $ElementType<T, P> | NullObject>;
    }
