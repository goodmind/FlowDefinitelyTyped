declare module 'libxslt' {
	...
	import type {
          ApplyCallback,ApplyResult,ApplyStringCallback,OutputFormat,ParseCallback
        } from './internal-types';
...
apply(source: xmljs.Document, params?: {[key: string]: any}): xmljs.Document,
applyToFile(
sourcePath: string,
params: {[key: string]: any},
options: ApplyOptions,
...
applyToFile(sourcePath: string, callback: ApplyStringCallback): void
	...
	declare export function parse(source: string | xmljs.Document, callback: ParseCallback): void
