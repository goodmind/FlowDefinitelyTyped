...
declare module "phonegap-nfc" {
  ...
  declare var nfc: PhoneGapNfc$PhoneGapNfc$Nfc;
  declare var ndef: PhoneGapNfc$PhoneGapNfc$Ndef;
  declare var util: PhoneGapNfc$PhoneGapNfc$Util;
}
