declare module "jest-each" {
  ...
  declare type JestEach$TestCallback =
    | JestEach$SyncCallback
    | JestEach$AsyncCallback;

  declare type JestEach$TestFn = (
    name: string,
    fn: JestEach$TestCallback
  ) => void;

  declare type JestEach$DescribeFn = (
    name: string,
    fn: JestEach$SyncCallback
  ) => void;
