...
contextAttributes?: WebGLContextAttributes): WebGL2RenderingContext | null
} & HTMLElement
...
format: number,
type: number,
source: ImageData | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement): void,
texImage2D(
target: number,
level: number,
internalformat: number,
...
uniformBlockBinding: number): void,
