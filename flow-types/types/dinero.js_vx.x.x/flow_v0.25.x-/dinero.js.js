declare module "dinero.js" {
  ...
  declare function DineroFactory$normalizePrecision(
    objects: DineroFactory$Dinero[]
  ...
  declare interface DineroFactory$Dinero {
    ...
    convert(
      currency: string,
      options?: DineroFactory$ExchangeRatesApiOptions
    ): Promise<DineroFactory$Dinero>;
  ...
  declare type DineroFactory$RoundingMode =
    | "HALF_ODD"
    | "HALF_EVEN"
    | "HALF_UP"
    | "HALF_DOWN"
