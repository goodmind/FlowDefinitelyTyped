declare module 'auth0-js' {
        declare export class Authentication  {
constructor(options: AuthOptions): this;
 ...
 */
getUserCountry(callback: Auth0Callback<{
countryCode: string
}>): void
}
	declare export class PasswordlessAuthentication  {
constructor(request: any, option: any): this;
...
verify(options: PasswordlessVerifyOptions, callback: Auth0Callback<any>): void
	...
	declare export class DBConnection  {
constructor(request: any, option: any): this;
...
userId: string,
userMetadata: any,
callback: Auth0Callback<Auth0UserProfile>): void;
...
callback: Auth0Callback<Auth0DecodedHash | null, Auth0ParseHashError>): void;
...
constructor(client: any, options: any): this;
...
callback: Auth0Callback<any>): void;
...
callback: Auth0Callback<any>): void
	...
	declare export class CrossOriginAuthentication  {
constructor(webAuth: any, options: any): this;
...
callback(): void
	...
	declare export type Auth0Callback<T, E> = (error: null | E, result: T) => void;
	declare export interface TokenProvider {
enableCache?: boolean,
cacheTTLInSeconds?: number
} 
	declare export interface ManagementOptions {
domain: string,
token?: string,
clientId?: string,
clientSecret?: string,
...
_telemetryInfo?: any
	...
	declare export interface PasswordlessAuthOptions {
connection: string,
verificationCode: string,
phoneNumber: string,
email: string
 ...
 */
declare export type LibErrorCodes = "timeout" | "request_error" | "invalid_token";
	
/**
 * The user was not logged in at Auth0, so silent authentication is not possible.
 */
declare export type LoginRequiredErrorCode = "login_required";
 ...
 */
declare export type InteractionRequiredErrorCode = "interaction_required";
	
/**
 * The user was logged in at Auth0, but needs to give consent to authorize the application.
 */
declare export type ConsentRequiredErrorCode = "consent_required";
	
/**
 * These are error codes defined by the OpenID Connect specification.
 */
declare export type SpecErrorCodes = LoginRequiredErrorCode
...
| "registration_not_supported";
	declare export interface Auth0Error {
error: LibErrorCodes | SpecErrorCodes | string,
errorDescription: string
} 
	declare export type Auth0ParseHashError = Auth0Error & {
state?: string
};
 ...
 */
declare export interface Auth0DecodedHash {
accessToken?: string,
idToken?: string,
idTokenPayload?: any,
appState?: any,
 ...
 */
declare export interface Auth0DelegationToken {
...
password?: string
	...
	declare export interface PasswordlessStartOptions {
connection: string,
send: string,
phoneNumber?: string,
email?: string,
authParams?: any
	...
	declare export interface PasswordlessVerifyOptions {
connection: string,
verificationCode: string,
phoneNumber?: string,
email?: string,
send?: string
	...
	declare export interface PasswordlessLoginOptions {
connection: string,
verificationCode: string,
phoneNumber?: string,
email?: string
} 
	declare export interface Auth0UserProfile {
name: string,
nickname: string,
picture: string,
user_id: string,
...
app_metadata?: any
	...
	declare export type MicrosoftUserProfile = {
emails?: string[]
} & Auth0UserProfile

	declare export type Office365UserProfile = {
tenantid: string,
upn: string
} & Auth0UserProfile

	declare export type AdfsUserProfile = {
issuer?: string
} & Auth0UserProfile

	declare export interface Auth0Identity {
connection: string,
isSocial: boolean,
provider: string,
user_id: string
} 
	declare export interface LoginOptions {
username: string,
password: string,
scope?: string
} 
	declare export type DefaultLoginOptions = {
audience?: string,
realm: string
} & LoginOptions

	declare export type DefaultDirectoryLoginOptions = {
audience?: string
} & LoginOptions

	declare export type ResourceOwnerLoginOptions = {
connection: string,
device?: string
} & LoginOptions

	declare export interface CrossOriginLoginOptions {
username?: string,
email?: string,
password: string,
realm?: string
} 
	declare export interface LogoutOptions {
clientID?: string,
returnTo?: string,
federated?: boolean
} 
	declare export interface DelegationOptions {
client_id?: string,
grant_type: string,
id_token?: string,
...
api_type?: string
	...
	declare export interface DbSignUpOptions {
email: string,
password: string,
connection: string,
scope?: string,
user_metadata?: any
	...
	declare export interface ParseHashOptions {
hash?: string,
state?: string,
nonce?: string,
_idTokenVerification?: boolean
} 
	declare export interface RenewAuthOptions {
...
approvalPrompt?: string
	...
	declare export type CheckSessionOptions = {
