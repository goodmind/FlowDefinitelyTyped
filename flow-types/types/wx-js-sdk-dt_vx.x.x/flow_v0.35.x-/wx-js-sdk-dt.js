 ...
 * @deprecated
 */
declare function wx$onMenuShareTimeline(setting: wx$ShareTimelineConfig): void
 ...
 * @param config
 */
declare function wx$updateAppMessageShareData(wx$config: wx$ShareToUserConfig): void
 ...
 * @param config
 */
declare function wx$updateTimelineShareData(wx$config: wx$ShareToTimelineConfig): void
 ...
 */
declare function wx$getLocalImgData(wx$config: wx$GetLocalImgDataConfig): void
 ...
 * 停止录音
 */
declare function wx$stopRecord(success: (res: {
localId: string
}) => void): void
 ...
 */
declare function wx$onVoiceRecordEnd(complete: (res: {
localId: string
}) => void): void
 ...
 * 停止播放后的回调
 */
declare function wx$onVoicePlayEnd(success: (res: {
localId: string
}) => void): void
 ...
 */
declare function wx$getNetworkType(success: (res: {
networkType: string
}) => void): void
 ...
 * 开启查找周边 ibeacon 设备接口
 */
declare function wx$startSearchBeacons(wx$config: wx$StartSearchBeaconsConfig): void
 ...
 * 关闭查找完成后的回调函数
 */
declare function wx$stopSearchBeacons(wx$config: wx$StopSearchBeaconsConfig): void
 ...
 */
declare function wx$onSearchBeacons(wx$config: wx$OnSearchBeaconsConfig): void
 ...
 * 跳转微信商品页接口
 */
declare function wx$openProductSpecificView(wx$config: wx$OpenProductSpecificViewConfig): void
