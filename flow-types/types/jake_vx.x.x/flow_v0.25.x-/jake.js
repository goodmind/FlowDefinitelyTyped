declare module "jake" {
   ...
   */
  declare export function jake$mkdirP(
    name: string,
    mode?: string,
   ...
   */
  declare export function jake$readdirR(
    name: string,
    opts?: jake$UtilOptions
  ): string[];
   ...
   */
  declare export function jake$rmRf(
    name: string,
    opts?: jake$UtilOptions
  ): void;
  ...
  declare export function jake$exec(
    cmds: string[],
    callback?: () => void,
    opts?: jake$ExecOptions
  ): void;
  ...
  declare export function jake$createExec(
    cmds: string[],
    callback?: () => void,
    opts?: jake$ExecOptions
  ): jake$Exec;
