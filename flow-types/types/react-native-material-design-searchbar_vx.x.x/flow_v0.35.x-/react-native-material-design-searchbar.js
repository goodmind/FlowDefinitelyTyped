declare module 'react-native-material-design-searchbar' {
	...
	import type {
          TextInputProps,ReturnKeyType,ReturnKeyTypeAndroid,TextStyle,ReturnKeyTypeIOS
        } from 'react-native';
...
onBackPress(): void
	...
	declare export default class SearchBar mixins React.Component<SearchBarProps, any> {}
    }
