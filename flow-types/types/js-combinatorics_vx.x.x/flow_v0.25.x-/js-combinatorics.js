declare module "js-combinatorics" {
   ...
   */
  declare function __Combinatorics$power<T>(
    a: T[]
   ...
   */
  declare function __Combinatorics$combination<T>(
    a: T[],
    n?: number
   ...
   */
  declare function __Combinatorics$bigCombination<T>(
    a: T[],
    n?: number
  ): __Combinatorics$IGenerator<T[]>;
   ...
   * `n` defaults to the length of `a`.
   */
  declare function __Combinatorics$permutation<T>(
    a: T[],
    n?: number
  ): __Combinatorics$IGenerator<T[]>;
   ...
   */
  declare function __Combinatorics$permutationCombination<T>(
    a: T[]
  ): __Combinatorics$IGenerator<T[]>;
   ...
   * `n` defaults to the length of `a`.
   */
  declare function __Combinatorics$baseN<T>(
    a: T[],
    n?: number
  ): __Combinatorics$IPredictableGenerator<T[]>;
   ...
   */
  declare function __Combinatorics$cartesianProduct<T1>(
    a1: T1[]
  ): __Combinatorics$ICartesianProductGenerator<[T1]>;

  declare function __Combinatorics$cartesianProduct<T1, T2>(
    a1: T1[],
    a2: T2[]
  ): __Combinatorics$ICartesianProductGenerator<[T1, T2]>;

  declare function __Combinatorics$cartesianProduct<T1, T2, T3>(
    a1: T1[],
    a2: T2[],
    a3: T3[]
  ): __Combinatorics$ICartesianProductGenerator<[T1, T2, T3]>;
  ...
  declare function __Combinatorics$cartesianProduct<T1, T2, T3, T4>(
    ...
    a3: T3[],
    a4: T4[]
  ): __Combinatorics$ICartesianProductGenerator<[T1, T2, T3, T4]>;
  ...
  declare function __Combinatorics$cartesianProduct<T1, T2, T3, T4, T5>(
    ...
    a4: T4[],
    a5: T5[]
  ): __Combinatorics$ICartesianProductGenerator<[T1, T2, T3, T4, T5]>;
  ...
  declare function __Combinatorics$cartesianProduct<T1, T2, T3, T4, T5, T6>(
    ...
    a5: T5[],
    a6: T6[]
  ): __Combinatorics$ICartesianProductGenerator<[T1, T2, T3, T4, T5, T6]>;
  ...
  declare function __Combinatorics$cartesianProduct<T1, T2, T3, T4, T5, T6, T7>(
    ...
    a6: T6[],
    a7: T7[]
  ): __Combinatorics$ICartesianProductGenerator<[T1, T2, T3, T4, T5, T6, T7]>;

  declare function __Combinatorics$cartesianProduct<
    T1,
    T2,
    T3,
    T4,
  ...
  >(
    ...
    a7: T7[],
    a8: T8[]
  ): __Combinatorics$ICartesianProductGenerator<
