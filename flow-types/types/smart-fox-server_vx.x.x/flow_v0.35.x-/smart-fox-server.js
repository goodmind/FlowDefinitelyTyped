...
| Requests$Game.Game$CreateSFSGameRequest
| Requests$System.System$FindRoomsRequest
| Requests$System.System$FindUsersRequest, value: any): this;
...
declare export class Variables$MMOItemVariable mixins Variables$SFSUserVariable {
...
declare export class Variables$SFSBuddyVariable mixins Variables$SFSUserVariable {
...
declare export class Variables$SFSRoomVariable mixins Variables$SFSUserVariable {
 ...
 */
getMyVariable(varName: string): Entities$Variables.Variables$SFSBuddyVariable;
 ...
 */
constructor(message: string, targetBuddy: Entities$Entities$SFSBuddy, parms?: Object): this
}
 ...
 */
constructor(buddyVariables: Entities$Variables.Variables$SFSBuddyVariable[]): this
}
 ...
 */
constructor(invitedUsers: Entities$Entities$SFSUser[], secondsForAnswer: number, params?: Object): this
}
 ...
 */
constructor(whereToSearch: Entities$Entities$SFSRoom[], roomToLeave?: Entities$Entities$SFSRoom): this;
 ...
 * @param {Entities$Entities$SFSRoom} roomToLeave A SFSRoom object representing the Room that the user should leave when joining the game.
 */
constructor(matchExpression: Entities$Match.Match$MatchExpression, whereToSearch: Entities$Entities$SFSRoom[], roomToLeave?: Entities$Entities$SFSRoom): this
}
 ...
 */
constructor(lowerLimit: Entities$Data.Data$Vec3D, higherLimit: Entities$Data.Data$Vec3D): this
}
 ...
 */
constructor(pos: Entities$Data.Data$Vec3D, targetRoom?: Entities$Entities$MMORoom): this
}
 ...
 */
constructor(room: Entities$Entities$SFSRoom, newMaxUsers: number, newMaxSpect: number): this
}
 ...
 */
constructor(settings: Requests$RoomSettings, autoJoin?: boolean, roomToLeave?: Entities$Entities$SFSRoom): this
}
 ...
 */
constructor(extCmd: string, params?: Object, room?: Entities$Entities$SFSRoom): this
}
 ...
 */
constructor(expr: Entities$Match.Match$MatchExpression, groupId?: string, limit?: number): this
}
 ...
 */
constructor(expr: Entities$Match.Match$MatchExpression, target?: any, limit?: number): this
}
 ...
 */
constructor(obj: Object, targetRoom?: Entities$Entities$SFSRoom, recipients?: Entities$Entities$SFSUser[]): this
}
 ...
 * @param {Entities$Entities$SFSRoom} targetRoom The SFSRoom object corresponding to the Room where the message should be dispatched; if null, the last Room joined by the user is used.
 */
constructor(message: string, params?: Object, targetRoom?: Entities$Entities$SFSRoom): this
}
 ...
 */
constructor(roomVariables: Entities$Variables.Variables$SFSRoomVariable[], room: Entities$Entities$SFSRoom): this
}
 ...
 */
constructor(userVariables: Entities$Variables.Variables$SFSUserVariable): this
}
 ...
 */
send(
request: Requests$BuddyList.BuddyList$AddBuddyRequest
| Requests$BuddyList.BuddyList$BlockBuddyRequest
| Requests$BuddyList.BuddyList$BuddyMessageRequest
| Requests$BuddyList.BuddyList$GoOnlineRequest
| Requests$BuddyList.BuddyList$InitBuddyListRequest
...
| Requests$System.System$SpectatorToPlayerRequest
| Requests$System.System$SubscribeRoomGroupRequest
| Requests$System.System$UnsubscribeRoomGroupRequest): void;
