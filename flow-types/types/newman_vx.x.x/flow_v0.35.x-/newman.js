declare module 'newman' {
	...
	import type {
          Collection,CollectionDefinition,VariableScope,VariableScopeDefinition
        } from 'postman-collection';

	declare export interface NewmanRunOptions {
...
sslClientPassphrase?: string
	...
	declare export interface NewmanRunSummary {
error?: any,
collection: any,
environment: any,
globals: any,
run: NewmanRun
	...
	declare export interface NewmanRun {
stats: {
...
executions: NewmanRunExecution[]
	...
	declare export interface NewmanRunStat {
total?: number,
failed?: number,
pending?: number
} 
	declare export interface NewmanRunExecution {
item: NewmanRunExecutionItem,
assertions: NewmanRunExecutionAssertion[]
} 
	declare export interface NewmanRunExecutionItem {
name: string
} 
	declare export interface NewmanRunExecutionAssertion {
assertion: string,
error: NewmanRunExecutionAssertionError
} 
	declare export interface NewmanRunExecutionAssertionError {
name: string,
index: number,
test: string,
message: string,
stack: string
	...
	declare export interface NewmanRunFailure {
error: NewmanRunExecutionAssertionError,
...
callback?: (err: Error | null, summary: NewmanRunSummary) => void): EventEmitter
