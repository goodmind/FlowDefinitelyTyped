 ...
 */
define(resourceId: string, requestType: string, settings?: amplify$AjaxSettings): void,
...
define(
resourceId: string,
resource: (settings: amplify$RequestSettings) => void): void,
