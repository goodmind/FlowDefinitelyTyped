...
res: ServerResponse,
next: MiddlewareNextFunction) => void;
...
clientId: string,
redirectURI: string,
validated: (err: Error | null, client?: any, redirectURI?: string) => void) => void;
...
areq: any,
	...
	declare export type DecisionParseFunction = (req: MiddlewareRequest, done: (err: Error | null, params: any) => void) => void;
	declare export type SerializeClientFunction = (client: any, done: SerializeClientDoneFunction) => void;
	declare export type SerializeClientDoneFunction = (err: Error | null, id: string) => void;
	declare export type DeserializeClientFunction = (id: string, done: DeserializeClientDoneFunction) => void;
	declare export type DeserializeClientDoneFunction = (err: Error | null, client?: any | boolean) => void;
	declare export type IssueGrantCodeFunction = (
client: any,
redirectUri: string,
user: any,
res: any,
issued: (err: Error | null, exchange$code?: string) => void) => void;
	declare export type IssueGrantTokenFunction = (
client: any,
user: any,
ares: any,
issued: (err: Error | null, exchange$code?: string, params?: any) => void) => void;
	declare export type IssueExchangeCodeFunction = (
client: any,
exchange$code: string,
redirectURI: string,
issued: ExchangeDoneFunction) => void;
...
immediate?: ImmediateFunction): MiddlewareFunction;
...
declare function grant$code(options: grant$Options, issue: IssueGrantCodeFunction): MiddlewareFunction


declare function grant$code(issue: IssueGrantCodeFunction): MiddlewareFunction


declare function grant$token(options: grant$Options, issue: IssueGrantTokenFunction): MiddlewareFunction


declare function grant$token(issue: IssueGrantTokenFunction): MiddlewareFunction
...
issue: IssueExchangeCodeFunction): MiddlewareFunction


declare function exchange$authorizationCode(issue: IssueExchangeCodeFunction): MiddlewareFunction
...
declare function exchange$code(issue: IssueExchangeCodeFunction): MiddlewareFunction
...
body: any,
authInfo: any,
issued: ExchangeDoneFunction) => void): MiddlewareFunction


declare function exchange$clientCredentials(
options: exchange$Options,
issue: (client: any, scope: string[], body: any, issued: ExchangeDoneFunction) => void): MiddlewareFunction


declare function exchange$clientCredentials(
options: exchange$Options,
issue: (client: any, scope: string[], issued: ExchangeDoneFunction) => void): MiddlewareFunction


declare function exchange$clientCredentials(
options: exchange$Options,
issue: (client: any, issued: ExchangeDoneFunction) => void): MiddlewareFunction
...
declare function exchange$clientCredentials(issue: (client: any, issued: ExchangeDoneFunction) => void): MiddlewareFunction
