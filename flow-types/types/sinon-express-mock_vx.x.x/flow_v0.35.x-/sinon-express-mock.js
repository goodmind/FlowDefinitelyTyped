...
vary: SinonStub
	...
	declare export function mockReq<T: {[key: string]: any}>(options?: T): mockReq$mockReq$MockReq & T & Request

	declare export function mockRes<T: {[key: string]: any}>(options?: T): mockRes$mockRes$MockRes & T & Response
