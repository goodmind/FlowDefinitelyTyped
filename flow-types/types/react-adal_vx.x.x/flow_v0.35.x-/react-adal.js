declare module 'react-adal' {
	...
	declare export type TokenCallback = (errorDesc: string | null, token: string | null, error: any) => void;
	declare export type UserCallback = (errorDesc: string | null, user: UserInfo | null) => void;
	declare export interface AdalConfig {
...
callback?: TokenCallback
	...
	declare export type LoggingLevel = 0 | 1 | 2 | 3;
...
valid: boolean
	...
	declare export type RequestType = "LOGIN" | "RENEW_TOKEN" | "UNKNOWN";
	declare export type ResponseType = "id_token token" | "token";
	declare export interface UserInfo {
...
POPUP_HEIGHT: 600
	...
	declare export class AuthenticationContext  {
instance: string;
config: AdalConfig;
callback: TokenCallback;
popUp: boolean;
...
CONSTANTS: Constants;
constructor(options: AdalConfig): this;
 ...
 */
declare export function adalGetToken(
authContext: AuthenticationContext,
resourceUrl: string): Promise<string | null>
 ...
 */
declare export function adalFetch(
authContext: AuthenticationContext,
resource: string,
 ...
 *
 */
declare export function runWithAdal(authContext: AuthenticationContext, app: () => void, doNotLogin: boolean): void
 ...
 * @param resource Resource GUID ot URI identifying the target resource.
 */
declare export function withAdalLogin(
authContext: AuthenticationContext,
resource: string): (
wrappedComponent: React.ComponentClass | React.StatelessComponent,
renderLoading: () => JSX.Element | null,
renderError: (error: any) => JSX.Element | null) => React.ComponentClass
