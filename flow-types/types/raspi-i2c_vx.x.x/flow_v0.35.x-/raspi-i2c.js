declare module 'raspi-i2c' {
	...
	declare export type ReadCallback = (err: null | Error | string, data: null | Buffer | number) => void;
...
readSync(address: number, registerOrLength: number | void, length?: number): Buffer;
