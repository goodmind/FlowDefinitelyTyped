...
line: string[] | any,
encoding?: string,
cb?: (error: Error | void, output: string) => void): boolean,
write(
 ...
 */
declare function stringify(opts?: stringify$stringify$StringifyOpts): stringify$stringify$Stringifier
...
callback: (error: Error | void, output: string) => void): void
