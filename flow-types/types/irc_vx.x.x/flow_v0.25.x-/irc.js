 ...
 */
declare export function colors$wrap(
  color: string,
  text: string,
  reset_color?: string
): string;
...
declare export class NodeIRC$Client mixins events.EventEmitter {
  ...
  join(
    channel: string,
    callback?: NodeIRC$handlers.handlers$IJoinChannel
  ): void;
  ...
  part(
    channel: string,
    message: string,
    callback: NodeIRC$handlers.handlers$IPartChannel
  ): void;
   ...
   * @param callback
   */
  whois(nick: string, callback: NodeIRC$handlers.handlers$IWhois): void;
   ...
   */
  connect(
    retryCount?: number | NodeIRC$handlers.handlers$IRaw,
    callback?: NodeIRC$handlers.handlers$IRaw
  ): void;
 ...
 */
export interface NodeIRC$IClientOpts {
  /**
   * IRC username
   * @default 'nodebot'
   */
...
declare export class NodeIRC$CommandType {
  ...
  static +normal: Class<NodeIRC$CommandType__normal> &
    NodeIRC$CommandType__normal &
    0; // 0
  static +reply: Class<NodeIRC$CommandType__reply> &
    NodeIRC$CommandType__reply &
    1; // 1
  static +error: Class<NodeIRC$CommandType__error> &
    NodeIRC$CommandType__error &
    2; // 2
}
 ...
 * Parsed IRC message.
 */
export interface NodeIRC$IMessage {
  /**
   * Prefix
   */
  prefix?: string;
 ...
 * Whois data
 */
export interface NodeIRC$IWhoisData {
  /**
   * Nickname
   */
  nick: string;
 ...
 */
export interface NodeIRC$IChannel {
  /**
   * Channel name
   */
  name: string;
 ...
 */
export interface handlers$IRegistered {
  /**
 ...
 * clients.
 */
export interface handlers$IMotd {
  /**
 ...
 * channel.
 */
export interface handlers$INames {
  /**
 ...
 * channel.
 */
export interface handlers$INamesChannel {
  /**
   * @param channel - channel name
   * @param nicks - nicks list
   */
 ...
 */
export interface handlers$ITopic {
  /**
   * @param channel - channel name
   * @param topic - topic
   * @param nick - nick
 ...
 * message object.
 */
export interface handlers$IJoin {
  /**
   * @param channel - channel name
 ...
 */
export interface handlers$IJoinChannel {
  /**
   * @param nick - who joined
   * @param message - raw message
   */
 ...
 * message object.
 */
export interface handlers$IPart {
  /**
   * @param channel - channel name
 ...
 * channel. See the raw event for details on the message object.
 */
export interface handlers$IPartChannel {
  /**
   * @param nick - who parted
   * @param reason - part reason
   * @param message - raw message
 ...
 */
export interface handlers$IKick {
  /**
   * @param channel - channel name
 ...
 * event for details on the message object.
 */
export interface handlers$IKickChannel {
  /**
   * @param nick - who was kicked
   * @param by - kicker
   * @param reason - kick reason
 ...
 * event for details on the message object.
 */
export interface handlers$IRecievedMessage {
  /**
 ...
 */
export interface handlers$IMessageAllChannels {
  /**
   * @param nick - who sent the message
   * @param to - to whom was the message sent
   * @param text - message text
 ...
 * object.
 */
export interface handlers$IMessageChannel {
  /**
   * @param nick - who sent the message
   * @param text - message text
   * @param message - raw message
 ...
 */
export interface handlers$ISelfMessage {
 ...
 */
export interface handlers$INotice {
  /**
   * @param nick - from
   * @param to - to
   * @param text - text
 ...
 */
export interface handlers$IPing {
  /**
 ...
 */
export interface handlers$ICtcp {
  /**
   * @param from - sender
   * @param to - recievier
 ...
 * recieved.
 */
export interface handlers$ICtcpSpecific {
  /**
   * @param from - sender
   * @param to - recievier
   * @param message - raw message
 ...
 * object.
 */
export interface handlers$INick {
  /**
 ...
 * raw event for details on the message object.
 */
export interface handlers$IInvite {
  /**
 ...
 * event for details on the message object.
 */
export interface handlers$IModeChange {
  /**
 ...
 * response.
 */
export interface handlers$IWhois {
 ...
 */
export interface handlers$IChannelList {
  /**
   * @param list - channels
   */
 ...
 */
export interface handlers$IRaw {
  /**
   * @param message - raw message
   */
  (message: NodeIRC$IMessage): void;
 ...
 */
export interface handlers$IError {
  /**
   * @param message - raw message
   */
  (message: NodeIRC$IMessage): void;
 ...
 * (e.g. /me waves).
 */
export interface handlers$IAction {
  /**
   * @param from - sender
   * @param to - reciever
   * @param text - text
