 ...
 * @param callback
 */
join(channel: string, callback?: handlers$handlers$IJoinChannel): void;
...
channel: string,
message: string,
callback: handlers$handlers$IPartChannel): void;
 ...
 * @param callback
 */
whois(nick: string, callback: handlers$handlers$IWhois): void;
 ...
 */
connect(
retryCount?: number | handlers$handlers$IRaw,
callback?: handlers$handlers$IRaw): void;
 ...
 * Command types
 */
declare export  class NodeIRC$CommandType {
  constructor(...args: empty): mixed;
static +normal: Class<NodeIRC$CommandType__normal> & NodeIRC$CommandType__normal & 0;// 0
static +reply: Class<NodeIRC$CommandType__reply> & NodeIRC$CommandType__reply & 1;// 1
static +error: Class<NodeIRC$CommandType__error> & NodeIRC$CommandType__error & 2;// 2

}

declare class NodeIRC$CommandType__normal mixins NodeIRC$CommandType {}
declare class NodeIRC$CommandType__reply mixins NodeIRC$CommandType {}
declare class NodeIRC$CommandType__error mixins NodeIRC$CommandType {}
 ...
 * Command type
 */
commandType: NodeIRC$CommandType,
 ...
 */
declare export interface handlers$IRegistered {
 ...
 * clients.
 */
declare export interface handlers$IMotd {
 ...
 * channel.
 */
declare export interface handlers$INames {
 ...
 * channel.
 */
declare export interface handlers$INamesChannel {
 ...
 */
declare export interface handlers$ITopic {
 ...
 * @param message - raw message
 */
(channel: string, topic: string, nick: string, message: NodeIRC$IMessage): void
} 
 ...
 * message object.
 */
declare export interface handlers$IJoin {
 ...
 */
declare export interface handlers$IJoinChannel {
 ...
 * message object.
 */
declare export interface handlers$IPart {
 ...
 * @param message - raw message
 */
(channel: string, nick: string, reason: string, message: NodeIRC$IMessage): void
} 
 ...
 * channel. See the raw event for details on the message object.
 */
declare export interface handlers$IPartChannel {
 ...
 */
declare export interface handlers$IKick {
 ...
 * @param message - raw message
 */
(channel: string, nick: string, by: string, reason: string, message: NodeIRC$IMessage): void
} 
 ...
 * event for details on the message object.
 */
declare export interface handlers$IKickChannel {
 ...
 * event for details on the message object.
 */
declare export interface handlers$IRecievedMessage {
 ...
 */
declare export interface handlers$IMessageAllChannels {
 ...
 * object.
 */
declare export interface handlers$IMessageChannel {
 ...
 */
declare export interface handlers$ISelfMessage {
 ...
 */
declare export interface handlers$INotice {
 ...
 */
declare export interface handlers$IPing {
 ...
 * object.
 */
declare export interface handlers$IPm {
 ...
 */
declare export interface handlers$ICtcp {
 ...
 * @param message - raw message
 */
(from: string, to: string, text: string, type: string, message: NodeIRC$IMessage): void
} 
 ...
 * recieved.
 */
declare export interface handlers$ICtcpSpecific {
 ...
 * object.
 */
declare export interface handlers$INick {
 ...
 * @param message - raw message
 */
(oldnick: string, newnick: string, channels: string[], message: NodeIRC$IMessage): void
} 
 ...
 * raw event for details on the message object.
 */
declare export interface handlers$IInvite {
 ...
 * event for details on the message object.
 */
declare export interface handlers$IModeChange {
 ...
 * @param message - raw message
 */
(channel: string, by: string, mode: string, argument: string, message: NodeIRC$IMessage): void
} 
 ...
 * response.
 */
declare export interface handlers$IWhois {
 ...
 */
declare export interface handlers$IChannelList {
 ...
 */
declare export interface handlers$IRaw {
 ...
 */
declare export interface handlers$IError {
 ...
 * (e.g. /me waves).
 */
declare export interface handlers$IAction {
...
(from: string, to: string, text: string, message: NodeIRC$IMessage): void
      ...
      declare var npm$namespace$colors: {
        wrap: typeof colors$wrap,
        codes: typeof colors$codes,
      }
 ...
 */
declare export function colors$wrap(color: string, text: string, reset_color?: string): string
 ...
 * text in a color.
 */
declare export var colors$codes: {
[index: string]: string
};
