 ...
 */
declare export type ValueType = Node
| Date
| string
| number
| boolean
 ...
 */
constructor(subject: ValueType, predicate: ValueType, object: ValueType, DataFactory$graph: ValueType): this;
...
n3String: string,
jsonCallback: (err: string, jsonString: string) => void): void
...
n3String: string,
nquadCallback: (err: string, nquadString: string) => void): void
 ...
 * @param optional
 */
constructor(statements: $ReadOnlyArray<Statement>, constraints: $ReadOnlyArray<any>, initBindings: {
[id: string]: Node
}, optional: $ReadOnlyArray<any>): this;
...
subject: Node,
doc: ValueType,
excludePredicateURIs: $ReadOnlyArray<string>): Statement[];
...
predicate: ValueType,
object: ValueType,
DataFactory$graph: ValueType): Statement[];
...
predicate: ValueType,
object: ValueType,
DataFactory$graph: ValueType): void;
 ...
 */
declare function DataFactory$collection(elements: $ReadOnlyArray<ValueType>): Collection
 ...
 */
declare function DataFactory$lit(val: string, lang: string, dt: NamedNode): Literal
 ...
 */
declare function DataFactory$literal(value: string, languageOrDatatype: string | NamedNode): Literal
...
predicate: Node,
object: Node,
DataFactory$graph: Node): Statement
 ...
 * @param object The object
 */
declare function DataFactory$triple(subject: Node, predicate: Node, object: Node): Statement
 ...
 * @param requestedBy
 */
declare function Util$AJAR_handleNewTerm(kb: Formula, p: NamedNode, requestedBy: string): Promise<any>
 ...
 * @param dt The datatype
 */
declare export function lit(val: string, lang: string, dt: NamedNode): Literal
 ...
 * @param languageOrDatatype Either the language or the datatype
 */
declare export function literal(value: string, languageOrDatatype: string | NamedNode): Literal
 ...
 * @param object The object
 */
declare export function triple(subject: Node, predicate: Node, object: Node): Statement
...
base: string,
contentType: string,
callback: (log$error: any, kb: Formula) => void): void
