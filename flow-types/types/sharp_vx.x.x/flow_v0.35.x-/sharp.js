...
declare function sharp(options?: sharp$sharp$SharpOptions): sharp$sharp$Sharp
	...
	declare function sharp(input?: string | Buffer, options?: sharp$sharp$SharpOptions): sharp$sharp$Sharp
 ...
 */
declare function sharp$cache(options?: boolean | sharp$CacheOptions): sharp$CacheResult
 ...
 * @returns A sharp instance that can be used to chain operations
 */
overlayWith(image?: string | Buffer, options?: sharp$OverlayOptions): sharp$Sharp,
...
toFile(
fileOut: string,
callback: (err: Error, info: sharp$OutputInfo) => void): sharp$Sharp,
 ...
 */
toBuffer(
callback: (err: Error, buffer: Buffer, info: sharp$OutputInfo) => void): sharp$Sharp,
...
width?: number | null,
height?: number | null,
options?: sharp$ResizeOptions): sharp$Sharp,
