...
cb?: (con: ConnectionType) => void) => reconnect$Instance<ArgType, ConnectionType>;
...
on(event: "reconnect", cb: (n: number, delay: number) => void): this
	...
	declare type ConnectFunction<ArgType, ConnectionType> = (opts: ArgType) => ConnectionType;
	declare function reconnect<ArgType, ConnectionType>(
cf: ConnectFunction<ArgType, ConnectionType>): reconnect$reconnect$CustomModule<ArgType, ConnectionType>
