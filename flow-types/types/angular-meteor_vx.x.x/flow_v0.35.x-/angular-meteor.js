declare module 'angular-meteor' {
	...
	declare module 'angular' {
        declare type meteor$IRootScopeService = {
 ...
 */
loggingIn: boolean
} & angular.meteor$IRootScopeService


declare type meteor$IScope = {
 ...
 */
getReactively(scopeVariableName: string, objectEquality?: boolean): meteor$ReactiveResult,
...
} & angular.meteor$IScope & meteor$IRootScopeService
 ...
 * $meteor in angularjs
 */
declare interface meteor$IMeteorService {
 ...
 */
collection<T>(
collection: Mongo.Collection<T> | meteor$ReactiveResult | Function | (() => T),
autoClientSave?: boolean): meteor$AngularMeteorCollection<T>,
...
updateCollection: Mongo.Collection<U>): meteor$AngularMeteorCollection2<T, U>,
...
autoClientSave?: boolean): meteor$AngularMeteorObject<T>,
 ...
 * @param - A unique name for this user. Either this, or email is required.
 * @param - The user's email address. Either this, or username is required.
 * @param - The user's password. This is not sent in plain text over the wire.
 * @param - The user's profile, typically including the name field.
 */
createUser(
options: {
username?: string,
 ...
 * @param - The email address to send a password reset link.
 */
...
loginWithFacebook: meteor$ILoginWithExternalService,
loginWithTwitter: meteor$ILoginWithExternalService,
loginWithGoogle: meteor$ILoginWithExternalService,
loginWithGithub: meteor$ILoginWithExternalService,
loginWithMeetup: meteor$ILoginWithExternalService,
loginWithWeibo: meteor$ILoginWithExternalService,
 ...
 */
autorun(scope: angular.meteor$IScope, fn: Function): void,
 ...
 * @param - An integer that specifies the minimum width of the returned photo.
 * @param - An integer that specifies the minimum height of the returned photo.
 * @param - A number from 0 to 100 specifying the desired quality of JPEG encoding.
 ...
 */
bind: (scope: meteor$IScope, model: string) => void
}
} 
 ...
 */
declare interface meteor$AngularMeteorObject<T> {
 ...
 */
subscribe(subscriptionName: string): meteor$AngularMeteorObject<T>
} 
 ...
 */
declare type meteor$AngularMeteorCollection<T> = {} & meteor$AngularMeteorCollection2<T, T>
 ...
 */
declare type meteor$AngularMeteorCollection2<T, U> = {
 ...
 * @param subscriptionName - The subscription name to subscribe to. Exactly like the first parameter in $meteor.subscribe service.
 */
subscribe(subscriptionName: string): meteor$AngularMeteorCollection2<T, U>
} & Array<T>


declare interface meteor$ILoginWithExternalService {
(options: Meteor.LoginWithExternalServiceOptions): angular.IPromise<void>
} 

declare interface meteor$ReactiveResult {} 
    }
