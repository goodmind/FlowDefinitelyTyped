...
req: express.Request,
callback: (err: Error, res: RedisRateLimiter$RedisRateLimiter$Response) => void) => void;
static middleware(options: RedisRateLimiter$RedisRateLimiter$Options): express.RequestHandler
}
