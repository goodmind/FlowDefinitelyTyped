 ...
 */
signIn(
options?: auth2$SigninOptions | auth2$SigninOptionsBuilder): Promise<auth2$GoogleUser>;
 ...
 */
grantOfflineAccess(options?: auth2$OfflineAccessOptions): Promise<{
code: string
}>;
...
onfailure: (reason: string) => any): any
}
...
callback: (response: auth2$AuthorizeResponse) => void): void
