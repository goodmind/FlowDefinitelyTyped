declare module "glob-stream" {
  ...
  declare function GlobStream(
    glob: string | string[],
    options: GlobStream$GlobStream$Options
  ...
  declare export type GlobStream$UniqueByStringPredicate =
    | "cwd"
    | "base"
    | "path";

  declare export type GlobStream$UniqueByFunctionPredicate = (
    entry: GlobStream$Entry
  ) => string;
  ...
  declare export type GlobStream$Options = {
     ...
     */
    uniqueBy?:
      | GlobStream$UniqueByStringPredicate
      | GlobStream$UniqueByFunctionPredicate
  } & glob.IOptions;
