declare module "webpack-merge" {
  ...
  declare type webpackMerge$CustomizeArrayFunction = (
    a: any[],
    b: any[],
    key: string
  ) => any[] | null | void;

  declare type webpackMerge$CustomizeObjectFunction = (
    a: {},
    b: {},
    key: string
  ) => {} | null | void;
  ...
  ) => webpackMerge$CustomizeArrayFunction;

  declare interface webpackMerge$CustomizeOptions {
    customizeArray?:
      | webpackMerge$CustomizeArrayFunction
      | webpackMerge$UniqueFunction;
    customizeObject?: webpackMerge$CustomizeObjectFunction;
  }

  declare type webpackMerge$ConfigurationMergeFunction = (
    ...configs: Configuration[]
  ) => Configuration;

  declare type webpackMerge$ConfigurationMergeConfigFunction = (
    customizeOptions: webpackMerge$CustomizeOptions
  ) => webpackMerge$ConfigurationMergeFunction;

  declare type webpackMerge$MergeFunction =
    | webpackMerge$ConfigurationMergeFunction
    | webpackMerge$ConfigurationMergeConfigFunction;
