...
declare type favicons$Callback = (error: Error | null, response: favicons$FavIconResponse) => void;
...
declare function favicons$stream(configuration?: favicons$Configuration): Duplex
...
configuration?: $Shape<favicons$favicons$Configuration>): Promise<favicons$favicons$FavIconResponse>

	declare function favicons(
source: string | Buffer | string[],
callback?: favicons$favicons$Callback): void
