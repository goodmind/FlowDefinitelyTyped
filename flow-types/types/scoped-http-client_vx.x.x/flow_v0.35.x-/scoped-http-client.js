declare module 'scoped-http-client' {
        import type {
          Agent,RequestOptions,IncomingMessage,ClientRequest
        } from 'http';

	declare export type ScopeCallback = (scoped: ScopedClient) => void;
	declare export type RequestCallback = (err: any, request: ClientRequest) => void;
	declare export type ResponseCallback = (
cb?: (err: any, response: IncomingMessage, body: string) => void) => ScopedClient;
