...
declare function Enum$create<T>(
  model: MeteorAstronomy$MeteorAstronomy$EnumModel<T>
): MeteorAstronomy$MeteorAstronomy$Enum<T>;

declare var npm$namespace$Class: {
  create: typeof Class$create
};
declare function Class$create<T: {}>(
  model: MeteorAstronomy$MeteorAstronomy$ClassModel<T>
): MeteorAstronomy$MeteorAstronomy$Class<T>;
