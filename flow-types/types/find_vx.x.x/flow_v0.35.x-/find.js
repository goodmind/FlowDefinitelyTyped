declare module 'find' {
        declare export interface AsyncFindStream {
...
error(callback: (() => void) | ((err: Error) => void)): void
	...
	declare export interface FindEachStream {
 ...
 */
declare export function file(root: string, callback: (files: string[]) => void): AsyncFindStream
...
root: string,
callback: (files: string[]) => void): AsyncFindStream
 ...
 */
declare export function eachfile(root: string, callback: (file: string) => void): FindEachStream
 ...
 * @param callback A callback that accepts an array of the found files
 */
declare export function eachfile(
pattern: string | RegExp,
root: string,
callback: (file: string) => void): FindEachStream
 ...
 */
declare export function fileSync(root: string): string[]
 ...
 * @returns The files that have been found
 */
declare export function fileSync(pattern: string | RegExp, root: string): string[]
 ...
 */
declare export function dir(root: string, callback: (directories: string[]) => void): AsyncFindStream
...
root: string,
callback: (directories: string[]) => void): AsyncFindStream
 ...
 */
declare export function dirSync(root: string): string[]
 ...
 * @returns The directories that have been found
 */
declare export function dirSync(pattern: string | RegExp, root: string): string[]
 ...
 */
declare export function eachdir(root: string, callback: (directory: string) => void): FindEachStream
 ...
 * @param callback A callback that accepts each of the found directories separately
 */
declare export function eachdir(
pattern: string | RegExp,
root: string,
callback: (directory: string) => void): FindEachStream
