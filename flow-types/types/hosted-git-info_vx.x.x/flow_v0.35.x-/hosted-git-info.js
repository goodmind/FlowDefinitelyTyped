...
constructor(host: HostedGitInfo$HostedGitInfo$hosts, user: string | null, auth: string | null, project: string | null, committish: string | null, defaultRepresentation: string, opts?: HostedGitInfo$HostedGitInfo$Options): this;
sshtemplate: string;
...
path: string,
fragment: string,
opts?: HostedGitInfo$HostedGitInfo$FillOptions): string | void;
browse(path: string, opts?: HostedGitInfo$HostedGitInfo$FillOptions): string | void;
...
file(path: string, opts?: HostedGitInfo$HostedGitInfo$FillOptions): string | void;
getDefaultRepresentation(): string;
toString(opts?: HostedGitInfo$HostedGitInfo$FillOptions): string | void;
static fromUrl(gitUrl: string, options?: HostedGitInfo$HostedGitInfo$Options): HostedGitInfo
}
