...
declare type uri$URITemplateValue = string
...
declare type uri$URITemplateCallback = (keyName: string) => uri$URITemplateValue;
...
declare type uri$URITemplatePart = uri$URITemplateLiteral | uri$URITemplateExpression;
...
uri(): uri$uri$URI
} declare var uri$URI: uri$uri$URIStatic;declare var uri$URITemplate: uri$uri$URITemplateStatic;declare module 'URI' {
