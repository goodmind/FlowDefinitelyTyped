 ...
 * @default null
 */
functionInit?: JQueryTooltipster$TooltipsterStandardCallbackFunction,
 ...
 * @default null
 */
functionBefore?: JQueryTooltipster$TooltipsterStandardCallbackFunction,

/**
 * A custom function to be fired when the tooltip and its contents have been added to the DOM.
 * @default null
 */
functionReady?: JQueryTooltipster$TooltipsterStandardCallbackFunction,

/**
 * A custom function to be fired once the tooltip has been closed and removed from the DOM.
 * @default null
 */
functionAfter?: JQueryTooltipster$TooltipsterStandardCallbackFunction,
 ...
 */
functionFormat?: (
instance: JQueryTooltipster$ITooltipsterInstance,
helper: JQueryTooltipster$ITooltipsterHelper,
content: any) => string | JQuery,
...
instance: JQueryTooltipster$ITooltipsterInstance,
helper: JQueryTooltipster$ITooltipsterHelper,
position: JQueryTooltipster$ITooltipPosition) => JQueryTooltipster$ITooltipPosition,
 ...
 */
side?: JQueryTooltipster$TooltipPositioningSide | JQueryTooltipster$TooltipPositioningSide[],
...
declare type JQueryTooltipster$TooltipsterStandardCallbackFunction = (
instance: JQueryTooltipster$ITooltipsterInstance,
helper: JQueryTooltipster$ITooltipsterHelper) => void;

declare interface JQueryTooltipster$ITooltipsterHelper {
origin: HTMLElement,

/**
 * provided on functionReady and open callbacks
 */
tooltip?: HTMLElement | void,
 ...
 * provided on position callback
 */
geo?: JQueryTooltipster$ITooltipsterGeoHelper
} 

declare interface JQueryTooltipster$ITooltipsterGeoHelper {
document: {
size: {
height: number,
width: number
 ...
 */
declare interface JQueryTooltipster$ITooltipPosition {
 ...
 */
side: JQueryTooltipster$TooltipPositioningSide,
...
declare type JQueryTooltipster$TooltipPositioningSide = "top" | "bottom" | "left" | "right";

declare type JQueryTooltipster$TooltipEventName = "init"
| "before"
| "ready"
| "after"
| "format"
 ...
 */
close(callback?: JQueryTooltipster$TooltipsterStandardCallbackFunction): void,
 ...
 */
content(value: any): JQueryTooltipster$ITooltipsterInstance,
...
on(
eventName: string,
callback: (e: JQueryEventObject) => void): JQueryTooltipster$ITooltipsterInstance,
 ...
 */
off(eventName: string): JQueryTooltipster$ITooltipsterInstance,

/**
 * Trigger a Tooltipster's event coming from any instance.
 */
triggerHandler(eventName: string): JQueryTooltipster$ITooltipsterInstance,
 ...
 */
open(
callback?: JQueryTooltipster$TooltipsterStandardCallbackFunction): JQueryTooltipster$ITooltipsterInstance,
 ...
 */
option(optionName: string, optionValue: any): JQueryTooltipster$ITooltipsterInstance,

/**
 * Resizes and repositions the tooltip.
 */
reposition(): JQueryTooltipster$ITooltipsterInstance,
 ...
 */
status(): JQueryTooltipster$ITooltipStatus,
 ...
 */
declare export interface JQueryTooltipster$ITooltipsterJQuery {

/**
 * Activates Tooltipster
 */
(options?: JQueryTooltipster$ITooltipsterOptions): JQuery,

/**
 * Closes the tooltip. When the animation is over, its HTML element is destroyed (definitely removed from the 
 * DOM). The `callback` function argument is optional.
 */
(method: "close", callback?: JQueryTooltipster$TooltipsterStandardCallbackFunction): JQuery,
 ...
 * only the instance of the first will be returned.
 */
(method: "instance"): JQueryTooltipster$ITooltipsterInstance,
 ...
 * is called when the opening animation has ended
 */
(method: "open", callback?: JQueryTooltipster$TooltipsterStandardCallbackFunction): JQuery,
 ...
 * http://iamceege.github.io/tooltipster/#status
 */
(method: "status"): JQueryTooltipster$ITooltipStatus
} 

declare interface JQueryTooltipster$ITooltipsterStatic {

/**
 * all instances of all tooltips present in the page are returned
 */
instances(): JQueryTooltipster$ITooltipsterInstance[],

/**
 * Returns the instances of Tooltipster of all tooltips set on the element(s) matched by the argument.
 */
instances(selector: string | JQuery): JQueryTooltipster$ITooltipsterInstance[],

/**
 * Returns the instances of Tooltipster of all tooltips set on the element(s) matched by the argument.
 */
instances(element: HTMLElement): JQueryTooltipster$ITooltipsterInstance[],

/**
 * Returns the instances of Tooltipster which were generated during the last initializing call.
 */
instancesLatest(): JQueryTooltipster$ITooltipsterInstance[],
...
on(
eventName: string,
callback: (e: JQueryTooltipster$ITooltipEvent) => void): JQueryTooltipster$ITooltipsterStatic,
 ...
 * Handle Tooltipster's `off` event coming from any instance.
 */
off(eventName: string): JQueryTooltipster$ITooltipsterStatic,

/**
 * Trigger a Tooltipster's event coming from any instance.
 */
triggerHandler(eventName: string): JQueryTooltipster$ITooltipsterStatic,
 ...
 */
setDefaults(options: JQueryTooltipster$ITooltipsterOptions): void
} 

declare interface JQueryTooltipster$ITooltipEvent {
instance: JQueryTooltipster$ITooltipsterInstance,
origin: HTMLElement,
event: JQueryEventObject
} 

declare interface JQueryTooltipster$ITooltipStatus {
...
tooltipster: JQueryTooltipster$JQueryTooltipster$ITooltipsterJQuery
} 
	declare interface JQueryStatic {
tooltipster: JQueryTooltipster$JQueryTooltipster$ITooltipsterStatic
} 
    }
