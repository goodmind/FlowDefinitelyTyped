declare module "tooltipster" {
  ...
  declare export interface JQueryTooltipster$ITooltipsterOptions {
    ...
    functionPosition?: (
      instance: JQueryTooltipster$ITooltipsterInstance,
      helper: JQueryTooltipster$ITooltipsterHelper,
      position: JQueryTooltipster$ITooltipPosition
    ) => JQueryTooltipster$ITooltipPosition;
     ...
     */
    side?:
      | JQueryTooltipster$TooltipPositioningSide
      | JQueryTooltipster$TooltipPositioningSide[];
  ...
  declare type JQueryTooltipster$TooltipPositioningSide =
    | "top"
    | "bottom"
    | "left"
    | "right";

  declare type JQueryTooltipster$TooltipEventName =
    | "init"
    | "before"
    | "ready"
    | "after"
  ...
  declare export interface JQueryTooltipster$ITooltipsterInstance {
     ...
     */
    close(
      callback?: JQueryTooltipster$TooltipsterStandardCallbackFunction
    ): void;
  ...
  declare interface JQueryTooltipster$ITooltipsterStatic {
    ...
    on(
      eventName: string,
      callback: (e: JQueryTooltipster$ITooltipEvent) => void
    ): JQueryTooltipster$ITooltipsterStatic;
