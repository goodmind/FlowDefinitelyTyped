...
status?: string
	...
	declare module 'DPA' {
        declare type ViewContentParameters = {
content_type: string,
content_ids: string[]
} & undefined.ViewContentParameters

	declare type AddToCartParameters = {
content_type: string,
content_ids: string[]
} & undefined.AddToCartParameters

	declare type PurchaseParameters = {
content_type: string,
content_ids: string[]
} & undefined.PurchaseParameters
