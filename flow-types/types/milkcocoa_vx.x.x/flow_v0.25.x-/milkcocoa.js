declare module "milkcocoa" {
  declare class milkcocoa$MilkCocoa {
    ...
    addAccount(
      ...
      options?: {},
      callback?: (
        err: milkcocoa$MilkCocoa.Error.Error$AddAccount,
        user: milkcocoa$User
      ) => void
    ): void;
    login(
      ...
      password: string,
      callback: (
        err: milkcocoa$MilkCocoa.Error.Error$Login,
        user: milkcocoa$User
      ) => void
    ): void;
  ...
  declare class Error$AddAccount {
    ...
    static +FormatError: Class<Error$AddAccount__FormatError> &
      Error$AddAccount__FormatError &
      0; // 0
    static +AlreadyExist: Class<Error$AddAccount__AlreadyExist> &
      Error$AddAccount__AlreadyExist &
      1; // 1
  }
  ...
  declare class Error$Login {
    constructor(...args: empty): mixed;
    static +FormatError: Class<Error$Login__FormatError> &
      Error$Login__FormatError &
      0; // 0
    static +LoginError: Class<Error$Login__LoginError> &
      Error$Login__LoginError &
      1; // 1
    static +EmailNotVerificated: Class<Error$Login__EmailNotVerificated> &
      Error$Login__EmailNotVerificated &
      2; // 2
  }
  ...
  declare class Error$GetCurrentUser {
    constructor(...args: empty): mixed;
    static +NotLoggedIn: Class<Error$GetCurrentUser__NotLoggedIn> &
      Error$GetCurrentUser__NotLoggedIn &
      0; // 0
  }
  ...
  declare interface milkcocoa$DataStore {
    push(
      object: {},
      callback?: (data: milkcocoa$DataStoreCallbackData) => void
    ): void;
