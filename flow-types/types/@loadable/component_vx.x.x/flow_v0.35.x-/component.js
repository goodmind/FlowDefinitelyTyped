...
default: React.ComponentType<P>
	...
	declare export type DefaultComponent<P> = React.ComponentType<P> | DefaultImportedComponent<P>;
	declare export interface Options {
fallback?: JSX.Element
} 
	declare export type LoadableComponent<T> = React.ComponentType<T & {
fallback?: JSX.Element
}>;
...
loadFn: (props: {[key: string]: any}) => Promise<TModule>): LoadableLibrary<TModule>

	declare export function lazy<T>(loadFn: (props: T) => Promise<DefaultComponent<T>>): LoadableComponent<T>
