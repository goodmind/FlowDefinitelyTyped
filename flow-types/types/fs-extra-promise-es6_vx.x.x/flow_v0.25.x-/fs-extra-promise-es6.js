declare module "fs-extra-promise-es6" {
  ...
  declare export function chownSync(
    path: string,
    uid: number,
    gid: number
  ): void;
  ...
  declare export function fchownSync(
    fd: number,
    uid: number,
    gid: number
  ): void;
  ...
  declare export function lchownSync(
    path: string,
    uid: number,
    gid: number
  ): void;
  ...
  declare export function symlinkSync(
    srcpath: string,
    dstpath: string,
  ...
  declare export function openSync(
    path: string,
    flags: string,
    mode?: string
  ): number;
  ...
  declare export function utimesSync(
    path: string,
    atime: number,
    mtime: number
  ): void;
  ...
  declare export function futimesSync(
    fd: number,
    atime: number,
    mtime: number
  ): void;
  ...
  declare export function copyAsync(
    src: string,
    dest: string,
    filter?: (src: string) => boolean
  ): Promise<void>;
  ...
  declare export function outputFileAsync(
    file: string,
    data: any
  ): Promise<void>;

  declare export function outputJSONAsync(
    file: string,
    data: any
  ): Promise<void>;

  declare export function readJSONAsync(
    file: string,
    options?: OpenOptions
  ): Promise<void>;
  ...
  declare export function writeJsonAsync(
    file: string,
    object: any,
    options?: OpenOptions
  ): Promise<void>;
  ...
  declare export function renameAsync(
    oldPath: string,
    newPath: string
  ): Promise<void>;
  ...
  declare export function chownAsync(
    path: string,
    uid: number,
    gid: number
  ): Promise<void>;

  declare export function fchownAsync(
    fd: number,
    uid: number,
    gid: number
  ): Promise<void>;

  declare export function lchownAsync(
    path: string,
    uid: number,
    gid: number
  ): Promise<void>;

  declare export function chmodAsync(
    path: string,
    mode: number | string
  ): Promise<void>;

  declare export function fchmodAsync(
    fd: number,
    mode: number | string
  ): Promise<void>;

  declare export function lchmodAsync(
    path: string,
    mode: number | string
  ): Promise<void>;
  ...
  declare export function linkAsync(
    srcpath: string,
    dstpath: string
  ): Promise<void>;

  declare export function symlinkAsync(
    srcpath: string,
    dstpath: string,
    type?: fs.symlink.Type
  ): Promise<void>;
  ...
  declare export function realpathAsync(
    path: string,
    cache?: string
  ): Promise<string>;
  ...
  declare export function mkdirAsync(
    path: string,
    mode?: number | string
  ): Promise<void>;
  ...
  declare export function openAsync(
    path: string,
    flags: string,
    mode?: string
  ): Promise<number>;

  declare export function utimesAsync(
    path: string,
    atime: number,
    mtime: number
  ): Promise<void>;

  declare export function futimesAsync(
    fd: number,
    atime: number,
    mtime: number
  ): Promise<void>;
  ...
  declare export function readFileAsync(
    filename: string,
    options: OpenOptions | string
  ): Promise<string>;
  ...
  declare export function writeFileAsync(
    filename: string,
    data: any,
    options?: OpenOptions | string
  ): Promise<void>;

  declare export function appendFileAsync(
    filename: string,
    data: any,
    option?: OpenOptions | string
  ): Promise<void>;
  ...
  declare export function isDirectory(
    path: string,
