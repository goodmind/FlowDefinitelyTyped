declare module "weapp-api" {
  ...
  declare interface wx$DownloadTask {
    ...
    offProgressUpdate(
      callback: (res: wx$OnProgressCallbackOptions) => {}
    ): void;
    onHeadersReceived(callback: wx$DataResponseCallback): void;
    offHeadersReceived(callback: wx$DataResponseCallback): void;
  }
  ...
  declare type wx$GetBackgroundAudioPlayerStateSuccessCallback = (
    state: wx$BackgroundAudioPlayerState
  ) => void;
   ...
   * 监听音乐播放。
   */
  declare function wx$onBackgroundAudioPlay(
    callback: wx$NoneParamCallback
  ): void;

  /**
   * 监听音乐暂停。
   */
  declare function wx$onBackgroundAudioPause(
    callback: wx$NoneParamCallback
  ): void;
   ...
   * 监听音乐停止。
   */
  declare function wx$onBackgroundAudioStop(
    callback: wx$NoneParamCallback
  ): void;
   ...
   * 在当前页面隐藏导航条加载动画
   */
  declare function wx$hideNavigationBarLoading(
    options?: wx$CommonCallbackOptions
  ): void;

  /**
   * 在当前页面显示导航条加载动画
   */
  declare function wx$showNavigationBarLoading(
    options: wx$CommonCallbackOptions
  ): void;
  ...
  declare function wx$setNavigationBarTitle(
    options: wx$NavigationBarTitleOptions
  ): void;
   ...
   * 停止当前页面下拉刷新。
   */
  declare function wx$stopPullDownRefresh(
    options?: wx$CommonCallbackOptions
  ): void;
   ...
   */
  declare function wx$startPullDownRefresh(
    options?: wx$CommonCallbackOptions
  ): void;
