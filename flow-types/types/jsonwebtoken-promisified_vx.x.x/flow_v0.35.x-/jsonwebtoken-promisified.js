...
decoded: {[key: string]: any} | string) => void;
	declare export type SignCallback = (err: Error, encoded: string) => void;
	declare export type Secret = string | Buffer | {
key: string,
passphrase: string
};
...
options?: VerifyOptions): {[key: string]: any} | string
...
token: string,
secretOrPublicKey: string | Buffer,
options?: VerifyOptions): Promise<{[key: string]: any} | string>
 ...
 * @returns The decoded Token
 */
declare export function decode(token: string, options?: DecodeOptions): null | {
[key: string]: any
} | string
