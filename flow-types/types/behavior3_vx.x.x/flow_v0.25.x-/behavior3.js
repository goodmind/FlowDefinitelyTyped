declare module "behavior3" {
  declare var npm$namespace$b3: {
    ...
    BaseNode: typeof b3$BaseNode,
    Action: typeof b3$Action,
    BehaviorTree: typeof b3$BehaviorTree,
    Blackboard: typeof b3$Blackboard,
    Composite: typeof b3$Composite,
    Condition: typeof b3$Condition,
    Decorator: typeof b3$Decorator,
    Tick: typeof b3$Tick,
    Error: typeof b3$Error,
    Failer: typeof b3$Failer,
    Runner: typeof b3$Runner,
    Succeeder: typeof b3$Succeeder,
    Wait: typeof b3$Wait,
    MemPriority: typeof b3$MemPriority,
    MemSequence: typeof b3$MemSequence,
    Priority: typeof b3$Priority,
    Sequence: typeof b3$Sequence,
    Inverter: typeof b3$Inverter,
    Limiter: typeof b3$Limiter,
    MaxTime: typeof b3$MaxTime,
    RepeatUntilFailure: typeof b3$RepeatUntilFailure,
    RepeatUntilSuccess: typeof b3$RepeatUntilSuccess,
    Repeater: typeof b3$Repeater
  };
   ...
   *      };
   */
  declare class b3$Action mixins BaseNode {
    /**
   ...
   *      };
   */
  declare class b3$Composite mixins BaseNode {
    /**
   ...
   */
  declare class b3$Condition mixins BaseNode {
    /**
   ...
   *      });
   */
  declare class b3$Decorator mixins BaseNode {
    /**
   ...
   */
  declare class b3$Error mixins Action {
    /**
   ...
   */
  declare class b3$Failer mixins Action {
    /**
   ...
   */
  declare class b3$Runner mixins Action {
    /**
   ...
   */
  declare class b3$Succeeder mixins Action {
    /**
   ...
   * Wait a few seconds.
   */
  declare class b3$Wait mixins Action {
    /**
   ...
   * children again.
   */
  declare class b3$MemPriority mixins Composite {
    /**
   ...
   * children again.
   */
  declare class b3$MemSequence mixins Composite {
    /**
   ...
   */
  declare class b3$Priority mixins Composite {
    /**
   ...
   */
  declare class b3$Sequence mixins Composite {
    /**
   ...
   */
  declare class b3$Inverter mixins Decorator {
    /**
   ...
   * executing the child.
   */
  declare class b3$Limiter mixins Decorator {
    /**
   ...
   * status.
   */
  declare class b3$MaxTime mixins Decorator {
    /**
   ...
   */
  declare class b3$RepeatUntilFailure mixins Decorator {
    /**
   ...
   * number of repetitions can be defined.
   */
  declare class b3$RepeatUntilSuccess mixins Decorator {
    /**
   ...
   * can be defined.
   */
  declare class b3$Repeater mixins Decorator {
    /**
     * Creates an instance of MaxTime.
     *
     * - **maxLoop** (*Integer*) Maximum number of repetitions. Default to -1 (infinite).
