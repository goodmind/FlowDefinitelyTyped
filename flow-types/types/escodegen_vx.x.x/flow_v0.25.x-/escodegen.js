declare module "escodegen" {
  ...
  declare export class Precedence {
    ...
    static +Assignment: Class<Precedence__Assignment> &
      Precedence__Assignment &
      3; // 3
    static +Conditional: Class<Precedence__Conditional> &
      Precedence__Conditional &
      4; // 4
    static +ArrowFunction: Class<Precedence__ArrowFunction> &
      Precedence__ArrowFunction &
      5; // 5
    static +LogicalOR: Class<Precedence__LogicalOR> & Precedence__LogicalOR & 6; // 6
    static +LogicalAND: Class<Precedence__LogicalAND> &
      Precedence__LogicalAND &
      7; // 7
    static +BitwiseOR: Class<Precedence__BitwiseOR> & Precedence__BitwiseOR & 8; // 8
    static +BitwiseXOR: Class<Precedence__BitwiseXOR> &
      Precedence__BitwiseXOR &
      9; // 9
    static +BitwiseAND: Class<Precedence__BitwiseAND> &
      Precedence__BitwiseAND &
      10; // 10
    static +Equality: Class<Precedence__Equality> & Precedence__Equality & 11; // 11
    static +Relational: Class<Precedence__Relational> &
      Precedence__Relational &
      12; // 12
    static +BitwiseSHIFT: Class<Precedence__BitwiseSHIFT> &
      Precedence__BitwiseSHIFT &
      13; // 13
    static +Additive: Class<Precedence__Additive> & Precedence__Additive & 14; // 14
    static +Multiplicative: Class<Precedence__Multiplicative> &
      Precedence__Multiplicative &
      15; // 15
    ...
    static +TaggedTemplate: Class<Precedence__TaggedTemplate> &
      Precedence__TaggedTemplate &
      20; // 20
   ...
   */
  declare export function attachComments(
    ast: any,
    comments: any,
    tokens: any
  ): any;
