...
errorCallback?: (error: Frame | string) => any): any;
connect(
headers: {},
connectCallback: (frame?: Frame) => any,
errorCallback?: (error: Frame | string) => any): any;
...
static marshall(command: string, headers?: {}, body?: string): any
	...
	declare export function client(url: string, protocols?: string | Array<string>): Client
	...
	declare export function setInterval(interval: number, f: (...args: any[]) => void): NodeJS.Timer
