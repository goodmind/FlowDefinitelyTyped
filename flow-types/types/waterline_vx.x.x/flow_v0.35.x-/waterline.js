...
cb: (err: Error, ontology: Waterline$Ontology) => any) => any,
collections: any
} 
...
declare export type Waterline$AttributeType = "string"
| "text"
| "integer"
| "float"
| "date"
...
declare export type Waterline$Attribute = string
...
declare export type Waterline$BaseAttribute<T> = Waterline$AttributeValidations & {
type?: string,
primaryKey?: boolean,
unique?: boolean,
required?: boolean,
...
declare type Waterline$AttributeValidationAsyncFn<T> = (cb: (value: T) => any) => void;

declare export type Waterline$AttributeValidation<T> = T | Waterline$AttributeValidationSyncFn<T> | Waterline$AttributeValidationAsyncFn<T>;
...
create(params: any, cb?: Waterline$Callback<any>): Waterline$WaterlinePromise<any>,
create(params: any[], cb?: Waterline$Callback<any>): Waterline$WaterlinePromise<any[]>,
find(criteria?: any, cb?: Waterline$Callback<any[]>): Waterline$QueryBuilder<any[]>,
findOne(criteria?: any, cb?: Waterline$Callback<any>): Waterline$QueryBuilder<any>,
findOrCreate(
criteria?: any,
values?: any,
cb?: Waterline$Callback<any>): Waterline$QueryBuilder<any>,
update(
criteria: any,
changes: any,
cb?: Waterline$Callback<any>): Waterline$WaterlinePromise<any[]>,
update(
criteria: any,
changes: any[],
cb?: Waterline$Callback<any[]>): Waterline$WaterlinePromise<any[]>,
destroy(criteria: any, cb?: Waterline$Callback<any>): Waterline$WaterlinePromise<any[]>,
destroy(
criteria: any[],
cb?: Waterline$Callback<any[]>): Waterline$WaterlinePromise<any[]>,
...
Waterline$Collection: {
extend: (
params: Waterline$Waterline.Waterline$CollectionDefinition) => Waterline$Waterline.Waterline$CollectionClass
},
