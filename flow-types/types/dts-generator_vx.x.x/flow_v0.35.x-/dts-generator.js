declare module 'dts-generator' {
        declare module.exports: typeof dtsGenerator

	declare function dtsGenerator(options: dtsGenerator$dtsGenerator$DtsGeneratorOptions): Bluebird<void>

	declare interface dtsGenerator$ResolveModuleIdParams {
...
declare interface dtsGenerator$ResolveModuleImportParams {
...
declare interface dtsGenerator$DtsGeneratorOptions {
 ...
 */
resolveModuleId(params: dtsGenerator$ResolveModuleIdParams): string,

/**
 * An optional callback provided by the invoker to customize the imported module ids in the output d.ts files.
 * @see {@link https://github.com/SitePen/dts-generator/blob/master/docs/resolving-module-ids.md Resolving Module Ids}
 */
resolveModuleImport(params: dtsGenerator$ResolveModuleImportParams): string
} 
    }
