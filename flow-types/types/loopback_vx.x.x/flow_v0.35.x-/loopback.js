...
ctor: () => void;
http: any;
constructor(name: string, function Object() { [native code] }: () => void): this;
 ...
 */
static create<T>(data: any | any[], callback: l$CallbackWithResult<T | T[] | null>): void;
 ...
 */
static findOrCreate<T>(data: any, callback: l$CallbackWithMultipleResults<T, boolean>): void;
 ...
 */
static replaceById<T>(id: any, data: any, callback: l$CallbackWithResult<T>): void;
 ...
 * @property {boolean} validate Perform validation before saving.  Default is true.
 */
static replaceById<T>(id: any, data: any, options?: {
validate: boolean
}): Promise<T>;
 ...
 * @callback {() => void} callback Callback function called with `cb(err, obj)` signature.
 */
static replaceOrCreate<T>(data: any, callback: l$CallbackWithResult<T>): void;
 ...
 * @property {boolean} validate Perform validation before saving.  Default is true.
 */
static replaceOrCreate<T>(data: any, options?: {
validate: boolean
}): Promise<T>;
 ...
 * @callback {() => void} callback Callback function called with `cb(err, obj)` signature.
 */
static upsertWithWhere<T>(data: any, callback: l$CallbackWithResult<T>): void;
 ...
 * @property {boolean} validate Perform validation before saving.  Default is true.
 */
replaceAttributes<T>(data: any, options?: {
validate: boolean
}): Promise<T>;
 ...
 *              *
 */
updateAttribute<T>(name: string, value: any, callback: l$CallbackWithResult<T>): void;
