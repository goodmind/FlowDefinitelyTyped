declare module "google-apps-script-oauth2" {
  ...
  declare interface GoogleAppsScriptOAuth2$OAuth2Service {
     ...
     */
    setTokenFormat(
      tokenFormat: GoogleAppsScriptOAuth2$TokenFormat
    ): GoogleAppsScriptOAuth2$OAuth2Service;
    ...
    setTokenPayloadHandler(
      tokenHandler: (
        tokenPayload: GoogleAppsScriptOAuth2$TokenPayload
      ) => { [key: string]: any }
    ): GoogleAppsScriptOAuth2$OAuth2Service;
  ...
  declare class GoogleAppsScriptOAuth2$StateParameterLocation {
    ...
    static +AUTHORIZATION_URL: Class<GoogleAppsScriptOAuth2$StateParameterLocation__AUTHORIZATION_URL> &
      GoogleAppsScriptOAuth2$StateParameterLocation__AUTHORIZATION_URL &
      0; // 0
    static +REDIRECT_URL: Class<GoogleAppsScriptOAuth2$StateParameterLocation__REDIRECT_URL> &
      GoogleAppsScriptOAuth2$StateParameterLocation__REDIRECT_URL &
      1; // 1
  }

  declare class GoogleAppsScriptOAuth2$StateParameterLocation__AUTHORIZATION_URL
    mixins GoogleAppsScriptOAuth2$StateParameterLocation {}
  declare class GoogleAppsScriptOAuth2$StateParameterLocation__REDIRECT_URL
    mixins GoogleAppsScriptOAuth2$StateParameterLocation {}

  declare class GoogleAppsScriptOAuth2$TokenFormat {
    constructor(...args: empty): mixed;
    static +JSON: Class<GoogleAppsScriptOAuth2$TokenFormat__JSON> &
      GoogleAppsScriptOAuth2$TokenFormat__JSON &
      0; // 0
    static +FORM_URL_ENCODED: Class<GoogleAppsScriptOAuth2$TokenFormat__FORM_URL_ENCODED> &
      GoogleAppsScriptOAuth2$TokenFormat__FORM_URL_ENCODED &
      1; // 1
  }

  declare class GoogleAppsScriptOAuth2$TokenFormat__JSON
    mixins GoogleAppsScriptOAuth2$TokenFormat {}
  declare class GoogleAppsScriptOAuth2$TokenFormat__FORM_URL_ENCODED
    mixins GoogleAppsScriptOAuth2$TokenFormat {}
