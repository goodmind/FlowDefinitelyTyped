...
declare class Edit$PolyVerticesEdit mixins Handler {
  constructor(
    ...
    options?: Control$EditOptions.EditOptions$EditPolyVerticesEditOptions
  ): this;
  updateMarkers(): void;
}
...
declare class Edit$SimpleShape mixins Handler {
  constructor(
    ...
    options?: Control$EditOptions.EditOptions$EditSimpleShapeOptions
  ): this;
  updateMarkers(): void;
}
...
declare class Draw$Feature mixins Handler {
  initialize(
    map: Map,
    options:
      | Control$DrawOptions.DrawOptions$PolylineOptions
      ...
      | Control$DrawOptions.DrawOptions$DeleteHandlerOptions
  ): void;
  setOptions(
    options:
      | Control$DrawOptions.DrawOptions$PolylineOptions
...
declare class Draw$Marker mixins Draw$Feature {
  constructor(
    map: Map,
    options?: Control$DrawOptions.DrawOptions$MarkerOptions
  ): this;
}
...
declare class Draw$Circle mixins Draw$SimpleShape {
  constructor(
    map: Map,
    options?: Control$DrawOptions.DrawOptions$CircleOptions
  ): this;
}
...
declare class Draw$Rectangle mixins Draw$SimpleShape {
  constructor(
    map: Map,
    options?: Control$DrawOptions.DrawOptions$RectangleOptions
  ): this;
}
...
declare class Draw$Polygon mixins Draw$Polyline {
  constructor(
    map: Map,
    options?: Control$DrawOptions.DrawOptions$PolygonOptions
  ): this;
}
