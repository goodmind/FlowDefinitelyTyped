 ...
 */
(alias: string, ...args: any[]): j$JfpCurriedOutput<any>,
(externalFunction: (...args: any[]) => any, ...args: any[]): j$JfpCurriedOutput<any>,
...
defaultValue: any,
preferredValue: any,
predicate: (value: any) => boolean): any,
 ...
 * @param predicateValue Value to set behavior execution
 * @param userFunction Behavior to execute
 * @param arguments for userFunction
 */
when(
 ...
 * @param Initial arguments for currying application
 */
 ...
 * @param Functions to chain/pipeline
 */
 ...
 * @param Initial condition arguments
 */
