...
position: number,
ref: number,
callback?: (error: Error, position: number) => void): void;
...
constructor(options: LargeObjectManagerSettings | {[key: string]: any}): this;
open(
oid: number,
mode: number,
callback: (error: Error, result: LargeObject) => void): void;
...
oid: number,
bufferSize: number,
callback: (error: Error, size: number, stream: ReadStream) => void): void;
openAndReadableStreamAsync(oid: number, bufferSize?: number): Promise<[number, ReadStream]>;
createAndWritableStream(
bufferSize?: number,
callback?: (error: Error, oid: number, stream: WriteStream) => void): void;
