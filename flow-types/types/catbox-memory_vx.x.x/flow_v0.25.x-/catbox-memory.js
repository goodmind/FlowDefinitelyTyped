declare module "catbox-memory" {
  import type { ClientApi } from "catbox";

  declare class CatboxMemory<T> mixins ClientApi<T> {
    constructor(options?: CatboxMemory$CatboxMemory$Options): this;
  }
  declare interface CatboxMemory$Options {
    /**
  ...
  declare module.exports: typeof CatboxMemory;
}
