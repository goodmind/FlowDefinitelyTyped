declare module 'node-statsd' {
	...
	declare export interface StatsDConfig {
host?: string,
port?: number,
prefix?: string,
suffix?: string,
...
global_tags?: string[]
	...
	declare export type Callback = (error?: Error, bytes?: Buffer) => void;
 ...
 */
constructor(config: StatsDConfig): this;
constructor(host?: string, port?: number, prefix?: string, suffix?: string, globalize?: boolean, cacheDns?: boolean, mock?: boolean, global_tags?: string[]): this;
socket: dgram.Socket;
host: string;
port: number;
prefix: string;
