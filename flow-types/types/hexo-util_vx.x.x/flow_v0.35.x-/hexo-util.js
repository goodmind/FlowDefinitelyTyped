...
[name: string]: string
	...
	declare export function slugize(str: string, options?: {
separator?: string,
transform?: 1 | 2
}): string
...
command: string,
args: string[],
options: hexoSpawnDisableEncodingAndOverrideStdioOptions): Promise<Buffer | void>

	declare export function spawn(
command: string,
args: string[],
options: hexoSpawnOverrideStdioOptions): Promise<string | void>

	declare export function spawn(
command: string,
args: string[],
options: hexoSpawnDisableEncodingOptions): Promise<Buffer>

	declare export function spawn(command: string, args: string[], options?: hexoSpawnOptions): Promise<string>
...
options: hexoSpawnOverrideStdioOptions): Promise<string | void>
	...
	declare export function spawn(command: string, options: hexoSpawnDisableEncodingOptions): Promise<Buffer>

	declare export function spawn(command: string, options?: hexoSpawnOptions): Promise<string>

	declare export function stripHTML(str: string): string

	declare export function wordWrap(str: string, options?: {
width?: number
}): string
