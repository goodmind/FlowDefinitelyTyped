 ...
 */
declare export type ParentNode = DefaultTreeParentNode | {[key: string]: any};
 ...
 */
declare export type DocumentType = DefaultTreeDocumentType | {[key: string]: any};
 ...
 */
declare export type DocumentFragment = DefaultTreeDocumentFragment | {[key: string]: any};
 ...
 */
declare export type CommentNode = DefaultTreeCommentNode | {[key: string]: any};
 ...
 * ```
 */
declare export function parse(html: string, options?: ParserOptions): Document
...
options?: ParserOptions): DocumentFragment
	...
	declare export function parseFragment(html: string, options?: ParserOptions): DocumentFragment
 ...
 * ```
 */
declare export function serialize(node: Node, options?: SerializerOptions): string
