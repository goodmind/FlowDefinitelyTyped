declare module 'jenkins' {
        declare interface create$JenkinsAPI {
...
declare interface create$JenkinsPromisifiedAPI {
info(): Promise<any>,
build: {
...
build(opts: create$JobBuildOptions): Promise<any>,
...
declare interface create$JobBuildOptions {
name: string,
parameters?: any,
token?: string
} 

declare interface create$JenkinsClientOptions {
baseUrl?: string,
crumbIssuer?: boolean,
headers?: any,
...
headers?: any,
promisify: true
}): create$create$JenkinsPromisifiedAPI
