declare module 'tinycolor2' {
        declare type tinycolor$ColorInputWithoutInstance = string
| ColorFormats$ColorFormats$PRGB
| ColorFormats$ColorFormats$PRGBA
| ColorFormats$ColorFormats$RGB
| ColorFormats$ColorFormats$RGBA
| ColorFormats$ColorFormats$HSL
| ColorFormats$ColorFormats$HSLA
| ColorFormats$ColorFormats$HSV
| ColorFormats$ColorFormats$HSVA;

declare type tinycolor$ColorInput = tinycolor$ColorInputWithoutInstance | tinycolor$Instance;

declare interface ColorFormats$Alpha {
a: number
} 

declare interface ColorFormats$PRGB {
r: string,
g: string,
b: string
} 

declare type ColorFormats$PRGBA = {} & ColorFormats$PRGB & ColorFormats$Alpha
...
declare type ColorFormats$RGBA = {} & ColorFormats$RGB & ColorFormats$Alpha
...
declare type ColorFormats$HSLA = {} & ColorFormats$HSL & ColorFormats$Alpha
...
declare interface tinycolor$ConstructorOptions {
format?: string,
gradientType?: boolean
} 

declare interface tinycolor$WCAG2Options {
level?: "AA" | "AAA",
size?: "large" | "small"
} 

declare type tinycolor$MostReadableArgs = {
includeFallbackColors?: boolean
} & tinycolor$WCAG2Options


declare interface tinycolor$Constructor {
...
opts?: tinycolor$ConstructorOptions): tinycolor$Instance,
(color?: tinycolor$ColorInput, opts?: tinycolor$ConstructorOptions): tinycolor$Instance,
 ...
 */
fromRatio(ratio?: tinycolor$ColorInputWithoutInstance): tinycolor$Instance,

/**
 * Compares two colors. Each colors can be any color inputs.
 */
equals(color1?: tinycolor$ColorInput, color2?: tinycolor$ColorInput): boolean,

/**
 * Returns a random color
 */
random(): tinycolor$Instance,
mix(
color1: tinycolor$ColorInput,
color2: tinycolor$ColorInput,
amount?: number): tinycolor$Instance,
 ...
 */
readability(color1: tinycolor$ColorInput, color2: tinycolor$ColorInput): number,
 ...
 * @param - The 'level' property states 'AA' or 'AAA'
if missing or invalid, it defaults to 'AA'
 * @param - The 'size' property states 'large' or 'small'
if missing or invalid, it defaults to 'small'.
 */
isReadable(
color1: tinycolor$ColorInput,
color2: tinycolor$ColorInput,
wcag2?: tinycolor$WCAG2Options): boolean,
 ...
 */
mostReadable(
baseColor: tinycolor$ColorInput,
colorList: tinycolor$ColorInput[],
args?: tinycolor$MostReadableArgs): tinycolor$Instance,
...
declare interface tinycolor$Instance {
 ...
 */
setAlpha(alpha: number): tinycolor$Instance,

/**
 * Returns the object as a HSVA object.
 */
toHsv(): ColorFormats$ColorFormats$HSVA,
 ...
 */
toHsl(): ColorFormats$ColorFormats$HSLA,
 ...
 */
toRgb(): ColorFormats$ColorFormats$RGBA,
 ...
 * Returns the object as a RGBA object.
 */
toPercentageRgb(): ColorFormats$ColorFormats$PRGBA,
...
Default value: 10.
 */
lighten(amount?: number): tinycolor$Instance,
...
Default value: 10.
 */
brighten(amount?: number): tinycolor$Instance,
...
Default value: 10.
 */
darken(amount?: number): tinycolor$Instance,
...
Default value: 10.
 */
desaturate(amount?: number): tinycolor$Instance,
...
Default value: 10.
 */
saturate(amount?: number): tinycolor$Instance,

/**
 * Completely desaturates a color into greyscale.
 * Same as calling desaturate(100).
 */
greyscale(): tinycolor$Instance,
 ...
 */
spin(amount: number): tinycolor$Instance,
...
Default value: 30.
 */
analogous(results?: number, slices?: number): tinycolor$Instance[],

/**
 * Gets the complement of the current color
 */
complement(): tinycolor$Instance,
...
Default value: 6.
 */
monochromatic(results?: number): tinycolor$Instance[],

/**
 * Gets a split complement color scheme based off of the current color.
 */
splitcomplement(): [tinycolor$Instance, tinycolor$Instance, tinycolor$Instance],

/**
 * Gets a triad based off of the current color.
 */
triad(): [tinycolor$Instance, tinycolor$Instance, tinycolor$Instance],

/**
 * Gets a tetrad based off of the current color.
 */
tetrad(
): [tinycolor$Instance, tinycolor$Instance, tinycolor$Instance, tinycolor$Instance]
} 
	declare var tinycolor: tinycolor$tinycolor$Constructor;
