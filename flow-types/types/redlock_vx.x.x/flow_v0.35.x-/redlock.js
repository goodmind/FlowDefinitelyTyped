...
value: string | null;
expiration: number;
constructor(redlock: Redlock, resource: string, value: string | null, expiration: number): this;
...
constructor(clients: Redlock$Redlock$CompatibleRedisClient[], options?: Redlock$Redlock$Options): this;
acquire(
resource: string,
ttl: number,
callback?: Redlock$Redlock$Callback<Redlock$Redlock$Lock>): Promise<Redlock$Redlock$Lock>;
lock(
resource: string,
ttl: number,
callback?: Redlock$Redlock$Callback<Redlock$Redlock$Lock>): Promise<Redlock$Redlock$Lock>;
...
resource: string,
ttl: number,
errorHandler?: Redlock$Redlock$Callback<void>): Promise.Disposer<Redlock$Redlock$Lock>;
release(
lock: Redlock$Redlock$Lock,
callback?: Redlock$Redlock$Callback<void>): Promise<void>;
unlock(
lock: Redlock$Redlock$Lock,
callback?: Redlock$Redlock$Callback<void>): Promise<void>;
extend(
