...
declare function internals$addRef<T>(xs: Rx$Observable<T>, r: {
...
constructor(scheduler: Rx$IScheduler, state: any, action: (scheduler: Rx$IScheduler, state: any) => IDisposable, dueTime: TTime, comparer?: (x: TTime, y: TTime) => number): this;
...
state: TState,
action: (scheduler: Rx$IScheduler, state: TState) => IDisposable): IDisposable,
...
state: TState,
action: (state: TState, action: (state: TState) => void) => void): IDisposable,
scheduleRecursiveWithAbsolute(
dueTime: number,
action: (action: (dueTime: number) => void) => void): IDisposable,
scheduleRecursiveWithAbsoluteAndState<TState>(
state: TState,
dueTime: number,
action: (state: TState, action: (state: TState, dueTime: number) => void) => void): IDisposable,
...
schedule: (
state: any,
action: (scheduler: Rx$IScheduler, state: any) => IDisposable) => IDisposable,
scheduleRelative: (
state: any,
dueTime: number,
action: (scheduler: Rx$IScheduler, state: any) => IDisposable) => IDisposable,
...
state: any,
dueTime: number,
action: (scheduler: Rx$IScheduler, state: any) => IDisposable) => IDisposable): Rx$Scheduler,
...
second: Rx$Observable<T2> | IPromise<T2>,
third: Rx$Observable<T3> | IPromise<T3>,
fourth: Rx$Observable<T4> | IPromise<T4>): Rx$Observable<[T, T2, T3, T4]>,
...
third: Rx$Observable<T3> | IPromise<T3>,
fourth: Rx$Observable<T4> | IPromise<T4>,
fifth: Rx$Observable<T5> | IPromise<T5>): Rx$Observable<[T, T2, T3, T4, T5]>,
...
withLatestFrom<T2>(second: Rx$Observable<T2> | IPromise<T2>): Rx$Observable<[T, T2]>,
...
concatMap<R>(selector: (value: T, index: number) => IPromise<R>): Rx$Observable<R>,
...
selectMany<TResult>(selector: (value: T) => IPromise<TResult>): Rx$Observable<TResult>,
...
flatMap<TResult>(
selector: (value: T) => Rx$Observable<TResult>): Rx$Observable<TResult>,
flatMap<TResult>(selector: (value: T) => IPromise<TResult>): Rx$Observable<TResult>,
...
selectConcat<R>(selector: (value: T, index: number) => IPromise<R>): Rx$Observable<R>,
...
throttleWithTimeout(dueTime: number, scheduler?: Rx$IScheduler): Rx$Observable<T>,
...
create<T>(subscribe: (observer: Rx$Observer<T>) => IDisposable): Rx$Observable<T>,
create<T>(subscribe: (observer: Rx$Observer<T>) => () => void): Rx$Observable<T>,
create<T>(subscribe: (observer: Rx$Observer<T>) => void): Rx$Observable<T>,
createWithDisposable<T>(subscribe: (observer: Rx$Observer<T>) => IDisposable): Rx$Observable<T>,
...
catchException<T>(sources: IPromise<T>[] | Rx$Observable<T>[]): Rx$Observable<T>,
...
second: Rx$Observable<T2> | IPromise<T2>): Rx$Observable<[T, T2]>,
...
fifth: Rx$Observable<T5> | IPromise<T5>,
resultSelector: (v1: T, v2: T2, v3: T3, v4: T4, v5: T5) => TResult): Rx$Observable<TResult>,
combineLatest<T>(sources: (Rx$Observable<T> | IPromise<T>)[]): Rx$Observable<T[]>,
combineLatest<TOther, TResult>(
...
merge<T>(scheduler: Rx$IScheduler, ...sources: IPromise<T>[]): Rx$Observable<T>,
merge<T>(
scheduler: Rx$IScheduler,
sources: IPromise<T>[] | Rx$Observable<T>[]): Rx$Observable<T>,
pairs<T>(
obj: {
[key: string]: T
},
...
sources: Rx$Observable<T2> | IPromise<T2> | (Rx$Observable<T2> | IPromise<T2>)[]): Rx$Observable<[T1, T2]>,
zip<T1, T2, TResult>(
first: Rx$Observable<T1> | IPromise<T1>,
...
source1: Rx$Observable<T1> | IPromise<T1>,
source2: Rx$Observable<T2> | IPromise<T2>,
source3: Rx$Observable<T3> | IPromise<T3>): Rx$Observable<[T1, T2, T3]>,
...
source2: Rx$Observable<T2> | IPromise<T2>,
source3: Rx$Observable<T3> | IPromise<T3>,
source4: Rx$Observable<T4> | IPromise<T4>): Rx$Observable<[T1, T2, T3, T4]>,
...
source3: Rx$Observable<T3> | IPromise<T3>,
source4: Rx$Observable<T4> | IPromise<T4>,
source5: Rx$Observable<T5> | IPromise<T5>): Rx$Observable<[T1, T2, T3, T4, T5]>,
...
prototype: any,
fromCallback: {
(func: (callback: (result: TResult) => any) => any, context?: any): () => Rx$Observable<TResult>,
(func: (arg1: T1, callback: (result: TResult) => any) => any, context?: any): (arg1: T1) => Rx$Observable<TResult>,
(func: (arg1: T1, arg2: T2, callback: (result: TResult) => any) => any, context?: any): (arg1: T1, arg2: T2) => Rx$Observable<TResult>,
(func: (arg1: T1, arg2: T2, arg3: T3, callback: (result: TResult) => any) => any, context?: any): (arg1: T1, arg2: T2, arg3: T3) => Rx$Observable<TResult>,
(func: (callback: Function) => any, context: any, selector: (args: TCallbackResult[]) => TResult): () => Rx$Observable<TResult>,
(func: (arg1: T1, callback: Function) => any, context: any, selector: (args: TCallbackResult[]) => TResult): (arg1: T1) => Rx$Observable<TResult>,
(func: (arg1: T1, arg2: T2, callback: Function) => any, context: any, selector: (args: TCallbackResult[]) => TResult): (arg1: T1, arg2: T2) => Rx$Observable<TResult>,
(func: (arg1: T1, arg2: T2, arg3: T3, callback: Function) => any, context: any, selector: (args: TCallbackResult[]) => TResult): (arg1: T1, arg2: T2, arg3: T3) => Rx$Observable<TResult>,
(func: (callback: Function) => any, context?: any): () => Rx$Observable<TResult>,
(func: (arg1: T1, callback: Function) => any, context?: any): (arg1: T1) => Rx$Observable<TResult>,
(func: (arg1: T1, arg2: T2, callback: Function) => any, context?: any): (arg1: T1, arg2: T2) => Rx$Observable<TResult>,
(func: (arg1: T1, arg2: T2, arg3: T3, callback: Function) => any, context?: any): (arg1: T1, arg2: T2, arg3: T3) => Rx$Observable<TResult>,
(func: Function, context: any, selector: (args: TCallbackResult[]) => TResult): (...args: any[]) => Rx$Observable<TResult>,
(func: Function, context?: any): (...args: any[]) => Rx$Observable<TResult>
},
fromNodeCallback: {
(func: (callback: (err: any, result: T) => any) => any, context?: any): () => Rx$Observable<T>,
(func: (arg1: T1, callback: (err: any, result: T) => any) => any, context?: any): (arg1: T1) => Rx$Observable<T>,
(func: (arg1: T1, arg2: T2, callback: (err: any, result: T) => any) => any, context?: any): (arg1: T1, arg2: T2) => Rx$Observable<T>,
(func: (arg1: T1, arg2: T2, arg3: T3, callback: (err: any, result: T) => any) => any, context?: any): (arg1: T1, arg2: T2, arg3: T3) => Rx$Observable<T>,
(func: (callback: Function) => any, context: any, selector: (results: TC[]) => TR): () => Rx$Observable<TR>,
(func: (arg1: T1, callback: Function) => any, context: any, selector: (results: TC[]) => TR): (arg1: T1) => Rx$Observable<TR>,
(func: (arg1: T1, arg2: T2, callback: Function) => any, context: any, selector: (results: TC[]) => TR): (arg1: T1, arg2: T2) => Rx$Observable<TR>,
(func: (arg1: T1, arg2: T2, arg3: T3, callback: Function) => any, context: any, selector: (results: TC[]) => TR): (arg1: T1, arg2: T2, arg3: T3) => Rx$Observable<TR>,
(func: (callback: Function) => any, context?: any): () => Rx$Observable<TR>,
(func: (arg1: T1, callback: Function) => any, context?: any): (arg1: T1) => Rx$Observable<TR>,
(func: (arg1: T1, arg2: T2, callback: Function) => any, context?: any): (arg1: T1, arg2: T2) => Rx$Observable<TR>,
(func: (arg1: T1, arg2: T2, arg3: T3, callback: Function) => any, context?: any): (arg1: T1, arg2: T2, arg3: T3) => Rx$Observable<TR>,
(func: Function, context: any, selector: (results: TC[]) => T): (...args: any[]) => Rx$Observable<T>,
(func: Function, context?: any): (...args: any[]) => Rx$Observable<T>
},
fromEvent<T>(
element: ArrayLike<Rx$DOMEventTarget> | Rx$DOMEventTarget | Rx$NodeEventTarget | Rx$NativeEventTarget,
eventName: string,
selector?: (...args: any[]) => T): Rx$Observable<T>,
fromEventPattern<T>(
...
dutTime: number,
period: number,
scheduler?: Rx$IScheduler): Rx$Observable<number>,
timer(
dueTime: number,
period: number,
scheduler?: Rx$IScheduler): Rx$Observable<number>,
