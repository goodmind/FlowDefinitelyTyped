declare module "jquery.fileupload" {
  ...
  declare type JqueryFileUploadEnhancedPromise<T> = {
    success: $ElementType<JQueryPromise<T>, "done">,
    error: $ElementType<JQueryPromise<T>, "fail">,
    complete: $ElementType<JQueryPromise<T>, "always">
  } & JQueryPromise<T>;
  ...
  declare interface JqueryFileUploadConvenienceObject {
  ...
  declare type JqueryFileUploadAddObject = {
  ...
  declare type JQueryFileUploadProgressObject = {} & JQueryFileInputOptions &
    JQueryFileUploadProgressAllObject;

  declare type JQueryFileUploadDone = {} & JQueryFileInputOptions &
    JQueryFileUploadXhr;
}
