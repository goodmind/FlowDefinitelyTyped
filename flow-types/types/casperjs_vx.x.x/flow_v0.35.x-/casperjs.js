declare module 'casperjs' {
	...
	declare export function selectXPath(expression: string): {[key: string]: any}
...
zoom(factor: number): Casper
	...
	declare export type FunctionOnTimeout = (timeout: number, details: any) => void;
...
begin(description: string, planned: number, config: {[key: string]: any}): any,
