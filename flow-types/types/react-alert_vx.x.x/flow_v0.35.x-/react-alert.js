declare module 'react-alert' {
	...
	declare export type AlertPosition = "top left"
| "top right"
| "top center"
| "bottom left"
| "bottom right"
...
zIndex?: number
	...
	declare export class Provider mixins React.Component<ProviderOptions & {
...
show(message?: string, options?: AlertCustomOptionsWithType): InjectedAlertProp,
...
info(message?: string, options?: AlertCustomOptions): InjectedAlertProp
	...
	declare export function withAlert<P: {
alert: InjectedAlertProp
}>(
c: React.ComponentType<P>): React.ComponentType<Pick<P, Exclude<$Keys<P>, "alert">>>
