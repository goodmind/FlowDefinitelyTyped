declare module 'parse5-serializer-stream' {
 ...
 * ```
 */
declare class SerializerStream mixins stream.Readable {
 ...
 */
constructor(node: parse5.Node, options?: parse5.SerializerOptions): this
}
	
	declare module.exports: typeof SerializerStream
