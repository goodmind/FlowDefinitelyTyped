declare module 'snapsvg' {
        declare module.exports: typeof Snap

	declare function Snap(width: number | string, height: number | string): Snap$Snap$Paper
...
declare export function Snap$matrix(a: number, b: number, c: number, d: number, e: number, f: number): Snap$Matrix
...
declare export function Snap$ajax(url: string, callback: Function, scope?: Object): XMLHttpRequest
...
declare export function Snap$getElementByPoint(x: number, y: number): Snap$Snap$Element


declare export function Snap$is(o: any, type: string): boolean


declare export function Snap$load(url: string, callback: (f: Snap$Fragment) => void, scope?: Object): void
...
declare export function Snap$snapTo(values: Array<number> | number, value: number, tolerance?: number): number
...
duration: number,
easing?: (num: number) => number,
callback?: () => void): Snap$Snap$Animation
...
declare export function Snap$parsePathString(pathString: Array<string>): Array<any>


declare export function Snap$parseTransformString(TString: string): Array<any>


declare export function Snap$parseTransformString(TString: Array<string>): Array<any>
...
animate(Snap$animation: any): Snap$Snap$Element,
animate(
attrs: {
[attr: string]: string | number | boolean | any
},
duration: number,
easing?: (num: number) => number,
callback?: () => void): Snap$Snap$Element,
...
select(query: string): Snap$Snap$Element,
...
type: string,
use(): Object,
selectAll(): Snap$Snap$Set,
selectAll(query: string): Snap$Snap$Set,
click(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
dblclick(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
mousedown(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
mousemove(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
mouseout(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
mouseover(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
mouseup(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
touchstart(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
touchmove(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
touchend(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
touchcancel(handler: (event: MouseEvent) => void, thisArg?: any): Snap$Snap$Element,
...
thisArg?: any): Snap$Snap$Element,
hover(
hoverInHandler: (event: MouseEvent) => void,
hoverOutHandler: (event: MouseEvent) => void,
inThisArg?: any,
outThisArg?: any): Snap$Snap$Element,
unhover(
hoverInHandler: (event: MouseEvent) => void,
hoverOutHandler: (event: MouseEvent) => void): Snap$Snap$Element,
...
moveThisArg?: any,
startThisArg?: any,
endThisArg?: any): Snap$Snap$Element,
undrag(
onMove: (dx: number, dy: number, event: MouseEvent) => void,
onStart: (x: number, y: number, event: MouseEvent) => void,
onEnd: (event: MouseEvent) => void): Snap$Snap$Element,
...
add(a: number, b: number, c: number, d: number, e: number, f: number): Snap$Matrix,
...
filter(filstr: string): Snap$Snap$Element,
...
y: number,
width: number,
height: number): Snap$Snap$Element,
line(x1: number, y1: number, x2: number, y2: number): Snap$Snap$Element,
path(pathSpec: string | (string | number)[][]): Snap$Snap$Element,
...
duration: number,
easing?: (num: number) => number,
callback?: () => void): Snap$Snap$Set,
animate(
...attrs: [{
[attr: string]: string | number | boolean | any
}, "NO PRINT IMPLEMENTED: OptionalType", "NO PRINT IMPLEMENTED: OptionalType", "NO PRINT IMPLEMENTED: OptionalType"][]): Snap$Snap$Element,
attr(
params: {
[attr: string]: string
| number
...
splice(index: number, count: number, ...insertion: Snap$Snap$Element[]): Snap$Snap$Set
} 
