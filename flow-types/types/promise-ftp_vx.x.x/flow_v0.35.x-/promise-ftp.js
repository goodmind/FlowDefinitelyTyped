declare module 'promise-ftp' {
        import typeof * as FtpClient from 'ftp';
	...
	import typeof * as Promise from 'bluebird';
      ...
      declare var npm$namespace$PromiseFtp: {
        
        ERROR_CODES: typeof PromiseFtp$ERROR_CODES,
      }
declare interface PromiseFtp$ERROR_CODES {
...
declare var PromiseFtp$ERROR_CODES: PromiseFtp$ERROR_CODES;
