 ...
 */
declare export function parseDocument(str: string, options?: ParseOptions): ast$ast$Document
 ...
 */
declare export function parseAllDocuments(str: string, options?: ParseOptions): ast$ast$Document[]
...
value: any,
wrapScalars?: true): ast$ast$MapBase | ast$ast$SeqBase | ast$ast$Scalar
...
declare export function createNode(
value: any,
wrapScalars: false): ast$ast$MapBase
| ast$ast$SeqBase
| string
| number
| boolean
 ...
 */
stringify(item: ast$ast$Node, ctx: StringifyContext, onComment: () => void): string,
...
[key: string]: any
	...
	declare export type YAMLError = YAMLSyntaxError | YAMLSemanticError | YAMLReferenceError;
...
declare type cst$ContentNode = cst$Alias
| cst$Scalar
| cst$Map
| cst$Seq
| cst$FlowCollection;
...
toString(): string
	...
	declare type ast$AstNode = ast$ScalarNode | ast$MapNode | ast$SeqNode | cst$Alias;

declare type ast$DocumentConstructor = (options?: ParseOptions) => cst$Document;
...
declare type ast$ScalarConstructor = (value: null | boolean | number | string) => cst$Scalar;

declare type ast$Scalar = cst$BlockValue | cst$PlainValue | cst$QuoteValue;

declare type ast$ScalarNode = cst$BlockFolded
| cst$BlockLiteral
| cst$PlainValue
| cst$QuoteDouble
| cst$QuoteSingle;
...
declare type ast$PairConstructor = (key: ast$AstNode | null, value?: ast$AstNode | null) => ast$Pair;
