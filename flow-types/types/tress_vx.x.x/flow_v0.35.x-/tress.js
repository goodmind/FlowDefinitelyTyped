declare module 'tress' {
        declare export type tress$TressJobCallback = (...args: any[]) => void;

declare export type tress$TressWorkerDoneCallback = (err: boolean | Error | null | void, ...args: any[]) => void;

declare export interface tress$TressJobData {
[name: string]: {}
} 

declare export interface tress$TressJob {
data: tress$TressJobData,
callback: tress$TressJobCallback
} 

declare export interface tress$TressJobQueues {
failed: tress$TressJobData[],
finished: tress$TressJobData[],
waiting: tress$TressJobData[]
} 

declare export interface tress$TressStatic {

/**
 * Array of jobs currently being processed (readonly)
 */
+active: tress$TressJob[],
 ...
 */
load(data: tress$TressJobQueues): void,
 ...
 */
push(
job: tress$TressJobData | tress$TressJobData[],
done?: tress$TressJobCallback): void,
 ...
 */
save(callback: (data: tress$TressJobQueues) => void): void,

/**
 * Returns the status of job ("waiting", "running", "finished", "pending" or "missing")
 */
status(job: tress$TressJob): "active"
| "failed"
| "finished"
| "missing"
| "waiting",
 ...
 */
workersList(): $ElementType<tress$TressStatic, "active">,
 ...
 */
error(err: Error, job: tress$TressJobData, ...args: any[]): void,
...
worker: (
job: tress$tress$TressJobData,
done: tress$tress$TressWorkerDoneCallback) => void,
concurrency?: number): tress$tress$TressStatic

	declare module.exports: typeof tress
