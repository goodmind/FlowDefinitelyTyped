declare module "tress" {
  ...
  declare export type tress$TressWorkerDoneCallback = (
    err: boolean | Error | null | void,
    ...args: any[]
  ) => void;
 ...
 */
  declare function tress(
    worker: (
      ...
      done: tress$tress$TressWorkerDoneCallback
    ) => void,
    concurrency?: number
  ): tress$tress$TressStatic;
