declare module 'oclazyload' {
	...
	declare export interface ILazyLoad {
...
config?: IOptionsConfig): ng.IPromise<any>,
...
toggleWatch(watch: boolean): void
	...
	declare export type ITypedModuleConfig = {
...
path: string
	...
	declare export type IModuleConfig = {
...
files: string[]
	...
	declare export type IOptionsConfig = {
...
insertBefore?: string
	...
	declare export interface ILazyLoadProvider {
...
config(config: IProviderConfig): void
	...
	declare export interface IProviderConfig {
