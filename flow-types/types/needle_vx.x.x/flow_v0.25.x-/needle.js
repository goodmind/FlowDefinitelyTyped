declare module "needle" {
  ...
  declare type core$ReadableStream = NodeJS$ReadableStream;

  declare type core$NeedleCallback = (
    error: Error | null,
    response: core$NeedleResponse,
    body: any
  ) => void;
  ...
  declare type core$NeedleOptions = core$RequestOptions &
    core$ResponseOptions &
    core$RedirectOptions &
    https.RequestOptions;

  declare type core$NeedleReadonlyHttpVerbs = "get" | "head";

  declare type core$NeedleReadWriteHttpVerbs =
    | "delete"
    | "patch"
    | "post"
    | "put";

  declare type core$NeedleHttpVerbs =
    | core$NeedleReadonlyHttpVerbs
    | core$NeedleReadWriteHttpVerbs;
  ...
  declare export type needle$BodyData = core$BodyData;

  declare export type needle$NeedleCallback = core$NeedleCallback;

  declare export type needle$NeedleHttpVerbs = core$NeedleHttpVerbs;

  declare export type needle$NeedleOptions = core$NeedleOptions;

  declare export type needle$NeedleResponse = core$NeedleResponse;

  declare export type needle$ReadableStream = core$ReadableStream;

  /**
   * Lets override the defaults for all future requests.
   */
  declare export function needle$defaults(
  ...
  declare export function needle$head(
    url: string,
    callback?: needle$NeedleCallback
  ): needle$ReadableStream;
  ...
  declare export { deleteFunc as delete };
