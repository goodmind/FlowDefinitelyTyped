declare module "bootstrap-growl-ifightcrime" {
  ...
  declare type BootstrapGrowlIfightcrime$AlertType =
    | "info"
    | "danger"
    | "success"
    | "warning"
  ...
  declare type BootstrapGrowlIfightcrime$AlignType =
    | "left"
    | "center"
    | "right";
  ...
  declare interface JQueryStatic {
    ...
    bootstrapGrowl: (
      message: string,
      options?: BootstrapGrowlIfightcrime$BootstrapGrowlIfightcrime$Options
    ) => JQuery;
  }
}
