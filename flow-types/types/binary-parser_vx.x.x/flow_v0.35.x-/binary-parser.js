declare module 'binary-parser' {
        declare export interface Parser<O: {[key: string]: any} | void> {
parse(
buffer: Buffer,
callback?: (err?: Error, result?: any) => void): Parser$Parser$Parsed<O>,
create(constructorFunction: ObjectConstructor): Parser,
int8<N: string>(
name: N,
options?: Parser$Parser$Options): Parser$Parser$Next<O, N, number>,
uint8<N: string>(
name: N,
options?: Parser$Parser$Options): Parser$Parser$Next<O, N, number>,
int16<N: string>(
...
string<N: string>(
name: N,
options?: Parser$Parser$StringOptions): Parser$Parser$Next<O, N, string>,
buffer<N: string>(
name: N,
options: Parser$Parser$BufferOptions): Parser$Parser$Next<O, N, Buffer>,
array<N: string, Q: Parser$Parser$ArrayOptions>(
name: N,
options: Q): Parser$Parser$Next<O, N, "There was Conditional Type, use $Call utility type">,
...
new (): Parser
	...
	declare type Parser$Data = number
| string
| Array<number | Parser<any>>
| Parser<any>
| Buffer;

declare type Parser$Parsed<O: {[key: string]: any} | void> = "There was Conditional Type, use $Call utility type";
...
declare type Parser$Valid<O: {[key: string]: any} | void, P: {[key: string]: any}> = "There was Conditional Type, use $Call utility type";

declare type Parser$Next<O: {[key: string]: any} | void, N: string, T: any> = Parser<Parser$Valid<O, $ObjMapi<{[k: N]: any}, <name>(name) => T>>>;
    }
