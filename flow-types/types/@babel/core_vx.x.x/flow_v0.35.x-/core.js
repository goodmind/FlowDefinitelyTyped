declare module '@babel/core' {
	...
	declare export {
          ParserOptions,GeneratorOptions,types,template,traverse,Visitor
        }
...
callback: (path: NodePath, state: any) => void) => (path: NodePath, state: any) => void) | null
} 
	declare export type FileResultCallback = (err: Error | null, result: BabelFileResult | null) => any;
	
/**
 * Transforms the passed in code. Calling a callback with an object with the generated code, source map, and AST.
 */
declare export function transform(code: string, callback: FileResultCallback): void
 ...
 */
declare export function transform(code: string, opts?: TransformOptions): BabelFileResult | null

	
/**
 * Transforms the passed in code. Returning an object with the generated code, source map, and AST.
 */
declare export function transformSync(code: string, opts?: TransformOptions): BabelFileResult | null

	
/**
 * Transforms the passed in code. Calling a callback with an object with the generated code, source map, and AST.
 */
declare export function transformAsync(code: string, opts?: TransformOptions): Promise<BabelFileResult | null>

	
/**
 * Asynchronously transforms the entire contents of a file.
 */
declare export function transformFile(filename: string, callback: FileResultCallback): void
 ...
 */
declare export function transformFileSync(filename: string, opts?: TransformOptions): BabelFileResult | null

	
/**
 * Asynchronously transforms the entire contents of a file.
 */
declare export function transformFileAsync(filename: string, opts?: TransformOptions): Promise<BabelFileResult | null>

	
/**
 * Given an AST, transform it.
 */
declare export function transformFromAst(ast: Node, code: string | void, callback: FileResultCallback): void
 ...
 * Here for backward-compatibility. Ideally use ".transformSync" if you want a synchronous API.
 */
declare export function transformFromAstSync(ast: Node, code?: string, opts?: TransformOptions): BabelFileResult | null
...
ast: Node,
code?: string,
opts?: TransformOptions): Promise<BabelFileResult | null>
...
specifiers: {[key: string]: any}[]
	...
	declare export type FileParseCallback = (err: Error | null, result: ParseResult | null) => any;
...
callback: FileParseCallback): void
 ...
 * Referenced presets and plugins will be loaded such that optional syntax plugins are automatically enabled.
 */
declare export function parse(code: string, options?: TransformOptions): ParseResult | null
 ...
 * Referenced presets and plugins will be loaded such that optional syntax plugins are automatically enabled.
 */
declare export function parseSync(code: string, options?: TransformOptions): ParseResult | null
 ...
 * Referenced presets and plugins will be loaded such that optional syntax plugins are automatically enabled.
 */
declare export function parseAsync(code: string, options?: TransformOptions): Promise<ParseResult | null>
 ...
 */
declare export function loadOptions(options?: TransformOptions): {[key: string]: any} | null
 ...
 */
declare export function loadPartialConfig(options?: TransformOptions): $ReadOnly<PartialConfig> | null
...
resolved: string
	...
	declare export type PluginTarget = string | {[key: string]: any} | ((...args: any[]) => any);
	declare export type PluginItem = ConfigItem
| PluginObj<any>
| PluginTarget
...
value: PluginTarget | [PluginTarget, PluginOptions] | [PluginTarget, PluginOptions, string | void],
