 ...
 */
declare export function inject(dispatchFunc: Listener, options: RequestOptions): Promise<ResponseObject>
 ...
 */
declare export function isInjection(obj: any): boolean
 ...
 * @see {@link https://github.com/hapijs/shot/blob/master/API.md#shotinjectdispatchfunc-options-callback}
 */
declare export type Listener = (req: SimulatedRequestObject, res: SimulatedResponseObject) => void;
	
/**
 * a simulated request object. Inherits from Stream.Readable.
 * @see {@link https://github.com/hapijs/shot/blob/master/API.md#shotinjectdispatchfunc-options-callback}
 */
declare export type SimulatedRequestObject = {} & Readable
 ...
 * @see {@link https://github.com/hapijs/shot/blob/master/API.md#shotinjectdispatchfunc-options-callback}
 */
declare export type SimulatedResponseObject = {} & ServerResponse
 ...
 */
payload?: string | Buffer | Stream | {[key: string]: any},
