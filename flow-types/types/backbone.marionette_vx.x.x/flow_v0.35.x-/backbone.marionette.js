...
getUI(ui: string): JQuery
	...
	declare export type CollectionViewOptions<TModel: Backbone.Model, TCollection: Backbone.Collection<TModel>> = {
 ...
 * initialize.
 */
declare export class CollectionView<TModel: Backbone.Model, TView: View<TModel>, TCollection: Backbone.Collection<TModel>> mixins View<TModel> {
