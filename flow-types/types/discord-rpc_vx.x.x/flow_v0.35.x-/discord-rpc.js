declare module 'discord-rpc' {
	...
	declare export function register(id: string): boolean

	declare export class Client mixins EventEmitter {
constructor(options: RPCClientOptions): this;
application: {
description: string,
icon: string,
id: string,
...
selectVoiceChannel(id: string, options?: {
timeout?: number,
force?: boolean
}): Promise<Channel>;
selectTextChannel(id: string, options?: {
timeout: number,
force: boolean
}): Promise<Channel>;
...
destroy(): Promise<void>
	...
	declare export interface RPCClientOptions {
transport: "ipc" | "websocket"
} 
	declare export interface RPCLoginOptions {
clientId: string,
clientSecret?: string,
accessToken?: string,
rpcToken?: string,
...
scopes?: string[]
	...
	declare export interface Guild {
id: string,
name: string,
icon_url?: string,
members?: any[]
...
messages?: any[]
	...
	declare export interface CertifiedDevice {
...
hardwareMute?: boolean
	...
	declare export interface UserVoiceSettings {
id: string,
pan?: {
left: number,
right: number
...
mute?: boolean
	...
	declare export interface VoiceSettings {
automaticGainControl: boolean,
echoCancellation: boolean,
noiseSuppression: boolean,
qos: boolean,
