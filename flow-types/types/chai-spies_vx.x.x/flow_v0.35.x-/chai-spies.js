...
(fn: ChaiSpies$SpyFunc0<R>): ChaiSpies$SpyFunc0Proxy<R>,
(fn: ChaiSpies$SpyFunc1<A1, R>): ChaiSpies$SpyFunc1Proxy<A1, R>,
(fn: ChaiSpies$SpyFunc2<A1, A2, R>): ChaiSpies$SpyFunc2Proxy<A1, A2, R>,
(fn: ChaiSpies$SpyFunc3<A1, A2, A3, R>): ChaiSpies$SpyFunc3Proxy<A1, A2, A3, R>,
(fn: ChaiSpies$SpyFunc4<A1, A2, A3, A4, R>): ChaiSpies$SpyFunc4Proxy<A1, A2, A3, A4, R>,
(fn: ChaiSpies$SpyFunc5<A1, A2, A3, A4, A5, R>): ChaiSpies$SpyFunc5Proxy<A1, A2, A3, A4, A5, R>,
(fn: ChaiSpies$SpyFunc6<A1, A2, A3, A4, A5, A6, R>): ChaiSpies$SpyFunc6Proxy<A1, A2, A3, A4, A5, A6, R>,
(fn: ChaiSpies$SpyFunc7<A1, A2, A3, A4, A5, A6, A7, R>): ChaiSpies$SpyFunc7Proxy<A1, A2, A3, A4, A5, A6, A7, R>,
(fn: ChaiSpies$SpyFunc8<A1, A2, A3, A4, A5, A6, A7, A8, R>): ChaiSpies$SpyFunc8Proxy<A1, A2, A3, A4, A5, A6, A7, A8, R>,
(fn: ChaiSpies$SpyFunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9, R>): ChaiSpies$SpyFunc9Proxy<A1, A2, A3, A4, A5, A6, A7, A8, A9, R>,
(fn: ChaiSpies$SpyFunc10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R>): ChaiSpies$SpyFunc10Proxy<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R>,
(name: string, fn: ChaiSpies$SpyFunc0<R>): ChaiSpies$SpyFunc0Proxy<R>,
(name: string, fn: ChaiSpies$SpyFunc1<A1, R>): ChaiSpies$SpyFunc1Proxy<A1, R>,
(name: string, fn: ChaiSpies$SpyFunc2<A1, A2, R>): ChaiSpies$SpyFunc2Proxy<A1, A2, R>,
(name: string, fn: ChaiSpies$SpyFunc3<A1, A2, A3, R>): ChaiSpies$SpyFunc3Proxy<A1, A2, A3, R>,
(name: string, fn: ChaiSpies$SpyFunc4<A1, A2, A3, A4, R>): ChaiSpies$SpyFunc4Proxy<A1, A2, A3, A4, R>,
(name: string, fn: ChaiSpies$SpyFunc5<A1, A2, A3, A4, A5, R>): ChaiSpies$SpyFunc5Proxy<A1, A2, A3, A4, A5, R>,
(name: string, fn: ChaiSpies$SpyFunc6<A1, A2, A3, A4, A5, A6, R>): ChaiSpies$SpyFunc6Proxy<A1, A2, A3, A4, A5, A6, R>,
(name: string, fn: ChaiSpies$SpyFunc7<A1, A2, A3, A4, A5, A6, A7, R>): ChaiSpies$SpyFunc7Proxy<A1, A2, A3, A4, A5, A6, A7, R>,
(name: string, fn: ChaiSpies$SpyFunc8<A1, A2, A3, A4, A5, A6, A7, A8, R>): ChaiSpies$SpyFunc8Proxy<A1, A2, A3, A4, A5, A6, A7, A8, R>,
(name: string, fn: ChaiSpies$SpyFunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9, R>): ChaiSpies$SpyFunc9Proxy<A1, A2, A3, A4, A5, A6, A7, A8, A9, R>,
(name: string, fn: ChaiSpies$SpyFunc10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R>): ChaiSpies$SpyFunc10Proxy<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R>,
 ...
 *          * ```
 */
(a: any, b?: any, c?: any, d?: any, e?: any, f?: any, g?: any, h?: any, i?: any, j?: any): Chai$Chai$Assertion,
...
declare interface ChaiSpies$SpyFunc10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> {
(a: A1, b: A2, c: A3, d: A4, e: A5, f: A6, g: A7, h: A8, i: A9, j: A10): R
} 

declare type ChaiSpies$SpyFunc0Proxy<R> = {} & ChaiSpies$SpyFunc0<R> & ChaiSpies$Resetable


declare type ChaiSpies$SpyFunc1Proxy<A1, R> = {} & ChaiSpies$SpyFunc1<A1, R> & ChaiSpies$Resetable


declare type ChaiSpies$SpyFunc2Proxy<A1, A2, R> = {} & ChaiSpies$SpyFunc2<A1, A2, R> & ChaiSpies$Resetable


declare type ChaiSpies$SpyFunc3Proxy<A1, A2, A3, R> = {} & ChaiSpies$SpyFunc3<A1, A2, A3, R> & ChaiSpies$Resetable


declare type ChaiSpies$SpyFunc4Proxy<A1, A2, A3, A4, R> = {} & ChaiSpies$SpyFunc4<A1, A2, A3, A4, R> & ChaiSpies$Resetable


declare type ChaiSpies$SpyFunc5Proxy<A1, A2, A3, A4, A5, R> = {} & ChaiSpies$SpyFunc5<A1, A2, A3, A4, A5, R> & ChaiSpies$Resetable


declare type ChaiSpies$SpyFunc6Proxy<A1, A2, A3, A4, A5, A6, R> = {} & ChaiSpies$SpyFunc6<A1, A2, A3, A4, A5, A6, R> & ChaiSpies$Resetable


declare type ChaiSpies$SpyFunc7Proxy<A1, A2, A3, A4, A5, A6, A7, R> = {} & ChaiSpies$SpyFunc7<A1, A2, A3, A4, A5, A6, A7, R> & ChaiSpies$Resetable


declare type ChaiSpies$SpyFunc8Proxy<A1, A2, A3, A4, A5, A6, A7, A8, R> = {} & ChaiSpies$SpyFunc8<A1, A2, A3, A4, A5, A6, A7, A8, R> & ChaiSpies$Resetable


declare type ChaiSpies$SpyFunc9Proxy<A1, A2, A3, A4, A5, A6, A7, A8, A9, R> = {} & ChaiSpies$SpyFunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9, R> & ChaiSpies$Resetable


declare type ChaiSpies$SpyFunc10Proxy<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> = {} & ChaiSpies$SpyFunc10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> & ChaiSpies$Resetable
declare var spies: ChaiSpies$ChaiSpies$Spy;declare module 'chai-spies' {
