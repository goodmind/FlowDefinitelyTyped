declare module "navigator-permissions" {
   ...
   */
  declare type NavigatorPermissions$PermissionState =
    | "granted"
    | "denied"
    | "prompt";
   ...
   */
  declare type NavigatorPermissions$PermissionName =
    | "accelerometer"
   ...
   */
  declare interface NavigatorPermissions$PermissionDescriptor<
    N: NavigatorPermissions$PermissionName
  > {
    /**
  ...
  declare interface NavigatorPermissions$QueryNameDescriptorMap {
    ...
    "accessibility-events": NavigatorPermissions$PermissionDescriptor<
      "accessibility-events"
    >;
    "ambient-light-sensor": NavigatorPermissions$PermissionDescriptor<
      "ambient-light-sensor"
    >;
    "background-sync": NavigatorPermissions$PermissionDescriptor<
      "background-sync"
    >;
    camera: NavigatorPermissions$PermissionDescriptor<"camera">;
    "clipboard-read": NavigatorPermissions$PermissionDescriptor<
      "clipboard-read"
    >;
    "clipboard-write": NavigatorPermissions$PermissionDescriptor<
      "clipboard-write"
    >;
    ...
    "payment-handler": NavigatorPermissions$PermissionDescriptor<
      "payment-handler"
    >;
    "persistent-storage": NavigatorPermissions$PermissionDescriptor<
      "persistent-storage"
    >;
 ...
 */
    query(
      permissionDescriptor: $ElementType<
        NavigatorPermissions$QueryNameDescriptorMap,
        $Keys<NavigatorPermissions$QueryNameDescriptorMap>
      >
    ): Promise<NavigatorPermissions$PermissionStatus>;
    ...
    revoke(
      permissionDescriptor: $ElementType<
        NavigatorPermissions$RevokeNameDescriptorMap,
        $Keys<NavigatorPermissions$RevokeNameDescriptorMap>
      >
    ): Promise<NavigatorPermissions$PermissionStatus>;
  }
