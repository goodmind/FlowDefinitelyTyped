...
size: number,
str: string,
options?: RangeParser$RangeParser$Options): RangeParser$RangeParser$Result | RangeParser$RangeParser$Ranges
...
declare type RangeParser$Result = RangeParser$ResultUnsatisfiable | RangeParser$ResultInvalid;
