declare module "react-native-snap-carousel" {
  ...
  declare export type CarouselProperties<T> = ScrollViewProps &
    CarouselProps<T> &
  ...
  declare export type ParallaxImageProperties = ParallaxImageProps &
    React.Props<ParallaxImageStatic>;
  declare export class ParallaxImage
    mixins React.Component<ParallaxImageProperties> {}
  ...
  declare export type PaginationProperties = PaginationProps &
    React.Props<PaginationStatic>;
  declare export class Pagination
    mixins React.Component<PaginationProperties> {}
  declare export default class Carousel<T>
    mixins React.Component<CarouselProperties<T>> {}
}
