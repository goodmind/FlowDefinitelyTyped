declare module 'react-native-snap-carousel' {
	...
	import type {
          Animated,LayoutChangeEvent,NativeSyntheticEvent,NativeScrollEvent,StyleProp,ScrollViewProps,ViewStyle,ImageProps,FlatListProps
        } from 'react-native';

	declare export interface AdditionalParallaxProps {
...
vertical?: boolean
	...
	declare export type CarouselProps<T> = {
...
parallaxProps?: AdditionalParallaxProps): React.ReactNode,
...
carouselProps: CarouselProps<any>): StyleProp<ViewStyle>,
...
} & React.Props<ScrollViewProps>

	declare export type CarouselStatic<T> = {
...
} & React.ComponentClass<CarouselProps<T>>

	declare export type CarouselProperties<T> = ScrollViewProps & CarouselProps<T> & React.Props<CarouselStatic<T>>;
	declare export type ParallaxImageProps = {
 ...
 */
spinnerColor?: string
} & ImageProps & AdditionalParallaxProps

	declare export type ParallaxImageStatic = React.ComponentClass<ParallaxImageProps>;
	declare export type ParallaxImageProperties = ParallaxImageProps & React.Props<ParallaxImageStatic>;
	declare export class ParallaxImage mixins React.Component<ParallaxImageProperties> {}
...
vertical?: boolean
	...
	declare export type PaginationStatic = React.ComponentClass<PaginationProps>;
	declare export type PaginationProperties = PaginationProps & React.Props<PaginationStatic>;
	declare export class Pagination mixins React.Component<PaginationProperties> {}
	declare export default class Carousel<T> mixins React.Component<CarouselProperties<T>> {}
    }
