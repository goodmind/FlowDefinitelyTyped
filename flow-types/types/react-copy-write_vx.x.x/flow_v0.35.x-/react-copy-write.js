...
...state: Array<$ReadOnly<ReturnType<SelectorFn<T>>>>) => JSX.Element | JSX.Element[] | null;
...
children?: RenderFn<T>
	...
	declare type ConsumerProps<T> = ConsumerPropsExplicitRender<T> | ConsumerPropsImplicitRender<T>;
