...
declare function iferr$iferr<T>(fail: (err: Error) => void, succ: (...result: T[]) => void): nodeCallback<T>


declare function iferr$tiferr<T>(fail: (err: Error) => void, succ: (...result: T[]) => void): nodeCallback<T>


declare function iferr$throwerr<T>(succ: (...result: T[]) => void): nodeCallback<T>
