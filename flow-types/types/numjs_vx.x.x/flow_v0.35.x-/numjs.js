 ...
 */
declare export function arange<T>(start: number, stop?: number, dtype?: NdType<T>): NdArray<T>

	declare export function arange<T>(stop: number, dtype: NdType<T>): NdArray<T>

	declare export function arange<T>(start: number, stop: number, step: number, dtype?: NdType<T>): NdArray<T>
 ...
 */
declare export function clip<T>(x: NjParam<T>, min?: number, max?: number): NdArray<T>

	
/**
 * Join given arrays along the last axis.
 */
declare export function concatenate<T>(...arrays: Array<NjArray<T>>): NdArray<T>
 ...
 */
declare export function empty<T>(shape: NdArrayData<T> | number, dtype?: NdType<T>): NdArray<T>
 ...
 */
declare export function fftconvolve<T>(a: NjArray<T>, b: NjArray<T>): NdArray<T>
...
declare export function flatten<T>(array: NjArray<T>): NdArray<T>
	...
	declare export function setRawData<T>(array: NdArrayData<T>, data: NdArrayData<T>): Uint8Array
 ...
 */
declare export function ones<T>(shape: NdArrayData<T> | number, dtype?: BaseNdArray.DataType): NdArray<T>
 ...
 */
declare export function random<T>(shape?: NdArrayData<T> | number): NdArray<T>
 ...
 */
declare export function reshape<T>(array: NjArray<T>, shape: NdArray<T>): NdArray<T>
...
//        [[ 3, 4, 5]]])
 */
declare export function transpose<T>(x: NjParam<T>, axes?: number): NdArray<T>
 ...
 */
declare export function zeros<T>(shape: NdArrayData<T> | number, dtype?: BaseNdArray.DataType): NdArray<T>
 ...
 */
declare export function identity<T>(n: T, dtype?: BaseNdArray.DataType): NdArray<T>
 ...
 */
declare export function stack<T>(arrays: Array<NdArray<T>>, axis?: number): NdArray<T>
...
declare function images$resize<T>(img: NdArray<T>, height: number, width: number): NdArray<Uint8Array>
...
declare function images$areaSum<T>(h0: number, w0: number, H: number, W: number, SAT: NdArray<T>): number
...
declare function images$flip<T, O>(img: NdArray<T>): NdArray<O>
	...
	declare export function array<T>(arr: NjArray<T>, dtype?: BaseNdArray.DataType): NdArray<T>
