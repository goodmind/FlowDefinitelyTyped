...
contextAttributes?: wx$types.types$RenderingContextConfig): WxRenderingContext | WxWebGLRenderingContext;
...
readFileSync(
filePath: string,
encoding?: wx$types.types$FileContentEncoding): string | ArrayBuffer;
...
encoding?: wx$types.types$FileContentEncoding): void;
 ...
 * @param 文件创建时间
 */
getSavedFileList(param: wx$types.types$CallbacksWithType<wx$types.types$SavedfileList>): void;
...
declare type types$FileContentEncoding = "ascii"
| "base64"
| "binary"
| "hex"
| "ucs2"
...
declare type types$NetworkType = "wifi"
| "2g"
| "3g"
| "4g"
| "unknown"
...
declare type types$RequestMethod = "GET"
| "HEAD"
| "POST"
| "PUT"
| "DELETE"
...
declare type types$AudioSourceType = "auto"
| "buildInMic"
| "headsetMic"
| "mic"
| "camcorder";
 ...
 * @param p 字体参数
 */
declare function wx$getTextLineHeight(p: types$types$LineHeightParams): number
...
declare function wx$onShow(cb: (res: {
scene: string,
query: any,
shareTicket: string
}) => void): void
...
declare function wx$offShow(cb: (res: {
scene: string,
query: any,
shareTicket: string
}) => void): void
...
declare function wx$getSystemInfo(cb: types$types$CallbacksWithType<types$types$SystemInfo>): void
 ...
 * 监听全局错误事件
 */
declare function wx$onError(cb: (res: {
message: string,
stack: string
}) => void): void


declare function wx$offError(cb: (res: {
message: string,
stack: string
}) => void): void
 ...
 * 监听开始始触摸事件
 */
declare function wx$onTouchStart(cb: (res: types$types$TouchData) => void): void


declare function wx$offTouchStart(cb: (res: types$types$TouchData) => void): void
 ...
 * 监听触点移动事件
 */
declare function wx$onTouchMove(cb: (res: types$types$TouchData) => void): void


declare function wx$offTouchMove(cb: (res: types$types$TouchData) => void): void
 ...
 * 监听触摸结束事件
 */
declare function wx$onTouchEnd(cb: (res: types$types$TouchData) => void): void


declare function wx$offTouchEnd(cb: (res: types$types$TouchData) => void): void
 ...
 * 监听触点失效事件
 */
declare function wx$onTouchCancel(cb: (res: types$types$TouchData) => void): void


declare function wx$offTouchCancel(cb: (res: types$types$TouchData) => void): void
 ...
 */
declare function wx$onAccelerometerChange(cb: (res: {
x: number,
y: number,
z: number
}) => void): void
 ...
 * 开始监听加速度数据。
 */
declare function wx$startAccelerometer(cb: types$types$AccelerometerParams): void
 ...
 */
declare function wx$getBatteryInfo(cb: types$types$CallbacksWithType<types$types$BatteryInfo>): void
 ...
 * 取得系统剪贴板的内容
 */
declare function wx$getClipboardData(cb: types$types$CallbacksWithType<types$types$ClipboardData>): void
 ...
 * 设置系统剪贴板的内容
 */
declare function wx$setClipboardData(p: types$types$SetClipboardDataParams): void
 ...
 * @param 面对的方向度数
 */
declare function wx$onCompassChange(cb: (res: {
direction: number
}) => void): void
 ...
 * 获取屏幕亮度
 */
declare function wx$getScreenBrightness(cb: types$types$CallbacksWithType<{
value: number
}>): void
 ...
 */
declare function wx$setKeepScreenOn(p: types$types$SetKeepScreenOnParams): void
 ...
 * 设置屏幕亮度
 */
declare function wx$setScreenBrightness(p: types$types$SetScreenBrightnessParams): void
 ...
 * 监听横竖屏切换事件
 */
declare function wx$onDeviceOrientationChange(callback: (res: {
value: string
}) => void): void
 ...
 * 取消监听横竖屏切换事件
 */
declare function wx$offDeviceOrientationChange(callback: (res: {
value: string
}) => void): void
 ...
 */
declare function wx$getLocation(
param: {
 ...
 * 下载文件
 */
declare function wx$downloadFile(param: types$types$DownfileParams): DownloadTask
 ...
 */
declare function wx$connectSocket(param: types$types$SocketConnectParams): SocketTask
 ...
 * 监听WebSocket 连接打开事件
 */
declare function wx$onSocketOpen(callback: types$types$SocketOpenCallback): void
 ...
 * 监听WebSocket 接受到服务器的消息事件
 */
declare function wx$onSocketMessage(callback: types$types$SocketMessageCallback): void
 ...
 * 监听WebSocket 错误事件
 */
declare function wx$onSocketError(callback: types$types$SocketErrorCallback): void
 ...
 */
declare function wx$sendSocketMessage(param: types$types$SocketSendParams): void


declare function wx$uploadFile(
param: {
 ...
 */
declare function wx$getFriendCloudStorage(
param: {
 ...
 */
declare function wx$getUserCloudStorage(
param: {
 ...
 */
declare function wx$getUserInfo(param: types$types$NewUserInfoParam | types$types$OldUserInfoParam): void
 ...
 */
declare function wx$getGroupCloudStorage(
param: {
 ...
 */
declare function wx$removeUserCloudStorage(
param: {
 ...
 */
declare function wx$setUserCloudStorage(
param: {
 ...
 */
declare function wx$checkIsUserAdvisedToRest(
param: {
...
declare function wx$createUserInfoButton(
param: {
 ...
 * 创建打开设置页面的按钮
 */
declare function wx$createOpenSettingButton(
param: {
 ...
 */
declare function wx$createGameClubButton(
param: {
type: types$types$ButtonType,
text?: string,
image?: string,
 ...
 * 用户点击后打开意见反馈页面的按钮
 */
declare function wx$createFeedbackButton(
param: {
type: types$types$ButtonType,
text?: string,
image?: string,
 ...
 */
declare function wx$openCustomerServiceConversation(
param: {
 ...
 * 获取转发详细信息
 */
declare function wx$getShareInfo(
param: {
shareTicket: string,
success?: (
res: {
 ...
 */
declare function wx$onShareAppMessage(cb: () => types$types$ShareOption): void
 ...
 */
declare function wx$offShareAppMessage(cb: () => types$types$ShareOption): void
 ...
 * 显示当前页面的转发按钮
 */
declare function wx$showShareMenu(
param?: {
 ...
 */
declare function wx$onMemoryWarning(callback: (res: {
level: number
}) => void): void


declare function wx$setEnableDebug(
p: {
enableDebug: boolean,
success?: () => void,
fail?: () => void,
 ...
 * 异步获取当前storage的相关信息
 */
declare function wx$getStorageInfo(param: types$types$CallbacksWithType<types$types$StorageInfo>): void
 ...
 * 从本地缓存中移除指定 key
 */
declare function wx$removeStorage(param: types$types$RemoveStorageParams): void
 ...
 * 触发分包加载，详见 分包加载
 */
declare function wx$loadSubpackage(
param: {
...
declare function wx$setMenuStyle(
param: {
 ...
 */
declare function wx$showLoading(
prms?: {
 ...
 * 显示选择器
 */
declare function wx$showActionSheet(
params: {
 ...
 * @param 键盘输入的当前值
 */
declare function wx$onKeyboardInput(callback: (res: {
value: string
}) => void): void
 ...
 * 取消监听键盘输入事件
 */
declare function wx$offKeyboardInput(callback: (res: {
value: string
}) => void): void
 ...
 * @param 键盘输入的当前值
 */
declare function wx$onKeyboardConfirm(callback: (res: {
value: string
}) => void): void
 ...
 */
declare function wx$offKeyboardConfirm(callback: (res: {
value: string
}) => void): void
 ...
 * @param 键盘输入的当前值
 */
declare function wx$onKeyboardComplete(callback: (res: {
value: string
}) => void): void
 ...
 * 取消监听监听键盘收起的事件
 */
declare function wx$offKeyboardComplete(callback: (res: {
value: string
}) => void): void
 ...
 * 显示键盘
 */
declare function wx$showKeyboard(
param: {
 ...
 */
declare function wx$updateKeyboard(
param: {
 ...
 */
declare function wx$setStatusBarStyle(
param: {
style: "white" | "black",
success?: () => void,
fail?: () => void,
 ...
 * 监听窗口尺寸变化事件
 */
declare function wx$onWindowResize(cb: (res: {
windowWidth: number,
windowHeight: number
}) => void): void
 ...
 * 取消监听窗口尺寸变化事件
 */
declare function wx$offWindowResize(cb: (res: {
windowWidth: number,
windowHeight: number
}) => void): void
 ...
 * 从本地相册选择图片或使用相机拍照。
 */
declare function wx$chooseImage(
param: {
count: number,
 ...
 */
declare function wx$previewImage(
param: {
...
declare function wx$createVideo(
param: {
 ...
 */
declare function wx$createBannerAd(
param: {
 ...
 * 发起米大师支付
 */
declare function wx$requestMidasPayment(
param: {
