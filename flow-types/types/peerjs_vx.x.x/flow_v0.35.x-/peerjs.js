...
connect(
id: string,
options?: PeerJs$PeerJs$PeerConnectOption): PeerJs$PeerJs$DataConnection,
...
on(
event: "connection",
cb: (dataConnection: PeerJs$PeerJs$DataConnection) => void): void,
...
on(
event: "call",
cb: (mediaConnection: PeerJs$PeerJs$MediaConnection) => void): void,
