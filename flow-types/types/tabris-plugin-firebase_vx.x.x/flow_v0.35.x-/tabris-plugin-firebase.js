...
screenName: string,
userId: string
} & NativeObject & PropertyMixins$firebase$Analytics
...
instanceIdChanged(event: PropertyChangedEvent<firebase$Messaging, string>): void,
tokenChanged(event: PropertyChangedEvent<firebase$Messaging, string>): void,
...
declare type PropertyMixins$Analytics = {
logEvent(eventName: string, parameters?: {
[key: string]: string
}): void,
setUserProperty(propertyName: string, value: string): void,
...
screenName: string,
userId: string
} & NativeObject & PropertyMixins$PropertyMixins$Analytics
