 ...
 */
declare export interface TimeLocaleDefinition {
 ...
 */
declare export interface TimeLocaleObject {
 ...
 */
declare export function timeFormatLocale(timeLocale: TimeLocaleDefinition): TimeLocaleObject
 ...
 * @param timeLocale A time locale definition.
 */
declare export function timeFormatDefaultLocale(defaultTimeLocale: TimeLocaleDefinition): TimeLocaleObject
 ...
 * @param specifier A specifier string for the date format.
 */
declare export function timeFormat(specifier: string): (date: Date) => string
 ...
 * @param specifier A specifier string for the date format.
 */
declare export function timeParse(specifier: string): (dateString: string) => (Date | null)
 ...
 * @param specifier A specifier string for the date format.
 */
declare export function utcFormat(specifier: string): (date: Date) => string
 ...
 * @param specifier A specifier string for the date format.
 */
declare export function utcParse(specifier: string): (dateString: string) => (Date | null)
 ...
 */
declare export function isoFormat(date: Date): string
 ...
 */
declare export function isoParse(dateString: string): Date | null
