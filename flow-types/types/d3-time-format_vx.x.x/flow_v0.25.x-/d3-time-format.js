declare module "d3-time-format" {
   ...
   */
  declare export function timeFormatLocale(
   ...
   * @param timeLocale A time locale definition.
   */
  declare export function timeFormatDefaultLocale(
   ...
   * @param specifier A specifier string for the date format.
   */
  declare export function timeParse(
    specifier: string
   ...
   * @param specifier A specifier string for the date format.
   */
  declare export function utcParse(
    specifier: string
  ): (dateString: string) => Date | null;
