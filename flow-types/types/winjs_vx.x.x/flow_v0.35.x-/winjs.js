 ...
 */
declare function Application$addEventListener(type: string, listener: Function, capture?: boolean): void
 ...
 */
declare function Application$removeEventListener(type: string, listener: Function, useCapture?: any): void
 ...
 */
declare function Application$onactivated(eventInfo: Application$IPromiseEvent): void
 ...
 */
declare function Application$oncheckpoint(eventInfo: Application$IPromiseEvent): void
 ...
 */
declare function Application$onerror(eventInfo: Application$IPromiseEvent): void
 ...
 * @param eventInfo An object that contains information about the event. The detail property of this object includes the following subproperties: type, setPromise.
 */
declare function Application$onloaded(eventInfo: Application$IPromiseEvent): void
 ...
 */
declare function Application$onready(eventInfo: Application$IPromiseEvent): void
 ...
 */
declare function Application$onsettings(eventInfo: Application$IPromiseEvent): void
 ...
 * @param eventInfo An object that contains information about the event. The detail property of this object includes the following sub-properties: type, setPromise.
 */
declare function Application$onunload(eventInfo: Application$IPromiseEvent): void
 ...
 */
declare function Application$onbackclick(eventInfo: Application$IPromiseEvent): void
 ...
 */
createFiltered(predicate: (x: T) => boolean): Binding$FilteredListProjection<T>;
...
groupKey: (x: T) => string,
groupData: (x: T) => G,
groupSorter?: (left: string, right: string) => number): Binding$GroupedSortedListProjection<T, G>;
 ...
 */
createSorted(sorter: (left: T, right: T) => number): Binding$SortedListProjection<T>;
...
href: string,
dataContext: any,
container?: HTMLElement): WinJS$Promise<HTMLElement>;
 ...
 */
declare function Binding$addClassOneTime(source: any, sourceProperties: any[], dest: HTMLElement): void
 ...
 */
declare function Binding$defaultBind(source: any, sourceProperties: any, dest: any, destProperties: any): any
 ...
 * @returns An object with a cancel method that is used to coalesce bindings.
 */
declare function Binding$oneTime(source: any, sourceProperties: any, dest: any, destProperties: any): any
...
skipRoot?: boolean,
bindingCache?: any,
defaultInitializer?: Function): WinJS$Promise<void>
 ...
 */
declare function Class$mix(function Object() { [native code] }: Function, ...Binding$mixin: any[]): any
...
onProgress?: (progress: any) => void): void,
then<U>(
onComplete?: (value: T) => WinJS$IPromise<U>,
onError?: (error: any) => WinJS$IPromise<U>,
onProgress?: (progress: any) => void): WinJS$IPromise<U>,
then<U>(
onComplete?: (value: T) => WinJS$IPromise<U>,
onError?: (error: any) => U,
onProgress?: (progress: any) => void): WinJS$IPromise<U>,
...
onError?: (error: any) => any,
onProgress?: (progress: any) => void): WinJS$IPromise<any>;
...
progress?: (progress: any) => void): WinJS$IPromise<any>;
 ...
 */
static timeout(timeout?: number, promise?: WinJS$IPromise<any>): WinJS$IPromise<any>;
 ...
 */
declare function WinJS$xhr(options: WinJS$IXHROptions): WinJS$Promise<XMLHttpRequest>
 ...
 * @returns The newly-defined namespace.
 */
declare function Namespace$defineWithParent(parentNamespace?: any, name?: string, members?: any): any
 ...
 */
declare function Navigation$addEventListener(eventType: string, listener: Function, capture?: boolean): void
 ...
 */
declare function Navigation$navigate(Navigation$location: any, initialState?: any): WinJS$Promise<boolean>
 ...
 * @param useCapture Specifies whether or not to initiate capture.
 */
declare function Navigation$removeEventListener(eventType: string, listener: Function, useCapture?: boolean): void
 ...
 */
declare function Resources$addEventListener(type: string, listener: Function, useCapture?: boolean): void
 ...
 */
declare function Resources$processAll(rootElement?: HTMLElement): WinJS$Promise<void>
 ...
 */
declare function Resources$removeEventListener(type: string, listener: Function, useCapture?: boolean): void
 ...
 */
declare function TrackTabBehavior$attach(element: HTMLElement, tabIndex: number): void
...
static +aboveNormal: Class<Scheduler$Priority__aboveNormal> & Scheduler$Priority__aboveNormal & 0;// 0
static +belowNormal: Class<Scheduler$Priority__belowNormal> & Scheduler$Priority__belowNormal & 1;// 1
...
static +normal: Class<Scheduler$Priority__normal> & Scheduler$Priority__normal & 6;// 6
 ...
 */
declare function Scheduler$requestDrain(priority?: Scheduler$Priority, name?: string): WinJS$Promise<any>
 ...
 */
declare function Scheduler$schedulePromiseAboveNormal<U>(promiseValue?: U, jobName?: string): WinJS$Promise<U>
 ...
 */
declare function Scheduler$schedulePromiseBelowNormal<U>(promiseValue?: U, jobName?: string): WinJS$Promise<U>
 ...
 */
declare function Scheduler$schedulePromiseHigh<U>(promiseValue?: U, jobName?: string): WinJS$Promise<U>
 ...
 */
declare function Scheduler$schedulePromiseIdle<U>(promiseValue?: U, jobName?: string): WinJS$Promise<U>
 ...
 */
declare function Scheduler$schedulePromiseNormal<U>(promiseValue?: U, jobName?: string): WinJS$Promise<U>
