 ...
 */
declare export function create<ClientIdName: string>(
options: ModuleOptions<ClientIdName>): OAuthClient<ClientIdName>

	declare export interface ModuleOptions<ClientIdName: string> {
client: {
...
scope?: string | string[]
	...
	declare export interface OAuthClient<ClientIdName: string> {
authorizationCode: {
