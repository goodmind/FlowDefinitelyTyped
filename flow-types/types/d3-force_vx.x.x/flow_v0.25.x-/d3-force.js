declare module "d3-force" {
   ...
   */
  declare export interface Simulation<
    NodeDatum: SimulationNodeDatum,
    LinkDatum: SimulationLinkDatum<NodeDatum> | void
  > {
    /**
 ...
 */
   ...
   * @param nodesData Optional array of nodes data, defaults to empty array.
   */
  declare export function forceSimulation<
    NodeDatum: SimulationNodeDatum,
    LinkDatum: SimulationLinkDatum<NodeDatum>
  >(
    nodesData?: NodeDatum[]
   ...
   */
  declare export interface Force<
    NodeDatum: SimulationNodeDatum,
    LinkDatum: SimulationLinkDatum<NodeDatum> | void
  > {
    /**
   ...
   */
  declare export function forceCenter<NodeDatum: SimulationNodeDatum>(
    x?: number,
    y?: number
 ...
 */
   ...
   * The generic refers to the type of data for a node.
   */
  declare export function forceCollide<
    NodeDatum: SimulationNodeDatum
 ...
 */
   ...
   * The second generic refers to the type of data for a link.
   */
  declare export function forceLink<
    NodeDatum: SimulationNodeDatum,
    LinksDatum: SimulationLinkDatum<NodeDatum>
 ...
 */
   ...
   * The generic refers to the type of data for a node.
   */
  declare export function forceManyBody<
    NodeDatum: SimulationNodeDatum
 ...
 */
   ...
   * The generic refers to the type of data for a node.
   */
  declare export function forceX<
    NodeDatum: SimulationNodeDatum
  >(): ForceX<NodeDatum>;
 ...
 */
   ...
   * The generic refers to the type of data for a node.
   */
  declare export function forceY<
    NodeDatum: SimulationNodeDatum
  >(): ForceY<NodeDatum>;
