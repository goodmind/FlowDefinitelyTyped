declare module 'next-redux-wrapper' {
	...
	import type {
          MapDispatchToPropsParam,MapStateToPropsParam,MergeProps,ConnectOptions
        } from 'react-redux';
...
options: nextReduxWrapper$StoreCreatorOptions<TInitialState, TStateProps, TDispatchProps, TOwnProps, TMergedProps>) => Store<TInitialState>;
	declare function nextReduxWrapper<TInitialState, TStateProps, TDispatchProps, TOwnProps, TMergedProps>(
