declare module 'redux-first-routing' {
	...
	import type {
          History,Pathname,Search,Hash,Path,LocationDescriptorObject
        } from 'history';

	import type {
          Action,Store,Reducer,Middleware
        } from 'redux';
...
payload: T
	...
	declare export function push<T: Path | LocationDescriptorObject>(href: T): pushAction<T>

	declare export type replaceAction<T: Path | LocationDescriptorObject> = {
payload: T
} & Action<typeof REPLACE>

	declare export function replace<T: Path | LocationDescriptorObject>(href: T): replaceAction<T>
...
hash: H
	...
	declare export function locationChange<P: Pathname, S: Search, H: Hash>(
_: {
pathname: P,
search: S,
hash: H
...
hash: Hash
	...
	declare export function routerMiddleware(history: History): Middleware<any, State>
