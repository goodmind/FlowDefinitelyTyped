declare module '@feathersjs/authentication' {
	...
	declare var feathersAuthentication: ((config?: FeathersAuthenticationOptions) => () => void) & typeof self;
...
options?: FeathersAuthenticationOptions): RequestHandler


declare function express$setCookie(options?: FeathersAuthenticationOptions): RequestHandler


declare function express$successRedirect(): RequestHandler


declare function express$failureRedirect(options?: FeathersAuthenticationOptions): RequestHandler


declare function express$emitEvents(): RequestHandler

	declare export function service(options: FeathersAuthenticationOptions): (app?: Application) => void

	declare class service$Service<T>  {
constructor(app: Application): this;
create(data: $Shape<T>, params: Params): Promise<{
accessToken: string
}>;
remove(id: null | string, params: Params): Promise<{
accessToken: string
}>
}
