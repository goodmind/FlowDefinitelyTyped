declare module '@feathersjs/authentication-oauth2' {
	...
	declare export interface FeathersAuthenticationOAuth2Options<VerifierType, ServiceType> {
...
__oath?: boolean
	...
	declare interface FeathersAuthenticationOAuth2Data<T: Profile> {
profile: T,
accessToken: string,
refreshToken: string
} 
	declare export class Verifier<DataType, OptionType: FeathersAuthenticationOAuth2Options, ProfileType: Profile>  {
