declare module 'halogen' {
	...
	declare export type VerticalAlign = "baseline"
| "length"
| "sub"
| "super"
| "top"
...
declare export type PulseLoader = react.Component<MarginLoaderProps<string>>;
	declare export var PulseLoader: react.ComponentClass<MarginLoaderProps<string>>;
	declare export type RotateLoader = react.Component<MarginLoaderProps<string>>;
	declare export var RotateLoader: react.ComponentClass<MarginLoaderProps<string>>;
	declare export type BeatLoader = react.Component<MarginLoaderProps<string>>;
	declare export var BeatLoader: react.ComponentClass<MarginLoaderProps<string>>;
	declare export type RiseLoader = react.Component<MarginLoaderProps<string>>;
	declare export var RiseLoader: react.ComponentClass<MarginLoaderProps<string>>;
	declare export type SyncLoader = react.Component<MarginLoaderProps<string>>;
	declare export var SyncLoader: react.ComponentClass<MarginLoaderProps<string>>;
	declare export type GridLoader = react.Component<MarginLoaderProps<string>>;
	declare export var GridLoader: react.ComponentClass<MarginLoaderProps<string>>;
	...
	declare export var PacmanLoader: react.ComponentClass<MarginLoaderProps<number>>;
