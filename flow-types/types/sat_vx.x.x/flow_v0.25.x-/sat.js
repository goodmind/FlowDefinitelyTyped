 ...
 */
declare export function SAT$pointInCircle(
  p: SAT$Vector,
  c: SAT$Circle
): boolean;
 ...
 * @return {boolean} return {true} if there is a collision. {false} otherwise.
 */
declare export function SAT$pointInPolygon(
  p: SAT$Vector,
  poly: SAT$Polygon
): boolean;
 ...
 * @return {boolean} return {true} if there is a collision. {false} otherwise.
 */
declare export function SAT$testCircleCircle(
  a: SAT$Circle,
  b: SAT$Circle,
 ...
 * @return {boolean} return {true} if there is a collision. {false} otherwise.
 */
declare export function SAT$testPolygonCircle(
  polygon: SAT$Polygon,
  circle: SAT$Circle,
  response?: SAT$Response
): boolean;
 ...
 * @return {boolean} return {true} if there is a collision. {false} otherwise.
 */
declare export function SAT$testCirclePolygon(
  circle: SAT$Circle,
  polygon: SAT$Polygon,
  response?: SAT$Response
): boolean;
 ...
 * @return {boolean} return {true} if there is a collision. {false} otherwise.
 */
declare export function SAT$testPolygonPolygon(
  a: SAT$Polygon,
  b: SAT$Polygon,
  response?: SAT$Response
): boolean;
