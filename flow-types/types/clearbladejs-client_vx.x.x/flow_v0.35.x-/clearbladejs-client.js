...
static +MESSAGING_QOS_AT_MOST_ONCE: Class<CbClient$MessagingQOS__MESSAGING_QOS_AT_MOST_ONCE> & CbClient$MessagingQOS__MESSAGING_QOS_AT_MOST_ONCE & 0;// 0
static +MESSAGING_QOS_AT_LEAST_ONCE: Class<CbClient$MessagingQOS__MESSAGING_QOS_AT_LEAST_ONCE> & CbClient$MessagingQOS__MESSAGING_QOS_AT_LEAST_ONCE & 1;// 1
static +MESSAGING_QOS_EXACTLY_ONCE: Class<CbClient$MessagingQOS__MESSAGING_QOS_EXACTLY_ONCE> & CbClient$MessagingQOS__MESSAGING_QOS_EXACTLY_ONCE & 2;// 2

}

declare class CbClient$MessagingQOS__MESSAGING_QOS_AT_MOST_ONCE mixins CbClient$MessagingQOS {}
declare class CbClient$MessagingQOS__MESSAGING_QOS_AT_LEAST_ONCE mixins CbClient$MessagingQOS {}
declare class CbClient$MessagingQOS__MESSAGING_QOS_EXACTLY_ONCE mixins CbClient$MessagingQOS {}
...
declare type CbClient$CbCallback = (error: boolean, response: CbClient$Resp) => void;
...
request(options: CbClient$RequestOptions, callback: CbClient$CbCallback): void
...
registerUser(email: string, password: string, callback: CbClient$CbCallback): void,
...
loginUser(email: string, password: string, callback: CbClient$CbCallback): void,
loginUserMqtt(email: string, password: string, callback: CbClient$CbCallback): void,
registerMasterCallback(callback: CbClient$CbCallback): void,
Collection(
options: string | CbClient$CollectionOptionsWithName | CbClient$CollectionOptionsWithID): CbClient$Collection,
Query(
options: string | CbClient$QueryOptionsWithName | CbClient$QueryOptionsWithID): CbClient$QueryObj,
Item(
data: {[key: string]: any},
collectionID: string | CbClient$ItemOptions): CbClient$Item,
Code(): CbClient$Code,
User(): CbClient$AppUser,
Messaging(
options: CbClient$MessagingOptions,
callback: CbClient$CbCallback): CbClient$Messaging,
MessagingStats(): CbClient$MessagingStats,
sendPush(
users: string[],
payload: {[key: string]: any},
appId: string,
callback: CbClient$CbCallback): void,
...
declare  class CbClient$QuerySortDirections {
  constructor(...args: empty): mixed;
static +QUERY_SORT_ASCENDING: Class<CbClient$QuerySortDirections__QUERY_SORT_ASCENDING> & CbClient$QuerySortDirections__QUERY_SORT_ASCENDING & "ASC";// "ASC"
static +QUERY_SORT_DESCENDING: Class<CbClient$QuerySortDirections__QUERY_SORT_DESCENDING> & CbClient$QuerySortDirections__QUERY_SORT_DESCENDING & "DESC";// "DESC"

}

declare class CbClient$QuerySortDirections__QUERY_SORT_ASCENDING mixins CbClient$QuerySortDirections {}
declare class CbClient$QuerySortDirections__QUERY_SORT_DESCENDING mixins CbClient$QuerySortDirections {}


declare  class CbClient$QueryConditions {
  constructor(...args: empty): mixed;
static +QUERY_EQUAL: Class<CbClient$QueryConditions__QUERY_EQUAL> & CbClient$QueryConditions__QUERY_EQUAL & "EQ";// "EQ"
static +QUERY_NOTEQUAL: Class<CbClient$QueryConditions__QUERY_NOTEQUAL> & CbClient$QueryConditions__QUERY_NOTEQUAL & "NEQ";// "NEQ"
static +QUERY_GREATERTHAN: Class<CbClient$QueryConditions__QUERY_GREATERTHAN> & CbClient$QueryConditions__QUERY_GREATERTHAN & "GT";// "GT"
static +QUERY_GREATERTHAN_EQUAL: Class<CbClient$QueryConditions__QUERY_GREATERTHAN_EQUAL> & CbClient$QueryConditions__QUERY_GREATERTHAN_EQUAL & "GTE";// "GTE"
static +QUERY_LESSTHAN: Class<CbClient$QueryConditions__QUERY_LESSTHAN> & CbClient$QueryConditions__QUERY_LESSTHAN & "LT";// "LT"
static +QUERY_LESSTHAN_EQUAL: Class<CbClient$QueryConditions__QUERY_LESSTHAN_EQUAL> & CbClient$QueryConditions__QUERY_LESSTHAN_EQUAL & "LTE";// "LTE"
static +QUERY_MATCHES: Class<CbClient$QueryConditions__QUERY_MATCHES> & CbClient$QueryConditions__QUERY_MATCHES & "RE";// "RE"

}

declare class CbClient$QueryConditions__QUERY_EQUAL mixins CbClient$QueryConditions {}
declare class CbClient$QueryConditions__QUERY_NOTEQUAL mixins CbClient$QueryConditions {}
declare class CbClient$QueryConditions__QUERY_GREATERTHAN mixins CbClient$QueryConditions {}
declare class CbClient$QueryConditions__QUERY_GREATERTHAN_EQUAL mixins CbClient$QueryConditions {}
declare class CbClient$QueryConditions__QUERY_LESSTHAN mixins CbClient$QueryConditions {}
declare class CbClient$QueryConditions__QUERY_LESSTHAN_EQUAL mixins CbClient$QueryConditions {}
declare class CbClient$QueryConditions__QUERY_MATCHES mixins CbClient$QueryConditions {}
...
declare type CbClient$QueryOptionsWithName = {} & CbClient$CollectionOptionsWithName & CbClient$QueryOptions


declare type CbClient$QueryOptionsWithID = {} & CbClient$CollectionOptionsWithID & CbClient$QueryOptions
...
key: string,
value: CbClient$QueryValue): void,
...
update(changes: {[key: string]: any}, callback: CbClient$CbCallback): void,
...
messageCallback: CbClient$MessageCallback): void,
unsubscribe(topic: string, options: CbClient$MessagingSubscribeOptions): void,
disconnect(): void
} 
...
create(newDevice: {[key: string]: any}, callback: CbClient$CbCallback): void,
columns(callback: CbClient$CbCallback): void,
count(query: CbClient$Query, callback: CbClient$CbCallback): void
} 
...
systemKey: string,
systemSecret: string,
getStorage(filter: CbClient$QueryFilter, callback: CbClient$CbCallback): void,
getCount(filter: CbClient$QueryFilter, callback: CbClient$CbCallback): void,
getEventList(filter: CbClient$QueryFilter, callback: CbClient$CbCallback): void,
getEventTotals(filter: CbClient$QueryFilter, callback: CbClient$CbCallback): void,
getUserEvents(filter: CbClient$QueryFilter, callback: CbClient$CbCallback): void
} 
...
create(name: string, data: {[key: string]: any}, callback: CbClient$CbCallback): void,
update(name: string, data: {[key: string]: any}, callback: CbClient$CbCallback): void,
delete(name: string, callback: CbClient$CbCallback): void
} 
