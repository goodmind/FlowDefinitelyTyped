...
declare function ECDSA$sign(message: Buffer, key: PrivateKey): crypto$Signature
...
declare function Script$buildMultisigOut(publicKeys: PublicKey[], threshold: number, opts: {[key: string]: any}): Script


declare function Script$buildWitnessMultisigOutFromScript(script: Script): Script
...
declare function Script$buildDataOut(data: string | Buffer, encoding?: string): Script


declare function Script$buildScriptHashOut(script: Script): Script


declare function Script$buildPublicKeyIn(signature: crypto$crypto$Signature | Buffer, sigtype: number): Script


declare function Script$buildPublicKeyHashIn(
publicKey: PublicKey,
signature: crypto$crypto$Signature | Buffer,
sigtype: number): Script
...
keys: string | string[]): Networks$Network

	declare export class Address  {
hashBuffer: Buffer;
network: Networks$Networks$Network;
type: string;
constructor(data: Buffer | Uint8Array | string | {[key: string]: any}, network?: Networks$Networks$Network, type?: string): this
}
