declare module "vis" {
  import type { MomentInput, MomentFormatSpecification, Moment } from "moment";
  ...
  declare export type MomentConstructor =
    | MomentConstructor1
    | MomentConstructor2;
  ...
  declare export type TimelineItemType =
    | "box"
    | "point"
    | "range"
    | "background";
  declare export type TimelineAlignType = "auto" | "center" | "left" | "right";
  declare export type TimelineTimeAxisScaleType =
    | "millisecond"
    | "second"
    | "minute"
    | "hour"
    ...
    | "month"
    | "year";
  declare export type TimelineEventPropertiesResultWhatType =
    | "item"
    | "background"
    | "axis"
    | "group-label"
    | "custom-time"
    | "current-time";
  declare export type TimelineEvents =
    | "currentTimeTick"
    | "click"
    | "contextmenu"
    | "doubleClick"
  ...
  declare export type LegendPositionType =
    | "top-right"
    | "top-left"
    | "bottom-right"
    | "bottom-left";
  declare export type ParametrizationInterpolationType =
    | "centripetal"
    | "chordal"
    | "uniform"
    | "disabled";
  ...
  declare export type TimelineFormatLabelsFunction = (
    date: Date,
    scale: string,
    step: number
  ) => string;
  ...
  declare export type TimelineOptionsConfigureFunction = (
    option: string,
    path: string[]
  ) => boolean;
  declare export type TimelineOptionsConfigureType =
    | boolean
    | TimelineOptionsConfigureFunction;
  declare export type TimelineOptionsDataAttributesType =
    | boolean
    | string
    | string[];
  declare export type TimelineOptionsEditableType =
    | boolean
    | TimelineEditableOption;
  declare export type TimelineOptionsItemCallbackFunction = (
    item: TimelineItem,
    callback: (item: TimelineItem | null) => void
  ) => void;
  declare export type TimelineOptionsGroupCallbackFunction = (
    group: TimelineGroup,
    callback: (group: TimelineGroup | null) => void
  ) => void;
  declare export type TimelineOptionsGroupEditableType =
    | boolean
    | TimelineGroupEditableOption;
  declare export type TimelineOptionsGroupOrderType =
    | string
    | TimelineOptionsComparisonFunction;
  declare export type TimelineOptionsGroupOrderSwapFunction = (
    fromGroup: any,
    toGroup: any,
    groups: DataSet<DataGroup>
  ) => void;
  declare export type TimelineOptionsHiddenDatesType =
    | TimelineHiddenDateOption
    | TimelineHiddenDateOption[];
  declare export type TimelineOptionsItemsAlwaysDraggableType =
    | boolean
    | TimelineItemsAlwaysDraggableOption;
  declare export type TimelineOptionsMarginType = number | TimelineMarginOption;
  declare export type TimelineOptionsOrientationType =
    | string
    | TimelineOrientationOption;
  declare export type TimelineOptionsSnapFunction = (
    date: Date,
    scale: string,
    step: number
  ) => Date | number;
  declare export type TimelineOptionsTemplateFunction = (
    item?: any,
    element?: any,
    data?: any
  ) => string;
  declare export type TimelineOptionsComparisonFunction = (
    a: any,
    b: any
  ) => number;
 ...
 */
  ...
  declare export type DataItemCollectionType =
    | DataItem[]
    | DataSet<DataItem>
    | DataView<DataItem>;
  declare export type DataGroupCollectionType =
    | DataGroup[]
    | DataSet<DataGroup>
    | DataView<DataGroup>;
  ...
  declare export type Graph2dOptionDrawPoints =
    | boolean
  ...
  declare export type TimelineItemEditableType =
    | boolean
  ...
  declare export type NetworkEvents =
    | "click"
    | "doubleClick"
    | "oncontext"
    | "hold"
  ...
  declare export type EasingFunction =
    | "linear"
    | "easeInQuad"
    | "easeOutQuad"
    | "easeInOutQuad"
