declare module "text-encoding-utf-8" {
  ...
  declare interface TextEncoding$TextDecoder {
    ...
    decode(
      ...
      options?: TextEncoding$TextDecodeOptions
    ): string;
  }
  ...
  declare interface TextEncoding$TextEncoder {
    ...
    encode(
      input?: string,
      options?: TextEncoding$TextEncodeOptions
    ): Uint8Array;
  }
  ...
  declare interface TextEncoding$TextEncoderStatic {
    (
      utfLabel?: string,
      options?: TextEncoding$TextEncoderOptions
  ...
  declare interface TextEncoding$TextDecoderStatic {
    (
      label?: string,
      options?: TextEncoding$TextDecoderOptions
