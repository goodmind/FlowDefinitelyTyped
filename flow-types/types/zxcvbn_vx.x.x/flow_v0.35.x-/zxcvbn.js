declare module "zxcvbn" {
    ...
    declare interface zxcvbn$ZXCVBNResult {
        /**
         ...
         */
        crack_times_seconds: zxcvbn$ZXCVBNAttackTime;
         ...
         */
        crack_times_display: zxcvbn$ZXCVBNAttackTime;
         ...
         */
        sequence: zxcvbn$ZXCVBNSequence[];
    ...
    declare type zxcvbn$ZXCVBNScore = 0 | 1 | 2 | 3 | 4;

    declare interface zxcvbn$ZXCVBNAttackTime {
        /**
    ...
    declare interface zxcvbn$ZXCVBNFeedback {
        /**
    ...
    declare interface zxcvbn$ZXCVBNSequence {
        /**
