 ...
 */
registerEvent(events: Podium$Podium$Events[]): void,
registerEvent(events: Podium$Podium$Events): void,
 ...
 */
on(
criteria: string | Podium$Podium$Criteria,
listener: Podium$Podium$Listener): void,
 ...
 */
removeListener(name: string, listener: Podium$Podium$Listener): Podium,
 ...
 * @see {@link https://github.com/hapijs/podium/blob/master/API.md#podiumregistereventevents}
 */
declare export type Podium$Events = string | Podium$EventOptionsObject | Podium;


/**
 * @see {@link https://github.com/hapijs/podium/blob/master/API.md#podiumregistereventevents}
 */
declare export interface Podium$EventOptionsObject {
 ...
 */
declare export interface Podium$CriteriaObject {
 ...
 */
filter?: string | string[] | Podium$CriteriaFilterOptionsObject,
 ...
 * @see {@link https://github.com/hapijs/podium/blob/master/API.md#podiumoncriteria-listener}
 */
declare export interface Podium$CriteriaFilterOptionsObject {
 ...
 * @see {@link https://github.com/hapijs/podium/blob/master/API.md#podiumoncriteria-listener}
 */
declare export type Podium$Criteria = string | Podium$CriteriaObject;


/**
 * @see {@link https://github.com/hapijs/podium/blob/master/API.md#podiumoncriteria-listener}
 */
declare export interface Podium$Listener {
(data: any, tags?: Podium$Tags, callback?: () => void): void
} 

declare export type Podium$Tags = {
[tag: string]: boolean
};
	declare var Podium: Podium;
	declare module.exports: typeof Podium
