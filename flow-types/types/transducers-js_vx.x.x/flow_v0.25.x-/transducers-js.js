declare module "transducers-js" {
  ...
  declare export type Reducer<TResult, TInput> = (
    result: TResult,
    input: TInput
  ) => TResult;
  ...
  declare export interface CompletingTransformer<
    TResult,
    TCompleteResult,
    TInput
  > {
    "NO PRINT IMPLEMENTED: ComputedPropertyName"(): TResult | void;
   ...
   */
  declare export function comp<A, B, C>(
    a: Transducer<A, B>,
    b: Transducer<B, C>
  ): Transducer<A, C>;
  ...
  declare export function comp<A>(
    ...args: Array<Transducer<A, A>>
  ): Transducer<A, A>;
  ...
  declare export function comp(
    ...args: Array<(x: any) => any>
  ): (x: any) => any;

  /**
   * Take a predicate function and return its complement.
   */
  declare export function complement<T>(
    f: (x: T) => boolean
  ): (x: T) => boolean;
  ...
  declare export class Map<TResult, TInput, TOutput>
    mixins Transformer<TResult, TInput> {
    constructor(
      f: (x: TInput) => TOutput,
   ...
   */
  declare export function map<TInput, TOutput>(
    f: (x: TInput) => TOutput
  ): Transducer<TInput, TOutput>;

  declare export class Filter<TResult, TInput>
    mixins Transformer<TResult, TInput> {
    constructor(
   ...
   */
  declare export function filter<TInput>(
    pred: (x: TInput) => boolean
   ...
   * eliminate values.
   */
  declare export function remove<TInput>(
    pred: (x: TInput) => boolean
  ): Transducer<TInput, TInput>;

  declare export class Keep<TResult, TInput>
    mixins Transformer<TResult, TInput> {
   ...
   */
  declare export function keep<TInput>(
    f: (x: TInput) => any
  ): Transducer<TInput, TInput>;

  declare export class KeepIndexed<TResult, TInput>
    mixins Transformer<TResult, TInput> {
    constructor(
   ...
   */
  declare export function keepIndexed<TInput>(
    f: (i: number, x: TInput) => any
  ): Transducer<TInput, TInput>;

  declare export class Take<TResult, TInput>
    mixins Transformer<TResult, TInput> {
  ...
  declare export class TakeWhile<TResult, TInput>
    mixins Transformer<TResult, TInput> {
    constructor(
   ...
   */
  declare export function takeWhile<TInput>(
    pred: (n: TInput) => boolean
  ): Transducer<TInput, TInput>;

  declare export class TakeNth<TResult, TInput>
    mixins Transformer<TResult, TInput> {
    constructor(n: number, xf: Transformer<TResult, TInput>): this;
    undefined(): TResult;
    undefined(result: TResult, input: TInput): TResult;
   ...
   */
  declare export function takeNth<TInput>(
    n: number
  ): Transducer<TInput, TInput>;

  declare export class Drop<TResult, TInput>
    mixins Transformer<TResult, TInput> {
    constructor(n: number, xf: Transformer<TResult, TInput>): this;
    undefined(): TResult;
    undefined(result: TResult, input: TInput): TResult;
  ...
  declare export class DropWhile<TResult, TInput>
    mixins Transformer<TResult, TInput> {
    constructor(
   ...
   * pred is true.
   */
  declare export function dropWhile<TInput>(
    pred: (input: TInput) => boolean
  ): Transducer<TInput, TInput>;

  declare export class PartitionBy<TResult, TInput>
    mixins Transformer<TResult, TInput> {
    constructor(
      f: (input: TInput) => any,
      xf: Transformer<TResult, TInput[]>
   ...
   * inputs.
   */
  declare export function partitionBy<TInput>(
    f: (input: TInput) => any
  ): Transducer<TInput, TInput[]>;

  declare export class PartitionAll<TResult, TInput>
    mixins Transformer<TResult, TInput> {
    constructor(n: number, xf: Transformer<TResult, TInput[]>): this;
    undefined(): TResult;
    undefined(result: TResult, input: TInput): TResult;
   ...
   * arrays of size N.
   */
  declare export function partitionAll<TResult, TInput>(
    n: number
  ): Transducer<TInput, TInput[]>;

  declare export class Completing<TResult, TCompleteResult, TInput>
    mixins CompletingTransformer<TResult, TCompleteResult, TInput> {
    constructor(
  ...
  declare export class Wrap<TResult, TInput>
    mixins Transformer<TResult, TInput> {
   ...
   */
  declare export function ensureReduced<TResult>(
   ...
   */
  declare export function unreduced<TResult>(
    x: TResult | Reduced<TResult>
  ): TResult;
