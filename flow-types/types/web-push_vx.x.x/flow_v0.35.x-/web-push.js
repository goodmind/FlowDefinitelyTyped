 ...
 */
declare export function sendNotification(
subscription: PushSubscription,
payload?: string | Buffer | null,
options?: RequestOptions): Promise<SendResult>
 ...
 */
declare export function generateVAPIDKeys(): VapidKeys
 ...
 */
declare export function setGCMAPIKey(apiKey: string | null): void
...
contentEncoding: ContentEncoding): EncryptionResult
 ...
 */
declare export function getVapidHeaders(
audience: string,
subject: string,
publicKey: string,
privateKey: string,
 ...
 */
declare export function generateRequestDetails(
subscription: PushSubscription,
payload?: null,
options?: RequestOptions): RequestDetails & {
body: null
}
 ...
 */
declare export type ContentEncoding = "aesgcm" | "aes128gcm";
	
/**
 * Map of valid content encodings.
 */
declare export var supportedContentEncodings: {
+AES_GCM: "aesgcm" & ContentEncoding,
+AES_128_GCM: "aws128gcm" & ContentEncoding
};
	
/**
 * Returned by encrypt() on success.
 */
declare export interface EncryptionResult {
 ...
 */
declare export interface VapidKeys {
publicKey: string,
privateKey: string
} 
...
For example: 'https://my-site.com/contact' or 'mailto: contact
 * @my -site.com'
 * @param publicKey The public VAPID key.
 * @param privateKey The private VAPID key.
 */
declare export function setVapidDetails(subject: string, publicKey: string, privateKey: string): void
 ...
 * The expected format is the same output as JSON.stringify'ing a PushSubscription in the browser.
 */
declare export interface PushSubscription {
endpoint: string,
keys: {
p256dh: string,
auth: string
 ...
 */
declare export interface RequestDetails {
method: "POST",
headers: Headers,
body: Buffer | null,
endpoint: string,
 ...
 */
declare export interface SendResult {
statusCode: number,
body: string,
headers: Headers
} 
 ...
 */
declare export class WebPushError mixins Error {
message: string;
statusCode: number;
headers: Headers;
body: string;
endpoint: string;
constructor(message: string, statusCode: number, headers: Headers, body: string, endpoint: string): this
}
    }
