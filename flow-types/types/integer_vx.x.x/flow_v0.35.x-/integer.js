declare module 'integer' {
        declare function Integer(val: Integer$Integer$IntLike): Integer$Integer$IntClass
...
declare function Integer$fromBits(low: number, high?: number): Integer$IntClass


declare function Integer$fromNumber(val: number, defaultVal?: number | Integer$IntClass): Integer$IntClass


declare function Integer$fromString(
val: string,
radix?: number,
defaultVal?: string | Integer$IntClass): Integer$IntClass
