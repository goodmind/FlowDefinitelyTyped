...
[key: number]: Glyph
	...
	declare export function parse(text: string | Buffer, options?: ParseOptions): Font
...
[row: number]: number[]
	...
	declare export function draw(font: Font, text: string, options?: DrawOptions): Bitmap | void
