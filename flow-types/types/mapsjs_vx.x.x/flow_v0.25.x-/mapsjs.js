...
declare module "tile" {
  ...
  declare export class layer {
     ...
     * @returns {{[key: string]: any}} The tile layer's descriptor.
     */
    getDescriptor(): any;
 ...
 * @returns {{[key: string]: any}} Composed object in the form 
 ...
 * @param {string} layerId The MapDotNet map layer ID.
 * @returns {{[key: string]: any}} JavaScript object of the form {color, thickness}
 ...
 */
  ...
  declare export class requestorLocal mixins requestor {
     ...
     * @returns {{[key: string]: any}} Array of source data objects.
     */
    getSource(): {}[];

    /**
 * Sets source data.
 * @param {{[key: string]: any}} data An array of JavaScript objects to use as
 ...
 */
     ...
     * @returns {{[key: string]: any}} Parsed data object in the form {Shapes, Values, Bounds}.
     */
    getParsedData(): {
      Shapes: any[],
      Values: any[],
 ...
 */
   ...
   */
  declare export function toMultiPolygonString(
...
declare module "sphericalMercator" {
   ...
   */
  declare export function getQuadTreeNodeToMapEnvelope(
    x: number,
    y: number,
    z: number
  ): envelope;
   ...
   */
  declare export function getQuadTreeNodeRangeFromEnvelope(
    env: envelope,
    z: number
  ): envelope;
   ...
   */
  declare export function getActualUnitsPerPixel(
    mapPt: point,
    zoomLevel: number
  ): number;
   ...
   */
  declare export function getBestFitZoomLevelByExtents(
   ...
   */
  declare export function getQuadKeyFromXYZ(
    x: number,
    y: number,
    z: number
  ): string;
   ...
   * @return {{[key: string]: any}} JavaScript object of the form {x,y,z}.
   */
  declare export function getXYZFromQuadKey(
    key: string
  ): {
    x: number,
    y: number,
...
declare module "point" {
   ...
   */
  declare export function midpoint(
    x1: number,
    y1: number,
    x2: number,
    y2: number
...
declare module "mapsjs" {
   ...
   * @param {{[key: string]: any}} options An options object which specifies the clustering algorithm.
   * @returns {{[key: string]: any}} An array of clustered points.
   */
  declare export function clusterPoints(options: {
    data: {}[],
    pointKey: string,
 ...
 * @returns {{[key: string]: any}} Object of the form {setIdx, idx} where setIdx is
 ...
 * @returns {{[key: string]: any}} An object of the form {setIdx, ptIdx, pt, distance}
 ...
 * @returns {{[key: string]: any}} JavaScript object of the form {w, h} where w is
 ...
 * @param {{[key: string]: any}} dragOptions JavaScript object of the form {dragEnabled,
 ...
 * click locations.
 * @param {{[key: string]: any}} options JavaScript object of the form { key,
