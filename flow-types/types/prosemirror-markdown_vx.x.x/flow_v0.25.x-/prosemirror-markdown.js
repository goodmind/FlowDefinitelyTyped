declare module "prosemirror-markdown" {
   ...
   */
  declare export class MarkdownParser<S: Schema = any> {
    /**
   ...
   */
  declare export class MarkdownSerializer<S: Schema = any> {
    constructor(
      nodes: {
        [name: string]: (
   ...
   */
  declare export class MarkdownSerializerState<S: Schema = any> {
    /**
