declare module "globby" {
  import type { IOptions as NodeGlobOptions } from "glob";

  import type { Options as FastGlobOptions } from "fast-glob";

  declare type ExpandDirectoriesOption =
    | boolean
    | string[]
    | {
        files: string[],
   ...
   */
  declare function globby$hasMagic(
    patterns: string | string[],
   ...
   *      * ```
   */
  declare function globby$gitignore(options?: {
    cwd?: string,
    ignore?: string[]
