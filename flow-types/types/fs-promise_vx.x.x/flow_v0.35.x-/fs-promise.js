...
reviver(key: any, value: any): any
	...
	declare export function ensureLink(srcpath: string, dstpath: string): Promise<void>
...
type?: "dir" | "file" | "junction"): Promise<void>
	...
	declare export function outputFile(file: string, data: string | Buffer, options?: WriteOptions): Promise<void>

	declare export function outputJson(file: string, data: any, options?: WriteJsonOptions): Promise<void>

	declare export function readJson(file: string, options?: ReadJsonOptions): Promise<any>

	declare export function remove(path: string): Promise<void>

	declare export function walk(dir: string): Promise<string[]>

	declare export function writeJson(file: string, data: any, options?: WriteJsonOptions): Promise<void>

	declare export {
          emptydir,createFile,createLink,createSymlink,mkdirp,outputJSON,readJSON,writeJSON
        }
