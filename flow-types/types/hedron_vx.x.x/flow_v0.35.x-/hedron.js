...
breakpoints: Breakpoints
	...
	declare export class Column mixins React.Component<ColumnProps & React.HTMLProps<HTMLElement>> {}
	declare export class Page mixins React.Component<PageProps & React.HTMLProps<HTMLElement>> {}
	declare export class Row mixins React.Component<RowProps & React.HTMLProps<HTMLElement>> {}
	declare export class Hidden mixins React.Component<HiddenProps & React.HTMLProps<HTMLElement>> {}
	declare export class BreakpointProvider mixins React.Component<BreakpointsProps & React.HTMLProps<HTMLElement>> {}
	declare export function withBreakpoints<T>(
wrappedComponent: React.ComponentClass<T & BreakpointsProps>): React.ComponentClass<T>
