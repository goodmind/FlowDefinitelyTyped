declare module 'nise' {
        declare export interface FakeUploadProgress {
eventListeners: {
progress: any[],
load: any[],
abort: any[],
...
dispatchEvent(event: Event): void
	...
	declare export interface FakeXMLHttpRequest {
...
onload(e: Event): void
	...
	declare export interface FakeServerOptions {
...
respondImmediately: boolean
	...
	declare export type FakeServer = {
lastRequest: FakeXMLHttpRequest | void,
firstRequest: FakeXMLHttpRequest | void,
secondRequest: FakeXMLHttpRequest | void,
thirdRequest: FakeXMLHttpRequest | void,
...
respond(): void,
restore(): void,
getRequest(): FakeXMLHttpRequest | void,
reset(): void,
resetBehavior(): void,
resetHistory(): void
} & FakeServerOptions

	declare export interface FakeXMLHttpRequestStatic {
...
restore(): void
	...
	declare export interface FakeServerStatic {
create(options?: $Shape<FakeServerOptions>): FakeServer
} 
	declare export interface FakeXHR {
useFakeXMLHttpRequest(): FakeXMLHttpRequestStatic,
FakeXMLHttpRequest: FakeXMLHttpRequestStatic
} 
	declare export var fakeServerWithClock: FakeServerStatic;
	declare export var fakeServer: FakeServerStatic;
	declare export var fakeXhr: FakeXHR;
    }
