 ...
 * @param options
 */
constructor(servers: string, options?: ClientOptions): this;
...
get(
key: string,
callback: (err?: Error | null, value?: Buffer, flags?: Buffer) => void): void;
...
callback: (err?: Error | null, success?: boolean) => void): void;
 ...
 * @param callback
 */
delete(key: string, callback: (err?: Error | null, success?: boolean) => void): void;
...
callback: (err?: Error | null, success?: boolean, value?: number) => void): void;
 ...
 */
flush(
callback: (err?: Error | null, results?: Record<string, boolean>) => void): void;
...
statsWithKey(
key: string,
callback: (err?: Error | null, server?: string, stats?: Record<string, string>) => void): void;
