 ...
 * multiple `MenuItem`s.
 */
declare export class Wrapper mixins React.Component<WrapperProps<HTMLElement>> {}
 ...
 * one `Button`.
 */
declare export class Button mixins React.Component<ButtonProps<HTMLElement>> {}
 ...
 */
declare export class MenuItem mixins React.Component<MenuItemProps<HTMLElement>> {}
