 ...
 */
declare function client$load(name: "androidenterprise", version: "v1"): PromiseLike<void>


declare function client$load(name: "androidenterprise", version: "v1", callback: () => any): void
