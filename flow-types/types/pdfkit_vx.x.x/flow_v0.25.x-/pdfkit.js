...
declare interface Mixins$PDFAnnotation<TDocument> {
  annotate(
    ...
    w: number,
    h: number,
    option: Mixins$AnnotationOption
  ): TDocument;
  note(
    x: number,
    y: number,
...
declare type Mixins$ColorValue =
  | string
  | PDFKit$PDFGradient
...
declare type PDFKit$PDFDocument = {
  ...
  Mixins$Mixins$PDFAnnotation<PDFKit$PDFDocument> &
  Mixins$Mixins$PDFColor<PDFKit$PDFDocument> &
  Mixins$Mixins$PDFImage<PDFKit$PDFDocument> &
  Mixins$Mixins$PDFText<PDFKit$PDFDocument> &
  Mixins$Mixins$PDFVector<PDFKit$PDFDocument> &
  Mixins$Mixins$PDFFont<PDFKit$PDFDocument>;
