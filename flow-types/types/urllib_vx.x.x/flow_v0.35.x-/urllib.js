 ...
 */
declare export type Callback = (err: Error, data: any, res: http.IncomingMessage) => void;
	
/**
 * Handle all http request, both http and https support well.
 * @example // GET http://httptest.cnodejs.net
 ...
 */
declare export function request(url: string | url.URL, options?: RequestOptions): Promise<any>

	
/**
 * @param url The URL to request, either a String or a Object that return by url.parse.
 */
declare export function request(url: string | url.URL, callback: Callback): void

	
/**
 * @param url The URL to request, either a String or a Object that return by url.parse.
 */
declare export function request(url: string | url.URL, options: RequestOptions, callback: Callback): void
 ...
 * @param url The URL to request, either a String or a Object that return by url.parse.
 */
declare export function requestWithCallback(url: string | url.URL, callback: Callback): void

	
/**
 * @param url The URL to request, either a String or a Object that return by url.parse.
 */
declare export function requestWithCallback(url: string | url.URL, options: RequestOptions, callback: Callback): void
 ...
 * @param url The URL to request, either a String or a Object that return by url.parse.
 */
declare export function requestThunk(
url: string | url.URL,
options?: RequestOptions): (callback: (...args: any[]) => void) => void
 ...
 * @see RequestOptions.
 */
declare export function curl(url: string | url.URL, options?: RequestOptions): Promise<any>

	
/**
 * @param url The URL to request, either a String or a Object that return by url.parse.
 */
declare export function curl(url: string | url.URL, callback: Callback): void

	
/**
 * @param url The URL to request, either a String or a Object that return by url.parse.
 */
declare export function curl(url: string | url.URL, options: RequestOptions, callback: Callback): void

	
/**
 * The default request timeout(in milliseconds).
 */
declare export var TIMEOUT: number;
	
/**
 * The default request & response timeout(in milliseconds).
 */
declare export var TIMEOUTS: [number, number];
	
/**
 * Request user agent.
 */
declare export var USER_AGENT: string;
	
/**
 * Request http agent.
 */
declare export var agent: http.Agent;
	
/**
 * Request https agent.
 */
declare export var httpsAgent: https.Agent;
	declare export class HttpClient mixins EventEmitter {
 ...
 */
declare export class HttpClient2 mixins EventEmitter {
constructor(options?: RequestOptions): this;
 ...
 */
declare export function create(options?: RequestOptions): HttpClient
