...
declare type api$PaymentMethodTokenizationSpecification = api$PaymentGatewayTokenizationSpecification | api$DirectTokenizationSpecification;
...
declare type api$AllowedCardNetwork = "AMEX"
| "DISCOVER"
| "JCB"
| "MASTERCARD"
| "VISA";
...
declare type api$TransactionInfo = api$UnknownPriceTransactionInfo | api$KnownPriceTransactionInfo;

declare type api$TotalPriceStatus = "ESTIMATED" | "FINAL" | "NOT_CURRENTLY_KNOWN";
...
declare type api$ErrorStatusCode = "BUYER_ACCOUNT_ERROR" | "CANCELED" | "DEVELOPER_ERROR" | "INTERNAL_ERROR";
...
isReadyToPay(request: api$IsReadyToPayRequest): Promise<api$IsReadyToPayResponse>;
