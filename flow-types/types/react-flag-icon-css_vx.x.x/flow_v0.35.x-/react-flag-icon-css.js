declare module 'react-flag-icon-css' {
	...
	import type {
          PureComponent,ReactNode
        } from 'react';

	declare export type FlagIconSize = "lg"
| "2x"
| "3x"
| "4x"
| "5x";
	declare export type FlagIconFlip = "horizontal" | "vertical";
	declare export type FlagIconRotate = 30
| 60
| 90
| 180
| 270;
...
children?: ReactNode
	...
	declare export default function FlagIconFactory(react: any, opts?: $ReadOnly<FlagIconOptions>): typeof FlagIcon

	declare export function CustomFlagIconFactory(react: any, opts?: $ReadOnly<FlagIconOptions>): typeof FlagIcon
