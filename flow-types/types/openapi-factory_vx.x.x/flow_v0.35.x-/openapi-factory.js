...
constructor(options: OpenApi$OpenApi$ApiOptions, overrideLogger?: () => void): this;
...
route: string,
handler: (
req?: {[key: string]: any}) => (OpenApi$OpenApi$HttpResponse | Promise<OpenApi$OpenApi$HttpResponse>)): void;
head(
route: string,
options: OpenApi$OpenApi$HttpMethodOptions,
handler: (req?: any) => any): void;
get(
route: string,
handler: (
req?: {[key: string]: any}) => (OpenApi$OpenApi$HttpResponse | Promise<OpenApi$OpenApi$HttpResponse>)): void;
...
handler: (
req?: {[key: string]: any}) => (OpenApi$OpenApi$HttpResponse | Promise<OpenApi$OpenApi$HttpResponse>)): void;
handler(event: {[key: string]: any}, context: {[key: string]: any}): Promise<any>
}
