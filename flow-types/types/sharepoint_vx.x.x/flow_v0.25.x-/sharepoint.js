...
declare class U$LoadScriptsProgress {
  ...
  static +loading: Class<U$LoadScriptsProgress__loading> &
    U$LoadScriptsProgress__loading &
    0; // 0
  static +success: Class<U$LoadScriptsProgress__success> &
    U$LoadScriptsProgress__success &
    1; // 1
  static +failure: Class<U$LoadScriptsProgress__failure> &
    U$LoadScriptsProgress__failure &
    2; // 2
}
...
declare class Srch$EventType {
  ...
  static +queryReady: Class<Srch$EventType__queryReady> &
    Srch$EventType__queryReady &
    1; // 1
  static +queryIssuing: Class<Srch$EventType__queryIssuing> &
    Srch$EventType__queryIssuing &
    2; // 2
  static +batchQueryIssuing: Class<Srch$EventType__batchQueryIssuing> &
    Srch$EventType__batchQueryIssuing &
    3; // 3
  static +resultReady: Class<Srch$EventType__resultReady> &
    Srch$EventType__resultReady &
    4; // 4
  static +batchResultReady: Class<Srch$EventType__batchResultReady> &
    Srch$EventType__batchResultReady &
    5; // 5
  static +queryStateChanged: Class<Srch$EventType__queryStateChanged> &
    Srch$EventType__queryStateChanged &
    6; // 6
  static +resultRendered: Class<Srch$EventType__resultRendered> &
    Srch$EventType__resultRendered &
    7; // 7
  ...
  static +postLoad: Class<Srch$EventType__postLoad> &
    Srch$EventType__postLoad &
    10; // 10
}
...
declare class Srch$MessageLevel {
  constructor(...args: empty): mixed;
  static +information: Class<Srch$MessageLevel__information> &
    Srch$MessageLevel__information &
    0; // 0
  static +warning: Class<Srch$MessageLevel__warning> &
    Srch$MessageLevel__warning &
    1; // 1
...
declare class Srch$UserActionType {
  constructor(...args: empty): mixed;
  static +search: Class<Srch$UserActionType__search> &
    Srch$UserActionType__search &
    0; // 0
  static +pageNext: Class<Srch$UserActionType__pageNext> &
    Srch$UserActionType__pageNext &
    1; // 1
  static +pagePrev: Class<Srch$UserActionType__pagePrev> &
    Srch$UserActionType__pagePrev &
    2; // 2
  static +refine: Class<Srch$UserActionType__refine> &
    Srch$UserActionType__refine &
    3; // 3
  static +sort: Class<Srch$UserActionType__sort> &
    Srch$UserActionType__sort &
    4; // 4
  static +filterLanguage: Class<Srch$UserActionType__filterLanguage> &
    Srch$UserActionType__filterLanguage &
    5; // 5
}
...
declare class Srch$DateTimeKind {
  constructor(...args: empty): mixed;
  static +unspecified: Class<Srch$DateTimeKind__unspecified> &
    Srch$DateTimeKind__unspecified &
    0; // 0
...
declare class Srch$Result mixins Srch$DisplayControl {
  ...
  processResultReady(
    resultTableCollection: Microsoft$Microsoft$SharePoint.Client.Search.Query$Query.Query$ResultTableCollection
  ): void;
  render(): void;
  scriptApplication_PreLoad(sender: any, e: any): void;
   ...
   */
  shouldShowTable(
    resultTable: Microsoft$Microsoft$SharePoint.Client.Search.Query$Query.Query$ResultTable
  ): boolean;
}
...
declare class Srch$U {
  ...
  static cancelEventEx(
    ...
    IE8Support$stopPropagation: boolean
  ): void;
  ...
  static getTableOfType(
    tableCollection: Microsoft$Microsoft$SharePoint.Client.Search.Query$Query.Query$ResultTableCollection,
    tableTypeName: string
  ): Microsoft$Microsoft$SharePoint.Client.Search.Query$Query.Query$ResultTable;
...
declare class SP$GanttControl {
  ...
  get_Columns(): SP$JsGrid.JsGrid$ColumnInfo[];
}

declare class WorkflowServices$WorkflowStatus {
  constructor(...args: empty): mixed;
  static +notStarted: Class<WorkflowServices$WorkflowStatus__notStarted> &
    WorkflowServices$WorkflowStatus__notStarted &
    0; // 0
  static +started: Class<WorkflowServices$WorkflowStatus__started> &
    WorkflowServices$WorkflowStatus__started &
    1; // 1
  static +suspended: Class<WorkflowServices$WorkflowStatus__suspended> &
    WorkflowServices$WorkflowStatus__suspended &
    2; // 2
  static +canceling: Class<WorkflowServices$WorkflowStatus__canceling> &
    WorkflowServices$WorkflowStatus__canceling &
    3; // 3
  static +canceled: Class<WorkflowServices$WorkflowStatus__canceled> &
    WorkflowServices$WorkflowStatus__canceled &
    4; // 4
  static +terminated: Class<WorkflowServices$WorkflowStatus__terminated> &
    WorkflowServices$WorkflowStatus__terminated &
    5; // 5
  static +completed: Class<WorkflowServices$WorkflowStatus__completed> &
    WorkflowServices$WorkflowStatus__completed &
    6; // 6
  static +notSpecified: Class<WorkflowServices$WorkflowStatus__notSpecified> &
    WorkflowServices$WorkflowStatus__notSpecified &
    7; // 7
  static +invalid: Class<WorkflowServices$WorkflowStatus__invalid> &
    WorkflowServices$WorkflowStatus__invalid &
    8; // 8
}

declare class WorkflowServices$WorkflowStatus__notStarted
  mixins WorkflowServices$WorkflowStatus {}
declare class WorkflowServices$WorkflowStatus__started
  mixins WorkflowServices$WorkflowStatus {}
declare class WorkflowServices$WorkflowStatus__suspended
  mixins WorkflowServices$WorkflowStatus {}
declare class WorkflowServices$WorkflowStatus__canceling
  mixins WorkflowServices$WorkflowStatus {}
declare class WorkflowServices$WorkflowStatus__canceled
  mixins WorkflowServices$WorkflowStatus {}
declare class WorkflowServices$WorkflowStatus__terminated
  mixins WorkflowServices$WorkflowStatus {}
declare class WorkflowServices$WorkflowStatus__completed
  mixins WorkflowServices$WorkflowStatus {}
declare class WorkflowServices$WorkflowStatus__notSpecified
  mixins WorkflowServices$WorkflowStatus {}
declare class WorkflowServices$WorkflowStatus__invalid
  mixins WorkflowServices$WorkflowStatus {}

declare class WorkflowServices$InteropService mixins SP$SP$ClientObject {
  constructor(
    context: SP$SP$ClientRuntimeContext,
    objectPath: SP$SP$ObjectPathStaticProperty
  ): this;
  static getCurrent(
    context: SP$SP$ClientRuntimeContext
  ): WorkflowServices$InteropService;
 ...
 */
declare class WorkflowServices$WorkflowDeploymentService
  mixins SP$SP$ClientObject {
  /**
   ...
   */
  saveDefinition(
    definition: WorkflowServices$WorkflowDefinition
  ): SP$SP$GuidResult;
  ...
  ): WorkflowServices$WorkflowDefinitionCollection;
 ...
 */
declare class WorkflowServices$WorkflowInstanceService
  mixins SP$SP$ClientObject {
  /**
  ...
  ): WorkflowServices$WorkflowInstanceCollection;
  ...
  countInstancesWithStatus(
    parentSubscription: WorkflowServices$WorkflowSubscription,
    status: WorkflowServices$WorkflowStatus
  ): SP$SP$IntResult;
 ...
 */
declare class WorkflowServices$WorkflowServicesManager
  mixins SP$SP$ClientObject {
  constructor(context: SP$SP$ClientRuntimeContext, web: SP$SP$Web): this;
  static newObject(
    context: SP$SP$ClientRuntimeContext,
    web: SP$SP$Web
  ): WorkflowServices$WorkflowServicesManager;
...
declare class WorkflowServices$WorkflowSubscriptionService
  mixins SP$SP$ClientObject {
  constructor(
    context: SP$SP$ClientRuntimeContext,
    objectPath: SP$SP$ObjectPathStaticProperty
  ...
  static getCurrent(
    context: SP$SP$ClientRuntimeContext
  ): WorkflowServices$WorkflowSubscriptionService;
  ...
  getSubscription(
    subscriptionId: SP$SP$Guid
  ): WorkflowServices$WorkflowSubscription;
  deleteSubscription(
    subscriptionId: SP$SP$Guid
  ): WorkflowServices$WorkflowSubscription;
  ...
  enumerateSubscriptionsByDefinition(
    definitionId: string
  ): WorkflowServices$WorkflowSubscriptionCollection;
...
declare class SP$PermissionKind {
  constructor(...args: empty): mixed;
  static +emptyMask: Class<SP$PermissionKind__emptyMask> &
    SP$PermissionKind__emptyMask &
    0; // 0
  static +viewListItems: Class<SP$PermissionKind__viewListItems> &
    SP$PermissionKind__viewListItems &
    1; // 1
  static +addListItems: Class<SP$PermissionKind__addListItems> &
    SP$PermissionKind__addListItems &
    2; // 2
  static +editListItems: Class<SP$PermissionKind__editListItems> &
    SP$PermissionKind__editListItems &
    3; // 3
  static +deleteListItems: Class<SP$PermissionKind__deleteListItems> &
    SP$PermissionKind__deleteListItems &
    4; // 4
  static +approveItems: Class<SP$PermissionKind__approveItems> &
    SP$PermissionKind__approveItems &
    5; // 5
  static +openItems: Class<SP$PermissionKind__openItems> &
    SP$PermissionKind__openItems &
    6; // 6
  static +viewVersions: Class<SP$PermissionKind__viewVersions> &
    SP$PermissionKind__viewVersions &
    7; // 7
  static +deleteVersions: Class<SP$PermissionKind__deleteVersions> &
    SP$PermissionKind__deleteVersions &
    8; // 8
  static +cancelCheckout: Class<SP$PermissionKind__cancelCheckout> &
    SP$PermissionKind__cancelCheckout &
    9; // 9
  static +managePersonalViews: Class<SP$PermissionKind__managePersonalViews> &
    SP$PermissionKind__managePersonalViews &
    10; // 10
  static +manageLists: Class<SP$PermissionKind__manageLists> &
    SP$PermissionKind__manageLists &
    11; // 11
  static +viewFormPages: Class<SP$PermissionKind__viewFormPages> &
    SP$PermissionKind__viewFormPages &
    12; // 12
  static +anonymousSearchAccessList: Class<SP$PermissionKind__anonymousSearchAccessList> &
    SP$PermissionKind__anonymousSearchAccessList &
    13; // 13
  static +open: Class<SP$PermissionKind__open> & SP$PermissionKind__open & 14; // 14
  static +viewPages: Class<SP$PermissionKind__viewPages> &
    SP$PermissionKind__viewPages &
    15; // 15
  static +addAndCustomizePages: Class<SP$PermissionKind__addAndCustomizePages> &
    SP$PermissionKind__addAndCustomizePages &
    16; // 16
  static +applyThemeAndBorder: Class<SP$PermissionKind__applyThemeAndBorder> &
    SP$PermissionKind__applyThemeAndBorder &
    17; // 17
  static +applyStyleSheets: Class<SP$PermissionKind__applyStyleSheets> &
    SP$PermissionKind__applyStyleSheets &
    18; // 18
  static +viewUsageData: Class<SP$PermissionKind__viewUsageData> &
    SP$PermissionKind__viewUsageData &
    19; // 19
  static +createSSCSite: Class<SP$PermissionKind__createSSCSite> &
    SP$PermissionKind__createSSCSite &
    20; // 20
  static +manageSubwebs: Class<SP$PermissionKind__manageSubwebs> &
    SP$PermissionKind__manageSubwebs &
    21; // 21
  static +createGroups: Class<SP$PermissionKind__createGroups> &
    SP$PermissionKind__createGroups &
    22; // 22
  static +managePermissions: Class<SP$PermissionKind__managePermissions> &
    SP$PermissionKind__managePermissions &
    23; // 23
  static +browseDirectories: Class<SP$PermissionKind__browseDirectories> &
    SP$PermissionKind__browseDirectories &
    24; // 24
  static +browseUserInfo: Class<SP$PermissionKind__browseUserInfo> &
    SP$PermissionKind__browseUserInfo &
    25; // 25
  static +addDelPrivateWebParts: Class<SP$PermissionKind__addDelPrivateWebParts> &
    SP$PermissionKind__addDelPrivateWebParts &
    26; // 26
  static +updatePersonalWebParts: Class<SP$PermissionKind__updatePersonalWebParts> &
    SP$PermissionKind__updatePersonalWebParts &
    27; // 27
  static +manageWeb: Class<SP$PermissionKind__manageWeb> &
    SP$PermissionKind__manageWeb &
    28; // 28
  static +anonymousSearchAccessWebLists: Class<SP$PermissionKind__anonymousSearchAccessWebLists> &
    SP$PermissionKind__anonymousSearchAccessWebLists &
    29; // 29
  static +useClientIntegration: Class<SP$PermissionKind__useClientIntegration> &
    SP$PermissionKind__useClientIntegration &
    30; // 30
  static +useRemoteAPIs: Class<SP$PermissionKind__useRemoteAPIs> &
    SP$PermissionKind__useRemoteAPIs &
    31; // 31
  static +manageAlerts: Class<SP$PermissionKind__manageAlerts> &
    SP$PermissionKind__manageAlerts &
    32; // 32
  static +createAlerts: Class<SP$PermissionKind__createAlerts> &
    SP$PermissionKind__createAlerts &
    33; // 33
  static +editMyUserInfo: Class<SP$PermissionKind__editMyUserInfo> &
    SP$PermissionKind__editMyUserInfo &
    34; // 34
  static +enumeratePermissions: Class<SP$PermissionKind__enumeratePermissions> &
    SP$PermissionKind__enumeratePermissions &
    35; // 35
  static +fullMask: Class<SP$PermissionKind__fullMask> &
    SP$PermissionKind__fullMask &
    36; // 36
}
...
declare class SP$PermissionKind__anonymousSearchAccessList
  mixins SP$PermissionKind {}
...
declare class SP$PermissionKind__addAndCustomizePages
  mixins SP$PermissionKind {}
...
declare class SP$PermissionKind__addDelPrivateWebParts
  mixins SP$PermissionKind {}
declare class SP$PermissionKind__updatePersonalWebParts
  mixins SP$PermissionKind {}
declare class SP$PermissionKind__manageWeb mixins SP$PermissionKind {}
declare class SP$PermissionKind__anonymousSearchAccessWebLists
  mixins SP$PermissionKind {}
declare class SP$PermissionKind__useClientIntegration
  mixins SP$PermissionKind {}
...
declare class SP$PermissionKind__enumeratePermissions
  mixins SP$PermissionKind {}
...
declare class SP$ClientObjectPropertyConditionalScope
  mixins SP$SP$ConditionalScopeBase {
  constructor(
    clientObject: SP$SP$ClientObject,
    propertyName: string,
...
declare class SP$DataConvert {
  static writePropertiesToXml(
    ...
    obj: any,
    propNames: string[],
    serializationContext: SP$SP$SerializationContext
  ): void;
...
declare class SP$PageRequest {
  ...
  static doPost(
    ...
    succeededHandler: (
      sender: any,
      args: SP$SP$PageRequestSucceededEventArgs
    ) => void,
    failedHandler: (sender: any, args: SP$SP$PageRequestFailedEventArgs) => void
  ): void;
  static doGet(
    url: string,
    expectedContentType: string,
  ...
  add_succeeded(
    value: (sender: any, args: SP$SP$PageRequestSucceededEventArgs) => void
  ): void;
  remove_succeeded(
    value: (sender: any, args: SP$SP$PageRequestSucceededEventArgs) => void
  ): void;
  add_failed(
    value: (sender: any, args: SP$SP$PageRequestFailedEventArgs) => void
  ): void;
  remove_failed(
    value: (sender: any, args: SP$SP$PageRequestFailedEventArgs) => void
  ): void;
...
declare class SP$ClientObjectCollection<T>
  mixins SP$SP$ClientObject, IEnumerable<T> {
  constructor(): this;
...
declare class SP$ClientObjectPrototype {
  ...
  retrieveCollectionObject(
    propertyName: string
  ): SP$SP$ClientObjectCollectionPrototype;
}

declare class SP$ClientObjectCollectionPrototype
  mixins SP$SP$ClientObjectPrototype {
  retrieveItems(): SP$SP$ClientObjectPrototype;
}

declare class SP$ClientRequestStatus {
  constructor(...args: empty): mixed;
  static +active: Class<SP$ClientRequestStatus__active> &
    SP$ClientRequestStatus__active &
    0; // 0
  static +inProgress: Class<SP$ClientRequestStatus__inProgress> &
    SP$ClientRequestStatus__inProgress &
    1; // 1
  static +completedSuccess: Class<SP$ClientRequestStatus__completedSuccess> &
    SP$ClientRequestStatus__completedSuccess &
    2; // 2
  static +completedException: Class<SP$ClientRequestStatus__completedException> &
    SP$ClientRequestStatus__completedException &
    3; // 3
}

declare class SP$ClientRequestStatus__active mixins SP$ClientRequestStatus {}
declare class SP$ClientRequestStatus__inProgress
  mixins SP$ClientRequestStatus {}
declare class SP$ClientRequestStatus__completedSuccess
  mixins SP$ClientRequestStatus {}
declare class SP$ClientRequestStatus__completedException
  mixins SP$ClientRequestStatus {}
...
declare class SP$ClientRequest {
  ...
  add_requestSucceeded(
    value: (sender: any, args: SP$SP$ClientRequestSucceededEventArgs) => void
  ): void;
  remove_requestSucceeded(
    value: (sender: any, args: SP$SP$ClientRequestSucceededEventArgs) => void
  ): void;
  add_requestFailed(
    value: (sender: any, args: SP$SP$ClientRequestFailedEventArgs) => void
  ): void;
...
declare class SP$ClientRequestFailedEventArgs
  mixins SP$SP$ClientRequestEventArgs {
  constructor(
    request: SP$SP$ClientRequest,
    message: string,
    stackTrace: string,
    errorCode: number,
    errorValue: string,
...
declare class SP$ClientRuntimeContext mixins Sys.IDisposable {
  ...
  add_executingWebRequest(
    value: (sender: any, args: SP$SP$WebRequestEventArgs) => void
  ): void;
  ...
  add_beginningRequest(
    value: (sender: any, args: SP$SP$ClientRequestEventArgs) => void
  ): void;
  ...
  executeQueryAsync(
    succeededCallback?: (
      sender: any,
      args: SP$SP$ClientRequestSucceededEventArgs
    ) => void,
    failedCallback?: (
      sender: any,
      args: SP$SP$ClientRequestFailedEventArgs
    ) => void
  ): void;
  ...
  loadQuery<T>(
    clientObjectCollection: SP$SP$ClientObjectCollection<T>,
    exp?: string
  ): any;
...
declare class SP$ClientValueObjectCollection<T>
  mixins SP$SP$ClientValueObject, IEnumerable<T> {
  get_count(): number;
  getEnumerator(): IEnumerator<T>;
  writeToXml(
    writer: SP$SP$XmlWriter,
...
declare class SP$DateTimeKind {
  constructor(...args: empty): mixed;
  static +unspecified: Class<SP$DateTimeKind__unspecified> &
    SP$DateTimeKind__unspecified &
    0; // 0
...
declare class SP$ULSTraceLevel {
  constructor(...args: empty): mixed;
  static +verbose: Class<SP$ULSTraceLevel__verbose> &
    SP$ULSTraceLevel__verbose &
    0; // 0
}
...
declare class SP$AddFieldOptions {
  constructor(...args: empty): mixed;
  static +defaultValue: Class<SP$AddFieldOptions__defaultValue> &
    SP$AddFieldOptions__defaultValue &
    0; // 0
  static +addToDefaultContentType: Class<SP$AddFieldOptions__addToDefaultContentType> &
    SP$AddFieldOptions__addToDefaultContentType &
    1; // 1
  static +addToNoContentType: Class<SP$AddFieldOptions__addToNoContentType> &
    SP$AddFieldOptions__addToNoContentType &
    2; // 2
  static +addToAllContentTypes: Class<SP$AddFieldOptions__addToAllContentTypes> &
    SP$AddFieldOptions__addToAllContentTypes &
    3; // 3
  static +addFieldInternalNameHint: Class<SP$AddFieldOptions__addFieldInternalNameHint> &
    SP$AddFieldOptions__addFieldInternalNameHint &
    4; // 4
  static +addFieldToDefaultView: Class<SP$AddFieldOptions__addFieldToDefaultView> &
    SP$AddFieldOptions__addFieldToDefaultView &
    5; // 5
  static +addFieldCheckDisplayName: Class<SP$AddFieldOptions__addFieldCheckDisplayName> &
    SP$AddFieldOptions__addFieldCheckDisplayName &
    6; // 6
}

declare class SP$AddFieldOptions__defaultValue mixins SP$AddFieldOptions {}
declare class SP$AddFieldOptions__addToDefaultContentType
  mixins SP$AddFieldOptions {}
declare class SP$AddFieldOptions__addToNoContentType
  mixins SP$AddFieldOptions {}
declare class SP$AddFieldOptions__addToAllContentTypes
  mixins SP$AddFieldOptions {}
declare class SP$AddFieldOptions__addFieldInternalNameHint
  mixins SP$AddFieldOptions {}
declare class SP$AddFieldOptions__addFieldToDefaultView
  mixins SP$AddFieldOptions {}
declare class SP$AddFieldOptions__addFieldCheckDisplayName
  mixins SP$AddFieldOptions {}
...
declare class SP$AppCatalog {
  static getAppInstances(
    context: SP$SP$ClientRuntimeContext,
    web: SP$SP$Web
  ): SP$SP$ClientObjectList<SP$SP$AppInstance>;
  static getDeveloperSiteAppInstancesByIds(
    context: SP$SP$ClientRuntimeContext,
    site: SP$SP$Site,
    appInstanceIds: SP$SP$Guid[]
  ): SP$SP$ClientObjectList<SP$SP$AppInstance>;
...
declare class SP$AppInstanceErrorSource {
  constructor(...args: empty): mixed;
  static +common: Class<SP$AppInstanceErrorSource__common> &
    SP$AppInstanceErrorSource__common &
    0; // 0
  static +appWeb: Class<SP$AppInstanceErrorSource__appWeb> &
    SP$AppInstanceErrorSource__appWeb &
    1; // 1
  static +parentWeb: Class<SP$AppInstanceErrorSource__parentWeb> &
    SP$AppInstanceErrorSource__parentWeb &
    2; // 2
  static +remoteWebSite: Class<SP$AppInstanceErrorSource__remoteWebSite> &
    SP$AppInstanceErrorSource__remoteWebSite &
    3; // 3
  static +database: Class<SP$AppInstanceErrorSource__database> &
    SP$AppInstanceErrorSource__database &
    4; // 4
  static +officeExtension: Class<SP$AppInstanceErrorSource__officeExtension> &
    SP$AppInstanceErrorSource__officeExtension &
    5; // 5
  static +eventCallouts: Class<SP$AppInstanceErrorSource__eventCallouts> &
    SP$AppInstanceErrorSource__eventCallouts &
    6; // 6
  static +finalization: Class<SP$AppInstanceErrorSource__finalization> &
    SP$AppInstanceErrorSource__finalization &
    7; // 7
}

declare class SP$AppInstanceErrorSource__common
  mixins SP$AppInstanceErrorSource {}
declare class SP$AppInstanceErrorSource__appWeb
  mixins SP$AppInstanceErrorSource {}
declare class SP$AppInstanceErrorSource__parentWeb
  mixins SP$AppInstanceErrorSource {}
declare class SP$AppInstanceErrorSource__remoteWebSite
  mixins SP$AppInstanceErrorSource {}
declare class SP$AppInstanceErrorSource__database
  mixins SP$AppInstanceErrorSource {}
declare class SP$AppInstanceErrorSource__officeExtension
  mixins SP$AppInstanceErrorSource {}
declare class SP$AppInstanceErrorSource__eventCallouts
  mixins SP$AppInstanceErrorSource {}
declare class SP$AppInstanceErrorSource__finalization
  mixins SP$AppInstanceErrorSource {}

declare class SP$AppInstanceErrorType {
  constructor(...args: empty): mixed;
  static +transient: Class<SP$AppInstanceErrorType__transient> &
    SP$AppInstanceErrorType__transient &
    0; // 0
  static +configuration: Class<SP$AppInstanceErrorType__configuration> &
    SP$AppInstanceErrorType__configuration &
    1; // 1
  static +app: Class<SP$AppInstanceErrorType__app> &
    SP$AppInstanceErrorType__app &
    2; // 2
}

declare class SP$AppInstanceErrorType__transient
  mixins SP$AppInstanceErrorType {}
declare class SP$AppInstanceErrorType__configuration
  mixins SP$AppInstanceErrorType {}
declare class SP$AppInstanceErrorType__app mixins SP$AppInstanceErrorType {}

declare class SP$AppInstanceStatus {
  constructor(...args: empty): mixed;
  static +invalidStatus: Class<SP$AppInstanceStatus__invalidStatus> &
    SP$AppInstanceStatus__invalidStatus &
    0; // 0
  static +installing: Class<SP$AppInstanceStatus__installing> &
    SP$AppInstanceStatus__installing &
    1; // 1
  static +canceling: Class<SP$AppInstanceStatus__canceling> &
    SP$AppInstanceStatus__canceling &
    2; // 2
  static +uninstalling: Class<SP$AppInstanceStatus__uninstalling> &
    SP$AppInstanceStatus__uninstalling &
    3; // 3
  static +installed: Class<SP$AppInstanceStatus__installed> &
    SP$AppInstanceStatus__installed &
    4; // 4
  static +upgrading: Class<SP$AppInstanceStatus__upgrading> &
    SP$AppInstanceStatus__upgrading &
    5; // 5
  static +initialized: Class<SP$AppInstanceStatus__initialized> &
    SP$AppInstanceStatus__initialized &
    6; // 6
  static +upgradeCanceling: Class<SP$AppInstanceStatus__upgradeCanceling> &
    SP$AppInstanceStatus__upgradeCanceling &
    7; // 7
  static +disabling: Class<SP$AppInstanceStatus__disabling> &
    SP$AppInstanceStatus__disabling &
    8; // 8
  static +disabled: Class<SP$AppInstanceStatus__disabled> &
    SP$AppInstanceStatus__disabled &
    9; // 9
}
...
declare class SP$AppInstanceStatus__upgradeCanceling
  mixins SP$AppInstanceStatus {}
...
declare class SP$AppLicenseCollection
  mixins SP$SP$ClientValueObjectCollection<SP$AppLicense> {
...
declare class SP$AppLicenseType {
  constructor(...args: empty): mixed;
  static +perpetualMultiUser: Class<SP$AppLicenseType__perpetualMultiUser> &
    SP$AppLicenseType__perpetualMultiUser &
    0; // 0
  static +perpetualAllUsers: Class<SP$AppLicenseType__perpetualAllUsers> &
    SP$AppLicenseType__perpetualAllUsers &
    1; // 1
  static +trialMultiUser: Class<SP$AppLicenseType__trialMultiUser> &
    SP$AppLicenseType__trialMultiUser &
    2; // 2
  static +trialAllUsers: Class<SP$AppLicenseType__trialAllUsers> &
    SP$AppLicenseType__trialAllUsers &
    3; // 3
}
...
declare class SP$BaseType {
  ...
  static +genericList: Class<SP$BaseType__genericList> &
    SP$BaseType__genericList &
    1; // 1
  static +documentLibrary: Class<SP$BaseType__documentLibrary> &
    SP$BaseType__documentLibrary &
    2; // 2
  static +unused: Class<SP$BaseType__unused> & SP$BaseType__unused & 3; // 3
  static +discussionBoard: Class<SP$BaseType__discussionBoard> &
    SP$BaseType__discussionBoard &
    4; // 4
...
declare class SP$BrowserFileHandling {
  constructor(...args: empty): mixed;
  static +permissive: Class<SP$BrowserFileHandling__permissive> &
    SP$BrowserFileHandling__permissive &
    0; // 0
  static +strict: Class<SP$BrowserFileHandling__strict> &
    SP$BrowserFileHandling__strict &
    1; // 1
}

declare class SP$BrowserFileHandling__permissive
  mixins SP$BrowserFileHandling {}
...
declare class SP$CalendarType {
  ...
  static +gregorian: Class<SP$CalendarType__gregorian> &
    SP$CalendarType__gregorian &
    1; // 1
  ...
  static +gregorianMEFrench: Class<SP$CalendarType__gregorianMEFrench> &
    SP$CalendarType__gregorianMEFrench &
    8; // 8
  static +gregorianArabic: Class<SP$CalendarType__gregorianArabic> &
    SP$CalendarType__gregorianArabic &
    9; // 9
  static +gregorianXLITEnglish: Class<SP$CalendarType__gregorianXLITEnglish> &
    SP$CalendarType__gregorianXLITEnglish &
    10; // 10
  static +gregorianXLITFrench: Class<SP$CalendarType__gregorianXLITFrench> &
    SP$CalendarType__gregorianXLITFrench &
    11; // 11
  static +koreaJapanLunar: Class<SP$CalendarType__koreaJapanLunar> &
    SP$CalendarType__koreaJapanLunar &
    12; // 12
  static +chineseLunar: Class<SP$CalendarType__chineseLunar> &
    SP$CalendarType__chineseLunar &
    13; // 13
  static +sakaEra: Class<SP$CalendarType__sakaEra> &
    SP$CalendarType__sakaEra &
    14; // 14
  static +umAlQura: Class<SP$CalendarType__umAlQura> &
    SP$CalendarType__umAlQura &
    15; // 15
}
...
declare class SP$ChangeType {
  constructor(...args: empty): mixed;
  static +noChange: Class<SP$ChangeType__noChange> &
    SP$ChangeType__noChange &
    0; // 0
  ...
  static +deleteObject: Class<SP$ChangeType__deleteObject> &
    SP$ChangeType__deleteObject &
    3; // 3
  static +rename: Class<SP$ChangeType__rename> & SP$ChangeType__rename & 4; // 4
  static +moveAway: Class<SP$ChangeType__moveAway> &
    SP$ChangeType__moveAway &
    5; // 5
  static +moveInto: Class<SP$ChangeType__moveInto> &
    SP$ChangeType__moveInto &
    6; // 6
  ...
  static +roleDelete: Class<SP$ChangeType__roleDelete> &
    SP$ChangeType__roleDelete &
    9; // 9
  static +roleUpdate: Class<SP$ChangeType__roleUpdate> &
    SP$ChangeType__roleUpdate &
    10; // 10
  static +assignmentAdd: Class<SP$ChangeType__assignmentAdd> &
    SP$ChangeType__assignmentAdd &
    11; // 11
  static +assignmentDelete: Class<SP$ChangeType__assignmentDelete> &
    SP$ChangeType__assignmentDelete &
    12; // 12
  static +memberAdd: Class<SP$ChangeType__memberAdd> &
    SP$ChangeType__memberAdd &
    13; // 13
  static +memberDelete: Class<SP$ChangeType__memberDelete> &
    SP$ChangeType__memberDelete &
    14; // 14
  static +systemUpdate: Class<SP$ChangeType__systemUpdate> &
    SP$ChangeType__systemUpdate &
    15; // 15
  static +navigation: Class<SP$ChangeType__navigation> &
    SP$ChangeType__navigation &
    16; // 16
  static +scopeAdd: Class<SP$ChangeType__scopeAdd> &
    SP$ChangeType__scopeAdd &
    17; // 17
  static +scopeDelete: Class<SP$ChangeType__scopeDelete> &
    SP$ChangeType__scopeDelete &
    18; // 18
  static +listContentTypeAdd: Class<SP$ChangeType__listContentTypeAdd> &
    SP$ChangeType__listContentTypeAdd &
    19; // 19
  static +listContentTypeDelete: Class<SP$ChangeType__listContentTypeDelete> &
    SP$ChangeType__listContentTypeDelete &
    20; // 20
}
...
declare class SP$CheckinType {
  constructor(...args: empty): mixed;
  static +minorCheckIn: Class<SP$CheckinType__minorCheckIn> &
    SP$CheckinType__minorCheckIn &
    0; // 0
  static +majorCheckIn: Class<SP$CheckinType__majorCheckIn> &
    SP$CheckinType__majorCheckIn &
    1; // 1
  static +overwriteCheckIn: Class<SP$CheckinType__overwriteCheckIn> &
    SP$CheckinType__overwriteCheckIn &
    2; // 2
}
...
declare class SP$CheckOutType {
  ...
  static +offline: Class<SP$CheckOutType__offline> &
    SP$CheckOutType__offline &
    1; // 1
...
declare class SP$ChoiceFormatType {
  constructor(...args: empty): mixed;
  static +dropdown: Class<SP$ChoiceFormatType__dropdown> &
    SP$ChoiceFormatType__dropdown &
    0; // 0
  static +radioButtons: Class<SP$ChoiceFormatType__radioButtons> &
    SP$ChoiceFormatType__radioButtons &
    1; // 1
}
...
declare class SP$ContentType mixins SP$SP$ClientObject {
  ...
  get_stringId(): string;
  get_workflowAssociations(): SP$Workflow.Workflow$WorkflowAssociationCollection;
...
declare class SP$CustomizedPageStatus {
  constructor(...args: empty): mixed;
  static +none: Class<SP$CustomizedPageStatus__none> &
    SP$CustomizedPageStatus__none &
    0; // 0
  static +uncustomized: Class<SP$CustomizedPageStatus__uncustomized> &
    SP$CustomizedPageStatus__uncustomized &
    1; // 1
  static +customized: Class<SP$CustomizedPageStatus__customized> &
    SP$CustomizedPageStatus__customized &
    2; // 2
}

declare class SP$CustomizedPageStatus__none mixins SP$CustomizedPageStatus {}
declare class SP$CustomizedPageStatus__uncustomized
  mixins SP$CustomizedPageStatus {}
declare class SP$CustomizedPageStatus__customized
  mixins SP$CustomizedPageStatus {}

declare class SP$DateTimeFieldFormatType {
  constructor(...args: empty): mixed;
  static +dateOnly: Class<SP$DateTimeFieldFormatType__dateOnly> &
    SP$DateTimeFieldFormatType__dateOnly &
    0; // 0
  static +dateTime: Class<SP$DateTimeFieldFormatType__dateTime> &
    SP$DateTimeFieldFormatType__dateTime &
    1; // 1
}

declare class SP$DateTimeFieldFormatType__dateOnly
  mixins SP$DateTimeFieldFormatType {}
declare class SP$DateTimeFieldFormatType__dateTime
  mixins SP$DateTimeFieldFormatType {}

declare class SP$DateTimeFieldFriendlyFormatType {
  constructor(...args: empty): mixed;
  static +unspecified: Class<SP$DateTimeFieldFriendlyFormatType__unspecified> &
    SP$DateTimeFieldFriendlyFormatType__unspecified &
    0; // 0
  static +disabled: Class<SP$DateTimeFieldFriendlyFormatType__disabled> &
    SP$DateTimeFieldFriendlyFormatType__disabled &
    1; // 1
  static +relative: Class<SP$DateTimeFieldFriendlyFormatType__relative> &
    SP$DateTimeFieldFriendlyFormatType__relative &
    2; // 2
}

declare class SP$DateTimeFieldFriendlyFormatType__unspecified
  mixins SP$DateTimeFieldFriendlyFormatType {}
declare class SP$DateTimeFieldFriendlyFormatType__disabled
  mixins SP$DateTimeFieldFriendlyFormatType {}
declare class SP$DateTimeFieldFriendlyFormatType__relative
  mixins SP$DateTimeFieldFriendlyFormatType {}

declare class SP$DraftVisibilityType {
  constructor(...args: empty): mixed;
  static +reader: Class<SP$DraftVisibilityType__reader> &
    SP$DraftVisibilityType__reader &
    0; // 0
  static +author: Class<SP$DraftVisibilityType__author> &
    SP$DraftVisibilityType__author &
    1; // 1
  static +approver: Class<SP$DraftVisibilityType__approver> &
    SP$DraftVisibilityType__approver &
    2; // 2
}
...
declare type SP$EventReceiverDefinitionCollection = {
  ...
  add(
    eventReceiverCreationInformation: SP$SP$EventReceiverDefinitionCreationInformation
  ): SP$SP$EventReceiverDefinition
} & SP$SP$ClientObjectCollection<SP$EventReceiverDefinition>;

declare class SP$EventReceiverDefinitionCreationInformation
  mixins SP$SP$ClientValueObject {
  get_receiverAssembly(): string;
...
declare class SP$EventReceiverSynchronization {
  constructor(...args: empty): mixed;
  static +defaultSynchronization: Class<SP$EventReceiverSynchronization__defaultSynchronization> &
    SP$EventReceiverSynchronization__defaultSynchronization &
    0; // 0
  static +synchronous: Class<SP$EventReceiverSynchronization__synchronous> &
    SP$EventReceiverSynchronization__synchronous &
    1; // 1
  static +asynchronous: Class<SP$EventReceiverSynchronization__asynchronous> &
    SP$EventReceiverSynchronization__asynchronous &
    2; // 2
}

declare class SP$EventReceiverSynchronization__defaultSynchronization
  mixins SP$EventReceiverSynchronization {}
declare class SP$EventReceiverSynchronization__synchronous
  mixins SP$EventReceiverSynchronization {}
declare class SP$EventReceiverSynchronization__asynchronous
  mixins SP$EventReceiverSynchronization {}

declare class SP$EventReceiverType {
  constructor(...args: empty): mixed;
  static +invalidReceiver: Class<SP$EventReceiverType__invalidReceiver> &
    SP$EventReceiverType__invalidReceiver &
    0; // 0
  static +itemAdding: Class<SP$EventReceiverType__itemAdding> &
    SP$EventReceiverType__itemAdding &
    1; // 1
  static +itemUpdating: Class<SP$EventReceiverType__itemUpdating> &
    SP$EventReceiverType__itemUpdating &
    2; // 2
  static +itemDeleting: Class<SP$EventReceiverType__itemDeleting> &
    SP$EventReceiverType__itemDeleting &
    3; // 3
  static +itemCheckingIn: Class<SP$EventReceiverType__itemCheckingIn> &
    SP$EventReceiverType__itemCheckingIn &
    4; // 4
  static +itemCheckingOut: Class<SP$EventReceiverType__itemCheckingOut> &
    SP$EventReceiverType__itemCheckingOut &
    5; // 5
  static +itemUncheckingOut: Class<SP$EventReceiverType__itemUncheckingOut> &
    SP$EventReceiverType__itemUncheckingOut &
    6; // 6
  static +itemAttachmentAdding: Class<SP$EventReceiverType__itemAttachmentAdding> &
    SP$EventReceiverType__itemAttachmentAdding &
    7; // 7
  static +itemAttachmentDeleting: Class<SP$EventReceiverType__itemAttachmentDeleting> &
    SP$EventReceiverType__itemAttachmentDeleting &
    8; // 8
  static +itemFileMoving: Class<SP$EventReceiverType__itemFileMoving> &
    SP$EventReceiverType__itemFileMoving &
    9; // 9
  static +itemVersionDeleting: Class<SP$EventReceiverType__itemVersionDeleting> &
    SP$EventReceiverType__itemVersionDeleting &
    10; // 10
  static +fieldAdding: Class<SP$EventReceiverType__fieldAdding> &
    SP$EventReceiverType__fieldAdding &
    11; // 11
  static +fieldUpdating: Class<SP$EventReceiverType__fieldUpdating> &
    SP$EventReceiverType__fieldUpdating &
    12; // 12
  static +fieldDeleting: Class<SP$EventReceiverType__fieldDeleting> &
    SP$EventReceiverType__fieldDeleting &
    13; // 13
  static +listAdding: Class<SP$EventReceiverType__listAdding> &
    SP$EventReceiverType__listAdding &
    14; // 14
  static +listDeleting: Class<SP$EventReceiverType__listDeleting> &
    SP$EventReceiverType__listDeleting &
    15; // 15
  static +siteDeleting: Class<SP$EventReceiverType__siteDeleting> &
    SP$EventReceiverType__siteDeleting &
    16; // 16
  static +webDeleting: Class<SP$EventReceiverType__webDeleting> &
    SP$EventReceiverType__webDeleting &
    17; // 17
  static +webMoving: Class<SP$EventReceiverType__webMoving> &
    SP$EventReceiverType__webMoving &
    18; // 18
  static +webAdding: Class<SP$EventReceiverType__webAdding> &
    SP$EventReceiverType__webAdding &
    19; // 19
  static +groupAdding: Class<SP$EventReceiverType__groupAdding> &
    SP$EventReceiverType__groupAdding &
    20; // 20
  static +groupUpdating: Class<SP$EventReceiverType__groupUpdating> &
    SP$EventReceiverType__groupUpdating &
    21; // 21
  static +groupDeleting: Class<SP$EventReceiverType__groupDeleting> &
    SP$EventReceiverType__groupDeleting &
    22; // 22
  static +groupUserAdding: Class<SP$EventReceiverType__groupUserAdding> &
    SP$EventReceiverType__groupUserAdding &
    23; // 23
  static +groupUserDeleting: Class<SP$EventReceiverType__groupUserDeleting> &
    SP$EventReceiverType__groupUserDeleting &
    24; // 24
  static +roleDefinitionAdding: Class<SP$EventReceiverType__roleDefinitionAdding> &
    SP$EventReceiverType__roleDefinitionAdding &
    25; // 25
  static +roleDefinitionUpdating: Class<SP$EventReceiverType__roleDefinitionUpdating> &
    SP$EventReceiverType__roleDefinitionUpdating &
    26; // 26
  static +roleDefinitionDeleting: Class<SP$EventReceiverType__roleDefinitionDeleting> &
    SP$EventReceiverType__roleDefinitionDeleting &
    27; // 27
  static +roleAssignmentAdding: Class<SP$EventReceiverType__roleAssignmentAdding> &
    SP$EventReceiverType__roleAssignmentAdding &
    28; // 28
  static +roleAssignmentDeleting: Class<SP$EventReceiverType__roleAssignmentDeleting> &
    SP$EventReceiverType__roleAssignmentDeleting &
    29; // 29
  static +inheritanceBreaking: Class<SP$EventReceiverType__inheritanceBreaking> &
    SP$EventReceiverType__inheritanceBreaking &
    30; // 30
  static +inheritanceResetting: Class<SP$EventReceiverType__inheritanceResetting> &
    SP$EventReceiverType__inheritanceResetting &
    31; // 31
  static +workflowStarting: Class<SP$EventReceiverType__workflowStarting> &
    SP$EventReceiverType__workflowStarting &
    32; // 32
  static +itemAdded: Class<SP$EventReceiverType__itemAdded> &
    SP$EventReceiverType__itemAdded &
    33; // 33
  static +itemUpdated: Class<SP$EventReceiverType__itemUpdated> &
    SP$EventReceiverType__itemUpdated &
    34; // 34
  static +itemDeleted: Class<SP$EventReceiverType__itemDeleted> &
    SP$EventReceiverType__itemDeleted &
    35; // 35
  static +itemCheckedIn: Class<SP$EventReceiverType__itemCheckedIn> &
    SP$EventReceiverType__itemCheckedIn &
    36; // 36
  static +itemCheckedOut: Class<SP$EventReceiverType__itemCheckedOut> &
    SP$EventReceiverType__itemCheckedOut &
    37; // 37
  static +itemUncheckedOut: Class<SP$EventReceiverType__itemUncheckedOut> &
    SP$EventReceiverType__itemUncheckedOut &
    38; // 38
  static +itemAttachmentAdded: Class<SP$EventReceiverType__itemAttachmentAdded> &
    SP$EventReceiverType__itemAttachmentAdded &
    39; // 39
  static +itemAttachmentDeleted: Class<SP$EventReceiverType__itemAttachmentDeleted> &
    SP$EventReceiverType__itemAttachmentDeleted &
    40; // 40
  static +itemFileMoved: Class<SP$EventReceiverType__itemFileMoved> &
    SP$EventReceiverType__itemFileMoved &
    41; // 41
  static +itemFileConverted: Class<SP$EventReceiverType__itemFileConverted> &
    SP$EventReceiverType__itemFileConverted &
    42; // 42
  static +itemVersionDeleted: Class<SP$EventReceiverType__itemVersionDeleted> &
    SP$EventReceiverType__itemVersionDeleted &
    43; // 43
  static +fieldAdded: Class<SP$EventReceiverType__fieldAdded> &
    SP$EventReceiverType__fieldAdded &
    44; // 44
  static +fieldUpdated: Class<SP$EventReceiverType__fieldUpdated> &
    SP$EventReceiverType__fieldUpdated &
    45; // 45
  static +fieldDeleted: Class<SP$EventReceiverType__fieldDeleted> &
    SP$EventReceiverType__fieldDeleted &
    46; // 46
  static +listAdded: Class<SP$EventReceiverType__listAdded> &
    SP$EventReceiverType__listAdded &
    47; // 47
  static +listDeleted: Class<SP$EventReceiverType__listDeleted> &
    SP$EventReceiverType__listDeleted &
    48; // 48
  static +siteDeleted: Class<SP$EventReceiverType__siteDeleted> &
    SP$EventReceiverType__siteDeleted &
    49; // 49
  static +webDeleted: Class<SP$EventReceiverType__webDeleted> &
    SP$EventReceiverType__webDeleted &
    50; // 50
  static +webMoved: Class<SP$EventReceiverType__webMoved> &
    SP$EventReceiverType__webMoved &
    51; // 51
  static +webProvisioned: Class<SP$EventReceiverType__webProvisioned> &
    SP$EventReceiverType__webProvisioned &
    52; // 52
  static +groupAdded: Class<SP$EventReceiverType__groupAdded> &
    SP$EventReceiverType__groupAdded &
    53; // 53
  static +groupUpdated: Class<SP$EventReceiverType__groupUpdated> &
    SP$EventReceiverType__groupUpdated &
    54; // 54
  static +groupDeleted: Class<SP$EventReceiverType__groupDeleted> &
    SP$EventReceiverType__groupDeleted &
    55; // 55
  static +groupUserAdded: Class<SP$EventReceiverType__groupUserAdded> &
    SP$EventReceiverType__groupUserAdded &
    56; // 56
  static +groupUserDeleted: Class<SP$EventReceiverType__groupUserDeleted> &
    SP$EventReceiverType__groupUserDeleted &
    57; // 57
  static +roleDefinitionAdded: Class<SP$EventReceiverType__roleDefinitionAdded> &
    SP$EventReceiverType__roleDefinitionAdded &
    58; // 58
  static +roleDefinitionUpdated: Class<SP$EventReceiverType__roleDefinitionUpdated> &
    SP$EventReceiverType__roleDefinitionUpdated &
    59; // 59
  static +roleDefinitionDeleted: Class<SP$EventReceiverType__roleDefinitionDeleted> &
    SP$EventReceiverType__roleDefinitionDeleted &
    60; // 60
  static +roleAssignmentAdded: Class<SP$EventReceiverType__roleAssignmentAdded> &
    SP$EventReceiverType__roleAssignmentAdded &
    61; // 61
  static +roleAssignmentDeleted: Class<SP$EventReceiverType__roleAssignmentDeleted> &
    SP$EventReceiverType__roleAssignmentDeleted &
    62; // 62
  static +inheritanceBroken: Class<SP$EventReceiverType__inheritanceBroken> &
    SP$EventReceiverType__inheritanceBroken &
    63; // 63
  static +inheritanceReset: Class<SP$EventReceiverType__inheritanceReset> &
    SP$EventReceiverType__inheritanceReset &
    64; // 64
  static +workflowStarted: Class<SP$EventReceiverType__workflowStarted> &
    SP$EventReceiverType__workflowStarted &
    65; // 65
  static +workflowPostponed: Class<SP$EventReceiverType__workflowPostponed> &
    SP$EventReceiverType__workflowPostponed &
    66; // 66
  static +workflowCompleted: Class<SP$EventReceiverType__workflowCompleted> &
    SP$EventReceiverType__workflowCompleted &
    67; // 67
  static +entityInstanceAdded: Class<SP$EventReceiverType__entityInstanceAdded> &
    SP$EventReceiverType__entityInstanceAdded &
    68; // 68
  static +entityInstanceUpdated: Class<SP$EventReceiverType__entityInstanceUpdated> &
    SP$EventReceiverType__entityInstanceUpdated &
    69; // 69
  static +entityInstanceDeleted: Class<SP$EventReceiverType__entityInstanceDeleted> &
    SP$EventReceiverType__entityInstanceDeleted &
    70; // 70
  static +appInstalled: Class<SP$EventReceiverType__appInstalled> &
    SP$EventReceiverType__appInstalled &
    71; // 71
  static +appUpgraded: Class<SP$EventReceiverType__appUpgraded> &
    SP$EventReceiverType__appUpgraded &
    72; // 72
  static +appUninstalling: Class<SP$EventReceiverType__appUninstalling> &
    SP$EventReceiverType__appUninstalling &
    73; // 73
  static +emailReceived: Class<SP$EventReceiverType__emailReceived> &
    SP$EventReceiverType__emailReceived &
    74; // 74
  static +contextEvent: Class<SP$EventReceiverType__contextEvent> &
    SP$EventReceiverType__contextEvent &
    75; // 75
}

declare class SP$EventReceiverType__invalidReceiver
  mixins SP$EventReceiverType {}
...
declare class SP$EventReceiverType__itemCheckingIn
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemCheckingOut
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemUncheckingOut
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemAttachmentAdding
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemAttachmentDeleting
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemFileMoving
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemVersionDeleting
  mixins SP$EventReceiverType {}
...
declare class SP$EventReceiverType__groupUserAdding
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__groupUserDeleting
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__roleDefinitionAdding
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__roleDefinitionUpdating
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__roleDefinitionDeleting
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__roleAssignmentAdding
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__roleAssignmentDeleting
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__inheritanceBreaking
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__inheritanceResetting
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__workflowStarting
  mixins SP$EventReceiverType {}
...
declare class SP$EventReceiverType__itemCheckedOut
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemUncheckedOut
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemAttachmentAdded
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemAttachmentDeleted
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemFileMoved mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemFileConverted
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__itemVersionDeleted
  mixins SP$EventReceiverType {}
...
declare class SP$EventReceiverType__webProvisioned
  mixins SP$EventReceiverType {}
...
declare class SP$EventReceiverType__groupUserAdded
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__groupUserDeleted
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__roleDefinitionAdded
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__roleDefinitionUpdated
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__roleDefinitionDeleted
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__roleAssignmentAdded
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__roleAssignmentDeleted
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__inheritanceBroken
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__inheritanceReset
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__workflowStarted
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__workflowPostponed
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__workflowCompleted
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__entityInstanceAdded
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__entityInstanceUpdated
  mixins SP$EventReceiverType {}
declare class SP$EventReceiverType__entityInstanceDeleted
  mixins SP$EventReceiverType {}
...
declare class SP$EventReceiverType__appUninstalling
  mixins SP$EventReceiverType {}
...
declare type SP$FeatureCollection = {
  ...
  add(
    ...
    force: boolean,
    featdefScope: SP$SP$FeatureDefinitionScope
  ): SP$SP$Feature,
...
declare class SP$FeatureDefinitionScope {
  constructor(...args: empty): mixed;
  static +none: Class<SP$FeatureDefinitionScope__none> &
    SP$FeatureDefinitionScope__none &
    0; // 0
  static +farm: Class<SP$FeatureDefinitionScope__farm> &
    SP$FeatureDefinitionScope__farm &
    1; // 1
  static +site: Class<SP$FeatureDefinitionScope__site> &
    SP$FeatureDefinitionScope__site &
    2; // 2
  static +web: Class<SP$FeatureDefinitionScope__web> &
    SP$FeatureDefinitionScope__web &
    3; // 3
}

declare class SP$FeatureDefinitionScope__none
  mixins SP$FeatureDefinitionScope {}
declare class SP$FeatureDefinitionScope__farm
  mixins SP$FeatureDefinitionScope {}
declare class SP$FeatureDefinitionScope__site
  mixins SP$FeatureDefinitionScope {}
...
declare class SP$Field mixins SP$SP$ClientObject {
  ...
  validateSetValue<T>(item: SP$SP$ListItem<T>, value: string): void;
...
declare class SP$FieldLookup mixins SP$SP$Field {
  ...
  set_relationshipDeleteBehavior(
    value: SP$SP$RelationshipDeleteBehaviorType
  ): void;
}
...
declare class SP$FieldType {
  ...
  static +threading: Class<SP$FieldType__threading> &
    SP$FieldType__threading &
    13; // 13
  static +guid: Class<SP$FieldType__guid> & SP$FieldType__guid & 14; // 14
  static +multiChoice: Class<SP$FieldType__multiChoice> &
    SP$FieldType__multiChoice &
    15; // 15
  static +gridChoice: Class<SP$FieldType__gridChoice> &
    SP$FieldType__gridChoice &
    16; // 16
  static +calculated: Class<SP$FieldType__calculated> &
    SP$FieldType__calculated &
    17; // 17
  static +file: Class<SP$FieldType__file> & SP$FieldType__file & 18; // 18
  static +attachments: Class<SP$FieldType__attachments> &
    SP$FieldType__attachments &
    19; // 19
  static +user: Class<SP$FieldType__user> & SP$FieldType__user & 20; // 20
  static +recurrence: Class<SP$FieldType__recurrence> &
    SP$FieldType__recurrence &
    21; // 21
  static +crossProjectLink: Class<SP$FieldType__crossProjectLink> &
    SP$FieldType__crossProjectLink &
    22; // 22
  ...
  static +contentTypeId: Class<SP$FieldType__contentTypeId> &
    SP$FieldType__contentTypeId &
    25; // 25
  static +pageSeparator: Class<SP$FieldType__pageSeparator> &
    SP$FieldType__pageSeparator &
    26; // 26
  static +threadIndex: Class<SP$FieldType__threadIndex> &
    SP$FieldType__threadIndex &
    27; // 27
  static +workflowStatus: Class<SP$FieldType__workflowStatus> &
    SP$FieldType__workflowStatus &
    28; // 28
  static +allDayEvent: Class<SP$FieldType__allDayEvent> &
    SP$FieldType__allDayEvent &
    29; // 29
  static +workflowEventType: Class<SP$FieldType__workflowEventType> &
    SP$FieldType__workflowEventType &
    30; // 30
  static +geolocation: Class<SP$FieldType__geolocation> &
    SP$FieldType__geolocation &
    31; // 31
  static +outcomeChoice: Class<SP$FieldType__outcomeChoice> &
    SP$FieldType__outcomeChoice &
    32; // 32
...
declare class SP$FieldUserSelectionMode {
  constructor(...args: empty): mixed;
  static +peopleOnly: Class<SP$FieldUserSelectionMode__peopleOnly> &
    SP$FieldUserSelectionMode__peopleOnly &
    0; // 0
  static +peopleAndGroups: Class<SP$FieldUserSelectionMode__peopleAndGroups> &
    SP$FieldUserSelectionMode__peopleAndGroups &
    1; // 1
}

declare class SP$FieldUserSelectionMode__peopleOnly
  mixins SP$FieldUserSelectionMode {}
declare class SP$FieldUserSelectionMode__peopleAndGroups
  mixins SP$FieldUserSelectionMode {}
...
declare class SP$File mixins SP$SP$ClientObject {
   ...
   */
  get_listItemAllFields<T>(): SP$SP$ListItem<T>;
  ...
  getLimitedWebPartManager(
    scope: SP$WebParts.WebParts$PersonalizationScope
  ): SP$WebParts.WebParts$LimitedWebPartManager;
...
declare type SP$FileCollection = {
  ...
  addTemplateFile(
    urlOfFile: string,
    templateFileType: SP$SP$TemplateFileType
  ): SP$SP$File
...
declare class SP$FileLevel {
  constructor(...args: empty): mixed;
  static +published: Class<SP$FileLevel__published> &
    SP$FileLevel__published &
    0; // 0
...
declare class SP$FileSystemObjectType {
  constructor(...args: empty): mixed;
  static +invalid: Class<SP$FileSystemObjectType__invalid> &
    SP$FileSystemObjectType__invalid &
    0; // 0
  static +file: Class<SP$FileSystemObjectType__file> &
    SP$FileSystemObjectType__file &
    1; // 1
  static +folder: Class<SP$FileSystemObjectType__folder> &
    SP$FileSystemObjectType__folder &
    2; // 2
  static +web: Class<SP$FileSystemObjectType__web> &
    SP$FileSystemObjectType__web &
    3; // 3
}
...
declare class SP$Principal mixins SP$SP$ClientObject {
  ...
  get_title(): string;
  set_title(value: string): void;
  get_principalType(): SP$Utilities.Utilities$PrincipalType;
}
...
declare class SP$ControlMode {
  ...
  static +displayMode: Class<SP$ControlMode__displayMode> &
    SP$ControlMode__displayMode &
    1; // 1
  static +editMode: Class<SP$ControlMode__editMode> &
    SP$ControlMode__editMode &
    2; // 2
...
declare type SP$ListCollection = {
   ...
   */
  itemAt<T>(index: number): SP$SP$List<T>,

  /**
   * Gets the list at the specified index in the collection.
   */
  get_item<T>(index: number): SP$SP$List<T>,

  /**
   * Returns the list with the specified title from the collection.
   */
  getByTitle<T>(title: string): SP$SP$List<T>,

  /**
   * Returns the list with the specified list identifier.
   */
  getById<T>(id: string | SP$SP$Guid): SP$SP$List<T>,
...
declare class SP$ListDataValidationFailureReason {
  constructor(...args: empty): mixed;
  static +dataFailure: Class<SP$ListDataValidationFailureReason__dataFailure> &
    SP$ListDataValidationFailureReason__dataFailure &
    0; // 0
  static +formulaError: Class<SP$ListDataValidationFailureReason__formulaError> &
    SP$ListDataValidationFailureReason__formulaError &
    1; // 1
}

declare class SP$ListDataValidationFailureReason__dataFailure
  mixins SP$ListDataValidationFailureReason {}
declare class SP$ListDataValidationFailureReason__formulaError
  mixins SP$ListDataValidationFailureReason {}

declare class SP$ListDataValidationType {
  constructor(...args: empty): mixed;
  static +userFormulaField: Class<SP$ListDataValidationType__userFormulaField> &
    SP$ListDataValidationType__userFormulaField &
    0; // 0
  static +userFormulaItem: Class<SP$ListDataValidationType__userFormulaItem> &
    SP$ListDataValidationType__userFormulaItem &
    1; // 1
  static +requiredField: Class<SP$ListDataValidationType__requiredField> &
    SP$ListDataValidationType__requiredField &
    2; // 2
  static +choiceField: Class<SP$ListDataValidationType__choiceField> &
    SP$ListDataValidationType__choiceField &
    3; // 3
  static +minMaxField: Class<SP$ListDataValidationType__minMaxField> &
    SP$ListDataValidationType__minMaxField &
    4; // 4
  static +textField: Class<SP$ListDataValidationType__textField> &
    SP$ListDataValidationType__textField &
    5; // 5
}

declare class SP$ListDataValidationType__userFormulaField
  mixins SP$ListDataValidationType {}
declare class SP$ListDataValidationType__userFormulaItem
  mixins SP$ListDataValidationType {}
declare class SP$ListDataValidationType__requiredField
  mixins SP$ListDataValidationType {}
declare class SP$ListDataValidationType__choiceField
  mixins SP$ListDataValidationType {}
declare class SP$ListDataValidationType__minMaxField
  mixins SP$ListDataValidationType {}
declare class SP$ListDataValidationType__textField
  mixins SP$ListDataValidationType {}
...
declare class SP$ListItem<T = any> mixins SP$SP$SecurableObject {
  ...
  refreshLoad(): void;
  getWOPIFrameUrl(
    action: SP$Utilities.Utilities$SPWOPIFrameAction
  ): SP$SP$StringResult;
...
declare class SP$ListTemplateType {
  constructor(...args: empty): mixed;
  static +invalidType: Class<SP$ListTemplateType__invalidType> &
    SP$ListTemplateType__invalidType &
    0; // 0
  static +noListTemplate: Class<SP$ListTemplateType__noListTemplate> &
    SP$ListTemplateType__noListTemplate &
    1; // 1
  static +genericList: Class<SP$ListTemplateType__genericList> &
    SP$ListTemplateType__genericList &
    2; // 2
  static +documentLibrary: Class<SP$ListTemplateType__documentLibrary> &
    SP$ListTemplateType__documentLibrary &
    3; // 3
  static +survey: Class<SP$ListTemplateType__survey> &
    SP$ListTemplateType__survey &
    4; // 4
  static +links: Class<SP$ListTemplateType__links> &
    SP$ListTemplateType__links &
    5; // 5
  static +announcements: Class<SP$ListTemplateType__announcements> &
    SP$ListTemplateType__announcements &
    6; // 6
  static +contacts: Class<SP$ListTemplateType__contacts> &
    SP$ListTemplateType__contacts &
    7; // 7
  static +events: Class<SP$ListTemplateType__events> &
    SP$ListTemplateType__events &
    8; // 8
  static +tasks: Class<SP$ListTemplateType__tasks> &
    SP$ListTemplateType__tasks &
    9; // 9
  static +discussionBoard: Class<SP$ListTemplateType__discussionBoard> &
    SP$ListTemplateType__discussionBoard &
    10; // 10
  static +pictureLibrary: Class<SP$ListTemplateType__pictureLibrary> &
    SP$ListTemplateType__pictureLibrary &
    11; // 11
  static +dataSources: Class<SP$ListTemplateType__dataSources> &
    SP$ListTemplateType__dataSources &
    12; // 12
  static +webTemplateCatalog: Class<SP$ListTemplateType__webTemplateCatalog> &
    SP$ListTemplateType__webTemplateCatalog &
    13; // 13
  static +userInformation: Class<SP$ListTemplateType__userInformation> &
    SP$ListTemplateType__userInformation &
    14; // 14
  static +webPartCatalog: Class<SP$ListTemplateType__webPartCatalog> &
    SP$ListTemplateType__webPartCatalog &
    15; // 15
  static +listTemplateCatalog: Class<SP$ListTemplateType__listTemplateCatalog> &
    SP$ListTemplateType__listTemplateCatalog &
    16; // 16
  static +xMLForm: Class<SP$ListTemplateType__xMLForm> &
    SP$ListTemplateType__xMLForm &
    17; // 17
  static +masterPageCatalog: Class<SP$ListTemplateType__masterPageCatalog> &
    SP$ListTemplateType__masterPageCatalog &
    18; // 18
  static +noCodeWorkflows: Class<SP$ListTemplateType__noCodeWorkflows> &
    SP$ListTemplateType__noCodeWorkflows &
    19; // 19
  static +workflowProcess: Class<SP$ListTemplateType__workflowProcess> &
    SP$ListTemplateType__workflowProcess &
    20; // 20
  static +webPageLibrary: Class<SP$ListTemplateType__webPageLibrary> &
    SP$ListTemplateType__webPageLibrary &
    21; // 21
  static +customGrid: Class<SP$ListTemplateType__customGrid> &
    SP$ListTemplateType__customGrid &
    22; // 22
  static +solutionCatalog: Class<SP$ListTemplateType__solutionCatalog> &
    SP$ListTemplateType__solutionCatalog &
    23; // 23
  static +noCodePublic: Class<SP$ListTemplateType__noCodePublic> &
    SP$ListTemplateType__noCodePublic &
    24; // 24
  static +themeCatalog: Class<SP$ListTemplateType__themeCatalog> &
    SP$ListTemplateType__themeCatalog &
    25; // 25
  static +designCatalog: Class<SP$ListTemplateType__designCatalog> &
    SP$ListTemplateType__designCatalog &
    26; // 26
  static +appDataCatalog: Class<SP$ListTemplateType__appDataCatalog> &
    SP$ListTemplateType__appDataCatalog &
    27; // 27
  static +dataConnectionLibrary: Class<SP$ListTemplateType__dataConnectionLibrary> &
    SP$ListTemplateType__dataConnectionLibrary &
    28; // 28
  static +workflowHistory: Class<SP$ListTemplateType__workflowHistory> &
    SP$ListTemplateType__workflowHistory &
    29; // 29
  static +ganttTasks: Class<SP$ListTemplateType__ganttTasks> &
    SP$ListTemplateType__ganttTasks &
    30; // 30
  static +helpLibrary: Class<SP$ListTemplateType__helpLibrary> &
    SP$ListTemplateType__helpLibrary &
    31; // 31
  static +accessRequest: Class<SP$ListTemplateType__accessRequest> &
    SP$ListTemplateType__accessRequest &
    32; // 32
  static +tasksWithTimelineAndHierarchy: Class<SP$ListTemplateType__tasksWithTimelineAndHierarchy> &
    SP$ListTemplateType__tasksWithTimelineAndHierarchy &
    33; // 33
  static +maintenanceLogs: Class<SP$ListTemplateType__maintenanceLogs> &
    SP$ListTemplateType__maintenanceLogs &
    34; // 34
  static +meetings: Class<SP$ListTemplateType__meetings> &
    SP$ListTemplateType__meetings &
    35; // 35
  static +agenda: Class<SP$ListTemplateType__agenda> &
    SP$ListTemplateType__agenda &
    36; // 36
  static +meetingUser: Class<SP$ListTemplateType__meetingUser> &
    SP$ListTemplateType__meetingUser &
    37; // 37
  static +decision: Class<SP$ListTemplateType__decision> &
    SP$ListTemplateType__decision &
    38; // 38
  static +meetingObjective: Class<SP$ListTemplateType__meetingObjective> &
    SP$ListTemplateType__meetingObjective &
    39; // 39
  static +textBox: Class<SP$ListTemplateType__textBox> &
    SP$ListTemplateType__textBox &
    40; // 40
  static +thingsToBring: Class<SP$ListTemplateType__thingsToBring> &
    SP$ListTemplateType__thingsToBring &
    41; // 41
  static +homePageLibrary: Class<SP$ListTemplateType__homePageLibrary> &
    SP$ListTemplateType__homePageLibrary &
    42; // 42
  static +posts: Class<SP$ListTemplateType__posts> &
    SP$ListTemplateType__posts &
    43; // 43
  static +comments: Class<SP$ListTemplateType__comments> &
    SP$ListTemplateType__comments &
    44; // 44
  static +categories: Class<SP$ListTemplateType__categories> &
    SP$ListTemplateType__categories &
    45; // 45
  static +facility: Class<SP$ListTemplateType__facility> &
    SP$ListTemplateType__facility &
    46; // 46
  static +whereabouts: Class<SP$ListTemplateType__whereabouts> &
    SP$ListTemplateType__whereabouts &
    47; // 47
  static +callTrack: Class<SP$ListTemplateType__callTrack> &
    SP$ListTemplateType__callTrack &
    48; // 48
  static +circulation: Class<SP$ListTemplateType__circulation> &
    SP$ListTemplateType__circulation &
    49; // 49
  static +timecard: Class<SP$ListTemplateType__timecard> &
    SP$ListTemplateType__timecard &
    50; // 50
  static +holidays: Class<SP$ListTemplateType__holidays> &
    SP$ListTemplateType__holidays &
    51; // 51
  static +iMEDic: Class<SP$ListTemplateType__iMEDic> &
    SP$ListTemplateType__iMEDic &
    52; // 52
  static +externalList: Class<SP$ListTemplateType__externalList> &
    SP$ListTemplateType__externalList &
    53; // 53
  static +mySiteDocumentLibrary: Class<SP$ListTemplateType__mySiteDocumentLibrary> &
    SP$ListTemplateType__mySiteDocumentLibrary &
    54; // 54
  static +issueTracking: Class<SP$ListTemplateType__issueTracking> &
    SP$ListTemplateType__issueTracking &
    55; // 55
  static +adminTasks: Class<SP$ListTemplateType__adminTasks> &
    SP$ListTemplateType__adminTasks &
    56; // 56
  static +healthRules: Class<SP$ListTemplateType__healthRules> &
    SP$ListTemplateType__healthRules &
    57; // 57
  static +healthReports: Class<SP$ListTemplateType__healthReports> &
    SP$ListTemplateType__healthReports &
    58; // 58
  static +developerSiteDraftApps: Class<SP$ListTemplateType__developerSiteDraftApps> &
    SP$ListTemplateType__developerSiteDraftApps &
    59; // 59
}
...
declare class SP$ListTemplateType__webTemplateCatalog
  mixins SP$ListTemplateType {}
...
declare class SP$ListTemplateType__listTemplateCatalog
  mixins SP$ListTemplateType {}
declare class SP$ListTemplateType__xMLForm mixins SP$ListTemplateType {}
declare class SP$ListTemplateType__masterPageCatalog
  mixins SP$ListTemplateType {}
...
declare class SP$ListTemplateType__dataConnectionLibrary
  mixins SP$ListTemplateType {}
...
declare class SP$ListTemplateType__tasksWithTimelineAndHierarchy
  mixins SP$ListTemplateType {}
...
declare class SP$ListTemplateType__meetingObjective
  mixins SP$ListTemplateType {}
...
declare class SP$ListTemplateType__mySiteDocumentLibrary
  mixins SP$ListTemplateType {}
...
declare class SP$ListTemplateType__developerSiteDraftApps
  mixins SP$ListTemplateType {}

declare class SP$MoveOperations {
  constructor(...args: empty): mixed;
  static +none: Class<SP$MoveOperations__none> & SP$MoveOperations__none & 0; // 0
  static +overwrite: Class<SP$MoveOperations__overwrite> &
    SP$MoveOperations__overwrite &
    1; // 1
  static +allowBrokenThickets: Class<SP$MoveOperations__allowBrokenThickets> &
    SP$MoveOperations__allowBrokenThickets &
    2; // 2
  static +bypassApprovePermission: Class<SP$MoveOperations__bypassApprovePermission> &
    SP$MoveOperations__bypassApprovePermission &
    3; // 3
}
...
declare class SP$MoveOperations__bypassApprovePermission
  mixins SP$MoveOperations {}
...
declare class SP$ObjectSharingInformation mixins SP$SP$ClientObject {
  ...
  ): SP$SP$ObjectSharingInformation;
...
declare class SP$OpenWebOptions {
  ...
  static +initNavigationCache: Class<SP$OpenWebOptions__initNavigationCache> &
    SP$OpenWebOptions__initNavigationCache &
    1; // 1
}
...
declare class SP$PageType {
  ...
  static +defaultView: Class<SP$PageType__defaultView> &
    SP$PageType__defaultView &
    1; // 1
  static +normalView: Class<SP$PageType__normalView> &
    SP$PageType__normalView &
    2; // 2
  static +dialogView: Class<SP$PageType__dialogView> &
    SP$PageType__dialogView &
    3; // 3
  static +view: Class<SP$PageType__view> & SP$PageType__view & 4; // 4
  static +displayForm: Class<SP$PageType__displayForm> &
    SP$PageType__displayForm &
    5; // 5
  static +displayFormDialog: Class<SP$PageType__displayFormDialog> &
    SP$PageType__displayFormDialog &
    6; // 6
  static +editForm: Class<SP$PageType__editForm> & SP$PageType__editForm & 7; // 7
  static +editFormDialog: Class<SP$PageType__editFormDialog> &
    SP$PageType__editFormDialog &
    8; // 8
  static +newForm: Class<SP$PageType__newForm> & SP$PageType__newForm & 9; // 9
  static +newFormDialog: Class<SP$PageType__newFormDialog> &
    SP$PageType__newFormDialog &
    10; // 10
  static +solutionForm: Class<SP$PageType__solutionForm> &
    SP$PageType__solutionForm &
    11; // 11
  static +pAGE_MAXITEMS: Class<SP$PageType__pAGE_MAXITEMS> &
    SP$PageType__pAGE_MAXITEMS &
    12; // 12
}
...
declare class SP$QuickLaunchOptions {
  constructor(...args: empty): mixed;
  static +off: Class<SP$QuickLaunchOptions__off> &
    SP$QuickLaunchOptions__off &
    0; // 0
  static +on: Class<SP$QuickLaunchOptions__on> & SP$QuickLaunchOptions__on & 1; // 1
  static +defaultValue: Class<SP$QuickLaunchOptions__defaultValue> &
    SP$QuickLaunchOptions__defaultValue &
    2; // 2
}
...
declare class SP$QuickLaunchOptions__defaultValue
  mixins SP$QuickLaunchOptions {}
...
declare class SP$RecycleBinItemState {
  constructor(...args: empty): mixed;
  static +none: Class<SP$RecycleBinItemState__none> &
    SP$RecycleBinItemState__none &
    0; // 0
  static +firstStageRecycleBin: Class<SP$RecycleBinItemState__firstStageRecycleBin> &
    SP$RecycleBinItemState__firstStageRecycleBin &
    1; // 1
  static +secondStageRecycleBin: Class<SP$RecycleBinItemState__secondStageRecycleBin> &
    SP$RecycleBinItemState__secondStageRecycleBin &
    2; // 2
}

declare class SP$RecycleBinItemState__none mixins SP$RecycleBinItemState {}
declare class SP$RecycleBinItemState__firstStageRecycleBin
  mixins SP$RecycleBinItemState {}
declare class SP$RecycleBinItemState__secondStageRecycleBin
  mixins SP$RecycleBinItemState {}

declare class SP$RecycleBinItemType {
  constructor(...args: empty): mixed;
  static +none: Class<SP$RecycleBinItemType__none> &
    SP$RecycleBinItemType__none &
    0; // 0
  static +file: Class<SP$RecycleBinItemType__file> &
    SP$RecycleBinItemType__file &
    1; // 1
  static +fileVersion: Class<SP$RecycleBinItemType__fileVersion> &
    SP$RecycleBinItemType__fileVersion &
    2; // 2
  static +listItem: Class<SP$RecycleBinItemType__listItem> &
    SP$RecycleBinItemType__listItem &
    3; // 3
  static +list: Class<SP$RecycleBinItemType__list> &
    SP$RecycleBinItemType__list &
    4; // 4
  static +folder: Class<SP$RecycleBinItemType__folder> &
    SP$RecycleBinItemType__folder &
    5; // 5
  static +folderWithLists: Class<SP$RecycleBinItemType__folderWithLists> &
    SP$RecycleBinItemType__folderWithLists &
    6; // 6
  static +attachment: Class<SP$RecycleBinItemType__attachment> &
    SP$RecycleBinItemType__attachment &
    7; // 7
  static +listItemVersion: Class<SP$RecycleBinItemType__listItemVersion> &
    SP$RecycleBinItemType__listItemVersion &
    8; // 8
  static +cascadeParent: Class<SP$RecycleBinItemType__cascadeParent> &
    SP$RecycleBinItemType__cascadeParent &
    9; // 9
  static +web: Class<SP$RecycleBinItemType__web> &
    SP$RecycleBinItemType__web &
    10; // 10
}
...
declare class SP$RecycleBinItemType__folderWithLists
  mixins SP$RecycleBinItemType {}
declare class SP$RecycleBinItemType__attachment mixins SP$RecycleBinItemType {}
declare class SP$RecycleBinItemType__listItemVersion
  mixins SP$RecycleBinItemType {}
declare class SP$RecycleBinItemType__cascadeParent
  mixins SP$RecycleBinItemType {}
...
declare class SP$RelationshipDeleteBehaviorType {
  constructor(...args: empty): mixed;
  static +none: Class<SP$RelationshipDeleteBehaviorType__none> &
    SP$RelationshipDeleteBehaviorType__none &
    0; // 0
  static +cascade: Class<SP$RelationshipDeleteBehaviorType__cascade> &
    SP$RelationshipDeleteBehaviorType__cascade &
    1; // 1
  static +restrict: Class<SP$RelationshipDeleteBehaviorType__restrict> &
    SP$RelationshipDeleteBehaviorType__restrict &
    2; // 2
}

declare class SP$RelationshipDeleteBehaviorType__none
  mixins SP$RelationshipDeleteBehaviorType {}
declare class SP$RelationshipDeleteBehaviorType__cascade
  mixins SP$RelationshipDeleteBehaviorType {}
declare class SP$RelationshipDeleteBehaviorType__restrict
  mixins SP$RelationshipDeleteBehaviorType {}
...
declare class SP$RoleAssignment mixins SP$SP$ClientObject {
  ...
  importRoleDefinitionBindings(
    roleDefinitionBindings: SP$SP$RoleDefinitionBindingCollection
  ): void;
  update(): void;
  deleteObject(): void;
}
...
declare type SP$RoleAssignmentCollection = {
  ...
  add(
    ...
    roleBindings: SP$SP$RoleDefinitionBindingCollection
  ): SP$SP$RoleAssignment
...
declare class SP$RoleDefinitionBindingCollection
  mixins SP$SP$ClientObjectCollection<SP$RoleDefinition> {
  constructor(context: SP$SP$ClientRuntimeContext): this;
  ...
  static newObject(
    context: SP$SP$ClientRuntimeContext
  ): SP$SP$RoleDefinitionBindingCollection;
}
...
declare type SP$RoleDefinitionCollection = {
  ...
  add(
    parameters: SP$SP$RoleDefinitionCreationInformation
  ): SP$SP$RoleDefinition,
...
declare class SP$RoleType {
  ...
  static +contributor: Class<SP$RoleType__contributor> &
    SP$RoleType__contributor &
    3; // 3
  static +webDesigner: Class<SP$RoleType__webDesigner> &
    SP$RoleType__webDesigner &
    4; // 4
  static +administrator: Class<SP$RoleType__administrator> &
    SP$RoleType__administrator &
    5; // 5
...
declare class SP$ServerSettings {
  static getAlternateUrls(
    context: SP$SP$ClientRuntimeContext
  ): SP$SP$ClientObjectList<SP$SP$AlternateUrl>;
...
declare class SP$Site mixins SP$SP$ClientObject {
  ...
  runHealthCheck(
    ...
    bRepair: boolean,
    bRunAlways: boolean
  ): SP$SiteHealth.SiteHealth$SiteHealthSummary;
...
declare class SP$TemplateFileType {
  constructor(...args: empty): mixed;
  static +standardPage: Class<SP$TemplateFileType__standardPage> &
    SP$TemplateFileType__standardPage &
    0; // 0
  static +wikiPage: Class<SP$TemplateFileType__wikiPage> &
    SP$TemplateFileType__wikiPage &
    1; // 1
  static +formPage: Class<SP$TemplateFileType__formPage> &
    SP$TemplateFileType__formPage &
    2; // 2
}
...
declare class SP$UpgradeStatus {
  ...
  static +inProgress: Class<SP$UpgradeStatus__inProgress> &
    SP$UpgradeStatus__inProgress &
    1; // 1
  static +failed: Class<SP$UpgradeStatus__failed> &
    SP$UpgradeStatus__failed &
    2; // 2
  static +completed: Class<SP$UpgradeStatus__completed> &
    SP$UpgradeStatus__completed &
    3; // 3
}
...
declare class SP$UpgradeType {
  constructor(...args: empty): mixed;
  static +buildUpgrade: Class<SP$UpgradeType__buildUpgrade> &
    SP$UpgradeType__buildUpgrade &
    0; // 0
  static +versionUpgrade: Class<SP$UpgradeType__versionUpgrade> &
    SP$UpgradeType__versionUpgrade &
    1; // 1
}
...
declare class SP$UrlFieldFormatType {
  constructor(...args: empty): mixed;
  static +hyperlink: Class<SP$UrlFieldFormatType__hyperlink> &
    SP$UrlFieldFormatType__hyperlink &
    0; // 0
  static +image: Class<SP$UrlFieldFormatType__image> &
    SP$UrlFieldFormatType__image &
    1; // 1
}
...
declare class SP$UrlZone {
  constructor(...args: empty): mixed;
  static +defaultZone: Class<SP$UrlZone__defaultZone> &
    SP$UrlZone__defaultZone &
    0; // 0
...
declare class SP$UserCustomActionRegistrationType {
  constructor(...args: empty): mixed;
  static +none: Class<SP$UserCustomActionRegistrationType__none> &
    SP$UserCustomActionRegistrationType__none &
    0; // 0
  static +list: Class<SP$UserCustomActionRegistrationType__list> &
    SP$UserCustomActionRegistrationType__list &
    1; // 1
  static +contentType: Class<SP$UserCustomActionRegistrationType__contentType> &
    SP$UserCustomActionRegistrationType__contentType &
    2; // 2
  static +progId: Class<SP$UserCustomActionRegistrationType__progId> &
    SP$UserCustomActionRegistrationType__progId &
    3; // 3
  static +fileType: Class<SP$UserCustomActionRegistrationType__fileType> &
    SP$UserCustomActionRegistrationType__fileType &
    4; // 4
}

declare class SP$UserCustomActionRegistrationType__none
  mixins SP$UserCustomActionRegistrationType {}
declare class SP$UserCustomActionRegistrationType__list
  mixins SP$UserCustomActionRegistrationType {}
declare class SP$UserCustomActionRegistrationType__contentType
  mixins SP$UserCustomActionRegistrationType {}
declare class SP$UserCustomActionRegistrationType__progId
  mixins SP$UserCustomActionRegistrationType {}
declare class SP$UserCustomActionRegistrationType__fileType
  mixins SP$UserCustomActionRegistrationType {}

declare class SP$UserCustomActionScope {
  constructor(...args: empty): mixed;
  static +unknown: Class<SP$UserCustomActionScope__unknown> &
    SP$UserCustomActionScope__unknown &
    0; // 0
  static +site: Class<SP$UserCustomActionScope__site> &
    SP$UserCustomActionScope__site &
    1; // 1
  static +web: Class<SP$UserCustomActionScope__web> &
    SP$UserCustomActionScope__web &
    2; // 2
  static +list: Class<SP$UserCustomActionScope__list> &
    SP$UserCustomActionScope__list &
    3; // 3
}

declare class SP$UserCustomActionScope__unknown
  mixins SP$UserCustomActionScope {}
...
declare class SP$ViewScope {
  constructor(...args: empty): mixed;
  static +defaultValue: Class<SP$ViewScope__defaultValue> &
    SP$ViewScope__defaultValue &
    0; // 0
  static +recursive: Class<SP$ViewScope__recursive> &
    SP$ViewScope__recursive &
    1; // 1
  static +recursiveAll: Class<SP$ViewScope__recursiveAll> &
    SP$ViewScope__recursiveAll &
    2; // 2
  static +filesOnly: Class<SP$ViewScope__filesOnly> &
    SP$ViewScope__filesOnly &
    3; // 3
}
...
declare class SP$ViewType {
  ...
  static +recurrence: Class<SP$ViewType__recurrence> &
    SP$ViewType__recurrence &
    4; // 4
...
declare class SP$Web mixins SP$SP$SecurableObject {
  ...
  get_workflowAssociations(): SP$Workflow.Workflow$WorkflowAssociationCollection;
  get_workflowTemplates(): SP$Workflow.Workflow$WorkflowTemplateCollection;
  doesUserHavePermissions(
    permissionMask: SP$SP$BasePermissions
  ): SP$SP$BooleanResult;
  getUserEffectivePermissions(userName: string): SP$SP$BasePermissions;
  mapToIcon(
    fileName: string,
    progId: string,
    size: SP$Utilities.Utilities$IconSize
  ): SP$SP$StringResult;
  registerPushNotificationSubscriber(
    deviceAppInstanceId: SP$SP$Guid,
    serviceToken: string
  ): SP$SP$PushNotificationSubscriber;
  unregisterPushNotificationSubscriber(deviceAppInstanceId: SP$SP$Guid): void;
  getPushNotificationSubscribersByArgs(
    customArgs: string
  ): SP$SP$PushNotificationSubscriberCollection;
  ...
  getEntity(
    namespace: string,
    name: string
  ): SP$BusinessData.BusinessData$Entity;
  getAppBdcCatalogForAppInstance(
    appInstanceId: SP$SP$Guid
  ): SP$BusinessData.BusinessData$AppBdcCatalog;
  getAppBdcCatalog(): SP$BusinessData.BusinessData$AppBdcCatalog;
...
declare class SP$WebProxy {
  static invoke(
    context: SP$SP$ClientRuntimeContext,
    requestInfo: SP$SP$WebRequestInfo
  ): SP$SP$WebResponseInfo;
}
...
declare class SP$RequestExecutorErrors {
  constructor(...args: empty): mixed;
  static +requestAbortedOrTimedout: Class<SP$RequestExecutorErrors__requestAbortedOrTimedout> &
    SP$RequestExecutorErrors__requestAbortedOrTimedout &
    0; // 0
  static +unexpectedResponse: Class<SP$RequestExecutorErrors__unexpectedResponse> &
    SP$RequestExecutorErrors__unexpectedResponse &
    1; // 1
  static +httpError: Class<SP$RequestExecutorErrors__httpError> &
    SP$RequestExecutorErrors__httpError &
    2; // 2
  static +noAppWeb: Class<SP$RequestExecutorErrors__noAppWeb> &
    SP$RequestExecutorErrors__noAppWeb &
    3; // 3
  static +domainDoesNotMatch: Class<SP$RequestExecutorErrors__domainDoesNotMatch> &
    SP$RequestExecutorErrors__domainDoesNotMatch &
    4; // 4
  static +noTrustedOrigins: Class<SP$RequestExecutorErrors__noTrustedOrigins> &
    SP$RequestExecutorErrors__noTrustedOrigins &
    5; // 5
  static +iFrameLoadError: Class<SP$RequestExecutorErrors__iFrameLoadError> &
    SP$RequestExecutorErrors__iFrameLoadError &
    6; // 6
}

declare class SP$RequestExecutorErrors__requestAbortedOrTimedout
  mixins SP$RequestExecutorErrors {}
declare class SP$RequestExecutorErrors__unexpectedResponse
  mixins SP$RequestExecutorErrors {}
declare class SP$RequestExecutorErrors__httpError
  mixins SP$RequestExecutorErrors {}
declare class SP$RequestExecutorErrors__noAppWeb
  mixins SP$RequestExecutorErrors {}
declare class SP$RequestExecutorErrors__domainDoesNotMatch
  mixins SP$RequestExecutorErrors {}
declare class SP$RequestExecutorErrors__noTrustedOrigins
  mixins SP$RequestExecutorErrors {}
declare class SP$RequestExecutorErrors__iFrameLoadError
  mixins SP$RequestExecutorErrors {}
...
declare class SP$ProxyWebRequestExecutorFactory
  mixins SP$SP$IWebRequestExecutorFactory {
  constructor(url: string, options?: any): this;
...
declare class SP$ListLevelPermissionMask {
  constructor(...args: empty): mixed;
  static +viewListItems: Class<SP$ListLevelPermissionMask__viewListItems> &
    SP$ListLevelPermissionMask__viewListItems &
    0; // 0
  static +insertListItems: Class<SP$ListLevelPermissionMask__insertListItems> &
    SP$ListLevelPermissionMask__insertListItems &
    1; // 1
  static +editListItems: Class<SP$ListLevelPermissionMask__editListItems> &
    SP$ListLevelPermissionMask__editListItems &
    2; // 2
  static +deleteListItems: Class<SP$ListLevelPermissionMask__deleteListItems> &
    SP$ListLevelPermissionMask__deleteListItems &
    3; // 3
  static +approveItems: Class<SP$ListLevelPermissionMask__approveItems> &
    SP$ListLevelPermissionMask__approveItems &
    4; // 4
  static +openItems: Class<SP$ListLevelPermissionMask__openItems> &
    SP$ListLevelPermissionMask__openItems &
    5; // 5
  static +viewVersions: Class<SP$ListLevelPermissionMask__viewVersions> &
    SP$ListLevelPermissionMask__viewVersions &
    6; // 6
  static +deleteVersions: Class<SP$ListLevelPermissionMask__deleteVersions> &
    SP$ListLevelPermissionMask__deleteVersions &
    7; // 7
  static +breakCheckout: Class<SP$ListLevelPermissionMask__breakCheckout> &
    SP$ListLevelPermissionMask__breakCheckout &
    8; // 8
  static +managePersonalViews: Class<SP$ListLevelPermissionMask__managePersonalViews> &
    SP$ListLevelPermissionMask__managePersonalViews &
    9; // 9
  static +manageLists: Class<SP$ListLevelPermissionMask__manageLists> &
    SP$ListLevelPermissionMask__manageLists &
    10; // 10
}

declare class SP$ListLevelPermissionMask__viewListItems
  mixins SP$ListLevelPermissionMask {}
declare class SP$ListLevelPermissionMask__insertListItems
  mixins SP$ListLevelPermissionMask {}
declare class SP$ListLevelPermissionMask__editListItems
  mixins SP$ListLevelPermissionMask {}
declare class SP$ListLevelPermissionMask__deleteListItems
  mixins SP$ListLevelPermissionMask {}
declare class SP$ListLevelPermissionMask__approveItems
  mixins SP$ListLevelPermissionMask {}
declare class SP$ListLevelPermissionMask__openItems
  mixins SP$ListLevelPermissionMask {}
declare class SP$ListLevelPermissionMask__viewVersions
  mixins SP$ListLevelPermissionMask {}
declare class SP$ListLevelPermissionMask__deleteVersions
  mixins SP$ListLevelPermissionMask {}
declare class SP$ListLevelPermissionMask__breakCheckout
  mixins SP$ListLevelPermissionMask {}
declare class SP$ListLevelPermissionMask__managePersonalViews
  mixins SP$ListLevelPermissionMask {}
declare class SP$ListLevelPermissionMask__manageLists
  mixins SP$ListLevelPermissionMask {}
...
declare class SP$ScriptHelpers {
  static disableWebpartSelection(
    context: SPClientTemplates$SPClientTemplates$RenderContext
  ): void;
  ...
  static getFieldFromSchema(
    ...
    fieldName: string
  ): SPClientTemplates$SPClientTemplates$FieldSchema;
...
declare class Utilities$Set {
   ...
   */
  AddArray(array: any[]): SP$Utilities.Utilities$Set;
   ...
   */
  Clear(): SP$Utilities.Utilities$Set;
...
declare class Utilities$Utility {
  ...
  static createWikiPageInContextWeb(
    context: SP$SP$ClientRuntimeContext,
    parameters: SP$Utilities.Utilities$WikiPageCreationInformation
  ): SP$SP$File;
  static localizeWebPartGallery(
    context: SP$SP$ClientRuntimeContext,
    items: SP$SP$ListItemCollection
  ): SP$SP$ClientObjectList<SP$SP$ListItem>;
  static getAppLicenseInformation(
    context: SP$SP$ClientRuntimeContext,
    productId: SP$SP$Guid
  ): SP$SP$AppLicenseCollection;
  ...
  static searchPrincipals(
    ...
    web: SP$SP$Web,
    input: string,
    scopes: SP$Utilities.Utilities$PrincipalType,
    sources: SP$Utilities.Utilities$PrincipalSource,
    usersContainer: SP$SP$UserCollection,
    maxCount: number
  ): SP$Utilities.Utilities$PrincipalInfo[];
  ...
  static formatDateTime(
    ...
    web: SP$SP$Web,
    datetime: Date,
    format: SP$Utilities.Utilities$DateTimeFormat
  ): SP$SP$StringResult;
...
declare class Utilities$DateTimeFormat {
  constructor(...args: empty): mixed;
  static +dateTime: Class<Utilities$DateTimeFormat__dateTime> &
    Utilities$DateTimeFormat__dateTime &
    0; // 0
  static +dateOnly: Class<Utilities$DateTimeFormat__dateOnly> &
    Utilities$DateTimeFormat__dateOnly &
    1; // 1
  static +timeOnly: Class<Utilities$DateTimeFormat__timeOnly> &
    Utilities$DateTimeFormat__timeOnly &
    2; // 2
  static +iSO8601: Class<Utilities$DateTimeFormat__iSO8601> &
    Utilities$DateTimeFormat__iSO8601 &
    3; // 3
  static +monthDayOnly: Class<Utilities$DateTimeFormat__monthDayOnly> &
    Utilities$DateTimeFormat__monthDayOnly &
    4; // 4
  static +monthYearOnly: Class<Utilities$DateTimeFormat__monthYearOnly> &
    Utilities$DateTimeFormat__monthYearOnly &
    5; // 5
  static +longDate: Class<Utilities$DateTimeFormat__longDate> &
    Utilities$DateTimeFormat__longDate &
    6; // 6
  static +unknownFormat: Class<Utilities$DateTimeFormat__unknownFormat> &
    Utilities$DateTimeFormat__unknownFormat &
    7; // 7
}

declare class Utilities$DateTimeFormat__dateTime
  mixins Utilities$DateTimeFormat {}
declare class Utilities$DateTimeFormat__dateOnly
  mixins Utilities$DateTimeFormat {}
declare class Utilities$DateTimeFormat__timeOnly
  mixins Utilities$DateTimeFormat {}
declare class Utilities$DateTimeFormat__iSO8601
  mixins Utilities$DateTimeFormat {}
declare class Utilities$DateTimeFormat__monthDayOnly
  mixins Utilities$DateTimeFormat {}
declare class Utilities$DateTimeFormat__monthYearOnly
  mixins Utilities$DateTimeFormat {}
declare class Utilities$DateTimeFormat__longDate
  mixins Utilities$DateTimeFormat {}
declare class Utilities$DateTimeFormat__unknownFormat
  mixins Utilities$DateTimeFormat {}

declare class Utilities$EmailProperties mixins SP$SP$ClientValueObject {
...
declare class Utilities$IconSize {
  constructor(...args: empty): mixed;
  static +size16: Class<Utilities$IconSize__size16> &
    Utilities$IconSize__size16 &
    0; // 0
  static +size32: Class<Utilities$IconSize__size32> &
    Utilities$IconSize__size32 &
    1; // 1
  static +size256: Class<Utilities$IconSize__size256> &
    Utilities$IconSize__size256 &
    2; // 2
}

declare class Utilities$IconSize__size16 mixins Utilities$IconSize {}
declare class Utilities$IconSize__size32 mixins Utilities$IconSize {}
declare class Utilities$IconSize__size256 mixins Utilities$IconSize {}

declare class Utilities$LogAppErrorResult {
  constructor(...args: empty): mixed;
  static +success: Class<Utilities$LogAppErrorResult__success> &
    Utilities$LogAppErrorResult__success &
    0; // 0
  static +errorsThrottled: Class<Utilities$LogAppErrorResult__errorsThrottled> &
    Utilities$LogAppErrorResult__errorsThrottled &
    1; // 1
  static +accessDenied: Class<Utilities$LogAppErrorResult__accessDenied> &
    Utilities$LogAppErrorResult__accessDenied &
    2; // 2
}

declare class Utilities$LogAppErrorResult__success
  mixins Utilities$LogAppErrorResult {}
declare class Utilities$LogAppErrorResult__errorsThrottled
  mixins Utilities$LogAppErrorResult {}
declare class Utilities$LogAppErrorResult__accessDenied
  mixins Utilities$LogAppErrorResult {}

declare class Utilities$PrincipalInfo mixins SP$SP$ClientValueObject {
  get_department(): string;
  get_displayName(): string;
  get_email(): string;
  get_jobTitle(): string;
...
declare class Utilities$PrincipalSource {
  constructor(...args: empty): mixed;
  static +none: Class<Utilities$PrincipalSource__none> &
    Utilities$PrincipalSource__none &
    0; // 0
  static +userInfoList: Class<Utilities$PrincipalSource__userInfoList> &
    Utilities$PrincipalSource__userInfoList &
    1; // 1
  static +windows: Class<Utilities$PrincipalSource__windows> &
    Utilities$PrincipalSource__windows &
    2; // 2
  static +membershipProvider: Class<Utilities$PrincipalSource__membershipProvider> &
    Utilities$PrincipalSource__membershipProvider &
    3; // 3
  static +roleProvider: Class<Utilities$PrincipalSource__roleProvider> &
    Utilities$PrincipalSource__roleProvider &
    4; // 4
  static +all: Class<Utilities$PrincipalSource__all> &
    Utilities$PrincipalSource__all &
    5; // 5
}

declare class Utilities$PrincipalSource__none
  mixins Utilities$PrincipalSource {}
declare class Utilities$PrincipalSource__userInfoList
  mixins Utilities$PrincipalSource {}
declare class Utilities$PrincipalSource__windows
  mixins Utilities$PrincipalSource {}
declare class Utilities$PrincipalSource__membershipProvider
  mixins Utilities$PrincipalSource {}
declare class Utilities$PrincipalSource__roleProvider
  mixins Utilities$PrincipalSource {}
declare class Utilities$PrincipalSource__all mixins Utilities$PrincipalSource {}

declare class Utilities$PrincipalType {
  constructor(...args: empty): mixed;
  static +none: Class<Utilities$PrincipalType__none> &
    Utilities$PrincipalType__none &
    0; // 0
  static +user: Class<Utilities$PrincipalType__user> &
    Utilities$PrincipalType__user &
    1; // 1
  static +distributionList: Class<Utilities$PrincipalType__distributionList> &
    Utilities$PrincipalType__distributionList &
    2; // 2
  static +securityGroup: Class<Utilities$PrincipalType__securityGroup> &
    Utilities$PrincipalType__securityGroup &
    3; // 3
  static +sharePointGroup: Class<Utilities$PrincipalType__sharePointGroup> &
    Utilities$PrincipalType__sharePointGroup &
    4; // 4
  static +all: Class<Utilities$PrincipalType__all> &
    Utilities$PrincipalType__all &
    5; // 5
}

declare class Utilities$PrincipalType__none mixins Utilities$PrincipalType {}
declare class Utilities$PrincipalType__user mixins Utilities$PrincipalType {}
declare class Utilities$PrincipalType__distributionList
  mixins Utilities$PrincipalType {}
declare class Utilities$PrincipalType__securityGroup
  mixins Utilities$PrincipalType {}
declare class Utilities$PrincipalType__sharePointGroup
  mixins Utilities$PrincipalType {}
declare class Utilities$PrincipalType__all mixins Utilities$PrincipalType {}

declare class Utilities$SPWOPIFrameAction {
  constructor(...args: empty): mixed;
  static +view: Class<Utilities$SPWOPIFrameAction__view> &
    Utilities$SPWOPIFrameAction__view &
    0; // 0
  static +edit: Class<Utilities$SPWOPIFrameAction__edit> &
    Utilities$SPWOPIFrameAction__edit &
    1; // 1
  static +mobileView: Class<Utilities$SPWOPIFrameAction__mobileView> &
    Utilities$SPWOPIFrameAction__mobileView &
    2; // 2
  static +interactivePreview: Class<Utilities$SPWOPIFrameAction__interactivePreview> &
    Utilities$SPWOPIFrameAction__interactivePreview &
    3; // 3
}

declare class Utilities$SPWOPIFrameAction__view
  mixins Utilities$SPWOPIFrameAction {}
declare class Utilities$SPWOPIFrameAction__edit
  mixins Utilities$SPWOPIFrameAction {}
declare class Utilities$SPWOPIFrameAction__mobileView
  mixins Utilities$SPWOPIFrameAction {}
declare class Utilities$SPWOPIFrameAction__interactivePreview
  mixins Utilities$SPWOPIFrameAction {}

declare class Utilities$WikiPageCreationInformation
  mixins SP$SP$ClientValueObject {
  get_serverRelativeUrl(): string;
  set_serverRelativeUrl(value: string): void;
...
declare class Utilities$DateUtility {
  static isLeapYear(year: number): boolean;
  static dateToJulianDay(year: number, month: number, day: number): number;
  static julianDayToDate(
    julianDay: number
  ): SP$DateTimeUtil.DateTimeUtil$SimpleDate;
  static daysInMonth(year: number, month: number): number;
}

declare class Utilities$HttpUtility {
  /**
...
declare class Utilities$UrlBuilder {
...
declare class Utilities$LocUtility {
...
declare class Utilities$VersionUtility {
  static get_layoutsLatestVersionRelativeUrl(): string;
  static get_layoutsLatestVersionUrl(): string;
  static getLayoutsPageUrl(pageName: string): string;
  static getImageUrl(imageName: string): string;
...
declare class PropertyType$MultiValuePropType
  mixins JsGrid$IMultiValuePropertyType {
  SPAnimation$ID: string;
  BeginValidateNormalizeConvert(
    recordKey: number,
    fieldKey: string,
...
declare class JsGridControl$Parameters {
  tableCache: SP$JsGrid.JsGrid$TableCache;
  name: any;
  bNotificationsEnabled: boolean;
  styleManager: JsGrid$IStyleManager;
  minHeaderHeight: number;
  minRowHeight: number;
  commandMgr: SP$JsGrid.JsGrid$CommandManager;
  enabledRowHeaderAutoStates: SP$Utilities.Utilities$Set;
...
declare class JsGridControl$TableViewParameters {
  paneLayout: SP$JsGrid.JsGrid$PaneLayout;
  defaultEditMode: SP$JsGrid.JsGrid$EditMode;
  allowedSelectionTypes: SP$JsGrid.JsGrid$SelectionTypeFlags;
...
declare class JsGridControl$RowViewParameters {
  hierarchyMode: SP$JsGrid.JsGrid$HierarchyMode;
  view: any;
  topViewIdx: number;
  groupingLevel: any;
...
declare class EventArgs$CellEditCompleted mixins JsGrid$IEventArgs {
  constructor(
    recordKey: number,
    fieldKey: string,
    changeKey: JsGrid$JsGrid$IChangeKey,
    bCancelled: boolean
  ): this;
  recordKey: number;
  fieldKey: string;
...
declare class EventArgs$Click mixins JsGrid$IEventArgs {
  constructor(
    ...
    context: JsGrid$JsGrid$ClickContext,
    recordKey: number,
    fieldKey: string
  ): this;
  eventInfo: Sys.UI.DomEvent;
...
declare class EventArgs$PropertyChanged mixins JsGrid$IEventArgs {
  constructor(
    recordKey: number,
    fieldKey: string,
    oldProp: SP$JsGrid.Internal.Internal$PropertyUpdate,
    newProp: SP$JsGrid.Internal.Internal$PropertyUpdate,
    propType: SP$JsGrid.JsGrid$IPropertyType,
    changeKey: SP$JsGrid.JsGrid$IChangeKey,
    validationState: SP$JsGrid.JsGrid$ValidationState
  ): this;
  recordKey: number;
  fieldKey: string;
  oldProp: SP$JsGrid.Internal.Internal$PropertyUpdate;
...
declare class EventArgs$RecordChecked mixins JsGrid$IEventArgs {
  constructor(
    recordKeySet: SP$Utilities.Utilities$Set,
    bChecked: boolean
  ): this;
  recordKeySet: SP$Utilities.Utilities$Set;
  bChecked: boolean;
...
declare class EventArgs$PendingChangeKeyInitiallyComplete
  mixins JsGrid$IEventArgs {
  constructor(changeKey: JsGrid$JsGrid$IChangeKey): this;
  changeKey: JsGrid$JsGrid$IChangeKey;
}
...
declare class EventArgs$OnRecordsReordered mixins JsGrid$IEventArgs {
  constructor(recordKeys: string[], changeKey: JsGrid$JsGrid$IChangeKey): this;
...
declare class JsGrid$TextDirection {
  constructor(...args: empty): mixed;
  static +Default: Class<JsGrid$TextDirection__Default> &
    JsGrid$TextDirection__Default &
    0; // 0
  static +RightToLeft: Class<JsGrid$TextDirection__RightToLeft> &
    JsGrid$TextDirection__RightToLeft &
    1; // 1
  static +LeftToRight: Class<JsGrid$TextDirection__LeftToRight> &
    JsGrid$TextDirection__LeftToRight &
    2; // 2
}
...
declare class JsGrid$PaneId {
  constructor(...args: empty): mixed;
  static +MainGrid: Class<JsGrid$PaneId__MainGrid> &
    JsGrid$PaneId__MainGrid &
    0; // 0
  static +PivotedGrid: Class<JsGrid$PaneId__PivotedGrid> &
    JsGrid$PaneId__PivotedGrid &
    1; // 1
...
declare class JsGrid$PaneLayout {
  constructor(...args: empty): mixed;
  static +GridOnly: Class<JsGrid$PaneLayout__GridOnly> &
    JsGrid$PaneLayout__GridOnly &
    0; // 0
  static +GridAndGantt: Class<JsGrid$PaneLayout__GridAndGantt> &
    JsGrid$PaneLayout__GridAndGantt &
    1; // 1
  static +GridAndPivotedGrid: Class<JsGrid$PaneLayout__GridAndPivotedGrid> &
    JsGrid$PaneLayout__GridAndPivotedGrid &
    2; // 2
}
...
declare class JsGrid$EditMode {
  constructor(...args: empty): mixed;
  static +ReadOnly: Class<JsGrid$EditMode__ReadOnly> &
    JsGrid$EditMode__ReadOnly &
    0; // 0
  static +ReadWrite: Class<JsGrid$EditMode__ReadWrite> &
    JsGrid$EditMode__ReadWrite &
    1; // 1
  static +ReadOnlyDefer: Class<JsGrid$EditMode__ReadOnlyDefer> &
    JsGrid$EditMode__ReadOnlyDefer &
    2; // 2
  static +ReadWriteDefer: Class<JsGrid$EditMode__ReadWriteDefer> &
    JsGrid$EditMode__ReadWriteDefer &
    3; // 3
...
declare class JsGrid$GanttDrawBarFlags {
  constructor(...args: empty): mixed;
  static +LeftLink: Class<JsGrid$GanttDrawBarFlags__LeftLink> &
    JsGrid$GanttDrawBarFlags__LeftLink &
    0; // 0
  static +RightLink: Class<JsGrid$GanttDrawBarFlags__RightLink> &
    JsGrid$GanttDrawBarFlags__RightLink &
    1; // 1
}

declare class JsGrid$GanttDrawBarFlags__LeftLink
  mixins JsGrid$GanttDrawBarFlags {}
declare class JsGrid$GanttDrawBarFlags__RightLink
  mixins JsGrid$GanttDrawBarFlags {}

declare class JsGrid$GanttBarDateType {
  constructor(...args: empty): mixed;
  static +Start: Class<JsGrid$GanttBarDateType__Start> &
    JsGrid$GanttBarDateType__Start &
    0; // 0
  static +End: Class<JsGrid$GanttBarDateType__End> &
    JsGrid$GanttBarDateType__End &
    1; // 1
}
...
declare class JsGrid$ValidationState {
  constructor(...args: empty): mixed;
  static +Valid: Class<JsGrid$ValidationState__Valid> &
    JsGrid$ValidationState__Valid &
    0; // 0
  static +Pending: Class<JsGrid$ValidationState__Pending> &
    JsGrid$ValidationState__Pending &
    1; // 1
  static +Invalid: Class<JsGrid$ValidationState__Invalid> &
    JsGrid$ValidationState__Invalid &
    2; // 2
}
...
declare class JsGrid$HierarchyMode {
  constructor(...args: empty): mixed;
  static +None: Class<JsGrid$HierarchyMode__None> &
    JsGrid$HierarchyMode__None &
    0; // 0
  static +Standard: Class<JsGrid$HierarchyMode__Standard> &
    JsGrid$HierarchyMode__Standard &
    1; // 1
  static +Grouping: Class<JsGrid$HierarchyMode__Grouping> &
    JsGrid$HierarchyMode__Grouping &
    2; // 2
}
...
declare class JsGrid$EditActorWriteType {
  constructor(...args: empty): mixed;
  static +Both: Class<JsGrid$EditActorWriteType__Both> &
    JsGrid$EditActorWriteType__Both &
    0; // 0
  static +LocalizedOnly: Class<JsGrid$EditActorWriteType__LocalizedOnly> &
    JsGrid$EditActorWriteType__LocalizedOnly &
    1; // 1
  static +DataOnly: Class<JsGrid$EditActorWriteType__DataOnly> &
    JsGrid$EditActorWriteType__DataOnly &
    2; // 2
  static +Either: Class<JsGrid$EditActorWriteType__Either> &
    JsGrid$EditActorWriteType__Either &
    3; // 3
}

declare class JsGrid$EditActorWriteType__Both
  mixins JsGrid$EditActorWriteType {}
declare class JsGrid$EditActorWriteType__LocalizedOnly
  mixins JsGrid$EditActorWriteType {}
declare class JsGrid$EditActorWriteType__DataOnly
  mixins JsGrid$EditActorWriteType {}
declare class JsGrid$EditActorWriteType__Either
  mixins JsGrid$EditActorWriteType {}

declare class JsGrid$EditActorReadType {
  constructor(...args: empty): mixed;
  static +Both: Class<JsGrid$EditActorReadType__Both> &
    JsGrid$EditActorReadType__Both &
    0; // 0
  static +LocalizedOnly: Class<JsGrid$EditActorReadType__LocalizedOnly> &
    JsGrid$EditActorReadType__LocalizedOnly &
    1; // 1
  static +DataOnly: Class<JsGrid$EditActorReadType__DataOnly> &
    JsGrid$EditActorReadType__DataOnly &
    2; // 2
}

declare class JsGrid$EditActorReadType__Both mixins JsGrid$EditActorReadType {}
declare class JsGrid$EditActorReadType__LocalizedOnly
  mixins JsGrid$EditActorReadType {}
declare class JsGrid$EditActorReadType__DataOnly
  mixins JsGrid$EditActorReadType {}

declare class JsGrid$EditActorUpdateType {
  constructor(...args: empty): mixed;
  static +Committed: Class<JsGrid$EditActorUpdateType__Committed> &
    JsGrid$EditActorUpdateType__Committed &
    0; // 0
  static +Uncommitted: Class<JsGrid$EditActorUpdateType__Uncommitted> &
    JsGrid$EditActorUpdateType__Uncommitted &
    1; // 1
}

declare class JsGrid$EditActorUpdateType__Committed
  mixins JsGrid$EditActorUpdateType {}
declare class JsGrid$EditActorUpdateType__Uncommitted
  mixins JsGrid$EditActorUpdateType {}

declare class JsGrid$SortMode {
  constructor(...args: empty): mixed;
  static +Ascending: Class<JsGrid$SortMode__Ascending> &
    JsGrid$SortMode__Ascending &
    0; // 0
  static +Descending: Class<JsGrid$SortMode__Descending> &
    JsGrid$SortMode__Descending &
    1; // 1
...
declare class JsGrid$RowHeaderStatePriorities {
  constructor(...args: empty): mixed;
  static +Dirty: Class<JsGrid$RowHeaderStatePriorities__Dirty> &
    JsGrid$RowHeaderStatePriorities__Dirty &
    0; // 0
  static +Transfer: Class<JsGrid$RowHeaderStatePriorities__Transfer> &
    JsGrid$RowHeaderStatePriorities__Transfer &
    1; // 1
  static +CellError: Class<JsGrid$RowHeaderStatePriorities__CellError> &
    JsGrid$RowHeaderStatePriorities__CellError &
    2; // 2
  static +Conflict: Class<JsGrid$RowHeaderStatePriorities__Conflict> &
    JsGrid$RowHeaderStatePriorities__Conflict &
    3; // 3
  static +RowError: Class<JsGrid$RowHeaderStatePriorities__RowError> &
    JsGrid$RowHeaderStatePriorities__RowError &
    4; // 4
  static +NewRow: Class<JsGrid$RowHeaderStatePriorities__NewRow> &
    JsGrid$RowHeaderStatePriorities__NewRow &
    5; // 5
}

declare class JsGrid$RowHeaderStatePriorities__Dirty
  mixins JsGrid$RowHeaderStatePriorities {}
declare class JsGrid$RowHeaderStatePriorities__Transfer
  mixins JsGrid$RowHeaderStatePriorities {}
declare class JsGrid$RowHeaderStatePriorities__CellError
  mixins JsGrid$RowHeaderStatePriorities {}
declare class JsGrid$RowHeaderStatePriorities__Conflict
  mixins JsGrid$RowHeaderStatePriorities {}
declare class JsGrid$RowHeaderStatePriorities__RowError
  mixins JsGrid$RowHeaderStatePriorities {}
declare class JsGrid$RowHeaderStatePriorities__NewRow
  mixins JsGrid$RowHeaderStatePriorities {}

declare class JsGrid$UpdateSerializeMode {
  constructor(...args: empty): mixed;
  static +Cancel: Class<JsGrid$UpdateSerializeMode__Cancel> &
    JsGrid$UpdateSerializeMode__Cancel &
    0; // 0
  static +Default: Class<JsGrid$UpdateSerializeMode__Default> &
    JsGrid$UpdateSerializeMode__Default &
    1; // 1
  static +PropDataOnly: Class<JsGrid$UpdateSerializeMode__PropDataOnly> &
    JsGrid$UpdateSerializeMode__PropDataOnly &
    2; // 2
  static +PropLocalizedOnly: Class<JsGrid$UpdateSerializeMode__PropLocalizedOnly> &
    JsGrid$UpdateSerializeMode__PropLocalizedOnly &
    3; // 3
  static +PropBoth: Class<JsGrid$UpdateSerializeMode__PropBoth> &
    JsGrid$UpdateSerializeMode__PropBoth &
    4; // 4
}

declare class JsGrid$UpdateSerializeMode__Cancel
  mixins JsGrid$UpdateSerializeMode {}
declare class JsGrid$UpdateSerializeMode__Default
  mixins JsGrid$UpdateSerializeMode {}
declare class JsGrid$UpdateSerializeMode__PropDataOnly
  mixins JsGrid$UpdateSerializeMode {}
declare class JsGrid$UpdateSerializeMode__PropLocalizedOnly
  mixins JsGrid$UpdateSerializeMode {}
declare class JsGrid$UpdateSerializeMode__PropBoth
  mixins JsGrid$UpdateSerializeMode {}

declare class JsGrid$UpdateTrackingMode {
  constructor(...args: empty): mixed;
  static +PropData: Class<JsGrid$UpdateTrackingMode__PropData> &
    JsGrid$UpdateTrackingMode__PropData &
    0; // 0
  static +PropLocalized: Class<JsGrid$UpdateTrackingMode__PropLocalized> &
    JsGrid$UpdateTrackingMode__PropLocalized &
    1; // 1
  static +PropBoth: Class<JsGrid$UpdateTrackingMode__PropBoth> &
    JsGrid$UpdateTrackingMode__PropBoth &
    2; // 2
}

declare class JsGrid$UpdateTrackingMode__PropData
  mixins JsGrid$UpdateTrackingMode {}
declare class JsGrid$UpdateTrackingMode__PropLocalized
  mixins JsGrid$UpdateTrackingMode {}
declare class JsGrid$UpdateTrackingMode__PropBoth
  mixins JsGrid$UpdateTrackingMode {}

declare class JsGrid$ReadOnlyActiveState {
  constructor(...args: empty): mixed;
  static +ReadOnlyActive: Class<JsGrid$ReadOnlyActiveState__ReadOnlyActive> &
    JsGrid$ReadOnlyActiveState__ReadOnlyActive &
    0; // 0
  static +ReadOnlyDisabled: Class<JsGrid$ReadOnlyActiveState__ReadOnlyDisabled> &
    JsGrid$ReadOnlyActiveState__ReadOnlyDisabled &
    1; // 1
}

declare class JsGrid$ReadOnlyActiveState__ReadOnlyActive
  mixins JsGrid$ReadOnlyActiveState {}
declare class JsGrid$ReadOnlyActiveState__ReadOnlyDisabled
  mixins JsGrid$ReadOnlyActiveState {}
...
declare class JsGrid$SelectionTypeFlags {
  constructor(...args: empty): mixed;
  static +MultipleCellRanges: Class<JsGrid$SelectionTypeFlags__MultipleCellRanges> &
    JsGrid$SelectionTypeFlags__MultipleCellRanges &
    0; // 0
  static +MultipleRowRanges: Class<JsGrid$SelectionTypeFlags__MultipleRowRanges> &
    JsGrid$SelectionTypeFlags__MultipleRowRanges &
    1; // 1
  static +MultipleColRanges: Class<JsGrid$SelectionTypeFlags__MultipleColRanges> &
    JsGrid$SelectionTypeFlags__MultipleColRanges &
    2; // 2
}

declare class JsGrid$SelectionTypeFlags__MultipleCellRanges
  mixins JsGrid$SelectionTypeFlags {}
declare class JsGrid$SelectionTypeFlags__MultipleRowRanges
  mixins JsGrid$SelectionTypeFlags {}
declare class JsGrid$SelectionTypeFlags__MultipleColRanges
  mixins JsGrid$SelectionTypeFlags {}
...
declare class JsGrid$JsGridControl {
   ...
   */
  ResetData(cache: SP$JsGrid.JsGrid$TableCache): void;

  /**
   * Initialize the control
   */
  Init(
    parameters: SP$JsGrid.JsGrid$JsGridControl.JsGridControl$Parameters
  ): void;
  Cleanup(): void;
   ...
   */
  GetDiffTracker(): SP$JsGrid.Internal.Internal$DiffTracker;
  ...
  AddRowHeaderState(
    recordKey: number,
    rowHeaderState: SP$JsGrid.JsGrid$RowHeaderState
  ): void;
   ...
   */
  AttachEvent(
    eventType: JsGrid$Srch$EventType,
   ...
   */
  DetachEvent(eventType: JsGrid$Srch$EventType, fnOnEvent: any): void;

  /**
   * Set a delegate. Delegates are way to replace default functionality with custom one.
   */
  SetDelegate(delegateKey: JsGrid$JsGrid$DelegateType, fn: any): void;

  /**
   * Get current delegate.
   */
  GetDelegate(delegateKey: JsGrid$JsGrid$DelegateType): any;
   ...
   */
  GetUndoManager(): SP$JsGrid.JsGrid$CommandManager;
...
declare class JsGrid$EventType {
  constructor(...args: empty): mixed;
  static +OnCellFocusChanged: Class<JsGrid$EventType__OnCellFocusChanged> &
    JsGrid$EventType__OnCellFocusChanged &
    0; // 0
  static +OnRowFocusChanged: Class<JsGrid$EventType__OnRowFocusChanged> &
    JsGrid$EventType__OnRowFocusChanged &
    1; // 1
  static +OnCellEditBegin: Class<JsGrid$EventType__OnCellEditBegin> &
    JsGrid$EventType__OnCellEditBegin &
    2; // 2
  static +OnCellEditCompleted: Class<JsGrid$EventType__OnCellEditCompleted> &
    JsGrid$EventType__OnCellEditCompleted &
    3; // 3
  static +OnRightClick: Class<JsGrid$EventType__OnRightClick> &
    JsGrid$EventType__OnRightClick &
    4; // 4
  static +OnPropertyChanged: Class<JsGrid$EventType__OnPropertyChanged> &
    JsGrid$EventType__OnPropertyChanged &
    5; // 5
  static +OnRecordInserted: Class<JsGrid$EventType__OnRecordInserted> &
    JsGrid$EventType__OnRecordInserted &
    6; // 6
  static +OnRecordDeleted: Class<JsGrid$EventType__OnRecordDeleted> &
    JsGrid$EventType__OnRecordDeleted &
    7; // 7
  static +OnRecordChecked: Class<JsGrid$EventType__OnRecordChecked> &
    JsGrid$EventType__OnRecordChecked &
    8; // 8
  static +OnCellErrorStateChanged: Class<JsGrid$EventType__OnCellErrorStateChanged> &
    JsGrid$EventType__OnCellErrorStateChanged &
    9; // 9
  static +OnEntryRecordAdded: Class<JsGrid$EventType__OnEntryRecordAdded> &
    JsGrid$EventType__OnEntryRecordAdded &
    10; // 10
  static +OnEntryRecordCommitted: Class<JsGrid$EventType__OnEntryRecordCommitted> &
    JsGrid$EventType__OnEntryRecordCommitted &
    11; // 11
  static +OnEntryRecordPropertyChanged: Class<JsGrid$EventType__OnEntryRecordPropertyChanged> &
    JsGrid$EventType__OnEntryRecordPropertyChanged &
    12; // 12
  static +OnRowErrorStateChanged: Class<JsGrid$EventType__OnRowErrorStateChanged> &
    JsGrid$EventType__OnRowErrorStateChanged &
    13; // 13
  static +OnDoubleClick: Class<JsGrid$EventType__OnDoubleClick> &
    JsGrid$EventType__OnDoubleClick &
    14; // 14
  static +OnBeforeGridDispose: Class<JsGrid$EventType__OnBeforeGridDispose> &
    JsGrid$EventType__OnBeforeGridDispose &
    15; // 15
  static +OnSingleCellClick: Class<JsGrid$EventType__OnSingleCellClick> &
    JsGrid$EventType__OnSingleCellClick &
    16; // 16
  static +OnInitialChangesForChangeKeyComplete: Class<JsGrid$EventType__OnInitialChangesForChangeKeyComplete> &
    JsGrid$EventType__OnInitialChangesForChangeKeyComplete &
    17; // 17
  static +OnVacateChange: Class<JsGrid$EventType__OnVacateChange> &
    JsGrid$EventType__OnVacateChange &
    18; // 18
  static +OnGridErrorStateChanged: Class<JsGrid$EventType__OnGridErrorStateChanged> &
    JsGrid$EventType__OnGridErrorStateChanged &
    19; // 19
  static +OnSingleCellKeyDown: Class<JsGrid$EventType__OnSingleCellKeyDown> &
    JsGrid$EventType__OnSingleCellKeyDown &
    20; // 20
  static +OnRecordsReordered: Class<JsGrid$EventType__OnRecordsReordered> &
    JsGrid$EventType__OnRecordsReordered &
    21; // 21
  static +OnBeforePropertyChanged: Class<JsGrid$EventType__OnBeforePropertyChanged> &
    JsGrid$EventType__OnBeforePropertyChanged &
    22; // 22
  static +OnRowEscape: Class<JsGrid$EventType__OnRowEscape> &
    JsGrid$EventType__OnRowEscape &
    23; // 23
  static +OnBeginRenameColumn: Class<JsGrid$EventType__OnBeginRenameColumn> &
    JsGrid$EventType__OnBeginRenameColumn &
    24; // 24
  static +OnEndRenameColumn: Class<JsGrid$EventType__OnEndRenameColumn> &
    JsGrid$EventType__OnEndRenameColumn &
    25; // 25
  static +OnPasteBegin: Class<JsGrid$EventType__OnPasteBegin> &
    JsGrid$EventType__OnPasteBegin &
    26; // 26
  static +OnPasteEnd: Class<JsGrid$EventType__OnPasteEnd> &
    JsGrid$EventType__OnPasteEnd &
    27; // 27
  static +OnBeginRedoDataUpdateChange: Class<JsGrid$EventType__OnBeginRedoDataUpdateChange> &
    JsGrid$EventType__OnBeginRedoDataUpdateChange &
    28; // 28
  static +OnBeginUndoDataUpdateChange: Class<JsGrid$EventType__OnBeginUndoDataUpdateChange> &
    JsGrid$EventType__OnBeginUndoDataUpdateChange &
    29; // 29
}
...
declare class JsGrid$EventType__OnCellErrorStateChanged
  mixins JsGrid$EventType {}
declare class JsGrid$EventType__OnEntryRecordAdded mixins JsGrid$EventType {}
declare class JsGrid$EventType__OnEntryRecordCommitted
  mixins JsGrid$EventType {}
declare class JsGrid$EventType__OnEntryRecordPropertyChanged
  mixins JsGrid$EventType {}
declare class JsGrid$EventType__OnRowErrorStateChanged
  mixins JsGrid$EventType {}
...
declare class JsGrid$EventType__OnInitialChangesForChangeKeyComplete
  mixins JsGrid$EventType {}
declare class JsGrid$EventType__OnVacateChange mixins JsGrid$EventType {}
declare class JsGrid$EventType__OnGridErrorStateChanged
  mixins JsGrid$EventType {}
...
declare class JsGrid$EventType__OnBeforePropertyChanged
  mixins JsGrid$EventType {}
...
declare class JsGrid$EventType__OnBeginRedoDataUpdateChange
  mixins JsGrid$EventType {}
declare class JsGrid$EventType__OnBeginUndoDataUpdateChange
  mixins JsGrid$EventType {}

declare class JsGrid$DelegateType {
  constructor(...args: empty): mixed;
  static +ExpandColumnMenu: Class<JsGrid$DelegateType__ExpandColumnMenu> &
    JsGrid$DelegateType__ExpandColumnMenu &
    0; // 0
  static +AddColumnMenuItems: Class<JsGrid$DelegateType__AddColumnMenuItems> &
    JsGrid$DelegateType__AddColumnMenuItems &
    1; // 1
  static +Sort: Class<JsGrid$DelegateType__Sort> &
    JsGrid$DelegateType__Sort &
    2; // 2
  static +Filter: Class<JsGrid$DelegateType__Filter> &
    JsGrid$DelegateType__Filter &
    3; // 3
  static +InsertRecord: Class<JsGrid$DelegateType__InsertRecord> &
    JsGrid$DelegateType__InsertRecord &
    4; // 4
  static +DeleteRecords: Class<JsGrid$DelegateType__DeleteRecords> &
    JsGrid$DelegateType__DeleteRecords &
    5; // 5
  static +IndentRecords: Class<JsGrid$DelegateType__IndentRecords> &
    JsGrid$DelegateType__IndentRecords &
    6; // 6
  static +OutdentRecords: Class<JsGrid$DelegateType__OutdentRecords> &
    JsGrid$DelegateType__OutdentRecords &
    7; // 7
  static +IsRecordInsertInView: Class<JsGrid$DelegateType__IsRecordInsertInView> &
    JsGrid$DelegateType__IsRecordInsertInView &
    8; // 8
  static +ExpandDelayLoadedHierarchyNode: Class<JsGrid$DelegateType__ExpandDelayLoadedHierarchyNode> &
    JsGrid$DelegateType__ExpandDelayLoadedHierarchyNode &
    9; // 9
  static +AutoFilter: Class<JsGrid$DelegateType__AutoFilter> &
    JsGrid$DelegateType__AutoFilter &
    10; // 10
  static +ExpandConflictResolution: Class<JsGrid$DelegateType__ExpandConflictResolution> &
    JsGrid$DelegateType__ExpandConflictResolution &
    11; // 11
  static +GetAutoFilterEntries: Class<JsGrid$DelegateType__GetAutoFilterEntries> &
    JsGrid$DelegateType__GetAutoFilterEntries &
    12; // 12
  static +LaunchFilterDialog: Class<JsGrid$DelegateType__LaunchFilterDialog> &
    JsGrid$DelegateType__LaunchFilterDialog &
    13; // 13
  static +ShowColumnConfigurationDialog: Class<JsGrid$DelegateType__ShowColumnConfigurationDialog> &
    JsGrid$DelegateType__ShowColumnConfigurationDialog &
    14; // 14
  static +GetRecordEditMode: Class<JsGrid$DelegateType__GetRecordEditMode> &
    JsGrid$DelegateType__GetRecordEditMode &
    15; // 15
  static +GetGridRowStyleId: Class<JsGrid$DelegateType__GetGridRowStyleId> &
    JsGrid$DelegateType__GetGridRowStyleId &
    16; // 16
  static +CreateEntryRecord: Class<JsGrid$DelegateType__CreateEntryRecord> &
    JsGrid$DelegateType__CreateEntryRecord &
    17; // 17
  static +TryInsertEntryRecord: Class<JsGrid$DelegateType__TryInsertEntryRecord> &
    JsGrid$DelegateType__TryInsertEntryRecord &
    18; // 18
  static +WillAddColumnMenuItems: Class<JsGrid$DelegateType__WillAddColumnMenuItems> &
    JsGrid$DelegateType__WillAddColumnMenuItems &
    19; // 19
  static +NextPage: Class<JsGrid$DelegateType__NextPage> &
    JsGrid$DelegateType__NextPage &
    20; // 20
  static +AddNewColumn: Class<JsGrid$DelegateType__AddNewColumn> &
    JsGrid$DelegateType__AddNewColumn &
    21; // 21
  static +RemoveColumnFromView: Class<JsGrid$DelegateType__RemoveColumnFromView> &
    JsGrid$DelegateType__RemoveColumnFromView &
    22; // 22
  static +ReorderColumnPositionInView: Class<JsGrid$DelegateType__ReorderColumnPositionInView> &
    JsGrid$DelegateType__ReorderColumnPositionInView &
    23; // 23
  static +TryCreateProvisionalRecord: Class<JsGrid$DelegateType__TryCreateProvisionalRecord> &
    JsGrid$DelegateType__TryCreateProvisionalRecord &
    24; // 24
  static +CanReorderRecords: Class<JsGrid$DelegateType__CanReorderRecords> &
    JsGrid$DelegateType__CanReorderRecords &
    25; // 25
  static +AddNewColumnMenuItems: Class<JsGrid$DelegateType__AddNewColumnMenuItems> &
    JsGrid$DelegateType__AddNewColumnMenuItems &
    26; // 26
  static +TryBeginPaste: Class<JsGrid$DelegateType__TryBeginPaste> &
    JsGrid$DelegateType__TryBeginPaste &
    27; // 27
  static +AllowSelectionChange: Class<JsGrid$DelegateType__AllowSelectionChange> &
    JsGrid$DelegateType__AllowSelectionChange &
    28; // 28
  static +GetFieldEditMode: Class<JsGrid$DelegateType__GetFieldEditMode> &
    JsGrid$DelegateType__GetFieldEditMode &
    29; // 29
  static +GetFieldReadOnlyActiveState: Class<JsGrid$DelegateType__GetFieldReadOnlyActiveState> &
    JsGrid$DelegateType__GetFieldReadOnlyActiveState &
    30; // 30
  static +OnBeforeRecordReordered: Class<JsGrid$DelegateType__OnBeforeRecordReordered> &
    JsGrid$DelegateType__OnBeforeRecordReordered &
    31; // 31
}

declare class JsGrid$DelegateType__ExpandColumnMenu
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__AddColumnMenuItems
  mixins JsGrid$DelegateType {}
...
declare class JsGrid$DelegateType__IsRecordInsertInView
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__ExpandDelayLoadedHierarchyNode
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__AutoFilter mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__ExpandConflictResolution
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__GetAutoFilterEntries
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__LaunchFilterDialog
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__ShowColumnConfigurationDialog
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__GetRecordEditMode
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__GetGridRowStyleId
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__CreateEntryRecord
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__TryInsertEntryRecord
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__WillAddColumnMenuItems
  mixins JsGrid$DelegateType {}
...
declare class JsGrid$DelegateType__RemoveColumnFromView
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__ReorderColumnPositionInView
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__TryCreateProvisionalRecord
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__CanReorderRecords
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__AddNewColumnMenuItems
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__TryBeginPaste mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__AllowSelectionChange
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__GetFieldEditMode
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__GetFieldReadOnlyActiveState
  mixins JsGrid$DelegateType {}
declare class JsGrid$DelegateType__OnBeforeRecordReordered
  mixins JsGrid$DelegateType {}

declare class JsGrid$ClickContext {
  constructor(...args: empty): mixed;
  static +SelectAllSquare: Class<JsGrid$ClickContext__SelectAllSquare> &
    JsGrid$ClickContext__SelectAllSquare &
    0; // 0
  static +RowHeader: Class<JsGrid$ClickContext__RowHeader> &
    JsGrid$ClickContext__RowHeader &
    1; // 1
  static +ColumnHeader: Class<JsGrid$ClickContext__ColumnHeader> &
    JsGrid$ClickContext__ColumnHeader &
    2; // 2
  static +Cell: Class<JsGrid$ClickContext__Cell> &
    JsGrid$ClickContext__Cell &
    3; // 3
  static +Gantt: Class<JsGrid$ClickContext__Gantt> &
    JsGrid$ClickContext__Gantt &
    4; // 4
  static +Other: Class<JsGrid$ClickContext__Other> &
    JsGrid$ClickContext__Other &
    5; // 5
}
...
declare class JsGrid$RowHeaderState {
  constructor(
    id: string,
    img: SP$JsGrid.JsGrid$Image,
    priority: SP$JsGrid.JsGrid$RowHeaderStatePriorities,
    tooltip: string,
    fnOnClick: (eventInfo: Sys.UI.DomEvent, recordKey: number) => void
  ): this;
  GetId(): string;
  GetImg(): SP$JsGrid.JsGrid$Image;
  GetPriority(): SP$JsGrid.JsGrid$RowHeaderStatePriorities;
...
declare interface JsGrid$IStyleManager {
  ...
  RegisterCellStyle(
    styleId: string,
    cellStyle: JsGrid$IStyleType.IStyleType$Cell
  ): void;
  ...
  UpdateDefaultCellStyleFromCss(
    styleObject: JsGrid$IStyleType.IStyleType$Cell,
    cssClass: string
  ): void;
...
declare interface JsGrid$IEditControl {
  SupportedWriteMode?: SP$JsGrid.JsGrid$EditActorWriteType;
  SupportedReadMode?: SP$JsGrid.JsGrid$EditActorReadType;
...
declare class JsGrid$StaticDataSource {
  ...
  AddColumn(
    gridField: SP$JsGrid.JsGrid$GridField,
    values: JsGrid$IValue[]
  ): void;
  RemoveColumn(fieldKey: string): void;
  InitJsGridParams(
    optGridParams?: JsGrid$JsGridControl.JsGridControl$Parameters
  ): JsGrid$JsGridControl.JsGridControl$Parameters;
}
...
declare class InformationPolicy$ProjectPolicy mixins SP$SP$ClientObject {
  ...
  static getProjectPolicies(
    context: SP$ClientRuntimeContext,
    web: SP$Web
  ): SP$ClientObjectList<InformationPolicy$ProjectPolicy>;
  static getCurrentlyAppliedProject(
    context: SP$ClientRuntimeContext,
    web: SP$Web
  ): InformationPolicy$ProjectPolicy;
  static applyProjectPolicy(
    context: SP$ClientRuntimeContext,
    web: SP$Web,
    projectPolicy: InformationPolicy$ProjectPolicy
  ): void;
...
declare class Discovery$ExportStatus {
  constructor(...args: empty): mixed;
  static +notStarted: Class<Discovery$ExportStatus__notStarted> &
    Discovery$ExportStatus__notStarted &
    0; // 0
  static +started: Class<Discovery$ExportStatus__started> &
    Discovery$ExportStatus__started &
    1; // 1
  static +complete: Class<Discovery$ExportStatus__complete> &
    Discovery$ExportStatus__complete &
    2; // 2
  static +failed: Class<Discovery$ExportStatus__failed> &
    Discovery$ExportStatus__failed &
    3; // 3
}

declare class Discovery$ExportStatus__notStarted
  mixins Discovery$ExportStatus {}
...
declare class CompliancePolicy$SPContainerType {
  constructor(...args: empty): mixed;
  static +site: Class<CompliancePolicy$SPContainerType__site> &
    CompliancePolicy$SPContainerType__site &
    0; // 0
  static +web: Class<CompliancePolicy$SPContainerType__web> &
    CompliancePolicy$SPContainerType__web &
    1; // 1
  static +list: Class<CompliancePolicy$SPContainerType__list> &
    CompliancePolicy$SPContainerType__list &
    2; // 2
}

declare class CompliancePolicy$SPContainerType__site
  mixins CompliancePolicy$SPContainerType {}
declare class CompliancePolicy$SPContainerType__web
  mixins CompliancePolicy$SPContainerType {}
declare class CompliancePolicy$SPContainerType__list
  mixins CompliancePolicy$SPContainerType {}
...
declare class CompliancePolicy$SPContainerId mixins SP$ClientObject {
  static createFromList(
    context: SP$ClientRuntimeContext,
    list: SP$List
  ): CompliancePolicy$SPContainerId;
...
declare class CompliancePolicy$SPPolicyStore mixins SP$ClientObject {
  ...
  static createPolicyDefinition(
    context: SP$ClientRuntimeContext
  ): CompliancePolicy$SPPolicyDefinition;
  static createPolicyBinding(
    context: SP$ClientRuntimeContext
  ): CompliancePolicy$SPPolicyBinding;
  static createPolicyAssociation(
    context: SP$ClientRuntimeContext
  ): CompliancePolicy$SPPolicyAssociation;
  static createPolicyRule(
    context: SP$ClientRuntimeContext
  ): CompliancePolicy$SPPolicyRule;
  ...
  updatePolicyDefinition(
    policyDefinition: CompliancePolicy$SPPolicyDefinition
  ): void;
  getPolicyDefinition(
  ...
  getPolicyDefinitions(
    scenario: any
  ): SP$ClientObjectList<CompliancePolicy$SPPolicyDefinition>;
  ...
  updatePolicyAssociation(
    policyAssociation: CompliancePolicy$SPPolicyAssociation
  ): void;
  getPolicyAssociation(
    policyAssociationId: any
  ): CompliancePolicy$SPPolicyAssociation;
  getPolicyAssociationForContainer(
    containerId: CompliancePolicy$SPContainerId
  ): CompliancePolicy$SPPolicyAssociation;
...
declare class Navigation$NavigationLinkType {
  constructor(...args: empty): mixed;
  static +root: Class<Navigation$NavigationLinkType__root> &
    Navigation$NavigationLinkType__root &
    0; // 0
  static +friendlyUrl: Class<Navigation$NavigationLinkType__friendlyUrl> &
    Navigation$NavigationLinkType__friendlyUrl &
    1; // 1
  static +simpleLink: Class<Navigation$NavigationLinkType__simpleLink> &
    Navigation$NavigationLinkType__simpleLink &
    2; // 2
}

declare class Navigation$NavigationLinkType__root
  mixins Navigation$NavigationLinkType {}
declare class Navigation$NavigationLinkType__friendlyUrl
  mixins Navigation$NavigationLinkType {}
declare class Navigation$NavigationLinkType__simpleLink
  mixins Navigation$NavigationLinkType {}

declare class Navigation$StandardNavigationSource {
  constructor(...args: empty): mixed;
  static +unknown: Class<Navigation$StandardNavigationSource__unknown> &
    Navigation$StandardNavigationSource__unknown &
    0; // 0
  static +portalProvider: Class<Navigation$StandardNavigationSource__portalProvider> &
    Navigation$StandardNavigationSource__portalProvider &
    1; // 1
  static +taxonomyProvider: Class<Navigation$StandardNavigationSource__taxonomyProvider> &
    Navigation$StandardNavigationSource__taxonomyProvider &
    2; // 2
  static +inheritFromParentWeb: Class<Navigation$StandardNavigationSource__inheritFromParentWeb> &
    Navigation$StandardNavigationSource__inheritFromParentWeb &
    3; // 3
}

declare class Navigation$StandardNavigationSource__unknown
  mixins Navigation$StandardNavigationSource {}
declare class Navigation$StandardNavigationSource__portalProvider
  mixins Navigation$StandardNavigationSource {}
declare class Navigation$StandardNavigationSource__taxonomyProvider
  mixins Navigation$StandardNavigationSource {}
declare class Navigation$StandardNavigationSource__inheritFromParentWeb
  mixins Navigation$StandardNavigationSource {}
...
declare class Navigation$NavigationTermSetItem mixins SP$ClientObject {
  ...
  set_linkType(
    value: Navigation$NavigationLinkType
  ...
  getTaxonomyTermStore(): Taxonomy$Taxonomy$TermStore;
...
declare class Navigation$NavigationTerm
  mixins Navigation$NavigationTermSetItem {
  ...
  getAsEditable(
    taxonomySession: Taxonomy$Taxonomy$TaxonomySession
  ): Navigation$NavigationTerm;
  getWithNewView(
  ...
  getTaxonomyTerm(): Taxonomy$Taxonomy$Term;
...
declare class Navigation$NavigationTermSet
  mixins Navigation$NavigationTermSetItem {
  ...
  getAsEditable(
    taxonomySession: Taxonomy$Taxonomy$TaxonomySession
  ): Navigation$NavigationTermSet;
  getWithNewView(
    newView: Navigation$NavigationTermSetView
  ): Navigation$NavigationTermSet;
  getTaxonomyTermSet(): Taxonomy$Taxonomy$TermSet;
  getAllTerms(): Navigation$NavigationTermCollection;
  findTermForUrl(url: string): Navigation$NavigationTerm;
  static getAsResolvedByWeb(
    context: SP$ClientContext,
    termSet: Taxonomy$Taxonomy$TermSet,
    web: SP$Web,
    siteMapProviderName: string
  ): Navigation$NavigationTermSet;
  static getAsResolvedByView(
...
declare class Navigation$NavigationTermSetView mixins SP$ClientObject {
  ...
  static createEmptyInstance(
    context: SP$ClientContext
  ): Navigation$NavigationTermSetView;
}
...
declare class Navigation$TaxonomyNavigation {
  ...
  static setCrawlAsFriendlyUrlPage(
    context: SP$ClientContext,
    navigationTerm: Taxonomy$Taxonomy$Term,
...
declare class Navigation$WebNavigationSettings mixins SP$ClientObject {
  ...
  update(taxonomySession: Taxonomy$Taxonomy$TaxonomySession): void;
...
declare class Navigation$StandardNavigationSettings mixins SP$ClientObject {
  ...
  set_source(
    value: Navigation$StandardNavigationSource
  ): Navigation$StandardNavigationSource;
}
declare class Publishing$PublishingWeb mixins SP$ClientObject {
  static getPublishingWeb(
    context: SP$ClientContext,
    web: SP$Web
  ): Publishing$PublishingWeb;
  get_web(): SP$Web;
  addPublishingPage(
...
declare class Publishing$PublishingPage mixins Publishing$ScheduledItem {
  ...
  addFriendlyUrl(
    ...
    editableParent: SP$Navigation.Navigation$NavigationTermSetItem,
...
declare class Publishing$PageLayoutCreationInformation
...
declare type Workflow$WorkflowAssociationCollection = {
  itemAt(index: number): SP$Workflow.Workflow$WorkflowAssociation,
  get_item(index: number): SP$Workflow.Workflow$WorkflowAssociation,
  getById(associationId: SP$SP$Guid): SP$Workflow.Workflow$WorkflowAssociation,
  add(
    parameters: SP$Workflow.Workflow$WorkflowAssociationCreationInformation
  ): SP$Workflow.Workflow$WorkflowAssociation,
  getByName(name: string): SP$Workflow.Workflow$WorkflowAssociation
} & SP$SP$ClientObjectCollection<Workflow$WorkflowAssociation>;

declare class Workflow$WorkflowAssociationCreationInformation
  mixins SP$SP$ClientValueObject {
  ...
  get_template(): SP$Workflow.Workflow$WorkflowTemplate;
  set_template(value: SP$Workflow.Workflow$WorkflowTemplate): void;
  get_typeId(): string;
  writeToXml(
    writer: SP$SP$XmlWriter,
    serializationContext: SP$SP$SerializationContext
...
declare type Workflow$WorkflowTemplateCollection = {
  itemAt(index: number): SP$Workflow.Workflow$WorkflowTemplate,
  get_item(index: number): SP$Workflow.Workflow$WorkflowTemplate,
  getById(templateId: SP$SP$Guid): SP$Workflow.Workflow$WorkflowTemplate,
  getByName(name: string): SP$Workflow.Workflow$WorkflowTemplate
...
declare class WebParts$LimitedWebPartManager mixins SP$SP$ClientObject {
  ...
  get_scope(): SP$WebParts.WebParts$PersonalizationScope;
  get_webParts(): SP$WebParts.WebParts$WebPartDefinitionCollection;
  addWebPart(
    webPart: SP$WebParts.WebParts$WebPart,
    zoneId: string,
    zoneIndex: number
  ): SP$WebParts.WebParts$WebPartDefinition;
  importWebPart(webPartXml: string): SP$WebParts.WebParts$WebPartDefinition;
}

declare class WebParts$PersonalizationScope {
  constructor(...args: empty): mixed;
  static +user: Class<WebParts$PersonalizationScope__user> &
    WebParts$PersonalizationScope__user &
    0; // 0
  static +shared: Class<WebParts$PersonalizationScope__shared> &
    WebParts$PersonalizationScope__shared &
    1; // 1
}

declare class WebParts$PersonalizationScope__user
  mixins WebParts$PersonalizationScope {}
declare class WebParts$PersonalizationScope__shared
  mixins WebParts$PersonalizationScope {}
...
declare class WebParts$WebPartDefinition mixins SP$SP$ClientObject {
  get_id(): SP$SP$Guid;
  get_webPart(): SP$WebParts.WebParts$WebPart;
...
declare type WebParts$WebPartDefinitionCollection = {
  itemAt(index: number): SP$WebParts.WebParts$WebPartDefinition,
  get_item(index: number): SP$WebParts.WebParts$WebPartDefinition,
  getById(id: SP$SP$Guid): SP$WebParts.WebParts$WebPartDefinition,
  getByControlId(controlId: string): SP$WebParts.WebParts$WebPartDefinition
...
declare class DateTimeUtil$SimpleDate {
  ...
  static dateEquals(
    date1: DateTimeUtil$SimpleDate,
    date2: DateTimeUtil$SimpleDate
  ): boolean;
...
declare class UserProfiles$ChangeTypes {
  constructor(...args: empty): mixed;
  static +none: Class<UserProfiles$ChangeTypes__none> &
    UserProfiles$ChangeTypes__none &
    0; // 0
  static +add: Class<UserProfiles$ChangeTypes__add> &
    UserProfiles$ChangeTypes__add &
    1; // 1
  static +modify: Class<UserProfiles$ChangeTypes__modify> &
    UserProfiles$ChangeTypes__modify &
    2; // 2
  static +remove: Class<UserProfiles$ChangeTypes__remove> &
    UserProfiles$ChangeTypes__remove &
    3; // 3
  static +metadata: Class<UserProfiles$ChangeTypes__metadata> &
    UserProfiles$ChangeTypes__metadata &
    4; // 4
  static +all: Class<UserProfiles$ChangeTypes__all> &
    UserProfiles$ChangeTypes__all &
    5; // 5
}
...
declare class UserProfiles$ChangeTypes__modify
  mixins UserProfiles$ChangeTypes {}
declare class UserProfiles$ChangeTypes__remove
  mixins UserProfiles$ChangeTypes {}
declare class UserProfiles$ChangeTypes__metadata
  mixins UserProfiles$ChangeTypes {}
...
declare class UserProfiles$ObjectTypes {
  constructor(...args: empty): mixed;
  static +none: Class<UserProfiles$ObjectTypes__none> &
    UserProfiles$ObjectTypes__none &
    0; // 0
  static +singleValueProperty: Class<UserProfiles$ObjectTypes__singleValueProperty> &
    UserProfiles$ObjectTypes__singleValueProperty &
    1; // 1
  static +multiValueProperty: Class<UserProfiles$ObjectTypes__multiValueProperty> &
    UserProfiles$ObjectTypes__multiValueProperty &
    2; // 2
  static +anniversary: Class<UserProfiles$ObjectTypes__anniversary> &
    UserProfiles$ObjectTypes__anniversary &
    3; // 3
  static +dlMembership: Class<UserProfiles$ObjectTypes__dlMembership> &
    UserProfiles$ObjectTypes__dlMembership &
    4; // 4
  static +siteMembership: Class<UserProfiles$ObjectTypes__siteMembership> &
    UserProfiles$ObjectTypes__siteMembership &
    5; // 5
  static +quickLink: Class<UserProfiles$ObjectTypes__quickLink> &
    UserProfiles$ObjectTypes__quickLink &
    6; // 6
  static +colleague: Class<UserProfiles$ObjectTypes__colleague> &
    UserProfiles$ObjectTypes__colleague &
    7; // 7
  static +personalizationSite: Class<UserProfiles$ObjectTypes__personalizationSite> &
    UserProfiles$ObjectTypes__personalizationSite &
    8; // 8
  static +userProfile: Class<UserProfiles$ObjectTypes__userProfile> &
    UserProfiles$ObjectTypes__userProfile &
    9; // 9
  static +webLog: Class<UserProfiles$ObjectTypes__webLog> &
    UserProfiles$ObjectTypes__webLog &
    10; // 10
  static +custom: Class<UserProfiles$ObjectTypes__custom> &
    UserProfiles$ObjectTypes__custom &
    11; // 11
  static +organizationProfile: Class<UserProfiles$ObjectTypes__organizationProfile> &
    UserProfiles$ObjectTypes__organizationProfile &
    12; // 12
  static +organizationMembership: Class<UserProfiles$ObjectTypes__organizationMembership> &
    UserProfiles$ObjectTypes__organizationMembership &
    13; // 13
  static +all: Class<UserProfiles$ObjectTypes__all> &
    UserProfiles$ObjectTypes__all &
    14; // 14
}

declare class UserProfiles$ObjectTypes__none mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__singleValueProperty
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__multiValueProperty
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__anniversary
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__dlMembership
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__siteMembership
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__quickLink
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__colleague
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__personalizationSite
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__userProfile
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__webLog
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__custom
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__organizationProfile
  mixins UserProfiles$ObjectTypes {}
declare class UserProfiles$ObjectTypes__organizationMembership
  mixins UserProfiles$ObjectTypes {}
...
declare class UserProfiles$PeopleManager mixins SP$SP$ClientObject {
  ...
  static getTrendingTags(
    context: SP$SP$ClientRuntimeContext
  ): UserProfiles$HashTagCollection;
  ...
  getPeopleFollowedBy(
    accountName: string
  ): SP$SP$ClientObjectList<UserProfiles$PersonProperties>;
...
declare class UserProfiles$PersonalSiteCapabilities {
  constructor(...args: empty): mixed;
  static +none: Class<UserProfiles$PersonalSiteCapabilities__none> &
    UserProfiles$PersonalSiteCapabilities__none &
    0; // 0
  static +profile: Class<UserProfiles$PersonalSiteCapabilities__profile> &
    UserProfiles$PersonalSiteCapabilities__profile &
    1; // 1
  static +social: Class<UserProfiles$PersonalSiteCapabilities__social> &
    UserProfiles$PersonalSiteCapabilities__social &
    2; // 2
  static +storage: Class<UserProfiles$PersonalSiteCapabilities__storage> &
    UserProfiles$PersonalSiteCapabilities__storage &
    3; // 3
  static +myTasksDashboard: Class<UserProfiles$PersonalSiteCapabilities__myTasksDashboard> &
    UserProfiles$PersonalSiteCapabilities__myTasksDashboard &
    4; // 4
  static +education: Class<UserProfiles$PersonalSiteCapabilities__education> &
    UserProfiles$PersonalSiteCapabilities__education &
    5; // 5
  static +guest: Class<UserProfiles$PersonalSiteCapabilities__guest> &
    UserProfiles$PersonalSiteCapabilities__guest &
    6; // 6
}

declare class UserProfiles$PersonalSiteCapabilities__none
  mixins UserProfiles$PersonalSiteCapabilities {}
declare class UserProfiles$PersonalSiteCapabilities__profile
  mixins UserProfiles$PersonalSiteCapabilities {}
declare class UserProfiles$PersonalSiteCapabilities__social
  mixins UserProfiles$PersonalSiteCapabilities {}
declare class UserProfiles$PersonalSiteCapabilities__storage
  mixins UserProfiles$PersonalSiteCapabilities {}
declare class UserProfiles$PersonalSiteCapabilities__myTasksDashboard
  mixins UserProfiles$PersonalSiteCapabilities {}
declare class UserProfiles$PersonalSiteCapabilities__education
  mixins UserProfiles$PersonalSiteCapabilities {}
declare class UserProfiles$PersonalSiteCapabilities__guest
  mixins UserProfiles$PersonalSiteCapabilities {}
...
declare class UserProfiles$PersonalSiteInstantiationState {
  constructor(...args: empty): mixed;
  static +uninitialized: Class<UserProfiles$PersonalSiteInstantiationState__uninitialized> &
    UserProfiles$PersonalSiteInstantiationState__uninitialized &
    0; // 0
  static +enqueued: Class<UserProfiles$PersonalSiteInstantiationState__enqueued> &
    UserProfiles$PersonalSiteInstantiationState__enqueued &
    1; // 1
  static +created: Class<UserProfiles$PersonalSiteInstantiationState__created> &
    UserProfiles$PersonalSiteInstantiationState__created &
    2; // 2
  static +deleted: Class<UserProfiles$PersonalSiteInstantiationState__deleted> &
    UserProfiles$PersonalSiteInstantiationState__deleted &
    3; // 3
  static +permissionsGeneralFailure: Class<UserProfiles$PersonalSiteInstantiationState__permissionsGeneralFailure> &
    UserProfiles$PersonalSiteInstantiationState__permissionsGeneralFailure &
    4; // 4
  static +permissionsUPANotGranted: Class<UserProfiles$PersonalSiteInstantiationState__permissionsUPANotGranted> &
    UserProfiles$PersonalSiteInstantiationState__permissionsUPANotGranted &
    5; // 5
  static +permissionsUserNotLicensed: Class<UserProfiles$PersonalSiteInstantiationState__permissionsUserNotLicensed> &
    UserProfiles$PersonalSiteInstantiationState__permissionsUserNotLicensed &
    6; // 6
  static +permissionsSelfServiceSiteCreationDisabled: Class<UserProfiles$PersonalSiteInstantiationState__permissionsSelfServiceSiteCreationDisabled> &
    UserProfiles$PersonalSiteInstantiationState__permissionsSelfServiceSiteCreationDisabled &
    7; // 7
  static +permissionsNoMySitesInPeopleLight: Class<UserProfiles$PersonalSiteInstantiationState__permissionsNoMySitesInPeopleLight> &
    UserProfiles$PersonalSiteInstantiationState__permissionsNoMySitesInPeopleLight &
    8; // 8
  static +permissionsEmptyHostUrl: Class<UserProfiles$PersonalSiteInstantiationState__permissionsEmptyHostUrl> &
    UserProfiles$PersonalSiteInstantiationState__permissionsEmptyHostUrl &
    9; // 9
  static +permissionsHostFailedToInitializePersonalSiteContext: Class<UserProfiles$PersonalSiteInstantiationState__permissionsHostFailedToInitializePersonalSiteContext> &
    UserProfiles$PersonalSiteInstantiationState__permissionsHostFailedToInitializePersonalSiteContext &
    10; // 10
  static +errorGeneralFailure: Class<UserProfiles$PersonalSiteInstantiationState__errorGeneralFailure> &
    UserProfiles$PersonalSiteInstantiationState__errorGeneralFailure &
    11; // 11
  static +errorManagedPathDoesNotExist: Class<UserProfiles$PersonalSiteInstantiationState__errorManagedPathDoesNotExist> &
    UserProfiles$PersonalSiteInstantiationState__errorManagedPathDoesNotExist &
    12; // 12
  static +errorLanguageNotInstalled: Class<UserProfiles$PersonalSiteInstantiationState__errorLanguageNotInstalled> &
    UserProfiles$PersonalSiteInstantiationState__errorLanguageNotInstalled &
    13; // 13
  static +errorPartialCreate: Class<UserProfiles$PersonalSiteInstantiationState__errorPartialCreate> &
    UserProfiles$PersonalSiteInstantiationState__errorPartialCreate &
    14; // 14
  static +errorPersonalSiteAlreadyExists: Class<UserProfiles$PersonalSiteInstantiationState__errorPersonalSiteAlreadyExists> &
    UserProfiles$PersonalSiteInstantiationState__errorPersonalSiteAlreadyExists &
    15; // 15
  static +errorRootSiteNotPresent: Class<UserProfiles$PersonalSiteInstantiationState__errorRootSiteNotPresent> &
    UserProfiles$PersonalSiteInstantiationState__errorRootSiteNotPresent &
    16; // 16
  static +errorSelfServiceSiteCreateCallFailed: Class<UserProfiles$PersonalSiteInstantiationState__errorSelfServiceSiteCreateCallFailed> &
    UserProfiles$PersonalSiteInstantiationState__errorSelfServiceSiteCreateCallFailed &
    17; // 17
}

declare class UserProfiles$PersonalSiteInstantiationState__uninitialized
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__enqueued
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__created
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__deleted
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__permissionsGeneralFailure
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__permissionsUPANotGranted
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__permissionsUserNotLicensed
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__permissionsSelfServiceSiteCreationDisabled
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__permissionsNoMySitesInPeopleLight
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__permissionsEmptyHostUrl
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__permissionsHostFailedToInitializePersonalSiteContext
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__errorGeneralFailure
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__errorManagedPathDoesNotExist
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__errorLanguageNotInstalled
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__errorPartialCreate
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__errorPersonalSiteAlreadyExists
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__errorRootSiteNotPresent
  mixins UserProfiles$PersonalSiteInstantiationState {}
declare class UserProfiles$PersonalSiteInstantiationState__errorSelfServiceSiteCreateCallFailed
  mixins UserProfiles$PersonalSiteInstantiationState {}

declare class UserProfiles$SocialDataStoreExceptionCode {
  constructor(...args: empty): mixed;
  static +socialListNotFound: Class<UserProfiles$SocialDataStoreExceptionCode__socialListNotFound> &
    UserProfiles$SocialDataStoreExceptionCode__socialListNotFound &
    0; // 0
  static +personalSiteNotFound: Class<UserProfiles$SocialDataStoreExceptionCode__personalSiteNotFound> &
    UserProfiles$SocialDataStoreExceptionCode__personalSiteNotFound &
    1; // 1
  static +cannotCreatePersonalSite: Class<UserProfiles$SocialDataStoreExceptionCode__cannotCreatePersonalSite> &
    UserProfiles$SocialDataStoreExceptionCode__cannotCreatePersonalSite &
    2; // 2
  static +noSocialFeatures: Class<UserProfiles$SocialDataStoreExceptionCode__noSocialFeatures> &
    UserProfiles$SocialDataStoreExceptionCode__noSocialFeatures &
    3; // 3
}

declare class UserProfiles$SocialDataStoreExceptionCode__socialListNotFound
  mixins UserProfiles$SocialDataStoreExceptionCode {}
declare class UserProfiles$SocialDataStoreExceptionCode__personalSiteNotFound
  mixins UserProfiles$SocialDataStoreExceptionCode {}
declare class UserProfiles$SocialDataStoreExceptionCode__cannotCreatePersonalSite
  mixins UserProfiles$SocialDataStoreExceptionCode {}
declare class UserProfiles$SocialDataStoreExceptionCode__noSocialFeatures
  mixins UserProfiles$SocialDataStoreExceptionCode {}
...
declare class UserProfiles$FollowedItemType {
  constructor(...args: empty): mixed;
  static +unknown: Class<UserProfiles$FollowedItemType__unknown> &
    UserProfiles$FollowedItemType__unknown &
    0; // 0
  static +document: Class<UserProfiles$FollowedItemType__document> &
    UserProfiles$FollowedItemType__document &
    1; // 1
  static +site: Class<UserProfiles$FollowedItemType__site> &
    UserProfiles$FollowedItemType__site &
    2; // 2
  static +all: Class<UserProfiles$FollowedItemType__all> &
    UserProfiles$FollowedItemType__all &
    3; // 3
}

declare class UserProfiles$FollowedItemType__unknown
  mixins UserProfiles$FollowedItemType {}
declare class UserProfiles$FollowedItemType__document
  mixins UserProfiles$FollowedItemType {}
declare class UserProfiles$FollowedItemType__site
  mixins UserProfiles$FollowedItemType {}
declare class UserProfiles$FollowedItemType__all
  mixins UserProfiles$FollowedItemType {}

declare class UserProfiles$FollowedContentExceptionType {
  constructor(...args: empty): mixed;
  static +itemAlreadyExists: Class<UserProfiles$FollowedContentExceptionType__itemAlreadyExists> &
    UserProfiles$FollowedContentExceptionType__itemAlreadyExists &
    0; // 0
  static +itemDoesNotExist: Class<UserProfiles$FollowedContentExceptionType__itemDoesNotExist> &
    UserProfiles$FollowedContentExceptionType__itemDoesNotExist &
    1; // 1
  static +invalidQueryString: Class<UserProfiles$FollowedContentExceptionType__invalidQueryString> &
    UserProfiles$FollowedContentExceptionType__invalidQueryString &
    2; // 2
  static +invalidSubtypeValue: Class<UserProfiles$FollowedContentExceptionType__invalidSubtypeValue> &
    UserProfiles$FollowedContentExceptionType__invalidSubtypeValue &
    3; // 3
  static +unsupportedItemType: Class<UserProfiles$FollowedContentExceptionType__unsupportedItemType> &
    UserProfiles$FollowedContentExceptionType__unsupportedItemType &
    4; // 4
  static +followLimitReached: Class<UserProfiles$FollowedContentExceptionType__followLimitReached> &
    UserProfiles$FollowedContentExceptionType__followLimitReached &
    5; // 5
  static +untrustedSource: Class<UserProfiles$FollowedContentExceptionType__untrustedSource> &
    UserProfiles$FollowedContentExceptionType__untrustedSource &
    6; // 6
  static +unsupportedSite: Class<UserProfiles$FollowedContentExceptionType__unsupportedSite> &
    UserProfiles$FollowedContentExceptionType__unsupportedSite &
    7; // 7
  static +internalError: Class<UserProfiles$FollowedContentExceptionType__internalError> &
    UserProfiles$FollowedContentExceptionType__internalError &
    8; // 8
}

declare class UserProfiles$FollowedContentExceptionType__itemAlreadyExists
  mixins UserProfiles$FollowedContentExceptionType {}
declare class UserProfiles$FollowedContentExceptionType__itemDoesNotExist
  mixins UserProfiles$FollowedContentExceptionType {}
declare class UserProfiles$FollowedContentExceptionType__invalidQueryString
  mixins UserProfiles$FollowedContentExceptionType {}
declare class UserProfiles$FollowedContentExceptionType__invalidSubtypeValue
  mixins UserProfiles$FollowedContentExceptionType {}
declare class UserProfiles$FollowedContentExceptionType__unsupportedItemType
  mixins UserProfiles$FollowedContentExceptionType {}
declare class UserProfiles$FollowedContentExceptionType__followLimitReached
  mixins UserProfiles$FollowedContentExceptionType {}
declare class UserProfiles$FollowedContentExceptionType__untrustedSource
  mixins UserProfiles$FollowedContentExceptionType {}
declare class UserProfiles$FollowedContentExceptionType__unsupportedSite
  mixins UserProfiles$FollowedContentExceptionType {}
declare class UserProfiles$FollowedContentExceptionType__internalError
  mixins UserProfiles$FollowedContentExceptionType {}

declare class UserProfiles$FollowedContentQueryOptions {
  constructor(...args: empty): mixed;
  static +unset: Class<UserProfiles$FollowedContentQueryOptions__unset> &
    UserProfiles$FollowedContentQueryOptions__unset &
    0; // 0
  static +sites: Class<UserProfiles$FollowedContentQueryOptions__sites> &
    UserProfiles$FollowedContentQueryOptions__sites &
    1; // 1
  static +documents: Class<UserProfiles$FollowedContentQueryOptions__documents> &
    UserProfiles$FollowedContentQueryOptions__documents &
    2; // 2
  static +hidden: Class<UserProfiles$FollowedContentQueryOptions__hidden> &
    UserProfiles$FollowedContentQueryOptions__hidden &
    3; // 3
  static +nonFeed: Class<UserProfiles$FollowedContentQueryOptions__nonFeed> &
    UserProfiles$FollowedContentQueryOptions__nonFeed &
    4; // 4
  static +defaultOptions: Class<UserProfiles$FollowedContentQueryOptions__defaultOptions> &
    UserProfiles$FollowedContentQueryOptions__defaultOptions &
    5; // 5
  static +all: Class<UserProfiles$FollowedContentQueryOptions__all> &
    UserProfiles$FollowedContentQueryOptions__all &
    6; // 6
}

declare class UserProfiles$FollowedContentQueryOptions__unset
  mixins UserProfiles$FollowedContentQueryOptions {}
declare class UserProfiles$FollowedContentQueryOptions__sites
  mixins UserProfiles$FollowedContentQueryOptions {}
declare class UserProfiles$FollowedContentQueryOptions__documents
  mixins UserProfiles$FollowedContentQueryOptions {}
declare class UserProfiles$FollowedContentQueryOptions__hidden
  mixins UserProfiles$FollowedContentQueryOptions {}
declare class UserProfiles$FollowedContentQueryOptions__nonFeed
  mixins UserProfiles$FollowedContentQueryOptions {}
declare class UserProfiles$FollowedContentQueryOptions__defaultOptions
  mixins UserProfiles$FollowedContentQueryOptions {}
declare class UserProfiles$FollowedContentQueryOptions__all
  mixins UserProfiles$FollowedContentQueryOptions {}

declare class UserProfiles$FollowedStatus {
  constructor(...args: empty): mixed;
  static +followed: Class<UserProfiles$FollowedStatus__followed> &
    UserProfiles$FollowedStatus__followed &
    0; // 0
  static +notFollowed: Class<UserProfiles$FollowedStatus__notFollowed> &
    UserProfiles$FollowedStatus__notFollowed &
    1; // 1
  static +notFollowable: Class<UserProfiles$FollowedStatus__notFollowable> &
    UserProfiles$FollowedStatus__notFollowable &
    2; // 2
}

declare class UserProfiles$FollowedStatus__followed
  mixins UserProfiles$FollowedStatus {}
declare class UserProfiles$FollowedStatus__notFollowed
  mixins UserProfiles$FollowedStatus {}
declare class UserProfiles$FollowedStatus__notFollowable
  mixins UserProfiles$FollowedStatus {}
...
declare class UserProfiles$FollowResultType {
  constructor(...args: empty): mixed;
  static +unknown: Class<UserProfiles$FollowResultType__unknown> &
    UserProfiles$FollowResultType__unknown &
    0; // 0
  static +followed: Class<UserProfiles$FollowResultType__followed> &
    UserProfiles$FollowResultType__followed &
    1; // 1
  static +refollowed: Class<UserProfiles$FollowResultType__refollowed> &
    UserProfiles$FollowResultType__refollowed &
    2; // 2
  static +hitFollowLimit: Class<UserProfiles$FollowResultType__hitFollowLimit> &
    UserProfiles$FollowResultType__hitFollowLimit &
    3; // 3
  static +failed: Class<UserProfiles$FollowResultType__failed> &
    UserProfiles$FollowResultType__failed &
    4; // 4
}

declare class UserProfiles$FollowResultType__unknown
  mixins UserProfiles$FollowResultType {}
declare class UserProfiles$FollowResultType__followed
  mixins UserProfiles$FollowResultType {}
declare class UserProfiles$FollowResultType__refollowed
  mixins UserProfiles$FollowResultType {}
declare class UserProfiles$FollowResultType__hitFollowLimit
  mixins UserProfiles$FollowResultType {}
declare class UserProfiles$FollowResultType__failed
  mixins UserProfiles$FollowResultType {}

/**
 * Represents a set of user profile properties for a specified user.
 */
declare class UserProfiles$UserProfilePropertiesForUser
  mixins SP$SP$ClientObject {
  /**
...
declare class Controls$Navigation {
  constructor(
    ...
    options: Controls$INavigationOptions
  ): this;
  get_assetId(): string;
...
declare var npm$namespace$UI: {
  $create_DialogOptions: typeof UI$$create_DialogOptions
};
declare class UI$PopoutMenu mixins Sys.IDisposable {
  constructor(
    launcherId: string,
    menuId: string,
    iconId: string,
...
declare class UI$AttractModeControl mixins undefined.Control {
...
declare class UI$Menu {
  static create(id: string): SP$UI.UI$Menu;
  addMenuItem(
    text: string,
...
declare class UI$MenuTest {
  static setup(relativeElement: HTMLElement): void;
  constructor(): this;
}

declare function UI$$create_DialogOptions(): UI$DialogOptions;

/**
 * Result of a modal dialog execution
 */
declare class UI$DialogResult {
  constructor(...args: empty): mixed;
  static +invalid: Class<UI$DialogResult__invalid> &
    UI$DialogResult__invalid &
    0; // 0
  static +cancel: Class<UI$DialogResult__cancel> & UI$DialogResult__cancel & 1; // 1
  static +OK: Class<UI$DialogResult__OK> & UI$DialogResult__OK & 2; // 2
}

declare class UI$DialogResult__invalid mixins UI$DialogResult {}
declare class UI$DialogResult__cancel mixins UI$DialogResult {}
declare class UI$DialogResult__OK mixins UI$DialogResult {}

/**
 * Callback which processes dialog result value after dialog is closed
 */
declare type UI$DialogReturnValueCallback = (
  dialogResult: UI$DialogResult,
  returnValue: any
) => void;
 ...
 */
declare interface UI$IDialogOptions {
  /**
   ...
   */
  dialogReturnValueCallback?: UI$DialogReturnValueCallback;
...
declare class UI$DialogOptions mixins UI$IDialogOptions {
  /**
   * Text displayed in the title bar of the dialog box. If not defined, it will default to the title of the page defined by url property.
   */
  title: string;
...
declare class UI$ModalDialog mixins undefined.UI$Dialog {
  ...
  static commonModalDialogOpen(
    url: string,
    options: SP$UI.UI$IDialogOptions,
    callback?: SP$UI.UI$DialogReturnValueCallback,
    args?: any
  ): void;
   ...
   */
  static RefreshPage(dialogResult: SP$UI.UI$DialogResult): void;
  ...
  static showWaitScreenSize(
    title: string,
    message?: string,
    callbackFunc?: SP$UI.UI$DialogReturnValueCallback,
    height?: number,
    width?: number
  ): SP$UI.UI$ModalDialog;
  ...
  static get_childDialog(): SP$UI.UI$ModalDialog;

  /**
   * Closes the dialog using the specified dialog result.
   */
  close(dialogResult: SP$UI.UI$DialogResult): void;
}

declare class UI$Command {
...
declare class UI$CommandBar {
  constructor(): this;
  get_commands(): UI$Command[];
  ...
  addCommand(action: UI$Command): void;
  insertCommand(action: UI$Command, position: number): void;
  render(builder: SP$HtmlBuilder): void;
  attachEvents(): void;
  findCommandByName(name: string): UI$Command;
}

declare class UI$PagingControl {
...
declare interface UI$DefaultFormsInformationRequestor {
  onDefaultFormsInformationRetrieveSuccess(
    defaultForms: SP$Application.UI.UI$DefaultFormsInformation
  ): void;
...
declare class UI$DefaultFormsInformation {
  DefaultForms: SP$Application.UI.UI$FormsInfo;
  OtherForms: any;
  constructor(): this;
}
...
declare class UI$DefaultFormsMenuBuilder {
  static getDefaultFormsInformation(
    requestor: SP$Application.UI.UI$DefaultFormsInformationRequestor,
    listId: SP$SP$Guid
  ): void;
}
...
declare interface UI$ViewInformationRequestor {
  onViewInformationReturned(
    viewGroups: SP$Application.UI.UI$ViewSelectorGroups
  ): void;
}
...
declare class UI$ViewSelectorGroups {
  ...
  PersonalViews: any;
  OtherViews: any;
  DefaultView: SP$Application.UI.UI$ViewSelectorMenuItem;
  ViewCreation: any;
  constructor(): this;
}
...
declare class UI$ViewSelectorMenuBuilder {
  ...
  static showMenu(
    elem: HTMLElement,
    options: SP$Application.UI.UI$ViewSelectorMenuOptions
  ): void;
  static getViewInformation(
    requestor: SP$Application.UI.UI$ViewInformationRequestor,
    options: SP$Application.UI.UI$ViewSelectorMenuOptions
  ): void;
}
...
declare class UI$MoreColorsPage mixins undefined.Control {
  ...
  initialize(): void;
  dispose(): void;
  get_moreColorsPicker(): SP$Application.UI.UI$MoreColorsPicker;
  set_moreColorsPicker(value: SP$Application.UI.UI$MoreColorsPicker): void;
}
...
declare class SPNotifications$ContainerID {
  constructor(...args: empty): mixed;
  static +Basic: Class<SPNotifications$ContainerID__Basic> &
    SPNotifications$ContainerID__Basic &
    0; // 0
  static +Status: Class<SPNotifications$ContainerID__Status> &
    SPNotifications$ContainerID__Status &
    1; // 1
}

declare class SPNotifications$ContainerID__Basic
  mixins SPNotifications$ContainerID {}
declare class SPNotifications$ContainerID__Status
  mixins SPNotifications$ContainerID {}

declare class SPNotifications$EventID {
  constructor(...args: empty): mixed;
  static +OnShow: Class<SPNotifications$EventID__OnShow> &
    SPNotifications$EventID__OnShow &
    0; // 0
  static +OnHide: Class<SPNotifications$EventID__OnHide> &
    SPNotifications$EventID__OnHide &
    1; // 1
  static +OnDisplayNotification: Class<SPNotifications$EventID__OnDisplayNotification> &
    SPNotifications$EventID__OnDisplayNotification &
    2; // 2
  static +OnRemoveNotification: Class<SPNotifications$EventID__OnRemoveNotification> &
    SPNotifications$EventID__OnRemoveNotification &
    3; // 3
  static +OnNotificationCountChanged: Class<SPNotifications$EventID__OnNotificationCountChanged> &
    SPNotifications$EventID__OnNotificationCountChanged &
    4; // 4
}
...
declare class SPNotifications$EventID__OnDisplayNotification
  mixins SPNotifications$EventID {}
declare class SPNotifications$EventID__OnRemoveNotification
  mixins SPNotifications$EventID {}
declare class SPNotifications$EventID__OnNotificationCountChanged
  mixins SPNotifications$EventID {}

declare var npm$namespace$UIUtility: {
  generateRandomElementId: typeof UIUtility$generateRandomElementId,
  cancelEvent: typeof UIUtility$cancelEvent,
  clearChildNodes: typeof UIUtility$clearChildNodes,
  hideElement: typeof UIUtility$hideElement,
  showElement: typeof UIUtility$showElement,
  insertBefore: typeof UIUtility$insertBefore,
  insertAfter: typeof UIUtility$insertAfter,
  removeNode: typeof UIUtility$removeNode,
  calculateOffsetLeft: typeof UIUtility$calculateOffsetLeft,
  calculateOffsetTop: typeof UIUtility$calculateOffsetTop,
  createHtmlInputText: typeof UIUtility$createHtmlInputText,
  createHtmlInputCheck: typeof UIUtility$createHtmlInputCheck,
  setInnerText: typeof UIUtility$setInnerText,
  getInnerText: typeof UIUtility$getInnerText,
  isTextNode: typeof UIUtility$isTextNode,
  isSvgNode: typeof UIUtility$isSvgNode,
  isNodeOfType: typeof UIUtility$isNodeOfType,
  focusValidOnThisNode: typeof UIUtility$focusValidOnThisNode
};
declare function UIUtility$generateRandomElementId(): string;

declare function UIUtility$cancelEvent(evt: Event): void;

declare function UIUtility$clearChildNodes(elem: HTMLElement): void;

declare function UIUtility$hideElement(elem: HTMLElement): void;

declare function UIUtility$showElement(elem: HTMLElement): void;

declare function UIUtility$insertBefore(
  elem: HTMLElement,
  targetElement: HTMLElement
): void;

declare function UIUtility$insertAfter(
  elem: HTMLElement,
  targetElement: HTMLElement
): void;

declare function UIUtility$removeNode(elem: HTMLElement): void;

declare function UIUtility$calculateOffsetLeft(elem: HTMLElement): number;

declare function UIUtility$calculateOffsetTop(elem: HTMLElement): number;

declare function UIUtility$createHtmlInputText(text: string): HTMLInputElement;

declare function UIUtility$createHtmlInputCheck(
  isChecked: boolean
): HTMLInputElement;

declare function UIUtility$setInnerText(elem: HTMLElement, value: string): void;

declare function UIUtility$getInnerText(elem: HTMLElement): string;

declare function UIUtility$isTextNode(elem: HTMLElement): boolean;

declare function UIUtility$isSvgNode(elem: HTMLElement): boolean;

declare function UIUtility$isNodeOfType(
  elem: HTMLElement,
  tagNames: string[]
): boolean;

declare function UIUtility$focusValidOnThisNode(elem: HTMLElement): boolean;

declare var npm$namespace$Workplace: {
  add_resized: typeof Workplace$add_resized,
  remove_resized: typeof Workplace$remove_resized
};
declare function Workplace$add_resized(
  handler: (obj: any, args: any) => void
): void;

declare function Workplace$remove_resized(
  handler: (obj: any, args: any) => void
): void;

declare var npm$namespace$Workspace: {
  add_resized: typeof Workspace$add_resized,
  remove_resized: typeof Workspace$remove_resized
};
declare function Workspace$add_resized(handler: () => void): void;

declare function Workspace$remove_resized(handler: () => void): void;

declare var npm$namespace$Notify: {
  addNotification: typeof Notify$addNotification,
  removeNotification: typeof Notify$removeNotification,
  showLoadingNotification: typeof Notify$showLoadingNotification
};
declare function Notify$addNotification(
  strHtml: string,
  bSticky: boolean
): string;

declare function Notify$removeNotification(nid: string): void;

declare function Notify$showLoadingNotification(bSticky: boolean): string;

declare class Notify$Notification {
  constructor(
    containerId: SPNotifications$SPNotifications$ContainerID,
    strHtml: string,
    bSticky?: boolean,
    strTooltip?: string,
    onclickHandler?: () => void,
...
declare class Notify$NotificationContainer {
  constructor(
    id: number,
    element: any,
    layer: number,
  ...
  GetCount(): number;
  SetEventHandler(
    eventId: SPNotifications$SPNotifications$EventID,
    eventHandler: any
  ): void;
}
declare class ApplicationPages$SelectorSelectionEventArgs mixins Sys.EventArgs {
  constructor(entities: any): this;
  get_entities(): any;
}

declare interface ApplicationPages$ISelectorComponent {
  ...
  get_scopeKey(): string;
  get_componentType(): SP$UI.ApplicationPages.ApplicationPages$SelectorType;
  revertTo(ent: SP$UI.ApplicationPages.ApplicationPages$ResolveEntity): void;
  removeEntity(
    ent: SP$UI.ApplicationPages.ApplicationPages$ResolveEntity
  ): void;
  setEntity(ent: SP$UI.ApplicationPages.ApplicationPages$ResolveEntity): void;
}

declare class ApplicationPages$SelectorType {
  constructor(...args: empty): mixed;
  static +none: Class<ApplicationPages$SelectorType__none> &
    ApplicationPages$SelectorType__none &
    0; // 0
  static +resource: Class<ApplicationPages$SelectorType__resource> &
    ApplicationPages$SelectorType__resource &
    1; // 1
  static +people: Class<ApplicationPages$SelectorType__people> &
    ApplicationPages$SelectorType__people &
    2; // 2
  static +people_And_Resource: Class<ApplicationPages$SelectorType__people_And_Resource> &
    ApplicationPages$SelectorType__people_And_Resource &
    3; // 3
  static +event: Class<ApplicationPages$SelectorType__event> &
    ApplicationPages$SelectorType__event &
    4; // 4
}

declare class ApplicationPages$SelectorType__none
  mixins ApplicationPages$SelectorType {}
declare class ApplicationPages$SelectorType__resource
  mixins ApplicationPages$SelectorType {}
declare class ApplicationPages$SelectorType__people
  mixins ApplicationPages$SelectorType {}
declare class ApplicationPages$SelectorType__people_And_Resource
  mixins ApplicationPages$SelectorType {}
declare class ApplicationPages$SelectorType__event
  mixins ApplicationPages$SelectorType {}

declare class ApplicationPages$CalendarSelector mixins Sys.Component {
  static instance(): SP$UI.ApplicationPages.ApplicationPages$CalendarSelector;
  registerSelector(
    selector: SP$UI.ApplicationPages.ApplicationPages$ISelectorComponent
  ): void;
  getSelector(
    type: SP$UI.ApplicationPages.ApplicationPages$SelectorType,
    scopeKey: string
  ): SP$UI.ApplicationPages.ApplicationPages$ISelectorComponent;
  addHandler(
    scopeKey: string,
    people: boolean,
    resource: boolean,
    handler: (
      sender: any,
      selection: SP$UI.ApplicationPages.ApplicationPages$SelectorSelectionEventArgs
    ) => void
  ): void;
  revertTo(
    scopeKey: string,
...
declare class ApplicationPages$BaseSelectorComponent
  mixins undefined.ApplicationPages$ISelectorComponent {
  constructor(
    key: string,
    type: SP$UI.ApplicationPages.ApplicationPages$SelectorType
  ): this;
...
declare interface ApplicationPages$ICalendarController {
  moveToDate(date: string): void;
  moveToViewType(viewType: string): void;
  moveToViewDate(
    scope: SP$UI.ApplicationPages.ApplicationPages$CalendarScope,
    date: string
  ): void;
  moveToView(
    scope: SP$UI.ApplicationPages.ApplicationPages$CalendarScope
  ...
  collapseAll(): void;
  refreshItems(): void;
  getActiveScope(): SP$UI.ApplicationPages.ApplicationPages$CalendarScope;
  newItemDialog(contentTypeId: string): void;
  deleteItem(itemId: string): void;
}

declare class ApplicationPages$CalendarScope {
  constructor(...args: empty): mixed;
  static +nothing: Class<ApplicationPages$CalendarScope__nothing> &
    ApplicationPages$CalendarScope__nothing &
    0; // 0
  static +monthly: Class<ApplicationPages$CalendarScope__monthly> &
    ApplicationPages$CalendarScope__monthly &
    1; // 1
  static +weeklyGroup: Class<ApplicationPages$CalendarScope__weeklyGroup> &
    ApplicationPages$CalendarScope__weeklyGroup &
    2; // 2
  static +daily: Class<ApplicationPages$CalendarScope__daily> &
    ApplicationPages$CalendarScope__daily &
    3; // 3
  static +weekly: Class<ApplicationPages$CalendarScope__weekly> &
    ApplicationPages$CalendarScope__weekly &
    4; // 4
  static +dailyGroup: Class<ApplicationPages$CalendarScope__dailyGroup> &
    ApplicationPages$CalendarScope__dailyGroup &
    5; // 5
}

declare class ApplicationPages$CalendarScope__nothing
  mixins ApplicationPages$CalendarScope {}
declare class ApplicationPages$CalendarScope__monthly
  mixins ApplicationPages$CalendarScope {}
declare class ApplicationPages$CalendarScope__weeklyGroup
  mixins ApplicationPages$CalendarScope {}
declare class ApplicationPages$CalendarScope__daily
  mixins ApplicationPages$CalendarScope {}
declare class ApplicationPages$CalendarScope__weekly
  mixins ApplicationPages$CalendarScope {}
declare class ApplicationPages$CalendarScope__dailyGroup
  mixins ApplicationPages$CalendarScope {}

declare class ApplicationPages$CalendarInstanceRepository {
  static registerInstance(
    instanceId: string,
    contoller: SP$UI.ApplicationPages.ApplicationPages$ICalendarController
  ): void;
  static lookupInstance(
    instanceId: string
  ): SP$UI.ApplicationPages.ApplicationPages$ICalendarController;
  static firstInstance(): SP$UI.ApplicationPages.ApplicationPages$ICalendarController;
}

declare class ApplicationPages$ResolveEntity {
  tYPE_EVENT: string;
  tYPE_USER: string;
  ...
  accountName: string;
  id: string;
  members: SP$UI.ApplicationPages.ApplicationPages$ResolveEntity[];
  needResolve: boolean;
  isGroup: boolean;
  get_key(): string;
  constructor(): this;
...
declare class ApplicationPages$ClientPeoplePickerQueryParameters
  mixins SP$SP$ClientValueObject {
  ...
  get_principalSource(): SP$Utilities.Utilities$PrincipalSource;
  set_principalSource(value: SP$Utilities.Utilities$PrincipalSource): void;
  get_principalType(): SP$Utilities.Utilities$PrincipalType;
  set_principalType(value: SP$Utilities.Utilities$PrincipalType): void;
  ...
  get_urlZone(): SP$SP$UrlZone;
  set_urlZone(value: SP$SP$UrlZone): void;
  get_urlZoneSpecified(): boolean;
  set_urlZoneSpecified(value: boolean): void;
  get_web(): SP$SP$Web;
  set_web(value: SP$SP$Web): void;
  get_webApplicationID(): SP$SP$Guid;
  set_webApplicationID(value: SP$SP$Guid): void;
  get_typeId(): string;
  writeToXml(
    writer: SP$SP$XmlWriter,
    serializationContext: SP$SP$SerializationContext
...
declare class ApplicationPages$ClientPeoplePickerWebServiceInterface {
  static clientPeoplePickerSearchUser(
    context: SP$SP$ClientRuntimeContext,
    queryParams: SP$UI.ApplicationPages.ApplicationPages$ClientPeoplePickerQueryParameters
  ): SP$SP$StringResult;
...
declare class ApplicationPages$PeoplePickerWebServiceInterface {
...
declare class Video$VideoSet mixins DocumentSet$DocumentSet$DocumentSet {
  ...
  static getEmbedCode(
    context: SP$ClientContext,
    videoPath: string,
    properties: Video$EmbedCodeConfiguration
  ): SP$StringResult;
...
declare class Taxonomy$StringMatchOption {
  constructor(...args: empty): mixed;
  static +startsWith: Class<Taxonomy$StringMatchOption__startsWith> &
    Taxonomy$StringMatchOption__startsWith &
    0; // 0
  static +exactMatch: Class<Taxonomy$StringMatchOption__exactMatch> &
    Taxonomy$StringMatchOption__exactMatch &
    1; // 1
}

declare class Taxonomy$StringMatchOption__startsWith
  mixins Taxonomy$StringMatchOption {}
declare class Taxonomy$StringMatchOption__exactMatch
  mixins Taxonomy$StringMatchOption {}

declare class Taxonomy$ChangeItemType {
  constructor(...args: empty): mixed;
  static +unknown: Class<Taxonomy$ChangeItemType__unknown> &
    Taxonomy$ChangeItemType__unknown &
    0; // 0
  static +term: Class<Taxonomy$ChangeItemType__term> &
    Taxonomy$ChangeItemType__term &
    1; // 1
  static +termSet: Class<Taxonomy$ChangeItemType__termSet> &
    Taxonomy$ChangeItemType__termSet &
    2; // 2
  static +group: Class<Taxonomy$ChangeItemType__group> &
    Taxonomy$ChangeItemType__group &
    3; // 3
  static +termStore: Class<Taxonomy$ChangeItemType__termStore> &
    Taxonomy$ChangeItemType__termStore &
    4; // 4
  static +site: Class<Taxonomy$ChangeItemType__site> &
    Taxonomy$ChangeItemType__site &
    5; // 5
}
...
declare class Taxonomy$ChangeItemType__termStore
  mixins Taxonomy$ChangeItemType {}
declare class Taxonomy$ChangeItemType__site mixins Taxonomy$ChangeItemType {}

declare class Taxonomy$ChangeOperationType {
  constructor(...args: empty): mixed;
  static +unknown: Class<Taxonomy$ChangeOperationType__unknown> &
    Taxonomy$ChangeOperationType__unknown &
    0; // 0
  static +add: Class<Taxonomy$ChangeOperationType__add> &
    Taxonomy$ChangeOperationType__add &
    1; // 1
  static +edit: Class<Taxonomy$ChangeOperationType__edit> &
    Taxonomy$ChangeOperationType__edit &
    2; // 2
  static +deleteObject: Class<Taxonomy$ChangeOperationType__deleteObject> &
    Taxonomy$ChangeOperationType__deleteObject &
    3; // 3
  static +move: Class<Taxonomy$ChangeOperationType__move> &
    Taxonomy$ChangeOperationType__move &
    4; // 4
  static +copy: Class<Taxonomy$ChangeOperationType__copy> &
    Taxonomy$ChangeOperationType__copy &
    5; // 5
  static +pathChange: Class<Taxonomy$ChangeOperationType__pathChange> &
    Taxonomy$ChangeOperationType__pathChange &
    6; // 6
  static +merge: Class<Taxonomy$ChangeOperationType__merge> &
    Taxonomy$ChangeOperationType__merge &
    7; // 7
  static +importObject: Class<Taxonomy$ChangeOperationType__importObject> &
    Taxonomy$ChangeOperationType__importObject &
    8; // 8
  static +restore: Class<Taxonomy$ChangeOperationType__restore> &
    Taxonomy$ChangeOperationType__restore &
    9; // 9
}

declare class Taxonomy$ChangeOperationType__unknown
  mixins Taxonomy$ChangeOperationType {}
declare class Taxonomy$ChangeOperationType__add
  mixins Taxonomy$ChangeOperationType {}
declare class Taxonomy$ChangeOperationType__edit
  mixins Taxonomy$ChangeOperationType {}
declare class Taxonomy$ChangeOperationType__deleteObject
  mixins Taxonomy$ChangeOperationType {}
declare class Taxonomy$ChangeOperationType__move
  mixins Taxonomy$ChangeOperationType {}
declare class Taxonomy$ChangeOperationType__copy
  mixins Taxonomy$ChangeOperationType {}
declare class Taxonomy$ChangeOperationType__pathChange
  mixins Taxonomy$ChangeOperationType {}
declare class Taxonomy$ChangeOperationType__merge
  mixins Taxonomy$ChangeOperationType {}
declare class Taxonomy$ChangeOperationType__importObject
  mixins Taxonomy$ChangeOperationType {}
declare class Taxonomy$ChangeOperationType__restore
  mixins Taxonomy$ChangeOperationType {}
...
declare class Taxonomy$CustomPropertyMatchInformation
  mixins SP$SP$ClientObject {
  constructor(context: SP$SP$ClientContext): this;
...
declare class Taxonomy$TaxonomyFieldValueCollection
  mixins SP$SP$ClientObjectCollection<Taxonomy$TaxonomyFieldValue> {
  constructor(
    context: SP$SP$ClientContext,
    fieldValue: string,
    creatingField: SP$SP$Field
  ): this;
...
declare class Social$SocialActorType {
  constructor(...args: empty): mixed;
  static +user: Class<Social$SocialActorType__user> &
    Social$SocialActorType__user &
    0; // 0
  static +document: Class<Social$SocialActorType__document> &
    Social$SocialActorType__document &
    1; // 1
  static +site: Class<Social$SocialActorType__site> &
    Social$SocialActorType__site &
    2; // 2
  static +tag: Class<Social$SocialActorType__tag> &
    Social$SocialActorType__tag &
    3; // 3
}
...
declare class Social$SocialActorTypes {
  constructor(...args: empty): mixed;
  static +none: Class<Social$SocialActorTypes__none> &
    Social$SocialActorTypes__none &
    0; // 0
  static +users: Class<Social$SocialActorTypes__users> &
    Social$SocialActorTypes__users &
    1; // 1
  static +documents: Class<Social$SocialActorTypes__documents> &
    Social$SocialActorTypes__documents &
    2; // 2
  static +sites: Class<Social$SocialActorTypes__sites> &
    Social$SocialActorTypes__sites &
    3; // 3
  static +tags: Class<Social$SocialActorTypes__tags> &
    Social$SocialActorTypes__tags &
    4; // 4
  static +excludeContentWithoutFeeds: Class<Social$SocialActorTypes__excludeContentWithoutFeeds> &
    Social$SocialActorTypes__excludeContentWithoutFeeds &
    5; // 5
  static +all: Class<Social$SocialActorTypes__all> &
    Social$SocialActorTypes__all &
    6; // 6
}
...
declare class Social$SocialActorTypes__documents
  mixins Social$SocialActorTypes {}
...
declare class Social$SocialActorTypes__excludeContentWithoutFeeds
  mixins Social$SocialActorTypes {}
...
declare class Social$SocialAttachmentActionKind {
  constructor(...args: empty): mixed;
  static +navigate: Class<Social$SocialAttachmentActionKind__navigate> &
    Social$SocialAttachmentActionKind__navigate &
    0; // 0
  static +adHocAction: Class<Social$SocialAttachmentActionKind__adHocAction> &
    Social$SocialAttachmentActionKind__adHocAction &
    1; // 1
}

declare class Social$SocialAttachmentActionKind__navigate
  mixins Social$SocialAttachmentActionKind {}
declare class Social$SocialAttachmentActionKind__adHocAction
  mixins Social$SocialAttachmentActionKind {}

declare class Social$SocialAttachmentKind {
  constructor(...args: empty): mixed;
  static +image: Class<Social$SocialAttachmentKind__image> &
    Social$SocialAttachmentKind__image &
    0; // 0
  static +video: Class<Social$SocialAttachmentKind__video> &
    Social$SocialAttachmentKind__video &
    1; // 1
  static +document: Class<Social$SocialAttachmentKind__document> &
    Social$SocialAttachmentKind__document &
    2; // 2
}

declare class Social$SocialAttachmentKind__image
  mixins Social$SocialAttachmentKind {}
declare class Social$SocialAttachmentKind__video
  mixins Social$SocialAttachmentKind {}
declare class Social$SocialAttachmentKind__document
  mixins Social$SocialAttachmentKind {}
...
declare class Social$SocialDataItemType {
  constructor(...args: empty): mixed;
  static +user: Class<Social$SocialDataItemType__user> &
    Social$SocialDataItemType__user &
    0; // 0
  static +document: Class<Social$SocialDataItemType__document> &
    Social$SocialDataItemType__document &
    1; // 1
  static +site: Class<Social$SocialDataItemType__site> &
    Social$SocialDataItemType__site &
    2; // 2
  static +tag: Class<Social$SocialDataItemType__tag> &
    Social$SocialDataItemType__tag &
    3; // 3
  static +link: Class<Social$SocialDataItemType__link> &
    Social$SocialDataItemType__link &
    4; // 4
}

declare class Social$SocialDataItemType__user
  mixins Social$SocialDataItemType {}
declare class Social$SocialDataItemType__document
  mixins Social$SocialDataItemType {}
declare class Social$SocialDataItemType__site
  mixins Social$SocialDataItemType {}
declare class Social$SocialDataItemType__tag mixins Social$SocialDataItemType {}
declare class Social$SocialDataItemType__link
  mixins Social$SocialDataItemType {}
...
declare class Social$SocialDataOverlayType {
  constructor(...args: empty): mixed;
  static +link: Class<Social$SocialDataOverlayType__link> &
    Social$SocialDataOverlayType__link &
    0; // 0
  static +actors: Class<Social$SocialDataOverlayType__actors> &
    Social$SocialDataOverlayType__actors &
    1; // 1
}

declare class Social$SocialDataOverlayType__link
  mixins Social$SocialDataOverlayType {}
declare class Social$SocialDataOverlayType__actors
  mixins Social$SocialDataOverlayType {}
...
declare class Social$SocialFeedSortOrder {
  constructor(...args: empty): mixed;
  static +byModifiedTime: Class<Social$SocialFeedSortOrder__byModifiedTime> &
    Social$SocialFeedSortOrder__byModifiedTime &
    0; // 0
  static +byCreatedTime: Class<Social$SocialFeedSortOrder__byCreatedTime> &
    Social$SocialFeedSortOrder__byCreatedTime &
    1; // 1
}

declare class Social$SocialFeedSortOrder__byModifiedTime
  mixins Social$SocialFeedSortOrder {}
declare class Social$SocialFeedSortOrder__byCreatedTime
  mixins Social$SocialFeedSortOrder {}
...
declare class Social$SocialFeedType {
  constructor(...args: empty): mixed;
  static +personal: Class<Social$SocialFeedType__personal> &
    Social$SocialFeedType__personal &
    0; // 0
  static +news: Class<Social$SocialFeedType__news> &
    Social$SocialFeedType__news &
    1; // 1
  static +timeline: Class<Social$SocialFeedType__timeline> &
    Social$SocialFeedType__timeline &
    2; // 2
  static +likes: Class<Social$SocialFeedType__likes> &
    Social$SocialFeedType__likes &
    3; // 3
  static +everyone: Class<Social$SocialFeedType__everyone> &
    Social$SocialFeedType__everyone &
    4; // 4
}
...
declare class Social$SocialFeedAttributes {
  constructor(...args: empty): mixed;
  static +none: Class<Social$SocialFeedAttributes__none> &
    Social$SocialFeedAttributes__none &
    0; // 0
  static +moreThreadsAvailable: Class<Social$SocialFeedAttributes__moreThreadsAvailable> &
    Social$SocialFeedAttributes__moreThreadsAvailable &
    1; // 1
}

declare class Social$SocialFeedAttributes__none
  mixins Social$SocialFeedAttributes {}
declare class Social$SocialFeedAttributes__moreThreadsAvailable
  mixins Social$SocialFeedAttributes {}
...
declare class Social$SocialPostAttributes {
  constructor(...args: empty): mixed;
  static +none: Class<Social$SocialPostAttributes__none> &
    Social$SocialPostAttributes__none &
    0; // 0
  static +canLike: Class<Social$SocialPostAttributes__canLike> &
    Social$SocialPostAttributes__canLike &
    1; // 1
  static +canDelete: Class<Social$SocialPostAttributes__canDelete> &
    Social$SocialPostAttributes__canDelete &
    2; // 2
  static +useAuthorImage: Class<Social$SocialPostAttributes__useAuthorImage> &
    Social$SocialPostAttributes__useAuthorImage &
    3; // 3
  static +useSmallImage: Class<Social$SocialPostAttributes__useSmallImage> &
    Social$SocialPostAttributes__useSmallImage &
    4; // 4
  static +canFollowUp: Class<Social$SocialPostAttributes__canFollowUp> &
    Social$SocialPostAttributes__canFollowUp &
    5; // 5
}

declare class Social$SocialPostAttributes__none
  mixins Social$SocialPostAttributes {}
declare class Social$SocialPostAttributes__canLike
  mixins Social$SocialPostAttributes {}
declare class Social$SocialPostAttributes__canDelete
  mixins Social$SocialPostAttributes {}
declare class Social$SocialPostAttributes__useAuthorImage
  mixins Social$SocialPostAttributes {}
declare class Social$SocialPostAttributes__useSmallImage
  mixins Social$SocialPostAttributes {}
declare class Social$SocialPostAttributes__canFollowUp
  mixins Social$SocialPostAttributes {}
...
declare class Social$SocialPostDefinitionDataItemType {
  constructor(...args: empty): mixed;
  static +text: Class<Social$SocialPostDefinitionDataItemType__text> &
    Social$SocialPostDefinitionDataItemType__text &
    0; // 0
  static +user: Class<Social$SocialPostDefinitionDataItemType__user> &
    Social$SocialPostDefinitionDataItemType__user &
    1; // 1
  static +document: Class<Social$SocialPostDefinitionDataItemType__document> &
    Social$SocialPostDefinitionDataItemType__document &
    2; // 2
  static +site: Class<Social$SocialPostDefinitionDataItemType__site> &
    Social$SocialPostDefinitionDataItemType__site &
    3; // 3
  static +tag: Class<Social$SocialPostDefinitionDataItemType__tag> &
    Social$SocialPostDefinitionDataItemType__tag &
    4; // 4
  static +link: Class<Social$SocialPostDefinitionDataItemType__link> &
    Social$SocialPostDefinitionDataItemType__link &
    5; // 5
}

declare class Social$SocialPostDefinitionDataItemType__text
  mixins Social$SocialPostDefinitionDataItemType {}
declare class Social$SocialPostDefinitionDataItemType__user
  mixins Social$SocialPostDefinitionDataItemType {}
declare class Social$SocialPostDefinitionDataItemType__document
  mixins Social$SocialPostDefinitionDataItemType {}
declare class Social$SocialPostDefinitionDataItemType__site
  mixins Social$SocialPostDefinitionDataItemType {}
declare class Social$SocialPostDefinitionDataItemType__tag
  mixins Social$SocialPostDefinitionDataItemType {}
declare class Social$SocialPostDefinitionDataItemType__link
  mixins Social$SocialPostDefinitionDataItemType {}

declare class Social$SocialPostType {
  constructor(...args: empty): mixed;
  static +root: Class<Social$SocialPostType__root> &
    Social$SocialPostType__root &
    0; // 0
  static +reply: Class<Social$SocialPostType__reply> &
    Social$SocialPostType__reply &
    1; // 1
}
...
declare class Social$SocialStatusCode {
  constructor(...args: empty): mixed;
  static +OK: Class<Social$SocialStatusCode__OK> &
    Social$SocialStatusCode__OK &
    0; // 0
  static +invalidRequest: Class<Social$SocialStatusCode__invalidRequest> &
    Social$SocialStatusCode__invalidRequest &
    1; // 1
  static +accessDenied: Class<Social$SocialStatusCode__accessDenied> &
    Social$SocialStatusCode__accessDenied &
    2; // 2
  static +itemNotFound: Class<Social$SocialStatusCode__itemNotFound> &
    Social$SocialStatusCode__itemNotFound &
    3; // 3
  static +invalidOperation: Class<Social$SocialStatusCode__invalidOperation> &
    Social$SocialStatusCode__invalidOperation &
    4; // 4
  static +itemNotModified: Class<Social$SocialStatusCode__itemNotModified> &
    Social$SocialStatusCode__itemNotModified &
    5; // 5
  static +internalError: Class<Social$SocialStatusCode__internalError> &
    Social$SocialStatusCode__internalError &
    6; // 6
  static +cacheReadError: Class<Social$SocialStatusCode__cacheReadError> &
    Social$SocialStatusCode__cacheReadError &
    7; // 7
  static +cacheUpdateError: Class<Social$SocialStatusCode__cacheUpdateError> &
    Social$SocialStatusCode__cacheUpdateError &
    8; // 8
  static +personalSiteNotFound: Class<Social$SocialStatusCode__personalSiteNotFound> &
    Social$SocialStatusCode__personalSiteNotFound &
    9; // 9
  static +failedToCreatePersonalSite: Class<Social$SocialStatusCode__failedToCreatePersonalSite> &
    Social$SocialStatusCode__failedToCreatePersonalSite &
    10; // 10
  static +notAuthorizedToCreatePersonalSite: Class<Social$SocialStatusCode__notAuthorizedToCreatePersonalSite> &
    Social$SocialStatusCode__notAuthorizedToCreatePersonalSite &
    11; // 11
  static +cannotCreatePersonalSite: Class<Social$SocialStatusCode__cannotCreatePersonalSite> &
    Social$SocialStatusCode__cannotCreatePersonalSite &
    12; // 12
  static +limitReached: Class<Social$SocialStatusCode__limitReached> &
    Social$SocialStatusCode__limitReached &
    13; // 13
  static +attachmentError: Class<Social$SocialStatusCode__attachmentError> &
    Social$SocialStatusCode__attachmentError &
    14; // 14
  static +partialData: Class<Social$SocialStatusCode__partialData> &
    Social$SocialStatusCode__partialData &
    15; // 15
  static +featureDisabled: Class<Social$SocialStatusCode__featureDisabled> &
    Social$SocialStatusCode__featureDisabled &
    16; // 16
}

declare class Social$SocialStatusCode__OK mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__invalidRequest
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__accessDenied
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__itemNotFound
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__invalidOperation
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__itemNotModified
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__internalError
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__cacheReadError
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__cacheUpdateError
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__personalSiteNotFound
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__failedToCreatePersonalSite
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__notAuthorizedToCreatePersonalSite
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__cannotCreatePersonalSite
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__limitReached
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__attachmentError
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__partialData
  mixins Social$SocialStatusCode {}
declare class Social$SocialStatusCode__featureDisabled
  mixins Social$SocialStatusCode {}
...
declare class Social$SocialThreadAttributes {
  constructor(...args: empty): mixed;
  static +none: Class<Social$SocialThreadAttributes__none> &
    Social$SocialThreadAttributes__none &
    0; // 0
  static +isDigest: Class<Social$SocialThreadAttributes__isDigest> &
    Social$SocialThreadAttributes__isDigest &
    1; // 1
  static +canReply: Class<Social$SocialThreadAttributes__canReply> &
    Social$SocialThreadAttributes__canReply &
    2; // 2
  static +canLock: Class<Social$SocialThreadAttributes__canLock> &
    Social$SocialThreadAttributes__canLock &
    3; // 3
  static +isLocked: Class<Social$SocialThreadAttributes__isLocked> &
    Social$SocialThreadAttributes__isLocked &
    4; // 4
  static +replyLimitReached: Class<Social$SocialThreadAttributes__replyLimitReached> &
    Social$SocialThreadAttributes__replyLimitReached &
    5; // 5
}

declare class Social$SocialThreadAttributes__none
  mixins Social$SocialThreadAttributes {}
declare class Social$SocialThreadAttributes__isDigest
  mixins Social$SocialThreadAttributes {}
declare class Social$SocialThreadAttributes__canReply
  mixins Social$SocialThreadAttributes {}
declare class Social$SocialThreadAttributes__canLock
  mixins Social$SocialThreadAttributes {}
declare class Social$SocialThreadAttributes__isLocked
  mixins Social$SocialThreadAttributes {}
declare class Social$SocialThreadAttributes__replyLimitReached
  mixins Social$SocialThreadAttributes {}

declare class Social$SocialThreadType {
  constructor(...args: empty): mixed;
  static +normal: Class<Social$SocialThreadType__normal> &
    Social$SocialThreadType__normal &
    0; // 0
  static +likeReference: Class<Social$SocialThreadType__likeReference> &
    Social$SocialThreadType__likeReference &
    1; // 1
  static +replyReference: Class<Social$SocialThreadType__replyReference> &
    Social$SocialThreadType__replyReference &
    2; // 2
  static +mentionReference: Class<Social$SocialThreadType__mentionReference> &
    Social$SocialThreadType__mentionReference &
    3; // 3
  static +tagReference: Class<Social$SocialThreadType__tagReference> &
    Social$SocialThreadType__tagReference &
    4; // 4
}

declare class Social$SocialThreadType__normal mixins Social$SocialThreadType {}
declare class Social$SocialThreadType__likeReference
  mixins Social$SocialThreadType {}
declare class Social$SocialThreadType__replyReference
  mixins Social$SocialThreadType {}
declare class Social$SocialThreadType__mentionReference
  mixins Social$SocialThreadType {}
declare class Social$SocialThreadType__tagReference
  mixins Social$SocialThreadType {}
...
declare class Social$SocialAttachment mixins SP$SP$ClientValueObject {
   ...
   */
  set_attachmentKind(
    value: Social$SocialAttachmentKind
  ): Social$SocialAttachmentKind;
...
declare class Social$SocialAttachmentAction mixins SP$SP$ClientValueObject {
   ...
   */
  set_actionKind(
    value: Social$SocialAttachmentActionKind
  ): Social$SocialAttachmentActionKind;
 ...
 * This type can only be specified in a server-to-server call.
 */
declare class Social$SocialPostDefinitionDataItem
  mixins SP$SP$ClientValueObject {
  /**
   ...
   */
  set_itemType(
    value: Social$SocialPostDefinitionDataItemType
  ): Social$SocialPostDefinitionDataItemType;
...
declare class Sharing$DocumentSharingManager {
  ...
  static updateDocumentSharingInfo(
    ...
    userRoleAssignments: SP$Sharing.Sharing$UserRoleAssignment[],
  ...
  ): SP$Sharing.Sharing$UserSharingResult[];
}
...
declare class Sharing$UserRoleAssignment mixins SP$SP$ClientValueObject {
  get_role(): SP$Sharing.Sharing$Role;
  set_role(value: SP$Sharing.Sharing$Role): void;
  get_userId(): string;
...
declare class Sharing$UserSharingResult mixins SP$SP$ClientValueObject {
  get_allowedRoles(): SP$Sharing.Sharing$Role[];
  get_currentRole(): SP$Sharing.Sharing$Role;
...
declare class Runtime$EntityEventType {
  constructor(...args: empty): mixed;
  static +none: Class<Runtime$EntityEventType__none> &
    Runtime$EntityEventType__none &
    0; // 0
  static +itemAdded: Class<Runtime$EntityEventType__itemAdded> &
    Runtime$EntityEventType__itemAdded &
    1; // 1
  static +itemUpdated: Class<Runtime$EntityEventType__itemUpdated> &
    Runtime$EntityEventType__itemUpdated &
    2; // 2
  static +itemDeleted: Class<Runtime$EntityEventType__itemDeleted> &
    Runtime$EntityEventType__itemDeleted &
    3; // 3
}

declare class Runtime$EntityEventType__none mixins Runtime$EntityEventType {}
declare class Runtime$EntityEventType__itemAdded
  mixins Runtime$EntityEventType {}
declare class Runtime$EntityEventType__itemUpdated
  mixins Runtime$EntityEventType {}
declare class Runtime$EntityEventType__itemDeleted
  mixins Runtime$EntityEventType {}
...
declare class Runtime$EntityIdentity mixins SP$SP$ClientObject {
  ...
  static newObject(
    context: SP$SP$ClientRuntimeContext,
    identifierValues: any[]
  ): SP$BusinessData.Runtime.Runtime$EntityIdentity;
  refreshLoad(): void;
}
...
declare class Runtime$EntityInstance mixins SP$SP$ClientObject {
  ...
  createCollectionInstance(fieldDotNotation: string, size: number): void;
  getIdentity(): SP$BusinessData.Runtime.Runtime$EntityIdentity;
  deleteObject(): void;
  update(): void;
  fromXml(xml: string): void;
  toXml(): SP$SP$StringResult;
...
declare class Runtime$NotificationCallback mixins SP$SP$ClientObject {
  ...
  static newObject(
    context: SP$SP$ClientRuntimeContext,
    notificationEndpoint: string
  ): SP$BusinessData.Runtime.Runtime$NotificationCallback;
}
...
declare class Runtime$Subscription mixins SP$SP$ClientObject {
  ...
  static newObject(
    ...
    id: any,
    hash: string
  ): SP$BusinessData.Runtime.Runtime$Subscription;
}
declare class Infrastructure$ExternalSubscriptionStore
  mixins SP$SP$ClientObject {
  constructor(context: SP$SP$ClientRuntimeContext, web: SP$SP$Web): this;
  static newObject(
    context: SP$SP$ClientRuntimeContext,
    web: SP$SP$Web
  ): SP$BusinessData.Infrastructure.Infrastructure$ExternalSubscriptionStore;
  indexStore(): void;
}
declare type Collections$EntityFieldCollection = {
  itemAt(index: number): SP$BusinessData.BusinessData$EntityField,
  get_item(index: number): SP$BusinessData.BusinessData$EntityField
} & SP$SP$ClientObjectCollection<SP$BusinessData.BusinessData$EntityField>;

declare type Collections$EntityIdentifierCollection = {
  itemAt(index: number): SP$BusinessData.BusinessData$EntityIdentifier,
  get_item(index: number): SP$BusinessData.BusinessData$EntityIdentifier
} & SP$SP$ClientObjectCollection<SP$BusinessData.BusinessData$EntityIdentifier>;

declare type Collections$EntityInstanceCollection = {
  itemAt(index: number): SP$BusinessData.Runtime.Runtime$EntityInstance,
  get_item(index: number): SP$BusinessData.Runtime.Runtime$EntityInstance
} & SP$SP$ClientObjectCollection<SP$BusinessData.Runtime.Runtime$EntityInstance>;

declare type Collections$FilterCollection = {
  itemAt(index: number): SP$BusinessData.BusinessData$Filter,
  get_item(index: number): SP$BusinessData.BusinessData$Filter,
  setFilterValue(inputFilterName: string, valueIndex: number, value: any): void
} & SP$SP$ClientObjectCollection<SP$BusinessData.BusinessData$Filter>;

declare type Collections$LobSystemInstanceCollection = {
  itemAt(index: number): SP$BusinessData.BusinessData$LobSystemInstance,
  get_item(index: number): SP$BusinessData.BusinessData$LobSystemInstance
} & SP$SP$ClientObjectCollection<SP$BusinessData.BusinessData$LobSystemInstance>;

declare type Collections$TypeDescriptorCollection = {
  itemAt(index: number): SP$BusinessData.BusinessData$TypeDescriptor,
  get_item(index: number): SP$BusinessData.BusinessData$TypeDescriptor
} & SP$SP$ClientObjectCollection<SP$BusinessData.BusinessData$TypeDescriptor>;
...
declare class BusinessData$Entity mixins SP$SP$ClientObject {
  ...
  getIdentifiers(): SP$BusinessData.Collections.Collections$EntityIdentifierCollection;
  getIdentifierCount(): SP$SP$IntResult;
  getLobSystem(): SP$BusinessData.BusinessData$LobSystem;
  getCreatorView(
    methodInstanceName: string
  ): SP$BusinessData.BusinessData$EntityView;
  getUpdaterView(updaterName: string): SP$BusinessData.BusinessData$EntityView;
  getFinderView(
    methodInstanceName: string
  ): SP$BusinessData.BusinessData$EntityView;
  ...
  getDefaultSpecificFinderView(): SP$BusinessData.BusinessData$EntityView;
  findSpecificDefault(
    identity: SP$BusinessData.Runtime.Runtime$EntityIdentity,
    lobSystemInstance: SP$BusinessData.BusinessData$LobSystemInstance
  ): SP$BusinessData.Runtime.Runtime$EntityInstance;
  findSpecific(
    identity: SP$BusinessData.Runtime.Runtime$EntityIdentity,
    specificFinderName: string,
    lobSystemInstance: SP$BusinessData.BusinessData$LobSystemInstance
  ...
  findFiltered(
    filterList: SP$BusinessData.Collections.Collections$FilterCollection,
    nameOfFinder: string,
    lobSystemInstance: SP$BusinessData.BusinessData$LobSystemInstance
  ): SP$BusinessData.Collections.Collections$EntityInstanceCollection;
  findAssociated(
    entityInstance: SP$BusinessData.Runtime.Runtime$EntityInstance,
    associationName: string,
    filterList: SP$BusinessData.Collections.Collections$FilterCollection,
    lobSystemInstance: SP$BusinessData.BusinessData$LobSystemInstance
  ): SP$BusinessData.Collections.Collections$EntityInstanceCollection;
  getFilters(
    methodInstanceName: string
  ): SP$BusinessData.Collections.Collections$FilterCollection;
  execute(
    methodInstanceName: string,
    lobSystemInstance: SP$BusinessData.BusinessData$LobSystemInstance,
    inputParams: any[]
  ): SP$BusinessData.BusinessData$MethodExecutionResult;
  getAssociationView(
    associationName: string
  ): SP$BusinessData.BusinessData$EntityView;
  create(
    fieldValues: SP$BusinessData.Runtime.Runtime$EntityFieldValueDictionary,
    lobSystemInstance: SP$BusinessData.BusinessData$LobSystemInstance
  ): SP$BusinessData.Runtime.Runtime$EntityIdentity;
  subscribe(
    eventType: SP$BusinessData.Runtime.Runtime$EntityEventType,
    notificationCallback: SP$BusinessData.Runtime.Runtime$NotificationCallback,
    onBehalfOfUser: string,
    subscriberName: string,
    lobSystemInstance: SP$BusinessData.BusinessData$LobSystemInstance
  ): SP$BusinessData.Runtime.Runtime$Subscription;
  unsubscribe(
    subscription: SP$BusinessData.Runtime.Runtime$Subscription,
    onBehalfOfUser: string,
...
declare class BusinessData$EntityView mixins SP$SP$ClientObject {
  get_fields(): SP$BusinessData.Collections.Collections$EntityFieldCollection;
  get_name(): string;
  get_relatedSpecificFinderName(): string;
  getDefaultValues(): SP$BusinessData.Runtime.Runtime$EntityFieldValueDictionary;
  getXmlSchema(): SP$SP$StringResult;
  getTypeDescriptor(
    fieldDotNotation: string
  ): SP$BusinessData.BusinessData$TypeDescriptor;
...
declare class BusinessData$LobSystem mixins SP$SP$ClientObject {
  get_name(): string;
  getLobSystemInstances(): SP$BusinessData.Collections.Collections$LobSystemInstanceCollection;
}
...
declare class BusinessData$MethodExecutionResult mixins SP$SP$ClientObject {
  get_returnParameterCollection(): SP$BusinessData.BusinessData$ReturnParameterCollection;
}

declare type BusinessData$ReturnParameterCollection = {
  itemAt(
    index: number
  ): SP$BusinessData.Runtime.Runtime$EntityFieldValueDictionary,
  get_item(
    index: number
  ): SP$BusinessData.Runtime.Runtime$EntityFieldValueDictionary
} & SP$SP$ClientObjectCollection<SP$BusinessData.Runtime.Runtime$EntityFieldValueDictionary>;
...
declare class BusinessData$TypeDescriptor mixins SP$SP$ClientObject {
  ...
  getChildTypeDescriptors(): SP$BusinessData.Collections.Collections$TypeDescriptorCollection;
  getParentTypeDescriptor(): SP$BusinessData.BusinessData$TypeDescriptor;
}
...
declare class Analytics$EventTypeId {
  constructor(...args: empty): mixed;
  static +none: Class<Analytics$EventTypeId__none> &
    Analytics$EventTypeId__none &
    0; // 0
  static +first: Class<Analytics$EventTypeId__first> &
    Analytics$EventTypeId__first &
    1; // 1
  static +view: Class<Analytics$EventTypeId__view> &
    Analytics$EventTypeId__view &
    2; // 2
  static +recommendationView: Class<Analytics$EventTypeId__recommendationView> &
    Analytics$EventTypeId__recommendationView &
    3; // 3
  static +recommendationClick: Class<Analytics$EventTypeId__recommendationClick> &
    Analytics$EventTypeId__recommendationClick &
    4; // 4
  static +last: Class<Analytics$EventTypeId__last> &
    Analytics$EventTypeId__last &
    5; // 5
}
...
declare class Analytics$EventTypeId__recommendationView
  mixins Analytics$EventTypeId {}
declare class Analytics$EventTypeId__recommendationClick
  mixins Analytics$EventTypeId {}
declare class Analytics$EventTypeId__last mixins Analytics$EventTypeId {}
declare class Portability$SearchConfigurationPortability
  mixins SP$SP$ClientObject {
  constructor(context: SP$SP$ClientContext): this;
  get_importWarnings: () => string;
  exportSearchConfiguration: (
    owningScope: Administration$Administration$SearchObjectOwner
  ) => SP$SP$JsonObjectResult;
...
declare class Administration$SearchObjectLevel {
  constructor(...args: empty): mixed;
  static +spWeb: Class<Administration$SearchObjectLevel__spWeb> &
    Administration$SearchObjectLevel__spWeb &
    0; // 0
  static +spSite: Class<Administration$SearchObjectLevel__spSite> &
    Administration$SearchObjectLevel__spSite &
    1; // 1
  static +spSiteSubscription: Class<Administration$SearchObjectLevel__spSiteSubscription> &
    Administration$SearchObjectLevel__spSiteSubscription &
    2; // 2
  static +ssa: Class<Administration$SearchObjectLevel__ssa> &
    Administration$SearchObjectLevel__ssa &
    3; // 3
}

declare class Administration$SearchObjectLevel__spWeb
  mixins Administration$SearchObjectLevel {}
declare class Administration$SearchObjectLevel__spSite
  mixins Administration$SearchObjectLevel {}
declare class Administration$SearchObjectLevel__spSiteSubscription
  mixins Administration$SearchObjectLevel {}
declare class Administration$SearchObjectLevel__ssa
  mixins Administration$SearchObjectLevel {}
...
declare class WebControls$MessageLevel {
  constructor(...args: empty): mixed;
  static +information: Class<WebControls$MessageLevel__information> &
    WebControls$MessageLevel__information &
    0; // 0
  static +warning: Class<WebControls$MessageLevel__warning> &
    WebControls$MessageLevel__warning &
    1; // 1
  static +error: Class<WebControls$MessageLevel__error> &
    WebControls$MessageLevel__error &
    2; // 2
}

declare class WebControls$MessageLevel__information
  mixins WebControls$MessageLevel {}
declare class WebControls$MessageLevel__warning
  mixins WebControls$MessageLevel {}
...
declare class Query$StringCollection
  mixins SP$SP$ClientObjectCollection<string> {
  constructor(context: SP$SP$ClientContext): this;
  itemAt(index: number): string;
  get_item(index: number): string;
...
declare class Query$QueryPropertyValueType {
  constructor(...args: empty): mixed;
  static +none: Class<Query$QueryPropertyValueType__none> &
    Query$QueryPropertyValueType__none &
    0; // 0
  static +stringType: Class<Query$QueryPropertyValueType__stringType> &
    Query$QueryPropertyValueType__stringType &
    1; // 1
  static +int32TYpe: Class<Query$QueryPropertyValueType__int32TYpe> &
    Query$QueryPropertyValueType__int32TYpe &
    2; // 2
  static +booleanType: Class<Query$QueryPropertyValueType__booleanType> &
    Query$QueryPropertyValueType__booleanType &
    3; // 3
  static +stringArrayType: Class<Query$QueryPropertyValueType__stringArrayType> &
    Query$QueryPropertyValueType__stringArrayType &
    4; // 4
  static +unSupportedType: Class<Query$QueryPropertyValueType__unSupportedType> &
    Query$QueryPropertyValueType__unSupportedType &
    5; // 5
}

declare class Query$QueryPropertyValueType__none
  mixins Query$QueryPropertyValueType {}
declare class Query$QueryPropertyValueType__stringType
  mixins Query$QueryPropertyValueType {}
declare class Query$QueryPropertyValueType__int32TYpe
  mixins Query$QueryPropertyValueType {}
declare class Query$QueryPropertyValueType__booleanType
  mixins Query$QueryPropertyValueType {}
declare class Query$QueryPropertyValueType__stringArrayType
  mixins Query$QueryPropertyValueType {}
declare class Query$QueryPropertyValueType__unSupportedType
  mixins Query$QueryPropertyValueType {}
...
declare class Query$QueryUtility {
  ...
  static getQueryPropertyValueType: (
    val: Query$QueryPropertyValue
  ) => Query$QueryPropertyValueType;
...
declare class Query$ReorderingRuleMatchType {
  constructor(...args: empty): mixed;
  static +resultContainsKeyword: Class<Query$ReorderingRuleMatchType__resultContainsKeyword> &
    Query$ReorderingRuleMatchType__resultContainsKeyword &
    0; // 0
  static +titleContainsKeyword: Class<Query$ReorderingRuleMatchType__titleContainsKeyword> &
    Query$ReorderingRuleMatchType__titleContainsKeyword &
    1; // 1
  static +titleMatchesKeyword: Class<Query$ReorderingRuleMatchType__titleMatchesKeyword> &
    Query$ReorderingRuleMatchType__titleMatchesKeyword &
    2; // 2
  static +urlStartsWith: Class<Query$ReorderingRuleMatchType__urlStartsWith> &
    Query$ReorderingRuleMatchType__urlStartsWith &
    3; // 3
  static +urlExactlyMatches: Class<Query$ReorderingRuleMatchType__urlExactlyMatches> &
    Query$ReorderingRuleMatchType__urlExactlyMatches &
    4; // 4
  static +contentTypeIs: Class<Query$ReorderingRuleMatchType__contentTypeIs> &
    Query$ReorderingRuleMatchType__contentTypeIs &
    5; // 5
  static +fileExtensionMatches: Class<Query$ReorderingRuleMatchType__fileExtensionMatches> &
    Query$ReorderingRuleMatchType__fileExtensionMatches &
    6; // 6
  static +resultHasTag: Class<Query$ReorderingRuleMatchType__resultHasTag> &
    Query$ReorderingRuleMatchType__resultHasTag &
    7; // 7
  static +manualCondition: Class<Query$ReorderingRuleMatchType__manualCondition> &
    Query$ReorderingRuleMatchType__manualCondition &
    8; // 8
}

declare class Query$ReorderingRuleMatchType__resultContainsKeyword
  mixins Query$ReorderingRuleMatchType {}
declare class Query$ReorderingRuleMatchType__titleContainsKeyword
  mixins Query$ReorderingRuleMatchType {}
declare class Query$ReorderingRuleMatchType__titleMatchesKeyword
  mixins Query$ReorderingRuleMatchType {}
declare class Query$ReorderingRuleMatchType__urlStartsWith
  mixins Query$ReorderingRuleMatchType {}
declare class Query$ReorderingRuleMatchType__urlExactlyMatches
  mixins Query$ReorderingRuleMatchType {}
declare class Query$ReorderingRuleMatchType__contentTypeIs
  mixins Query$ReorderingRuleMatchType {}
declare class Query$ReorderingRuleMatchType__fileExtensionMatches
  mixins Query$ReorderingRuleMatchType {}
declare class Query$ReorderingRuleMatchType__resultHasTag
  mixins Query$ReorderingRuleMatchType {}
declare class Query$ReorderingRuleMatchType__manualCondition
  mixins Query$ReorderingRuleMatchType {}
...
declare class Query$SortDirection {
  constructor(...args: empty): mixed;
  static +ascending: Class<Query$SortDirection__ascending> &
    Query$SortDirection__ascending &
    0; // 0
  static +descending: Class<Query$SortDirection__descending> &
    Query$SortDirection__descending &
    1; // 1
  static +fqlFormula: Class<Query$SortDirection__fqlFormula> &
    Query$SortDirection__fqlFormula &
    2; // 2
}
...
declare class Query$ResultTableCollection
  mixins SP$SP$ClientValueObjectCollection<Query$ResultTable> {
...
declare class SiteHealth$SiteHealthResult mixins SP$SP$ClientValueObject {
  ...
  get_ruleName(): string;
  get_status(): SP$SiteHealth.SiteHealth$SiteHealthStatusType;
  set_status(value: SP$SiteHealth.SiteHealth$SiteHealthStatusType): void;
  get_timeStamp(): Date;
...
declare class SiteHealth$SiteHealthStatusType {
  constructor(...args: empty): mixed;
  static +passed: Class<SiteHealth$SiteHealthStatusType__passed> &
    SiteHealth$SiteHealthStatusType__passed &
    0; // 0
  static +failedWarning: Class<SiteHealth$SiteHealthStatusType__failedWarning> &
    SiteHealth$SiteHealthStatusType__failedWarning &
    1; // 1
  static +failedError: Class<SiteHealth$SiteHealthStatusType__failedError> &
    SiteHealth$SiteHealthStatusType__failedError &
    2; // 2
}

declare class SiteHealth$SiteHealthStatusType__passed
  mixins SiteHealth$SiteHealthStatusType {}
declare class SiteHealth$SiteHealthStatusType__failedWarning
  mixins SiteHealth$SiteHealthStatusType {}
declare class SiteHealth$SiteHealthStatusType__failedError
  mixins SiteHealth$SiteHealthStatusType {}
...
declare class SiteHealth$SiteHealthSummary mixins SP$SP$ClientObject {
  ...
  get_results(): SP$SiteHealth.SiteHealth$SiteHealthResult[];
}
declare class SPAnimationUtility$BasicAnimator {
  ...
  static CommonResize(
    ...
    finishFunc: (data: any) => void,
    data: any,
    animationId: SPAnimation$SPAnimation$ID
  ): void;
  static QuickResize(
    element: HTMLElement,
    newHeight: number,
...
declare class SPAnimation$Attribute {
  constructor(...args: empty): mixed;
  static +PositionX: Class<SPAnimation$Attribute__PositionX> &
    SPAnimation$Attribute__PositionX &
    0; // 0
  static +PositionY: Class<SPAnimation$Attribute__PositionY> &
    SPAnimation$Attribute__PositionY &
    1; // 1
  static +Height: Class<SPAnimation$Attribute__Height> &
    SPAnimation$Attribute__Height &
    2; // 2
  static +Width: Class<SPAnimation$Attribute__Width> &
    SPAnimation$Attribute__Width &
    3; // 3
  static +Opacity: Class<SPAnimation$Attribute__Opacity> &
...
declare class SPAnimation$ID {
  constructor(...args: empty): mixed;
  static +Basic_Show: Class<SPAnimation$ID__Basic_Show> &
    SPAnimation$ID__Basic_Show &
    0; // 0
  static +Basic_SlowShow: Class<SPAnimation$ID__Basic_SlowShow> &
    SPAnimation$ID__Basic_SlowShow &
    1; // 1
  static +Basic_Fade: Class<SPAnimation$ID__Basic_Fade> &
    SPAnimation$ID__Basic_Fade &
    2; // 2
  static +Basic_Move: Class<SPAnimation$ID__Basic_Move> &
    SPAnimation$ID__Basic_Move &
    3; // 3
  static +Basic_Size: Class<SPAnimation$ID__Basic_Size> &
    SPAnimation$ID__Basic_Size &
    4; // 4
  static +Content_SlideInFadeInRight: Class<SPAnimation$ID__Content_SlideInFadeInRight> &
    SPAnimation$ID__Content_SlideInFadeInRight &
    5; // 5
  static +Content_SlideInFadeInRightInc: Class<SPAnimation$ID__Content_SlideInFadeInRightInc> &
    SPAnimation$ID__Content_SlideInFadeInRightInc &
    6; // 6
  static +Content_SlideOutFadeOutRight: Class<SPAnimation$ID__Content_SlideOutFadeOutRight> &
    SPAnimation$ID__Content_SlideOutFadeOutRight &
    7; // 7
  static +Content_SlideInFadeInLeft: Class<SPAnimation$ID__Content_SlideInFadeInLeft> &
    SPAnimation$ID__Content_SlideInFadeInLeft &
    8; // 8
  static +Content_SlideInFadeInLeftInc: Class<SPAnimation$ID__Content_SlideInFadeInLeftInc> &
    SPAnimation$ID__Content_SlideInFadeInLeftInc &
    9; // 9
  static +SmallObject_SlideInFadeInTop: Class<SPAnimation$ID__SmallObject_SlideInFadeInTop> &
    SPAnimation$ID__SmallObject_SlideInFadeInTop &
    10; // 10
  static +SmallObject_SlideInFadeInLeft: Class<SPAnimation$ID__SmallObject_SlideInFadeInLeft> &
    SPAnimation$ID__SmallObject_SlideInFadeInLeft &
    11; // 11
  static +Test_Instant: Class<SPAnimation$ID__Test_Instant> &
    SPAnimation$ID__Test_Instant &
    12; // 12
  static +Test_Hold: Class<SPAnimation$ID__Test_Hold> &
    SPAnimation$ID__Test_Hold &
    13; // 13
  static +Basic_Opacity: Class<SPAnimation$ID__Basic_Opacity> &
    SPAnimation$ID__Basic_Opacity &
    14; // 14
  static +Basic_QuickShow: Class<SPAnimation$ID__Basic_QuickShow> &
    SPAnimation$ID__Basic_QuickShow &
    15; // 15
  static +Basic_QuickFade: Class<SPAnimation$ID__Basic_QuickFade> &
    SPAnimation$ID__Basic_QuickFade &
    16; // 16
  static +Content_SlideInFadeInGeneric: Class<SPAnimation$ID__Content_SlideInFadeInGeneric> &
    SPAnimation$ID__Content_SlideInFadeInGeneric &
    17; // 17
  static +Basic_StrikeThrough: Class<SPAnimation$ID__Basic_StrikeThrough> &
    SPAnimation$ID__Basic_StrikeThrough &
    18; // 18
  static +SmallObject_SlideInFadeInBottom: Class<SPAnimation$ID__SmallObject_SlideInFadeInBottom> &
    SPAnimation$ID__SmallObject_SlideInFadeInBottom &
    19; // 19
  static +SmallObject_SlideOutFadeOutBottom: Class<SPAnimation$ID__SmallObject_SlideOutFadeOutBottom> &
    SPAnimation$ID__SmallObject_SlideOutFadeOutBottom &
    20; // 20
  static +Basic_QuickSize: Class<SPAnimation$ID__Basic_QuickSize> &
    SPAnimation$ID__Basic_QuickSize &
    21; // 21
}
...
declare class SPAnimation$ID__Content_SlideInFadeInRight
  mixins SPAnimation$ID {}
declare class SPAnimation$ID__Content_SlideInFadeInRightInc
  mixins SPAnimation$ID {}
declare class SPAnimation$ID__Content_SlideOutFadeOutRight
  mixins SPAnimation$ID {}
declare class SPAnimation$ID__Content_SlideInFadeInLeft mixins SPAnimation$ID {}
declare class SPAnimation$ID__Content_SlideInFadeInLeftInc
  mixins SPAnimation$ID {}
declare class SPAnimation$ID__SmallObject_SlideInFadeInTop
  mixins SPAnimation$ID {}
declare class SPAnimation$ID__SmallObject_SlideInFadeInLeft
  mixins SPAnimation$ID {}
...
declare class SPAnimation$ID__Content_SlideInFadeInGeneric
  mixins SPAnimation$ID {}
declare class SPAnimation$ID__Basic_StrikeThrough mixins SPAnimation$ID {}
declare class SPAnimation$ID__SmallObject_SlideInFadeInBottom
  mixins SPAnimation$ID {}
declare class SPAnimation$ID__SmallObject_SlideOutFadeOutBottom
  mixins SPAnimation$ID {}
...
declare class ClientValidation$RequiredValidator
  mixins ClientValidation$IValidator {
  Validate(value: any): ClientValidation$ValidationResult;
}

declare class ClientValidation$RequiredFileValidator
  mixins ClientValidation$IValidator {
  Validate(value: any): ClientValidation$ValidationResult;
}

declare class ClientValidation$RequiredRichTextValidator
  mixins ClientValidation$IValidator {
  Validate(value: any): ClientValidation$ValidationResult;
}

declare class ClientValidation$MaxLengthUrlValidator
  mixins ClientValidation$IValidator {
  Validate(value: any): ClientValidation$ValidationResult;
}
declare class SPClientForms$FormManagerEvents {
  constructor(...args: empty): mixed;
  static +Event_OnControlValueChanged: Class<SPClientForms$FormManagerEvents__Event_OnControlValueChanged> &
    SPClientForms$FormManagerEvents__Event_OnControlValueChanged &
    0; // 0
  static +Event_OnControlInitializedCallback: Class<SPClientForms$FormManagerEvents__Event_OnControlInitializedCallback> &
    SPClientForms$FormManagerEvents__Event_OnControlInitializedCallback &
    1; // 1
  static +Event_OnControlFocusSetCallback: Class<SPClientForms$FormManagerEvents__Event_OnControlFocusSetCallback> &
    SPClientForms$FormManagerEvents__Event_OnControlFocusSetCallback &
    2; // 2
  static +Event_GetControlValueCallback: Class<SPClientForms$FormManagerEvents__Event_GetControlValueCallback> &
    SPClientForms$FormManagerEvents__Event_GetControlValueCallback &
    3; // 3
  static +Event_OnControlValidationError: Class<SPClientForms$FormManagerEvents__Event_OnControlValidationError> &
    SPClientForms$FormManagerEvents__Event_OnControlValidationError &
    4; // 4
  static +Event_RegisterControlValidator: Class<SPClientForms$FormManagerEvents__Event_RegisterControlValidator> &
    SPClientForms$FormManagerEvents__Event_RegisterControlValidator &
    5; // 5
  static +Event_GetHasValueChangedCallback: Class<SPClientForms$FormManagerEvents__Event_GetHasValueChangedCallback> &
    SPClientForms$FormManagerEvents__Event_GetHasValueChangedCallback &
    6; // 6
}

declare class SPClientForms$FormManagerEvents__Event_OnControlValueChanged
  mixins SPClientForms$FormManagerEvents {}
declare class SPClientForms$FormManagerEvents__Event_OnControlInitializedCallback
  mixins SPClientForms$FormManagerEvents {}
declare class SPClientForms$FormManagerEvents__Event_OnControlFocusSetCallback
  mixins SPClientForms$FormManagerEvents {}
declare class SPClientForms$FormManagerEvents__Event_GetControlValueCallback
  mixins SPClientForms$FormManagerEvents {}
declare class SPClientForms$FormManagerEvents__Event_OnControlValidationError
  mixins SPClientForms$FormManagerEvents {}
declare class SPClientForms$FormManagerEvents__Event_RegisterControlValidator
  mixins SPClientForms$FormManagerEvents {}
declare class SPClientForms$FormManagerEvents__Event_GetHasValueChangedCallback
  mixins SPClientForms$FormManagerEvents {}
...
declare class SPClientTemplates$FileSystemObjectType {
  constructor(...args: empty): mixed;
  static +Invalid: Class<SPClientTemplates$FileSystemObjectType__Invalid> &
    SPClientTemplates$FileSystemObjectType__Invalid &
    0; // 0
  static +File: Class<SPClientTemplates$FileSystemObjectType__File> &
    SPClientTemplates$FileSystemObjectType__File &
    1; // 1
  static +Folder: Class<SPClientTemplates$FileSystemObjectType__Folder> &
    SPClientTemplates$FileSystemObjectType__Folder &
    2; // 2
  static +Web: Class<SPClientTemplates$FileSystemObjectType__Web> &
    SPClientTemplates$FileSystemObjectType__Web &
    3; // 3
}

declare class SPClientTemplates$FileSystemObjectType__Invalid
  mixins SPClientTemplates$FileSystemObjectType {}
declare class SPClientTemplates$FileSystemObjectType__File
  mixins SPClientTemplates$FileSystemObjectType {}
declare class SPClientTemplates$FileSystemObjectType__Folder
  mixins SPClientTemplates$FileSystemObjectType {}
declare class SPClientTemplates$FileSystemObjectType__Web
  mixins SPClientTemplates$FileSystemObjectType {}

declare class SPClientTemplates$ChoiceFormatType {
  constructor(...args: empty): mixed;
  static +Dropdown: Class<SPClientTemplates$ChoiceFormatType__Dropdown> &
    SPClientTemplates$ChoiceFormatType__Dropdown &
    0; // 0
  static +Radio: Class<SPClientTemplates$ChoiceFormatType__Radio> &
    SPClientTemplates$ChoiceFormatType__Radio &
    1; // 1
}

declare class SPClientTemplates$ChoiceFormatType__Dropdown
  mixins SPClientTemplates$ChoiceFormatType {}
declare class SPClientTemplates$ChoiceFormatType__Radio
  mixins SPClientTemplates$ChoiceFormatType {}

declare class SPClientTemplates$ClientControlMode {
  constructor(...args: empty): mixed;
  static +Invalid: Class<SPClientTemplates$ClientControlMode__Invalid> &
    SPClientTemplates$ClientControlMode__Invalid &
    0; // 0
  static +DisplayForm: Class<SPClientTemplates$ClientControlMode__DisplayForm> &
    SPClientTemplates$ClientControlMode__DisplayForm &
    1; // 1
  static +EditForm: Class<SPClientTemplates$ClientControlMode__EditForm> &
    SPClientTemplates$ClientControlMode__EditForm &
    2; // 2
  static +NewForm: Class<SPClientTemplates$ClientControlMode__NewForm> &
    SPClientTemplates$ClientControlMode__NewForm &
    3; // 3
  static +View: Class<SPClientTemplates$ClientControlMode__View> &
    SPClientTemplates$ClientControlMode__View &
    4; // 4
}

declare class SPClientTemplates$ClientControlMode__Invalid
  mixins SPClientTemplates$ClientControlMode {}
declare class SPClientTemplates$ClientControlMode__DisplayForm
  mixins SPClientTemplates$ClientControlMode {}
declare class SPClientTemplates$ClientControlMode__EditForm
  mixins SPClientTemplates$ClientControlMode {}
declare class SPClientTemplates$ClientControlMode__NewForm
  mixins SPClientTemplates$ClientControlMode {}
declare class SPClientTemplates$ClientControlMode__View
  mixins SPClientTemplates$ClientControlMode {}

declare class SPClientTemplates$RichTextMode {
  constructor(...args: empty): mixed;
  static +Compatible: Class<SPClientTemplates$RichTextMode__Compatible> &
    SPClientTemplates$RichTextMode__Compatible &
    0; // 0
  static +FullHtml: Class<SPClientTemplates$RichTextMode__FullHtml> &
    SPClientTemplates$RichTextMode__FullHtml &
    1; // 1
  static +HtmlAsXml: Class<SPClientTemplates$RichTextMode__HtmlAsXml> &
    SPClientTemplates$RichTextMode__HtmlAsXml &
    2; // 2
  static +ThemeHtml: Class<SPClientTemplates$RichTextMode__ThemeHtml> &
    SPClientTemplates$RichTextMode__ThemeHtml &
    3; // 3
}

declare class SPClientTemplates$RichTextMode__Compatible
  mixins SPClientTemplates$RichTextMode {}
declare class SPClientTemplates$RichTextMode__FullHtml
  mixins SPClientTemplates$RichTextMode {}
declare class SPClientTemplates$RichTextMode__HtmlAsXml
  mixins SPClientTemplates$RichTextMode {}
declare class SPClientTemplates$RichTextMode__ThemeHtml
  mixins SPClientTemplates$RichTextMode {}

declare class SPClientTemplates$UrlFormatType {
  constructor(...args: empty): mixed;
  static +Hyperlink: Class<SPClientTemplates$UrlFormatType__Hyperlink> &
    SPClientTemplates$UrlFormatType__Hyperlink &
    0; // 0
  static +Image: Class<SPClientTemplates$UrlFormatType__Image> &
    SPClientTemplates$UrlFormatType__Image &
    1; // 1
}

declare class SPClientTemplates$UrlFormatType__Hyperlink
  mixins SPClientTemplates$UrlFormatType {}
declare class SPClientTemplates$UrlFormatType__Image
  mixins SPClientTemplates$UrlFormatType {}

declare class SPClientTemplates$DateTimeDisplayFormat {
  constructor(...args: empty): mixed;
  static +DateOnly: Class<SPClientTemplates$DateTimeDisplayFormat__DateOnly> &
    SPClientTemplates$DateTimeDisplayFormat__DateOnly &
    0; // 0
  static +DateTime: Class<SPClientTemplates$DateTimeDisplayFormat__DateTime> &
    SPClientTemplates$DateTimeDisplayFormat__DateTime &
    1; // 1
  static +TimeOnly: Class<SPClientTemplates$DateTimeDisplayFormat__TimeOnly> &
    SPClientTemplates$DateTimeDisplayFormat__TimeOnly &
    2; // 2
}

declare class SPClientTemplates$DateTimeDisplayFormat__DateOnly
  mixins SPClientTemplates$DateTimeDisplayFormat {}
declare class SPClientTemplates$DateTimeDisplayFormat__DateTime
  mixins SPClientTemplates$DateTimeDisplayFormat {}
declare class SPClientTemplates$DateTimeDisplayFormat__TimeOnly
  mixins SPClientTemplates$DateTimeDisplayFormat {}

declare class SPClientTemplates$DateTimeCalendarType {
  constructor(...args: empty): mixed;
  static +None: Class<SPClientTemplates$DateTimeCalendarType__None> &
    SPClientTemplates$DateTimeCalendarType__None &
    0; // 0
  static +Gregorian: Class<SPClientTemplates$DateTimeCalendarType__Gregorian> &
    SPClientTemplates$DateTimeCalendarType__Gregorian &
    1; // 1
  static +Japan: Class<SPClientTemplates$DateTimeCalendarType__Japan> &
    SPClientTemplates$DateTimeCalendarType__Japan &
    2; // 2
  static +Taiwan: Class<SPClientTemplates$DateTimeCalendarType__Taiwan> &
    SPClientTemplates$DateTimeCalendarType__Taiwan &
    3; // 3
  static +Korea: Class<SPClientTemplates$DateTimeCalendarType__Korea> &
    SPClientTemplates$DateTimeCalendarType__Korea &
    4; // 4
  static +Hijri: Class<SPClientTemplates$DateTimeCalendarType__Hijri> &
    SPClientTemplates$DateTimeCalendarType__Hijri &
    5; // 5
  static +Thai: Class<SPClientTemplates$DateTimeCalendarType__Thai> &
    SPClientTemplates$DateTimeCalendarType__Thai &
    6; // 6
  static +Hebrew: Class<SPClientTemplates$DateTimeCalendarType__Hebrew> &
    SPClientTemplates$DateTimeCalendarType__Hebrew &
    7; // 7
  static +GregorianMEFrench: Class<SPClientTemplates$DateTimeCalendarType__GregorianMEFrench> &
    SPClientTemplates$DateTimeCalendarType__GregorianMEFrench &
    8; // 8
  static +GregorianArabic: Class<SPClientTemplates$DateTimeCalendarType__GregorianArabic> &
    SPClientTemplates$DateTimeCalendarType__GregorianArabic &
    9; // 9
  static +GregorianXLITEnglish: Class<SPClientTemplates$DateTimeCalendarType__GregorianXLITEnglish> &
    SPClientTemplates$DateTimeCalendarType__GregorianXLITEnglish &
    10; // 10
  static +GregorianXLITFrench: Class<SPClientTemplates$DateTimeCalendarType__GregorianXLITFrench> &
    SPClientTemplates$DateTimeCalendarType__GregorianXLITFrench &
    11; // 11
  static +KoreaJapanLunar: Class<SPClientTemplates$DateTimeCalendarType__KoreaJapanLunar> &
    SPClientTemplates$DateTimeCalendarType__KoreaJapanLunar &
    12; // 12
  static +ChineseLunar: Class<SPClientTemplates$DateTimeCalendarType__ChineseLunar> &
    SPClientTemplates$DateTimeCalendarType__ChineseLunar &
    13; // 13
  static +SakaEra: Class<SPClientTemplates$DateTimeCalendarType__SakaEra> &
    SPClientTemplates$DateTimeCalendarType__SakaEra &
    14; // 14
  static +UmAlQura: Class<SPClientTemplates$DateTimeCalendarType__UmAlQura> &
    SPClientTemplates$DateTimeCalendarType__UmAlQura &
    15; // 15
}

declare class SPClientTemplates$DateTimeCalendarType__None
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__Gregorian
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__Japan
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__Taiwan
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__Korea
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__Hijri
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__Thai
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__Hebrew
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__GregorianMEFrench
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__GregorianArabic
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__GregorianXLITEnglish
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__GregorianXLITFrench
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__KoreaJapanLunar
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__ChineseLunar
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__SakaEra
  mixins SPClientTemplates$DateTimeCalendarType {}
declare class SPClientTemplates$DateTimeCalendarType__UmAlQura
  mixins SPClientTemplates$DateTimeCalendarType {}

declare class SPClientTemplates$UserSelectionMode {
  constructor(...args: empty): mixed;
  static +PeopleOnly: Class<SPClientTemplates$UserSelectionMode__PeopleOnly> &
    SPClientTemplates$UserSelectionMode__PeopleOnly &
    0; // 0
  static +PeopleAndGroups: Class<SPClientTemplates$UserSelectionMode__PeopleAndGroups> &
    SPClientTemplates$UserSelectionMode__PeopleAndGroups &
    1; // 1
}

declare class SPClientTemplates$UserSelectionMode__PeopleOnly
  mixins SPClientTemplates$UserSelectionMode {}
declare class SPClientTemplates$UserSelectionMode__PeopleAndGroups
  mixins SPClientTemplates$UserSelectionMode {}
...
declare class SPClientTemplates$Utility {
  ...
  static ControlModeToString(
    mode: SPClientTemplates$SPClientTemplates$ClientControlMode
  ): string;
  static FileSystemObjectTypeToString(
    fileSystemObjectType: SPClientTemplates$SPClientTemplates$FileSystemObjectType
  ): string;
  static ChoiceFormatTypeToString(
    fileSystemObjectType: SPClientTemplates$SPClientTemplates$ChoiceFormatType
  ): string;
  static RichTextModeToString(
    fileSystemObjectType: SPClientTemplates$SPClientTemplates$RichTextMode
  ): string;
...
declare class SPClientTemplates$ClientFormContext {
  ...
  registerClientValidator(
    fieldname: string,
    validator: SPClientForms$ClientValidation.ClientValidation$ValidatorSet
  ): void;
...
declare function Overrides$overrideDeleteConfirmation(
  listId: string,
  overrideText: string
): void;
...
declare function Selection$getSelectedItems(): Array<{
  id: number,
  fsObjType: SPClientTemplates$FileSystemObjectType
}>;
...
declare module "sharepoint" {
  ...
  declare function GenerateIID(
    renderCtx: SPClientTemplates$SPClientTemplates$RenderContext_ItemInView
  ): string;

  declare function GenerateIIDForListItem(
    renderCtx: SPClientTemplates$SPClientTemplates$RenderContext_InView,
    listItem: SPClientTemplates$SPClientTemplates$Item
  ): string;
  ...
  declare class SPMgr {
    ...
    RenderField(
      ...
      listSchema: SPClientTemplates$SPClientTemplates$ListSchema
    ): string;
    RenderFieldByName(
      renderCtx: SPClientTemplates$SPClientTemplates$RenderContext,
      fieldName: string,
  ...
  declare function SPField_FormDisplay_Default(
    ctx: SPClientTemplates$SPClientTemplates$RenderContext_FieldInForm
  ): string;
  ...
  declare class SPClientPeoplePicker {
    ...
    PrincipalAccountTypeEnum: SP$Utilities.Utilities$PrincipalType;
    EnabledClaimProviders: string;
    SearchPrincipalSource: SP$Utilities.Utilities$PrincipalSource;
    ResolvePrincipalSource: SP$Utilities.Utilities$PrincipalSource;
    ...
    UpdateUnresolvedUser(
      results: SP$SP$StringResult,
      user: ISPClientPeoplePickerEntity
    ): void;
    AddPickerSearchQuery(queryStr: string): string;
    AddPickerResolveQuery(queryStr: string): string;
    GetPeoplePickerQueryParameters(): SP$UI.ApplicationPages.ApplicationPages$ClientPeoplePickerQueryParameters;
    AddProcessedUser(
