 ...
 */
declare class SP$List<T> mixins SP$SP$SecurableObject {
 ...
 */
declare class SP$ListItem<T> mixins SP$SP$SecurableObject {
get_fieldValues(): T;
...
declare type SP$ListItemCollection<T> = {
...
setFieldValueByTerm<T>(listItem: SP$SP$ListItem<T>, term: Taxonomy$Term, lcid: number): void;
setFieldValueByTermCollection<T>(
listItem: SP$SP$ListItem<T>,
terms: Taxonomy$TermCollection,
lcid: number): void;
setFieldValueByCollection<T>(listItem: SP$SP$ListItem<T>, terms: Taxonomy$Term[], lcid: number): void;
setFieldValueByValue<T>(listItem: SP$SP$ListItem<T>, taxValue: Taxonomy$TaxonomyFieldValue): void;
...
static migrateVideo<T>(context: SP$ClientContext, videoFile: SP$File): SP$SP$ListItem<T>
}
...
(object?: MQueryResultSet<T> | T | T[]): MQueryResultSet<T>,
