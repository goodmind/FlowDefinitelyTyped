...
driverConfig?: {[key: string]: any}): Promise<massive$massive$Database>

	declare type massive$UUID = string;

declare interface massive$AnyObject<T> {
[key: string]: T
} 
...
declare type massive$QueryParamTypes = string | number | {[key: string]: any};

declare type massive$QueryParams = massive$QueryParamTypes[] | massive$QueryParamTypes;
 ...
 */
invoke(options?: massive$ResultProcessingOptions): Promise<massive$AnyObject | any[]>
}
...
options?: massive$RetrievalOptions & massive$ResultProcessingOptions): Promise<any>;
...
findDoc(
criteria?: massive$AnyObject | number | massive$UUID,
options?: massive$RetrievalOptions): Promise<any>;
...
options?: massive$ResultProcessingOptions): Promise<any[]>;
...
options?: massive$PersistenceInsertOptions & massive$ResultProcessingOptions): Promise<massive$AnyObject>;
insert(
data: massive$AnyObject[],
options?: massive$PersistenceInsertOptions & massive$ResultProcessingOptions): Promise<massive$AnyObject[]>;
...
options?: massive$PersistenceInsertOptions & massive$PersistenceUpdateDocOptions & massive$ResultProcessingOptions): Promise<massive$AnyObject>;
...
options?: massive$PersistenceUpdateDocOptions & massive$ResultProcessingOptions): Promise<massive$AnyObject>;
update(
criteria: massive$AnyObject,
changes: massive$AnyObject,
options?: massive$PersistenceUpdateDocOptions & massive$ResultProcessingOptions): Promise<massive$AnyObject[]>;
 ...
 */
constructor(source: massive$Readable, criteria: massive$AnyObject | massive$UUID, options?: massive$RetrievalOptions & massive$ResultProcessingOptions): this;
 ...
 */
constructor(source: massive$Readable, record: massive$AnyObject | any[], options?: massive$ResultProcessingOptions & massive$PersistenceInsertOptions): this;
 ...
 */
constructor(source: massive$Readable, changes: massive$AnyObject, criteria: massive$AnyObject, options?: massive$ResultProcessingOptions & massive$PersistenceUpdateDocOptions): this;
 ...
 */
constructor(source: massive$Readable, criteria?: massive$AnyObject | massive$UUID | number, options?: massive$ResultProcessingOptions & massive$InheritanceOptions): this;
 ...
 */
constructor(connection: {[key: string]: any} | string, loader?: massive$Loader, driverConfig?: {[key: string]: any}): this;
 ...
 */
dropSchema(schemaName: string, options?: massive$DropOptions): Promise<void>;
 ...
 */
withConnection(cb: (withTask: any) => any, options?: massive$AnyObject): Promise<any>;
 ...
 */
withTransaction(cb: (withTx: any) => any, options?: massive$AnyObject): Promise<any>;
