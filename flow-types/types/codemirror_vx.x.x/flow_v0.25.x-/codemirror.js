 ...
 */
declare function CodeMirror$countColumn(
  line: string,
  index: number | null,
  tabSize: number
): number;
 ...
 */
declare function CodeMirror$cmpPos(
 ...
 */
declare function CodeMirror$changeEnd(
 ...
 */
declare function CodeMirror$defineOption(
  name: string,
  default_: any,
  updateFunc: Function
): void;
 ...
 */
declare function CodeMirror$registerHelper(
  namespace: string,
  name: string,
  helper: any
): void;
 ...
 */
declare function CodeMirror$extendMode(
  name: string,
  properties: CodeMirror$Mode<any>
): void;
...
declare function CodeMirror$on(
  doc: CodeMirror$Doc,
  eventName: "change",
  handler: (instance: CodeMirror$Doc, change: CodeMirror$EditorChange) => void
): void;
...
declare function CodeMirror$on(
  ...
  handler: (instance: CodeMirror$CodeMirror$Editor) => void
): void;
 ...
 */
declare function CodeMirror$signal(
  target: any,
  name: string,
  ...args: any[]
): void;

declare type CodeMirror$DOMEvent =
  | "mousedown"
  | "dblclick"
  | "touchstart"
  | "contextmenu"
...
declare interface CodeMirror$KeyMap {
  [keyName: string]:
    | false
    | string
    | ((instance: CodeMirror$Editor) => void | typeof Pass);
}
...
declare interface CodeMirror$Editor {
  ...
  ): CodeMirror$CodeMirror$LineHandle;
  ...
  addLineWidget(
    line: any,
    node: HTMLElement,
    options?: CodeMirror$CodeMirror$LineWidgetOptions
   ...
   */
  scrollIntoView(
    pos: CodeMirror$CodeMirror$Position | null,
    margin?: number
  ): void;
  ...
  coordsChar(
    ...
    mode?: CodeMirror$CoordsMode
  ): CodeMirror$CodeMirror$Position;
  ...
  CodeMirror$on(
    ...
    handler: (
      instance: CodeMirror$CodeMirror$Editor,
      change: CodeMirror$CodeMirror$EditorChangeLinkedList
    ) => void
  ): void;
  CodeMirror$off(
    eventName: "change",
  ...
  CodeMirror$on(
    ...
    handler: (
      instance: CodeMirror$CodeMirror$Editor,
      change: CodeMirror$CodeMirror$EditorChangeCancellable
    ) => void
  ): void;
  CodeMirror$off(
    eventName: "beforeChange",
  ...
  CodeMirror$on(
    ...
    handler: (instance: CodeMirror$CodeMirror$Editor, event: Event) => void
  ): void;
  CodeMirror$off(
    eventName: CodeMirror$DOMEvent,
    handler: (instance: CodeMirror$CodeMirror$Editor, event: Event) => void
...
declare interface CodeMirror$Doc {
  ...
  eachLine(
    ...
    f: (line: CodeMirror$CodeMirror$LineHandle) => void
  ): void;
   ...
   */
  iterLinkedDocs(
    fn: (doc: CodeMirror$CodeMirror$Doc, sharedHist: boolean) => void
  ): void;
  ...
  markText(
    from: CodeMirror$CodeMirror$Position,
    to: CodeMirror$CodeMirror$Position,
    options?: CodeMirror$CodeMirror$TextMarkerOptions
...
declare interface CodeMirror$TextMarker {
  ...
  CodeMirror$on(
    eventName: "clear",
    handler: (from: CodeMirror$Position, to: CodeMirror$Position) => void
  ): void;
 ...
 */
declare function CodeMirror$defineMode(
  id: string,
  modefactory: CodeMirror$ModeFactory<any>
): void;
 ...
 * (modes should not leak anything into the global scope!), i.e. write your whole mode inside this function.
 */
declare function CodeMirror$defineMode<T>(
  id: string,
...
declare interface CodeMirror$Linter {
  (
    ...
    codeMirror: CodeMirror$Editor
  ): CodeMirror$Annotation[] | PromiseLike<CodeMirror$Annotation[]>;
}
...
declare function CodeMirror$MergeView(
  element: HTMLElement,
  options?: CodeMirror$MergeView.MergeView$MergeViewEditorConfiguration
): CodeMirror$MergeView.MergeView$MergeViewEditor;
declare module "codemirror" {
  declare module.exports: typeof CodeMirror;

  declare function CodeMirror(
    host: HTMLElement,
    options?: CodeMirror$CodeMirror$EditorConfiguration
  ): CodeMirror$CodeMirror$Editor;
