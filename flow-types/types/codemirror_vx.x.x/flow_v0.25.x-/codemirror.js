declare module "codemirror" {
  ...
  declare export var CodeMirror$Doc: CodeMirror$DocConstructor;

  declare export var CodeMirror$Pos: CodeMirror$PositionConstructor;
   ...
   */
  declare function CodeMirror$defineDocExtension(
    name: string,
    value: any
  ): void;
   ...
   */
  declare type CodeMirror$MergeView$MergeViewEditorConfiguration = {
    /**
  ...
  declare type CodeMirror$MergeView$MergeViewEditor = {
    /**
   ...
   */
  declare interface CodeMirror$MergeView$MergeViewDiffChunk {
    editFrom: number;
    editTo: number;
    origFrom: number;
    origTo: number;
  ...
  declare interface CodeMirror$MergeView$DiffView {
    /**
