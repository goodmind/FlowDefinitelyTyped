...
generateStopWordFilter: typeof lunr$generateStopWordFilter,
 ...
 */
field(field: string, attributes?: {[key: string]: any}): void;
 ...
 */
add(doc: {[key: string]: any}, attributes?: {[key: string]: any}): void;
 ...
 */
search(queryString: lunr$Index.Index$QueryString): lunr$Index.Index$Result[];
 ...
 */
static load(serializedIndex: {[key: string]: any}): lunr$Index
}
 ...
 */
constructor(term: string, field: string, metadata: {[key: string]: any}): this;
 ...
 */
combine(otherMatchData: lunr$MatchData): void
}
 ...
 */
declare type lunr$PipelineFunction = (
token: lunr$Token,
i: number,
tokens: lunr$Token[]) => null | lunr$Token | lunr$Token[];
 ...
 */
static load(serialised: {[key: string]: any}): lunr$Pipeline;
...
static +OPTIONAL: Class<Query$presence__OPTIONAL> & Query$presence__OPTIONAL & 1;// 1
static +REQUIRED: Class<Query$presence__REQUIRED> & Query$presence__REQUIRED & 2;// 2
static +PROHIBITED: Class<Query$presence__PROHIBITED> & Query$presence__PROHIBITED & 3;// 3
...
static +LEADING: Class<Query$wildcard__LEADING> & Query$wildcard__LEADING & "NO PRINT IMPLEMENTED: BinaryExpression";// "NO PRINT IMPLEMENTED: BinaryExpression"
static +TRAILING: Class<Query$wildcard__TRAILING> & Query$wildcard__TRAILING & "NO PRINT IMPLEMENTED: BinaryExpression";// "NO PRINT IMPLEMENTED: BinaryExpression"
 ...
 */
constructor(allFields: string[]): this;
...
options: {[key: string]: any}): lunr$Query
}

declare class lunr$QueryParseError mixins Error {
name: "QueryParseError";
message: string;
start: number;
end: number;
constructor(message: string, start: string, end: string): this
}
 ...
 */
declare function lunr$stemmer(token: lunr$Token): lunr$Token
 ...
 */
declare function lunr$generateStopWordFilter(stopWords: string[]): lunr$PipelineFunction
 ...
 * @see {@link lunr.Pipeline}
 */
declare function lunr$stopWordFilter(token: lunr$Token): lunr$Token
 ...
 */
declare type Token$UpdateFunction = (str: string, metadata: {[key: string]: any}) => void;
 ...
 */
fromArray(arr: string[]): lunr$TokenSet;
 ...
 */
fromFuzzyString(str: string, editDistance: number): lunr$Vector;
 ...
 */
fromString(str: string): lunr$TokenSet;
 ...
 */
declare function lunr$tokenizer(
obj?: null | string | {[key: string]: any} | {[key: string]: any}[]): lunr$Token[]
...
insertIdx: number,
val: number,
fn: (existingVal: number, val: number) => number): void;
...
declare var lunr$version: string;

declare type lunr$ConfigFunction = (builder: lunr$Builder) => void;
