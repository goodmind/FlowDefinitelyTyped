...
[field: string]: Find$Selector | Find$Selector[] | Find$ConditionOperators | any,
...
callback: Core.Callback<Find$Find$FindResponse<Content>>): void,
find(
request?: Find$Find$FindRequest<Content>): Promise<Find$Find$FindResponse<Content>>,
...
callback: Core.Callback<Find$Find$CreateIndexResponse<Content>>): void,
createIndex(
index?: Find$Find$CreateIndexOptions): Promise<Find$Find$CreateIndexResponse<Content>>,
 ...
 */
getIndexes(callback: Core.Callback<Find$Find$GetIndexesResponse<Content>>): void,
...
callback: Core.Callback<Find$Find$DeleteIndexResponse<Content>>): void,
deleteIndex(
index?: Find$Find$DeleteIndexOptions): Promise<Find$Find$DeleteIndexResponse<Content>>
