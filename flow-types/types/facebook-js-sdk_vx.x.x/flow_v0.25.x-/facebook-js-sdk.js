declare module "facebook-js-sdk" {
  ...
  declare interface facebook$FacebookStatic {
    ...
    ui(
      ...
      callback?: (response: facebook$ShareOpenGraphDialogResponse) => void
    ): void;
    ...
    ui(
      ...
      callback?: (response: facebook$DialogResponse) => void
    ): void;
    ...
    ui(
      ...
      callback?: (response: facebook$GameRequestDialogResponse) => void
    ): void;
    ...
    ui(
      ...
      callback?: (response: facebook$PayDialogResponse) => void
    ): void;
    ...
    ui(
      ...
      callback?: (response: facebook$PaymentsLiteDialogResponse) => void
    ): void;
    ...
    ui(
      ...
      callback?: (response: facebook$LiveDialogResponse) => void
    ): void;
    ...
    ui(
      ...
      callback?: (response: facebook$CreateOfferDialogResponse) => void
    ): void;
    ...
    ui(
      ...
      callback?: (response: facebook$LeadgenDialogResponse) => void
    ): void;
    ...
    ui(
      ...
      callback?: (
        response: facebook$InstantExperiencesAdsDialogResponse
      ) => void
    ): void;
    ...
    ui(
      ...
      callback?: (response: facebook$CollectionAdsDialogResponse) => void
    ): void;
    XFBML: any;
  }
