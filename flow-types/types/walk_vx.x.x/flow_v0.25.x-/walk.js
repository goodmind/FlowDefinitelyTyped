declare module "walk" {
  ...
  declare export type WalkStatEventCallback = (
    base: string,
    names: WalkStats,
    next: WalkNext
  ) => void;
  declare export type WalkStatArrayEventCallback = (
    base: string,
    names: WalkStats[],
    next: WalkNext
  ) => void;
  declare export type WalkNamesEventCallback = (
    base: string,
    names: string[],
    next: WalkNext
  ) => void;
  declare export type WalkStatArrayEvent =
    | "files"
    | "directories"
    | "errors"
    | "nodeError"
