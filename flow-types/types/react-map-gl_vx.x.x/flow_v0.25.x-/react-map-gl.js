declare module "react-map-gl" {
  ...
  declare export class TRANSITION_EVENTS {
    ...
    static +BREAK: Class<TRANSITION_EVENTS__BREAK> &
      TRANSITION_EVENTS__BREAK &
      1; // 1
    static +SNAP_TO_END: Class<TRANSITION_EVENTS__SNAP_TO_END> &
      TRANSITION_EVENTS__SNAP_TO_END &
      2; // 2
    static +IGNORE: Class<TRANSITION_EVENTS__IGNORE> &
      TRANSITION_EVENTS__IGNORE &
      3; // 3
  }
  ...
  declare export class InteractiveMap
    mixins React.Component<InteractiveMapProps> {
    getMap(): MapboxGL.Map;
    queryRenderedFeatures(
      geometry?: MapboxGL.PointLike | MapboxGL.PointLike[],
      parameters?: QueryRenderedFeaturesParams
  ...
  declare export class BaseControl<T: BaseControlProps>
    mixins React.Component<T> {}
  ...
  declare export class NavigationControl
    mixins BaseControl<NavigationControlProps> {}
  ...
  declare export class DraggableControl
    mixins BaseControl<DraggableControlProps> {}
