declare module 'oauth' {
        import type {
          Agent,ClientRequest,IncomingMessage,OutgoingHttpHeaders,RequestOptions
        } from 'http';
...
NONCE_CHARS: string[];
constructor(requestUrl: string, accessUrl: string, consumerKey: string, consumerSecret: string, version: string, authorize_callback: string | null, signatureMethod: string, nonceSize?: number, customHeaders?: OutgoingHttpHeaders): this;
setClientOptions(
options: {
requestTokenHttpMethod: string,
accessTokenHttpMethod: string,
...
oauth_token: string,
oauth_token_secret: string,
callback: dataCallback): ClientRequest;
get(
url: string,
oauth_token: string,
oauth_token_secret: string,
...
_getSignature(method: string, url: string, parameters: string, tokenSecret: string): string;
...
_createSignatureBase(method: string, url: string, parameters: string): string;
...
sslEnabled?: boolean): ClientRequest;
_prepareParameters(
oauth_token: string,
oauth_token_secret: string,
method: string,
url: string,
extra_params?: any): string[][];
_prepareParameters(
oauth_token_secret: string,
method: string,
url: string,
...
constructor(realm: string, verify_credentials: string, consumerKey: string, consumerSecret: string, version: string, signatureMethod: string, nonceSize?: number, customHeaders?: OutgoingHttpHeaders): this
}
...
constructor(clientId: string, clientSecret: string, baseSite: string, authorizePath?: string, accessTokenPath?: string, customHeaders?: OutgoingHttpHeaders): this;
...
post_body: any,
callback: dataCallback): void;
_executeRequest(http_library: string, options: RequestOptions, callback: dataCallback): void
}
    }
