...
events?: any,
references?: any,
element?: HTMLElement): Sys$Sys$Component
 ...
 */
declare function $find(id: string, parent?: Sys$Sys$Component): Sys$Sys$Component
...
element: HTMLElement,
eventName: string,
handler: (e: Sys$UI.UI$DomEvent) => void): void
 ...
 */
static InvariantCulture: Sys$CultureInfo;
 ...
 */
static CurrentCulture: Sys$CultureInfo;
 ...
 */
constructor(action: Sys$NotifyCollectionChangedAction, newItems: any[], newStartingIndex: number, oldItems: any[], oldStartingIndex: number): this;
 ...
 */
static raiseCollectionChanged(target: any[], changes: Sys$Sys$CollectionChange): void;
 ...
 */
static raiseEvent(target: any, eventName: string, eventArgs: Sys$Sys$EventArgs): void;
 ...
 */
declare class Sys$StringBuilder  {
...
static +add: Class<Sys$NotifyCollectionChangedAction__add> & Sys$NotifyCollectionChangedAction__add & 0;// 0
static +remove: Class<Sys$NotifyCollectionChangedAction__remove> & Sys$NotifyCollectionChangedAction__remove & 1;// 1
static +reset: Class<Sys$NotifyCollectionChangedAction__reset> & Sys$NotifyCollectionChangedAction__reset & 2;// 2

}

declare class Sys$NotifyCollectionChangedAction__add mixins Sys$NotifyCollectionChangedAction {}
declare class Sys$NotifyCollectionChangedAction__remove mixins Sys$NotifyCollectionChangedAction {}
declare class Sys$NotifyCollectionChangedAction__reset mixins Sys$NotifyCollectionChangedAction {}
...
declare class Sys$ApplicationLoadEventArgs  {
 ...
 */
add_completed(handler: (reference: any, eventArgs: Sys$Sys$EventArgs) => void): void;
 ...
 */
remove_completed(handler: (reference: any, eventArgs: Sys$Sys$EventArgs) => void): void;
 ...
 */
static getBehaviorsByType(element: HTMLElement, type: Sys$UI.UI$Behavior): UI$Behavior[];
 ...
 */
setVisibilityMode(element: HTMLElement, value: Sys$UI.UI$VisibilityMode): void,
...
declare  class UI$MouseButton {
  constructor(...args: empty): mixed;
static +leftButton: Class<UI$MouseButton__leftButton> & UI$MouseButton__leftButton & 0;// 0
static +middleButton: Class<UI$MouseButton__middleButton> & UI$MouseButton__middleButton & 1;// 1
static +rightButton: Class<UI$MouseButton__rightButton> & UI$MouseButton__rightButton & 2;// 2
...
static +collapse: Class<UI$VisibilityMode__collapse> & UI$VisibilityMode__collapse & 1;// 1
 ...
 */
constructor(request: Sys$Net.Net$WebRequest, postBackElement: any, updatePanelsToUpdate: string[]): this;
 ...
 */
constructor(error: Error, dataItems: any, response: Sys$Net.Net$WebRequestExecutor): this;
 ...
 */
add_endRequest(
endRequestHandler: (sender: any, args: Sys$WebForms.WebForms$EndRequestEventArgs) => void): void;
