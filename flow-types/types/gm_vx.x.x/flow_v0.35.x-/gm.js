declare module 'gm' {
        declare function m(stream: NodeJS.ReadableStream | Buffer | string, image?: string): m$m$State
...
page(width: number, height: number, arg?: "%"
| "!"
| "<"
| ">"
| string): m$State,
...
filesize(opts: m$GetterOptions, callback: m$GetterCallback<string>): m$State,
...
identify(opts: m$GetterOptions, callback: m$GetterCallback<m$ImageInfo>): m$State,
...
size(opts: m$GetterOptions, callback: m$GetterCallback<m$Dimensions>): m$State,
orientation(callback: m$GetterCallback<string>): m$State,
orientation(opts: m$GetterOptions, callback: m$GetterCallback<string>): m$State,
...
...coords: Array<[number, number]>): m$State,
...
y: number,
text: string,
gravity?: m$GravityDirection | string): m$State,
...
x: number,
y: number,
method: m$SetDrawMethod | string): m$State,
...
declare function m$compare(filename1: string, filename2: string, callback: m$CompareCallback): void
...
callback: m$CompareCallback): void


declare function m$subClass(options: m$ClassOptions): m$SubClass


declare type m$ChannelOperator = "Add"
| "And"
| "Assign"
| "Depth"
| "Divide"
...
declare type m$ChannelType = "All"
| "Intensity"
| "Red"
| "Green"
| "Blue"
...
declare type m$ColorSpace = "CineonLog"
| "CMYK"
| "GRAY"
| "HSL"
| "HSB"
...
declare type m$CompareCallback = (err: Error, isEqual: boolean, equality: number, raw: number) => any;

declare type m$ComposeOperator = "Over"
| "In"
| "Out"
| "Atop"
| "Xor"
...
declare type m$CompressionType = "None"
| "BZip"
| "Fax"
| "Group4"
| "JPEG"
...
declare type m$DisposeMethod = "Undefined" | "None" | "Background" | "Previous";

declare type m$Encoding = "AdobeCustom"
| "AdobeExpert"
| "AdobeStandard"
| "AppleRoman"
| "BIG5"
...
declare type m$FilterType = "Point"
| "Box"
| "Triangle"
| "Hermite"
| "Hanning"
...
declare type m$GravityDirection = "NorthWest"
| "North"
| "NorthEast"
| "West"
| "Center"
...
declare type m$ImageType = "Bilevel"
| "Grayscale"
| "Palette"
| "PaletteMatte"
| "TrueColor"
...
declare type m$IntentType = "Absolute" | "Perceptual" | "Relative" | "Saturation";

declare type m$InterlaceType = "None" | "Line" | "Plane" | "Partition";

declare type m$LimitType = "disk"
| "file"
| "map"
| "memory"
| "pixels"
...
declare type m$NoiseType = "uniform"
| "gaussian"
| "multiplicative"
| "impulse"
| "laplacian"
...
declare type m$PreviewType = "Rotate"
| "Shear"
| "Roll"
| "Hue"
| "Saturation"
...
declare type m$SetDrawMethod = "point"
| "replace"
| "floodfill"
| "filltoborder"
| "reset";
...
declare type m$UnitType = "Undefined" | "PixelsPerInch" | "PixelsPerCentimeter";

declare type m$VirtualPixelMethod = "Constant" | "Edge" | "Mirror" | "Tile";

declare type m$VisualType = "StaticGray"
| "GrayScale"
| "StaticColor"
| "PseudoColor"
| "TrueColor"
...
declare type m$WriteCallback = (err: Error, stdout: string, stderr: string, cmd: string) => any;
