declare module "socketcluster" {
  ...
  declare class SocketCluster mixins EventEmitter {
    ...
    on(
      event: "workerExit",
      listener: (workerInfo: SocketCluster$SocketCluster$WorkerExitInfo) => void
    ): this;
    on(
      event: "brokerStart",
      listener: (
        brokerInfo: SocketCluster$SocketCluster$BrokerStartInfo
      ) => void
    ): this;
    on(
      event: "brokerExit",
      listener: (brokerInfo: SocketCluster$SocketCluster$BrokerExitInfo) => void
    ): this;
    on(
