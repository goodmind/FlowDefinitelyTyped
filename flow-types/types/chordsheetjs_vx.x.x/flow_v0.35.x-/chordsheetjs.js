 ...
 */
declare export class ChordLyricsPair  {
 ...
 */
constructor(chords: string, lyrics: string): this;
chords: string;
lyrics: string;
...
constructor(name: string, value: string | null): this;
 ...
 */
declare export class Paragraph  {
constructor(): this;
 ...
 */
declare export class Song  {
constructor(metadata: {[key: string]: any}): this;
...
assignMetaData(metadata: {[key: string]: any}): void;
...
optimizedMetaData: {[key: string]: any};
getOptimizedMetaData(): {[key: string]: any};
optimizeMetaDataValue(valueSet: string[] | void): string | string[] | null;
 ...
 */
declare export class ParserWarning  {
 ...
 */
declare export class ChordProParser  {
...
addWarning(message: string): void
	...
	declare export interface ChordSheetParserProps {
 ...
 */
declare export class ChordSheetParser  {
constructor(props: ChordSheetParserProps): this;
song: Song;
lines: Line[];
songLine: Line;
...
ensureChordLyricsPairInitialized(): void
	...
	declare export interface SongHeader {
title: string,
subtitle: string
} 
	declare export class TextFormatter  {
constructor(): this;
 ...
 * PDF conversion.
 */
declare export class HtmlTableFormatter  {
constructor(): this;
 ...
 */
declare export class HtmlDivFormatter  {
constructor(): this;
 ...
 */
declare export class ChordProFormatter  {
constructor(): this;
