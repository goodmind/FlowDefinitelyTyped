...
issuerCertificate: Certificate): PromiseLike<GetCertificateStatusResult>;
...
certificate: Certificate,
parameters: CreateFroCertificateParams): PromiseLike<void>;
constructor(params?: any): this;
static defaultValues(memberName: string): any;
static schema(parameters?: any): any;
fromSchema(schema: any): void;
...
toJSON(): any
	...
	declare module 'pkijs/src/Certificate' {
        import type {
          OctetString,Integer,BitString,Sequence
        } from 'asn1js';
 ...
 * @param {{
initialPolicySet: <<UNKNOWN PARAM FORMAT>>,
initialExplicitPolicy: <<UNKNOWN PARAM FORMAT>>,
initialPolicyMappingInhibit: <<UNKNOWN PARAM FORMAT>>,
initialInhibitPolicy: <<UNKNOWN PARAM FORMAT>>,
initialPermittedSubtreesSet: <<UNKNOWN PARAM FORMAT>>,
initialExcludedSubtreesSet: <<UNKNOWN PARAM FORMAT>>,
initialRequiredNameForms: <<UNKNOWN PARAM FORMAT>>
}} parameters
...
| DhImportKeyParams,
extractable: boolean,
keyUsages: string[]): PromiseLike<CryptoKey>;
importKey(
...
algorithm: Algorithm,
extractable: boolean,
keyUsages: string[]): PromiseLike<BufferSource | JsonWebKey>;
generateKey(
algorithm: string,
extractable: boolean,
keyUsages: string[]): PromiseLike<CryptoKeyPair | CryptoKey>;
generateKey(
algorithm: RsaHashedKeyGenParams | EcKeyGenParams | DhKeyGenParams,
extractable: boolean,
keyUsages: string[]): PromiseLike<CryptoKeyPair>;
generateKey(
...
key: CryptoKey,
data: BufferSource): PromiseLike<ArrayBuffer>;
unwrapKey(
format: string,
...
data: BufferSource): PromiseLike<boolean>;
wrapKey(
format: string,
key: CryptoKey,
...
| Pbkdf2Params,
baseKey: CryptoKey,
length: number): PromiseLike<ArrayBuffer>;
deriveKey(
algorithm: string
| EcdhKeyDeriveParams
| DhKeyDeriveParams
...
encrypt(
contentEncryptionAlgorithm: Algorithm,
contentToEncrypt: ArrayBuffer): PromiseLike<ArrayBuffer>;
 ...
 * @returns {Promise}
 */
declare export default function generatorsDriver(generatorInstance: any): PromiseLike<any>
...
toJSON(): any
	...
	import type {
        ...
        } from 'pkijs/src/BasicOCSPResponse';

	import type {
          CreateFroCertificateParams
        } from 'pkijs/src/CertID';
...
toJSON(): any
	...
	import type {
          VerifyResult,VerifyParams
        } from 'pkijs/src/SignedData';
...
subtle: SubtleCrypto
	...
	declare function setEngine(name: string, crypto: Crypto, subtle: SubtleCrypto): void
 ...
 * @returns {ArrayBuffer}
 */
declare function createECDSASignatureFromCMS(cmsSignature: Sequence): ArrayBuffer
...
Zbuffer: ArrayBuffer,
Counter: number,
SharedInfo: ArrayBuffer): PromiseLike<{
counter: number,
result: ArrayBuffer
}>
...
Zbuffer: ArrayBuffer,
keydatalen: number,
SharedInfo: ArrayBuffer): PromiseLike<ArrayBuffer>
