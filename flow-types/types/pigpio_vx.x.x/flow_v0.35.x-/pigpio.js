 ...
 */
declare export class Gpio mixins NodeJS.EventEmitter {
 ...
 */
constructor(gpio: number, options?: {
 ...
 * PI_CLOCK_PWM
 */
declare export var CLOCK_PWM: number;
	
/**
 * PI_CLOCK_PCM
 */
declare export var CLOCK_PCM: number;
	
/**
 * Initialize the pigpio package
 */
declare export function initialize(): void

	
/**
 * Terminate the pigpio package
 */
declare export function terminate(): void
 ...
 */
declare export function configureClock(microseconds: number, peripheral: number): void
 ...
 */
declare export function configureSocketPort(port: number): void
 ...
 */
declare export function hardwareRevision(): number
 ...
 * of overflow.
 */
declare export function getTick(): number
 ...
 */
declare export function tickDiff(startTick: number, endTick: number): number
