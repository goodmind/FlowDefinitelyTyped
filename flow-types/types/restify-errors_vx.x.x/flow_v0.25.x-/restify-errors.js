declare module "restify-errors" {
  import type { VError, Options as vErrorOptions } from "verror";
  ...
  declare export function makeErrFromCode(
    statusCode: number,
    ...args: any[]
  ): HttpError;
  ...
  declare export class ProxyAuthenticationRequiredError
    mixins DefinedHttpError {}
  ...
  declare export class RequestHeaderFieldsTooLargeError
    mixins DefinedHttpError {}
  ...
  declare export class NetworkAuthenticationRequiredError
    mixins DefinedHttpError {}
  ...
  declare export class UnavailableForLegalReasonsError
    mixins DefinedHttpError {}
