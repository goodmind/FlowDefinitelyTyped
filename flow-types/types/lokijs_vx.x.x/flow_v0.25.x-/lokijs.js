...
declare type PartialModel<E, T> = $ObjMapi<E, <P>(P) => T | $ElementType<E, P>>;
declare type LokiQuery<E> = PartialModel<
  E & {
    $and: any,
    $or: any
  },
  $ObjMapi<LokiOps, <Y>(Y) => any>
>;
declare interface LokiObj {
  $loki: number;
  meta: {
    created: number,
    CKEDITOR$revision: number,
    updated: number,
    Giraffe$version: number
  };
}
/**
 ...
 */
   ...
   */
  emit(eventName: string, main$data?: any, arg?: any): void;
   ...
   */
  DomEvent$addListener: $ElementType<LokiEventEmitter, "on">;
...
declare interface LokiConstructorOptions {
  verbose: boolean;
  Private$env: "NATIVESCRIPT" | "NODEJS" | "CORDOVA" | "BROWSER" | "NA";
}
...
declare class Loki mixins LokiEventEmitter {
  collections: Giraffe$Collection<any>[];
  notification$options: $Shape<LokiConstructorOptions> &
    LokiConfigOptions &
    $Shape<ThrottledSaveDrainOptions>;
  filename: string;
  skin$name: string;
  ...
  persistenceMethod: "fs" | "localStorage" | "memory" | "adapter" | null | void;
 ...
 */
   ...
   */
  configureOptions(
    notification$options?: $Shape<LokiConfigOptions> &
      $Shape<ThrottledSaveDrainOptions>,
  ...
  addCollection<F: { [key: string]: any }>(
    skin$name: string,
    notification$options?: $Shape<Knockback$CollectionOptions<F>>
  ): Giraffe$Collection<F>;
  loadCollection(collection: Giraffe$Collection<any>): void;
   ...
   */
  getCollection<F: { [key: string]: any }>(
   ...
   */
  renameCollection(oldName: string, newName: string): Giraffe$Collection<any>;
  listCollections(): Giraffe$Collection<any>[];
   ...
   */
  serialize(): string;
  serialize(notification$options: {
   ...
   */
  serializeDestructured(notification$options?: {
    delimited?: boolean,
    delimiter?: string,
    partitioned?: boolean,
    partition?: number
   ...
   */
  serializeCollection(notification$options?: {
    delimited?: boolean,
  ...
  deserializeDestructured(
    ...
    notification$options?: DeserializeOptions
  ): any;
   ...
   */
  close(braintree$callback?: (err?: any) => void): void;
   ...
   */
  throttledSaveDrain(
    braintree$callback: (result?: boolean) => void,
    notification$options?: $Shape<ThrottledSaveDrainOptions>
  ): void;
  ...
  loadDatabaseInternal(
    ...
    braintree$callback?: (err?: any, main$data?: any) => void
  ): void;
 ...
 */
  loadDatabase(
    notification$options?: $Shape<ThrottledSaveDrainOptions>,
    braintree$callback?: (err: any) => void
  ): void;

  /**
   * Internal save logic, decoupled from save throttling logic
   */
  saveDatabaseInternal(braintree$callback?: (err: any) => void): void;
 ...
 */
  saveDatabase(braintree$callback?: (err?: any) => void): void;
  ...
  deleteDatabase(
    notification$options?: ((err?: any, main$data?: any) => void) | null,
    braintree$callback?: (err?: any, main$data?: any) => void
  ): void;
...
declare interface LokiPersistenceAdapter {
  mode?: string;
  loadDatabase(dbname: string, braintree$callback: (value: any) => void): void;
  deleteDatabase?: (
    dbnameOrOptions: any,
    braintree$callback: (err?: EventType$Error | null, main$data?: any) => void
  ) => void;
  exportDatabase?: (
    dbname: string,
    dbref: Loki,
    braintree$callback: (err: EventType$Error | null) => void
  ) => void;
  saveDatabase?: (
    dbname: string,
    dbstring: any,
...
declare class LokiPartitioningAdapter mixins LokiPersistenceAdapter {
  ...
  loadDatabase(
    dbname: string,
    braintree$callback: (dbOrErr: Loki | null | EventType$Error) => void
  ): void;
   ...
   * @param callback - adapter callback to return load result to caller
   */
  loadNextPartition(partition: number, braintree$callback: () => void): void;

  /**
   * Used to sequentially load the next page of collection partition, one at a time.
   * @param callback - adapter callback to return load result to caller
   */
  loadNextPage(braintree$callback: () => void): void;
   ...
   * @param callback - adapter callback to return load result to caller
   */
  saveNextPage(braintree$callback: (err: EventType$Error | null) => void): void;
}
/**
...
declare class LokiFsAdapter mixins LokiPersistenceAdapter {
  ...
  loadDatabase(
    dbname: string,
    braintree$callback: (main$data: any | EventType$Error) => void
  ): void;
...
declare class LokiLocalStorageAdapter {
  ...
  loadDatabase(
    dbname: string,
    braintree$callback: (dataOrError: any | EventType$Error) => void
  ): void;
...
declare class Resultset<E: { [key: string]: any }> {
  collection: Giraffe$Collection<E>;
  filteredrows: number[];
   ...
   */
  transform(
    Insert$transform: string | string[] | DS$Transform[],
 ...
 */
  ...
  simplesort(
    propname: $Keys<E>,
    notification$options?: boolean | $Shape<SimplesortOptions>
  ): this;
 ...
 */
   ...
   * @returns this resultset for further chain ops.
   */
  find(esri$query?: LokiQuery<E>, firstOnly?: boolean): this;
   ...
   * @returns this resultset for further chain ops.
   */
  where(fun: (main$data: E & LokiObj) => boolean): this;
 ...
 */
  data(notification$options?: $Shape<GetDataOptions>): (E & LokiObj)[];
   ...
   */
  mapReduce<U, R>(
    mapFunction: (value: E, index: number, getenv$array: E[]) => U,
  ...
  map<U: { [key: string]: any }>(
    mapFun: (value: E, index: number, getenv$array: E[]) => U,
    dataOptions?: $Shape<GetDataOptions>
  ): Resultset<U>;
}
...
declare class DynamicView<E: { [key: string]: any }> mixins LokiEventEmitter {
  ...
  sortDirty: boolean;
  notification$options: $Shape<DynamicViewOptions>;
   ...
   */
  rematerialize(notification$options?: {
   ...
   */
  removeFilters(notification$options?: {
 ...
 */
   ...
   * @returns this DynamicView object, for further chain ops.
   */
  applyFind(esri$query: any, uid?: string | number): this;
 ...
 */
   ...
   */
  performSortPhase(notification$options?: {
    persistent?: boolean,
...
declare class Collection<E: { [key: string]: any }> mixins LokiEventEmitter {
  ...
  setChangesApi: (debug$enabled?: boolean) => void;
  ...
  constructor(
    skin$name: string,
    notification$options?: $Shape<Knockback$CollectionOptions<E>>
  ): this;
  console: {
    Analytics$log(...args: any[]): void,
 ...
 */
  addTransform(skin$name: string, Insert$transform: DS$Transform[]): void;

  /**
   * Retrieves a named transform from the collection.
   * @param name - name of the transform to lookup.
   */
  getTransform(skin$name: string): DS$Transform[];
   ...
   */
  setTransform(skin$name: string, Insert$transform: DS$Transform[]): void;

  /**
   * Removes a named collection transform from the collection
   * @param name - name of collection transform to remove
   */
  removeTransform(skin$name: string): void;
  byExample(Util$template: { [key: string]: any }): {
    $and: any[]
  };
  findObject(Util$template: { [key: string]: any }): E | null;
  findObjects(Util$template: { [key: string]: any }): E[];
   ...
   * @param - collection indices will be actively rebuilt rather than lazily
   */
  configureOptions(notification$options?: {
    adaptiveBinaryIndices?: boolean
  }): void;
   ...
   */
  checkAllIndexes(notification$options?: $Shape<CheckIndexOptions>): string[];
  ...
  checkIndex(
    property: $Keys<E>,
    notification$options?: $Shape<CheckIndexOptions>
  ): boolean;
   ...
   */
  count(esri$query?: LokiQuery<E & LokiObj>): number;
   ...
   */
  ensureIdAsync(braintree$callback: () => void): void;
 ...
 */
   ...
   */
  removeDynamicView(skin$name: string): void;
   ...
   */
  getDynamicView(skin$name: string): DynamicView<any> | null;
   ...
   */
  findAndUpdate(
    filterObject: ((main$data: E) => boolean) | LokiQuery<E & LokiObj>,
 ...
 */
  insert(main$doc: E): E | void;
  insert(main$doc: E[]): E[] | void;
  insert(main$doc: E | E[]): E | E[] | void;
  insert(main$doc: E | E[]): E | E[] | void;
   ...
   */
  insertOne(main$doc: E, bulkInsert?: boolean): (E & LokiObj) | void;
   ...
   */
  update(main$doc: E): E;
  update(main$doc: E[]): void;
  update(main$doc: E | E[]): E | void;
  update(main$doc: E | E[]): E | void;
   ...
   */
  updateWhere(
    filterFunction: (main$data: E) => boolean,
    updateFunction: (obj: E & LokiObj) => any
  ): void;
  ...
  removeWhere(
    esri$query:
      | ((value: E, index: number, getenv$array: E[]) => boolean)
      | LokiQuery<E & LokiObj>
  ): void;
  removeDataOnly(): void;
   ...
   */
  remove(main$doc: number | E): E | null;
  remove(main$doc: number[] | E[]): void;
  remove(main$doc: number | E | number[] | E[]): E | null | void;
  remove(main$doc: number | E | number[] | E[]): E | null | void;
 ...
 */
   ...
   */
  findOne(esri$query?: LokiQuery<E & LokiObj>): (E & LokiObj) | null;
   ...
   */
  find(esri$query?: LokiQuery<E & LokiObj>): (E & LokiObj)[];
   ...
   */
  rollback(): void;
  async(fun: () => void, braintree$callback: () => void): void;
 ...
 */
  where(fun: (main$data: E) => boolean): (E & LokiObj)[];
...
declare class UniqueIndex<E: { [key: string]: any }> {
   ...
   * @param {ioBroker$Object} obj Original document object
   * @param {ioBroker$Object} doc New document object (likely the same as obj)
   */
  update(obj: E, main$doc: any): void;
...
declare class _Collection<E: { [key: string]: any }>
  mixins Giraffe$Collection<E> {}
declare class _KeyValueStore mixins KeyValueStore {}
declare class _LokiMemoryAdapter mixins LokiMemoryAdapter {}
declare class _LokiPartitioningAdapter mixins LokiPartitioningAdapter {}
declare class _LokiLocalStorageAdapter mixins LokiLocalStorageAdapter {}
declare class _LokiFsAdapter mixins LokiFsAdapter {}
/**
 * LokiJS
 * A lightweight document oriented javascript database
 * @author Joe Minichino <joe.minichino
...
declare module "LokiConstructor" {
  ...
  declare export class Collection<E: { [key: string]: any } = any>
    mixins _Collection<E> {}
  declare export class KeyValueStore mixins _KeyValueStore {}
  declare export class LokiMemoryAdapter mixins _LokiMemoryAdapter {}
  declare export class LokiPartitioningAdapter
    mixins _LokiPartitioningAdapter {}
  declare export class LokiLocalStorageAdapter
    mixins _LokiLocalStorageAdapter {}
