...
userIsInRole: typeof Roles$userIsInRole,
        GLOBAL_GROUP: typeof Roles$GLOBAL_GROUP,
subscription: typeof Roles$subscription,
      }

/**
 * Constant used to reference the special 'global' group that
 * can be used to apply blanket permissions across all groups.
 * @example Roles.addUsersToRoles(user, 'admin', Roles.GLOBAL_GROUP)
 ...
 * @final
 */
declare var Roles$GLOBAL_GROUP: string;
 ...
 * @example `Roles.subscription.ready()` // => `true` if user roles have been loaded
 * @property subscription
 * @type {Object}
 * @for Roles
 */
declare var Roles$subscription: Subscription;
 ...
 */
declare function Roles$getRolesForUser(user: string | Object, group?: string): string[]
...
name: string
      ...
      declare var npm$namespace$Meteor: {
        ...
        roles: typeof Meteor$roles,
      }
declare var Meteor$roles: Mongo.Collection<Roles$Roles$Role>;
