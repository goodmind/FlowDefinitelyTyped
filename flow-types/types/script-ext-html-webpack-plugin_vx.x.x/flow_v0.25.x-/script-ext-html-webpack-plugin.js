declare module "script-ext-html-webpack-plugin" {
  ...
  declare class ScriptExtHtmlWebpackPlugin mixins Plugin {
    constructor(
      options?: ScriptExtHtmlWebpackPlugin$ScriptExtHtmlWebpackPlugin$Options
    ): this;
  }
  declare type ScriptMatchingPatternBase =
    | string
    | RegExp
  ...
  declare type ScriptMatchingPattern =
    | ScriptMatchingPatternBase
    | ScriptMatchingPatternHash;
  declare type ScriptMatchingPatternPre =
    | ScriptMatchingPatternBase
    | (ScriptMatchingPatternHash & {
