declare module "mockjs" {
  ...
  declare type mockjs$MockjsSetup = (
    settings: mockjs$MockjsSetupSettings
  ) => void;
  ...
  declare type mockjs$RandomDateUtilString =
    | "year"
    | "month"
    | "week"
    | "day"
  ...
  declare type mockjs$RandomWebProtocal =
    | "http"
    | "ftp"
    | "gopher"
    | "mailto"
  ...
  declare type mockjs$MockjsValid = (
    template: any,
    data: any
  ) => mockjs$MockjsValidRsItem[];
  ...
  declare type mockjs$MockjsToJSONSchema = (
    template: any
  ) => mockjs$MockjsToJSONSchemaRs;
