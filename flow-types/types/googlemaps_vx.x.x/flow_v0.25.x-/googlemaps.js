...
export interface maps$MapOptions {
  /**
...
declare export class maps$MapTypeId {
  ...
  static +SATELLITE: Class<maps$MapTypeId__SATELLITE> &
    maps$MapTypeId__SATELLITE &
    2; // 2
 ...
 */
export interface maps$MapTypeControlOptions {
  /**
...
declare export class maps$MapTypeControlStyle {
  constructor(...args: empty): mixed;
  static +DEFAULT: Class<maps$MapTypeControlStyle__DEFAULT> &
    maps$MapTypeControlStyle__DEFAULT &
    0; // 0
  static +DROPDOWN_MENU: Class<maps$MapTypeControlStyle__DROPDOWN_MENU> &
    maps$MapTypeControlStyle__DROPDOWN_MENU &
    1; // 1
  static +HORIZONTAL_BAR: Class<maps$MapTypeControlStyle__HORIZONTAL_BAR> &
    maps$MapTypeControlStyle__HORIZONTAL_BAR &
    2; // 2
}

declare class maps$MapTypeControlStyle__DEFAULT
  mixins maps$MapTypeControlStyle {}
declare class maps$MapTypeControlStyle__DROPDOWN_MENU
  mixins maps$MapTypeControlStyle {}
declare class maps$MapTypeControlStyle__HORIZONTAL_BAR
  mixins maps$MapTypeControlStyle {}

export interface maps$OverviewMapControlOptions {
  opened?: boolean;
}

export type maps$GestureHandlingOptions =
  | "cooperative"
  | "greedy"
  | "none"
  | "auto";
 ...
 */
export interface maps$PanControlOptions {
  /**
   * Position id. Used to specify the position of the control on the map.
 ...
 */
export interface maps$RotateControlOptions {
  /**
   * Position id. Used to specify the position of the control on the map.
   * The default position is TOP_LEFT.
   */
 ...
 */
export interface maps$ScaleControlOptions {
  /**
...
declare export class maps$ScaleControlStyle {
  constructor(...args: empty): mixed;
  static +DEFAULT: Class<maps$ScaleControlStyle__DEFAULT> &
    maps$ScaleControlStyle__DEFAULT &
    0; // 0
}
 ...
 */
export interface maps$StreetViewControlOptions {
  /**
 ...
 */
export interface maps$ZoomControlOptions {
  /**
   * Position id. Used to specify the position of the control on the map.
   * The default position is TOP_LEFT.
   */
...
declare export class maps$ZoomControlStyle {
  constructor(...args: empty): mixed;
  static +DEFAULT: Class<maps$ZoomControlStyle__DEFAULT> &
    maps$ZoomControlStyle__DEFAULT &
    0; // 0
...
declare export class maps$ControlPosition {
  constructor(...args: empty): mixed;
  static +BOTTOM_CENTER: Class<maps$ControlPosition__BOTTOM_CENTER> &
    maps$ControlPosition__BOTTOM_CENTER &
    0; // 0
  static +BOTTOM_LEFT: Class<maps$ControlPosition__BOTTOM_LEFT> &
    maps$ControlPosition__BOTTOM_LEFT &
    1; // 1
  static +BOTTOM_RIGHT: Class<maps$ControlPosition__BOTTOM_RIGHT> &
    maps$ControlPosition__BOTTOM_RIGHT &
    2; // 2
  static +LEFT_BOTTOM: Class<maps$ControlPosition__LEFT_BOTTOM> &
    maps$ControlPosition__LEFT_BOTTOM &
    3; // 3
  static +LEFT_CENTER: Class<maps$ControlPosition__LEFT_CENTER> &
    maps$ControlPosition__LEFT_CENTER &
    4; // 4
  static +LEFT_TOP: Class<maps$ControlPosition__LEFT_TOP> &
    maps$ControlPosition__LEFT_TOP &
    5; // 5
  static +RIGHT_BOTTOM: Class<maps$ControlPosition__RIGHT_BOTTOM> &
    maps$ControlPosition__RIGHT_BOTTOM &
    6; // 6
  static +RIGHT_CENTER: Class<maps$ControlPosition__RIGHT_CENTER> &
    maps$ControlPosition__RIGHT_CENTER &
    7; // 7
  static +RIGHT_TOP: Class<maps$ControlPosition__RIGHT_TOP> &
    maps$ControlPosition__RIGHT_TOP &
    8; // 8
  static +TOP_CENTER: Class<maps$ControlPosition__TOP_CENTER> &
    maps$ControlPosition__TOP_CENTER &
    9; // 9
  static +TOP_LEFT: Class<maps$ControlPosition__TOP_LEFT> &
    maps$ControlPosition__TOP_LEFT &
    10; // 10
  static +TOP_RIGHT: Class<maps$ControlPosition__TOP_RIGHT> &
    maps$ControlPosition__TOP_RIGHT &
    11; // 11
}
...
declare export class maps$Data mixins maps$MVCObject {
  ...
  loadGeoJson(
    url: string,
    options?: maps$Data.GeoJsonOptions,
    callback?: (features: maps$Data.Feature[]) => void
  ): void;
  overrideStyle(
    feature: maps$Data.Feature,
    style: maps$Data.StyleOptions
  ): void;
...
declare module "Data" {
  ...
  declare export type StylingFunction = (
    feature: maps$Data.Feature
  ...
  declare export class Feature {
    ...
    setGeometry(
      newGeometry: maps$Data.Geometry | maps$LatLng | maps$LatLngLiteral
    ): void;
  ...
  declare export class MultiLineString mixins Data.Geometry {
    constructor(
      elements: (maps$Data.LineString | (maps$LatLng | maps$LatLngLiteral)[])[]
    ): this;
  ...
  declare export class Polygon mixins Data.Geometry {
    constructor(
      elements: (maps$Data.LinearRing | (maps$LatLng | maps$LatLngLiteral)[])[]
    ): this;
  ...
  declare export class MultiPolygon mixins Data.Geometry {
    constructor(
      elements: (
        | maps$Data.maps$Polygon
        | (LinearRing | (maps$LatLng | maps$LatLngLiteral)[])[]
      )[]
    ): this;
  ...
  declare export class GeometryCollection mixins Data.Geometry {
    constructor(
      elements: (maps$Data.Geometry[] | maps$LatLng[] | maps$LatLngLiteral)[]
    ): this;
...
export interface maps$MarkerOptions {
  /**
...
export interface maps$MarkerLabel {
  /**
...
export interface maps$MarkerShape {
  coords?: number[];
  type?: string;
}

export interface maps$Symbol {
  /**
...
export interface maps$InfoWindowOptions {
  /**
...
export interface maps$PolylineOptions {
  /**
...
export interface maps$IconSequence {
...
declare export class maps$Polygon mixins maps$MVCObject {
  ...
  setPaths(
    paths:
      | maps$MVCArray<maps$MVCArray<maps$LatLng>>
...
export interface maps$PolygonOptions {
  /**
...
export type maps$PolyMouseEvent = {
  edge?: number,
  path?: number,
  vertex?: number
} & maps$MouseEvent;
...
export interface maps$RectangleOptions {
  bounds?: maps$LatLngBounds | maps$LatLngBoundsLiteral;
  clickable?: boolean;
  draggable?: boolean;
  editable?: boolean;
...
export interface maps$CircleOptions {
  /**
   * The center
   */
  center?: maps$LatLng | maps$LatLngLiteral;
...
export type maps$CircleLiteral = {
  /**
...
declare export class maps$StrokePosition {
  constructor(...args: empty): mixed;
  static +CENTER: Class<maps$StrokePosition__CENTER> &
    maps$StrokePosition__CENTER &
    0; // 0
  static +INSIDE: Class<maps$StrokePosition__INSIDE> &
    maps$StrokePosition__INSIDE &
    1; // 1
  static +OUTSIDE: Class<maps$StrokePosition__OUTSIDE> &
    maps$StrokePosition__OUTSIDE &
    2; // 2
}
...
declare export class maps$GroundOverlay mixins maps$MVCObject {
  constructor(
    url: string,
    bounds: maps$LatLngBounds | maps$LatLngBoundsLiteral,
    opts?: maps$GroundOverlayOptions
  ): this;
  getBounds(): maps$LatLngBounds;
  getMap(): maps$Map;
  getOpacity(): number;
...
export interface maps$GroundOverlayOptions {
  clickable?: boolean;
  map?: maps$Map;
  opacity?: number;
}
...
export interface maps$MapPanes {
  floatPane: Element;
  floatShadow: Element;
  mapPane: Element;
  markerLayer: Element;
...
declare export class maps$Geocoder {
  geocode(
    ...
    callback: (
      results: maps$GeocoderResult[],
      status: maps$GeocoderStatus
    ) => void
  ): void;
}

export interface maps$GeocoderRequest {
  address?: string;
  bounds?: maps$LatLngBounds | maps$LatLngBoundsLiteral;
...
export interface maps$GeocoderComponentRestrictions {
...
declare export class maps$GeocoderStatus {
  constructor(...args: empty): mixed;
  static +ERROR: Class<maps$GeocoderStatus__ERROR> &
    maps$GeocoderStatus__ERROR &
    0; // 0
  static +INVALID_REQUEST: Class<maps$GeocoderStatus__INVALID_REQUEST> &
    maps$GeocoderStatus__INVALID_REQUEST &
    1; // 1
  static +OK: Class<maps$GeocoderStatus__OK> & maps$GeocoderStatus__OK & 2; // 2
  static +OVER_QUERY_LIMIT: Class<maps$GeocoderStatus__OVER_QUERY_LIMIT> &
    maps$GeocoderStatus__OVER_QUERY_LIMIT &
    3; // 3
  static +REQUEST_DENIED: Class<maps$GeocoderStatus__REQUEST_DENIED> &
    maps$GeocoderStatus__REQUEST_DENIED &
    4; // 4
  static +UNKNOWN_ERROR: Class<maps$GeocoderStatus__UNKNOWN_ERROR> &
    maps$GeocoderStatus__UNKNOWN_ERROR &
    5; // 5
  static +ZERO_RESULTS: Class<maps$GeocoderStatus__ZERO_RESULTS> &
    maps$GeocoderStatus__ZERO_RESULTS &
    6; // 6
}
...
declare class maps$GeocoderStatus__OVER_QUERY_LIMIT
  mixins maps$GeocoderStatus {}
...
export interface maps$GeocoderResult {
...
export interface maps$GeocoderAddressComponent {
  long_name: string;
  short_name: string;
  types: string[];
}

export interface maps$GeocoderGeometry {
...
declare export class maps$GeocoderLocationType {
  constructor(...args: empty): mixed;
  static +APPROXIMATE: Class<maps$GeocoderLocationType__APPROXIMATE> &
    maps$GeocoderLocationType__APPROXIMATE &
    0; // 0
  static +GEOMETRIC_CENTER: Class<maps$GeocoderLocationType__GEOMETRIC_CENTER> &
    maps$GeocoderLocationType__GEOMETRIC_CENTER &
    1; // 1
  static +RANGE_INTERPOLATED: Class<maps$GeocoderLocationType__RANGE_INTERPOLATED> &
    maps$GeocoderLocationType__RANGE_INTERPOLATED &
    2; // 2
  static +ROOFTOP: Class<maps$GeocoderLocationType__ROOFTOP> &
    maps$GeocoderLocationType__ROOFTOP &
    3; // 3
}

declare class maps$GeocoderLocationType__APPROXIMATE
  mixins maps$GeocoderLocationType {}
declare class maps$GeocoderLocationType__GEOMETRIC_CENTER
  mixins maps$GeocoderLocationType {}
declare class maps$GeocoderLocationType__RANGE_INTERPOLATED
  mixins maps$GeocoderLocationType {}
declare class maps$GeocoderLocationType__ROOFTOP
  mixins maps$GeocoderLocationType {}
...
export interface maps$DirectionsRendererOptions {
...
declare export class maps$DirectionsService {
  route(
    ...
    callback: (
      result: maps$DirectionsResult,
      status: maps$DirectionsStatus
    ) => void
  ): void;
}
 ...
 */
export interface maps$DirectionsRequest {
  /**
...
declare export class maps$TravelMode {
  constructor(...args: empty): mixed;
  static +BICYCLING: Class<maps$TravelMode__BICYCLING> &
    maps$TravelMode__BICYCLING &
    0; // 0
  static +DRIVING: Class<maps$TravelMode__DRIVING> &
    maps$TravelMode__DRIVING &
    1; // 1
  static +TRANSIT: Class<maps$TravelMode__TRANSIT> &
    maps$TravelMode__TRANSIT &
    2; // 2
  static +WALKING: Class<maps$TravelMode__WALKING> &
    maps$TravelMode__WALKING &
    3; // 3
}
...
declare export class maps$UnitSystem {
  constructor(...args: empty): mixed;
  static +IMPERIAL: Class<maps$UnitSystem__IMPERIAL> &
    maps$UnitSystem__IMPERIAL &
    0; // 0
...
export interface maps$TransitOptions {
  arrivalTime?: Date;
  departureTime?: Date;
...
declare export class maps$TransitMode {
  ...
  static +SUBWAY: Class<maps$TransitMode__SUBWAY> &
    maps$TransitMode__SUBWAY &
    2; // 2
...
declare export class maps$TransitRoutePreference {
  constructor(...args: empty): mixed;
  static +FEWER_TRANSFERS: Class<maps$TransitRoutePreference__FEWER_TRANSFERS> &
    maps$TransitRoutePreference__FEWER_TRANSFERS &
    0; // 0
  static +LESS_WALKING: Class<maps$TransitRoutePreference__LESS_WALKING> &
    maps$TransitRoutePreference__LESS_WALKING &
    1; // 1
}

declare class maps$TransitRoutePreference__FEWER_TRANSFERS
  mixins maps$TransitRoutePreference {}
declare class maps$TransitRoutePreference__LESS_WALKING
  mixins maps$TransitRoutePreference {}

export interface maps$TransitFare {}

export interface maps$DrivingOptions {
  departureTime: Date;
...
declare export class maps$TrafficModel {
  constructor(...args: empty): mixed;
  static +BEST_GUESS: Class<maps$TrafficModel__BEST_GUESS> &
    maps$TrafficModel__BEST_GUESS &
    0; // 0
  static +OPTIMISTIC: Class<maps$TrafficModel__OPTIMISTIC> &
    maps$TrafficModel__OPTIMISTIC &
    1; // 1
  static +PESSIMISTIC: Class<maps$TrafficModel__PESSIMISTIC> &
    maps$TrafficModel__PESSIMISTIC &
    2; // 2
}
 ...
 */
export interface maps$DirectionsWaypoint {
  /**
...
declare export class maps$DirectionsStatus {
  constructor(...args: empty): mixed;
  static +INVALID_REQUEST: Class<maps$DirectionsStatus__INVALID_REQUEST> &
    maps$DirectionsStatus__INVALID_REQUEST &
    0; // 0
  static +MAX_WAYPOINTS_EXCEEDED: Class<maps$DirectionsStatus__MAX_WAYPOINTS_EXCEEDED> &
    maps$DirectionsStatus__MAX_WAYPOINTS_EXCEEDED &
    1; // 1
  static +NOT_FOUND: Class<maps$DirectionsStatus__NOT_FOUND> &
    maps$DirectionsStatus__NOT_FOUND &
    2; // 2
  static +OK: Class<maps$DirectionsStatus__OK> & maps$DirectionsStatus__OK & 3; // 3
  static +OVER_QUERY_LIMIT: Class<maps$DirectionsStatus__OVER_QUERY_LIMIT> &
    maps$DirectionsStatus__OVER_QUERY_LIMIT &
    4; // 4
  static +REQUEST_DENIED: Class<maps$DirectionsStatus__REQUEST_DENIED> &
    maps$DirectionsStatus__REQUEST_DENIED &
    5; // 5
  static +UNKNOWN_ERROR: Class<maps$DirectionsStatus__UNKNOWN_ERROR> &
    maps$DirectionsStatus__UNKNOWN_ERROR &
    6; // 6
  static +ZERO_RESULTS: Class<maps$DirectionsStatus__ZERO_RESULTS> &
    maps$DirectionsStatus__ZERO_RESULTS &
    7; // 7
}

declare class maps$DirectionsStatus__INVALID_REQUEST
  mixins maps$DirectionsStatus {}
declare class maps$DirectionsStatus__MAX_WAYPOINTS_EXCEEDED
  mixins maps$DirectionsStatus {}
...
declare class maps$DirectionsStatus__OVER_QUERY_LIMIT
  mixins maps$DirectionsStatus {}
declare class maps$DirectionsStatus__REQUEST_DENIED
  mixins maps$DirectionsStatus {}
declare class maps$DirectionsStatus__UNKNOWN_ERROR
  mixins maps$DirectionsStatus {}
declare class maps$DirectionsStatus__ZERO_RESULTS
  mixins maps$DirectionsStatus {}

export interface maps$DirectionsResult {
 ...
 */
export interface maps$DirectionsGeocodedWaypoint {
  partial_match: boolean;
  place_id: string;
  types: string[];
}
 ...
 */
export interface maps$DirectionsRoute {
  /**
...
export interface maps$DirectionsLeg {
...
export interface maps$DirectionsStep {
  distance: maps$Distance;
  duration: maps$Duration;
  end_location: maps$LatLng;
  instructions: string;
...
export interface maps$Distance {
  text: string;
  value: number;
}

export interface maps$Duration {
  text: string;
  value: number;
}

export interface maps$Time {
  text: string;
  time_zone: string;
  value: Date;
}

export interface maps$TransitDetails {
...
export interface maps$TransitStop {
  location: maps$LatLng;
  name: string;
}

export interface maps$TransitLine {
...
export interface maps$TransitAgency {
  name: string;
  phone: string;
  url: string;
}

export interface maps$TransitVehicle {
  icon: string;
  local_icon: string;
  name: string;
...
declare export class maps$VehicleType {
  ...
  static +CABLE_CAR: Class<maps$VehicleType__CABLE_CAR> &
    maps$VehicleType__CABLE_CAR &
    1; // 1
  static +COMMUTER_TRAIN: Class<maps$VehicleType__COMMUTER_TRAIN> &
    maps$VehicleType__COMMUTER_TRAIN &
    2; // 2
  static +FERRY: Class<maps$VehicleType__FERRY> & maps$VehicleType__FERRY & 3; // 3
  static +FUNICULAR: Class<maps$VehicleType__FUNICULAR> &
    maps$VehicleType__FUNICULAR &
    4; // 4
  static +GONDOLA_LIFT: Class<maps$VehicleType__GONDOLA_LIFT> &
    maps$VehicleType__GONDOLA_LIFT &
    5; // 5
  static +HEAVY_RAIL: Class<maps$VehicleType__HEAVY_RAIL> &
    maps$VehicleType__HEAVY_RAIL &
    6; // 6
  static +HIGH_SPEED_TRAIN: Class<maps$VehicleType__HIGH_SPEED_TRAIN> &
    maps$VehicleType__HIGH_SPEED_TRAIN &
    7; // 7
  static +INTERCITY_BUS: Class<maps$VehicleType__INTERCITY_BUS> &
    maps$VehicleType__INTERCITY_BUS &
    8; // 8
  static +METRO_RAIL: Class<maps$VehicleType__METRO_RAIL> &
    maps$VehicleType__METRO_RAIL &
    9; // 9
  static +MONORAIL: Class<maps$VehicleType__MONORAIL> &
    maps$VehicleType__MONORAIL &
    10; // 10
  ...
  static +SHARE_TAXI: Class<maps$VehicleType__SHARE_TAXI> &
    maps$VehicleType__SHARE_TAXI &
    13; // 13
  static +SUBWAY: Class<maps$VehicleType__SUBWAY> &
    maps$VehicleType__SUBWAY &
    14; // 14
  static +TRAM: Class<maps$VehicleType__TRAM> & maps$VehicleType__TRAM & 15; // 15
  static +TROLLEYBUS: Class<maps$VehicleType__TROLLEYBUS> &
    maps$VehicleType__TROLLEYBUS &
    16; // 16
}
...
declare export class maps$ElevationService {
  getElevationAlongPath(
    ...
    callback: (
      results: maps$ElevationResult[],
      status: maps$ElevationStatus
    ) => void
  ): void;
...
export interface maps$LocationElevationRequest {
  locations: maps$LatLng[];
}

export interface maps$PathElevationRequest {
  path?: maps$LatLng[];
  samples?: number;
}

export interface maps$ElevationResult {
  elevation: number;
  location: maps$LatLng;
  resolution: number;
}
...
declare export class maps$ElevationStatus {
  constructor(...args: empty): mixed;
  static +INVALID_REQUEST: Class<maps$ElevationStatus__INVALID_REQUEST> &
    maps$ElevationStatus__INVALID_REQUEST &
    0; // 0
  static +OK: Class<maps$ElevationStatus__OK> & maps$ElevationStatus__OK & 1; // 1
  static +OVER_QUERY_LIMIT: Class<maps$ElevationStatus__OVER_QUERY_LIMIT> &
    maps$ElevationStatus__OVER_QUERY_LIMIT &
    2; // 2
  static +REQUEST_DENIED: Class<maps$ElevationStatus__REQUEST_DENIED> &
    maps$ElevationStatus__REQUEST_DENIED &
    3; // 3
  static +UNKNOWN_ERROR: Class<maps$ElevationStatus__UNKNOWN_ERROR> &
    maps$ElevationStatus__UNKNOWN_ERROR &
    4; // 4
}

declare class maps$ElevationStatus__INVALID_REQUEST
  mixins maps$ElevationStatus {}
declare class maps$ElevationStatus__OK mixins maps$ElevationStatus {}
declare class maps$ElevationStatus__OVER_QUERY_LIMIT
  mixins maps$ElevationStatus {}
declare class maps$ElevationStatus__REQUEST_DENIED
  mixins maps$ElevationStatus {}
...
declare export class maps$MaxZoomService {
  getMaxZoomAtLatLng(
    ...
    callback: (result: maps$MaxZoomResult) => void
  ): void;
}

export interface maps$MaxZoomResult {
...
declare export class maps$MaxZoomStatus {
  constructor(...args: empty): mixed;
  static +ERROR: Class<maps$MaxZoomStatus__ERROR> &
    maps$MaxZoomStatus__ERROR &
    0; // 0
...
declare export class maps$DistanceMatrixService {
  getDistanceMatrix(
    ...
    callback: (
      ...
      status: maps$DistanceMatrixStatus
    ) => void
  ): void;
}

export interface maps$DistanceMatrixRequest {
  avoidFerries?: boolean;
  avoidHighways?: boolean;
  avoidTolls?: boolean;
...
export interface maps$DistanceMatrixResponse {
  destinationAddresses: string[];
  originAddresses: string[];
  rows: maps$DistanceMatrixResponseRow[];
}

export interface maps$DistanceMatrixResponseRow {
  elements: maps$DistanceMatrixResponseElement[];
}

export interface maps$DistanceMatrixResponseElement {
  distance: maps$Distance;
  duration: maps$Duration;
  duration_in_traffic: maps$Duration;
  fare: maps$TransitFare;
...
declare export class maps$DistanceMatrixStatus {
  constructor(...args: empty): mixed;
  static +INVALID_REQUEST: Class<maps$DistanceMatrixStatus__INVALID_REQUEST> &
    maps$DistanceMatrixStatus__INVALID_REQUEST &
    0; // 0
  static +MAX_DIMENSIONS_EXCEEDED: Class<maps$DistanceMatrixStatus__MAX_DIMENSIONS_EXCEEDED> &
    maps$DistanceMatrixStatus__MAX_DIMENSIONS_EXCEEDED &
    1; // 1
  static +MAX_ELEMENTS_EXCEEDED: Class<maps$DistanceMatrixStatus__MAX_ELEMENTS_EXCEEDED> &
    maps$DistanceMatrixStatus__MAX_ELEMENTS_EXCEEDED &
    2; // 2
  static +OK: Class<maps$DistanceMatrixStatus__OK> &
    maps$DistanceMatrixStatus__OK &
    3; // 3
  static +OVER_QUERY_LIMIT: Class<maps$DistanceMatrixStatus__OVER_QUERY_LIMIT> &
    maps$DistanceMatrixStatus__OVER_QUERY_LIMIT &
    4; // 4
  static +REQUEST_DENIED: Class<maps$DistanceMatrixStatus__REQUEST_DENIED> &
    maps$DistanceMatrixStatus__REQUEST_DENIED &
    5; // 5
  static +UNKNOWN_ERROR: Class<maps$DistanceMatrixStatus__UNKNOWN_ERROR> &
    maps$DistanceMatrixStatus__UNKNOWN_ERROR &
    6; // 6
}

declare class maps$DistanceMatrixStatus__INVALID_REQUEST
  mixins maps$DistanceMatrixStatus {}
declare class maps$DistanceMatrixStatus__MAX_DIMENSIONS_EXCEEDED
  mixins maps$DistanceMatrixStatus {}
declare class maps$DistanceMatrixStatus__MAX_ELEMENTS_EXCEEDED
  mixins maps$DistanceMatrixStatus {}
declare class maps$DistanceMatrixStatus__OK mixins maps$DistanceMatrixStatus {}
declare class maps$DistanceMatrixStatus__OVER_QUERY_LIMIT
  mixins maps$DistanceMatrixStatus {}
declare class maps$DistanceMatrixStatus__REQUEST_DENIED
  mixins maps$DistanceMatrixStatus {}
declare class maps$DistanceMatrixStatus__UNKNOWN_ERROR
  mixins maps$DistanceMatrixStatus {}

declare export class maps$DistanceMatrixElementStatus {
  constructor(...args: empty): mixed;
  static +NOT_FOUND: Class<maps$DistanceMatrixElementStatus__NOT_FOUND> &
    maps$DistanceMatrixElementStatus__NOT_FOUND &
    0; // 0
  static +OK: Class<maps$DistanceMatrixElementStatus__OK> &
    maps$DistanceMatrixElementStatus__OK &
    1; // 1
  static +ZERO_RESULTS: Class<maps$DistanceMatrixElementStatus__ZERO_RESULTS> &
    maps$DistanceMatrixElementStatus__ZERO_RESULTS &
    2; // 2
}

declare class maps$DistanceMatrixElementStatus__NOT_FOUND
  mixins maps$DistanceMatrixElementStatus {}
declare class maps$DistanceMatrixElementStatus__OK
  mixins maps$DistanceMatrixElementStatus {}
declare class maps$DistanceMatrixElementStatus__ZERO_RESULTS
  mixins maps$DistanceMatrixElementStatus {}

/**
 * *** Save to Google Maps ****
 */
export interface maps$Attribution {
  iosDeepLinkId?: string;
  source?: string;
  webUrl?: string;
}

export interface maps$Place {
  location?: maps$LatLng | maps$LatLngLiteral;
  placeId?: string;
  query?: string;
}
...
export interface maps$SaveWidgetOptions {
 ...
 * *** Map Types ****
 */
export interface maps$MapType {
  getTile(
    tileCoord: maps$Point,
    zoom: number,
...
export interface maps$Projection {
...
export interface maps$ImageMapTypeOptions {
  alt?: string;
...
declare export class maps$StyledMapType mixins maps$MVCObject, maps$MapType {
  constructor(
    styles: maps$MapTypeStyle[],
    options?: maps$StyledMapTypeOptions
  ): this;
  getTile(
    tileCoord: maps$Point,
    zoom: number,
...
export interface maps$StyledMapTypeOptions {
  alt?: string;
  maxZoom?: number;
  minZoom?: number;
  name?: string;
...
export type maps$MapTypeStyleElementType =
  | "all"
  | "geometry"
  | "geometry.fill"
  | "geometry.stroke"
...
export interface maps$MapTypeStyler {
  color?: string;
  gamma?: number;
  hue?: string;
...
export interface maps$FusionTablesLayerOptions {
  clickable?: boolean;
...
export interface maps$FusionTablesQuery {
  from?: string;
  limit?: number;
  offset?: number;
  orderBy?: string;
...
export interface maps$FusionTablesStyle {
...
export interface maps$FusionTablesHeatmap {
  enabled: boolean;
}

export interface maps$FusionTablesMarkerOptions {
  iconName: string;
}

export interface maps$FusionTablesPolygonOptions {
  fillColor?: string;
  fillOpacity?: number;
  strokeColor?: string;
  strokeOpacity?: number;
...
export interface maps$FusionTablesPolylineOptions {
  strokeColor?: string;
  strokeOpacity?: number;
  strokeWeight?: number;
}

export interface maps$FusionTablesMouseEvent {
...
export interface maps$FusionTablesCell {
  columnName?: string;
  value?: string;
}
...
export interface maps$KmlLayerOptions {
  clickable?: boolean;
  map?: maps$Map;
  preserveViewport?: boolean;
...
export interface maps$KmlLayerMetadata {
...
declare export class maps$KmlLayerStatus {
  constructor(...args: empty): mixed;
  static +DOCUMENT_NOT_FOUND: Class<maps$KmlLayerStatus__DOCUMENT_NOT_FOUND> &
    maps$KmlLayerStatus__DOCUMENT_NOT_FOUND &
    0; // 0
  static +DOCUMENT_TOO_LARGE: Class<maps$KmlLayerStatus__DOCUMENT_TOO_LARGE> &
    maps$KmlLayerStatus__DOCUMENT_TOO_LARGE &
    1; // 1
  static +FETCH_ERROR: Class<maps$KmlLayerStatus__FETCH_ERROR> &
    maps$KmlLayerStatus__FETCH_ERROR &
    2; // 2
  static +INVALID_DOCUMENT: Class<maps$KmlLayerStatus__INVALID_DOCUMENT> &
    maps$KmlLayerStatus__INVALID_DOCUMENT &
    3; // 3
  static +INVALID_REQUEST: Class<maps$KmlLayerStatus__INVALID_REQUEST> &
    maps$KmlLayerStatus__INVALID_REQUEST &
    4; // 4
  static +LIMITS_EXCEEDED: Class<maps$KmlLayerStatus__LIMITS_EXCEEDED> &
    maps$KmlLayerStatus__LIMITS_EXCEEDED &
    5; // 5
  static +OK: Class<maps$KmlLayerStatus__OK> & maps$KmlLayerStatus__OK & 6; // 6
  static +TIMED_OUT: Class<maps$KmlLayerStatus__TIMED_OUT> &
    maps$KmlLayerStatus__TIMED_OUT &
    7; // 7
  static +UNKNOWN: Class<maps$KmlLayerStatus__UNKNOWN> &
    maps$KmlLayerStatus__UNKNOWN &
    8; // 8
}

declare class maps$KmlLayerStatus__DOCUMENT_NOT_FOUND
  mixins maps$KmlLayerStatus {}
declare class maps$KmlLayerStatus__DOCUMENT_TOO_LARGE
  mixins maps$KmlLayerStatus {}
declare class maps$KmlLayerStatus__FETCH_ERROR mixins maps$KmlLayerStatus {}
declare class maps$KmlLayerStatus__INVALID_DOCUMENT
  mixins maps$KmlLayerStatus {}
...
export interface maps$KmlMouseEvent {
  featureData: maps$KmlFeatureData;
  latLng: maps$LatLng;
  pixelOffset: maps$Size;
}

export interface maps$KmlFeatureData {
  author: maps$KmlAuthor;
  description: string;
  id: string;
  infoWindowHtml: string;
...
export interface maps$KmlAuthor {
  email: string;
  name: string;
  uri: string;
}
...
export interface maps$TrafficLayerOptions {
  autoRefresh?: boolean;
  map?: maps$Map;
}
...
declare export class maps$StreetViewPanorama mixins maps$MVCObject {
  ...
  registerPanoProvider(
    provider: (input: string) => maps$StreetViewPanoramaData
  ): void;
 ...
 */
export interface maps$FullscreenControlOptions {
  /**
   * Position id. Used to specify the position of the control on the map.
...
export interface maps$StreetViewPanoramaOptions {
...
export interface maps$StreetViewAddressControlOptions {
  position?: maps$ControlPosition;
}

export interface maps$StreetViewLink {
  description?: string;
  heading?: number;
  pano?: string;
}

export interface maps$StreetViewPov {
  heading?: number;
  pitch?: number;
}

export interface maps$StreetViewPanoramaData {
  copyright?: string;
  imageDate?: string;
...
export interface maps$StreetViewLocation {
  description?: string;
  latLng?: maps$LatLng;
  pano?: string;
...
export interface maps$StreetViewTileData {
  getTileUrl(
    pano: string,
    tileZoom: number,
    tileX: number,
...
declare export class maps$StreetViewPreference {
  constructor(...args: empty): mixed;
  static +BEST: Class<maps$StreetViewPreference__BEST> &
    maps$StreetViewPreference__BEST &
    0; // 0
  static +NEAREST: Class<maps$StreetViewPreference__NEAREST> &
    maps$StreetViewPreference__NEAREST &
    1; // 1
}

declare class maps$StreetViewPreference__BEST
  mixins maps$StreetViewPreference {}
declare class maps$StreetViewPreference__NEAREST
  mixins maps$StreetViewPreference {}

declare export class maps$StreetViewSource {
  constructor(...args: empty): mixed;
  static +DEFAULT: Class<maps$StreetViewSource__DEFAULT> &
    maps$StreetViewSource__DEFAULT &
    0; // 0
  static +OUTDOOR: Class<maps$StreetViewSource__OUTDOOR> &
    maps$StreetViewSource__OUTDOOR &
    1; // 1
}
...
export interface maps$StreetViewLocationRequest {
  location: maps$LatLng | maps$LatLngLiteral;
...
export interface maps$StreetViewPanoRequest {
  pano: string;
}
...
declare export class maps$StreetViewService {
  getPanorama(
    ...
    cb: (
      data: maps$StreetViewPanoramaData,
      status: maps$StreetViewStatus
    ) => void
  ): void;
  getPanoramaById(
    pano: string,
    callback: (
      ...
      streetViewStatus: maps$StreetViewStatus
    ) => void
  ): void;
...
declare export class maps$StreetViewStatus {
  ...
  static +UNKNOWN_ERROR: Class<maps$StreetViewStatus__UNKNOWN_ERROR> &
    maps$StreetViewStatus__UNKNOWN_ERROR &
    1; // 1
  static +ZERO_RESULTS: Class<maps$StreetViewStatus__ZERO_RESULTS> &
    maps$StreetViewStatus__ZERO_RESULTS &
    2; // 2
}

declare class maps$StreetViewStatus__OK mixins maps$StreetViewStatus {}
declare class maps$StreetViewStatus__UNKNOWN_ERROR
  mixins maps$StreetViewStatus {}
declare class maps$StreetViewStatus__ZERO_RESULTS
  mixins maps$StreetViewStatus {}
...
export interface maps$MotionTrackingControlOptions {
  position?: maps$ControlPosition;
}
 ...
 * *** Events ****
 */
export interface maps$MapsEventListener {
  /**
 ...
 */
export interface maps$MouseEvent {
  /**
 ...
 */
export type maps$IconMouseEvent = {
  /**
...
export type maps$LatLngLiteral = {
  lat: number,
  lng: number
};

export type maps$LatLngBoundsLiteral = {
  east: number,
  north: number,
  south: number,
  west: number
...
declare export class maps$LatLngBounds {
   ...
   */
  constructor(
    sw?: maps$LatLng | maps$LatLngLiteral,
    ne?: maps$LatLng | maps$LatLngLiteral
  ): this;
...
declare module "geometry" {
  ...
  declare export class spherical {
     ...
     */
    static computeArea(
      path: maps$LatLng[] | maps$MVCArray<maps$LatLng>,
      radius?: number
    ): number;
    ...
    static computeSignedArea(
      loop: maps$LatLng[] | maps$MVCArray<maps$LatLng>,
      radius?: number
    ): number;
...
declare module "adsense" {
  ...
  declare export class AdFormat {
    ...
    static +HALF_BANNER: Class<AdFormat__HALF_BANNER> &
      AdFormat__HALF_BANNER &
      2; // 2
    static +LARGE_HORIZONTAL_LINK_UNIT: Class<AdFormat__LARGE_HORIZONTAL_LINK_UNIT> &
      AdFormat__LARGE_HORIZONTAL_LINK_UNIT &
      3; // 3
    static +LARGE_RECTANGLE: Class<AdFormat__LARGE_RECTANGLE> &
      AdFormat__LARGE_RECTANGLE &
      4; // 4
    static +LARGE_VERTICAL_LINK_UNIT: Class<AdFormat__LARGE_VERTICAL_LINK_UNIT> &
      AdFormat__LARGE_VERTICAL_LINK_UNIT &
      5; // 5
    static +LEADERBOARD: Class<AdFormat__LEADERBOARD> &
      AdFormat__LEADERBOARD &
      6; // 6
    static +MEDIUM_RECTANGLE: Class<AdFormat__MEDIUM_RECTANGLE> &
      AdFormat__MEDIUM_RECTANGLE &
      7; // 7
    static +MEDIUM_VERTICAL_LINK_UNIT: Class<AdFormat__MEDIUM_VERTICAL_LINK_UNIT> &
      AdFormat__MEDIUM_VERTICAL_LINK_UNIT &
      8; // 8
    static +SKYSCRAPER: Class<AdFormat__SKYSCRAPER> & AdFormat__SKYSCRAPER & 9; // 9
    static +SMALL_HORIZONTAL_LINK_UNIT: Class<AdFormat__SMALL_HORIZONTAL_LINK_UNIT> &
      AdFormat__SMALL_HORIZONTAL_LINK_UNIT &
      10; // 10
    static +SMALL_RECTANGLE: Class<AdFormat__SMALL_RECTANGLE> &
      AdFormat__SMALL_RECTANGLE &
      11; // 11
    static +SMALL_SQUARE: Class<AdFormat__SMALL_SQUARE> &
      AdFormat__SMALL_SQUARE &
      12; // 12
    static +SMALL_VERTICAL_LINK_UNIT: Class<AdFormat__SMALL_VERTICAL_LINK_UNIT> &
      AdFormat__SMALL_VERTICAL_LINK_UNIT &
      13; // 13
    static +SQUARE: Class<AdFormat__SQUARE> & AdFormat__SQUARE & 14; // 14
    static +VERTICAL_BANNER: Class<AdFormat__VERTICAL_BANNER> &
      AdFormat__VERTICAL_BANNER &
      15; // 15
    static +WIDE_SKYSCRAPER: Class<AdFormat__WIDE_SKYSCRAPER> &
      AdFormat__WIDE_SKYSCRAPER &
      16; // 16
    static +X_LARGE_VERTICAL_LINK_UNIT: Class<AdFormat__X_LARGE_VERTICAL_LINK_UNIT> &
      AdFormat__X_LARGE_VERTICAL_LINK_UNIT &
      17; // 17
  }
...
declare module "places" {
  ...
  declare export type LocationBias =
    | maps$LatLng
    | maps$LatLngLiteral
    | maps$LatLngBounds
 ...
 */
  ...
  declare export class PlacesServiceStatus {
    constructor(...args: empty): mixed;
    static +ERROR: Class<PlacesServiceStatus__ERROR> &
      PlacesServiceStatus__ERROR &
      0; // 0
    static +INVALID_REQUEST: Class<PlacesServiceStatus__INVALID_REQUEST> &
      PlacesServiceStatus__INVALID_REQUEST &
      1; // 1
    static +OK: Class<PlacesServiceStatus__OK> & PlacesServiceStatus__OK & 2; // 2
    static +OVER_QUERY_LIMIT: Class<PlacesServiceStatus__OVER_QUERY_LIMIT> &
      PlacesServiceStatus__OVER_QUERY_LIMIT &
      3; // 3
    static +NOT_FOUND: Class<PlacesServiceStatus__NOT_FOUND> &
      PlacesServiceStatus__NOT_FOUND &
      4; // 4
    static +REQUEST_DENIED: Class<PlacesServiceStatus__REQUEST_DENIED> &
      PlacesServiceStatus__REQUEST_DENIED &
      5; // 5
    static +UNKNOWN_ERROR: Class<PlacesServiceStatus__UNKNOWN_ERROR> &
      PlacesServiceStatus__UNKNOWN_ERROR &
      6; // 6
    static +ZERO_RESULTS: Class<PlacesServiceStatus__ZERO_RESULTS> &
      PlacesServiceStatus__ZERO_RESULTS &
      7; // 7
  }

  declare class PlacesServiceStatus__ERROR mixins PlacesServiceStatus {}
  declare class PlacesServiceStatus__INVALID_REQUEST
    mixins PlacesServiceStatus {}
  declare class PlacesServiceStatus__OK mixins PlacesServiceStatus {}
  declare class PlacesServiceStatus__OVER_QUERY_LIMIT
    mixins PlacesServiceStatus {}
  declare class PlacesServiceStatus__NOT_FOUND mixins PlacesServiceStatus {}
  declare class PlacesServiceStatus__REQUEST_DENIED
    mixins PlacesServiceStatus {}
...
declare module "drawing" {
  ...
  declare export class OverlayType {
    ...
    static +RECTANGLE: Class<OverlayType__RECTANGLE> &
      OverlayType__RECTANGLE &
      4; // 4
  }
...
declare module "visualization" {
  ...
  declare export class MapsEngineStatus {
    constructor(...args: empty): mixed;
    static +INVALID_LAYER: Class<MapsEngineStatus__INVALID_LAYER> &
      MapsEngineStatus__INVALID_LAYER &
      0; // 0
    static +OK: Class<MapsEngineStatus__OK> & MapsEngineStatus__OK & 1; // 1
    static +UNKNOWN_ERROR: Class<MapsEngineStatus__UNKNOWN_ERROR> &
      MapsEngineStatus__UNKNOWN_ERROR &
      2; // 2
  }
  ...
  declare export class HeatmapLayer mixins maps$MVCObject {
    ...
    setData(
      data:
        | maps$MVCArray<maps$LatLng | WeightedLocation>
        | maps$LatLng[]
        | WeightedLocation[]
    ): void;
    setMap(map: maps$Map | null): void;
