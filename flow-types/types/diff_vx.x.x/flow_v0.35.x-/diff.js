...
line: string,
operation: "-" | " ",
patchContent: string) => boolean
} 
	declare export interface ApplyPatchesOptions {
...
oldString: string,
newString: string,
options?: Callback | (ArrayOptions<any, any> & $Shape<CallbackOptions>)): Change[];
 ...
 */
declare export function diffChars(oldStr: string, newStr: string, options?: BaseOptions): Change[]

	declare export function diffChars(
oldStr: string,
newStr: string,
options: Callback | (BaseOptions & CallbackOptions)): void
 ...
 * @returns A list of change objects.
 */
declare export function diffWords(oldStr: string, newStr: string, options?: WordsOptions): Change[]

	declare export function diffWords(
oldStr: string,
newStr: string,
options: Callback | (WordsOptions & CallbackOptions)): void
 ...
 * @returns A list of change objects.
 */
declare export function diffWordsWithSpace(oldStr: string, newStr: string, options?: WordsOptions): Change[]
 ...
 * @returns A list of change objects.
 */
declare export function diffLines(oldStr: string, newStr: string, options?: LinesOptions): Change[]

	declare export function diffLines(
oldStr: string,
newStr: string,
options: Callback | (LinesOptions & CallbackOptions)): void
 ...
 * @returns A list of change objects.
 */
declare export function diffTrimmedLines(oldStr: string, newStr: string, options?: LinesOptions): Change[]
 ...
 * @returns A list of change objects.
 */
declare export function diffSentences(oldStr: string, newStr: string, options?: BaseOptions): Change[]
 ...
 * @returns A list of change objects.
 */
declare export function diffCss(oldStr: string, newStr: string, options?: BaseOptions): Change[]
...
options?: JsonOptions): Change[]

	declare export function diffJson(
oldObj: string | {[key: string]: any},
newObj: string | {[key: string]: any},
options: Callback | (JsonOptions & CallbackOptions)): void
...
oldArr: TOld[],
newArr: TNew[],
options?: ArrayOptions<TOld, TNew>): Array<ArrayChange<TOld | TNew>>
...
oldHeader?: string,
newHeader?: string,
options?: PatchOptions): ParsedDiff
...
options?: ApplyPatchOptions): string
 ...
 */
declare export function applyPatches(patch: string | ParsedDiff[], options: ApplyPatchesOptions): void
 ...
 */
declare export function parsePatch(diffStr: string, options?: {
strict?: boolean
}): ParsedDiff[]
 ...
 */
declare export function convertChangesToDMP(changes: Change[]): Array<[1 | 0 | -1, string]>

	declare export function merge(mine: string, theirs: string, base: string): ParsedDiff

	declare export function canonicalize(obj: any, stack: any[], replacementStack: any[]): any
