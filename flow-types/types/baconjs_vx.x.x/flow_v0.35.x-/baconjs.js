 ...
 */
asEventStream(eventName: string): Bacon$Bacon$EventStream<ErrorEvent, JQueryEventObject>,
...
asEventStream(
eventName: string,
selector: string): Bacon$Bacon$EventStream<ErrorEvent, JQueryEventObject>,
...
asEventStream<A>(
eventName: string,
f: (event: JQueryEventObject, args: any[]) => A): Bacon$Bacon$EventStream<ErrorEvent, A>,
...
abort: boolean,
eventTransformer: (
value: A) => (Bacon$Initial<B> | Bacon$Next<B> | Bacon$End<B> | Bacon$Error<E>)[]): Bacon$EventStream<E, B>
...
target: EventTarget | NodeJS.EventEmitter | JQuery,
eventName: string,
eventTransformer: (event: A) => B): Bacon$EventStream<E, B>
 ...
 */
declare function Bacon$fromCallback<E, A>(f: (...args: any[]) => void, ...args: any[]): Bacon$EventStream<E, A>
 ...
 * @returns {Bacon$EventStream<E, A>}
 */
declare function Bacon$interval<E, A>(Bacon$interval: number, value: A): Bacon$EventStream<E, A>
 ...
 * @returns {Bacon$EventStream<E, A>}
 */
declare function Bacon$sequentially<E, A>(Bacon$interval: number, values: A[]): Bacon$EventStream<E, A>
 ...
 */
declare function Bacon$repeatedly<E, A>(Bacon$interval: number, values: A[]): Bacon$EventStream<E, A>
...
| Bacon$End<B>
| Bacon$Error<E>
| Bacon$Observable<E, B>): Bacon$EventStream<E, B>,
...
f: (a: A, b: B) => C): Bacon$EventStream<E, C>,
...
f: (a: A, b: B) => C): Bacon$Property<E, C>,
...
f: (
state: B,
event: Bacon$Initial<A> | Bacon$Next<A> | Bacon$End<A> | Bacon$Error<E>) => [B, (Bacon$Initial<C> | Bacon$Next<C> | Bacon$End<C> | Bacon$Error<E>)[]]): Bacon$EventStream<E, C>,
 ...
 */
awaiting<B>(otherObservable: Bacon$Observable<E, B>): Bacon$Property<E, boolean>
} 
 ...
 */
withHandler(
f: (event: Bacon$Initial<A> | Bacon$Next<A> | Bacon$End<A> | Bacon$Error<E>) => any): Bacon$EventStream<E, A>,
 ...
 */
groupBy<B>(keyF: (value: A) => B): Bacon$EventStream<E, Bacon$EventStream<E, A>>,
...
groupStartingEvent: Bacon$Initial<A> | Bacon$Next<A> | Bacon$End<A> | Bacon$Error<E>) => Bacon$EventStream<E, C>): Bacon$EventStream<E, Bacon$EventStream<E, C>>,
 ...
 */
skipDuplicates(isEqual?: (oldValue: A, newValue: A) => boolean): Bacon$EventStream<E, A>,
 ...
 */
bufferWithTime(f: (defer: (...args: any[]) => void) => void): Bacon$EventStream<E, A[]>,
 ...
 * @returns {Bacon$EventStream<E, A[]>}
 */
bufferWithTimeOrCount(delay: number, count: number): Bacon$EventStream<E, A[]>,
 ...
 */
withHandler(
f: (event: Bacon$Initial<A> | Bacon$Next<A> | Bacon$End<A> | Bacon$Error<E>) => any): Bacon$Property<E, A>,
...
f: (propertyValue: A, samplerValue: B) => C): Bacon$EventStream<E, C>,
 ...
 * @returns {Bacon$Property<E, A>}
 */
skipDuplicates(isEqual?: (oldValue: A, newValue: A) => boolean): Bacon$Property<E, A>,
...
declare function Bacon$zipWith<E, A, B>(
f: (...args: A[]) => B,
...streams: Bacon$EventStream<E, A>[]): Bacon$EventStream<E, B>
...
f2: (...args: A2[]) => B): Bacon$EventStream<E, B>
...
f3: (...args: A3[]) => B): Bacon$EventStream<E, B>
...
f4: (...args: A4[]) => B): Bacon$EventStream<E, B>
...
f5: (...args: A5[]) => B): Bacon$EventStream<E, B>
...
initial: B,
pattern1: Bacon$Observable<E, A1>[],
f1: (initial: B, ...args: A1[]) => B): Bacon$Property<E, B>
...
pattern2: Bacon$Observable<E, A2>[],
f2: (initial: B, ...args: A2[]) => B): Bacon$Property<E, B>
...
pattern3: Bacon$Observable<E, A3>[],
f3: (initial: B, ...args: A3[]) => B): Bacon$Property<E, B>
...
pattern4: Bacon$Observable<E, A4>[],
f4: (initial: B, ...args: A4[]) => B): Bacon$Property<E, B>
...
pattern5: Bacon$Observable<E, A5>[],
f5: (initial: B, ...args: A5[]) => B): Bacon$Property<E, B>
