...
A.y is within [1...p - 1]
 */
declare export function isPoint(A: Buffer): boolean

	
/**
 * Returns false if the point is not compressed.
 */
declare export function isPointCompressed(A: Buffer): boolean
...
within [1...order - 1]
 */
declare export function isPrivate(d: Buffer): boolean
 ...
 */
declare export function pointAdd(A: Buffer, B: Buffer, compressed?: boolean): Buffer | null
 ...
 * @param compressed optional, if true compresses the resulting point
 */
declare export function pointAddScalar(A: Buffer, tweak: Buffer, compressed?: boolean): Buffer | null
 ...
 */
declare export function pointCompress(A: Buffer, compressed: boolean): Buffer
 ...
 * @param compressed optional, if true compresses the resulting point
 */
declare export function pointFromScalar(d: Buffer, compressed?: boolean): Buffer | null
 ...
 * @param compressed optional, if true compresses the resulting point
 */
declare export function pointMultiply(A: Buffer, tweak: Buffer, compressed?: boolean): Buffer | null
 ...
 * @param tweak should be within [1...order - 1]
 */
declare export function privateAdd(d: Buffer, tweak: Buffer): Buffer | null
 ...
 * @param tweak should be within [1...order - 1]
 */
declare export function privateSub(d: Buffer, tweak: Buffer): Buffer | null
 ...
 */
declare export function sign(message: Buffer, privateKey: Buffer): Buffer
 ...
 */
declare export function verify(message: Buffer, publicKey: Buffer, signature: Buffer): boolean
