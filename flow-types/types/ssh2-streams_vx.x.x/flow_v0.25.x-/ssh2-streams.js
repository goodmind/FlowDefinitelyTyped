declare module "ssh2-streams" {
  ...
  declare export class SSH2Stream mixins stream.Transform {
    ...
    on(
      ...
      listener: (
        reqName: string,
        wantReply: boolean,
        request: GlobalRequest | Buffer | void
      ) => void
    ): this;
    ...
    on(
      event: "fingerprint",
      listener: (hostKey: Buffer, callback: (success: boolean) => void) => void
    ): this;
  ...
  declare export type GlobalRequest =
  ...
  declare export type ChannelOpenInfo =
    | X11ChannelInfo
  ...
  declare export type ChannelRequest =
  ...
  declare export type AuthMethodData =
    | string
 ...
 */
    ...
    on(
      event: "FSETSTAT",
      listener: (reqID: number, handle: Buffer, attrs: InputAttributes) => void
    ): this;
  ...
  declare export function utils$parseKey(
    keyData: string | Buffer
  ): ParsedKey | Error;

  declare export function utils$genPublicKey(privKeyInfo: ParsedKey): ParsedKey;

  declare export function utils$decryptKey(
    privKeyInfo: ParsedKey,
    passphrase: string
  ): void;
