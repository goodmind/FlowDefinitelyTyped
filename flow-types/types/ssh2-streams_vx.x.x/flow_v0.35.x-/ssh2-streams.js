declare module 'ssh2-streams' {
	...
	declare export class SSH2Stream mixins stream.Transform {
 ...
 */
constructor(config?: SSH2StreamConfig): this;
...
username: string,
pubKey: ParsedKey,
cbSign?: (blob: Buffer, callback: (signedBlob: Buffer) => void) => void): boolean;
...
initWindow: number,
maxPacket: number,
config: TcpipForwardingConfig): boolean;
...
initWindow: number,
maxPacket: number,
config: SocketForwardingConfig): boolean;
...
reqName: string,
wantReply: boolean,
request: GlobalRequest | Buffer | void) => void): this;
...
on(
event: "DISCONNECT",
listener: (reason: string, reasonCode: number, description: string) => void): this;
...
listener: (channelInfo: ChannelOpenConfirmationInfo) => void): this;
...
listener: (failInfo: ChannelOpenFailureInfo) => void): this;
...
listener: (type: number, data: Buffer) => void): this;
...
on(
event: "fingerprint",
listener: (hostKey: Buffer, callback: (success: boolean) => void) => void): this;
...
listener: (name: string, instructions: string, lang: string, prompts: Prompt[]) => void): this;
...
listener: (methodsContinue: string[], partialSuccess: boolean) => void): this;
...
serviceName: string,
authMethod: string,
authMethodData: AuthMethodData) => void): this;
...
on(event: string | Symbol, listener: Function): this
	...
	declare export interface SSH2StreamConfig {
...
debug?: (information: string) => any
	...
	declare export interface HostKeys {
[format: string]: HostKey
} 
	declare export interface HostKey {
...
comments: string
	...
	declare export interface Versions {
...
software: string
	...
	declare export interface TcpipForwardGlobalRequest {
...
bindPort: number
	...
	declare export interface openssh_StreamLocalForwardGlobalRequest {
socketPath: string
} 
	declare export type GlobalRequest = TcpipForwardGlobalRequest | openssh_StreamLocalForwardGlobalRequest | Buffer;
	declare export interface ChannelOpenConfirmationInfo {
recipient: number,
sender: number,
window: number,
packetSize: number
} 
	declare export interface ChannelOpenFailureInfo {
recipient: number,
reasonCode: number,
reason: string,
description: string
} 
	declare export interface X11ChannelInfo {
type: "x11",
sender: number,
window: number,
packetSize: number,
data: X11ChannelData
	...
	declare export interface X11ChannelData {
srcIP: string,
srcPort: number
} 
	declare export interface ForwardedTcpipChannelInfo {
...
data: TcpipChannelData
	...
	declare export interface DirectTcpipChannelInfo {
type: "direct-tcpip",
sender: number,
window: number,
packetSize: number,
data: TcpipChannelData
	...
	declare export interface TcpipChannelData {
srcIP: string,
srcPort: number,
destIP: string,
destPort: number
} 
	declare export interface openssh_ForwardedStreamLocalChannelInfo {
...
data: SocketChannelData
	...
	declare export interface openssh_DirectStreamLocalChannelInfo {
...
data: SocketChannelData
	...
	declare export interface SocketChannelData {
socketPath: string
} 
	declare export interface openssh_AuthAgentChannelInfo {
type: "auth-agent@openssh.com",
sender: number,
window: number,
packetSize: number
} 
	declare export interface SessionChannelInfo {
type: "session",
sender: number,
window: number,
packetSize: number
} 
	declare export type ChannelOpenInfo = X11ChannelInfo
...
| SessionChannelInfo;
	declare export interface ExitStatusChannelRequest {
request: "exit-status",
recipient: number,
code: number
} 
	declare export interface ExitSignalChannelRequest {
request: "exit-signal",
recipient: number,
signal: string,
coredump: boolean,
description: string
	...
	declare export interface PseudoTtyChannelRequest {
request: "pty-req",
recipient: number,
wantReply: boolean,
term: string,
...
modes: any
	...
	declare export interface WindowChangeChannelRequest {
...
height: number
	...
	declare export interface X11ChannelRequest {
request: "x11-req",
recipient: number,
wantReply: boolean,
single: boolean,
...
screen: number
	...
	declare export interface EnvChannelRequest {
request: "env",
recipient: number,
wantReply: boolean,
key: string,
val: string
	...
	declare export interface ShellChannelRequest {
request: "shell",
recipient: number,
wantReply: boolean
} 
	declare export interface ExecChannelRequest {
request: "exec",
recipient: number,
wantReply: boolean,
command: string
} 
	declare export interface SubsystemChannelRequest {
request: "subsystem",
recipient: number,
wantReply: boolean,
subsystem: string
} 
	declare export interface SignalChannelRequest {
request: "signal",
recipient: number,
signal: string
} 
	declare export interface FlowControlChannelRequest {
request: "xon-xoff",
recipient: number,
clientControl: boolean
} 
	declare export interface openssh_AuthAgentChannelRequest {
request: "auth-agent-req@openssh.com",
recipient: number
} 
	declare export type ChannelRequest = ExitStatusChannelRequest
...
| FlowControlChannelRequest;
	declare export interface PublicKeyAuthMethodData {
keyAlgo: string,
key: Buffer,
signature?: Buffer,
blob?: Buffer
} 
	declare export interface HostbasedAuthMethodData {
keyAlgo: string,
key: Buffer,
signature?: Buffer,
blob?: Buffer,
...
localUsername: string
	...
	declare export type AuthMethodData = string | PublicKeyAuthMethodData | HostbasedAuthMethodData;
	declare export interface TcpipForwardingConfig {
...
destPort: number
	...
	declare export interface X11ForwardingConfig {
...
screen: number
	...
	declare export interface SocketForwardingConfig {
socketPath: string
} 
...
echo?: boolean
	...
	declare export interface ForwardedTcpip {
bindAddr: string,
bindPort: number,
remoteAddr: string,
remotePort: number
} 
	declare export interface ForwardedX11 {
originAddr: string,
originPort: number
} 
	declare export interface ForwardedSocket {
socketPath: string
} 
	declare export class SFTPStream mixins stream.Transform {

/**
 * Creates and returns a new SFTPStream instance.
 */
constructor(remoteIdentRaw: string): this;

/**
 * Creates and returns a new SFTPStream instance.
 */
constructor(cfg?: SFTPStreamConfig, remoteIdentRaw?: string): this;
...
callback: (err: any, handle: Buffer) => void): void;
...
callback: (err: any, list: FileEntry[]) => void): boolean;
...
on(
event: "OPEN",
listener: (reqID: number, filename: string, flags: number, attrs: InputAttributes) => void): this;
...
on(
event: "READ",
listener: (reqID: number, handle: Buffer, offset: number, length: number) => void): this;
...
on(
event: "WRITE",
listener: (reqID: number, handle: Buffer, offset: number, data: Buffer) => void): this;
...
on(
event: "FSETSTAT",
listener: (reqID: number, handle: Buffer, attrs: InputAttributes) => void): this;
...
on(
event: "SETSTAT",
listener: (reqID: number, path: string, attrs: InputAttributes) => void): this;
...
on(
event: "RENAME",
listener: (reqID: number, oldPath: string, newPath: string) => void): this;
...
on(
event: "SYMLINK",
listener: (reqID: number, linkPath: string, targetPath: string) => void): this;
...
static +OK: Class<SFTPStream$STATUS_CODE__OK> & SFTPStream$STATUS_CODE__OK & 0;// 0
static +EOF: Class<SFTPStream$STATUS_CODE__EOF> & SFTPStream$STATUS_CODE__EOF & 1;// 1
static +NO_SUCH_FILE: Class<SFTPStream$STATUS_CODE__NO_SUCH_FILE> & SFTPStream$STATUS_CODE__NO_SUCH_FILE & 2;// 2
static +PERMISSION_DENIED: Class<SFTPStream$STATUS_CODE__PERMISSION_DENIED> & SFTPStream$STATUS_CODE__PERMISSION_DENIED & 3;// 3
static +FAILURE: Class<SFTPStream$STATUS_CODE__FAILURE> & SFTPStream$STATUS_CODE__FAILURE & 4;// 4
static +BAD_MESSAGE: Class<SFTPStream$STATUS_CODE__BAD_MESSAGE> & SFTPStream$STATUS_CODE__BAD_MESSAGE & 5;// 5
static +NO_CONNECTION: Class<SFTPStream$STATUS_CODE__NO_CONNECTION> & SFTPStream$STATUS_CODE__NO_CONNECTION & 6;// 6
static +CONNECTION_LOST: Class<SFTPStream$STATUS_CODE__CONNECTION_LOST> & SFTPStream$STATUS_CODE__CONNECTION_LOST & 7;// 7
static +OP_UNSUPPORTED: Class<SFTPStream$STATUS_CODE__OP_UNSUPPORTED> & SFTPStream$STATUS_CODE__OP_UNSUPPORTED & 8;// 8
...
declare class SFTPStream$STATUS_CODE__NO_SUCH_FILE mixins SFTPStream$STATUS_CODE {}
declare class SFTPStream$STATUS_CODE__PERMISSION_DENIED mixins SFTPStream$STATUS_CODE {}
declare class SFTPStream$STATUS_CODE__FAILURE mixins SFTPStream$STATUS_CODE {}
declare class SFTPStream$STATUS_CODE__BAD_MESSAGE mixins SFTPStream$STATUS_CODE {}
declare class SFTPStream$STATUS_CODE__NO_CONNECTION mixins SFTPStream$STATUS_CODE {}
declare class SFTPStream$STATUS_CODE__CONNECTION_LOST mixins SFTPStream$STATUS_CODE {}
declare class SFTPStream$STATUS_CODE__OP_UNSUPPORTED mixins SFTPStream$STATUS_CODE {}
...
declare export  class SFTPStream$OPEN_MODE {
  constructor(...args: empty): mixed;
static +READ: Class<SFTPStream$OPEN_MODE__READ> & SFTPStream$OPEN_MODE__READ & 1;// 1
static +WRITE: Class<SFTPStream$OPEN_MODE__WRITE> & SFTPStream$OPEN_MODE__WRITE & 2;// 2
static +APPEND: Class<SFTPStream$OPEN_MODE__APPEND> & SFTPStream$OPEN_MODE__APPEND & 4;// 4
static +CREAT: Class<SFTPStream$OPEN_MODE__CREAT> & SFTPStream$OPEN_MODE__CREAT & 8;// 8
static +TRUNC: Class<SFTPStream$OPEN_MODE__TRUNC> & SFTPStream$OPEN_MODE__TRUNC & 16;// 16
static +EXCL: Class<SFTPStream$OPEN_MODE__EXCL> & SFTPStream$OPEN_MODE__EXCL & 32;// 32
...
debug?: (information: string) => any
	...
	declare export interface TransferOptions {
...
mode?: number
	...
	declare export interface FileEntry {
filename: string,
longname: string,
attrs: Attributes
} 
	declare export interface InputAttributes {
mode?: number | string,
uid?: number,
gid?: number,
size?: number,
...
genPublicKey: typeof utils$genPublicKey,
decryptKey: typeof utils$decryptKey,
        
      }
declare export function utils$parseKey(keyData: string | Buffer): ParsedKey | Error


declare export function utils$genPublicKey(privKeyInfo: ParsedKey): ParsedKey


declare export function utils$decryptKey(privKeyInfo: ParsedKey, passphrase: string): void

	declare export interface ParsedKey {
fulltype: string,
type: string,
extra: string,
comment: string,
...
privateMAC?: string
	...
	declare export interface ReadFileOptions {
encoding?: string,
flag?: string
} 
    }
