...
constructor(options?: StylelintWebpackPlugin$StylelintWebpackPlugin$Options): this
}
...
declare type StylelintWebpackPlugin$Formatter = (messages: StylelintWebpackPlugin$Message[], source: string) => string;
