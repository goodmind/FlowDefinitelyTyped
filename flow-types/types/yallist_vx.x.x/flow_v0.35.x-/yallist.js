...
map<U, R>(callbackFn: (value: T, list: this) => R, thisArg?: U): Yallist<R>;
mapReverse<U, R>(callbackFn: (value: T, list: this) => R, thisArg?: U): Yallist<R>;
pop(): T | void;
push(...items: T[]): number;
...
(value: T, prev?: Yallist$Node<T>, next?: Yallist$Node<T>, list?: Yallist<T>): Yallist$Node<T>,
new <T>(
value: T,
prev?: Yallist$Node<T>,
next?: Yallist$Node<T>,
