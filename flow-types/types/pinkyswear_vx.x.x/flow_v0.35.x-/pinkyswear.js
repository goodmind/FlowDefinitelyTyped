 ...
 */
(extend: (
promise: PinkySwear$PinkySwear$GenericPromise<T>) => PinkySwear$PinkySwear$GenericPromise<T>): PinkySwear$PinkySwear$GenericPromise<T>,
 ...
 * @returns PinkySwear.Promise
 */
(extend: (promise: PinkySwear$PinkySwear$Promise) => PinkySwear$PinkySwear$Promise): PinkySwear$PinkySwear$Promise,
