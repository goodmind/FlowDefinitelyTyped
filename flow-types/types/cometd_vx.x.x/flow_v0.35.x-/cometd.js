...
data: any
	...
	declare export type Listener = (message: Message) => void;
	declare export type Callback = (data: any) => void;
	declare export interface SubscriptionHandle {
id: number,
channel: string,
listener: boolean,
callback: Callback,
...
outgoing?: Listener
	...
	declare export class CometD  {
constructor(options?: Configuration): this;
 ...
 */
registerTransport(type: string, transport: {[key: string]: any}, index?: number): boolean;
...
handshakeProps?: {[key: string]: any}): void;
 ...
 * @param handshakeCallback a function to be invoked when the handshake is acknowledged
 */
handshake(handshakeProps: {[key: string]: any}, handshakeCallback: Listener): void;
 ...
 * @param disconnectCallback a function to be invoked when the disconnect is acknowledged
 */
disconnect(disconnectProps: {[key: string]: any}, disconnectCallback: Listener): void;
...
channel: string,
callback: Callback,
subscribeCallback?: Listener): SubscriptionHandle;
...
unsubscribeProps: {[key: string]: any},
unsubscribeCallback?: Listener): void;
...
resubscribe(
subscription: SubscriptionHandle,
subscribeProps?: {[key: string]: any}): SubscriptionHandle;
