...
config: ReactReconciler$ReactReconciler$HostConfig<Type, Props, Container, Instance, TextInstance, HydratableInstance, PublicInstance, HostContext, UpdatePayload, ChildSet, TimeoutHandle, NoTimeout>): ReactReconciler$ReactReconciler$Reconciler<Instance, TextInstance, Container, PublicInstance>
...
declare interface ReactReconciler$HostConfig<Type, Props, Container, Instance, TextInstance, HydratableInstance, PublicInstance, HostContext, UpdatePayload, ChildSet, TimeoutHandle, NoTimeout> {
getPublicInstance(instance: Instance | TextInstance): PublicInstance,
getRootHostContext(rootContainerInstance: Container): HostContext,
getChildHostContext(
parentHostContext: HostContext,
type: Type,
rootContainerInstance: Container): HostContext,
...
internalInstanceHandle: ReactReconciler$OpaqueHandle): Instance,
...
newProps: Props,
rootContainerInstance: Container,
hostContext: HostContext): null | UpdatePayload,
...
rootContainerInstance: Container,
hostContext: HostContext,
internalInstanceHandle: ReactReconciler$OpaqueHandle): TextInstance,
scheduleDeferredCallback(callback: () => any, options?: {
timeout: number
}): any,
...
type: Type,
newProps: Props,
internalInstanceHandle: ReactReconciler$OpaqueHandle): void,
commitUpdate(
instance: Instance,
...
recyclableInstance: Instance): Instance,
...
instance: Instance | TextInstance | HydratableInstance): null | HydratableInstance,
...
rootContainerInstance: Container,
hostContext: HostContext,
internalInstanceHandle: ReactReconciler$OpaqueHandle): null | UpdatePayload,
hydrateTextInstance(
textInstance: TextInstance,
text: string,
internalInstanceHandle: ReactReconciler$OpaqueHandle): boolean,
...
parentProps: Props,
parentInstance: Instance,
instance: Instance | TextInstance): void,
...
findFiberByHostInstance?: (instance: Instance | TextInstance) => ReactReconciler$Fiber,
getInspectorDataForViewTag?: (tag: number) => {[key: string]: any}
} 

declare interface ReactReconciler$Reconciler<Instance, TextInstance, Container, PublicInstance> {
...
expirationTime: ReactReconciler$ExpirationTime,
callback: () => void | null | void): ReactReconciler$ExpirationTime,
createContainer(
containerInfo: Container,
isConcurrent: boolean,
hydrate: boolean): ReactReconciler$OpaqueRoot,
updateContainer(
element: ReactReconciler$ReactNodeList,
container: ReactReconciler$OpaqueRoot,
parentComponent: Component<any, any> | null | void,
...
expirationTime: ReactReconciler$ExpirationTime): void,
requestWork(
root: ReactReconciler$OpaqueRoot,
expirationTime: ReactReconciler$ExpirationTime): void,
...
container: ReactReconciler$OpaqueRoot): Component<any, any> | PublicInstance | null,
findHostInstance(component: {[key: string]: any}): PublicInstance | null,
findHostInstanceWithNoPortals(component: ReactReconciler$Fiber): PublicInstance | null,
injectIntoDevTools(
devToolsConfig: ReactReconciler$DevToolsConfig<Instance, TextInstance>): boolean
} 
...
declare type ReactReconciler$PendingInteractionMap = Map<ReactReconciler$ExpirationTime, Set<ReactReconciler$Interaction>>;
...
pingCache: WeakMap<ReactReconciler$Thenable, Set<ReactReconciler$ExpirationTime>> | Map<ReactReconciler$Thenable, Set<ReactReconciler$ExpirationTime>> | null,
didError: boolean,
...
declare type ReactReconciler$FiberRoot = ReactReconciler$BaseFiberRootProperties & ReactReconciler$ProfilingOnlyFiberRootProperties;
...
declare type ReactReconciler$ReactNodeList = ReactReconciler$ReactEmpty | ReactNode;
...
declare type ReactReconciler$WorkTag = 0
| 1
| 2
| 3
| 4
