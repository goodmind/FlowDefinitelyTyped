...
declare function MDNS$makeServiceType(serviceTypeIdentifier: string): MDNS$ServiceType


declare function MDNS$makeServiceType(serviceTypeIdentifier: Array<string>): MDNS$ServiceType
...
declare function MDNS$makeServiceType(serviceType: MDNS$ServiceType): MDNS$ServiceType
