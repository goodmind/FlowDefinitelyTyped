declare module "redux-first-router" {
  ...
  declare export type ConfirmLeave = (
    state: { [key: string]: any },
    action: { [key: string]: any }
  ) => Nullable<string>;
  declare export type RouteThunk<TState = any> = (
  ...
  declare export type Route<TKeys = {}, TState = any> =
    | RouteString
  ...
  declare export type SelectLocationState<TKeys = {}, TState = any> = (
    state: TState
  ) => LocationState<TKeys, TState>;
  declare export type SelectTitleState<TState = any> = (
    state: TState
  ) => string;
  ...
  declare export type DisplayConfirmLeave = (
    message: string,
