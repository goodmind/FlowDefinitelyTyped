 ...
 */
declare function client$load(name: "pagespeedonline", version: "v2"): PromiseLike<void>


declare function client$load(name: "pagespeedonline", version: "v2", callback: () => any): void
