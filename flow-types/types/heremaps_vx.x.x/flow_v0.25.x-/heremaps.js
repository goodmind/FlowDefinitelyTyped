...
declare class OList$Event mixins undefined.OList$Event {
  /**
   * Constructor
   * @param {Hutilutil$OList} list - The OList instance which is emitting the event
   * @param {Hutilutil$OListprototypeEventType} type - The type of the event
...
declare interface ContextItem$Options {
  label?: string;
  disabled?: boolean;
  callback?: (event: HutilOList$Event) => void;
}
/**
...
declare class util$Cache mixins undefined.util$ICache {
   ...
   * @returns {Hutilutil$Cache} - this cache
   */
  setMaxSize(maxSize: number): Hutilutil$Cache;
 ...
 * @property defaultPrevented {boolean} - Indicates if preventDefault was called on the current event
 */
declare class util$ChangeEvent mixins undefined.OList$Event {
  /**
   * Constructor
...
declare class util$ContextItem mixins undefined.util$EventTarget {
   ...
   */
  constructor(opt_options?: Hutilutil$ContextItemContextItem$Options): this;
   ...
   * @returns {Hutilutil$ContextItem} - this context item instance
   */
  setLabel(label: string): Hutilutil$ContextItem;
   ...
   * @returns {Hutilutil$ContextItem} - this context item instance
   */
  setDisabled(disabled: boolean): Hutilutil$ContextItem;

  /**
   * This method will dispatch event on the event target object
   * @param {(HutilOList$Event | string)} evt - event object or event name
   */
  dispatchEvent(evt: HutilOList$Event | string): void;
  ...
  static SEPARATOR: Hutilutil$ContextItem;
}
...
declare class util$EventTarget {
  ...
  /**
   * This method will dispatch event on the event target object
   * @param {Hutilutil$Event | string} evt - event object or event name
   */
  dispatchEvent(evt: Hutilutil$Event | string): void;
...
declare class util$Request {
   ...
   */
  constructor(
    opt_onprogress?: (req: Hutilutil$Request) => void,
    opt_total?: number
  ): this;

  /**
   * Returns the state of this request
   * @returns {Hutilutil$RequestRequest$State}
   */
  getState(): Hutilutil$RequestRequest$State;
...
declare class base$Container mixins undefined.util$EventTarget {
   ...
   * @param {Huibasebase$Element} child - the child element to be added
   * @returns {Huibasebase$Container} - this container instance
   */
  addChild(child: base$Element): base$Container;

  /**
   * Returns the child collection of this container.
   * @returns {Array<Huibasebase$Element>} - Returns the child collection of this container.
   */
  getChildren(): base$Element[];

  /**
   * Removes a child element from this container's child collection.
   * @param {Huibasebase$Element} child - the child element to be removed
   */
   ...
   * @returns {Huibasebase$Element} - this element instance
   */
   ...
   * @returns {Huibasebase$Element} - this UI element instance
   */
...
declare interface ZoomRectangle$Options {
  alignment?: Huiui$LayoutAlignment;
  adjustZoom?: (n: number, m: HH$Map) => number;
}
/**
...
declare interface UI$Options {
  unitSystem?: Huiui$UnitSystem;
  zoom?: Huiui$ZoomControlUI$Options | boolean;
  zoomrectangle?: Huiui$ZoomRectangleUI$Options | boolean;
  mapsettings?: Huiui$MapSettingsControlUI$Options | boolean;
  scalebar?: Huiui$ScaleBarUI$Options | boolean;
  panorama?: Huiui$PanoUI$Options | boolean;
  distancemeasurement?: Huiui$DistanceMeasurementUI$Options | boolean;
  locale?: Huii18ni18n$Localization | string;
}
/**
 * @property alignment {H.ui.LayoutAlignment=} - the layout alignment which should be applied to this control, default is H.ui.LayoutAlignment.BOTTOM_RIGHT
 */
...
declare interface Pano$Options {
  alignment?: Huiui$LayoutAlignment;
  mapTypes: Hserviceservice$MapType;
}
/**
...
declare interface MapSettingsControl$MapTypeEntry {
  name: string;
  mapType: Hserviceservice$MapType;
}
...
declare interface MapSettingsControl$Options {
  alignment?: Huiui$LayoutAlignment;
  entries?: Huiui$MapSettingsControlMapSettingsControl$MapTypeEntry[];
  incidents: Hmaplayerlayer$Layer;
}
/**
...
declare class InfoBubble$State {
  ...
  static +CLOSED: Class<InfoBubble$State__CLOSED> &
    InfoBubble$State__CLOSED &
    1; // 1
}
...
declare interface InfoBubble$Options {
   ...
   * @param {Hutilutil$Event} event
   */
  onStateChange?: (event: Hutilutil$Event) => void;
...
declare interface DistanceMeasurement$Options {
  alignment?: Huiui$LayoutAlignment;
  startIcon?: Hmapmap$Icon;
  stopoverIcon?: Hmapmap$Icon;
  endIcon?: Hmapmap$Icon;
  splitIcon?: Hmapmap$Icon;
  lineStyle:
    | Hmapmap$SpatialStyle
    | Hmapmap$SpatialStyleDistanceMeasurement$Options;
...
declare class ui$Control mixins undefined.base$Container {
   ...
   * @param {Huiui$UnitSystem} unitSystem - the unit system the UI currently uses
   */
  onUnitSystemChange(unitSystem: Huiui$UnitSystem): void;

  /**
   * This abstract method can be overridden by deriving classes to be invoked when the underlying map engine changes.
   * @param {HH$MapMap$EngineType} engineType - the engine type the map currently uses
   */
  onMapEngineTypeChange(engineType: HH$MapMap$EngineType): void;
   ...
   * @returns {Huii18ni18n$Localization}
   */
  getLocalization(): Huii18ni18n$Localization;

  /**
   * This method returns this control&#x27;s layout alignment.
   * @returns {Huiui$LayoutAlignment} - the control&#x27;s current layout alignment
   */
  getAlignment(): Huiui$LayoutAlignment;

  /**
   * This method sets the control&#x27;s layout alignments.
   * @param {Huiui$LayoutAlignment} alignment - The new alignment of the control
   * @returns {Huiui$Control} - returns this control instance
   */
  setAlignment(alignment: Huiui$LayoutAlignment): Huiui$Control;
}
...
declare class ui$DistanceMeasurement mixins undefined.ui$Control {
   ...
   */
  constructor(
    opt_options?: Huiui$DistanceMeasurementDistanceMeasurement$Options
  ): this;
}
...
declare class ui$InfoBubble mixins base$base$Element {
  /**
   * Constructor
   * @param {Hgeogeo$IPoint} position - the geo-position to which this info bubble corresponds
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - optional parameters to be passed to the info bubble
   */
  constructor(
    position: Hgeogeo$IPoint,
    opt_options?: ui$InfoBubbleDistanceMeasurement$Options
  ): this;

  /**
   * This method sets the geo-position of this info bubble
   * @param {(Hgeogeo$IPoint | Hgeogeo$Point)} position - the new geo-position of this bubble
   */
  setPosition(position: Hgeogeo$IPoint | Hgeogeo$Point): void;

  /**
   * This method returns this info bubble's current state.
   * @returns {Huiui$InfoBubbleInfoBubble$State} - this bubble's current state
   */
  getState(): ui$InfoBubbleInfoBubble$State;

  /**
   * This method sets the info bubble's state.
   * @param {Huiui$InfoBubbleInfoBubble$State} state - the new state
   */
  setState(state: ui$InfoBubbleInfoBubble$State): void;
...
declare class ui$LayoutAlignment {
  constructor(...args: empty): mixed;
  static +TOP_LEFT: Class<ui$LayoutAlignment__TOP_LEFT> &
    ui$LayoutAlignment__TOP_LEFT &
    0; // 0
  static +TOP_CENTER: Class<ui$LayoutAlignment__TOP_CENTER> &
    ui$LayoutAlignment__TOP_CENTER &
    1; // 1
  static +TOP_RIGHT: Class<ui$LayoutAlignment__TOP_RIGHT> &
    ui$LayoutAlignment__TOP_RIGHT &
    2; // 2
  static +LEFT_TOP: Class<ui$LayoutAlignment__LEFT_TOP> &
    ui$LayoutAlignment__LEFT_TOP &
    3; // 3
  static +LEFT_MIDDLE: Class<ui$LayoutAlignment__LEFT_MIDDLE> &
    ui$LayoutAlignment__LEFT_MIDDLE &
    4; // 4
  static +LEFT_BOTTOM: Class<ui$LayoutAlignment__LEFT_BOTTOM> &
    ui$LayoutAlignment__LEFT_BOTTOM &
    5; // 5
  static +RIGHT_TOP: Class<ui$LayoutAlignment__RIGHT_TOP> &
    ui$LayoutAlignment__RIGHT_TOP &
    6; // 6
  static +RIGHT_MIDDLE: Class<ui$LayoutAlignment__RIGHT_MIDDLE> &
    ui$LayoutAlignment__RIGHT_MIDDLE &
    7; // 7
  static +RIGHT_BOTTOM: Class<ui$LayoutAlignment__RIGHT_BOTTOM> &
    ui$LayoutAlignment__RIGHT_BOTTOM &
    8; // 8
  static +BOTTOM_LEFT: Class<ui$LayoutAlignment__BOTTOM_LEFT> &
    ui$LayoutAlignment__BOTTOM_LEFT &
    9; // 9
  static +BOTTOM_CENTER: Class<ui$LayoutAlignment__BOTTOM_CENTER> &
    ui$LayoutAlignment__BOTTOM_CENTER &
    10; // 10
  static +BOTTOM_RIGHT: Class<ui$LayoutAlignment__BOTTOM_RIGHT> &
    ui$LayoutAlignment__BOTTOM_RIGHT &
    11; // 11
}
...
declare class ui$MapSettingsControl mixins undefined.ui$Control {
   ...
   */
  constructor(
    opt_options?: Huiui$MapSettingsControlDistanceMeasurement$Options
  ): this;

  /**
   * Sets the traffic incidents layer to be shown when activating the respective button on the map settings control.
   * @param {Hmaplayerlayer$Layer} incidentsLayer - the incidents layer
   */
  setIncidentsLayer(incidentsLayer: Hmaplayerlayer$Layer): void;
}
...
declare class ui$Pano mixins undefined.ui$Control {
   ...
   */
  constructor(opt_options?: Huiui$PanoDistanceMeasurement$Options): this;
}
...
declare class ui$ScaleBar {
   ...
   */
  constructor(opt_options?: Huiui$ScaleBarDistanceMeasurement$Options): this;
}
...
declare class ui$UI mixins undefined.util$ICapturable {
  ...
  constructor(
    map: HH$Map,
    opt_options?: ui$UIDistanceMeasurement$Options
  ): this;
   ...
   * @returns {Huiui$UnitSystem} - the current unit system
   */
  getUnitSystem(): ui$UnitSystem;

  /**
   * This method sets this UI object's unit system for displaying distances.
   * @param {Huiui$UnitSystem} unitSystem - the unit system to use
   */
   ...
   * @param {Huiui$InfoBubble} bubble - the info bubble to be added
   */
  addBubble(bubble: ui$InfoBubble): void;

  /**
   * This method removes a previously added info bubble from the UI.
   * @param {Huiui$InfoBubble} bubble - the info bubble to be removed
   */
   ...
   * @returns {Array<Huiui$InfoBubble>} - the list of info bubbles
   */
   ...
   * @param {Huiui$Control} control - the control to add to this UI
   */
   ...
   * @returns {Huiui$Control} - the removed control
   */
   ...
   * @returns {Huiui$Control} - the control or undefined if the control does not exist.
   */
   ...
   *      id: 'panorama'
   *      alignment: 'top-right'
   * @param {HH$Map} map - The map instance to which to append the UI
   * @param {map$Object<Hserviceservice$MapType>} mapTypes - The map types to use
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_locale - the language to use (or a full localization object).
   * @returns {Huiui$UI} - the UI instance configured with the default controls
   */
  static createDefault(
    map: HH$Map,
    mapTypes:
      | Hserviceservice$PlatformPlatform$MapTypes
      | Hserviceservice$DefaultLayers,
    opt_locale?: Huii18ni18n$Localization | string
  ): Huiui$UI;
...
declare class ui$UnitSystem {
  constructor(...args: empty): mixed;
  static +IMPERIAL: Class<ui$UnitSystem__IMPERIAL> &
    ui$UnitSystem__IMPERIAL &
    0; // 0
...
declare class ui$ZoomControl mixins undefined.ui$Control {
   ...
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - optional parameters to be passed to the map.
   */
  constructor(opt_options?: Huiui$ZoomControlDistanceMeasurement$Options): this;
...
declare class ui$ZoomRectangle mixins undefined.ui$Control {
   ...
   */
  constructor(
    opt_options?: Huiui$ZoomRectangleDistanceMeasurement$Options
  ): this;
}
...
declare interface TileProvider$Options {
  ...
  pixelRatio?: number;
  onSpaceCreated?: (space: Hservicevenuesvenues$Space) => void;
  tileType?: string;
  scheme?: string;
  tileCacheSize?: number;
  tileSize?: number;
  ...
  min?: number;
  max?: number;
  getCopyrights?: (rect: Hgeogeo$Rect, number: number) => Hmapmap$ICopyright[];
  tileSize?: number;
}
/**
...
declare class venues$Building mixins undefined.map$Group {
  /**
   * Constructor
   * @param {Hmapproviderprovider$ObjectProvider} provider - The object provider of this venue building
   ...
   */
  constructor(
    provider: Hmapproviderprovider$ObjectProvider,
    uid: string,
    minLevel: number,
    maxLevel: number
  ): this;
   ...
   * @returns {Hservicevenuesvenues$Venue}
   */
  getVenue(): Hservicevenuesvenues$Venue;
   ...
   * @returns {(Hservicevenuesvenues$Floor | void)} - The floor object or undefined if floor was not loaded
   */
  getFloor(level: number): Hservicevenuesvenues$Floor | void;
}
...
declare class venues$Floor mixins undefined.map$Group {
  /**
   * Constructor
   * @param {Hmapproviderprovider$ObjectProvider} provider - The object provider of this venue floor
   ...
   * @returns {(Hservicevenuesvenues$Space | void)}
   */
  getFloorSpace(): Hservicevenuesvenues$Space | void;

  /**
   * Method returns the H.map.Group of all spaces that belong to the floor.
   * @returns {Hmapmap$Group}
   */
  getSpaces(): Hmapmap$Group;

  /**
   * Method returns parent object - building (see H.service.venues.Building) of the floor.
   * @returns {Hservicevenuesvenues$Building}
   */
  getBuilding(): Hservicevenuesvenues$Building;
   ...
   * @returns {(Hservicevenuesvenues$Space | void)} - The requested space or undefined if space not found.
   */
  getSpace(id: string): Hservicevenuesvenues$Space | void;
}

/**
 * This class encapsulates methods to call Venue Maps API endpoints.
 */
declare class venues$Service
  mixins undefined.util$EventTarget, undefined.service$IConfigurable {
  /**
   * Constructor
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - additional service parameters
   */
  constructor(opt_options?: Hservicevenuesvenues$ServiceService$Options): this;
   ...
   * @param {Hserviceservice$ServiceParameters} serviceParams - the service parameters to be sent with the discovery request
   ...
   */
  discover(
    serviceParams: Hserviceservice$ServiceParameters,
    onResult: (res: Hserviceservice$ServiceResult) => void,
   ...
   * @returns {Hmaplayerlayer$TileLayer} - the tile layer
   */
  createTileLayer(
    opt_options?: Hservicevenuesprovider$TileProviderService$Options
  ): Hmaplayerlayer$TileLayer;

  /**
   * Method returns current state of the service.
   * @returns {Hservicevenuesvenues$ServiceService$State} - State of the service
   */
  getState(): Hservicevenuesvenues$ServiceService$State;
 ...
 * @returns {Hserviceservice$IConfigurable}
 */
  configure(
    appId: string,
    appCode: string,
    useHTTPS: boolean,
    useCIT: boolean,
    opt_baseUrl?: Hserviceservice$Url
  ): Hserviceservice$IConfigurable;
}
...
declare class venues$Space {
  /**
   * Constructor
   * @param {Hmapproviderprovider$ObjectProvider} provider - The provider of this object.
   ...
   * @param {(Hmapmap$SpatialStyle | Hmapmap$SpatialStyleService$Options)} labelStyle - Custom label style
   */
  initLabelStyle(
    labelStyle: Hmapmap$SpatialStyle | Hmapmap$SpatialStyleService$Options
  ): void;

  /**
   * Method returns parent object - floor (see H.service.venues.Floor) of the space.
   * @returns {Hservicevenuesvenues$Floor}
   */
  getFloor(): Hservicevenuesvenues$Floor;
...
declare class venues$TileProvider mixins undefined.provider$RemoteTileProvider {
  /**
   * Constructor
   * @param {Hservicevenuesvenues$Service} service
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   */
  constructor(
    service: Hservicevenuesvenues$Service,
    opt_options?: Hservicevenuesvenues$TileProviderService$Options
  ): this;
...
declare class venues$Venue mixins undefined.map$Group {
  /**
   * Constructor
   * @param {Hmapproviderprovider$ObjectProvider} provider - The object provider of this venue
   * @param {string} uid - The unique identifier of this venue
   */
  constructor(provider: Hmapproviderprovider$ObjectProvider, uid: string): this;
   ...
   * @returns {(Hservicevenuesvenues$Building | void)} - The requested building or undefined if building wasn't loaded
   */
  getBuilding(id: string): Hservicevenuesvenues$Building | void;

  /**
   * Method returns map of all loaded buildings associated with the venue.
   * @returns {map$Object<"NO PRINT IMPLEMENTED: JSDocAllType", Hservicevenuesvenues$Building>}
   */
  getBuildings(): any;
}
/**
 ...
 */
declare class metaInfo$Service
  mixins undefined.util$EventTarget, undefined.service$IConfigurable {
  /**
   * Constructor
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - additional service parameters
   */
  constructor(
    opt_options?: HservicemetaInfometaInfo$ServiceService$Options
  ): this;
   ...
   * @returns {(HservicemetaInfometaInfo$ServiceService$Info | void)} - meta information for this meta info tile service
   */
  getInfo(): HservicemetaInfometaInfo$ServiceService$Info | void;
   ...
   * @returns {Hmapprovidervenues$TileProvider} - the tile provider
   */
  createTileProvider(
    tileSize: number,
    pixelRatio: number,
    opt_categoryFilter?: string[],
    opt_additionalParameters?: Hserviceservice$ServiceParameters,
    opt_tileType?: string,
    opt_scheme?: string
  ): Hmapprovidervenues$TileProvider;
 ...
 */
declare class metaInfo$TileProvider
  mixins undefined.provider$RemoteTileProvider {
  /**
   * Constructor
   * @param {(HservicemetaInfometaInfo$Service | Hserviceservice$MapTileService)} service - the tile service which holds information from about the source of the tiles
   ...
   */
  constructor(
    service: HservicemetaInfometaInfo$Service | Hserviceservice$MapTileService,
    opt_params?: Hserviceservice$ServiceParameters,
    opt_options?: HservicemetaInfometaInfo$TileProviderService$Options
  ): this;
}
/**
...
declare interface Platform$MapTypes {
  normal?: Hserviceservice$MapType;
  satellite?: Hserviceservice$MapType;
  terrain?: Hserviceservice$MapType;
  [key: string]: Hserviceservice$MapType | void;
}
/**
...
declare class PlacesService$EntryPoint {
  constructor(...args: empty): mixed;
  static +SEARCH: Class<PlacesService$EntryPoint__SEARCH> &
    PlacesService$EntryPoint__SEARCH &
    0; // 0
  static +SUGGEST: Class<PlacesService$EntryPoint__SUGGEST> &
    PlacesService$EntryPoint__SUGGEST &
    1; // 1
  static +EXPLORE: Class<PlacesService$EntryPoint__EXPLORE> &
    PlacesService$EntryPoint__EXPLORE &
    2; // 2
  static +AROUND: Class<PlacesService$EntryPoint__AROUND> &
    PlacesService$EntryPoint__AROUND &
    3; // 3
  static +HERE: Class<PlacesService$EntryPoint__HERE> &
    PlacesService$EntryPoint__HERE &
    4; // 4
  static +CATEGORIES: Class<PlacesService$EntryPoint__CATEGORIES> &
    PlacesService$EntryPoint__CATEGORIES &
    5; // 5
}

declare class PlacesService$EntryPoint__SEARCH
  mixins PlacesService$EntryPoint {}
declare class PlacesService$EntryPoint__SUGGEST
  mixins PlacesService$EntryPoint {}
declare class PlacesService$EntryPoint__EXPLORE
  mixins PlacesService$EntryPoint {}
declare class PlacesService$EntryPoint__AROUND
  mixins PlacesService$EntryPoint {}
declare class PlacesService$EntryPoint__HERE mixins PlacesService$EntryPoint {}
declare class PlacesService$EntryPoint__CATEGORIES
  mixins PlacesService$EntryPoint {}
...
declare type AbstractRestService$Options = any;
/**
 * Abstract rest service class
 */
declare class service$AbstractRestService
  mixins undefined.service$IConfigurable {
  /**
   * Constructor
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   */
  constructor(
    opt_options?: Hserviceservice$AbstractRestServiceAbstractRestService$Options
  ): this;
...
declare interface service$DefaultLayers {
  ...
  satellite: Hserviceservice$MapType;
  terrain: Hserviceservice$MapType;
  incidents: Hmaplayerlayer$MarkerTileLayer;
  venues: Hmaplayerlayer$TileLayer;
}
 ...
 */
declare class service$EnterpriseRoutingService
  mixins undefined.service$AbstractRestService {
  /**
   * Constructor
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   */
  constructor(
    opt_options?: Hserviceservice$EnterpriseRoutingServiceAbstractRestService$Options
  ): this;
   ...
   * @param {Hserviceservice$ServiceParameters} calculateRouteParams - the service parameters to be sent with the routing request.
   ...
   */
  calculateRoute(
    calculateRouteParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
   ...
   * a H.service.ServiceResult object - or the onError callback if a communication error occurred.
   * @param {Hserviceservice$ServiceParameters} getRouteParams - the service parameters to be sent with the routing request.
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onResult - this function will be called once the Enterprise Routing REST API provides a response to the request.
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onError - this function will be called if a communication error occurs during the JSON-P request
   */
  getRoute(
    getRouteParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): void;
   ...
   * @param {Hserviceservice$ServiceParameters} getLinkInfoParams - the service parameters to be sent with the routing request.
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onResult - this function will be called once the Enterprise Routing REST API provides a response to the request.
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onError - this function will be called if a communication error occurs during the JSON-P request
   */
  getLinkInfo(
    getLinkInfoParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): void;
   ...
   * a H.service.ServiceResult object - or the onError callback if a communication error occurred.
   * @param {Hserviceservice$ServiceParameters} calculateIsolineParams - the service parameters to be sent with the routing request.
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onResult - this function will be called once the Enterprise Routing REST API provides a response to the request.
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onError - this function will be called if a communication error occurs during the JSON-P request
   */
  calculateIsoline(
    calculateIsolineParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): void;
}
 ...
 */
declare class service$GeocodingService
  mixins undefined.service$AbstractRestService {
  /**
   * Constructor
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   */
  constructor(
    opt_options?: Hserviceservice$GeocodingServiceAbstractRestService$Options
  ): this;
   ...
   * object - or the onError callback if a communication error occured.
   * @param {Hserviceservice$ServiceParameters} geoodingParams - the service parameters to be sent with the geocoding request.
   ...
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onError - this function will be called if a communication error occurs during the JSON-P request
   * @returns {Hserviceservice$JsonpRequestHandle}
   */
  geocode(
    geoodingParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): Hserviceservice$JsonpRequestHandle;

  /**
   * This method sends a reverse geocoding request to Geocoder REST API and calls the onResult callback function once the service response was received - providing a H.service.ServiceResult
   * object - or the onError callback if a communication error occured.
   * @param {Hserviceservice$ServiceParameters} reverseGeocodingParams - the service parameters to be sent with the reverse geocoding request
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onResult - this function will be called once the Geocoder REST API provides a response to the request.
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onError - this function will be called if a communication error occurs during the JSON-P request
   * @returns {Hserviceservice$JsonpRequestHandle}
   */
  reverseGeocode(
    reverseGeocodingParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): Hserviceservice$JsonpRequestHandle;
   ...
   * object - or the onError callback if a communication error occured.
   * @param {Hserviceservice$ServiceParameters} searchParams - the service parameters to be sent with the reverse geocoding request
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onResult - this function will be called once the Geocoder REST API provides a response to the request.
   * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} onError - this function will be called if a communication error occurs during the JSON-P request
   * @returns {Hserviceservice$JsonpRequestHandle}
   */
  search(
    searchParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): Hserviceservice$JsonpRequestHandle;
}
 ...
 */
declare class service$MapTileService
  mixins undefined.util$EventTarget, undefined.service$IConfigurable {
  /**
   * Constructor
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   */
  constructor(
    opt_options?: Hserviceservice$MapTileServiceAbstractRestService$Options
  ): this;
   ...
   * @returns {(Hserviceservice$MapTileServiceMapTileService$Info | void)} - meta information for this map tile service
   */
  getInfo(): Hserviceservice$MapTileServiceMapTileService$Info | void;
   ...
   * @returns {Hmapproviderprovider$ImageTileProvider} - the image tile provider
   */
  createTileProvider(
    tileType: string,
    scheme: string,
    ...
    format: string,
    opt_additionalParameters?: Hserviceservice$ServiceParameters,
    opt_options?: Hserviceservice$TileProviderOptions
  ): Hmapproviderprovider$ImageTileProvider;
...
declare interface service$MapType {
  map: Hmaplayerlayer$TileLayer;
  mapnight: Hmaplayerlayer$TileLayer;
  xbase?: Hmaplayerlayer$TileLayer;
  xbasenight?: Hmaplayerlayer$TileLayer;
  base?: Hmaplayerlayer$TileLayer;
  basenight?: Hmaplayerlayer$TileLayer;
  traffic?: Hmaplayerlayer$TileLayer;
  trafficnight?: Hmaplayerlayer$TileLayer;
  transit?: Hmaplayerlayer$TileLayer;
  panorama?: Hmaplayerlayer$TileLayer;
  panoramanight?: Hmaplayerlayer$TileLayer;
  labels?: Hmaplayerlayer$TileLayer;
}
 ...
 */
declare class service$PlacesService
  mixins undefined.service$AbstractRestService {
  /**
   * Constructor
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   */
  constructor(
    opt_options?: Hserviceservice$PlacesServiceAbstractRestService$Options
  ): this;

  /**
 * This is generic method to query places RestAPI.
 * @param {Hserviceservice$PlacesServicePlacesService$EntryPoint} entryPoint - can be one of available entry points H.service.PlacesService.EntryPoint i.e value of H.service.PlacesService.EntryPoint.SEARCH
 ...
 * @returns {Hserviceservice$JsonpRequestHandle} - jsonp request handle
 */
  request(
    entryPoint: Hserviceservice$PlacesServicePlacesService$EntryPoint,
    entryPointParams: {},
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): Hserviceservice$JsonpRequestHandle;
   ...
   * @param {Hserviceservice$ServiceParameters} searchParams - places api search entry point parameters please refer to places api documentation
   ...
   * @param {Hserviceservice$ServiceParameters} suggestParams - places api suggest entry point parameters please refer to places api documentation
   * @param {Function} onResult
   * @param {Function} onError
   * @returns {Hserviceservice$JsonpRequestHandle} - jsonp request handle
   */
  suggest(
    suggestParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): Hserviceservice$JsonpRequestHandle;
   ...
   * @param {Hserviceservice$ServiceParameters} exploreParams - places api explore entry point parameters please refer to places api documentation
   * @param {Function} onResult
   * @param {Function} onError
   * @returns {Hserviceservice$JsonpRequestHandle} - jsonp request handle
   */
  explore(
    exploreParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): Hserviceservice$JsonpRequestHandle;
   ...
   * @param {Hserviceservice$ServiceParameters} aroundParams - places api around entry point parameters please refer to places api documentation
   * @param {Function} onResult
   * @param {Function} onError
   * @returns {Hserviceservice$JsonpRequestHandle} - jsonp request handle
   */
  around(
    aroundParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): Hserviceservice$JsonpRequestHandle;
   ...
   * @param {Hserviceservice$ServiceParameters} hereParams - places api here entry point parameters please refer to places api documentation
   * @param {Function} onResult
   * @param {Function} onError
   * @returns {Hserviceservice$JsonpRequestHandle} - jsonp request handle
   */
  here(
    hereParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): Hserviceservice$JsonpRequestHandle;
   ...
   * @param {Hserviceservice$ServiceParameters} categoriesParams - places api here entry point parameters please refer to places api documentation
   * @param {Function} onResult
   * @param {Function} onError
   * @returns {Hserviceservice$JsonpRequestHandle} - jsonp request handle
   */
  categories(
    categoriesParams: Hserviceservice$ServiceParameters,
    onResult: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): Hserviceservice$JsonpRequestHandle;
   ...
   * @returns {Hserviceservice$JsonpRequestHandle} - jsonp resquest handle
   */
  follow(
    hyperlink: string,
    onResult: (result: Hserviceservice$ServiceResult) => void,
...
declare class service$Platform {
  /**
   * Constructor
   * @param {Hserviceservice$PlatformAbstractRestService$Options} options
   */
  constructor(
    options: Hserviceservice$PlatformAbstractRestService$Options
  ): this;

  /**
   * Method attempts to configure object that implements H.service.IConfigurable
   * @param {Hserviceservice$IConfigurable} configurable
   * @returns {Hserviceservice$IConfigurable}
   */
  configure(
    configurable: Hserviceservice$IConfigurable
  ): Hserviceservice$IConfigurable;
   ...
   * @param {Hserviceservice$Url} baseUrl - the new base URL to use
   */
  setBaseUrl(baseUrl: Hserviceservice$Url): void;

  /**
   * This method returns the currently used base URL.
   * @returns {Hserviceservice$Url}
   */
  getBaseUrl(): Hserviceservice$Url;

  /**
   * This method returns an instance of H.service.TrafficIncidentsService to query the Traffic API Traffic Incident Data
   * @returns {Hserviceservice$TrafficIncidentsService} - a new places service instance
   */
  getTrafficIncidentsService(): Hserviceservice$TrafficIncidentsService;

  /**
   * This method returns an instance of H.service.MapTileService to query the Map Tile API.
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   * @returns {Hserviceservice$MapTileService}
   */
  getMapTileService(
    opt_options?: Hserviceservice$MapTileServiceAbstractRestService$Options
  ): Hserviceservice$MapTileService;
   ...
   * @returns {HservicevenuesmetaInfo$Service}
   */
  getVenueService(
    opt_params?: HservicevenuesmetaInfo$ServiceAbstractRestService$Options
  ): HservicevenuesmetaInfo$Service;

  /**
   * This method returns an instance of H.service.metaInfo.Service to query the Map Tile API Metainfo Tiles
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_params - additional service parameters
   * @returns {HservicemetaInfometaInfo$Service}
   */
  getMetaInfoService(
    opt_params?: HservicemetaInfometaInfo$ServiceAbstractRestService$Options
  ): HservicemetaInfometaInfo$Service;
 ...
 * @returns {Hserviceservice$DefaultLayers} - a set of tile layers ready to use
 */
  createDefaultLayers(
    opt_tileSize?:
      | Hserviceservice$PlatformPlatform$DefaultLayersOptions
      | number,
    opt_ppi?: number,
    opt_lang?: string,
   ...
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   * @returns {Hserviceservice$RoutingService}
   */
  getRoutingService(
    opt_options?: Hserviceservice$RoutingServiceAbstractRestService$Options
  ): Hserviceservice$RoutingService;
   ...
   * @returns {Hserviceservice$GeocodingService} - a new geocoding service instance
   */
  getGeocodingService(
    opt_options?: Hserviceservice$GeocodingServiceAbstractRestService$Options
  ): Hserviceservice$GeocodingService;

  /**
   * This method returns an instance of H.service.PlacesService to query the Places API.
   * @returns {Hserviceservice$PlacesService} - a new places service instance
   */
  getPlacesService(): Hserviceservice$PlacesService;

  /**
   * This method returns an instance of H.service.EnterpriseRoutingService to query the Enterprise Routing API.
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   * @returns {Hserviceservice$EnterpriseRoutingService}
   */
  getEnterpriseRoutingService(
    opt_options?: Hserviceservice$EnterpriseRoutingServiceAbstractRestService$Options
  ): Hserviceservice$EnterpriseRoutingService;
}
 ...
 */
declare class service$RoutingService
  mixins undefined.service$AbstractRestService {
  /**
   * Constructor
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
 ...
 * tile basis
 */
declare class service$TrafficIncidentsService
  mixins undefined.service$AbstractRestService {
  /**
   * Constructor
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   */
  constructor(
    opt_options?: Hserviceservice$TrafficIncidentsServiceAbstractRestService$Options
  ): this;

  /**
   * This method requests traffic incidents based on the service parameters provided.
   * @param {Hserviceservice$ServiceParameters} serviceParams
  ...
  requestIncidents(
    serviceParams: Hserviceservice$ServiceParameters,
    onResponse: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void
  ): Hserviceservice$JsonpRequestHandle;
  ...
  requestIncidentsByTile(
    ...
    onResponse: (result: Hserviceservice$ServiceResult) => void,
    onError: (error: Error) => void,
    opt_serviceParams?: Hserviceservice$ServiceParameters
  ): Hserviceservice$JsonpRequestHandle;
}
...
declare class service$Url {
   ...
   * @returns {Hserviceservice$Url} - the parsed URL object
   */
  static parse(url: string, opt_baseURL?: string): Hserviceservice$Url;
   ...
   * @returns {Hserviceservice$Url} - the clone of the URL object
   */
  clone(): Hserviceservice$Url;

  /**
   * This function sets the scheme of this URL object.
   * @param {string} scheme - the new scheme
   * @returns {Hserviceservice$Url} - this URL object
   */
  setScheme(scheme: string): Hserviceservice$Url;
   ...
   * @returns {Hserviceservice$Url} - this URL object
   */
  setHost(host: string): Hserviceservice$Url;
   ...
   * @returns {Hserviceservice$Url} - this URL object
   */
  setPath(path: string | boolean): Hserviceservice$Url;
   ...
   * @returns {Hserviceservice$Url} - this URL object
   */
  setQuery(params?: {} | boolean): Hserviceservice$Url;
   ...
   * @returns {Hserviceservice$Url} - this URL object
   */
  setAnchor(anchor?: string | boolean): Hserviceservice$Url;
   ...
   * @returns {Hserviceservice$Url} - this URL object
   */
  mergeQuery(other: {}): Hserviceservice$Url;
   ...
   * @returns {Hserviceservice$Url} - this URL object
   */
  addSubDomain(subDomain: string): Hserviceservice$Url;
   ...
   * @returns {Hserviceservice$Url} - this URL object
   */
  addSubPath(subPath: string): Hserviceservice$Url;
...
declare class math$Point mixins math$IPoint {
   ...
   * @returns {Hmathmath$Point} - The clone of the point
   */
  clone(opt_out?: math$Point): math$Point;

  /**
   * This method adds given point coordinates to the current one.
   * @param {Hmathmath$IPoint} other - The point to add
   * @returns {Hmathmath$Point} - the point itself after adding
   */
  add(other: math$IPoint): math$Point;

  /**
   * This method subtracts given point coordinates from the current point.
   * @param {Hmathmath$IPoint} other - The point to subtract
   * @returns {Hmathmath$Point} - the point itself after subtracting
   */
   ...
   * @param {Hmathmath$IPoint} start - The start point of the line
   * @param {Hmathmath$IPoint} end - The end point of the line
   * @returns {Hmathmath$IPoint} - the closest point
   */
   ...
   * @param {Hmathmath$IPoint} iPoint - The IPoint object to use
   * @returns {Hmathmath$Point} - the created Point instance
   */
...
declare class math$Rect {
   ...
   * @returns {Hmathmath$Point}
   */
  getTopLeft(): Hmathmath$Point;

  /**
   * To get the rectangle's bottom-right vertex
   * @returns {Hmathmath$Point}
   */
  getBottomRight(): Hmathmath$Point;
   ...
   * @param {Hmathmath$IPoint} topLeft - the top-left vertex of the rectanle
   * @param {Hmathmath$IPoint} bottomRight - the bottom-right vertex of the rectanle
   * @returns {Hmathmath$Rect} - returns the rectangular area defined by the top-left and bottom-right vertices
   */
  static fromPoints(
    topLeft: Hmathmath$IPoint,
    bottomRight: Hmathmath$IPoint
  ): Hmathmath$Rect;

  /**
   * To clone a rectangle
   * @returns {Hmathmath$Rect}
   */
  clone(): Hmathmath$Rect;
}
 ...
 */
declare type Pointer$Buttons = Hmathmath$BitMask;
/**
...
declare interface Behavior$Options {
  kinetics?: Hutilkineticskinetics$IKinetics;
  enable?: Hmathmath$BitMask;
}
/**
...
declare class mapevents$Behavior mixins undefined.util$Disposable {
  /**
   * Constructor
   * @param {Hmapeventsmapevents$MapEvents} mapEvents - previously initialized map events instance
   * @param {Hmapeventsmapevents$BehaviorBehavior$Options} options - additional options (i.e kinetics)
   */
  constructor(
    mapEvents: Hmapeventsmapevents$MapEvents,
    options?: Hmapeventsmapevents$BehaviorBehavior$Options
  ): this;
   ...
   */
  disable(opt_behavior?: Hmathmath$BitMask): void;
   ...
   */
  enable(opt_behavior?: Hmathmath$BitMask): void;
 ...
 * @property defaultPrevented {boolean} - Indicates if preventDefault was called on the current event
 */
declare class mapevents$ContextMenuEvent mixins undefined.util$Event {
  /**
   * Constructor
   * @param {number} viewportX - The x coordinate on the viewport
   * @param {number} viewportY - The y coordinate on the viewport
   * @param {(HH$Map | Hmapmap$Object)} target - The event's target element
   * @param {util$Event} originalEvent - target of the event
   */
  constructor(
    viewportX: number,
    viewportY: number,
    target: HH$Map | Hmapmap$Object,
    originalEvent: util$Event
  ): this;
  viewportX: Hutilutil$ContextItem[];
  viewportY: number;
  originalEvent: util$Event;
}
...
declare class mapevents$Event mixins undefined.mapevents$Event {
   ...
   * @param {Array<Hmapeventsmapevents$Pointer>} pointers - pointers which are currently on the screen
   * @param {Array<Hmapeventsmapevents$Pointer>} changedPointers - pointers which changed during event
   * @param {Array<Hmapeventsmapevents$Pointer>} targetPointers - pointers on the event target
   * @param {Hmapeventsmapevents$Pointer} currentPointer - pointer which triggered the event
   * @param {(HH$Map | Hmapmap$Object)} target - target map object which triggered event
   * @param {mapevents$Event} originalEvent - original dom event
   */
  constructor(
    type: string,
    pointers: Hmapeventsmapevents$Pointer[],
    changedPointers: Hmapeventsmapevents$Pointer[],
    targetPointers: Hmapeventsmapevents$Pointer[],
    currentPointer: Hmapeventsmapevents$Pointer,
    target: HH$Map | Hmapmap$Object,
  ...
  currentPointer: Hmapeventsmapevents$Pointer;
  originalEvent: mapevents$Event;
  target: Hmapmap$Object | HH$Map;
  currentTarget: Hmapmap$Object | HH$Map;
  type: string;
  defaultPrevented: boolean;
}
...
declare class mapevents$MapEvents mixins undefined.util$Disposable {
  /**
   * Constructor
   * @param {HH$Map} map - map instance which is used for firing events
   */
  constructor(map: HH$Map): this;
...
declare class mapevents$Pointer {
  ...
  constructor(
    ...
    id: number,
    type: string,
    opt_button?: Hmapeventsmapevents$PointerPointer$Button,
    opt_buttons?: Hmathmath$BitMask
  ): this;
  static viewportX: number;
  static viewportY: number;
  static target: Hmapmap$Object | HH$Map;
  static id: number;
  static type: string;
  static dragTarget: Hmapmap$Object | HH$Map;
  static button: Hmapeventsmapevents$PointerPointer$Button;
}
...
declare class RenderEngine$InteractionModifiers {
  constructor(...args: empty): mixed;
  static +ZOOM: Class<RenderEngine$InteractionModifiers__ZOOM> &
    RenderEngine$InteractionModifiers__ZOOM &
    0; // 0
  static +HEADING: Class<RenderEngine$InteractionModifiers__HEADING> &
    RenderEngine$InteractionModifiers__HEADING &
    1; // 1
  static +TILT: Class<RenderEngine$InteractionModifiers__TILT> &
    RenderEngine$InteractionModifiers__TILT &
    2; // 2
  static +INCLINE: Class<RenderEngine$InteractionModifiers__INCLINE> &
    RenderEngine$InteractionModifiers__INCLINE &
    3; // 3
  static +COORD: Class<RenderEngine$InteractionModifiers__COORD> &
    RenderEngine$InteractionModifiers__COORD &
    4; // 4
}

declare class RenderEngine$InteractionModifiers__ZOOM
  mixins RenderEngine$InteractionModifiers {}
declare class RenderEngine$InteractionModifiers__HEADING
  mixins RenderEngine$InteractionModifiers {}
declare class RenderEngine$InteractionModifiers__TILT
  mixins RenderEngine$InteractionModifiers {}
declare class RenderEngine$InteractionModifiers__INCLINE
  mixins RenderEngine$InteractionModifiers {}
declare class RenderEngine$InteractionModifiers__COORD
  mixins RenderEngine$InteractionModifiers {}
...
declare class p2d$RenderEngine mixins undefined.p2d$RenderEngine {
  /**
   * Constructor
   * @param {Hmapmap$ViewPort} viewPort - An object representing the map viewport
   * @param {Hmapmap$ViewModel} viewModel - An object representing a view of the map
   * @param {Hmapmap$DataModel} dataModel - An object encapsulating the data to be rendered on the map (layers and objects)
   * @param {Hmaprenderp2d$RenderEngineRenderEngine$Options} options - An object containing the render engine initialization options
   */
  constructor(
    viewPort: Hmapmap$ViewPort,
    viewModel: Hmapmap$ViewModel,
    dataModel: Hmapmap$DataModel,
    options: Hmaprenderp2d$RenderEngineRenderEngine$Options
  ): this;
 ...
 */
  ...
  addEventListener(
    type: string,
    handler: (evt: mapevents$Event) => void,
    opt_capture?: boolean,
    opt_scope?: {}
  ): void;
   ...
   * @param {Hutilmapevents$Event | string} evt - An object representing the event or a string with the event name
   */
  dispatchEvent(evt: Hutilmapevents$Event | string): void;
...
declare class render$RenderEngine mixins undefined.util$EventTarget {
   ...
   * @param {Hmapmap$ViewModel} viewModel - An object representing a view of the map
   * @param {Hmapmap$DataModel} dataModel - An object encapsulating the data to be rendered on the map (layers and objects)
   * @param {Hmaprenderrender$RenderEngineRenderEngine$Options} options - An object containing the render engine initialization options
   */
  constructor(
    viewPort: Hmapmap$ViewPort,
    viewModel: Hmapmap$ViewModel,
    dataModel: Hmapmap$DataModel,
    options: Hmaprenderrender$RenderEngineRenderEngine$Options
  ): this;
...
declare class render$RenderState {
  constructor(...args: empty): mixed;
  static +PENDING: Class<render$RenderState__PENDING> &
    render$RenderState__PENDING &
    0; // 0
  static +ACTIVE: Class<render$RenderState__ACTIVE> &
    render$RenderState__ACTIVE &
    1; // 1
...
declare interface render$RenderingParams {
   ...
   * @type {Hmathmath$Point}
   */
  screenCenter: Hmathmath$Point;
...
declare interface Provider$Options {
  ...
  min?: number;
  max?: number;
  getCopyrights?: (rect: Hgeomath$Rect, n: number) => Hmapmap$ICopyright[];
  min?: number;
  max?: number;
  clusteringOptions?: Hclusteringclustering$ProviderProvider$ClusteringOptions;
  theme?: Hclusteringclustering$ITheme;
}
...
declare interface Provider$ClusteringOptions {
  eps?: number;
  minWeight?: number;
  projection?: Hgeogeo$IProjection;
  strategy?: Hclusteringclustering$ProviderProvider$Strategy;
}
...
declare class Provider$Strategy {
  constructor(...args: empty): mixed;
  static +FASTGRID: Class<Provider$Strategy__FASTGRID> &
    Provider$Strategy__FASTGRID &
    0; // 0
  static +GRID: Class<Provider$Strategy__GRID> & Provider$Strategy__GRID & 1; // 1
  static +DYNAMICGRID: Class<Provider$Strategy__DYNAMICGRID> &
    Provider$Strategy__DYNAMICGRID &
    2; // 2
}
...
declare interface MarkerTileProvider$Options {
  ...
  requestData(
    ...
    n2: number,
    n3: number,
    markerCallback: (markers: Hmapmap$AbstractMarker[]) => void,
    f: () => void
  ): Hutilutil$ICancelable;
...
declare class Invalidations$Flag {
  ...
  static +VISUAL: Class<Invalidations$Flag__VISUAL> &
    Invalidations$Flag__VISUAL &
    1; // 1
  static +SPATIAL: Class<Invalidations$Flag__SPATIAL> &
    Invalidations$Flag__SPATIAL &
    2; // 2
  static +ADD: Class<Invalidations$Flag__ADD> & Invalidations$Flag__ADD & 3; // 3
  static +REMOVE: Class<Invalidations$Flag__REMOVE> &
    Invalidations$Flag__REMOVE &
    4; // 4
  static +Z_ORDER: Class<Invalidations$Flag__Z_ORDER> &
    Invalidations$Flag__Z_ORDER &
    5; // 5
}
 ...
 */
declare class provider$ImageTileProvider
  mixins undefined.provider$RemoteTileProvider {
  /**
   * Constructor
   * @param {Hmapproviderprovider$ImageTileProviderImageTileProvider$Options} options - configuration for tile provider
   */
  constructor(
    options: Hmapproviderprovider$ImageTileProviderImageTileProvider$Options
  ): this;
  tileSize: number;
}
...
declare class provider$Invalidations {
   ...
   * @param {Hmapproviderprovider$InvalidationsInvalidations$Mark} mark - The invalidation mark to set
   * @param {Hmathmath$BitMask} types - The descrete invalidation types to update
   */
  update(
    mark: Hmapproviderprovider$InvalidationsInvalidations$Mark,
    types: Hmathmath$BitMask
  ): void;

  /**
   * This method returns the current invalidation mark of this invalidations object.
   * @returns {Hmapproviderprovider$InvalidationsInvalidations$Mark} - the current invalidation mark
   */
  getMark(): Hmapproviderprovider$InvalidationsInvalidations$Mark;

  /**
   * Checks whether any change occurred after the specified since mark
   * @param {Hmapproviderprovider$InvalidationsInvalidations$Mark} since - The invalidation mark to check against
   * @returns {boolean}
   */
  isAny(since: Hmapproviderprovider$InvalidationsInvalidations$Mark): boolean;
   ...
   */
  isVisual(
    since: Hmapproviderprovider$InvalidationsInvalidations$Mark
  ): boolean;
   ...
   * @returns {boolean}
   */
  isAdd(since: Hmapproviderprovider$InvalidationsInvalidations$Mark): boolean;
  ...
  static MARK_INITIAL: Hmapproviderprovider$InvalidationsInvalidations$Mark;
}
 ...
 */
declare class provider$MarkerTileProvider
  mixins undefined.provider$RemoteTileProvider {
  /**
   * Constructor
   * @param {Hmapproviderprovider$MarkerTileProviderImageTileProvider$Options} options - configuration for tile provider
   */
  constructor(
    options: Hmapproviderprovider$MarkerTileProviderImageTileProvider$Options
  ): this;
   ...
   * @param {Hmathmath$BitMask} flags - The flags indicating the types of occurred changes
   */
  invalidateObject(
    marker: Hmapmap$AbstractMarker,
    flags: Hmathmath$BitMask
  ): void;
...
declare class provider$ObjectProvider mixins undefined.clustering$Provider {
   ...
   */
  constructor(
    opt_options?: Hmapproviderclustering$ProviderImageTileProvider$Options
  ): this;
   ...
   * @returns {Hmapproviderprovider$Invalidations}
   */
  getInvalidations(
    opt_type?: Hmapmap$ObjectObject$Type
  ): Hmapproviderprovider$Invalidations;
   ...
   * @param {Hmathmath$BitMask} changes - The flags indicating the types of occurred changes
   */
  invalidateObject(mapObject: Hmapmap$Object, changes: Hmathmath$BitMask): void;
   ...
   * @param {Hgeomath$Rect} geoRect - A rectangular area in geo space to intersect with
   ...
   * @returns {Array<Hmapmap$Overlay>} - a list of intersecting objects
   */
  requestOverlays(
    geoRect: Hgeomath$Rect,
    zoomLevel: number,
   ...
   * @param {boolean} visiblesOnly - Indicates whether only invisible objects are to be considered
   * @param {boolean} cacheOnly - Indicates whether only cached objects are to be considered
   * @returns {Array<Hmapmap$Spatial>} - a list of intersecting objects
   */
  requestSpatials(
    geoRect: Hgeomath$Rect,
    zoomLevel: number,
   ...
   * @param {HmapproviderSpatialTile} tile - The tile for which the objects are requested
   * @param {boolean} visiblesOnly - Indicates whether only invisible objects are to be considered
   * @param {boolean} cacheOnly - Indicates whether only cached objects are to be considered
   * @returns {Array<Hmapmap$Spatial>} - a list of intersecting objects
   */
  requestSpatialsByTile(
    tile: Hmapproviderprovider$Tile,
    visiblesOnly: boolean,
    cacheOnly: boolean
  ): Hmapmap$Spatial[];
   ...
   * @param {boolean} visiblesOnly - Indicates whether only invisible objects are to be considered
   * @param {boolean} cacheOnly - Indicates whether only cached objects are to be considered
   * @returns {Array<Hmapmap$Marker>} - a list of intersecting objects
   */
  requestMarkers(
    geoRect: Hgeomath$Rect,
    zoomLevel: number,
   ...
   * @param {boolean} visiblesOnly - Indicates whether only invisible objects are to be considered
   * @param {boolean} cacheOnly - Indicates whether only cached objects are to be considered
   * @returns {Array<Hmapmap$DomMarker>} - a list of intersecting objects
   */
  requestDomMarkers(
    geoRect: Hgeomath$Rect,
    zoomLevel: number,
...
declare class provider$Provider mixins undefined.util$EventTarget {
   ...
   */
  constructor(
    opt_options?: Hmapproviderprovider$ProviderImageTileProvider$Options
  ): this;

  /**
   * This method returns the copyrights of the provided content for a certain geographical area at a specified zoom level.
   * @param {Hgeomath$Rect} bounds - The bounding area for which to retrieve the copyright information
   ...
   */
  getCopyrights(bounds: Hgeomath$Rect, level: number): Hmapmap$ICopyright[];

  /**
   * This method will dispatch event on the event target object
   * @param {(Hutilmapevents$Event | string)} evt - event object or event name
   */
  dispatchEvent(evt: Hutilmapevents$Event | string): void;
 ...
 */
declare class provider$RemoteTileProvider
  mixins undefined.metaInfo$TileProvider {
  /**
   * Constructor
   * @param {HmapprovidermetaInfo$TileProviderImageTileProvider$Options} options - The options to instantiate this TileProvider
   */
  constructor(
    options: HmapprovidermetaInfo$TileProviderImageTileProvider$Options
  ): this;

  /**
   * This method returns cache which should be used to store tiles
   * @returns {Hutilutil$ICache} - cache
   */
  getCache(): Hutilutil$ICache;
  ...
  requestInternal(
    ...
    onError?: (s: string) => void,
    opt_priority?: Hnetutil$RequestRequest$Priority
  ): Hutilutil$ICancelable;
...
declare class provider$TileProvider mixins undefined.provider$Provider {
  /**
   * Constructor
   * @param {Hmapproviderprovider$TileProviderImageTileProvider$Options} options - The options to instantiate this TileProvider
   */
  constructor(
    options: Hmapproviderprovider$TileProviderImageTileProvider$Options
  ): this;
   ...
   * @returns {Hmapproviderprovider$Tile}
   */
  createTileInternal(
    x: number,
    y: number,
...
declare interface ITileLayer$Response {
  total: number;
  tiles: Hmapproviderprovider$Tile[];
}
/**
...
declare interface IMarkerLayer$Response {
  total: number;
  markers: Hmapmap$AbstractMarker[];
}
...
declare interface IMarkerLayer$TiledResponse {
  number: number;
  requested: number;
  objects: Hmapmap$AbstractMarker[];
}
/**
...
declare class layer$BaseTileLayer mixins undefined.layer$Layer {
  /**
   * Constructor
   * @param {Hmapproviderprovider$TileProvider} provider - data source for the TileLayer
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - additional options
   */
  constructor(
    provider: Hmapproviderprovider$TileProvider,
    opt_options?: Hmaplayerlayer$ITileLayerITileLayer$Options
  ): this;

  /**
   * This method returns the provider which feeds this layer with data.
   * @returns {Hmapproviderprovider$TileProvider} - this layer's provider
   */
  getProvider(): Hmapproviderprovider$TileProvider;
   ...
   * @param {Hgeomath$Rect} geoRect - geo bounds to be projected
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_zoom - overrides current projection zoom level
   * @returns {Hmathmath$Rect} - projected 2d space rect cooresponding to provided geo bounds
   */
  geoRectToRect(geoRect: Hgeomath$Rect, opt_zoom?: number): Hmathmath$Rect;

  /**
   * This method returns tile grid for a bounding rectangle
   * @param {Hmathmath$Rect} rectBounds - projected rect bounds which coorespond to geo bounding box
   * @param {number} zoom - current zoom level
   * @returns {Hmathmath$Rect} - rectangle which represents the tile grid bounds
   */
  getTileBounds(rectBounds: Hmathmath$Rect, zoom: number): Hmathmath$Rect;
   ...
   * @returns {(Hmapproviderprovider$Tile | void)} - tile object corresponding to requested coordinates
   */
  requestTile(
    x: number,
    y: number,
    z: number,
    cacheOnly: boolean
  ): Hmapproviderprovider$Tile | void;
   ...
   * @param {Hmathmath$Rect} tileBounds - bounds in tile grid
   * @param {boolean} isCDB
   * @param {number} zoomLevel - The zoom level for which the objects are requested
   * @param {boolean} cacheOnly - Indicates whether only cached objects are to be considered
   * @param {Hmathmath$Point} prioCenter - The priority center as an offset in screen pixel relative to the center
   * @returns {Hmaplayerlayer$ITileLayerIMarkerLayer$Response} - returns an array if tile which are already loaded
   */
  getProviderTiles(
    tileBounds: Hmathmath$Rect,
    isCDB: boolean,
    zoomLevel: number,
    cacheOnly: boolean,
    prioCenter: Hmathmath$Point
  ): Hmaplayerlayer$ITileLayerIMarkerLayer$Response;
}
...
declare interface layer$IMarkerLayer {
   ...
   * @param {Hgeomath$Rect} boundingRect - the bounding rectangle for which marker are to be returned
   * @param {number} zoomLevel - The zoom level for which the objects are requested
   * @param {boolean} cacheOnly - Indicates whether only cached objects are to be considered
   * @param {Hmathmath$Point} prioCenter - The priority center as an offset in screen pixel relative to the center
   * @returns {(Hmaplayerlayer$IMarkerLayerIMarkerLayer$Response | Hmaplayerlayer$IMarkerLayerIMarkerLayer$TiledResponse)} - a response object containing the number of markers and the markers themselves
   */
  requestMarkers(
    boundingRect: Hgeomath$Rect,
    zoomLevel: number,
    cacheOnly: boolean,
    prioCenter: Hmathmath$Point
  ):
    | Hmaplayerlayer$IMarkerLayerIMarkerLayer$Response
    | Hmaplayerlayer$IMarkerLayerIMarkerLayer$TiledResponse;
...
declare interface layer$ITileLayer {
   ...
   * @param {Hgeomath$Rect} boundingRect - the bounding rectangle for which tiles are to be returned
   * @param {number} zoomLevel - The zoom level for which the tiles are requested
   * @param {boolean} cacheOnly - Indicates whether only cached tiles are to be considered
   * @param {Hmathmath$Point} prioCenter - The priority center as an offset in screen pixel relative to the center
   * @returns {Hmaplayerlayer$ITileLayerIMarkerLayer$Response} - a response object containing the total number of tiles requested and the tile objects that could be immediately returned
   */
  requestTiles(
    boundingRect: Hgeomath$Rect,
    zoomLevel: number,
...
declare class layer$Layer mixins undefined.util$EventTarget {
   ...
   */
  constructor(opt_options?: Hmaplayerlayer$LayerITileLayer$Options): this;
   ...
   * @returns {Hmaplayerlayer$Layer} - Returns this instance of the layer
   */
  setMin(min: number): Hmaplayerlayer$Layer;
   ...
   * @returns {Hmaplayerlayer$Layer} - Returns this instance of the layer
   */
  setMax(max: number): Hmaplayerlayer$Layer;

  /**
   * This method returns the copyright of the current data provider.
   * @param {Hgeomath$Rect} bounds - the bounding area for which to retrieve the copyright information
   * @param {number} level - the zoom level for which to retrieve the copyright information
   * @returns {Array<Hmapmap$ICopyright>} - a list of copyright information objects for the provided area and zoom level
   */
  getCopyrights(bounds: Hgeomath$Rect, level: number): Hmapmap$ICopyright[];
 ...
 */
declare class layer$MarkerTileLayer
  mixins undefined.layer$BaseTileLayer, undefined.layer$IMarkerLayer {
  /**
   * Constructor
   * @param {Hmapproviderprovider$MarkerTileProvider} provider
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   */
  constructor(
    provider: Hmapproviderprovider$MarkerTileProvider,
    opt_options?: Hmaplayerlayer$ITileLayerITileLayer$Options
  ): this;
 ...
 */
declare class layer$ObjectLayer
  mixins undefined.layer$Layer, undefined.layer$ITileLayer {
  /**
   * Constructor
   * @param {Hmapproviderprovider$ObjectProvider} provider - the ObjectProvider which provides the map objects to this object layer.
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - The options for this layer
   */
  constructor(
    provider:
      | Hmapproviderprovider$ObjectProvider
      | Hclusteringprovider$Provider,
    opt_options?: Hmaplayerlayer$ObjectLayerITileLayer$Options
  ): this;

  /**
   * This method returns current ObjectLayer's data provider
   * @returns {Hmapproviderprovider$ObjectProvider}
   */
  getProvider(): Hmapproviderprovider$ObjectProvider;
   ...
   * @param {Hgeomath$Rect} bounds - The bounding rectangle for which overlays are to be returned
   * @param {number} zoomLevel - The zoom level for which the objects are requested
   * @param {boolean} cacheOnly - Indicates whether only cached objects are to be considered
   * @param {Hmathmath$Point} prioCenter - The priority center as an offset in screen pixel relative to the center
   * @returns {Hmaplayerlayer$ObjectLayerObjectLayer$OverlaysResponse}
   */
  requestOverlays(
    bounds: Hgeomath$Rect,
    zoomLevel: number,
    cacheOnly: boolean,
    prioCenter: Hmathmath$Point
  ): Hmaplayerlayer$ObjectLayerObjectLayer$OverlaysResponse;
 ...
 */
declare class layer$TileLayer
  mixins undefined.layer$BaseTileLayer, undefined.layer$ITileLayer {
  /**
   * Constructor
   * @param {Hmapproviderprovider$TileProvider} provider - data source for the TileLayer
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - additional options
...
declare interface ViewPort$Options {
  margin?: number;
  padding?: Hmapmap$ViewPortViewPort$Padding;
  fixedCenter?: boolean;
}
...
declare interface ViewModel$RequestedData {
  camera?: Hmapmap$ViewModelViewModel$CameraData;
  zoom?: number;
  animate?: boolean;
}
 ...
 * @property defaultPrevented {boolean} - Indicates if preventDefault was called on the current event
 */
declare class ViewModel$UpdateEvent mixins undefined.mapevents$Event {
  /**
   * Constructor
   * @param {Hmapmap$ViewModelViewModel$RequestedData} requested
   */
  constructor(requested: Hmapmap$ViewModelViewModel$RequestedData): this;
...
declare interface SpatialStyle$Options {
  ...
  fillColor?: string;
  lineWidth?: number;
  lineCap?: Hmapmap$SpatialStyleSpatialStyle$LineCap;
  lineJoin?: Hmapmap$SpatialStyleSpatialStyle$LineJoin;
  miterLimit?: number;
  lineDash?: number[];
...
declare interface Spatial$Options {
  style?: Hmapmap$SpatialStyle | Hmapmap$SpatialStyleSpatial$Options;
  arrows?: Hmapmap$ArrowStyle | Hmapmap$ArrowStyleSpatial$Options;
  visibility?: boolean;
  zIndex?: number;
  min?: number;
  max?: number;
  provider?: Hmapproviderprovider$Provider;
  data?: any;
}
/**
...
declare interface Polyline$Options {
  style?: Hmapmap$SpatialStyle | Hmapmap$SpatialStylePolyline$Options;
  arrows?: Hmapmap$ArrowStyle | Hmapmap$ArrowStylePolyline$Options;
  visibility?: boolean;
  zIndex?: number;
  min?: number;
  max?: number;
...
declare class Object$Type {
  ...
  static +DOM_MARKER: Class<Object$Type__DOM_MARKER> &
    Object$Type__DOM_MARKER &
    4; // 4
...
declare interface Icon$Options {
  size?: Hmathmath$ISize | number;
  anchor?: Hmathmath$IPoint;
  hitArea?: Hmapmap$HitArea;
  asCanvas?: Hmapmap$HitArea;
  crossOrigin: boolean;
}
/**
...
declare class HitArea$ShapeType {
  ...
  static +CIRCLE: Class<HitArea$ShapeType__CIRCLE> &
    HitArea$ShapeType__CIRCLE &
    2; // 2
  static +POLYGON: Class<HitArea$ShapeType__POLYGON> &
    HitArea$ShapeType__POLYGON &
    3; // 3
}
...
declare interface Circle$Options {
  style?: Hmapmap$SpatialStyle | Hmapmap$SpatialStyleCircle$Options;
  visibility?: boolean;
  precision?: number;
  zIndex?: number;
  min?: number;
...
declare interface AbstractMarker$Options {
  ...
  zIndex?: number;
  provider?: Hmapproviderprovider$Provider;
  icon?: Hmapmap$Icon | Hmapmap$DomIcon;
  data?: any;
}
/**
...
declare class map$AbstractMarker mixins undefined.map$Object {
  /**
   * Constructor
   * @param {Hgeomath$IPoint} position - The location of this marker
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - The values to initialize this marker
   */
  constructor(
    position: Hgeomath$IPoint,
    opt_options?: Hmapmap$AbstractMarkerAbstractMarker$Options
  ): this;

  /**
   * This method returns this marker's current position.
   * @returns {Hgeomath$Point} - current marker geo position
   */
  getPosition(): Hgeomath$Point;

  /**
   * This method sets the marker's current position.
   * @param {Hgeomath$IPoint} position
   * @returns {Hmapmap$AbstractMarker} - the marker itself
   */
  setPosition(position: Hgeomath$IPoint): Hmapmap$AbstractMarker;

  /**
   * Returns this marker's current icon.
   * @returns {"NO PRINT IMPLEMENTED: JSDocNonNullableType"}
   */
  getIcon(): Hmapmap$Icon | Hmapmap$DomIcon;
   ...
   * @returns {Hmapmap$AbstractMarker} - the marker itself
   */
  setIcon(icon: Hmapmap$Icon | Hmapmap$DomIcon): Hmapmap$AbstractMarker;
...
declare class map$ArrowStyle {
   ...
   */
  constructor(
    opt_options?: Hmapmap$ArrowStyle | Hmapmap$ArrowStyleAbstractMarker$Options
  ): this;

  /**
   * This method checks value-equality with another arrow style.
   * @param {(Hmapmap$ArrowStyle | Hmapmap$ArrowStyleAbstractMarker$Options)} other - the arrow style to compare with
   * @returns {boolean} - true if the arrow styles are value-equal, otherwise false
   */
  equals(
    other: Hmapmap$ArrowStyle | Hmapmap$ArrowStyleAbstractMarker$Options
  ): boolean;
}
...
declare class map$Circle mixins undefined.map$Polygon {
  /**
   * Constructor
   * @param {Hgeomath$IPoint} center - The geographical coordinates of the circle's center
   ...
   */
  constructor(
    center: Hgeomath$IPoint,
    radius: number,
    opt_options?: Hmapmap$CircleAbstractMarker$Options
  ): this;
   ...
   * @param {Hgeomath$IPoint} center
   */
  setCenter(center: Hgeomath$IPoint): void;
   ...
   * @returns {Hgeomath$Point}
   */
  getCenter(): Hgeomath$Point;
...
declare class map$DataModel mixins undefined.util$OList {
   ...
   */
  constructor(opt_layers?: Hmaplayerlayer$Layer[]): this;
}
...
declare class map$DomIcon {
  ...
  constructor(
    ...
    opt_options?: Hmapmap$DomIconAbstractMarker$Options
  ): this;
}
...
declare class map$DomMarker mixins undefined.map$AbstractMarker {
  ...
  constructor(
    position: Hgeomath$IPoint,
    opt_options?: Hmapmap$DomMarkerAbstractMarker$Options
  ): this;
}
...
declare class map$GeoShape mixins undefined.map$Spatial {
   ...
   * @param {Hgeogeo$Strip} strip - The strip describing the shape of the spatial object
   * @param {Hmapmap$SpatialAbstractMarker$Options} options - The options to apply
   */
  constructor(
    isClosed: boolean,
    strip: Hgeogeo$Strip,
    options: Hmapmap$SpatialAbstractMarker$Options
  ): this;

  /**
   * This method returns the strip which represents the shape of the spatial object.
   * @returns {Hgeogeo$Strip} - the strip
   */
  getStrip(): Hgeogeo$Strip;
   ...
   * @returns {Hmapmap$GeoShape} - the Spatial instance itself
   */
  setStrip(strip: Hgeogeo$Strip): Hmapmap$GeoShape;
   ...
   * @returns {Hgeomath$Rect}
   */
  getBounds(): Hgeomath$Rect;
}
...
declare class map$Group mixins undefined.map$Object {
   ...
   */
  constructor(opt_options?: Hmapmap$GroupAbstractMarker$Options): this;
   ...
   */
  forEach(
    callback: (object: Hmapmap$Object, n: number, group: Hmapmap$Group) => void,
   ...
   * @returns {"NO PRINT IMPLEMENTED: JSDocNonNullableType"}
   */
  getObjects(opt_recursive?: boolean): Hmapmap$Object[];
   ...
   * @returns {Hgeomath$Rect} - geo ractangle that covers all objects in the group
   */
  getBounds(): Hgeomath$Rect;
...
declare class map$HitArea {
  /**
   * Constructor
   * @param {Hmapmap$HitAreaHitArea$ShapeType} shapeType - The shape type of the HitArea
   ...
   */
  constructor(
    shapeType: Hmapmap$HitAreaHitArea$ShapeType,
    opt_values?: number[]
  ): this;
}
...
declare interface map$IControl {
   ...
   */
  startControl(
    opt_kinetics?: Hutilkineticskinetics$IKinetics,
    opt_atX?: number,
    opt_atY?: number
  ): void;
 ...
 */
  endControl(
    ...
    opt_adjustView?: (data: Hmapmap$ViewModelViewModel$CameraData) => void
  ): void;
}
...
declare class map$Icon {
  ...
  constructor(
    ...
    opt_options?: Hmapmap$IconAbstractMarker$Options
  ): this;

  /**
   * Returns the icon's bitmap loading state
   * @returns {Hmapmap$IconprototypeIcon$State}
   */
  getState(): Hmapmap$IconIcon$State;
...
declare class map$Imprint {
  /**
   * Constructor
   * @param {HH$Map} map - The map where the imprint is attached to
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - The options to style the imprint
   */
  constructor(
    map: HH$Map,
    opt_options?: Hmapmap$ImprintAbstractMarker$Options
  ): this;
   ...
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - The options to style the imprint
   */
  setOptions(opt_options?: Hmapmap$ImprintAbstractMarker$Options): void;
...
declare class map$Marker mixins undefined.map$AbstractMarker {
  ...
  constructor(
    position: Hgeomath$IPoint,
    opt_options?: Hmapmap$MarkerAbstractMarker$Options
  ): this;
}
...
declare class map$Object mixins undefined.util$EventTarget {
   ...
   */
  constructor(opt_options?: Hmapmap$ObjectAbstractMarker$Options): this;
   ...
   * @returns {Hmapmap$Object} - returns this object
   */
  setVisibility(opt_visibility?: boolean): Hmapmap$Object;
   ...
   * @returns {Hmapmap$Object} - returns this object
   */
  setZIndex(zIndex?: number): Hmapmap$Object;

  /**
   * Compares two objects regarding their z-order, useful to sort a list of objects via Array's sort() method
   * @param {Hmapmap$Object} first - The first object to compare
   * @param {Hmapmap$Object} second - The second object to compare
   ...
   * @returns {Hmapproviderprovider$Invalidations} - an invalidation object
   */
  getInvalidations(): Hmapproviderprovider$Invalidations;
   ...
   */
  invalidate(flags: Hmathmath$BitMask): boolean;
   ...
   * @param {"NO PRINT IMPLEMENTED: JSDocAllType"} data - the data to be stored
   * @returns {Hmapmap$Object} - returns this map object instance
   */
  setData(data: any): Hmapmap$Object;
...
declare class map$Overlay mixins undefined.map$Object {
  /**
   * Constructor
   * @param {Hgeomath$Rect} bounds - The geographical reactangular area of this overlay
   * @param {"NO PRINT IMPLEMENTED: JSDocNonNullableType"} bitmap - Either an image URL, a SVG markup, an image or a canvas.
  ...
  constructor(
    bounds: Hgeomath$Rect,
    bitmap: string | HTMLImageElement | HTMLCanvasElement,
    opt_options?: Hmapmap$OverlayAbstractMarker$Options
  ): this;
   ...
   * @param {Hgeomath$Rect} bounds
   * @returns {Hmapmap$Overlay} - the overlay itself
   */
  setBounds(bounds: Hgeomath$Rect): Hmapmap$Overlay;
   ...
   * @returns {Hmapmap$Overlay} - the overlay itself
   */
  setOpacity(opacity: number): Hmapmap$Overlay;
}
...
declare class map$Polygon mixins undefined.map$GeoShape {
  /**
   * Constructor
   * @param {Hgeogeo$Strip} strip - the strip describing this polygon's vertices
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - optional initialization parameters
   */
  constructor(
    strip: Hgeogeo$Strip,
    opt_options?: Hmapmap$SpatialAbstractMarker$Options
  ): this;
   ...
   * @returns {Hmapmap$Polygon} - the Polygon instance itself
   */
  setNorthPoleCovering(flag: boolean): Hmapmap$Polygon;
...
declare class map$Polyline mixins undefined.map$GeoShape {
  /**
   * Constructor
   * @param {Hgeogeo$Strip | Hgeogeo$LineString | Hgeogeo$MultiLineString} geometry - The geometry that defines the line segments of the polyline
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - optional initialization parameters
   */
  constructor(
    geometry: Hgeogeo$Strip | Hgeogeo$LineString | Hgeogeo$MultiLineString,
    opt_options?: Hmapmap$PolylineAbstractMarker$Options
  ): this;
   ...
   * @param {Hgeogeo$LineString | Hgeogeo$MultiLineString} geometry - the geometry to set.
   * @return {Hmapmap$Polyline} - The polyline instance itself.
   */
  setGeometry(
    geometry: Hgeogeo$LineString | Hgeogeo$MultiLineString
  ): Hmapmap$Polyline;
   ...
   * @return {Hgeogeo$LineString | Hgeogeo$MultiLineString}
   */
  getGeometry(): Hgeogeo$LineString | Hgeogeo$MultiLineString;

  /**
 * Clips the geometry of the Polyline to a rectangular area
 * @param {Hgeomath$Rect} geoRect - The rectangle to clip against.
 ...
 */
  clip(geoRect: Hgeomath$Rect): number[][];

  /**
   * Returns the geometry.
   * @deprecated since 3.0.15.0
   * @return {Hgeogeo$Strip} - spatial object.
   */
  getStrip(): Hgeogeo$Strip;
   ...
   * Sets the geometry.
   * @deprecated since 3.0.15.0
   * @param {Hgeogeo$Strip} strip - The strip which represents geometry.
   * @return {Hmapmap$GeoShape} - The given spatial object
   */
  setStrip(strip: Hgeogeo$Strip): Hmapmap$GeoShape;

  /**
   * Returns the smallest rectangle which encloses the whole geometry of the GeoShape.
   * @return {Hgeomath$Rect}
   */
  getBounds(): Hgeomath$Rect;
   ...
   * @return {Hmapmap$SpatialStyle} - The given spatial object
   */
  getStyle(): Hmapmap$SpatialStyle;
   ...
   * @return {Hmapmap$Spatial} - The given spatial object
   */
  setStyle(
    opt_style?:
      | Hmapmap$SpatialStyle
      | Hmapmap$SpatialStyleAbstractMarker$Options
  ): Hmapmap$Spatial;
   ...
   * @return {Hmapmap$ArrowStyle} - An object encapsulating information about the arrow style or undefined if the arrow style is not defined.
   */
  getArrows(): Hmapmap$ArrowStyle | void;
   ...
   */
  setArrows(
    opt_arrows?: Hmapmap$ArrowStyle | Hmapmap$ArrowStyleAbstractMarker$Options
  ): Hmapmap$Spatial;
   ...
   * @return {Hmapmap$Object} - The given object
   */
  setVisibility(opt_visibility?: boolean): Hmapmap$Object;
   ...
   * @return {Hmapmap$Object} - The given object
   */
  setZIndex(zIndex: number | void): Hmapmap$Object;
 ...
 * @param {Hmapmap$Object} other -The map object with which to compare the given object.
 ...
 */
  compareZOrder(other: Hmapmap$Object): number;
   ...
   * @return {Hmapmap$Group} - An object representing the containing group object or null if the given object is not contained in any group.
   */
  getParentGroup(): Hmapmap$Group;

  /**
   * The root object to which the given object is attached or the object itself if it is not attached to another.
   * @return {Hmapmap$Object} - An object representing the root group for the given object or the given object if it is not part of a group.
   */
  getRootGroup(): Hmapmap$Object;
   ...
   * @return {Hmapproviderprovider$ObjectProvider} - An object representing the provider
   */
  getProvider(): Hmapproviderprovider$ObjectProvider;

  /**
   * This method retrieves the invalidation states for the given object.
   * @return {Hmapproviderprovider$Invalidations} - An object containing the invalidation states
   */
  getInvalidations(): Hmapproviderprovider$Invalidations;

  /**
   * This method invalidates the given map object.
   * @param {Hmathmath$BitMask} flags - The flags indicating the types of changes to the given object
   ...
   * @return {Hmapmap$Object} - The given map object
   */
  setData(data: any): Hmapmap$Object;
...
declare class map$Rect mixins undefined.map$Polygon {
  /**
   * Constructor
   * @param {Hgeomap$Rect} bounds - The geographical bounding box for this rectangle
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   */
  constructor(
    bounds: Hgeomap$Rect,
   ...
   * @param {Hgeomap$Rect} bounds
   */
  setBounds(bounds: Hgeomap$Rect): void;
}
...
declare class map$Spatial mixins undefined.map$Object {
   ...
   * @returns {Hmapmap$Spatial} - the Spatial instance itself
   */
  setStyle(
    opt_style?:
      | Hmapmap$SpatialStyle
   ...
   * inconsistancies!
   * @returns {(Hmapmap$ArrowStyle | void)}
   */
  getArrows(): Hmapmap$ArrowStyle | void;
...
declare class map$SpatialStyle {
   ...
   * @param {(Hmapmap$SpatialStyle | Hmapmap$SpatialStyleAbstractMarker$Options)} other - the style to compare with
   * @returns {boolean} - true if the styles are value-equal, otherwise false
   */
  equals(
    other: Hmapmap$SpatialStyle | Hmapmap$SpatialStyleAbstractMarker$Options
  ): boolean;
   ...
   */
  getCopy(
    opt_attributes?: Hmapmap$SpatialStyleAbstractMarker$Options
  ): Hmapmap$SpatialStyle;
  strokeColor: string;
  fillColor: string;
  lineWidth: number;
  ...
  static DEFAULT_STYLE: Hmapmap$SpatialStyle;
}
 ...
 */
declare class map$ViewModel
  mixins undefined.util$EventTarget, undefined.map$IControl {
  /**
   * This method returns the camera data, which is currently rendered.
   * @returns {Hmapmap$ViewModelViewModel$CameraData} - the current rendered camera data
   */
  getCameraData(): Hmapmap$ViewModelViewModel$CameraData;

  /**
   * This method sets new camera data to be processed by the renderer.
   * @param {Hmapmap$ViewModelViewModel$CameraData} data - the values to be modified
   * @returns {Hmapmap$ViewModel} - this view model object
   */
  setCameraData(data: Hmapmap$ViewModelViewModel$CameraData): Hmapmap$ViewModel;
   ...
   * @returns {Hmapmap$ViewModelViewModel$CameraData} - last requested cam/view data
   */
  getRequestedCameraData(): Hmapmap$ViewModelViewModel$CameraData;
 ...
 */
declare class map$ViewPort
  mixins undefined.util$EventTarget, undefined.map$IInteraction {
  /**
   * Constructor
  ...
  constructor(
    ...
    opt_options?: Hmapmap$ViewPortAbstractMarker$Options
  ): this;
...
declare class geo$AbstractGeometry {
   ...
   * @return {Hgeomap$Rect} - the bounding rectangle of the geometry or null if the bounding rectangle can't be computed (e.g. for a geometry without coordinates)
   */
  getBounds(): Hgeomap$Rect;
...
declare class geo$AltitudeContext {
  constructor(...args: empty): mixed;
  static +undefined: Class<geo$AltitudeContext__undefined> &
    geo$AltitudeContext__undefined &
    0; // 0
...
declare interface geo$IPoint {
  lat: Hgeogeo$Latitude;
  lng: geo$Longitude;
  alt?: Hgeogeo$Altitude;
  ctx?: Hgeogeo$AltitudeContext;
}
...
declare interface geo$IProjection {
  latLngToPoint(
    lat: number,
    lng: number,
    opt_out?: Hmathmath$Point
  ): Hmathmath$Point;
  xyToGeo(x: number, y: number, opt_out?: Hgeomath$Point): Hgeomath$Point;
  pointToGeo(point: Hmathgeo$IPoint, opt_out?: Hgeomath$Point): Hgeomath$Point;
  geoToPoint(
    geoPoint: Hgeogeo$IPoint,
    opt_out?: Hmathmath$Point
  ): Hmathmath$Point;
}
...
declare class geo$LineString {
   ...
   * @param {Hgeogeo$Latitude} lat - the latitude to insert
   * @param {Hgeogeo$Longitude} lng - the longitude to insert
   * @param {Hgeogeo$Altitude} alt - the altitude to insert
   */
  insertLatLngAlt(
    index: number,
    lat: Hgeogeo$Latitude,
   ...
   * @param {Hgeogeo$IPoint} geoPoint
   */
  insertPoint(pointIndex: number, geoPoint: Hgeogeo$IPoint): void;
   ...
   * @return {Hgeomath$Point} - Returns either the 'opt_out' point object or a new point object.
   */
  extractPoint(pointIndex: number, opt_out?: Hgeomath$Point): Hgeomath$Point;
   ...
   * @param {Hgeogeo$Longitude} lng1 - The start longitude of the leg
   * @param {Hgeogeo$Longitude} lng2 - The end longitude of the leg
   * @return {boolean}
   */
  static isDBC(lng1: Hgeogeo$Longitude, lng2: Hgeogeo$Longitude): boolean;
 ...
 */
   ...
   * @return {Hgeomap$Rect} - This LineString's bounding rectangle
   */
  getBounds(): Hgeomap$Rect;
   ...
   * @return {Hgeogeo$LineString} - The LineString containing the lat, lng values
   * @throws {H.lang.InvalidArgumentError} - throws an error in case the latLngs array has an odd length
   */
  static fromLatLngArray(latLngs: number[]): Hgeogeo$LineString;
...
declare class geo$MultiLineString
  mixins undefined.geo$MultiGeometry<Hgeogeo$LineString> {
  /**
   ...
   * @param {Hgeogeo$LineString[]} lineStrings - The list of line-strings which are initially represented by the MultiLineString.
   * @throws {H.lang.InvalidArgumentError} - if the lineStrings argument is not valid
   */
  constructor(lineStrings: Hgeogeo$LineString[]): this;
   ...
   * @return {Hgeogeo$LineString[]} - the removed geometries
   */
  splice(
    index: number,
    opt_deleteCount?: number,
    opt_items?: Hgeogeo$LineString[]
  ): Hgeogeo$LineString[];

  /**
   * Removes a contained geometry at the given index.
   * @param {number} index - The index of the geometry to remove.
   * @return {Hgeogeo$LineString} - the removed geometry.
   * @throws {H.lang.OutOfRangeError} - if no geometry exists at the given index.
   */
  removeAt(index: number): Hgeogeo$LineString;

  /**
   * Removes the specified geometry from the multi-geometry
   * @param {Hgeogeo$LineString} geometry -The geometry (by reference) to remove from this multi-geometry
   * @return {Hgeogeo$LineString} -the removed geometry or null if the geometry was not found
   */
  remove(geometry: Hgeogeo$LineString): Hgeogeo$LineString;

  /**
   * Returns the aggregated geometries of the multi-geometry. The returned geometries must be treated as read-only to not violate the integrity of the multi-geometry.
   * @return {Hgeogeo$LineString[]} - An array of geometries
   */
  getGeometries(): Hgeogeo$LineString[];

  /**
   * Adds the specified geometry to the current multi-geometry.
   * @param {Hgeogeo$LineString} geometry - A geometry which will be added to the current multi-geometry
   * @throws {H.lang.InvalidArgumentError} - in case of invalid geometry argument
   */
  push(geometry: Hgeogeo$LineString): void;
...
declare class geo$PixelProjection {
   ...
   */
  constructor(
    opt_projection?: Hgeogeo$IProjection,
   ...
   * @param {Hgeogeo$IPoint} geoPoint - An object containing the geographic coordinates
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_out - An optional point to store the result
   * @return {Hmathgeo$IPoint} - An object representing the results of the the conversion to pixel coordinates
   */
  geoToPixel(
    geoPoint: Hgeogeo$IPoint,
    opt_out?: Hmathgeo$IPoint
  ): Hmathgeo$IPoint;

  /**
   * This method translates a point defined in terms of its pixel coordinates to a location defined in geographic coordinates.
   * @param {Hmathgeo$IPoint} point - An object defining a location on the screen in terms of pixel coordinates
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_out - An optional point to store the result
   * @return {Hgeogeo$IPoint} - An object representing the results of conversion to a geographic location
   */
  pixelToGeo(point: Hmathgeo$IPoint, opt_out?: Hgeogeo$IPoint): Hgeogeo$IPoint;
   ...
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_out - An optional point to store the result
   * @return {Hgeomath$Point} - An object representing the results of the conversion to a geographic location
   */
  xyToGeo(x: number, y: number, opt_out?: Hgeomath$Point): Hgeomath$Point;
   ...
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_out - An optional point to store the result
   * @return {Hmathmath$Point} - The results of the conversion as a point object containing x and y coordinates (in pixels)
   */
  latLngToPixel(
    latitude: number,
    longitude: number,
   ...
   * @param {Hmathgeo$IPoint} point - An object representing the map point to convert
   * @return {Hmathmath$Point} - The result of the conversion as an object containing pixel coordinate
   */
  pointToPixel(point: Hmathgeo$IPoint): Hmathmath$Point;
}
...
declare class geo$Point mixins geo$IPoint {
   ...
   * @returns {Hgeogeo$Point} - The calculated point
   */
  walk(
    bearing: number,
    distance: number,
   ...
   * @param {Hgeogeo$IPoint} point - The point to validate
  ...
  /**
   * This method creates a Point instance from a given IPoint object.
   * @param {Hgeogeo$IPoint} iPoint - The IPoint object to use
   * @returns {Hgeogeo$Point} - the created Point instance
   */
...
declare class geo$Rect {
  /**
   * Constructor
   * @param {Hgeogeo$Latitude} top - the northern-most latitude
   * @param {Hgeogeo$Longitude} left - the left-most longitude
   * @param {Hgeogeo$Latitude} bottom - the southern-most latitude
   * @param {Hgeogeo$Longitude} right - the right-most latitude
   */
  constructor(
    top: Hgeogeo$Latitude,
    left: Hgeogeo$Longitude,
    bottom: Hgeogeo$Latitude,
    right: Hgeogeo$Longitude
  ): this;

  /**
   * To compare this rectangle with a supplied other rectangle for equality.
   * @param {Hgeogeo$Rect} other
   * @returns {boolean} - Whether the two rectangles are equal.
   */
  equals(other: Hgeogeo$Rect): boolean;

  /**
   * Toclone this rectangle.
   * @returns {Hgeogeo$Rect}
   */
  clone(): Hgeogeo$Rect;

  /**
   * This method returns the top-left corner of the rectangular area.
   * @returns {Hgeogeo$Point} - the top-left corner of the area
   */
  getTopLeft(): Hgeogeo$Point;

  /**
   * This method returns the bottom-right corner of the rectangular area.
   * @returns {Hgeogeo$Point} - the bottom-right corner of the area
   */
  getBottomRight(): Hgeogeo$Point;

  /**
   * This method returns the north-most latitude of this rectangular area
   * @returns {Hgeogeo$Latitude} - the north-most latitude of the area
   */
  getTop(): Hgeogeo$Latitude;

  /**
   * This method returns the south-most latitude of this rectangular area
   * @returns {Hgeogeo$Latitude} - the south-most latitude of the area
   */
  getBottom(): Hgeogeo$Latitude;

  /**
   * This method returns the left-most longitude of this rectangular area
   * @returns {Hgeogeo$Longitude} - the left-most longitude of the area
   */
  getLeft(): Hgeogeo$Longitude;

  /**
   * This method returns the right-most longitude of this rectangular area
   * @returns {Hgeogeo$Longitude} - the right-most longitude of the area
   */
  getRight(): Hgeogeo$Longitude;

  /**
   * This method returns the center point of this rectangular area
   * @returns {Hgeogeo$Point} - the center point of the area
   */
  getCenter(): Hgeogeo$Point;
   ...
   * @param {Hgeogeo$Latitude} lat - the latitude
   * @param {Hgeogeo$Longitude} lng - the longitude
   ...
   * @param {Hgeogeo$IPoint} geoPoint - the point
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_skipValidation - a boolean flag indicating whether to check validity of the arguments
   ...
   * @param {Hgeogeo$Rect} geoRect - the rectangular area
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_skipValidation - a boolean flag indicating whether to check validity of the arguments
   * @returns {boolean} - true if the rectangular area is contained in this area, otherwise false
   */
  containsRect(geoRect: Hgeogeo$Rect, opt_skipValidation?: boolean): boolean;
   ...
   * @returns {Hgeogeo$Rect} - either the rectangular area passed as out parameter or a new rectangular area
   */
  mergeLatLng(
    lat: Hgeogeo$Latitude,
    lng: Hgeogeo$Longitude,
    opt_skipValidation?: boolean,
    opt_out?: Hgeogeo$Rect
  ): Hgeogeo$Rect;

  /**
   * This method returns the smallest bounding box that covers this rectangular area and the point supplied by the caller.
   * @param {Hgeogeo$IPoint} geoPoint - the point to merge
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_skipValidation - a boolean flag indicating whether to check validity of the arguments
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_out - an optional rectangular area to store the result
   * @returns {Hgeogeo$Rect} - either the rectangular area passed as out parameter or a new rectangular area
   */
   ...
   * @param {Hgeogeo$Rect} geoRect - the point to merge
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_skipValidation - a boolean flag indicating whether to check validity of the arguments
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_out - an optional rectangular area to store the result
   * @returns {Hgeogeo$Rect} - either the rectangular area passed as out parameter or a new rectangular area
   */
  mergeRect(
    geoRect: Hgeogeo$Rect,
    opt_skipValidation?: boolean,
    opt_out?: Hgeogeo$Rect
  ): Hgeogeo$Rect;
  ...
  /**
   * This method returns the smallest bounding box that covers this rectangular area and the rectangular area supplied by the caller.
   * @param {Hgeogeo$Latitude} top - The top latitude of the rectangle to merge
   * @param {Hgeogeo$Longitude} left - The left longitude of the rectangle to merge
   * @param {Hgeogeo$Latitude} bottom - The bottom latitude of the rectangle to merge
   * @param {Hgeogeo$Longitude} right - The right longitude of the rectangle to merge
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_skipValidation - a boolean flag indicating whether to check validity of the arguments
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_out - an optional rectangular area to store the result
   * @returns {Hgeogeo$Rect} - either the rectangular area passed as out parameter or a new rectangular area
   */
   ...
   * @param {Hgeogeo$Rect} geoRect - a rectangular area to be tested for intersection with this rectangular area
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_skipValidation - a boolean flag indicating whether to check validity of the arguments
   * @returns {boolean} - a boolean value indicating whether the two areas intersect
   */
  intersects(geoRect: Hgeogeo$Rect, opt_skipValidation?: boolean): boolean;
   ...
   * @param {Hgeogeo$Latitude} topA - the northern-most latitude
   * @param {Hgeogeo$Longitude} leftA - the left-most longitude of operand A
   * @param {Hgeogeo$Latitude} bottomA - the southern-most latitude of operand A
   * @param {Hgeogeo$Longitude} rightA - the right-most latitude of operand A
   * @param {Hgeogeo$Latitude} topB - the northern-most latitude of operand B
   * @param {Hgeogeo$Longitude} leftB - the left-most longitude of operand B
   * @param {Hgeogeo$Latitude} bottomB - the southern-most latitude of operand B
   * @param {Hgeogeo$Longitude} rightB - the right-most latitude of operand B
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_out - an optional rect to store the results
   * @returns {Hgeogeo$Rect} - either the opt_out rect or a new rect
   */
  static merge(
    topA: Hgeogeo$Latitude,
    leftA: Hgeogeo$Longitude,
    bottomA: Hgeogeo$Latitude,
    rightA: Hgeogeo$Longitude,
    topB: Hgeogeo$Latitude,
    leftB: Hgeogeo$Longitude,
    bottomB: Hgeogeo$Latitude,
    rightB: Hgeogeo$Longitude,
    opt_out?: Hgeogeo$Rect
  ): Hgeogeo$Rect;

  /**
   * This method creates a rectangular area from a top-left and bottom-right point pair.
   * @param {Hgeogeo$IPoint} topLeft - the top-left corner of the area
   * @param {Hgeogeo$IPoint} bottomRight - the bottom-right corner of the area
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_skipValidation - a boolean flag indicating whether to check validity of the arguments
   * @returns {Hgeogeo$Rect} - returns the rectangular area defined by the top-left and bottom-right corners
   */
  static fromPoints(
    topLeft: Hgeogeo$IPoint,
    bottomRight: Hgeogeo$IPoint,
    opt_skipValidation?: boolean
  ): Hgeogeo$Rect;

  /**
   * This method creates the minimum rectangular area covering all of the points in the argument array.
   * @param {Array<Hgeogeo$IPoint>} pointArray - the array of points to cover
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_skipValidation - a boolean flag indicating whether to check validity of the arguments
   * @returns {Hgeogeo$Rect} - returns the minimum rectangular area covering the points or null if no point is covered
   */
  static coverPoints(
    pointArray: Hgeogeo$IPoint[],
    opt_skipValidation?: boolean
  ): Hgeogeo$Rect;
   ...
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_skipValidation - a boolean flag indicating whether to check validity of the arguments
   * @returns {(Hgeogeo$Rect | void)} - returns the minimum rectangular area covering the coordinates
   */
   ...
   * @param {Array<Hgeogeo$Rect>} rectArray - the array of points to cover
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_skipValidation - a boolean flag indicating whether to check validity of the arguments
   * @returns {(Hgeogeo$Rect | void)} - returns the minimum rectangular area covering the rectangular areas
   */
  static coverRects(
    rectArray: Hgeogeo$Rect[],
    opt_skipValidation?: boolean
  ): Hgeogeo$Rect | void;
   ...
   * @param {Hgeogeo$IPoint} center - a point which is to be the center of the resized rectangular area
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_out - an optional rectangular area to store the result
   * @returns {Hgeogeo$Rect} - the resized rectangular area
   */
  resizeToCenter(center: Hgeogeo$IPoint, opt_out?: Hgeogeo$Rect): Hgeogeo$Rect;
}
...
declare class geo$Strip {
   ...
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_out - an optional point object to store the lat, lng, alt values
   * @returns {Hgeogeo$Point} - returns either the 'opt_out' point object or a new point object.
   */
  extractPoint(pointIndex: number, opt_out?: Hgeogeo$Point): Hgeogeo$Point;
   ...
   * @returns {Hgeogeo$Strip} - the strip containing the lat, lng values
   */
  static fromLatLngArray(latLngs: number[]): Hgeogeo$Strip;
}
/**
...
declare class AbstractReader$Event mixins undefined.AbstractReader$Event {
  /**
   * Constructor
   * @param {(Hdatadata$AbstractReader | Hmapmap$Object)} target - The target that's passed to event listeners
   * @param {string} type - The type of the event
   * @param {Hdatadata$AbstractReaderIcon$State} state - The state of the target firing an event
   * @param {string} message - The message associated with an event
   */
  constructor(
    target: Hdatadata$AbstractReader | Hmapmap$Object,
    type: string,
    state: Hdatadata$AbstractReaderIcon$State,
    message: string
  ): this;
}
...
declare class AbstractReader$State {
  constructor(...args: empty): mixed;
  static +ERROR: Class<AbstractReader$State__ERROR> &
    AbstractReader$State__ERROR &
    0; // 0
  static +LOADING: Class<AbstractReader$State__LOADING> &
    AbstractReader$State__LOADING &
    1; // 1
  static +VISIT: Class<AbstractReader$State__VISIT> &
    AbstractReader$State__VISIT &
    2; // 2
  static +READY: Class<AbstractReader$State__READY> &
    AbstractReader$State__READY &
    3; // 3
}
...
declare class data$AbstractReader mixins undefined.util$EventTarget {
   ...
   * @returns {Hmaplayerlayer$ObjectLayer}
   */
  getLayer(): Hmaplayerlayer$ObjectLayer;
   ...
   * @returns {Array<Hmapmap$Object>}
   */
  getParsedObjects(): Hmapmap$Object[];
   ...
   * @returns {Hdatadata$AbstractReader}
   */
  setUrl(url: string): Hdatadata$AbstractReader;

  /**
   * Returns the reader's processing state for possible states see H.data.AbstractReader.State
   * @returns {Hdatadata$AbstractReaderAbstractReader$State}
   */
  getState(): Hdatadata$AbstractReaderAbstractReader$State;
 ...
 */
declare class clustering$DataPoint mixins undefined.geo$IPoint {
  /**
   * Constructor
   * @param {Hgeogeo$Latitude} lat - The latitude coordinate of the data point's position
   * @param {Hgeogeo$Longitude} lng - The longitude coordinate of the data point's position
...
declare interface clustering$ICluster {
   ...
   */
  forEachEntry(callback: (result: Hclusteringclustering$IResult) => void): void;
   ...
   */
  forEachDataPoint(
    callback: (noise: Hclusteringclustering$INoisePoint) => void
  ): void;

  /**
   * Returns the geographical position of this cluster result.
   * @returns {Hgeogeo$Point}
   */
  getPosition(): Hgeogeo$Point;
...
declare interface clustering$ITheme {
   ...
   * @param {Hclusteringclustering$ICluster} cluster
   * @returns {Hmapmap$Object}
   */
  getClusterPresentation(
    cluster: Hclusteringclustering$ICluster
  ): Hmapmap$Object;

  /**
   * Function returns noise point presentation as a map object
   * @param {Hclusteringclustering$INoisePoint} noisePoint
   * @returns {Hmapmap$Object}
   */
  getNoisePresentation(
    noisePoint: Hclusteringclustering$INoisePoint
  ): Hmapmap$Object;
}
...
declare class clustering$Provider mixins undefined.util$EventTarget {
  /**
   * Constructor
   * @param {Array<Hclusteringclustering$DataPoint>} dataPoints
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options
   */
  constructor(
    dataPoints: Hclusteringclustering$DataPoint[],
    opt_options?: Hclusteringclustering$ProviderAbstractMarker$Options
  ): this;

  /**
   * This method will dispatch event on the event target object
   * @param {(HutilAbstractReader$Event | string)} evt - event object or event name
   */
  dispatchEvent(evt: HutilAbstractReader$Event | string): void;
   ...
   * @param {Array<Hclusteringclustering$DataPoint>} dataPoints
   */
  setDataPoints(dataPoints: Hclusteringclustering$DataPoint[]): void;

  /**
   * This method adds a data point to the provider. Beware that this method provokes reclustering of the whole data set.
   * @param {Hclusteringclustering$DataPoint} dataPoint
   */
  addDataPoint(dataPoint: Hclusteringclustering$DataPoint): void;
   ...
   * @param {Array<Hclusteringclustering$DataPoint>} dataPoints
   */
  addDataPoints(dataPoints: Hclusteringclustering$DataPoint[]): void;

  /**
   * This method removes a data point from the provider. Beware that this method provokes reclustering of the whole data set.
   * @param {Hclusteringclustering$DataPoint} dataPoint
   */
  removeDataPoint(dataPoint: Hclusteringclustering$DataPoint): void;

  /**
   * This method returns current theme used for creating cluster visualization
   * @returns {Hclusteringclustering$ITheme}
   */
  getTheme(): Hclusteringclustering$ITheme;
   ...
   * @param {Hclusteringclustering$ITheme} theme
   */
  setTheme(theme: Hclusteringclustering$ITheme): void;
   ...
   * @param {Hgeogeo$Rect} bounds - A rectangular area in geo space to intersect with
   * @param {number} zoomLevel - The zoom level for which the objects are requested
   * @param {boolean} visiblesOnly - Indicates whether only invisible objects are to be considered
   * @param {boolean} cacheOnly - Indicates whether only cached objects are to be considered
   * @returns {Array<Hmapmap$DomMarker>} - a list of intersecting objects
  ...
  /**
   * Returns the accumulate invalidations of this provider's objects that have occurred.
   * @returns {Hmapproviderprovider$Invalidations} - an invalidations object
   */
  getInvalidations(): Hmapproviderprovider$Invalidations;
...
declare class Map$EngineType {
  ...
  static +PANORAMA: Class<Map$EngineType__PANORAMA> &
    Map$EngineType__PANORAMA &
    1; // 1
}
...
declare interface Map$Options {
  center?: Hgeogeo$IPoint;
  zoom?: number;
  bounds?: Hgeogeo$Rect;
  layers?: Hmaplayerlayer$Layer[];
  engineType?: Map$EngineType;
  pixelRatio?: number;
  imprint?: Hmapmap$ImprintMap$Options;
...
declare class H$Map mixins undefined.util$EventTarget {
   ...
   * @param {Hmaplayerlayer$Layer} baseLayer - The layer to be used as the base (bottom most) layer.
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_options - additional map options
   */
  constructor(
    element: base$Element,
    baseLayer: Hmaplayerlayer$Layer,
    opt_options?: HH$MapMap$Options
  ): this;
   ...
   * @param {Hgeogeo$IPoint} center - requested center to be set
   ...
   * @returns {HH$Map} - the instance itself
   */
  setCenter(center: Hgeogeo$IPoint, opt_animate?: boolean): HH$Map;
   ...
   * @returns {HH$Map} - the instance itself
   */
  setZoom(zoom: number, opt_animate?: boolean): HH$Map;
   ...
   * @param {Hgeogeo$Rect} boundingRect - view bound which should be shown on map
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_animate - parameter indicates if animated transition should be applied, default is false
   * @returns {HH$Map} - the instance itself
   */
  setViewBounds(boundingRect: Hgeogeo$Rect, opt_animate?: boolean): HH$Map;
   ...
   * @returns {Hgeogeo$Rect}
   */
  getViewBounds(): Hgeogeo$Rect;

  /**
   * Calculates the best CameraModel to show the provided bounding rectangle
   * @param {Hgeogeo$Rect} rect - The geographical bounding rectangle to use
   * @returns {Hmapmap$ViewModelViewModel$CameraData} - The result, represented by the properties zoom (number) and position (geo.Point)
   */
  getCameraDataForBounds(
    rect: Hgeogeo$Rect
  ): Hmapmap$ViewModelViewModel$CameraData;
  ...
  capture(
    callback?: (canvas: HTMLCanvasElement) => void,
    opt_capturables?: Hutilutil$ICapturable[],
    opt_x1?: number,
    opt_y1?: number,
    opt_x2?: number,
    opt_y2?: number
   ...
   * @param {HH$MapMap$EngineType} type
   * @returns {HH$Map} - the map itself
   */
  setEngineType(type: HH$MapMap$EngineType): HH$Map;
   ...
   * @returns {Hutilutil$Request} - A handle to the created storage request
   */
  storeContent(
    opt_onprogress?: (req: Hutilutil$Request) => void,
    opt_bounds?: Hgeogeo$Rect,
    opt_min?: number,
    opt_max?: number,
    opt_layer?: Hmaplayerlayer$BaseTileLayer
  ): Hutilutil$Request;
   ...
   * @returns {Hutilutil$Request} - A handle to the created flush request
   */
  clearContent(
    opt_onprogress?: (req: Hutilutil$Request) => void
  ): Hutilutil$Request;
   ...
   * @param {Hmaplayerlayer$Layer} layer - The map layer to be added
   * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_idx - index at which the new layer should be inserted
   * @returns {HH$Map} - current map instance
   */
  addLayer(layer: Hmaplayerlayer$Layer, opt_idx?: number): HH$Map;

  /**
   * This method removes layer from the map.
   * @param {Hmaplayerlayer$Layer} layer - The map layer to be removed
   * @returns {HH$Map} - current map instance
   */
  removeLayer(layer: Hmaplayerlayer$Layer): HH$Map;

  /**
   * This method will set provided layer as base map. The layer will be inserted as the bottom most layer in the map.
   * @param {Hmaplayerlayer$Layer} layer - The layer to use as base map
   * @returns {HH$Map} - the instance itself
   */
  setBaseLayer(layer: Hmaplayerlayer$Layer): HH$Map;

  /**
   * To get the current base map layer.
   * @returns {"NO PRINT IMPLEMENTED: JSDocNullableType"}
   */
  getBaseLayer(): Hmaplayerlayer$Layer;
   ...
   * @param {Hgeogeo$IPoint} geoPoint - point on the map
   * @returns {"NO PRINT IMPLEMENTED: JSDocNullableType"}
   */
  geoToScreen(geoPoint: Hgeogeo$IPoint): Hmathgeo$Point;
   ...
   * @returns {"NO PRINT IMPLEMENTED: JSDocNullableType"}
   */
  screenToGeo(x: number, y: number): Hgeogeo$Point;
   ...
   * @param {number} x - map viewport x-axis pixel coordinate
   * @param {number} y - map viewport y-axis pixel coordinate
   * @returns {Hmapmap$ViewModelViewModel$CameraData}
   */
  screenToCameraData(
    x: number,
    y: number
   ...
   */
  addObject(mapObject: Hmapmap$Object): Hmapmap$Object;
   ...
   */
  removeObject(mapObject: Hmapmap$Object): Hmapmap$Object;

  /**
   * This method retrieves the list of all objects which have been added to the map.
   * @returns {Array<Hmapmap$Object>} - the list of all use objects which are currently on the map.
   */
  getObjects(): Hmapmap$Object[];
   ...
   * @returns {HH$Map} - the map instance
   */
  addObjects(mapObjects: Hmapmap$Object[]): HH$Map;

  /**
   * This method removes an array of object or an object group from the map.
   * @param {(Array<Hmapmap$Object> | Hmapmap$Group)} mapObjects
   * @returns {HH$Map} - the map instance
   */
  removeObjects(mapObjects: Hmapmap$Object[] | Hmapmap$Group): HH$Map;
   ...
   */
  getObjectAt(x: number, y: number): Hmapmap$Object;
   ...
   */
  getObjectsAt(x: number, y: number): Hmapmap$Object[];
   ...
   * @return {Hmaprenderp2drender$RenderEngine} - map render engine
   */
  getEngine(): Hmaprenderp2drender$RenderEngine;
}
