declare module 'ssh2' {
	...
	import type {
          utils,Algorithms,Header,Prompt,SFTPStream,InputAttributes,Attributes,Stats,TransferOptions,ReadFileOptions,ReadStreamOptions,WriteStreamOptions,FileEntry
        } from 'ssh2-streams';
...
destroy(): void
	...
	declare export type ClientChannel = {
...
signalName?: string,
didCoreDump?: boolean,
description?: string) => void): this,
on(event: string | Symbol, listener: Function): this
} & Channel

	declare export type ServerChannel = {
...
on(
event: "x11",
listener: (details: X11Details, accept: () => ClientChannel, reject: () => void) => void): this;
...
lang: string,
prompts: Prompt[],
finish: (responses: string[]) => void) => void): this;
...
listener: (message: string, lang: string, done: (password: string) => void) => void): this;
...
command: string,
options: ExecOptions,
callback: (err: Error, channel: ClientChannel) => void): boolean;
...
remoteAddr: string,
remotePort: number,
callback?: (err: Error, bindPort: number) => void): boolean;
...
callback?: (err: Error, channel: ClientChannel) => void): boolean
	...
	declare export interface ConnectConfig {
...
debug?: (information: string) => any
	...
	declare export interface TcpConnectionDetails {
...
destPort: number
	...
	declare export interface X11Details {
...
srcPort: number
	...
	declare export interface ClientErrorExtensions {
...
x11?: boolean | number | X11Options
	...
	declare export interface ShellOptions {
...
x11?: boolean | number | X11Options
	...
	declare export interface X11Options {
...
screen?: number
	...
	declare export interface PseudoTtyOptions {
...
on(
event: "connection",
listener: (client: Connection, info: ClientInfo) => void): this;
 ...
 */
constructor(config: ServerConfig, connectionListener?: (client: Connection, info: ClientInfo) => void): this;
...
static createServer(
config: ServerConfig,
connectionListener?: (client: Connection, info: ClientInfo) => void): Server;
 ...
 * @param callback An optional callback to add to the `listening` event of the server.
 */
listen(handle: net.Server | net.Socket | {
fd: number
}, callback?: () => void): this;
...
unref(): void
	...
	declare export interface ServerConfig {
...
debug?: (information: string) => any
	...
	declare export interface EncryptedPrivateKey {
...
on(
event: "session",
listener: (accept: () => Session, reject: () => boolean) => void): this,
...
reject: () => boolean,
info: TcpipRequestInfo) => void): this,
...
accept: () => ServerChannel,
reject: () => boolean,
info: SocketRequestInfo) => void): this,
...
reject: () => void,
name: string,
info: TcpipBindInfo | SocketBindInfo) => void): this,
...
originAddr: string,
originPort: number,
callback: (err: Error, channel: ServerChannel) => void): boolean,
...
callback: (err: Error, channel: ServerChannel) => void): boolean
	...
	declare export type AuthContextBase = {
...
on(event: string | Symbol, listener: Function): this
	...
	declare export type KeyboardAuthContext = {
...
callback: () => void): void
	...
	declare export type PublicKeyAuthContext = {
...
data: Buffer
	...
	declare export type HostbasedAuthContext = {
...
localUsername: string
	...
	declare export type PasswordAuthContext = {
...
password: string
	...
	declare export type NoneAuthContext = {
...
method: "none"
	...
	declare export type AuthContext = KeyboardAuthContext
| PublicKeyAuthContext
| HostbasedAuthContext
| PasswordAuthContext
| NoneAuthContext;
	declare export interface TcpipRequestInfo {
...
destPort: number
	...
	declare export interface SocketRequestInfo {
...
socketPath: string
	...
	declare export interface TcpipBindInfo {
...
bindPort: number
	...
	declare export interface SocketBindInfo {
...
on(
event: "pty",
listener: (accept: () => boolean, reject: () => boolean, info: PseudoTtyInfo) => void): this,
...
on(
event: "window-change",
listener: (accept: () => boolean, reject: () => boolean, info: WindowChangeInfo) => void): this,
...
on(
event: "x11",
listener: (accept: () => boolean, reject: () => boolean, info: X11Info) => void): this,
...
on(
event: "env",
listener: (accept: () => boolean, reject: () => boolean, info: SetEnvInfo) => void): this,
...
on(
event: "signal",
listener: (accept: () => boolean, reject: () => boolean, info: SignalInfo) => void): this,
...
on(
event: "auth-agent",
listener: (accept: () => boolean, reject: () => boolean) => void): this,
...
on(
event: "shell",
listener: (accept: () => ServerChannel, reject: () => boolean) => void): this,
...
on(
event: "exec",
listener: (accept: () => ServerChannel, reject: () => boolean, info: ExecInfo) => void): this,
...
on(
event: "sftp",
listener: (accept: () => SFTPStream, reject: () => boolean) => void): this,
...
on(event: string | Symbol, listener: Function): this
	...
	declare export interface PseudoTtyInfo {
...
modes: TerminalModes
	...
	declare export interface TerminalModes {
...
TTY_OP_OSPEED?: number
	...
	declare export interface WindowChangeInfo {
...
height: number
	...
	declare export interface X11Info {
...
screen: number
	...
	declare export interface SetEnvInfo {
...
value: string
	...
	declare export interface SignalInfo {
...
name: string
	...
	declare export interface ExecInfo {
...
command: string
	...
	declare export interface SubsystemInfo {
...
name: string
	...
	declare export type SFTPWrapper = {
