 ...
 */
    forwardIn(
      remoteAddr: string,
      remotePort: number,
      callback?: (err: Error, bindPort: number) => void
    ): boolean;
  ...
  declare export class Server mixins events.EventEmitter {
    ...
    on(
      event: "connection",
      listener: (client: Connection, info: ClientInfo) => void
    ): this;
 ...
 */
  ...
  declare export type Connection = {
    ...
    on(
      event: "session",
      listener: (accept: () => Session, reject: () => boolean) => void
    ): this,
  ...
  declare export type AuthContext =
    | KeyboardAuthContext
  ...
  declare export type Session = {
    ...
    on(
      event: "auth-agent",
      listener: (accept: () => boolean, reject: () => boolean) => void
    ): this,
    ...
    on(
      event: "shell",
      listener: (accept: () => ServerChannel, reject: () => boolean) => void
    ): this,
    ...
    on(
      event: "sftp",
      listener: (accept: () => SFTPStream, reject: () => boolean) => void
    ): this,
