declare module "waitme" {
  declare interface WaitMe$WaitMeOptions {
    /**
  ...
  declare interface WaitMe$WaitMeStatic {
    /**
     ...
     * @returns {JQuery}
     */
    (options?: WaitMe$WaitMeOptions | "hide"): JQuery;
  }
  declare interface JQuery {
    /**
     * $(container).waitMe({param1 : value1, param2 : value2, ...});
     */
    waitMe: WaitMe$WaitMe$WaitMeStatic;
