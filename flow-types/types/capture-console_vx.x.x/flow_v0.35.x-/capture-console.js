 ...
 * Captures stderr for the provided execution scope.
 */
declare export function captureStderr(opts: CaptureOptions, exec: () => void): string
 ...
 */
declare export function captureStdio(exec: () => void): {
stdout: string,
stderr: string
}
 ...
 * the provided execution scope.
 */
declare export function captureStdio(opts: CaptureOptions, exec: () => void): {
stdout: string,
stderr: string
}
 ...
 * Captures stdout for the provided execution scope.
 */
declare export function captureStdout(opts: CaptureOptions, exec: () => void): string
...
exec: (string: string, encoding?: string, fd?: (error?: any) => void) => void): () => boolean
 ...
 */
declare export function intercept(stream: NodeJS.WritableStream, exec: () => void): string[]
 ...
 * Delegate to #captureStderr with a quiet passthrough.
 */
declare export function interceptStderr(opts: CaptureOptions, exec: () => void): string

	
/**
 * Delegate to #captureStdio with a quiet passthrough.
 */
declare export function interceptStdio(exec: () => void): {
stdout: string,
stderr: string
}
 ...
 * Delegate to #captureStdio with a quiet passthrough.
 */
declare export function interceptStdio(opts: CaptureOptions, exec: () => void): {
stdout: string,
stderr: string
}
 ...
 * Delegate to #captureStdout with a quiet passthrough.
 */
declare export function interceptStdout(opts: CaptureOptions, exec: () => void): string
 ...
 */
declare export function startIntercept(stream: NodeJS.WritableStream, exec: () => void): boolean

	
/**
 * Delegate to #startCapture with a quiet passthrough.
 */
declare export function startIntercept(stream: NodeJS.WritableStream, opts: CaptureOptions, exec: () => void): boolean
