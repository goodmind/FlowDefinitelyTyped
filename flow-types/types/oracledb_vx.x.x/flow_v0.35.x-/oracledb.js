...
onReject?: oracledb$TFunc<any, R>): oracledb$IPromise<R>
} 
...
callback: (err: any, value: oracledb$IExecuteReturn) => void): void,
...
sql: string,
bindParams?: Object | Array<any>,
options?: oracledb$IExecuteOptions): oracledb$IPromise<oracledb$IExecuteReturn>,
...
sql: string,
bindParams?: Object | Array<any>,
options?: oracledb$IExecuteOptions): stream.Readable,
 ...
 */
getConnection(callback: (err: any, connection: oracledb$IConnection) => void): void,
...
callback: (err: any, connection: oracledb$IConnectionPool) => void): void
 ...
 */
declare function oracledb$createPool(
poolAttributes: oracledb$IPoolAttributes): oracledb$IPromise<oracledb$IConnectionPool>
 ...
 */
declare function oracledb$getPool(poolAlias?: string): oracledb$IConnectionPool
 ...
 * @returns void
 */
declare function oracledb$getConnection(callback: (err: any, connection: oracledb$IConnection) => void): void
...
poolAlias: string,
callback: (err: any, connection: oracledb$IConnection) => void): void
 ...
 * @returns {(connection: oracledb$IConnection) => any} Promise with the connection.
 */
declare function oracledb$getConnection(poolAlias: string): oracledb$IPromise<oracledb$IConnection>
 ...
 */
declare function oracledb$getConnection(
connectionAttributes: oracledb$IConnectionAttributes): oracledb$IPromise<oracledb$IConnection>
