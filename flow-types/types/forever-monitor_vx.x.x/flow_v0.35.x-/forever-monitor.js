...
outFile?: string,
errFile?: string,
parser(command: string, args: string[]): {
command: string,
args: string[]
}
} 
	declare export function start(script: string | string[], options?: Options): Monitor

	declare export function kill(pid: number, killTree?: boolean, signal?: string, callback?: () => any): void
