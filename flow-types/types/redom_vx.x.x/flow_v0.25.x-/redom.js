declare module "redom" {
  ...
  declare export type RedomQueryArgumentValue =
    | RedomElement
    | string
    | number
    | {
    ...
    | RedomMiddleware;
  declare export type RedomQueryArgument =
  ...
  declare export function el(
    query: RedomQuery,
    ...args: RedomQueryArgument[]
  ): HTMLElement;

  declare export function listPool(
    View: RedomComponentConstructor,
    key?: string,
    initData?: any
  ): ListPool;
  ...
  declare export function unmount(
    parent: RedomElement,
    child: RedomElement
  ): RedomElement;

  declare export function place(
    View: RedomComponentConstructor,
    initData?: any
  ): Place;
  ...
  declare export function setAttr(
    view: RedomElement,
  ...
  declare export function setChildren(
    parent: RedomElement,
