...
options?: npmKeyword$npmKeyword$Options): Promise<npmKeyword$npmKeyword$PackageDescriptor[]>
 ...
 */
declare function npmKeyword$names(keyword: string | string[], options?: npmKeyword$Options): Promise<string[]>
 ...
 */
declare function npmKeyword$count(keyword: string | string[]): Promise<number>
