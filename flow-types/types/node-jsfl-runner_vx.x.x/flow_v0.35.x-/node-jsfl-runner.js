 ...
 */
declare export function createJSFL(
jsfl: JSFL,
fileName: string,
 ...
 * @param callback Callback
 */
declare export function deleteJSFL(fileName: string, callback: (err: NodeJS.ErrnoException) => void): void
 ...
 * @param callback Callback
 */
declare export function runJSFL(
