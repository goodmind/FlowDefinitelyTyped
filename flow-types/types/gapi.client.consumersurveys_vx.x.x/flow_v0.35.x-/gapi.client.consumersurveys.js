 ...
 */
declare function client$load(name: "consumersurveys", version: "v2"): PromiseLike<void>


declare function client$load(name: "consumersurveys", version: "v2", callback: () => any): void
