...
strict?: boolean
	...
	declare export interface RouteComponentProps<Params: $ObjMapi<Params, <K>(K) => string>> {
match: match<Params>,
location: H.Location,
history: H.History,
staticContext?: any
...
(element: React.DOMElement<React.DOMAttributes<T>, T>, container: Element | null, callback?: () => void): T,
...
(element: React.CElement<P, T>, container: Element | null, callback?: () => void): T,
...
(element: React.ReactElement<P>, container: Element | null, callback?: () => void): React.Component<P, React.ComponentState> | Element | void,
...
declare export var connect: Connect;
	...
	declare export class Router<State> mixins React.Component<ConnectedRouterProps<State>> {}
	...
	declare export class Route<T: RouteProps> mixins React.Component<T, any> {}
...
component: React.ComponentType<P>): React.ComponentClass<Omit<P, $Keys<RouteComponentProps<any>>>>

	declare export function withRouter<TFunction: React.ComponentClass<any>>(target: TFunction): TFunction
