declare module 'ng-file-upload' {
	...
	declare module 'angular' {
        declare interface angularFileUpload$ImageDimensions {
height: number,
width: number
} 

declare interface angularFileUpload$FileUploadOptions {
...
declare interface angularFileUpload$ResizeIfFunction {
(width: number, height: number): boolean
} 

declare interface angularFileUpload$FileResizeOptions {
centerCrop?: boolean,
height?: number,
pattern?: string,
ratio?: number | string,
resizeIf?: angularFileUpload$ResizeIfFunction,
restoreExif?: boolean,
quality?: number,
type?: string,
width?: number
...
declare interface angularFileUpload$IUploadService {
 ...
 */
http<T>(config: IRequestConfig): angularFileUpload$IUploadPromise<T>,
 ...
 * @return {angular.IPromise<angularFileUpload$ImageDimensions>}
 */
imageDimensions(file: File): angular.IPromise<angularFileUpload$ImageDimensions>,
...
resize(
file: File,
options: angularFileUpload$FileResizeOptions): angular.IPromise<File>,

/**
 * Set the default values for ngf-select and ngf-drop directives
 * @param {angularFileUpload$FileUploadOptions} defaultFileUploadOptions
 */
setDefaults(defaultFileUploadOptions: angularFileUpload$FileUploadOptions): void,
 ...
 */
upload<T>(
config: angularFileUpload$IFileUploadConfigFile): angularFileUpload$IUploadPromise<T>
} 

declare type angularFileUpload$IUploadPromise<T> = {

/**
 * Cancel/abort the upload in progress.
 * @return {angularFileUpload$IUploadPromise<T>}
 */
abort(): angularFileUpload$IUploadPromise<T>,
progress(
callback: (event: angularFileUpload$IFileProgressEvent) => void): angularFileUpload$IUploadPromise<T>,
 ...
 * @return {angularFileUpload$IUploadPromise<T>}
 */
xhr(callback: IHttpPromiseCallback<T>): angularFileUpload$IUploadPromise<T>
} & IHttpPromise<T>


declare type angularFileUpload$IFileUploadConfigFile = {
...
declare type angularFileUpload$IFileProgressEvent = {
config: angularFileUpload$IFileUploadConfigFile
} & ProgressEvent
