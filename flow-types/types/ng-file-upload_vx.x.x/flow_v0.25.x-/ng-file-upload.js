...
declare interface angularFileUpload$IUploadService {
  ...
  imageDimensions(
    file: File
  ): angular.IPromise<angularFileUpload$ImageDimensions>;
  ...
  resize(
    file: File,
    options: angularFileUpload$FileResizeOptions
   ...
   */
  setDefaults(
    defaultFileUploadOptions: angularFileUpload$FileUploadOptions
  ): void;
  ...
  ): angularFileUpload$IUploadPromise<T>;
}
...
declare type angularFileUpload$IUploadPromise<T> = {
  ...
  progress(
    callback: (event: angularFileUpload$IFileProgressEvent) => void
  ): angularFileUpload$IUploadPromise<T>,
