...
fallbackTo(
value: (error: Error, args: [T, U]) => PromiseLike<R>): CommandBuilderA2<R, T, U>,
...
fallbackTo(
value: (error: Error, args: [T, U, V]) => PromiseLike<R>): CommandBuilderA3<R, T, U, V>,
...
run(
value: (t: T, u: U, v: V, w: W) => PromiseLike<R>): CommandBuilderA4<R, T, U, V, W>,
fallbackTo(
value: (error: Error, args: [T, U, V, W]) => PromiseLike<R>): CommandBuilderA4<R, T, U, V, W>,
...
run(
value: (t: T, u: U, v: V, w: W, x: X) => PromiseLike<R>): CommandBuilderA5<R, T, U, V, W, X>,
fallbackTo(
value: (error: Error, args: [T, U, V, W, X]) => PromiseLike<R>): CommandBuilderA5<R, T, U, V, W, X>,
...
run(
value: (t: T, u: U, v: V, w: W, x: X, y: Y) => PromiseLike<R>): CommandBuilderA6<R, T, U, V, W, X, Y>,
fallbackTo(
value: (error: Error, args: [T, U, V, W, X, Y]) => PromiseLike<R>): CommandBuilderA6<R, T, U, V, W, X, Y>,
...
run(
value: (t: T, u: U, v: V, w: W, x: X, y: Y, z: Z) => PromiseLike<R>): CommandBuilderA7<R, T, U, V, W, X, Y, Z>,
fallbackTo(
value: (error: Error, args: [T, U, V, W, X, Y, Z]) => PromiseLike<R>): CommandBuilderA7<R, T, U, V, W, X, Y, Z>,
...
getOrCreate<R, T, U, V>(
commandKey: string,
commandGroup?: string): CommandBuilderA3<R, T, U, V>,
getOrCreate<R, T, U, V, W>(
commandKey: string,
commandGroup?: string): CommandBuilderA4<R, T, U, V, W>,
getOrCreate<R, T, U, V, W, X>(
commandKey: string,
commandGroup?: string): CommandBuilderA5<R, T, U, V, W, X>,
getOrCreate<R, T, U, V, W, X, Y>(
commandKey: string,
commandGroup?: string): CommandBuilderA6<R, T, U, V, W, X, Y>,
getOrCreate<R, T, U, V, W, X, Y, Z>(
commandKey: string,
commandGroup?: string): CommandBuilderA7<R, T, U, V, W, X, Y, Z>,
resetCache(): void
} 
