declare module "sylvester-es6" {
  declare export class Vector {
     ...
     */
    constructor(elements: Vector | number[]): this;
    static i: Vector;
    static j: Vector;
    static k: Vector;
  ...
  declare export class Vertex mixins Vector {
    /**
     * The constructor function.
     */
    constructor(point: Vector | number[]): this;
  ...
  declare export class Matrix {
     ...
     * Constructor function.
     */
    constructor(elements: number[] | number[][] | Vector | Matrix): this;
  ...
  declare export class Line {
     ...
     * Constructor function.
     */
    constructor(anchor: number[] | Vector, direction: number[] | Vector): this;
    static X: Line;
    static Y: Line;
    static Z: Line;
  ...
  declare export class LineSegment {
    /**
     * Constructor function.
     */
    constructor(v1: Vector | number[], v2: Vector | number[]): this;
  ...
  declare export class LinkedListNode {
    /**
     * Constructor function.
     */
  ...
  declare export class CircularLinkedList mixins LinkedList {
    /**
  ...
  declare export class Polygon {
     ...
     * Constructor function.
     */
    constructor(points: Vector[] | number[][], plane: Plane): this;
   ...
   */
  declare export function mht(m: Matrix): string;

  /**
   * Creates a look-at matrix given the parameters.
   */
  declare export function makeLookAt(
    ex: number,
    ey: number,
    ez: number,
    cx: number,
   ...
   */
  declare export function makeOrtho(
    left: number,
    right: number,
    bottom: number,
    top: number,
   ...
   */
  declare export function makePerspective(
    fovy: number,
    aspect: number,
    znear: number,
    zfar: number
   ...
   */
  declare export function makeFrustum(
    left: number,
    right: number,
    bottom: number,
    top: number,
