declare module 'c3' {
	...
	declare export type PrimitiveArray = Array<string | boolean | number | null>;
	declare export type FormatFunction = (v: any, id: string, i: number, j: number) => void;
	declare export interface TargetIds {
ids: ArrayOrString
} 
	declare export type ArrayOrString = string[] | string;
...
y2?: YAxisConfiguration
	...
	declare export interface XAxisConfiguration {
...
position: string
	...
	declare export interface YAxisConfiguration {
...
default?: number[]
	...
	declare export interface XTickConfiguration {
...
multiline?: boolean
	...
	declare export interface YTickConfiguration {
...
count?: number
	...
	declare export interface CullingConfiguration {
...
class?: string
	...
	declare export interface RegionOptions {
axis?: string,
...
order?: string | any[] | ((data1: any, data2: any) => number) | null
	...
	declare export interface SubchartOptions {
...
onzoomend(domain: any): void
	...
	declare export interface PointOptions {
...
r?: number
	...
	declare export interface ChartAPI {
...
destroy(): void
	...
	declare export interface GridOperations {
