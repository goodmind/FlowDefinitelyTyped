declare module "fluent-ffmpeg" {
  ...
  declare type Ffmpeg$FiltersCallback = (
    err: Error,
  ...
  declare type Ffmpeg$CodecsCallback = (
    err: Error,
  ...
  declare type Ffmpeg$EncodersCallback = (
    err: Error,
  ...
  declare type Ffmpeg$FormatsCallback = (
    err: Error,
  ...
  declare function Ffmpeg$availableFilters(
    callback: Ffmpeg$FiltersCallback
  ): void;

  declare function Ffmpeg$getAvailableFilters(
    callback: Ffmpeg$FiltersCallback
  ): void;

  declare function Ffmpeg$availableCodecs(
    callback: Ffmpeg$CodecsCallback
  ): void;

  declare function Ffmpeg$getAvailableCodecs(
    callback: Ffmpeg$CodecsCallback
  ): void;

  declare function Ffmpeg$availableEncoders(
    callback: Ffmpeg$EncodersCallback
  ): void;

  declare function Ffmpeg$getAvailableEncoders(
    callback: Ffmpeg$EncodersCallback
  ): void;

  declare function Ffmpeg$availableFormats(
    callback: Ffmpeg$FormatsCallback
  ): void;

  declare function Ffmpeg$getAvailableFormats(
    callback: Ffmpeg$FormatsCallback
  ): void;
  ...
  declare class Ffmpeg$FfmpegCommand mixins events.EventEmitter {
    ...
    withAudioFilter(
      filters: string | string[] | Ffmpeg$AudioVideoFilter[]
    ...
    ffprobe(
      index: number,
      callback: (err: any, data: Ffmpeg$FfprobeData) => void
    ): void;
    ffprobe(
      options: string[],
      callback: (err: any, data: Ffmpeg$FfprobeData) => void
