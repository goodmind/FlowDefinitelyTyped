 ...
 */
declare export function parse(src: string | Buffer, options?: DotenvParseOptions): DotenvParseOutput
 ...
 */
declare export function config(options?: DotenvConfigOptions): DotenvConfigOutput
