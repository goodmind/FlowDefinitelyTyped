declare type dygraphs$DataArray = (number | Date)[][];

declare type dygraphs$Data = string | dygraphs$DataArray | google.visualization.DataTable;
...
declare interface dygraphs$SeriesLegendData {
...
declare interface dygraphs$LegendData {
...
annotation: dygraphs$dygraphs$Annotation,
...
declare type dygraphs$Axis = "x" | "y" | "y2";declare class Dygraph  {
constructor(container: HTMLElement | string, data: dygraphs$dygraphs$Data | (() => dygraphs$dygraphs$Data), options?: dygraphs$dygraphs$Options): this;
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} opt_seriesName Series name to get per-series values.
 * @return {"NO PRINT IMPLEMENTED: JSDocAllType"} The value of the option.
 */
 ...
 */
getOptionForAxis(name: string, axis: dygraphs$dygraphs$Axis): any;
 ...
 */
getPropertiesForSeries(series_name: string): dygraphs$dygraphs$SeriesProperties;
 ...
 */
getArea(): dygraphs$dygraphs$Area;
...
callback).
 */
updateOptions(input_attrs: dygraphs$dygraphs$Options, block_redraw?: boolean): void;
 ...
 * @param {Array} ann An array of annotation objects.
 * @param {Boolean} suppressDraw Set to "true" to block chart redraw (optional).
 */
setAnnotations(ann: dygraphs$dygraphs$Annotation[], suppressDraw?: boolean): void;

/**
 * Return the list of annotations.
 */
annotations(): dygraphs$dygraphs$Annotation[];
...
fillPlotter: any
        ...
        declare export default typeof Dygraph
