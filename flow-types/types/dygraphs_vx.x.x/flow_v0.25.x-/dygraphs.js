...
} & dygraphs$PerSeriesOptions &
  dygraphs$PerAxisOptions;
...
declare class Dygraph {
  constructor(
    ...
    data: dygraphs$dygraphs$Data | (() => dygraphs$dygraphs$Data),
    options?: dygraphs$dygraphs$Options
  ): this;
 ...
 */
  ...
  getPropertiesForSeries(
    series_name: string
  ): dygraphs$dygraphs$SeriesProperties;
 ...
 */
  updateOptions(
    input_attrs: dygraphs$dygraphs$Options,
   ...
   */
  setAnnotations(
    ann: dygraphs$dygraphs$Annotation[],
