...
declare class Proj$CRS mixins Proj$CRS {
...
infinite: boolean;
constructor(projection: proj4.InterfaceProjection, options?: Proj$ProjCRSOptions): this;
constructor(code: string, proj4def: string, options?: Proj$ProjCRSOptions): this;
...
declare class Proj$GeoJSON mixins L.Proj$GeoJSON {}

declare var Proj$geoJson: (geojson?: Proj4GeoJSONFeature, options?: GeoJSONOptions) => Proj$GeoJSON;

declare class Proj$ImageOverlay mixins L.Proj$ImageOverlay {}

declare var Proj$imageOverlay: (
imageUrl: string,
bounds: LatLngBoundsExpression,
options?: ImageOverlayOptions) => Proj$ImageOverlay;
