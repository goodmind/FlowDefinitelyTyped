...
constructor(d: Buffer, Q: Buffer, chainCode: Buffer, network: NetworkType): this;
identifier: Buffer;
fingerprint: Buffer;
chainCode: Buffer;
privateKey: Buffer;
 ...
 */
declare export function fromBase58(string: string, network?: NetworkType): BIP32
 ...
 * @param network network type of the node
 */
declare export function fromPrivateKey(privateKey: Buffer, chainCode: Buffer, network?: NetworkType): BIP32
 ...
 * @param network network type of the node
 */
declare export function fromPublicKey(publicKey: Buffer, chainCode: Buffer, network?: NetworkType): BIP32
