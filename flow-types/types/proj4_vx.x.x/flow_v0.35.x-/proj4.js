...
declare type proj4$TemplateCoordinates = number[] | proj4$InterfaceCoordinates;
...
declare function proj4$Proj(srsCode: any, callback?: any): proj4$InterfaceProjection
 ...
 * @deprecated v3
 */
declare function proj4$Point(x: number, y: number, z?: number): proj4$InterfaceCoordinates


declare function proj4$Point(coordinates: proj4$TemplateCoordinates | string): proj4$InterfaceCoordinates


declare function proj4$toPoint(array: number[]): proj4$InterfaceCoordinates


declare function proj4$defs(name: string, projection: string | proj4$ProjectionDefinition): void
...
point: proj4$TemplateCoordinates): any
...
declare var proj4$version: string;
	declare function proj4(fromProjection: string, toProjection?: string): proj4$proj4$Converter

	declare function proj4<T: proj4$proj4$TemplateCoordinates>(toProjection: string, coordinates: T): T

	declare function proj4<T: proj4$proj4$TemplateCoordinates>(
