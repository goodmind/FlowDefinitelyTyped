...
declare function java$combine(className: string, value: any): {[key: string]: any}


declare function java$array(className: string, value: any[]): {[key: string]: any}
...
declare function java$Set(value: {[key: string]: any}): {[key: string]: any}


declare function java$Iterator(value: {[key: string]: any}): {[key: string]: any}


declare function java$HashMap(value: {[key: string]: any}): {[key: string]: any}


declare function java$Map(value: {[key: string]: any}): {[key: string]: any}


declare function java$Enumeration(value: {[key: string]: any}): {[key: string]: any}


declare function java$Dictionary(value: {[key: string]: any}): {[key: string]: any}
...
declare function array$Set(value: {[key: string]: any}[]): {[key: string]: any}


declare function array$Iterator(value: {[key: string]: any}[]): {[key: string]: any}


declare function array$HashMap(value: {[key: string]: any}[]): {[key: string]: any}


declare function array$Map(value: {[key: string]: any}[]): {[key: string]: any}


declare function array$Enumeration(value: {[key: string]: any}[]): {[key: string]: any}


declare function array$Dictionary(value: {[key: string]: any}[]): {[key: string]: any}


declare function array$Class(className: string[]): {[key: string]: any}


declare function array$Locale(locale: string[], handle: string): {[key: string]: any}


declare function array$BigDecimal(val: string[]): {[key: string]: any}


declare function array$Currency(value: (null[] | string[] | array$Currency[])): {[key: string]: any}


declare function java$abstract(abstractClassName: string, className: string, value: any): {[key: string]: any}


declare function java$Class(className: string): {[key: string]: any}


declare function java$Locale(locale: string, handle: string): {[key: string]: any}


declare function java$BigDecimal(val: string): {[key: string]: any}


declare function java$Currency(value: null | string | java$Currency): {[key: string]: any}


declare function java$revert(javaObject: {[key: string]: any}): any


declare function java$exception(error: Error, className: string): {[key: string]: any}
