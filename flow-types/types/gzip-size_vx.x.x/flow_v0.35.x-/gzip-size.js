 ...
 * @param options Any zlib option
 */
declare function gzipSize$sync(input: string | Buffer, options?: zlib.ZlibOptions): number
 ...
 * @param options Any zlib option
 */
declare function gzipSize$file(path: string, options?: zlib.ZlibOptions): Promise<number>
