declare module 'd3-interpolate' {
	...
	declare export type ZoomInterpolator = {
(t: number): ZoomView,
...
duration: number
	...
	declare export type ColorGammaInterpolationFactory = {
 ...
 */
declare export type ZoomView = [number, number, number];
	
/**
 * Returns an `null` constant interpolator.
 */
declare export function interpolate(a: any, b: null): ((t: number) => null)

	
/**
 * Returns an boolean constant interpolator of value `b`.
 */
declare export function interpolate(a: any, b: boolean): ((t: number) => boolean)

	
/**
 * Returns a `interpolateNumber` interpolator.
 */
declare export function interpolate(a: number | {
valueOf(): number
...
b: ColorCommonInstance): ((t: number) => string)

	
/**
 * Returns a `interpolateDate` interpolator.
 */
declare export function interpolate(a: Date, b: Date): ((t: number) => Date)

	
/**
 * Returns a `interpolateString` interpolator. If `b` is a string coercible to a color use use `interpolateRgb`.
 */
declare export function interpolate(a: string | {
toString(): string
}, b: string): ((t: number) => string)

	
/**
 * Returns a `interpolateArray` interpolator.
 */
declare export function interpolate<U: any[]>(a: any[], b: U): ((t: number) => U)
 ...
 */
declare export function interpolate<U: {[key: string]: any}>(a: any, b: U): ((t: number) => U)
 ...
 */
declare export function interpolateNumber(
a: number | {
valueOf(): number
},
b: number | {
 ...
 */
declare export function interpolateRound(
a: number | {
valueOf(): number
},
b: number | {
 ...
 */
declare export function interpolateString(
a: string | {
toString(): string
},
b: string | {
 ...
 */
declare export function interpolateDate(a: Date, b: Date): ((t: number) => Date)

	declare export type ArrayInterpolator<A: any[]> = ((t: number) => A);
 ...
 * No copy is made for performance reasons; interpolators are often part of the inner loop of animated transitions.
 */
declare export function interpolateArray<A: any[]>(a: any[], b: A): ArrayInterpolator<A>
 ...
 * No copy is made for performance reasons; interpolators are often part of the inner loop of animated transitions.
 */
declare export function interpolateObject<U: {[key: string]: any}>(a: any, b: U): ((t: number) => U)
 ...
 */
declare export function interpolateTransformCss(a: string, b: string): ((t: number) => string)
 ...
 * This behavior is standardized by CSS: see [matrix decomposition for animation](http://www.w3.org/TR/css3-2d-transforms/#matrix-decomposition).
 */
declare export function interpolateTransformSvg(a: string, b: string): ((t: number) => string)
 ...
 */
declare export function interpolateZoom(a: ZoomView, b: ZoomView): ZoomInterpolator
 ...
 */
declare export function interpolateDiscrete<T>(values: T[]): ((t: number) => T)
 ...
 */
declare export function quantize<T>(interpolator: ((t: number) => T), n: number): T[]
 ...
 */
declare export var interpolateRgb: ColorGammaInterpolationFactory;
 ...
 */
declare export function interpolateRgbBasis(colors: Array<string | ColorCommonInstance>): ((t: number) => string)
 ...
 *  *
 */
declare export function interpolateRgbBasisClosed(colors: Array<string | ColorCommonInstance>): ((t: number) => string)
 ...
 */
declare export function interpolateHslLong(
a: string | ColorCommonInstance,
b: string | ColorCommonInstance): ((t: number) => string)
 ...
 */
declare export function interpolateHclLong(
a: string | ColorCommonInstance,
b: string | ColorCommonInstance): ((t: number) => string)
 ...
 */
declare export var interpolateCubehelix: ColorGammaInterpolationFactory;
	
/**
 * Like `interpolateCubehelix`, but does not use the shortest path between hues.
 */
declare export var interpolateCubehelixLong: ColorGammaInterpolationFactory;
 ...
 */
declare export function interpolateHue(a: number, b: number): ((t: number) => number)
 ...
 */
declare export function interpolateBasis(splineNodes: number[]): ((t: number) => number)
 ...
 */
declare export function interpolateBasisClosed(splineNodes: number[]): ((t: number) => number)
 ...
 */
declare export function piecewise(
 ...
 */
declare export function piecewise<A: any[]>(
interpolate: (a: any[], b: A) => ArrayInterpolator<A>,
values: A[]): ArrayInterpolator<A>
 ...
 */
declare export function piecewise<TData, Interpolator>(
interpolate: (a: TData, b: TData) => Interpolator,
values: TData[]): (t: number) => any
