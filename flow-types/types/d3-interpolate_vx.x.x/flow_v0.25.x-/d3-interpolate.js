declare module "d3-interpolate" {
  import type { ColorCommonInstance } from "d3-color";
   ...
   */
  declare export function interpolate<U: any[]>(
    a: any[],
    b: U
  ): (t: number) => U;
   ...
   */
  declare export function interpolate<U: { [key: string]: any }>(
    a: any,
    b: U
  ): (t: number) => U;
   ...
   */
  declare export function interpolateDate(
    a: Date,
    b: Date
  ): (t: number) => Date;
   ...
   * No copy is made for performance reasons; interpolators are often part of the inner loop of animated transitions.
   */
  declare export function interpolateArray<A: any[]>(
    a: any[],
    b: A
  ): ArrayInterpolator<A>;
   ...
   * No copy is made for performance reasons; interpolators are often part of the inner loop of animated transitions.
   */
  declare export function interpolateObject<U: { [key: string]: any }>(
    a: any,
    b: U
  ): (t: number) => U;
   ...
   */
  declare export function interpolateTransformCss(
    a: string,
    b: string
  ): (t: number) => string;
   ...
   * This behavior is standardized by CSS: see [matrix decomposition for animation](http://www.w3.org/TR/css3-2d-transforms/#matrix-decomposition).
   */
  declare export function interpolateTransformSvg(
    a: string,
    b: string
  ): (t: number) => string;
   ...
   */
  declare export function quantize<T>(
   ...
   */
  declare export function interpolateRgbBasis(
   ...
   *  *
   */
  declare export function interpolateRgbBasisClosed(
    colors: Array<string | ColorCommonInstance>
  ): (t: number) => string;
   ...
   */
  declare export function interpolateHue(
    a: number,
    b: number
  ): (t: number) => number;
   ...
   */
  declare export function interpolateBasis(
    splineNodes: number[]
  ): (t: number) => number;
   ...
   */
  declare export function interpolateBasisClosed(
    splineNodes: number[]
  ): (t: number) => number;
