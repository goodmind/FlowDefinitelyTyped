declare module 'better-queue' {
        declare class BetterQueue<T, K> mixins NodeJS.EventEmitter {
constructor(options: BetterQueue$BetterQueue$QueueOptions<T, K>): this;
constructor(process: BetterQueue$BetterQueue$ProcessFunction<T, K>, options?: $Shape<BetterQueue$BetterQueue$QueueOptions<T, K>>): this;
push(task: T, cb?: (err: any, result: K) => void): BetterQueue$BetterQueue$Ticket;
...
on(
event: "task_failed",
listener: (taskId: any, errorMessage: string) => void): this;
on(
event: "task_progress",
listener: (taskId: any, completed: number, total: number) => void): this;
on(
...
declare type BetterQueue$ProcessFunction<T, K> = (task: any, cb: BetterQueue$ProcessFunctionCb<K>) => void;

declare type BetterQueue$ProcessFunctionCb<K> = (error?: any, result?: K) => void;

declare type BetterQueue$QueueEvent = "task_queued"
| "task_accepted"
| "task_started"
| "task_finish"
| "task_failed"
...
declare type BetterQueue$TicketEvent = "accept"
| "queued"
| "started"
| "progress"
| "finish"
...
getLock(lockId: string, cb: (error: any, tasks: {
[taskId: string]: T
}) => void): void,
...
on(event: BetterQueue$TicketEvent, listener: (...args: any[]) => void): this
}
