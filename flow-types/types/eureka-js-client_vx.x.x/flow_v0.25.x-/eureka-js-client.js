declare module "eureka-js-client" {
  declare export class Eureka {
    constructor(
      config:
        | EurekaClient$EurekaClient$EurekaConfig
        | EurekaClient$EurekaClient$EurekaYmlConfig
    ): this;
    start(cb?: (err: Error, ...rest: any[]) => void): void;
    stop(cb?: (err: Error, ...rest: any[]) => void): void;
    getInstancesByAppId(
      appId: string
    ): EurekaClient$EurekaClient$EurekaInstanceConfig[];
    getInstancesByVipAddress(
      vidAddress: string
    ): EurekaClient$EurekaClient$EurekaInstanceConfig[];
  }
  declare type EurekaClient$InstanceStatus =
    | "UP"
    | "DOWN"
    | "STARTING"
    | "OUT_OF_SERVICE"
