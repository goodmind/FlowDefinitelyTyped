declare module "console-log-level" {
  ...
  declare type consoleLogLevel$LogLevelNames =
    | "trace"
    | "debug"
    | "info"
    | "warn"
  ...
  declare type consoleLogLevel$Logger = Record<
    consoleLogLevel$LogLevelNames,
    (...args: any[]) => void
  >;
  ...
  declare function consoleLogLevel(
    opts: Options
  ): consoleLogLevel$consoleLogLevel$Logger;
