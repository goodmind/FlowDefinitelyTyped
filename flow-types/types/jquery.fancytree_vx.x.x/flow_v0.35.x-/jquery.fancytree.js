...
fancytree(
options?: Fancytree$Fancytree.Fancytree$FancytreeOptions): Fancytree$Fancytree.Fancytree$Fancytree,
 ...
 */
findAll(
match: string | ((node: Fancytree$FancytreeNode) => boolean | void)): Fancytree$FancytreeNode[],
...
addChildren(
children: Fancytree$Fancytree.Fancytree$NodeData[],
insertBefore?: string): Fancytree$FancytreeNode,
...
addChildren(
children: Fancytree$Fancytree.Fancytree$NodeData[],
insertBefore?: number): Fancytree$FancytreeNode,
...
static +activate: Class<Fancytree$FancytreeClickFolderMode__activate> & Fancytree$FancytreeClickFolderMode__activate & 1;// 1
static +expand: Class<Fancytree$FancytreeClickFolderMode__expand> & Fancytree$FancytreeClickFolderMode__expand & 2;// 2
static +activate_and_expand: Class<Fancytree$FancytreeClickFolderMode__activate_and_expand> & Fancytree$FancytreeClickFolderMode__activate_and_expand & 3;// 3
static +activate_dblclick_expands: Class<Fancytree$FancytreeClickFolderMode__activate_dblclick_expands> & Fancytree$FancytreeClickFolderMode__activate_dblclick_expands & 4;// 4

}

declare class Fancytree$FancytreeClickFolderMode__activate mixins Fancytree$FancytreeClickFolderMode {}
declare class Fancytree$FancytreeClickFolderMode__expand mixins Fancytree$FancytreeClickFolderMode {}
declare class Fancytree$FancytreeClickFolderMode__activate_and_expand mixins Fancytree$FancytreeClickFolderMode {}
declare class Fancytree$FancytreeClickFolderMode__activate_dblclick_expands mixins Fancytree$FancytreeClickFolderMode {}


declare  class Fancytree$FancytreeSelectMode {
  constructor(...args: empty): mixed;
static +single: Class<Fancytree$FancytreeSelectMode__single> & Fancytree$FancytreeSelectMode__single & 1;// 1
static +multi: Class<Fancytree$FancytreeSelectMode__multi> & Fancytree$FancytreeSelectMode__multi & 2;// 2
static +mutlti_hier: Class<Fancytree$FancytreeSelectMode__mutlti_hier> & Fancytree$FancytreeSelectMode__mutlti_hier & 3;// 3

}

declare class Fancytree$FancytreeSelectMode__single mixins Fancytree$FancytreeSelectMode {}
declare class Fancytree$FancytreeSelectMode__multi mixins Fancytree$FancytreeSelectMode {}
declare class Fancytree$FancytreeSelectMode__mutlti_hier mixins Fancytree$FancytreeSelectMode {}
 ...
 */
checkbox?: boolean | string | ((event: JQueryEventObject, data: Fancytree$EventData) => boolean),
...
data: Fancytree$Fancytree.Fancytree$EventData) => boolean | void),
