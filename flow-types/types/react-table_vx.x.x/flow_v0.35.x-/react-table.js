declare module 'react-table' {
	...
	declare export type AccessorFunction<D> = (row: D) => any;
	declare export type Accessor<D> = string | string[] | AccessorFunction<D>;
	declare export type Aggregator = (values: any, rows: any) => any;
	declare export type TableCellRenderer = ((cellInfo: CellInfo, column: any) => React.ReactNode) | React.ReactNode;
	declare export type FilterRender = (
params: {
column: Column,
filter: any,
...
key?: string
	...
	declare export type PivotRenderer = ((cellInfo: CellInfo) => React.ReactNode) | (() => any) | string | React.ReactNode;
	declare export type ComponentPropsGetter0 = (
finalState: any,
rowInfo: void,
column: void,
instance?: any) => {[key: string]: any} | void;
...
column?: Column,
instance?: any) => {[key: string]: any} | void;
	declare export type DefaultFilterFunction = (filter: Filter, row: any, column: any) => boolean;
	declare export type FilterFunction = (filter: Filter, rows: any[], column: any) => any[];
	declare export type SubComponentFunction = (rowInfo: RowInfo) => React.ReactNode;
	declare export type PageChangeFunction = (page: number) => void;
	declare export type PageSizeChangeFunction = (newPageSize: number, newPage: number) => void;
	declare export type SortedChangeFunction = (newSorted: SortingRule[], column: any, additive: boolean) => void;
	declare export type FilteredChangeFunction = (newFiltering: Filter[], column: any, value: any) => void;
	declare export type ExpandedChangeFunction = (column: any, event: any, isTouch: boolean) => void;
	declare export type ResizedChangeFunction = (newResized: Resize[], event: any) => void;
...
desc?: true
	...
	declare export type TableProps<D, ResolvedData> = {
...
instance: Instance<ResolvedData>) => React.ReactNode
} & $Shape<TextProps> & $Shape<ComponentDecoratorProps> & $Shape<ControlledStateCallbackProps> & $Shape<PivotingProps> & $Shape<ControlledStateOverrideProps> & $Shape<ComponentProps>
...
rowsText: string
	...
	declare export type GlobalColumn = {} & Column$Column$Basics & Column$Column$CellProps & Column$Column$FilterProps & Column$Column$FooterProps & Column$Column$HeaderProps
 ...
 */
pivot?: boolean
} & $Shape<Column$Column$Basics> & $Shape<Column$Column$CellProps> & $Shape<Column$Column$FilterProps> & $Shape<Column$Column$FooterProps> & $Shape<Column$Column$HeaderProps>

	declare export interface ColumnRenderProps<D> {
...
} & RowInfo & Pick<ControlledStateOverrideProps, "resized">

	declare export type FinalState<D> = {
frozen: boolean,
startRow: number,
endRow: number,
pageRows: number,
...
headerGroups: any[]
	...
	declare export default class ReactTable<D> mixins React.Component<$Shape<TableProps<D>>> {}
	declare export type Instance<D> = {
context: any,
