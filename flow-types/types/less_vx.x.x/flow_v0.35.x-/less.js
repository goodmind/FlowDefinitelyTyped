...
render(
input: string,
callback: (error: Less$Less$RenderError, output: Less$Less$RenderOutput) => void): void,
render(
input: string,
options: Less$Less$Options,
callback: (error: Less$Less$RenderError, output: Less$Less$RenderOutput) => void): void,
render(input: string): Promise<Less$Less$RenderOutput>,
render(input: string, options: Less$Less$Options): Promise<Less$Less$RenderOutput>,
refresh(
reload?: boolean,
modifyVars?: {
[variable: string]: string
},
clearFileCache?: boolean): Promise<Less$Less$RefreshOutput>,
version: number[],
watch(): void
} declare module 'less' {
