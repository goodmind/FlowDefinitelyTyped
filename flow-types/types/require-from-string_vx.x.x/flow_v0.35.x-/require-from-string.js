 ...
 */
declare function requireFromString(code: string, options?: requireFromString$requireFromString$Options): any

	declare function requireFromString(
code: string,
filename?: string,
options?: requireFromString$requireFromString$Options): any
