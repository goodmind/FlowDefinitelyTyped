declare module "png-async" {
  ...
  declare export class EDeflateStrategy {
    ...
    static +DEFAULT_STRATEGY: Class<EDeflateStrategy__DEFAULT_STRATEGY> &
      EDeflateStrategy__DEFAULT_STRATEGY &
      0; // 0
    static +FILTERED: Class<EDeflateStrategy__FILTERED> &
      EDeflateStrategy__FILTERED &
      1; // 1
    static +HUFFMAN_ONLY: Class<EDeflateStrategy__HUFFMAN_ONLY> &
      EDeflateStrategy__HUFFMAN_ONLY &
      2; // 2
