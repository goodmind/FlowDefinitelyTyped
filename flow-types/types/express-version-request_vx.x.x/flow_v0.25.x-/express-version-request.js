declare module "express-version-request" {
  ...
  declare export type CustomParsingFunction = (
    header: $ElementType<$ElementType<Request, "headers">, "accept">
  ) => string;
  ...
  declare export function setVersionByQueryParam(
    queryParam?: string,
    options?: SetVersionByQueryParamOptions
  ): Handler;

  declare export function setVersionByAcceptHeader(
    customParsingFunction?: CustomParsingFunction
  ): Handler;

  declare export function formatVersion(
    version: { [key: string]: any } | string
  ): string;
}
