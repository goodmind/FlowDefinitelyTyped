 ...
 */
ensureIndex(options: Nedb$Nedb$EnsureIndexOptions, cb?: (err: Error) => void): void;
...
query: any,
projection: T,
callback: (err: Error, documents: T[]) => void): void;
...
cb?: (err: Error, numberOfUpdated: number, upsert: boolean) => void): void;
