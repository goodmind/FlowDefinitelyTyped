...
declare interface my$BaseOptions<R, E> {
 ...
 * 动态设置当前页面的标题。
 */
declare function my$setNavigationBar(options: $Shape<my$SetNavigationBarOptions>): void
 ...
 * 选择本地系统通信录中某个联系人的电话。
 */
declare function my$choosePhoneContact(options: my$ChoosePhoneContactOptions): void
 ...
 */
declare function my$chooseAlipayContact(options: my$ChooseAlipayContactOptions): void
...
declare type my$TimingFunction = "linear"
| "ease"
| "ease-in"
| "ease-in-out"
| "ease-out"
 ...
 */
declare function my$createAnimation(options: $Shape<my$CreateAnimationOptions>): my$Animation
 ...
 * @param color 阴影颜色
 */
setShadow(offsetX: number, offsetY: number, blur: number, color: my$Color): void,
 ...
 * @param y1 终点 y 坐标
 */
createLinearGradient(x0: number, y0: number, x1: number, y1: number): my$CanvasAction,
...
callback?: (rect: T) => void): my$SelectorQuery,
...
declare function my$multiLevelSelect(options?: my$MultiLevelSelectOptions): void
 ...
 * @param options
 */
declare function my$openMerchantCardList(options: my$OpenMerchantCardList): void
 ...
 * 有关支付宝卡包详细功能，见[支付宝卡包产品介绍](https://docs.alipay.com/mini/introduce/voucher)
 */
declare function my$openMerchantVoucherList(options: my$OpenMerchantVoucherListOptions): void
 ...
 * 有关支付宝卡包详细功能，见[支付宝卡包产品介绍](https://docs.alipay.com/mini/introduce/voucher)
 */
declare function my$openVoucherDetail(options: my$OpenVoucherDetailOptions1 | my$OpenVoucherDetailOptions2): void
 ...
 * 有关支付宝卡包详细功能，见[支付宝卡包产品介绍](https://docs.alipay.com/mini/introduce/voucher)
 */
declare function my$openKBVoucherDetail(options: my$OpenKBVoucherDetailOptions1 | my$OpenKBVoucherDetailOptions2): void
 ...
 * 有关支付宝卡包详细功能，见[支付宝卡包产品介绍](https://docs.alipay.com/mini/introduce/voucher)
 */
declare function my$openMerchantTicketList(options: my$OpenMerchantTicketListOptions): void
 ...
 * 有关支付宝卡包详细功能，见[支付宝卡包产品介绍](https://docs.alipay.com/mini/introduce/voucher)
 */
declare function my$openTicketDetail(options: my$OpenTicketDetailOptions1 | my$OpenTicketDetailOptions2): void
...
declare type my$TextRiskIdentificationType = "keyword"
| "0"
| "1"
| "2"
| "3"
 ...
 */
declare function my$textRiskIdentification(options: my$TextRiskIdentificationOptions): void
 ...
 * @param options
 */
declare function my$navigateToMiniProgram(options: my$NavigateToMiniProgramOptions): void
 ...
 */
declare function my$navigateBackMiniProgram(options: my$NavigateBackMiniProgramOptions): void
 ...
 */
declare function my$createWebViewContext(webviewId: string): my$WebViewContext
 ...
 * 获取保存的文件信息
 */
declare function my$getSavedFileInfo(options: my$GetSavedFileInfoOptions): void
...
declare function my$getSavedFileList(options: my$GetSavedFileListOptions): void
 ...
 */
declare function my$sendSocketMessage(options: my$SendSocketMessageOptions): void
...
declare type my$NetworkType = "UNKNOWN"
| "NOTREACHABLE"
| "WIFI"
| "3G"
| "2G"
 ...
 */
declare function my$setKeepScreenOn(options?: my$SetKeepScreenOnOptions): void
 ...
 * 获取屏幕亮度
 */
declare function my$getScreenBrightness(options?: my$GetScreenBrightnessOptions): void
 ...
 * 设置屏幕亮度
 */
declare function my$setScreenBrightness(options: my$SetScreenBrightnessOptions): void
 ...
 */
declare function my$openBluetoothAdapter(options: $Shape<my$OpenBluetoothAdapterOptions>): void
 ...
 * 关闭本机蓝牙模块
 */
declare function my$closeBluetoothAdapter(options: my$CloseBluetoothAdapterOptions): void
 ...
 * 获取本机蓝牙适配器状态
 */
declare function my$getBluetoothAdapterState(options: my$GetBluetoothAdapterStateOptions): void
 ...
 */
declare function my$startBluetoothDevicesDiscovery(options: my$StartBluetoothDevicesDiscoveryOptions): void
 ...
 */
declare function my$stopBluetoothDevicesDiscovery(options: my$StopBluetoothDevicesDiscoveryOptions): void
 ...
 */
declare function my$getBluetoothDevices(options: my$GetBluetoothDevicesOptions): void
 ...
 * 获取处于已连接状态的设备。
 */
declare function my$getConnectedBluetoothDevices(options: my$GetConnectedBluetoothDevicesOptions): void
 ...
 * 向低功耗蓝牙设备特征值中写入数据。
 */
declare function my$writeBLECharacteristicValue(options: my$WriteBLECharacteristicValueOptions): void
 ...
 */
declare function my$readBLECharacteristicValue(options: my$ReadBLECharacteristicValueOptions): void
...
declare function my$notifyBLECharacteristicValueChange(optons: my$NotifyBLECharacteristicValueChangeOptions): void
 ...
 */
declare function my$notifyBLECharacteristicValueChanged(options: my$NotifyBLECharacteristicValueChangedOptions): void
 ...
 * 获取蓝牙设备所有 service（服务）
 */
declare function my$getBLEDeviceServices(options: my$GetBLEDeviceServicesOptions): void
 ...
 */
declare function my$getBLEDeviceCharacteristics(options: my$GetBLEDeviceCharacteristicsOptions): void
 ...
 * 搜索到新的蓝牙设备时触发此事件。
 */
declare function my$onBluetoothDeviceFound(options: my$OnBluetoothDeviceFoundOptions): void
 ...
 * 监听低功耗蓝牙设备的特征值变化的事件。
 */
declare function my$onBLECharacteristicValueChange(options: my$OnBLECharacteristicValueChangeOptions): void
 ...
 */
declare function my$onBLEConnectionStateChanged(options: my$OnBLEConnectionStateChangedOptions): void
 ...
 * 监听本机蓝牙状态变化的事件。
 */
declare function my$onBluetoothAdapterStateChange(callback: (res: my$BluetoothAdapterState) => void): void
 ...
 * 开始搜索附近的iBeacon设备
 */
declare function my$startBeaconDiscovery(options: my$StartBeaconDiscoveryOptions): void
 ...
 * 停止搜索附近的iBeacon设备
 */
declare function my$stopBeaconDiscovery(options: my$StopBeaconDiscoveryOptions): void
 ...
 * 监听 iBeacon 服务的状态变化
 */
declare function my$onBeaconServiceChange(options: my$BeaconServiceChangeOptions): void
...
relativeTo(selector?: string, margins?: my$Margins): my$IntersectionObserver,
relativeToViewport(margins?: my$Margins): my$IntersectionObserver,
observe(
selector?: string,
callback?: (response: my$ObserveResponse) => void): my$IntersectionObserver,
disconnect(): void
} 
...
createIntersectionObserver(options?: my$CreateIntersectionObserverOption): my$IntersectionObserver,
...
declare type my$TouchEventType = "tap"
| "touchstart"
| "touchmove"
| "touchcancel"
| "touchend"
...
declare type my$TransitionEventType = "transitionend" | "animationstart" | "animationiteration" | "animationend";

declare type my$EventType = "input"
| "form"
| "submit"
| "scroll"
| my$TouchEventType
...
declare var my$onMessage: my$onMessageFun;
	declare function App(app: $Shape<my$my$AppOptions & my$my$App>): void

	declare function getApp(): my$my$App

	declare function Behavior(options?: any): my$my$Component

	declare function Component(options?: any): my$my$Component

	declare function Page(options: $Shape<my$my$PageOptions & my$my$Page>): void

	declare function getCurrentPages(): my$my$Page[]
