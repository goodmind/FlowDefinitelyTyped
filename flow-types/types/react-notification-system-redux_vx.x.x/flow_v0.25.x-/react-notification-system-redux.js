declare module "react-notification-system-redux" {
  ...
  declare type Notifications$NotificationLevel =
    | "error"
    | "warning"
    | "info"
    | "success";
  ...
  declare function Notifications$show(
    opts?: Notification,
    level?: Notifications$NotificationLevel
  ): Action;

  declare var Notifications$error: Notifications$NotificationShow;

  declare function Notifications$hide(
    opts?: Notification | string | number
  ): Action;
