declare module 'simpl-schema' {
        declare export type ValidationContext = {
...
} & SimpleSchemaValidationContextStatic

	declare interface CustomValidationContext {
 ...
 */
custom?: () => void | string | SimpleSchemaValidationError,
blackbox?: boolean,
autoValue?: () => any,
defaultValue?: any,
trim?: boolean
} 
	declare interface CleanOption {
filter?: boolean,
autoConvert?: boolean,
...
removeNullsFromArrays?: boolean
	...
	declare interface SimpleSchemaOptions {
check?: boolean,
clean?: CleanOption,
defaultLabel?: string,
...
tracker?: any
	...
	declare interface SimpleSchemaValidationError {
type: string,
...
options?: SimpleSchemaOptions): SimpleSchema,
...
KEY_NOT_IN_SCHEMA: string
	...
	declare interface ValidationOption {
modifier?: boolean,
upsert?: boolean,
clean?: boolean,
filter?: boolean,
...
keys?: string[]
	...
	declare interface SimpleSchemaValidationContextStaticKeys {
name: string,
type: string,
value?: any
} 
	declare interface SimpleSchemaError {
name: string,
type: string
} 
	declare interface SimpleSchemaValidationContextStatic {
...
getErrorObject(): any
	...
	declare interface MongoObjectStatic {
forEachNode(func: (() => void), options?: {
...
affectsGenericKeyImplicit(key: string): any
	...
	declare export var SimpleSchema: SimpleSchemaStatic;
	declare export var SimpleSchemaValidationContext: SimpleSchemaValidationContextStatic;
	declare export var MongoObject: MongoObjectStatic;
	declare export type SimpleSchema = {
debug: boolean,
...
messages(messages: any): void
	...
	declare export interface MongoObject {
