 ...
 */
declare function weak<T: {[key: string]: any}>(object: T, callback?: () => void): WeakRef<T>
 ...
 */
declare function weak$addCallback(ref: WeakRef<any>, callback: () => void): NodeJS.EventEmitter
 ...
 * @param callback function to be called
 */
declare function weak$removeCallback(ref: WeakRef<any>, callback: () => void): NodeJS.EventEmitter
