declare module 'overlayscrollbars' {
        declare type OverlayScrollbars$ResizeBehavior = "none"
| "both"
| "horizontal"
| "vertical"
| "n"
...
declare type OverlayScrollbars$OverflowBehavior = "hidden"
| "scroll"
| "visible-hidden"
| "visible-scroll"
| "h"
...
declare type OverlayScrollbars$VisibilityBehavior = "visible"
| "hidden"
| "auto"
| "v"
| "h"
...
declare type OverlayScrollbars$AutoHideBehavior = "never"
| "scroll"
| "leave"
| "move"
| "n"
...
declare type OverlayScrollbars$ScrollBehavior = "always" | "ifneeded" | "never";

declare type OverlayScrollbars$BlockBehavior = "begin" | "end" | "center" | "nearest";
...
declare type OverlayScrollbars$OverflowChangedCallback = (args?: OverlayScrollbars$OverflowChangedArgs) => void;

declare type OverlayScrollbars$OverflowAmountChangedCallback = (args?: OverlayScrollbars$OverflowAmountChangedArgs) => void;

declare type OverlayScrollbars$DirectionChangedCallback = (args?: OverlayScrollbars$DirectionChangedArgs) => void;

declare type OverlayScrollbars$SizeChangedCallback = (args?: OverlayScrollbars$SizeChangedArgs) => void;

declare type OverlayScrollbars$UpdatedCallback = (args?: OverlayScrollbars$UpdatedArgs) => void;
...
scroll?: OverlayScrollbars$ScrollBehavior | {
x?: OverlayScrollbars$ScrollBehavior,
y?: OverlayScrollbars$ScrollBehavior
} | [OverlayScrollbars$ScrollBehavior, OverlayScrollbars$ScrollBehavior],
block?: OverlayScrollbars$BlockBehavior | {
...
margin?: OverlayScrollbars$Margin | {
top?: OverlayScrollbars$Margin,
right?: OverlayScrollbars$Margin,
bottom?: OverlayScrollbars$Margin,
left?: OverlayScrollbars$Margin
} | [OverlayScrollbars$Margin, OverlayScrollbars$Margin] | [OverlayScrollbars$Margin, OverlayScrollbars$Margin, OverlayScrollbars$Margin, OverlayScrollbars$Margin]
};
...
| OverlayScrollbars$UpdatedArgs): void
} 
...
framework: any) => OverlayScrollbars$Extension,
defaultOptions?: {}
} 
...
duration?: number,
easing?: OverlayScrollbars$OverlayScrollbars$Easing | {
x?: OverlayScrollbars$OverlayScrollbars$Easing,
y?: OverlayScrollbars$OverlayScrollbars$Easing
} | [OverlayScrollbars$OverlayScrollbars$Easing, OverlayScrollbars$OverlayScrollbars$Easing],
complete?: (...args: any[]) => any): void,
scroll(
coordinates: OverlayScrollbars$OverlayScrollbars$Coordinates,
options: {}): void,
...
options: {}): OverlayScrollbars$OverlayScrollbars$Extension,
removeExt(extensionName: string): boolean
} 
	declare interface OverlayScrollbarsStatic {
(element: HTMLElement | Element | JQuery, options: OverlayScrollbars$OverlayScrollbars$Options, extensions?: string | $ReadOnlyArray<string> | {
[extensionName: string]: {}
}): OverlayScrollbars,
(element: HTMLElement | Element | JQuery | null): OverlayScrollbars | void,
(elements: NodeListOf<Element> | $ReadOnlyArray<Element> | JQuery, options: OverlayScrollbars$OverlayScrollbars$Options, extensions?: string | $ReadOnlyArray<string> | {
[extensionName: string]: {}
}): OverlayScrollbars | OverlayScrollbars[] | void,
(elements: NodeListOf<Element> | $ReadOnlyArray<Element> | JQuery, filter?: string | ((element: Element, instance: OverlayScrollbars) => boolean)): OverlayScrollbars | OverlayScrollbars[] | void,
globals(): OverlayScrollbars$OverlayScrollbars$Globals,
defaultOptions(): OverlayScrollbars$OverlayScrollbars$Options,
defaultOptions(newDefaultOptions: OverlayScrollbars$OverlayScrollbars$Options): void,
extension(
): {
[index: number]: OverlayScrollbars$OverlayScrollbars$ExtensionInfo,
length: number
},
extension(extensionName: string): OverlayScrollbars$OverlayScrollbars$ExtensionInfo,
extension(
extensionName: string,
extensionFactory: (
defaultOptions: {},
compatibility: OverlayScrollbars$OverlayScrollbars$Compatibility,
framework: any) => OverlayScrollbars$OverlayScrollbars$Extension,
defaultOptions?: {}): void,
...
overlayScrollbars(
filter?: string | ((element: Element, instance: OverlayScrollbars) => boolean)): OverlayScrollbars | OverlayScrollbars[] | void
} 
