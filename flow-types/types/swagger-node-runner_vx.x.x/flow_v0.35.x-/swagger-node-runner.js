 ...
 */
declare export type SwaggerToolsMiddleware = (req: any, res: any, next: any) => any;
 ...
 */
declare export function create(config: Config, cb: (err: Error | void, runner: Runner) => void): void
