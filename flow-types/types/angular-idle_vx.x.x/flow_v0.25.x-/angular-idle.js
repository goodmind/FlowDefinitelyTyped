 ...
 */
declare type idle$ITitleProvider = {
  /**
...
declare interface idle$ITitleService {
  /**
 ...
 */
declare type idle$IKeepAliveProvider = {
  /**
 ...
 */
declare interface idle$IKeepAliveService {
  /**
 ...
 */
declare type idle$IIdleProvider = {
  /**
 ...
 */
declare interface idle$IIdleService {
  /**
