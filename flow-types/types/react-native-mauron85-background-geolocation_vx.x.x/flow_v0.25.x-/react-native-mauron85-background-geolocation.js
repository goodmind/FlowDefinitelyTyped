declare module "react-native-mauron85-background-geolocation" {
  declare export type Event =
    ...
    | "background"
    | "abort_requested";
  declare export type iOSActivityType =
    | "AutomotiveNavigation"
    | "OtherNavigation"
    | "Fitness"
    | "Other";
  declare export type Provider = "gps" | "network" | "passive" | "fused";
  declare export type ActivityType =
    | "IN_VEHICLE"
    | "ON_BICYCLE"
    | "ON_FOOT"
    | "RUNNING"
    ...
    | "UNKNOWN"
    | "WALKING";
  declare export type LogLevel = "TRACE" | "DEBUG" | "INFO" | "WARN" | "ERROR";
  declare export type HeadlessTaskEventName =
    | "location"
    | "stationary"
    | "activity";
