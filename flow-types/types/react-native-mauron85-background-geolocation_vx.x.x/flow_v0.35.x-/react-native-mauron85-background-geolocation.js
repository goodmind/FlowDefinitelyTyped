declare module 'react-native-mauron85-background-geolocation' {
        declare export type Event = "location"
| "stationary"
| "activity"
| "start"
| "stop"
...
| "background"
| "abort_requested";
	declare export type iOSActivityType = "AutomotiveNavigation" | "OtherNavigation" | "Fitness" | "Other";
	declare export type Provider = "gps" | "network" | "passive" | "fused";
	declare export type ActivityType = "IN_VEHICLE"
| "ON_BICYCLE"
| "ON_FOOT"
| "RUNNING"
| "STILL"
...
| "UNKNOWN"
| "WALKING";
	declare export type LogLevel = "TRACE"
| "DEBUG"
| "INFO"
| "WARN"
| "ERROR";
	declare export type HeadlessTaskEventName = "location" | "stationary" | "activity";
...
postTemplate?: any
	...
	declare export interface LocationOptions {
...
enableHighAccuracy?: boolean
	...
	declare export interface LocationError {
...
stackTrace: string
	...
	declare export interface ServiceStatus {
isRunning: boolean,
locationServicesEnabled: boolean,
authorization: number,
hasPermissions: boolean
} 
	declare export interface EventSubscription {
remove(): void
} 
	declare export interface HeadlessTaskEvent {
...
params: any
	...
	declare export interface BackgroundGeolocationStatic {
...
headlessTask(callbackfn: (event: HeadlessTaskEvent) => void): void
	...
	declare var BackgroundGeolocation: BackgroundGeolocationStatic;
	declare export default typeof BackgroundGeolocation
