declare module "awesomplete" {
  declare class Awesomplete {
    constructor(
      ...
      o?: Awesomplete$Awesomplete$Options
    ): this;
    static all: any[];
    ...
    static DATA: (
      item: Awesomplete$Awesomplete$Suggestion
    ) => Awesomplete$Awesomplete$Suggestion;
    next: () => void;
  ...
  declare type Awesomplete$Suggestion =
    | string
    | {
        label: string | any,
        value: string | any
  ...
  declare type Awesomplete$SortFunction = (
    left: number | any[],
    right: number | any[]
  ) => number;
