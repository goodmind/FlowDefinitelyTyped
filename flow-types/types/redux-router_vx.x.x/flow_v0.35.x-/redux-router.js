declare module 'redux-router' {
	...
	import type {
          historyAPI,pushState,push,replaceState,replace,setState,go,goBack,goForward
        } from './lib/actionCreators';

	declare export {
          ReduxRouter,routerStateReducer,reduxReactRouter,isActive,historyAPI,pushState,push,replaceState,replace,setState,go,goBack,goForward
        }
