declare module "react-sparklines" {
  ...
  declare export interface SparklinesProps {
    ...
    width?: number;
    height?: number;
    svgWidth?: $ElementType<
      React.SVGAttributes<React.ReactSVGElement>,
      "width"
    >;
    svgHeight?: $ElementType<
      React.SVGAttributes<React.ReactSVGElement>,
      "height"
    >;
    preserveAspectRatio?: $ElementType<
      React.SVGAttributes<React.ReactSVGElement>,
      "preserveAspectRatio"
    >;
    margin?: number;
  ...
  declare export class SparklinesBars
    mixins React.Component<SparklinesBarsProps> {}
  declare export interface SparklinesCurveProps {
    color?: $ElementType<React.SVGAttributes<React.ReactSVGElement>, "color">;
    style?: $ElementType<React.SVGAttributes<React.ReactSVGElement>, "style">;
  }
  declare export class SparklinesCurve
    mixins React.Component<SparklinesCurveProps> {}
  ...
  declare export class SparklinesLine
    mixins React.Component<SparklinesLineProps> {}
  declare export interface SparklinesNormalBandProps {
    style?: $ElementType<React.SVGAttributes<React.ReactSVGElement>, "style">;
  }
  declare export class SparklinesNormalBand
    mixins React.Component<SparklinesNormalBandProps> {}
  declare export interface SparklinesReferenceLineProps {
    type?: "max" | "min" | "mean" | "avg" | "median" | "custom";
    value?: number;
    style?: $ElementType<React.SVGAttributes<React.ReactSVGElement>, "style">;
  }
  declare export class SparklinesReferenceLine
    mixins React.Component<SparklinesReferenceLineProps> {}
  ...
  declare export class SparklinesSpots
    mixins React.Component<SparklinesSpotsProps> {}
  ...
  declare export class SparklinesText
    mixins React.Component<SparklinesTextProps> {}
}
