...
declare type LanguageCodes$ALL =
...
declare module "qlik" {
  ...
  declare export type InitialProperties =
  ...
  declare export type CustomPropertyOptions =
  ...
  declare export type CustomProperty =
  ...
  declare export function callRepository(
    path: string,
    method: string,
    body: string
  ): Promise<any>;
  ...
  declare export function getAppList(
    callback: App[],
    config: GetAppConfig
  ): void;
  ...
  declare export function registerExtension(
    id: string,
    impl: Extension,
  ...
  declare export function setLanguage(
    lang: LanguageCodes$LanguageCodes$ALL
  ): void;
  ...
  declare export function setOnError(
