...
constructor(tabStripDirection?: dockspawn$TabStripDirection, displayCloseButton?: boolean): this;
...
static +DIRECTION_TOP: Class<dockspawn$TabStripDirection__DIRECTION_TOP> & dockspawn$TabStripDirection__DIRECTION_TOP & 0;// 0
static +DIRECTION_BOTTOM: Class<dockspawn$TabStripDirection__DIRECTION_BOTTOM> & dockspawn$TabStripDirection__DIRECTION_BOTTOM & 1;// 1
static +DIRECTION_LEFT: Class<dockspawn$TabStripDirection__DIRECTION_LEFT> & dockspawn$TabStripDirection__DIRECTION_LEFT & 2;// 2
static +DIRECTION_RIGHT: Class<dockspawn$TabStripDirection__DIRECTION_RIGHT> & dockspawn$TabStripDirection__DIRECTION_RIGHT & 3;// 3

}

declare class dockspawn$TabStripDirection__DIRECTION_TOP mixins dockspawn$TabStripDirection {}
declare class dockspawn$TabStripDirection__DIRECTION_BOTTOM mixins dockspawn$TabStripDirection {}
declare class dockspawn$TabStripDirection__DIRECTION_LEFT mixins dockspawn$TabStripDirection {}
declare class dockspawn$TabStripDirection__DIRECTION_RIGHT mixins dockspawn$TabStripDirection {}
...
constructor(dockManager: dockspawn$DockManager, tabStripDirection?: dockspawn$TabStripDirection): this
}
 ...
 */
declare class dockspawn$DocumentManagerContainer mixins dockspawn$FillDockContainer {
...
static fromElement(id: string, dockManager: dockspawn$DockManager): dockspawn$Dialog;
