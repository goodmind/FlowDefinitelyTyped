 ...
 */
declare export interface KatexOptions {
...
strict?: boolean | string | Function
	...
	declare export class ParseError mixins Error {
 ...
 */
declare export function render(tex: string, element: HTMLElement, options?: KatexOptions): void
 ...
 * @param options KaTeX options
 */
declare export function renderToString(tex: string, options?: KatexOptions): string
