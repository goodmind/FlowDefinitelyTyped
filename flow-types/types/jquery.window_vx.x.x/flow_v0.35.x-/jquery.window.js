...
(options: JQueryWindow$WindowOptions): JQueryWindow$JQueryWindow$Window,
 ...
 */
getAll(): Array<JQueryWindow$JQueryWindow$Window>,

/**
 * get the window instance by passed window id
 */
getWindow(windowId: string): JQueryWindow$JQueryWindow$Window,

/**
 * get the selected window instance
 */
getSelectedWindow(): JQueryWindow$JQueryWindow$Window
} 
 ...
 */
callback: (
btn: JQueryWindow$JQueryWindow$Button,
wnd: JQueryWindow$JQueryWindow$Window) => void
} 
	declare interface JQuery {
window(
options: JQueryWindow$JQueryWindow$WindowOptions): JQueryWindow$JQueryWindow$Window
} 
	declare interface JQueryStatic {
window: JQueryWindow$JQueryWindow$Static
} 
    }
