...
declare type maps$PointLiteral = maps$PointArrayLiteral | maps$PointObjectLiteral;

declare type maps$SizeArrayLiteral = [number, number];

declare type maps$SizeLiteral = maps$SizeArrayLiteral | maps$SizeObjectLiteral;

declare type maps$LatLngLiteral = maps$PointLiteral | maps$LatLngObjectLiteral;

declare type maps$PointBoundsArrayLiteral = [number, number, number, number];

declare type maps$PointBoundsLiteral = maps$PointBoundsArrayLiteral | maps$PointBoundsObjectLiteral;

declare type maps$LatLngBoundsLiteral = maps$PointBoundsLiteral | maps$LatLngBoundsObjectLiteral;

declare type maps$BoundsLiteral = maps$PointBoundsLiteral | maps$LatLngBoundsLiteral;
...
declare type maps$StylingFunction = (feature: maps$Feature) => maps$StyleOptions;

declare type maps$ArrayOfCoords = maps$Point[] | maps$LatLng[];

declare type maps$ArrayOfBounds = maps$PointBounds[] | maps$LatLngBounds[];

declare type maps$ArrayOfBoundsLiteral = maps$PointBoundsLiteral[] | maps$LatLngBoundsLiteral[];

declare type maps$forEachOverlayCallback = (overlay: maps$Marker | maps$Polyline | maps$Polygon, index: number) => void;
...
declare type maps$ArrayOfCoordsLiteral = maps$PointLiteral[] | maps$LatLngLiteral[];

declare type maps$strokeStyleType = "solid"
| "shortdash"
| "shortdot"
| "shortdashdot"
| "shortdashdotdot"
...
fromCoordToPoint(coord: maps$Coord): maps$Point,
fromOffsetToCoord(offset: maps$Point): maps$Coord,
fromOffsetToPoint(offset: maps$Point): maps$Point,
fromPointToCoord(point: maps$Point): maps$Coord,
fromPointToOffset(point: maps$Point): maps$Point,
getDestinationCoord(fromCoord: maps$Coord, angle: number, meter: number): maps$Coord,
getDistance(coord1: maps$Coord, coord2: maps$Coord): number,
getProjectionName(): number,
scaleDown(
operand: number | maps$Point | maps$Size,
zoom: number): number | maps$Point | maps$Size,
scaleUp(
operand: number | maps$Point | maps$Size,
zoom: number): number | maps$Point | maps$Size
} & maps$KVO
...
title: string,
link?: string,
bounds?: maps$Bounds | maps$BoundsLiteral | maps$ArrayOfBounds | maps$ArrayOfBoundsLiteral
} 
...
map?: maps$Map,
paths: maps$ArrayOfCoords[] | maps$KVOArrayOfCoords[] | maps$ArrayOfCoordsLiteral[],
strokeWeight?: number,
strokeOpacity?: number,
strokeColor?: string,
strokeStyle?: maps$strokeStyleType,
...
map?: maps$Map,
path: maps$ArrayOfCoords | maps$KVOArrayOfCoords | maps$ArrayOfCoordsLiteral,
strokeWeight?: number,
strokeOpacity?: number,
strokeColor?: string,
strokeStyle?: maps$strokeStyleType,
...
static +BUTTON: Class<maps$MapTypeControlStyle__BUTTON> & maps$MapTypeControlStyle__BUTTON & 0;// 0
static +DROPDOWN: Class<maps$MapTypeControlStyle__DROPDOWN> & maps$MapTypeControlStyle__DROPDOWN & 1;// 1

}

declare class maps$MapTypeControlStyle__BUTTON mixins maps$MapTypeControlStyle {}
declare class maps$MapTypeControlStyle__DROPDOWN mixins maps$MapTypeControlStyle {}


declare  class maps$ZoomControlStyle {
  constructor(...args: empty): mixed;
static +LARGE: Class<maps$ZoomControlStyle__LARGE> & maps$ZoomControlStyle__LARGE & 0;// 0
static +SMALL: Class<maps$ZoomControlStyle__SMALL> & maps$ZoomControlStyle__SMALL & 1;// 1
...
declare  class maps$PointingIcon {
  constructor(...args: empty): mixed;
static +OPEN_ARROW: Class<maps$PointingIcon__OPEN_ARROW> & maps$PointingIcon__OPEN_ARROW & 1;// 1
static +BLOCK_ARROW: Class<maps$PointingIcon__BLOCK_ARROW> & maps$PointingIcon__BLOCK_ARROW & 1;// 1
static +CIRCLE: Class<maps$PointingIcon__CIRCLE> & maps$PointingIcon__CIRCLE & 2;// 2
static +DIAMOND: Class<maps$PointingIcon__DIAMOND> & maps$PointingIcon__DIAMOND & 3;// 3
...
static +TOP_LEFT: Class<maps$Position__TOP_LEFT> & maps$Position__TOP_LEFT & 1;// 1
static +TOP_CENTER: Class<maps$Position__TOP_CENTER> & maps$Position__TOP_CENTER & 2;// 2
static +TOP_RIGHT: Class<maps$Position__TOP_RIGHT> & maps$Position__TOP_RIGHT & 3;// 3
static +LEFT_CENTER: Class<maps$Position__LEFT_CENTER> & maps$Position__LEFT_CENTER & 4;// 4
static +LEFT_TOP: Class<maps$Position__LEFT_TOP> & maps$Position__LEFT_TOP & 5;// 5
static +LEFT_BOTTOM: Class<maps$Position__LEFT_BOTTOM> & maps$Position__LEFT_BOTTOM & 6;// 6
static +RIGHT_TOP: Class<maps$Position__RIGHT_TOP> & maps$Position__RIGHT_TOP & 7;// 7
static +RIGHT_CENTER: Class<maps$Position__RIGHT_CENTER> & maps$Position__RIGHT_CENTER & 8;// 8
static +RIGHT_BOTTOM: Class<maps$Position__RIGHT_BOTTOM> & maps$Position__RIGHT_BOTTOM & 9;// 9
static +BOTTOM_LEFT: Class<maps$Position__BOTTOM_LEFT> & maps$Position__BOTTOM_LEFT & 10;// 10
static +BOTTOM_CENTER: Class<maps$Position__BOTTOM_CENTER> & maps$Position__BOTTOM_CENTER & 11;// 11
static +BOTTOM_RIGHT: Class<maps$Position__BOTTOM_RIGHT> & maps$Position__BOTTOM_RIGHT & 12;// 12
...
declare  class maps$SymbolPath {
  constructor(...args: empty): mixed;
static +BACKWARD_CLOSED_ARROW: Class<maps$SymbolPath__BACKWARD_CLOSED_ARROW> & maps$SymbolPath__BACKWARD_CLOSED_ARROW & 1;// 1
...
removeListener(listeners: maps$MapEventListener | maps$MapEventListener[]): void;
...
pointN: maps$Coord | maps$PointLiteral): maps$PointBounds;
...
latlngN: maps$Coord | maps$LatLngLiteral): maps$LatLngBounds;
...
constructor(mapDiv: string | HTMLElement, mapOptions?: maps$MapOptions): this;
...
zoom?: number,
transitionOptions?: maps$TransitionOptions): void;
...
remove(): void;
reset(mapType: maps$MapType, zoom: number, tileOptions?: maps$TileOptions): void;
setBlank(): void;
...
declare function maps$NaverMapTypeOption(options: maps$NaverImageMapTypeOptions): void
...
declare function NaverMapTypeOption$getBicycleLayer(opts: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getBlankMap(opts: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getCadastralLayer(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getHybridMap(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getMapTypes(opts?: maps$NaverImageMapTypeOptions): maps$MapTypeRegistry


declare function NaverMapTypeOption$getNormalLabelLayer(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getNormalMap(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getSatelliteLabelLayer(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getSatelliteMap(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getStreetLayer(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getTerrainMap(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getTrafficLayer(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getVectorMap(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType


declare function NaverMapTypeOption$getWorldMap(opts?: maps$NaverImageMapTypeOptions): maps$ImageMapType
...
constructor(name: string, maps$MapTypeRegistry: maps$MapTypeRegistry, options: maps$LayerOptions): this;
...
constructor(url: string, bounds: maps$Bounds | maps$BoundsLiteral, options?: maps$GroundOverlayOptions): this;
getBounds(): maps$Bounds;
getOpacity(): number;
getUrl(): string;
setOpacity(opacity: number): void
...
getZIndex(): number;
open(map: maps$Map, anchor: maps$Coord | maps$CoordLiteral | maps$Marker): void;
...
setIcon(icon: string | maps$ImageIcon | maps$SymbolIcon | maps$HtmlIcon): void;
...
setPath(
path: maps$ArrayOfCoords | maps$KVOArrayOfCoords | maps$ArrayOfCoordsLiteral): void;
...
constructor(panoramaDiv: string | HTMLElement, panoramaOptions: maps$PanoramaOptions): this;
...
setEditable: (
editable: boolean,
drawing$controlPointOptions?: drawing$controlPointOptions) => void
} 

declare  class drawing$DrawingStyle {
  constructor(...args: empty): mixed;
static +HORIZONTAL: Class<drawing$DrawingStyle__HORIZONTAL> & drawing$DrawingStyle__HORIZONTAL & 0;// 0
static +VERTICAL: Class<drawing$DrawingStyle__VERTICAL> & drawing$DrawingStyle__VERTICAL & 1;// 1
static +HORIZONTAL_2: Class<drawing$DrawingStyle__HORIZONTAL_2> & drawing$DrawingStyle__HORIZONTAL_2 & 2;// 2
static +VERTICAL_2: Class<drawing$DrawingStyle__VERTICAL_2> & drawing$DrawingStyle__VERTICAL_2 & 3;// 3
...
declare class drawing$DrawingStyle__HORIZONTAL_2 mixins drawing$DrawingStyle {}
declare class drawing$DrawingStyle__VERTICAL_2 mixins drawing$DrawingStyle {}


declare  class drawing$DrawingMode {
  constructor(...args: empty): mixed;
static +HAND: Class<drawing$DrawingMode__HAND> & drawing$DrawingMode__HAND & 0;// 0
static +RECTANGLE: Class<drawing$DrawingMode__RECTANGLE> & drawing$DrawingMode__RECTANGLE & 1;// 1
static +ELLIPSE: Class<drawing$DrawingMode__ELLIPSE> & drawing$DrawingMode__ELLIPSE & 2;// 2
static +POLYLINE: Class<drawing$DrawingMode__POLYLINE> & drawing$DrawingMode__POLYLINE & 3;// 3
static +ARROWLINE: Class<drawing$DrawingMode__ARROWLINE> & drawing$DrawingMode__ARROWLINE & 4;// 4
static +POLYGON: Class<drawing$DrawingMode__POLYGON> & drawing$DrawingMode__POLYGON & 5;// 5
static +MARKER: Class<drawing$DrawingMode__MARKER> & drawing$DrawingMode__MARKER & 6;// 6
...
declare  class drawing$DrawingEvent {
  constructor(...args: empty): mixed;
static +ADD: Class<drawing$DrawingEvent__ADD> & drawing$DrawingEvent__ADD & 0;// 0
static +REMOVE: Class<drawing$DrawingEvent__REMOVE> & drawing$DrawingEvent__REMOVE & 1;// 1
static +SELECT: Class<drawing$DrawingEvent__SELECT> & drawing$DrawingEvent__SELECT & 2;// 2
static +Added: Class<drawing$DrawingEvent__Added> & drawing$DrawingEvent__Added & 3;// 3
static +Removed: Class<drawing$DrawingEvent__Removed> & drawing$DrawingEvent__Removed & 4;// 4
static +Selected: Class<drawing$DrawingEvent__Selected> & drawing$DrawingEvent__Selected & 5;// 5
...
listener: (overlay: drawing$DrawingOverlay) => void): maps$MapEventListener;
destroy(): void;
...
map: maps$Map,
data: maps$LatLng[] | maps$PointArrayLiteral[] | visualization$WeightedLocation[],
opacity?: number,
radius?: number,
strokeWeight?: number,
strokeColor?: string,
...
declare  class visualization$SpectrumStyle {
  constructor(...args: empty): mixed;
static +JET: Class<visualization$SpectrumStyle__JET> & visualization$SpectrumStyle__JET & 0;// 0
static +HSV: Class<visualization$SpectrumStyle__HSV> & visualization$SpectrumStyle__HSV & 1;// 1
static +HOT: Class<visualization$SpectrumStyle__HOT> & visualization$SpectrumStyle__HOT & 2;// 2
static +COOL: Class<visualization$SpectrumStyle__COOL> & visualization$SpectrumStyle__COOL & 3;// 3
static +GREYS: Class<visualization$SpectrumStyle__GREYS> & visualization$SpectrumStyle__GREYS & 4;// 4
static +YIGnBu: Class<visualization$SpectrumStyle__YIGnBu> & visualization$SpectrumStyle__YIGnBu & 5;// 5
static +YIOrRd: Class<visualization$SpectrumStyle__YIOrRd> & visualization$SpectrumStyle__YIOrRd & 6;// 6
static +RdBu: Class<visualization$SpectrumStyle__RdBu> & visualization$SpectrumStyle__RdBu & 7;// 7
static +RAINBOW: Class<visualization$SpectrumStyle__RAINBOW> & visualization$SpectrumStyle__RAINBOW & 8;// 8
static +PORTLAND: Class<visualization$SpectrumStyle__PORTLAND> & visualization$SpectrumStyle__PORTLAND & 9;// 9
static +OXYGEN: Class<visualization$SpectrumStyle__OXYGEN> & visualization$SpectrumStyle__OXYGEN & 10;// 10

}

declare class visualization$SpectrumStyle__JET mixins visualization$SpectrumStyle {}
declare class visualization$SpectrumStyle__HSV mixins visualization$SpectrumStyle {}
declare class visualization$SpectrumStyle__HOT mixins visualization$SpectrumStyle {}
declare class visualization$SpectrumStyle__COOL mixins visualization$SpectrumStyle {}
declare class visualization$SpectrumStyle__GREYS mixins visualization$SpectrumStyle {}
declare class visualization$SpectrumStyle__YIGnBu mixins visualization$SpectrumStyle {}
declare class visualization$SpectrumStyle__YIOrRd mixins visualization$SpectrumStyle {}
declare class visualization$SpectrumStyle__RdBu mixins visualization$SpectrumStyle {}
declare class visualization$SpectrumStyle__RAINBOW mixins visualization$SpectrumStyle {}
declare class visualization$SpectrumStyle__PORTLAND mixins visualization$SpectrumStyle {}
declare class visualization$SpectrumStyle__OXYGEN mixins visualization$SpectrumStyle {}
...
listener: (overlay: maps$drawing.drawing$DrawingOverlay) => void): maps$MapEventListener;
destroy(): void;
...
redraw(): void;
setColorMap(colormap: visualization$SpectrumStyle, inReverse: boolean): void;
...
declare  class Service$CoordType {
  constructor(...args: empty): mixed;
static +LATLNG: Class<Service$CoordType__LATLNG> & Service$CoordType__LATLNG & 0;// 0
static +TM128: Class<Service$CoordType__TM128> & Service$CoordType__TM128 & 1;// 1
...
static +EUC_KR: Class<Service$Encoding__EUC_KR> & Service$Encoding__EUC_KR & 1;// 1
...
callback?: (status: Service$Status, response: Service$GeocodeResponse) => void): void


declare function Service$reverseGeocode(
options: Service$ReverseServiceOptions,
callback?: (status: Service$Status, response: Service$ReverseGeocodeResponse) => void): void
...
declare function TransCoord$fromEPSG3857ToLatLng(coord: maps$Point): maps$LatLng


declare function TransCoord$fromEPSG3857ToNaver(coord: maps$Point): maps$Point


declare function TransCoord$fromEPSG3857ToTM128(coord: maps$Point): maps$Point


declare function TransCoord$fromEPSG3857ToUTMK(coord: maps$Point): maps$Point


declare function TransCoord$fromLatLngToEPSG3857(latlng: maps$Coord): maps$Point
...
declare function TransCoord$fromTM128ToEPSG3857(tm128: maps$Point): maps$Point
...
declare function Event$addDOMListener(element: HTMLElement, eventName: string, listener: (event: any) => any): void


declare function Event$addListener(
target: any,
eventName: string,
listener: (event: any) => any): maps$MapEventListener


declare function Event$clearInstanceListeners(target: any): void


declare function Event$clearListeners(target: any, fromEventName: string): void
...
target: any,
toEventName: string): maps$MapEventListener
...
declare function Event$removeDOMListener(element: HTMLElement, eventName: string, listener: (event: any) => any): void


declare function Event$removeDOMListener(listeners: maps$DOMEventListener | maps$DOMEventListener[]): void


declare function Event$removeListener(listeners: maps$MapEventListener | maps$MapEventListener[]): void
...
declare function Event$trigger(target: any, eventName: string, eventObject?: any): void
...
declare function EPSG3857$getDestinationCoord(fromLatLng: maps$LatLng, angle: number, meter: number): maps$LatLng


declare function EPSG3857$getDistance(latlng1: maps$LatLng, latlng2: maps$LatLng): number
...
declare function UTMK$getDestinationCoord(fromLatLng: maps$LatLng, angle: number, meter: number): maps$LatLng


declare function UTMK$getDistance(latlng1: maps$LatLng, latlng2: maps$LatLng): number
...
declare function UTMK_NAVER$fromLatLngToNaver(latlng: maps$LatLng): maps$Point


declare function UTMK_NAVER$fromNaverToCoord(naverPoint: maps$Point): maps$LatLng


declare function UTMK_NAVER$fromNaverToLatLng(naverPoint: maps$Point): maps$LatLng


declare function UTMK_NAVER$fromNaverToPoint(naverPoint: maps$Point): maps$Point


declare function UTMK_NAVER$fromNaverToUTMK(naverPoint: maps$Point): maps$Point
...
declare function EPSG3857Coord$fromCoordToLatLng(coord: maps$Point): maps$LatLng


declare function EPSG3857Coord$fromCoordToPoint(coord: maps$Point): maps$Point


declare function EPSG3857Coord$fromEPSG3857ToLatLng(coord: maps$Point): maps$LatLng


declare function EPSG3857Coord$fromEPSG3857ToPoint(coord: maps$Point): maps$Point


declare function EPSG3857Coord$fromLatLngToCoord(coord: maps$Coord): maps$Point


declare function EPSG3857Coord$fromLatLngToEPSG3857(coord: maps$Coord): maps$Point


declare function EPSG3857Coord$fromPointToCoord(point: maps$Point): maps$Point


declare function EPSG3857Coord$fromPointToEPSG3857(point: maps$Point): maps$Point
...
declare function UTMK_NAVERCoord$fromCoordToLatLng(n: maps$Point): maps$LatLng


declare function UTMK_NAVERCoord$fromCoordToPoint(n: maps$Point): maps$Point


declare function UTMK_NAVERCoord$fromLatLngToCoord(latlng: maps$Coord): maps$Point


declare function UTMK_NAVERCoord$fromPointToCoord(point: maps$Point): maps$Point
