declare module 'josa' {
	...
	declare export type Josa = Topic
| Subject
| Objective
| Conjunction
| Means;
...
declare export function getJosaPicker(josa: Topic): (noun: string) => Topic
	...
	declare export function getJosaPicker(josa: Subject): (noun: string) => Subject

	declare export function getJosaPicker(josa: Objective): (noun: string) => Objective

	declare export function getJosaPicker(josa: Conjunction): (noun: string) => Conjunction
