...
declare module "global" {
  ...
  declare type Strophe$Status = _Strophe.Status;

  declare type Strophe$LogLevel = _Strophe.LogLevel;

  declare type Strophe$Builder = _Strophe.Builder;

  declare type Strophe$ConnectionOptions = _Strophe.ConnectionOptions;

  declare type Strophe$Connection = _Strophe.Connection;

  declare type Strophe$SASLMechanism = _Strophe.SASLMechanism;
...
declare module "strophe.js" {
  declare var npm$namespace$Strophe: {
    ...
    Status: typeof Strophe$Status,
    LogLevel: typeof Strophe$LogLevel,
    Builder: typeof Strophe$Builder,
    Connection: typeof Strophe$Connection
  };
   ...
   */
  declare function Strophe$forEachChild(
    elem: Element,
    elemName: string,
   ...
   */
  declare function Strophe$xmlElement(
    name: string,
    attrs?: any,
    text?: string
  ): Element;
   ...
   */
  declare function Strophe$log(
    level: $Values<typeof Strophe$LogLevel>,
    msg: string
  ): void;
  ...
  declare class Strophe$Connection {
    ...
    connect(
      ...
      pass?: string,
      callback?: (
        status: $Values<typeof Strophe$Status>,
        condition: string
      ) => any,
      wait?: number,
      hold?: number,
   ...
   */
  declare export function $build(name: string, attrs?: any): Strophe$Builder;
   ...
   *   A new Strophe.Builder object.
   */
  declare export function $msg(attrs?: any): Strophe$Builder;
   ...
   *   A new Strophe.Builder object.
   */
  declare export function $iq(attrs?: any): Strophe$Builder;
   ...
   *   A new Strophe.Builder object.
   */
  declare export function $pres(attrs?: any): Strophe$Builder;
