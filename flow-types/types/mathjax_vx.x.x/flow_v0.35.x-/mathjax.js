...
ExecuteHooks(hooks: any[], data: any[], reset: boolean): MathJax$CallbackObject,
...
Post(message: string, callback: MathJax$CallbackObject): MathJax$CallbackObject,
...
Interest(callback: MathJax$CallbackObject, ignorePast: boolean): MathJax$CallbackObject,
NoInterest(callback: MathJax$CallbackObject): void,
MessageHook(message: string, callback: MathJax$CallbackObject): MathJax$CallbackObject,
...
loadDomain(domain: string, callback: MathJax$CallbackObject): MathJax$CallbackObject,
Try(spec: any): void
} 
...
Zoom(jax: any, span: any, math: any, Mw: number, Mh: number): MathJax$ZoomStruct
} 
