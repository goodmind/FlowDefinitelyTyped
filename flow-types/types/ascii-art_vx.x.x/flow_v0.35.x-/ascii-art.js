declare module 'ascii-art' {
        declare export type StyleType = (text: string, style?: string, close?: boolean) => Art;
	declare export type FontType = ((
text: string,
font?: string,
styleOrCallback?: string | Cb,
callback?: Cb) => Art);
	declare export type ImageType = (options: {[key: string]: any}, callback?: Cb) => Art;
	declare export type TableType = (options: {[key: string]: any}, callback?: Cb) => Art;
	declare export type ArtworkType = (options: {[key: string]: any}, callback?: Cb) => Art;
