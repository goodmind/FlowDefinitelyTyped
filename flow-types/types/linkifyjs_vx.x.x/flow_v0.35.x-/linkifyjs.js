declare module 'linkifyjs' {
	...
	declare export type PossiblyFuncOfHrefAndType<T> = T | ((href: string, type: string) => T);
	declare export type PossiblyByType<T> = T | {
[type: string]: T | void
};
	declare export type EventHandler = (e: HTMLElement) => void;
	declare export interface LinkifyOptions {
 ...
 */
className?: PossiblyByType<PossiblyFuncOfHrefAndType<string | void>>,
 ...
 */
target?: PossiblyByType<PossiblyFuncOfHrefAndType<string | null | void>>,
