...
declare function HTMLHint$verify(fileContent: string, ruleSet?: RuleSet): LintResult[]


declare function HTMLHint$format(arrMessages: LintResult[], options?: FormatOptions): string[]
