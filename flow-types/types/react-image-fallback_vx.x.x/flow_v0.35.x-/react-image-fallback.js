declare module 'react-image-fallback' {
	...
	declare export default class ReactImageFallback mixins React.Component<ReactImageFallbackProps & React.DetailedHTMLProps<React.ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>, any> {}
