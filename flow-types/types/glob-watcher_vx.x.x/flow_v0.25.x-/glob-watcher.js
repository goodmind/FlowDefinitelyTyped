declare module "glob-watcher" {
  ...
  declare type GlobWatcher$AsyncType =
    | NodeJS$EventEmitter
    | PromiseLike<any>
    | {
        subscribe(
  ...
  declare interface GlobWatcher$WatchOptions {
    /**
     ...
     */
    awaitWriteFinish?: GlobWatcher$AwaitWriteFinishOptions | boolean;
  }

  declare interface GlobWatcher$AwaitWriteFinishOptions {
    /**
  ...
  declare export default typeof GlobWatcher;
}
