 ...
 */
declare function newGithubIssueUrl(options: newGithubIssueUrl$newGithubIssueUrl$Options): string

	declare type newGithubIssueUrl$Without<T, U> = $ObjMapi<{[k: Exclude<$Keys<T>, $Keys<U>>]: any}, <P>(P) => empty>;

declare type newGithubIssueUrl$XOR<T, U> = "There was Conditional Type, use $Call utility type";

declare type newGithubIssueUrl$Options = newGithubIssueUrl$XOR<newGithubIssueUrl$RepoUrlOptions, newGithubIssueUrl$UserRepoOptions>;
