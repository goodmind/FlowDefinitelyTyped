...
destroy(
error: Error | null,
callback?: (error: Error | null) => void): _Readable$Readable | _Readable$Writable,
undestroy(): void
} 

declare type _Readable$DuplexOptions = _Readable$ReadableOptions & _Readable$WritableOptions & {
...
declare class _Readable$Duplex mixins _Readable$Writable, _Readable, stream._Readable$Duplex {
allowHalfOpen: boolean;
destroyed: boolean;
readable: boolean;
...
destroy(err?: Error, callback?: (error: Error | null) => void): this;
pipe<S: NodeJS.WritableStream>(dest: S, pipeOpts?: {
end?: boolean
}): S;
...
declare class _Readable$PassThrough mixins _Readable$Transform, stream._Readable$PassThrough {
constructor(options?: _Readable$TransformOptions): this;
_transform<T>(
chunk: T,
encoding: string | null | void,
callback: (error: any, data: T) => void): void
}
...
declare class _Readable$Transform mixins _Readable$Duplex, stream._Readable$Transform {
_transformState: {
