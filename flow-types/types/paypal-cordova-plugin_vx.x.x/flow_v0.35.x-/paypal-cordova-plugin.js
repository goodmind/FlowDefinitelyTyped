 ...
 * @ "my-client-id-for-Production",
PayPalEnvironmentSandbox :
 * @ "my-client-id-for-Sandbox"
}
 * @param completionCallback a callback function on success
 */
init(
clientIdsForEnvironments: PayPalCordovaPlugin$PayPalCordovaPlugin$PayPalClientIds,
...
completionCallback: (result: PayPalCordovaPlugin$PayPalCordovaPlugin$SinglePaymentResult) => void,
...
completionCallback: (result: PayPalCordovaPlugin$PayPalCordovaPlugin$FuturePaymentResult) => void,
cancelCallback: (cancelReason: string) => void): void,
...
cancelCallback: (cancelReason: string) => void): void
	...
	declare var PayPalMobile: PayPalCordovaPlugin$PayPalCordovaPlugin$PayPalMobileStatic;
    }
