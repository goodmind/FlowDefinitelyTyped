 ...
 */
declare function confetti(options?: confetti$confetti$Options): Promise<null> | null
 ...
 */
declare var confetti$Promise: any;

declare interface confetti$Options {
...
declare interface confetti$Origin {
