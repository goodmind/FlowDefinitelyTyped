declare module 'nvd3' {
	...
	declare var nv: nv$nv$Nvd3Static;
...
declare interface nv$ChartFactory<TChart: nv$Nvd3Element> {
generate: () => TChart,
callback?: (chart: TChart) => void
} 

declare interface nv$Nvd3TooltipStatic {
show(leftTop: [number, number], content: string, gravity?: string): void,
cleanup(): void
} 
...
declare interface nv$SankeyNodeStyleOptions {
title?: any,
fillColor?: any,
strokeColor?: any
} 
...
nodeStyle(): nv$SankeyNodeStyleOptions,
nodeStyle(value: nv$SankeyNodeStyleOptions): this,
width(): number,
width(value: number): this,
units(): string,
...
utils: nv$Utils,
logs: any,
addGraph<TChart: nv$Nvd3Element>(factory: nv$ChartFactory<TChart>): void,
addGraph<TChart: nv$Nvd3Element>(
generate: () => TChart,
callBack?: (chart: TChart) => void): void,
