...
PhysicalResourceId: string
	...
	declare export type CloudFormationCustomResourceEvent = CloudFormationCustomResourceCreateEvent | CloudFormationCustomResourceUpdateEvent | CloudFormationCustomResourceDeleteEvent;
...
Reason: string
	...
	declare export type CloudFormationCustomResourceResponse = CloudFormationCustomResourceSuccessResponse | CloudFormationCustomResourceFailedResponse;
 ...
 */
declare export type Statement = BaseStatement & StatementAction & (StatementResource | StatementPrincipal);
 ...
 */
declare export type CodePipelineState = "STARTED"
| "SUCCEEDED"
| "RESUMED"
| "FAILED"
| "CANCELED"
| "SUPERSEDED";
	declare export type CodePipelineStageState = "STARTED"
| "SUCCEEDED"
| "RESUMED"
| "FAILED"
| "CANCELED";
	declare export type CodePipelineActionState = "STARTED" | "SUCCEEDED" | "FAILED" | "CANCELED";
...
state: CodePipelineStageState
	...
	declare export type CodePipelineActionCategory = "Approval"
| "Build"
| "Deploy"
| "Invoke"
| "Source"
...
version: number
	...
	declare export type CodePipelineCloudWatchEvent = CodePipelineCloudWatchPipelineEvent | CodePipelineCloudWatchStageEvent | CodePipelineCloudWatchActionEvent;
...
response: CloudFrontResponse
	...
	declare export type CloudFrontRequestResult = void | null | CloudFrontResultResponse | CloudFrontRequest;
...
subsequenceNumber: string
	...
	declare export type FirehoseRecordTransformationStatus = "Ok" | "Dropped" | "ProcessingFailed";
...
[name: string]: string | null
	...
	declare export type LexDialogAction = LexDialogActionClose
 ...
 */
declare export type Handler<TEvent, TResult> = (
event: TEvent,
context: Context,
callback: Callback<TResult>) => void | Promise<TResult>;
 ...
 */
declare export type Callback<TResult> = (error?: Error | null | string, result?: TResult) => void;
	declare export type S3Handler = Handler<S3Event, void>;
	declare export type DynamoDBStreamHandler = Handler<DynamoDBStreamEvent, void>;
	...
	declare export type CloudFormationCustomResourceHandler = Handler<CloudFormationCustomResourceEvent, void>;
	declare export type CloudWatchLogsHandler = Handler<CloudWatchLogsEvent, void>;
	...
	declare export type APIGatewayProxyHandler = Handler<APIGatewayProxyEvent, APIGatewayProxyResult>;
	...
	declare export type CodePipelineCloudWatchHandler = Handler<CodePipelineCloudWatchEvent, void>;
	declare export type CodePipelineCloudWatchPipelineHandler = Handler<CodePipelineCloudWatchPipelineEvent, void>;
	declare export type CodePipelineCloudWatchStageHandler = Handler<CodePipelineCloudWatchStageEvent, void>;
	declare export type CodePipelineCloudWatchActionHandler = Handler<CodePipelineCloudWatchActionEvent, void>;
	declare export type CloudFrontRequestHandler = Handler<CloudFrontRequestEvent, CloudFrontRequestResult>;
	declare export type CloudFrontRequestCallback = Callback<CloudFrontRequestResult>;
	declare export type CloudFrontResponseHandler = Handler<CloudFrontResponseEvent, CloudFrontResponseResult>;
	...
	declare export type FirehoseTransformationHandler = Handler<FirehoseTransformationEvent, FirehoseTransformationResult>;
	declare export type CustomAuthorizerHandler = Handler<CustomAuthorizerEvent, CustomAuthorizerResult>;
