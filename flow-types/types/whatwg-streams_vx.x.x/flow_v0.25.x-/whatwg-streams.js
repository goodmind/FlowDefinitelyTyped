declare module "whatwg-streams" {
  declare export interface ReadableStreamSource<R = ArrayBufferView> {
    start?: (
  ...
  declare export interface QueuingStrategy<T = ArrayBufferView> {
    size?: (chunk: T) => number;
  ...
  declare export interface WritableReadablePair<
    T: WritableStream<any>,
    U: ReadableStream<any>
  > {
    writable: T;
    readable: U;
  }
  ...
  declare class ReadableStream<R = ArrayBufferView> {
    ...
    pipeThrough<T: ReadableStream<any>>(
      writablereadable: WritableReadablePair<WritableStream<R>, T>,
      options?: PipeOptions
    ): T;
  ...
  declare interface WritableStreamSink<W = ArrayBufferView> {
    start?: (
  ...
  declare class TransformStream<R, W>
    mixins WritableReadablePair<WritableStream<W>, ReadableStream<R>> {
    constructor(
