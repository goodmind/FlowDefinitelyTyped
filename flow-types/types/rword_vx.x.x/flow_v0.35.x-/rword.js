...
randomly chosen.
 */
declare export function generate(count?: 1, options?: GenerateOptions): string
...
randomly chosen.
 */
declare export function generate(count: number, options?: GenerateOptions): string[]
...
returned. If greater than 1 an array of strings is returned.
 */
declare export function generateFromPool(count?: 1): string
...
returned. If greater than 1 an array of strings is returned.
 */
declare export function generateFromPool(count: 2
| 3
| 4
| 5
| 6
 ...
 */
declare export function shuffle(): void
