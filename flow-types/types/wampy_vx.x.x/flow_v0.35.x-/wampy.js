...
declare type wampy$RPCCallback = (args: wampy$DataArgs) => wampy$RPCResult | void;

declare type wampy$ChallengeCallback = (auth_method: string, extra: wampy$Dict) => string;

declare type wampy$Payload = wampy$Args
| wampy$Dict
| string
| number
| boolean
...
function Object() { [native code] }: wampy$WampyStatic,
...
subscribe(
topicURI: string,
callbacks: wampy$EventCallback | wampy$SubscribeCallbacksHash): wampy$Wampy,
unsubscribe(
topicURI: string,
callbacks?: wampy$EventCallback | wampy$UnsubscibeCallbacksHash): wampy$Wampy,
publish(
topicURI: string,
payload?: wampy$Payload,
callbacks?: wampy$PublishCallbacksHash,
advancedOptions?: wampy$PublishAdvancedOptions): wampy$Wampy,
call(
topicURI: string,
payload?: wampy$Payload,
callbacks?: wampy$SuccessCallback | wampy$CallCallbacksHash,
advancedOptions?: wampy$CallAdvancedOptions): wampy$Wampy,
cancel(
reqId: number,
callbacks?: wampy$Callback | wampy$CancelCallbacksHash,
advancedOptions?: wampy$CancelAdvancedOptions): wampy$Wampy,
register(
topicURI: string,
callbacks: wampy$RPCCallback | wampy$RegisterCallbacksHash,
avdancedOptions?: wampy$RegisterAdvancedOptions): wampy$Wampy,
unregister(
topicURI: string,
callbacks?: wampy$Callback | wampy$UnregisterCallbacksHash): wampy$Wampy
} 
