declare module "sharedb" {
  ...
  declare class sharedb {
    ...
    use(
      action: sharedb$sharedb$UseAction,
      fn: sharedb$sharedb$UseCallback
    ): void;
    static types: {
      register: (type: {
        name?: string,
  ...
  declare type sharedb$UseAction =
    | "connect"
    | "op"
    | "doc"
    | "query"
  ...
  declare class sharedb$PubSub {
    ...
    publish(
      ...
      callback: (err: sharedb$Error | null) => void
    ): void;
    subscribe(
      channel: string,
      callback: (err: sharedb$Error | null, stream?: Stream) => void
    ): void;
    _subscribe(
      channel: string,
      callback: (err: sharedb$Error | null) => void
  ...
  declare class sharedb$Connection {
    ...
    createFetchQuery(
      ...
      callback: (err: sharedb$Error, results: any) => any
    ): ShareDB.sharedb$Query;
