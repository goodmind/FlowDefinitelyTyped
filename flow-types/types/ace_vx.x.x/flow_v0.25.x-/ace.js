declare module "ace" {
  declare var npm$namespace$AceAjax: {
    Anchor: typeof AceAjax$Anchor,
    BackgroundTokenizer: typeof AceAjax$BackgroundTokenizer,
    Document: typeof AceAjax$Document,
    EditSession: typeof AceAjax$EditSession,
    Editor: typeof AceAjax$Editor,
    PlaceHolder: typeof AceAjax$PlaceHolder,
    RangeList: typeof AceAjax$RangeList,
    Range: typeof AceAjax$Range,
    RenderLoop: typeof AceAjax$RenderLoop,
    ScrollBar: typeof AceAjax$ScrollBar,
    Search: typeof AceAjax$Search,
    Selection: typeof AceAjax$Selection,
    Split: typeof AceAjax$Split,
    TokenIterator: typeof AceAjax$TokenIterator,
    Tokenizer: typeof AceAjax$Tokenizer,
    UndoManager: typeof AceAjax$UndoManager,
    VirtualRenderer: typeof AceAjax$VirtualRenderer
  };
  ...
  declare export interface AceAjax$OptionProvider {
    /**
  ...
  declare export interface AceAjax$Ace {
     ...
     */
    createEditSession(
      text: AceAjax$Document,
      mode: AceAjax$TextMode
 ...
 */
  ...
  declare var AceAjax$BackgroundTokenizer: {
    /**
 ...
 */
   ...
   */
  declare export type AceAjax$IEditSession = {
     ...
     */
    getTokenAt(row: number, column: number): AceAjax$TokenInfo | null,
   ...
   */
  declare export type AceAjax$Editor = {
    on(ev: string, callback: (e: any) => any): void,
    addEventListener(
      ev: "change",
      callback: (ev: AceAjax$EditorChangeEvent) => any
    ): void,
  ...
  declare var AceAjax$PlaceHolder: {
    /**
  ...
  declare export var AceAjax$RangeList: {
  ...
  declare var AceAjax$RenderLoop: {
 ...
 */
  ...
  declare var AceAjax$TokenIterator: {
    /**
  ...
  declare var AceAjax$UndoManager: {
    /**
   ...
   */
  declare export type AceAjax$VirtualRenderer = {
    scroller: any,
  ...
  declare export interface AceAjax$Completer {
    /**
    ...
    getCompletions: (
      ...
      pos: AceAjax$Position,
      prefix: string,
      callback: AceAjax$CompletionCallback
    ) => void;
     ...
     */
    getDocTooltip?: (item: AceAjax$Completion) => void;
  }

  declare export interface AceAjax$Completion {
    value: string;
    meta: string;
    type?: string;
    caption?: string;
  ...
  declare export type AceAjax$CompletionCallback = (
    error: Error,
