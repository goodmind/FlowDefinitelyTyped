...
pos: AceAjax$Position,
prefix: string,
callback: AceAjax$CompletionCallback) => void,
...
declare export type AceAjax$CompletionCallback = (error: Error, results: AceAjax$Completion[]) => void;
