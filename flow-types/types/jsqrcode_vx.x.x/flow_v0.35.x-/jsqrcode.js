...
constructor(image: Uint8Array, startX: number, startY: number, width: number, height: number, moduleSize: number, resultPointCallback: ResultPointCallback): this;
...
constructor(blocks: number[], version: number, numErrorCorrectionCode: number): this;
...
y2p: number,
x3p: number,
y3p: number): PerspectiveTransform;
...
x3: number,
y3: number): PerspectiveTransform;
constructor(a11: number, a21: number, a31: number, a12: number, a22: number, a32: number, a13: number, a23: number, a33: number): this;
...
bits: BitMatrix;
points: [DetectorResult, DetectorResult, DetectorResult] | [DetectorResult, DetectorResult, DetectorResult, DetectorResult];
constructor(bits: BitMatrix, points: [DetectorResult, DetectorResult, DetectorResult] | [DetectorResult, DetectorResult, DetectorResult, DetectorResult]): this
}
...
bottomLeft: AlignmentPattern): number;
...
dimension: number): PerspectiveTransform;
sampleGrid(
image: Uint8Array,
...
TopLeft: AlignmentPattern;
TopRight: AlignmentPattern;
constructor(patternCenters: [AlignmentPattern, AlignmentPattern, AlignmentPattern]): this
}
...
findFinderPattern(image: Uint8Array): FinderPatternInfo
	...
	declare var FORMAT_INFO_DECODE_LOOKUP: [[21522, 0], [20773, 1], [24188, 2], [23371, 3], [17913, 4], [16590, 5], [20375, 6], [19104, 7], [30660, 8], [29427, 9], [32170, 10], [30877, 11], [26159, 12], [25368, 13], [27713, 14], [26998, 15], [5769, 16], [5054, 17], [7399, 18], [6608, 19], [1890, 20], [597, 21], [3340, 22], [2107, 23], [13663, 24], [12392, 25], [16177, 26], [14854, 27], [9396, 28], [8579, 29], [11994, 30], [11245, 31]];
	declare var BITS_SET_IN_HALF_BYTE: [0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2, 3, 2, 3, 3, 4];
...
NumBlocks: number;
constructor(ecCodewordsPerBlock: number, ecBlocks1: ECB, ecBlocks2?: ECB): this;
getECBlocks(): [ECB] | [ECB, ECB]
}
	declare class Version  {
static VERSION_DECODE_INFO: [31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017];
...
constructor(versionNumber: number, alignmentPatternCenters: number[], ecBlocks1: ECBlocks, ecBlocks2: ECBlocks, ecBlocks3: ECBlocks, ecBlocks4: ECBlocks): this;
