...
(error: Error, matched?: boolean): void
	...
	declare export interface ExopCallback {
...
[key: string]: any
	...
	declare export var Change: {
new (change: Change): Change
};
	declare export interface SearchCallBack {
(error: Error, result: EventEmitter): void
} 
	declare export type Control = any;
...
_bypass: boolean): void,
search(
base: string,
options: SearchOptions,
controls: Control | Array<Control>,
callback: SearchCallBack): void,
search(
base: string,
options: SearchOptions,
controls: Control | Array<Control>,
...
destroy(err?: any): void
	...
	declare export function createClient(options?: ClientOptions): Client

	declare class Filter  {
matches(obj: any): boolean;
type: string
}
	declare export function parseFilter(filterString: string): Filter

	declare export class EqualityFilter mixins Filter {
constructor(options: {
attribute: string,
value: string
}): this
}
	declare export class PresenceFilter mixins Filter {
constructor(options: {
attribute: string
}): this
}
	declare export class SubstringFilter mixins Filter {
constructor(options: {
attribute: string,
initial: string,
any?: string[],
final?: string
	...
	declare export class GreaterThanEqualsFilter mixins Filter {
constructor(options: {
attribute: string,
value: string
}): this
}
	declare export class LessThanEqualsFilter mixins Filter {
constructor(options: {
attribute: string,
value: string
}): this
...
filter: Filter
	...
	declare export class ApproximateFilter mixins Filter {
constructor(options: {
attribute: string,
value: string
}): this
