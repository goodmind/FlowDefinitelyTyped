declare module "openstack-wrapper" {
  declare export interface RequestOption {
    uri?: string;
    headers?: any;
    json?: any;
    timeout?: any;
  ...
  declare export function getSimpleProject(
    username: string,
    password: string,
    project_id: string,
    keystone_url: string,
  ...
  declare export class Nova {
    ...
    user_name: any;
    logger: any;
    constructor(endpoint_url: string, auth_token: string): this;
  ...
  declare export class Keystone {
    ...
    user_name: any;
    logger: any;
    constructor(endpoint_url: string): this;
    setTimeout(new_timeout: any): void;
    setRequestID(request_id: any): void;
    setUserName(user_name: string): void;
    setLogger(logger: any): void;
