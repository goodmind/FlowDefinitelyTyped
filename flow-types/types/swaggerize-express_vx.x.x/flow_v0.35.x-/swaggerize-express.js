declare module 'swaggerize-express' {
        declare function swaggerize(options: swaggerize$swaggerize$Options): express.RequestHandler
...
declare export interface swaggerize$RouteSegment {
[urlSegment: string]: swaggerize$RouteSegment | express.RequestHandler | express.RequestHandler[]
} 
