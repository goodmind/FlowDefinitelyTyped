declare module "apigee-access" {
  ...
  declare function ApigeeAccess$getVariable(
    request: any,
    name: string
  ): string | number | boolean;

  declare function ApigeeAccess$setVariable(
    request: any,
    name: string,
    value: string | number | boolean
  ): void;

  declare function ApigeeAccess$setIntVariable(
    request: any,
    name: string,
    value: string | number
  ): void;

  declare function ApigeeAccess$deleteVariable(
    request: any,
    name: string
  ): void;

  declare function ApigeeAccess$getCache(
    name: string,
    options?: ApigeeAccess$CacheOptions
  ): any;

  declare function ApigeeAccess$getVault(
    name: string,
    scope?: "organization" | "environment"
  ): ApigeeAccess$SecureVault;

  declare function ApigeeAccess$getQuota(
    options?: any
  ): ApigeeAccess$QuotaService;
  ...
  declare interface ApigeeAccess$QuotaService {
    apply(
      ...
      callback?: (
        err: any,
        data: ApigeeAccess$QuotaServiceApplyCallbackData
      ) => void
    ): void;
  }
