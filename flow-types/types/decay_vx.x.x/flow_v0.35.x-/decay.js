 ...
 */
declare export function redditHot(decay?: number): RedditHotFunction
 ...
 * @return calculator function
 */
declare export function hackerHot(gravity?: number): HackerNewsHotFunction
 ...
 */
declare export function wilsonScore(confidence?: number): WilsonScoreFunction
 ...
 * @return ranking
 */
declare export type RedditHotFunction = (upvotes: number, downvotes: number, date: Date) => number;
 ...
 * @return ranking
 */
declare export type HackerNewsHotFunction = (votes: number, date: Date) => number;
 ...
 * @return ranking
 */
declare export type WilsonScoreFunction = (upvotes: number, downvotes: number) => number;
    }
