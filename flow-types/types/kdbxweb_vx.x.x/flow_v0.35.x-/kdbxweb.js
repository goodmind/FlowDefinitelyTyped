...
constructor(password: ProtectedValue, keyFile: string | ArrayBuffer | Uint8Array): this;
...
declare function ByteUtils$arrayBufferEquals(ab1: ArrayBuffer, ab2: ArrayBuffer): boolean


declare function ByteUtils$arrayToBuffer(arr: Uint8Array | ArrayBuffer): ArrayBuffer


declare function ByteUtils$base64ToBytes(str: string): Uint8Array


declare function ByteUtils$bytesToBase64(arr: Uint8Array | ArrayBuffer): string


declare function ByteUtils$bytesToHex(arr: Uint8Array | ArrayBuffer): string


declare function ByteUtils$bytesToString(arr: Uint8Array | ArrayBuffer): string
...
parallelism: number,
type: number,
version: number): Promise<ArrayBuffer>


declare function CryptoEngine$chacha20(data: ArrayBuffer, key: ArrayBuffer, iv: ArrayBuffer): Promise<ArrayBuffer>


declare function CryptoEngine$configure(
newSubtle: SubtleCrypto | null,
newWebCrypto: Crypto | null,
newNodeCrypto: Crypto | null): void


declare function CryptoEngine$createAesCbc(): any


declare function CryptoEngine$hmacSha256(key: ArrayBuffer, data: ArrayBuffer): Promise<ArrayBuffer>
