...
x: number,
y: number
}, target?: React.ReactElement<any>) => void,
onViewTap?: (point: {
x: number,
y: number
}, target?: React.ReactElement<any>) => void,
onScale?: (scale: number, target?: React.ReactElement<any>) => void
	...
	declare export default class ReactNativePhotoView mixins React.Component<ReactNativePhotoViewProps & ViewProps> {}
    }
