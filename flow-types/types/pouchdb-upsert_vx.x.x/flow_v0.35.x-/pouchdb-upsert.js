...
diffFun: PouchDB$UpsertDiffCallback<Content & Model>): Promise<PouchDB$UpsertResponse>,
...
callback: Core.Callback<PouchDB$UpsertResponse>): void,
 ...
 */
putIfNotExists<Model>(doc: Core.Document<Content & Model>): Promise<PouchDB$UpsertResponse>,
...
declare type PouchDB$CancelUpsert = ""
| 0
| false
| null
| void;
...
doc: $Shape<Core.Document<Content>>) => Content & $Shape<Core.IdMeta> | PouchDB$CancelUpsert;
