declare module 'hellosign-embedded' {
        ...
        declare interface SignedMessageEvent {
event: "signature_request_signed",
signature_id: string
} 
	declare interface DeclinedMessageEvent {
event: "signature_request_declined",
signature_id: string
} 
	declare interface CanceledMessageEvent {
event: "signature_request_canceled"
} 
	declare interface SentMessageEvent {
...
cc_email_addresses: Array<string>
	...
	declare interface TemplateCreatedMessageEvent {
...
name: string
	...
	declare interface ErrorMessageEvent {
event: "error",
description: string
} 
	declare type MessageEvent = SignedMessageEvent
