declare module "mithril-global" {
  ...
  declare export type MithrilGlobal$Lifecycle<
    A,
    S
  > = mithril.MithrilGlobal$Lifecycle<A, S>;

  declare export type MithrilGlobal$Hyperscript = mithril.MithrilGlobal$Hyperscript;

  declare export type MithrilGlobal$RouteResolver<
    S,
    P
  > = mithril.MithrilGlobal$RouteResolver<S, P>;
  ...
  declare export type MithrilGlobal$RequestOptions<
    T
  > = mithril.MithrilGlobal$RequestOptions<T>;
  ...
  declare export type MithrilGlobal$Vnode<A, S> = mithril.MithrilGlobal$Vnode<
    A,
    S
  >;

  declare export type MithrilGlobal$VnodeDOM<
    A,
    S
  > = mithril.MithrilGlobal$VnodeDOM<A, S>;

  declare export type MithrilGlobal$CVnode<A> = mithril.MithrilGlobal$CVnode<A>;

  declare export type MithrilGlobal$CVnodeDOM<
    A
  > = mithril.MithrilGlobal$CVnodeDOM<A>;

  declare export type MithrilGlobal$Component<
    A,
    S
  > = mithril.MithrilGlobal$Component<A, S>;

  declare export type MithrilGlobal$Comp<A, S> = mithril.MithrilGlobal$Comp<
    A,
    S
  >;

  declare export type MithrilGlobal$ClassComponent<
    A
  > = mithril.MithrilGlobal$ClassComponent<A>;

  declare export type MithrilGlobal$FactoryComponent<
    A
  > = mithril.MithrilGlobal$FactoryComponent<A>;

  declare export type MithrilGlobal$ComponentTypes<
    A,
    S
  > = mithril.MithrilGlobal$ComponentTypes<A, S>;
