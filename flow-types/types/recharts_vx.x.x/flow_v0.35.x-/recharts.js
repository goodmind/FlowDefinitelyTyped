declare module 'recharts' {
	...
	import type {
          getTickValues,getNiceTickValues,getTickValuesFixedDomain
        } from 'recharts-scale';
...
i?: number) => any;
	...
	declare export type TickGeneratorFunction = (noTicksProps: {[key: string]: any}) => any[];
	declare export type LabelFormatter = (label: string | number) => React.ReactNode;
...
index: number) => React.ReactNode;
	...
	declare export type DataKey = string | number | ((dataObject: any) => number | [number, number] | null);
	declare export type IconType = "plainline"
| "line"
| "square"
| "rect"
| "circle"
...
| "plainline";
	...
	declare export type AnimationEasingType = "ease"
| "ease-in"
| "ease-out"
| "ease-in-out"
| "linear";
	declare export type ScaleType = "auto"
| "linear"
| "pow"
| "sqrt"
| "log"
...
| "sequential"
| "threshold";
	declare export type PositionType = "top"
| "left"
| "right"
| "bottom"
| "inside"
...
| "end"
| "center";
	declare export type StackOffsetType = "sign"
| "expand"
| "none"
| "wiggle"
| "silhouette";
	declare export type LineType = "basis"
| "basisClosed"
| "basisOpen"
| "linear"
| "linearClosed"
...
| "stepAfter"
| CurveFactory;
	declare export type IfOverflowType = "hidden" | "visible" | "discard" | "extendDomain";
	declare export type AxisInterval = number | "preserveStart" | "preserveEnd" | "preserveStartEnd";
	declare export type PickedCSSStyleDeclarationKeys = "alignmentBaseline"
| "baselineShift"
| "clip"
| "clipPath"
| "clipRule"
...
animationEasing?: AnimationEasingType
	...
	declare export interface CategoricalChartWrapper<L> {
...
onTouchCancel?: RechartsFunction
	...
	declare export type PresentationAttributes<X, Y> = {
angle: number,
...
activeDot?: boolean | {[key: string]: any} | React.ReactElement<any> | ContentRenderer<any>,
dot?: boolean | {[key: string]: any} | React.ReactElement<any> | ContentRenderer<DotProps>,
label?: boolean | {[key: string]: any} | ContentRenderer<any> | React.ReactElement<any>,
hide?: boolean,
layout?: LayoutType,
baseLine?: number | any[],
isRange?: boolean,
points?: Point[]
} & EventAttributes & $Shape<PresentationAttributes> & Animatable

	declare export class Area mixins React.Component<AreaProps> {}
	declare export type AreaChartProps = CategoricalChartWrapper & EventAttributes;
...
data?: BarData[],
background?: boolean | React.ReactElement<any> | ContentRenderer<any> | {[key: string]: any},
label?: boolean
| Label
...
viewBox?: ViewBox,
tick?: boolean | ContentRenderer<any> | {[key: string]: any} | React.ReactElement<any>,
...
} & EventAttributes & $Shape<PresentationAttributes>

	declare export class CartesianAxis mixins React.Component<CartesianAxisProps> {}
	declare export type CoordinatesGenerator = (
arg: {
...
width?: number,
height?: number,
horizontal?: {[key: string]: any} | React.ReactElement<any> | ContentRenderer<LineProps & CartesianGridProps> | boolean,
vertical?: {[key: string]: any} | React.ReactElement<any> | ContentRenderer<LineProps & CartesianGridProps> | boolean,
...
verticalFill?: string[]
	...
	declare export class CartesianGrid mixins React.Component<CartesianGridProps> {}
	declare export type CellProps = {
onClick?: RechartsFunction
} & $Shape<PresentationAttributes>

	declare export class Cell mixins React.Component<CellProps> {}
	declare export type ComposedChartProps = CategoricalChartWrapper & EventAttributes;
	declare export class ComposedChart mixins React.Component<ComposedChartProps> {}
...
connectNulls?: boolean,
hide?: boolean,
activeDot?: {[key: string]: any} | React.ReactElement<any> | ContentRenderer<any> | boolean,
dot?: {[key: string]: any} | React.ReactElement<any> | ContentRenderer<DotProps> | boolean,
top?: number,
left?: number,
width?: number,
height?: number,
data?: {[key: string]: any}[],
dataKey: DataKey,
label?: boolean | {[key: string]: any} | React.ReactElement<any> | ContentRenderer<any>,
points?: Point[]
} & EventAttributes & $Shape<PresentationAttributes> & Animatable

	declare export class Line mixins React.Component<LineProps> {}
	declare export type LineChartProps = CategoricalChartWrapper & EventAttributes;
...
hide?: boolean,
labelLine?: {[key: string]: any} | ContentRenderer<LineProps & any> | React.ReactElement<any> | boolean,
label?: {
offsetRadius: number
} | React.ReactElement<any> | ContentRenderer<PieLabelRenderProps> | boolean,
activeShape?: {[key: string]: any} | ContentRenderer<any> | React.ReactElement<any>,
...
innerRadius?: number | string,
outerRadius?: number | string
} & EventAttributes & CategoricalChartWrapper<"centric">
...
tickFormatter?: TickFormatterFunction
	...
	declare export class PolarAngleAxis mixins React.Component<PolarAngleAxisProps> {}
...
coordinate: number
	...
	declare export type PolarRadiusAxisDomain = number | "auto" | "dataMin" | "dataMax";
...
axisLine?: boolean | {[key: string]: any},
tick?: boolean | {[key: string]: any} | React.ReactElement<any> | ContentRenderer<any>,
stroke?: string,
tickFormatter?: TickFormatterFunction,
...
allowDataOverflow?: boolean
	...
	declare export class PolarRadiusAxis mixins React.Component<PolarRadiusAxisProps> {}
...
activeDot?: {[key: string]: any} | React.ReactElement<any> | ContentRenderer<any> | boolean,
dot?: {[key: string]: any} | React.ReactElement<any> | ContentRenderer<DotProps> | boolean,
label?: {[key: string]: any} | React.ReactElement<any> | ContentRenderer<any> | boolean,
legendType?: LegendType,
hide?: boolean
} & EventAttributes & $Shape<PresentationAttributes> & Animatable
...
data?: RadialBarData[],
legendType?: LegendType,
label?: boolean | React.ReactElement<any> | ContentRenderer<any> | {[key: string]: any},
background?: boolean | React.ReactElement<any> | ContentRenderer<any> | {[key: string]: any},
hide?: boolean
} & EventAttributes & $Shape<PresentationAttributes> & Animatable
...
outerRadius?: string | number
	...
	declare export class RadialBarChart mixins React.Component<RadialBarChartProps> {}
...
shape?: ContentRenderer<ReferenceAreaProps & RectangleProps> | React.ReactElement<any>
	...
	declare export class ReferenceArea mixins React.Component<ReferenceAreaProps> {}
...
xAxisId?: string | number,
yAxisId?: string | number,
shape?: ContentRenderer<EventAttributes & $Shape<PresentationAttributes<number | string, number | string>> & {
cx: number,
cy: number
}> | React.ReactElement<any>
} & EventAttributes & $Shape<PresentationAttributes<number | string, number | string>>
...
y2: number
	...
	declare export class ReferenceLine mixins React.Component<ReferenceLineProps> {}
...
className?: string | number
	...
	declare export class ResponsiveContainer mixins React.Component<ResponsiveContainerProps> {}
...
line?: boolean | {[key: string]: any} | RechartsFunction | React.ReactElement<any>,
lineType?: "joint" | "fitting",
lineJointType?: LineType,
legendType?: LegendType,
activeIndex?: number,
activeShape?: {[key: string]: any} | RechartsFunction | React.ReactElement<any>,
shape?: "circle"
| "cross"
| "diamond"
| "square"
...
name?: string | number
	...
	declare export type ScatterChartProps = CategoricalChartWrapper & EventAttributes;
...
wrapperStyle?: {[key: string]: any},
cursor?: boolean | {[key: string]: any} | React.ReactElement<any> | React.StatelessComponent<any>,
...
valueAccessor?: RechartsFunction
	...
	declare export type AxisDomain = string
| number
| ContentRenderer<any>
| "auto"
| "dataMin"
