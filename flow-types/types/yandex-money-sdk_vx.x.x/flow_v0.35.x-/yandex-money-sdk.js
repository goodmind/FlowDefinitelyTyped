...
redirectURI: string,
clientSecret: string,
callback: ResponseCallback<YandexMoneySDK$Wallet.Wallet$GetAccessTokenResult>): void,
...
accountInfo(
callback: ResponseCallback<YandexMoneySDK$Wallet.Wallet$AccountInfoResult>): void,
operationHistory(
options: YandexMoneySDK$Wallet.Wallet$OperationHistoryOptions,
callback: ResponseCallback<YandexMoneySDK$Wallet.Wallet$OperationHistoryResult>): void,
operationDetails(
operation_id: string,
callback: ResponseCallback<YandexMoneySDK$Wallet.Wallet$OperationDetailsResult>): void,
requestPayment(
options: YandexMoneySDK$Wallet.Wallet$RequestPaymentOptions,
callback: ResponseCallback<YandexMoneySDK$Wallet.Wallet$RequestPaymentResult>): void,
processPayment(
options: YandexMoneySDK$Wallet.Wallet$ProcessPaymentOptions,
callback: ResponseCallback<YandexMoneySDK$Wallet.Wallet$ProcessPaymentResult>): void,
incomingTransferAccept(
operation_id: string,
protectionCode: string,
callback: ResponseCallback<YandexMoneySDK$Wallet.Wallet$IncomingTransferAcceptResult>): void,
incomingTransferReject(
operation_id: string,
callback: ResponseCallback<YandexMoneySDK$Wallet.Wallet$IncomingTransferRejectResult>): void
} 
	declare export interface ExternalPaymentStatic {
new (instanceId: string): ExternalPayment,
getInstanceId(
clientId: string,
callback: ResponseCallback<YandexMoneySDK$ExternalPayment.ExternalPayment$GetInstanceIdResult>): void
} 
	declare export interface ExternalPayment {
request(
options: YandexMoneySDK$ExternalPayment.ExternalPayment$RequestOptions,
callback: ResponseCallback<YandexMoneySDK$ExternalPayment.ExternalPayment$RequestResult>): void,
process(
options: YandexMoneySDK$ExternalPayment.ExternalPayment$ProcessOptions,
callback: ResponseCallback<YandexMoneySDK$ExternalPayment.ExternalPayment$ProcessResult>): void
} 
