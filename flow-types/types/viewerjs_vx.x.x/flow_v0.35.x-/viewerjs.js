declare module 'viewerjs' {
      ...
      declare var npm$namespace$Viewer: {
        setDefaults: typeof Viewer$setDefaults,
noConflict: typeof Viewer$noConflict,
        
      }
declare type Viewer$ImageSourceDelegate = (image: HTMLImageElement) => string;

declare type Viewer$ViewerMethod = () => void;
 ...
 */
declare interface Viewer$ViewerOption {
 ...
 */
url?: string | Viewer$ImageSourceDelegate,

/**
 * A shortcut of the `ready` event.
 * @default null
 */
ready?: Viewer$ViewerMethod | null,

/**
 * A shortcut of the `show` event.
 * @default null
 */
show?: Viewer$ViewerMethod | null,

/**
 * A shortcut of the `shown` event.
 * @default null
 */
shown?: Viewer$ViewerMethod | null,

/**
 * A shortcut of the `hide` event.
 * @default null
 */
hide?: Viewer$ViewerMethod | null,

/**
 * A shortcut of the `hidden` event.
 * @default null
 */
hidden?: Viewer$ViewerMethod | null,

/**
 * A shortcut of the `view` event.
 * @default null
 */
view?: Viewer$ViewerMethod | null,

/**
 * A shortcut of the `viewed` event.
 * @default null
 */
viewed?: Viewer$ViewerMethod | null
} 
 ...
 */
declare function Viewer$setDefaults(options: Viewer$ViewerOption): void
 ...
 */
declare function Viewer$noConflict(): void
