...
declare type Mailgun$AttachmentData = string | Buffer | NodeJS.ReadWriteStream | Mailgun$Attachment;
...
text?: string,
html?: string,
attachment?: Mailgun$AttachmentData | $ReadOnlyArray<Mailgun$AttachmentData>,
...
callback?: (err: Mailgun$Error, data: any) => void): Promise<any>,
add(
data: lists$MemberCreateData[],
callback?: (err: Mailgun$Error, data: any) => void): Promise<any>,
...
declare type validation$ValidationCallback = (error: Mailgun$Error, body: validation$ValidateResponse) => void;
...
Mailgun$Attachment: (params: Mailgun$AttachmentParams) => Mailgun$Attachment,
validateWebhook(bodyTimestamp: number, bodyToken: string, bodySignature: string): boolean,
parse(
addressList: string[],
callback?: validation$validation$ValidationCallback): Promise<validation$validation$ParseResponse>,
validate(address: string, callback: validation$validation$ValidationCallback): void,
validate(
address: string,
opts: validation$validation$ValidationOptionsPublic,
callback: validation$validation$ValidationCallback): void,
validate(
address: string,
isPrivate: boolean,
callback: validation$validation$ValidationCallback): void,
...
validate(
address: string,
opts?: validation$validation$ValidationOptionsPublic): Promise<validation$validation$ValidateResponse>,
validate(
address: string,
isPrivate: false,
opts?: validation$validation$ValidationOptionsPublic): Promise<validation$validation$ValidateResponse>,
...
address: string,
isPrivate: true,
opts?: validation$validation$ValidationOptionsPrivate): Promise<validation$validation$ValidateResponse>
} 
...
callback?: (error: Mailgun$Error, body: messages$messages$SendResponse) => void): Promise<messages$messages$SendResponse>
} 
    }
