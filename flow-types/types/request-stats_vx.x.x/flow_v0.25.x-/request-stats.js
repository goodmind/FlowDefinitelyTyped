declare module "request-stats" {
  ...
  declare function requestStats(
    ...
    statsCallback?: requestStats$requestStats$StatsCallback
  ): requestStats$requestStats$StatsEmitter;
  ...
  declare type requestStats$StatsEmitter = {
    ...
    addListener(
      event: "request",
      listener: (req: requestStats$Request) => void
    ): this,
    ...
    removeListener(
      event: "complete",
      listener: requestStats$StatsCallback
    ): this,
    removeListener(
      event: "request",
      listener: (req: requestStats$Request) => void
