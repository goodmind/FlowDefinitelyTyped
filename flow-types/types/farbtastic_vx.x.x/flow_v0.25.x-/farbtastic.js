declare module "farbtastic" {
  ...
  declare type JQueryFarbtastic$Callback =
  ...
  declare interface JQueryStatic {
    farbtastic(
      ...
      callback: JQueryFarbtastic$JQueryFarbtastic$Callback
    ): JQueryFarbtastic$JQueryFarbtastic$Farbtastic;
    farbtastic(
      placeholder: JQueryFarbtastic$JQueryFarbtastic$Placeholder,
      options: JQueryFarbtastic$JQueryFarbtastic$Options
    ): JQueryFarbtastic$JQueryFarbtastic$Farbtastic;
    farbtastic(
      placeholder: JQueryFarbtastic$JQueryFarbtastic$Placeholder
    ): JQueryFarbtastic$JQueryFarbtastic$Farbtastic;
