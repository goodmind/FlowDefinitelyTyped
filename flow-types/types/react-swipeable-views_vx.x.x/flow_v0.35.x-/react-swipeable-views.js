declare module 'react-swipeable-views' {
	...
	declare export type OnChangeIndexCallback = (index: number, indexLatest: number) => void;
	declare export type OnTransitionEndCallback = () => void;
	declare export type OnSwitchingCallback = (index: number, type: OnSwitchingCallbackTypeDescriptor) => void;
...
displaySameSlide?: boolean
	...
	declare export default class SwipeableViews mixins React.Component<SwipeableViewsProps, SwipeableViewsState> {}
    }
