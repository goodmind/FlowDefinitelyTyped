declare module "reapop" {
   ...
   */
  declare export function addNotification(
   ...
   * and only return the notification object.
   */
  declare export function updateNotification(
    notification: Notification
  ): (dispatch: Dispatch<any>) => Notification;
   ...
   */
  declare export function removeNotification(
    notification: Notification
  ): {
    type: string,
  ...
  declare class NotificationSystem
    mixins React.Component<NotificationSystemProps, any> {}
