...
outputOrOptions?: string | imagemin$imagemin$Options): Promise<imagemin$imagemin$Result[]>

	declare function imagemin(
input: $ReadOnlyArray<string>,
output?: string,
options?: imagemin$imagemin$Options): Promise<imagemin$imagemin$Result[]>
...
declare function imagemin$buffer(imagemin$buffer: Buffer, options?: imagemin$Options): Promise<Buffer>
