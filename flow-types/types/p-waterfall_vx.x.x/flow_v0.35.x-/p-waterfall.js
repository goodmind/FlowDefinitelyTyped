declare module 'p-waterfall' {
	...
	declare function pWaterfall<T1, T2, R>(tasks: [InitialTask<T1>, Task<T1, T2>, Task<T2, R>]): Promise<R>

	declare function pWaterfall<T1, T2, T3, R>(
tasks: [InitialTask<T1>, Task<T1, T2>, Task<T2, T3>, Task<T3, R>]): Promise<R>

	declare function pWaterfall<T1, T2, T3, T4, R>(
tasks: [InitialTask<T1>, Task<T1, T2>, Task<T2, T3>, Task<T3, T4>, Task<T4, R>]): Promise<R>

	declare function pWaterfall<T1, T2, T3, T4, T5, R>(
tasks: [InitialTask<T1>, Task<T1, T2>, Task<T2, T3>, Task<T3, T4>, Task<T4, T5>, Task<T5, R>]): Promise<R>

	declare function pWaterfall<T1, T2, T3, T4, T5, T6, R>(
tasks: [InitialTask<T1>, Task<T1, T2>, Task<T2, T3>, Task<T3, T4>, Task<T4, T5>, Task<T5, T6>, Task<T6, R>]): Promise<R>

	declare function pWaterfall<T1, T2, T3, T4, T5, T6, T7, R>(
tasks: [InitialTask<T1>, Task<T1, T2>, Task<T2, T3>, Task<T3, T4>, Task<T4, T5>, Task<T5, T6>, Task<T6, T7>, Task<T7, R>]): Promise<R>

	declare function pWaterfall<T1, R>(tasks: [Task<T1, R>], initialValue: T1): Promise<R>

	declare function pWaterfall<T1, T2, R>(tasks: [Task<T1, T2>, Task<T2, R>], initialValue: T1): Promise<R>

	declare function pWaterfall<T1, T2, T3, R>(
tasks: [Task<T1, T2>, Task<T2, T3>, Task<T3, R>],
initialValue: T1): Promise<R>
...
initialValue: T1): Promise<R>
	...
	declare function pWaterfall<T1, T2, T3, T4, T5, T6, T7, R>(
tasks: [Task<T1, T2>, Task<T2, T3>, Task<T3, T4>, Task<T4, T5>, Task<T5, T6>, Task<T6, T7>, Task<T7, R>],
initialValue: T1): Promise<R>

	declare function pWaterfall<T1, T2, T3, T4, T5, T6, T7, T8, R>(
tasks: [Task<T1, T2>, Task<T2, T3>, Task<T3, T4>, Task<T4, T5>, Task<T5, T6>, Task<T6, T7>, Task<T7, T8>, Task<T8, R>],
initialValue: T1): Promise<R>
