declare module 'cassandra-driver' {
	...
	declare export type ResultCallback = (err: Error, result: types$types$ResultSet) => void;
...
whiteList: string[]): loadBalancing$WhiteListPolicy
} 
...
static +rethrow: Class<retry$retryDecision__rethrow> & retry$retryDecision__rethrow & 0;// 0
static +retry: Class<retry$retryDecision__retry> & retry$retryDecision__retry & 1;// 1
static +ignore: Class<retry$retryDecision__ignore> & retry$retryDecision__ignore & 2;// 2
...
new (
delay: number,
maxSpeculativeExecutions: number): speculativeExecution$ConstantSpeculativeExecutionPolicy
} 
...
minLogInterval?: number): timestampGeneration$MonotonicTimestampGeneratorStatic
} 
...
static +three: Class<types$consistencies__three> & types$consistencies__three & 3;// 3
static +quorum: Class<types$consistencies__quorum> & types$consistencies__quorum & 4;// 4
static +all: Class<types$consistencies__all> & types$consistencies__all & 5;// 5
static +localQuorum: Class<types$consistencies__localQuorum> & types$consistencies__localQuorum & 6;// 6
static +eachQuorum: Class<types$consistencies__eachQuorum> & types$consistencies__eachQuorum & 7;// 7
static +serial: Class<types$consistencies__serial> & types$consistencies__serial & 8;// 8
static +localSerial: Class<types$consistencies__localSerial> & types$consistencies__localSerial & 9;// 9
static +localOne: Class<types$consistencies__localOne> & types$consistencies__localOne & 10;// 10
...
declare  class types$dataTypes {
  constructor(...args: empty): mixed;
static +custom: Class<types$dataTypes__custom> & types$dataTypes__custom & 0;// 0
static +ascii: Class<types$dataTypes__ascii> & types$dataTypes__ascii & 1;// 1
static +bigint: Class<types$dataTypes__bigint> & types$dataTypes__bigint & 2;// 2
static +blob: Class<types$dataTypes__blob> & types$dataTypes__blob & 3;// 3
static +boolean: Class<types$dataTypes__boolean> & types$dataTypes__boolean & 4;// 4
static +counter: Class<types$dataTypes__counter> & types$dataTypes__counter & 5;// 5
static +decimal: Class<types$dataTypes__decimal> & types$dataTypes__decimal & 6;// 6
static +double: Class<types$dataTypes__double> & types$dataTypes__double & 7;// 7
...
static +timestamp: Class<types$dataTypes__timestamp> & types$dataTypes__timestamp & 11;// 11
static +uuid: Class<types$dataTypes__uuid> & types$dataTypes__uuid & 12;// 12
static +varchar: Class<types$dataTypes__varchar> & types$dataTypes__varchar & 13;// 13
static +varint: Class<types$dataTypes__varint> & types$dataTypes__varint & 14;// 14
static +timeuuid: Class<types$dataTypes__timeuuid> & types$dataTypes__timeuuid & 15;// 15
...
static +smallint: Class<types$dataTypes__smallint> & types$dataTypes__smallint & 19;// 19
static +tinyint: Class<types$dataTypes__tinyint> & types$dataTypes__tinyint & 20;// 20
...
static +ignored: Class<types$distance__ignored> & types$distance__ignored & 2;// 2
...
new (month: number, days: number, nanoseconds: number | _Long): types$Duration,
...
consistency: types$consistencies): types$ResultSet
} 
...
options?: QueryOptions): Promise<types$types$ResultSet>,
...
constructor(message: string, function Object() { [native code] }?: any): this;
info: string
}
...
constructor(address: string, maxRequestsPerConnection: number, connectionLength: number): this
}
...
declare  class metadata$IndexType {
  constructor(...args: empty): mixed;
static +custom: Class<metadata$IndexType__custom> & metadata$IndexType__custom & 0;// 0
static +keys: Class<metadata$IndexType__keys> & metadata$IndexType__keys & 1;// 1
static +composites: Class<metadata$IndexType__composites> & metadata$IndexType__composites & 2;// 2
...
options: {[key: string]: any}): metadata$Index,
