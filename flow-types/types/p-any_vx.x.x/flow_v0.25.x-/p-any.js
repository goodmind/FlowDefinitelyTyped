declare module "p-any" {
  declare export default typeof pAny;
  ...
  declare function pAny<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
    ...
    options?: pAny$Options<T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8 | T9 | T10>
  ...
  declare function pAny<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
    ...
    options?: pAny$Options<T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8 | T9>
  ...
  declare function pAny<T1, T2, T3, T4, T5, T6, T7, T8>(
    ...
    options?: pAny$Options<T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8>
