...
options?: pAny$pAny$Options<T1 | T2 | T3 | T4>): Promise<T1 | T2 | T3 | T4>

	declare function pAny<T1, T2, T3>(
values: [Value<T1>, Value<T2>, Value<T3>],
options?: pAny$pAny$Options<T1 | T2 | T3>): Promise<T1 | T2 | T3>

	declare function pAny<T1, T2>(
values: [Value<T1>, Value<T2>],
options?: pAny$pAny$Options<T1 | T2>): Promise<T1 | T2>

	declare function pAny<T>(
values: Iterable<Value<T>> | Array<Value<T>>,
options?: pAny$pAny$Options<T>): Promise<T>
