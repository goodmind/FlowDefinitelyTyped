declare module 'speakeasy' {
        declare export type Encoding = "ascii" | "hex" | "base32" | "base64";
	declare export type Algorithm = "sha1" | "sha256" | "sha512";
	declare export interface SharedOptions {
...
algorithm?: Algorithm
	...
	declare export interface GeneratedSecret {
...
otpauth_url?: string
	...
	declare export type GeneratedSecretWithOtpAuthUrl = {
...
otpauth_url: string
	...
	declare export type DigestOptions = {
secret: string,
counter: number,
...
key?: string
	...
	declare export interface GenerateSecretOptions {
...
google_auth_qr?: boolean
	...
	declare export type GenerateSecretWithOtpAuthUrlOptions = {
...
otpauth_url: true
	...
	declare export type HotpOptions = {
...
digest?: Buffer
	...
	declare export type HotpVerifyOptions = {
...
window?: number
	...
	declare export type TotpOptions = {
...
counter?: string
	...
	declare export type TotpVerifyOptions = {
...
counter?: string
	...
	declare export type OtpauthURLOptions = {
...
`{ delta: 0 }`).
 */
verifyDelta: (options: HotpVerifyOptions) => void | Delta,
...
`{ delta: 0 }`).
 */
verifyDelta: (options: TotpVerifyOptions) => void | Delta,
 ...
 */
declare export function digest(options: DigestOptions): Buffer

	declare export var hotp: Hotp;
	declare export var counter: Hotp;
	declare export var totp: Totp;
	declare export var time: Totp;
 ...
 */
declare export function generateSecret(options: GenerateSecretWithOtpAuthUrlOptions): GeneratedSecretWithOtpAuthUrl
 ...
 * Authenticator URL to obtain a QR code you can scan into the app.
 */
declare export function generateSecret(options?: GenerateSecretOptions): GeneratedSecret

	
/**
 * @deprecated use generateSecret
 */
declare export var generate_key: typeof generateSecret;
 ...
 */
declare export function generateSecretASCII(length?: number, symbols?: boolean): string

	
/**
 * @deprecated use generateSecret
 */
declare export var generate_key_ascii: typeof generateSecretASCII;
 ...
 */
declare export function otpauthURL(options: OtpauthURLOptions): string
