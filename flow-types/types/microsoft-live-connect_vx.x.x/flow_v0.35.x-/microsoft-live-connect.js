 ...
 */
declare interface Live$IUserInfo {
 ...
 * item is shared with.
 */
declare interface Live$ISharedWith {
 ...
 * 'type' field.
 */
declare interface Live$IObject {
 ...
 */
declare interface Live$IObjectCollection<T> {
 ...
 */
declare interface Live$INewAlbum {
 ...
 */
declare interface Live$INewAudio {
 ...
 * Calendar objects.
 */
declare interface Live$ICalendar {
 ...
 */
declare interface Live$INewCalendar {
 ...
 * given iCal calendar.
 */
declare interface Live$INewCalendarSubscription {
 ...
 * shared with the user.
 */
declare interface Live$IComment {
 ...
 */
declare interface Live$INewComment {
 ...
 */
declare interface Live$IContact {
 ...
 */
declare interface Live$INewContact {
 ...
 */
declare interface Live$INewEvent {
 ...
 */
declare interface Live$INewEventResponse {
 ...
 */
declare interface Live$INewFileResponse {
 ...
 */
declare interface Live$IFileDownloadLink {
 ...
 */
declare interface Live$IFolder {
 ...
 */
declare interface Live$INewFolder {
 ...
 */
declare interface Live$IFriend {
 ...
 */
declare interface Live$IPermissions {
[scope: string]: number
} 
 ...
 */
declare interface Live$IImageInfo {
 ...
 */
declare interface Live$ILocation {
 ...
 */
declare interface Live$ISearch {
 ...
 */
declare interface Live$IWorkInfo {
 ...
 */
declare interface Live$IPostalAddress {
 ...
 */
personal: Live$IPostalAddress,

/**
 * The user's business postal address.
 */
business: Live$IPostalAddress
},
 ...
 */
declare interface Live$IAPIProperties {
 ...
 */
declare interface Live$IBackgroundDownloadProperties {
 ...
 */
declare interface Live$IBackgroundUploadProperties {
 ...
 */
declare interface Live$IDownloadProperties {
 ...
 */
declare interface Live$IFileDialogProperties {
 ...
 */
declare interface Live$IInitProperties {
 ...
 */
declare interface Live$ILoginProperties {
 ...
 */
declare interface Live$IUIProperties {
 ...
 * 'skydrivepicker'.
 */
declare type Live$ISkyDrivePickerProperies = {
 ...
 * 'signin'.
 */
declare type Live$ISignInProperties = {
 ...
 */
declare interface Live$IUploadProperties {
 ...
 */
declare interface Live$ISession {
 ...
 */
declare interface Live$ILoginStatus {
 ...
 */
declare interface Live$IEventAPI {
 ...
 */
declare interface Live$IFilePickerResult {
 ...
 */
declare interface Live$IPromise<T> {
...
onProgress?: (progress: any) => void): Live$IPromise<T>,
 ...
 */
declare interface Live$IJSError {
 ...
 */
api<T>(
properties: Live$IAPIProperties,
callback?: (response: any) => void): Live$IPromise<T>,
 ...
 * @param properties Required. A JSON object that contains properties
that are necessary to make the REST API call.
 * @param a callback function that is executed when
the REST API call is complete. The callback function takes the API
response object as a parameter. The response object exposes the
...
properties: Live$IBackgroundDownloadProperties,
callback?: (response: any) => void): Live$IPromise<T>,
 ...
 */
backgroundUpload<T>(
properties: Live$IBackgroundUploadProperties,
callback?: (response: any) => void): Live$IPromise<T>,
 ...
 */
download(
properties: Live$IDownloadProperties,
callback?: (response: any) => void): Live$IPromise<void>,
Event: Live$IEventAPI,
 ...
 */
fileDialog(
properties: Live$IFileDialogProperties,
callback?: (response: any) => void): Live$IPromise<Live$IFilePickerResult>,
 ...
 */
getLoginStatus(
callback?: (status: Live$ILoginStatus) => void,
force?: boolean): Live$IPromise<Live$ILoginStatus>,
...
status.
 */
init(properties: Live$IInitProperties): Live$IPromise<Live$ILoginStatus>,
 ...
 */
login(
properties: Live$ILoginProperties,
callback?: (status: any) => void): Live$IPromise<Live$ILoginStatus>,
 ...
 */
logout(
callback?: (status: Live$ILoginStatus) => void): Live$IPromise<Live$ILoginStatus>,
 ...
 */
ui(properties: Live$IUIProperties, callback?: () => void): void,
 ...
 */
upload<T>(
properties: Live$IUploadProperties,
callback?: (response: any) => void): Live$IPromise<T>
} 
 ...
 */
declare var WL: Microsoft$Live.Live$API;
    }
