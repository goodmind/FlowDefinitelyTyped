...
declare type Test$ExtJS = {
  ...
  Test$IExtJSAjax &
  Test$IExtJSComponent &
  Test$IExtJSDataView &
  Test$IExtJSElement &
  Test$IExtJSFormField &
  Test$IExtJSGrid &
  Test$IExtJSObservable &
  Test$IExtJSStore &
  Test$IExtJSCore;
...
declare type Test$Browser = {
  ...
  Simulate$Simulate$IEvent &
  Simulate$Simulate$IKeyboard &
  Simulate$Simulate$IMouse &
  Test$IElement &
  Test$ITextSelection;
...
declare module "siesta" {
  declare function StartTest(
    testScript: (t: Siesta$Siesta$ITest) => void
  ): void;
