 ...
 * @param partials Either an object that contains the names and templates of partials that are used in a template
 ...
 */
  ...
  declare class MustacheScanner {
     ...
     * @param re The regex-pattern to match.
     * @returns Returns the skipped string, which is the entire tail if no match can be made.
     */
  ...
  declare class MustacheContext {
     ...
     */
    constructor(view: any, parentContext: MustacheContext): this;
     ...
     * @param view The view to create the new context with.
     */
 ...
 * @param context The context to use for rendering the tokens.
 * @param partials The partials to use for rendering the tokens.
 * @param originalTemplate An object used to extract the portion of the original template that was contained in a higher-order section.
