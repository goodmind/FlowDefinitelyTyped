declare module 'expired-storage' {
        declare module.exports: typeof ExpiredStorage

	declare class ExpiredStorage  {
constructor(localStorage?: any): this;
 ...
 */
setJson(key: string, value: {[key: string]: any}, expirationTime?: number): any;
 ...
 */
peek(key: string): ExpiredStorage$ExpiredStorage$PeekInterface;
...
updateExpiration(key: string, expiration: number): any
	...
	declare interface ExpiredStorage$PeekInterface {
