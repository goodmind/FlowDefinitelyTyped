 ...
 * @param - Exclude the origin and destination nodes from the result
 * @param - Return the path in reversed order
 * @param - Also return the cost of the path when set to true
...
path(start: any, goal: any, options?: PathOption): any
	...
	declare interface PathOption {
trim?: boolean,
reverse?: boolean,
cost?: boolean,
avoid?: any[]
} 
	declare module.exports: typeof Graph
