...
static +AuthResult: Class<VoxImplant$Events__AuthResult> & VoxImplant$Events__AuthResult & 0;// 0
static +ConnectionClosed: Class<VoxImplant$Events__ConnectionClosed> & VoxImplant$Events__ConnectionClosed & 1;// 1
static +ConnectionEstablished: Class<VoxImplant$Events__ConnectionEstablished> & VoxImplant$Events__ConnectionEstablished & 2;// 2
static +ConnectionFailed: Class<VoxImplant$Events__ConnectionFailed> & VoxImplant$Events__ConnectionFailed & 3;// 3
static +IncomingCall: Class<VoxImplant$Events__IncomingCall> & VoxImplant$Events__IncomingCall & 4;// 4
static +MicAccessResult: Class<VoxImplant$Events__MicAccessResult> & VoxImplant$Events__MicAccessResult & 5;// 5
static +NetStatsReceived: Class<VoxImplant$Events__NetStatsReceived> & VoxImplant$Events__NetStatsReceived & 6;// 6
static +PlaybackFinished: Class<VoxImplant$Events__PlaybackFinished> & VoxImplant$Events__PlaybackFinished & 7;// 7
static +SDKReady: Class<VoxImplant$Events__SDKReady> & VoxImplant$Events__SDKReady & 8;// 8
static +SourcesInfoUpdated: Class<VoxImplant$Events__SourcesInfoUpdated> & VoxImplant$Events__SourcesInfoUpdated & 9;// 9
...
declare class VoxImplant$Events__ConnectionEstablished mixins VoxImplant$Events {}
...
declare class VoxImplant$Events__SourcesInfoUpdated mixins VoxImplant$Events {}
...
declare  class VoxImplant$IMEvents {
  constructor(...args: empty): mixed;
static +ChatHistoryReceived: Class<VoxImplant$IMEvents__ChatHistoryReceived> & VoxImplant$IMEvents__ChatHistoryReceived & 0;// 0
static +ChatRoomBanList: Class<VoxImplant$IMEvents__ChatRoomBanList> & VoxImplant$IMEvents__ChatRoomBanList & 1;// 1
static +ChatRoomCreated: Class<VoxImplant$IMEvents__ChatRoomCreated> & VoxImplant$IMEvents__ChatRoomCreated & 2;// 2
static +ChatRoomError: Class<VoxImplant$IMEvents__ChatRoomError> & VoxImplant$IMEvents__ChatRoomError & 3;// 3
static +ChatRoomHistoryReceived: Class<VoxImplant$IMEvents__ChatRoomHistoryReceived> & VoxImplant$IMEvents__ChatRoomHistoryReceived & 4;// 4
static +ChatRoomInfo: Class<VoxImplant$IMEvents__ChatRoomInfo> & VoxImplant$IMEvents__ChatRoomInfo & 5;// 5
static +ChatRoomInvitation: Class<VoxImplant$IMEvents__ChatRoomInvitation> & VoxImplant$IMEvents__ChatRoomInvitation & 6;// 6
static +ChatRoomInviteDeclined: Class<VoxImplant$IMEvents__ChatRoomInviteDeclined> & VoxImplant$IMEvents__ChatRoomInviteDeclined & 7;// 7
static +ChatRoomMessageModified: Class<VoxImplant$IMEvents__ChatRoomMessageModified> & VoxImplant$IMEvents__ChatRoomMessageModified & 8;// 8
static +ChatRoomMessageNotModified: Class<VoxImplant$IMEvents__ChatRoomMessageNotModified> & VoxImplant$IMEvents__ChatRoomMessageNotModified & 9;// 9
static +ChatRoomMessageReceived: Class<VoxImplant$IMEvents__ChatRoomMessageReceived> & VoxImplant$IMEvents__ChatRoomMessageReceived & 10;// 10
static +ChatRoomMessageRemoved: Class<VoxImplant$IMEvents__ChatRoomMessageRemoved> & VoxImplant$IMEvents__ChatRoomMessageRemoved & 11;// 11
static +ChatRoomNewParticipant: Class<VoxImplant$IMEvents__ChatRoomNewParticipant> & VoxImplant$IMEvents__ChatRoomNewParticipant & 12;// 12
static +ChatRoomOperation: Class<VoxImplant$IMEvents__ChatRoomOperation> & VoxImplant$IMEvents__ChatRoomOperation & 13;// 13
static +ChatRoomParticipantExit: Class<VoxImplant$IMEvents__ChatRoomParticipantExit> & VoxImplant$IMEvents__ChatRoomParticipantExit & 14;// 14
static +ChatRoomParticipants: Class<VoxImplant$IMEvents__ChatRoomParticipants> & VoxImplant$IMEvents__ChatRoomParticipants & 15;// 15
static +ChatRoomPresenceUpdate: Class<VoxImplant$IMEvents__ChatRoomPresenceUpdate> & VoxImplant$IMEvents__ChatRoomPresenceUpdate & 16;// 16
static +ChatRoomStateUpdate: Class<VoxImplant$IMEvents__ChatRoomStateUpdate> & VoxImplant$IMEvents__ChatRoomStateUpdate & 17;// 17
static +ChatRoomSubjectChange: Class<VoxImplant$IMEvents__ChatRoomSubjectChange> & VoxImplant$IMEvents__ChatRoomSubjectChange & 18;// 18
static +ChatRoomsDataReceived: Class<VoxImplant$IMEvents__ChatRoomsDataReceived> & VoxImplant$IMEvents__ChatRoomsDataReceived & 19;// 19
static +ChatStateUpdate: Class<VoxImplant$IMEvents__ChatStateUpdate> & VoxImplant$IMEvents__ChatStateUpdate & 20;// 20
static +MessageModified: Class<VoxImplant$IMEvents__MessageModified> & VoxImplant$IMEvents__MessageModified & 21;// 21
static +MessageNotModified: Class<VoxImplant$IMEvents__MessageNotModified> & VoxImplant$IMEvents__MessageNotModified & 22;// 22
static +MessageReceived: Class<VoxImplant$IMEvents__MessageReceived> & VoxImplant$IMEvents__MessageReceived & 23;// 23
static +MessageRemoved: Class<VoxImplant$IMEvents__MessageRemoved> & VoxImplant$IMEvents__MessageRemoved & 24;// 24
static +MessageStatus: Class<VoxImplant$IMEvents__MessageStatus> & VoxImplant$IMEvents__MessageStatus & 25;// 25
static +PresenceUpdate: Class<VoxImplant$IMEvents__PresenceUpdate> & VoxImplant$IMEvents__PresenceUpdate & 26;// 26
static +RosterItemChange: Class<VoxImplant$IMEvents__RosterItemChange> & VoxImplant$IMEvents__RosterItemChange & 27;// 27
static +RosterPresenceUpdate: Class<VoxImplant$IMEvents__RosterPresenceUpdate> & VoxImplant$IMEvents__RosterPresenceUpdate & 28;// 28
static +RosterReceived: Class<VoxImplant$IMEvents__RosterReceived> & VoxImplant$IMEvents__RosterReceived & 29;// 29
static +SubscriptionRequest: Class<VoxImplant$IMEvents__SubscriptionRequest> & VoxImplant$IMEvents__SubscriptionRequest & 30;// 30
static +SystemError: Class<VoxImplant$IMEvents__SystemError> & VoxImplant$IMEvents__SystemError & 31;// 31
static +UCConnected: Class<VoxImplant$IMEvents__UCConnected> & VoxImplant$IMEvents__UCConnected & 32;// 32
static +UCDisconnected: Class<VoxImplant$IMEvents__UCDisconnected> & VoxImplant$IMEvents__UCDisconnected & 33;// 33

}

declare class VoxImplant$IMEvents__ChatHistoryReceived mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomBanList mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomCreated mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomError mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomHistoryReceived mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomInfo mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomInvitation mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomInviteDeclined mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomMessageModified mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomMessageNotModified mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomMessageReceived mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomMessageRemoved mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomNewParticipant mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomOperation mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomParticipantExit mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomParticipants mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomPresenceUpdate mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomStateUpdate mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomSubjectChange mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatRoomsDataReceived mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__ChatStateUpdate mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__MessageModified mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__MessageNotModified mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__MessageReceived mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__MessageRemoved mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__MessageStatus mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__PresenceUpdate mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__RosterItemChange mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__RosterPresenceUpdate mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__RosterReceived mixins VoxImplant$IMEvents {}
declare class VoxImplant$IMEvents__SubscriptionRequest mixins VoxImplant$IMEvents {}
...
declare class VoxImplant$IMEvents__UCDisconnected mixins VoxImplant$IMEvents {}
...
declare  class VoxImplant$CallEvents {
  constructor(...args: empty): mixed;
static +Connected: Class<VoxImplant$CallEvents__Connected> & VoxImplant$CallEvents__Connected & 0;// 0
static +Disconnected: Class<VoxImplant$CallEvents__Disconnected> & VoxImplant$CallEvents__Disconnected & 1;// 1
static +Failed: Class<VoxImplant$CallEvents__Failed> & VoxImplant$CallEvents__Failed & 2;// 2
static +ICETimeout: Class<VoxImplant$CallEvents__ICETimeout> & VoxImplant$CallEvents__ICETimeout & 3;// 3
static +InfoReceived: Class<VoxImplant$CallEvents__InfoReceived> & VoxImplant$CallEvents__InfoReceived & 4;// 4
static +MessageReceived: Class<VoxImplant$CallEvents__MessageReceived> & VoxImplant$CallEvents__MessageReceived & 5;// 5
static +ProgressToneStart: Class<VoxImplant$CallEvents__ProgressToneStart> & VoxImplant$CallEvents__ProgressToneStart & 6;// 6
static +ProgressToneStop: Class<VoxImplant$CallEvents__ProgressToneStop> & VoxImplant$CallEvents__ProgressToneStop & 7;// 7
static +TransferComplete: Class<VoxImplant$CallEvents__TransferComplete> & VoxImplant$CallEvents__TransferComplete & 8;// 8
static +TransferFailed: Class<VoxImplant$CallEvents__TransferFailed> & VoxImplant$CallEvents__TransferFailed & 9;// 9

}

declare class VoxImplant$CallEvents__Connected mixins VoxImplant$CallEvents {}
declare class VoxImplant$CallEvents__Disconnected mixins VoxImplant$CallEvents {}
declare class VoxImplant$CallEvents__Failed mixins VoxImplant$CallEvents {}
declare class VoxImplant$CallEvents__ICETimeout mixins VoxImplant$CallEvents {}
declare class VoxImplant$CallEvents__InfoReceived mixins VoxImplant$CallEvents {}
declare class VoxImplant$CallEvents__MessageReceived mixins VoxImplant$CallEvents {}
declare class VoxImplant$CallEvents__ProgressToneStart mixins VoxImplant$CallEvents {}
declare class VoxImplant$CallEvents__ProgressToneStop mixins VoxImplant$CallEvents {}
declare class VoxImplant$CallEvents__TransferComplete mixins VoxImplant$CallEvents {}
declare class VoxImplant$CallEvents__TransferFailed mixins VoxImplant$CallEvents {}
...
declare type VoxImplant$VoxImplantEvent = EventTypes$EventTypes$AuthResult
...
declare type VoxImplant$VoxImplantCallEvent = CallEventTypes$CallEventTypes$Connected
...
declare type VoxImplant$VoxImplantIMEvent = IMEventTypes$IMEventTypes$ChatHistoryReceived
...
declare  class VoxImplant$ChatStateType {
  constructor(...args: empty): mixed;
static +Active: Class<VoxImplant$ChatStateType__Active> & VoxImplant$ChatStateType__Active & 0;// 0
static +Composing: Class<VoxImplant$ChatStateType__Composing> & VoxImplant$ChatStateType__Composing & 1;// 1
static +Gone: Class<VoxImplant$ChatStateType__Gone> & VoxImplant$ChatStateType__Gone & 2;// 2
static +Inactive: Class<VoxImplant$ChatStateType__Inactive> & VoxImplant$ChatStateType__Inactive & 3;// 3
static +Invalid: Class<VoxImplant$ChatStateType__Invalid> & VoxImplant$ChatStateType__Invalid & 4;// 4
static +Paused: Class<VoxImplant$ChatStateType__Paused> & VoxImplant$ChatStateType__Paused & 5;// 5

}

declare class VoxImplant$ChatStateType__Active mixins VoxImplant$ChatStateType {}
declare class VoxImplant$ChatStateType__Composing mixins VoxImplant$ChatStateType {}
declare class VoxImplant$ChatStateType__Gone mixins VoxImplant$ChatStateType {}
declare class VoxImplant$ChatStateType__Inactive mixins VoxImplant$ChatStateType {}
declare class VoxImplant$ChatStateType__Invalid mixins VoxImplant$ChatStateType {}
declare class VoxImplant$ChatStateType__Paused mixins VoxImplant$ChatStateType {}


declare  class VoxImplant$IMErrorType {
  constructor(...args: empty): mixed;
static +RemoteFunctionError: Class<VoxImplant$IMErrorType__RemoteFunctionError> & VoxImplant$IMErrorType__RemoteFunctionError & 0;// 0
static +Error: Class<VoxImplant$IMErrorType__Error> & VoxImplant$IMErrorType__Error & 1;// 1
static +RosterError: Class<VoxImplant$IMErrorType__RosterError> & VoxImplant$IMErrorType__RosterError & 2;// 2

}

declare class VoxImplant$IMErrorType__RemoteFunctionError mixins VoxImplant$IMErrorType {}
declare class VoxImplant$IMErrorType__Error mixins VoxImplant$IMErrorType {}
declare class VoxImplant$IMErrorType__RosterError mixins VoxImplant$IMErrorType {}


declare  class VoxImplant$MessageEventType {
  constructor(...args: empty): mixed;
static +Cancel: Class<VoxImplant$MessageEventType__Cancel> & VoxImplant$MessageEventType__Cancel & 0;// 0
static +Composing: Class<VoxImplant$MessageEventType__Composing> & VoxImplant$MessageEventType__Composing & 1;// 1
static +Delivered: Class<VoxImplant$MessageEventType__Delivered> & VoxImplant$MessageEventType__Delivered & 2;// 2
static +Displayed: Class<VoxImplant$MessageEventType__Displayed> & VoxImplant$MessageEventType__Displayed & 3;// 3
static +Invalid: Class<VoxImplant$MessageEventType__Invalid> & VoxImplant$MessageEventType__Invalid & 4;// 4
static +Offline: Class<VoxImplant$MessageEventType__Offline> & VoxImplant$MessageEventType__Offline & 5;// 5

}

declare class VoxImplant$MessageEventType__Cancel mixins VoxImplant$MessageEventType {}
declare class VoxImplant$MessageEventType__Composing mixins VoxImplant$MessageEventType {}
declare class VoxImplant$MessageEventType__Delivered mixins VoxImplant$MessageEventType {}
declare class VoxImplant$MessageEventType__Displayed mixins VoxImplant$MessageEventType {}
declare class VoxImplant$MessageEventType__Invalid mixins VoxImplant$MessageEventType {}
declare class VoxImplant$MessageEventType__Offline mixins VoxImplant$MessageEventType {}


declare  class VoxImplant$OperatorACDStatuses {
  constructor(...args: empty): mixed;
static +AfterService: Class<VoxImplant$OperatorACDStatuses__AfterService> & VoxImplant$OperatorACDStatuses__AfterService & 0;// 0
static +DND: Class<VoxImplant$OperatorACDStatuses__DND> & VoxImplant$OperatorACDStatuses__DND & 1;// 1
static +InService: Class<VoxImplant$OperatorACDStatuses__InService> & VoxImplant$OperatorACDStatuses__InService & 2;// 2
static +Offline: Class<VoxImplant$OperatorACDStatuses__Offline> & VoxImplant$OperatorACDStatuses__Offline & 3;// 3
static +Online: Class<VoxImplant$OperatorACDStatuses__Online> & VoxImplant$OperatorACDStatuses__Online & 4;// 4
static +Ready: Class<VoxImplant$OperatorACDStatuses__Ready> & VoxImplant$OperatorACDStatuses__Ready & 5;// 5
static +Timeout: Class<VoxImplant$OperatorACDStatuses__Timeout> & VoxImplant$OperatorACDStatuses__Timeout & 6;// 6

}

declare class VoxImplant$OperatorACDStatuses__AfterService mixins VoxImplant$OperatorACDStatuses {}
declare class VoxImplant$OperatorACDStatuses__DND mixins VoxImplant$OperatorACDStatuses {}
declare class VoxImplant$OperatorACDStatuses__InService mixins VoxImplant$OperatorACDStatuses {}
declare class VoxImplant$OperatorACDStatuses__Offline mixins VoxImplant$OperatorACDStatuses {}
declare class VoxImplant$OperatorACDStatuses__Online mixins VoxImplant$OperatorACDStatuses {}
declare class VoxImplant$OperatorACDStatuses__Ready mixins VoxImplant$OperatorACDStatuses {}
declare class VoxImplant$OperatorACDStatuses__Timeout mixins VoxImplant$OperatorACDStatuses {}


declare  class VoxImplant$RosterItemEvent {
  constructor(...args: empty): mixed;
static +Added: Class<VoxImplant$RosterItemEvent__Added> & VoxImplant$RosterItemEvent__Added & 0;// 0
static +Removed: Class<VoxImplant$RosterItemEvent__Removed> & VoxImplant$RosterItemEvent__Removed & 1;// 1
static +Subscribed: Class<VoxImplant$RosterItemEvent__Subscribed> & VoxImplant$RosterItemEvent__Subscribed & 2;// 2
static +Unsubscribed: Class<VoxImplant$RosterItemEvent__Unsubscribed> & VoxImplant$RosterItemEvent__Unsubscribed & 3;// 3
static +Updated: Class<VoxImplant$RosterItemEvent__Updated> & VoxImplant$RosterItemEvent__Updated & 4;// 4

}

declare class VoxImplant$RosterItemEvent__Added mixins VoxImplant$RosterItemEvent {}
declare class VoxImplant$RosterItemEvent__Removed mixins VoxImplant$RosterItemEvent {}
declare class VoxImplant$RosterItemEvent__Subscribed mixins VoxImplant$RosterItemEvent {}
declare class VoxImplant$RosterItemEvent__Unsubscribed mixins VoxImplant$RosterItemEvent {}
declare class VoxImplant$RosterItemEvent__Updated mixins VoxImplant$RosterItemEvent {}


declare  class VoxImplant$SubscriptionRequestType {
  constructor(...args: empty): mixed;
static +Subscribe: Class<VoxImplant$SubscriptionRequestType__Subscribe> & VoxImplant$SubscriptionRequestType__Subscribe & 0;// 0
static +Unsubscribe: Class<VoxImplant$SubscriptionRequestType__Unsubscribe> & VoxImplant$SubscriptionRequestType__Unsubscribe & 1;// 1

}

declare class VoxImplant$SubscriptionRequestType__Subscribe mixins VoxImplant$SubscriptionRequestType {}
declare class VoxImplant$SubscriptionRequestType__Unsubscribe mixins VoxImplant$SubscriptionRequestType {}


declare  class VoxImplant$UserStatuses {
  constructor(...args: empty): mixed;
static +Away: Class<VoxImplant$UserStatuses__Away> & VoxImplant$UserStatuses__Away & 0;// 0
static +Chat: Class<VoxImplant$UserStatuses__Chat> & VoxImplant$UserStatuses__Chat & 1;// 1
static +DND: Class<VoxImplant$UserStatuses__DND> & VoxImplant$UserStatuses__DND & 2;// 2
static +Offline: Class<VoxImplant$UserStatuses__Offline> & VoxImplant$UserStatuses__Offline & 3;// 3
static +Online: Class<VoxImplant$UserStatuses__Online> & VoxImplant$UserStatuses__Online & 4;// 4
static +XA: Class<VoxImplant$UserStatuses__XA> & VoxImplant$UserStatuses__XA & 5;// 5
...
declare class VoxImplant$UserStatuses__Offline mixins VoxImplant$UserStatuses {}
declare class VoxImplant$UserStatuses__Online mixins VoxImplant$UserStatuses {}
declare class VoxImplant$UserStatuses__XA mixins VoxImplant$UserStatuses {}


declare  class VoxImplant$ChatRoomOperationType {
  constructor(...args: empty): mixed;
static +Ban: Class<VoxImplant$ChatRoomOperationType__Ban> & VoxImplant$ChatRoomOperationType__Ban & 0;// 0
static +Unban: Class<VoxImplant$ChatRoomOperationType__Unban> & VoxImplant$ChatRoomOperationType__Unban & 1;// 1

}

declare class VoxImplant$ChatRoomOperationType__Ban mixins VoxImplant$ChatRoomOperationType {}
declare class VoxImplant$ChatRoomOperationType__Unban mixins VoxImplant$ChatRoomOperationType {}
 ...
 */
setMessageStatus(user_id: string, type: VoxImplant$MessageEventType, message_id: string[]): void,
 ...
 * @param eventHandler Handler function
 */
removeEventListener(eventName: VoxImplant$VoxImplant$CallEvents, eventHandler: () => any): void,
