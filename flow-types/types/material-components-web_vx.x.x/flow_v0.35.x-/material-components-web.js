declare module 'material-components-web' {
	...
	declare export {
          autoInit,base,checkbox,chips,dialog,drawer,floatingLabel,formField,gridList,iconToggle,lineRipple,linearProgress,menu,notchedOutline,radio,ripple,select,selectionControl,slider,snackbar,tabs,textField,toolbar,topAppBar
        }
