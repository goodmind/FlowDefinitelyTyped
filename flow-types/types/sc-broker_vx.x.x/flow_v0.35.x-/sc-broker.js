...
sendToBroker(
data: any,
callback?: (err: Error | null, data: any, brokerId: string) => void): void
} & EventEmitter

	declare export function createServer(options?: SCBrokerServerOptions): SCBrokerServer
...
on(
event: "subscribeFail",
listener: (err: Error | null, channel: string) => void): this,
...
extractValues(keyChain: KeyChain): any[],
	...
	declare export function createClient(options?: SCBrokerClientOptions): SCBrokerClient
