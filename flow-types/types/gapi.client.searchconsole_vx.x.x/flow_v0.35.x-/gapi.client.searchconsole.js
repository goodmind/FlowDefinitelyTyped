 ...
 */
declare function client$load(name: "searchconsole", version: "v1"): PromiseLike<void>


declare function client$load(name: "searchconsole", version: "v1", callback: () => any): void
