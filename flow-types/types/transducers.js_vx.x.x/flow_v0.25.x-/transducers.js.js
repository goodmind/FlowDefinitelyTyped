declare module "transducers.js" {
  ...
  declare export type Transducer<TInput, TOutput> = <TResult>(
  ...
  declare export function keep<TInput>(): Transducer<
    TInput | null | void,
    TInput
  >;
  ...
  declare export function partition<TInput>(
    n: number
  ): Transducer<TInput, TInput[]>;
  ...
  declare export function interpose<TInput>(
    sep: TInput
  ): Transducer<TInput, TInput>;
