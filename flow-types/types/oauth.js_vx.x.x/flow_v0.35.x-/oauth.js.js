 ...
 * Convert the given parameters to an Array of name-value pairs.
 */
declare function OAuth$getParameterList(parameters: string): OAuth$ParameterList
 ...
 * Convert the given parameters to a map from name to value.
 */
declare function OAuth$getParameterMap(parameters: string): OAuth$ParameterMap
...
declare function OAuth$setParameters(message: OAuth$Message, parameters: string): void
...
declare function OAuth$getAuthorizationHeader(realm: string, parameters: string): string
