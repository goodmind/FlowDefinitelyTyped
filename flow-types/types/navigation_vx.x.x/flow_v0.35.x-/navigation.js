 ...
 */
declare export interface StateInfo {
 ...
 */
declare export class State mixins StateInfo {
 ...
 * history is disabled
 */
declare export class HashHistoryManager mixins HistoryManager {
 ...
 * history is disabled
 */
declare export class HTML5HistoryManager mixins HistoryManager {
 ...
 */
declare export class StateContext  {
 ...
 */
declare export interface FluentNavigator {
 ...
 * current State
 */
declare export class StateNavigator  {
 ...
 */
onNavigate(
handler: (oldState: State, state: State, data: any, asyncData: any) => void): void;
