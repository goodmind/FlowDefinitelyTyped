declare module "react-native-tab-navigator" {
  ...
  declare export class TabNavigator
    mixins React.Component<TabNavigatorProps, any> {}
  declare class TabNavigator$Item
    mixins React.Component<TabNavigatorItemProps, any> {}
