declare module 'remote-redux-devtools' {
        import type {
          Action,ActionCreator,ActionCreatorsMapObject,StoreEnhancer
        } from 'redux';

	declare export interface RemoteReduxDevToolsOptions {
...
id?: string
	...
	declare export function composeWithDevTools(
options?: RemoteReduxDevToolsOptions): (...funcs: StoreEnhancer[]) => StoreEnhancer

	declare export function composeWithDevTools(...funcs: StoreEnhancer[]): StoreEnhancer
