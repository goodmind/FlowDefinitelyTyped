...
(modelContext: MakerJs$IModel, pathId: string, pathContext: MakerJs$IPath): void
} 
...
} & MakerJs$IRefPathIdInModel & MakerJs$IRouteOffset
 ...
 */
declare type MakerJs$IWalkModel = {} & MakerJs$IRefModelInModel & MakerJs$IRouteOffset
 ...
 */
declare function angle$ofArcMiddle(arc: MakerJs$IPathArc, ratio?: number): number
 ...
 */
declare function angle$ofPointInDegrees(origin: MakerJs$IPoint, pointToFindAngle: MakerJs$IPoint): number
 ...
 */
declare function angle$ofPointInRadians(origin: MakerJs$IPoint, pointToFindAngle: MakerJs$IPoint): number
 ...
 */
declare function angle$mirror(angleInDegrees: number, mirrorX: boolean, mirrorY: boolean): number
 ...
 */
declare function point$add(a: MakerJs$IPoint, b: MakerJs$IPoint, point$subtract?: boolean): MakerJs$IPoint
 ...
 */
declare function point$average(a: MakerJs$IPoint, b: MakerJs$IPoint): MakerJs$IPoint
 ...
 */
declare function point$closest(referencePoint: MakerJs$IPoint, pointOptions: MakerJs$IPoint[]): MakerJs$IPoint
 ...
 * @returns A new point object.
 */
declare function point$fromPolar(angleInRadians: number, radius: number): MakerJs$IPoint
 ...
 * @returns A new point object.
 */
declare function point$fromAngleOnCircle(angleInDegrees: number, circle: MakerJs$IPathCircle): MakerJs$IPoint
 ...
 */
declare function point$fromPathEnds(pathContext: MakerJs$IPath, pathOffset?: MakerJs$IPoint): MakerJs$IPoint[]
...
options?: MakerJs$IPathIntersectionBaseOptions): MakerJs$IPoint
 ...
 */
declare function point$middle(pathContext: MakerJs$IPath, ratio?: number): MakerJs$IPoint
...
mirrorX: boolean,
mirrorY: boolean): MakerJs$IPoint
 ...
 */
declare function point$rounded(pointContext: MakerJs$IPoint, accuracy?: number): MakerJs$IPoint
...
rotationOrigin?: MakerJs$IPoint): MakerJs$IPoint
 ...
 * @returns A new point.
 */
declare function point$scale(pointToScale: MakerJs$IPoint, scaleValue: number): MakerJs$IPoint
 ...
 * @returns A new point.
 */
declare function point$distort(pointToDistort: MakerJs$IPoint, scaleX: number, scaleY: number): MakerJs$IPoint
 ...
 * @returns A new point object.
 */
declare function point$subtract(a: MakerJs$IPoint, b: MakerJs$IPoint): MakerJs$IPoint
...
lineB: MakerJs$IPathLine,
filletRadius: number,
options?: MakerJs$IPointMatchOptions): MakerJs$IPathArc
 ...
 */
constructor(origin: MakerJs$IPoint, radius: number, startAngle: number, endAngle: number): this;
 ...
 */
constructor(pointA: MakerJs$IPoint, pointB: MakerJs$IPoint, radius: number, largeArc: boolean, clockwise: boolean): this;
 ...
 * @param clockwise Boolean flag to indicate clockwise direction.
 */
constructor(pointA: MakerJs$IPoint, pointB: MakerJs$IPoint, clockwise?: boolean): this;
 ...
 */
constructor(pointA: MakerJs$IPoint, pointB: MakerJs$IPoint, pointC: MakerJs$IPoint): this
}
...
constructor(toLine: MakerJs$IPathLine, distance: number, nearPoint: MakerJs$IPoint): this
}
...
modelContext: MakerJs$IModel,
options?: MakerJs$IFindLoopsOptions): MakerJs$IModel
...
keep?: MakerJs$IWalkPathBooleanCallback): MakerJs$IModel
 ...
 */
declare function units$conversionScale(srcUnitType: string, destUnitType: string): number
 ...
 */
declare function measure$increase(baseMeasure: MakerJs$IMeasure, addMeasure: MakerJs$IMeasure): MakerJs$IMeasure
 ...
 */
declare function measure$isArcConcaveTowardsPoint(arc: MakerJs$IPathArc, towardsPoint: MakerJs$IPoint): boolean
...
excludeTangents: boolean): boolean
 ...
 */
declare function measure$isBetweenArcAngles(angleInQuestion: number, arc: MakerJs$IPathArc, exclusive: boolean): boolean
 ...
 */
declare function measure$isBezierSeedLinear(seed: MakerJs$IPathBezierSeed): boolean
 ...
 */
declare function measure$isMeasurementOverlapping(measureA: MakerJs$IMeasure, measureB: MakerJs$IMeasure): boolean
 ...
 */
declare function measure$pointDistance(a: MakerJs$IPoint, b: MakerJs$IPoint): number
 ...
 */
declare function measure$pathExtents(pathToMeasure: MakerJs$IPath, addOffset?: MakerJs$IPoint): MakerJs$IMeasure
...
atlas?: MakerJs$measure.measure$Atlas): MakerJs$IMeasureWithCenter
 ...
 */
declare function measure$boundingHexagon(modelToMeasure: MakerJs$IModel): measure$IBoundingHex
 ...
 */
declare function exporter$chainToSVGPathData(MakerJs$chain: MakerJs$IChain, offset: MakerJs$IPoint): string
...
byLayers?: boolean,
origin?: MakerJs$IPoint): exporter$IPathDataByLayerMap | string


declare function exporter$toSVG(modelToExport: MakerJs$IModel, options?: exporter$ISVGRenderOptions): string


declare function exporter$toSVG(pathsToExport: MakerJs$IPath[], options?: exporter$ISVGRenderOptions): string


declare function exporter$toSVG(pathToExport: MakerJs$IPath, options?: exporter$ISVGRenderOptions): string
 ...
 */
declare function solvers$solveTriangleSSS(lengthA: number, lengthB: number, lengthC: number): number
...
otherAngleInDegrees: number): number
 ...
 */
declare function chain$cycle(chainContext: MakerJs$IChain, amount?: number): MakerJs$IChain
 ...
 * @returns The chainContext for cascading.
 */
declare function chain$startAt(chainContext: MakerJs$IChain, routeKey: string): MakerJs$IChain
...
distance: number,
maxPoints?: number): MakerJs$IPoint[]
 ...
 */
declare function chain$toKeyPoints(chainContext: MakerJs$IChain, maxArcFacet?: number): MakerJs$IPoint[]
...
MakerJs$models: MakerJs$IModelMap;
constructor(font: opentype.Font, text: string, fontSize: number, model$combine?: boolean, centerCharacterOrigin?: boolean, bezierAccuracy?: number): this
}
