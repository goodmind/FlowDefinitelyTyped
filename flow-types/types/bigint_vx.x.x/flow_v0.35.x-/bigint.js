 ...
 * @return {string} A string representation of given BigInt.
 */
declare export function BigInt$bigInt2str(x: BigInt$BigInt, base: string): string
 ...
 * @return {BigInt$BigInt} A parsed BigInt.
 */
declare export function BigInt$str2bigInt(s: string, b: string, n?: number, m?: number): BigInt$BigInt
