declare module 'earcut' {
        declare interface EarcutStatic {
 ...
 * @example const triangles = earcut(vertices, holes, dimensions);
const deviation = earcut.deviation(vertices, holes, dimensions, triangles);
 */
deviation(
vertices: ArrayLike<number>,
holes: ArrayLike<number> | void,
dimensions: number,
triangles: ArrayLike<number>): number,
default: EarcutStatic
} 
	declare var exports: EarcutStatic;
