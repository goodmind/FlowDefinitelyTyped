...
runOnPhantom: false,
listener: (status: "success" | "fail") => void): Promise<{
pageId: string
}>,
on(
event: "onLoadFinished",
...
event: "onAlert",
runOnPhantom: false,
listener: (msg: string) => void): Promise<{
pageId: string
}>,
on(event: "onAlert", listener: (msg: string) => void): Promise<{
pageId: string
}>,
on(
event: "onCallback",
runOnPhantom: false,
listener: (data: any) => void): Promise<{
pageId: string
}>,
on(
event: "onCallback",
...
event: "onClosing",
runOnPhantom: false,
listener: (closingPage: any) => void): Promise<{
pageId: string
}>,
on(
event: "onClosing",
...
runOnPhantom: false,
listener: (msg: string, lineNum: number, sourceId: string) => void): Promise<{
pageId: string
}>,
on(
event: "onConsoleMessage",
...
event: "onFilePicker",
runOnPhantom: false,
listener: (oldFile: any) => void): Promise<{
pageId: string
}>,
on(
event: "onFilePicker",
...
on(event: "onInitialized", listener: () => void): Promise<{
pageId: string
}>,
on(
event: "onLoadStarted",
...
on(event: "onLoadStarted", listener: () => void): Promise<{
pageId: string
}>,
on(
...
event: "onPageCreated",
runOnPhantom: false,
listener: (newPage: any) => void): Promise<{
pageId: string
}>,
on(
event: "onPageCreated",
...
event: "onPrompt",
runOnPhantom: false,
listener: (msg: string, defaultVal: string) => void): Promise<{
pageId: string
}>,
on(
event: "onPrompt",
...
runOnPhantom: false,
listener: (response: IResponse) => void): Promise<{
pageId: string
}>,
on(
event: "onResourceReceived",
...
event: "onUrlChanged",
runOnPhantom: false,
listener: (targetUrl: string) => void): Promise<{
pageId: string
}>,
on(
event: "onUrlChanged",
...
property(
key: "canGoBack" | "canGoForward" | "navigationLocked" | "ownsPages"): Promise<boolean>,
property(key: "framesCount" | "offlineStorageQuota" | "zoomFactor"): Promise<number>,
property(
key: "clipRect"): Promise<{
top: number,
left: number,
width: number,
height: number
...
property(key: "customHeaders"): Promise<{
[key: string]: string
}>,
property(key: "paperSize"): Promise<IPaperSizeOptions>,
property(key: "scrollPosition"): Promise<{
top: number,
left: number
}>,
property(key: "viewportSize"): Promise<{
width: number,
height: number
}>,
...
expires?: string
	...
	declare export interface IPaperSizeOptions {
width?: string,
height?: string,
format?: "A3"
| "A4"
...
contents: IPhantomCallback
	...
	declare export interface IOpenWebPageSettings {
operation?: "GET"
| "POST"
| "HEAD"
| "DELETE"
 ...
 */
declare export interface IPhantomCallback {
transform: true,
target: Function,
method: "callback",
parent: "phantom"
...
statusText: string
	...
	declare export interface IRequestData {
id: number,
method: string,
url: string,
time: Date,
