 ...
 */
declare function client$load(name: "taskqueue", version: "v1beta2"): PromiseLike<void>


declare function client$load(name: "taskqueue", version: "v1beta2", callback: () => any): void
