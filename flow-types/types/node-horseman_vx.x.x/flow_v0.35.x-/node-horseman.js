declare module 'node-horseman' {
        declare module.exports: typeof horseman
 ...
 */
cookies(args: {[key: string]: any} | {[key: string]: any}[] | string): this;
 ...
 */
crop(area: string | {[key: string]: any}, path: string): this;
 ...
 */
type(selector: string, text: string, options?: {[key: string]: any}): this;
 ...
 */
waitForNextPage(object?: {[key: string]: any}): this;

/**
 * Wait for a selector to be present on the current page.
 */
waitForSelector(selector: string, options: {[key: string]: any}): this;
