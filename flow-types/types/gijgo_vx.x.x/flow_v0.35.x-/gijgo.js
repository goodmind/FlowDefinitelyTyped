declare module 'gijgo' {
        declare module.exports: typeof Types
...
width?: number
	...
	declare interface GridParamNames {
direction?: string,
limit?: string,
page?: string,
sortBy?: string,
...
totalRecordsField?: string
	...
	declare interface GridIcons {
expandRow?: string,
collapseRow?: string,
expandGroup?: string,
collapseGroup?: string
} 
	declare interface GridGrouping {
groupBy: string
} 
	declare interface GridHeaderFilter {
type: string
} 
	declare interface GridInlineEditing {
mode?: string,
managementColumn?: boolean
} 
	declare interface GridOptimisticPersistence {
...
open(): Dialog
	...
	declare interface CheckboxSettings {
uiLibrary?: string,
iconsLibrary?: string,
...
destroy(): void
	...
	declare interface DatePickerIcons {
rightIcon?: string
} 
	declare interface DatePickerSettings {
...
value(value?: string): string | DatePicker
	...
	declare interface DropDownIcons {
dropdown?: string
} 
	declare interface DropDownSettings {
dataSource?: any,
textField?: string,
valueField?: string,
...
destroy(): void
	...
	declare interface TimePickerSettings {
width?: number,
modal?: boolean,
header?: boolean,
footer?: boolean,
...
value(value?: string): string | TimePicker
	...
	declare interface DateTimePickerSettings {
...
change?: (e: any) => any
	...
	declare type DateTimePicker = {
destroy(): void,
value(value?: string): string | DateTimePicker
} & JQuery

	declare interface SliderSettings {
min?: number,
max?: number,
uiLibrary?: string,
value?: string,
...
value(value?: string): string | Slider
	...
	declare interface TreeIcons {
expand?: string,
collapse?: string
} 
	declare interface TreeParamNames {
parentId?: string
} 
	declare interface TreeSettings {
autoLoad?: boolean,
selectionType?: string,
...
grid<Entity, Params>(
settings: Types.GridSettings<Entity>): Types.Grid<Entity, Params>,
