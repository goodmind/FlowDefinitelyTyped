...
static +authContinue: Class<errors__authContinue> & errors__authContinue & 1;// 1
...
static +objectTooBig: Class<errors__objectTooBig> & errors__objectTooBig & 4;// 4
static +serverBusy: Class<errors__serverBusy> & errors__serverBusy & 5;// 5
static +cLibInternal: Class<errors__cLibInternal> & errors__cLibInternal & 6;// 6
static +cLinInvalidArgument: Class<errors__cLinInvalidArgument> & errors__cLinInvalidArgument & 7;// 7
static +cLibOutOfMemory: Class<errors__cLibOutOfMemory> & errors__cLibOutOfMemory & 8;// 8
static +invalidRange: Class<errors__invalidRange> & errors__invalidRange & 9;// 9
static +cLibGenericError: Class<errors__cLibGenericError> & errors__cLibGenericError & 10;// 10
static +temporaryError: Class<errors__temporaryError> & errors__temporaryError & 11;// 11
static +keyAlreadyExists: Class<errors__keyAlreadyExists> & errors__keyAlreadyExists & 12;// 12
static +keyNotFound: Class<errors__keyNotFound> & errors__keyNotFound & 13;// 13
static +failedToOpenLibrary: Class<errors__failedToOpenLibrary> & errors__failedToOpenLibrary & 14;// 14
static +failedToFindSymbol: Class<errors__failedToFindSymbol> & errors__failedToFindSymbol & 15;// 15
static +networkError: Class<errors__networkError> & errors__networkError & 16;// 16
static +wrongServer: Class<errors__wrongServer> & errors__wrongServer & 17;// 17
static +notMyVBucket: Class<errors__notMyVBucket> & errors__notMyVBucket & 18;// 18
static +notSorted: Class<errors__notSorted> & errors__notSorted & 19;// 19
static +notSupported: Class<errors__notSupported> & errors__notSupported & 20;// 20
static +unknownCommand: Class<errors__unknownCommand> & errors__unknownCommand & 21;// 21
static +unknownHost: Class<errors__unknownHost> & errors__unknownHost & 22;// 22
static +protocolError: Class<errors__protocolError> & errors__protocolError & 23;// 23
static +timedOut: Class<errors__timedOut> & errors__timedOut & 24;// 24
static +connectError: Class<errors__connectError> & errors__connectError & 25;// 25
static +bukcketNotFound: Class<errors__bukcketNotFound> & errors__bukcketNotFound & 26;// 26
static +clientOutOfMemory: Class<errors__clientOutOfMemory> & errors__clientOutOfMemory & 27;// 27
static +clientTemporaryError: Class<errors__clientTemporaryError> & errors__clientTemporaryError & 28;// 28
...
static +invalidHostFormat: Class<errors__invalidHostFormat> & errors__invalidHostFormat & 31;// 31
static +notEnoughNodes: Class<errors__notEnoughNodes> & errors__notEnoughNodes & 32;// 32
static +duplicateItems: Class<errors__duplicateItems> & errors__duplicateItems & 33;// 33
static +noMatchingServerForKey: Class<errors__noMatchingServerForKey> & errors__noMatchingServerForKey & 34;// 34
static +badEnvironmentVariable: Class<errors__badEnvironmentVariable> & errors__badEnvironmentVariable & 35;// 35
static +outOfMemory: Class<errors__outOfMemory> & errors__outOfMemory & 36;// 36
static +invalidArguments: Class<errors__invalidArguments> & errors__invalidArguments & 37;// 37
static +schedulingError: Class<errors__schedulingError> & errors__schedulingError & 38;// 38
static +checkResults: Class<errors__checkResults> & errors__checkResults & 39;// 39
static +genericError: Class<errors__genericError> & errors__genericError & 40;// 40
static +durabilityFailed: Class<errors__durabilityFailed> & errors__durabilityFailed & 41;// 41
 ...
 */
declare class ClassicAuthenticator mixins Authenticator {
 ...
 */
declare class PasswordAuthenticator mixins Authenticator {
 ...
 */
declare class CertAuthenticator mixins Authenticator {
...
deferred?: boolean
	...
	declare interface CreatePrimaryIndexOptions {
...
deferred?: boolean
	...
	declare interface DropIndexOptions {
...
ignoreIfNotExists?: boolean
	...
	declare interface DropPrimaryIndexOptions {
...
using: "gsi"
	...
	declare interface WatchIndexesOptions {
...
callback: (err: CouchbaseError | null, deferredIndexes: string[]) => void): void,
...
indexName: string,
fields: string[],
callback: (err: CouchbaseError | null) => void): void,
 ...
 */
getIndexes(
callback: (err: CouchbaseError | null, indexes: IndexInfo[] | null) => void): void,
...
declare  class ViewQuery$ErrorMode {
  constructor(...args: empty): mixed;
static +CONTINUE: Class<ViewQuery$ErrorMode__CONTINUE> & ViewQuery$ErrorMode__CONTINUE & 0;// 0
static +STOP: Class<ViewQuery$ErrorMode__STOP> & ViewQuery$ErrorMode__STOP & 1;// 1
...
declare  class ViewQuery$Order {
  constructor(...args: empty): mixed;
static +ASCENDING: Class<ViewQuery$Order__ASCENDING> & ViewQuery$Order__ASCENDING & 0;// 0
static +DESCENDING: Class<ViewQuery$Order__DESCENDING> & ViewQuery$Order__DESCENDING & 1;// 1
...
declare  class ViewQuery$Update {
  constructor(...args: empty): mixed;
static +BEFORE: Class<ViewQuery$Update__BEFORE> & ViewQuery$Update__BEFORE & 0;// 0
...
declare  class N1qlQuery$Consistency {
  constructor(...args: empty): mixed;
static +NOT_BOUND: Class<N1qlQuery$Consistency__NOT_BOUND> & N1qlQuery$Consistency__NOT_BOUND & 0;// 0
static +REQUEST_PLUS: Class<N1qlQuery$Consistency__REQUEST_PLUS> & N1qlQuery$Consistency__REQUEST_PLUS & 1;// 1
static +STATEMENT_PLUS: Class<N1qlQuery$Consistency__STATEMENT_PLUS> & N1qlQuery$Consistency__STATEMENT_PLUS & 2;// 2

}

declare class N1qlQuery$Consistency__NOT_BOUND mixins N1qlQuery$Consistency {}
declare class N1qlQuery$Consistency__REQUEST_PLUS mixins N1qlQuery$Consistency {}
declare class N1qlQuery$Consistency__STATEMENT_PLUS mixins N1qlQuery$Consistency {}
...
declare  class SpatialQuery$Update {
  constructor(...args: empty): mixed;
static +BEFORE: Class<SpatialQuery$Update__BEFORE> & SpatialQuery$Update__BEFORE & 0;// 0
static +NONE: Class<SpatialQuery$Update__NONE> & SpatialQuery$Update__NONE & 1;// 1
static +AFTER: Class<SpatialQuery$Update__AFTER> & SpatialQuery$Update__AFTER & 2;// 2
 ...
 */
static new(indexName: string, query: SearchQuery$SearchQuery$Query): SearchQuery;
 ...
 */
static booleanField(val: boolean): SearchQuery$SearchQuery$BooleanFieldQuery;

/**
 * Creates a query for matches all of a list of subqueries in an index.
 */
static conjuncts(
queries: $ReadOnlyArray<SearchQuery$SearchQuery$Query>): SearchQuery$SearchQuery$ConjunctionQuery;

/**
 * Creates a query for matches all of a list of subqueries in an index.
 */
static conjuncts(
...queries: SearchQuery$SearchQuery$Query[]): SearchQuery$SearchQuery$ConjunctionQuery;
 ...
 */
static disjuncts(
queries: $ReadOnlyArray<SearchQuery$SearchQuery$Query>): SearchQuery$SearchQuery$DisjunctionQuery;

/**
 * Creates a query for matches any of a list of subqueries in an index.
 */
static disjuncts(
...queries: SearchQuery$SearchQuery$Query[]): SearchQuery$SearchQuery$DisjunctionQuery;

/**
 * Creates a query which allows you to match a list of document IDs in an index.
 */
static docIds(ids: $ReadOnlyArray<string>): SearchQuery$SearchQuery$DocIdQuery;
...
tl_lon: number,
br_lat: number,
br_lon: number): SearchQuery$SearchQuery$GeoBoundingBoxQuery;
 ...
 */
static matchPhrase(phrase: string): SearchQuery$SearchQuery$MatchPhraseQuery;
 ...
 */
static phrase(terms: $ReadOnlyArray<string>): SearchQuery$SearchQuery$PhraseQuery;
...
fields: $ReadOnlyArray<string>): this;

/**
 * Request a particular highlight style and field list for this query.
 */
highlight(style: SearchQuery$SearchQuery$HighlightStyle, ...fields: string[]): this;
 ...
 * @param query
 */
must(query: SearchQuery$Query): this;

/**
 * Specifies a predicate query which must not match.
 * @param query
 */
mustNot(query: SearchQuery$Query): this;

/**
 * Specifies a predicate query which should match.
 * @param query
 */
should(query: SearchQuery$Query): this;
...
declare  class SearchQuery$Consistency {
  constructor(...args: empty): mixed;
static +NOT_BOUNDED: Class<SearchQuery$Consistency__NOT_BOUNDED> & SearchQuery$Consistency__NOT_BOUNDED & 0;// 0

}

declare class SearchQuery$Consistency__NOT_BOUNDED mixins SearchQuery$Consistency {}
...
declare  class SearchQuery$HighlightStyle {
  constructor(...args: empty): mixed;
static +DEFAULT: Class<SearchQuery$HighlightStyle__DEFAULT> & SearchQuery$HighlightStyle__DEFAULT & 0;// 0
static +HTML: Class<SearchQuery$HighlightStyle__HTML> & SearchQuery$HighlightStyle__HTML & 1;// 1
static +ANSI: Class<SearchQuery$HighlightStyle__ANSI> & SearchQuery$HighlightStyle__ANSI & 2;// 2

}

declare class SearchQuery$HighlightStyle__DEFAULT mixins SearchQuery$HighlightStyle {}
declare class SearchQuery$HighlightStyle__HTML mixins SearchQuery$HighlightStyle {}
declare class SearchQuery$HighlightStyle__ANSI mixins SearchQuery$HighlightStyle {}
...
declare function SearchFacet$term(SearchSort$field: string, size: number): SearchFacet$TermFacet


declare class SearchFacet$NumericFacet mixins SearchFacet {
addRange(name: string, min: number, max: number): this
}

declare function SearchFacet$numeric(SearchSort$field: string, size: number): SearchFacet$NumericFacet


declare class SearchFacet$DateFacet mixins SearchFacet {
addRange(name: string, start: string, end: string): this
}

declare function SearchFacet$date(SearchSort$field: string, size: number): SearchFacet$DateFacet
...
descending(descending: boolean): this
      ...
      declare var npm$namespace$SearchSort: {
...
declare function SearchSort$score(): SearchSort$ScoreSort


declare class SearchSort$IdSort mixins SearchSort {}

declare function SearchSort$id(): SearchSort$IdSort


declare class SearchSort$FieldSort mixins SearchSort {
type(type: string): this;
mode(mode: string): this;
missing(missing: string): this
}

declare function SearchSort$field(SearchSort$field: string): SearchSort$FieldSort
...
declare function SearchSort$geoDistance(SearchSort$field: string, lat: number, lon: number): SearchSort$GeoDistanceSort
 ...
 * @param callback The callback function.
 */
append(key: string | Buffer, fragment: any, callback: Bucket$Bucket$OpCallback): void,
...
callback: Bucket$Bucket$OpCallback): void,
 ...
 * @param callback The callback function.
 */
counter(key: string | Buffer, delta: number, callback: Bucket$Bucket$OpCallback): void,
 ...
 * @param callback The callback function.
 */
get(key: string | Buffer, options: any, callback: Bucket$Bucket$OpCallback): void,
 ...
 * @param callback The callback function.
 */
getAndTouch(key: string | Buffer, expiry: number, callback: Bucket$Bucket$OpCallback): void,
...
callback: Bucket$Bucket$MultiGetCallback): void,
 ...
 * @param callback The callback function.
 */
insert(key: string | Buffer, value: any, callback: Bucket$Bucket$OpCallback): void,
 ...
 * @param callback The callback function.
 */
prepend(key: string, fragment: any, callback: Bucket$Bucket$OpCallback): void,
...
callback?: Bucket$Bucket$QueryCallback): Bucket$Bucket$ViewQueryResponse,
...
query(
query: N1qlQuery,
callback?: Bucket$Bucket$N1qlQueryCallback): Bucket$Bucket$N1qlQueryResponse,
...
query(
query: SearchQuery,
callback?: Bucket$Bucket$FtsQueryCallback): Bucket$Bucket$FtsQueryResponse,
 ...
 * @param callback The callback function.
 */
replace(key: string | Buffer, value: any, callback: Bucket$Bucket$OpCallback): void,
...
decoder: Bucket$Bucket$DecoderFunction): void,
 ...
 * @param callback The callback function.
 */
upsert(key: string | Buffer, value: any, callback: Bucket$Bucket$OpCallback): void,
 ...
 */
(error: CouchbaseError | null, rows: any[] | null, meta: Bucket$Bucket$ViewQueryResponse.FtsQueryResponse$Meta): void
} 
 ...
 * This is used as a callback from executed queries. It is a shortcut method that automatically subscribes to the rows and error events of the Bucket.ViewQueryResponse.
 */
declare interface Bucket$N1qlQueryCallback {
 ...
 * @param meta The metadata returned by the query.
 */
(error: CouchbaseError | null, rows: any[] | null, meta: Bucket$Bucket$N1qlQueryResponse.FtsQueryResponse$Meta): void
} 
 ...
 * This is used as a callback from executed queries. It is a shortcut method that automatically subscribes to the rows and error events of the Bucket.ViewQueryResponse.
 */
declare interface Bucket$FtsQueryCallback {
 ...
 * @param meta The metadata returned by the query.
 */
(error: CouchbaseError | null, rows: any[] | null, meta: Bucket$Bucket$FtsQueryResponse.FtsQueryResponse$Meta): void
} 
...
addListener(
event: "end",
listener: (meta: Bucket$N1qlQueryResponse.FtsQueryResponse$Meta) => void): this,
addListener(event: "error", listener: (error: CouchbaseError) => void): this,
addListener(
event: "row",
listener: (row: any, meta: Bucket$N1qlQueryResponse.FtsQueryResponse$Meta) => void): this,
addListener(
event: "rows",
listener: (rows: any[], meta: Bucket$N1qlQueryResponse.FtsQueryResponse$Meta) => void): this,
on(
event: "end",
listener: (meta: Bucket$N1qlQueryResponse.FtsQueryResponse$Meta) => void): this,
on(event: "error", listener: (error: CouchbaseError) => void): this,
 ...
 */
declare class Bucket$TranscoderDoc  {
value: Buffer;
flags: number
}
...
addListener(
event: "end",
listener: (meta: Bucket$ViewQueryResponse.N1qlQueryResponse$Meta) => void): this,
addListener(event: "error", listener: (error: CouchbaseError) => void): this,
addListener(
event: "row",
listener: (row: any, meta: Bucket$ViewQueryResponse.N1qlQueryResponse$Meta) => void): this,
addListener(
event: "rows",
listener: (rows: any[], meta: Bucket$ViewQueryResponse.N1qlQueryResponse$Meta) => void): this,
on(
event: "end",
listener: (meta: Bucket$ViewQueryResponse.N1qlQueryResponse$Meta) => void): this,
on(event: "error", listener: (error: CouchbaseError) => void): this,
...
addListener(
event: "end",
listener: (meta: Bucket$FtsQueryResponse.ViewQueryResponse$Meta) => void): this,
addListener(event: "error", listener: (error: CouchbaseError) => void): this,
addListener(
event: "row",
listener: (row: any, meta: Bucket$FtsQueryResponse.ViewQueryResponse$Meta) => void): this,
addListener(
event: "rows",
listener: (rows: any[], meta: Bucket$FtsQueryResponse.ViewQueryResponse$Meta) => void): this,
on(
event: "end",
listener: (meta: Bucket$FtsQueryResponse.ViewQueryResponse$Meta) => void): this,
on(event: "error", listener: (error: CouchbaseError) => void): this,
