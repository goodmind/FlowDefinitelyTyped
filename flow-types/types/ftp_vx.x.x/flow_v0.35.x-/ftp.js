 ...
 */
connect(config?: Client$Client$Options): void;
...
callback: (error: Error, listing: Client$Client$ListingElement[]) => void): void;
list(
path: string,
callback: (error: Error, listing: Client$Client$ListingElement[]) => void): void;
list(
...
get(
path: string,
callback: (error: Error, stream: NodeJS.ReadableStream) => void): void;
get(
path: string,
useCompression: boolean,
callback: (error: Error, stream: NodeJS.ReadableStream) => void): void;
...
site(
command: string,
callback: (error: Error, responseText: string, responseCode: number) => void): void;
