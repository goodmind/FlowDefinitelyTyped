declare module "graphql-resolvers" {
  import type { IFieldResolver } from "graphql-tools";
  ...
  declare export function combineResolvers<TSource, TContext>(
    ...resolvers: core$Array<IFieldResolver<TSource, TContext, TArgs>>
  ...
  declare export function resolveDependee(
    dependeeName: string
  ): IFieldResolver<any, any, TArgs>;

  declare export function resolveDependees(
