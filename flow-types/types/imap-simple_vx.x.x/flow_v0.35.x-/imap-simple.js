...
seqno: number
	...
	declare export class ImapSimple mixins NodeJS.EventEmitter {
constructor(imap: Imap): this;
...
callback: (err: Error, messages: Message[]) => void): void;
 ...
 */
declare export class errors$ConnectionTimeoutError mixins Error {
timeout: number;
...
callback: (err: Error, connection: ImapSimple) => void): void

	declare export function connect(options: ImapSimpleOptions): Promise<ImapSimple>
