declare interface PageJS$Static {
   ...
   * @type {PageJS$Route}
   */
  PageJS$Route: PageJS$Route;

  /**
   * Export Context
   * @type {PageJS$Context}
   */
  PageJS$Context: PageJS$Context;
   ...
   * Links that are not of the same origin are disregarded and will not be dispatched.
   */
  (path: RegExp, ...callbacks: PageJS$Callback[]): void;
   ...
   */
  (options: $Shape<PageJS$Options>): void;
   ...
   */
  start(options: $Shape<PageJS$Options>): void;
...
declare interface PageJS$Context {
   ...
   */
  new(path: string, state?: any): PageJS$Context;
  [idx: string]: any;
...
declare module "page" {
  declare var page: PageJS$PageJS$Static;
  declare export default typeof page;
}
declare var page: PageJS$PageJS$Static;
