...
constructor(options?: UglifyJsPlugin$UglifyJsPlugin$UglifyJsPluginOptions): this
}
...
extractComments?: boolean | RegExp | ((node: {[key: string]: any}, comment: string) => boolean) | UglifyJsPlugin$ExtractCommentsOptions,
...
condition?: RegExp | ((node: {[key: string]: any}, comment: string) => boolean),
