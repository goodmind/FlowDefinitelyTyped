declare module "csv-parse" {
    ...
    declare function parse(callback?: parse$parse$Callback): any;

    declare type parse$Callback = (err: any, output: any) => void;

    declare class parse$Parser {
        constructor(options: parse$Options): this;
        __push(line: any): any;
    ...
    declare type parse$ParserStream = {
