declare module 'jasmine-jquery' {
	...
	declare function loadJSONFixtures(...uls: string[]): jasmine$jasmine$JSONFixtures

	declare function getJSONFixture(url: string): any

	declare function spyOnEvent(selector: string, eventName: string): jasmine$jasmine$JQueryEventSpy
...
declare var jasmine$JQuery: jasmine$JasmineJQuery;
    }
