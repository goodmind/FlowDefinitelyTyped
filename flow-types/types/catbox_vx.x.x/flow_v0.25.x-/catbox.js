declare module "catbox" {
  ...
  declare export type EnginePrototypeOrObject =
    | EnginePrototype<any>
    | ClientApi<any>;
  ...
  declare export type PolicyOptionVariants<T> =
    | PolicyOptions<T>
    | DecoratedPolicyOptions<T>;
  declare export type Id =
    | string
    | {
        id: string
      };
 ...
 */
  ...
  declare export type DecoratedPolicyOptions<T> = {
     ...
     * @default false
     */
    getDecoratedValue: boolean | void
  } & PolicyOptions<T>;
   ...
   * @see {@link https://github.com/hapijs/catbox#policy}
   */
  declare export type GenerateFunc<T> = (
    id: Id,
    flags: GenerateFuncFlags
  ) => Promise<T>;
