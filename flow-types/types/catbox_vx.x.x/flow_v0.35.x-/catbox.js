 ...
 */
declare export class Client<T> mixins ClientApi<T> {
constructor(engine: EnginePrototypeOrObject, options: ClientOptions): this;
...
validateSegmentName(segment: string): null | Error
	...
	declare export type EnginePrototypeOrObject = EnginePrototype<any> | ClientApi<any>;
	
/**
 * A prototype CatBox engine function
 */
declare export interface EnginePrototype<T> {
 ...
 */
declare export interface ClientApi<T> {
 ...
 */
declare export interface CacheKey {
 ...
 */
declare export interface CachedObject<T> {
...
partition: string
	...
	declare export type PolicyOptionVariants<T> = PolicyOptions<T> | DecoratedPolicyOptions<T>;
 ...
 */
declare export class Policy<T, O: PolicyOptionVariants<T>>  {
constructor(options: O, cache: Client<T>, segment: string): this;
 ...
 */
get(id: Id): Promise<"There was Conditional Type, use $Call utility type">;
...
stats(): CacheStatisticsObject
	...
	declare export interface DecoratedResult<T> {
value: T,
cached: PolicyGetCachedOptions<T>,
report: PolicyGetReportLog
} 
	declare export interface PolicyGetCachedOptions<T> {
 ...
 * @see {@link https://github.com/hapijs/catbox#policy}
 */
declare export interface PolicyOptions<T> {
...
pendingGenerateTimeout?: number
	...
	declare export type DecoratedPolicyOptions<T> = {
...
getDecoratedValue?: boolean
	...
	declare export interface GenerateFuncFlags {
ttl: number
} 
 ...
 * @see {@link https://github.com/hapijs/catbox#policy}
 */
declare export type GenerateFunc<T> = (id: Id, flags: GenerateFuncFlags) => Promise<T>;
	
/**
 * An object with logging information about the generation operation containing the following keys (as relevant):
 */
declare export interface PolicyGetReportLog {
 ...
 */
declare export interface CacheStatisticsObject {
