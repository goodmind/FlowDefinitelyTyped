 ...
 */
   ...
   * The interpolator factory may be set using the interpolate(...) method of the scale.
   */
  declare export function scaleLinear<Range, Output>(): ScaleLinear<
    Range,
    Output
  >;
 ...
 */
   ...
   * The interpolator factory may be set using the interpolate(...) method of the scale.
   */
  declare export function scaleLog<Range, Output>(): ScaleLogarithmic<
    Range,
    Output
  >;
 ...
 */
   ...
   */
  declare export function scaleSequential<Output>(
    interpolator: (t: number) => Output
   ...
   * @param interpolator The scale’s interpolator.
   */
  declare export function scaleDiverging<T>(
 ...
 */
   ...
   */
  declare export interface ScaleThreshold<
   ...
   * The second generic corresponds to the data type of range values.
   */
  declare export function scaleThreshold<
    Domain: number | string | Date,
    Range
   ...
   * The second generic corresponds to the data type of range values.
   */
  declare export interface ScaleOrdinal<
    Domain: {
      toString(): string
    },
    Range
   ...
   */
  declare export function scaleOrdinal<Range>(
   ...
   * @parm range An optional array of range values to initialize the scale with.
   */
  declare export function scaleOrdinal<
    Domain: {
      toString(): string
    },
    Range
   ...
   */
  declare export interface ScaleBand<
    Domain: {
      toString(): string
    }
  > {
   ...
   * The generic corresponds to the data type of domain elements.
   */
  declare export function scaleBand<
    Domain: {
      toString(): string
    }
  >(): ScaleBand<Domain>;
   ...
   * The generic corresponds to the data type of domain elements.
   */
  declare export interface ScalePoint<
    Domain: {
      toString(): string
    }
  > {
   ...
   * The generic corresponds to the data type of domain elements.
   */
  declare export function scalePoint<
    Domain: {
      toString(): string
    }
  >(): ScalePoint<Domain>;
