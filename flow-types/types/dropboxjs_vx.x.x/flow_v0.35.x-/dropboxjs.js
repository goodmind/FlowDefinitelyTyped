...
(err: Dropbox$ApiError, fileContents: string, stat: File$File$Stat, rangeInfo: Http$Http$RangeInfo): void
} 
...
authDriver(driver: Dropbox$AuthDriver.AuthDriver$IAuthDriver): Dropbox$Client;
dropboxUid(): string;
...
Dropbox$AccountInfo: Dropbox$AccountInfo) => void): XMLHttpRequest;
getAccountInfo(
...
err: Dropbox$ApiError,
stat: File$File$Stat,
folderEntries: File$File$Stat[]) => void): XMLHttpRequest;
stat(
path: string,
...
err: Dropbox$ApiError,
stat: File$File$Stat,
folderEntries: File$File$Stat[]) => void): void;
metadata(
path: string,
options: File$File$StatOptions,
callback: (
...
makeUrl(
path: string,
callback: (err: Dropbox$ApiError, shareUrl: File$File$ShareUrl) => void): XMLHttpRequest;
makeUrl(
path: string,
...
history(
path: string,
callback: (err: Dropbox$ApiError, fileVersions: File$File$Stat[]) => void): XMLHttpRequest;
history(
path: string,
...
path: string,
options: Dropbox$HistoryOptions,
callback: (err: Dropbox$ApiError, fileVersions: File$File$Stat[]) => void): void;
...
path: string,
namePattern: string,
callback: (err: Dropbox$ApiError, resultStats: File$File$Stat[]) => void): XMLHttpRequest;
findByName(
path: string,
namePattern: string,
...
namePattern: string,
options: Dropbox$FindByNameOptions,
callback: (err: Dropbox$ApiError, resultStats: File$File$Stat[]) => void): void;
makeCopyReference(
path: string,
callback: (err: Dropbox$ApiError, copyReference: File$File$CopyReference) => void): XMLHttpRequest;
copyRef(
path: string,
callback: (err: Dropbox$ApiError, copyReference: File$File$CopyReference) => void): XMLHttpRequest;
pullChanges(
callback: (err: Dropbox$ApiError, changes: Http$Http$PulledChanges) => void): XMLHttpRequest;
pullChanges(
cursor: string,
callback: (err: Dropbox$ApiError, changes: Http$Http$PulledChanges) => void): XMLHttpRequest;
pullChanges(
...
delta(
cursor: string,
callback: (err: Dropbox$ApiError, changes: Http$Http$PulledChanges) => void): void;
delta(
cursor: Http$Http$PulledChanges,
callback: (err: Dropbox$ApiError, changes: Http$Http$PulledChanges) => void): void;
pollForChanges(
cursor: string,
options: {},
callback: (err: Dropbox$ApiError, changes: Http$Http$PollResult) => void): void;
pollForChanges(
cursor: Http$Http$PulledChanges,
options: {},
callback: (err: Dropbox$ApiError, changes: Http$Http$PollResult) => void): void;
...
callback: Dropbox$FileStatCallback): XMLHttpRequest;
appInfo(
callback: (err: Dropbox$ApiError, changes: Http$Http$AppInfo) => void): XMLHttpRequest;
appInfo(
appKey: string,
callback: (err: Dropbox$ApiError, changes: Http$Http$AppInfo) => void): XMLHttpRequest;
isAppDeveloper(
