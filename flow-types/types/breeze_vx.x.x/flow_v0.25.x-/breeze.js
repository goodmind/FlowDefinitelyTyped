...
declare export class breeze$core$Enum mixins IEnum {
...
declare export class breeze$ComplexType mixins IStructuralType {
  complexProperties: breeze$DataProperty[];
  dataProperties: breeze$DataProperty[];
  name: string;
  namespace: string;
...
declare export class breeze$DataProperty mixins IProperty {
...
declare export class breeze$DataTypeSymbol mixins undefined.EnumSymbol {
  defaultValue: any;
...
declare export class breeze$EntityActionSymbol mixins undefined.EnumSymbol {}
...
declare export class breeze$PropertyChangedEvent mixins undefined.Event {
...
declare export class breeze$EntityManager {
  ...
  fetchMetadata(
    ...
    errorCallback?: breeze$coreErrorCallback
  ): Promise<any>;
...
declare export class breeze$EntityChangedEvent mixins undefined.Event {
...
declare export class breeze$HasChangesChangedEvent mixins undefined.Event {
  subscribe(
...
declare export class breeze$EntityStateSymbol mixins undefined.EnumSymbol {
  isAdded(): boolean;
...
declare export class breeze$EntityType mixins IStructuralType {
...
declare export class breeze$FetchStrategySymbol mixins undefined.EnumSymbol {}
...
declare export class breeze$FilterQueryOpSymbol mixins undefined.EnumSymbol {}
...
declare export class breeze$MergeStrategySymbol mixins undefined.EnumSymbol {}
...
declare export class breeze$NavigationProperty mixins IProperty {
...
declare export function breeze$config$setQ(
  q: breeze$promisesIPromiseService
): void;
