...
export interface core$ErrorCallback {
  (error: Error): void;
}

export interface core$IEnum {
...
declare export class core$Event {
  constructor(
    name: string,
    publisher: any,
    defaultErrorCallback?: core$ErrorCallback
  ): this;
  ...
  publish(
    ...
    errorCallback?: core$ErrorCallback
  ): void;
...
declare export function core$objectForEach(
  obj: Object,
...
declare export function core$propEq(
  propertyName: string,
  value: any
): (obj: Object) => boolean;
...
declare export function core$arrayEquals(
  a1: any[],
  a2: any[],
  equalsFn: (e1: any, e2: any) => boolean
): boolean;

declare export function core$arrayFirst(
  a1: any[],
  predicate: (e: any) => boolean
): any;

declare export function core$arrayIndexOf(
  a1: any[],
  predicate: (e: any) => boolean
): number;
...
declare export function core$arrayZip(
  a1: any[],
  a2: any[],
  callback: (e1: any, e2: any) => any
): any[];

declare export function core$requireLib(
  libnames: string,
  errMessage: string
): Object;

declare export function core$using(
  obj: Object,
  property: string,
  tempValue: any,
  fn: () => any
...
declare export function core$stringStartsWith(
  str: string,
  prefix: string
): boolean;

declare export function core$stringEndsWith(
  str: string,
  suffix: string
): boolean;

declare export function core$formatString(
  format: string,
  ...args: any[]
): string;
 ...
 */
declare export function core$getPropertyDescriptor(
  obj: any,
  propertyName: string
): PropertyDescriptor;
 ...
 */
declare export function core$toJSONSafe(
  obj: any,
...
declare export class breeze$EntityActionSymbol
  mixins undefined.core$EnumSymbol {}
...
declare export class breeze$EntityManager {
  ...
  fetchMetadata(
    ...
    errorCallback?: breeze$core.core$ErrorCallback
  ): Promise<any>;
...
declare export class breeze$FetchStrategySymbol
  mixins undefined.core$EnumSymbol {}
...
declare export class breeze$FilterQueryOpSymbol
  mixins undefined.core$EnumSymbol {}
...
declare export class breeze$MergeStrategySymbol
  mixins undefined.core$EnumSymbol {}
...
declare export class breeze$ValidationOptions {
  ...
  using(
    breeze$config: breeze$ValidationOptionsConfiguration
 ...
 */
declare export function config$getAdapter(
  interfaceName: string,
  adapterName?: string
): Function;
 ...
 */
declare export function config$getAdapterInstance(
  interfaceName: string,
  adapterName?: string
): Object;
 ...
 * @return {an} instance of the specified adapter}
 */
declare export function config$initializeAdapterInstance(
  interfaceName: string,
  adapterName: string,
  isDefault?: boolean
): Object;

export interface config$AdapterInstancesConfig {
  /**
 ...
 */
declare export function config$initializeAdapterInstances(
  breeze$config: config$AdapterInstancesConfig
): Object[];
 ...
 */
declare export function config$registerAdapter(
  interfaceName: string,
  adapterCtor: Function
): void;

declare export function config$registerFunction(
  fn: Function,
  fnName: string
): void;

declare export function config$registerType(
  ctor: Function,
  typeName: string
): void;
 ...
 */
declare export function config$setQ(
  q: breeze$breeze$promises.promises$IPromiseService
): void;
...
export interface promises$IDeferred<T> {
  promise: Promise<T>;
  resolve(value: T): void;
  reject(reason: any): void;
}

export interface promises$IPromiseService {
