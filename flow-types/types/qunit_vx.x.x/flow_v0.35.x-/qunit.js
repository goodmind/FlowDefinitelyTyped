 ...
 * `QUnit.start()`.
 * @param {number} acceptCallCount Number of expected callbacks before the test is done.
 */
...
beforeEach: (fn: (assert: Assert) => void) => void
	...
	declare interface QUnit$BeginDetails {
totalTests: number
} 

declare interface QUnit$DoneDetails {
failed: number,
passed: number,
total: number,
runtime: number
...
declare interface QUnit$LogDetails {
result: boolean,
actual: any,
expected: any,
message: string,
...
declare interface QUnit$ModuleDoneDetails {
name: string,
failed: number,
passed: number,
total: number,
...
declare interface QUnit$ModuleStartDetails {
name: string
} 

declare interface QUnit$TestDoneDetails {
name: string,
module: string,
failed: number,
passed: number,
...
declare interface QUnit$TestStartDetails {
name: string,
module: string
} 
 ...
 */
begin(callback: (details: QUnit$QUnit$BeginDetails) => void): void,
 ...
 */
done(callback: (details: QUnit$QUnit$DoneDetails) => void): void,
 ...
 * @param callback Callback to execute
 */
log(callback: (details: QUnit$QUnit$LogDetails) => void): void,
 ...
 * @param callback Callback to execute
 */
moduleDone(callback: (details: QUnit$QUnit$ModuleDoneDetails) => void): void,

/**
 * Register a callback to fire whenever a module begins.
 * @param callback Callback to execute
 */
moduleStart(callback: (details: QUnit$QUnit$ModuleStartDetails) => void): void,
 ...
 * @param callback Callback to execute
 */
testStart(callback: (details: QUnit$QUnit$TestStartDetails) => void): void,
