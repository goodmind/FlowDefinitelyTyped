declare module 'roads' {
        
/**
 * Roads module
 */
declare export type Keys = string;
	declare export type Option = $ObjMapi<{[k: Keys]: any}, <k>(k) => any>;
 ...
 */
use(
fn: (method: string, url: any, body: any, headers: Headers, next: () => any) => any): any;
...
constructor(body: any, status: number, headers?: Option): this;
...
constructor(message: string, code: number): this
      ...
      declare var npm$namespace$middleware: {
        applyToContext: typeof middleware$applyToContext,
killSlash: typeof middleware$killSlash,
 ...
 */
declare function middleware$applyToContext(key: string, val: any): () => any
 ...
 */
declare function middleware$killSlash(): any
 ...
 */
declare function middleware$cors(options: Cors): any
 ...
 */
declare function middleware$parseBody(body: any, content_type: string): {[key: string]: any} | string
 ...
 */
declare function middleware$setTitle(): any
 ...
 */
declare function middleware$reroute(key: string, road: Road): () => any
 ...
 * Middleware to Apply proper cors headers
 */
declare class middleware$SimpleRouter  {
...
method: string,
path: string,
fn: (url: any, body: any, headers: Headers, next: () => any) => any): any;
...
addRouteFile(file_path: string, prefix?: string): any
      ...
      declare var npm$namespace$integrations: {
        express: typeof integrations$express,
koa: typeof integrations$koa,
 ...
 */
declare function integrations$express(road: Road): () => any
 ...
 * @param road The Road object that contains all routing information for this integration
 */
declare function integrations$koa(road: Road): () => any

	
/**
 * A helper object to easily enable PJAX on your website using roads
 */
declare export class PJAX  {
 ...
 */
constructor(road: Road, container_element?: Element | null, window?: Window | null): this;
 ...
 */
render(response_object: {[key: string]: any}): any
}
 ...
 */
declare export function build(input_file: string, output_file: string, options?: Options): any
