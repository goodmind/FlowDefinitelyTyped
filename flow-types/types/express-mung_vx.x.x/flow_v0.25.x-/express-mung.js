declare module "express-mung" {
   ...
   * @return {RequestHandler} Middleware to transform the body
   */
  declare export function jsonAsync(
    fn: TransformAsync,
    options?: Options
  ): RequestHandler;
   ...
   * @return {RequestHandler} Middleware to transform the headers
   */
  declare export function headersAsync(
    fn: TransformHeaderAsync
  ): RequestHandler;
