...
declare function contentDisposition$parse(contentDispositionHeader: string): contentDisposition$ContentDisposition

	declare function contentDisposition(
filename?: string,
options?: contentDisposition$contentDisposition$Options): string
