 ...
 */
declare var event$trigger: (instance: any, eventName: string, extArgs: any) => void;
...
getAllOverlays(type: string): AMap$Marker[] | AMap$Circle[] | AMap$Polygon[] | AMap$Polyline[];
...
speed?: number,
f?: (k: number) => number,
circlable?: boolean): void;
moveTo(lnglat: AMap$LngLat, speed?: number, f?: (k: number) => number): void;
stopMove(): void;
setMap(map: AMap$Map): void;
getMap(): AMap$Map;
...
constructor(map: AMap$Map, markers: AMap$Marker[], opt?: AMap$MarkerClustererOptions): this;
...
getLocation(
address: string,
callback?: (status?: string, result?: string | AMap$GeocodeResult) => void): void;
setCity(city: string): void;
getAddress(
location: AMap$LngLat | AMap$LngLat[],
callback: (status?: string, result?: string | AMap$ReGeocodeResult) => void): void
}
...
type: string,
result: (status: string, result: AMap$ConvertorResult) => void): void
...
getLocalCity(
callback: (status: string, result: string | AMap$CitySearchResult) => void): void;
getCityByIp(
ip: string,
callback: (status: string, result: string | AMap$CitySearchResult) => void): void
}
...
static +LEAST_TIME: Class<AMap$DrivingPolicy__LEAST_TIME> & AMap$DrivingPolicy__LEAST_TIME & 0;// 0
static +LEAST_FEE: Class<AMap$DrivingPolicy__LEAST_FEE> & AMap$DrivingPolicy__LEAST_FEE & 1;// 1
static +LEAST_DISTANCE: Class<AMap$DrivingPolicy__LEAST_DISTANCE> & AMap$DrivingPolicy__LEAST_DISTANCE & 2;// 2
static +REAL_TRAFFIC: Class<AMap$DrivingPolicy__REAL_TRAFFIC> & AMap$DrivingPolicy__REAL_TRAFFIC & 3;// 3
...
callback?: (status: string, result: string | AMap$DrivingResult) => void): void;
search(
point: Array<{
keyword: string,
city: string
...
getLive(
district: string,
callback: (errorStatus: any, result: AMap$WeatherLiveResult) => void): void;
...
getForecast(
district: string,
callback: (errorStatus: any, result: AMap$WeatherForecastResult) => void): void
}
...
search(
keyword: string,
callback: (status: string, result: string | AMap$AutocompleteResult) => void): void
}
...
search(
keyword: string,
callback: (status: string, result: string | AMap$SearchResult) => void): void;
searchNearBy(
keyword: string,
center: AMap$LngLat,
radius: number,
...
search(
keywords: string,
callback?: (status: string, result: string | AMap$DistrictSearchResult) => void,
opts?: AMap$DistrictSearchOptions): void;
