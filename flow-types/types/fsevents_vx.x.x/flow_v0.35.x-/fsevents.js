...
path: string,
flags: number): fsevents$BaseEventInfo<fsevents$BaseEventType | "moved">


declare class fsevents$FSEvents  {
constructor(path: string, handler: (path: string, flags: number, id: number) => void): this;
start(): this;
stop(): this
}
...
addListener(
event: "fsevent",
listener: (path: string, flags: number, id: number) => void): this,
addListener(
event: fsevents$EventType | "change",
listener: (path: string, info: fsevents$EventInfo) => void): this,
on(
event: "fsevent",
listener: (path: string, flags: number, id: number) => void): this,
on(
...
declare type fsevents$BaseEventType = "created"
| "deleted"
| "modified"
| "root-changed"
| "unknown";
