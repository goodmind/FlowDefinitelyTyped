 ...
 * Stream options
 */
declare type csvtojson$StreamOptions = stream.TransformOptions;


/**
 * Converter options
 */
declare interface csvtojson$ConverterOptions {
 ...
 */
declare type csvtojson$ParseResultHandler = (err: any, result: any) => void;


/**
 * Event handler for "json" events.
 */
declare type csvtojson$JsonEventHandler = (jsonObj: any, rowNumber: number) => void;


/**
 * Event handler for "csv" events.
 */
declare type csvtojson$CsvEventHandler = (csvRow: string[], rowNumber: number) => void;


/**
 * Event handler for "data" events.
 */
declare type csvtojson$DataEventHandler = (data: any) => void;


/**
 * Event handler for "error" events.
 */
declare type csvtojson$ErrorEventHandler = (err: any) => void;


/**
 * Event handler for "record_parsed" events.
 */
declare type csvtojson$RecordParsedEventHandler = (jsonObj: any, csvRoe: string[], rowNumber: number) => void;


/**
 * Event handler for "end" events.
 */
declare type csvtojson$EndEventHandler = () => void;


/**
 * Event handler for "end_parsed" events.
 */
declare type csvtojson$EndParsedEventHandler = (jsonObjArray: any[]) => void;


/**
 * Event handler for "done" events.
 */
declare type csvtojson$DoneEventHandler = (err: any) => void;


/**
 * Converts provided CSV input to  a JSON object.
 */
declare class csvtojson$Converter mixins stream.Transform {
 ...
 */
constructor(options?: csvtojson$ConverterOptions, streamOptions?: csvtojson$StreamOptions): this;
 ...
 */
fromString(str: string, callback: csvtojson$ParseResultHandler): void;
 ...
 * @param callback callback function to handle result or error
 */
fromFile(filePath: string, callback: csvtojson$ParseResultHandler): void;
 ...
 * @param callback callback function to handle result or error
 */
fromStream(stream: stream.Stream, callback: csvtojson$ParseResultHandler): void;
...
| csvtojson$DoneEventHandler): this;
...
options?: csvtojson$csvtojson$ConverterOptions,
streamOptions?: csvtojson$csvtojson$StreamOptions): csvtojson$csvtojson$Converter

	declare module.exports: typeof csvtojson
