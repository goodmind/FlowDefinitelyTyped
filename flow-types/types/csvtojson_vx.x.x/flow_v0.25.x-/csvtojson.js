declare module "csvtojson" {
   ...
   */
  declare type csvtojson$JsonEventHandler = (
    jsonObj: any,
    rowNumber: number
  ) => void;
   ...
   */
  declare type csvtojson$CsvEventHandler = (
    csvRow: string[],
    rowNumber: number
  ) => void;
   ...
   */
  declare type csvtojson$RecordParsedEventHandler = (
    jsonObj: any,
    csvRoe: string[],
    rowNumber: number
  ) => void;
  ...
  declare class csvtojson$Converter mixins stream.Transform {
    ...
    fromStream(
      ...
      callback: csvtojson$ParseResultHandler
    ): void;
     ...
     */
    transf(
      callback: (jsonObj: any, csvRow: string[], rowNumber: number) => void
    ): this;
  ...
  declare function csvtojson(
    ...
    streamOptions?: csvtojson$csvtojson$StreamOptions
  ): csvtojson$csvtojson$Converter;
