declare module 'react-native-text-input-mask' {
	...
	declare export type onChangeTextCallback = (formatted: string, extracted: string) => void;
	declare export type TextInputMaskProps = {
 ...
 */
onBlur?: (
e: ReactNative.NativeSyntheticEvent<ReactNative.TextInputFocusEventData>) => void,
 ...
 */
onScroll?: (
e: ReactNative.NativeSyntheticEvent<ReactNative.TextInputScrollEventData>) => void,
 ...
 */
onKeyPress?: (
e: ReactNative.NativeSyntheticEvent<ReactNative.TextInputKeyPressEventData>) => void,
 ...
 */
value?: string
} & ReactNative.ViewProps & ReactNative.TextInputIOSProps & ReactNative.TextInputAndroidProps & ReactNative.AccessibilityProps

	declare export default class TextInputMask mixins React.Component<TextInputMaskProps> {}
    }
