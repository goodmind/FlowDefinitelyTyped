...
[number: number]: JSX.Element | string | {
style: any,
...
tipProps?: $Shape<RCTooltip.Props>
	...
	declare export function createSliderWithTooltip(slider: typeof Slider): () => React.Component<WithTooltipProps & SliderProps>

	declare export function createSliderWithTooltip(range: typeof Range): () => React.Component<WithTooltipProps & RangeProps>
