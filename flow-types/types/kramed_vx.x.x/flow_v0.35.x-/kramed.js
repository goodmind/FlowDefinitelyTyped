declare module 'kramed' {
        declare export interface KramedStatic {
...
new (options: KramedOptions): KramedParser
	...
	declare export interface KramedRenderer {
...
text(text: string): string
	...
	declare export interface KramedParser {
parse(source: any[]): string
} 
	declare export interface KramedOptions {
...
smartypants?: boolean
	...
	declare export var kramed: KramedStatic;
    }
