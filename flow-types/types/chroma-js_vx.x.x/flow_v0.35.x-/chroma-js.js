...
declare type chroma$InterpolationMode = "rgb"
| "hsl"
| "hsv"
| "hsi"
| "lab"
 ...
 * @return the color object.
 */
(a: number, b: number, c: number, colorSpace?: $Keys<chroma$ColorSpaces>): chroma$Color,
(a: number, b: number, c: number, d: number, colorSpace?: $Keys<chroma$ColorSpaces>): chroma$Color,
...
f?: number,
colorSpace?: $Keys<chroma$ColorSpaces>): chroma$Color,
 ...
 */
contrast(color1: string | chroma$Color, color2: string | chroma$Color): number,
...
color1: string | chroma$Color,
color2: string | chroma$Color,
colorSpace?: $Keys<chroma$ColorSpaces>): number,
...
format: K): chroma$Scale<$ElementType<chroma$ColorSpaces, K>>,
