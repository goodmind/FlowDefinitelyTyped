declare module "intercom-client" {
  import type { List as UserList, User, UserIdentifier } from "./User";

  import type { List as LeadList, Lead, LeadIdentifier } from "./Lead";
  ...
  import type { TagIdentifier, List as TagList, Tag, TagOper } from "./Tag";

  import type {
    List as EventList,
    Event,
    ListParam as EventListParam
  } from "./Event";

  import type { Scroll } from "./Scroll";

  import type { IntercomError } from "./IntercomError";

  import type { IncomingMessage } from "http";

  declare export { IntercomError };
  ...
  declare export class Users {
    ...
    update(
      user: UserIdentifier & $Shape<User>,
  ...
  declare export class Leads {
    ...
    update(
      lead: UserIdentifier & $Shape<Lead>,
