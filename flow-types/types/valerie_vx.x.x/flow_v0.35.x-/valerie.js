...
validate(
validationOptions?: Valerie$Valerie$ValidationOptions): Valerie$Valerie$PropertyValidationState<KnockoutObservable<T>>
} 
	declare interface KnockoutComputed<T> {
validate(
validationOptions?: Valerie$Valerie$ValidationOptions): Valerie$Valerie$PropertyValidationState<KnockoutComputed<T>>
} 
	declare interface KnockoutObservableArray<T> {
validate(
validationOptions?: Valerie$Valerie$ValidationOptions): Valerie$Valerie$PropertyValidationState<KnockoutObservableArray<T>>
} 
 ...
 */
validateAsModel(): Valerie$Valerie$ValidatableModel<KnockoutObservableArray<T>>
} 
...
includeUnwrappedFunction?: Valerie$IncludePropertyCallback): any,
 ...
 */
validatableModel(model: any, options?: Valerie$ValidationOptions): Valerie$ModelValidationState,
validatableProperty<T>(
value: T,
options?: Valerie$ValidationOptions): Valerie$PropertyValidationState<T>,
...
options: any): Valerie$ValidationOptions
} 
...
new: (
model: any,
options?: Valerie$ModelValidationStateOptions) => Valerie$ModelValidationState,
model: any,
 ...
 */
addValidationStates(validationStateOrStates: any): Valerie$ModelValidationState,
 ...
 * @return {valerie.Valerie$ModelValidationState}
 */
removeValidationStates(validationStateOrStates: any): Valerie$ModelValidationState,
 ...
 * @return {valerie.Valerie$ModelValidationState}
 */
startValidatingSubModel(validatableSubModel: any): Valerie$ModelValidationState,
 ...
 * @return {valerie.Valerie$ModelValidationState}
 */
stopValidatingSubModel(validatableSubModel: any): Valerie$ModelValidationState,
 ...
 * @return {valerie.Valerie$ModelValidationState}
 */
updateSummary(updateSubModelSummaries: boolean): Valerie$ModelValidationState,
...
currencyMajor(options?: Valerie$ValidationOptions): Valerie$PropertyValidationState<T>,
currencyMajorMinor(options?: Valerie$ValidationOptions): Valerie$PropertyValidationState<T>,
...
options?: Valerie$ValidationOptions): Valerie$PropertyValidationState<T>,
float(options?: Valerie$ValidationOptions): Valerie$PropertyValidationState<T>,
integer(options?: Valerie$ValidationOptions): Valerie$PropertyValidationState<T>,
latest(
...
ruleMessage(failureMessageFormat: string): Valerie$PropertyValidationState<T>,
...
currencySign: string,
currencyMinorUnitPlaces: number): Valerie$NumericHelper,
...
recurse?: boolean,
validationStates?: Valerie$IValidationState[]): Valerie$IValidationState[],
getFor(modelOrObservableOrComputed: any): Valerie$IValidationState,
has(modelOrObservableOrComputed: any): boolean,
setFor(modelOrObservableOrComputed: any, state: Valerie$IValidationState): void
} 
