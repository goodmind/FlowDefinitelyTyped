...
declare type SNS$AddCallback<T = any> = (
...
declare type SNS$CloseCallback = (
  optional: any,
...
declare interface SNS$Instance {
  ...
  add<PatternType, CallBackParams>(
    pattern: PatternType,
    action: SNS$AddCallback<PatternType & CallBackParams>
  ): this;
  add<PatternType, CallbackParams>(
    pattern: PatternType,
    paramspec: any,
...
declare interface SNS$Entity {
  ...
  load$(
    ...
    callback: SNS$EntityLoadCallback
  ): void;
  remove$(
    id: SNS$DatabaseID | SNS$EntityDataWithQuery,
    callback: SNS$EntityRemoveCallback
  ): void;
