...
(options: AsyncCache$AsyncCache$Options<T>): AsyncCache$AsyncCache$Cache<T>,
new <T>(options: AsyncCache$AsyncCache$Options<T>): AsyncCache$AsyncCache$Cache<T>
} 
...
load(
key: string,
callback: (error: any, asyncValue: T, maxAge?: number) => void): void
} & LRUOptions<string, T>
