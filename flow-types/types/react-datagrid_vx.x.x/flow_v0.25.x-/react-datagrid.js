declare type ReactDataGrid$DataGridProps = {
  ...
  rowStyle?:
    | React.CSSProperties
    | ((data: any, props: ReactDataGrid$RowProps) => React.CSSProperties),
  ...
  onPageSizeChange?: (
    pageSize: number,
    props: ReactDataGrid$DataGridProps
  ) => void
} & React.Props<ReactDataGrid$DataGrid>;
...
declare export class ReactDataGrid$DataGrid
  mixins React.Component<ReactDataGrid$DataGridProps> {}
declare module "react-datagrid" {
  import typeof * as React from "react";

  declare module.exports: typeof ReactDataGrid$DataGrid;
}
