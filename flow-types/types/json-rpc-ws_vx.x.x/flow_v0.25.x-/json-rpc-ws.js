declare module "json-rpc-ws" {
  ...
  declare export class Server<TConnection: Connection>
    mixins Base<TConnection> {
    constructor(): this;
  ...
  declare export class Client<TConnection: Connection>
    mixins Base<TConnection> {
  ...
  declare export type Handler<
    ...
    ParamType,
    ParamCallbackType
  > = (params: ParamType, reply: ReplyCallback<ParamCallbackType>) => void;
  declare export type ReplyCallback<ParamType> = (
    error: any,
    params?: ParamType
  ) => void;
   ...
   */
  declare export function Errors(
    type: string,
