...
static relate(from: string, to: string, options?: RelateUrl$RelateUrl$Options): string;
constructor(from: string, options?: RelateUrl$RelateUrl$Options): this;
relate(to: string, options?: RelateUrl$RelateUrl$Options): string
}
