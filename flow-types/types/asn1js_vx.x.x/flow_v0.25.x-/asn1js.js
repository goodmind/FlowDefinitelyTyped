...
declare class Asn1js$LocalIdentificationBlock
  mixins Asn1js$LocalBaseBlock, Asn1js$ILocalHexBlock {
  isConstructed: boolean;
  tagClass: number;
  tagNumber: number;
...
declare class Asn1js$Primitive
  mixins Asn1js$BaseBlock<Asn1js$LocalPrimitiveValueBlock> {}
...
declare class Asn1js$Constructed
  mixins Asn1js$BaseBlock<Asn1js$LocalConstructedValueBlock> {}
...
declare export class Asn1js$EndOfContent
  mixins Asn1js$BaseBlock<Asn1js$LocalEndOfContentValueBlock> {}
...
declare class Asn1js$Boolean
  mixins Asn1js$BaseBlock<Asn1js$LocalBooleanValueBlock> {}
...
declare type Asn1js$LocalOctetStringValueBlockParams = {
  isConstructed?: boolean
} & Asn1js$LocalConstructedValueBlockParams &
  Asn1js$LocalHexBlockParams;

declare class Asn1js$LocalOctetStringValueBlock
  mixins Asn1js$LocalConstructedValueBlock, Asn1js$ILocalHexBlock {
  isConstructed: boolean;
  isHexOnly: boolean;
  valueHex: ArrayBuffer;
...
declare export class Asn1js$OctetString
  mixins Asn1js$BaseBlock<Asn1js$LocalOctetStringValueBlock> {
  constructor(params?: Asn1js$LocalOctetStringValueBlockParams): this;
...
declare class Asn1js$LocalBitStringValueBlock
  mixins Asn1js$LocalConstructedValueBlock, Asn1js$LocalHexBlock {
  unusedBits: number;
  isConstructed: boolean;
  blockLength: number;
  isHexOnly: boolean;
...
declare class Asn1js$BitString
  mixins Asn1js$BaseBlock<Asn1js$LocalBitStringValueBlock> {
  constructor(params?: Asn1js$LocalBitStringValueBlockParams): this;
...
declare type Asn1js$LocalIntegerValueBlockParams = {} & Asn1js$LocalBaseBlockParams &
  Asn1js$LocalHexBlockParams;

declare class Asn1js$LocalIntegerValueBlock
  mixins Asn1js$LocalValueBlock, Asn1js$LocalHexBlock {
  valueDec: number;
  isHexOnly: boolean;
  valueHex: ArrayBuffer;
...
declare export class Asn1js$Integer
  mixins Asn1js$BaseBlock<Asn1js$LocalIntegerValueBlock> {
...
declare class Asn1js$LocalSidValueBlock
  mixins Asn1js$LocalBaseBlock, Asn1js$LocalHexBlock {
  valueDec: number;
  isFirstSid: boolean;
  isHexOnly: boolean;
  valueHex: ArrayBuffer;
...
declare class Asn1js$LocalObjectIdentifierValueBlock
  mixins Asn1js$LocalValueBlock {
...
declare export class Asn1js$ObjectIdentifier
  mixins Asn1js$BaseBlock<Asn1js$LocalObjectIdentifierValueBlock> {
  constructor(params?: Asn1js$LocalObjectIdentifierValueBlockParams): this;
}

declare type Asn1js$LocalUtf8StringValueBlockParams = {} & Asn1js$LocalBaseBlockParams &
  Asn1js$LocalHexBlock;
...
declare class Asn1js$Utf8String
  mixins Asn1js$BaseBlock<Asn1js$LocalUtf8StringValueBlock> {
...
declare type Asn1js$LocalBmpStringValueBlockParams = {} & Asn1js$LocalHexBlockParams &
  Asn1js$LocalBaseBlockParams;
...
declare export class Asn1js$BmpString
  mixins Asn1js$BaseBlock<Asn1js$LocalBmpStringValueBlock> {
...
declare type Asn1js$LocalUniversalStringValueParams = {} & Asn1js$LocalHexBlockParams &
  Asn1js$LocalBaseBlockParams;
...
declare export class Asn1js$UniversalString
  mixins Asn1js$BaseBlock<Asn1js$LocalUniversalStringValueBlock> {
...
declare type Asn1js$LocalSimpleLocalSimpleStringValueBlockParams = {} & Asn1js$LocalHexBlockParams &
  Asn1js$LocalBaseBlockParams;
...
declare export class Asn1js$LocalSimpleStringBlock
  mixins Asn1js$BaseBlock<Asn1js$LocalSimpleLocalSimpleStringValueBlock> {
...
declare export class Asn1js$NumericString
  mixins Asn1js$LocalSimpleStringBlock {}

declare export class Asn1js$PrintableString
  mixins Asn1js$LocalSimpleStringBlock {}

declare export class Asn1js$TeletexString
  mixins Asn1js$LocalSimpleStringBlock {}

declare export class Asn1js$VideotexString
  mixins Asn1js$LocalSimpleStringBlock {}

declare export class Asn1js$IA5String mixins Asn1js$LocalSimpleStringBlock {}

declare export class Asn1js$GraphicString
  mixins Asn1js$LocalSimpleStringBlock {}

declare export class Asn1js$VisibleString
  mixins Asn1js$LocalSimpleStringBlock {}

declare export class Asn1js$GeneralString
  mixins Asn1js$LocalSimpleStringBlock {}

declare export class Asn1js$CharacterString
  mixins Asn1js$LocalSimpleStringBlock {}
