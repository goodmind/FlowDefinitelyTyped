declare module "linkify-it" {
  declare var LinkifyIt$LinkifyIt: {
    (
      schemas?:
        | LinkifyIt$LinkifyIt.LinkifyIt$SchemaRules
        | LinkifyIt$LinkifyIt.LinkifyIt$Options,
      options?: LinkifyIt$LinkifyIt.LinkifyIt$Options
    ): LinkifyIt$LinkifyIt.LinkifyIt$LinkifyIt,
    new(
      schemas?:
        | LinkifyIt$LinkifyIt.LinkifyIt$SchemaRules
        | LinkifyIt$LinkifyIt.LinkifyIt$Options,
  ...
  declare type LinkifyIt$Validate = (
    text: string,
    pos: number,
