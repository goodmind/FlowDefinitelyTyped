 ...
 * @param : defaults to 0, must be between 0 and 1
 * @param : defaults to 100 ms
 * @param : defaults to 10000 ms
 ...
 */
declare export function fibonacci(options?: Options): Backoff
 ...
 * @param : defaults to 100 ms
 * @param : defaults to 10000 ms
 * @param : defaults to 2, must be greater than 1

With these values, the backoff delay will increase from 100 ms to 10000 ms. The
randomisation factor controls the range of randomness and must be between 0
and 1. By default, no randomisation is applied on the backoff delay.
 */
declare export function exponential(options?: ExponentialOptions): Backoff
...
maxDelay?: number
	...
	declare export type ExponentialOptions = {
factor?: number
} & Options
 ...
 */
declare export function call<R1, R2, R3, E>(
wrappedFunction: (cb: (err: E, r1: R1, r2: R2, r3: R3) => void) => void,
callback: (error: E, r1: R1, r2: R2, r3: R3) => void): TypedFunctionCall<void[], E, R1, R2, R3>

	declare export function call<R1, R2, E>(
wrappedFunction: (cb: (err: E, r1: R1, r2: R2) => void) => void,
callback: (error: E, r1: R1, r2: R2) => void): TypedFunctionCall<void[], E, R1, R2>

	declare export function call<R1, E>(
wrappedFunction: (cb: (err: E, r1: R1) => void) => void,
callback: (error: E, r1: R1) => void): TypedFunctionCall<void[], E, R1>

	declare export function call<E>(
wrappedFunction: (cb: (err: E) => void) => void,
callback: (err: E) => void): TypedFunctionCall<void[], E>

	declare export function call<T1, R1, R2, R3, E>(
...
callback: (error: E, r1: R1, r2: R2, r3: R3) => void): TypedFunctionCall<[T1, T2], E, R1, R2, R3>
	...
	declare export function call<T1, T2, R1, R2, E>(
...
callback: (error: E, r1: R1, r2: R2, r3: R3) => void): TypedFunctionCall<[T1, T2, T3], E, R1, R2, R3>
	...
	declare export function call<T1, T2, T3, R1, R2, E>(
...
callback: (error: E, r1: R1, r2: R2) => void): TypedFunctionCall<[T1, T2, T3], E, R1, R2>
	...
	declare export function call<T1, T2, T3, R1, E>(
...
callback: (error: E, r1: R1) => void): TypedFunctionCall<[T1, T2, T3], E, R1>
	...
	declare export function call<T1, T2, T3, E>(
...
callback: (err: E) => void): TypedFunctionCall<[T1, T2, T3], E>
	...
	declare export function call(wrappedFunction: (...args: any[]) => void, ...args: any[]): FunctionCallAny

	declare export class Backoff mixins EventEmitter {
 ...
 */
constructor(strategy: BackoffStrategy): this;
...
addListener(
event: "backoff",
listener: (number: number, delay: number, error?: any) => void): this;
...
listenerCount(type: "backoff" | "ready" | "fail"): number
	...
	declare export class BackoffStrategy  {
 ...
 */
declare export class ExponentialStrategy mixins BackoffStrategy {
 ...
 * @param : defaults to 2, must be greater than 1
 */
constructor(options?: ExponentialOptions): this;
 ...
 */
declare export class FibonacciStrategy mixins BackoffStrategy {
 ...
 */
declare export var FunctionCall: FunctionCallConstructor;
 ...
 */
declare export interface FunctionCallConstructor {
new <R1, R2, R3, E>(
wrappedFunction: (cb: (err: E, r1: R1, r2: R2, r3: R3) => void) => void,
args: void[],
callback: (error: E, r1: R1, r2: R2, r3: R3) => void): TypedFunctionCall<void[], E, R1, R2, R3>,
...
callback: (error: any, ...resArgs: any[]) => void): FunctionCallAny
	...
	declare export type TypedFunctionCall<T, E, R1, R2, R3> = FunctionCall<T> & FunctionCallArgs<E, R1, R2, R3>;
	declare export type FunctionCallAny = FunctionCall<any[]> & FunctionCallArgsAny;
	declare export type FunctionCall<T> = {
...
listenerCount(type: "call" | "callback" | "backoff" | "abort"): number
	...
	declare export interface FunctionCallArgs<E, R1, R2, R3> {
...
emit(event: "callback", results: [E, R1, R2, R3]): boolean
	...
	declare export interface FunctionCallArgsAny {
