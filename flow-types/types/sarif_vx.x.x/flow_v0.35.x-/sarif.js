...
properties?: PropertyBag
	...
	declare type File$roles = "analysisTarget"
| "attachment"
| "responseFile"
| "resultFile"
| "standardStream"
...
declare type Result$suppressionStates = "suppressedInSource" | "suppressedExternally";
...
properties?: PropertyBag
	...
	declare type RuleConfiguration$defaultLevel = "note" | "warning" | "error" | "open";
...
properties?: PropertyBag
	...
	declare type ThreadFlowLocation$importance = "important" | "essential" | "unimportant";
