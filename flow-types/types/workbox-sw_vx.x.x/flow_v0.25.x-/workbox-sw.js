declare module "workbox-sw" {
  ...
  declare interface IBroadcastCacheUpdateConstructor {
    new(
      channelName: string,
      options: $Shape<IBroadcastCacheUpdateOptions>
    ): BroadcastCacheUpdate;
  }
  ...
  declare interface ICacheExpirationConstructor {
    new(
      cacheName: string,
      config: $Shape<ICacheExpirationOptions>
    ): CacheExpiration;
  }
  ...
  declare interface INavigationRouteConstructor {
    new(
      ...
      options: $Shape<INavigationRouteOptions>
    ): NavigationRoute;
  }
 ...
 */
  ...
  declare class CoreNamespace {
     ...
     */
    static setLogLevel(
      logLevel: $ElementType<ILogLevel, $Keys<ILogLevel>>
    ): void;
  }
  ...
  declare class PrecachingNamespace {
    ...
    static precacheAndRoute(
      entries: (string | IPrecacheEntry)[],
      route?: $Shape<IRouteOptions>
    ): void;
  ...
  declare class RoutingNamespace {
    ...
    static registerNavigationRoute(
      ...
      options?: $Shape<IRegisterNavigationRouteOptions>
    ): NavigationRoute;
  ...
  declare class StrategiesNamespace {
    ...
    static staleWhileRevalidate(
      options?: $Shape<IStrategyOptions>
    ): HandlerCallback;
  }
 ...
 */
   ...
   */
  declare type ModulePathCallback = (
    moduleName: string,
    debug: boolean
  ) => string;
