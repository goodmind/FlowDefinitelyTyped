 ...
 */
declare interface IBroadcastCacheUpdateOptions {
 ...
 */
declare interface IBroadcastCacheUpdateConstructor {
new (
channelName: string,
options: $Shape<IBroadcastCacheUpdateOptions>): BroadcastCacheUpdate
} 
	
/**
 * ===== CacheableResponse =====
 */
declare interface ICacheableResponseOptions {
statuses: number[],
headers: {
[key: string]: string
}
 ...
 */
declare interface ICacheableResponseConstructor {
new (options: $Shape<ICacheableResponseOptions>): CacheableResponse
} 
	
/**
 * ===== CacheExpiration =====
 */
declare interface ICacheExpirationOptions {
 ...
 */
declare interface ICacheExpirationConstructor {
new (cacheName: string, config: $Shape<ICacheExpirationOptions>): CacheExpiration
} 
	
/**
 * ===== Strategies =====
 */
declare interface ICacheStrategyHandleOptions {
event: FetchEvent
} 
	declare interface ICacheStrategyMakeRequestOptions {
 ...
 * ===== CacheOnly strategy =====
 */
declare interface ICacheOnlyOptions {
 ...
 */
declare class CacheOnly mixins CacheStrategy {}
	
/**
 * Instantiates a new CacheOnly strategy
 */
declare interface ICacheOnlyConstructor {
new (options?: $Shape<ICacheOnlyOptions>): CacheOnly
} 
	
/**
 * ===== CacheFirst strategy =====
 */
declare type ICacheFirstOptions = {
 ...
 */
declare class CacheFirst mixins CacheStrategy {}
	
/**
 * Instantiates a new CacheFirst strategy
 */
declare interface ICacheFirstConstructor {
new (options?: $Shape<ICacheFirstOptions>): CacheFirst
} 
	
/**
 * ===== NetworkOnly strategy =====
 */
declare type INetworkOnlyOptions = {} & ICacheFirstOptions
 ...
 * This class is useful if you want to take advantage of any Workbox plugins.
 */
declare class NetworkOnly mixins CacheStrategy {}
	
/**
 * Instantiates a new NetworkOnly strategy
 */
declare interface INetworkOnlyConstructor {
new (options?: $Shape<INetworkOnlyOptions>): NetworkOnly
} 
	
/**
 * ===== NetworkFirst strategy =====
 */
declare type INetworkFirstOptions = {
 ...
 */
declare class NetworkFirst mixins CacheStrategy {}
	
/**
 * Instantiates a new NetworkFirst strategy
 */
declare interface INetworkFirstConstructor {
new (options?: $Shape<INetworkFirstOptions>): NetworkFirst
} 
	
/**
 * ===== StaleWhileRevalidate strategy =====
 */
declare type IStaleWhileRevalidateOptions = {} & ICacheFirstOptions
 ...
 * Opaque responses are are cross-origin requests where the response doesn't support CORS.
 */
declare class StaleWhileRevalidate mixins CacheStrategy {}
	
/**
 * Instantiates a new StaleWhileRevalidate strategy
 */
declare interface IStaleWhileRevalidateConstructor {
new (options?: $Shape<IStaleWhileRevalidateOptions>): StaleWhileRevalidate
} 
	
/**
 * ===== MatchCallback =====
 */
declare type IMatchContext = {
 ...
 */
declare type MatchCallback = (context: IMatchContext) => {} | null;
	
/**
 * ===== HandlerCallback =====
 */
declare type IHandlerContext = {
 ...
 */
declare type HandlerCallback = (context: IHandlerContext) => Promise<Response>;
	
/**
 * ===== NavigationRoute =====
 */
declare interface IHandlerOptions {
url: string,
event: FetchEvent,
params: URLSearchParams
} 
	declare interface INavigationRouteOptions {
 ...
 */
declare interface INavigationRouteConstructor {
new (
handler: HandlerCallback,
options: $Shape<INavigationRouteOptions>): NavigationRoute
} 
 ...
 */
declare interface IBroadcastUpdatePluginConstructor {
new (
channelName: string,
options?: $Shape<IBroadcastCacheUpdateOptions>): BroadcastUpdatePlugin
} 
 ...
 */
declare interface IRangeRequestsPluginConstructor {
 ...
 * If both statuses and headers are specified, then both conditions must be met for the Response to be considered cacheable.
 */
declare interface ICacheableResponsePluginConstructor {
new (config: $Shape<ICacheableResponseOptions>): CacheableResponsePlugin
} 
 ...
 */
declare interface IBackgroundSyncPluginConstructor {
 ...
 */
declare interface IExpirationPluginConstructor {
new (config: $Shape<ICacheExpirationOptions>): ExpirationPlugin
} 
	
/**
 * ===== ExpirationPlugin =====
 */
declare type Plugin = BroadcastUpdatePlugin
| RangeRequestsPlugin
| CacheableResponsePlugin
| BackgroundSyncPlugin
| ExpirationPlugin
 ...
 * ===== BackgroundSync =====
 */
declare interface IStorableRequestOptions {
url: string,
 ...
 */
declare interface IStorableRequestConstructor {
 ...
 * ===== PrecacheController =====
 */
declare interface ICleanupResult {
...
deletedRevisionDetails: string[]
	...
	declare interface IActivateOptions {
...
plugins: Plugin[]
	...
	declare interface IInstallOptions {
...
plugins: Plugin[]
	...
	declare interface IPrecacheEntry {
url: string,
revision: string
} 
 ...
 */
activate(options: $Shape<IActivateOptions>): Promise<ICleanupResult>;
 ...
 * @param {$Shape<IInstallOptions>} options
 * @returns {Promise<IInstallResult>}
 */
install(options?: $Shape<IInstallOptions>): Promise<IInstallResult>
}
	
/**
 * Create a new PrecacheController.
 */
declare interface IPrecacheControllerConstructor {
 ...
 * ===== Queue =====
 */
declare interface IQueueCallback {
...
queueDidReplay(requests: StorableRequest[]): void
	...
	declare interface IQueueOptions {
 ...
 */
callbacks: $Shape<IQueueCallback>
} 
 ...
 */
declare interface IQueueConstructor {
 ...
 * @param {$Shape<IQueueOptions>} options
 * @returns {Queue}
 */
new (name: string, options?: $Shape<IQueueOptions>): Queue
} 
 ...
 */
declare interface IRouteConstructor {
 ...
 * @returns {"NO PRINT IMPLEMENTED: JSDocNullableType"} A promise is returned if a registered route can handle the FetchEvent's request. If there is no matching route and there's no defaultHandler, undefined is returned.
 */
handleRequest(event: FetchEvent): Promise<Response> | void;
 ...
 */
declare interface IRouterConstructor {
new (): Router
} 
 ...
 * ===== CoreNamespace =====
 */
declare interface ICacheNames {
precache: string,
runtime: string,
googleAnalytics: string
} 
	declare interface ILogLevel {
...
silent: 4
	...
	declare interface ICacheNameDetails {
prefix: string,
suffix: string,
precache: string,
runtime: string,
 ...
 */
static cacheNames: ICacheNames;

/**
 * The available log levels in Workbox: debug, log, warn, error and silent.
 */
static LOG_LEVELS: ILogLevel;

/**
 * Get the current log level.
 */
static logLevel: $ElementType<ILogLevel, $Keys<ILogLevel>>;

/**
 * You can alter the default cache names used by the Workbox modules by changing the cache name details.
 * Cache names are generated as <prefix>-<Cache Name>-<suffix>.
 * @param {$Shape<ICacheNameDetails>} details
 */
static setCacheNameDetails(details: $Shape<ICacheNameDetails>): void;

/**
 * Set the current log level passing in one of the values from LOG_LEVELS.
 * @param {number} logLevel - The new log level to use.
 */
static setLogLevel(logLevel: $ElementType<ILogLevel, $Keys<ILogLevel>>): void
}
	
/**
 * ===== PrecachingNamespace =====
 */
declare interface IURLContext {
 ...
 */
declare type UrlManipulation = (context: IURLContext) => URL[];
	declare interface IRouteOptions {
 ...
 * Performs efficient precaching of assets.
 */
static PrecacheController: IPrecacheControllerConstructor;
 ...
 * @param {$Shape<IRouteOptions>} route
 */
static addRoute(route: $Shape<IRouteOptions>): void;
 ...
 * @param {(string | IPrecacheEntry)[]} entries - Array of entries to precache.
 * @param {$Shape<IRouteOptions>} route - see addRoute() options
 */
static precacheAndRoute(entries: (string | IPrecacheEntry)[], route?: $Shape<IRouteOptions>): void;
 ...
 * ===== RoutingNamespace =====
 */
declare type IRegisterNavigationRouteOptions = {
cacheName: string
} & INavigationRouteOptions
 ...
 */
static NavigationRoute: INavigationRouteConstructor;

/**
 * RegExpRoute makes it easy to create a regular expression based Route.
 * For same-origin requests the RegExp only needs to match part of the URL. For requests against third-party servers, you must define a RegExp that matches the start of the URL.
 */
static RegExpRoute: IRegExpRouteConstructor;
 ...
 */
static Route: IRouteConstructor;
 ...
 * If a request matches multiple routes, the earliest registered route will be used to respond to the request.
 */
static Router: IRouterConstructor;
 ...
 * @param {$Shape<IRegisterNavigationRouteOptions>} options
 * @returns {NavigationRoute} Returns the generated Route.
 */
static registerNavigationRoute(
cachedAssetUrl: string,
options?: $Shape<IRegisterNavigationRouteOptions>): NavigationRoute;
 ...
 */
cacheExpiration: $Shape<ICacheExpirationOptions>,
 ...
 * A cache first strategy is useful for assets that have been revisioned, such as URLs like /styles/example.a8f5f1.css, since they can be cached for long periods of time.
 */
static CacheFirst: ICacheFirstConstructor;

/**
 * An implementation of a cache-only request strategy.
 * This class is useful if you want to take advantage of any Workbox plugins.
 */
static CacheOnly: ICacheOnlyConstructor;
 ...
 */
static NetworkFirst: INetworkFirstConstructor;

/**
 * An implementation of a network-only request strategy.
 * This class is useful if you want to take advantage of any Workbox plugins.
 */
static NetworkOnly: INetworkOnlyConstructor;
 ...
 * Opaque responses are are cross-origin requests where the response doesn't support CORS.
 */
static StaleWhileRevalidate: IStaleWhileRevalidateConstructor;

/**
 * Instantiates a new CacheFirst strategy
 * @param {$Shape<IStrategyOptions>} options
 * @returns {HandlerCallback}
 */
static cacheFirst(options?: $Shape<IStrategyOptions>): HandlerCallback;
 ...
 * @returns {HandlerCallback}
 */
static cacheOnly(options?: $Shape<IStrategyOptions>): HandlerCallback;
 ...
 * @returns {HandlerCallback}
 */
static networkFirst(options?: $Shape<IStrategyOptions>): HandlerCallback;
 ...
 * @returns {HandlerCallback}
 */
static networkOnly(options?: $Shape<IStrategyOptions>): HandlerCallback;
 ...
 */
static staleWhileRevalidate(options?: $Shape<IStrategyOptions>): HandlerCallback
}
	
/**
 * ===== StreamsNamespace =====
 */
declare type StreamSource = Response | ReadableStream | BodyInit;
	declare interface IConcatenateResult {
done: Promise<StreamSource>,
stream: ReadableStream
} 
	declare interface IConcatenateToResponseResult {
done: Promise<StreamSource>,
response: Response
} 
...
headersInit?: HeadersInit): IConcatenateToResponseResult;
 ...
 * The CacheExpiration class allows you define an expiration and / or limit on the number of responses stored in a Cache.
 */
static CacheExpiration: ICacheExpirationConstructor;
 ...
 * When using maxEntries, the last request to be used will be the request that is removed from the Cache.
 */
static Plugin: IExpirationPluginConstructor
}
 ...
 */
static Plugin: IBackgroundSyncPluginConstructor;
 ...
 */
static Queue: IQueueConstructor
}
	
/**
 * ===== GoogleAnalyticsNamespace =====
 */
declare interface IGoogleAnalyticsInitializeOptions {
...
static initialize(options: $Shape<IGoogleAnalyticsInitializeOptions>): void
}
 ...
 * This class allows you to set up rules determining what status codes and/or headers need to be present in order for a Response to be considered cacheable.
 */
static CacheableResponse: ICacheableResponseConstructor;
 ...
 */
static Plugin: ICacheableResponsePluginConstructor
}
 ...
 * For efficiency's sake, the underlying response bodies are not compared; only specific response headers are checked.
 */
static BroadcastCacheUpdate: IBroadcastCacheUpdateConstructor;

/**
 * This plugin will automatically broadcast a message whenever a cached response is updated.
 */
static Plugin: IBroadcastUpdatePluginConstructor;
 ...
 * It does this by intercepting the cachedResponseWillBeUsed plugin callback and returning the appropriate subset of the cached response body.
 */
static Plugin: IRangeRequestsPluginConstructor;
 ...
 */
+cacheWillUpdate?: (context: CacheWillUpdatePluginContext) => Promise<Response> | Response | null,
 ...
 * @returns {void}
 */
+cacheDidUpdate?: (context: CacheDidUpdatePluginContext) => void,
...
context: CacheResponseWillBeUsedPluginContext) => Promise<Response> | Response | null,
 ...
 * @returns {Request}
 */
+requestWillFetch?: (context: RequestWillFetchPluginContext) => Request,
 ...
 * @returns {void}
 */
+fetchDidFail?: (context: FetchDidFailPluginContext) => void
} 
	declare interface CacheWillUpdatePluginContext {
+request: Request,
+response: Response
} 
	declare interface CacheDidUpdatePluginContext {
+cacheName: string,
+request: Request,
+oldResponse: Response,
+newResponse: Response
} 
	declare interface CacheResponseWillBeUsedPluginContext {
+cacheName: string,
+request: Request,
+matchOptions: any,
+cachedResponse: Response
} 
	declare interface RequestWillFetchPluginContext {
+request: Request
} 
	declare interface FetchDidFailPluginContext {
 ...
 */
declare type ModulePathCallback = (moduleName: string, debug: boolean) => string;
...
static backgroundSync: typeof BackgroundSyncNamespace;
static broadcastUpdate: typeof BroadcastUpdateNamespace;
static cacheableResponse: typeof CacheableResponseNamespace;
static core: typeof CoreNamespace;
static expiration: typeof ExpirationNamespace;
static googleAnalytics: typeof GoogleAnalyticsNamespace;
static precaching: typeof PrecachingNamespace;
static rangeRequests: typeof RangeRequestsNamespace;
static routing: typeof RoutingNamespace;
static strategies: typeof StrategiesNamespace;
static streams: typeof StreamsNamespace;
 ...
 * @param {$Shape<IConfigOptions>} config
 */
static setConfig(config?: $Shape<IConfigOptions>): void;
...
static skipWaiting(): void
	...
	declare export default typeof WorkboxNamespace
