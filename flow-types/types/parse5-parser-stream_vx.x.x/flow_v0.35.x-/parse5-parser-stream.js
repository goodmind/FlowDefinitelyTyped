declare module 'parse5-parser-stream' {
 ...
 * ```
 */
declare class ParserStream<TDocument> mixins stream.Writable {

/**
 * @param options - Parsing options.
 */
constructor(options?: parse5.ParserOptions): this;
 ...
 * @param - The script element that caused the event.
 * @param - Write additional `html` at the current parsing position. Suitable for implementing the DOM `document.write` and `document.writeln` methods.
 * @param - HTML to write.
 * @param - Resumes parsing.
 * @example ```js
     *
...
on(event: string, listener: (...params: any[]) => any): this
	...
	declare module.exports: typeof ParserStream
