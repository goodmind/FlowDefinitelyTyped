declare var Hammer: HammerStatic;declare module 'hammerjs' {
...
} declare type RecognizerTuple = [RecognizerStatic] | [RecognizerStatic, RecognizerOptions] | [RecognizerStatic, RecognizerOptions, string | string[]] | [RecognizerStatic, RecognizerOptions, string | string[], (string | Recognizer) | (string | Recognizer)[]];declare type HammerDefaults = {
domEvents: boolean,
enable: boolean,
