 ...
 * Default: false
 */
files?: string | (string | browserSync$FileCallback | {[key: string]: any})[],
...
declare type browserSync$WatchEvents = "add"
| "change"
| "unlink"
| "addDir"
| "unlinkDir";
...
declare type browserSync$OpenOptions = "local"
| "external"
| "ui"
| "ui-external"
| "tunnel";
...
ws?: boolean,
reqHeaders?: (config: {[key: string]: any}) => browserSync$Hash<{[key: string]: any}>,
proxyRes?: browserSync$ProxyResponseMiddleware | browserSync$ProxyResponseMiddleware[],
 ...
 */
(config?: browserSync$Options, callback?: (err: Error, bs: {[key: string]: any}) => any): browserSync$BrowserSyncInstance,
 ...
 */
create(name?: string, emitter?: NodeJS.EventEmitter): browserSync$BrowserSyncInstance,
...
callback?: (err: Error, bs: {[key: string]: any}) => any): browserSync$BrowserSyncInstance,
 ...
 */
cleanup(
fn?: (error: NodeJS.ErrnoException, bs: browserSync$BrowserSyncInstance) => void): void,
...
module: {
"plugin:name"?: string,
plugin: (opts: {[key: string]: any}, bs: browserSync$BrowserSyncInstance) => any
},
