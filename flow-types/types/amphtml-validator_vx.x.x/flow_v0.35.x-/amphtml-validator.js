...
validateString(stringToValidate: string): ValidationResult
	...
	declare export function getInstance(validatorJs?: string, userAgent?: string): Promise<Validator>
...
declare export type ValidationResultStatus = "UNKNOWN" | "PASS" | "FAIL";
	declare export type ValidationErrorSeverity = "UNKNOWN_SEVERITY" | "ERROR" | "WARNING";
	declare export type ErrorCategoryCode = "UNKNOWN"
| "GENERIC"
...
| "DEPRECATION";
	declare export type ValidationErrorCode = "UNKNOWN_CODE"
