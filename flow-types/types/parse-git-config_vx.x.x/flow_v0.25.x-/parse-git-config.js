declare module "parse-git-config" {
  ...
  declare function parse(
    options?: parse$parse$Options | string
  ): Promise<parse$parse$Config | null>;

  declare function parse(
    options: parse$parse$Options | string,
    cb: parse$parse$ParseCallback
  ): void;
   ...
   */
  declare function parse$promise(
   ...
   */
  declare function parse$resolveConfigPath(
    options: string | parse$ResolveConfigOptions
  ): string | null;
  ...
  declare type parse$ParseCallback = (
    err: Error | null,
    config: parse$Config
  ) => void;
