...
connect(): Promise<void>;
	...
	declare export interface Job<TResult> {
plugins?: string[],
pluginOptions?: {
...
perform: (...args: any[]) => Promise<TResult>
	...
	declare export interface JobsHash {
[jobName: string]: Job<any>
} 
	declare export interface QueueOptions {
connection?: ConnectionOptions
} 
	declare export class Queue mixins NodeJS.EventEmitter {
constructor(options: QueueOptions, jobs?: JobsHash): this;
connect(): Promise<void>;
...
queue: string,
jobName: string,
args: $ReadOnlyArray<any>): Promise<void>;
end(): Promise<void>;
...
looping?: boolean
	...
	declare export type WorkerEvent = "start"
| "end"
| "cleaning_worker"
| "poll"
| "ping"
...
| "error"
| "pause";
	declare export class Worker mixins NodeJS.EventEmitter {
constructor(options: WorkerOptions, jobs?: JobsHash): this;
connect(): Promise<void>;
start(): Promise<void>;
end(): Promise<void>;
...
on(
event: "reEnqueue",
cb: (queue: string, job: Job<any>, plugin: string) => void): this;
on(
event: "success",
cb: (queue: string, job: Job<any>, result: any) => void): this;
on(
event: "failure",
cb: (queue: string, job: Job<any>, failure: any) => void): this;
...
removeAllListeners(event: WorkerEvent): this
	...
	declare export interface SchedulerOptions {
connection?: ConnectionOptions,
name?: string,
timeout?: number,
...
masterLockTimeout?: number
	...
	declare export type SchedulerEvent = "start"
| "end"
| "poll"
| "master"
| "cleanStuckWorker"
...
| "workingTimestamp"
| "transferredJob";
	declare export class Scheduler mixins NodeJS.EventEmitter {
constructor(options: SchedulerOptions, jobs?: JobsHash): this;
connect(): Promise<void>;
start(): Promise<void>;
end(): Promise<void>;
...
cb: (workerName: string, errorPayload: ErrorPayload, delta: number) => void): this;
on(event: "error", cb: (error: Error, queue: string) => void): this;
...
removeAllListeners(event: SchedulerEvent): this
	...
	declare export interface ErrorPayload {
worker: string,
queue: string,
payload: any,
exception: string,
