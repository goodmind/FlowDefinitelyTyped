...
constructor(audioContext: AudioContext, config?: Recorder$Recorder$RecorderConfig): this;
...
stop(): Promise<Recorder$Recorder$RecorderResult>
	...
	declare type Recorder$OnAnalysedHandler = (data: number[], lastNonZero: number) => void;
