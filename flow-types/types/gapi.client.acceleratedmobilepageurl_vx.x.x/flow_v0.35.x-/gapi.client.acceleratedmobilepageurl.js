 ...
 */
declare function client$load(name: "acceleratedmobilepageurl", version: "v1"): PromiseLike<void>


declare function client$load(name: "acceleratedmobilepageurl", version: "v1", callback: () => any): void
