 ...
 */
ComputeAABB(aabb: Collision$b2AABB, xf: Box2D$Box2D$Common.Math.Math$b2Transform): void;
...
c: Box2D$Box2D$Common.Math.Math$b2Vec2): number;
...
transform: Box2D$Box2D$Common.Math.Math$b2Transform): boolean;
...
transform2: Box2D$Box2D$Common.Math.Math$b2Transform): boolean;
...
TestPoint(
xf: Box2D$Box2D$Common.Math.Math$b2Transform,
p: Box2D$Box2D$Common.Math.Math$b2Vec2): boolean
}
...
bA: Dynamics$b2Body,
bB: Dynamics$b2Body,
anchor: Box2D$Box2D$Common.Math.Math$b2Vec2): void
}
    }
