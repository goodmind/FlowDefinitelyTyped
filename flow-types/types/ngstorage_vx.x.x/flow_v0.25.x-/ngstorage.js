declare module "ngstorage" {
  declare interface ngStorage$StorageService {
    /**
     ...
     */
    $default<T>(items: T): ngStorage$StorageService & T;
     ...
     * @return the modified storage service.
     */
    $reset<T>(items?: T): ngStorage$StorageService & T;
    $apply(): void;
    $sync(): void;
  ...
  declare type ngStorage$StorageProvider = {
