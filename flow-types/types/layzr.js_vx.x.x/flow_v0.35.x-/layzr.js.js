declare module 'layzr.js' {
        declare type Layzr$LayzrEvents = "src:before" | "src:after";

declare interface Layzr$LayzrInstance {

/**
 * Manually check if elements are in the viewport. This method is called while the window is scrolled or resized.
 */
check(): Layzr$LayzrInstance,
 ...
 */
emit(name: Layzr$LayzrEvents, ...args: any[]): Layzr$LayzrInstance,

/**
 * Add or remove the scroll and resize event handlers.
 * @param flag
 */
handlers(flag: boolean): Layzr$LayzrInstance,
 ...
 */
off(name: Layzr$LayzrEvents, handler?: () => {}): Layzr$LayzrInstance,
 ...
 */
on(
name: Layzr$LayzrEvents,
handler: (element: HTMLElement) => void): Layzr$LayzrInstance,
 ...
 */
update(): Layzr$LayzrInstance
} 

declare interface Layzr$LayzrOptions {
 ...
 */
declare function Layzr(options?: Layzr$Layzr$LayzrOptions): Layzr$Layzr$LayzrInstance

	declare module.exports: typeof Layzr
