declare module 'knockout.mapping' {
	...
	declare module 'global' {
        declare type KnockoutObservableType<T> = $ObjMapi<T, <P>(P) => KnockoutObservable<KnockoutObservableType<$ElementType<T, P>>> | $ElementType<T, P>>;
...
fromJS<T>(
jsObject: T[],
targetOrOptions: any): KnockoutObservableArray<KnockoutObservableType<T>>,
fromJS<T>(
jsObject: T[],
inputOptions: any,
target: any): KnockoutObservableArray<KnockoutObservableType<T>>,
...
toJS<T>(
viewModel: KnockoutObservableArray<T> | KnockoutObservableType<T>[] | KnockoutObservableArray<KnockoutObservableType<T>> | T[],
options?: KnockoutMappingOptions): T[],
toJS<T>(
viewModel: KnockoutObservable<T> | KnockoutObservableType<T> | KnockoutObservable<KnockoutObservableType<T>>,
options?: KnockoutMappingOptions): T,
