declare module 'libpq' {
	...
	declare interface Libpq$NotifyMsg {
relname: string,
extra: string,
be_pid: number
} 

declare interface Libpq$ResultError {
severity: string,
sqlState: string,
...
sourceFunction: string
	...
	declare class Libpq mixins EventEmitter {
 ...
 * connection.
 * @param async a boolean. Pass false to block waiting for data from the
 ...
 * @example ```ts
     ...
     * ```
 */
notifies(): Libpq$Libpq$NotifyMsg;
 ...
 * @example ```ts
     ...
     * ```
 */
resultErrorFields(): Libpq$Libpq$ResultError;
...
writable(callback: () => void): this
	...
	declare module.exports: typeof Libpq
