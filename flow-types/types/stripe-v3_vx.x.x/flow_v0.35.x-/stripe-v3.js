...
elements(options?: elements$elements$ElementsCreateOptions): elements$elements$Elements,
createToken(
element: elements$elements$Element,
options?: stripe$TokenOptions): Promise<stripe$TokenResponse>,
createToken(
name: "bank_account",
options: stripe$BankAccountTokenOptions): Promise<stripe$TokenResponse>,
...
retrieveSource(options: stripe$RetrieveSourceOptions): Promise<stripe$SourceResponse>,
paymentRequest(
options: paymentRequest$paymentRequest$StripePaymentRequestOptions): paymentRequest$paymentRequest$StripePaymentRequest
} 
...
declare type stripe$statusType = "new"
| "validated"
| "verified"
| "verification_failed"
| "errored";
...
declare type stripe$brandType = "Visa"
| "American Express"
| "MasterCard"
| "Discover"
| "JCB"
...
on(
event: "token",
elements$handler: (response: paymentRequest$StripeTokenPaymentResponse) => void): void,
on(
event: "source",
elements$handler: (response: paymentRequest$StripeSourcePaymentResponse) => void): void,
...
declare type elements$handler = (response?: elements$ElementChangeResponse) => void;
...
declare type elements$elementsType = "card"
| "cardNumber"
| "cardExpiry"
| "cardCvc"
| "postalCode"
...
options?: elements$ElementsOptions): elements$Element
} 
