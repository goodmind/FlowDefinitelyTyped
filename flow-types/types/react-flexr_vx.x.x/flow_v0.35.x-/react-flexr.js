...
declare export class __ReactFlexr$Grid mixins React.Component<__ReactFlexr$GridProps> {}
...
declare export class __ReactFlexr$Cell mixins React.Component<__ReactFlexr$CellProps> {}
...
declare export type __ReactFlexr$ErgonomicType = "palm" | "lap" | "portable" | "desk";
 ...
 */
declare export var __ReactFlexr$findMatch: (...arguments: __ReactFlexr$ErgonomicType[]) => boolean;
 ...
 */
declare export var __ReactFlexr$setBreakpoints: (breakpoints: __ReactFlexr$ErgonomicType[]) => void;
 ...
 */
declare export var __ReactFlexr$findBreakpoints: () => __ReactFlexr$ErgonomicType[] | boolean;
 ...
 * The ergonomic breakpoint media query that flexr uses internally.
 */
declare export var __ReactFlexr$desk: string;declare module 'react-flexr' {
        declare module.exports: typeof __ReactFlexr
