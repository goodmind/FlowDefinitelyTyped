declare module 'parallel-transform' {
        import type {
          Transform,TransformOptions,TransformCallback
        } from 'stream';
...
(maxParallel: number, opts: ParallelTransform$ParallelTransform$Options | void | null, ontransform: OnTransform): Transform,
(opts: ParallelTransform$ParallelTransform$Options | number | void | null, ontransform: OnTransform): Transform,
