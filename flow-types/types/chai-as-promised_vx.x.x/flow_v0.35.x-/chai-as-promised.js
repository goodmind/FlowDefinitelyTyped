...
declare function chaiAsPromised$transferPromiseness(assertion: Chai$Chai$PromisedAssertion, promise: PromiseLike<any>): void
...
(function Object() { [native code] }: Object, message?: string): Chai$PromisedAssertion
} 
...
(name: string, descriptor: PropertyDescriptor, message?: string): Chai$PromisedAssertion,
(name: string, message?: string): Chai$PromisedAssertion
} 
...
(function Object() { [native code] }: Error, expected?: string, message?: string): Chai$PromisedAssertion,
(function Object() { [native code] }: Error, expected?: RegExp, message?: string): Chai$PromisedAssertion,
(function Object() { [native code] }: Function, expected?: string, message?: string): Chai$PromisedAssertion,
(function Object() { [native code] }: Function, expected?: RegExp, message?: string): Chai$PromisedAssertion
} 
...
expected?: any,
msg?: string,
operator?: string): PromiseLike<void>,
