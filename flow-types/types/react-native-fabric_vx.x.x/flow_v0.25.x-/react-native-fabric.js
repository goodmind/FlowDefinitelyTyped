declare module "react-native-fabric" {
  ...
  declare function Answers$logCustom(
    eventName: string,
    customAttributes?: CustomAttributes
  ): void;

  declare function Answers$logInvite(
    method: string,
    customAttributes?: CustomAttributes
  ): void;

  declare function Answers$logLevelStart(
    levelName: string,
    customAttributes?: CustomAttributes
  ): void;

  declare function Answers$logLevelEnd(
    levelName: string,
    customAttributes?: CustomAttributes
  ): void;

  declare function Answers$logLogin(
    method: string,
    success: boolean,
    customAttributes?: CustomAttributes
  ): void;

  declare function Answers$logSearch(
    query: string,
    customAttributes?: CustomAttributes
  ): void;

  declare function Answers$logSignUp(
    method: string,
    success: boolean,
    customAttributes?: CustomAttributes
  ): void;
  ...
  declare function Crashlytics$recordCustomExceptionName(
    name: string,
    reason: string,
    stack?: any[]
  ): void;
