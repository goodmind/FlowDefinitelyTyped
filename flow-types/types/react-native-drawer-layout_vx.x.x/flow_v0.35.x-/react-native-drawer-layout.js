...
offset: number
	...
	declare export type DrawerLayoutSlideEventHandler = (event: DrawerLayoutSlideEvent) => void;
	declare export type DrawerLayoutStateChangeEventHandler = (state: string) => void;
