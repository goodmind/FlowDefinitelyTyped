...
declare class Bookshelf$ModelBase<T: Bookshelf$Model<any>> mixins Bookshelf$Events<T | Bookshelf$Collection<T>> {
...
related<R: Bookshelf$Model<any>>(relation: string): R | Bookshelf$Collection<R>;
...
declare class Bookshelf$Model<T: Bookshelf$Model<any>> mixins Bookshelf$ModelBase<T> {
static collection<T: Bookshelf$Model<any>>(
models?: T[],
options?: Bookshelf$CollectionOptions<T>): Bookshelf$Collection<T>;
static count(column?: string, options?: Bookshelf$SyncOptions): BlueBird<number>;
...
classProperties?: any): Function;
static fetchAll<T: Bookshelf$Model<any>>(): BlueBird<Bookshelf$Collection<T>>;
...
otherKeyTarget?: string): Bookshelf$Collection<R>;
...
fetchAll(options?: Bookshelf$FetchAllOptions): BlueBird<Bookshelf$Collection<T>>;
hasMany<R: Bookshelf$Model<any>>(
target: {
new (...args: any[]): R
},
foreignKey?: string,
foreignKeyTarget?: string): Bookshelf$Collection<R>;
...
foreignKey?: string,
foreignKeyTarget?: string): R;
load(relations: string | string[], options?: Bookshelf$LoadOptions): BlueBird<T>;
...
columnNames?: string[],
morphValue?: string): R;
morphTo(name: string, columnNames?: string[], ...target: Bookshelf$ModelSubclass[]): T;
...
save(attrs?: {
[key: string]: any
}, options?: Bookshelf$SaveOptions): BlueBird<T>;
...
declare class Bookshelf$CollectionBase<T: Bookshelf$Model<any>> mixins Bookshelf$Events<T> {
length: number;
...
fetch(options?: Bookshelf$CollectionFetchOptions): BlueBird<Bookshelf$Collection<T>>;
findWhere(match: {
[key: string]: any
}): T;
get(id: any): T;
...
declare class Bookshelf$Collection<T: Bookshelf$Model<any>> mixins Bookshelf$CollectionBase<T> {
...
attach(
ids: any | any[],
options?: Bookshelf$SyncOptions): BlueBird<Bookshelf$Collection<T>>;
count(column?: string, options?: Bookshelf$SyncOptions): BlueBird<number>;
create(
model: {
[key: string]: any
},
options?: Bookshelf$CollectionCreateOptions): BlueBird<T>;
...
options?: Bookshelf$SyncOptions): BlueBird<Bookshelf$Collection<T>>;
orderBy(column: string, order?: Bookshelf$SortOrder): Bookshelf$Collection<T>;
query(): Knex.QueryBuilder;
...
updatePivot(attributes: any, options?: Bookshelf$PivotOptions): BlueBird<number>;
