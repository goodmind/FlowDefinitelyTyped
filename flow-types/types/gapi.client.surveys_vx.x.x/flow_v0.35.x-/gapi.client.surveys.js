 ...
 * Load Surveys API v2
 */
declare function client$load(name: "surveys", version: "v2"): PromiseLike<void>


declare function client$load(name: "surveys", version: "v2", callback: () => any): void
...
images?: surveys$SurveyQuestionImage[],
