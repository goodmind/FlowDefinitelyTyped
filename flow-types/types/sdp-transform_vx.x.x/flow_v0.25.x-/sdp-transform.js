declare module "sdp-transform" {
  ...
  declare export function parseRemoteCandidates(
    candidates: string
  ): Array<{
    component: number,
    ip: string,
  ...
  declare export function parseSimulcastStreamList(
    streams: string
  ): Array<{
    scid: number | string,
    paused: boolean
  ...
  declare export type MediaDescription = {} & SharedDescriptionFields &
    MediaAttributes;
