 ...
 * @default T = any
 */
declare interface AdazzleReactDataGrid$RowUpdateEvent<T> {
 ...
 * @default T = any
 */
declare interface AdazzleReactDataGrid$DragHandleDoubleClickEvent<T> {
 ...
 * @default T = any
 */
declare interface AdazzleReactDataGrid$GridRowsUpdatedEvent<T> {
...
declare module 'react-data-grid-addons' {
        declare export {
          Editors,Filters,Formatters,Toolbar,Menu,Data,DraggableHeader
        }
