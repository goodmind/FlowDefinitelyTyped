declare module "event-kit" {
  ...
  > mixins DisposableLike {
    ...
    on<T: $Keys<OptionalEmissions>>(
      eventName: T,
      handler: (value?: $ElementType<OptionalEmissions, T>) => void
    ): Disposable;
    ...
    on<T: $Keys<RequiredEmissions>>(
      eventName: T,
      handler: (value: $ElementType<RequiredEmissions, T>) => void
    ): Disposable;
    ...
    emit<T: $Keys<OptionalEmissions>>(
      eventName: T,
      value?: $ElementType<OptionalEmissions, T>
    ): void;
    ...
    emit<T: $Keys<RequiredEmissions>>(
      eventName: T,
      value: $ElementType<RequiredEmissions, T>
    ): void;
