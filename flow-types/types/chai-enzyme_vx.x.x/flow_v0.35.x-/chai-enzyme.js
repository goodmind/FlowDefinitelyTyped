declare type Chai$EnzymeSelector = string | React.StatelessComponent<any> | React.ComponentClass<any> | {
[key: string]: any
};
...
props(props: Chai$EnzymeSelector): Chai$Assertion
	...
	declare type DebugWrapper = ShallowWrapper<any, any> | Cheerio | ReactWrapper<any, any>;
