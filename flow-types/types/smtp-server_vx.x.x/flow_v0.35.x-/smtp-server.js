declare module 'smtp-server' {
	...
	import typeof * as shared from 'nodemailer/lib/shared';
	...
	declare export type ms = number;
	declare export interface SMTPServerAddress {
...
args: {[key: string]: any}
	...
	declare export interface SMTPServerAuthentication {
...
validatePassword(password: string): boolean
	...
	declare export interface SMTPServerAuthenticationResponse {
...
data?: {[key: string]: any}
	...
	declare export interface SMTPServerSession {
...
tlsOptions: tls.TlsOptions
	...
	declare export type SMTPServerDataStream = {
...
sizeExceeded: boolean
	...
	declare export interface SMTPServerEnvelope {
...
rcptTo: SMTPServerAddress[]
	...
	declare export type SMTPServerOptions = {
...
callback: (err: Error | null | void, response?: SMTPServerAuthenticationResponse) => void): void,
 ...
 */
declare export class SMTPServer mixins EventEmitter {
...
hostname?: string,
backlog?: number,
listeningListener?: () => void): net.Server;
