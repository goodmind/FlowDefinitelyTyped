declare module "react-virtualized-select" {
  ...
  declare type VirtualizedSelectProps<TValue = OptionValues> =
    ...
    | (ReactCreatableSelectProps<TValue> &
        ...
        AdditionalVirtualizedSelectProps<TValue>);
  declare class VirtualizedSelect<TValue = OptionValues>
    mixins React.PureComponent<VirtualizedSelectProps<TValue>> {}
