...
declare type VisualizationAPI$VisualizationType =
  | "barchart"
  | "combochart"
  | "gauge"
  | "kpi"
...
declare type NavigationAPI$NavigationErrorType =
  | "NOSUCHSHEET"
  | "NOCURRENTSHEET"
  | "NOSUCHSTORY";
 ...
 */
  switchMode(
    mode: NavigationAPI$NavigationModeType
  ): NavigationAPI$NavigationResult;
}
 ...
 */
  ...
  selectionState(
    state?: string
  ): SelectionStateAPI$SelectionStateAPI$IQSelectionState;
 ...
 */
  ...
  sessionAppFromApp(
    appId: string,
    config?: RootAPI$ISessionAppConfig
  ): AppAPI$AppAPI$IApp;
...
declare type BackendAPI$StateType =
  | "L"
  | "S"
  | "O"
  | "D"
...
declare type BackendAPI$FieldAttributesType =
  | "U"
  | "A"
  | "I"
  | "R"
