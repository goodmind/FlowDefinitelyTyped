declare module 'qlik-visualizationextensions' {
        declare type BackendAPI$StateType = "L"
| "S"
| "O"
| "D"
| "A"
...
declare type BackendAPI$SortIndicatorType = "N" | "A" | "D";

declare type BackendAPI$DimensionType = "D" | "N" | "T";

declare type BackendAPI$GroupingType = "N" | "H" | "C";

declare type BackendAPI$FieldAttributesType = "U"
| "A"
| "I"
| "R"
| "F"
...
declare type BackendAPI$PatchType = "Add" | "Remove" | "Replace";

declare interface BackendAPI$ICharRange {
...
declare interface BackendAPI$INxHighlightRanges {

/**
 * Ranges of highlighted values
 * Array of CharRange
 */
qRanges: BackendAPI$ICharRange[]
} 

declare interface BackendAPI$INxSimpleValue {
...
declare interface BackendAPI$INxAttributeExpressionValues {

/**
 * List of attribute expressions values.
 * Array of NxSimpleValue
 */
qValues: BackendAPI$INxSimpleValue[]
} 

declare interface BackendAPI$INxSimpleDimValue {
...
declare interface BackendAPI$INxAttributeDimValues {

/**
 * List of values.
 * Array of NxSimpleDimValue
 */
qValues: BackendAPI$INxSimpleDimValue[]
} 

declare interface BackendAPI$INxCell {
 ...
 * This parameter is optional.
 */
qHighlightRanges: BackendAPI$INxHighlightRanges,

/**
 * Attribute expression values.
 */
qAttrExps: BackendAPI$INxAttributeExpressionValues,
 ...
 */
qAttrDims: BackendAPI$INxAttributeDimValues
} 

declare interface BackendAPI$INxPage {
...
declare interface BackendAPI$INxAttrDimInfo {
 ...
 */
qError: BackendAPI$INxValidationError
} 

declare interface BackendAPI$INxDimensionInfo {
 ...
 */
qSortIndicator: BackendAPI$SortIndicatorType,
 ...
 * NxStateCounts
 */
qStateCounts: BackendAPI$INxStateCounts,
 ...
 */
qDimensionType: BackendAPI$DimensionType,
 ...
 *        # C for cyclic
 */
qGrouping: BackendAPI$GroupingType,
 ...
 * FieldAttributes
 */
qNumFormat: BackendAPI$FieldAttributesType,
 ...
 */
qAttrExprInfo: BackendAPI$INxAttrExprInfo,
 ...
 */
qAttrDimInfo: BackendAPI$INxAttrDimInfo
} 

declare interface BackendAPI$INxAttrExprInfo {
...
declare interface BackendAPI$INxStateCounts {
...
declare interface BackendAPI$INxValidationError {
...
declare interface BackendAPI$IFieldAttributes {
 ...
 */
qType: BackendAPI$FieldAttributesType,
...
declare interface BackendAPI$INxMeasureInfo {
 ...
 */
qNumFormat: BackendAPI$IFieldAttributes,
 ...
 */
qAttrDimInfo: BackendAPI$INxMeasureInfo[]
} 

declare interface BackendAPI$IRange {
...
declare interface BackendAPI$INxPatch {
...
declare interface BackendAPI$IBackend {
 ...
 */
eachDataRow(callback: any): BackendAPI$INxCell[],
 ...
 */
getData(qPages: BackendAPI$INxPage[]): ng.IPromise<any>,
 ...
 */
getPivotData(qPages: BackendAPI$INxPage[]): ng.IPromise<BackendAPI$INxPage[]>,
 ...
 */
getReducedData(
qPages: BackendAPI$INxPage[],
qZoomFactor: number,
qReductionMode: string): ng.IPromise<any>,
 ...
 */
getStackedData(qPages: BackendAPI$INxPage[], qMaxNbrCells: number): ng.IPromise<any>,
 ...
 */
selectRange(qRanges: BackendAPI$IRange[], qOrMode: boolean): void,
...
setProperties(props: any): ng.IPromise<any>
	...
	declare interface RootAPI$IAppConfig {
...
declare interface RootAPI$IGlobalConfig {
...
declare interface RootAPI$ISessionAppConfig {
...
declare interface RootAPI$IRoot {
 ...
 */
currApp(object?: any): AppAPI$AppAPI$IApp,
 ...
 * @return - App JavaScript object with app methods.
 */
sessionApp(config?: RootAPI$ISessionAppConfig): AppAPI$AppAPI$IApp,
 ...
 * @return - App JavaScript object with app methods.
 */
sessionAppFromApp(appId: string, config?: RootAPI$ISessionAppConfig): AppAPI$AppAPI$IApp,
 ...
 */
table(ext: any, path?: string): TableAPI$TableAPI$IQTable,
navigation: NavigationAPI$NavigationAPI$INavigation
} 
	declare interface AppAPI$IApp {
...
measures: string[] | any[],
options?: any): TableAPI$TableAPI$IQTable,
 ...
 */
field(field?: string, state?: string): FieldAPI$FieldAPI$IQField,
 ...
 */
selectionState(state?: string): SelectionStateAPI$SelectionStateAPI$IQSelectionState,
...
unlockAll(state?: string): ng.IPromise<any>
	...
	declare interface BookmarkAPI$IBookmark {
...
remove(id: string): ng.IPromise<any>
	...
	declare interface FieldAPI$IQField {
 ...
 */
selectValues(
array: FieldAPI$IQFieldValue[],
toggle?: boolean,
softlock?: boolean): ng.IPromise<any>,
...
declare interface FieldAPI$IQFieldValue {
...
select(toggle?: boolean, softlock?: boolean): ng.IPromise<any>
	...
	declare interface GlobalAPI$IGlobal {
...
isPersonalMode(callback?: any): ng.IPromise<any>
	...
	declare type NavigationAPI$NavigationModeType = "ANALYSIS" | "EDIT";

declare type NavigationAPI$NavigationErrorType = "NOSUCHSHEET" | "NOCURRENTSHEET" | "NOSUCHSTORY";


/**
 * The navigation result object.
 */
declare interface NavigationAPI$NavigationResult {
 ...
 */
error: NavigationAPI$NavigationErrorType,
 ...
 */
declare interface NavigationAPI$INavigation {
 ...
 */
getCurrentSheetId(): NavigationAPI$NavigationResult,
 ...
 * @return - A navigation result object.
 */
gotoSheet(sheetId: string): NavigationAPI$NavigationResult,
 ...
 * @return - A navigation result object.
 */
gotoStory(storyId: string): NavigationAPI$NavigationResult,
 ...
 */
isModeAllowed(mode: NavigationAPI$NavigationModeType): boolean,
 ...
 * @return - A navigation result object.
 */
nextSheet(): NavigationAPI$NavigationResult,
 ...
 * @return - A navigation result object.
 */
prevSheet(): NavigationAPI$NavigationResult,
 ...
 * @return - A navigation result object.
 */
setMode(mode: string): NavigationAPI$NavigationResult,
 ...
 * @return - A navigation result object.
 */
switchMode(mode: NavigationAPI$NavigationModeType): NavigationAPI$NavigationResult
} 
	declare interface SelectionStateAPI$IQFieldSelections {
 ...
 */
field: FieldAPI$FieldAPI$IQField,
...
declare interface SelectionStateAPI$IQSelectionState {
 ...
 * Selections
 */
selections: SelectionStateAPI$IQFieldSelections,
...
unlockAll(): ng.IPromise<any>
	...
	declare interface TableAPI$IQTable {
 ...
 * Header information.
 */
headers: TableAPI$IQHeader[],

/**
 * Total information for measures.
 */
totals: TableAPI$IQMeasureCell[],
...
declare interface TableAPI$IQHeader {
...
max: number,
inclMin?: boolean,
inclMax?: boolean): ng.IPromise<any>
} 

declare interface TableAPI$IQRow {

/**
 * Dimension cells.
 */
dimensions: TableAPI$IQDimensionCell[],

/**
 * Measure cells.
 */
measures: TableAPI$IQMeasureCell[],
...
declare type TableAPI$IQDimensionCell = {
 ...
 */
select(): void
} & TableAPI$IQMeasureCell


declare interface TableAPI$IQMeasureCell {
...
getPercentOfMax(): number
	...
	declare interface VariableAPI$IVariable {
...
setStringValue(qName: string, qVal: string): ng.IPromise<any>
	...
	declare type VisualizationAPI$VisualizationType = "barchart"
| "combochart"
| "gauge"
| "kpi"
| "linechart"
...
declare interface VisualizationAPI$IVisualization {
 ...
 */
create(
type: VisualizationAPI$VisualizationType,
cols?: any[],
...
declare interface VisualizationAPI$IQVisualization {

/**
 * Table object for this visualization.
 * Only for visualizations built on a hypercube.
 */
table: TableAPI$TableAPI$IQTable,
...
show(element?: any | string, options?: any): void
	...
	declare interface ExtensionAPI$IExtensionModel {} 

declare interface ExtensionAPI$IExtensionComponent {
model: ExtensionAPI$IExtensionModel
} 

declare type ExtensionAPI$IExtensionScope = {
component: ExtensionAPI$IExtensionComponent
} & ng.IScope


declare type ExtensionAPI$SelectionModeType = "CONFIRM" | "QUICK";

declare interface ExtensionAPI$IInitialProperties {
qHyperCubeDef?: any,
qListObjectDef?: any,
fixed?: boolean,
width?: number,
percent?: boolean,
selectionMode?: ExtensionAPI$SelectionModeType
} 

declare interface ExtensionAPI$ISupport {
snapshot?: boolean,
export?: boolean,
exportData?: boolean,
snapshot?: boolean,
...
declare interface ExtensionAPI$IExtension {
definition?: ExtensionAPI$IDefinition,
paint($element: HTMLElement, layout?: any): void,
initialProperties?: ExtensionAPI$IInitialProperties,
template?: string,
controller?: any,
support?: ExtensionAPI$ISupport
} 

declare type ExtensionAPI$ExpressionType = "always" | "optional" | "";

declare type ExtensionAPI$func<T> = () => T;

declare type ExtensionAPI$valueOrfunc<T> = T | ExtensionAPI$func<T>;

declare interface ExtensionAPI$ICustomControlOption {
value: string,
label: string
} 

declare interface ExtensionAPI$ICustomControl {
type: string,
label: string,
ref: string
} 

declare type ExtensionAPI$ICustomString = {
defaultValue: string,
expression: ExtensionAPI$ExpressionType,
show: ExtensionAPI$valueOrfunc<boolean>,
maxlength: number
} & ExtensionAPI$ICustomControl


declare type ExtensionAPI$ICustomNumber = {
defaultValue: number,
min: number,
max: number
} & ExtensionAPI$ICustomControl
...
declare type ExtensionAPI$ICustomInteger = {} & ExtensionAPI$ICustomNumber


declare type ExtensionAPI$ICustomArray = {
itemTitleRef: string,
...
declare type ExtensionAPI$ICustomButton = {
label: string,
component: "button",
action: ExtensionAPI$valueOrfunc<void>
} & ExtensionAPI$ICustomControl


declare type ExtensionAPI$ICustomButtonGroup = {
component: "buttongroup",
defaultValue: string,
options: ExtensionAPI$valueOrfunc<ExtensionAPI$ICustomControlOption>
} & ExtensionAPI$ICustomControl


declare type ExtensionAPI$ICustomCheckBox = {
component: "checkbox",
defaultValue: boolean
} & ExtensionAPI$ICustomControl


declare type ExtensionAPI$ICustomColorPicker = {
component: "color-picker",
defaultValue: number
} & ExtensionAPI$ICustomControl


declare type ExtensionAPI$ICustomDropDownList = {
component: "dropdown",
defaultValue: string,
options: ExtensionAPI$valueOrfunc<ExtensionAPI$ICustomControlOption>
} & ExtensionAPI$ICustomControl
...
declare interface ExtensionAPI$ICustomLink {
type: string,
component: "link",
label: string,
url: string
...
declare type ExtensionAPI$ICustomMedia = {
component: "media",
layoutRef: string
} & ExtensionAPI$ICustomControl


declare type ExtensionAPI$ICustomRadioButton = {
...
declare type ExtensionAPI$ICustomSlider = {
component: "slider",
defaultValue: number,
min: number,
max: number,
...
declare type ExtensionAPI$ICustomRangeSlider = {
component: "slider",
defaultValue: number[],
min: number,
max: number,
...
declare interface ExtensionAPI$ICustomSwitch {
component: "switch",
defaultValue: boolean,
options: ExtensionAPI$valueOrfunc<ExtensionAPI$ICustomControlOption>
} 

declare interface ExtensionAPI$ICustomText {
type: "text",
component: "text",
label: string
} 

declare type ExtensionAPI$ICustomTextArea = {
component: "textarea",
rows: number,
maxlength: number,
defaultValue: string,
...
declare interface ExtensionAPI$IDefinition {
type: "items",
component: "accordion",
items: ExtensionAPI$IItems
} 

declare interface ExtensionAPI$IItems {
dimentions?: ExtensionAPI$IDimensions,
measures?: ExtensionAPI$IMeasures,
appearance?: ExtensionAPI$IAppearance,
sorting?: ExtensionAPI$ISorting,
AddOns?: ExtensionAPI$IAddOns,
[other: string]: any
} 

declare interface ExtensionAPI$IAddOns {
uses: "addons"
} 

declare interface ExtensionAPI$ISorting {
uses: "sorting"
} 

declare interface ExtensionAPI$IDimensions {
uses: "dimensions",
min?: number,
max?: number
} 

declare interface ExtensionAPI$IAppearance {
uses: "settings",
min?: number,
max?: number,
items: any
...
declare interface ExtensionAPI$ISettings {
uses: "settings",
min?: number,
max?: number
} 

declare interface ExtensionAPI$IMeasures {
uses: "measures",
min?: number,
max?: number
} 
	declare module 'qlik' {
        declare var e: RootAPI$RootAPI$IRoot;
	declare module.exports: typeof e

    }

	declare interface IQVAngular {
 ...
 */
on(event: "changed" | "closed", ExtensionAPI$func: () => void): void,
