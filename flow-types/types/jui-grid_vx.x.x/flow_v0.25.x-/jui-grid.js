declare module "jui-grid" {
  import type { UIEvent } from "jui-core";

  declare export interface GridColumn {
  ...
  declare export interface GridBase {
 ...
 */
  ...
  declare export type GridXTable = {
    ...
    /**
     * @deprecated Sets the scroll based on the height of a table.
     */
