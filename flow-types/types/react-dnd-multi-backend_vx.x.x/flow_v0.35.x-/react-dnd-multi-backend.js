 ...
 */
declare export function createTransition(eventType: string, check: CheckFunction<any>): Transition
 ...
 */
declare export default function BackendFactory(backends: Backends): BackendFactory
