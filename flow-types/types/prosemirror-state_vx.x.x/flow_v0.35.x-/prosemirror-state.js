declare module 'prosemirror-state' {
        import type {
          Mark,MarkType,ProsemirrorNode,ResolvedPos,Schema,Slice
        } from 'prosemirror-model';

	import type {
          Mappable,Mapping,Transform
        } from 'prosemirror-transform';

	import type {
          EditorProps,EditorView
 ...
 */
declare export interface PluginSpec<S: Schema> {
...
newState: EditorState<S>) => Transaction<S> | null | void | void) | null
} 
 ...
 */
declare export class Plugin<S: Schema>  {
 ...
 */
declare export interface StateField<T, S: Schema> {
...
fromJSON?: ((config: {
[key: string]: any
}, value: any, state: EditorState<S>) => T) | null
} 
 ...
 */
declare export class PluginKey<S: Schema>  {
 ...
 */
declare export class Selection<S: Schema>  {
 ...
 * `$head`.
 */
constructor($anchor: ResolvedPos<S>, $head: ResolvedPos<S>, ranges?: Array<SelectionRange<S>>): this;
 ...
 * found.
 */
static findFrom<S: Schema>(
$pos: ResolvedPos<S>,
dir: number,
textOnly?: boolean): Selection<S> | null | void;
 ...
 */
static near<S: Schema>($pos: ResolvedPos<S>, bias?: number): Selection<S>;
 ...
 * exists.
 */
static atStart<S: Schema>(doc: ProsemirrorNode<S>): Selection<S>;

/**
 * Find the cursor or leaf node selection closest to the end of the
 * given document.
 */
static atEnd<S: Schema>(doc: ProsemirrorNode<S>): Selection<S>;

/**
 * Deserialize the JSON representation of a selection. Must be
 * implemented for custom classes (as a static class method).
 */
static fromJSON<S: Schema>(doc: ProsemirrorNode<S>, json: {
[key: string]: any
}): Selection<S>;
 ...
 */
declare export interface SelectionBookmark<S: Schema> {
 ...
 */
declare export class SelectionRange<S: Schema>  {
 ...
 * position).
 */
declare export class TextSelection<S: Schema> mixins Selection<S> {
 ...
 */
static create<S: Schema>(
doc: ProsemirrorNode<S>,
anchor: number,
head?: number): TextSelection<S>;
 ...
 */
static between<S: Schema>(
$anchor: ResolvedPos<S>,
$head: ResolvedPos<S>,
bias?: number): Selection<S>
}
 ...
 */
declare export class NodeSelection<S: Schema> mixins Selection<S> {
 ...
 */
static create<S: Schema>(doc: ProsemirrorNode<S>, from: number): NodeSelection<S>;
 ...
 * document).
 */
declare export class AllSelection<S: Schema> mixins Selection<S> {
 ...
 */
declare export class EditorState<S: Schema>  {
 ...
 */
declare export class Transaction<S: Schema> mixins Transform<S> {
