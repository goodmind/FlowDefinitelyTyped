declare module 'dotenv-safe' {
        declare export type MissingEnvVarsError = {
...
missing: string[]
	...
	declare export interface DotenvSafeOptions {
 ...
 */
declare export function load(options?: DotenvSafeOptions): env.DotenvConfigOutput
 ...
 * @throws MissingEnvVarsError
 */
declare export function config(options?: DotenvSafeOptions): env.DotenvConfigOutput
