declare module 'react-sticky-el' {
	...
	declare type Sticky$Props<HolderProps: {[key: string]: any}> = {
 ...
 * Defaults to 'div'.
 */
wrapperCmp?: $Keys<React.ReactHTML> | React.ReactElement<any>,
 ...
 * Defaults to 'div'.
 */
holderCmp?: $Keys<React.ReactHTML> | React.ReactElement<HolderProps>,
