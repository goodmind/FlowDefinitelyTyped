...
appRawOrPath: {[key: string]: any} | string): (event: any, context: any, callback: any) => void

	declare export function createAppTester(appRawOrPath: {[key: string]: any} | string): Promise<any>

	declare export function integrationTestHandler(event: any, context: any, callback: any): any
...
json: {[key: string]: any} | void | Promise<{[key: string]: any} | void>,
...
oauth2Config: {
authorizeUrl: string | ((z: Z, bundle: AuthorizeUrlBundle<InputData>) => string | Promise<string>) | HttpRequestOptions,
getAccessToken: ((z: Z, bundle: GetAccessTokenBundle<InputData>) => AuthData | Promise<AuthData>) | HttpRequestOptions,
refreshAccessToken?: ((
z: Z,
bundle: RefreshAccessTokenBundle<InputData>) => AuthData | Promise<AuthData>) | HttpRequestOptions,
autoRefresh: boolean,
scope?: string
},
test: ((z: Z, bundle: Bundle<InputData>) => boolean | Promise<boolean>) | {
url: string
}
} 
    }
