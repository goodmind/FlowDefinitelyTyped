declare module "steam-totp" {
   ...
   */
  declare export function generateAuthCode(
    secret: string,
   ...
   * @returns the generated auth code
   */
  declare export function getAuthCode(
    secret: string,
    timeOffset: number | TimeOffsetFunction
  ): string;
 ...
 */
  declare export function generateConfirmationKey(
 ...
 * @returns the generated confirmation key
 */
  declare export function getConfirmationKey(
    identitySecret: Buffer | string,
    time: number,
    tag: string
  ): string;
   ...
   */
  declare export function getTimeOffset(
   ...
   */
  declare export function getDeviceID(
    steamID: string | { [key: string]: any }
  ): string;
}
