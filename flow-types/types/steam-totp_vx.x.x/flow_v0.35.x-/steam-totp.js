declare module 'steam-totp' {
        declare export type TimeOffsetFunction = () => number;
 ...
 * @returns the current local Unix time
 */
declare export function time(timeOffset?: number): number
 ...
 */
declare export function generateAuthCode(secret: string, timeOffset: number | TimeOffsetFunction): string
 ...
 * @returns the generated auth code
 */
declare export function getAuthCode(secret: string, timeOffset: number | TimeOffsetFunction): string
 ...
 */
declare export function generateConfirmationKey(identitySecret: Buffer | string, time: number, tag: string): string
 ...
 * @returns the generated confirmation key
 */
declare export function getConfirmationKey(identitySecret: Buffer | string, time: number, tag: string): string
 ...
 */
declare export function getTimeOffset(callback: (error: Error, offset?: number, elapsedTime?: number) => void): void
 ...
 */
declare export function getDeviceID(steamID: string | {[key: string]: any}): string
