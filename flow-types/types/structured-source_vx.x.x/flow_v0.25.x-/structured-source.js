declare module "structured-source" {
  ...
  declare class StructuredSource {
    ...
    locationToRange(
      loc: StructuredSource$StructuredSource$SourceLocation
    ): [number, number];
    rangeToLocation(
      range: [number, number]
    ): StructuredSource$StructuredSource$SourceLocation;
    positionToIndex(
      pos: StructuredSource$StructuredSource$SourcePosition
    ): number;
    indexToPosition(
      index: number
    ): StructuredSource$StructuredSource$SourcePosition;
  }
