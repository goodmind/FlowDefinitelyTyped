declare module "clean-css" {
  ...
  declare interface OptionsBase {
    ...
    compatibility?:
      ...
      | "ie8"
      | "ie7"
      | CleanCSS$CleanCSS$CompatibilityOptions;
    ...
    format?:
      | "beautify"
      | "keep-breaks"
      | CleanCSS$CleanCSS$FormatOptions
      | false;
     ...
     */
    level?: 0 | 1 | 2 | CleanCSS$CleanCSS$OptimizationsOptions;
   ...
   */
  declare interface CleanCSS$CompatibilityOptions {
    /**
   ...
   */
  declare interface CleanCSS$FormatOptions {
    /**
   ...
   */
  declare interface CleanCSS$OptimizationsOptions {
    1?: {
      /**
   ...
   */
  declare interface CleanCSS$Source {
    /**
     * Path to file
     */
    [path: string]: {
   ...
   */
  declare type CleanCSS$FetchCallback = (
   ...
   */
  declare type CleanCSS$Sources =
    | string
    | $ReadOnlyArray<string>
    | CleanCSS$Source
    | $ReadOnlyArray<CleanCSS$Source>
    | Buffer;

  /**
   * Union type for both types of minifier functions
   */
  declare type CleanCSS$Minifier =
    | CleanCSS$MinifierOutput
    | CleanCSS$MinifierPromise;

  /**
   * Interface exposed when a new CleanCSS object is created
   */
  declare interface CleanCSS$MinifierOutput {
    minify(
      sources: CleanCSS$Sources,
      callback?: (error: any, output: CleanCSS$Output) => void
    ): CleanCSS$Output;
    minify(
      sources: CleanCSS$Sources,
      sourceMap: string,
   ...
   */
  declare interface CleanCSS$MinifierPromise {
    minify(
      sources: CleanCSS$Sources,
      sourceMap?: string
    ): Promise<CleanCSS$Output>;
  }

  /**
   * Options when returning a promise
   */
  declare type CleanCSS$OptionsPromise = OptionsBase & {
    /**
   ...
   */
  declare type CleanCSS$OptionsOutput = OptionsBase & {
    /**
     * If you prefer clean-css to return a Promise object then you need to explicitly ask for it; defaults to `false`
     */
    returnPromise?: false
   ...
   */
  declare interface CleanCSS$Constructor {
    new(options: CleanCSS$OptionsPromise): CleanCSS$MinifierPromise;
    new(options?: CleanCSS$OptionsOutput): CleanCSS$MinifierOutput;
  }

  /**
   * Creates a new CleanCSS object which can be used to minify css
   */
  declare var CleanCSS: CleanCSS$CleanCSS$Constructor;
