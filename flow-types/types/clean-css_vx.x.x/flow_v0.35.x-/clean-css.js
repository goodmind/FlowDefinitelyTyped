...
done: (message: string | number, body: string) => void) => void,
 ...
 */
declare type CleanCSS$FetchCallback = (message: string | number, body: string) => void;


/**
 * Union of all types acceptable as input for the minify function
 */
declare type CleanCSS$Sources = string
 ...
 */
declare type CleanCSS$Minifier = CleanCSS$MinifierOutput | CleanCSS$MinifierPromise;
...
callback?: (error: any, output: CleanCSS$Output) => void): CleanCSS$Output,
minify(
sources: CleanCSS$Sources,
sourceMap: string,
callback?: (error: any, output: CleanCSS$Output) => void): CleanCSS$Output
...
minify(sources: CleanCSS$Sources, sourceMap?: string): Promise<CleanCSS$Output>
} 
...
new (options: CleanCSS$Options & {
returnPromise: true
}): CleanCSS$MinifierPromise,
new (options?: CleanCSS$Options): CleanCSS$MinifierOutput
} 
