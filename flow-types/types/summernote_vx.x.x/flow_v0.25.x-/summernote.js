...
declare type Summernote$toolbarStyleGroupOptions =
  | "style"
  | "bold"
  | "italic"
  | "underline"
...
declare type Summernote$toolbarFontGroupOptions =
  | "strikethrough"
  | "superscript"
  | "subscript";
...
declare type Summernote$toolbarDef = [
...
declare type Summernote$styleTagsOptions =
  | "p"
  | "blockquote"
  | "pre"
  | "h1"
...
declare type Summernote$popoverImageOptionsImagesize =
  | "imageSize100"
  | "imageSize50"
  | "imageSize25";

declare type Summernote$popoverImageOptionsFloat =
  | "floatLeft"
  | "floatRight"
  | "floatNone";
...
declare type Summernote$popoverImageDef = [
  ["imagesize", Summernote$popoverImageOptionsImagesize[]],
  ["float", Summernote$popoverImageOptionsFloat[]],
  ["remove", Summernote$popoverImageOptionsRemove[]]
];

declare type Summernote$popoverLinkLinkOptions = "linkDialogShow" | "unlink";

declare type Summernote$popoverLinkDef = [
  ["link", Summernote$popoverLinkLinkOptions[]]
];
...
declare type Summernote$popoverAirDef = [
  ["color", Summernote$popoverAirOptionsColor],
  ["font", Summernote$popoverAirOptionsFont],
  ["para", Summernote$popoverAirOptionsPara],
  ["table", Summernote$popoverAirOptionsTable],
  ["insert", Summernote$popoverAirOptionsInsert]
];
...
declare module "global" {
  declare interface JQuery {
    ...
    summernote(
      command: string,
      url: string,
      filename?: string | Summernote$Summernote$EditImageCallback
    ): JQuery;
    ...
    summernote(
      command: "createLink",
      options: Summernote$Summernote$CreateLinkOptions
    ): JQuery;
  }
}
