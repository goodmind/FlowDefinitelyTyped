declare module 'chartmogul-node' {
        import type {
          Map,Cursor,CursorParams,Strings,Entries,EntriesSummary
        } from './common';
...
declare function DataSource$create(config: Config, data: DataSource$DataSource): Promise<DataSource$DataSource>


declare function DataSource$retrieve(config: Config, uuid: string): Promise<DataSource$DataSource>


declare function DataSource$destroy(config: Config, uuid: string): Promise<{}>


declare function DataSource$all(
config: Config,
params?: DataSource$ListDataSourcesParams): Promise<DataSource$DataSources>
...
declare function Customer$create(config: Config, data: Customer$NewCustomer): Promise<Customer$Customer>


declare function Customer$retrieve(config: Config, uuid: string): Promise<Customer$Customer>


declare function Customer$modify(
config: Config,
uuid: string,
data: Customer$UpdateCustomer): Promise<Customer$Customer>
...
config: Config,
params?: Customer$ListCustomersParams): Promise<Entries<Customer$Customer>>


declare function Customer$search(
config: Config,
params?: Customer$SearchCustomersParams): Promise<Entries<Customer$Customer>>


declare function Customer$merge(config: Config, params?: Customer$MergeCustomersParams): Promise<{}>


declare function Customer$attributes(config: Config, uuid: string): Promise<Customer$Attributes>
...
declare function Plan$create(config: Config, data: Plan$Plan): Promise<Plan$Plan>


declare function Plan$retrieve(config: Config, uuid: string): Promise<Plan$Plan>


declare function Plan$modify(config: Config, uuid: string, data: Plan$Plan): Promise<Plan$Plan>


declare function Plan$destroy(config: Config, uuid: string): Promise<{}>


declare function Plan$all(config: Config, params?: Plan$ListPlansParams): Promise<Plan$Plans>
...
declare function Invoice$retrieve(config: Config, uuid: string): Promise<Invoice$Invoice>
...
config: Config,
uuid: string,
params?: Invoice$ListInvoicesParams): Promise<Invoice$Invoices>


declare function Invoice$all(config: Config, params?: Invoice$ListInvoicesParams): Promise<Invoice$Invoices>
...
config: Config,
uuid: string,
data: Transaction$Transaction): Promise<Transaction$Transaction>
...
config: Config,
uuid: string,
data: CursorParams): Promise<Subscription$Subscriptions>


declare function Subscription$cancel(
config: Config,
uuid: string,
data: Subscription$CancelSubscriptionParams): Promise<Subscription$Subscription>
...
config: Config,
uuid: string,
data: Tag$TagsWithEmail): Promise<Entries<Customer$Customer.Customer$Customer>>


declare function Tag$add(config: Config, uuid: string, data: Tag$Tags): Promise<Tag$Tags>


declare function Tag$remove(config: Config, uuid: string, data: Tag$Tags): Promise<Tag$Tags>
...
config: Config,
uuid: string,
data: CustomAttribute$CustomAttributes): Promise<CustomAttribute$CustomAttributes>
...
declare function Metrics$all(config: Config, params: Metrics$Params): Promise<Metrics$All>


declare function Metrics$mrr(config: Config, params: Metrics$Params): Promise<EntriesSummary<Metrics$MRR>>


declare function Metrics$arr(config: Config, params: Metrics$Params): Promise<EntriesSummary<Metrics$ARR>>


declare function Metrics$asp(config: Config, params: Metrics$Params): Promise<EntriesSummary<Metrics$ASP>>


declare function Metrics$arpa(config: Config, params: Metrics$Params): Promise<EntriesSummary<Metrics$ARPA>>


declare function Metrics$customerCount(
config: Config,
params: Metrics$Params): Promise<EntriesSummary<Metrics$CustomerCount>>


declare function Metrics$customerChurnRate(
config: Config,
params: Metrics$ParamsNoInterval): Promise<EntriesSummary<Metrics$CustomerChurnRate>>


declare function Metrics$mrrChurnRate(
config: Config,
params: Metrics$ParamsNoInterval): Promise<EntriesSummary<Metrics$MRRChurnRate>>


declare function Metrics$ltv(
config: Config,
params: Metrics$ParamsNoInterval): Promise<EntriesSummary<Metrics$LTV>>
...
config: Config,
uuid: string,
params?: CursorParams): Promise<Entries<Customer$MetricsSubscription>>


declare function Customer$activities(
config: Config,
uuid: string,
params?: CursorParams): Promise<Entries<Customer$MetricsActivity>>
