...
declare type gitconfig$callback = (error: Error | false, config: gitconfig$GitConfig) => void;
...
cb: gitconfig$gitconfig$callback): void

	declare function gitconfig(dir: string, cb: gitconfig$gitconfig$callback): void
