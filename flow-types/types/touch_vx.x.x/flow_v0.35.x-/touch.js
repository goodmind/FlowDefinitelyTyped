declare module 'touch' {
        declare function touch<T>(filename: string, cb?: (err?: NodeJS.ErrnoException) => T): Promise<T>

	declare function touch<T>(
filename: string,
options?: touch$touch$Options,
cb?: (err?: NodeJS.ErrnoException) => T): Promise<T>
...
declare function touch$ftouch<T>(fd: number, cb?: (err?: NodeJS.ErrnoException) => T): Promise<T>
