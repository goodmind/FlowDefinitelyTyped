declare module 'transliteration' {
        declare export function transliterate(str: string, options?: transliterate$slugify$Options): string
 ...
 */
declare function transliterate$config(optionsObj?: slugify$Options): slugify$Options
...
ignore?: string[]
	...
	declare export function slugify(str: string, options?: slugify$transliterate$Options): string
 ...
 * it will return current default option object.
 */
declare function slugify$config(optionsObj?: transliterate$Options): transliterate$Options
