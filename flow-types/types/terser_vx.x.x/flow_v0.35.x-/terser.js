...
ast?: boolean | AST_Toplevel
	...
	declare export function minify(files: {}, options?: MinifyOptions): MinifyOutput
...
static +Disabled: Class<InlineFunctions__Disabled> & InlineFunctions__Disabled & 0;// 0
static +SimpleFunctions: Class<InlineFunctions__SimpleFunctions> & InlineFunctions__SimpleFunctions & 1;// 1
static +WithArguments: Class<InlineFunctions__WithArguments> & InlineFunctions__WithArguments & 2;// 2
static +WithArgumentsAndVariables: Class<InlineFunctions__WithArgumentsAndVariables> & InlineFunctions__WithArgumentsAndVariables & 3;// 3
...
declare class InlineFunctions__WithArgumentsAndVariables mixins InlineFunctions {}
...
wrap_iife?: boolean
  ...
  constructor(...args: empty): mixed;
static +PreferDouble: Class<OutputQuoteStyle__PreferDouble> & OutputQuoteStyle__PreferDouble & 0;// 0
static +AlwaysSingle: Class<OutputQuoteStyle__AlwaysSingle> & OutputQuoteStyle__AlwaysSingle & 1;// 1
static +AlwaysDouble: Class<OutputQuoteStyle__AlwaysDouble> & OutputQuoteStyle__AlwaysDouble & 2;// 2
static +AlwaysOriginal: Class<OutputQuoteStyle__AlwaysOriginal> & OutputQuoteStyle__AlwaysOriginal & 3;// 3
 ...
 */
declare export function parse(code: string, options?: ParseOptions): AST_Toplevel
 ...
 */
declare export function OutputStream(options?: BeautifierOptions): OutputStream
...
stack: AST_Scope[]
	...
	declare export type visitor = (node: AST_Node, descend: () => void) => boolean | void;
