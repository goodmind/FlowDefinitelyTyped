 ...
 */
declare function client$load(name: "siteverification", version: "v1"): PromiseLike<void>


declare function client$load(name: "siteverification", version: "v1", callback: () => any): void
