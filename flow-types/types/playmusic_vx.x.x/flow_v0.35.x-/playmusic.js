...
password?: string
	...
	declare export interface LoginResponse {
androidId: string,
masterToken: string
} 
	declare export interface LibraryOptions {
limit?: number,
nextPageToken?: string
} 
	declare export interface LibraryResponse {
data?: LibraryData,
kind?: string,
nextPageToken?: string
} 
	declare export interface LibraryData {
items?: LibraryItem[]
} 
	declare export interface LibraryItem {
album?: string,
albumArtist?: string,
albumArtRef?: ArtRef[],
artist?: string,
...
year?: number
	...
	declare export interface ArtRef {
url?: string
} 
	declare export interface PlaylistListResponse {
data?: PlaylistListData,
kind?: string
} 
	declare export interface PlaylistListData {
items?: PlaylistListItem[]
} 
	declare export interface PlaylistListItem {
...
type?: string
	...
	declare export interface PlaylistOptions {
limit?: number,
nextPageToken?: string
} 
	declare export interface PlaylistResponse {
data?: PlaylistData,
kind?: string,
nextPageToken?: string
} 
	declare export interface PlaylistData {
items?: PlaylistItem[]
} 
	declare export interface PlaylistItem {
...
trackId?: string
	...
	declare export interface PlaylistTrack {
album?: string,
albumArtist?: string,
albumArtRef?: ArtRef[],
...
year?: number
	...
	declare export interface PlaylistMeta {
name?: string,
description?: string,
shareState?: string
} 
	declare export interface MutateResponses {
mutate_response?: MutateResponse[]
} 
	declare export interface MutateResponse {
client_id?: string,
id?: string,
response_code?: string
} 
	declare export default class PlayMusic  {
constructor(): this;
init(options: InitOptions, callback: (error: Error) => void): void;
login(
options: LoginOptions,
callback: (error: Error, response: LoginResponse) => void): void;
...
callback: (error: Error, response: LibraryResponse) => void): void;
...
text: string,
maxResults: number,
callback: (error: Error, searchResults: any) => void): void;
...
addPlayList(
playlistName: string,
callback: (error: Error, mutateResponses: MutateResponses) => void): void;
...
deletePlaylist(
playlistId: string,
callback: (error: Error, mutationStatus: MutateResponses) => void): void;
...
callback: (error: Error, response: PlaylistResponse) => void): void
}
    }
