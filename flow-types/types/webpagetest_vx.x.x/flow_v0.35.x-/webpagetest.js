declare module 'webpagetest' {
        declare interface Response<R> {
data: R,
statusCode: number,
statusText: string
} 
	declare type Callback<R> = (err: Error | void, data: R | void, info: any) => void;
	declare type TestScript = TestScriptCommand[];
	declare type TestScriptCommand = string | {
...
lighthouse?: boolean
	...
	declare interface ResultsOptions {
...
documentComplete?: boolean
	...
	declare interface WaterfallOptions {
...
cert?: string
	...
	declare interface WebPageTest$Location {
id: string,
Label: string,
location: string,
Browsers: string,
...
declare interface WebPageTest$TestStatus {
statusCode: number,
statusText: string,
id: string,
testInfo: WebPageTest$TestInfo,
testId: string,
runs: number,
fvonly: number,
remote: false,
...
declare interface WebPageTest$TestInfo {
url: string,
runs: number,
fvonly: number,
web10: number,
...
declare interface WebPageTest$TestResult {
id: string,
url: string,
summary: string,
testUrl: string,
...
testerDNS: string,
runs: {
[key: string]: WebPageTest$TestRun
},
fvonly: boolean,
successfulFVRuns: number,
average: WebPageTest$TestRun,
standardDeviation: WebPageTest$TestRun,
median: WebPageTest$TestRun
} 

declare interface WebPageTest$TestRun {
firstView: any
} 
 ...
 */
constructor(server?: string, key?: string): this;
static scriptToString(script: TestScript): string;
getTestStatus(
id: string,
options: Options & RequestOptions,
callback: Callback<Response<WebPageTest$WebPageTest$TestStatus>>): void;
getTestStatus(
id: string,
callback: Callback<Response<WebPageTest$WebPageTest$TestStatus>>): void;
getTestResults(
...
callback: Callback<Response<WebPageTest$WebPageTest$TestResult>>): void;
getTestResults(
id: string,
callback: Callback<Response<WebPageTest$WebPageTest$TestResult>>): void;
getLocations(
...
callback: Callback<{
response: Response<{
location: WebPageTest$WebPageTest$Location[]
}>
}>): void;
getLocations(
callback: Callback<{
...
scriptToString(script: TestScript): string
	...
	declare module.exports: typeof WebPageTest
