declare module "webpagetest" {
  ...
  declare type Callback<R> = (
    err: Error | void,
    data: R | void,
    info: any
  ) => void;
  declare type TestScript = TestScriptCommand[];
  declare type TestScriptCommand =
    | string
    | {
  ...
  declare class WebPageTest {
    ...
    getTestStatus(
      ...
      callback: Callback<Response<WebPageTest$WebPageTest$TestStatus>>
    ): void;
    getTestStatus(
      id: string,
      callback: Callback<Response<WebPageTest$WebPageTest$TestStatus>>
    ...
    getTestResults(
      ...
      callback: Callback<Response<WebPageTest$WebPageTest$TestResult>>
    ): void;
    getTestResults(
      id: string,
      callback: Callback<Response<WebPageTest$WebPageTest$TestResult>>
