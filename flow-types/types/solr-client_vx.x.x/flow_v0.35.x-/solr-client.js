...
docs: {[key: string]: any}[],
options?: Options,
callback?: (err: Error, data: {[key: string]: any}) => void): ClientRequest,
realTimeGet(
ids: string | string[],
query?: Query,
callback?: (err: Error, data: {[key: string]: any}) => void): ClientRequest,
...
options?: Options,
callback?: (err: Error, data: {[key: string]: any}) => void): ClientRequest,
prepareCommit(callback?: (err: Error, data: {[key: string]: any}) => void): ClientRequest,
softCommit(callback?: (err: Error, data: {[key: string]: any}) => void): ClientRequest,
delete(
field: string,
text: string,
options?: Options,
...
options: {[key: string]: any},
callback?: (err: Error, data: {[key: string]: any}) => void): ClientRequest,
rollback(callback?: (err: Error, data: {[key: string]: any}) => void): ClientRequest,
update(
data: {[key: string]: any},
options?: {[key: string]: any},
callback?: (err: Error, data: {[key: string]: any}) => void): ClientRequest,
...
callback?: (err: Error, data: {[key: string]: any}) => void): ClientRequest,
searchAll(callback?: (err: Error, data: {[key: string]: any}) => void): ClientRequest,
get(
handler: string,
