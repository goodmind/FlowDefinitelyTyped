declare module "wiiu" {
  ...
  declare class wiiu$TPValidity {
    ...
    static +X_INVALID: Class<wiiu$TPValidity__X_INVALID> &
      wiiu$TPValidity__X_INVALID &
      1; // 1
    static +Y_INVALID: Class<wiiu$TPValidity__Y_INVALID> &
      wiiu$TPValidity__Y_INVALID &
      2; // 2
    static +INVALID: Class<wiiu$TPValidity__INVALID> &
      wiiu$TPValidity__INVALID &
      3; // 3
  }
  ...
  declare class wiiu$Button {
    ...
    static +R_STICK: Class<wiiu$Button__R_STICK> &
      wiiu$Button__R_STICK &
      131072; // 131072
    static +L_STICK: Class<wiiu$Button__L_STICK> &
      wiiu$Button__L_STICK &
      262144; // 262144
    static +R_STICK_DOWN: Class<wiiu$Button__R_STICK_DOWN> &
      wiiu$Button__R_STICK_DOWN &
      8388608; // 8388608
    static +R_STICK_UP: Class<wiiu$Button__R_STICK_UP> &
      wiiu$Button__R_STICK_UP &
      16777216; // 16777216
    static +R_STICK_RIGHT: Class<wiiu$Button__R_STICK_RIGHT> &
      wiiu$Button__R_STICK_RIGHT &
      33554432; // 33554432
    static +R_STICK_LEFT: Class<wiiu$Button__R_STICK_LEFT> &
      wiiu$Button__R_STICK_LEFT &
      67108864; // 67108864
    static +L_STICK_DOWN: Class<wiiu$Button__L_STICK_DOWN> &
      wiiu$Button__L_STICK_DOWN &
      134217728; // 134217728
    static +L_STICK_UP: Class<wiiu$Button__L_STICK_UP> &
      wiiu$Button__L_STICK_UP &
      268435456; // 268435456
    static +L_STICK_RIGHT: Class<wiiu$Button__L_STICK_RIGHT> &
      wiiu$Button__L_STICK_RIGHT &
      536870912; // 536870912
    static +L_STICK_LEFT: Class<wiiu$Button__L_STICK_LEFT> &
      wiiu$Button__L_STICK_LEFT &
  ...
  declare class wiiu$ImageViewErrorCode {
    constructor(...args: empty): mixed;
    static +UNSUPPORTED_FORMAT: Class<wiiu$ImageViewErrorCode__UNSUPPORTED_FORMAT> &
      wiiu$ImageViewErrorCode__UNSUPPORTED_FORMAT &
      202; // 202
    static +DIMENSIONS_TOO_LARGE: Class<wiiu$ImageViewErrorCode__DIMENSIONS_TOO_LARGE> &
      wiiu$ImageViewErrorCode__DIMENSIONS_TOO_LARGE &
      203; // 203
    static +FILE_SIZE_TOO_LARGE: Class<wiiu$ImageViewErrorCode__FILE_SIZE_TOO_LARGE> &
      wiiu$ImageViewErrorCode__FILE_SIZE_TOO_LARGE &
      204; // 204
    static +TOO_MANY_PIXELS_PROGRESSIVE_JPEG: Class<wiiu$ImageViewErrorCode__TOO_MANY_PIXELS_PROGRESSIVE_JPEG> &
      wiiu$ImageViewErrorCode__TOO_MANY_PIXELS_PROGRESSIVE_JPEG &
      205; // 205
  }

  declare class wiiu$ImageViewErrorCode__UNSUPPORTED_FORMAT
    mixins wiiu$ImageViewErrorCode {}
  declare class wiiu$ImageViewErrorCode__DIMENSIONS_TOO_LARGE
    mixins wiiu$ImageViewErrorCode {}
  declare class wiiu$ImageViewErrorCode__FILE_SIZE_TOO_LARGE
    mixins wiiu$ImageViewErrorCode {}
  declare class wiiu$ImageViewErrorCode__TOO_MANY_PIXELS_PROGRESSIVE_JPEG
    mixins wiiu$ImageViewErrorCode {}
