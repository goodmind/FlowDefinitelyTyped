declare module 'knuddels-userapps-api' {
        declare export type JsonData = string
| number
| boolean
| Date
| Json
| JsonArray
| void;
	declare export type KnuddelsJsonData = string
| number
| boolean
| Date
| KnuddelsJson
...
| void;
	declare export type KnuddelsSerializable = string
| number
| boolean
| User
| BotUser
| void;
	declare export type KnuddelsEvent = string | Json | KnuddelsEventArray;
	declare module 'global' {
        declare interface Json {
[x: string]: JsonData | void
} 
	declare interface KnuddelsJson {
[x: string]: KnuddelsJsonData | void
} 
	declare type JsonArray = {} & Array<JsonData>

	declare type KnuddelsJsonArray = {} & Array<KnuddelsJsonData>

	declare type KnuddelsEventArray = {} & Array<string | Json | KnuddelsEventArray>
...
knuddelAccount: KnuddelAccount): void,
...
newKnuddelAmount: KnuddelAmount): void,
 ...
 */
declare class AppPersistence mixins Persistence {
 ...
 */
declare class AppServerInfo mixins ServerInfo {}
 ...
 */
static dispatchEvent(event: Client$Client$Event): void;
 ...
 */
static getHostFrame(): Client$Client$HostFrame;
...
declare class Client$Event  {

/**
 * @see https://developer.knuddels.de/docs/classes/Client.Event.html#method_Event
 */
constructor(type: string, data: KnuddelsEvent): this
}

declare class Client$HostFrame  {
 ...
 */
setBackgroundColor(newColor: Client$Color, durationMillis?: number): void;
 ...
 */
static fromRGBA(red: number, green: number, blue: number, alpha: number): Client$Color;
 ...
 */
static fromNumber(value: number): Client$Color
}
 ...
 */
constructor(count: number, value: number): this;
 ...
 */
constructor(assetPath: string, pageData?: Json): this;
 ...
 */
constructor(knuddel: number): this;
 ...
 */
setBackgroundColor(color: Client$Color): void;
 ...
 */
setForegroundColor(color: Client$Color): void;
...
setObject(
key: string,
object: (KnuddelsJson | KnuddelsJsonArray | KnuddelsSerializable)): void;
...
getObject(
key: string,
defaultValue?: (KnuddelsJson | KnuddelsJsonArray | KnuddelsSerializable)): (KnuddelsJson | KnuddelsJsonArray | KnuddelsSerializable);
 ...
 */
declare class PrivateMessage mixins Message {
 ...
 */
declare class PublicActionMessage mixins Message {}
	
/**
 * @see https://developer.knuddels.de/docs/classes/PublicEventMessage.html
 */
declare class PublicEventMessage mixins Message {}
	
/**
 * @see https://developer.knuddels.de/docs/classes/PublicMessage.html
 */
declare class PublicMessage mixins Message {}
 ...
 */
static nextInt(minValue: number, maxValue: number): number;
...
maxValue: number,
count: number,
onlyDifferentNumbers: boolean): number[];
 ...
 */
declare class RootAppInstance mixins AppInstance {

/**
 * @see https://developer.knuddels.de/docs/classes/RootAppInstance.html#method_updateApp
 */
updateApp(message: string, logMessage?: string): number;
 ...
 */
stopApp(message: string, logMessage?: string): void
}
...
abbreviationMarker?: string): string,
 ...
 */
declare class UserPersistence mixins Persistence {
