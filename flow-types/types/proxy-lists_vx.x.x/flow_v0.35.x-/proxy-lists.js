declare module 'proxy-lists' {
	...
	declare export function getProxies(options?: $Shape<Options>): GetProxiesEventEmitter

	declare export function getProxiesFromSource(name: string, options?: Options): GetProxiesEventEmitter
