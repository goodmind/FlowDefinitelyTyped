...
set(propertyName: string, value: PropertiesReader$Value): PropertiesReader$Reader,
length: number,
each(
iterator: (key: string, value: PropertiesReader$Value) => void): PropertiesReader$Reader,
each<T>(
iterator: (key: string, value: PropertiesReader$Value) => void,
scope: T): PropertiesReader$Reader,
getAllProperties(): {
[key: string]: PropertiesReader$Value
},
clone(): PropertiesReader$Reader
} 
	declare function PropertiesReader(path: string): PropertiesReader$PropertiesReader$Reader
