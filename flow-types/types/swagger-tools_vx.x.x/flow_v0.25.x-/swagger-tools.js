declare module "swagger-tools" {
  ...
  declare export type SwaggerRouter12HandlerFunction = (
  ...
  declare export type SwaggerSecurityCallback = (
    err?: SwaggerSecurityError
  ) => void;
  ...
  declare export type InitializeMiddlewareCallback12 = (
    middleware: Middleware12
  ) => void;
  declare export type InitializeMiddlewareCallback20 = (
