declare module 'cbor' {
	...
	declare export function decodeAll(input: Buffer | string, callback: (error: any, objs: any[]) => void): void

	declare export function decodeAllSync(input: Buffer | string): any[]

	declare export function decodeFirst(input: Buffer | string, callback: (error: any, obj: any) => void): void
...
addSemanticType<T>(
type: (...args: any[]) => T,
encodeFunction: (encoder: Encoder, t: T) => void): void;
