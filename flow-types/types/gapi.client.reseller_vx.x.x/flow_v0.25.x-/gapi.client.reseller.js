declare module "gapi.client.reseller" {
  ...
  declare var npm$namespace$gapi$client: {
    ...
    customers: typeof gapi$client$customers,
    resellernotify: typeof gapi$client$resellernotify,
  ...
  declare var gapi$client$customers: reseller$CustomersResource;

  declare var gapi$client$resellernotify: reseller$ResellernotifyResource;

  declare var gapi$client$subscriptions: reseller$SubscriptionsResource;

  declare interface gapi$client$reseller$Address {
    /**
  ...
  declare interface gapi$client$reseller$ChangePlanRequest {
    /**
  ...
  declare interface gapi$client$reseller$Customer {
    /**
     ...
     */
    postalAddress?: gapi$client$reseller$Address;
  ...
  declare interface gapi$client$reseller$RenewalSettings {
    /**
  ...
  declare interface gapi$client$reseller$ResellernotifyGetwatchdetailsResponse {
    /**
  ...
  declare interface gapi$client$reseller$ResellernotifyResource {
    /**
     * Topic name of the PubSub
     */
    topicName?: string;
    ...
    getwatchdetails(request: {
       ...
       */
      userIp?: string
    }): Request<gapi$client$reseller$ResellernotifyGetwatchdetailsResponse>;
    ...
    register(request: {
       ...
       */
      userIp?: string
    }): Request<gapi$client$reseller$ResellernotifyResource>;
  ...
  declare interface gapi$client$reseller$Seats {
    /**
  ...
  declare interface gapi$client$reseller$Subscription {
    /**
     ...
     */
    renewalSettings?: gapi$client$reseller$RenewalSettings;
     ...
     */
    seats?: gapi$client$reseller$Seats;
  ...
  declare interface gapi$client$reseller$Subscriptions {
    /**
     ...
     */
    subscriptions?: gapi$client$reseller$Subscription[];
  }

  declare interface gapi$client$reseller$CustomersResource {
    /**
    ...
    get(request: {
       ...
       */
      userIp?: string
    }): Request<gapi$client$reseller$Customer>;
  ...
  declare interface gapi$client$reseller$SubscriptionsResource {
    /**
    ...
    activate(request: {
       ...
       */
      userIp?: string
    }): Request<gapi$client$reseller$Subscription>;
    ...
    list(request: {
       ...
       */
      userIp?: string
    }): Request<gapi$client$reseller$Subscriptions>;
