declare module 'gapi.client.reseller' {
      ...
      declare var npm$namespace$client: {
        ...
        customers: typeof client$customers,
resellernotify: typeof client$resellernotify,
 ...
 */
declare function client$load(name: "reseller", version: "v1"): PromiseLike<void>


declare function client$load(name: "reseller", version: "v1", callback: () => any): void


declare var client$customers: reseller$reseller$CustomersResource;

declare var client$resellernotify: reseller$reseller$ResellernotifyResource;

declare var client$subscriptions: reseller$reseller$SubscriptionsResource;

declare interface reseller$Address {
...
declare interface reseller$ChangePlanRequest {
...
declare interface reseller$Customer {
 ...
 */
postalAddress?: reseller$Address,
...
declare interface reseller$RenewalSettings {
...
declare interface reseller$ResellernotifyGetwatchdetailsResponse {
...
declare interface reseller$ResellernotifyResource {
 ...
 */
userIp?: string
}): Request<reseller$ResellernotifyGetwatchdetailsResponse>,
 ...
 */
userIp?: string
}): Request<reseller$ResellernotifyResource>,
...
declare interface reseller$Seats {
...
declare interface reseller$Subscription {
 ...
 */
renewalSettings?: reseller$RenewalSettings,
...
declare interface reseller$Subscriptions {
 ...
 */
client$subscriptions?: reseller$Subscription[]
} 

declare interface reseller$CustomersResource {
...
declare interface reseller$SubscriptionsResource {
 ...
 */
userIp?: string
}): Request<reseller$Subscriptions>,
