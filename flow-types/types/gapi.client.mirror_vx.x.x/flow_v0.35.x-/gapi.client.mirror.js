 ...
 */
declare function client$load(name: "mirror", version: "v1"): PromiseLike<void>


declare function client$load(name: "mirror", version: "v1", callback: () => any): void
