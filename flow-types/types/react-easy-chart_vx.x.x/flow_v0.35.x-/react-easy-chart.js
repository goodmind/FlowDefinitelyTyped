...
yTickNumber?: number
	...
	declare class BarChart mixins React.Component<BarChartProps> {}
	declare interface PieData {
key: string,
value: number,
color?: string
} 
...
size?: number,
styles?: {
[cssSelector: string]: React.CSSProperties
}
} 
	declare class PieChart mixins React.Component<PieChartProps> {}
...
yType?: "time" | "text" | "linear"
	...
	declare class LineChart mixins React.Component<LineChartProps> {}
	declare type AreaChartProps = {
...
noAreaGradient?: boolean
	...
	declare class AreaChart mixins React.Component<AreaChartProps> {}
	declare interface ScatterplotData {
type: string | number,
x: number | Date | string,
y: number | Date | string,
z?: number
} 
	declare interface ScatterplotChartProps {
...
yType?: "time" | "text" | "linear"
	...
	declare class ScatterplotChart mixins React.Component<ScatterplotChartProps> {}
...
[cssSelector: string]: React.CSSProperties
	...
	declare class Legend mixins React.Component<LegendProps> {}
    }
