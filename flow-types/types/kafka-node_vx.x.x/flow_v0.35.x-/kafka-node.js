...
constructor(connectionString: string, clientId?: string, options?: ZKOptions, noBatchOptions?: AckBatchOptions, sslOptions?: any): this;
close(cb?: () => void): void;
loadMetadataForTopics(
topics: string[],
cb: (error: TopicsNotExistError | any, data: any) => any): void;
...
constructor(client: Client, options?: ProducerOptions, customPartitioner?: CustomPartitioner): this;
...
constructor(client: Client, fetchRequests: Array<OffsetFetchRequest | string>, options: ConsumerOptions): this;
client: Client;
...
constructor(client: Client, payloads: Topic[], options: HighLevelConsumerOptions): this;
client: Client;
on(eventName: "message", cb: (message: Message) => any): void;
on(eventName: "error" | "offsetOutOfRange", cb: (error: any) => any): void;
...
addTopics(
topics: string[] | Topic[],
cb?: (error: any, added: string[] | Topic[]) => any): void;
removeTopics(topics: string | string[], cb: (error: any, removed: number) => any): void;
commit(cb: (error: any, data: any) => any): void;
commit(force: boolean, cb: (error: any, data: any) => any): void;
...
topicPattern: any,
groupMembers: any,
cb: (error: any, result: any) => void): void
} 
...
topics: string | string[]
	...
	declare export type CustomPartitioner = (partitions: number[], key: any) => number;
    }
