 ...
 * @param time An optional time in milliseconds relative to which the delay is calculated (default = now).
 */
declare export function timer(callback: (elapsed: number) => void, delay?: number, time?: number): Timer

	
/**
 * Immediately invoke any eligible timer callbacks.
 */
declare export function timerFlush(): void
 ...
 * @param time An optional time in milliseconds relative to which the delay is calculated (default = now).
 */
declare export function timeout(callback: (elapsed: number) => void, delay?: number, time?: number): Timer
 ...
 */
declare export function interval(callback: (elapsed: number) => void, delay?: number, time?: number): Timer
