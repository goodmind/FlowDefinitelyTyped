declare module 'webpack-env' {
        declare interface __WebpackModuleApi$RequireContext {
keys(): string[],
(id: string): any,
(id: string): T,
...
declare interface __WebpackModuleApi$RequireFunction {
...
| "weak"
| "lazy"
| "lazy-once"): __WebpackModuleApi$RequireContext,
...
declare interface __WebpackModuleApi$Module {
exports: any,
...
declare type __WebpackModuleApi$ModuleId = string | number;

declare interface __WebpackModuleApi$Hot {
...
accept(
dependencies: string[],
callback: (updatedDependencies: __WebpackModuleApi$ModuleId[]) => void): void,
...
check(
autoApply: boolean,
callback: (err: Error, outdatedModules: __WebpackModuleApi$ModuleId[]) => void): void,
 ...
 */
apply(
options: __WebpackModuleApi$AcceptOptions,
callback: (err: Error, outdatedModules: __WebpackModuleApi$ModuleId[]) => void): void,
...
declare interface __WebpackModuleApi$AcceptOptions {
 ...
 */
declare interface __WebpackModuleApi$NodeProcess {
env?: any
} 

declare type __WebpackModuleApi$__Require1 = (id: string) => any;

declare type __WebpackModuleApi$__Require2 = <T>(id: string) => T;

declare type __WebpackModuleApi$RequireLambda = __WebpackModuleApi$__Require1 & __WebpackModuleApi$__Require2;
	declare type NodeRequire = {} & __WebpackModuleApi$__WebpackModuleApi$RequireFunction
...
chunkId: any,
callback: (require: __WebpackModuleApi$__WebpackModuleApi$RequireLambda) => void) => void;
...
declare var DEBUG: boolean;
	declare type NodeModule = {} & __WebpackModuleApi$__WebpackModuleApi$Module

	declare var module: NodeModule;
	declare type NodeJS$Process = {} & __WebpackModuleApi$__WebpackModuleApi$NodeProcess
