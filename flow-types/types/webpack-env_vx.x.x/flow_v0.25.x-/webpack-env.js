declare module "webpack-env" {
  ...
  declare interface __WebpackModuleApi$Hot {
    ...
    accept(
      dependencies: string[],
      callback: (updatedDependencies: __WebpackModuleApi$ModuleId[]) => void
    ): void;
    ...
    check(
      ...
      callback: (
        err: Error,
        outdatedModules: __WebpackModuleApi$ModuleId[]
      ) => void
    ): void;
  ...
  declare type __WebpackModuleApi$RequireLambda = __WebpackModuleApi$__Require1 &
    __WebpackModuleApi$__Require2;
  ...
  declare var __webpack_chunk_load__: (
    chunkId: any,
    callback: (
      require: __WebpackModuleApi$__WebpackModuleApi$RequireLambda
    ) => void
  ) => void;
