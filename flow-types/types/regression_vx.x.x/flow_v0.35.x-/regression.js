 ...
 * [x, y]
 */
declare export type DataPoint = [number, number];
...
r2: number
	...
	declare export function _round(number: number, precision: number): number

	declare export function linear(data: $ReadOnlyArray<DataPoint>, options?: Options): Result

	declare export function exponential(data: $ReadOnlyArray<DataPoint>, options?: Options): Result

	declare export function logarithmic(data: $ReadOnlyArray<DataPoint>, options?: Options): Result

	declare export function power(data: $ReadOnlyArray<DataPoint>, options?: Options): Result

	declare export function polynomial(data: $ReadOnlyArray<DataPoint>, options?: Options): Result
