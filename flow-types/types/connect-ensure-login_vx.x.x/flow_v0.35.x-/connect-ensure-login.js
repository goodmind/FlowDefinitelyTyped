declare module 'connect-ensure-login' {
	...
	declare export interface LoggedInOptions {
...
setRedirectTo?: boolean
	...
	declare export interface LoggedOutOptions {
 ...
 *        function(req, res) { ... });
 */
declare export function ensureLoggedIn(options?: LoggedInOptions | string): RequestHandler
 ...
 *        function(req, res) { ... });
 */
declare export function ensureLoggedOut(options?: LoggedOutOptions | string): RequestHandler
