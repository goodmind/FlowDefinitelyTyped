declare module "snappy" {
  ...
  declare export type bufferCallback = (
    err: Error | null,
    data: Buffer
  ) => void;
  declare export type bufferOrStringCallback = (
    err: Error | null,
    data: Buffer | string
  ) => void;
  declare export type booleanCallback = (
    err: Error | null,
    data: boolean
  ) => void;
  ...
  declare export function uncompress(
    ...
    callback: bufferOrStringCallback
  ): void;

  declare export function uncompressSync(buffer: Buffer): Buffer;

  declare export function uncompressSync(
    buffer: Buffer,
    options: SnappyDecompressOpts
  ): Buffer | string;

  declare export function isValidCompressed(
    buffer: Buffer,
