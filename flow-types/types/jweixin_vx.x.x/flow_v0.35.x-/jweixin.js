...
declare type wx$ApiMethod = "onMenuShareTimeline"
...
declare type wx$menuBase = "menuItem:exposeArticle"
| "menuItem:setFont"
| "menuItem:dayMode"
| "menuItem:nightMode"
| "menuItem:refresh"
...
declare type wx$menuShare = "menuItem:share:appMessage"
...
declare type wx$menuProtected = "menuItem:editTag"
| "menuItem:delete"
| "menuItem:copyUrl"
| "menuItem:originPage"
| "menuItem:readMode"
...
declare type wx$menuList = Array<wx$menuBase | wx$menuProtected | wx$menuShare>;

declare function wx$config(
conf: {
debug?: boolean,
appId: string,
timestamp: number,
...
declare function wx$error(fn: (err: {
errMsg: string
}) => void): void
 ...
 */
declare function wx$onMenuShareTimeline(params: wx$IonMenuShareTimeline): void
 ...
 */
declare function wx$onMenuShareAppMessage(params: wx$IonMenuShareAppMessage): void
 ...
 * 跳转微信商品页接口
 */
declare function wx$openProductSpecificView(params: wx$IopenProductSpecificView): void
 ...
 * 核销后再次赠送卡券接口
 */
declare function wx$consumeAndShareCard(params: wx$IconsumeAndShareCard): void
