declare class intlTelInputUtils$numberFormat {
  ...
  static +E164: Class<intlTelInputUtils$numberFormat__E164> &
    intlTelInputUtils$numberFormat__E164 &
    0; // 0
  static +INTERNATIONAL: Class<intlTelInputUtils$numberFormat__INTERNATIONAL> &
    intlTelInputUtils$numberFormat__INTERNATIONAL &
    1; // 1
  static +NATIONAL: Class<intlTelInputUtils$numberFormat__NATIONAL> &
    intlTelInputUtils$numberFormat__NATIONAL &
    2; // 2
  static +RFC3966: Class<intlTelInputUtils$numberFormat__RFC3966> &
    intlTelInputUtils$numberFormat__RFC3966 &
    3; // 3
}

declare class intlTelInputUtils$numberFormat__E164
  mixins intlTelInputUtils$numberFormat {}
declare class intlTelInputUtils$numberFormat__INTERNATIONAL
  mixins intlTelInputUtils$numberFormat {}
declare class intlTelInputUtils$numberFormat__NATIONAL
  mixins intlTelInputUtils$numberFormat {}
declare class intlTelInputUtils$numberFormat__RFC3966
  mixins intlTelInputUtils$numberFormat {}

declare class intlTelInputUtils$numberType {
  constructor(...args: empty): mixed;
  static +FIXED_LINE: Class<intlTelInputUtils$numberType__FIXED_LINE> &
    intlTelInputUtils$numberType__FIXED_LINE &
    0; // 0
  static +MOBILE: Class<intlTelInputUtils$numberType__MOBILE> &
    intlTelInputUtils$numberType__MOBILE &
    1; // 1
  static +FIXED_LINE_OR_MOBILE: Class<intlTelInputUtils$numberType__FIXED_LINE_OR_MOBILE> &
    intlTelInputUtils$numberType__FIXED_LINE_OR_MOBILE &
    2; // 2
  static +TOLL_FREE: Class<intlTelInputUtils$numberType__TOLL_FREE> &
    intlTelInputUtils$numberType__TOLL_FREE &
    3; // 3
  static +PREMIUM_RATE: Class<intlTelInputUtils$numberType__PREMIUM_RATE> &
    intlTelInputUtils$numberType__PREMIUM_RATE &
    4; // 4
  static +SHARED_COST: Class<intlTelInputUtils$numberType__SHARED_COST> &
    intlTelInputUtils$numberType__SHARED_COST &
    5; // 5
  static +VOIP: Class<intlTelInputUtils$numberType__VOIP> &
    intlTelInputUtils$numberType__VOIP &
    6; // 6
  static +PERSONAL_NUMBER: Class<intlTelInputUtils$numberType__PERSONAL_NUMBER> &
    intlTelInputUtils$numberType__PERSONAL_NUMBER &
    7; // 7
  static +PAGER: Class<intlTelInputUtils$numberType__PAGER> &
    intlTelInputUtils$numberType__PAGER &
    8; // 8
  static +UAN: Class<intlTelInputUtils$numberType__UAN> &
    intlTelInputUtils$numberType__UAN &
    9; // 9
  static +VOICEMAIL: Class<intlTelInputUtils$numberType__VOICEMAIL> &
    intlTelInputUtils$numberType__VOICEMAIL &
    10; // 10
  static +UNKNOWN: Class<intlTelInputUtils$numberType__UNKNOWN> &
    intlTelInputUtils$numberType__UNKNOWN &
    -1; // -1
}

declare class intlTelInputUtils$numberType__FIXED_LINE
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__MOBILE
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__FIXED_LINE_OR_MOBILE
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__TOLL_FREE
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__PREMIUM_RATE
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__SHARED_COST
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__VOIP
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__PERSONAL_NUMBER
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__PAGER
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__UAN
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__VOICEMAIL
  mixins intlTelInputUtils$numberType {}
declare class intlTelInputUtils$numberType__UNKNOWN
  mixins intlTelInputUtils$numberType {}

declare class intlTelInputUtils$validationError {
  constructor(...args: empty): mixed;
  static +IS_POSSIBLE: Class<intlTelInputUtils$validationError__IS_POSSIBLE> &
    intlTelInputUtils$validationError__IS_POSSIBLE &
    0; // 0
  static +INVALID_COUNTRY_CODE: Class<intlTelInputUtils$validationError__INVALID_COUNTRY_CODE> &
    intlTelInputUtils$validationError__INVALID_COUNTRY_CODE &
    1; // 1
  static +TOO_SHORT: Class<intlTelInputUtils$validationError__TOO_SHORT> &
    intlTelInputUtils$validationError__TOO_SHORT &
    2; // 2
  static +TOO_LONG: Class<intlTelInputUtils$validationError__TOO_LONG> &
    intlTelInputUtils$validationError__TOO_LONG &
    3; // 3
  static +NOT_A_NUMBER: Class<intlTelInputUtils$validationError__NOT_A_NUMBER> &
    intlTelInputUtils$validationError__NOT_A_NUMBER &
    4; // 4
}

declare class intlTelInputUtils$validationError__IS_POSSIBLE
  mixins intlTelInputUtils$validationError {}
declare class intlTelInputUtils$validationError__INVALID_COUNTRY_CODE
  mixins intlTelInputUtils$validationError {}
declare class intlTelInputUtils$validationError__TOO_SHORT
  mixins intlTelInputUtils$validationError {}
declare class intlTelInputUtils$validationError__TOO_LONG
  mixins intlTelInputUtils$validationError {}
declare class intlTelInputUtils$validationError__NOT_A_NUMBER
  mixins intlTelInputUtils$validationError {}
...
declare type intlTelInputUtils$placeholderNumberType =
...
declare module "global" {
  declare interface Window {
    ...
    intlTelInput(
      node: Element,
      options?: IntlTelInput$IntlTelInput$Options
...
declare interface IntlTelInput$Plugin {
   ...
   */
  getNumber(
    intlTelInputUtils$numberFormat?: intlTelInputUtils$intlTelInputUtils$numberFormat
  ): string;
  ...
  setPlaceholderNumberType(
    type: intlTelInputUtils$intlTelInputUtils$placeholderNumberType
  ): void;
}
...
declare interface IntlTelInput$JQueryPlugin {
  ...
  ): intlTelInputUtils$intlTelInputUtils$CountryData;
  ...
  ): intlTelInputUtils$intlTelInputUtils$validationError;
...
declare interface IntlTelInput$Options {
  ...
  customPlaceholder?: (
    ...
    selectedCountryData: intlTelInputUtils$intlTelInputUtils$CountryData
  ) => string;
