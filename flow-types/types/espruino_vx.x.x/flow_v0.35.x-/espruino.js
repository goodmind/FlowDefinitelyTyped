...
removeListener(event: string, listener: any): any
	...
	declare module 'Wifi' {
        declare function connect(ssid: string, options: any, callback: (err: any) => any): any

	declare function startAP(ssid: string, options: any, callback: (err: any) => any): any
	...
	declare function write(data: string): any
 ...
 */
declare function E$interpolate2d(array: any, width: number, x: number, y: number): number
 ...
 */
declare function AES$encrypt(passphrase: any, key: any, options: any): ArrayBuffer
 ...
 */
declare function AES$decrypt(passphrase: any, key: any, options: any): ArrayBuffer
 ...
 */
declare function Trig$setTrigger(num: number, pos: number, pins: any, pulseLength: number): void
