declare module 'overwatch-api' {
	...
	declare export type OverwatchServerRegion = "us"
| "eu"
| "kr"
| "cn"
| "global";
	declare export type OverwatchHero = "Zarya"
| "Mercy"
| "Reinhardt"
| "Zenyatta"
| "Hanzo"
...
tag: string,
callback: callbackFunc<ProfileApiResponse>): void

	declare export function getStats(
platform: OverwatchPlatform,
region: OverwatchServerRegion,
tag: string,
callback: callbackFunc<StatsApiResponse>): void
...
declare function owl$getLiveMatch(callback: callbackFunc<owl$ApiResponse<owl$LiveMatchData>>): void


declare function owl$getStandings(callback: callbackFunc<owl$ApiResponse<owl$TeamStandingInfo[]>>): void


declare function owl$getSchedule(callback: callbackFunc<owl$ApiResponse<owl$ScheduleInfo>>): void
