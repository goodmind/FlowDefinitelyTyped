...
declare module "simmerjs" {
  declare export interface Simmer {
    /**
   ...
   * configuration.
   */
  declare export type QueryEngine = (
    selector: string,
  ...
  declare export interface WindowLike {
    document: Queryable;
  }
   ...
   */
  declare export type Scope = Queryable | WindowLike;
  ...
  declare interface SimmerConstructor {
    /**
  ...
  declare var Simmer: SimmerConstructor;
  declare export default typeof Simmer;
}
