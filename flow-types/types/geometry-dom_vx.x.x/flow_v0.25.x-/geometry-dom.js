declare module "geometry-dom" {
  declare export interface GeometryDom$DOMPointReadOnly {
     ...
     */
    matrixTransform(
      matrix: GeometryDom$DOMMatrixReadOnly
    ): GeometryDom$DOMPoint;
  }
  ...
  declare var GeometryDom$DOMPointReadOnly: {
    ...
    new(
      ...
      z: number,
      w: number
    ): GeometryDom$GeometryDom$DOMPointReadOnly
  };
  declare var GeometryDom$DOMPoint: {
    ...
    new(
      ...
      z?: number,
      w?: number
    ): GeometryDom$GeometryDom$DOMPoint
  };
  ...
  declare var GeometryDom$DOMRect: {
    ...
    new(
      ...
      width: number,
      height: number
    ): GeometryDom$GeometryDom$DOMRect
  };
  declare var GeometryDom$DOMRectReadOnly: {
    ...
    new(
      ...
      width: number,
      height: number
    ): GeometryDom$GeometryDom$DOMRectReadOnly
  };
  ...
  declare var GeometryDom$DOMQuad: {
    ...
    new(
      ...
      p3?: DOMPointInit,
      p4?: DOMPointInit
    ): GeometryDom$GeometryDom$DOMQuad
  };
  declare var GeometryDom$DOMMatrixReadOnly: {
    prototype: GeometryDom$GeometryDom$DOMMatrixReadOnly,
    new(
      numberSequence: Array<number>
    ): GeometryDom$GeometryDom$DOMMatrixReadOnly
  };
  declare var GeometryDom$DOMMatrix: {
    ...
    new(
      other: GeometryDom$GeometryDom$DOMMatrixReadOnly
    ): GeometryDom$GeometryDom$DOMMatrix,
