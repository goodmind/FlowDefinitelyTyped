declare module "falcor-router" {
  ...
  declare class FalcorRouter mixins DataSource {
    constructor(
      routes: Array<FalcorRouter$FalcorRouter$RouteDefinition>,
      options?: FalcorRouter$FalcorRouter$RouterOptions
    ): this;
  ...
  declare type FalcorRouter$CallRoute = {
    call(
      ...
      args: Array<any>
    ): FalcorRouter$CallRouteResult | Promise<FalcorRouter$CallRouteResult>
  } & FalcorRouter$Route;

  declare type FalcorRouter$GetRoute = {
    get(
      pathset: FalcorRouter$RoutePathSet
    ): FalcorRouter$RouteResult | Promise<FalcorRouter$RouteResult>
  } & FalcorRouter$Route;
  ...
  declare type FalcorRouter$RouteDefinition =
    | FalcorRouter$GetRoute
    | FalcorRouter$SetRoute
    | FalcorRouter$CallRoute;

  declare type FalcorRouter$RouteResult =
    | FalcorJsonGraph.PathValue
    | Array<FalcorJsonGraph.PathValue>
    | FalcorJsonGraph.JSONEnvelope<any>;

  declare type FalcorRouter$CallRouteResult =
    | FalcorJsonGraph.PathValue
