...
export interface Winreg$Registry {
   ...
   */
  values(
    cb: (err: Error, result: Array<Winreg$Winreg$RegistryItem>) => void
  ): Winreg$Registry;
   ...
   */
  keys(
    cb: (err: Error, result: Array<Winreg$Registry>) => void
  ): Winreg$Registry;
  ...
  get(
    name: string,
    cb: (err: Error, result: Winreg$Winreg$RegistryItem) => void
  ): Winreg$Registry;
...
declare module "winreg" {
  declare export default typeof Winreg;
}
