declare var Winreg: WinregStatic;declare interface WinregStatic {
 ...
 */
new (options: Winreg$Winreg$Options): Winreg$Winreg$Registry,
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} - error object or null if successful
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} - an array of {@link RegistryItem} objects
 * @returns {Winreg$Registry} this registry key object
 */
values(
cb: (err: Error, result: Array<Winreg$Winreg$RegistryItem>) => void): Winreg$Registry,

/**
 * Retrieve all subkeys from this registry key.
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} cb - callback function
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} - error object or null if successful
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} - an array of {@link Registry} objects
 * @returns {Winreg$Registry} this registry key object
 */
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} cb - callback function
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} - error object or null if successful
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} - the retrieved registry item
 * @returns {Winreg$Registry} this registry key object
 */
get(
name: string,
cb: (err: Error, result: Winreg$Winreg$RegistryItem) => void): Winreg$Registry,
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} cb - callback function
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} - error object or null if successful
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} - true if a registry key with this name already exists
 * @returns {Winreg$Registry} this registry key object
 */
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} cb - callback function
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} - error object or null if successful
 * @param {"NO PRINT IMPLEMENTED: JSDocOptionalType"} - true if a value with the given name was found in this key
 * @returns {Winreg$Registry} this registry key object
 */
