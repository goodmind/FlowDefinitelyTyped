declare module '@storybook/addon-storyshots' {
	...
	import type {
          Page,NavigationOptions,ScreenshotOptions
        } from 'puppeteer';
...
story: StoryObject,
context: StoryContext,
options?: SnapshotOptions) => void | void | Promise<void>;
...
url: string
	...
	declare export function imageSnapshot(
options?: {
storybookUrl?: string,
getMatchOptions?: (
...
chromeExecutablePath?: string
	...
	declare export function multiSnapshotWithOptions(options: SnapshotOptions): Test
	...
	declare export default function initStoryshots<Rendered>(options: InitOptions<Rendered>): void

	declare export interface InitOptions<Rendered> {
configPath?: string,
suite?: string,
