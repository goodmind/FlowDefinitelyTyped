declare module "tesseract.js" {
  declare type Tesseract$ImageLike =
    | string
    | HTMLImageElement
    | HTMLCanvasElement
    | HTMLVideoElement
  ...
  declare interface Tesseract$TesseractJob {
    then: (
      callback: (result: Tesseract$Page) => void
    ) => Tesseract$TesseractJob;
    progress: (
      callback: (progress: Tesseract$Progress) => void
    ) => Tesseract$TesseractJob;
    catch: (callback: (error: Error) => void) => Tesseract$TesseractJob;
    finally: (
      callback: (resultOrError: Error | Tesseract$Page) => void
    ) => Tesseract$TesseractJob;
