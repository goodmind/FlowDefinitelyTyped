...
declare export class Artboard mixins React.Component<ArtboardProps, any> {}
	declare export type ImageSource = string | {
src: string
};
	declare export type ResizeMode = "contain"
| "cover"
| "stretch"
| "center"
| "repeat"
...
t: T) => $ObjMapi<T, <P>(P) => StyleReference>,
 ...
 */
flatten: (
input: Array<Style | TextStyle | StyleReference> | StyleReference | void | Style) => Style | TextStyle,

/**
 * resolve one style
 */
resolve: (style: Style | TextStyle) => {
...
name?: string): React.ComponentClass<P & {
overrides?: {
[key: string]: any
}
}>
