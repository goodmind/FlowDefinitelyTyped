declare module 'prosemirror-transform' {
        import type {
          ContentMatch,Fragment,Mark,MarkType,ProsemirrorNode,NodeRange,NodeType,Schema,Slice
 ...
 */
declare export class AddMarkStep<S: Schema> mixins Step<S> {
 ...
 */
declare export class RemoveMarkStep<S: Schema> mixins Step<S> {
constructor(from: number, to: number, mark: Mark<S>): this
}
 ...
 */
declare export class Transform<S: Schema>  {
 ...
 */
declare export class ReplaceStep<S: Schema> mixins Step<S> {
 ...
 * slice.
 */
declare export class ReplaceAroundStep<S: Schema> mixins Step<S> {
 ...
 */
declare export function replaceStep<S: Schema>(
doc: ProsemirrorNode<S>,
from: number,
to?: number,
 ...
 */
declare export class Step<S: Schema>  {
 ...
 */
static fromJSON<S: Schema>(schema: S, json: {
[key: string]: any
}): Step<S>;
 ...
 */
declare export class StepResult<S: Schema>  {
 ...
 */
static ok<S: Schema>(doc: ProsemirrorNode<S>): StepResult<S>;
 ...
 * content of range.
 */
declare export function findWrapping<S: Schema>(
range: NodeRange<S>,
nodeType: NodeType<S>,
attrs?: {
[key: string]: any
 ...
 */
declare export function canSplit<S: Schema>(
doc: ProsemirrorNode<S>,
pos: number,
depth?: number,
typesAfter?: Array<{
 ...
 */
declare export function insertPoint<S: Schema>(
doc: ProsemirrorNode<S>,
pos: number,
 ...
 * found.
 */
declare export function dropPoint<S: Schema>(
doc: ProsemirrorNode<S>,
pos: number,
