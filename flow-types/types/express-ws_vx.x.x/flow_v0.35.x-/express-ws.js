...
options?: expressWs$expressWs$Options): expressWs$expressWs$Instance

	declare type expressWs$Application = express.expressWs$Application & expressWs$WithWebsocketMethod;

declare type expressWs$Router = express.expressWs$Router & expressWs$WithWebsocketMethod;
...
declare type expressWs$WebsocketRequestHandler = (ws: ws, req: express.Request, next: express.NextFunction) => void;

declare type expressWs$WebsocketMethod<T> = (
route: core.PathParams,
...middlewares: expressWs$WebsocketRequestHandler[]) => T;
