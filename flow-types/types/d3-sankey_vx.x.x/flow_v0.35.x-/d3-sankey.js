 ...
 */
declare export interface SankeyExtraProperties {
[key: string]: any
} 
 ...
 */
declare export interface SankeyNodeMinimal<N: SankeyExtraProperties, L: SankeyExtraProperties> {
 ...
 * SankeyLinkMinimal interface.
 */
declare export type SankeyNode<N: SankeyExtraProperties, L: SankeyExtraProperties> = N & SankeyNodeMinimal<N, L>;
 ...
 * SankeyLinkMinimal interface.
 */
declare export interface SankeyLinkMinimal<N: SankeyExtraProperties, L: SankeyExtraProperties> {
 ...
 * SankeyLinkMinimal interface.
 */
declare export type SankeyLink<N: SankeyExtraProperties, L: SankeyExtraProperties> = L & SankeyLinkMinimal<N, L>;
 ...
 * SankeyLinkMinimal interface.
 */
declare export interface SankeyGraph<N: SankeyExtraProperties, L: SankeyExtraProperties> {
 ...
 * SankeyLinkMinimal interface.
 */
declare export interface SankeyLayout<Data, N: SankeyExtraProperties, L: SankeyExtraProperties> {
 ...
 */
declare export function sankey(): SankeyLayout<SankeyGraph<{}, {}>, {}, {}>
 ...
 * SankeyLinkMinimal interface.
 */
declare export function sankey<N: SankeyExtraProperties, L: SankeyExtraProperties>(
 ...
 * SankeyLinkMinimal interface.
 */
declare export function sankey<Data, N: SankeyExtraProperties, L: SankeyExtraProperties>(
 ...
 */
declare export function sankeyLeft(node: SankeyNode<{}, {}>, n: number): number
 ...
 * @param n Total depth n of the graph  (one plus the maximum node.depth)
 */
declare export function sankeyRight(node: SankeyNode<{}, {}>, n: number): number
 ...
 * @param n Total depth n of the graph  (one plus the maximum node.depth)
 */
declare export function sankeyCenter(node: SankeyNode<{}, {}>, n: number): number
 ...
 * @param n Total depth n of the graph  (one plus the maximum node.depth)
 */
declare export function sankeyJustify(node: SankeyNode<{}, {}>, n: number): number
 ...
 */
declare export function sankeyLinkHorizontal(): Link<any, SankeyLink<{}, {}>, [number, number]>
 ...
 * SankeyLinkMinimal interface.
 */
declare export function sankeyLinkHorizontal<N: SankeyExtraProperties, L: SankeyExtraProperties>(
