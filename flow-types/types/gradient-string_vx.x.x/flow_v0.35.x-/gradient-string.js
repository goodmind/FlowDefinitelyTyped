...
colors: tinycolor.ColorInput[] | gradient$gradient$PositionedColorInput[]): gradient$gradient$Gradient

	declare function gradient(...colors: tinycolor.ColorInput[]): gradient$gradient$Gradient

	declare function gradient(
...colors: gradient$gradient$PositionedColorInput[]): gradient$gradient$Gradient
