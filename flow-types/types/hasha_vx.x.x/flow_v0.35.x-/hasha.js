...
options: hasha$hasha$HashaOptions<E>): string

	declare function hasha<E: "buffer">(
input: hasha$hasha$HashaInput,
options: hasha$hasha$HashaOptions<E>): Buffer
...
declare type hasha$ToStringEncoding = "hex"
| "base64"
| "latin1"
| "binary"
| void;
...
declare function hasha$stream(options?: hasha$HashaOptions<hasha$HashaEncoding>): crypto.Hash


declare function hasha$fromStream(hasha$stream: NodeJS.ReadableStream): Promise<string | null>


declare function hasha$fromStream<E: hasha$ToStringEncoding>(
hasha$stream: NodeJS.ReadableStream,
options?: hasha$HashaOptions<E>): Promise<string | null>


declare function hasha$fromStream<E: "buffer">(
hasha$stream: NodeJS.ReadableStream,
options?: hasha$HashaOptions<E>): Promise<Buffer | null>
...
filePath: string,
options: hasha$HashaOptions<E>): string


declare function hasha$fromFileSync<E: "buffer">(filePath: string, options: hasha$HashaOptions<E>): Buffer
