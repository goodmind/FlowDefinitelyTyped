...
warn(...args: any[]): void
	...
	declare export function define(modelName: string, config: ModelConfiguration): Model
...
callback: DynogelsItemCallback): void,
...
callback: (err: Error, items: any[]) => void): void,
getItems(
items: string[] | Array<{
[key: string]: string
}>,
...
callback: (err: Error, data: AWS.DynamoDB.CreateTableOutput) => void): void,
createTable(callback: (err: Error, data: AWS.DynamoDB.CreateTableOutput) => void): void,
updateTable(
throughput: Throughput,
callback: (err: Error, data: AWS.DynamoDB.UpdateTableOutput) => void): void,
...
listner: (data: any, next: (err: Error | null, data: any) => void) => void): void,
