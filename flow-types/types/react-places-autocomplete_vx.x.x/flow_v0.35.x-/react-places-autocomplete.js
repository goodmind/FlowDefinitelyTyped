...
formattedSuggestion: {
mainText: $ElementType<$ElementType<AutocompletePrediction, "structured_formatting">, "main_text">,
secondaryText: $ElementType<$ElementType<AutocompletePrediction, "structured_formatting">, "secondary_text">
},
matchedSubstrings: $ElementType<AutocompletePrediction, "matched_substrings">,
...
onClick: (event?: Event) => void
	...
	declare export function geocodeByAddress(address: string): Promise<google.maps.GeocoderResult[]>

	declare export function geocodeByPlaceId(placeId: string): Promise<google.maps.GeocoderResult[]>

	declare export function getLatLng(results: google.maps.GeocoderResult): Promise<google.maps.LatLngLiteral>

	declare export default class PlacesAutocomplete mixins React.Component<PropTypes> {}
    }
