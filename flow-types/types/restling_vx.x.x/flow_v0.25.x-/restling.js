declare module "restling" {
   ...
   * @return Result.
   */
  declare export function patchJson(
    url: string,
    data?: any,
    options?: RestlingOptions
  ): Promise<RestlingResult>;
   ...
   * @return Result.
   */
  declare export function postJson(
    url: string,
    data?: any,
    options?: RestlingOptions
  ): Promise<RestlingResult>;
   ...
   * @return Result.
   */
  declare export function putJson(
    url: string,
    data?: any,
    options?: RestlingOptions
  ): Promise<RestlingResult>;
  ...
  declare export function settleAsync(requests: {
    [key: string]: {
      url: string,
      options?: RestlingOptions
    }
  ...
  declare export function allAsync(requests: {
    [key: string]: {
      url: string,
      options?: RestlingOptions
    }
