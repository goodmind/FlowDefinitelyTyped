 ...
 */
ViewFields(viewFields: string[]): CamlBuilder$CamlBuilder$IFinalizableToString;
...
static +Recursive: Class<CamlBuilder$ViewScope__Recursive> & CamlBuilder$ViewScope__Recursive & 0;// 0
static +RecursiveAll: Class<CamlBuilder$ViewScope__RecursiveAll> & CamlBuilder$ViewScope__RecursiveAll & 1;// 1
static +FilesOnly: Class<CamlBuilder$ViewScope__FilesOnly> & CamlBuilder$ViewScope__FilesOnly & 2;// 2

}

declare class CamlBuilder$ViewScope__Recursive mixins CamlBuilder$ViewScope {}
declare class CamlBuilder$ViewScope__RecursiveAll mixins CamlBuilder$ViewScope {}
...
declare  class CamlBuilder$DateRangesOverlapType {
  constructor(...args: empty): mixed;
static +Now: Class<CamlBuilder$DateRangesOverlapType__Now> & CamlBuilder$DateRangesOverlapType__Now & 0;// 0
static +Day: Class<CamlBuilder$DateRangesOverlapType__Day> & CamlBuilder$DateRangesOverlapType__Day & 1;// 1
static +Week: Class<CamlBuilder$DateRangesOverlapType__Week> & CamlBuilder$DateRangesOverlapType__Week & 2;// 2
static +Month: Class<CamlBuilder$DateRangesOverlapType__Month> & CamlBuilder$DateRangesOverlapType__Month & 3;// 3
static +Year: Class<CamlBuilder$DateRangesOverlapType__Year> & CamlBuilder$DateRangesOverlapType__Year & 4;// 4

}

declare class CamlBuilder$DateRangesOverlapType__Now mixins CamlBuilder$DateRangesOverlapType {}
declare class CamlBuilder$DateRangesOverlapType__Day mixins CamlBuilder$DateRangesOverlapType {}
declare class CamlBuilder$DateRangesOverlapType__Week mixins CamlBuilder$DateRangesOverlapType {}
declare class CamlBuilder$DateRangesOverlapType__Month mixins CamlBuilder$DateRangesOverlapType {}
declare class CamlBuilder$DateRangesOverlapType__Year mixins CamlBuilder$DateRangesOverlapType {}


declare class CamlBuilder$Internal  {
static createView(viewFields?: string[]): CamlBuilder$IView;
static createViewFields(viewFields: string[]): CamlBuilder$IFinalizableToString;
