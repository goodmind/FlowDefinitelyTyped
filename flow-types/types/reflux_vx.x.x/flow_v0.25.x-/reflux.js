declare module "reflux" {
  ...
  declare export class Component<
    TOfStore: typeof Store = typeof Store,
    P = any,
    S = any
  ...
  declare export class PureComponent<
    TOfStore: typeof Store = typeof Store,
    P = any,
    S = any,
    SS = any
  > mixins React.PureComponent<P, S, SS> {
    store: TOfStore;
    stores: TOfStore[];
    storeKeys: string[];
    mapStoreToState(
  ...
  declare export function createAction(
    definition?: ActionDefinition | string | { [key: string]: any }
  ): any;
