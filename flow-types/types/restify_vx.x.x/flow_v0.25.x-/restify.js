declare module "restify" {
  ...
  declare export type FindRouteCallback = (
    err: Error,
    route?: Route,
    params?: any
  ) => void;
  ...
  declare type plugins$AuditLoggerContext = (
    req: Request,
    res: Response,
    route: any,
    error: any
   ...
   */
  declare function plugins$auditLogger(
    options: plugins$AuditLoggerOptions
  ): (...args: any[]) => void;
  ...
  declare function plugins$conditionalHandler(
    candidates: plugins$HandlerCandidate | plugins$HandlerCandidate[]
  ): RequestHandler;
   ...
   */
  declare function plugins$cpuUsageThrottle(
    opts?: plugins$CpuUsageThrottleOptions
  ): RequestHandler;
   ...
   */
  declare function plugins$bodyParser(
    options?: plugins$BodyParserOptions
  ): RequestHandler[];
   ...
   * error is logged.
   */
  declare function plugins$urlEncodedBodyParser(
    options?: plugins$UrlEncodedBodyParserOptions
  ): RequestHandler[];
   ...
   */
  declare function plugins$jsonBodyParser(
    options?: plugins$JsonBodyParserOptions
  ): RequestHandler[];
   ...
   * Parses JSONP callback
   */
  declare function plugins$multipartBodyParser(
    options?: plugins$MultipartBodyParser
  ): RequestHandler;
   ...
   */
  declare function plugins$queryParser(
    options?: plugins$QueryParserOptions
  ): RequestHandler;
   ...
   */
  declare function plugins$requestLogger(
    options?: plugins$RequestLogger
  ): RequestHandler;
   ...
   */
  declare function plugins$gzipResponse(
  ...
  declare function plugins$inflightRequestThrottle(
    opts: plugins$InflightRequestThrottleOptions
  ): RequestHandler;
   ...
   */
  declare function plugins$serveStatic(
    options?: plugins$ServeStatic
  ): RequestHandler;
   ...
   * throttles responses
   */
  declare function plugins$throttle(
    options?: plugins$ThrottleOptions
  ): RequestHandler;
  ...
  declare function plugins$metrics(
    ...
    callback: plugins$MetricsCallback
  ): (...args: any[]) => void;
   ...
   */
  declare function plugins$requestExpiry(
    options?: plugins$RequestExpiryOptions
  ): RequestHandler;
