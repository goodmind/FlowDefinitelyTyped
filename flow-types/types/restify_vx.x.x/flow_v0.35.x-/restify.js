...
ignoreTrailingSlash?: boolean
	...
	declare export interface AddressInterface {
port: number,
family: string,
address: string
} 
...
...handlers: RequestHandlerType[]): Route | boolean,
...
spdy?: boolean,
http2?: boolean,
ca: $ElementType<ServerOptions, "ca">,
certificate: $ElementType<ServerOptions, "certificate">,
key: $ElementType<ServerOptions, "key">,
passphrase: $ElementType<ServerOptions, "passphrase"> | null,
secure?: boolean
} & http.Server

	declare export interface ChainOptions {
onceNext?: boolean,
strictNext?: boolean
} 
...
strictNext: boolean
	...
	declare export interface RouterRegistryRadix {
 ...
 * Removes a route.
 */
remove(name: string): Route | void,

/**
 * Registry for route.
 */
lookup(method: string, pathname: string): Chain | void,
 ...
 * Lookup for route
 */
lookup(req: Request, res: Response): Chain | void;

/**
 * Lookup by name
 */
lookupByName(name: string, req: Request, res: Response): Chain | void;
...
strictNext: boolean
	...
	declare export interface RequestFileInterface {
path: string,
type: string
} 
	declare export interface RequestAuthorization {
scheme: string,
credentials: string,
basic?: {
username: string,
 ...
 */
json(code: number, body: any, headers?: {
 ...
 */
send(code?: number, body?: any, headers?: {
[header: string]: string
}): any,
 ...
 * @returns the response object
 */
sendRaw(code?: number, body?: any, headers?: {
[header: string]: string
}): any,
...
id: string
	...
	declare export interface RedirectOptions {
...
ifError(err?: any): void
	...
	declare export interface RouteSpec {
method: string,
name?: string,
path: string | RegExp,
versions?: string[]
...
versions?: string[]
	...
	declare export interface MountOptions {
name: string,
method: string,
path?: string | RegExp,
url?: string | RegExp,
...
versions?: string[]
	...
	declare export type FindRouteCallback = (err: Error, route?: Route, params?: any) => void;
	declare export type RequestHandler = (req: Request, res: Response, next: Next) => any;
	declare export type RequestHandlerType = RequestHandler | RequestHandler[];
	declare export interface ServerUpgradeResponse {
 ...
 */
declare class bunyan$RequestCaptureStream mixins stream.Stream {
constructor(opts: bunyan$RequestCaptureOptions): this;
...
declare var bunyan$serializers: Logger.Serializers & {
 ...
 */
declare function bunyan$createLogger(name: string): Logger

	declare export function createServer(options?: ServerOptions): Server

	declare export type Formatter = (req: Request, res: Response, body: any) => string | Buffer | null;
	declare export interface Formatters {
[contentType: string]: Formatter
} 
	declare export var formatters: Formatters;
	
      declare var npm$namespace$plugins: {
        acceptParser: typeof plugins$acceptParser,
auditLogger: typeof plugins$auditLogger,
authorizationParser: typeof plugins$authorizationParser,
conditionalHandler: typeof plugins$conditionalHandler,
conditionalRequest: typeof plugins$conditionalRequest,
cpuUsageThrottle: typeof plugins$cpuUsageThrottle,
fullResponse: typeof plugins$fullResponse,
bodyParser: typeof plugins$bodyParser,
bodyReader: typeof plugins$bodyReader,
urlEncodedBodyParser: typeof plugins$urlEncodedBodyParser,
jsonBodyParser: typeof plugins$jsonBodyParser,
jsonp: typeof plugins$jsonp,
multipartBodyParser: typeof plugins$multipartBodyParser,
queryParser: typeof plugins$queryParser,
requestLogger: typeof plugins$requestLogger,
dateParser: typeof plugins$dateParser,
gzipResponse: typeof plugins$gzipResponse,
inflightRequestThrottle: typeof plugins$inflightRequestThrottle,
serveStatic: typeof plugins$serveStatic,
 ...
 */
declare function plugins$acceptParser(accepts: string[]): RequestHandler


declare type plugins$AuditLoggerContext = (req: Request, res: Response, route: any, error: any) => any;

declare interface plugins$AuditLoggerOptions {
 ...
 */
declare function plugins$auditLogger(options: plugins$AuditLoggerOptions): (...args: any[]) => void
 ...
 */
declare function plugins$authorizationParser(options?: any): RequestHandler


declare interface plugins$HandlerCandidate {
 ...
 */
declare function plugins$conditionalHandler(
candidates: plugins$HandlerCandidate | plugins$HandlerCandidate[]): RequestHandler
 ...
 */
declare function plugins$conditionalRequest(): RequestHandler[]


declare interface plugins$CpuUsageThrottleOptions {
limit?: number,
max?: number,
interval?: number,
halfLife?: number
 ...
 */
declare function plugins$cpuUsageThrottle(opts?: plugins$CpuUsageThrottleOptions): RequestHandler
 ...
 */
declare function plugins$fullResponse(): RequestHandler


declare interface plugins$BodyParserOptions {
 ...
 */
declare function plugins$bodyParser(options?: plugins$BodyParserOptions): RequestHandler[]
 ...
 */
declare function plugins$bodyReader(options?: {
maxBodySize?: number
}): RequestHandler
 ...
 * error is logged.
 */
declare function plugins$urlEncodedBodyParser(options?: plugins$UrlEncodedBodyParserOptions): RequestHandler[]


declare interface plugins$JsonBodyParserOptions {
mapParams?: boolean,
overrideParams?: boolean,
 ...
 */
declare function plugins$jsonBodyParser(options?: plugins$JsonBodyParserOptions): RequestHandler[]
 ...
 */
declare function plugins$jsonp(): RequestHandler


declare interface plugins$MultipartBodyParser {
overrideParams?: boolean,
multiples?: boolean,
keepExtensions?: boolean,
uploadDir?: string,
 ...
 * Parses JSONP callback
 */
declare function plugins$multipartBodyParser(options?: plugins$MultipartBodyParser): RequestHandler


declare interface plugins$QueryParserOptions {
 ...
 */
declare function plugins$queryParser(options?: plugins$QueryParserOptions): RequestHandler
 ...
 */
declare function plugins$requestLogger(options?: plugins$RequestLogger): RequestHandler
 ...
 */
declare function plugins$dateParser(delta?: number): RequestHandler
 ...
 */
declare function plugins$gzipResponse(options?: zlib.ZlibOptions): RequestHandler


declare interface plugins$InflightRequestThrottleOptions {
limit: number,
server: Server,
err: any
} 

declare function plugins$inflightRequestThrottle(opts: plugins$InflightRequestThrottleOptions): RequestHandler


declare interface plugins$ServeStatic {
 ...
 */
declare function plugins$serveStatic(options?: plugins$ServeStatic): RequestHandler


declare interface plugins$ThrottleOptions {
burst?: number,
rate?: number,
setHeaders?: boolean,
ip?: boolean,
 ...
 * throttles responses
 */
declare function plugins$throttle(options?: plugins$ThrottleOptions): RequestHandler
...
declare type plugins$TMetricsCallback = "close" | "aborted" | void;

declare interface plugins$MetricsCallbackOptions {
 ...
 */
connectionState: plugins$TMetricsCallback
} 
 ...
 *      * ```
 */
declare function plugins$metrics(
opts: {
server: Server
},
callback: plugins$MetricsCallback): (...args: any[]) => void
 ...
 *      * ```
 */
declare function plugins$oauth2TokenParser(): RequestHandler


declare interface plugins$RequestExpiryOptions {
 ...
 */
declare function plugins$requestExpiry(options?: plugins$RequestExpiryOptions): RequestHandler
