declare module "victory" {
  ...
  declare export type AnimationEasing =
    | "back"
    | "backIn"
    | "backOut"
    | "backInOut"
   ...
   */
  declare export class VictoryAnimation
    mixins React.Component<VictoryAnimationProps, any> {}
   ...
   */
  declare export class VictoryLabel
    mixins React.Component<VictoryLabelProps, any> {}
 ...
 */
  ...
  declare export class VictoryContainer
    mixins React.Component<VictoryContainerProps, any> {}
  declare type CursorData = {
    x: number,
    y: number
  };
  declare export type VictoryCursorContainerProps = {
    /**
  ...
  declare export class VictoryCursorContainer
    mixins React.Component<VictoryCursorContainerProps, any> {}
  declare export type VictoryBrushContainerProps = {
    /**
  ...
  declare export class VictoryBrushContainer
    mixins React.Component<VictoryBrushContainerProps, any> {}
  declare export type VictoryZoomContainerProps = {
    /**
  ...
  declare export class VictoryZoomContainer
    mixins React.Component<VictoryZoomContainerProps, any> {}
  ...
  declare type OrientationTypes = "top" | "bottom" | "left" | "right";
  declare export interface VictoryTooltipProps {
    /**
   ...
   */
  declare export class VictoryTooltip
    mixins React.Component<VictoryTooltipProps, any> {}
   ...
   * Data domain type
   */
  declare type DomainTuple = [number, number] | [Date, Date];
  declare type DomainPropType =
    | DomainTuple
    | {
        x?: DomainTuple,
        y: DomainTuple
   ...
   * Domain padding
   */
  declare type DomainPaddingPropType =
    | number
    | {
   ...
   */
  declare type DataGetterPropType =
    | number
    | string
    | string[]
    | {
  ...
  declare type InterpolationPropType =
    | "basis"
    | "basisClosed"
    | "basisOpen"
    | "bundle"
    ...
    | "stepAfter"
    | "stepBefore";
  declare type ColorScalePropType =
    | "greyscale"
    | "qualitative"
    | "heatmap"
    | "warm"
 ...
 */
   ...
   */
  declare export class VictoryArea
    mixins React.Component<VictoryAreaProps, any> {}
 ...
 */
   ...
   */
  declare export class VictoryAxis
    mixins React.Component<VictoryAxisProps, any> {}
 ...
 */
   ...
   */
  declare export class VictoryBoxPlot
    mixins React.Component<VictoryBoxPlotProps, any> {}
 ...
 */
   ...
   * - VictoryBar
   */
  declare export class VictoryChart
    mixins React.Component<VictoryChartProps, any> {}
 ...
 */
  ...
  declare export class VictoryGroup
    mixins React.Component<VictoryGroupProps, any> {}
 ...
 */
   ...
   */
  declare export class VictoryLine
    mixins React.Component<VictoryLineProps, any> {}
  declare export type VictoryLegendProps = {
    /**
   ...
   */
  declare export class VictoryLegend
    mixins React.Component<VictoryLegendProps, any> {}
  declare type ScatterSymbolType =
    | "circle"
    | "diamond"
    | "plus"
    | "square"
 ...
 */
   ...
   */
  declare export class VictoryScatter
    mixins React.Component<VictoryScatterProps, any> {}
 ...
 */
  ...
  declare export class VictoryStack
    mixins React.Component<VictoryStackProps, any> {}
 ...
 */
   ...
   * Data changes are animated with VictoryAnimation.
   */
  declare export class VictoryPie
    mixins React.Component<VictoryPieProps, any> {}
}
