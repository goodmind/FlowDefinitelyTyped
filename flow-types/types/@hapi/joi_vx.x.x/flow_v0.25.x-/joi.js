declare module "@hapi/joi" {
  ...
  declare export type LanguageRootOptions = {
    root?: string,
    key?: string,
    messages?: {
      wrapArrays?: boolean
    }
  } & $Shape<Record<Types, LanguageOptions>> & {
      [key: string]: LanguageOptions
    };
  ...
  declare export interface HexOptions {
    /**
  ...
  declare export type GuidVersions =
    | "uuidv1"
    | "uuidv2"
    | "uuidv3"
    | "uuidv4"
    | "uuidv5";
  declare export interface GuidOptions {
  ...
  declare export interface DataUriOptions {
    /**
     * optional parameter defaulting to true which will require = padding if true or make padding optional if false
     */
    paddingRequired?: boolean;
  }
  declare export interface Base64Options {
    /**
     * optional parameter defaulting to true which will require = padding if true or make padding optional if false
     */
    paddingRequired?: boolean;
  }
  declare export interface WhenOptions {
    /**
  ...
  declare export interface WhenSchemaOptions {
    /**
     * the alternative schema type if the condition is true. Required if otherwise is missing.
     */
    then?: SchemaLike;
  ...
  declare export interface StringRegexOptions {
    name?: string;
    invert?: boolean;
  }
  declare export interface JoiObject {
    isJoi: boolean;
  }
  ...
  declare export type ValidationErrorFunction = (
    errors: ValidationErrorItem[]
  ) => string | ValidationErrorItem | ValidationErrorItem[] | Error;
  declare export type ValidationResult<T> = {
    error: ValidationError,
    value: T
  } & Pick<Promise<T>, "then" | "catch">;

  declare export type SchemaLike =
    | string
    | number
    | boolean
    | { [key: string]: any }
  ...
  declare export type BooleanSchema = {
    /**
  ...
  declare export type SymbolSchema = {
    map(
      iterable:
  ...
  declare export type LazySchema = {} & AnySchema;

  declare export type Reference = {
  ...
  declare export type ExtensionBoundSchema = Schema & {
    /**
  ...
  declare export interface Rules<P: { [key: string]: any } = any> {
    name: string;
    params?: ObjectSchema | $ObjMapi<P, <key>(key) => SchemaLike>;
    setup?: (params: P) => Schema | void;
    validate?: (
      params: P,
      value: any,
      state: State,
  ...
  declare export type Err = {
    toString(): string
  } & JoiObject;

  declare export interface LazyOptions {
    /**
   ...
   */
  declare export function any(): AnySchema;
   ...
   */
  declare export function symbol(): SymbolSchema;

  /**
   * Generates a type that will match one of the provided alternative schemas
   */
  declare export function alternatives(types: SchemaLike[]): AlternativesSchema;
   ...
   */
  declare export function alt(types: SchemaLike[]): AlternativesSchema;
   ...
   */
  declare export function compile(schema: SchemaLike): Schema;
   ...
   * @param message - optional message string prefix added in front of the error message. may also be an Error object.
   */
  declare export function attempt<T>(
    value: T,
    schema: SchemaLike,
    message?: string | Error
  ): T;
  ...
  import typeof * as Module from "@hapi/joi";

  declare export type Root = typeof Module;
  declare export type DefaultsFunction = (root: Schema) => Schema;
   ...
   */
  declare export function defaults(fn: DefaultsFunction): Root;

  /**
   * Returns a plain object representing the schema's rules and properties
   */
  declare export function describe(schema: Schema): Description;
   ...
   * Alias of `required`.
   */
  declare export function exist(): Schema;
   ...
   * Annotates the key
   */
  declare export function notes(notes: string | string[]): Schema;

  /**
   * Annotates the key
   */
  declare export function tags(notes: string | string[]): Schema;

  /**
   * Attaches metadata to the key.
   */
  declare export function meta(meta: { [key: string]: any }): Schema;
