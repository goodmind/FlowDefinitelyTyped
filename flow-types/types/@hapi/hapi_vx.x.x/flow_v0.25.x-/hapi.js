declare module "@hapi/hapi" {
  ...
  import typeof * as Shot from "@hapi/shot";
  ...
  import type { MimosOptions } from "@hapi/mimos";

  import type { SealOptions, SealOptionsSub } from "@hapi/iron";

  import type { ValidationOptions, SchemaMap, Schema } from "@hapi/joi";

  import typeof * as Podium from "@hapi/podium";
   ...
   *   plugin version.
   */
  declare export type Dependencies =
    | string
    | string[]
    | {
        [key: string]: string
  ...
  declare export type AuthMode = "required" | "optional" | "try";
  ...
  declare export type AccessEntity = "any" | "user" | "app";
  ...
  declare export type RouteOptionsAccessObject =
   ...
   */
  declare export type PayloadCompressionDecoderSettings = {
    [key: string]: any
  };
  ...
  declare export interface CommonRouteProperties {
    /**
     * Default value: null.
     ...
     */
    ext?: $ObjMapi<
      { [k: RouteRequestExtType]: any },
      <key>(key) => RouteExtObject | RouteExtObject[]
    >;
  ...
  declare export interface AccessScopes {
    forbidden?: string[];
    required?: string[];
    selection?: string[];
  }
  declare export interface AccessSetting {
    entity?: AccessEntity;
    scope: AccessScopes | false;
  }
  declare export interface AuthSettings {
    strategies: string[];
    mode: AuthMode;
    access?: AccessSetting[];
  }
  declare export type RouteSettings = {
    auth?: AuthSettings
   ...
   */
  declare export type RouteOptions = {
    /**
   ...
   */
  declare export type ServerEventsApplication =
    | string
   ...
   */
  declare export type ServerExtType =
    | "onPreStart"
    | "onPostStart"
    | "onPreStop"
    | "onPostStop";
  declare export type RouteRequestExtType =
    | "onPreAuth"
    | "onCredentials"
    | "onPostAuth"
    | "onPreHandler"
   ...
   */
  declare type Lifecycle$FailAction =
    | "error"
    | "log"
    | "ignore"
    | Lifecycle$Method;
  ...
  declare type Util$HTTP_METHODS_PARTIAL_LOWERCASE =
    | "get"
    | "post"
    | "put"
    | "patch"
  ...
  declare type Util$HTTP_METHODS_PARTIAL =
    | "GET"
    | "POST"
    | "PUT"
    | "PATCH"
