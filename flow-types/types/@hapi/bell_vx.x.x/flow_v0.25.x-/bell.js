...
declare module "@hapi/bell" {
  import type { Server, Request, Plugin, AuthCredentials } from "@hapi/hapi";

  declare export interface StringLikeMap {
    [key: string]: string | number;
  }
  declare export type Provider =
    | "arcgisonline"
    | "auth0"
    | "azuread"
    | "bitbucket"
    ...
    | "wordpress"
    | "yahoo";
  declare export type RequestPassThrough = (
    request: Request
  ...
  declare export type BellOptions =
