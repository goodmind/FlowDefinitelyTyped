...
function toString() { [native code] }: (...args: any[]) => string
} 
...
constructor(socket: net.Socket, httpRequest: http.IncomingMessage, config: IServerConfig): this;
...
extraRequestOptions?: http.RequestOptions): void;
connect(
requestUrl: string,
protocols?: string[],
origin?: string,
...
constructor(url: string, protocols?: string | string[], origin?: string, headers?: any[], requestOptions?: {[key: string]: any}, clientConfig?: IClientConfig): this;
send(data: Buffer): void;
send(data: IStringified): void;
