declare module 'git-url-parse' {
      ...
      declare var npm$namespace$gitUrlParse: {
        stringify: typeof gitUrlParse$stringify,
        
      }
declare interface gitUrlParse$GitUrl {
...
declare function gitUrlParse$stringify(url: gitUrlParse$GitUrl, type?: string): string
