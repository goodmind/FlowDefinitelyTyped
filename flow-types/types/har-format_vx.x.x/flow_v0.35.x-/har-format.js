 ...
 */
declare export interface Creator {
 ...
 */
declare export interface PageTiming {
 ...
 */
declare export interface QueryString {
name: string,
value: string,
 ...
 */
declare export interface PostData {
 ...
 */
declare export interface Param {
...
comment?: string
	...
	declare export interface CacheDetails {
 ...
 */
declare export interface Timings {
