declare module "jira-client" {
  import type { CoreOptions, RequestResponse } from "request";
  ...
  declare class JiraApi {
    ...
    ): Promise<JiraApi$JiraApi$JsonResponse>;
    ...
    searchJira(
      searchString: string,
      optional?: JiraApi$JiraApi$SearchQuery
    ): Promise<JiraApi$JiraApi$JsonResponse>;
    createUser(
      user: JiraApi$JiraApi$UserObject
    ): Promise<JiraApi$JiraApi$JsonResponse>;
    searchUsers(
      options: JiraApi$JiraApi$SearchUserOptions
    ): Promise<JiraApi$JiraApi$JsonResponse>;
    getUsersInGroup(
      groupname: string,
      startAt?: number,
    ...
    addNewIssue(
      issue: JiraApi$JiraApi$IssueObject
    ): Promise<JiraApi$JiraApi$JsonResponse>;
    addWatcher(
      issueKey: string,
      username: string
    ...
    transitionIssue(
      issueId: string,
      issueTransition: JiraApi$JiraApi$TransitionObject
    ): Promise<JiraApi$JiraApi$JsonResponse>;
    ...
    addWorklog(
      ...
      newEstimate: JiraApi$JiraApi$EstimateObject
    ): Promise<JiraApi$JiraApi$JsonResponse>;
    deleteWorklog(
      issueId: string,
      worklogId: string
    ...
    registerWebhook(
      webhook: JiraApi$JiraApi$WebhookObject
    ): Promise<JiraApi$JiraApi$JsonResponse>;
    ...
    issueNotify(
      issueId: string,
      notificationBody: JiraApi$JiraApi$NotificationObject
    ): Promise<JiraApi$JiraApi$JsonResponse>;
    ...
    createBoard(
      boardBody: JiraApi$JiraApi$BoardObject
    ): Promise<JiraApi$JiraApi$JsonResponse>;
