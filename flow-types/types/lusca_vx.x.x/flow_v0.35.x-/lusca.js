declare module 'lusca' {
        declare function lusca(options?: lusca$lusca$LuscaOptions): express.RequestHandler
...
policy?: string | {[key: string]: any} | Array<{[key: string]: any} | string>,
reportOnly?: boolean,
reportUri?: string,
styleNonce?: boolean,
scriptNonce?: boolean
...
declare type lusca$csrfOptions = lusca$csrfOptionsAngular | lusca$csrfOptionsNonAngular;
...
declare function lusca$csrf(options?: lusca$csrfOptions): express.RequestHandler


declare function lusca$csp(options?: lusca$cspOptions): express.RequestHandler
...
declare function lusca$hsts(options?: lusca$hstsOptions): express.RequestHandler


declare function lusca$xssProtection(options?: lusca$xssProtectionOptions | true): express.RequestHandler
