...
callback: (
err: Error | null,
result: markdownlint$markdownlint$MarkdownlintResults) => any): void
...
declare function markdownlint$sync(options: markdownlint$MarkdownlintOptions): markdownlint$MarkdownlintResults


declare function markdownlint$readConfig(
file: string,
callback: (err: Error | null, result: markdownlint$MarkdownlintConfig) => any): void


declare function markdownlint$readConfigSync(file: string): markdownlint$MarkdownlintConfig
...
[source: string]: markdownlint$MarkdownlintResult[] | ((useAlias?: boolean) => string),
