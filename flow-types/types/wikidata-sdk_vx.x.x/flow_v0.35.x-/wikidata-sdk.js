declare module 'wikidata-sdk' {
        import type {
          WikidataLanguage
        } from './def/type/language';

	import type {
          WikidataProperty
        } from './def/type/property';
	...
	import type {
          WikidataSiteLink,WikidataSiteLinkSimplify,WikidataSiteLinkWithUrlSimplify
        } from './def/object/sitelink';

	import type {
          UrlResultFormat
        } from './def/type/format';

	import type {
          WikidataLanguageBaseString,WikidataLanguageBaseStringSimplify,WikidataLanguageBaseArrayString,WikidataLanguageBaseArrayStringSimplify
        } from './def/object/language-base-string';

	import type {
          WikidataClaim,WikidataMainSnak,WikidataTimeDataValue,WikidataEntityDataValue
        } from './def/object/claim';

	declare export {
          WikidataLanguage,WikidataProperty,WikidataSite
        }

	declare export {
          WikidataLanguageBaseString,WikidataLanguageBaseStringSimplify,WikidataLanguageBaseArrayString,WikidataLanguageBaseArrayStringSimplify,WikidataSiteLink,WikidataSiteLinkSimplify,WikidataSiteLinkWithUrlSimplify
        }
...
uselang?: WikidataLanguage): string
 ...
 * @see {@link https://www.mediawiki.org/wiki/Wikibase/Indexing/RDF_Dump_Format#Truthy_statements | Truthy}
 */
declare export function truthyPropertyClaims(claims: WikidataClaim[]): WikidataClaim[]
 ...
 */
declare export function getSitelinkUrl(site: WikidataSite, title: string): string
 ...
 */
declare function simplify$entity<T>(simplify$entity: T, opt?: SimplifyOption): T
 ...
 */
declare function simplify$entities<T>(simplify$entities: T[], opt?: SimplifyOption): T[]
...
simplify$labels: WikidataLanguageBaseString): WikidataLanguageBaseStringSimplify
...
simplify$descriptions: WikidataLanguageBaseString): WikidataLanguageBaseStringSimplify
...
simplify$aliases: WikidataLanguageBaseArrayString): WikidataLanguageBaseArrayStringSimplify
 ...
 */
declare function simplify$sitelinks(simplify$sitelinks: WikidataSiteLink): WikidataSiteLinkSimplify
