declare interface gettext$gettextCatalog {
  /**
 ...
 */
declare interface gettext$gettextFunction {
...
declare module "angular-gettext" {
  ...
  declare export type gettextCatalog = angular.gettext.gettext$gettextCatalog;
}
