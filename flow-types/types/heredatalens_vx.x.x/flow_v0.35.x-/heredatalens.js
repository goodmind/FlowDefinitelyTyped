...
params?: any,
onResult?: (result: any) => void,
onError?: (error: any) => void): Promise<Uint8Array>;
...
useHTTPS: boolean,
useCIT: boolean,
baseUrl?: service.Url): datalens$Service
}
...
x: datalens$QueryTileProvider.HeatmapLayer$X,
y: datalens$QueryTileProvider.HeatmapLayer$Y,
zoom: datalens$QueryTileProvider.QueryTileProvider$Zoom): SpatialLayer$Row[],
...
x: HeatmapLayer$X,
y: HeatmapLayer$Y): HeatmapLayer$TilePoint,
 ...
 */
buffer(zoom: datalens$QueryTileProvider.QueryTileProvider$Zoom): number,
...
zoom: datalens$QueryTileProvider.QueryTileProvider$Zoom): void,
 ...
 */
bandwidth?: HeatmapLayer$Bandwidth | HeatmapLayer$BandwidthStop | HeatmapLayer$BandwidthStop[] | HeatmapLayer$BandwidthCallback,

/**
 * Defines the range for the color scale as a function of the zoom level.
 * The returned value must be an array of 2 numbers.
 */
valueRange(zoom: datalens$QueryTileProvider.QueryTileProvider$Zoom): number[],
 ...
 */
countRange(zoom: datalens$QueryTileProvider.QueryTileProvider$Zoom): number[],
...
rowToMapObject(
row: SpatialLayer$Row,
z: datalens$QueryTileProvider.QueryTileProvider$Zoom): map.Object,
...
row: SpatialLayer$Row,
z: datalens$QueryTileProvider.QueryTileProvider$Zoom,
styleState: SpatialLayer$StyleState): ObjectLayer$ObjectStyleOptions,
...
helpers: RawDataProvider$Helpers): datalens$ObjectLayer.SpatialLayer$Row[],
...
x: datalens$QueryTileProvider.HeatmapLayer$X,
y: datalens$QueryTileProvider.HeatmapLayer$Y,
z: datalens$QueryTileProvider.QueryTileProvider$Zoom): SpatialLayer$Row[],
...
row: SpatialLayer$Row,
z: datalens$QueryTileProvider.QueryTileProvider$Zoom,
styleState: SpatialLayer$StyleState): any,
 ...
 */
constructor(data?: datalens$Service.Service$Data, options?: map.provider.datalens$Provider.Service$Options): this;
 ...
 */
constructor(data: datalens$Service.Service$Data, options?: datalens$QueryProvider.Service$Options): this;
 ...
 * @param options - Configures source query and data accessibility parameters
 */
constructor(service: datalens$Service, options: datalens$QueryTileProvider.QueryProvider$Options): this;
 ...
 */
setTileParamNames(
tileParamNames: datalens$QueryTileProvider.QueryTileProvider$TileParamNames): void
}
...
y: QueryTileProvider$Y): HeatmapLayer$TilePoint,
 ...
 */
constructor(provider: datalens$QueryTileProvider, options: datalens$HeatmapLayer.RasterLayer$Options): this;
...
zoom: datalens$QueryTileProvider.QueryTileProvider$Zoom) => datalens$HeatmapLayer.RasterLayer$Row[];
...
x: datalens$QueryTileProvider.RasterLayer$X,
y: datalens$QueryTileProvider.RasterLayer$Y,
zoom: datalens$QueryTileProvider.QueryTileProvider$Zoom): RasterLayer$Row[],
...
row: RasterLayer$Row,
x: RasterLayer$X,
y: RasterLayer$Y): RasterLayer$TilePoint,
...
z: datalens$QueryTileProvider.QueryTileProvider$Zoom,
tileSize: RawDataProvider$TileSize,
helpers: RawDataProvider$Helpers): datalens$ObjectLayer.RasterLayer$Row[],
...
x: datalens$QueryTileProvider.RasterLayer$X,
y: datalens$QueryTileProvider.RasterLayer$Y,
z: datalens$QueryTileProvider.QueryTileProvider$Zoom): RasterLayer$Row[],
...
static +SUM: Class<HeatmapLayer$Aggregation__SUM> & HeatmapLayer$Aggregation__SUM & 0;// 0
static +AVERAGE: Class<HeatmapLayer$Aggregation__AVERAGE> & HeatmapLayer$Aggregation__AVERAGE & 1;// 1

}

declare class HeatmapLayer$Aggregation__SUM mixins HeatmapLayer$Aggregation {}
declare class HeatmapLayer$Aggregation__AVERAGE mixins HeatmapLayer$Aggregation {}
...
declare  class HeatmapLayer$InputScale {
  constructor(...args: empty): mixed;
static +DB: Class<HeatmapLayer$InputScale__DB> & HeatmapLayer$InputScale__DB & 0;// 0
static +LINEAR: Class<HeatmapLayer$InputScale__LINEAR> & HeatmapLayer$InputScale__LINEAR & 1;// 1
static +LOG: Class<HeatmapLayer$InputScale__LOG> & HeatmapLayer$InputScale__LOG & 2;// 2

}

declare class HeatmapLayer$InputScale__DB mixins HeatmapLayer$InputScale {}
declare class HeatmapLayer$InputScale__LINEAR mixins HeatmapLayer$InputScale {}
 ...
 */
constructor(provider: map.provider.RemoteTileProvider | datalens$Provider | datalens$QueryProvider | datalens$QueryTileProvider, options: datalens$ObjectLayer.HeatmapLayer$Options): this;

/**
 * Default value for dataToRows callback option. It represents each row as an object where property names correspond to data column names.
 */
static defaultDataToRows(data: datalens$Service.Service$Data): datalens$ObjectLayer.HeatmapLayer$Row[];
 ...
 */
static createIcon(svg: string | any[], options?: map.Icon.HeatmapLayer$Options): map.Icon;
 ...
 */
updateObjectStyle(any: map.Object, state: datalens$ObjectLayer.SpatialLayer$StyleState): void
}
...
x: datalens$QueryTileProvider.HeatmapLayer$X,
y: datalens$QueryTileProvider.HeatmapLayer$Y,
zoom: datalens$QueryTileProvider.QueryTileProvider$Zoom): HeatmapLayer$Row[],
...
z: datalens$QueryTileProvider.QueryTileProvider$Zoom,
tileSize: RawDataProvider$TileSize,
helpers: RawDataProvider$Helpers): datalens$ObjectLayer.HeatmapLayer$Row[],
...
x: datalens$QueryTileProvider.HeatmapLayer$X,
y: datalens$QueryTileProvider.HeatmapLayer$Y,
z: datalens$QueryTileProvider.QueryTileProvider$Zoom): HeatmapLayer$Row[],
 ...
 */
options(
zoom: datalens$QueryTileProvider.QueryTileProvider$Zoom): clustering.datalens$Provider.ClusteringOptions
} 
...
x: datalens$QueryTileProvider.HeatmapLayer$X,
y: datalens$QueryTileProvider.HeatmapLayer$Y,
zoom: datalens$QueryTileProvider.QueryTileProvider$Zoom): ObjectLayer$Row[],
...
row: ObjectLayer$Row,
z: datalens$QueryTileProvider.QueryTileProvider$Zoom,
styleState: ObjectLayer$StyleState): ObjectLayer$ObjectStyleOptions,
...
z: datalens$QueryTileProvider.QueryTileProvider$Zoom,
tileSize: RawDataProvider$TileSize,
helpers: RawDataProvider$Helpers): datalens$ObjectLayer.ObjectLayer$Row[],
...
x: datalens$QueryTileProvider.HeatmapLayer$X,
y: datalens$QueryTileProvider.HeatmapLayer$Y,
z: datalens$QueryTileProvider.QueryTileProvider$Zoom): ObjectLayer$Row[],
...
row: ObjectLayer$Row,
z: datalens$QueryTileProvider.QueryTileProvider$Zoom,
styleState: ObjectLayer$StyleState): any,
...
z: datalens$QueryTileProvider.QueryTileProvider$Zoom,
tileSize: RawDataProvider$TileSize): RawDataProvider$PixelCoordinates,
...
z: datalens$QueryTileProvider.QueryTileProvider$Zoom,
tileSize: RawDataProvider$TileSize): RawDataProvider$GeoCoordinates,
 ...
 * @param options - Configuration for data processing and rendering
 */
constructor(dataProvider: datalens$Provider, spatialProvider: datalens$SpatialTileProvider, options: datalens$SpatialLayer.RawDataProvider$Options): this;
 ...
 */
updateSpatialStyle(spatial: map.Object, state: datalens$SpatialLayer.ObjectLayer$StyleState): void
}
 ...
 */
declare class datalens$SpatialTileProvider mixins undefined.RemoteTileProvider {
 ...
 */
constructor(service: datalens$Service, options: datalens$SpatialTileProvider.SpatialLayer$Options): this;
