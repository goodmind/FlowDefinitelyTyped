...
static query(parameters: calendar$FreeBusyQueryParameters): HttpRequest<calendar$FreeBusy>
}
...
static insert(parameters: calendar$AclInsertParameters): HttpRequest<calendar$Acl>;
static get(parameters: calendar$AclGetParameters): HttpRequest<calendar$Acl>;
static update(parameters: calendar$AclUpdateParameters): HttpRequest<calendar$Acl>;
...
static list(
parameters?: calendar$CalendarListListParameters): HttpRequest<calendar$CalendarList>;
static insert(
parameters: calendar$CalendarListInsertParameters): HttpRequest<calendar$CalendarListEntry>
}

declare type calendar$AccessRoleWithoutNone = "freeBusyReader" | "reader" | "writer" | "owner";
...
declare type calendar$NotificationType = "eventCreation"
| "eventChange"
| "eventCancellation"
| "eventResponse"
| "agenda";
...
static insert(parameters: calendar$CalendarsInsertParameters): HttpRequest<calendar$Calendar>;
static update(parameters: calendar$CalendarsUpdateParameters): HttpRequest<calendar$Calendar>;
static delete(parameters: calendar$CalendarsDeleteParameters): HttpRequest<void>
}
...
static list(parameters: calendar$EventsListParameters): HttpRequest<calendar$Events>;
static insert(parameters: calendar$EventsInsertParameters): HttpRequest<calendar$Event>;
static update(parameters: calendar$EventsUpdateParameters): HttpRequest<calendar$Event>;
static get(parameters: calendar$EventsGetParameters): HttpRequest<calendar$Event>;
static delete(parameters: calendar$EventsDeleteParameters): HttpRequest<calendar$Event>
}
...
declare type calendar$SyncToken = "iCalUID"
| "orderBy"
...
declare type calendar$AttendeeResponseStatus = "needsAction" | "declined" | "tentative" | "accepted";
...
declare type calendar$EventVisibility = "default" | "public" | "private" | "confidential";
