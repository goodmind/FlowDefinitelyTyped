 ...
 */
constructor(location: Memcached$Memcached$Location, Memcached$options?: Memcached$Memcached$options): this;
 ...
 */
getMulti(keys: string[], cb: (err: any, data: {
[key: string]: any
}) => void): void;
...
value: any,
lifetime: number,
cb: (err: any, result: boolean) => void): void;
 ...
 * @param value Either a buffer, JSON, number or string that you want to store.
 */
append(key: string, value: any, cb: (err: any, result: boolean) => void): void;
 ...
 * @param value Either a buffer, JSON, number or string that you want to store.
 */
prepend(key: string, value: any, cb: (err: any, result: boolean) => void): void;
...
key: string,
amount: number,
cb: (err: any, result: boolean | number) => void): void;
 ...
 */
version(cb: (err: any, version: Memcached$Memcached$VersionData[]) => void): void;

/**
 * Retrieves your stats settings.
 */
settings(cb: (err: any, settings: Memcached$Memcached$StatusData[]) => void): void;

/**
 * Retrieves stats from your memcached server.
 */
stats(cb: (err: any, stats: Memcached$Memcached$StatusData[]) => void): void;

/**
 * Retrieves stats slabs information.
 */
slabs(cb: (err: any, stats: Memcached$Memcached$StatusData[]) => void): void;

/**
 * Retrieves stats items information.
 */
items(cb: (err: any, stats: Memcached$Memcached$StatusData[]) => void): void;
...
cb: (
err: any,
cachedump: Memcached$Memcached$CacheDumpData | Memcached$Memcached$CacheDumpData[]) => void): void;
...
cb: (err: Memcached$Memcached$IssueData) => void): this;
 ...
 * </ul>
 */
declare type Memcached$EventNames = "issue"
| "failure"
| "reconnecting"
| "reconnect"
| "remove";
 ...
 */
declare type Memcached$Location = string | string[] | {
