...
callback?: (err: any, tempfs$dir: tempfs$dir) => any): any
 ...
 */
declare function tempfs$mkdirSync(tempfs$options?: tempfs$options): tempfs$dir
...
of {@link file}.
 */
declare function tempfs$open(callback?: (err: any, tempfs$file: tempfs$file) => any): any


declare function tempfs$open(
tempfs$options?: tempfs$options,
callback?: (err: any, tempfs$file: tempfs$file) => any): any
 ...
 * @throws when an error happens.
 */
declare function tempfs$openSync(tempfs$options?: tempfs$options): tempfs$file
