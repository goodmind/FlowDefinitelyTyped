...
declare interface balloonPanel$definition {
  ...
  downcast?: string | ((dom$element: htmlParser$dom$element) => void);
  downcasts?: {
    [key: string]: any
  };
  draggable?: boolean;
  ...
  upcast?:
    | string
    | ((dom$element: htmlParser$dom$element, data: any) => boolean);
...
declare interface balloonPanel$parts {
  close?: dom$dom$element;
  definition$content?: dom$dom$element;
  ui$panel?: dom$dom$element;
  title?: dom$dom$element;
  triangle?: dom$dom$element;
  triangleInner?: dom$dom$element;
  triangleOuter?: dom$dom$element;
}
declare interface definitions$button {
  label: string;
  disabled?: boolean;
  disabled?: boolean;
}

declare interface definitions$checkbox {
  checked?: boolean;
  validate?: () => boolean;
  label?: string;
  default?: string;
...
declare interface definitions$file {
  validate?: () => boolean;
  action?: string;
  size?: string;
  validate?: () => boolean;
...
declare interface definitions$fileButton {
  for: string;
  validate?: () => boolean;
  filebrowser?: string;
  for?: string;
...
declare interface definitions$hbox {
  widths?: string[];
  height?: string;
  padding?: string;
  align?: string;
...
declare interface definitions$html {
...
declare interface definitions$labeledElement {
  label: string;
...
declare interface definitions$radio {
  default: any;
  validate?: () => boolean;
...
declare interface definitions$select {
  default: any;
  validate?: () => boolean;
  items: Array<[string, string] | [string]>;
  multiple?: boolean;
...
declare interface definitions$textarea {
  rows?: number;
  cols?: number;
  default?: string;
  validate?: () => boolean;
...
declare interface definitions$textInput {
  default?: string;
  validate?: () => boolean;
  maxLength?: number;
  size?: string;
...
declare interface definitions$uiElement {
  ...
  align?: string;
  className?: string;
  commit?: (plugins$widget: plugins$plugins$widget) => void;
  id?: string;
  label?: string;
  ...
  requiredContent?:
    ...
    | CKEDITOR$style;
  setup?: (plugins$widget: plugins$plugins$widget) => void;
  CKEDITOR$style?: string;
  title?: string;
  notification$type?: string;
}

declare interface definitions$vbox {
  width?: string;
  heights?: string[];
  align?: string;
  padding?: string;
...
declare class dialog$button mixins definitions$uiElement {
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$button,
    htmlList: any[]
  ): this;
  accessKeyDown(): void;
  accessKeyUp(): void;
...
declare class dialog$checkbox mixins definitions$uiElement {
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$checkbox,
    htmlList: any[]
  ): this;
  accessKeyUp(): void;
  getValue(): boolean;
...
declare class dialog$fieldset mixins definitions$uiElement {
  constructor(
    ...
    childHtmlList: any[],
    htmlList: any[],
    elementDefinition: definitions$definitions$fieldSet
  ): this;
}
...
declare class dialog$file mixins undefined.definitions$labeledElement {
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$file,
    htmlList: any[]
  ): this;
  getAction(): string;
  registerEvents(balloonPanel$definition: {
    [key: string]: any
  }): dialog$file;
  reset(): void;
  setInitValue(): void;
...
declare class dialog$fileButton mixins dialog$button {
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$fileButton,
    htmlList: any[]
  ): this;
}
...
declare class dialog$hbox mixins definitions$uiElement {
  constructor(
    ...
    childHtmlList: any[],
    htmlList: any[],
    elementDefinition: definitions$dialog$hbox
  ): this;
  getChild(indices: number): CKEDITOR$ui.CKEDITOR$dialog.definitions$uiElement;
  getChild(
    indices: number[]
  ): CKEDITOR$ui.CKEDITOR$dialog.definitions$uiElement[];
}

declare class dialog$html mixins definitions$uiElement {
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$html,
    htmlList: any[]
  ): this;
}
...
declare class dialog$labeledElement mixins definitions$uiElement {
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$labeledElement,
    htmlList: any[],
    contentHtml: () => string
  ): this;
  getLabel(): string;
...
declare class dialog$radio mixins undefined.dialog$labeledElement {
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$radio,
    htmlList: any[]
  ): this;
  accessKeyUp(): void;
  getValue(): string;
...
declare class dialog$select mixins definitions$uiElement {
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$select,
    htmlList: any[]
  ): this;
...
declare class dialog$textarea mixins dialog$labeledElement {
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$textarea,
    htmlList: any[]
  ): this;
}
...
declare class dialog$textInput mixins undefined.dialog$labeledElement {
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$textInput,
    htmlList: any[]
  ): this;
  accessKeyUp(): void;
  focus(): void;
...
declare class dialog$uiElement {
  ...
  constructor(
    CKEDITOR$dialog: CKEDITOR$dialog,
    elementDefinition: definitions$dialog$uiElement,
    htmlList: any[],
  ...
  getInputElement(): dom$dom$element;
  getValue(): any;
  isChanged(): boolean;
  isEnabled(): boolean;
  isFocusable(): boolean;
  isVisible(): boolean;
  registerEvents(
    balloonPanel$definition: CKEDITOR$CKEDITOR$dialog.balloonPanel$definition.dialog$uiElement
  ): CKEDITOR$ui.CKEDITOR$dialog.dialog$uiElement;
  selectParentTab(): CKEDITOR$ui.CKEDITOR$dialog.dialog$uiElement;
  setValue(
    value: any,
    noChangeEvent: boolean
  ): CKEDITOR$ui.CKEDITOR$dialog.dialog$uiElement | void;
}
...
declare class dialog$vbox mixins dialog$hbox {
  constructor(
    ...
    childHtmlList: any[],
    htmlList: any[],
    elementDefinition: definitions$dialog$vbox
  ): this;
}

declare interface dialog$IDialogDefinition {
  buttons?: CKEDITOR$dialog.balloonPanel$definition.dialog$button[];
...
declare class ui$balloonPanel {
  ...
  attach(
    ...
    notification$options?:
      ...
      | boolean
      | {
          focusElement?: dom$dom$element | boolean,
          show?: boolean
        }
  ): void;
  blur(): void;
  ...
  deregisterFocusable(dom$element: dom$dom$element): void;
  destroy(): void;
  getHeight(): number;
  getWidth(): number;
  hide(): void;
  move(top: number, left: number): void;
  registerFocusable(dom$element: dom$dom$element): void;
...
declare class ui$balloonToolbar {
  ...
  addItem(name: string, dom$element: dialog$button | ui$richCombo): void;
  addItems(elements: {
    [itemName: string]: dialog$button | ui$richCombo
  }): void;
  deleteItem(name: string): void;
  destroy(): void;
  getItem(name: string): dialog$button | ui$richCombo;
  hide(): void;
  refresh(): void;
  show(): void;
}
...
declare class ui$button {
  static panel$handler: ui$handlerDefinition<ui$button>;
...
declare class ui$floatPanel {
  ...
  blur(): void;
  focus(): void;
  getBlock(name: string): ui$panel.panel$block;
...
declare class ui$handlerDefinition<T> {
  contentsElement: dom$dom$element;
...
declare function parse$background(
  value: string
): {
  color: string,
  unprocessed: string
...
declare function style$addCustomHandler(
  defintion: style$customHandler
): CKEDITOR$style;

declare function style$getStyleText(
  CKEDITOR$style: balloonPanel$definition
): string;
...
declare function object$findKey(
  obj: {
    [key: string]: any
  },
  value: any
...
declare function array$map<T, K>(
  array: T[],
  fn: (value: T) => K,
  thisArg?: {
    [key: string]: any
...
declare function tools$enableHtml5Elements(
...
declare function tools$getCookie(name: string): string;

declare function tools$getCsrfToken(): string;

declare function tools$getIndex<T>(
  array: T[],
  compareFunction: (dom$element: T) => boolean
): number;
...
declare function tools$htmlDecode(dom$text: string): string;

declare function tools$htmlDecodeAttr(dom$text: string): string;

declare function tools$htmlEncode(dom$text: string): string;

declare function tools$htmlEncodeAttr(dom$text: string): string;

declare function tools$indexOf<T>(
  array: T[],
...
declare function tools$normalizeCssText(
  styleText: string,
...
declare function tools$search<T>(
  array: T[],
  value: T | ((dom$element: T) => boolean)
): T;

declare function tools$setCookie(name: string, value: string): void;
...
declare function tools$transformPlainTextToHtml(
  dom$text: string,
  etnerMode: number
): string;
...
declare function tools$writeCssText(
  pastefromword$styles: {
    [key: string]: any
  },
  sort?: boolean
...
declare class customHandlers$widget mixins CKEDITOR$style {
  ...
  checkElement(dom$element: dom$dom$element): boolean;
...
declare function scriptLoader$queue(
  scriptUrl: string,
...
declare interface nestedEditable$definition {
  ...
  styleToAllowedContentRules?: (
    CKEDITOR$style: CKEDITOR$style
  ) => array$filter.allowedContentRules;
  styleableElements?: string;
  CKEDITOR$template?: string | CKEDITOR$template;
  upcast?:
    | string
...
declare function widget$getNestedEditable(
  guard: dom$dom$element,
  dom$node: dom$dom$node
): dom$dom$element;

declare function widget$isDomDragHandler(dom$node: dom$dom$node): boolean;

declare function widget$isDomDragHandlerContainer(
  dom$node: dom$dom$node
): boolean;

declare function widget$isDomNestedEditable(dom$node: dom$dom$node): boolean;

declare function widget$isDomWidget(dom$node: dom$dom$node): boolean;

declare function widget$isDomWidgetElement(dom$node: dom$dom$node): boolean;

declare function widget$isDomWidgetWrapper(dom$node: dom$dom$node): boolean;

declare function widget$isParserWidgetElement(dom$node: dom$dom$node): boolean;

declare function widget$isParserWidgetWrapper(dom$node: dom$dom$node): boolean;

declare class widget$nestedEditable mixins dom$dom$element {
  CKEDITOR$editor: CKEDITOR$editor;
  enterMode: number;
...
declare class widget$repository mixins CKEDITOR$event {
  ...
  registered: {
    [skin$name: string]: widget$definition
  };
  selected: customHandlers$widget[];
  widgetHoldingFocusedEditable: customHandlers$widget;
  add(
    skin$name: string,
    widgetDef: plugins$customHandlers$widget.widget$definition
  ): void;
  addUpcastCallback(
    callback: (dom$element: htmlParser$dom$element, data: any) => boolean
  ): void;
  checkSelection(): void;
  ...
  destroy(
    customHandlers$widget: plugins$customHandlers$widget,
    offline?: boolean
  ): void;
  ...
  initOnAll(container?: dom$dom$element): plugins$customHandlers$widget[];
  parseElementClasses(classes: string): any;
  wrapElement(dom$element: any, widgetName?: string): any;
}
...
declare function tableselection$getCellsBetween(
  first: dom$dom$element,
  last: dom$dom$element
): dom$dom$element[];
...
declare function link$getEditorAnchors(
  CKEDITOR$editor: CKEDITOR$editor
): dom$dom$element[];
...
): dom$dom$element | dom$dom$element[];
...
declare function indentList$firstItemInPath(
  query:
    ...
    | dom$dom$element
    | ((dom$element: dom$dom$element) => boolean)
): boolean;
...
declare class indent$specificDefinition {
  ...
  getContext(dom$node: dom$dom$elementPath): dom$dom$element;
...
declare function imagebase$addFeature(
  CKEDITOR$editor: CKEDITOR$editor,
  skin$name: string,
  widget$definition: imagebase$imageWidgetDefinition
...
declare function image2$checkHasNaturalRatio(image: dom$dom$element): boolean;
...
declare function image2$getNatural(
  image: dom$dom$element
): {
  [key: string]: string
};
...
declare function embedBase$createWidgetBaseDefinition(
  CKEDITOR$editor: CKEDITOR$editor
...
declare function condesnippet$setHighlighter(
  condesnippet$highlighter: condesnippet$highlighter
): void;
...
declare function clipboard$getDropTarget(
  CKEDITOR$editor: CKEDITOR$editor
): dom$dom$domObject;

declare function clipboard$getRangeAtDropPosition(
  domEvent: Event,
  CKEDITOR$editor: CKEDITOR$editor
): dom$dom$range;

declare function clipboard$initDragDataTransfer(
  evt?: dom$CKEDITOR$event,
  CKEDITOR$editor?: CKEDITOR$editor
): void;

declare function clipboard$initPasteDataTransfer(
  evt?: dom$CKEDITOR$event,
  sourceEditor?: CKEDITOR$editor
): void;

declare function clipboard$preventDefaultDropOnElement(
  dom$element: dom$dom$element
): void;
...
declare class balloontoolbar$context {
  ...
  hide(): void;
  refresh(): void;
  show(pointedElement?: dom$dom$element): void;
}
...
declare class cloudservices$cloudServicesLoader
  mixins fileTools$fileTools$fileLoader {
  customToken: string;
  constructor(
    CKEDITOR$editor: CKEDITOR$editor,
...
declare class plugins$autoEmbed {
  getWidgetDefinition(
    CKEDITOR$editor: CKEDITOR$editor,
    url: string
  ): customHandlers$widget.widget$definition;
}
...
declare class plugins$notification {
  ...
  constructor(
    CKEDITOR$editor: CKEDITOR$editor,
    notification$options: plugins$notification.notification$options
  ): this;
  hide(): void;
  isVisible(): boolean;
  show(): void;
  update(
    notification$options: plugins$notification.notification$updateOptions
  ): void;
}
...
declare class plugins$notificationAggregator mixins CKEDITOR$event {
  ...
  createTask(notification$options?: {
    weight?: number
...
declare class plugins$widget mixins CKEDITOR$event, widget$widget$definition {
  ...
  wrapper: dom$dom$element;
  constructor(
    widgetsRepo: plugins$plugins$widget.widget$repository,
    id: number,
    dom$element: dom$dom$element,
    widgetDef: plugins$plugins$widget.widget$definition,
    starupData?: any
  ): this;
  ...
  initEditable(
    editableName: string,
    widget$definition: plugins$plugins$widget.widget$nestedEditable.widget$definition
  ): boolean;
  isInited(): boolean;
  isReady(): boolean;
...
declare function plugins$add(
  skin$name: string,
  widget$definition?: CKEDITOR$pluginDefinition
): void;

declare function plugins$addExternal(
  skin$name: string,
  skin$path: string,
  fileName?: string
): void;

declare function plugins$get(skin$name: string): any;

declare function plugins$getFilePath(skin$name: string): string;

declare function plugins$getPath(skin$name: string): string;
...
declare function plugins$setLang(
  pluginName: string,
  languageCode: string,
  languageEntries: any
): void;
...
declare class htmlParser$comment mixins dom$node {
  ...
  value: string;
  constructor(value: string): this;
  filter(array$filter: array$filter): boolean;
  writeHtml(
    writer: htmlParser$htmlParser$basicWriter,
    array$filter?: htmlParser$array$filter
  ): void;
}
...
declare class htmlParser$element mixins dom$node {
  ...
  filter(array$filter: htmlParser$array$filter): boolean;
  filterChildren(array$filter: htmlParser$array$filter): void;
  find(
  ...
  getFirst(
    condition:
      ...
      | ((dom$node: htmlParser$dom$node) => boolean)
  ): htmlParser$dom$node;
  getHtml(): string;
  getOuterHtml(): string;
  ...
  setHtml(dialog$html: string): void;
...
declare class htmlParser$filter {
  ...
  attributesRules: {
    [skin$name: string]: htmlParser$filterRulesGroup
  };
...
declare class htmlParser$filterRulesGroup {
  ...
  add(
    ...
    priority: number,
    notification$options: htmlParser$ruleOptions
  ): void;
  addMany(
    rules: Array<{
      [key: string]: any
  ...
  exec(
    currentValue: htmlParser$dom$node | htmlParser$htmlParser$fragment | string
  ): htmlParser$dom$node | htmlParser$htmlParser$fragment | string;
...
declare class htmlParser$fragment {
  ...
  ): htmlParser$fragment | htmlParser$htmlParser$element;
}
...
declare class htmlParser$node {
  ...
  getAscendant(
    condition:
      ...
      | ((htmlParser$node: htmlParser$htmlParser$element) => boolean)
  ): htmlParser$element;
  getIndex(): number;
...
declare type htmlParser$rule =
  | ((
      value:
        | htmlParser$htmlParser$node
        | htmlParser$htmlParser$fragment
        | string
    ) => boolean)
  | [string, string];
...
declare module "filter" {
  declare type allowedContentRule =
    | string
    | CKEDITOR$style
    | {
        [key: string]: any
  ...
  declare type disallowedContentRules =
    | string
    | {
        [key: string]: any
      };
  declare interface transformation {
    check?: string;
    htmlParser$element?: string | CKEDITOR$style;
    left?: (
      htmlParser$element: htmlParser$htmlParser$element | CKEDITOR$style
    ) => boolean;
    right: (
      htmlParser$element: htmlParser$htmlParser$element,
      tools: string | htmlParser$filter.transformationTools
    ) => boolean;
  }
  ...
  declare interface transformationTools {
    ...
    alignmentToStyle(htmlParser$element: htmlParser$htmlParser$element): void;
    lengthToAttribute(
      htmlParser$element: htmlParser$htmlParser$element,
      styleName: string,
      attrName?: string
    ...
    sizeToAttribute(htmlParser$element: htmlParser$htmlParser$element): void;
    sizeToStyle(htmlParser$element: htmlParser$htmlParser$element): void;
    splitBorderShorthand(
      htmlParser$element: htmlParser$htmlParser$element
    ): void;
...
declare function fileTools$bindNotification(
  CKEDITOR$editor: CKEDITOR$editor,
  fileTools$fileLoader: fileTools$fileLoader
): void;

declare function fileTools$getUploadUrl(
  CKEDITOR$config: {
    [key: string]: any
  },
  notification$type?: string
...
declare function fileTools$isTypeSupported(
  dialog$file: Blob,
  supportedTypes: RegExp
): boolean;

declare function fileTools$markElement(
...
declare interface definition$button {
  label: string;
  disabled?: boolean;
  disabled?: boolean;
}

declare interface definition$checkbox {
  checked?: boolean;
  validate?: () => boolean;
  label?: string;
  default?: string;
...
declare interface definition$content {
  accessKey?: string;
  elements?: CKEDITOR$dialog.widget$definition.dialog$uiElement[];
  id?: string;
  label?: string;
  title?: string;
}

declare interface definition$file {
  validate?: () => boolean;
  action?: string;
  size?: string;
  validate?: () => boolean;
...
declare interface definition$fileButton {
  for: string;
  validate?: () => boolean;
  filebrowser?: string;
  for?: string;
...
declare interface definition$hbox {
  widths?: string[];
  height?: string;
  padding?: string;
  align?: string;
...
declare interface definition$html {
  definition$html: string;
  definition$html?: string;
}

declare interface definition$labeledElement {
  label: string;
  labelLayout?: "horizontal" | "vertical";
  widths?: [string, string];
  role?: string;
...
declare interface definition$radio {
  default: any;
  validate?: () => boolean;
  items: Array<[string, string] | [string]>;
  default?: string;
...
declare interface definition$select {
  default: any;
  validate?: () => boolean;
  items: Array<[string, string] | [string]>;
  multiple?: boolean;
...
declare interface definition$textarea {
  rows?: number;
  cols?: number;
  default?: string;
  validate?: () => boolean;
...
declare interface definition$textInput {
  default?: string;
  validate?: () => boolean;
  maxLength?: number;
  size?: string;
...
declare interface definition$vbox {
  width?: string;
  heights?: string[];
  align?: string;
  padding?: string;
...
declare class dom$comment mixins htmlParser$node {
  notification$type: number;
  constructor(dom$comment: string | Node, ownerDocument?: dom$document): this;
  getOuterHtml(): string;
}
...
declare class dom$document mixins dom$domObject {
  ...
  write(definition$html: string): void;
}
...
declare class dom$element mixins htmlParser$node {
  ...
  notification$type: number;
  constructor(
    dom$element: string | HTMLElement,
    ownerDocument?: dom$document
  ): this;
  addClass(className: string): void;
  append(
    htmlParser$node: htmlParser$node | string,
    toStart?: boolean
  ): htmlParser$node;
  appendBogus(force: boolean): void;
  appendHtml(definition$html: string): void;
  ...
  data(skin$name: string, value?: string | false): string;
  ...
  getAttribute(skin$name: string): string;
  ...
  getElementsByTag(tagName: string): dom$nodeList;
  getFirst(
    evaluator?: (htmlParser$node: htmlParser$node) => boolean
  ): htmlParser$node;
  ...
  getStyle(skin$name: string): string;
  getTabIndex(): number;
  getText(): string;
  getValue(): string;
  getWindow(): dom$window;
  hasAttributes(): boolean;
  hasAttribute(skin$name: string): boolean;
  hasClass(className: string): boolean;
  hide(): void;
  is(...skin$name: string[]): boolean;
  is(skin$name: any): boolean;
  ...
  removeAttribute(skin$name: string): void;
  removeAttributes(attributes?: string[]): void;
  removeClass(className: string): void;
  removeStyle(skin$name: string): void;
  renameNode(newTag: string): void;
  scrollIntoParent(
    parent: dom$element | dom$window,
    alignToTop: boolean,
    hscroll: boolean
  ): void;
  scrollIntoView(alignToTop?: boolean): void;
  setAttribute(skin$name: string, value: string): dom$element;
  setAttributes(attributesPairs: {
    [key: string]: string
  }): dom$element;
  setHtml(definition$html: string): string;
  ...
  setStyle(skin$name: string, value: string): dom$element;
  ...
  static createFromHtml(definition$html: string): dom$element;
...
declare class dom$node mixins dom$domObject {
  ...
  getNextSourceNode(
    ...
    nodeType?: number,
    guard?: dom$node | ((dom$node: dom$node) => boolean)
  ): dom$node;
  ...
  hasAscendant(skin$name: string, includeSelf: boolean): boolean;
...
declare class dom$range {
  ...
  shrink(
    ...
    notification$options?: boolean | dom$shrinkOptions
  ): void;
...
declare function CKEDITOR$getTemplate(skin$name: string): CKEDITOR$template;
...
declare function CKEDITOR$replace(
  dom$element: string | HTMLTextAreaElement,
  CKEDITOR$config?: CKEDITOR$config
): CKEDITOR$editor;
...
declare function CKEDITOR$replaceAll(
  assertionFunction: (
    definition$textarea: HTMLTextAreaElement,
    CKEDITOR$config: CKEDITOR$config
  ) => boolean
): void;
...
declare class CKEDITOR$command mixins dom$event, CKEDITOR$commandDefinition {
  ...
  constructor(
    CKEDITOR$editor: CKEDITOR$editor,
    CKEDITOR$commandDefinition: CKEDITOR$commandDefinition
  ): this;
...
declare interface CKEDITOR$config {
  allowedContent?: boolean | htmlParser$filter.allowedContentRules;
  ...
  extraAllowedContent?: htmlParser$filter.allowedContentRules;
  extraPlugins?: string;
  ...
  fillEmptyBlocks?:
    | boolean
    | ((dom$element: htmlParser$dom$element) => boolean);
...
declare interface CKEDITOR$dataProcessor {
  toDataFormat(definition$html: string, fixForBody: string): void;
...
declare class CKEDITOR$dialog {
  ...
  getButton(id: string): CKEDITOR$ui.CKEDITOR$dialog.definition$button;
  getContentElement(
    pageId: string,
    elementId: string
  ): CKEDITOR$ui.CKEDITOR$dialog.definition$uiElement;
  getElement(): dom$dom$element;
  getName(): string;
  getPageCount(): number;
  ...
  static add(
    ...
    dialogDefinition:
      ...
      | ((
          CKEDITOR$editor: CKEDITOR$editor
        ) => CKEDITOR$dialog.dialog$IDialogDefinition)
  ): void;
  static addIframe(
    skin$name: string,
    title: string,
  ...
  static exists(skin$name: string | number): void;
...
declare class CKEDITOR$editable mixins dom$dom$element {
  ...
  constructor(
    CKEDITOR$editor: CKEDITOR$editor,
    dom$element: HTMLElement | dom$dom$element
  ): this;
...
declare class CKEDITOR$editor mixins dom$event {
  ...
  CKEDITOR$document: dom$CKEDITOR$document;
  dom$element: dom$dom$element;
  elementMode: number;
  enterMode: number;
  htmlParser$filter: htmlParser$filter;
  ...
  widgets: plugins$plugins$widget.widget$repository;
  ...
  addMenuGroup(skin$name: string, order?: number): void;
  addMenuItem(
    skin$name: string,
    widget$definition?: CKEDITOR$IMenuItemDefinition
  ): void;
  ...
  attachStyleStateChange(
    CKEDITOR$style: CKEDITOR$style,
    callback: (copyformatting$state: number) => void
  ): void;
  checkDirty(): boolean;
  createFakeElement(
  ...
  editable(
    elementOrEditable?: dom$dom$element | CKEDITOR$editable
  ): CKEDITOR$editable;
  ...
  ): dom$dom$documentFragment | string | void;
  focus(): void;
  ...
  getCommandKeystroke(
    CKEDITOR$command: CKEDITOR$command | string
  ): number | null;
  getData(internal?: boolean): string;
  getMenuItem(skin$name: string): CKEDITOR$IMenuItemDefinition;
  ...
  getSnapshot(): string;
  getStylesSet(
    callback: (stylesDefinitions: CKEDITOR$style.widget$definition[]) => void
  ): void;
  getUiColor(): string;
  ...
  removeMenuItem(skin$name: string): void;
  removeStyle(CKEDITOR$style: CKEDITOR$style): void;
  resetDirty(): void;
  resetUndo(): void;
  resize(
  ...
  setActiveFilter(htmlParser$filter: htmlParser$filter): void;
  setData(
    data: string,
    notification$options?: {
      internal?: boolean,
...
declare class CKEDITOR$filter {
  ...
  addElementCallback(
    callback: (dom$element: htmlParser$dom$element) => number
  ): void;
  addFeature(CKEDITOR$feature: CKEDITOR$feature): boolean;
  addTransformations(
...
declare class CKEDITOR$htmlDataProcessor mixins CKEDITOR$dataProcessor {
  ...
  toHtml(
    data: string,
    notification$options?: string | CKEDITOR$htmlDataProcessorOptions
  ): string;
}
...
declare class CKEDITOR$resourceManager {
  ...
  add(skin$name: string, widget$definition?: CKEDITOR$pluginDefinition): void;
  addExternal(names: string, skin$path: string, fileName?: string): void;
  get(skin$name: string): CKEDITOR$pluginDefinition;
  getFilePath(skin$name: string): string;
  getPath(skin$name: string): string;
  load(
    skin$name: string | string[],
...
declare class CKEDITOR$style {
  ...
  constructor(
    styleDefinition: CKEDITOR$style.widget$definition,
    variableValues: any
  ): this;
  ...
  getDefintion(): CKEDITOR$style.widget$definition;
...
declare class CKEDITOR$ui mixins CKEDITOR$event {
  ...
  addButton(
    skin$name: string,
    widget$definition: CKEDITOR$buttonDefinition
  ): void;
  addHandler(
    notification$type: {
      [key: string]: any
  ...
  space(skin$name: string): dom$dom$element;
