...
nodeType: number,
guard: dom$node | ((dom$node: dom$node) => boolean)): void;
...
extractSelectedHtml(
function toString() { [native code] }?: boolean,
...
getSelectedHtml(function toString() { [native code] }?: false): dom$dom$documentFragment;
getSelectedHtml(function toString() { [native code] }: true): string;
getSelectedHtml(
function toString() { [native code] }?: boolean): dom$dom$documentFragment | string;
...
add(plugins$notification: plugins$notification): void,
