...
static +CONNTYPE_PG: Class<ConnectionType__CONNTYPE_PG> & ConnectionType__CONNTYPE_PG & 1;// 1
static +CONNTYPE_OP: Class<ConnectionType__CONNTYPE_OP> & ConnectionType__CONNTYPE_OP & 2;// 2
static +CONNTYPE_BASIC: Class<ConnectionType__CONNTYPE_BASIC> & ConnectionType__CONNTYPE_BASIC & 3;// 3
...
declare class ConnectionType__CONNTYPE_BASIC mixins ConnectionType {}
  ...
  constructor(...args: empty): mixed;
static +RemotePort: Class<ParamNumber__RemotePort> & ParamNumber__RemotePort & 2;// 2
static +PingTimeout: Class<ParamNumber__PingTimeout> & ParamNumber__PingTimeout & 3;// 3
static +SendTimeout: Class<ParamNumber__SendTimeout> & ParamNumber__SendTimeout & 4;// 4
static +RecvTimeout: Class<ParamNumber__RecvTimeout> & ParamNumber__RecvTimeout & 5;// 5
...
static +PDURequest: Class<ParamNumber__PDURequest> & ParamNumber__PDURequest & 10;// 10
...
static +S7WLCounter: Class<WordLen__S7WLCounter> & WordLen__S7WLCounter & 28;// 28
...
declare class BlockType__Block_SFB mixins BlockType {}
  ...
  constructor(...args: empty): mixed;
static +SubBlk_OB: Class<SubBlockType__SubBlk_OB> & SubBlockType__SubBlk_OB & 8;// 8
static +SubBlk_DB: Class<SubBlockType__SubBlk_DB> & SubBlockType__SubBlk_DB & 10;// 10
static +SubBlk_SDB: Class<SubBlockType__SubBlk_SDB> & SubBlockType__SubBlk_SDB & 11;// 11
static +SubBlk_FC: Class<SubBlockType__SubBlk_FC> & SubBlockType__SubBlk_FC & 12;// 12
static +SubBlk_SFC: Class<SubBlockType__SubBlk_SFC> & SubBlockType__SubBlk_SFC & 13;// 13
static +SubBlk_FB: Class<SubBlockType__SubBlk_FB> & SubBlockType__SubBlk_FB & 14;// 14
static +SubBlk_SFB: Class<SubBlockType__SubBlk_SFB> & SubBlockType__SubBlk_SFB & 15;// 15
...
declare class SubBlockType__SubBlk_SFB mixins SubBlockType {}
  ...
  constructor(...args: empty): mixed;
static +BlockLangAWL: Class<LangType__BlockLangAWL> & LangType__BlockLangAWL & 1;// 1
static +BlockLangKOP: Class<LangType__BlockLangKOP> & LangType__BlockLangKOP & 2;// 2
static +BlockLangFUP: Class<LangType__BlockLangFUP> & LangType__BlockLangFUP & 3;// 3
static +BlockLangSCL: Class<LangType__BlockLangSCL> & LangType__BlockLangSCL & 4;// 4
static +BlockLangDB: Class<LangType__BlockLangDB> & LangType__BlockLangDB & 5;// 5
static +BlockLangGRAPH: Class<LangType__BlockLangGRAPH> & LangType__BlockLangGRAPH & 6;// 6
...
declare class LangType__BlockLangGRAPH mixins LangType {}
  ...
  constructor(...args: empty): mixed;
static +S7CpuStatusUnknown: Class<Status__S7CpuStatusUnknown> & Status__S7CpuStatusUnknown & 0;// 0
static +S7CpuStatusRun: Class<Status__S7CpuStatusRun> & Status__S7CpuStatusRun & 8;// 8
static +S7CpuStatusStop: Class<Status__S7CpuStatusStop> & Status__S7CpuStatusStop & 4;// 4
