declare module "web-animations-js" {
  declare type AnimationEffectTimingFillMode =
    | "none"
    | "forwards"
    | "backwards"
    | "both"
    | "auto";
  declare type AnimationEffectTimingPlaybackDirection =
    | "normal"
    | "reverse"
    | "alternate"
    | "alternate-reverse";
  ...
  declare type AnimationEventListener =
    | ((evt: AnimationPlaybackEvent) => any)
    | null;
