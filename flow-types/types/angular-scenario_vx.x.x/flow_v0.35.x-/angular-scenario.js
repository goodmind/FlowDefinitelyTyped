...
expectation: angularScenario$angularScenario$Future): angularScenario$angularScenario$Expect
	...
	declare function input(ngModelBinding: string): angularScenario$angularScenario$Input

	declare function repeater(
selector: string,
repeaterDescription?: string): angularScenario$angularScenario$Repeater

	declare function select(ngModelBinding: string): angularScenario$angularScenario$Select

	declare function element(
selector: string,
elementDescription?: string): angularScenario$angularScenario$Element
