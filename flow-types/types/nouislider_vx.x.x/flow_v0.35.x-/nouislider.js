 ...
 * The filter function must return 0 (no value), 1 (large value) or 2 (small value).
 */
filter?: (...args: any[]) => noUiSlider$PipFilterResult,
...
static +NoValue: Class<noUiSlider$PipFilterResult__NoValue> & noUiSlider$PipFilterResult__NoValue & 0;// 0
static +LargeValue: Class<noUiSlider$PipFilterResult__LargeValue> & noUiSlider$PipFilterResult__LargeValue & 1;// 1
static +SmallValue: Class<noUiSlider$PipFilterResult__SmallValue> & noUiSlider$PipFilterResult__SmallValue & 2;// 2

}

declare class noUiSlider$PipFilterResult__NoValue mixins noUiSlider$PipFilterResult {}
declare class noUiSlider$PipFilterResult__LargeValue mixins noUiSlider$PipFilterResult {}
declare class noUiSlider$PipFilterResult__SmallValue mixins noUiSlider$PipFilterResult {}
 ...
 */
updateOptions(newOptions: noUiSlider$Options, fireSetEvent?: boolean): void
} 
