declare module 'enhanced-resolve' {
        import type {
          LoggingCallbackWrapper,ResolverRequest,ResolveContext,AbstractInputFileSystem
...
declare function Resolve$sync(Resolve$context: ResolveContext, path: string, request: string): string


declare function Resolve$context(path: string, request: string, callback: LoggingCallbackWrapper): void
...
path: string,
request: string,
callback: LoggingCallbackWrapper): void
...
declare function context$sync(Resolve$context: ResolveContext, path: string, request: string): string


declare function Resolve$loader(path: string, request: string, callback: LoggingCallbackWrapper): void
...
declare function loader$sync(Resolve$context: ResolveContext, path: string, request: string): string
...
(Resolve$context: ResolveContext, path: string, request: string, callback: LoggingCallbackWrapper): void
}
...
declare function ResolverFactory$createResolver(options: ResolverFactory$ResolverOption): Resolver
...
stat(
path: string,
callback: (err: NodeJS.ErrnoException, stats: fs.Stats) => void): void;
readdir(
path: string,
...
readlink(
path: string,
callback: (err: NodeJS.ErrnoException, linkString: string) => void): void;
statSync(path: string | Buffer): fs.Stats;
readdirSync(path: string): string[];
readFileSync(filename: string, options?: {
flag?: string
