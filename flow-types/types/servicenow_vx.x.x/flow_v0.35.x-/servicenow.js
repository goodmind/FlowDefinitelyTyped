...
constructor(): this;
constructor(name: string, methodName: servicenow$servicenow$RestHTTPMethods): this;
...
fireEvent(eventRecord: servicenow$servicenow$GlideRecord, eventName: string): void;
fireEventById(eventRecordId: string, eventName: string): void;
getContexts(record: servicenow$servicenow$GlideRecord): servicenow$servicenow$GlideRecord;
getEstimatedDeliveryTime(workflowId: string): string;
getEstimatedDeliveryTimeFromWFVersion(wfVersion: servicenow$servicenow$GlideRecord): string;
getReturnValue(workflowID: string, amount: number, result: boolean): {};
getRunningFlows(record: servicenow$servicenow$GlideRecord): servicenow$servicenow$GlideRecord;
...
restartWorkflow(record: servicenow$servicenow$GlideRecord, maintainStateFlag: boolean): void;
runFlows(
record: servicenow$servicenow$GlideRecord,
operation: servicenow$servicenow$GlideRecordOperation): void;
startFlow(
workflowId: string,
current: servicenow$servicenow$GlideRecord | null,
operation: servicenow$servicenow$GlideRecordOperation,
vars?: {[key: string]: any}): string;
...
operation: servicenow$servicenow$GlideRecordOperation,
vars?: {[key: string]: any},
withSchedule?: any): servicenow$servicenow$GlideRecord
}
...
createElementWithTextValue(name: string, value: string): servicenow$servicenow$XMLNode;
...
filter: string,
matchAll?: {[key: string]: any}): boolean
};
...
fileName: string,
contentType: string,
base64Content: string): string;
writeContentStream(
record: servicenow$servicenow$GlideRecord,
fileName: string,
contentType: string,
inputStream: {[key: string]: any}): string
}
...
joinTable: string,
primaryField?: string,
joinTableField?: string): servicenow$GlideQueryCondition,
...
value: {[key: string]: any} | string | number): servicenow$GlideQueryCondition,
addQuery(
fieldName: string,
value?: {[key: string]: any} | string | number): servicenow$GlideQueryCondition,
canCreate(): boolean,
...
eventQueue?: string): void,
eventQueueScheduled(
name: string,
instance: servicenow$GlideRecord,
parm1: string,
parm2: string,
expiration: {[key: string]: any}): void,
...
declare type servicenow$RestHTTPMethods = "get"
| "post"
| "delete"
| "patch"
| "put"
