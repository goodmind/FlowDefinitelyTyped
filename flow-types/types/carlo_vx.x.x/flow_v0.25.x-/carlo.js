declare module "carlo" {
  import type { Serializable, Browser, Page } from "puppeteer-core";
   ...
   */
  declare export type EvaluateFunction = (
  ...
  declare export type AppEvent = "exit" | "window";
  declare export type WindowEvent = "close";
  ...
  declare export interface HttpRequest {
    /**
     * Aborts request.
   ...
   */
  declare export function launch(options?: LaunchOptions): Promise<App>;

  /**
   * Enters headless test mode.
   */
  declare export function enterTestMode(): void;
   ...
   */
  declare export function fileInfo(
    file: any
  ): Promise<{
    /**
   ...
   */
  declare export function loadParams(): Promise<$ReadOnlyArray<any>>;
}
