declare module 'enigma.js' {
        declare var e: IEnigmaClass;
	declare module.exports: typeof e

    }
declare interface IEnigmaClass {
 ...
 */
create(config: enigmaJS$enigmaJS$IConfig): enigmaJS$enigmaJS$ISession
} declare type enigmaJS$MixinType = "Doc" | "GenericObject" | "GenericBookmark" | string;

declare interface enigmaJS$IMixin {
 ...
 */
types: enigmaJS$MixinType[],
init(args: {
config: any,
api: enigmaJS$IGeneratedAPI
}): void,
...
declare interface enigmaJS$IResponseInterceptors {
 ...
 */
onRejected(session: enigmaJS$ISession, request: any, error: any): Promise<any>,
 ...
 */
onFulfilled(session: enigmaJS$ISession, request: any, result: any): Promise<any>
} 

declare interface enigmaJS$IRequestInterceptors {
 ...
 */
onFulfilled(session: enigmaJS$ISession, request: any, result: any): any
} 

declare interface enigmaJS$IProtocol {
delta?: boolean
} 
 ...
 */
declare interface enigmaJS$IConfig {
 ...
 */
requestInterceptors?: enigmaJS$IRequestInterceptors[],
 ...
 * Interceptors are applied in the array order.
 */
responseInterceptors?: enigmaJS$IResponseInterceptors[],
...
declare interface enigmaJS$ISession {
 ...
 * @return Promise.
 */
open<T: enigmaJS$IGeneratedAPI>(): Promise<T>,
