declare module 'gapi.youtube' {
        declare export interface youtube$activities {
...
declare export interface youtube$channelBanners {
...
declare export interface youtube$channels {
...
declare export interface youtube$guideCategories {
...
declare export interface youtube$playlistItems {
...
declare export interface youtube$playlists {
...
declare export interface youtube$search {
...
declare export interface youtube$subscriptions {
...
declare export interface youtube$thumbnails {
...
declare export interface youtube$videoCategories {
...
declare export interface youtube$videos {
 ...
 */
youtube$thumbnails: GoogleApiYouTubeThumbnailResource,
