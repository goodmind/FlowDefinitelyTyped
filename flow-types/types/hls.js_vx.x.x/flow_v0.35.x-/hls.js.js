declare module 'hls.js' {
        declare type K_MEDIA_ATTACHING = "hlsMediaAttaching";
	declare type K_MEDIA_ATTACHED = "hlsMediaAttached";
	declare type K_MEDIA_DETACHING = "hlsMediaDetaching";
	declare type K_MEDIA_DETACHED = "hlsMediaDetached";
	declare type K_BUFFER_RESET = "hlsBufferReset";
	declare type K_BUFFER_CODECS = "hlsBufferCodecs";
	declare type K_BUFFER_CREATED = "hlsBufferCreated";
	declare type K_BUFFER_APPENDING = "hlsBufferAppending";
	declare type K_BUFFER_APPENDED = "hlsBufferAppended";
	declare type K_BUFFER_EOS = "hlsBufferEOS";
	declare type K_BUFFER_FLUSHING = "hlsBufferFlushing";
	declare type K_BUFFER_FLUSHED = "hlsBufferFlushed";
	declare type K_MANIFEST_LOADING = "hlsManifestLoading";
	declare type K_MANIFEST_LOADED = "hlsManifestLoaded";
	declare type K_MANIFEST_PARSED = "hlsManifestParsed";
	declare type K_LEVEL_LOADING = "hlsLevelLoading";
	declare type K_LEVEL_LOADED = "hlsLevelLoaded";
	declare type K_LEVEL_UPDATED = "hlsLevelUpdated";
	declare type K_LEVEL_PTS_UPDATED = "hlsLevelPtsUpdated";
	declare type K_LEVEL_SWITCHING = "hlsLevelSwitching";
	declare type K_LEVEL_SWITCHED = "hlsLevelSwitched";
	declare type K_AUDIO_TRACKS_UPDATED = "hlsAudioTracksUpdated";
	declare type K_AUDIO_TRACK_SWITCH = "hlsAudioTrackSwitch";
	declare type K_AUDIO_TRACK_SWITCHING = "hlsAudioTrackSwitching";
	declare type K_AUDIO_TRACK_SWITCHED = "hlsAudioTrackSwitched";
	declare type K_AUDIO_TRACK_LOADING = "hlsAudioTrackLoading";
	declare type K_AUDIO_TRACK_LOADED = "hlsAudioTrackLoaded";
	declare type K_SUBTITLE_TRACKS_UPDATED = "hlsSubtitleTracksUpdated";
	declare type K_SUBTITLE_TRACK_SWITCH = "hlsSubtitleTrackSwitch";
	declare type K_SUBTITLE_TRACK_LOADING = "hlsSubtitleTrackLoading";
	declare type K_SUBTITLE_TRACK_LOADED = "hlsSubtitleTrackLoaded";
	declare type K_SUBTITLE_FRAG_PROCESSED = "hlsSubtitleFragProcessed";
	declare type K_KEY_LOADING = "hlsKeyLoading";
	declare type K_KEY_LOADED = "hlsKeyLoaded";
	declare type K_INIT_PTS_FOUND = "hlsInitPtsFound";
	declare type K_FRAG_LOADING = "hlsFragLoading";
	declare type K_FRAG_LOAD_PROGRESS = "hlsFragLoadProgress";
	declare type K_FRAG_LOAD_EMERGENCY_ABORTED = "hlsFragLoadEmergencyAborted";
	declare type K_FRAG_LOADED = "hlsFragLoaded";
	declare type K_FRAG_DECRYPTED = "hlsFragDecrypted";
	declare type K_FRAG_PARSING_INIT_SEGMENT = "hlsFragParsingInitSegment";
	declare type K_FRAG_PARSING_USERDATA = "hlsFragParsingUserData";
	declare type K_FRAG_PARSING_METADATA = "hlsFragParsingMetadata";
	declare type K_FRAG_PARSING_DATA = "hlsFragParsingData";
	declare type K_FRAG_PARSED = "hlsFragParsed";
	declare type K_FRAG_BUFFERED = "hlsFragBuffered";
	declare type K_FRAG_CHANGED = "hlsFragChanged";
	declare type K_FPS_DROP = "hlsFpsDrop";
	declare type K_FPS_DROP_LEVEL_CAPPING = "hlsFpsDropLevelCapping";
	declare type K_ERROR = "hlsError";
	declare type K_DESTROYING = "hlsDestroying";
	declare type K_STREAM_STATE_TRANSITION = "hlsStreamStateTransition";
	declare type K_NETWORK_ERROR = "networkError";
	declare type K_MEDIA_ERROR = "mediaError";
	declare type K_KEY_SYSTEM_ERROR = "keySystemError";
	declare type K_MUX_ERROR = "muxError";
	declare type K_OTHER_ERROR = "otherError";
	declare type K_MANIFEST_LOAD_ERROR = "manifestLoadError";
	declare type K_MANIFEST_LOAD_TIMEOUT = "manifestLoadTimeout";
	declare type K_MANIFEST_PARSING_ERROR = "manifestParsingError";
	declare type K_LEVEL_LOAD_ERROR = "levelLoadError";
	declare type K_LEVEL_LOAD_TIMEOUT = "levelLoadTimeout";
	declare type K_AUDIO_TRACK_LOAD_ERROR = "audioTrackLoadError";
	declare type K_AUDIO_TRACK_LOAD_TIMEOUT = "audioTrackLoadTimeout";
	declare type K_FRAG_LOAD_ERROR = "fragLoadError";
	declare type K_FRAG_LOAD_TIMEOUT = "fragLoadTimeout";
	declare type K_KEY_LOAD_ERROR = "keyLoadError";
	declare type K_KEY_LOAD_TIMEOUT = "keyLoadTimeout";
	declare type K_MANIFEST_INCOMPATIBLE_CODECS_ERROR = "manifestIncompatibleCodecsError";
	declare type K_FRAG_LOOP_LOADING_ERROR = "fragLoopLoadingError";
	declare type K_FRAG_DECRYPT_ERROR = "fragDecryptError";
	declare type K_FRAG_PARSING_ERROR = "fragParsingError";
	declare type K_BUFFER_ADD_CODEC_ERROR = "bufferAddCodecError";
	declare type K_BUFFER_APPEND_ERROR = "bufferAppendError";
	declare type K_BUFFER_APPENDING_ERROR = "bufferAppendingError";
	declare type K_BUFFER_STALLED_ERROR = "bufferStalledError";
	declare type K_BUFFER_FULL_ERROR = "bufferFullError";
	declare type K_BUFFER_SEEK_OVER_HOLE = "bufferSeekOverHole";
	declare type K_BUFFER_NUDGE_ON_STALL = "bufferNudgeOnStall";
	declare type K_REMUX_ALLOC_ERROR = "remuxAllocError";
	declare type K_LEVEL_SWITCH_ERROR = "levelSwitchError";
	declare type K_INTERNAL_EXCEPTION = "interalException";
	declare class Hls$Loader  {
constructor(config: Hls$LoaderConfig): this;
...
callbacks: Hls$LoaderCallbacks): void;
 ...
 */
declare interface Hls$AbrController {
 ...
 */
declare interface Hls$TimelineController {
...
declare interface Hls$LevelAttr {
[key: string]: string
} 
 ...
 */
declare interface Hls$LevelDetails {
 ...
 */
declare interface Hls$Fragment {
...
declare type Hls$CustomLogger = (...args: any[]) => void;

declare interface Hls$CustomLoggerObject {
warn?: Hls$CustomLogger,
info?: Hls$CustomLogger,
log?: Hls$CustomLogger,
debug?: Hls$CustomLogger,
error?: Hls$CustomLogger
} 

declare interface Hls$Config {
 ...
 */
debug: boolean | Hls$CustomLoggerObject,
...
declare interface Hls$mediaAttachingData {
video: HTMLVideoElement,
mediaSource: string
} 

declare interface Hls$mediaAttachedData {
video: HTMLVideoElement,
mediaSource: string
} 

declare interface Hls$bufferCodecsData {
tracks: Hls$Tracks
} 

declare interface Hls$bufferCreatedData {
tracks: Hls$Tracks
} 

declare interface Hls$bufferAppendingData {
segment: {}
} 

declare interface Hls$bufferAppendedData {
parent: {},
pending: number,
timeRanges: {
video: {},
...
declare interface Hls$bufferFlushingData {
startOffset: number,
endOffset: number
} 

declare interface Hls$bufferFlushedData {
startOffset: number,
endOffset: number
} 

declare interface Hls$manifestLoadingData {
url: string
} 

declare interface Hls$manifestLoadedData {
levels: number[],
audioTracks: number[],
url: string,
stats: Hls$Stats
...
declare interface Hls$manifestParsedData {
levels: number[],
firstLevel: number
} 

declare interface Hls$levelLoadingData {
url: string,
level: number
} 

declare interface Hls$levelLoadedData {
details: Hls$LevelDetails,
levelId: number,
stats: Hls$Stats
} 

declare interface Hls$levelUpdatedData {
details: Hls$LevelDetails,
level: number
} 

declare interface Hls$levelPtsUpdatedData {
details: Hls$LevelDetails,
level: number,
drift: number
} 

declare interface Hls$levelSwitchingData {
attrs: any,
audioCodec: string,
bitrate: number,
fragmentError: boolean,
...
declare interface Hls$levelSwitchedData {
level: number
} 

declare interface Hls$audioTracksUpdatedData {
audioTracks: AudioTrack[]
} 

declare interface Hls$audioTrackSwitchingData {
id: string
} 

declare interface Hls$audioTrackSwitchedData {
id: string
} 

declare interface Hls$audioTrackLoadingData {
url: string,
id: string
} 

declare interface Hls$audioTrackLoadedData {
details: Hls$LevelDetails,
id: string,
stats: Hls$Stats
} 

declare interface Hls$subtitleTracksUpdatedData {
subtitleTracks: {}
} 

declare interface Hls$subtitleTrackSwitchData {
id: string
} 

declare interface Hls$subtitleTrackLoadingData {
url: string,
id: string
} 

declare interface Hls$subtitleTrackLoadedData {
details: Hls$LevelDetails,
id: string,
stats: Hls$Stats
} 

declare interface Hls$subtitleFragProcessedData {
success: boolean,
frag: Hls$Fragment
} 

declare interface Hls$initPtsFoundData {
d: string,
initPTS: number,
frag: Hls$Fragment
} 

declare interface Hls$fragLoadingData {
frag: Hls$Fragment
} 

declare interface Hls$fragLoadProgressData {
frag: Hls$Fragment,
stats: Hls$Stats
} 

declare interface Hls$fragLoadEmergencyAbortedData {
frag: Hls$Fragment
} 

declare interface Hls$fragLoadedData {
frag: Hls$Fragment,
payload: any
} 

declare interface Hls$fragDecryptedData {
id: string,
frag: Hls$Fragment,
payload: any,
stats: Hls$Stats
...
declare interface Hls$fragParsingInitSegmentData {
id: string,
frag: Hls$Fragment,
moov: any,
codecs: any
...
declare interface Hls$fragParsingUserData {
id: string,
frag: Hls$Fragment,
samples: any[]
} 

declare interface Hls$fragParsingMetadata {
id: string,
frag: Hls$Fragment,
samples: any[]
} 

declare interface Hls$fragParsingData {
id: string,
frag: Hls$Fragment,
moof: any,
mdat: any,
...
declare interface Hls$fragParsedData {
id: string,
frag: Hls$Fragment
} 

declare interface Hls$fragBufferedData {
id: string,
frag: Hls$Fragment,
stats: Hls$Stats
} 

declare interface Hls$fragChangedData {
id: string,
frag: Hls$Fragment
} 

declare interface Hls$fpsDropData {
currentDropped: number,
currentDecoded: number,
totalDroppedFragmes: number
} 

declare interface Hls$fpsDropLevelCappingData {
level: Hls$Level,
droppedLevel: Hls$Level
} 

declare interface Hls$errorData {
type: string,
details: string,
fatal: boolean,
frag?: Hls$Fragment,
networkDetails?: XMLHttpRequest,
response?: Hls$LoaderError,
context?: Hls$LoaderContext,
levelRetry?: boolean,
url?: string,
loader?: Hls$Loader,
...
declare interface Hls$keyLoadingData {
frag: Hls$Fragment
} 

declare interface Hls$keyLoadedData {
frag: Hls$Fragment
} 

declare interface Hls$streamStateTransitionData {
previousState: any,
nextState: any
} 

declare interface Hls$LoaderConfig {
...
declare interface Hls$LoaderResponse {
url: string,
data: string | ArrayBuffer
} 

declare interface Hls$LoaderError {
...
declare interface Hls$LoaderContext {
...
declare interface Hls$LoaderStats {
...
declare interface Hls$LoaderCallbacks {
onSuccess(
response: Hls$LoaderResponse,
stats: Hls$LoaderStats,
context: Hls$LoaderContext): void,
onProgress(
stats: Hls$LoaderStats,
context: Hls$LoaderContext,
data: string | ArrayBuffer): void,
onError(error: Hls$LoaderError, context: Hls$LoaderContext): void,
onTimeout(stats: Hls$LoaderStats, context: Hls$LoaderContext): void
} 
	declare class Hls  {
 ...
 */
static DefaultConfig: Hls$Hls$Config;
 ...
 */
constructor(config?: $Shape<Hls$Hls$Config>): this;

/**
 * return array of available quality levels
 */
levels: Hls$Hls$Level[];
...
callback: (event: K_MEDIA_ATTACHING, data: Hls$Hls$mediaAttachedData) => void): void;
on(
event: K_MEDIA_ATTACHED,
callback: (event: K_MEDIA_ATTACHED, data: Hls$Hls$mediaAttachedData) => void): void;
on(
event: K_MEDIA_DETACHING,
callback: (event: K_MEDIA_DETACHING, data: {}) => void): void;
on(
event: K_MEDIA_DETACHED,
callback: (event: K_MEDIA_DETACHED, data: {}) => void): void;
on(
event: K_BUFFER_RESET,
callback: (event: K_BUFFER_RESET, data: {}) => void): void;
on(
event: K_BUFFER_CODECS,
callback: (event: K_BUFFER_CODECS, data: Hls$Hls$bufferCodecsData) => void): void;
on(
event: K_BUFFER_CREATED,
callback: (event: K_BUFFER_CREATED, data: Hls$Hls$bufferCreatedData) => void): void;
on(
event: K_BUFFER_APPENDING,
callback: (event: K_BUFFER_APPENDING, data: Hls$Hls$bufferAppendingData) => void): void;
on(
event: K_BUFFER_APPENDED,
callback: (event: K_BUFFER_APPENDED, data: Hls$Hls$bufferAppendedData) => void): void;
on(event: K_BUFFER_EOS, callback: (event: K_BUFFER_EOS, data: {}) => void): void;
on(
event: K_BUFFER_FLUSHING,
callback: (event: K_BUFFER_FLUSHING, data: Hls$Hls$bufferFlushingData) => void): void;
on(
event: K_BUFFER_FLUSHED,
callback: (event: K_BUFFER_FLUSHED, data: Hls$Hls$bufferFlushedData) => void): void;
on(
event: K_MANIFEST_LOADING,
callback: (event: K_MANIFEST_LOADING, data: Hls$Hls$manifestLoadingData) => void): void;
on(
event: K_MANIFEST_LOADED,
callback: (event: K_MANIFEST_LOADED, data: Hls$Hls$manifestLoadedData) => void): void;
on(
event: K_MANIFEST_PARSED,
callback: (event: K_MANIFEST_PARSED, data: Hls$Hls$manifestParsedData) => void): void;
on(
event: K_LEVEL_SWITCHING,
callback: (event: K_LEVEL_SWITCHING, data: Hls$Hls$levelSwitchingData) => void): void;
on(
event: K_LEVEL_SWITCHED,
callback: (event: K_LEVEL_SWITCHED, data: Hls$Hls$levelSwitchedData) => void): void;
on(
event: K_LEVEL_LOADING,
callback: (event: K_LEVEL_LOADING, data: Hls$Hls$levelLoadingData) => void): void;
on(
event: K_LEVEL_LOADED,
callback: (event: K_LEVEL_LOADED, data: Hls$Hls$levelLoadedData) => void): void;
on(
event: K_LEVEL_UPDATED,
callback: (event: K_LEVEL_UPDATED, data: Hls$Hls$levelUpdatedData) => void): void;
on(
event: K_LEVEL_PTS_UPDATED,
callback: (event: K_LEVEL_PTS_UPDATED, data: Hls$Hls$levelPtsUpdatedData) => void): void;
on(
event: K_AUDIO_TRACKS_UPDATED,
callback: (event: K_AUDIO_TRACKS_UPDATED, data: Hls$Hls$audioTracksUpdatedData) => void): void;
on(
event: K_AUDIO_TRACK_SWITCHING,
callback: (event: K_AUDIO_TRACK_SWITCHING, data: Hls$Hls$audioTrackSwitchingData) => void): void;
on(
event: K_AUDIO_TRACK_SWITCHED,
callback: (event: K_AUDIO_TRACK_SWITCHED, data: Hls$Hls$audioTrackSwitchedData) => void): void;
on(
event: K_AUDIO_TRACK_LOADING,
callback: (event: K_AUDIO_TRACK_LOADING, data: Hls$Hls$audioTrackLoadingData) => void): void;
on(
event: K_AUDIO_TRACK_LOADED,
callback: (event: K_AUDIO_TRACK_LOADED, data: Hls$Hls$audioTrackLoadedData) => void): void;
on(
event: K_SUBTITLE_TRACKS_UPDATED,
callback: (
event: K_SUBTITLE_TRACKS_UPDATED,
data: Hls$Hls$subtitleTracksUpdatedData) => void): void;
on(
event: K_SUBTITLE_TRACK_SWITCH,
callback: (event: K_SUBTITLE_TRACK_SWITCH, data: Hls$Hls$subtitleTrackSwitchData) => void): void;
on(
event: K_SUBTITLE_TRACK_LOADING,
callback: (
event: K_SUBTITLE_TRACK_LOADING,
data: Hls$Hls$subtitleTrackLoadingData) => void): void;
on(
event: K_SUBTITLE_TRACK_LOADED,
callback: (event: K_SUBTITLE_TRACK_LOADED, data: Hls$Hls$subtitleTrackLoadedData) => void): void;
on(
event: K_SUBTITLE_FRAG_PROCESSED,
callback: (
event: K_SUBTITLE_FRAG_PROCESSED,
data: Hls$Hls$subtitleFragProcessedData) => void): void;
on(
event: K_INIT_PTS_FOUND,
callback: (event: K_INIT_PTS_FOUND, data: Hls$Hls$initPtsFoundData) => void): void;
on(
event: K_FRAG_LOADING,
callback: (event: K_FRAG_LOADING, data: Hls$Hls$fragLoadingData) => void): void;
on(
event: K_FRAG_LOAD_PROGRESS,
callback: (event: K_FRAG_LOAD_PROGRESS, data: Hls$Hls$fragLoadProgressData) => void): void;
on(
event: K_FRAG_LOAD_EMERGENCY_ABORTED,
callback: (
event: K_FRAG_LOAD_EMERGENCY_ABORTED,
data: Hls$Hls$fragLoadEmergencyAbortedData) => void): void;
on(
event: K_FRAG_LOADED,
callback: (event: K_FRAG_LOADED, data: Hls$Hls$fragLoadedData) => void): void;
on(
event: K_FRAG_DECRYPTED,
callback: (event: K_FRAG_DECRYPTED, data: Hls$Hls$fragDecryptedData) => void): void;
on(
event: K_FRAG_PARSING_INIT_SEGMENT,
callback: (
event: K_FRAG_PARSING_INIT_SEGMENT,
data: Hls$Hls$fragParsingInitSegmentData) => void): void;
on(
event: K_FRAG_PARSING_USERDATA,
callback: (event: K_FRAG_PARSING_USERDATA, data: Hls$Hls$fragParsingUserData) => void): void;
on(
event: K_FRAG_PARSING_METADATA,
callback: (event: K_FRAG_PARSING_METADATA, data: Hls$Hls$fragParsingMetadata) => void): void;
on(
event: K_FRAG_PARSING_DATA,
callback: (event: K_FRAG_PARSING_DATA, data: Hls$Hls$fragParsingData) => void): void;
on(
event: K_FRAG_PARSED,
callback: (event: K_FRAG_PARSED, data: Hls$Hls$fragParsedData) => void): void;
on(
event: K_FRAG_BUFFERED,
callback: (event: K_FRAG_BUFFERED, data: Hls$Hls$fragBufferedData) => void): void;
on(
event: K_FRAG_CHANGED,
callback: (event: K_FRAG_CHANGED, data: Hls$Hls$fragChangedData) => void): void;
on(
event: K_FPS_DROP,
callback: (event: K_FPS_DROP, data: Hls$Hls$fpsDropData) => void): void;
on(
event: K_FPS_DROP_LEVEL_CAPPING,
callback: (event: K_FPS_DROP_LEVEL_CAPPING, data: Hls$Hls$fpsDropLevelCappingData) => void): void;
on(
event: K_ERROR,
callback: (event: K_ERROR, data: Hls$Hls$errorData) => void): void;
on(event: K_DESTROYING, callback: (event: K_DESTROYING, data: {}) => void): void;
on(
event: K_KEY_LOADING,
callback: (event: K_KEY_LOADING, data: Hls$Hls$keyLoadingData) => void): void;
on(
event: K_KEY_LOADED,
callback: (event: K_KEY_LOADED, data: Hls$Hls$keyLoadedData) => void): void;
on(
event: K_STREAM_STATE_TRANSITION,
callback: (
event: K_STREAM_STATE_TRANSITION,
data: Hls$Hls$streamStateTransitionData) => void): void;
...
off(event: string, callback: (...params: any[]) => void): void
	...
	declare module.exports: typeof Hls
