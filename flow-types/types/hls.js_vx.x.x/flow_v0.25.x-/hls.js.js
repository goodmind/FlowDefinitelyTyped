declare module "hls.js" {
  ...
  declare type K_MANIFEST_INCOMPATIBLE_CODECS_ERROR =
  ...
  declare class Hls {
    ...
    on(
      ...
      callback: (
        event: K_MEDIA_ATTACHING,
        data: Hls$Hls$mediaAttachedData
      ) => void
    ): void;
    on(
    ...
    on(
      ...
      callback: (event: K_BUFFER_CODECS, data: Hls$Hls$bufferCodecsData) => void
    ): void;
    on(
      event: K_BUFFER_CREATED,
      callback: (
        event: K_BUFFER_CREATED,
        data: Hls$Hls$bufferCreatedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_BUFFER_APPENDING,
        data: Hls$Hls$bufferAppendingData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_BUFFER_APPENDED,
        data: Hls$Hls$bufferAppendedData
      ) => void
    ): void;
    on(
      event: K_BUFFER_EOS,
    ...
    on(
      ...
      callback: (
        event: K_BUFFER_FLUSHING,
        data: Hls$Hls$bufferFlushingData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_BUFFER_FLUSHED,
        data: Hls$Hls$bufferFlushedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_MANIFEST_LOADING,
        data: Hls$Hls$manifestLoadingData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_MANIFEST_LOADED,
        data: Hls$Hls$manifestLoadedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_MANIFEST_PARSED,
        data: Hls$Hls$manifestParsedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_LEVEL_SWITCHING,
        data: Hls$Hls$levelSwitchingData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_LEVEL_SWITCHED,
        data: Hls$Hls$levelSwitchedData
      ) => void
    ): void;
    on(
      event: K_LEVEL_LOADING,
      callback: (event: K_LEVEL_LOADING, data: Hls$Hls$levelLoadingData) => void
    ): void;
    on(
      event: K_LEVEL_LOADED,
      callback: (event: K_LEVEL_LOADED, data: Hls$Hls$levelLoadedData) => void
    ): void;
    on(
      event: K_LEVEL_UPDATED,
      callback: (event: K_LEVEL_UPDATED, data: Hls$Hls$levelUpdatedData) => void
    ): void;
    on(
      event: K_LEVEL_PTS_UPDATED,
      callback: (
        event: K_LEVEL_PTS_UPDATED,
        data: Hls$Hls$levelPtsUpdatedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_AUDIO_TRACKS_UPDATED,
        data: Hls$Hls$audioTracksUpdatedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_AUDIO_TRACK_SWITCHING,
        data: Hls$Hls$audioTrackSwitchingData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_AUDIO_TRACK_SWITCHED,
        data: Hls$Hls$audioTrackSwitchedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_AUDIO_TRACK_LOADING,
        data: Hls$Hls$audioTrackLoadingData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_AUDIO_TRACK_LOADED,
        data: Hls$Hls$audioTrackLoadedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_SUBTITLE_TRACKS_UPDATED,
        data: Hls$Hls$subtitleTracksUpdatedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_SUBTITLE_TRACK_SWITCH,
        data: Hls$Hls$subtitleTrackSwitchData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_SUBTITLE_TRACK_LOADING,
        data: Hls$Hls$subtitleTrackLoadingData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_SUBTITLE_TRACK_LOADED,
        data: Hls$Hls$subtitleTrackLoadedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_SUBTITLE_FRAG_PROCESSED,
        data: Hls$Hls$subtitleFragProcessedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_INIT_PTS_FOUND,
        data: Hls$Hls$initPtsFoundData
      ) => void
    ): void;
    on(
      event: K_FRAG_LOADING,
      callback: (event: K_FRAG_LOADING, data: Hls$Hls$fragLoadingData) => void
    ): void;
    on(
      event: K_FRAG_LOAD_PROGRESS,
      callback: (
        event: K_FRAG_LOAD_PROGRESS,
        data: Hls$Hls$fragLoadProgressData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_FRAG_LOAD_EMERGENCY_ABORTED,
        data: Hls$Hls$fragLoadEmergencyAbortedData
      ) => void
    ): void;
    on(
      event: K_FRAG_LOADED,
      callback: (event: K_FRAG_LOADED, data: Hls$Hls$fragLoadedData) => void
    ): void;
    on(
      event: K_FRAG_DECRYPTED,
      callback: (
        event: K_FRAG_DECRYPTED,
        data: Hls$Hls$fragDecryptedData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_FRAG_PARSING_INIT_SEGMENT,
        data: Hls$Hls$fragParsingInitSegmentData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_FRAG_PARSING_USERDATA,
        data: Hls$Hls$fragParsingUserData
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_FRAG_PARSING_METADATA,
        data: Hls$Hls$fragParsingMetadata
      ) => void
    ): void;
    on(
      ...
      callback: (
        event: K_FRAG_PARSING_DATA,
        data: Hls$Hls$fragParsingData
      ) => void
    ): void;
    on(
      event: K_FRAG_PARSED,
      callback: (event: K_FRAG_PARSED, data: Hls$Hls$fragParsedData) => void
    ): void;
    on(
      event: K_FRAG_BUFFERED,
      callback: (event: K_FRAG_BUFFERED, data: Hls$Hls$fragBufferedData) => void
    ): void;
    on(
      event: K_FRAG_CHANGED,
      callback: (event: K_FRAG_CHANGED, data: Hls$Hls$fragChangedData) => void
    ): void;
    on(
      event: K_FPS_DROP,
      callback: (event: K_FPS_DROP, data: Hls$Hls$fpsDropData) => void
    ): void;
    on(
      event: K_FPS_DROP_LEVEL_CAPPING,
      callback: (
        event: K_FPS_DROP_LEVEL_CAPPING,
        data: Hls$Hls$fpsDropLevelCappingData
      ) => void
    ): void;
    on(
      event: K_ERROR,
      callback: (event: K_ERROR, data: Hls$Hls$errorData) => void
    ): void;
    on(
      event: K_DESTROYING,
    ...
    on(
      event: K_KEY_LOADING,
      callback: (event: K_KEY_LOADING, data: Hls$Hls$keyLoadingData) => void
    ): void;
    on(
      event: K_KEY_LOADED,
      callback: (event: K_KEY_LOADED, data: Hls$Hls$keyLoadedData) => void
    ): void;
    on(
      event: K_STREAM_STATE_TRANSITION,
      callback: (
        event: K_STREAM_STATE_TRANSITION,
        data: Hls$Hls$streamStateTransitionData
      ) => void
    ): void;
