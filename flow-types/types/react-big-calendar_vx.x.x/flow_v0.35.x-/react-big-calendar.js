declare module 'react-big-calendar' {
	...
	declare export type DayPropGetter = (date: Date) => {
className?: string,
...
style?: React.CSSProperties
	...
	declare export type SlotPropGetter = (date: Date) => {
className?: string,
style?: React.CSSProperties
};
	declare export type stringOrDate = string | Date;
	declare export type ViewKey = "MONTH"
| "WEEK"
| "WORK_WEEK"
| "DAY"
| "AGENDA";
	declare export type View = "month"
| "week"
| "work_week"
| "day"
| "agenda";
	declare export type Views = View[] | {
...
start: Date,
	...
	declare export type DateFormatFunction = (date: Date, culture?: string, localizer?: {[key: string]: any}) => string;
	declare export type DateRangeFormatFunction = (range: DateRange, culture?: string, localizer?: {[key: string]: any}) => string;
...
children?: React.ReactNode
	...
	declare export interface EventWrapperProps<T: Event> {
style?: React.CSSProperties & {
xOffset: number
},
className: string,
...
format(value: FormatInput, format: string, culture: Culture): string
	...
	declare export type BigCalendarProps<TEvent: Event, TResource: {[key: string]: any}> = {
localizer: DateLocalizer,
date?: stringOrDate,
now?: Date,
view?: View,
...
resourceTitleAccessor?: $Keys<TResource> | ((resource: TResource) => string),
defaultView?: View,
defaultDate?: Date,
className?: string,
...
today: Date
	...
	declare export default class BigCalendar<TEvent: Event, TResource: {[key: string]: any}> mixins React.Component<BigCalendarProps<TEvent, TResource>> {
components: {
 ...
 */
static globalizeLocalizer(globalizeInstance: {[key: string]: any}): DateLocalizer;

/**
 * create DateLocalizer from a moment
 */
static momentLocalizer(momentInstance: {[key: string]: any}): DateLocalizer;
