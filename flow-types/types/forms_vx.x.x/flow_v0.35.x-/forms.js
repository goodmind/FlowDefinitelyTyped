...
[key: string]: string | FieldObjectChoice
	...
	declare export type FieldArrayChoice = {} & Array<[string, string | FieldArrayChoice]>
...
legendClasses?: string[]
	...
	declare export type FieldIterator = (name: string, field: FieldBound) => string;
 ...
 */
declare export type ValidatorFunction = (form: FormBound, field: FieldBound, callback: (err?: string) => void) => void;
...
declare function validators$alphanumeric(errorMessage?: string): ValidatorFunction
...
declare function validators$matchField(matchedField: string, errorMessage?: string): ValidatorFunction


declare function validators$matchValue(valueGetter: () => any, errorMessage?: string): ValidatorFunction


declare function validators$max(value: number, errorMessage?: string): ValidatorFunction


declare function validators$maxlength(value: number, errorMessage?: string): ValidatorFunction


declare function validators$min(value: number, errorMessage?: string): ValidatorFunction


declare function validators$minlength(value: number, errorMessage?: string): ValidatorFunction
...
declare function validators$regexp(validators$regexp: RegExp, errorMessage?: string): ValidatorFunction


declare function validators$required(errorMessage?: string): ValidatorFunction


declare function validators$requiresFieldIfEmpty(alternateField: string, errorMessage?: string): ValidatorFunction
...
declare function widgets$textarea(params?: WidgetParameters & {
rows?: number,
cols?: number
}): Widget
