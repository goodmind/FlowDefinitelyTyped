...
props?: FalcorJsonGraph$FalcorJsonGraph$Sentinel): FalcorJsonGraph$FalcorJsonGraph$Reference


declare function FalcorJsonGraph$atom(
value: any,
props?: FalcorJsonGraph$FalcorJsonGraph$Sentinel): FalcorJsonGraph$FalcorJsonGraph$Atom


declare function FalcorJsonGraph$error(
errorValue: any,
props?: FalcorJsonGraph$FalcorJsonGraph$Sentinel): FalcorJsonGraph$FalcorJsonGraph$Error


declare function FalcorJsonGraph$pathValue(
path: string | FalcorJsonGraph$FalcorJsonGraph$PathSet,
value: any): FalcorJsonGraph$FalcorJsonGraph$PathValue


declare function FalcorJsonGraph$pathInvalidation(
path: string | FalcorJsonGraph$FalcorJsonGraph$PathSet): FalcorJsonGraph$FalcorJsonGraph$InvalidPath
