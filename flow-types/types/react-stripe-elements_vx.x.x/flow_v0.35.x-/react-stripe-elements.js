...
createSource(
sourceData?: ReactStripeElements$SourceOptions): Promise<ReactStripeElements$SourceResponse>,
createToken(
options?: ReactStripeElements$TokenOptions): Promise<ReactStripeElements$PatchedTokenResponse>,
...
onReady(el: ReactStripeElements$HTMLStripeElement): void
	...
	declare export class StripeProvider mixins React.Component<ReactStripeElements$ReactStripeElements$StripeProviderProps> {}
	declare export class Elements mixins React.Component<stripe.elements.ElementsCreateOptions> {}
	declare export function injectStripe<P: {[key: string]: any}>(
WrappedComponent: React.ComponentType<P & ReactStripeElements$ReactStripeElements$InjectedStripeProps>,
componentOptions?: ReactStripeElements$ReactStripeElements$InjectOptions): React.ComponentType<P>

	declare export class CardElement mixins React.Component<ReactStripeElements$ReactStripeElements$ElementProps> {}
	declare export class CardNumberElement mixins React.Component<ReactStripeElements$ReactStripeElements$ElementProps> {}
	declare export class CardExpiryElement mixins React.Component<ReactStripeElements$ReactStripeElements$ElementProps> {}
	declare export class CardCVCElement mixins React.Component<ReactStripeElements$ReactStripeElements$ElementProps> {}
	declare export class PostalCodeElement mixins React.Component<ReactStripeElements$ReactStripeElements$ElementProps> {}
	declare export class PaymentRequestButtonElement mixins React.Component<ReactStripeElements$ReactStripeElements$ElementProps> {}
	declare export class IbanElement mixins React.Component<ReactStripeElements$ReactStripeElements$ElementProps> {}
	declare export class IdealBankElement mixins React.Component<ReactStripeElements$ReactStripeElements$ElementProps> {}
    }
