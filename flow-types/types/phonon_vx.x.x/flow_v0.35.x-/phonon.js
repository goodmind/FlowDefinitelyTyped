...
title?: string,
cancelable?: boolean,
textOk?: string): Phonon$PhononDialogComponent,
confirm(
text: string,
title?: string,
cancelable?: boolean,
textOk?: string,
textCancel?: string): Phonon$PhononDialogComponent,
prompt(
text: string,
title?: string,
cancelable?: boolean,
textOk?: string,
textCancel?: string): Phonon$PhononDialogComponent,
indicator(title: string, cancelable?: boolean): Phonon$PhononIndicatorComponent,
dialog(id: string): Phonon$PhononCustomDialogComponent,
notif(
textOrId: string,
timeout?: number,
showButton?: boolean,
textButton?: string): Phonon$PhononNotifComponent,
...
callback?: (activity: Phonon$PhononActivity) => void): void,
 ...
 * * Ajax **
 */
declare type Phonon$PhononAjaxErrorFlag = "NO_INTERNET_ACCESS"
| "TIMEOUT_EXCEEDED"
...
error(res: any, flagError: Phonon$PhononAjaxErrorFlag, xhr: XMLHttpRequest): void
} 
...
declare type Phonon$PhononPopoverDirection = "left" | "title-left" | "right" | "title";
...
on(event: string, callback: (value?: any) => void): Phonon$PhononDialogComponent
} 
...
setList(list: string[] | Phonon$PhononPopoverItem[]): Phonon$PhononPopoverComponent,
setList(list: any[], itemBuilder?: (item: any) => void): Phonon$PhononPopoverComponent,
attachButton(element: string | Element, autoBind?: boolean): Phonon$PhononPopoverComponent,
open(direction: Phonon$PhononPopoverDirection): Phonon$PhononPopoverComponent,
openFrom(element: string | Element): Phonon$PhononPopoverComponent,
close(): void,
onItemChanged(
callback: (data: Phonon$PhononPopoverItem) => void): Phonon$PhononPopoverComponent
} 
