 ...
 */
static DEFAULT_COMPARATOR: PriorityQueue$PriorityQueue$Comparator<number | string>;
 ...
 */
constructor(comparator: PriorityQueue$PriorityQueue$Comparator<T>): this;
...
size(): number
	...
	declare export interface PriorityQueue$Comparator<T> {
(a: T, b: T): number
} 
