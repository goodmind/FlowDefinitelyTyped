...
declare type esri$Basemaps = "Streets"
| "Topographic"
| "NationalGeographic"
| "Oceans"
| "Gray"
...
declare type esri$LeafletGeometry = L.Marker
| L.Polygon
| L.Polyline
| L.LatLngExpression
| L.LatLngBounds
...
declare type esri$GeoJSONGeometry = GeoJSON.Point | GeoJSON.Polygon | GeoJSON.LineString;
 ...
 * The Terms of Use for Esri hosted services apply to all Leaflet applications.
 */
declare function esri$basemapLayer(key: esri$Basemaps, options?: esri$BasemapLayerOptions): esri$BasemapLayer
...
} & L.TileLayerOptions & esri$LayerOptionsBase
 ...
 * service is added to map attribution automatically.
 */
declare function esri$tiledMapLayer(options: esri$TiledMapLayerOptions): esri$TiledMapLayer
...
} & esri$RasterLayerOptions & esri$LayerOptionsBase
 ...
 */
declare class esri$DynamicMapLayer mixins esri$RasterLayer {
 ...
 * return false.
 */
bindPopup(fn: esri$FeatureCallbackHandler, popupOptions?: L.PopupOptions): this;
bindPopup(
 ...
 * identifying individual features.
 */
declare function esri$dynamicMapLayer(options: esri$DynamicMapLayerOptions): esri$DynamicMapLayer
 ...
 */
setFeatureStyle(id: string | number, style: L.PathOptions | esri$StyleCallback): this;
 ...
 */
setWhere(where: string, callback?: esri$FeatureCallbackHandler, context?: any): this;
 ...
 */
addFeature(feature: any, callback?: esri$ResponseCallbackHandler, context?: any): this;
 ...
 */
updateFeature(feature: any, callback?: esri$ResponseCallbackHandler, context?: any): this;
 ...
 * JavaScript.
 */
declare function esri$featureLayer(options: esri$FeatureLayerOptions): esri$FeatureLayer


declare type esri$FeatureCallbackHandler = (error?: any, featureCollection?: any, response?: any) => void;

declare type esri$ResponseCallbackHandler = (error?: any, response?: any) => void;
 ...
 */
declare type esri$MapServiceOptions = {} & esri$ServiceOptions
 ...
 */
declare class esri$MapService mixins esri$Service {
 ...
 * Server that allows you to make requests to the API, as well as query and identify published features.
 */
declare function esri$mapService(options: esri$MapServiceOptions): esri$MapService
 ...
 * Options for Task
 */
declare type esri$TaskOptions = {} & esri$ServiceOptions
 ...
 * ArcGIS Server Services like query, find and identify.
 */
declare function esri$task(options: esri$TaskOptions | esri$Service): esri$Task
 ...
 */
declare type esri$ImageServiceOptions = {} & esri$ServiceOptions
 ...
 * service.
 */
declare class esri$ImageService mixins esri$Service {
 ...
 * service.
 */
declare function esri$imageService(options: esri$ImageServiceOptions): esri$ImageService
 ...
 */
declare type esri$FeatureLayerServiceOptions = {} & esri$ServiceOptions
 ...
 */
declare class esri$FeatureLayerService mixins esri$Service {
 ...
 * features from the service.
 */
declare function esri$featureLayerService(options: esri$FeatureLayerServiceOptions): esri$FeatureLayerService
 ...
 * Options for Query
 */
declare type esri$QueryOptions = {} & esri$TaskOptions
 ...
 */
declare class esri$Query mixins esri$Task {
 ...
 */
declare type esri$IdentifyFeaturesOptions = {} & esri$ServiceOptions
 ...
 */
declare class esri$IdentifyFeatures mixins esri$Task {
constructor(options: esri$IdentifyFeaturesOptions | esri$ImageService): this;
...
options: esri$IdentifyFeaturesOptions | esri$ImageService): esri$IdentifyFeatures
 ...
 */
declare type esri$FindOptions = {} & esri$ServiceOptions
 ...
 */
declare class esri$Find mixins esri$Task {
 ...
 * building request parameters and executing find tasks.
 */
declare function esri$find(options: esri$FindOptions | esri$MapService): esri$Find
