declare module 'CANNON' {
        declare export interface IAABBOptions {
upperBound?: Vec3,
lowerBound?: Vec3
} 
...
lowerBound: Vec3;
upperBound: Vec3;
constructor(options?: IAABBOptions): this;
clone(): AABB;
copy(aabb: AABB): void;
...
aabbMax: Vec3;
bins: any[];
constructor(aabbMin?: Vec3, aabbMax?: Vec3, nx?: number, ny?: number, nz?: number): this
}
	declare export class NaiveBroadphase mixins BroadPhase {}
	declare export class ObjectCollisionMatrix  {
matrix: number[];
get(i: number, j: number): number;
set(i: number, j: number, value: number): void;
reset(): void;
...
constructor(from?: Vec3, to?: Vec3): this;
getAABB(result: RaycastResult): void
}
	declare export class RaycastResult  {
rayFromWorld: Vec3;
rayToWorld: Vec3;
hitNormalWorld: Vec3;
hitPointWorld: Vec3;
...
aabbQuery(world: World, aabb: AABB, result?: Body[]): Body[]
	...
	declare export interface IConstraintOptions {
...
id: number;
collideConnected: boolean;
constructor(bodyA: Body, bodyB: Body, options?: IConstraintOptions): this;
update(): void;
disable(): void;
enable(): void
}
	declare export class DistanceConstraint mixins Constraint {
constructor(bodyA: Body, bodyB: Body, distance: number, maxForce?: number): this
}
	declare export interface IHingeConstraintOptions {
pivotA?: Vec3,
axisA?: Vec3,
pivotB?: Vec3,
axisB?: Vec3,
...
constructor(bodyA: Body, bodyB: Body, options?: IHingeConstraintOptions): this;
enableMotor(): void;
disableMotor(): void
}
	declare export class PointToPointConstraint mixins Constraint {
constructor(bodyA: Body, pivotA: Vec3, bodyB: Body, pivotB: Vec3, maxForce?: number): this
}
	declare export interface ILockConstraintOptions {
maxForce?: number
} 
	declare export class LockConstraint mixins Constraint {
constructor(bodyA: Body, bodyB: Body, options?: ILockConstraintOptions): this
}
	declare export interface IConeTwistConstraintOptions {
pivotA?: Vec3,
pivotB?: Vec3,
axisA?: Vec3,
axisB?: Vec3,
...
constructor(bodyA: Body, bodyB: Body, options?: IConeTwistConstraintOptions): this
}
...
enabled: boolean;
constructor(bi: Body, bj: Body, minForce?: number, maxForce?: number): this;
...
constructor(bi: Body, bj: Body, slipForce: number): this
}
	declare export class RotationalEquation mixins Equation {
ni: Vec3;
nj: Vec3;
nixnj: Vec3;
njxni: Vec3;
...
constructor(bodyA: Body, bodyB: Body): this
	...
	declare export class RotationalMotorEquation mixins Equation {
axisA: Vec3;
axisB: Vec3;
invLi: Mat3;
invIj: Mat3;
targetVelocity: number;
constructor(bodyA: Body, bodyB: Body, maxForce?: number): this
}
...
constructor(bi: Body, bj: Body): this
}
	declare export interface IContactMaterialOptions {
friction?: number,
restitution?: number,
...
frictionEquationStiffness: number;
frictionEquationRelaxation: number;
constructor(m1: Material, m2: Material, options?: IContactMaterialOptions): this
}
...
clone(): Vec3
	...
	declare export interface IBodyOptions {
position?: Vec3,
velocity?: Vec3,
...
shape?: Shape
	...
	declare export class Body mixins EventTarget {
...
wlambda: Vec3;
constructor(options?: IBodyOptions): this;
wakeUp(): void;
sleep(): void;
...
getVelocityAtWorldPoint(worldPoint: Vec3, result: Vec3): Vec3
	...
	declare export interface IRaycastVehicleOptions {
chassisBody?: Body,
indexRightAxis?: number,
indexLeftAxis?: number,
indexUpAxis?: number
} 
	declare export interface IWheelInfoOptions {
...
body?: Body
	...
	declare export class WheelInfo  {
...
isInContact: boolean;
constructor(options?: IWheelInfoOptions): this
}
	declare export class RaycastVehicle  {
chassisBody: Body;
...
indexUpAxis: number;
constructor(options?: IRaycastVehicleOptions): this;
...
getWheelTransformWorld(wheelIndex: number): Transform
	...
	declare export interface IRigidVehicleOptions {
chassisBody: Body
} 
	declare export class RigidVehicle  {
wheelBodies: Body[];
...
wheelAxes: Vec3[];
wheelForces: Vec3[];
constructor(options?: IRigidVehicleOptions): this;
...
getWheelSpeed(wheelIndex: number): number
	...
	declare export class SPHSystem  {
particles: Particle[];
density: number;
...
localAnchorA: Vec3;
localAnchorB: Vec3;
constructor(options?: ISpringOptions): this;
...
constructor(halfExtents: Vec3): this;
...
forEachWorldCorner(pos: Vec3, quat: Quaternion, callback: Function): void
	...
	declare export class ConvexPolyhedron mixins Shape {
...
faceNormals: Vec3[];
uniqueEdges: Vec3[];
constructor(points?: Vec3[], faces?: number[]): this;
computeEdges(): void;
computeNormals(): void;
...
pointIsInside(p: Vec3): boolean
	...
	declare export class Cylinder mixins Shape {
constructor(radiusTop: number, radiusBottom: number, height: number, numSegments: number): this
}
	declare export interface IHightfield {
minValue?: number,
maxValue?: number,
elementSize: number
} 
...
pillarOffset: Vec3;
type: number;
constructor(data: number[], options?: IHightfield): this;
update(): void;
updateMinValue(): void;
updateMaxValue(): void;
...
calculateLocalInertia(mass: number, target: Vec3): Vec3
	...
	declare export class Sphere mixins Shape {
radius: number;
...
removeAllEquations(): void
	...
	declare export class SplitSolver mixins Solver {
subsolver: Solver;
constructor(subsolver: Solver): this;
solve(dy: number, world: World): number
}
...
static defaults(options?: any, defaults?: any): any
	...
	declare export class Vec3Pool mixins Pool {
type: any;
...
v3pool: Vec3Pool
	...
	declare export class World mixins EventTarget {
iterations: number;
dt: number;
allowSleep: boolean;
...
type: string
	...
	declare export type IBodyEvent = {
body: Body
} & IEvent

	declare export type ICollisionEvent = {
contact: any
} & IBodyEvent

    }
declare module 'cannon' {
        declare module.exports: typeof CANNON
