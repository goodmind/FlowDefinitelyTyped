...
modem: any;
id: string;
inspect(options: {}, callback: Callback<Dockerode$ContainerInspectInfo>): void;
...
declare type Dockerode$LoggingDriverType = "json-file"
| "syslog"
| "journald"
| "gelf"
| "fluentd"
...
declare type Dockerode$MountConsistency = "default" | "consistent" | "cached" | "delegated";

declare type Dockerode$MountPropagation = "private"
| "rprivate"
| "shared"
| "rshared"
| "slave"
...
callback: Callback<Dockerode$Dockerode$Container>): void;
createContainer(
options: Dockerode$Dockerode$ContainerCreateOptions): Promise<Dockerode$Dockerode$Container>;
...
buildImage(
file: string | NodeJS.ReadableStream | Dockerode$Dockerode$ImageBuildContext,
options: {},
callback: Callback<NodeJS.ReadableStream>): void;
buildImage(
file: string | NodeJS.ReadableStream | Dockerode$Dockerode$ImageBuildContext,
...
listContainers(options: {}, callback: Callback<Dockerode$Dockerode$ContainerInfo[]>): void;
listContainers(callback: Callback<Dockerode$Dockerode$ContainerInfo[]>): void;
listContainers(options?: {}): Promise<Dockerode$Dockerode$ContainerInfo[]>;
listImages(options: {}, callback: Callback<Dockerode$Dockerode$ImageInfo[]>): void;
...
listSecrets(options: {}, callback: Callback<Dockerode$Dockerode$SecretInfo[]>): void;
...
listPlugins(options: {}, callback: Callback<Dockerode$Dockerode$PluginInfo[]>): void;
...
pruneImages(options: {}, callback: Callback<Dockerode$Dockerode$PruneImagesInfo>): void;
...
pruneContainers(options: {}, callback: Callback<Dockerode$Dockerode$PruneContainersInfo>): void;
pruneContainers(callback: Callback<Dockerode$Dockerode$PruneContainersInfo>): void;
pruneContainers(options?: {}): Promise<Dockerode$Dockerode$PruneContainersInfo>;
pruneVolumes(options: {}, callback: Callback<Dockerode$Dockerode$PruneVolumesInfo>): void;
pruneVolumes(callback: Callback<Dockerode$Dockerode$PruneVolumesInfo>): void;
pruneVolumes(options?: {}): Promise<Dockerode$Dockerode$PruneVolumesInfo>;
pruneNetworks(options: {}, callback: Callback<Dockerode$Dockerode$PruneNetworksInfo>): void;
pruneNetworks(callback: Callback<Dockerode$Dockerode$PruneNetworksInfo>): void;
...
auth?: {}): Dockerode$Dockerode$Image;
