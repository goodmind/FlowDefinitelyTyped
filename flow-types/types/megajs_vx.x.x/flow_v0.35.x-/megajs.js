...
cb: (err: Error | void, file: MutableFile) => void): Readable;
...
cb: (err: Error | void, url: string) => void): Readable;
shareFolder(
options: LinkOptions | void,
cb: (err: Error | void, url: string) => void): Readable;
delete(permanent: true | void, cb: (err: Error | void) => void): Readable;
moveTo(target: MutableFile | string, cb: (err: Error | void) => void): Readable;
setAttributes(attributes: {[key: string]: any}, cb: (err: Error | void) => void): Readable;
...
setFavorite(isFavorite: boolean, cb: (err: Error | void) => void): Readable
	...
	declare export default function mega(options: StorageOptions, cb?: any): Storage
