declare module "keycloak-connect" {
  ...
  declare class Keycloak {
    ...
    getGrant: (
      request: Request,
      response: Response
    ) => Promise<Keycloak$Keycloak$Grant>;
    storeGrant: (
      grant: Keycloak$Keycloak$Grant,
      request: Request,
      response: Response
    ) => Keycloak$Keycloak$Grant;
  ...
  declare type Keycloak$Config =
    | Keycloak$StoreConfig
    | Keycloak$CookiesConfig
    | Keycloak$BaseConfig;
  ...
  declare type Keycloak$SpecHandler = (
