...
constructor(stemmingFunction: StemmingFunction, decoratedTokenizer: ITokenizer): this;
tokenize(text: string): Array<string>
}
...
constructor(opt_indexStrategy: IIndexStrategy, opt_sanitizer: ISanitizer, opt_wrapperTagName: string): this;
