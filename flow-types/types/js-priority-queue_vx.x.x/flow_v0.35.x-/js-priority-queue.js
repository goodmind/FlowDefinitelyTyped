 ...
 */
constructor(options?: PriorityQueue$PriorityQueue$PriorityQueueOptions<T>): this;
...
declare class PriorityQueue$ArrayStrategy<T> mixins AbstractPriorityQueue<T> {}

declare class PriorityQueue$BinaryHeapStrategy<T> mixins AbstractPriorityQueue<T> {}

declare class PriorityQueue$BHeapStrategy<T> mixins AbstractPriorityQueue<T> {}
