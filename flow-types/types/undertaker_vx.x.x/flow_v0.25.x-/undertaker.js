declare module "undertaker" {
  ...
  declare type Undertaker$TaskFunction = {
    ...
    ): void | Duplex | NodeJS.Process | Promise<empty> | any
  ...
  declare class Undertaker mixins EventEmitter {
     ...
     */
    series(
      ...tasks: Undertaker$Undertaker$Task[]
    ): Undertaker$Undertaker$TaskFunction;
     ...
     */
    tree(
      options?: Undertaker$Undertaker$TreeOptions
    ): Undertaker$Undertaker$TreeResult;
