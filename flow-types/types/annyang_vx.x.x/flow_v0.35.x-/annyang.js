 ...
 */
declare export interface StartOptions {
 ...
 */
declare export interface CommandOptionRegex {
regexp: RegExp,
callback(): void
} 
 ...
 * ````
 */
declare export interface CommandOption {
 ...
 */
declare export type Events = "start"
| "soundstart"
| "error"
| "end"
| "result"
...
| "errorPermissionDenied";
	declare export interface Annyang {
 ...
 * @param newState Turn on/off debug messages
 */
...
removeCallback(
event?: Events,
callback?: (userSaid: string, commandText: string, results: string[]) => void): void,
