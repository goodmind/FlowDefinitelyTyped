declare module 'istanbul-lib-report' {
        import type {
          CoverageMap,FileCoverage,CoverageSummary
        } from 'istanbul-lib-coverage';

	declare export function createContext(options?: $Shape<ContextOptions>): Context
...
visit(visitor: Visitor<ReportNode>, state: any): void
	...
	declare export interface Visitor<N: Node> {
...
onEnd(root: N, state: any): void
	...
	declare export interface Tree<N: Node> {
getRoot(): N,
