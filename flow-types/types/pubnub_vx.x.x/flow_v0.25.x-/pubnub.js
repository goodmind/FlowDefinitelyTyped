declare module "pubnub" {
  declare class Pubnub {
    ...
    publish(
      ...
      callback: (
        ...
        response: Pubnub$Pubnub$PublishResponse
      ) => void
    ): void;
    publish(
      params: Pubnub$Pubnub$PublishParameters
    ): Promise<Pubnub$Pubnub$PublishResponse>;
    fire(
    ...
    history(
      ...
      callback: (
        ...
        response: Pubnub$Pubnub$HistoryResponse
      ) => void
    ): void;
    ...
    hereNow(
      ...
      callback: (
        ...
        response: Pubnub$Pubnub$HereNowResponse
      ) => void
    ): void;
    hereNow(
      params: Pubnub$Pubnub$HereNowParameters
    ): Promise<Pubnub$Pubnub$HereNowResponse>;
    whereNow(
      params: Pubnub$Pubnub$WhereNowParameters,
      callback: (
        status: Pubnub$Pubnub$WhereNowStatus,
        response: Pubnub$Pubnub$WhereNowResponse
      ) => void
    ): void;
    whereNow(
      params: Pubnub$Pubnub$WhereNowParameters
    ): Promise<Pubnub$Pubnub$WhereNowResponse>;
    getState(
      params: Pubnub$Pubnub$GetStateParameters,
      callback: (
        status: Pubnub$Pubnub$GetStateStatus,
        state: Pubnub$Pubnub$GetStateResponse
      ) => void
    ): void;
    getState(
      params: Pubnub$Pubnub$GetStateParameters
    ): Promise<Pubnub$Pubnub$GetStateResponse>;
    setState(
      params: Pubnub$Pubnub$SetStateParameters,
      callback: (
        status: Pubnub$Pubnub$SetStateStatus,
        state: Pubnub$Pubnub$SetStateResponse
      ) => void
    ): void;
    setState(
      params: Pubnub$Pubnub$SetStateParameters
    ): Promise<Pubnub$Pubnub$SetStateResponse>;
    grant(
      params: Pubnub$Pubnub$GrantParameters,
      callback: (status: Pubnub$Pubnub$GrantStatus, response: {}) => void
    ): void;
    grant(params: Pubnub$Pubnub$GrantParameters): Promise<{}>;
    encrypt(
      data: string,
      customCipherKey?: string,
      options?: Pubnub$Pubnub$CryptoParameters
    ): any;
    decrypt(
      data: { [key: string]: any },
      customCipherKey?: string,
  ...
  declare interface Pubnub$GrantParameters {
    channels?: string[];
    channelGroups?: string[];
    authKeys?: string[];
    ttl?: number;
  ...
  declare interface Pubnub$GrantStatus {
    error: boolean;
    operation: string;
    statusCode: number;
  }
