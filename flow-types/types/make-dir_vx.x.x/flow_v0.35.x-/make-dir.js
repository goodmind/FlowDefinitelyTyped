 ...
 */
declare function makeDir(path: string, options?: makeDir$makeDir$Options): Promise<string>
 ...
 * @param path Directory to create.
 */
declare function makeDir$sync(path: string, options?: makeDir$Options): string
