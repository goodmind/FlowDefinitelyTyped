 ...
 */
declare export interface PhotoSwipe$Item {
 ...
 */
declare export interface PhotoSwipe$Options {
...
declare export interface PhotoSwipe$UIFramework {
[name: string]: any
} 
 ...
 */
declare export interface PhotoSwipe$UI<T: PhotoSwipe$Options> {
 ...
 */
declare class PhotoSwipe<T: PhotoSwipe$PhotoSwipe$Options>  {
 ...
 * (4) Options.
 */
constructor(pswpElement: HTMLElement, uiConstructor: ((pswp: PhotoSwipe<T>, framework: PhotoSwipe$PhotoSwipe$UIFramework) => PhotoSwipe$PhotoSwipe$UI<T>) | boolean, items: PhotoSwipe$PhotoSwipe$Item[], options: T): this;

/**
 * Current slide object.
 */
currItem: PhotoSwipe$PhotoSwipe$Item;
 ...
 */
items: PhotoSwipe$PhotoSwipe$Item[];
 ...
 */
framework: PhotoSwipe$PhotoSwipe$UIFramework;

/**
 * The ui instance constructed by PhotoSwipe.
 */
ui: PhotoSwipe$PhotoSwipe$UI<T>;
 ...
 * @param {{[key: string]: any}} centerPoint The center of the zoom, relative to viewport.
 ...
 * @param {int} panX
 * @param {int} panY For example: `pswp.applyZoomPan(1, 0, 0)`
...
callback: (index: number, item: PhotoSwipe$PhotoSwipe$Item) => void): void;
...
callback: (item: PhotoSwipe$PhotoSwipe$Item) => void): void;
