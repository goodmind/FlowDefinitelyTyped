declare module "bootstrap-switch" {
  ...
  declare interface JQuery {
    ...
    bootstrapSwitch(
      options: BootstrapSwitch$BootstrapSwitch$BootstrapSwitchOptions
    ): JQuery;
    bootstrapSwitch(
    ...
    off(
      ...
      selector?: string,
      handler?: (
        eventobject: BootstrapSwitch$BootstrapSwitch$BootstrapSwitchEventObject
      ) => any
    ): JQuery;
    off(
      events: "init.bootstrapSwitch",
    ...
    off(
      ...
      selector?: string,
      handler?: (
        eventobject: BootstrapSwitch$BootstrapSwitch$BootstrapSwitchChangeEventObject
      ) => any
    ): JQuery;
    off(
      events: "switchChange.bootstrapSwitch",
