...
y: number,
fontSize: number,
options?: RenderOptions) => void): number;
...
validate(): void
	...
	declare export type FontConstructorOptions = FontConstructorOptionsBase & $Shape<FontOptions> & {
glyphs: Glyph[]
};
 ...
 * ****************************************
 */
declare export function load(url: string, callback: (error: any, font?: Font) => void): void
