declare module "react-wait" {
  ...
  declare export var Waiter: FunctionComponent;
  declare export interface WaitProps {
    fallback: React$Node;
    on: string;
  }
  declare export interface UseWaitAPI {
    /**
  ...
  declare export function useWait(): UseWaitAPI;
}
