declare module "camo" {
   ...
   */
  declare export type SchemaTypeConstructor =
   ...
   */
  declare export type SchemaType = TypeOrArrayOfType<
   ...
   */
  declare export type SchemaTypeExtended =
  ...
  declare export class Document<Schema: DocumentSchema> {
     ...
     */
    static create<StaticSchema: DocumentSchema>(
      schema: StaticSchema
