...
url: string,
prev: string,
done: (data: ImporterReturnType) => void) => ImporterReturnType | void;
 ...
 */
functions?: {
[key: string]: (...args: types$types$SassType[]) => types$types$SassType | void
},
...
options: Options,
callback: (exception: SassException, result: Result) => void): void
...
declare class types$Boolean<T: boolean> mixins types$SassType {
...
declare class types$List<T: types$SassType> mixins types$SassType {
...
declare class types$Map<K: types$SassType, V: types$SassType> mixins types$SassType {
