...
constructor(mode: "recv" | "send" | "sendRecv", options?: {[key: string]: any}, callback?: (error: string | void) => void): this;
 ...
 */
processAnswer: (sdpAnswer: string, callback?: (error: string | void) => void) => void;
...
processOffer: (
sdpOffer: string,
callback?: (error: string | void, sdp: string) => void) => void;
...
callback?: (error: string | void) => void) => void;
 ...
 */
generateOffer: (callback: (error: string | void, sdp: string) => void) => void;
...
callback: (error: string | void) => void) => WebRtcPeer;
