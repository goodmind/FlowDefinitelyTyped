declare module "hellojs" {
  ...
  declare type hello$HelloJSTokenResponseType =
    | "code"
    | "code id_token"
    | "code id_token token"
    | "code token"
  ...
  declare interface hello$HelloJSEvent {
    on(
      event: string,
      callback: (auth: hello$HelloJSEventArgument) => void
    ): hello$HelloJSStatic;
    off(
      event: string,
      callback: (auth: hello$HelloJSEventArgument) => void
  ...
  declare type hello$HelloJSStatic = {
    ...
    login(
      options?: hello$HelloJSLoginOptions,
      callback?: () => void
    ): PromiseLike<hello$HelloJSLoginEventArguement>,
    login(
      network?: string,
      options?: hello$HelloJSLoginOptions,
      callback?: () => void
  ...
  declare type hello$HelloJSUrlMappingFunction = (
    p: any,
