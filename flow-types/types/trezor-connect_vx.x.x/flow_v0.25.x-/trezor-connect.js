declare module "trezor-connect" {
  ...
  declare export type RequestLoginParams =
    | (CommonParams & {
  ...
  declare export type DeviceMode =
    | "normal"
    | "bootloader"
    | "initialize"
    | "seedless";
  ...
  declare export interface InternalOutput {
    address_n: number[];
    amount: string;
    script_type?: string;
  }
   ...
   * confirm the export.
   */
  declare function TrezorConnect$getPublicKey(
   ...
   */
  declare function TrezorConnect$requestLogin(
   ...
   */
  declare function TrezorConnect$getFeatures(
    params?: CommonParams
  ): Promise<ResponseMessage<Features>>;
   ...
   */
  declare function TrezorConnect$wipeDevice(): Promise<
   ...
   */
  declare function TrezorConnect$resetDevice(
    params: ResetDeviceParams
  ): Promise<ResponseMessage<Message>>;
   ...
   */
  declare function TrezorConnect$getAddress(
   ...
   */
  declare function TrezorConnect$getAccountInfo(
   ...
   * needed.
   */
  declare function TrezorConnect$composeTransaction(
   ...
   */
  declare function TrezorConnect$signTransaction(
   ...
   */
  declare function TrezorConnect$pushTransaction(
   ...
   * path.
   */
  declare function TrezorConnect$signMessage(
    params: SignMessageParams
  ): Promise<ResponseMessage<SignedMessage>>;

  /**
   * Asks device to verify a message using the signer address and signature.
   */
  declare function TrezorConnect$verifyMessage(
