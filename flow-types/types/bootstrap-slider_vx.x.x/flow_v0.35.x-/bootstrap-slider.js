declare module 'bootstrap-slider' {
        declare interface RangeHighlight {
class?: string,
start?: number,
end?: number
} 
	declare type SliderEventType = "slide"
| "slideStart"
| "slideStop"
| "change"
| "slideEnabled"
...
on(event: "slide", handler: (slideEvt: SliderEvent) => false | void): this
	...
	declare interface SliderPlugin<TJQuery> {
...
constructor(selector: string, opts: SliderOptions): this;
...
triggerChangeEvent?: boolean): this;
 ...
 */
on(eventType: SliderEventType, callback: (val: number | void) => void): this;

/**
 * Removes the callback function from the slider event eventType
 */
off(eventType: SliderEventType, callback: (val: number | void) => void): void;
