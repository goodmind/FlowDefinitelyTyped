declare module "angular-strap" {
  declare type modal$IModalService = (
    config?: modal$IModalOptions
  ) => modal$IModal;
  ...
  declare type aside$IAsideService = (
    config?: aside$IAsideOptions
  ) => aside$IAside;
  ...
  declare type alert$IAlertService = (
    config?: alert$IAlertOptions
  ) => alert$IAlert;
  ...
  declare type tooltip$ITooltipService = (
    ...
    config?: tooltip$ITooltipOptions
  ) => tooltip$ITooltip;
  ...
  declare type popover$IPopoverService = (
    element: ng.IAugmentedJQuery,
    config?: popover$IPopoverOptions
  ) => popover$IPopover;
  ...
  declare type typeahead$ITypeaheadService = (
    element: ng.IAugmentedJQuery,
    controller: any,
    config?: typeahead$ITypeaheadOptions
  ...
  declare type datepicker$IDatepickerService = (
    element: ng.IAugmentedJQuery,
    controller: any,
    config?: datepicker$IDatepickerOptions
  ...
  declare type timepicker$ITimepickerService = (
    element: ng.IAugmentedJQuery,
    controller: any,
    config?: timepicker$ITimepickerOptions
  ...
  declare type dropdown$IDropdownService = (
    element: ng.IAugmentedJQuery,
    config: dropdown$IDropdownOptions
  ) => dropdown$IDropdown;
  ...
  declare type scrollspy$IScrollspyService = (
    element: ng.IAugmentedJQuery,
    options: scrollspy$IScrollspyOptions
  ...
  declare type affix$IAffixService = (
    element: ng.IAugmentedJQuery,
    options: affix$IAffixOptions
  ) => affix$IAffix;
