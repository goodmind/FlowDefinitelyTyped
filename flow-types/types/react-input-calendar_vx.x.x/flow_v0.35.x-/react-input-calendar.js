 ...
 */
onBlur?: (
event: React.SyntheticEvent<reactInputCalendar$ReactInputCalendar>,
computableDate: string) => void,

/**
 * Set a function that will be triggered when the input field is focused.
 */
onFocus?: (event: React.SyntheticEvent<reactInputCalendar$ReactInputCalendar>) => void,
...
declare export class reactInputCalendar$ReactInputCalendar mixins React.Component<reactInputCalendar$ReactInputCalendarProps, reactInputCalendar$ReactInputCalendarState> {}declare var reactInputCalendar$ReactInputCalendar: typeof undefined;declare module 'react-input-calendar' {
        declare module.exports: typeof reactInputCalendar$ReactInputCalendar
