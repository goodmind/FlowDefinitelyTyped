 ...
 */
declare export function extract(input: string | ESTree.Program): ExtractFunction
...
parsers.
 */
declare export function compileExtracts(attributes: CompileExtractsAttributes): string
