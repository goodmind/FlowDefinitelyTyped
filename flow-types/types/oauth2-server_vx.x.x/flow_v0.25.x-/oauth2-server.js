declare module "oauth2-server" {
  ...
  declare class OAuth2Server {
    ...
    authenticate(
      ...
      callback?: OAuth2Server$OAuth2Server$Callback<OAuth2Server$OAuth2Server$Token>
    ): Promise<OAuth2Server$OAuth2Server$Token>;
    ...
    authorize(
      ...
      callback?: OAuth2Server$OAuth2Server$Callback<OAuth2Server$OAuth2Server$AuthorizationCode>
    ): Promise<OAuth2Server$OAuth2Server$AuthorizationCode>;
   ...
   */
  declare type OAuth2Server$Falsey = "" | 0 | false | null | void;
  ...
  declare interface OAuth2Server$BaseModel {
    ...
    getClient(
      clientId: string,
      clientSecret: string,
      callback?: OAuth2Server$Callback<
        OAuth2Server$Client | OAuth2Server$Falsey
      >
  ...
  } & OAuth2Server$BaseModel &
    OAuth2Server$RequestAuthenticationModel;
  ...
  declare type OAuth2Server$ExtensionModel = {} & OAuth2Server$BaseModel &
    OAuth2Server$RequestAuthenticationModel;
  ...
  declare class OAuth2Server$InsufficientScopeError
    mixins OAuth2Server$OAuthError {}

  declare class OAuth2Server$InvalidArgumentError
    mixins OAuth2Server$OAuthError {}

  declare class OAuth2Server$InvalidClientError
    mixins OAuth2Server$OAuthError {}

  declare class OAuth2Server$InvalidGrantError mixins OAuth2Server$OAuthError {}

  declare class OAuth2Server$InvalidRequestError
    mixins OAuth2Server$OAuthError {}
  ...
  declare class OAuth2Server$UnauthorizedClientError
    mixins OAuth2Server$OAuthError {}

  declare class OAuth2Server$UnauthorizedRequestError
    mixins OAuth2Server$OAuthError {}

  declare class OAuth2Server$UnsupportedGrantTypeError
    mixins OAuth2Server$OAuthError {}

  declare class OAuth2Server$UnsupportedResponseTypeError
    mixins OAuth2Server$OAuthError {}
