declare module 'react-native-scrollable-tab-view' {
	...
	import type {
          Animated,ScrollViewProps,ViewStyle,TextStyle,StyleProp
        } from 'react-native';
...
from: number
	...
	declare export default class ScrollableTabView mixins React.Component<ScrollableTabViewProperties> {}
...
pageIndex: number,
isTabActive: boolean,
goToPage: (pageNumber: number) => void) => JSX.Element;
	declare export class DefaultTabBar mixins React.Component<TabBarProps<DefaultTabBarProps>> {}
...
tabsContainerStyle?: ViewStyle
	...
	declare export class ScrollableTabBar mixins React.Component<TabBarProps<ScrollableTabBarProps>> {}
    }
