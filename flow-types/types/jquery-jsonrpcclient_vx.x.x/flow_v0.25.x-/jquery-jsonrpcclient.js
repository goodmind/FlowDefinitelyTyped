declare module "jquery-jsonrpcclient" {
  ...
  declare interface JsonRpcClient {
     ...
     * @param {{[key: string]: any} | array} params The params; an array or object.
     * @param {function} successCb A callback for successful request.
     * @param {function} errorCb A callback for error.
     * @return {{[key: string]: any}} Returns the deferred object that $.ajax returns or {null} for websockets
     */
    call(
      method: string,
 ...
 * @fn new
 * @memberof JsonRpcClient
 * @param {{[key: string]: any}} options An object stating the backends:
