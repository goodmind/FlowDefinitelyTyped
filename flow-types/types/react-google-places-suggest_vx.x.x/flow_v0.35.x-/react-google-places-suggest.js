declare module 'react-google-places-suggest' {
	...
	declare class ReactGooglePlacesSuggest mixins Component<ReactGooglePlacesSuggest$ReactGooglePlacesSuggest$Props> {}
...
children?: ReactNode,
customRender?: (prediction?: ReactGooglePlacesSuggest$Prediction) => JSX.Element | string,
customContainerRender?: (
predictions: $ReadOnlyArray<ReactGooglePlacesSuggest$Prediction>) => JSX.Element | string,
googleMaps: typeof undefined,
onSelectSuggest?: (
geocodedPrediction: ReactGooglePlacesSuggest$GeocodedPrediction,
originalPrediction: ReactGooglePlacesSuggest$Prediction) => any,
