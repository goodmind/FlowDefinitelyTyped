declare module "giraffe" {
  declare var npm$namespace$Giraffe: {
    ...
    Collection: typeof Giraffe$Collection,
    Model: typeof Giraffe$Model,
    Router: typeof Giraffe$Router,
    View: typeof Giraffe$View,
    App: typeof Giraffe$App,
    Contrib: typeof npm$namespace$Giraffe$Contrib
  };
  ...
  declare function Giraffe$bindAppEvents(
    instance: Giraffe$GiraffeObject
  ): Giraffe$GiraffeObject;

  declare function Giraffe$bindDataEvents(
    instance: Giraffe$GiraffeObject
  ): Giraffe$GiraffeObject;
  ...
  declare function Giraffe$bindEventMap(
    context: Backbone.Events,
    target: Backbone.Events,
    eventMap: any
  ): void;

  declare function Giraffe$unbindEventMap(
    context: Backbone.Events,
    target: Backbone.Events,
    eventMap: any
  ): void;
  ...
  declare function Giraffe$dispose(
    instance: Giraffe$GiraffeObject,
    ...args: any[]
  ): Giraffe$GiraffeObject;
  ...
  declare function Giraffe$wrapFn(
    obj: any,
    name: string,
    before: Function,
    after: Function
  ...
  declare class Giraffe$Collection<TModel: Giraffe$Model>
    mixins Backbone.Collection<TModel>, GiraffeObject {
  ...
  declare class Giraffe$Model mixins Backbone.Model, GiraffeObject {
    Giraffe$app: Giraffe$App;
  }

  declare class Giraffe$Router mixins Backbone.Router, GiraffeObject {
    Giraffe$app: Giraffe$App;
    namespace: string;
  ...
  declare class Giraffe$View<TModel: Giraffe$Model>
    mixins Backbone.View<TModel>, GiraffeObject {
    Giraffe$app: Giraffe$App;
    appEvents: Giraffe$StringMap;
    ...
    attachTo(
      el: any,
      options?: Giraffe$AttachmentOptions
    ): Giraffe$View<TModel>;
    attach(
    ...
    static detachByElement(
      el: any,
      preserve?: boolean
    ): Giraffe$View<Giraffe$Model>;
  ...
  declare class Giraffe$App mixins View<Giraffe$Model> {
  ...
  declare var npm$namespace$Giraffe$Contrib: {
    Controller: typeof Giraffe$Contrib$Controller,
    CollectionView: typeof Giraffe$Contrib$CollectionView,
    FastCollectionView: typeof Giraffe$Contrib$FastCollectionView
  };
  declare class Giraffe$Contrib$Controller
    mixins GiraffeObject, Backbone.Events {
    on(
      eventName: string,
  ...
  declare class Giraffe$Contrib$CollectionView<TModel: Giraffe$Model>
    mixins View<TModel> {
  ...
  declare class Giraffe$Contrib$FastCollectionView<TModel: Giraffe$Model>
    mixins View<TModel> {
    collection: Giraffe$Collection<TModel>;
    modelTemplate: any;
