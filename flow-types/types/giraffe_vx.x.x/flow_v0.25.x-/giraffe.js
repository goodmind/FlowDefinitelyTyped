...
declare class Contrib$CollectionView<TModel: Giraffe$Model>
  mixins Giraffe$View<TModel> {
...
declare class Contrib$FastCollectionView<TModel: Giraffe$Model>
  mixins Giraffe$View<TModel> {
  collection: Giraffe$Collection<TModel>;
  modelTemplate: any;
...
declare class Giraffe$Collection<TModel: Giraffe$Model>
  mixins Backbone.Giraffe$Collection<TModel>, Giraffe$GiraffeObject {
...
declare class Giraffe$Model
  mixins Backbone.Giraffe$Model, Giraffe$GiraffeObject {
  Giraffe$app: Giraffe$App;
}

declare class Giraffe$Router
  mixins Backbone.Giraffe$Router, Giraffe$GiraffeObject {
  Giraffe$app: Giraffe$App;
  namespace: string;
...
declare class Giraffe$View<TModel: Giraffe$Model>
  mixins Backbone.Giraffe$View<TModel>, Giraffe$GiraffeObject {
  Giraffe$app: Giraffe$App;
  appEvents: Giraffe$StringMap;
