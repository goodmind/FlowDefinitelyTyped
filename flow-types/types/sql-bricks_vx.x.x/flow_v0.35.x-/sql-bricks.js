 ...
 */
declare type SqlBricks$WhereExpression = SqlBricks$WhereGroup | SqlBricks$WhereBinary | SqlBricks$WhereObject | string;
 ...
 */
select(
...columns: Array<string | SqlBricks$SelectStatement>): SqlBricks$SelectStatement,
...
distinct(
...columns: Array<string | SqlBricks$SelectStatement>): SqlBricks$SelectStatement,
distinct(columns: string[] | SqlBricks$SelectStatement[]): SqlBricks$SelectStatement,
...
join(
tbl: string,
criteria?: SqlBricks$OnCriteria | string[] | SqlBricks$WhereExpression): SqlBricks$SelectStatement,
join(tbl: string, onCol1: string, onCol2: string): SqlBricks$SelectStatement,
join(firstTbl: string, ...otherTbls: string[]): SqlBricks$SelectStatement,
leftJoin(
tbl: string,
criteria?: SqlBricks$OnCriteria | string[] | SqlBricks$WhereExpression): SqlBricks$SelectStatement,
leftJoin(tbl: string, onCol1: string, onCol2: string): SqlBricks$SelectStatement,
leftJoin(firstTbl: string, ...otherTbls: string[]): SqlBricks$SelectStatement,
rightJoin(
tbl: string,
criteria?: SqlBricks$OnCriteria | string[] | SqlBricks$WhereExpression): SqlBricks$SelectStatement,
rightJoin(tbl: string, onCol1: string, onCol2: string): SqlBricks$SelectStatement,
rightJoin(firstTbl: string, ...otherTbls: string[]): SqlBricks$SelectStatement,
fullJoin(
tbl: string,
criteria?: SqlBricks$OnCriteria | string[] | SqlBricks$WhereExpression): SqlBricks$SelectStatement,
fullJoin(tbl: string, onCol1: string, onCol2: string): SqlBricks$SelectStatement,
fullJoin(firstTbl: string, ...otherTbls: string[]): SqlBricks$SelectStatement,
crossJoin(
tbl: string,
criteria?: SqlBricks$OnCriteria | string[] | SqlBricks$WhereExpression): SqlBricks$SelectStatement,
crossJoin(tbl: string, onCol1: string, onCol2: string): SqlBricks$SelectStatement,
crossJoin(firstTbl: string, ...otherTbls: string[]): SqlBricks$SelectStatement,
innerJoin(
tbl: string,
criteria?: SqlBricks$OnCriteria | string[] | SqlBricks$WhereExpression): SqlBricks$SelectStatement,
innerJoin(tbl: string, onCol1: string, onCol2: string): SqlBricks$SelectStatement,
innerJoin(firstTbl: string, ...otherTbls: string[]): SqlBricks$SelectStatement,
leftOuterJoin(
tbl: string,
criteria?: SqlBricks$OnCriteria | string[] | SqlBricks$WhereExpression): SqlBricks$SelectStatement,
leftOuterJoin(tbl: string, onCol1: string, onCol2: string): SqlBricks$SelectStatement,
leftOuterJoin(firstTbl: string, ...otherTbls: string[]): SqlBricks$SelectStatement,
rightOuterJoin(
tbl: string,
criteria?: SqlBricks$OnCriteria | string[] | SqlBricks$WhereExpression): SqlBricks$SelectStatement,
rightOuterJoin(tbl: string, onCol1: string, onCol2: string): SqlBricks$SelectStatement,
rightOuterJoin(firstTbl: string, ...otherTbls: string[]): SqlBricks$SelectStatement,
fullOuterJoin(
tbl: string,
criteria?: SqlBricks$OnCriteria | string[] | SqlBricks$WhereExpression): SqlBricks$SelectStatement,
fullOuterJoin(tbl: string, onCol1: string, onCol2: string): SqlBricks$SelectStatement,
fullOuterJoin(firstTbl: string, ...otherTbls: string[]): SqlBricks$SelectStatement,
on(
onCriteria: SqlBricks$OnCriteria | SqlBricks$WhereExpression): SqlBricks$SelectStatement,
...
into(tbl: SqlBricks$TableName, ...columns: any[]): SqlBricks$InsertStatement,
intoTable(tbl: SqlBricks$TableName, ...columns: any[]): SqlBricks$InsertStatement,
select(
...columns: Array<string | SqlBricks$SelectStatement>): SqlBricks$SelectStatement,
select(columns: string[] | SqlBricks$SelectStatement[]): SqlBricks$SelectStatement,
...
// INSERT INTO person (first_name, last_name) VALUES ('Fred', 'Flintstone')
 */
insertInto(tbl?: string, ...values: any[]): SqlBricks$SqlBricks$InsertStatement,
 ...
 */
select(
...columns: Array<string | SqlBricks$SqlBricks$SelectStatement>): SqlBricks$SqlBricks$SelectStatement,
select(
columns: string[] | SqlBricks$SqlBricks$SelectStatement[]): SqlBricks$SqlBricks$SelectStatement,
 ...
 * @param func
 */
joinCriteria(func?: (...args: any[]) => SqlBricks$SqlBricks$OnCriteria): any,
_extension(): any,
prop: number,
conversions: any,
 ...
 */
and(
...whereExprs: SqlBricks$SqlBricks$WhereExpression[]): SqlBricks$SqlBricks$WhereGroup,
 ...
 * @param whereExpr
 */
not(whereExpr: SqlBricks$SqlBricks$WhereExpression): SqlBricks$SqlBricks$WhereGroup,
 ...
 * @param value2
 */
between(column: string, value1: any, value2: any): SqlBricks$SqlBricks$WhereExpression,
isNull(column: string): SqlBricks$SqlBricks$WhereExpression,
isNotNull(column: string): SqlBricks$SqlBricks$WhereExpression,
like(
column: string,
value: any,
escapeStr?: string): SqlBricks$SqlBricks$WhereExpression,
exists(stmt: any): SqlBricks$SqlBricks$WhereExpression,
in(
column: string,
stmt: SqlBricks$SqlBricks$SelectStatement): SqlBricks$SqlBricks$WhereExpression,
...
value?: any): SqlBricks$SqlBricks$WhereBinary,
equal(
column: string | SqlBricks$SqlBricks$SelectStatement,
value?: any): SqlBricks$SqlBricks$WhereBinary,
notEq(
