declare module "object-keys-mapping" {
  ...
  declare export function toCamelcase(origin: { [key: string]: any }): {
    [key: string]: any
  };

  declare export function toCamelcase(
    origin: $ReadOnlyArray<{ [key: string]: any }>
  ): { [key: string]: any }[];

  declare export function reverseCamelcase(origin: { [key: string]: any }): {
    [key: string]: any
  };

  declare export function reverseCamelcase(
    origin: $ReadOnlyArray<{ [key: string]: any }>
  ): { [key: string]: any }[];
