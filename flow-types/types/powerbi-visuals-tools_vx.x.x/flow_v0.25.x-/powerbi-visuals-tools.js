declare module "powerbi-visuals-tools" {
  declare class powerbi$VisualDataRoleKind {
    ...
    static +Grouping: Class<powerbi$VisualDataRoleKind__Grouping> &
      powerbi$VisualDataRoleKind__Grouping &
      0; // 0
    static +Measure: Class<powerbi$VisualDataRoleKind__Measure> &
      powerbi$VisualDataRoleKind__Measure &
      1; // 1
    static +GroupingOrMeasure: Class<powerbi$VisualDataRoleKind__GroupingOrMeasure> &
      powerbi$VisualDataRoleKind__GroupingOrMeasure &
      2; // 2
  }

  declare class powerbi$VisualDataRoleKind__Grouping
    mixins powerbi$VisualDataRoleKind {}
  declare class powerbi$VisualDataRoleKind__Measure
    mixins powerbi$VisualDataRoleKind {}
  declare class powerbi$VisualDataRoleKind__GroupingOrMeasure
    mixins powerbi$VisualDataRoleKind {}

  declare class powerbi$VisualDataChangeOperationKind {
    constructor(...args: empty): mixed;
    static +Create: Class<powerbi$VisualDataChangeOperationKind__Create> &
      powerbi$VisualDataChangeOperationKind__Create &
      0; // 0
    static +Append: Class<powerbi$VisualDataChangeOperationKind__Append> &
      powerbi$VisualDataChangeOperationKind__Append &
      1; // 1
  }

  declare class powerbi$VisualDataChangeOperationKind__Create
    mixins powerbi$VisualDataChangeOperationKind {}
  declare class powerbi$VisualDataChangeOperationKind__Append
    mixins powerbi$VisualDataChangeOperationKind {}

  declare class powerbi$VisualUpdateType {
    constructor(...args: empty): mixed;
    static +Data: Class<powerbi$VisualUpdateType__Data> &
      powerbi$VisualUpdateType__Data &
      2; // 2
    static +Resize: Class<powerbi$VisualUpdateType__Resize> &
      powerbi$VisualUpdateType__Resize &
      4; // 4
    static +ViewMode: Class<powerbi$VisualUpdateType__ViewMode> &
      powerbi$VisualUpdateType__ViewMode &
      8; // 8
    static +Style: Class<powerbi$VisualUpdateType__Style> &
      powerbi$VisualUpdateType__Style &
      16; // 16
    static +ResizeEnd: Class<powerbi$VisualUpdateType__ResizeEnd> &
      powerbi$VisualUpdateType__ResizeEnd &
      32; // 32
    static +All: Class<powerbi$VisualUpdateType__All> &
      powerbi$VisualUpdateType__All &
      62; // 62
  }

  declare class powerbi$VisualUpdateType__Data
    mixins powerbi$VisualUpdateType {}
  declare class powerbi$VisualUpdateType__Resize
    mixins powerbi$VisualUpdateType {}
  declare class powerbi$VisualUpdateType__ViewMode
    mixins powerbi$VisualUpdateType {}
  declare class powerbi$VisualUpdateType__Style
    mixins powerbi$VisualUpdateType {}
  declare class powerbi$VisualUpdateType__ResizeEnd
    mixins powerbi$VisualUpdateType {}
  declare class powerbi$VisualUpdateType__All mixins powerbi$VisualUpdateType {}

  declare class powerbi$CartesianRoleKind {
    constructor(...args: empty): mixed;
    static +X: Class<powerbi$CartesianRoleKind__X> &
      powerbi$CartesianRoleKind__X &
      0; // 0
    static +Y: Class<powerbi$CartesianRoleKind__Y> &
      powerbi$CartesianRoleKind__Y &
      1; // 1
  }
  ...
  declare class powerbi$ViewMode {
    ...
    static +InFocusEdit: Class<powerbi$ViewMode__InFocusEdit> &
      powerbi$ViewMode__InFocusEdit &
      2; // 2
  }
  ...
  declare class powerbi$EditMode {
    constructor(...args: empty): mixed;
    static +Default: Class<powerbi$EditMode__Default> &
      powerbi$EditMode__Default &
      0; // 0
    static +Advanced: Class<powerbi$EditMode__Advanced> &
      powerbi$EditMode__Advanced &
      1; // 1
  }
  ...
  declare class powerbi$AdvancedEditModeSupport {
    constructor(...args: empty): mixed;
    static +NotSupported: Class<powerbi$AdvancedEditModeSupport__NotSupported> &
      powerbi$AdvancedEditModeSupport__NotSupported &
      0; // 0
    static +SupportedNoAction: Class<powerbi$AdvancedEditModeSupport__SupportedNoAction> &
      powerbi$AdvancedEditModeSupport__SupportedNoAction &
      1; // 1
    static +SupportedInFocus: Class<powerbi$AdvancedEditModeSupport__SupportedInFocus> &
      powerbi$AdvancedEditModeSupport__SupportedInFocus &
      2; // 2
  }

  declare class powerbi$AdvancedEditModeSupport__NotSupported
    mixins powerbi$AdvancedEditModeSupport {}
  declare class powerbi$AdvancedEditModeSupport__SupportedNoAction
    mixins powerbi$AdvancedEditModeSupport {}
  declare class powerbi$AdvancedEditModeSupport__SupportedInFocus
    mixins powerbi$AdvancedEditModeSupport {}

  declare class powerbi$ResizeMode {
    constructor(...args: empty): mixed;
    static +Resizing: Class<powerbi$ResizeMode__Resizing> &
      powerbi$ResizeMode__Resizing &
      1; // 1
    static +Resized: Class<powerbi$ResizeMode__Resized> &
      powerbi$ResizeMode__Resized &
      2; // 2
  }
  ...
  declare class powerbi$JoinPredicateBehavior {
    constructor(...args: empty): mixed;
    static +None: Class<powerbi$JoinPredicateBehavior__None> &
      powerbi$JoinPredicateBehavior__None &
      0; // 0
  }

  declare class powerbi$JoinPredicateBehavior__None
    mixins powerbi$JoinPredicateBehavior {}

  declare class powerbi$PromiseResultType {
    constructor(...args: empty): mixed;
    static +Success: Class<powerbi$PromiseResultType__Success> &
      powerbi$PromiseResultType__Success &
      0; // 0
    static +Failure: Class<powerbi$PromiseResultType__Failure> &
      powerbi$PromiseResultType__Failure &
      1; // 1
  }

  declare class powerbi$PromiseResultType__Success
    mixins powerbi$PromiseResultType {}
  declare class powerbi$PromiseResultType__Failure
    mixins powerbi$PromiseResultType {}
  ...
  declare class powerbi$VisualInteractivityAction {
    constructor(...args: empty): mixed;
    static +Selection: Class<powerbi$VisualInteractivityAction__Selection> &
      powerbi$VisualInteractivityAction__Selection &
      0; // 0
    static +None: Class<powerbi$VisualInteractivityAction__None> &
      powerbi$VisualInteractivityAction__None &
      1; // 1
  }

  declare class powerbi$VisualInteractivityAction__Selection
    mixins powerbi$VisualInteractivityAction {}
  declare class powerbi$VisualInteractivityAction__None
    mixins powerbi$VisualInteractivityAction {}
  ...
  declare class powerbi$VisualEventType {
    constructor(...args: empty): mixed;
    static +RenderStarted: Class<powerbi$VisualEventType__RenderStarted> &
      powerbi$VisualEventType__RenderStarted &
      0; // 0
    static +RenderCompleted: Class<powerbi$VisualEventType__RenderCompleted> &
      powerbi$VisualEventType__RenderCompleted &
      1; // 1
    static +Trace: Class<powerbi$VisualEventType__Trace> &
      powerbi$VisualEventType__Trace &
      2; // 2
    static +Error: Class<powerbi$VisualEventType__Error> &
      powerbi$VisualEventType__Error &
      3; // 3
  }

  declare class powerbi$VisualEventType__RenderStarted
    mixins powerbi$VisualEventType {}
  declare class powerbi$VisualEventType__RenderCompleted
    mixins powerbi$VisualEventType {}
  ...
  declare class powerbi$FilterAction {
    constructor(...args: empty): mixed;
    static +merge: Class<powerbi$FilterAction__merge> &
      powerbi$FilterAction__merge &
      0; // 0
    static +remove: Class<powerbi$FilterAction__remove> &
      powerbi$FilterAction__remove &
      1; // 1
  }
  ...
  declare interface powerbi$IPromiseFactory {
     ...
     */
    allSettled<T>(
      promises: Array<powerbi$IPromise2<any, any>>
    ): powerbi$IPromise<Array<powerbi$IPromiseResult<T>>>;
  ...
  declare interface powerbi$IPromise2<TSuccess, TError> {
    ...
    then<TSuccessResult, TErrorResult>(
      ...
      ) => TSuccessResult | powerbi$IPromise2<TSuccessResult, TErrorResult>,
      errorCallback?: (reason: TError) => TErrorResult
    ): powerbi$IPromise2<TSuccessResult, TErrorResult>;

    /**
     * Shorthand for promise.then(null, errorCallback).
     */
    catch<TErrorResult>(
      onRejected: (reason: any) => powerbi$IPromise2<TSuccess, TErrorResult>
    ): powerbi$IPromise2<TSuccess, TErrorResult>;
  ...
  declare type powerbi$RejectablePromise<T> = {} & powerbi$RejectablePromise2<
    T,
    T
  >;
  ...
  declare class powerbi$SortDirection {
    constructor(...args: empty): mixed;
    static +Ascending: Class<powerbi$SortDirection__Ascending> &
      powerbi$SortDirection__Ascending &
      1; // 1
    static +Descending: Class<powerbi$SortDirection__Descending> &
      powerbi$SortDirection__Descending &
      2; // 2
  }

  declare class powerbi$SortDirection__Ascending mixins powerbi$SortDirection {}
  declare class powerbi$SortDirection__Descending
    mixins powerbi$SortDirection {}
  ...
  declare type powerbi$DataViewTreeNodeMeasureValue = {
    ...
    powerbi$DataViewColumnAggregates;
 ...
 */
  ...
  declare interface powerbi$DataViewObject {
     ...
     */
    [propertyName: string]:
      | powerbi$DataViewPropertyValue
      | powerbi$DataViewObjectMap;
  }
  ...
  declare type powerbi$DataViewPropertyValue =
    | powerbi$PrimitiveValue
    | powerbi$StructuralObjectValue;
  ...
  declare class powerbi$DataRepetitionKind {
    constructor(...args: empty): mixed;
    static +RoleWildcard: Class<powerbi$DataRepetitionKind__RoleWildcard> &
      powerbi$DataRepetitionKind__RoleWildcard &
      0; // 0
    static +ScopeIdentity: Class<powerbi$DataRepetitionKind__ScopeIdentity> &
      powerbi$DataRepetitionKind__ScopeIdentity &
      1; // 1
    static +ScopeTotal: Class<powerbi$DataRepetitionKind__ScopeTotal> &
      powerbi$DataRepetitionKind__ScopeTotal &
      2; // 2
    static +ScopeWildcard: Class<powerbi$DataRepetitionKind__ScopeWildcard> &
      powerbi$DataRepetitionKind__ScopeWildcard &
      3; // 3
  }

  declare class powerbi$DataRepetitionKind__RoleWildcard
    mixins powerbi$DataRepetitionKind {}
  declare class powerbi$DataRepetitionKind__ScopeIdentity
    mixins powerbi$DataRepetitionKind {}
  declare class powerbi$DataRepetitionKind__ScopeTotal
    mixins powerbi$DataRepetitionKind {}
  declare class powerbi$DataRepetitionKind__ScopeWildcard
    mixins powerbi$DataRepetitionKind {}
  ...
  declare type powerbi$FillSolidColorTypeDescriptor =
    | boolean
    | powerbi$FillSolidColorAdvancedTypeDescriptor;
  ...
  declare type powerbi$FillRule = {} & powerbi$FillRuleGeneric<
    string,
    number,
    string
  >;
  ...
  declare interface powerbi$LinearGradient2Generic<TColor, TValue, TStrategy> {
    ...
    nullColoringStrategy?: powerbi$NullColoringStrategyGeneric<
      TStrategy,
      TColor
    >;
  }
   ...
   */
  declare type powerbi$StructuralObjectValue =
    | powerbi$Fill
    | powerbi$FillRule
    | SemanticFilter
  ...
  declare type powerbi$VisualObjectInstanceEnumeration =
