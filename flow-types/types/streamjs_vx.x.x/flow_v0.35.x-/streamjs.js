...
groupBy(mapper: Stream$Stream$Function<T, string>): Stream$Stream$GroupingResult<T>;
groupBy(path: string): Stream$Stream$GroupingResult<T>;
groupingBy(mapper: Stream$Stream$Function<T, string>): Stream$Stream$GroupingResult<T>;
groupingBy(path: string): Stream$Stream$GroupingResult<T>;
indexBy(
keyMapper: Stream$Stream$Function<T, string>,
mergeFunction?: Stream$Stream$Accumulator<T>): Stream$Stream$Map<T>;
...
reduce(accumulator: Stream$Stream$Accumulator<T>): Stream$Stream$Optional<T>;
reverse(): Stream<T>;
size(): number;
sorted(): Stream<T>;
...
flatMap<U>(mapper: (elem: T) => Stream$Stream$Optional<U>): Stream$Optional<U>;
isPresent(): boolean;
get(): T;
