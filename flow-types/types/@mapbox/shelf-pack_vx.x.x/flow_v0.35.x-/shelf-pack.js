...
constructor(width?: number, height?: number, options?: ShelfPack$ShelfPack$CreateOption): this;
pack(
bins: Array<ShelfPack$ShelfPack$RequestShort | ShelfPack$ShelfPack$RequestLong>,
options?: ShelfPack$ShelfPack$PackOption): ShelfPack$ShelfPack$Bin[];
packOne(w: number, h: number, id?: ShelfPack$ShelfPack$ID): ShelfPack$ShelfPack$Bin;
...
constructor(id: ShelfPack$ID, x: number, y: number, w: number, h: number, maxw?: number, maxh?: number): this;
id: ShelfPack$ID;
x: number;
y: number;
w: number;
