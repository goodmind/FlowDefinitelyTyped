declare module "steed" {
  ...
  declare type steed$SteedResultArrayCallback<T, E> = (
    err: E,
    results: T[]
  ) => void;

  declare type steed$SteedResultObjectCallback<T, E> = (
    err: E,
    results: steed$Dictionary<T>
  ) => void;

  declare type steed$SteedWorker<T, E> = (
    task: T,
    callback: steed$ErrorCallback<E>
  ) => void;

  declare type steed$SteedIterator<T, E> = (
    item: T,
    callback: steed$ErrorCallback<E>
  ) => void;

  declare type steed$SteedResultIterator<T, R, E> = (
    item: T,
    callback: steed$SteedResultCallback<R, E>
  ) => void;

  declare type steed$SteedFunction<T, E> = (
  ...
  declare interface steed$Steed {
    parallel<T, E>(
      ...
      callback?: steed$SteedResultArrayCallback<T, E>
    ): void;
    parallel<T, E>(
      tasks: steed$Dictionary<steed$SteedFunction<T, E>>,
      callback?: steed$SteedResultObjectCallback<T, E>
    ): void;
    series<T, E>(
      tasks: Array<steed$SteedFunction<T, E>>,
      callback?: steed$SteedResultArrayCallback<T, E>
    ...
    waterfall<T, E>(
      tasks: Function[],
      callback?: steed$SteedResultCallback<T, E>
    ): void;
    each<T, E>(
    ...
    map<T, R, E>(
      ...
      callback?: steed$SteedResultArrayCallback<R, E>
    ): void;
