declare module 'jquery.validation' {
        declare interface JQueryValidation$RulesDictionary {
[name: string]: any
} 

declare type JQueryValidation$ValidatePredicate = ((element: HTMLElement, event: JQueryEventObject) => void);

declare type JQueryValidation$ShouldValidatePredicate = boolean | JQueryValidation$ValidatePredicate;
 ...
 */
onfocusin?: JQueryValidation$ValidatePredicate,
...
message?: string | ((params: any, element: HTMLElement) => string)): void,
 ...
 */
rules(command: "add", rules?: JQueryValidation$JQueryValidation$RulesDictionary): any,
 ...
 */
validate(
options?: JQueryValidation$JQueryValidation$ValidationOptions): JQueryValidation$JQueryValidation$Validator
} 
...
validator: JQueryValidation$JQueryValidation$ValidatorStatic
} 
    }
