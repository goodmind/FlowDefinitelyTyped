declare module "jquery.validation" {
  ...
  declare type JQueryValidation$ValidatePredicate = (
    element: HTMLElement,
    event: JQueryEventObject
  ) => void;

  declare type JQueryValidation$ShouldValidatePredicate =
    | boolean
  ...
  declare interface JQuery {
    ...
    rules(
      command: "add",
      rules?: JQueryValidation$JQueryValidation$RulesDictionary
    ): any;
     ...
     */
    validate(
      options?: JQueryValidation$JQueryValidation$ValidationOptions
    ): JQueryValidation$JQueryValidation$Validator;
  }
