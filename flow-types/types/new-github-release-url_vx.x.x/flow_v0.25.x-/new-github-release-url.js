declare module "new-github-release-url" {
  ...
  declare function newGithubReleaseUrl(
    options: newGithubReleaseUrl$newGithubReleaseUrl$Options
  ): string;

  declare type newGithubReleaseUrl$Without<T, U> = $ObjMapi<
    { [k: Exclude<$Keys<T>, $Keys<U>>]: any },
    <P>(P) => empty
  >;

  declare type newGithubReleaseUrl$XOR<T, U> =
    "There was Conditional Type, use $Call utility type";

  declare type newGithubReleaseUrl$Options = newGithubReleaseUrl$XOR<
    newGithubReleaseUrl$RepoUrlOptions,
    newGithubReleaseUrl$UserRepoOptions
  >;
