declare module "d3-axis" {
  import type { Selection, TransitionLike } from "d3-selection";
   ...
   */
  declare export interface AxisTimeInterval {
   ...
   */
  declare export interface AxisScale<Domain> {
   ...
   */
  declare export type AxisContainerElement = SVGSVGElement | SVGGElement;

  /**
   * Interface defining an axis generator. The generic <Domain> is the type of the axis domain.
   */
  declare export interface Axis<Domain> {
    /**
 ...
 */
   ...
   * @param scale The scale to be used for axis generation.
   */
  declare export function axisTop<Domain: AxisDomain>(
   ...
   * @param scale The scale to be used for axis generation.
   */
  declare export function axisRight<Domain: AxisDomain>(
    scale: AxisScale<Domain>
  ): Axis<Domain>;
   ...
   * @param scale The scale to be used for axis generation.
   */
  declare export function axisBottom<Domain: AxisDomain>(
    scale: AxisScale<Domain>
  ): Axis<Domain>;
   ...
   * @param scale The scale to be used for axis generation.
   */
  declare export function axisLeft<Domain: AxisDomain>(
    scale: AxisScale<Domain>
  ): Axis<Domain>;
}
