 ...
 * when `App.injectTestHelpers` is called.
 */
declare export function registerAsyncHelper(name: string, helperMethod: (app: Application, ...args: any[]) => any): void
...
declare export function registerWaiter(callback: () => boolean): any
	...
	declare export function registerWaiter<Context>(context: Context, callback: () => boolean): any
...
declare export function unregisterWaiter(callback: () => boolean): any
	...
	declare export function unregisterWaiter<Context>(context: Context, callback: () => boolean): any
