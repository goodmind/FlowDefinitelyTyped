declare module '@ember/utils' {
        import type {
          TypeLookup,KeysOfType,FunctionArgs
        } from './-private/types';
...
obj: T,
methodName: FNAME,
args: FunctionArgs<$ElementType<T, FNAME>>): "There was Conditional Type, use $Call utility type"

	declare export function tryInvoke<FNAME: $Keys<T>, T: {[key: string]: any}>(
obj: T,
methodName: FNAME): "There was Conditional Type, use $Call utility type"

	declare export function tryInvoke(obj: {[key: string]: any}, methodName: string, args?: any[]): void
