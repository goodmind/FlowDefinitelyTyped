declare module '@ember/application' {
        import typeof Engine from '@ember/engine';

	import typeof ApplicationInstance from '@ember/application/instance';

	import typeof EventDispatcher from '@ember/application/-private/event-dispatcher';

	import type {
          EventDispatcherEvents
        } from '@ember/application/types';

	import typeof DefaultResolver from '@ember/application/-private/default-resolver';

	import type {
          Router
        } from '@ember/routing';

	import typeof Registry from '@ember/application/-private/registry';
 ...
 */
declare export default class Application mixins Engine {
 ...
 */
buildInstance(options?: {[key: string]: any}): ApplicationInstance
}
 ...
 */
declare export function getOwner(object: any): any
 ...
 */
declare export function setOwner(object: any, owner: any): void
 ...
 */
declare export function onLoad(name: string, callback: (...args: any[]) => any): any
 ...
 */
declare export function runLoadHooks(name: string, object?: {}): any
