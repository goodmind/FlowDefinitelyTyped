declare module '@webscopeio/react-textarea-autocomplete' {
        declare export default typeof ReactTextareaAutocomplete

	import typeof * as React from 'react';

	declare export type CaretPositionType = "start" | "end" | "next" | number;
	declare export interface TextToReplaceType {
text: string,
caretPosition: CaretPositionType,
key?: string
} 
	declare export type DataProviderType<TItem> = (token: string) => Promise<TItem[]> | TItem[];
	declare export interface ItemComponentProps<TItem> {
selected: boolean,
entity: TItem
} 
 ...
 * Textarea Types
 */
declare export interface SettingType<TItem> {
...
output?: (item: TItem, trigger?: string) => TextToReplaceType | string
	...
	declare export interface TriggerType<TItem> {
[key: string]: SettingType<TItem>
} 
	declare type PickedAttributes = "onChange" | "onSelect" | "onBlur" | "value";
	declare export type TextareaProps<TItem> = {
...
} & Pick<React.InputHTMLAttributes<HTMLTextAreaElement>, PickedAttributes>

	declare export interface TextareaState<TItem> {
...
component?: React.SFC<ItemComponentProps<TItem>>
	...
	declare class ReactTextareaAutocomplete<TItem: string | {[key: string]: any}> mixins React.Component<TextareaProps<TItem>, TextareaState<TItem>> {
