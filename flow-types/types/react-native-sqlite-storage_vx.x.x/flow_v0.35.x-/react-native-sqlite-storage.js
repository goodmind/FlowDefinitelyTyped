declare module 'react-native-sqlite-storage' {
	...
	declare export function openDatabase(params: DatabaseParams): Promise<SQLiteDatabase>

	declare export function openDatabase(
params: DatabaseParams,
success?: () => void,
error?: (e: SQLError) => void): SQLiteDatabase
...
static +UNKNOWN_ERR: Class<SQLErrors__UNKNOWN_ERR> & SQLErrors__UNKNOWN_ERR & 0;// 0
static +DATABASE_ERR: Class<SQLErrors__DATABASE_ERR> & SQLErrors__DATABASE_ERR & 1;// 1
static +VERSION_ERR: Class<SQLErrors__VERSION_ERR> & SQLErrors__VERSION_ERR & 2;// 2
static +TOO_LARGE_ERR: Class<SQLErrors__TOO_LARGE_ERR> & SQLErrors__TOO_LARGE_ERR & 3;// 3
static +QUOTA_ERR: Class<SQLErrors__QUOTA_ERR> & SQLErrors__QUOTA_ERR & 4;// 4
static +SYNTAX_ERR: Class<SQLErrors__SYNTAX_ERR> & SQLErrors__SYNTAX_ERR & 5;// 5
static +CONSTRAINT_ERR: Class<SQLErrors__CONSTRAINT_ERR> & SQLErrors__CONSTRAINT_ERR & 6;// 6
static +TIMEOUT_ERR: Class<SQLErrors__TIMEOUT_ERR> & SQLErrors__TIMEOUT_ERR & 7;// 7
...
message: string
	...
	declare export type StatementCallback = (transaction: Transaction, resultSet: ResultSet) => void;
	declare export type StatementErrorCallback = (transaction: Transaction, error: SQLError) => void;
...
errorCallback?: StatementErrorCallback): void
} 
...
success?: TransactionCallback): void,
...
error?: StatementErrorCallback): void,
