 ...
 * @template
 */
  declare export var patchInner: <T>(
 ...
 * @template
 */
  declare export var patchOuter: <T>(
    node: Element,
    fn: (data: T) => void,
    data?: T
  ) => Node | null;
...
Element is created.
 */
  declare export var elementOpenStart: (
    nameOrCtor: NameOrCtorDef,
    key?: string,
    statics?: any[]
  ) => void;
