declare module 'react-images' {
	...
	declare class Lightbox mixins React.Component<LightboxProps> {
constructor(props: LightboxProps): this
}
	declare export interface LightboxProps {
...
alt?: string
	...
	declare export default typeof Lightbox
