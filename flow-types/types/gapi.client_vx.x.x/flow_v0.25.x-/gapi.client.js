declare module "gapi.client" {
   ...
   */
  declare function client$request<T>(args: {
    /**
  ...
  declare type client$Batch<T> = {
    ...
    add<T>(
      ...
      opt_params?: {
        ...
        id: string,
        callback(
          individualResponse: client$Response<T>,
    ...
    execute(
      callback: (
        responseMap: client$ResponseMap<T>,
        rawBatchResponse: string
      ) => any
    ): void
 ...
 */
  declare function auth$authorize(
    ...
    callback: (authResult: auth$GoogleApiOAuth2TokenObject) => void
  ): void;
