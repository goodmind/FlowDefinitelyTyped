 ...
 */
constructor(key: NodeRSA$NodeRSA$Key, format?: NodeRSA$NodeRSA$Format, options?: NodeRSA$NodeRSA$Options): this;
 ...
 */
importKey(key: NodeRSA$NodeRSA$Key, format?: NodeRSA$NodeRSA$Format): NodeRSA;
...
exportKey(
format: NodeRSA$NodeRSA$FormatComponentsPrivate): NodeRSA$NodeRSA$KeyComponentsPrivate;
exportKey(
format: NodeRSA$NodeRSA$FormatComponentsPublic): NodeRSA$NodeRSA$KeyComponentsPublic;
isPrivate(): boolean;
...
encrypt(data: NodeRSA$NodeRSA$Data, encoding: NodeRSA$NodeRSA$Encoding): string;
encrypt(
data: Buffer,
encoding: "buffer",
sourceEncoding?: NodeRSA$NodeRSA$Encoding): Buffer;
encrypt(
data: Buffer,
encoding: NodeRSA$NodeRSA$Encoding,
sourceEncoding?: NodeRSA$NodeRSA$Encoding): string;
encryptPrivate(data: NodeRSA$NodeRSA$Data, encoding?: "buffer"): Buffer;
encryptPrivate(data: NodeRSA$NodeRSA$Data, encoding: NodeRSA$NodeRSA$Encoding): string;
encryptPrivate(
data: Buffer,
encoding: "buffer",
sourceEncoding?: NodeRSA$NodeRSA$Encoding): Buffer;
...
decrypt<T: {[key: string]: any}>(data: Buffer | string, encoding: "json"): T;
decryptPublic(data: Buffer | string, encoding?: "buffer"): Buffer;
decryptPublic(data: Buffer | string, encoding: NodeRSA$NodeRSA$Encoding): string;
decryptPublic<T: {[key: string]: any}>(data: Buffer | string, encoding: "json"): T;
sign(data: NodeRSA$NodeRSA$Data, encoding?: "buffer"): Buffer;
sign(data: NodeRSA$NodeRSA$Data, encoding: NodeRSA$NodeRSA$Encoding): string;
sign(
data: Buffer,
encoding: "buffer",
sourceEncoding?: NodeRSA$NodeRSA$Encoding): Buffer;
...
data: Buffer,
signature: Buffer,
sourceEncoding?: NodeRSA$NodeRSA$Encoding): boolean;
verify(
data: Buffer,
signature: string,
sourceEncoding: NodeRSA$NodeRSA$Encoding,
signatureEncoding: NodeRSA$NodeRSA$Encoding): boolean;
verify(
...
signatureEncoding: NodeRSA$NodeRSA$Encoding): boolean
	...
	declare type NodeRSA$Key = string | Buffer | NodeRSA$KeyComponentsPrivate | NodeRSA$KeyComponentsPublic;

declare type NodeRSA$Data = string | {[key: string]: any} | any[];

declare type NodeRSA$FormatPem = "private"
| "public"
| "pkcs1"
| "pkcs1-pem"
| "pkcs1-private"
...
declare type NodeRSA$FormatDer = "pkcs1-der"
| "pkcs1-private-der"
| "pkcs1-public-der"
| "pkcs8-der"
| "pkcs8-private-der"
...
declare type NodeRSA$FormatComponentsPrivate = "components"
| "components-pem"
| "components-der"
| "components-private"
...
declare type NodeRSA$FormatComponentsPublic = "components-public" | "components-public-pem" | "components-public-der";

declare type NodeRSA$Format = NodeRSA$FormatPem | NodeRSA$FormatDer | NodeRSA$FormatComponentsPrivate | NodeRSA$FormatComponentsPublic;

declare type NodeRSA$EncryptionScheme = "pkcs1_oaep" | "pkcs1";

declare type NodeRSA$HashingAlgorithm = "ripemd160"
| "md4"
| "md5"
| "sha1"
| "sha224"
...
declare type NodeRSA$SigningSchemeHash = "pkcs1-ripemd160"
| "pkcs1-md4"
| "pkcs1-md5"
| "pkcs1-sha"
| "pkcs1-sha1"
...
declare type NodeRSA$Encoding = "ascii"
| "utf8"
| "utf16le"
| "ucs2"
| "latin1"
 ...
 */
mgf(data: Buffer, length: number, hash: NodeRSA$HashingAlgorithm): Buffer
} 

declare type NodeRSA$AdvancedEncryptionScheme = NodeRSA$AdvancedEncryptionSchemePKCS1 | NodeRSA$AdvancedEncryptionSchemePKCS1OAEP;
...
declare type NodeRSA$AdvancedSigningScheme = NodeRSA$AdvancedSigningSchemePSS | NodeRSA$AdvancedSigningSchemePKCS1;
 ...
 */
encryptionScheme?: NodeRSA$EncryptionScheme | NodeRSA$AdvancedEncryptionScheme,

/**
 * scheme used for signing and verifying.. Default 'pkcs1-sha256', or, if chosen pss: 'pss-sha1'.
 */
signingScheme?: NodeRSA$SigningScheme | NodeRSA$SigningSchemeHash | NodeRSA$AdvancedSigningScheme
} 
