 ...
 * be supported.
 */
declare export type BaseType = Element
| EnterElement
| Document
| Window
| null;
 ...
 */
declare export interface EnterElement {
 ...
 */
declare export type ContainerElement = HTMLElement | SVGSVGElement | SVGGElement;
	
/**
 * A User interface event (e.g. mouse event, touch or MSGestureEvent) with captured clientX and clientY properties.
 */
declare export interface ClientPointEvent {
clientX: number,
clientY: number
} 
 ...
 * on a selection
 */
declare export interface CustomEventParameters {
 ...
 */
declare export type ValueFn<T: BaseType, Datum, Result> = (datum: Datum, index: number, groups: T[] | ArrayLike<T>) => Result;
 ...
 */
declare export interface TransitionLike<GElement: BaseType, Datum> {
selection(): Selection<GElement, Datum, any, any>,
on(type: string, listener: null): TransitionLike<GElement, Datum>,
on(
type: string,
listener: ValueFn<GElement, Datum, void>): TransitionLike<GElement, Datum>,
tween(name: string, tweenFn: null): TransitionLike<GElement, Datum>,
tween(
name: string,
tweenFn: ValueFn<GElement, Datum, ((t: number) => void)>): TransitionLike<GElement, Datum>
} 
 ...
 */
declare export function select<GElement: BaseType, OldDatum>(
selector: string): Selection<GElement, OldDatum, HTMLElement, any>
 ...
 */
declare export function select<GElement: BaseType, OldDatum>(
node: GElement): Selection<GElement, OldDatum, null, void>

	
/**
 * Create an empty selection.
 */
declare export function selectAll(): Selection<null, void, null, void>

	
/**
 * Create an empty selection.
 */
declare export function selectAll(selector: null): Selection<null, void, null, void>

	
/**
 * Create an empty selection.
 */
declare export function selectAll(selector: void): Selection<null, void, null, void>
 ...
 * @param selector CSS selector string
 */
declare export function selectAll<GElement: BaseType, OldDatum>(
selector: string): Selection<GElement, OldDatum, HTMLElement, any>
 ...
 */
declare export function selectAll<GElement: BaseType, OldDatum>(
nodes: GElement[]): Selection<GElement, OldDatum, null, void>
 ...
 */
declare export function selectAll<GElement: BaseType, OldDatum>(
nodes: ArrayLike<GElement>): Selection<GElement, OldDatum, null, void>
 ...
 */
declare export interface Selection<GElement: BaseType, Datum, PElement: BaseType, PDatum> {
 ...
 * @param selector CSS selector string
 */
select<DescElement: BaseType>(
selector: string): Selection<DescElement, Datum, PElement, PDatum>,
 ...
 */
select<DescElement: BaseType>(selector: null): Selection<null, void, PElement, PDatum>,
 ...
 */
select<DescElement: BaseType>(
selector: ValueFn<GElement, Datum, DescElement>): Selection<DescElement, Datum, PElement, PDatum>,
 ...
 */
selectAll(): Selection<null, void, GElement, Datum>,

/**
 * Create an empty sub-selection. Selection.selectAll does affect grouping: The elements in the returned
 * selection are grouped by their corresponding parent node in this selection, the group at the current index will be empty.
 */
selectAll(selector: null): Selection<null, void, GElement, Datum>,

/**
 * Create an empty sub-selection. Selection.selectAll does affect grouping: The elements in the returned
 * selection are grouped by their corresponding parent node in this selection, the group at the current index will be empty.
 */
selectAll(selector: void): Selection<null, void, GElement, Datum>,
 ...
 * @param selector CSS selector string
 */
selectAll<DescElement: BaseType, OldDatum>(
selector: string): Selection<DescElement, OldDatum, GElement, Datum>,
 ...
 */
selectAll<DescElement: BaseType, OldDatum>(
selector: ValueFn<GElement, Datum, DescElement[] | ArrayLike<DescElement>>): Selection<DescElement, OldDatum, GElement, Datum>,
...
attr(
name: string,
value: ValueFn<GElement, Datum, string | number | boolean | null>): this,
 ...
 */
property<T>(name: Local<T>): T | void,
 ...
 */
append<K: $Keys<ElementTagNameMap>>(
type: K): Selection<$ElementType<ElementTagNameMap, K>, Datum, PElement, PDatum>,
 ...
 */
insert<K: $Keys<ElementTagNameMap>>(
type: K,
before?: string | ValueFn<GElement, Datum, BaseType>): Selection<$ElementType<ElementTagNameMap, K>, Datum, PElement, PDatum>,
...
before which the element should be inserted.
 */
insert<ChildElement: BaseType>(
type: string | ValueFn<GElement, Datum, ChildElement>,
before?: string | ValueFn<GElement, Datum, BaseType>): Selection<ChildElement, Datum, PElement, PDatum>,
 ...
 */
merge(
other: Selection<GElement, Datum, PElement, PDatum>): Selection<GElement, Datum, PElement, PDatum>,
 ...
 * @param selector A CSS selector string to match when filtering.
 */
filter<FilteredElement: BaseType>(
selector: string): Selection<FilteredElement, Datum, PElement, PDatum>,
 ...
 */
filter(
selector: ValueFn<GElement, Datum, boolean>): Selection<GElement, Datum, PElement, PDatum>,
 ...
 */
filter<FilteredElement: BaseType>(
selector: ValueFn<GElement, Datum, boolean>): Selection<FilteredElement, Datum, PElement, PDatum>,
 ...
 */
datum(value: null): Selection<GElement, void, PElement, PDatum>,
 ...
 */
datum<NewDatum>(
value: ValueFn<GElement, Datum, NewDatum>): Selection<GElement, NewDatum, PElement, PDatum>,
...
data<NewDatum>(
data: NewDatum[],
key?: ValueFn<GElement | PElement, Datum | NewDatum, string>): Selection<GElement, NewDatum, PElement, PDatum>,
 ...
 */
on(typenames: string): ValueFn<GElement, Datum, void> | void,
...
dispatch(
type: string,
parameters?: ValueFn<GElement, Datum, CustomEventParameters>): this,
 ...
 */
declare export type SelectionFn = () => Selection<HTMLElement, any, null, void>;
	
/**
 * Selects the root element, document.documentElement. This function can also be used to test for selections
 * (instanceof d3.selection) or to extend the selection prototype.
 */
declare export var selection: SelectionFn;
 ...
 */
declare export function customEvent<Context, Result>(
event: BaseEvent,
listener: (...args: any[]) => Result,
that: Context,
...args: any[]): Result
 ...
 */
declare export function mouse(container: ContainerElement): [number, number]
 ...
 */
declare export function touch(container: ContainerElement, identifier: number): [number, number] | null
...
touches: TouchList,
identifier: number): [number, number] | null
 ...
 */
declare export function touches(container: ContainerElement, touches?: TouchList): Array<[number, number]>
 ...
 */
declare export function clientPoint(container: ContainerElement, event: ClientPointEvent): [number, number]
 ...
 */
declare export function style(node: Element, name: string): string

	declare export interface Local<T> {

/**
 * Retrieves a local variable stored on the node (or one of its parents).
 * @param node A node element.
 */
get(node: Element): T | void,
 ...
 */
declare export function namespace(prefixedLocal: string): NamespaceLocalObject | string

	
/**
 * Interface for maps of namespace prefixes to corresponding fully qualified namespace strings
 */
declare export interface NamespaceMap {
 ...
 */
declare export var namespaces: NamespaceMap;
 ...
 */
declare export function window(DOMNode: Window | Document | Element): Window
 ...
 */
declare export function create<K: $Keys<ElementTagNameMap>>(
name: K): Selection<$ElementType<ElementTagNameMap, K>, void, null, void>
 ...
 */
declare export function create<NewGElement: Element>(name: string): Selection<NewGElement, void, null, void>
 ...
 * @param name Tag name of the element to be added.
 */
declare export function creator<K: $Keys<ElementTagNameMap>>(name: K): () => $ElementType<ElementTagNameMap, K>
...
such as for SVG elements.
 */
declare export function creator<NewGElement: Element>(name: string): () => NewGElement
 ...
 */
declare export function matcher(selector: string): () => boolean
 ...
 * @param selector A CSS selector string.
 */
declare export function selector<DescElement: Element>(selector: string): () => DescElement
 ...
 * @param selector A CSS selector string.
 */
declare export function selectorAll<DescElement: Element>(selector: string): () => NodeListOf<DescElement>
