declare module "d3-selection" {
   ...
   */
  declare export type ContainerElement =
    | HTMLElement
    | SVGSVGElement
    | SVGGElement;
   ...
   */
  declare export type ValueFn<T: BaseType, Datum, Result> = (
    datum: Datum,
    index: number,
  ...
  declare export function select<GElement: BaseType, OldDatum>(
    node: GElement
  ): Selection<GElement, OldDatum, null, void>;
   ...
   * Create an empty selection.
   */
  declare export function selectAll(
    selector: null
  ): Selection<null, void, null, void>;
  ...
  > {
    ...
    select<DescElement: BaseType>(
      selector: null
    ): Selection<null, void, PElement, PDatum>;
 ...
 */
    ...
    append<K: $Keys<ElementTagNameMap>>(
      type: K
    ): Selection<$ElementType<ElementTagNameMap, K>, Datum, PElement, PDatum>;
 ...
 */
   ...
   */
  declare export type SelectionFn = () => Selection<
    HTMLElement,
    any,
    null,
    void
 ...
 */
   ...
   */
  declare export function clientPoint(
    container: ContainerElement,
 ...
 */
  declare export function namespace(
    prefixedLocal: string
  ): NamespaceLocalObject | string;
  ...
  declare export function create<K: $Keys<ElementTagNameMap>>(
    name: K
  ): Selection<$ElementType<ElementTagNameMap, K>, void, null, void>;
 ...
 */
  declare export function create<NewGElement: Element>(
    name: string
  ): Selection<NewGElement, void, null, void>;
   ...
   * @param name Tag name of the element to be added.
   */
  declare export function creator<K: $Keys<ElementTagNameMap>>(
    name: K
  ): () => $ElementType<ElementTagNameMap, K>;
...
such as for SVG elements.
 */
  declare export function creator<NewGElement: Element>(
    name: string
  ): () => NewGElement;
   ...
   * @param selector A CSS selector string.
   */
  declare export function selector<DescElement: Element>(
    selector: string
  ): () => DescElement;
   ...
   * @param selector A CSS selector string.
   */
  declare export function selectorAll<DescElement: Element>(
    selector: string
  ): () => NodeListOf<DescElement>;
}
