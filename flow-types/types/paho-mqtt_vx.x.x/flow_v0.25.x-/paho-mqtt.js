...
declare type MQTT$ErrorWithInvocationContext = {} & MQTT$MQTTError &
...
<li><code>invocationContext</code> as passed in with the corresponding field in the connectOptions.
 */
declare type MQTT$OnSubscribeSuccessCallback = (
  o: MQTT$OnSubscribeSuccessParams
) => void;
 ...
 */
declare type MQTT$OnFailureCallback = (
  e: MQTT$ErrorWithInvocationContext
) => void;
 ...
 */
  ...
  unsubscribe(
    filter: string,
    unsubcribeOptions?: MQTT$UnsubscribeOptions
  ): void;
}

declare type MQTT$TypedArray =
  | Int8Array
  | Uint8Array
  | Uint8ClampedArray
  | Int16Array
