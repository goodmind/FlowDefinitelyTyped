 ...
 */
declare export function closeHistory<S: Schema>(tr: Transaction<S>): Transaction<S>
 ...
 */
declare export function undo<S: Schema>(
state: EditorState<S>,
 ...
 */
declare export function redo<S: Schema>(
state: EditorState<S>,
dispatch?: (tr: Transaction<S>) => void): boolean
