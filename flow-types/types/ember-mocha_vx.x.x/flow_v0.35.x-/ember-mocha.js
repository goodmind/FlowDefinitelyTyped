import type {
          TestContext,ModuleCallbacks
        } from 'ember-test-helpers';
import typeof Ember from 'ember';
import type {
          mochaIt,ISuiteCallbackContext
        } from 'mocha';
declare type mochaBefore = typeof before;declare type mochaAfter = typeof after;declare type mochaBeforeEach = typeof beforeEach;declare type mochaAfterEach = typeof afterEach;declare type mochaSetup = typeof setup;declare type mochaTeardown = typeof teardown;declare type mochaSuiteSetup = typeof suiteSetup;declare type mochaSuiteTeardown = typeof suiteTeardown;declare module 'ember-mocha' {
        declare interface ContextDefinitionFunction {
(name: string, description: string, callbacks: ModuleCallbacks, tests: () => void): void,
