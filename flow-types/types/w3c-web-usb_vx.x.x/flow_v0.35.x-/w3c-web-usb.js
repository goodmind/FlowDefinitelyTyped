...
constructor(packets: USBIsochronousInTransferPacket[], data?: DataView): this;
data: DataView;
...
endpointNumber: number,
packetLengths: number[]): Promise<USBIsochronousInTransferResult>;
isochronousTransferOut(
endpointNumber: number,
data: BufferSource,
packetLengths: number[]): Promise<USBIsochronousOutTransferResult>;
reset(): Promise<void>
}
