declare module "cosmiconfig" {
  declare function cosmiconfig(
    moduleName: string,
    options?: cosmiconfig$cosmiconfig$ExplorerOptions
  ): cosmiconfig$cosmiconfig$Explorer;
  ...
  declare type cosmiconfig$SyncLoader = (
    filepath: string,
    content: string
  ) => cosmiconfig$Config | null;

  declare type cosmiconfig$AsyncLoader = (
    filepath: string,
    content: string
  ) => cosmiconfig$Config | null | Promise<{ [key: string]: any } | null>;
  ...
  declare interface cosmiconfig$ExplorerOptions {
    ...
    ) => Promise<cosmiconfig$CosmiconfigResult> | cosmiconfig$CosmiconfigResult;
    packageProp?: string;
