...
static +NO_CHANGE: Class<ISOLATION_LEVEL__NO_CHANGE> & ISOLATION_LEVEL__NO_CHANGE & 0;// 0
static +READ_UNCOMMITTED: Class<ISOLATION_LEVEL__READ_UNCOMMITTED> & ISOLATION_LEVEL__READ_UNCOMMITTED & 1;// 1
static +READ_COMMITTED: Class<ISOLATION_LEVEL__READ_COMMITTED> & ISOLATION_LEVEL__READ_COMMITTED & 2;// 2
static +REPEATABLE_READ: Class<ISOLATION_LEVEL__REPEATABLE_READ> & ISOLATION_LEVEL__REPEATABLE_READ & 3;// 3
static +SERIALIZABLE: Class<ISOLATION_LEVEL__SERIALIZABLE> & ISOLATION_LEVEL__SERIALIZABLE & 4;// 4
static +SNAPSHOT: Class<ISOLATION_LEVEL__SNAPSHOT> & ISOLATION_LEVEL__SNAPSHOT & 5;// 5
