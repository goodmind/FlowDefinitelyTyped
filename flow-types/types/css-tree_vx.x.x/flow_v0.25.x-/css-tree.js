declare module "css-tree" {
  ...
  declare export type IteratorFn<TData, TResult, TContext = List<TData>> = (
    item: TData,
    node: ListItem<TData>,
    list: List<TData>
  ) => TResult;
  declare export type FilterFn<
    TData,
    TResult: TData,
    TContext = List<TData>
  > = (item: TData, node: ListItem<TData>, list: List<TData>) => boolean;
  ...
  declare export function parse(text: string, options?: ParseOptions): CssNode;
