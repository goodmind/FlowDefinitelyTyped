declare module "rx" {
  declare var npm$namespace$DOM: {
    ...
    geolocation: typeof npm$namespace$DOM$geolocation
  };
  ...
  declare function DOM$ajax(
    settingsOrUrl: DOM$AjaxSettings | string
  ): Rx.Observable<DOM$AjaxSuccessResponse>;
  ...
  declare function DOM$jsonpRequest(
    settings: DOM$JsonpSettings
  ): Rx.Observable<DOM$JsonpSuccessResponse>;

  declare function DOM$fromEventSource<T>(
    url: string,
  ...
  declare function DOM$fromMutationObserver(
    target: Node,
    options: MutationObserverInit
  ): Rx.Observable<MutationEvent>;

  declare var npm$namespace$DOM$geolocation: {
    getCurrentPosition: typeof DOM$geolocation$getCurrentPosition,
    watchPosition: typeof DOM$geolocation$watchPosition
  };
  declare function DOM$geolocation$getCurrentPosition(
    geolocationOptions?: DOM$GeolocationOptions
  ): Rx.Observable<Position>;

  declare function DOM$geolocation$watchPosition(
    geolocationOptions?: DOM$GeolocationOptions
  ): Rx.Observable<Position>;
}
