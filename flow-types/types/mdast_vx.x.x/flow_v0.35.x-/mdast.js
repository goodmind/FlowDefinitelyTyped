declare module 'mdast' {
        import type {
          UnistParent,UnistLiteral,Node
        } from 'unist';

	declare export type AlignType = "left" | "right" | "center" | null;
	declare export type ReferenceType = "shortcut" | "collapsed" | "full";
	declare export type Content = TopLevelContent
| ListContent
| TableContent
| RowContent
| PhrasingContent;
	declare export type TopLevelContent = BlockContent | FrontmatterContent | DefinitionContent;
	declare export type BlockContent = Paragraph
| Heading
| ThematicBreak
| Blockquote
| List
...
| Code;
	...
	declare export type PhrasingContent = StaticPhrasingContent | Link | LinkReference;
	declare export type StaticPhrasingContent = Text
| Emphasis
| Strong
| Delete
| HTML
