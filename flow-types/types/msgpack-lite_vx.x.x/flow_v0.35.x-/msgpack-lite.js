 ...
 */
declare export function encode(input: any, options?: EncoderOptions): Buffer

	
/**
 * decode from MessagePack to JS Object
 */
declare export function decode(input: Buffer | Uint8Array | number[], options?: DecoderOptions): any

	
/**
 * create a stream that encodes from JS Object to MessagePack
 */
declare export function createEncodeStream(options?: EncoderOptions & stream.TransformOptions): EncodeStream

	
/**
 * create a stream that decodes from MessagePack (Buffer) to JS Object
 */
declare export function createDecodeStream(options?: DecoderOptions & stream.TransformOptions): DecodeStream
 ...
 */
declare export function createCodec(options?: CodecOptions): Codec

	
/**
 * The default built-in codec
 */
declare export var codec: {
...
encode(chunk: any): void,
	...
	declare export interface Decoder {
bufferish: any,
offset: number,
fetch(): void,
flush(): void,
...
push(chunk: any): void,
	...
	declare export type EncodeStream = {
encoder: Encoder
} & stream.Transform

	declare export type DecodeStream = {
decoder: Decoder
} & stream.Transform
...
usemap?: boolean
	...
	declare export interface EncoderOptions {
codec?: Codec
} 
	declare export interface DecoderOptions {
codec?: Codec
} 
    }
