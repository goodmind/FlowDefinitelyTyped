...
newNotification: NotificationSystem$Notification): void
} & React.Component<NotificationSystem$Attributes, NotificationSystem$State>


declare export type NotificationSystem$CallBackFunction = (notification: NotificationSystem$Notification) => void;
