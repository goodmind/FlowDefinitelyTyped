declare module 'aws-iot-device-sdk' {
        import typeof * as mqtt from 'mqtt';

	import typeof * as WebSocket from 'ws';

	declare export type DeviceOptions = {
...
debug?: boolean
	...
	declare export class device mixins NodeJS.EventEmitter {
 ...
 * in options.
 */
constructor(options?: DeviceOptions): this;
...
callback?: (error?: Error) => void): mqtt.Client;
 ...
 */
	...
	declare export type ThingShadowOptions = {
...
operationTimeout?: number
	...
	declare export interface RegisterOptions {
 ...
 */
declare export class thingShadow mixins NodeJS.EventEmitter {
constructor(options?: ThingShadowOptions): this;
...
callback?: (error: Error, failedTopics: mqtt.ISubscriptionGrant[]) => void): void;
...
on(
event: "timeout",
listener: (thingName: string, clientToken: string) => void): this;
...
listener: (thingName: string, operation: "update" | "delete", stateObject: any) => void): this
}
    }
