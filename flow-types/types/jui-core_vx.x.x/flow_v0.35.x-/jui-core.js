declare module 'jui-core' {
        declare export var jui: JuiStatic;
	declare export interface UtilBase {
...
loopArray(
data: any[],
context?: any): ((data: any, index: number, groupIndex: number) => void),
...
scrollWidth(): number
	...
	declare export interface JuiStatic {
...
create(type: string, selector: any, options?: {}): any
	...
	declare export interface UICollection {
destroy(): void
} 
	declare export interface UICore {
tpl?: any,
event?: any,
root?: any,
...
find(selector: any): JQuery
	...
	declare export class ColorScale  {
domain(color: string, color2: string): this;
ticks(max: number): this
}
	declare export interface UtilColor {
...
darken(color: string, rate: number): string
	...
	declare export interface UtilBase64 {
encode(input: string): string,
decode(input: string): string
} 
	declare export interface UtilKeyParser {
...
getParentIndex(index: string): string
	...
	declare export interface UtilMath {
...
inverseMatrix3d(a: any[]): any[]
	...
	declare export type UtilScaleOrdinal = {
(x: number): number,
