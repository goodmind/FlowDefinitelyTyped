declare module "fetch-mock" {
   ...
   */
  declare type fetchMock$MockMatcherFunction = (
    url: string,
   ...
   */
  declare type fetchMock$MockMatcher =
    | string
    | RegExp
   ...
   */
  declare type fetchMock$MockResponse =
    | Response
    | Promise<Response>
    | number
    | Promise<number>
   ...
   */
  declare type fetchMock$MockResponseFunction = (
    url: string,
    opts: fetchMock$MockRequest
 ...
 */
  ...
  declare interface fetchMock$FetchMockStatic {
    ...
    get(
      ...
      options?: fetchMock$MockOptionsMethodGet
    ): this;
    ...
    delete(
      matcher: fetchMock$MockMatcher,
      reponse: fetchMock$MockResponse | fetchMock$MockResponseFunction,
      options?: fetchMock$MockOptionsMethodDelete
    ): this;
    ...
    head(
      matcher: fetchMock$MockMatcher,
      reponse: fetchMock$MockResponse | fetchMock$MockResponseFunction,
      options?: fetchMock$MockOptionsMethodHead
    ): this;
 ...
 */
    calls(
      ...
      options?: fetchMock$InspectionOptions
    ): fetchMock$MockCall[];
