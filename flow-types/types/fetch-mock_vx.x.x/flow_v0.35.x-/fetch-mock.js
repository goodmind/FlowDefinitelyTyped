declare module 'fetch-mock' {
        declare type fetchMock$MockRequest = Request | RequestInit;


/**
 * Mock matcher function
 */
declare type fetchMock$MockMatcherFunction = (url: string, opts: fetchMock$MockRequest) => boolean;
 ...
 */
declare type fetchMock$MockMatcher = string | RegExp | fetchMock$MockMatcherFunction;
 ...
 */
declare type fetchMock$InspectionFilter = fetchMock$MockMatcher | boolean;
 ...
 * calls further.
 */
declare type fetchMock$InspectionOptions = fetchMock$MockOptions | string;


/**
 * Mock response object
 */
declare interface fetchMock$MockResponseObject {
 ...
 */
declare type fetchMock$MockResponse = Response
| Promise<Response>
| number
| Promise<number>
| string
...
| {}
| Promise<{}>
| fetchMock$MockResponseObject
| Promise<fetchMock$MockResponseObject>;


/**
 * Mock response function
 */
declare type fetchMock$MockResponseFunction = (url: string, opts: fetchMock$MockRequest) => fetchMock$MockResponse;


/**
 * Mock options object
 */
declare interface fetchMock$MockOptions {
 ...
 * as specified above
 */
response?: fetchMock$MockResponse | fetchMock$MockResponseFunction,
...
declare type fetchMock$MockCall = {
0: string,
1: RequestInit | void,
identifier: string,
isUnmatched: boolean | void,
request: Request | void
} & Array<string | RequestInit | void>


declare type fetchMock$MockOptionsMethodGet = {
method?: "GET"
} & fetchMock$MockOptions


declare type fetchMock$MockOptionsMethodPost = {
method?: "POST"
} & fetchMock$MockOptions


declare type fetchMock$MockOptionsMethodPut = {
method?: "PUT"
} & fetchMock$MockOptions


declare type fetchMock$MockOptionsMethodDelete = {
method?: "DELETE"
} & fetchMock$MockOptions


declare type fetchMock$MockOptionsMethodHead = {
method?: "HEAD"
} & fetchMock$MockOptions


declare interface fetchMock$FetchMockStatic {
MATCHED: true,
UNMATCHED: false,
...
matcher: fetchMock$MockMatcher,
response: fetchMock$MockResponse | fetchMock$MockResponseFunction,
options?: fetchMock$MockOptions): this,
 ...
 */
mock(options: fetchMock$MockOptions): this,
 ...
 * parallel.
 */
sandbox(): fetchMock$FetchMockSandbox,
...
get(
matcher: fetchMock$MockMatcher,
reponse: fetchMock$MockResponse | fetchMock$MockResponseFunction,
options?: fetchMock$MockOptionsMethodGet): this,
...
matcher: fetchMock$MockMatcher,
reponse: fetchMock$MockResponse | fetchMock$MockResponseFunction,
options?: fetchMock$MockOptionsMethodPost): this,
...
matcher: fetchMock$MockMatcher,
reponse: fetchMock$MockResponse | fetchMock$MockResponseFunction,
options?: fetchMock$MockOptionsMethodPut): this,
...
matcher: fetchMock$MockMatcher,
reponse: fetchMock$MockResponse | fetchMock$MockResponseFunction,
options?: fetchMock$MockOptionsMethodDelete): this,
...
matcher: fetchMock$MockMatcher,
reponse: fetchMock$MockResponse | fetchMock$MockResponseFunction,
options?: fetchMock$MockOptionsMethodHead): this,
 ...
 * @param response Configures the http response returned by the mock
 */
catch(response?: fetchMock$MockResponse | fetchMock$MockResponseFunction): this,
 ...
 */
spy(response?: fetchMock$MockResponse | fetchMock$MockResponseFunction): this,
 ...
 */
flush(waitForBody?: boolean): Promise<fetchMock$MockResponse[]>,
...
options?: fetchMock$InspectionOptions): fetchMock$MockCall[],
...
called(
filter?: fetchMock$InspectionFilter,
options?: fetchMock$InspectionOptions): boolean,
 ...
 */
done(filter?: fetchMock$InspectionFilter): boolean,
...
lastCall(
filter?: fetchMock$InspectionFilter,
options?: fetchMock$InspectionOptions): fetchMock$MockCall | void,
...
lastUrl(
filter?: fetchMock$InspectionFilter,
options?: fetchMock$InspectionOptions): string | void,
...
lastOptions(
filter?: fetchMock$InspectionFilter,
options?: fetchMock$InspectionOptions): fetchMock$MockOptions | void,
config: {
 ...
 * implementation.
 */
Promise?: (executor: (resolve: () => void, reject: () => void) => void) => Promise<Response>,
 ...
 * implementation.
 */
Request?: (input: string | Request, init?: RequestInit) => Request,
...
declare type fetchMock$FetchMockSandbox = {
...
(input?: string | Request, init?: RequestInit): Promise<Response>
	...
	declare var fetchMock: fetchMock$fetchMock$FetchMockStatic;
