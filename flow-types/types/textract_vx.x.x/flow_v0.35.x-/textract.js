declare module 'textract' {
        import typeof * as ChildProc from 'child_process';

	import type {
          URL
        } from 'url';

	declare export interface extractorExecOpts {
exec: {
[index: string]: string
}
} 
 ...
 */
declare export function fromFileWithPath(filePath: string, callback: (error: Error, text: string) => void): void
 ...
 * @param callback callback
 */
declare export function fromFileWithPath(
filePath: string,
config: Config,
callback: (error: Error, text: string) => void): void
 ...
 * @param callback callback
 */
declare export function fromFileWithMimeAndPath(
mimeType: string,
filePath: string,
callback: (error: Error, text: string) => void): void
 ...
 * @param callback callback
 */
declare export function fromBufferWithMime(
mimeType: string,
buffer: Buffer,
callback: (error: Error, text: string) => void): void
 ...
 * @param callback callback
 */
declare export function fromBufferWithName(
name: string,
buffer: Buffer,
callback: (error: Error, text: string) => void): void
 ...
 * @param callback callback
 */
declare export function fromUrl(url: string | URL, callback: (error: Error, text: string) => void): void
 ...
 * @param callback callback
 */
declare export function fromUrl(
url: string | URL,
config: URLConfig,
callback: (error: Error, text: string) => void): void
