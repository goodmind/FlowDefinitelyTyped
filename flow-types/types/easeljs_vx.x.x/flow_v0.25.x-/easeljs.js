declare module "easeljs" {
  ...
  declare export class createjs$Container mixins createjs$DisplayObject {
    ...
    addChildAt(
      ...childOrIndex: (createjs$DisplayObject | number)[]
    ...
    sortChildren(
      sortFunction: (
        a: createjs$DisplayObject,
        b: createjs$DisplayObject
      ) => number
    ): void;
    swapChildren(
      child1: createjs$DisplayObject,
  ...
  declare export class createjs$StageGL mixins createjs$Stage {
    constructor(
      ...
      options?: createjs$IStageGLOptions
    ): this;
