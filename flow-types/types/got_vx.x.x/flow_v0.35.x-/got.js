...
response: any
	...
	declare var got: got$got$GotFn & Record<"get"
| "post"
| "put"
| "patch"
| "head"
| "delete", got$got$GotFn> & {
stream: got$got$GotStreamFn & Record<"get"
| "post"
| "put"
| "patch"
| "head"
| "delete", got$got$GotStreamFn>,
...
(url: got$GotUrl, options: got$GotFormOptions<string>): got$GotPromise<string>,
(url: got$GotUrl, options: got$GotFormOptions<null>): got$GotPromise<Buffer>,
(url: got$GotUrl, options: got$GotBodyOptions<string>): got$GotPromise<string>,
(url: got$GotUrl, options: got$GotBodyOptions<null>): got$GotPromise<Buffer>
} 

declare type got$GotStreamFn = (
url: got$GotUrl,
options?: got$GotOptions<string | null>) => got$GotEmitter & nodeStream.Duplex;
 ...
 */
declare interface got$Hooks<Options, Body: Buffer | string | {[key: string]: any}> {
 ...
 */
declare type got$BeforeRetryHook<Options> = (options: Options, error: got$GotError, retryCount: number) => any;
 ...
 */
declare type got$AfterResponseHook<Options, Body: Buffer | string | {[key: string]: any}> = (
response: got$Response<Body>,
retryWithMergedOptions: (updateOptions: Options) => got$GotPromise<Body>) => got$Response<Body> | Promise<got$Response<Body>>;

declare type got$GotBodyOptions<E: string | null> = {
body?: string | Buffer | nodeStream.Readable,
hooks?: got$Hooks<got$GotBodyOptions<E>, string | Buffer | nodeStream.Readable>
} & got$GotOptions<E>
...
declare type got$GotPromise<B: Buffer | string | {[key: string]: any}> = Promise<got$Response<B>> & {
cancel(): void
};
...
nextOptions: got$GotOptions<string | null> & Url) => void): this,
addListener(
event: "error",
listener: (error: got$GotError, body?: any, res?: http.IncomingMessage) => void): this,
addListener(event: "downloadProgress", listener: (progress: got$Progress) => void): this,
addListener(event: "uploadProgress", listener: (progress: got$Progress) => void): this,
...
event: "error",
listener: (error: got$GotError, body?: any, res?: http.IncomingMessage) => void): this,
on(event: "downloadProgress", listener: (progress: got$Progress) => void): this,
on(event: "uploadProgress", listener: (progress: got$Progress) => void): this,
...
event: "error",
listener: (error: got$GotError, body?: any, res?: http.IncomingMessage) => void): this,
once(event: "downloadProgress", listener: (progress: got$Progress) => void): this,
once(event: "uploadProgress", listener: (progress: got$Progress) => void): this,
...
event: "error",
listener: (error: got$GotError, body?: any, res?: http.IncomingMessage) => void): this,
prependListener(event: "downloadProgress", listener: (progress: got$Progress) => void): this,
prependListener(event: "uploadProgress", listener: (progress: got$Progress) => void): this,
...
event: "error",
listener: (error: got$GotError, body?: any, res?: http.IncomingMessage) => void): this,
prependOnceListener(event: "downloadProgress", listener: (progress: got$Progress) => void): this,
prependOnceListener(event: "uploadProgress", listener: (progress: got$Progress) => void): this,
...
event: "error",
listener: (error: got$GotError, body?: any, res?: http.IncomingMessage) => void): this,
removeListener(event: "downloadProgress", listener: (progress: got$Progress) => void): this,
removeListener(event: "uploadProgress", listener: (progress: got$Progress) => void): this
} 

declare type got$GotError = RequestError
| ReadError
| ParseError
| HTTPError
| MaxRedirectsError
