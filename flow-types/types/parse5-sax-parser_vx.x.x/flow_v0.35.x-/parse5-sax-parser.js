...
on(
event: "startTag",
listener: (startTag: SAXParser$SAXParser$StartTagToken) => void): this;
...
on(
event: "endTag",
listener: (endTag: SAXParser$SAXParser$EndTagToken) => void): this;

/**
 * Raised when parser encounters text content.
 * @param - Text token.
 */
on(event: "text", listener: (text: SAXParser$SAXParser$TextToken) => void): this;
...
on(
event: "comment",
listener: (comment: SAXParser$SAXParser$CommentToken) => void): this;
...
on(
event: "doctype",
listener: (doctype: SAXParser$SAXParser$DoctypeToken) => void): this;
