 ...
 */
list(
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$Domain[]>): void,

/**
 * List all your inbound domains.
 * @returns Promise The Domain results array
 */
list(): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$Domain[]>,
 ...
 */
get(domain: string): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$Domain>,
 ...
 */
create(
createOpts: SparkPost$SparkPost$CreateOpts,
callback: SparkPost$SparkPost$Callback<void>): void,
 ...
 */
create(createOpts: SparkPost$SparkPost$CreateOpts): Promise<void>,
 ...
 * @param callback The request callback
 */
delete(domain: string, callback: SparkPost$SparkPost$Callback<void>): void,
 ...
 */
search(
parameters: SparkPost$SparkPost$MessageEventParameters,
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$MessageEvent[]>): void,
 ...
 */
search(
parameters: SparkPost$SparkPost$MessageEventParameters): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$MessageEvent[]>
};
 ...
 */
list(
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$RecipientList[]>): void,
 ...
 */
list(): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$RecipientList[]>,
...
callback: SparkPost$SparkPost$Callback<SparkPost$SparkPost$RecipientListWithRecipients>): void,
...
options?: {
show_recipients?: boolean
}): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$RecipientListWithRecipients>,
 ...
 */
create(
options: SparkPost$SparkPost$CreateRecipientList,
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$RecipientListMetadata>): void,
 ...
 */
create(
options: SparkPost$SparkPost$CreateRecipientList): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$RecipientListMetadata>,
...
update(
id: string,
options: SparkPost$SparkPost$UpdateRecipientList,
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$RecipientListMetadata>): void,
...
update(
id: string,
options: SparkPost$SparkPost$UpdateRecipientList): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$RecipientListMetadata>,
 ...
 * @param callback The request callback
 */
delete(id: string, callback: SparkPost$SparkPost$Callback<void>): void,
 ...
 */
list(
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$RelayWebhook[]>): void,

/**
 * List all your relay webhooks.
 * @returns Promise The RelayWebhook results array
 */
list(): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$RelayWebhook[]>,
 ...
 */
get(
relayWebhookId: string): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$RelayWebhook>,
 ...
 */
create(
options: SparkPost$SparkPost$RelayWebhook,
callback: SparkPost$SparkPost$ResultsCallback<{
id: string
}>): void,
 ...
 */
create(
options: SparkPost$SparkPost$RelayWebhook): SparkPost$SparkPost$ResultsPromise<{
id: string
}>,
...
update(
id: string,
options: SparkPost$SparkPost$UpdateRelayWebhook,
callback: SparkPost$SparkPost$ResultsCallback<{
id: string
}>): void,
...
update(
id: string,
options: SparkPost$SparkPost$UpdateRelayWebhook): SparkPost$SparkPost$ResultsPromise<{
id: string
}>,
 ...
 * @param callback The request callback
 */
delete(relayWebhookId: string, callback: SparkPost$SparkPost$Callback<void>): void,
 ...
 */
list(
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$SendingDomain[]>): void,

/**
 * List an overview of all sending domains in the system.
 * @returns The SendingDomain results array
 */
list(): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$SendingDomain[]>,
 ...
 */
get(
domain: string): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$SendingDomain>,
 ...
 */
create(
options: SparkPost$SparkPost$CreateSendingDomain,
callback: SparkPost$SparkPost$ResultsCallback<{
message: string,
domain: string
}>): void,
 ...
 */
create(
options: SparkPost$SparkPost$CreateSendingDomain): SparkPost$SparkPost$ResultsPromise<{
message: string,
domain: string
}>,
...
update(
domain: string,
updateOpts: SparkPost$SparkPost$UpdateSendingDomain,
callback: SparkPost$SparkPost$ResultsCallback<{
message: string,
domain: string
}>): void,
...
update(
domain: string,
updateOpts: SparkPost$SparkPost$UpdateSendingDomain): SparkPost$SparkPost$ResultsPromise<{
message: string,
domain: string
}>,
...
verify(
domain: string,
options: SparkPost$SparkPost$VerifyOptions,
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$VerifyResults>): void,
...
verify(
domain: string,
options: SparkPost$SparkPost$VerifyOptions): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$VerifyResults>
};
subaccounts: {
 ...
 */
list(
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$SubaccountInformation[]>): void,
 ...
 */
list(
): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$SubaccountInformation[]>,
 ...
 */
get(
id: string | number): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$SubaccountInformation>,
 ...
 */
create(
subaccount: SparkPost$SparkPost$CreateSubaccount,
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$CreateSubaccountResponse>): void,
 ...
 */
create(
subaccount: SparkPost$SparkPost$CreateSubaccount): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$CreateSubaccountResponse>,
...
update(
id: string,
subaccount: SparkPost$SparkPost$UpdateSubaccount,
callback: SparkPost$SparkPost$ResultsCallback<{
message: string
}>): void,
...
update(
id: string,
subaccount: SparkPost$SparkPost$UpdateSubaccount): SparkPost$SparkPost$ResultsPromise<{
message: string
}>
};
suppressionList: {
 ...
 */
list(
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$SupressionListEntry[]>): void,
 ...
 */
list(
parameters: SparkPost$SparkPost$SupressionSearchParameters,
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$SupressionListEntry[]>): void,
 ...
 */
list(
parameters?: SparkPost$SparkPost$SupressionSearchParameters): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$SupressionListEntry[]>,
 ...
 */
get(
email: string): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$SupressionListEntry[]>,

/**
 * Delete a recipient from the list by specifying the recipient’s email address in the URI path.
 * @param email Recipient email address
 */
delete(email: string, callback: SparkPost$SparkPost$Callback<void>): void,
 ...
 */
upsert(
listEntries: SparkPost$SparkPost$CreateSupressionListEntry | SparkPost$SparkPost$CreateSupressionListEntry[],
callback: SparkPost$SparkPost$ResultsCallback<{
message: string
}>): void,
 ...
 */
upsert(
listEntries: SparkPost$SparkPost$CreateSupressionListEntry | SparkPost$SparkPost$CreateSupressionListEntry[]): SparkPost$SparkPost$ResultsPromise<{
message: string
}>
};
templates: {
 ...
 */
list(
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$TemplateMeta[]>): void,

/**
 * List a summary of all templates.
 * @returns The TemplateMeta results array
 */
list(): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$TemplateMeta[]>,
...
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$Template>): void,
...
options?: {
draft?: boolean
}): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$Template>,
 ...
 */
create(
template: SparkPost$SparkPost$CreateTemplate,
callback: SparkPost$SparkPost$ResultsCallback<{
id: string
}>): void,
 ...
 */
create(
template: SparkPost$SparkPost$CreateTemplate): SparkPost$SparkPost$ResultsPromise<{
id: string
}>,
...
update(
id: string,
template: SparkPost$SparkPost$UpdateTemplate,
options: {
...
options?: {
update_published?: boolean
}): SparkPost$SparkPost$ResultsPromise<{
id: string
}>,
...
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$TemplateContent>): void,
...
substitution_data?: any,
draft?: boolean
}): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$TemplateContent>
};
transmissions: {
 ...
 */
list(
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$TransmissionSummary[]>): void,
...
campaign_id?: string,
template_id?: string
}): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$TransmissionSummary[]>,
...
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$Transmission>): void,
 ...
 */
get(
id: string): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$Transmission>,
 ...
 */
send(
transmission: SparkPost$SparkPost$CreateTransmission,
options: {
 ...
 */
list(
callback: SparkPost$SparkPost$ResultsCallback<Array<SparkPost$SparkPost$WebhookLinks & SparkPost$SparkPost$Webhook>>): void,
...
options?: {
timezone?: string
}): SparkPost$SparkPost$ResultsPromise<Array<SparkPost$SparkPost$WebhookLinks & SparkPost$SparkPost$Webhook>>,
...
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$WebhookLinks & SparkPost$SparkPost$Webhook>): void,
...
options?: {
timezone?: string
}): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$WebhookLinks & SparkPost$SparkPost$Webhook>,
 ...
 */
create(
options: SparkPost$SparkPost$Webhook,
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$WebhookLinks & {
id: string
}>): void,
 ...
 */
create(
options: SparkPost$SparkPost$Webhook): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$WebhookLinks & {
id: string
}>,
...
update(
id: string,
options: SparkPost$SparkPost$UpdateWebhook,
callback: SparkPost$SparkPost$ResultsCallback<SparkPost$SparkPost$WebhookLinks & {
id: string
}>): void,
...
update(
id: string,
options: SparkPost$SparkPost$UpdateWebhook): SparkPost$SparkPost$ResultsPromise<SparkPost$SparkPost$WebhookLinks & {
id: string
}>,
...
callback: SparkPost$SparkPost$ResultsCallback<Array<{
batch_id: string,
ts: string,
attempts: number,
...
options: {
limit?: number
}): SparkPost$SparkPost$ResultsPromise<Array<{
batch_id: string,
ts: string,
attempts: number,
response_code: number
 ...
 */
getDocumentation(callback: SparkPost$SparkPost$ResultsCallback<any>): void,

/**
 * Lists descriptions of the events, event types, and event fields that could be included in a Webhooks post to your target URL.
 * @returns The documentation results
 */
getDocumentation(): SparkPost$SparkPost$ResultsPromise<any>,
 ...
 */
getSamples(callback: SparkPost$SparkPost$Callback<any>): void,
...
callback: SparkPost$SparkPost$Callback<any>): void,
...
getSamples(options?: {
events?: string
}): Promise<SparkPost$SparkPost$Response<any>>
};
 ...
 */
constructor(apiKey?: string, options?: SparkPost$SparkPost$ConstructorOptions): this;
request(options: Request.Options, callback: SparkPost$SparkPost$Callback<any>): void;
request(options: Request.Options): Promise<SparkPost$SparkPost$Response<any>>;
get(options: Request.Options, callback: SparkPost$SparkPost$Callback<any>): void;
get(options: Request.Options): Promise<SparkPost$SparkPost$Response<any>>;
post(options: Request.Options, callback: SparkPost$SparkPost$Callback<any>): void;
post(options: Request.Options): Promise<SparkPost$SparkPost$Response<any>>;
put(options: Request.Options, callback: SparkPost$SparkPost$Callback<any>): void;
put(options: Request.Options): Promise<SparkPost$SparkPost$Response<any>>;
delete(options: Request.Options, callback: SparkPost$SparkPost$Callback<any>): void;
delete(options: Request.Options): Promise<SparkPost$SparkPost$Response<any>>
}
	declare interface SparkPost$ErrorWithDescription {
message: string,
code: string,
description: string
} 

declare interface SparkPost$ErrorWithParam {
message: string,
param: string,
value: string | null
} 

declare type SparkPost$SparkPostError = {
name: "SparkPostError",
errors: SparkPost$ErrorWithDescription[] | SparkPost$ErrorWithParam[],
statusCode: number
} & Error


declare interface SparkPost$ConstructorOptions {
origin?: string,
endpoint?: string,
apiVersion?: string,
headers?: any
...
declare type SparkPost$Response<T> = {
body: T
} & Http.IncomingMessage


declare type SparkPost$Callback<T> = (
err: Error | SparkPost$SparkPostError | null,
res: SparkPost$Response<T>) => void;

declare type SparkPost$ResultsCallback<T> = SparkPost$Callback<{
results: T
}>;

declare type SparkPost$ResultsPromise<T> = Promise<{
results: T
}>;

declare interface SparkPost$Domain {
domain: string
} 

declare interface SparkPost$MessageEvent {
...
declare interface SparkPost$MessageEventParameters {
...
declare interface SparkPost$RecipientListMetadata {
total_rejected_recipients: number,
total_accepted_recipients: number,
id: string,
name: string
...
declare interface SparkPost$RecipientList {
...
declare type SparkPost$RecipientListWithRecipients = {

/**
 * Array of recipient objects
 */
recipients: SparkPost$Recipient[]
} & SparkPost$RecipientList


declare interface SparkPost$CreateRecipientList {
...
declare interface SparkPost$UpdateRecipientList {
...
declare interface SparkPost$BaseRecipient {
...
declare interface SparkPost$RecipientWithAddress {

/**
 * Address information for a recipient  At a minimum, address or multichannel_addresses is required.
 */
address: SparkPost$Address | string
} 

declare interface SparkPost$RecipientWithMultichannelAddresses {
 ...
 * If both address and multichannel_addresses are specified only multichannel_addresses will be used.
 */
multichannel_addresses: SparkPost$MultichannelAddress[]
} 

declare type SparkPost$Recipient = (SparkPost$RecipientWithAddress | SparkPost$RecipientWithMultichannelAddresses) & SparkPost$BaseRecipient;

declare interface SparkPost$Address {
...
declare interface SparkPost$MultichannelAddress {
...
declare interface SparkPost$RelayWebhook {
 ...
 */
match: SparkPost$Match
} 

declare interface SparkPost$UpdateRelayWebhook {
...
declare interface SparkPost$Match {
...
declare interface SparkPost$SendingDomain {
...
declare interface SparkPost$CreateSendingDomain {
...
declare interface SparkPost$UpdateSendingDomain {
...
declare interface SparkPost$DKIM {
...
declare interface SparkPost$Status {
...
declare interface SparkPost$VerifyOptions {
...
declare type SparkPost$VerifyResults = {
dns?: {
dkim_record: string,
spf_record: string
}
...
declare interface SparkPost$CreateSubaccount {
...
declare interface SparkPost$CreateSubaccountResponse {
...
declare interface SparkPost$UpdateSubaccount {
...
declare interface SparkPost$SubaccountInformation {
...
declare interface SparkPost$CreateSupressionListEntry {
...
declare interface SparkPost$SupressionListEntry {
...
declare interface SparkPost$SupressionSearchParameters {
...
declare interface SparkPost$TemplateContent {
...
declare interface SparkPost$CreateTemplateContent {
...
declare interface SparkPost$TemplateMeta {
...
declare interface SparkPost$Template {
 ...
 */
content: SparkPost$TemplateContent | {
email_rfc822: string
},
 ...
 */
options: SparkPost$TemplateOptions,
...
declare interface SparkPost$CreateTemplate {
 ...
 * Content that will be used to construct a message  yes  For a full description, see the Content Attributes. Maximum length - 20 MBs
 */
content: SparkPost$CreateTemplateContent | {
email_rfc822: string
},
 ...
 * JSON object in which template options are defined  no  For a full description, see the Options Attributes.
 */
options?: SparkPost$CreateTemplateOptions
} 

declare interface SparkPost$UpdateTemplate {
...
declare interface SparkPost$TemplateOptions {
...
declare interface SparkPost$CreateTemplateOptions {
 ...
 */
content: SparkPost$InlineContent | {
template_id: string,
...
declare interface SparkPost$TransmissionSummary {
...
declare interface SparkPost$Transmission {
...
declare interface SparkPost$TransmissionOptions {
...
declare interface SparkPost$InlineContent {
 ...
 */
inline_images?: SparkPost$Attachment[]
} 

declare interface SparkPost$PushData {
...
declare interface SparkPost$Attachment {
...
declare interface SparkPost$Webhook {
...
declare interface SparkPost$UpdateWebhook {
...
declare interface SparkPost$WebhookLinks {
links: Array<{
href: string,
rel: string,
method: string[]
...
declare interface SparkPost$CreateOpts {
...
domain: string
	...
	declare module.exports: typeof SparkPost
