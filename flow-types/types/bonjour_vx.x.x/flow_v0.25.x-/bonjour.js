declare module "bonjour" {
  declare function bonjour(
    opts?: bonjour$bonjour$BonjourOptions
  ...
  declare type bonjour$Browser = {
    ...
    on(
      event: "up" | "down",
      listener: (service: bonjour$Service) => void
    ): this,
    once(
      event: "up" | "down",
      listener: (service: bonjour$Service) => void
  ...
  declare interface bonjour$Bonjour {
    ...
    find(
      ...
      onUp?: (service: bonjour$Service) => void
    ): bonjour$Browser;
    findOne(
      options: bonjour$BrowserOptions,
      cb?: (service: bonjour$Service) => void
    ): bonjour$Browser;
    destroy(): void;
  }
}
