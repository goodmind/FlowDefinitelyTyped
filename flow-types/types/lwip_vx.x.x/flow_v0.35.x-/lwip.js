...
a?: number
	...
	declare export type Color = string | [number, number, number, number] | ColorObject;
	declare export interface ImageCallback {
(err: any, image: Image): void
} 
	declare export interface BufferCallback {
 ...
 */
declare export function open(source: string, callback: ImageCallback): void
 ...
 */
declare export function open(source: string, type: string, callback: ImageCallback): void
 ...
 */
declare export function create(width: number, height: number, callback: ImageCallback): void
 ...
 */
declare export function create(width: number, height: number, color: Color, callback: ImageCallback): void

	declare export type JpegBufferParams = {
quality?: number
};
	declare export type PngBufferParams = {
compression?: string,
interlaced?: boolean,
transparency?: boolean | string
};
	declare export type GifBufferParams = {
colors?: number,
interlaced?: boolean,
transparency?: boolean | string,
threshold: number
...
batch(): Batch
	...
	declare export interface Batch {
