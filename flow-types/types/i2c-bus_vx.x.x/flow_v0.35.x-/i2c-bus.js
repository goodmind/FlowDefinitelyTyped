declare module 'i2c-bus' {
        declare type CompletionCallback = (error: any) => any;
	declare type BufferCallback = (error: any, bytesReadOrWritten: number, buffer: Buffer) => any;
	declare type ResultCallback<T> = (error: any, result: T) => any;
	declare export interface I2cBusFuncs {
i2c: boolean,
tenBitAddr: boolean,
...
smbusWriteI2cBlock: boolean
	...
	declare export interface I2cBus {
 ...
 * @param {ResultCallback<I2cBusFuncs>} callback Callback that will recieve a frozen I2cFuncs object describing the I2C functionality available.
 */
i2cFuncs(callback: ResultCallback<I2cBusFuncs>): void,

/**
 * Determine functionality of the bus/adapter synchronously.
 * @return {I2cBusFuncs} A frozen I2cFuncs object describing the I2C functionality available.
 */
i2cFuncsSync(): I2cBusFuncs,

/**
 * Scans the I2C bus asynchronously for devices the same way <code>i2cdetect -y -r</code> would.
 * @param {ResultCallback<number[]>} callback Callback that will recieve an array of numbers where each number represents the I2C address of a device which was detected.
 */
 ...
 * @return {number[]} An array of numbers where each number represents the I2C address of a device which was detected.
 */
scanSync(): number[],
 ...
 * @param {number} address I2C device address.
 * @return {number} The byte received.
 */
 ...
 * @param {CompletionCallback} callback Completion callback.
 * @return {I2cBus} A new I2cBus object.
 */
declare export function open(busNumber: number, callback: CompletionCallback): I2cBus
 ...
 * @return {I2cBus} A new I2cBus object.
 */
declare export function openSync(busNumber: number): I2cBus
