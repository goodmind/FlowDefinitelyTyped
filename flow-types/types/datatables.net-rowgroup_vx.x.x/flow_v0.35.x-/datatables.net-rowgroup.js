...
new (dt: DataTables$Api, settings: boolean | DataTables$RowGroupSettings): void,
version: string,
 ...
 */
endRender?: (rows: DataTables$Api, group: string) => string | HTMLElement | JQuery,

/**
 * Provide a function that can be used to control the data shown in the start grouping row
 */
startRender?: (rows: DataTables$Api, group: string) => string | HTMLElement | JQuery
} 
    }
