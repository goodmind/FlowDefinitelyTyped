declare module '@ledgerhq/hw-transport' {
        declare class Transport<TDescriptor: Descriptor>  {
constructor(): this;
...
timeout?: number): Promise<Transport<typeof descriptor>>;
...
p2: number,
data: Buffer,
statusList: $ReadOnlyArray<number>): Promise<Buffer>
}
...
+unsubscribe: () => void
	...
	declare export var StatusCodes: $ObjMapi<{[k: string]: any}, <k>(k) => number>;
