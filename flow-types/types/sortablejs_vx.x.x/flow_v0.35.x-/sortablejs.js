 ...
 * @param options Sortable options object.
 */
static create(element: HTMLElement, options: Sortable$Sortable$Options): Sortable;
...
name: K,
value: $ElementType<Sortable$Sortable$Options, K>): void;
option<K: $Keys<Sortable$Sortable$Options>>(
name: K): $ElementType<Sortable$Sortable$Options, K>;
...
element: HTMLElement,
prop: K): $ElementType<CSSStyleDeclaration, K>,
...
element: HTMLElement,
prop: K,
value: $ElementType<CSSStyleDeclaration, K>): void,
...
context: HTMLElement,
tagName: string,
iterator?: (value: HTMLElement, index: number) => void): NodeListOf<HTMLElement>,
...
element: HTMLElement,
selector: string,
context?: HTMLElement): HTMLElement | null,
