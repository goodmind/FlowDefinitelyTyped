...
scale(control$zoom: number): number,
zoom(control$scale: number): number,
...
noClip?: boolean
	...
	declare export class Polyline<T: geojson.GeometryObject, P> mixins Path {
...
options?: PolylineOptions): Polyline
	...
	declare export class Polygon<P> mixins Polyline<geojson.Polygon | geojson.MultiPolygon, P> {
...
options?: PolylineOptions): Polygon
	...
	declare export class Rectangle<P> mixins Polygon<P> {
...
radius?: number
	...
	declare export class CircleMarker<P> mixins Path {
...
feature: geojson.Feature<geojson.Point, P>
	...
	declare export class Circle<P> mixins CircleMarker<P> {
constructor(latlng: LatLngExpression, options?: CircleMarkerOptions): this;
 ...
 */
declare export class LayerGroup<P> mixins Layer {
 ...
 */
declare export class FeatureGroup<P> mixins LayerGroup<P> {
...
declare export function featureGroup(control$layers?: Layer[]): FeatureGroup
	...
	declare export type StyleFunction<P> = (feature?: geojson.Feature<geojson.GeometryObject, P>) => PathOptions;
	declare export type GeoJSONOptions<P> = {
 ...
 */
declare export class GeoJSON<P> mixins FeatureGroup<P> {
 ...
 * an options object.
 */
declare export function geoJSON<P>(geojson?: geojson.GeoJsonObject, options?: GeoJSONOptions<P>): GeoJSON<P>
...
iconUrl: string
	...
	declare export class Icon<T: BaseIconOptions> mixins Layer {
...
riseOffset?: number
	...
	declare export class Marker<P> mixins Layer {
...
declare function Util$extend<D: {[key: string]: any}, S1: {[key: string]: any}>(dest: D, src?: S1): D & S1
