...
timestamp: number;
constructor(id: string, timestamp: number, attempts: number, body: any, requeueDelay: number, msgTimeout: number, maxMsgTimeout: number): this;
json(): any;
...
on(
event: "respond",
listener: (responseType: number, wireData: Buffer) => void): this
}
...
static ERROR: string;
constructor(nsqdHost: string, nsqdPort: number, options?: ConnectionConfigOptions): this;
connect(): any;
...
constructor(topic: string, channel: any, options?: ReaderConnectionConfigOptions): this;
connect(): any;
close(): any;
pause(): any;
unpause(): any;
...
listener: (host: string, port: number) => void): this;
