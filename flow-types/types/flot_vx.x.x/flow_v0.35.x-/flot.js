...
processRawData?: {
(flot$plot: flot$plot, series: flot$dataSeries, data: any[], flot$datapoints: flot$datapoints): void
}[],
processDatapoints?: {
(flot$plot: flot$plot, series: flot$dataSeries, flot$datapoints: flot$datapoints): void
}[],
processOffset?: {
...
drawSeries?: {
(flot$plot: flot$plot, context: CanvasRenderingContext2D, series: flot$dataSeries): void
}[],
draw?: {
(flot$plot: flot$plot, context: CanvasRenderingContext2D): void
}[],
...
(placeholder: JQuery, data: flot$dataSeries[], options?: flot$plotOptions): flot$plot,
