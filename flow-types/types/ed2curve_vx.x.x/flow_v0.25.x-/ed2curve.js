declare module "ed2curve" {
  ...
  declare export function convertPublicKey(
    publicKey: $ElementType<SignKeyPair, "publicKey">
  ): $ElementType<BoxKeyPair, "publicKey"> | null;

  /**
   * Converts Ed25519 secret key to Curve25519 secret key.
   */
  declare export function convertSecretKey(
    secretKey: $ElementType<SignKeyPair, "secretKey">
  ): $ElementType<BoxKeyPair, "secretKey">;

  /**
   * Converts Ed25519 key pair to Curve25519 key pair.
   */
  declare export function convertKeyPair(
    keyPair: SignKeyPair
  ): BoxKeyPair | null;
}
