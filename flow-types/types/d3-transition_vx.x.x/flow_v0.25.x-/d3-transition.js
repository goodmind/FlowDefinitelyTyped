...
declare module "d3-transition" {
  import type { ArrayLike, BaseType, Selection, ValueFn } from "d3-selection";
 ...
 */
    ...
    attrTween(
      name: string
    ): ValueFn<GElement, Datum, (t: number) => string> | void;
 ...
 */
   ...
   */
  declare export type SelectionOrTransition<
    GElement: BaseType,
    Datum,
    PElement: BaseType,
    PDatum
  ...
  declare export function transition<OldDatum>(
    name?: string
  ): Transition<HTMLElement, OldDatum, null, void>;
