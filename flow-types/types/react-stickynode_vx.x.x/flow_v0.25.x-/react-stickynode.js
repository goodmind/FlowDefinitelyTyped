declare module "react-stickynode" {
  ...
  declare class Sticky$StatusCode {
    ...
    static +STATUS_ORIGINAL: Class<Sticky$StatusCode__STATUS_ORIGINAL> &
      Sticky$StatusCode__STATUS_ORIGINAL &
      0; // 0
    static +STATUS_RELEASED: Class<Sticky$StatusCode__STATUS_RELEASED> &
      Sticky$StatusCode__STATUS_RELEASED &
      1; // 1
    static +STATUS_FIXED: Class<Sticky$StatusCode__STATUS_FIXED> &
      Sticky$StatusCode__STATUS_FIXED &
      2; // 2
  }
