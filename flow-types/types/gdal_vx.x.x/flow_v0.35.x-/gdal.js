...
| Float32Array
| Float64Array;
	declare export type Resampling = "NEAREST"
| "GAUSS"
| "CUBIC"
| "AVERAGE"
| "MODE"
...
constructor(source: SpatialReference, target: SpatialReference | Dataset): this;
...
src_lyr_name: string,
dst_lyr_name: string,
options?: {[key: string]: any} | string[]): Layer,
count(): number,
create(
name: string,
srs: SpatialReference,
geomType: number | Geometry,
creation_options: string[] | {[key: string]: any}): Layer,
...
band_count?: number,
data_type?: number,
creation_options?: string[] | {[key: string]: any}): Dataset,
createCopy(
filename: string,
src: Dataset,
strict?: boolean,
options?: string[] | {[key: string]: any}): Dataset,
...
height: number,
data?: TypedArray,
options?: RasterBandPixelsReadOptions): TypedArray,
...
height: number,
data: TypedArray,
options?: RasterBandPixelsWriteOptions): void,
...
type: any
	...
	declare export function checksumImage(src: RasterBand, x?: number, y?: number, w?: number, h?: number): number

	declare export function contourGenerate(options: ContourGenerateOptions): void

	declare export function decToDMS(angle: number, axis: "lat" | "long", precision?: number): string

	declare export function fillNodata(options: FillNoDataOptions): void

	declare export function open(path: string, mode?: "r" | "r+" | "w", drivers?: string | string[]): Dataset
...
creation_options?: string[] | {[key: string]: any}): Dataset
	...
	declare export function suggestedWarpOutput(options: SuggestedWarpOutputOptions): {
rasterSize: any,
geoTransform: any
}
