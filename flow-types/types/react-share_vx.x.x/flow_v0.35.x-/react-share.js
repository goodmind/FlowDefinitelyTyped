...
additionalProps?: React.HTMLAttributes<HTMLDivElement>
	...
	declare export var FacebookShareButton: React.StatelessComponent<CommonShareButtonProps & {
...
hashtag?: string
	...
	declare export var LinkedinShareButton: React.StatelessComponent<CommonShareButtonProps & {
...
description?: string
	...
	declare export var TwitterShareButton: React.StatelessComponent<CommonShareButtonProps & {
...
hashtags?: string[]
	...
	declare export var TelegramShareButton: React.StatelessComponent<CommonShareButtonProps & {
...
title?: string
	...
	declare export var WhatsappShareButton: React.StatelessComponent<CommonShareButtonProps & {
...
separator?: string
	...
	declare export var PinterestShareButton: React.StatelessComponent<CommonShareButtonProps & {
media: string,
...
description?: string
	...
	declare export var VKShareButton: React.StatelessComponent<CommonShareButtonProps & {
...
image?: string
	...
	declare export var OKShareButton: React.StatelessComponent<CommonShareButtonProps & {
...
description?: string
	...
	declare export var RedditShareButton: React.StatelessComponent<CommonShareButtonProps & {
...
title?: string
	...
	declare export var TumblrShareButton: React.StatelessComponent<CommonShareButtonProps & {
...
caption?: string
	...
	declare export var LivejournalShareButton: React.StatelessComponent<CommonShareButtonProps & {
title?: string,
description?: string
}>;
	declare export var MalruShareButton: React.StatelessComponent<CommonShareButtonProps & {
...
image?: string
	...
	declare export var EmailShareButton: React.StatelessComponent<CommonShareButtonProps & {
