 ...
 * (`new Range(5, 5, "[)")`).
 * @example var Range = require("strange")
new Range(10, 20) // => {begin: 10, end: 20, bounds: "[]"}
new Range(new Date(2000, 5, 18), new Date(2000, 5, 22))
 */
declare var Range: RangeConstructor;
	declare interface RangeConstructor {
 ...
 */
new <T: Range$Range$Endpoint>(
begin?: T | null,
end?: T | null,
bounds?: Range$Range$Bounds): Range<T>,
 ...
 * @example Range.parse("[a,z)") // => new Range("a", "z", "[)")
 */
 ...
 */
union<U: Range$Range$Endpoint>(a: Range<U>, b: Range<U>): Range<U>,
+prototype: Range<any>
} 
	declare interface Range<T: Range$Range$Endpoint> {
 ...
 * endpoints.
 * @example new Range(0, 10).compareBegin(5) // => -1
 ...
 * endpoints.
 * @example new Range(0, 10).compareEnd(5) // => -1
 ...
 * @example new Range().isEmpty() // => true
 ...
 * @example new Range().isBounded() // => true
 ...
 * @example new Range().isUnbounded() // => false
 ...
 * @example new Range(0, 10).contains(5) // => true
 ...
 * intersect.
 * @example new Range(0, 10).intersects(new Range(5, 7)) // => true
 ...
 * @example new Range(1, 10, "[)").valueOf() // => [1, 10, "[)"]
 */
valueOf(): [T | null | void, T | null | void, Range$Range$Bounds],
 ...
 * @example new Range(1, 5).toString() // => "[1,5]"
 ...
 * @example JSON.stringify(new Range(1, 10)) // "\"[1,10]\""
 * @alias toString
 */
toJSON(): string,
...
inspect(): string
	...
	declare type Range$Endpoint = Date | number | string;

declare type Range$Bounds = "()" | "[]" | "[)" | "(]";
    }
