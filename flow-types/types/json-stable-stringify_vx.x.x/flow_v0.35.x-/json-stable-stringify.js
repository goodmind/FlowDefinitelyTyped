...
obj: any,
opts?: stringify$stringify$Comparator | stringify$stringify$Options): string
...
declare type stringify$Comparator = (a: stringify$Element, b: stringify$Element) => number;
