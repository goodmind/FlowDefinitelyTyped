declare module "jquery.qrcode" {
  ...
  declare export class JQueryQRCode$Mode {
    ...
    static +NORMAL: Class<JQueryQRCode$Mode__NORMAL> &
      JQueryQRCode$Mode__NORMAL &
      0; // 0
    static +LABEL_STRIP: Class<JQueryQRCode$Mode__LABEL_STRIP> &
      JQueryQRCode$Mode__LABEL_STRIP &
      1; // 1
    static +LABEL_BOX: Class<JQueryQRCode$Mode__LABEL_BOX> &
      JQueryQRCode$Mode__LABEL_BOX &
      2; // 2
    static +IMAGE_STRIP: Class<JQueryQRCode$Mode__IMAGE_STRIP> &
      JQueryQRCode$Mode__IMAGE_STRIP &
      3; // 3
    static +IMAGE_BOX: Class<JQueryQRCode$Mode__IMAGE_BOX> &
      JQueryQRCode$Mode__IMAGE_BOX &
      4; // 4
  }
