...
declare type client_sessions$RequestHandler = (req: any, res: any, next: client_sessions$NextFunction) => any;
...
decode(
options: client_sessions$SessionOptions,
encoded: string): client_sessions$DecodeResult
} 
