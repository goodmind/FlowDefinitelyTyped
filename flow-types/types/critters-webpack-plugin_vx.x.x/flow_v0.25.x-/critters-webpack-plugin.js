declare module "critters-webpack-plugin" {
  ...
  declare export default typeof Critters;

  declare class Critters mixins Plugin {
    constructor(options?: Critters$Critters$CrittersOptions): this;
  }
  declare interface Critters$CrittersOptions {
    /**
