declare module 'jsreport-core' {
        declare type JsReport$Helpers = string | {
...
declare type JsReport$Extension = (reporter: JsReport$Reporter, definition: {[key: string]: any}) => void;
...
use(
extension: JsReport$Extension | JsReport$ExtensionDefinition): JsReport$Reporter,
...
tempDirectory: string
	...
	declare function JsReport(config?: $Shape<JsReport$JsReport$Configuration>): JsReport$JsReport$Reporter
