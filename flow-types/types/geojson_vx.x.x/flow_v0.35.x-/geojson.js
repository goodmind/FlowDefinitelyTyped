 ...
 */
declare export type BBox = [number, number, number, number] | [number, number, number, number, number, number];
 ...
 * https://tools.ietf.org/html/rfc7946#section-3
 */
declare export type Geometry = Point
| MultiPoint
| LineString
| MultiLineString
| Polygon
 ...
 */
declare export type Feature<G: Geometry | null, P> = {
type: "Feature",
 ...
 */
declare export type FeatureCollection<G: Geometry | null, P> = {
