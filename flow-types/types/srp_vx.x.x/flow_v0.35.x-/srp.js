 ...
 * @returns {Buffer}
 */
declare export function SRP$computeVerifier(SRP$params: SRP$Params, salt: Buffer, I: Buffer, P: Buffer): Buffer
 ...
 * @param {function} callback function to call with err,key
 */
declare export function SRP$genKey(callback: (error: Error, key: Buffer) => void): void


declare export class SRP$Client  {
constructor(SRP$params: SRP$Params, salt: Buffer, identity: Buffer, password: Buffer, secret1: Buffer): this;
computeA(): Buffer;
setB(B: Buffer): void;
computeM1(): Buffer;
