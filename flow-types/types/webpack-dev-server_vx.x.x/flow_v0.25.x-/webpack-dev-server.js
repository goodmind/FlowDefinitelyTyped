...
declare type WebpackDevServer$RewriteTo = (
  context: WebpackDevServer$Context
) => string;
...
declare module "webpack-dev-server" {
  ...
  declare class WebpackDevServer {
    ...
    static addDevServerEntrypoints(
      webpackOptions:
        | webpack.WebpackDevServer$Configuration
        | webpack.WebpackDevServer$Configuration[],
      config: WebpackDevServer$WebpackDevServer$Configuration,
      listeningApp?: WebpackDevServer$WebpackDevServer$ListeningApp
    ): void;
    listen(
      port: number,
      hostname: string,
