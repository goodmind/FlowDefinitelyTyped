declare module 'webpack-dev-server' {
	...
	import typeof * as httpProxyMiddleware from 'http-proxy-middleware';

	import typeof * as express from 'express';

	import typeof * as serveStatic from 'serve-static';
	...
	declare interface WebpackDevServer$ListeningApp {
address(): {
port?: number
}
} 

declare interface WebpackDevServer$ProxyConfigMap {
[url: string]: string | httpProxyMiddleware.Config
} 

declare type WebpackDevServer$ProxyConfigArrayItem = {
path?: string | string[],
context?: string | string[]
} & httpProxyMiddleware.Config;

declare type WebpackDevServer$ProxyConfigArray = WebpackDevServer$ProxyConfigArrayItem[];

declare interface WebpackDevServer$Context {
match: RegExpMatchArray,
parsedUrl: Url
} 

declare type WebpackDevServer$RewriteTo = (context: WebpackDevServer$Context) => string;

declare interface WebpackDevServer$Rewrite {
from: RegExp,
to: string | RegExp | WebpackDevServer$RewriteTo
} 

declare interface WebpackDevServer$HistoryApiFallbackConfig {
disableDotRule?: boolean,
rewrites?: WebpackDevServer$Rewrite[]
} 

declare interface WebpackDevServer$Configuration {
 ...
 */
historyApiFallback?: boolean | WebpackDevServer$HistoryApiFallbackConfig,
 ...
 */
devServer?: WebpackDevServer$WebpackDevServer$Configuration
} 
    }

	declare class WebpackDevServer  {
constructor(webpack: webpack.Compiler | webpack.MultiCompiler, config: WebpackDevServer$WebpackDevServer$Configuration): this;
static addDevServerEntrypoints(
webpackOptions: webpack.WebpackDevServer$Configuration | webpack.WebpackDevServer$Configuration[],
config: WebpackDevServer$WebpackDevServer$Configuration,
listeningApp?: WebpackDevServer$WebpackDevServer$ListeningApp): void;
listen(
port: number,
hostname: string,
callback?: (error?: Error) => void): http.Server;
listen(port: number, callback?: (error?: Error) => void): http.Server;
close(callback?: () => void): void
}
	declare module.exports: typeof WebpackDevServer
