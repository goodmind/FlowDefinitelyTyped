...
applyPluginsAsyncSeries1(name: string, param: any, callback: Tapable$Tapable$CallbackFunction): void;
 ...
 */
applyPluginsAsyncSeriesBailResult1(name: string, param: any, callback: Tapable$Tapable$CallbackFunction): void;
...
and the real callback is call with that error.
 */
applyPluginsAsyncWaterfall(name: string, init: any, callback: Tapable$Tapable$CallbackFunction): void;
...
and a callback for plugins
 */
applyPluginsParallelBailResult1(name: string, param: any, callback: Tapable$Tapable$CallbackFunction): void;
...
context: boolean
	...
	declare export class Hook<TArg1, TArg2, TArg3, TTabResult, THookResult>  {
...
arg2?: TArg2,
arg3?: TArg3,
...args: any[]) => Promise<THookResult>;
callAsync: (arg1?: TArg1, arg2?: TArg2, arg3?: TArg3, ...args: any[]) => THookResult;
compile(options: HookCompileOptions): Function;
tap: (
name: string | Tap,
fn: (arg1: TArg1, arg2: TArg2, arg3: TArg3, ...args: any[]) => TTabResult) => void;
tapAsync: (
name: string | Tap,
fn: (arg1: TArg1, arg2: TArg2, arg3: TArg3, ...args: any[]) => void) => void;
tapPromise: (
name: string | Tap,
fn: (arg1: TArg1, arg2: TArg2, arg3: TArg3, ...args: any[]) => Promise<TTabResult>) => void;
intercept: (interceptor: HookInterceptor) => void
}
	declare export class SyncHook<T1, T2, T3> mixins Hook<T1, T2, T3, any, void> {}
	declare export class SyncBailHook<T1, T2, T3, THookResult> mixins Hook<T1, T2, T3, void | THookResult, void | THookResult> {}
	declare export class SyncLoopHook<T1, T2, T3> mixins Hook<T1, T2, T3, any, void> {}
	declare export class SyncWaterfallHook<T1, T2, T3> mixins Hook<T1, T2, T3, T1, T1> {}
	declare export class AsyncParallelHook<T1, T2, T3> mixins Hook<T1, T2, T3, any, void> {}
	declare export class AsyncParallelBailHook<T1, T2, T3, THookResult> mixins Hook<T1, T2, T3, void | THookResult, void | THookResult> {}
	declare export class AsyncSeriesHook<T1, T2, T3> mixins Hook<T1, T2, T3, any, void> {}
	declare export class AsyncSeriesBailHook<T1, T2, T3, THookResult> mixins Hook<T1, T2, T3, void | THookResult, void | THookResult> {}
	declare export class AsyncSeriesWaterfallHook<T1, T2, T3> mixins Hook<T1, T2, T3, T1, T1> {}
 ...
 */
declare export class HookMap<T1, T2, T3>  {
...
key: any,
name: string | Tap,
fn: (arg1: T1, arg2: T2, arg3: T3, ...args: any[]) => any) => void;
tapAsync: (
key: any,
name: string | Tap,
fn: (arg1: T1, arg2: T2, arg3: T3, ...args: any[]) => void) => void;
tapPromise: (
key: any,
name: string | Tap,
fn: (arg1: T1, arg2: T2, arg3: T3, ...args: any[]) => Promise<any>) => void;
intercept: (interceptor: HookMapInterceptor<T1, T2, T3>) => void
}
	declare export class HookMapInterceptor<T1, T2, T3>  {
