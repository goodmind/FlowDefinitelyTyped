declare module 'qlik-engineapi' {
        declare type EngineAPI$CommandType = "JsonRequest"
| "GetCustomCaption"
| "IsConnected"
| "DisableQlikViewSelectButton"
| "HaveStarField";

declare type EngineAPI$LogonType = "LOG_ON_SERVICE_USER" | "LOG_ON_CURRENT_USER";

declare type EngineAPI$NxGrpType = "N" | "H" | "C" | string;

declare type EngineAPI$FieldAttributesType = "U"
| "A"
| "I"
| "R"
| "F"
...
declare type EngineAPI$FileDataFormatType = "CSV"
| "FIX"
| "DIF"
| "EXCEL_BIFF"
| "EXCEL_OOXML"
...
declare type EngineAPI$TableRecordKeyType = "NOT_KEY" | "ANY_KEY" | "PRIMARY_KEY" | "PERFECT_KEY";
 ...
 */
declare type EngineAPI$ContextType = "Cleared" | "LockedFieldsOnly" | "CurrentSelections";

declare type EngineAPI$SearchObjectsGroupType = "DatasetType" | "GenericObjectsType";

declare type EngineAPI$SearchObjectsItemType = "0" | "1";

declare type EngineAPI$NxPatchOpType = "Add" | "Remove" | "Replace";

declare type EngineAPI$FileType = "CSV_C" | "CSV_T" | "OOXML";

declare type EngineAPI$ExportStateType = "P" | "A";

declare type EngineAPI$ReductionModeType = "N"
| "D1"
| "S"
| "C"
| "ST";

declare type EngineAPI$FieldDefExType = "0" | "1" | "2";

declare type EngineAPI$FolderItemType = "FOLDER" | "FILE" | "OTHER";

declare type EngineAPI$NxCellStateType = "L"
| "S"
| "O"
| "D"
| "A"
...
declare type EngineAPI$NxCellType = "V"
| "E"
| "N"
| "T"
| "P"
...
declare type EngineAPI$NxSelectionCellType = "D" | "T" | "L";

declare type EngineAPI$SortIndicatorType = "N" | "A" | "D";

declare type EngineAPI$OtherModeType = "OTHER_OFF"
| "OTHER_COUNTED"
| "OTHER_ABS_LIMITED"
...
declare type EngineAPI$OtherLimitModeType = "OTHER_GE_LIMIT" | "OTHER_LE_LIMIT" | "OTHER_GT_LIMIT" | "OTHER_LT_LIMIT";

declare type EngineAPI$OtherSortModeType = "OTHER_SORT_DEFAULT" | "OTHER_SORT_DESCENDING" | "OTHER_SORT_ASCENDING";

declare type EngineAPI$TotalModeType = "TOTAL_OFF" | "TOTAL_EXPR";

declare type EngineAPI$BnfType = "S" | "E";
 ...
 * - R for META_RET_TYPE
 */
declare type EngineAPI$MTType = "N" | "D" | "R";
 ...
 * - CONNECT_32
 */
declare type EngineAPI$MachineModeType = "CONNECT_DEFAULT" | "CONNECT_64" | "CONNECT_32";
 ...
 */
declare type EngineAPI$InteractionType = "IT_SCRIPTLINE" | "IT_MSGBOX" | "IT_BREAK" | "IT_END";

declare type EngineAPI$ErrorDataCodeType = "0" | "1" | "2";
 ...
 */
declare type EngineAPI$FunctionGroupType = "ALL"
| "U"
| "NONE"
| "AGGR"
| "NUM"
...
declare type EngineAPI$DimensionType = "D" | "N" | "T";
 ...
 */
declare type EngineAPI$NxHypercubeMode = "S" | "P" | "K" | "T";
 ...
 */
declare type EngineAPI$FrequencyModeType = "NX_FREQUENCY_NONE" | "NX_FREQUENCY_VALUE" | "NX_FREQUENCY_PERCENT" | "NX_FREQUENCY_RELATIVE";

declare type EngineAPI$TypeSortDirection = "1" | "-1" | "0";
 ...
 * - UNKNOWN_TYPE
 */
declare type EngineAPI$DriveType = "REMOVABLE"
| "FIXED"
| "NETWORK"
| "CD_ROM"
| "RAM"
 ...
 */
declare type EngineAPI$NxTreeNodeType = "V"
| "E"
| "G"
| "N"
| "T"
 ...
 * NxRange...
 */
declare interface EngineAPI$INxRange {
 ...
 * ExpressionResult...
 */
declare interface EngineAPI$IExpressionResult {
qBadFieldNames: EngineAPI$INxRange[]
} 
 ...
 */
declare type EngineAPI$ICheckExpressionResult = {
qDangerousFieldNames: EngineAPI$INxRange[],
qErrorMsg: string
} & EngineAPI$IExpressionResult
 ...
 */
declare type EngineAPI$ICheckNumberOrExpressionResult = {
qErrorMsg: string
} & EngineAPI$IExpressionResult
 ...
 * ScriptSyntaxError...
 */
declare interface EngineAPI$IScriptSyntaxError {
...
declare interface EngineAPI$INxMeta {
 ...
 */
declare interface EngineAPI$INxGetBookmarkOptions {
 ...
 * NxGetObjectOptions.
 */
declare interface EngineAPI$INxGetObjectOptions {
 ...
 */
declare type EngineAPI$INxMetaTitleDescription = {
 ...
 */
declare type EngineAPI$INxMetaTitleDescriptionTag = {

/**
 * Array of String
 */
tags: string[]
} & EngineAPI$INxMetaTitleDescription
 ...
 * Connection...
 */
declare interface EngineAPI$IConnection {
 ...
 */
declare interface EngineAPI$INxLibraryDimensionDef {

/**
 * Information about the grouping.
 */
qGrouping: EngineAPI$NxGrpType,
 ...
 * GenericProperties
 */
declare interface EngineAPI$IGenericProperties {

/**
 * Identifier and type of the object.
 * >> This parameter is mandatory.
 */
qInfo: EngineAPI$INxInfo,
[qMetaDef: string]: any
} 
 ...
 */
declare type EngineAPI$IGenericBookmarkProperties = {} & EngineAPI$IGenericProperties
 ...
 */
declare type EngineAPI$IGenericDimensionProperties = {
qDim: EngineAPI$INxLibraryDimensionDef
} & EngineAPI$IGenericProperties
 ...
 */
declare type EngineAPI$IGenericMeasureProperties = {
qMeasure: EngineAPI$INxLibraryMeasureDef
} & EngineAPI$IGenericProperties
 ...
 */
declare type EngineAPI$IGenericObjectProperties = {
qExtendsId?: string
} & EngineAPI$IGenericProperties
 ...
 */
declare type EngineAPI$IGenericVariableProperties = {
 ...
 * >> This parameter is optional.
 */
qNumberPresentation?: EngineAPI$IFieldAttributes,
 ...
 */
declare interface EngineAPI$IFieldAttributes {
 ...
 */
qType: EngineAPI$FieldAttributesType,
 ...
 * NxInfo...
 */
declare interface EngineAPI$INxInfo {
 ...
 * DoReloadExParams...
 */
declare interface EngineAPI$IDoReloadExParams {
 ...
 * DoReloadExResult...
 */
declare interface EngineAPI$IDoReloadExResult {
 ...
 * FieldValue...
 */
declare interface EngineAPI$IFieldValue {
 ...
 * NxMatchingFieldInfo...
 */
declare interface EngineAPI$INxMatchingFieldInfo {
 ...
 * NxAppLayout ...
 */
declare interface EngineAPI$INxAppLayout {
 ...
 */
qLocaleInfo: EngineAPI$ILocaleInfo,
 ...
 * App thumbnail.
 */
qThumbnail: EngineAPI$IStaticContentUrl
} 
 ...
 * NxAppProperties
 */
declare interface EngineAPI$INxAppProperties {
 ...
 * App thumbnail.
 */
qThumbnail: EngineAPI$IStaticContentUrlDef,
 ...
 * AssociationScore...
 */
declare interface EngineAPI$IAssociationScore {
 ...
 * FieldScores...
 */
declare interface EngineAPI$IFieldScores {
 ...
 */
declare interface EngineAPI$IContentLibraryListItem {
 ...
 * ContentLibraryList...
 */
declare interface EngineAPI$IContentLibraryList {

/**
 * Information about the content library.
 */
qItems: EngineAPI$IContentLibraryListItem
} 
 ...
 * DatabaseInfo...
 */
declare interface EngineAPI$IDatabaseInfo {
 ...
 * DatabaseOwner...
 */
declare interface EngineAPI$IDatabaseOwner {
 ...
 * Database...
 */
declare interface EngineAPI$IDatabase {
 ...
 * DataField...
 */
declare interface EngineAPI$IDataField {
 ...
 * DataRecord...
 */
declare interface EngineAPI$IDataRecord {
 ...
 * DataTable...
 */
declare interface EngineAPI$IDataTable {
 ...
 * FieldDescription...
 */
declare interface EngineAPI$IFieldDescription {
 ...
 * DelimiterInfo...
 */
declare interface EngineAPI$IDelimiterInfo {
 ...
 * FileDataFormat...
 */
declare interface EngineAPI$IFileDataFormat {

/**
 * Type of the file.
 */
qType: EngineAPI$FileDataFormatType,
 ...
 * This property is used for delimited files.
 */
qDelimiter: EngineAPI$IDelimiterInfo,
 ...
 * DataTableEx...
 */
declare interface EngineAPI$IDataTableEx {
 ...
 * FolderItem...
 */
declare interface EngineAPI$IFolderItem {
 ...
 */
qType: EngineAPI$FolderItemType
} 
 ...
 */
declare interface EngineAPI$IStaticContentList {
qItems: EngineAPI$IStaticContentListItem
} 
 ...
 */
declare interface EngineAPI$IStaticContentListItem {
 ...
 */
declare interface EngineAPI$IStaticContentUrl {
 ...
 */
declare interface EngineAPI$IStaticContentUrlDef {
 ...
 * CalenderStrings...
 */
declare interface EngineAPI$ICalenderStrings {
 ...
 * LocaleInfo...
 */
declare interface EngineAPI$ILocaleInfo {
 ...
 */
qCalendarStrings: EngineAPI$ICalenderStrings,
 ...
 * MediaListItem...
 */
declare interface EngineAPI$IMediaListItem {
 ...
 */
declare interface EngineAPI$IMediaList {
 ...
 */
qItems: EngineAPI$IMediaListItem[]
} 
 ...
 * EditorBreakpoint...
 */
declare interface EngineAPI$IEditorBreakpoint {
 ...
 * TableRow...
 */
declare interface EngineAPI$ITableRow {

/**
 * Array of field values [{qText, qIsNumeric, qNumber},..]
 */
vqValue: EngineAPI$IFieldValue[]
} 
 ...
 * Size...
 */
declare interface EngineAPI$ISize {
 ...
 */
declare interface EngineAPI$IDerivedFieldsInTableData {
 ...
 * FieldInTableData...
 */
declare interface EngineAPI$IFieldInTableData {
 ...
 */
qKeyType: EngineAPI$TableRecordKeyType,
 ...
 */
qDerivedFields: EngineAPI$IDerivedFieldsInTableData
} 
 ...
 * Point...
 */
declare interface EngineAPI$IPoint {
 ...
 * TableRecord...
 */
declare interface EngineAPI$ITableRecord {
 ...
 */
qFields: EngineAPI$IFieldInTableData[],

/**
 * Information about the position of the table.
 */
qPos: EngineAPI$IPoint,
 ...
 * SourceKeyRecord...
 */
declare interface EngineAPI$ISourceKeyRecord {
 ...
 * TextMacro...
 */
declare interface EngineAPI$ITextMacro {
 ...
 * Rect...
 */
declare interface EngineAPI$IRect {
 ...
 */
declare interface EngineAPI$ITableViewTableWinSaveInfo {

/**
 * Information about the position of the table.
 */
qPos: EngineAPI$IRect,
 ...
 */
declare interface EngineAPI$ITableViewBroomPointSaveInfo {
 ...
 */
declare interface EngineAPI$ITableViewConnectionPointSaveInfo {
 ...
 * TableViewSaveInfo...
 */
declare interface EngineAPI$ITableViewSaveInfo {

/**
 * List of the tables in the database model viewer.
 */
qTables: EngineAPI$ITableViewTableWinSaveInfo[],

/**
 * List of the broom points in the database model viewer.
 * Not used in Qlik Sense.
 */
qBroomPoints: EngineAPI$ITableViewBroomPointSaveInfo[],

/**
 * List of connection points in the database model viewer.
 * Not used in Qlik Sense.
 */
qConnectionPoints: EngineAPI$ITableViewConnectionPointSaveInfo[],
 ...
 */
declare interface EngineAPI$ITableViewCtlSaveInfo {

/**
 * Internal view mode.
 */
qInternalView: EngineAPI$ITableViewSaveInfo,

/**
 * Source view mode.
 */
qSourceView: EngineAPI$ITableViewSaveInfo
} 
 ...
 */
declare interface EngineAPI$ITableViewDlgSaveInfo {
 ...
 */
qCtlInfo: EngineAPI$ITableViewCtlSaveInfo,
 ...
 */
declare interface EngineAPI$ISearchCombinationOptions {
 ...
 */
qContext: EngineAPI$ContextType,
 ...
 * SearchGroupOptions...
 */
declare interface EngineAPI$ISearchGroupOptions {
 ...
 */
declare interface EngineAPI$ISearchGroupItemOptions {
 ...
 */
qGroupItemType: EngineAPI$IGenericObject,
 ...
 * SearchPage...
 */
declare interface EngineAPI$ISearchPage {
 ...
 */
qGroupOptions: EngineAPI$ISearchGroupOptions[],
 ...
 * This property is to be used with the SearchResults method or the SearchObjects method.
 */
qGroupItemOptions: EngineAPI$ISearchGroupItemOptions[]
} 
 ...
 */
declare interface EngineAPI$ISearchFieldDictionary {
 ...
 */
qResult: EngineAPI$ISearchTermResult[]
} 
 ...
 * SearchCharRange...
 */
declare interface EngineAPI$ISearchCharRange {
 ...
 * SearchTermResult...
 */
declare interface EngineAPI$ISearchTermResult {
 ...
 */
qRanges: EngineAPI$ISearchCharRange[]
} 
 ...
 */
declare interface EngineAPI$ISearchMatchCombinations {

/**
 * Array of search combinations.
 */
qSearchMatchCombinations: EngineAPI$ISerachMatchCombination[]
} 
 ...
 */
declare interface EngineAPI$ISerachMatchCombination {
 ...
 */
qFieldMatches: EngineAPI$ISerachFieldMatch[]
} 
 ...
 * SerachFieldMatch...
 */
declare interface EngineAPI$ISerachFieldMatch {
 ...
 */
declare interface EngineAPI$ISearchAssociationResult {
 ...
 */
qFieldDictionaries: EngineAPI$ISearchFieldDictionary[],

/**
 * List of search results.
 * The maximum number of search results in this list is set by qPage/qCount.
 */
qSearchTermsMatched: EngineAPI$ISearchMatchCombinations[],
 ...
 * SearchObjectOptions...
 */
declare interface EngineAPI$ISearchObjectOptions {
 ...
 * SearchAttribute...
 */
declare interface EngineAPI$ISearchAttribute {
 ...
 */
declare interface EngineAPI$ISearchGroupItemMatch {
 ...
 */
qAttributes: EngineAPI$ISearchAttribute[],
 ...
 * SearchGroupItem...
 */
declare interface EngineAPI$ISearchGroupItem {

/**
 * Type of the group item.
 */
qItemType: EngineAPI$SearchObjectsItemType,
 ...
 */
qItemMatches: EngineAPI$ISearchGroupItemMatch[],
 ...
 * SearchGroup...
 */
declare interface EngineAPI$ISearchGroup {
 ...
 */
qGroupType: EngineAPI$SearchObjectsGroupType,
 ...
 */
qItems: EngineAPI$ISearchGroupItem[]
} 
 ...
 * SearchResult...
 */
declare interface EngineAPI$ISearchResult {
 ...
 */
qSearchGroupArray: EngineAPI$ISearchGroup
} 
 ...
 * SearchSuggestItem...
 */
declare interface EngineAPI$ISearchSuggestItem {
 ...
 */
declare interface EngineAPI$ISearchSuggestionResult {

/**
 * List of suggestions.
 */
qSuggestions: EngineAPI$ISearchSuggestItem[],
 ...
 * @returns - A promise of a Qlik engine reply.
 */
checkExpression(qExpr: string, qLabels?: string[]): Promise<EngineAPI$ICheckExpressionResult>,
 ...
 * @returns - A promise of a Qlik engine reply.
 */
checkNumberOrExpression(qExpr: string): Promise<EngineAPI$ICheckNumberOrExpressionResult>,
 ...
 */
checkScriptSyntax(): Promise<EngineAPI$IScriptSyntaxError[]>,
 ...
 */
createBookmark(
qProp: EngineAPI$IGenericBookmarkProperties): Promise<EngineAPI$IGenericBookmark>,
 ...
 */
createConnection(qConnection: EngineAPI$IConnection): Promise<string>,
 ...
 */
createDimension(
qProp: EngineAPI$IGenericDimensionProperties): Promise<EngineAPI$IGenericDimension>,
 ...
 */
createMeasure(qProp: EngineAPI$IGenericMeasureProperties): Promise<EngineAPI$IGenericMeasure>,
 ...
 */
createObject(qProp: EngineAPI$IGenericObjectProperties): Promise<EngineAPI$IGenericObject>,
 ...
 * @returns - returns a GenericObject
 */
createSessionObject(qProp: EngineAPI$IGenericObjectProperties): Promise<EngineAPI$IGenericObject>,
...
qProp: EngineAPI$IGenericVariableProperties): Promise<EngineAPI$IGenericVariable>,
 ...
 */
createVariableEx(qProp: EngineAPI$IGenericVariableProperties): Promise<EngineAPI$INxInfo>,
 ...
 */
doReloadEx(qParams?: EngineAPI$IDoReloadExParams): Promise<EngineAPI$IDoReloadExResult>,
 ...
 */
evaluateEx(qExpression: string): Promise<EngineAPI$IFieldValue>,
 ...
 */
findMatchingFields(qFieldName: string, qTags: string[]): Promise<EngineAPI$INxMatchingFieldInfo[]>,
 ...
 */
getAllInfos(): Promise<EngineAPI$INxInfo[]>,
 ...
 */
getAppLayout(): Promise<EngineAPI$INxAppLayout>,
 ...
 */
getAppProperties(): Promise<EngineAPI$INxAppProperties>,
 ...
 */
getAssociationScores(qTable1: string, qTable2: string): Promise<EngineAPI$IAssociationScore>,
 ...
 */
getBookmark(qId: string): Promise<EngineAPI$IGenericBookmark>,
 ...
 */
getBookmarks(
qOptions: EngineAPI$INxGetBookmarkOptions): Promise<EngineAPI$INxContainerEntry<any>>,
 ...
 */
getConnection(qConnectionId: string): Promise<EngineAPI$IConnection>,
 ...
 */
getDatabaseInfo(qConnectionId: string): Promise<EngineAPI$IDatabaseInfo>,
 ...
 */
getDatabaseOwners(qConnectionId: string, qDatabase?: string): Promise<EngineAPI$IDatabaseOwner[]>,
 ...
 */
getDatabases(qConnectionId: string): Promise<EngineAPI$IDatabase[]>,
...
qTable: string,
qDatabase?: string,
qOwner?: string): Promise<EngineAPI$IDataField[]>,
...
qTable: string,
qDatabase?: string,
qOwner?: string): Promise<EngineAPI$IDataRecord[]>,
...
qConnectionId: string,
qDatabase?: string,
qOwner?: string): Promise<EngineAPI$IDataTable[]>,
 ...
 */
getDimension(qId: string): Promise<EngineAPI$IGenericDimension>,
 ...
 */
getFieldDescription(qFieldName: string): Promise<EngineAPI$IFieldDescription>,
 ...
 */
getFieldOnTheFlyByName(qReadableName: string): Promise<{
qName: string
}>,
 ...
 * @returns - return a Promise of FieldDescription.
 */
getField(qFieldName: string, qStateName?: string): Promise<EngineAPI$IField>,
...
qDataFormat: EngineAPI$IFileDataFormat,
qTable: string): Promise<{
qPreview: EngineAPI$IDataRecord[],
qFormatSpec: string
}>,
...
qConnectionId: string,
qRelativePath: string,
qDataFormat: EngineAPI$IFileDataFormat): Promise<EngineAPI$IDataTableEx[]>,
...
qConnectionId: string,
qRelativePath: string,
qDataFormat: EngineAPI$IFileDataFormat): Promise<EngineAPI$IDataTable[]>,
 ...
 */
getFolderItemsForConnection(qConnectionId: string, qRelativePath: string): Promise<EngineAPI$IFolderItem[]>,
 ...
 */
getLibraryContent(qName: string): Promise<EngineAPI$IStaticContentList>,
 ...
 */
getLocaleInfo(): Promise<EngineAPI$ILocaleInfo>,
...
getMatchingFields(
qTags: string[],
qMatchingFieldMode?: boolean): Promise<EngineAPI$INxMatchingFieldInfo[]>,
 ...
 */
getMeasure(qId: string): Promise<EngineAPI$IGenericMeasure>,
 ...
 */
getObject(qId: string): Promise<EngineAPI$IGenericObject>,
 ...
 */
getObjects(
qOptions: EngineAPI$INxGetObjectOptions): Promise<EngineAPI$INxContainerEntry<any>>,
 ...
 */
getProperties(): Promise<EngineAPI$INxAppProperties>,
 ...
 */
getScriptBreakpoints(): Promise<EngineAPI$IEditorBreakpoint[]>,
...
qTableName: string): Promise<EngineAPI$ITableRow[]>,
...
qCellHeight: number,
qSyntheticMode: boolean,
qIncludeSysVars: boolean): Promise<{
qtr: EngineAPI$ITableRecord[],
qk: EngineAPI$ISourceKeyRecord[]
}>,
 ...
 */
getTextMacros(): Promise<EngineAPI$ITextMacro[]>,
 ...
 */
getVariable(qName: string): Promise<EngineAPI$IVariable>,
 ...
 */
getVariableById(qId: string): Promise<EngineAPI$IGenericVariable>,
 ...
 * @returns - return a Promise GenericVariable
 */
getVariableByName(qName: string): Promise<EngineAPI$IGenericVariable>,
 ...
 */
getViewDlgSaveInfo(): Promise<EngineAPI$ITableViewDlgSaveInfo>,
...
guessFileType(
qConnectionId: string,
qRelativePath?: string): Promise<EngineAPI$IFileDataFormat>,
...
qOverrideCredentials: boolean): Promise<void>,
...
qTerms: string[],
qPage: EngineAPI$ISearchPage): Promise<void>,
...
qTerms: string[],
qPage: EngineAPI$ISearchPage): Promise<EngineAPI$ISearchResult>,
...
searchSuggest(
qOptions: EngineAPI$ISearchCombinationOptions,
qTerms: string[]): Promise<EngineAPI$ISearchSuggestionResult>,
...
qTerms: string[],
qMatchIx: number,
qSoftLock: boolean): Promise<void>,
...
qProvider: string,
qCommand: EngineAPI$CommandType,
qMethod: string,
qParameters: string[],
qAppendConnection: string[]): Promise<string>,
 ...
 * @returns - A promise of a Qlik engine reply.
 */
setAppProperties(qProp: EngineAPI$INxAppProperties): Promise<void>,
 ...
 * @returns - A promise of a Qlik engine reply.
 */
setScriptBreakpoints(qBreakpoints: EngineAPI$IEditorBreakpoint[]): Promise<void>,
 ...
 * @returns - A promise of a Qlik engine reply.
 */
setViewDlgSaveInfo(qInfo: EngineAPI$ITableViewDlgSaveInfo): Promise<void>,
...
createObject(qProp: EngineAPI$IGenericListProperties): Promise<EngineAPI$IGenericList>,
createSessionObject(qProp: EngineAPI$IGenericListProperties): Promise<EngineAPI$IGenericList>,
clearSelections(qPath: "/qListObjectDef", qColIndices?: number[]): Promise<void>,
createObject(
qProp: EngineAPI$IGenericHyperCubeProperties): Promise<EngineAPI$IHyperCubeObject>,
createSessionObject(
qProp: EngineAPI$IGenericHyperCubeProperties): Promise<EngineAPI$IHyperCubeObject>,
createObject(
qProp: EngineAPI$IGenericSelectionListProperties): Promise<EngineAPI$ISelectionListObject>,
createSessionObject(
qProp: EngineAPI$IGenericSelectionListProperties): Promise<EngineAPI$ISelectionListObject>,
createObject(
qProp: EngineAPI$IGenericBookmarkListProperties): Promise<EngineAPI$IBookmarkListObject>,
createSessionObject(
qProp: EngineAPI$IGenericBookmarkListProperties): Promise<EngineAPI$IBookmarkListObject>,
createObject(
qProp: EngineAPI$IGenericMeasureListProperties): Promise<EngineAPI$IMeassureListObject>,
createSessionObject(
qProp: EngineAPI$IGenericMeasureListProperties): Promise<EngineAPI$IMeassureListObject>,
createObject(
qProp: EngineAPI$IGenericDimensionsListProperties): Promise<EngineAPI$IDimensionListObject>,
createSessionObject(
qProp: EngineAPI$IGenericDimensionsListProperties): Promise<EngineAPI$IDimensionListObject>,
createObject(
qProp: EngineAPI$IGenericVariableListProperties): Promise<EngineAPI$IVariableListObject>,
createSessionObject(
qProp: EngineAPI$IGenericVariableListProperties): Promise<EngineAPI$IVariableListObject>,
createObject(
qProp: EngineAPI$IGenericFieldListProperties): Promise<EngineAPI$IFieldListObject>,
createSessionObject(
qProp: EngineAPI$IGenericFieldListProperties): Promise<EngineAPI$IFieldListObject>
} & enigmaJS$enigmaJS$IGeneratedAPI


declare interface EngineAPI$INxFieldProperties {
 ...
 */
declare interface EngineAPI$IField {
 ...
 */
getNxProperties(): Promise<EngineAPI$INxFieldProperties>,
...
qMatch: string,
qSoftLock?: boolean,
qExcludedValuesMode?: number): Promise<boolean>,
...
qToggleMode?: boolean,
qSoftLock?: boolean): Promise<boolean>,
 ...
 * @returns - A promise of a Qlik engine reply.
 */
setNxProperties(qProperties: EngineAPI$INxFieldProperties): Promise<void>,
 ...
 * NxPatch...
 */
declare interface EngineAPI$INxPatch {

/**
 * Operation to perform.
 */
qOp: EngineAPI$NxPatchOpType,
 ...
 * AlternateStateData...
 */
declare interface EngineAPI$IAlternateStateData {
 ...
 */
qFieldItems: EngineAPI$IBookmarkFieldItem[]
} 
 ...
 */
declare interface EngineAPI$IBookmarkVariableItem {
 ...
 * BookmarkFieldItem...
 */
declare interface EngineAPI$IBookmarkFieldItem {

/**
 * Name and type of the field
 */
qDef: EngineAPI$IFieldDefEx,
 ...
 * FieldDefEx...
 */
declare interface EngineAPI$IFieldDefEx {
 ...
 */
qType: EngineAPI$FieldDefExType
} 
 ...
 * SelectInfo...
 */
declare interface EngineAPI$ISelectInfo {
 ...
 * This parameter is used when performing range selections or text searches in dimensions.
 */
qNumberFormat: EngineAPI$IFieldAttributes,
 ...
 * bool SoftLock = false;
 */
qRangeInfo: EngineAPI$INxRangeSelectInfo[],

/**
 * List of information about ranges for selections.
 */
qContinuousRangeInfo: EngineAPI$IRange[]
} 
 ...
 * NxBookmark...
 */
declare interface EngineAPI$INxBookmark {

/**
 * List of selections for each state.
 */
qStateData: EngineAPI$IAlternateStateData[],
 ...
 */
qVariableItems: EngineAPI$IBookmarkVariableItem[]
} 
 ...
 * GenericBaseLayout...
 */
declare interface EngineAPI$IGenericBaseLayout {
qInfo: EngineAPI$INxInfo,
qMeta: EngineAPI$INxMeta
} 
 ...
 */
declare type EngineAPI$IGenericBookmarkLayout = {
qMeta: EngineAPI$INxMetaTitleDescription,
qBookmark: EngineAPI$INxBookmark
} & EngineAPI$IGenericBaseLayout
 ...
 */
declare interface EngineAPI$IGenericBookmark {
 ...
 * @returns - A promise of a Qlik engine reply.
 */
applyPatches(qPatches: EngineAPI$INxPatch[]): Promise<void>,
 ...
 */
getLayout(): Promise<EngineAPI$IGenericBookmarkLayout>,
 ...
 */
getProperties(): Promise<EngineAPI$IGenericBookmarkProperties>,
 ...
 * @returns - A promise of a Qlik engine reply.
 */
setProperties(qProp: EngineAPI$IGenericBookmarkProperties): Promise<void>,
 ...
 */
declare interface EngineAPI$IGenericBookmarkEntry {

/**
 * Information about the properties of the bookmark.
 */
qProperties: EngineAPI$IGenericBookmarkProperties,
 ...
 */
declare interface EngineAPI$IGenericDimensionInfo {
 ...
 */
declare type EngineAPI$IGenericDimensionLayout = {
 ...
 * Information about publishing and permissions.
 */
qMeta: EngineAPI$INxMetaTitleDescriptionTag,
 ...
 * Length of the longest value in the field.
 */
qDimInfos: EngineAPI$IGenericDimensionInfo[]
} & EngineAPI$IGenericBaseLayout
 ...
 * NxLinkedObjectInfo...
 */
declare interface EngineAPI$INxLinkedObjectInfo {
 ...
 */
declare interface EngineAPI$IGenericDimension {
 ...
 */
getDimension(): Promise<EngineAPI$IGenericDimensionProperties>,
 ...
 */
getLayout(): Promise<EngineAPI$IGenericDimensionLayout>,
 ...
 * Note: If the member delta is set to true in the request object, only the delta is retrieved.
 */
getProperties(): Promise<EngineAPI$IGenericDimensionProperties>,
 ...
 */
setProperties(): Promise<EngineAPI$IGenericDimensionProperties>,
 ...
 * GenericObjectEntry...
 */
declare interface EngineAPI$IGenericObjectEntry {
 ...
 */
qChildren: EngineAPI$IGenericObjectEntry[],

/**
 * Reference to a bookmark/snapshot that is embedded in the generic object.
 */
qEmbeddedSnapshotRef: EngineAPI$IGenericBookmarkEntry
} 
 ...
 * NxPage...
 */
declare interface EngineAPI$INxPage {
 ...
 * NxViewPort...
 */
declare interface EngineAPI$INxViewPort {
 ...
 * NxDataAreaPage...
 */
declare interface EngineAPI$INxDataAreaPage {
 ...
 * NxHighlightRanges...
 */
declare interface EngineAPI$INxHighlightRanges {

/**
 * Ranges of highlighted values
 */
qRanges: EngineAPI$ICharRange[]
} 
 ...
 * CharRange...
 */
declare interface EngineAPI$ICharRange {
 ...
 */
declare interface EngineAPI$INxAttributeExpressionValues {

/**
 * List of attribute expressions values.
 */
qValues: EngineAPI$INxSimpleValue[]
} 
 ...
 * NxSimpleValue
 */
declare interface EngineAPI$INxSimpleValue {
 ...
 * NxCell...
 */
declare interface EngineAPI$INxCell {
 ...
 * This parameter is optional.
 */
qHighlightRanges?: EngineAPI$INxHighlightRanges,
 ...
 */
qAttrDims: EngineAPI$INxAttributeExpressionValues
} 
 ...
 * NxCellRows...
 */
declare type EngineAPI$INxCellRows = EngineAPI$INxCell[];


/**
 * INxDataPage...
 */
declare interface EngineAPI$INxDataPage {

/**
 * Array of data.
 */
qMatrix: EngineAPI$INxCellRows[],
 ...
 * NxGroupTail
 */
declare interface EngineAPI$INxGroupTail {
 ...
 */
declare interface EngineAPI$IContinuousDataOptions {
 ...
 * Container for the dynamic properties of an attribute expression.
 */
declare interface EngineAPI$INxAxisTicks {
 ...
 * Container for the dynamic properties of an attribute expression.
 */
declare interface EngineAPI$INxTickCell {
 ...
 * NxAxisData...
 */
declare interface EngineAPI$INxAxisData {

/**
 * List of Axis data.
 */
qAxis: EngineAPI$INxAxisTicks[]
} 
 ...
 */
declare interface EngineAPI$INxAttributeDimValues {

/**
 * List of values.
 */
qValues: EngineAPI$INxSimpleDimValue[]
} 
 ...
 * NxSimpleDimValue..
 */
declare interface EngineAPI$INxSimpleDimValue {
 ...
 */
declare interface EngineAPI$INxPivotDimensionCell {
 ...
 */
qSubNodes: EngineAPI$INxPivotDimensionCell[],
 ...
 */
qAttrDims: EngineAPI$INxAttributeDimValues[]
} 
 ...
 * NxPivotPage...
 */
declare interface EngineAPI$INxPivotPage {
 ...
 * Array of data.
 */
qData: EngineAPI$INxPivotValuePoint[],
 ...
 * NxStackedPivotCell...
 */
declare interface EngineAPI$INxStackedPivotCell {
 ...
 */
qSubNodes: EngineAPI$INxStackedPivotCell[],
 ...
 * NxStackPage...
 */
declare interface EngineAPI$INxStackPage {

/**
 * Array of data.
 */
qData: EngineAPI$INxStackedPivotCell[],
 ...
 * GenericObjectLayout...
 */
declare type EngineAPI$IGenericObjectLayout = {
 ...
 */
qError?: EngineAPI$INxLayoutErrors,

/**
 * Information about the selections.
 */
qSelectionInfo: EngineAPI$INxSelectionInfo
} & EngineAPI$IGenericBaseLayout
 ...
 * NxLayoutErrors...
 */
declare interface EngineAPI$INxLayoutErrors {
 ...
 * NxSelectionInfo...
 */
declare interface EngineAPI$INxSelectionInfo {
 ...
 * RangeSelectInfo...
 */
declare interface EngineAPI$IRangeSelectInfo {

/**
 * Range of values.
 */
qRange: EngineAPI$IRange
} 
 ...
 */
declare type EngineAPI$INxMultiRangeSelectInfo = {
 ...
 */
declare type EngineAPI$INxRangeSelectInfo = {
 ...
 */
declare type EngineAPI$INxContinuousRangeSelectInfo = {
 ...
 * Range...
 */
declare interface EngineAPI$IRange {
 ...
 * NxSelectionCell...
 */
declare interface EngineAPI$INxSelectionCell {
...
declare interface EngineAPI$INxTreeDataOption {
 ...
 */
TreeNodes: EngineAPI$INxPageTreeNode[],

/**
 * Filters out complete dimensions from the fetched tree.
 */
TreeLevels: EngineAPI$INxPageTreeLevel
} 

declare interface EngineAPI$INxPageTreeNode {
...
declare interface EngineAPI$INxPageTreeLevel {
...
declare interface EngineAPI$INxTreeNode {
 ...
 * Type of the cell.
 */
qType: EngineAPI$NxTreeNodeType,

/**
 * The measures for this node.
 */
qValues: EngineAPI$INxTreeValue,

/**
 * The children of this node in the tree structure.
 */
qNodes: EngineAPI$INxTreeNode,
...
declare interface EngineAPI$INxTreeValue {
 ...
 */
declare type EngineAPI$IGenericObject = {
 ...
 * @returns -
 */
applyPatches(qPatches: EngineAPI$INxPatch[], qSoftPatch?: boolean): Promise<void>,
...
qPropForThis?: EngineAPI$IGenericObjectProperties): Promise<EngineAPI$IGenericObject>,
 ...
 * @returns -
 */
destroyAllChildren(qPropForThis?: EngineAPI$IGenericObjectProperties): Promise<void>,
...
destroyChild(
qid: string,
qPropForThis?: EngineAPI$IGenericObjectProperties): Promise<boolean>,
...
qPath: string,
qFileName?: string,
qExportState?: EngineAPI$ExportStateType): Promise<string>,
...
qMaxNbrCells: number,
qQueryLevel: number,
qBinningMethod: number): Promise<EngineAPI$INxDataPage[]>,
...
qPath: string,
qOptions: EngineAPI$IContinuousDataOptions[]): Promise<{
 ...
 */
getHyperCubeData(qPath: string, qPages: EngineAPI$INxPage[]): Promise<EngineAPI$INxDataPage[]>,
 ...
 */
getHyperCubePivotData(qPath: string, qPages: EngineAPI$INxPage[]): Promise<EngineAPI$INxPivotPage[]>,
...
qPages: EngineAPI$INxPage[],
qZoomFactor: number,
qReductionMode: EngineAPI$ReductionModeType): Promise<EngineAPI$INxDataPage[]>,
...
qPath: string,
qPages: EngineAPI$INxPage[],
qMaxNbrCells?: number): Promise<EngineAPI$INxStackPage[]>,
...
qPath: string,
qNodeOptions: EngineAPI$INxTreeDataOption[]): Promise<EngineAPI$INxTreeNode>,
 ...
 */
getLayout(): Promise<EngineAPI$IGenericBaseLayout>,
 ...
 */
getListObjectData(qPath: string, qPages: EngineAPI$INxPage[]): Promise<EngineAPI$INxDataPage[]>,
 ...
 * @returns - A Promise of GenericObjectProperties
 */
getProperties(): Promise<EngineAPI$IGenericObjectProperties>,
...
qColumnsToSelect?: number[],
qOrMode?: boolean): Promise<boolean>,
...
qColIndices: number[],
qSoftLock: boolean,
qDeselectOnlyOneSelected: boolean): Promise<boolean>,
...
qDimNo: number,
qValues: number[],
qToggleMode: boolean): Promise<boolean>,
 ...
 */
setFullPropertyTree(qPropEntry: EngineAPI$IGenericObjectEntry): Promise<void>,
 ...
 */
declare type EngineAPI$IGenericMeasureLayout = {
 ...
 */
declare type EngineAPI$IGenericVariableLayout = {
 ...
 * NxLibraryMeasureDef...
 */
declare interface EngineAPI$INxLibraryMeasureDef {
...
declare type EngineAPI$IGenericDerivedFieldProperties = {} & EngineAPI$IGenericProperties


declare type EngineAPI$IGenericDerivedFields = {
 ...
 */
getProperties(): Promise<EngineAPI$IGenericDerivedFieldProperties>,
 ...
 */
declare type EngineAPI$IGenericMeasure = {
 ...
 */
getLayout(): Promise<EngineAPI$IGenericMeasureLayout>,
...
>> This parameter is mandatory.
 */
getMeasure(): Promise<EngineAPI$IGenericMeasureProperties>,
...
>> This parameter is mandatory.
 */
getProperties(): Promise<EngineAPI$IGenericMeasureProperties>,
 ...
 */
setProperties(qProp: EngineAPI$IGenericMeasureProperties): Promise<void>,
 ...
 */
declare type EngineAPI$IGenericVariable = {
 ...
 */
getLayout(): Promise<EngineAPI$IGenericVariableLayout>,
 ...
 */
getProperties(): Promise<EngineAPI$IGenericVariableProperties>,
...
>> This parameter is mandatory.
 */
setProperties(qProp: EngineAPI$IGenericVariableProperties): Promise<void>,
 ...
 * AlfaNumString...
 */
declare interface EngineAPI$IAlfaNumString {
 ...
 */
declare interface EngineAPI$INxVariableProperties {
 ...
 */
declare type EngineAPI$IVariable = {
 ...
 */
getContent(): Promise<EngineAPI$IAlfaNumString>,
 ...
 * Note: This method is deprecated (not recommended to use). Use GetProperties method instead.
 */
getNxProperties(): Promise<EngineAPI$INxVariableProperties>,
 ...
 */
setNxProperties(qProperties: EngineAPI$INxVariableProperties): Promise<void>
} & enigmaJS$enigmaJS$IGeneratedAPI
 ...
 * AppEntry...
 */
declare interface EngineAPI$IAppEntry {
 ...
 * IBNFDefResult
 */
declare interface EngineAPI$IBNFDefResult {

/**
 * Description of the scripting language grammar.
 */
qBnfDefs: EngineAPI$IBNFDef[],
 ...
 * BNFDef...
 */
declare interface EngineAPI$IBNFDef {
 ...
 */
qFG: EngineAPI$FunctionGroupType,
 ...
 * CustomConnector...
 */
declare interface EngineAPI$ICustomConnector {
 ...
 */
qMachineMode: EngineAPI$MachineModeType
} 
 ...
 * DocListEntry...
 */
declare interface EngineAPI$IDocListEntry {
 ...
 * InteractDef
 */
declare interface EngineAPI$IInteractDef {

/**
 * Interaction type.
 */
qType?: EngineAPI$InteractionType,
 ...
 * DriveInfo...
 */
declare interface EngineAPI$IDriveInfo {
 ...
 */
qTypeIdentifier: EngineAPI$DriveType,
 ...
 * OdbcDsn...
 */
declare interface EngineAPI$IOdbcDsn {
 ...
 * OleDbProvider...
 */
declare interface EngineAPI$IOleDbProvider {
 ...
 * ErrorData...
 */
declare interface EngineAPI$IErrorData {
 ...
 */
qErrorDataCode: EngineAPI$ErrorDataCodeType
} 
 ...
 * ProgressMessage...
 */
declare interface EngineAPI$IProgressMessage {
 ...
 * ProgressData...
 */
declare interface EngineAPI$IProgressData {
 ...
 */
qErrorData: EngineAPI$IErrorData[],

/**
 * List of persistent progress messages.
 */
qPersistentProgressMessages: EngineAPI$IProgressMessage[],

/**
 * Transient progress message.
 */
qTransientProgressMessage: EngineAPI$IProgressMessage
} 
 ...
 */
declare interface EngineAPI$INxStreamListEntry {
 ...
 * CodePage...
 */
declare interface EngineAPI$ICodePage {
 ...
 * Function...
 */
declare interface EngineAPI$IFunction {
 ...
 */
qGroup: EngineAPI$FunctionGroupType,
...
declare interface EngineAPI$IQDownloadInfo {
...
declare interface EngineAPI$IQVersion {
qComponentVersion: string
} 

declare interface EngineAPI$IQConfig {
qFeatures: {
qIsDesktop: boolean,
qSSOEnabled: boolean
},
 ...
 */
declare type EngineAPI$IGlobal = {
...
qInteractOnError: boolean): Promise<void>,
...
qPassword?: string,
qSerial?: string,
qLocalizedScriptMainSection?: string): Promise<EngineAPI$IApp>,
 ...
 * @returns - A Promise of App
 */
createSessionApp(): Promise<EngineAPI$IApp>,
 ...
 * @returns - A Promise of App
 */
createSessionAppFromApp(qSrcAppId: string): Promise<EngineAPI$IApp>,
 ...
 * @returns - qVersion
 */
engineVersion(): Promise<EngineAPI$IQVersion>,
 ...
 */
getActiveDoc(): Promise<EngineAPI$IApp | string>,
 ...
 */
getAppEntry(qAppID: string): Promise<EngineAPI$IAppEntry>,
 ...
 */
getBNF(qBnfType: EngineAPI$BnfType): Promise<EngineAPI$IBNFDef>,
 ...
 */
getBaseBNF(qBnfType: EngineAPI$BnfType): Promise<EngineAPI$IBNFDefResult>,
 ...
 */
getBaseBNFHash(qBnfType: EngineAPI$BnfType): Promise<{
qBnfHash: string
}>,
 ...
 */
getBaseBNFString(
qBnfType: EngineAPI$BnfType): Promise<{
qBnfDefs: EngineAPI$IBNFDef,
qBnfHash: string
}>,
 ...
 */
getConfiguration(): Promise<EngineAPI$IQConfig>,
 ...
 */
getCustomConnectors(qReloadList?: boolean): Promise<EngineAPI$ICustomConnector[]>,
 ...
 */
getDatabasesFromConnectionString(qConnection: EngineAPI$IConnection): Promise<EngineAPI$IDatabase[]>,
 ...
 */
getDocList(): Promise<EngineAPI$IDocListEntry>,
 ...
 */
getFolderItemsForPath(qPath: string): Promise<EngineAPI$IFolderItem[]>,
 ...
 */
getFunctions(qGroup?: EngineAPI$FunctionGroupType): Promise<EngineAPI$IFunction | void>,
 ...
 */
getInteract(qRequestId: number): Promise<EngineAPI$IInteractDef>,
 ...
 */
getProgress(qRequestId: number): Promise<EngineAPI$IProgressData>,
 ...
 */
getStreamList(): Promise<EngineAPI$INxStreamListEntry[]>,

/**
 * Lists the supported code pages.
 */
getSupportedCodePages(): Promise<EngineAPI$ICodePage[]>,
...
qSrcPath: string,
qIds: string[],
qExcludeConnections: boolean): Promise<void>,
 ...
 */
interactDone(qRequestId: number, qDef: EngineAPI$IInteractDef): Promise<void>,
 ...
 */
isValidConnectionString(qConnection: EngineAPI$IConnection): Promise<boolean>,
...
qPassword?: string,
qSerial?: string,
qNoData?: boolean): Promise<EngineAPI$IApp>,
 ...
 * NxAttrExprInfo...
 */
declare interface EngineAPI$INxAttrExprInfo {
 ...
 * NxStateCounts...
 */
declare interface EngineAPI$INxStateCounts {
 ...
 * NxDimensionInfo...
 */
declare interface EngineAPI$INxDimensionInfo {
 ...
 */
qSortIndicator?: EngineAPI$SortIndicatorType,
 ...
 * NxStateCounts
 */
qStateCounts: EngineAPI$INxStateCounts,
 ...
 * FieldAttributes
 */
qNumFormat?: EngineAPI$FieldAttributesType,
 ...
 */
qAttrExprInfo: EngineAPI$INxAttrExprInfo,
 ...
 */
qAttrDimInfo: EngineAPI$INxAttrDimInfo
} 
 ...
 * NxAttrDimInfo...
 */
declare interface EngineAPI$INxAttrDimInfo {
 ...
 * NxValidationError...
 */
declare interface EngineAPI$INxValidationError {
 ...
 * NxMeasureInfo...
 */
declare interface EngineAPI$INxMeasureInfo {
 ...
 */
qNumFormat?: EngineAPI$IFieldAttributes,
 ...
 */
qAttrDimInfo: EngineAPI$INxMeasureInfo[]
} 
 ...
 */
declare interface EngineAPI$INxInlineDimensionDef {
 ...
 */
declare type EngineAPI$IHyperCubeDimensionqDef = {
autoSort?: boolean,
cId?: string,
othersLabel?: EngineAPI$IStringExpressionContainer
 ...
 * OtherTotalSpecProp...
 */
declare interface EngineAPI$IOtherTotalSpecProp {
 ...
 */
qOtherMode: EngineAPI$OtherModeType,
 ...
 * - OTHER_REL_ACC_TARGET
 */
qOtherLimitMode: EngineAPI$OtherLimitModeType,
 ...
 * NxAttrExprDef...
 */
declare interface EngineAPI$INxAttrExprDef {
 ...
 * NxAttrDimDef...
 */
declare interface EngineAPI$INxAttrDimDef {
 ...
 * Sorting
 */
qSortBy: EngineAPI$ISortCriteria
} 
 ...
 */
declare interface EngineAPI$INxDimension {
 ...
 */
qDef: EngineAPI$INxInlineDimensionDef,
 ...
 */
qOtherTotalSpec?: EngineAPI$IOtherTotalSpecProp,
 ...
 */
qOtherLabel?: EngineAPI$IStringExpressionContainer,
 ...
 */
qTotalLabel?: EngineAPI$IStringExpressionContainer,
 ...
 */
qCalcCond?: EngineAPI$IValueExpr,

/**
 * List of attribute expressions.
 */
qAttributeExpressions?: EngineAPI$INxAttrExprDef[],

/**
 * List of attribute dimensions.
 */
qAttributeDimensions?: EngineAPI$INxAttrDimDef[],
 ...
 */
declare interface EngineAPI$INxCellPosition {
 ...
 */
declare interface EngineAPI$IValueExpr {
qv: string
} 
 ...
 * SortCriteria...
 */
declare interface EngineAPI$ISortCriteria {

/**
 * Sorts the field values according to their logical state
 * (selected, optional, alternative or excluded).
 */
qSortByState?: EngineAPI$TypeSortDirection,

/**
 * Sorts the field values by frequency
 * (number of occurrences in the field).
 */
qSortByFrequency?: EngineAPI$TypeSortDirection,

/**
 * Sorts the field values by numeric value.
 */
qSortByNumeric?: EngineAPI$TypeSortDirection,

/**
 * Sorts the field by alphabetical order.
 */
qSortByAscii?: EngineAPI$TypeSortDirection,

/**
 * Sorts the field values by the initial load order.
 */
qSortByLoadOrder?: EngineAPI$TypeSortDirection,

/**
 * Sorts the field by expression.
 */
qSortByExpression?: EngineAPI$TypeSortDirection,

/**
 * Sort by expression.
 */
qExpression?: EngineAPI$IValueExpr,

/**
 * no / empty docu
 */
qSortByGreyness?: EngineAPI$TypeSortDirection
} 
 ...
 */
declare interface EngineAPI$IStringExpressionContainer {
 ...
 * CustomErrorMessage...
 */
declare interface EngineAPI$ICustomErrorMessage {
calcCond: string
} 
 ...
 */
declare interface EngineAPI$INxMeasure {
 ...
 */
qDef: EngineAPI$INxInlineMeasureDef,
 ...
 * NxInlineMeasureDef...
 */
declare interface EngineAPI$INxInlineMeasureDef {
 ...
 */
declare type EngineAPI$IHyperCubeMeasureqDef = {
autoSort?: boolean,
cId?: string,
 ...
 */
declare type EngineAPI$IHyperCubeMeasureDef = {
qDef: EngineAPI$IHyperCubeMeasureqDef
 ...
 * NxPivotValuePoint...
 */
declare interface EngineAPI$INxPivotValuePoint {
 ...
 * NxContainerEntry...
 */
declare interface EngineAPI$INxContainerEntry<T> {
...
declare type EngineAPI$IGenericObjectPrototype<P: EngineAPI$IGenericObjectProperties, L: EngineAPI$IGenericBaseLayout> = {
getLayout(): Promise<L>,
...
declare interface EngineAPI$IAppObjectPrototype<P: EngineAPI$IGenericObjectProperties, O: EngineAPI$IGenericObject> {
 ...
 */
declare interface EngineAPI$IListObject {
 ...
 */
qExpressions: EngineAPI$INxListObjectExpression[],
 ...
 */
declare interface EngineAPI$INxListObjectExpression {
 ...
 * GenericListLayout...
 */
declare type EngineAPI$IGenericListLayout = {
qListObject: EngineAPI$IListObject
} & EngineAPI$IGenericBaseLayout
 ...
 */
declare interface EngineAPI$INxAutoSortByStateDef {
 ...
 */
declare interface EngineAPI$INxListObjectExpressionDef {
 ...
 * Note: A dimension that is set in the library can be used by many objects.
 */
declare interface EngineAPI$IListObjectDef {
qStateName: string,
qLibraryId: string,
qDef: EngineAPI$INxInlineDimensionDef,
qAutoSortByState: EngineAPI$INxAutoSortByStateDef,
qFrequencyMode?: EngineAPI$FrequencyModeType,
qShowAlternatives?: boolean,
qInitialDataFetch: EngineAPI$INxPage[],
qExpressions?: EngineAPI$INxListObjectExpressionDef[]
} 
 ...
 */
declare type EngineAPI$IGenericListProperties = {
 ...
 * GenericList...
 */
declare type EngineAPI$IGenericList = {} & EngineAPI$IGenericObjectPrototype<EngineAPI$IGenericListProperties, EngineAPI$IGenericListLayout>


declare type EngineAPI$IHyperCubeDimensionDef = {
qDef: EngineAPI$IHyperCubeDimensionqDef
 ...
 */
declare interface EngineAPI$IHyperCube {
 ...
 */
qGrandTotalRow: EngineAPI$INxCell[],
 ...
 * Is empty if nothing has been defined in qInitialDataFetch in HyperCubeDef.
 */
qStackedDataPages: EngineAPI$INxStackPage[],

/**
 * Information about the mode of the visualization.
 */
qMode: EngineAPI$NxHypercubeMode,
 ...
 * >> This property is optional.
 */
qLastExpandedPos?: EngineAPI$INxCellPosition,
 ...
 */
declare type EngineAPI$IGenericHyperCubeLayout = {
 ...
 * HyperCubeDef...
 */
declare interface EngineAPI$IHyperCubeDef {
 ...
 * HyperCubeDef...
 */
declare type EngineAPI$IVisualizationHyperCubeDef = {
customErrorMessage: EngineAPI$ICustomErrorMessage,
qDimensions: EngineAPI$IHyperCubeDimensionDef[],
qMeasures: EngineAPI$IHyperCubeMeasureDef[],
qLayoutExclude: any
 ...
 */
declare type EngineAPI$IGenericHyperCubeProperties = {
qHyperCubeDef: EngineAPI$IVisualizationHyperCubeDef
 ...
 */
declare type EngineAPI$IHyperCubeObject = {} & EngineAPI$IGenericObjectPrototype<EngineAPI$IGenericHyperCubeProperties, EngineAPI$IGenericHyperCubeLayout>


declare type EngineAPI$FieldSelectionModeType = "NORMAL" | "AND" | "NOT";


/**
 * NxCurrentSelectionItem...
 */
declare interface EngineAPI$INxCurrentSelectionItem {
 ...
 */
qNotSelectedFieldSelectionInfo: EngineAPI$INxFieldSelectionInfo[],
 ...
 */
qRangeInfo: EngineAPI$IRangeSelectInfo[],
 ...
 */
qSelectedFieldSelectionInfo: EngineAPI$INxFieldSelectionInfo[],
 ...
 */
declare interface EngineAPI$INxFieldSelectionInfo {
 ...
 * Selection mode.
 */
qFieldSelectionMode: EngineAPI$FieldSelectionModeType
} 
 ...
 */
declare type EngineAPI$IGenericSelectionNxInfo = {
 ...
 */
declare type EngineAPI$IGenericSelectionListProperties = {
qInfo: EngineAPI$IGenericSelectionNxInfo,
 ...
 * SelectionListObject...
 */
declare interface EngineAPI$ISelectionListObject {
qBackCount: number,
qForwardCount: number,
qSelections: EngineAPI$INxCurrentSelectionItem[]
} 
 ...
 */
declare type EngineAPI$IGenericSelectionListLayout = {
qSelectionObject: EngineAPI$ISelectionListObject
} & EngineAPI$IGenericObjectLayout
 ...
 */
declare interface EngineAPI$IBookmarkList {

/**
 * Information about the list of bookmarks
 */
qItems: EngineAPI$IGenericBookmarkLayout[]
} 
 ...
 */
declare type EngineAPI$IGenericBookmarkListLayout = {
qBookmarkList: EngineAPI$IBookmarkList
} & EngineAPI$IGenericBaseLayout
 ...
 */
declare type EngineAPI$IGenericBookmarkListNxInfo = {
qType: "BookmarkList"
} & EngineAPI$INxInfo
 ...
 */
declare type EngineAPI$IGenericBookmarkListProperties = {
qInfo: EngineAPI$IGenericBookmarkListNxInfo,
qBookmarkListDef: EngineAPI$IBookmarkListDef
} & EngineAPI$IGenericProperties
 ...
 * BookmarkListDef
 */
declare interface EngineAPI$IBookmarkListDef {
 ...
 */
declare type EngineAPI$IBookmarkListObject = {} & EngineAPI$IGenericObjectPrototype<EngineAPI$IGenericBookmarkListProperties, EngineAPI$IGenericBookmarkListLayout>
 ...
 */
declare type EngineAPI$IMeassureListItemLayout = {
qMeta: EngineAPI$INxMetaTitleDescriptionTag,
qData: null
} & EngineAPI$IGenericBaseLayout
 ...
 * IMeassureList
 */
declare interface EngineAPI$IMeassureList {
qItems: EngineAPI$IMeassureListItemLayout[]
} 
 ...
 */
declare type EngineAPI$IGenericMeasureListLayout = {
qMeassureListObject: EngineAPI$IMeassureList
} & EngineAPI$IGenericBaseLayout
 ...
 */
declare type EngineAPI$IGenericMeassureListNxInfo = {
qType: "MeasureList"
} & EngineAPI$INxInfo
 ...
 */
declare type EngineAPI$IGenericMeasureListProperties = {
qInfo: EngineAPI$IGenericMeassureListNxInfo,
qMeasureListDef: EngineAPI$IMeasureListDef
} & EngineAPI$IGenericProperties
 ...
 * IMeasureListDef
 */
declare interface EngineAPI$IMeasureListDef {
qType: "measure"
} 
 ...
 * IMeassureListObject
 */
declare type EngineAPI$IMeassureListObject = {} & EngineAPI$IGenericObjectPrototype<EngineAPI$IGenericMeasureListProperties, EngineAPI$IGenericMeasureListLayout>
 ...
 * DimensionItemLayout...
 */
declare interface EngineAPI$IDimensionItemLayout {
qInfo: EngineAPI$INxInfo,
qMeta: EngineAPI$INxMetaTitleDescriptionTag,
qData: null
} 
 ...
 */
declare interface EngineAPI$IDimensionList {

/**
 * Information about the list of dimensions
 */
qItems: EngineAPI$IDimensionItemLayout[]
} 
 ...
 */
declare type EngineAPI$IGenericDimensionListLayout = {
qDimensionList: EngineAPI$IDimensionList
} & EngineAPI$IGenericBaseLayout
 ...
 */
declare type EngineAPI$IGenericDimensionListNxInfo = {
qType: "DimensionList"
} & EngineAPI$INxInfo
 ...
 */
declare type EngineAPI$IGenericDimensionsListProperties = {
qInfo: EngineAPI$IGenericDimensionListNxInfo,
qDimensionListDef: EngineAPI$IDimensionListDef
} & EngineAPI$IGenericProperties
 ...
 */
declare interface EngineAPI$IDimensionListDef {
...
declare type EngineAPI$IDimensionListObject = {} & EngineAPI$IGenericObjectPrototype<EngineAPI$IGenericDimensionsListProperties, EngineAPI$IGenericDimensionListLayout>
 ...
 * NxVariableListItem...
 */
declare interface EngineAPI$INxVariableListItem {
 ...
 * VariableListObject...
 */
declare interface EngineAPI$IVariableList {
qItems: EngineAPI$INxVariableListItem[]
} 
 ...
 */
declare type EngineAPI$IGenericVariableListLayout = {
qVariableListObject: EngineAPI$IVariableList
} & EngineAPI$IGenericBaseLayout
 ...
 */
declare type EngineAPI$IGenericVariableListProperties = {
qVariableListDef: EngineAPI$IVariableListDef
} & EngineAPI$IGenericProperties
 ...
 */
declare interface EngineAPI$IVariableListDef {
 ...
 */
declare type EngineAPI$IVariableListObject = {} & EngineAPI$IGenericObjectPrototype<EngineAPI$IGenericVariableListProperties, EngineAPI$IGenericVariableListLayout>
 ...
 * FieldListObject...
 */
declare interface EngineAPI$IFieldList {

/**
 * NxFieldDescription[]
 */
qItems: EngineAPI$INxFieldDescription[]
} 
 ...
 */
declare type EngineAPI$IGenericFieldListProperties = {

/**
 * FieldListDef...
 */
qFieldListDef: EngineAPI$IFieldListDef
} & EngineAPI$IGenericProperties
 ...
 * NxFieldDescription...
 */
declare interface EngineAPI$INxFieldDescription {
 ...
 */
qDerivedFieldData: EngineAPI$INxDerivedFieldDescriptionList,
 ...
 */
declare interface EngineAPI$INxDerivedFieldDescriptionList {

/**
 * Information about the derived fields.
 */
qDerivedFieldLists: EngineAPI$INxDerivedFieldsData[]
} 
 ...
 * NxDerivedField...
 */
declare interface EngineAPI$INxDerivedField {
 ...
 * NxDerivedGroup...
 */
declare interface EngineAPI$INxDerivedGroup {
 ...
 * NxDerivedFieldsData...
 */
declare interface EngineAPI$INxDerivedFieldsData {
 ...
 * List of the derived fields.
 */
qFieldDefs: EngineAPI$INxDerivedField[],

/**
 * List of the derived groups.
 */
qGroupDefs: EngineAPI$INxDerivedGroup[],
 ...
 */
declare interface EngineAPI$IFieldListDef {
 ...
 */
declare type EngineAPI$IGenericFieldLayout = {

/**
 * FieldListObject...
 */
qFieldListObject: EngineAPI$IFieldList
} & EngineAPI$IGenericBaseLayout
 ...
 */
declare type EngineAPI$IFieldListObject = {} & EngineAPI$IGenericObjectPrototype<EngineAPI$IGenericFieldListProperties, EngineAPI$IGenericFieldLayout>

	declare interface enigmaJS$IGeneratedAPI {} 
    }
