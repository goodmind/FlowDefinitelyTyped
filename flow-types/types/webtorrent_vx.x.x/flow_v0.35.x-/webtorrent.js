...
cb?: (torrent: WebTorrent$Torrent) => any): WebTorrent$Torrent,
add(
torrent: string | Buffer | ParseTorrent,
cb?: (torrent: WebTorrent$Torrent) => any): WebTorrent$Torrent,
seed(
...
get(torrentId: WebTorrent$Torrent | string | Buffer): WebTorrent$Torrent | void,
...
callback?: (err: Error | void, element: HTMLMediaElement) => void): void,
appendTo(
rootElement: HTMLElement | string,
callback?: (err: Error | void, element: HTMLMediaElement) => void): void,
renderTo(
