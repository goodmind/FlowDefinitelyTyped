declare module "plotly.js" {
  ...
  declare export function relayout(
    root: Root,
    layout: $Shape<Layout>
  ): Promise<PlotlyHTMLElement>;
  ...
  declare export function restyle(
    root: Root,
    aobj: Data,
  ...
  declare export function deleteTraces(
    root: Root,
  ...
  declare export function downloadImage(
    root: Root,
  ...
  declare export function addFrames(
    root: Root,
    frames: Array<$Shape<Frame>>
  ): Promise<PlotlyHTMLElement>;

  declare export function deleteFrames(
    root: Root,
    frames: number[]
  ): Promise<PlotlyHTMLElement>;
  ...
  declare export type AxisType = "-" | "linear" | "log" | "date" | "category";
  ...
  declare export type ModeBarDefaultButtons =
    | "lasso2d"
    | "select2d"
    | "sendDataToCloud"
    | "autoScale2d"
    ...
    | "resetViews"
    | "toggleSpikelines";
  declare export type ButtonClickEvent = (
  ...
  declare export type Color =
    | string
    | Array<string | void | null>
    | Array<Array<string | void | null>>;
