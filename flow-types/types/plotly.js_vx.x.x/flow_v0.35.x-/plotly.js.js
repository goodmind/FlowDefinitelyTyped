declare module 'plotly.js' {
        import typeof * as _d3 from 'd3';

	declare export interface StaticPlots {
resize(root: Root): void
} 
	declare export var Plots: StaticPlots;
	declare export interface Point {
x: number,
y: number,
z: number
} 
	declare export interface PlotScatterDataPoint {
curveNumber: number,
data: PlotData,
pointIndex: number,
pointNumber: number,
...
yaxis: LayoutAxis
	...
	declare export interface PlotDatum {
curveNumber: number,
data: PlotData,
pointIndex: number,
pointNumber: number,
...
yaxis: LayoutAxis
	...
	declare export interface PlotMouseEvent {
points: PlotDatum[],
event: MouseEvent
} 
	declare export interface PlotCoordinate {
x: number,
y: number,
pointNumber: number
} 
	declare export interface SelectionRange {
x: number[],
y: number[]
} 
	declare export type PlotSelectedData = $Shape<PlotDatum>;
	declare export interface PlotSelectionEvent {
points: PlotDatum[],
range?: SelectionRange,
lassoPoints?: SelectionRange
} 
	declare export type PlotRestyleEvent = [any, number[]];
	declare export interface PlotAxis {
range: [number, number],
autorange: boolean
} 
	declare export interface PlotScene {
center: Point,
eye: Point,
up: Point
} 
	declare export interface PlotRelayoutEvent {
xaxis: PlotAxis,
yaxis: PlotAxis,
scene: PlotScene
} 
	declare export interface ClickAnnotationEvent {
index: number,
annotation: Annotations,
fullAnnotation: Annotations,
event: MouseEvent
} 
	declare export interface FrameAnimationEvent {
name: string,
frame: Frame,
animation: {
frame: {
...
transition: Transition
	...
	declare export interface LegendClickEvent {
event: MouseEvent,
...
config: $Shape<Config>,
fullData: Data[],
fullLayout: $Shape<Layout>
} 
	declare export interface SliderChangeEvent {
slider: Slider,
step: SliderStep,
interaction: boolean,
previousActive: number
} 
	declare export interface SliderStartEvent {
slider: Slider
} 
	declare export interface SliderEndEvent {
slider: Slider,
step: SliderStep
} 
	declare export interface BeforePlotEvent {
data: Data[],
layout: $Shape<Layout>,
config: $Shape<Config>
} 
	declare export type PlotlyHTMLElement = {
on(
event: "plotly_click" | "plotly_hover" | "plotly_unhover",
callback: (event: PlotMouseEvent) => void): void,
on(
event: "plotly_selecting" | "plotly_selected",
callback: (event: PlotSelectionEvent) => void): void,
...
callback: (event: ClickAnnotationEvent) => void): void,
on(
event: "plotly_animatingframe",
callback: (event: FrameAnimationEvent) => void): void,
on(
event: "plotly_legendclick" | "plotly_legenddoubleclick",
callback: (event: LegendClickEvent) => boolean): void,
on(
event: "plotly_sliderchange",
callback: (event: SliderChangeEvent) => void): void,
...
callback: (event: BeforePlotEvent) => boolean): void,
on(
event: "plotly_afterexport"
| "plotly_afterplot"
| "plotly_animated"
...
removeAllListeners: (handler: string) => void
	...
	declare export interface ToImgopts {
format: "jpeg" | "png" | "webp" | "svg",
width: number,
height: number
} 
	declare export interface DownloadImgopts {
format: "jpeg" | "png" | "webp" | "svg",
width: number,
height: number,
filename: string
} 
	declare export type Root = string | HTMLElement;
	declare export function newPlot(
root: Root,
data: Data[],
layout?: $Shape<Layout>,
config?: $Shape<Config>): Promise<PlotlyHTMLElement>

	declare export function plot(
root: Root,
data: Data[],
layout?: $Shape<Layout>,
config?: $Shape<Config>): Promise<PlotlyHTMLElement>

	declare export function relayout(root: Root, layout: $Shape<Layout>): Promise<PlotlyHTMLElement>

	declare export function redraw(root: Root): Promise<PlotlyHTMLElement>

	declare export function purge(root: Root): void

	declare export var d3: typeof _d3;
	declare export function restyle(root: Root, aobj: Data, traces?: number[] | number): Promise<PlotlyHTMLElement>

	declare export function update(
root: Root,
traceUpdate: Data,
layoutUpdate: $Shape<Layout>,
traces?: number[] | number): Promise<PlotlyHTMLElement>

	declare export function addTraces(
root: Root,
traces: Data | Data[],
newIndices?: number[] | number): Promise<PlotlyHTMLElement>

	declare export function deleteTraces(root: Root, indices: number[] | number): Promise<PlotlyHTMLElement>

	declare export function moveTraces(
root: Root,
currentIndices: number[] | number,
newIndices?: number[] | number): Promise<PlotlyHTMLElement>

	declare export function extendTraces(
root: Root,
update: Data | Data[],
indices: number | number[]): Promise<PlotlyHTMLElement>

	declare export function prependTraces(
root: Root,
update: Data | Data[],
indices: number | number[]): Promise<PlotlyHTMLElement>

	declare export function toImage(root: Root, opts: ToImgopts): Promise<string>

	declare export function downloadImage(root: Root, opts: DownloadImgopts): Promise<string>

	declare export function react(
root: Root,
data: Data[],
layout?: $Shape<Layout>,
config?: $Shape<Config>): Promise<PlotlyHTMLElement>

	declare export function addFrames(root: Root, frames: Array<$Shape<Frame>>): Promise<PlotlyHTMLElement>

	declare export function deleteFrames(root: Root, frames: number[]): Promise<PlotlyHTMLElement>
...
separators: string,
hidesources: boolean,
xaxis: $Shape<LayoutAxis>,
xaxis2: $Shape<LayoutAxis>,
xaxis3: $Shape<LayoutAxis>,
xaxis4: $Shape<LayoutAxis>,
xaxis5: $Shape<LayoutAxis>,
xaxis6: $Shape<LayoutAxis>,
xaxis7: $Shape<LayoutAxis>,
xaxis8: $Shape<LayoutAxis>,
xaxis9: $Shape<LayoutAxis>,
yaxis: $Shape<LayoutAxis>,
yaxis2: $Shape<LayoutAxis>,
yaxis3: $Shape<LayoutAxis>,
yaxis4: $Shape<LayoutAxis>,
yaxis5: $Shape<LayoutAxis>,
yaxis6: $Shape<LayoutAxis>,
yaxis7: $Shape<LayoutAxis>,
yaxis8: $Shape<LayoutAxis>,
yaxis9: $Shape<LayoutAxis>,
margin: $Shape<Margin>,
height: number,
width: number,
hovermode: "closest" | "x" | "y" | false,
hoverlabel: $Shape<Label>,
calendar: Calendar,
...
| "turntable",
orientation: number,
annotations: Array<$Shape<Annotations>>,
shapes: Array<$Shape<Shape>>,
images: Array<$Shape<Image>>,
updatemenus: {},
sliders: Array<$Shape<Slider>>,
legend: $Shape<Legend>,
font: $Shape<Font>,
scene: $Shape<Scene>,
...
calendar: Calendar
	...
	declare export type Calendar = "gregorian"
| "chinese"
| "coptic"
| "discworld"
| "ethiopian"
...
| "thai"
| "ummalqura";
	declare export type AxisName = "x"
| "x2"
| "x3"
| "x4"
| "x5"
...
| "y8"
| "y9";
	declare export type LayoutAxis = {
fixedrange: boolean,
...
domain: number[],
position: number,
rangeslider: $Shape<RangeSlider>,
rangeselector: $Shape<RangeSelector>,
automargin: boolean
} & Axis

	declare export type SceneAxis = {
spikesides: boolean,
...
showaxeslabels: boolean
	...
	declare export interface ShapeLine {
color: string,
width: number,
dash: Dash
} 
...
r: number
	...
	declare export type ModeBarDefaultButtons = "lasso2d"
| "select2d"
| "sendDataToCloud"
| "autoScale2d"
| "zoom2d"
...
| "resetViews"
| "toggleSpikelines";
	declare export type ButtonClickEvent = (gd: PlotlyHTMLElement, ev: MouseEvent) => void;
...
descent: number
	...
	declare export interface ModeBarButton {
...
toggle?: boolean
	...
	declare export type Datum = string | number | Date | null;
	declare export type TypedArray = Int8Array
| Uint8Array
| Int16Array
| Uint16Array
| Int32Array
...
| Float32Array
| Float64Array;
	declare export interface ErrorOptions {
visible: boolean,
symmetric: boolean,
color: Color,
thickness: number,
...
opacity: number
	...
	declare export type ErrorBar = $Shape<ErrorOptions> & ({
...
arrayminus?: Datum[]
	...
	declare export type Dash = "solid"
| "dot"
| "dash"
| "longdash"
| "dashdot"
| "longdashdot";
	declare export type Data = $Shape<PlotData>;
	declare export type Color = string | Array<string | void | null> | Array<Array<string | void | null>>;
	declare export type DataTransform = $Shape<Transform>;
	declare export type ScatterData = PlotData;
	declare export interface PlotData {
type: "bar"
| "box"
| "candlestick"
| "choropleth"
...
"marker.line": $Shape<ScatterMarkerLine>,
"marker.colorbar": {},
mode: "lines"
| "markers"
| "text"
 ...
 */
declare export interface TransformStyle {
target: number | string | number[] | string[],
value: $Shape<PlotData>
} 
	declare export interface TransformAggregation {
target: string,
func?: "count"
| "sum"
| "avg"
...
order: "ascending" | "descending"
	...
	declare export interface ColorBar {
 ...
 * default: "all"
 */
declare export interface PlotMarker {
...
showscale: boolean,
line: $Shape<ScatterMarkerLine>,
width: number,
colorbar: $Shape<ColorBar>,
gradient: {
...
colorsrc: any
	...
	declare export type ScatterMarker = PlotMarker;
	declare export interface ScatterMarkerLine {
width: number | number[],
color: Color,
...
reversescale: boolean
	...
	declare export interface ScatterLine {
color: Color,
width: number,
dash: Dash,
shape: "linear"
...
color: Color
	...
	declare export interface Edits {
...
responsive: boolean
	...
	declare export interface RangeSlider {
visible: boolean,
thickness: number,
range: [Datum, Datum],
borderwidth: number,
...
bgcolor: string
	...
	declare export interface RangeSelectorButton {
step: "second"
| "minute"
| "hour"
| "day"
...
label: string
	...
	declare export type RangeSelector = {
buttons: Array<$Shape<RangeSelectorButton>>,
visible: boolean,
x: number,
xanchor: "auto" | "left" | "center" | "right",
y: number,
...
borderwidth: number
	...
	declare export interface Camera {
up: $Shape<Point>,
center: $Shape<Point>,
eye: $Shape<Point>
} 
...
font: $Shape<Font>
	...
	declare export type Annotations = {
...
yref: "paper" | "y"
	...
	declare export interface Scene {
bgcolor: string,
camera: $Shape<Camera>,
domain: $Shape<Domain>,
aspectmode: "auto" | "cube" | "data" | "manual",
aspectratio: $Shape<Point>,
xaxis: $Shape<SceneAxis>,
yaxis: $Shape<SceneAxis>,
zaxis: $Shape<SceneAxis>,
dragmode: "orbit"
| "turntable"
| "zoom"
| "pan"
...
annotations: $Shape<Annotations> | Array<$Shape<Annotations>>,
captureevents: boolean
} 
...
| "bounce-in-out"
	...
	declare export interface SliderStep {
