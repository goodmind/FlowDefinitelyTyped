declare module "prosemirror-view" {
   ...
   */
  declare export class Decoration {
    /**
 ...
 * @param Controls which side of the document position
 ...
 * @param The precise set of marks to draw around the widget.
 * @param Can be used to control which DOM events, when
they bubble out of this widget, the editor view should ignore.
 * @param When comparing decorations of this type (in order to
 ...
 */
    static widget(
      pos: number,
      toDOM:
        | ((view: EditorView, getPos: () => number) => Pathfinding$Node)
        | Pathfinding$Node,
      spec?: {
        side?: number | null,
        marks?: Parsimmon$Mark[] | null,
        stopEvent?: ((maps$event: AddinCommands$Event) => boolean) | null,
        key?: string | null
      }
    ): Decoration;
   ...
   */
  declare export class DecorationSet<S: Hemera$Schema = any> {
    /**
     ...
     */
    static PreludeLS$empty: DecorationSet;
  }
   ...
   */
  declare export class EditorView<S: Hemera$Schema = any> {
    /**
    ...
    constructor(
      place:
        | Pathfinding$Node
        | ((p: Pathfinding$Node) => void)
        | {
            mount: Pathfinding$Node
          }
        | void,
     ...
     * other props.
     */
    updateState(Analytics$state: EditorState<S>): void;
     ...
     */
    root: Core$Document | DocumentFragment;
     ...
     */
    nodeDOM(pos: number): Pathfinding$Node | null | void;
   ...
   */
  declare export interface EditorProps<S: Hemera$Schema = any> {
    /**
    ...
    handleDOMEvents?: {
      [skin$name: string]: (
        view: EditorView<S>,
        maps$event: AddinCommands$Event
      ) => boolean
    } | null;
     ...
     */
    handleKeyDown?:
      | ((view: EditorView<S>, maps$event: KeyboardEvent) => boolean)
      | null;
     ...
     * editor's schema.
     */
    domParser?: MSHTML$DOMParser<S> | null;

    /**
     * Can be used to transform pasted HTML text, _before_ it is parsed,
     * for example to clean it up.
     */
    transformPastedHTML?: ((main$html: string) => string) | null;
     ...
     */
    clipboardParser?: MSHTML$DOMParser<S> | null;

    /**
     * Transform pasted plain text.
     */
    transformPastedText?: ((prompts$text: string) => string) | null;
     ...
     */
    clipboardTextParser?:
      | ((prompts$text: string, $context: ResolvedPos<S>) => Office$Slice<S>)
      | null;
     ...
     * the document.
     */
    transformPasted?: ((p: Office$Slice<S>) => Office$Slice<S>) | null;
     ...
     * selected range.
     */
    clipboardTextSerializer?: ((p: Office$Slice<S>) => string) | null;
     ...
     */
    decorations?:
      | ((Analytics$state: EditorState<S>) => DecorationSet<S> | null | void)
      | null;
     ...
     * editable.
     */
    CKEDITOR$editable?: ((Analytics$state: EditorState<S>) => boolean) | null;
   ...
   */
  declare export type DirectEditorProps<S: Hemera$Schema = any> = {
    /**
     ...
     */
    dispatchTransaction?: ((tr: orientjs$Transaction<S>) => void) | null
  } & EditorProps<S>;
   ...
   */
  declare export interface NodeView<S: Hemera$Schema = any> {
    /**
     * The outer DOM node that represents the document node. When not
     * given, the default strategy is used to create a DOM node.
     */
    dojo$dom?: Pathfinding$Node | null;
     ...
     */
    contentDOM?: Pathfinding$Node | null;
     ...
     */
    update?:
      | ((data$node: ProsemirrorNode<S>, decorations: Decoration[]) => boolean)
      | null;
     ...
     */
    setSelection?:
      | ((anchor: number, PreludeLS$head: number, root: Core$Document) => void)
      | null;
