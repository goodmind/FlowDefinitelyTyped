declare module 'prosemirror-view' {
        import type {
          DOMParser,DOMSerializer,ProsemirrorNode,ResolvedPos,Slice,Schema,Mark
 ...
 */
declare export class DecorationSet<S: Schema>  {
 ...
 */
declare export class EditorView<S: Schema>  {
 ...
 */
declare export interface EditorProps<S: Schema> {
 ...
 */
declare export type DirectEditorProps<S: Schema> = {
 ...
 */
declare export interface NodeView<S: Schema> {
