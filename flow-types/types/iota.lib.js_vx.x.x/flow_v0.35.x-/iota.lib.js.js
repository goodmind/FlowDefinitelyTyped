...
version: string
	...
	declare module.exports: typeof IotaClass

	declare type Security = 1 | 2 | 3;
	declare type IOTAUnit = "i"
| "Ki"
| "Mi"
| "Gi"
| "Ti"
...
removeNeighbors(
uris: string[],
callback: (error: Error, removedNeighbors: number[]) => void): void,
...
storeTransactions(trytes: string[], callback: (error: Error, response: {}) => void): void
	...
	declare type IotaApi = {
getTransactionsObjects(
hashes: string[],
callback?: (error: Error, transactions: TransactionObject[]) => void): void,
...
getBundle(
transactionHash: string,
callback?: (error: Error, bundle: TransactionObject[]) => void): void,
getTransfers(
seed: string,
options?: {
start?: number,
...
callback?: (error: Error, transfers: TransactionObject[][]) => void): void,
getAccountData(
seed: string,
options?: {
start: number,
...
isBundle(bundle: TransactionObject[]): boolean
	...
	declare interface IotaMultisig {
...
callback?: (error: Error, bundle: TransactionObject[]) => void): void
	...
	declare interface MultisigAddress {
absorb(digest: string | string[]): MultisigAddress,
finalize(): string
} 
	declare interface IotaValid {
