declare module "bootstrap-datepicker" {
  declare type DatepickerEvents =
    ...
    | "changeDecade"
    | "changeCentury";
  declare type DatepickerViewModes =
    | 0
    | "days"
    | 1
    | "months"
  ...
  declare interface DatepickerOptions {
    ...
    beforeShowDay?: (
      date: Date
    ) => void | string | boolean | DatepickerBeforeShowDayResponse;
    beforeShowYear?: (
      date: Date
    ) => void | string | boolean | DatepickerBeforeShowResponse;
    beforeShowDecade?: (
      date: Date
    ) => void | string | boolean | DatepickerBeforeShowResponse;
    beforeShowCentury?: (
