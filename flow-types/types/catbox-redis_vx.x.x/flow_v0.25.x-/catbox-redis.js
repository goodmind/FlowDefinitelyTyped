declare module "catbox-redis" {
  ...
  import type { EnginePrototype, ClientOptions, Client } from "catbox";
  ...
  declare class CatboxRedis<T> mixins Client<T> {
    constructor(options: CatboxRedis$CatboxRedis$CatboxRedisOptions): this;
  }
  declare module.exports: typeof CatboxRedis;
}
