...
callback?: JwtAuthorizeCallback): (socket: SocketIO.Socket) => void
 ...
 */
declare export type JwtSecretFunc = (request: any, payload: any, callback: JwtSecretFuncCallback) => void;
	
/**
 * If JwtAuthOptions.secret is a function, then this is the signature of the callback function provided to that function
 */
declare export type JwtSecretFuncCallback = (err: Error | null, secret: string) => void;
