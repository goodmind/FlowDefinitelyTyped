...
static +start: Class<HubSpotPaceInterfaces$PaceEvent__start> & HubSpotPaceInterfaces$PaceEvent__start & 0;// 0
static +stop: Class<HubSpotPaceInterfaces$PaceEvent__stop> & HubSpotPaceInterfaces$PaceEvent__stop & 1;// 1
static +restart: Class<HubSpotPaceInterfaces$PaceEvent__restart> & HubSpotPaceInterfaces$PaceEvent__restart & 2;// 2
static +done: Class<HubSpotPaceInterfaces$PaceEvent__done> & HubSpotPaceInterfaces$PaceEvent__done & 3;// 3
static +hide: Class<HubSpotPaceInterfaces$PaceEvent__hide> & HubSpotPaceInterfaces$PaceEvent__hide & 4;// 4

}

declare class HubSpotPaceInterfaces$PaceEvent__start mixins HubSpotPaceInterfaces$PaceEvent {}
declare class HubSpotPaceInterfaces$PaceEvent__stop mixins HubSpotPaceInterfaces$PaceEvent {}
declare class HubSpotPaceInterfaces$PaceEvent__restart mixins HubSpotPaceInterfaces$PaceEvent {}
declare class HubSpotPaceInterfaces$PaceEvent__done mixins HubSpotPaceInterfaces$PaceEvent {}
declare class HubSpotPaceInterfaces$PaceEvent__hide mixins HubSpotPaceInterfaces$PaceEvent {}
