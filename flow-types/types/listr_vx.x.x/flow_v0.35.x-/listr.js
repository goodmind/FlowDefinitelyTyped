...
task: (
ctx: any,
task: Listr$ListrTaskWrapper) => void
| string
| Promise<any>
| stream.Readable
| Listr,
skip?: (
ctx: any,
task: Listr$ListrTaskWrapper) => boolean | Promise<boolean> | string | void,
enabled?: (ctx: any, task: Listr$ListrTaskWrapper) => boolean | Promise<boolean>
} 
...
run(ctx?: any): Promise<any>
	...
	declare class Listr  {
constructor(tasks?: $ReadOnlyArray<Listr$Listr$ListrTask>, options?: Listr$Listr$ListrOptions): this;
constructor(options?: Listr$Listr$ListrOptions): this;
add(tasks: Listr$Listr$ListrTask | $ReadOnlyArray<Listr$Listr$ListrTask>): void;
run(ctx?: any): Promise<any>
}
