...
callback?: (error: Error, stdout: string, stderr: string) => void) => PromiseLike<ShipitLocal>;
	declare export type EmptyCallback = () => void;
	declare export type TaskExecution = (name: string, depsOrFn: string[] | EmptyCallback, fn: () => void) => any;
...
name: string
	...
	declare export function blTask(name: string, depsOrFn: string[] | EmptyCallback, fn?: () => void): any
