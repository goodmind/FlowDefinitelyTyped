declare module "global" {
  declare type polymer$PropConstructorType =
    | StringConstructor
    | ObjectConstructor
    | BooleanConstructor
    | NumberConstructor
  ...
  declare interface polymer$CommonBase {
    ...
    notifySplices?: (
      path: string,
      splices: $ReadOnlyArray<polymer$polymer$PolymerSplice>
    ) => void;
...
declare module "polymer" {
  import type { CustomElementConstructor } from "webcomponents.js";
}
