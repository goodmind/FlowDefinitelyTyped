declare module 'cytoscape' {
	...
	declare function cytoscape(options?: cytoscape$cytoscape$CytoscapeOptions): cytoscape$Css$Core

	declare function cytoscape(extensionName: string, foo: string, bar: any): cytoscape$Css$Core
 ...
 */
elements?: cytoscape$ElementsDefinition | cytoscape$ElementDefinition[] | Promise<cytoscape$ElementsDefinition> | Promise<cytoscape$ElementDefinition[]>,
...
} & cytoscape$CoreGraphManipulation & cytoscape$CoreGraphManipulationExt & cytoscape$CoreEvents & cytoscape$CoreViewportManipulation & cytoscape$CoreAnimation & cytoscape$CoreLayout & cytoscape$CoreStyle & cytoscape$CoreExport
 ...
 */
add(
eles: cytoscape$ElementDefinition | cytoscape$ElementDefinition[] | cytoscape$CollectionArgument): cytoscape$CollectionReturnValue,

/**
 * Remove elements in collecion or match the selector from the graph and return them.
 */
remove(
eles: cytoscape$CollectionArgument | cytoscape$Selector): cytoscape$CollectionReturnValue,
 ...
 */
collection(
eles?: cytoscape$Selector | cytoscape$CollectionArgument[]): cytoscape$CollectionReturnValue,
...
i: number,
eles: cytoscape$CollectionArgument) => boolean)): cytoscape$CollectionReturnValue,
...
selector: cytoscape$Selector,
handler: cytoscape$EventHandler): this,
on(
events: cytoscape$EventNames,
selector: cytoscape$Selector,
data: any,
...
selector?: cytoscape$Selector,
data?: any): this,
addListener(events: cytoscape$EventNames, handler: cytoscape$EventHandler): this,
addListener(
events: cytoscape$EventNames,
selector: cytoscape$Selector,
handler: cytoscape$EventHandler): this,
...
promiseOn(
events: cytoscape$EventNames,
selector?: cytoscape$Selector): Promise<cytoscape$EventHandler>,
pon(
events: cytoscape$EventNames,
selector?: cytoscape$Selector): Promise<cytoscape$EventHandler>,
...
selector?: cytoscape$Selector): this,
unbind(
events: cytoscape$EventNames,
selector?: cytoscape$Selector,
handler?: cytoscape$EventHandler): this,
...
declare type cytoscape$ZoomOptions = cytoscape$ZoomOptionsLevel & (cytoscape$ZoomOptionsModel | cytoscape$ZoomOptionsRendered);
...
options?: cytoscape$AnimateOptions): cytoscape$Core,

/**
 * Get an animation of the viewport.
 * http://js.cytoscape.org/#cy.animation
 */
animation(options: cytoscape$AnimationOptions): cytoscape$AnimationManipulation,
 ...
 */
style(
sheet: cytoscape$Stylesheet | cytoscape$Stylesheet[] | string): cytoscape$Stylesheet
} 
 ...
 */
declare type cytoscape$Stylesheet = cytoscape$StylesheetStyle | cytoscape$StylesheetCSS;
...
declare type cytoscape$ExportJpgStringOptions = {} & cytoscape$ExportJpgOptions & cytoscape$ExportStringOptions


declare type cytoscape$ExportJpgBlobOptions = {} & cytoscape$ExportJpgOptions & cytoscape$ExportBlobOptions
 ...
 */
declare type cytoscape$Collection<TOut, TIn> = {} & cytoscape$CollectionGraphManipulation & cytoscape$CollectionEvents & cytoscape$CollectionData & cytoscape$CollectionPosition & cytoscape$CollectionTraversing & cytoscape$CollectionLayout & cytoscape$CollectionSelection & cytoscape$CollectionStyle & cytoscape$CollectionAnimation & cytoscape$CollectionComparision & cytoscape$CollectionIteration<TIn, TOut> & cytoscape$CollectionBuildingFiltering<TIn, TOut> & cytoscape$CollectionAlgorithms
 ...
 */
declare type cytoscape$Singular<TOut, TIn> = {} & cytoscape$Collection<TOut, TIn> & cytoscape$SingularGraphManipulation & cytoscape$SingularData & cytoscape$SingularPosition & cytoscape$SingularSelection & cytoscape$SingularStyle & cytoscape$SingularAnimation
 ...
 */
declare type cytoscape$CollectionArgument = cytoscape$Collection | cytoscape$EdgeCollection | cytoscape$NodeCollection | cytoscape$SingularElementArgument;

declare type cytoscape$CollectionReturnValue = cytoscape$Collection & cytoscape$EdgeCollection & cytoscape$NodeCollection & cytoscape$SingularElementReturnValue;
 ...
 */
declare type cytoscape$EdgeCollection = {} & cytoscape$Collection<cytoscape$EdgeSingular, cytoscape$EdgeSingular> & cytoscape$EdgeCollectionTraversing
 ...
 */
declare type cytoscape$NodeCollection = {} & cytoscape$Collection<cytoscape$NodeSingular, cytoscape$NodeSingular> & cytoscape$NodeCollectionMetadata & cytoscape$NodeCollectionPosition & cytoscape$NodeCollectionTraversing & cytoscape$NodeCollectionCompound


declare type cytoscape$SingularElementArgument = cytoscape$EdgeSingular | cytoscape$NodeSingular;

declare type cytoscape$SingularElementReturnValue = cytoscape$EdgeSingular & cytoscape$NodeSingular;
 ...
 */
declare type cytoscape$EdgeSingular = {} & cytoscape$Singular<cytoscape$EdgeSingular, cytoscape$EdgeSingular> & cytoscape$EdgeCollection & cytoscape$EdgeSingularData & cytoscape$EdgeSingularPoints & cytoscape$EdgeSingularTraversing
 ...
 */
declare type cytoscape$NodeSingular = {} & cytoscape$Singular<cytoscape$NodeSingular, cytoscape$NodeSingular> & cytoscape$NodeCollection & cytoscape$NodeSingularMetadata & cytoscape$NodeSingularPosition & cytoscape$NodeSingularCompound
...
promiseOn(
events: cytoscape$EventNames,
selector?: string): Promise<cytoscape$EventHandler>,
pon(
events: cytoscape$EventNames,
selector?: string): Promise<cytoscape$EventHandler>,
 ...
 * @param pos An object specifying name-value pairs representing dimensions to set.
 */
renderedPosition(dimension?: cytoscape$PositionDimension): cytoscape$Position,
renderedPosition(dimension: cytoscape$PositionDimension, value: cytoscape$Position): this,
...
renderedPoint(dimension: cytoscape$PositionDimension, value: cytoscape$Position): this,
renderedPoint(pos: {
[name: string]: number
}): this,
 ...
 * @param pos An object specifying name-value pairs representing dimensions to set.
 */
relativePosition(dimension?: cytoscape$PositionDimension): cytoscape$Position,
relativePosition(dimension: cytoscape$PositionDimension, value: cytoscape$Position): this,
...
relativePoint(dimension: cytoscape$PositionDimension, value: cytoscape$Position): this,
relativePoint(pos: {
[name: string]: number
}): this,
 ...
 */
declare type cytoscape$ElementPositionFunction = (ele: cytoscape$NodeSingular, ix: number) => cytoscape$Position;

declare type cytoscape$ElementCollectionFunction = (
ele: cytoscape$NodeSingular,
ix: number,
eles: cytoscape$CollectionArgument) => cytoscape$Position;
 ...
 */
positions(handler: cytoscape$ElementPositionFunction | cytoscape$Position): this,
modelPositions(handler: cytoscape$ElementPositionFunction | cytoscape$Position): this,
points(handler: cytoscape$ElementPositionFunction | cytoscape$Position): this,
 ...
 */
boundingBox(
options: cytoscape$BoundingBoxOptions): cytoscape$BoundingBox12 | cytoscape$BoundingBoxWH,
boundingbox(
options: cytoscape$BoundingBoxOptions): cytoscape$BoundingBox12 | cytoscape$BoundingBoxWH,
...
handler: cytoscape$ElementPositionFunction): void
} 
 ...
 * @param options The layout options object.
 */
layoutDimensions(options: cytoscape$LayoutDimensionOptions): {
x: number,
y: number
}
} 
 ...
 */
animate(
options: cytoscape$ElementAnimateOptionPos | cytoscape$ElementAnimateOptionRen,
params?: cytoscape$ElementAnimateOptionsBase): this,
 ...
 */
animation(
options: cytoscape$SingularAnimationOptionsRen | cytoscape$SingularAnimationOptionsPos): cytoscape$AnimationManipulation,
...
i: number,
eles: cytoscape$CollectionArgument) => boolean,
thisArg?: any): boolean,
...
eles: cytoscape$CollectionArgument | cytoscape$CollectionArgument[] | cytoscape$Selector) => cytoscape$CollectionReturnValue;
 ...
 */
filter(
selector: cytoscape$Selector | ((ele: TIn, i: number, eles: cytoscape$CollectionArgument) => boolean)): cytoscape$CollectionReturnValue,
 ...
 */
sort(sort: (ele1: TIn, ele2: TIn) => number): cytoscape$CollectionReturnValue,
 ...
 */
reduce<T>(
fn: (prevVal: T, ele: TIn, i: number, eles: cytoscape$CollectionArgument) => T,
initialValue: T): T,
 ...
 */
neighborhood(selector?: cytoscape$Selector): cytoscape$CollectionReturnValue,
 ...
 * @param selector [optional] An optional selector that is used to filter the resultant collection.
 */
openNeighborhood(selector?: cytoscape$Selector): cytoscape$CollectionReturnValue,
 ...
 * @param selector [optional] An optional selector that is used to filter the resultant collection.
 */
closedNeighborhood(selector?: cytoscape$Selector): cytoscape$CollectionReturnValue,
 ...
 */
edgesWith(
eles: cytoscape$CollectionArgument | cytoscape$Selector): cytoscape$EdgeCollection,
 ...
 * @param selector [optional] An optional selector that is used to filter the resultant collection.
 */
predecessors(selector?: cytoscape$Selector): cytoscape$CollectionReturnValue
} 
...
toNode: cytoscape$NodeSingular | cytoscape$Selector): number,
...
path(
fromNode: cytoscape$NodeSingular | cytoscape$CollectionSelection,
toNode: cytoscape$NodeSingular | cytoscape$Selector): cytoscape$CollectionReturnValue
} 
 ...
 */
pathTo(
node: cytoscape$NodeSingular | cytoscape$Selector): cytoscape$CollectionReturnValue,
 ...
 */
breadthFirstSearch(options: cytoscape$SearchFirstOptions): cytoscape$SearchFirstResult,

/**
 * Perform a depth-first search within the elements in the collection.
 * http://js.cytoscape.org/#eles.depthFirstSearch
 */
depthFirstSearch(options: cytoscape$SearchFirstOptions): cytoscape$SearchFirstResult,
 ...
 * http://js.cytoscape.org/#eles.dijkstra
 */
dijkstra(options: cytoscape$SearchDijkstraOptions): cytoscape$SearchDijkstraResult,
 ...
 */
aStar(
options: cytoscape$SearchFloydWarshallOptions): cytoscape$SearchFloydWarshallResult,
 ...
 * http://js.cytoscape.org/#eles.bellmanFord
 */
bellmanFort(options: cytoscape$SearchBellmanFordOptions): cytoscape$SearchBellmanFordResult,
 ...
 */
kruskal(
handler: (edge: cytoscape$EdgeCollection) => number): cytoscape$CollectionReturnValue,
 ...
 * http://js.cytoscape.org/#eles.pageRank
 */
pageRank(options: cytoscape$SearchPageRankOptions): cytoscape$SearchPageRankResult,
 ...
 */
degreeCentrality(
options: cytoscape$SearchDegreeCentralityOptions): cytoscape$SearchDegreeCentralityResultDirected | cytoscape$SearchDegreeCentralityResultUndirected,
...
options: cytoscape$SearchDegreeCentralityNormalizedOptions): cytoscape$SearchDegreeCentralityNormalizedResultDirected | cytoscape$SearchDegreeCentralityNormalizedResultUndirected,
 ...
 * http://js.cytoscape.org/#eles.closenessCentrality
 */
closenessCentrality(options: cytoscape$SearchClosenessCentralityOptions): number,
...
options: cytoscape$SearchClosenessCentralityNormalizedOptions): cytoscape$SearchDegreeCentralityNormalizedResultDirected | cytoscape$SearchDegreeCentralityNormalizedResultUndirected,
 ...
 * http://js.cytoscape.org/#eles.betweennessCentrality
 */
betweennessCentrality(options: cytoscape$SearchBetweennessOptions): cytoscape$SearchBetweennessResult
} 
 ...
 */
declare type Css$NodeShape = "rectangle"
| "roundrectangle"
| "ellipse"
| "triangle"
| "pentagon"
...
"text-opacity"?: number
} & $Shape<Css$Overlay> & Css$PaddingNode
...
declare type Css$Edge = {} & Css$EdgeLine & Css$EdgeArror & $Shape<Css$Overlay>
...
declare type Css$ArrowShape = "tee"
| "triangle"
| "triangle-tee"
| "triangle-backcurve"
| "square"
 ...
 */
declare type Css$FontWeight = number
| "normal"
| "bold"
| "lighter"
| "bolder";
 ...
 */
declare type Css$TransitionTimingFunction = "linear"
| "spring"
| "cubic-bezier"
| "ease"
| "ease-in"
 ...
 */
declare type cytoscape$EventObject = {} & cytoscape$InputEventObject & cytoscape$LayoutEventObject
 ...
 */
type: cytoscape$UserInputDeviceEventName | cytoscape$UserInputDeviceEventNameExt,
 ...
 */
declare type cytoscape$UserInputDeviceEventName = "mousedown"
| "mouseup"
| "click"
| "mouseover"
| "mouseout"
 ...
 * http://js.cytoscape.org/#events/user-input-device-events
 */
declare type cytoscape$UserInputDeviceEventNameExt = "tapstart"
| "vmousedown"
| "tapdrag"
| "vmousemove"
| "tapdragover"
 ...
 */
declare type cytoscape$CollectionEventName = "add"
| "remove"
| "select"
| "unselect"
| "lock"
 ...
 */
declare type cytoscape$GraphEventName = "layoutstart"
| "layoutready"
| "layoutstop"
| "ready"
| "destroy"
 ...
 */
declare type cytoscape$Layouts = {} & cytoscape$LayoutManipulation & cytoscape$LayoutEvents


declare type cytoscape$LayoutOptions = cytoscape$NullLayoutOptions
...
declare type cytoscape$LayoutHandler = (e: cytoscape$LayoutEventObject) => void;
...
} & cytoscape$BaseLayoutOptions & cytoscape$AnimatedLayoutOptions
...
declare type cytoscape$NodePositionFunction = (nodeid: string) => cytoscape$Position;
...
declare type cytoscape$SortingFunction = (a: cytoscape$SortableNode, b: cytoscape$SortableNode) => number;
 ...
 */
on(events: cytoscape$EventNames, handler: cytoscape$EventHandler): this,
on(events: cytoscape$EventNames, data: any, handler: cytoscape$EventHandler): this,
bind(events: cytoscape$EventNames, handler: cytoscape$EventHandler): this,
bind(events: cytoscape$EventNames, data: any, handler: cytoscape$EventHandler): this,
listen(events: cytoscape$EventNames, handler: cytoscape$EventHandler): this,
listen(events: cytoscape$EventNames, data: any, handler: cytoscape$EventHandler): this,
addListener(events: cytoscape$EventNames, handler: cytoscape$EventHandler): this,
addListener(events: cytoscape$EventNames, data: any, handler: cytoscape$EventHandler): this,
 ...
 */
one(events: cytoscape$EventNames, handler: cytoscape$EventHandler): this,
one(events: cytoscape$EventNames, data: any, handler: cytoscape$EventHandler): this,
...
unbind(events: cytoscape$EventNames, handler?: cytoscape$EventHandler): this,
unlisten(events: cytoscape$EventNames, handler?: cytoscape$EventHandler): this,
removeListener(events: cytoscape$EventNames, handler?: cytoscape$EventHandler): this,
 ...
 */
promise(
animationEvent?: "completed" | "complete" | "frame"): Promise<cytoscape$EventObject>
} 
 ...
 */
declare type cytoscape$Ext = (cytoscape: (options?: cytoscape$CytoscapeOptions) => Css$Core) => void;
