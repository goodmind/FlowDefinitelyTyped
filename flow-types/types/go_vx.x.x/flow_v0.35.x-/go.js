 ...
 */
static inherit(derivedclass: go$Constructor, baseclass: go$Constructor): void;
 ...
 */
static make(type: go$Constructor | string, ...initializers: Array<any>): any;
...
): go$Map<string, (shape: go$Shape, width: number, height: number) => go$Geometry>;
 ...
 */
static parseEnum(ctor: go$Constructor, defval: go$EnumValue): (a: string) => go$EnumValue;
 ...
 */
addAll(
coll: go$Iterable<go$KeyValuePair<K, V>> | Array<go$KeyValuePair<K, V>>): go$Map<K, V>;
