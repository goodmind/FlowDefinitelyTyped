...
declare class __Config$TypedChainedMap<Parent, Value> mixins __Config$Chained<Parent> {
clear(): this;
...
falseBrancher?: (obj: this) => void): this
}

declare class __Config$ChainedMap<Parent> mixins __Config$TypedChainedMap<Parent, any> {}

declare class __Config$TypedChainedSet<Parent, Value> mixins __Config$Chained<Parent> {
...
declare class __Config$ChainedSet<Parent> mixins __Config$TypedChainedSet<Parent, any> {}
	declare class Config mixins __Config$__Config$ChainedMap<void> {
devServer: Config$Config$DevServer;
entryPoints: Config$__Config$TypedChainedMap<Config, Config$Config$EntryPoint>;
...
declare class Config$TypedChainedMap<Parent, Value> mixins __Config$Config$TypedChainedMap<Parent, Value> {}

declare class Config$ChainedMap<Parent> mixins __Config$Config$TypedChainedMap<Parent, any> {}

declare class Config$TypedChainedSet<Parent, Value> mixins __Config$Config$TypedChainedSet<Parent, Value> {}

declare class Config$ChainedSet<Parent> mixins __Config$Config$TypedChainedSet<Parent, any> {}

declare class Config$Plugins<Parent> mixins Config$TypedChainedMap<Parent, Config$Plugin<Parent>> {}

declare class Config$Plugin<Parent> mixins Config$ChainedMap<Parent>, Config$Orderable {
init(
value: (plugin: Config$PluginClass, args: any[]) => webpack.Config$Plugin): this;
...
declare class Config$EntryPoint mixins Config$TypedChainedSet<Config, string> {}
...
runtimeChunk(value: boolean | "single" | "multiple" | Config$RuntimeChunk): this;
...
declare type Config$RuntimeChunkFunction = (entryPoint: Config$EntryPoint) => string;
...
declare class Config$Use mixins Config$ChainedMap<Config$Rule>, Config$Orderable {
...
declare type Config$DevTool = "eval"
| "inline-source-map"
