 ...
 */
declare export function compareTwoStrings(string1: string, string2: string): number
 ...
 */
declare export function findBestMatch(mainString: string, targetStrings: string[]): BestMatch

	declare export interface Rating {
target: string,
rating: number
} 
	declare export interface BestMatch {
ratings: Rating[],
bestMatch: Rating,
