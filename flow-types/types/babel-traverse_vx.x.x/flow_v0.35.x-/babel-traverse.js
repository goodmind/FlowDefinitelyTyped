...
Scope?: VisitNode<S, t.Scopable>
	...
	declare export type VisitNode<T, P> = VisitNodeFunction<T, P> | VisitNodeObject<T>;
	declare export type VisitNodeFunction<T, P> = (path: NodePath<P>, state: any) => void;
...
isExistentialTypeParam(opts?: {[key: string]: any}): boolean;
...
isNumericLiteralTypeAnnotation(opts?: {[key: string]: any}): boolean;
