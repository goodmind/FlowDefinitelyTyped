declare module 'redux-logger' {
	...
	declare export type LoggerPredicate = (getState: () => any, action: any, logEntry?: LogEntryObject) => boolean;
...
errorTransformer(error: any): any
	...
	declare export function createLogger(options?: ReduxLoggerOptions): Redux.Middleware
