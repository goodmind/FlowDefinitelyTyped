...
static +MissingGruntfile: Class<fail$ErrorCode__MissingGruntfile> & fail$ErrorCode__MissingGruntfile & 2;// 2
static +Task: Class<fail$ErrorCode__Task> & fail$ErrorCode__Task & 3;// 3
static +Template: Class<fail$ErrorCode__Template> & fail$ErrorCode__Template & 4;// 4
static +Autocomplete: Class<fail$ErrorCode__Autocomplete> & fail$ErrorCode__Autocomplete & 5;// 5
...
taskName: string,
description: string,
taskFunction: (...args: any[]) => void): void,
 ...
 */
registerMultiTask(taskName: string, taskFunction: (...args: any[]) => void): void,
registerMultiTask(
taskName: string,
...
targetname?: string): Array<grunt$file.file$IFileMap>,
 ...
 * @see ITaskOptions
 */
declare type task$ITaskCompactOptions = {} & undefined.task$ITaskOptions & undefined.file$IFilesConfig
 ...
 */
version: string
} & grunt$grunt$IConfigComponents & undefined.fail$FailModule & grunt$grunt$ITaskComponents
