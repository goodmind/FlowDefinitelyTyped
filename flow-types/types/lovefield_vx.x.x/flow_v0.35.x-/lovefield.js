...
declare  class lf$Type {
  constructor(...args: empty): mixed;
static +ARRAY_BUFFER: Class<lf$Type__ARRAY_BUFFER> & lf$Type__ARRAY_BUFFER & 0;// 0
...
declare  class lf$ConstraintAction {
  constructor(...args: empty): mixed;
static +RESTRICT: Class<lf$ConstraintAction__RESTRICT> & lf$ConstraintAction__RESTRICT & 0;// 0
static +CASCADE: Class<lf$ConstraintAction__CASCADE> & lf$ConstraintAction__CASCADE & 1;// 1
...
declare  class lf$ConstraintTiming {
  constructor(...args: empty): mixed;
static +IMMEDIATE: Class<lf$ConstraintTiming__IMMEDIATE> & lf$ConstraintTiming__IMMEDIATE & 0;// 0
static +DEFERRABLE: Class<lf$ConstraintTiming__DEFERRABLE> & lf$ConstraintTiming__DEFERRABLE & 1;// 1
...
eq(operand: lf$ValueLiteral | schema$schema$Column | lf$Binder): lf$Predicate,
neq(operand: lf$ValueLiteral | schema$schema$Column | lf$Binder): lf$Predicate,
lt(operand: lf$ValueLiteral | schema$schema$Column | lf$Binder): lf$Predicate,
lte(operand: lf$ValueLiteral | schema$schema$Column | lf$Binder): lf$Predicate,
gt(operand: lf$ValueLiteral | schema$schema$Column | lf$Binder): lf$Predicate,
gte(operand: lf$ValueLiteral | schema$schema$Column | lf$Binder): lf$Predicate,
match(operand: RegExp | lf$Binder): lf$Predicate,
between(
from: lf$ValueLiteral | lf$Binder,
to: lf$ValueLiteral | lf$Binder): lf$Predicate,
...
declare  class lf$TransactionType {
  constructor(...args: empty): mixed;
static +READ_ONLY: Class<lf$TransactionType__READ_ONLY> & lf$TransactionType__READ_ONLY & 0;// 0
static +READ_WRITE: Class<lf$TransactionType__READ_WRITE> & lf$TransactionType__READ_WRITE & 1;// 1
...
innerJoin(table: schema$schema$Table, predicate: lf$Predicate): query$Select,
leftOuterJoin(table: schema$schema$Table, predicate: lf$Predicate): query$Select,
...
declare  class schema$DataStoreType {
  constructor(...args: empty): mixed;
static +INDEXED_DB: Class<schema$DataStoreType__INDEXED_DB> & schema$DataStoreType__INDEXED_DB & 0;// 0
static +MEMORY: Class<schema$DataStoreType__MEMORY> & schema$DataStoreType__MEMORY & 1;// 1
static +LOCAL_STORAGE: Class<schema$DataStoreType__LOCAL_STORAGE> & schema$DataStoreType__LOCAL_STORAGE & 2;// 2
static +FIREBASE: Class<schema$DataStoreType__FIREBASE> & schema$DataStoreType__FIREBASE & 3;// 3
static +WEB_SQL: Class<schema$DataStoreType__WEB_SQL> & schema$DataStoreType__WEB_SQL & 4;// 4
...
declare class schema$DataStoreType__LOCAL_STORAGE mixins schema$DataStoreType {}
...
unique?: boolean,
order?: lf$Order): schema$TableBuilder,
...
declare function fn$count(column?: schema$schema$Column): schema$schema$Column


declare function fn$distinct(column: schema$schema$Column): schema$schema$Column


declare function fn$geomean(column: schema$schema$Column): schema$schema$Column
...
declare function fn$stddev(column: schema$schema$Column): schema$schema$Column
