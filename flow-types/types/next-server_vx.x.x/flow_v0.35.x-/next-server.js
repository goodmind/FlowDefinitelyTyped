...
declare interface next$ServerRoute<P> {
match(pathname: string, params?: $Shape<P>): P | false,
fn(
req: http.IncomingMessage,
res: http.ServerResponse,
params: P,
parsedUrl: UrlLike): Promise<void>
} 
...
req: http.IncomingMessage,
res: http.ServerResponse,
parsedUrl: UrlLike): (() => Promise<void>) | void
} 
...
res: http.ServerResponse,
pathname: string,
query?: DefaultQuery): Promise<string>,
renderError(
err: any,
req: http.IncomingMessage,
res: http.ServerResponse,
pathname: string,
query?: DefaultQuery): Promise<void>,
renderErrorToHTML(
err: any,
req: http.IncomingMessage,
res: http.ServerResponse,
