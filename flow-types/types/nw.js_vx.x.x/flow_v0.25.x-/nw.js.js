declare module "nw.gui" {
  ...
  declare export var nw$Window: nw$Window;
}
declare module "NWJS_Helpers" {
  ...
  declare type win = {
    ...
    showDevTools(
      ...
      callback?: (dev_win?: nw$Window) => void
    ): void,
...
declare module "nw.js" {
  ...
  declare class nw$Menu {
     ...
     */
    constructor(option?: MenuOption): this;
     ...
     */
    createMacBuiltin(appname: string, options?: CreateMacBuiltinOption): void;
  }
  ...
  declare class nw$MenuItem mixins NWJS_Helpers.EventEmitter {
     ...
     */
    constructor(option: MenuItemOption): this;
  ...
  declare type nw$Screen = {
     ...
     */
    on(event: "displayBoundsChanged", listener: (screen: screen) => any): this,
     ...
     * - (optional) screen {screen} screen object
     */
    on(event: "displayAdded ", listener: (screen: screen) => any): this,
     ...
     * - (optional) screen {screen} screen object
     */
    on(event: "displayRemoved ", listener: (screen: screen) => any): this
