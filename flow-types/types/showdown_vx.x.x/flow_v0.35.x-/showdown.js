 ...
 * @param name
 */
addExtension(Showdown$extension: Showdown$ShowdownExtension, name: string): void,
addExtension(Showdown$extension: Showdown$ShowdownExtension[], name: string): void,
...
name: string,
Showdown$extension: (() => Showdown$ShowdownExtension) | (() => Showdown$ShowdownExtension[]) | Showdown$ShowdownExtension): void
 ...
 * @param name
 */
declare function Showdown$setFlavor(name: "github"
| "original"
| "ghost"
| "vanilla"
| "allOn"): void
