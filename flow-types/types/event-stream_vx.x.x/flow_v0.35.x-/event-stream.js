 ...
 * @param to
 */
declare export function replace(from: string | RegExp, to: string | RegExp): MapStream
 ...
 * @param readStream
 */
declare export function duplex(writeStream: stream.Writable, readStream: stream.Readable): MapStream
