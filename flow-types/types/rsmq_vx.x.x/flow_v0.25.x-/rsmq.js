declare module "rsmq" {
  ...
  declare interface RedisSMQ$Client {
    createQueue(
      ...
      cb: RedisSMQ$CallbackT<number>
    ): void;
    changeMessageVisibility(
      options: RedisSMQ$VisibilityOptions,
      cb: RedisSMQ$CallbackT<number>
    ): void;
    deleteMessage(
      options: RedisSMQ$MessageIdentifier,
      cb: RedisSMQ$CallbackT<number>
    ): void;
    deleteQueue(
    ...
    getQueueAttributes(
      options: RedisSMQ$QueueIdentifier,
      cb: RedisSMQ$CallbackT<RedisSMQ$QueueAttributes>
    ): void;
    listQueues(cb: RedisSMQ$CallbackT<string[]>): void;
    receiveMessage(
      options: RedisSMQ$ReceiveOptions,
      cb: RedisSMQ$CallbackT<RedisSMQ$Message>
    ): void;
    sendMessage(
      options: RedisSMQ$NewMessage,
      cb: RedisSMQ$CallbackT<string>
    ): void;
    setQueueAttributes(
      options: RedisSMQ$QueueOptions,
      cb: RedisSMQ$CallbackT<RedisSMQ$QueueAttributes>
