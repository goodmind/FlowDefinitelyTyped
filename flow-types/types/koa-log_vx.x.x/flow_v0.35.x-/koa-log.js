...
declare function morgan$date(ctx: Koa.BaseContext, morgan$format: string): string
...
declare function morgan$token(name: string, fn: (ctx: Koa.BaseContext) => string): void
