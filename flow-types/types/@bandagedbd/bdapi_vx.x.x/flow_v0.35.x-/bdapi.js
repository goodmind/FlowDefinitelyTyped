 ...
 */
declare function BdApiModule$deleteData(pluginName: string, key: string): void
 ...
 */
declare function BdApiModule$getInternalInstance(node: HTMLElement): {[key: string]: any} | void
 ...
 */
declare function BdApiModule$getPlugin(name: string): {[key: string]: any} | null
 ...
 */
declare function BdApiModule$injectCSS(id: string, css: string): {[key: string]: any} | null
...
methodName: string,
options: MonkeyPatchOptions): CancelPatch
 ...
 */
declare function BdApiModule$onRemoved(node: HTMLElement, callback: () => void): void
 ...
 */
declare function BdApiModule$saveData(pluginName: string, key: string, data: any): void
 ...
 */
declare function BdApiModule$setData(pluginName: string, key: string, data: any): void
 ...
 */
declare function BdApiModule$showToast(content: string, options?: ToastOptions): void
 ...
 */
declare function BdApiModule$suppressErrors(method: () => void, message?: string): () => void
