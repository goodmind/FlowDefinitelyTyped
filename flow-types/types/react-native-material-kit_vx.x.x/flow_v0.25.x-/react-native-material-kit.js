declare module "react-native-material-kit" {
  ...
  declare export class MKTextField
    mixins MKComponent<MKTextFieldProperties, any> {}
  declare export class MKSwitch mixins MKComponent<MKSwitchProperties, any> {}
  declare export class MKIconToggle
    mixins MKComponent<MKIconToggleProperties, any> {}
  declare export class MKRipple mixins MKComponent<MKRippleProperties, any> {}
  declare export class MKProgress
    mixins MKComponent<MKProgressProperties, any> {}
  declare class MKProgress$Indeterminate
    mixins React.Component<IndeterminateProgressProperties> {}
  declare export class MKSlider mixins MKComponent<MKSliderProperties, any> {}
  declare export class MKRangeSlider
    mixins MKComponent<MKRangeSliderProperties, any> {}
  declare export class MKSpinner mixins MKComponent<MKSpinnerProperties, any> {}
  declare export class MKRadioButton
    mixins MKComponent<MKRadioButtonProperties, any> {}
  declare class MKRadioButton$MKRadioButton {}

  declare class MKRadioButton$Group mixins MKRadioButtonGroup {
    buttons: any[];
    constructor(
      onAdd?: (btn: MKRadioButton$MKRadioButton) => void,
      onRemove?: (btn: MKRadioButton$MKRadioButton) => void
    ): this;
  ...
  declare export class MKCheckbox
    mixins MKComponent<MKCheckboxProperties, any> {}
}
