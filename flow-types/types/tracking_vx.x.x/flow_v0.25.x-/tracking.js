declare module "tracking" {
  declare var npm$namespace$tracking: {
    ...
    ColorTracker: typeof tracking$ColorTracker,
    ObjectTracker: typeof tracking$ObjectTracker,
    Tracker: typeof tracking$Tracker,
    EventEmitter: typeof tracking$EventEmitter,
    TrackerTask: typeof tracking$TrackerTask
  };

  /**
   * Listener callback type for track events.
   */
  declare type tracking$TrackEventListener = (
   ...
   */
  declare type tracking$ColorFunction = (
    r: number,
    g: number,
    b: number
  ) => boolean;
   ...
   */
  declare class tracking$ColorTracker mixins Tracker {
    /**
     * Create a new ColorTracker.
     * @param colors Optional color(s) to track.
     */
    constructor(colors?: string | string[]): this;
     ...
     * the desired color.
     */
    static registerColor(name: string, predicate: tracking$ColorFunction): void;
     ...
     * @param name The color name.
     */
    static getColor(name: string): tracking$ColorFunction;
   ...
   */
  declare class tracking$ObjectTracker mixins Tracker {
    /**
     * Create a new Object Tracker.
     * @param classifiers Optional object classifiers to track.
     */
    constructor(classifiers?: string | string[]): this;
   ...
   */
  declare class tracking$Tracker mixins EventEmitter {
    /**
   ...
   */
  declare class tracking$EventEmitter {
    /**
     * Adds a listener to the end of the listeners array for the specified event.
     * @param event Name of the event.
     * @param listener Listener function.
     */
    addListener(event: string, listener: tracking$TrackEventListener): this;
     ...
     * @param listener Listener function.
     */
    on(event: string, listener: tracking$TrackEventListener): this;
     ...
     */
    once(event: string, listener: tracking$TrackEventListener): void;
     ...
     * @param listener Listener function.
     */
    removeListener(event: string, listener: tracking$TrackEventListener): this;
  }
   ...
   */
  declare class tracking$TrackerTask mixins EventEmitter {
    /**
     * Create a new tracker task.
     * @param tracker The tracker instance to manage.
     */
    constructor(tracker: tracking$Tracker): this;
   ...
   */
  declare function tracking$track(
