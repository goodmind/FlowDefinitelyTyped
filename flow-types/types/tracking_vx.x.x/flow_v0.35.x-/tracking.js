 ...
 */
declare type tracking$TrackEventListener = (event: tracking$TrackEvent) => void;


/**
 * Color match predicate function.
 */
declare type tracking$ColorFunction = (r: number, g: number, b: number) => boolean;
 ...
 */
declare class tracking$ColorTracker mixins tracking$Tracker {
 ...
 */
declare class tracking$ObjectTracker mixins tracking$Tracker {
 ...
 */
declare class tracking$Tracker mixins tracking$EventEmitter {
 ...
 */
declare class tracking$TrackerTask mixins tracking$EventEmitter {
...
tracker: tracking$tracking$Tracker,
options?: {
camera?: boolean,
audio?: boolean
