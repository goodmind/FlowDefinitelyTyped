 ...
 */
hull: Delaunator$Delaunator$Node;
...
points: ArrayLike<P>,
getX: (point: P) => number,
getY: (point: P) => number): Delaunator<P>
}
	declare interface Delaunator$Node {
i: number,
x: number,
y: number,
t: number,
prev: Delaunator$Node | null,
next: Delaunator$Node | null,
removed: boolean
} 
	declare module.exports: typeof Delaunator
