declare module "soundjs" {
  ...
  declare export class createjs$FlashAudioPlugin
    mixins createjs$AbstractPlugin {
    flashReady: boolean;
    showOutput: boolean;
  ...
  declare export class createjs$FlashAudioSoundInstance
    mixins createjs$AbstractSoundInstance {
    constructor(
      src: string,
      startTime: number,
      duration: number,
  ...
  declare export class createjs$HTMLAudioSoundInstance
    mixins createjs$AbstractSoundInstance {
    constructor(
      src: string,
      startTime: number,
  ...
  declare export class createjs$PlayPropsConfig {
    ...
    volume: number;
    static create(
      value: createjs$PlayPropsConfig | any
  ...
  declare export class createjs$WebAudioSoundInstance
    mixins createjs$AbstractSoundInstance {
    constructor(
      src: string,
      startTime: number,
