 ...
 */
declare function getStream$array<T>(stream: Stream, options?: Options): Promise<T[]>
 ...
 */
declare function getStream$buffer(stream: Stream, options?: Options): Promise<Buffer>
