 ...
 */
declare export function xml(text: string, amountOfWhitespaces?: number | string): string

	
/**
 * Pretty print a json string with the given number of whitespace, or with a given indentation pattern
 */
declare export function json(text: string, amountOfWhitespaces?: number | string): string

	
/**
 * Pretty print a css string with the given number of whitespace, or with a given indentation pattern
 */
declare export function css(text: string, amountOfWhitespaces?: number | string): string

	
/**
 * Pretty print an sql string with the given number of whitespace, or with a given indentation pattern
 */
declare export function sql(text: string, amountOfWhitespaces?: number | string): string

	
/**
 * Minifiy an xml string, and preserve or remove comments (default)
 */
declare export function xmlmin(text: string, preserveComments?: boolean): string
 ...
 */
declare export function cssmin(text: string, preserveComments?: boolean): string
