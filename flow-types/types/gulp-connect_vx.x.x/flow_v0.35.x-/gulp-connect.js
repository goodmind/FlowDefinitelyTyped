declare module 'gulp-connect' {
	...
	import typeof * as connectModule from 'connect';

	declare export interface LiveReloadOptions {
 ...
 */
declare export type ConnectRouteHandler = [string, connectModule.HandleFunction];
 ...
 */
declare export type MiddlewareFactory = (
connect: typeof connectModule,
options: ConnectAppOptions) => Array<connectModule.HandleFunction | ConnectRouteHandler>;
	declare export interface ConnectAppOptions {
 ...
 */
declare export function server(options?: ConnectAppOptions): ConnectAppOptions

	
/**
 * Reload all gulp-connect servers that have livereload enabled
 */
declare export function reload(): any

	
/**
 * Close all gulp-connect servers
 */
declare export function serverClose(): void
