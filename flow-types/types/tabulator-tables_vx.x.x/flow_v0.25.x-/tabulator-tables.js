declare module "tabulator-tables" {
  declare type Tabulator$Options = {} & Tabulator$OptionsGeneral &
    Tabulator$OptionsHistory &
    Tabulator$OptionsLocale &
    Tabulator$OptionsDownload &
    Tabulator$OptionsColumns &
    Tabulator$OptionsRows &
    Tabulator$OptionsData &
    Tabulator$OptionsSorting &
    Tabulator$OptionsFiltering &
    Tabulator$OptionsRowGrouping &
    Tabulator$OptionsPagination &
    Tabulator$OptionsPersistentConfiguration &
    Tabulator$OptionsClipboard &
    Tabulator$OptionsDataTree &
    Tabulator$OptionsCell;

  declare type Tabulator$OptionsCells = {
    /**
    ...
    validationFailed?: (
      ...
      value: any,
      validators: Tabulator$Validator[] | Tabulator$StandardValidatorType[]
    ) => void
  } & Tabulator$CellCallbacks;

  declare interface Tabulator$OptionsDataTree {
    /**
    ...
    dataTreeStartExpanded?:
      | boolean
      | boolean[]
      | ((row: Tabulator$RowComponent, level: number) => boolean);
  }

  declare interface Tabulator$OptionsClipboard {
    /**
  ...
  declare interface Tabulator$OptionsPersistentConfiguration {
    /**
  ...
  declare interface Tabulator$OptionsPagination {
    /**
  ...
  declare interface Tabulator$OptionsRowGrouping {
    /**
     ...
     */
    groupTapHold?: Tabulator$GroupEventCallback;
  }

  declare interface Tabulator$Filter {
    field: string;
    type: Tabulator$FilterType;
    value: any;
  }

  declare type Tabulator$FilterFunction = (
    field: string,
    type: Tabulator$FilterType,
    value: any
  ) => void;

  declare interface Tabulator$OptionsFiltering {
    /**
     * Array of filters to be applied on load.
     */
    initialFilter?: Tabulator$Filter[];

    /**
     * array of initial values for header filters.
     */
    initialHeaderFilter?: Array<Pick<Tabulator$Filter, "field" | "value">>;
    ...
    dataFiltered?: (
      ...
      rows: Tabulator$RowComponent[]
    ) => void;
  }

  declare interface Tabulator$OptionsSorting {
    /**
  ...
  declare interface Tabulator$Sorter {
    column: string;
    dir: Tabulator$SortDirection;
  }

  declare interface Tabulator$OptionsData {
    /**
     ...
     */
    ajaxConfig?: Tabulator$HttpMethod | Tabulator$AjaxConfig;
     ...
     */
    ajaxContentType?: "form" | "json" | Tabulator$AjaxContentType;
  ...
  declare interface Tabulator$AjaxContentType {
    headers: Tabulator$JSONRecord;
    body: (url: string, config: any, params: any) => any;
  }

  declare type Tabulator$HttpMethod = "GET" | "POST";

  declare interface Tabulator$AjaxConfig {
    method?: Tabulator$HttpMethod;
    headers?: Tabulator$JSONRecord;
    mode?: string;
    credentials?: string;
  }

  declare interface Tabulator$OptionsRows {
    /**
     ...
     */
    rowFormatter?: (row: Tabulator$RowComponent) => any;
     ...
     */
    selectableCheck?: (row: Tabulator$RowComponent) => boolean;
     ...
     */
    scrollToRowPosition?: Tabulator$ScrollToRowPostition;
     ...
     */
    rowClick?: Tabulator$RowEventCallback;

    /**
     * The rowDblClick callback is triggered when a user double clicks on a row.
     */
    rowDblClick?: Tabulator$RowEventCallback;
  ...
  declare interface Tabulator$OptionsColumns {
     ...
     */
    scrollToColumnPosition?: Tabulator$ScrollToColumnPosition;
     ...
     */
    columnMoved?: (column: Tabulator$ColumnComponent, columns: any[]) => void;
  ...
  declare interface Tabulator$OptionsCell {
    /**
     ...
     */
    cellClick?: Tabulator$CellEventCallback;
    cellDblClick?: Tabulator$CellEventCallback;
    cellContext?: Tabulator$CellEventCallback;
    cellTap?: Tabulator$CellEventCallback;
    cellDblTap?: Tabulator$CellEventCallback;
    cellTapHold?: Tabulator$CellEventCallback;
    cellMouseEnter?: Tabulator$CellEventCallback;
    cellMouseLeave?: Tabulator$CellEventCallback;
    cellMouseOver?: Tabulator$CellEventCallback;
    cellMouseOut?: Tabulator$CellEventCallback;
    cellMouseMove?: Tabulator$CellEventCallback;
    cellEditing?: Tabulator$CellEditEventCallback;
    cellEdited?: Tabulator$CellEditEventCallback;
    cellEditCancelled?: Tabulator$CellEditEventCallback;
  }

  declare interface Tabulator$OptionsGeneral {
    /**
     ...
     */
    tooltips?: Tabulator$GlobalTooltipOption;
     ...
     */
    keybindings?: false | Tabulator$KeyBinding;
     ...
     */
    dataSorted?: (
      sorters: Tabulator$Sorter[],
      rows: Tabulator$RowComponent[]
    ) => void;
  }

  declare type Tabulator$DownloadType = "csv" | "json" | "xlsx" | "pdf";

  declare type Tabulator$DownloadOptions = {
  ...
  declare interface Tabulator$DownloadCSV {
    /**
  ...
  declare interface Tabulator$DownloadXLXS {
    /**
  ...
  declare interface Tabulator$DownloadPDF {
  ...
  declare interface Tabulator$OptionsDownload {
    /**
  ...
  declare interface Tabulator$OptionsLocale {
    /**
  ...
  declare type Tabulator$HistoryAction =
    | "cellEdit"
    | "rowAdd"
    | "rowDelete"
    | "rowMoved";

  declare interface Tabulator$OptionsHistory {
    /**
     ...
     */
    historyUndo: (
      action: Tabulator$HistoryAction,
      component: Tabulator$CellComponent | Tabulator$RowComponent,
      data: any
    ) => void;
  ...
  declare interface Tabulator$ColumnLayout {
    /**
  ...
  declare type Tabulator$ColumnDefinition = {
    /**
     ...
     */
    tooltip?: string | Tabulator$GlobalTooltipOption,
    ...
    sorter?:
      ...
      | ((
          a: any,
          b: any,
          aRow: Tabulator$RowComponent,
          bRow: Tabulator$RowComponent,
          column: Tabulator$ColumnComponent,
          dir: Tabulator$SortDirection,
          sorterParams: {}
        ) => number),
     ...
     */
    sorterParams?:
      | Tabulator$ColumnDefinitionSorterParams
      | Tabulator$ColumnSorterParamLookupFunction,

    /**
     * set how you would like the data to be formatted
     */
    formatter?: Tabulator$Formatter,
     ...
     */
    editable?: boolean | ((cell: Tabulator$CellComponent) => boolean),
     ...
     */
    editor?: Tabulator$Editor,

    /**
     * additional parameters you can pass to the editor
     */
    editorParams?: Tabulator$EditorParams,
     ...
     */
    validator?:
      | Tabulator$StandardValidatorType
      | Tabulator$StandardValidatorType[]
      | Tabulator$Validator
      | Tabulator$Validator[],
     ...
     */
    mutator?: Tabulator$CustomMutator,

    /**
     * You can pass an optional additional parameter with mutator, mutatorParams that should contain an object with additional information for configuring the mutator.
     */
    mutatorParams?: Tabulator$CustomMutatorParams,

    /**
     * only called when data is loaded via a command {eg. setData).
     */
    mutatorData?: Tabulator$CustomMutator,
    mutatorDataParams?: Tabulator$CustomMutatorParams,

    /**
     * only called when data is changed via a user editing a cell.
     */
    mutatorEdit?: Tabulator$CustomMutator,
    mutatorEditParams?: Tabulator$CustomMutatorParams,

    /**
     * only called when data is changed via a user editing a cell.
     */
    mutatorClipboard?: Tabulator$CustomMutator,
    mutatorClipboardParams?: Tabulator$CustomMutatorParams,
     ...
     */
    topCalc?: Tabulator$ColumnCalc,

    /**
     * additional parameters you can pass to the topCalc calculation function (see Column Calculations for more details)
     */
    topCalcParams?: Tabulator$ColumnCalcParams,

    /**
     * formatter for the topCalc calculation cell
     */
    topCalcFormatter?: Tabulator$Formatter,

    /**
     * additional parameters you can pass to the topCalcFormatter function
     */
    topCalcFormatterParams?: Tabulator$FormatterParams,
    bottomCalc?: Tabulator$ColumnCalc,
    bottomCalcParams?: Tabulator$ColumnCalcParams,
    bottomCalcFormatter?: Tabulator$Formatter,

    /**
     * additional parameters you can pass to the bottomCalcFormatter function
     */
    bottomCalcFormatterParams?: Tabulator$FormatterParams,
     ...
     */
    headerSortStartingDir?: Tabulator$SortDirection,
     ...
     */
    headerDblTap?: Tabulator$ColumnEventCallback,
     ...
     */
    headerTapHold?: Tabulator$ColumnEventCallback,
    ...
    headerTooltip?:
      | boolean
      | string
      | ((column: Tabulator$ColumnComponent) => string),
     ...
     */
    headerFilterEmptyCheck?: Tabulator$ValueBooleanCallback,
  ...
  } & Tabulator$ColumnLayout &
    Tabulator$CellCallbacks;

  declare interface Tabulator$CellCallbacks {
    /**
  ...
  declare interface Tabulator$ColumnDefinitionSorterParams {
    format?: string;
  ...
  declare type Tabulator$GlobalTooltipOption =
    | boolean
    | ((cell: Tabulator$CellComponent) => string);

  declare type Tabulator$CustomMutator = (
    value: any,
    data: any,
    type: "data" | "edit",
    mutatorParams: any,
  ...
  declare type Tabulator$CustomMutatorParams =
    | {}
    | ((
        value: any,
        data: any,
  ...
  declare type Tabulator$CustomAccessor = (
    value: any,
    data: any,
  ...
  declare type Tabulator$CustomAccessorParams =
    | {}
    | ((
        value: any,
        data: any,
  ...
  declare type Tabulator$ColumnCalc =
    | "avg"
    | "max"
    | "min"
    | "sum"
  ...
  declare type Tabulator$ColumnCalcParams = (values: any, data: any) => any;

  declare type Tabulator$Formatter =
    | "plaintext"
    | "textarea"
    | "html"
    | "money"
  ...
  declare type Tabulator$FormatterParams =
    | Tabulator$MoneyParams
    | Tabulator$ImageParams
    | Tabulator$LinkParams
    | Tabulator$DateTimeParams
    | Tabulator$DateTimeDifferenceParams
    | Tabulator$TickCrossParams
    | Tabulator$TrafficParams
    | Tabulator$StarRatingParams
    | Tabulator$JSONRecord
    | ((cell: Tabulator$CellComponent) => {});

  declare type Tabulator$Editor =
    | true
    | "input"
    | "textarea"
    | "number"
    ...
    | ((
        cell: Tabulator$CellComponent,
        onRendered: Tabulator$EmptyCallback,
        success: Tabulator$ValueVoidCallback,
        cancel: Tabulator$ValueVoidCallback,
        editorParams: {}
      ) => HTMLElement | false);

  declare type Tabulator$EditorParams =
    | Tabulator$NumberParams
    | Tabulator$CheckboxParams
    | Tabulator$SelectParams
    | Tabulator$AutoCompleteParams
    | ((cell: Tabulator$CellComponent) => {});

  declare type Tabulator$ScrollToRowPostition =
    | "top"
    | "center"
    | "bottom"
    | "nearest";

  declare type Tabulator$ScrollToColumnPosition =
    | "left"
    | "center"
    | "middle"
    | "right";

  declare interface Tabulator$MoneyParams {
    decimal?: string;
    thousand?: string;
    symbol?: string;
    symbolAfter?: boolean;
  ...
  declare interface Tabulator$ImageParams {
    height?: string;
    width?: string;
  }

  declare interface Tabulator$LinkParams {
    labelField?: string;
    label?: string;
    urlPrefix?: string;
    urlField?: string;
  ...
  declare interface Tabulator$DateTimeParams {
    inputFormat?: string;
    outputFormat?: string;
    invalidPlaceholder?: true | string | number | Tabulator$ValueStringCallback;
  }

  declare type Tabulator$DateTimeDifferenceParams = {
    date?: any,
    humanize?: boolean,
    unit?:
      | "years"
  ...
  declare interface Tabulator$TickCrossParams {
    allowEmpty?: boolean;
    allowTruthy?: boolean;
  ...
  declare interface Tabulator$TrafficParams {
    min?: number;
    max?: number;
    color?: Tabulator$Color;
  }

  declare type Tabulator$ProgressBarParams = {
    legend?: string | true | Tabulator$ValueStringCallback,
    legendColor?: Tabulator$Color,
    legendAlign?: Tabulator$Align
  } & Tabulator$TrafficParams;

  declare interface Tabulator$StarRatingParams {
    stars?: number;
  }

  declare interface Tabulator$NumberParams {
    min?: number;
    max?: number;
    step?: number;
  }

  declare interface Tabulator$CheckboxParams {
    tristate?: boolean;
    indeterminateValue?: string;
  }

  declare interface Tabulator$SelectParams {
    values:
      | true
      | string[]
      | Tabulator$JSONRecord
      | Tabulator$SelectParamsGroup[];
    listItemFormatter?: (value: string, text: string) => string;
  }

  declare interface Tabulator$SelectParamsGroup {
    label: string;
    value?: string | number | boolean;
    options?: Tabulator$SelectLabelValue[];
  }

  declare interface Tabulator$SelectLabelValue {
    label: string;
    value: string | number | boolean;
  }

  declare interface Tabulator$AutoCompleteParams {
    values: true | string[] | Tabulator$JSONRecord;
    listItemFormatter?: (value: string, text: string) => string;
  ...
  declare type Tabulator$ValueStringCallback = (value: any) => string;

  declare type Tabulator$ValueBooleanCallback = (value: any) => boolean;

  declare type Tabulator$ValueVoidCallback = (value: any) => void;

  declare type Tabulator$EmptyCallback = (callback: () => void) => void;

  declare type Tabulator$CellEventCallback = (
    e: any,
    cell: Tabulator$CellComponent
  ) => void;

  declare type Tabulator$CellEditEventCallback = (
    cell: Tabulator$CellComponent
  ) => void;

  declare type Tabulator$ColumnEventCallback = (
    e: any,
    column: Tabulator$ColumnComponent
  ) => void;

  declare type Tabulator$RowEventCallback = (
    e: any,
    row: Tabulator$RowComponent
  ) => void;

  declare type Tabulator$RowChangedCallback = (
    row: Tabulator$RowComponent
  ) => void;

  declare type Tabulator$GroupEventCallback = (
    e: any,
    group: Tabulator$GroupComponent
  ) => void;

  declare type Tabulator$SortDirection = "asc" | "desc";

  declare type Tabulator$FilterType =
    | "="
    | "!="
    | "like"
    | "<"
  ...
  declare type Tabulator$Color = string | any[] | Tabulator$ValueStringCallback;

  declare type Tabulator$Align = "center" | "left" | "right" | "justify";

  declare type Tabulator$JSONRecord = Record<string, string | number | boolean>;

  declare type Tabulator$StandardValidatorType =
    | "required"
    | "unique"
    | "integer"
    | "float"
  ...
  declare interface Tabulator$Validator {
    type:
      | Tabulator$StandardValidatorType
      | ((
          cell: Tabulator$CellComponent,
  ...
  declare type Tabulator$ColumnSorterParamLookupFunction = (
    column: Tabulator$ColumnComponent,
    dir: Tabulator$SortDirection
  ) => {};

  declare type Tabulator$ColumnLookup =
    | Tabulator$ColumnComponent
    | Tabulator$ColumnDefinition
    | HTMLElement
    | string;

  declare type Tabulator$RowLookup =
    | Tabulator$RowComponent
    | HTMLElement
    | string
    | number;

  declare interface Tabulator$KeyBinding {
  ...
  declare interface Tabulator$CellNavigation {
    /**
  ...
  declare interface Tabulator$RowComponent {
    /**
     ...
     */
    getNextRow: () => Tabulator$RowComponent | false;
     ...
     */
    getPrevRow: () => Tabulator$RowComponent | false;
     ...
     */
    getCell: (
      column: Tabulator$ColumnComponent | HTMLElement | string
     ...
     */
    getGroup: () => Tabulator$GroupComponent;
     ...
     */
    move: (
      lookup: Tabulator$RowComponent | HTMLElement | number,
      belowTarget?: boolean
    ) => void;
     ...
     */
    getTreeParent: () => Tabulator$RowComponent | false;
     ...
     */
    getTreeChildren: () => Tabulator$RowComponent[];
  }

  declare interface Tabulator$GroupComponent {
    /**
     ...
     */
    getSubGroups: () => Tabulator$GroupComponent[];
     ...
     */
    getParentGroup: () => Tabulator$GroupComponent | false;
  ...
  declare interface Tabulator$ColumnComponent {
    getElement: () => HTMLElement;
     ...
     */
    getDefinition: () => Tabulator$ColumnDefinition;
     ...
     */
    getNextColumn: () => Tabulator$ColumnComponent | false;
     ...
     */
    getPrevColumn: () => Tabulator$ColumnComponent | false;
     ...
     */
    getSubColumns: () => Tabulator$ColumnComponent[];
     ...
     */
    getParentColumn: () => Tabulator$ColumnComponent | false;
  ...
  declare interface Tabulator$CellComponent {
    /**
