declare module 'geodesy' {
	...
	declare export type datum = "ED50"
| "Irl1975"
| "NAD27"
| "NAD83"
| "NTF"
...
| "WGS84";
	...
	declare export type ellipsoid = "WGS84"
| "Airy1830"
| "AiryModified"
| "Bessel1841"
| "Clarke1866"
...
| "Intl1924"
| "WGS72";
	declare export type transform = [number, number, number, number, number, number, number];
...
e100kLetters: string;
n100kLetters: string;
constructor(zone: number, band: string, e100k: string, n100k: string, easting: number, northing: number, datum?: datum): this;
...
convergence: number;
scale: number;
constructor(zone: number, hemisphere: hemisphere, easting: number, northing: number, datum?: datum, convergence?: number, scale?: number): this;
...
declare function Dms$toDMS(deg: number, format?: format, dp?: 0 | 2 | 4): string


declare function Dms$toLat(deg: number, format?: format, dp?: 0 | 2 | 4): string


declare function Dms$toLon(deg: number, format?: format, dp?: 0 | 2 | 4): string


declare function Dms$toBrng(deg: number, format?: format, dp?: 0 | 2 | 4): string


declare function Dms$compassPoint(bearing: number, precision?: 1 | 2 | 3): string
...
bearing2: number): LatLonSpherical;
...
path2brngEnd: LatLonVectors | number): LatLonVectors;
