declare module 'ngsijs' {
        declare export class Connection  {
constructor(url: any): this;
v2: Connection$Connection$V2;
v1: Connection$Connection$V1
}
	declare class Connection$V1  {
constructor(connection: any): this;
