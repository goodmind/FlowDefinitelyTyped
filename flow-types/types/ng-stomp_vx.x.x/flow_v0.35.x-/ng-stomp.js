...
connect(endpoint: string, headers?: ngStomp$ngStomp$Headers): angular.IHttpPromise<any>,
disconnect(callback: () => void): angular.IHttpPromise<any>,
subscribe(
destination: string,
callback: (payload: string, headers: ngStomp$ngStomp$Headers, res: Function) => void,
