...
declare type ZC$EventListenerOrEventListenerObject<T: ZC$ZeroClipboardEvent> =
  | ZC$EventListener<T>
  | ZC$EventListenerObject<T>;
...
declare interface ZC$ZeroClipboardCommon {
  ...
  on(
    eventType: string,
    listener: ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardEvent>
  ): void;
  ...
  on(
    eventType: "ready",
    listener: ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardReadyEvent>
  ): void;
  ...
  on(
    ...
    listener: ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardBeforeCopyEvent>
  ): void;
  ...
  on(
    eventType: "copy",
    listener: ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardCopyEvent>
  ): void;
  ...
  on(
    eventType: "aftercopy",
    listener: ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardAfterCopyEvent>
  ): void;
  ...
  on(
    eventType: "destroy",
    listener: ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardDestroyEvent>
  ): void;
  ...
  on(
    eventType: "error",
    listener: ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardErrorEvent>
  ): void;
  ...
  handlers(
    eventType: string
  ): ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardEvent>[];
  handlers(
    eventType: "ready"
  ): ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardReadyEvent>[];
  handlers(
    eventType: "beforecopy"
  ): ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardBeforeCopyEvent>[];
  handlers(
    eventType: "copy"
  ): ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardCopyEvent>[];
  handlers(
    eventType: "aftercopy"
  ): ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardAfterCopyEvent>[];
  handlers(
    eventType: "destroy"
  ): ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardDestroyEvent>[];
  handlers(
    eventType: "error"
  ): ZC$EventListenerOrEventListenerObject<ZC$ZeroClipboardErrorEvent>[];
 ...
 */
declare var ZeroClipboard: ZC$ZC$ZeroClipboardStatic;
declare module "zeroclipboard" {
  declare export default typeof ZeroClipboard;
}
