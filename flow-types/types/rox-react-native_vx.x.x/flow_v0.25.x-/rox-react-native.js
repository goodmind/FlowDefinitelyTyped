declare module "rox-react-native" {
  declare export {};

  declare export interface RoxContainer {
  ...
  declare export interface RoxSetupOptions {
    version?: string;
  ...
  declare export interface RoxFetcherResult {
    fetcherStatus:
  ...
  declare export interface RoxReporting {
    name: string;
    value: string;
  }
  declare export interface RoxExperiment {
    identifier: string;
    name: string;
    isArchived: boolean;
    labels: string[];
   ...
   */
  declare export function setCustomNumberProperty(
    name: string,
    value: number | (() => number)
  ): void;

  declare export function setCustomStringProperty(
    name: string,
    value: string | (() => string)
  ): void;

  declare export function setCustomBooleanProperty(
    name: string,
   ...
   */
  declare export function unfreeze(namespace?: string): void;
   ...
   */
  declare export function fetch(): Promise<mixed>;
   ...
   */
  declare export type RoxFlagFreezeLevel =
    | "none"
    | "untilForeground"
    | "untilLaunch";
  declare export interface RoxFlagOptions {
   ...
   */
  declare export class Flag {
    constructor(defaultValue: boolean, options?: RoxFlagOptions): this;
    name: string;
    isEnabled(): boolean;
   ...
   */
  declare export class Variant<T: string = string> {
    constructor(defaultValue: T, options: T[], name?: string): this;
    name: string;
    getValue(): T;
    getNameDetails(): RoxNameDetails;
    unfreeze(): void;
  }
  declare interface RoxNameDetails {
    name: string;
    namespace: string;
  }
   ...
   */
  declare export class Configuration<T: string | boolean | number = string> {
   ...
   */
  declare export interface RoxOverrides {
    /**
  ...
  declare export var overrides: RoxOverrides;
}
