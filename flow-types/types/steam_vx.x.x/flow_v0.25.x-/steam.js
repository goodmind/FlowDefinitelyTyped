...
declare export class Steam$EResult {
  ...
  static +AccountLogonDenied: Class<Steam$EResult__AccountLogonDenied> &
    Steam$EResult__AccountLogonDenied &
    0; // 0
}
...
declare export class Steam$EPersonaState {
  constructor(...args: empty): mixed;
  static +Online: Class<Steam$EPersonaState__Online> &
    Steam$EPersonaState__Online &
    0; // 0
}
...
declare export class Steam$EChatEntryType {
  constructor(...args: empty): mixed;
  static +ChatMsg: Class<Steam$EChatEntryType__ChatMsg> &
    Steam$EChatEntryType__ChatMsg &
    0; // 0
}
...
declare export class Steam$EChatMemberStateChange {
  constructor(...args: empty): mixed;
  static +Kicked: Class<Steam$EChatMemberStateChange__Kicked> &
    Steam$EChatMemberStateChange__Kicked &
    0; // 0
}

declare class Steam$EChatMemberStateChange__Kicked
  mixins Steam$EChatMemberStateChange {}
...
declare export class Steam$SteamClient mixins NodeJS.EventEmitter {
  ...
  sendMessage(
    source: any,
    message: string,
    entryType: Steam$EChatEntryType
  ): void;
