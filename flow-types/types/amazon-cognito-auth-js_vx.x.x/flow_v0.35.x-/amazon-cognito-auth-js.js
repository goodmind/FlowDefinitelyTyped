declare module 'amazon-cognito-auth-js' {
        declare export interface XDomainRequest {
+responseText: string,
timeout: number,
onprogress: () => void,
ontimeout: () => void,
...
abort(): void
	...
	declare export interface CognitoSessionData {
...
State?: string
	...
	declare export interface CognitoAuthOptions {
...
AdvancedSecurityDataCollectionFlag?: boolean
	...
	declare export interface CognitoAuthUserHandler {
onSuccess: (authSession: CognitoAuthSession) => void,
onFailure: (err: any) => void
} 
	declare export interface CognitoConstants {
...
decodePayload(): {[key: string]: any}
	...
	declare export class CognitoTokenScopes  {

/**
 * Constructs a new CognitoTokenScopes object
 * @param TokenScopesArray The token scopes
 */
constructor(TokenScopesArray: $ReadOnlyArray<string>): this;
...
setTokenScopes(tokenScopes: $ReadOnlyArray<string>): void
	...
	declare export class CognitoAuthSession  {

/**
 * Constructs a new CognitoUserSession object
 * @param sessionData The session's tokens, scopes, and state.
 */
constructor(sessionData: CognitoSessionData): this;
...
isValid(): boolean
	...
	declare export class CognitoAuth  {
 ...
 */
constructor(options: CognitoAuthOptions): this;
...
isUserSignedIn(): boolean
	...
	declare export class DateHelper  {
...
getNowString(): string
	...
	declare export class StorageHelper  {
