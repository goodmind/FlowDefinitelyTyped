...
columnCount?: number
	...
	declare export function table(data: any[], userConfig?: TableUserConfig): string

	declare export function createStream(userConfig: TableUserConfig): {
write: string[]
}

	declare export function getBorderCharacters(templateName: BorderType): JoinStruct
