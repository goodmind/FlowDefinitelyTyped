...
unproject(xyz: CoordinatesZ, opts?: UnprojectOptions): CoordinatesZ
	...
	declare export type Padding = number | {
top: number,
right: number,
bottom: number,
left: number
...
zoom: number
	...
	declare export function fitBounds(
options: {
width: number,
height: number,
bounds: Bounds,
...
bearing: number
	...
	declare export function normalizeViewportProps(props: ViewportProps): NormalizedViewportProps

	declare export function flyToViewport(
startProps: BaseViewportProps,
endProps: BaseViewportProps,
t: number): BaseViewportProps

	declare export function lngLatToWorld(lngLat: Coordinates, scale: number): Coordinates

	declare export function worldToLngLat(point: Coordinates, scale: number): Coordinates

	declare export function worldToPixels(
coordinates: Coordinates | CoordinatesZ,
pixelProjectionMatrix: ProjectionMatrix): CoordinatesZ

	declare export function pixelsToWorld(
pixels: Coordinates | CoordinatesZ,
pixelUnprojectionMatrix: ProjectionMatrix,
targetZ?: number): CoordinatesZ
...
latitude: number
	...
	declare export type DistanceScalesInput = BaseDistanceScalesInput & {
zoom: number
...
highPrecision: true
	...
	declare export type HighPrecisionDistanceScalesInput = BaseHighPrecisionDistanceScalesInput & {
zoom: number
} | BaseHighPrecisionDistanceScalesInput & {
scale: number
};
	declare export function getDistanceScales(input: DistanceScalesInput): DistanceScales

	declare export function getDistanceScales(input: HighPrecisionDistanceScalesInput): HighPrecisionDistanceScales
...
distanceScales?: DistanceScales
	...
	declare export function getViewMatrix(
input: {
height: number,
pitch: number,
bearing: number,
...
far: number
	...
	declare export function getProjectionParameters(input: ProjectionParametersInput): ProjectionParameters

	declare export function getProjectionMatrix(input: ProjectionParametersInput): ProjectionMatrix
