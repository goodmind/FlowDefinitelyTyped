...
declare interface swan$BaseOptions<R, E> {
 ...
 */
declare function swan$uploadFile(options: swan$UploadFileOptions): swan$UploadTask
 ...
 */
declare function swan$downloadFile(options: swan$DownloadFileOptions): swan$DownloadTask
 ...
 */
declare function swan$sendSocketMessage(options: swan$SendSocketMessageOptions): void
 ...
 */
declare function swan$onSocketMessage(callback: (res: swan$DataResponse) => void): void
...
declare function swan$onSocketClose(callback: (res: any) => void): void
      ...
      declare var npm$namespace$ai: {
        ocrIdCard: typeof ai$ocrIdCard,
ocrBankCard: typeof ai$ocrBankCard,
ocrDrivingLicense: typeof ai$ocrDrivingLicense,
ocrVehicleLicense: typeof ai$ocrVehicleLicense,
textReview: typeof ai$textReview,
textToAudio: typeof ai$textToAudio,
imageAudit: typeof ai$imageAudit,
advancedGeneralIdentify: typeof ai$advancedGeneralIdentify,
objectDetectIdentify: typeof ai$objectDetectIdentify,
carClassify: typeof ai$carClassify,
dishClassify: typeof ai$dishClassify,
logoClassify: typeof ai$logoClassify,
animalClassify: typeof ai$animalClassify,
plantClassify: typeof ai$plantClassify,
getVoiceRecognizer: typeof ai$getVoiceRecognizer,
 ...
 */
declare type ai$ocrIdCardOptions = {
image: string,
 ...
 * 识别银行卡并返回卡号、发卡行和卡片类型。
 */
declare type ai$ocrBankCardOptions = {
image: string,
 ...
 * 对机动车驾驶证所有关键字段进行识别。
 */
declare type ai$ocrDrivingLicenseOptions = {
image: string,
detect_direction?: boolean,
 ...
 * 对机动车行驶证正本所有关键字段进行识别
 */
declare type ai$ocrVehicleLicenseOptions = {
image: string,
detect_direction?: boolean,
accuracy?: string,
...
declare interface ai$ocrIdCardResponse {
direction: number,
image_status: string,
risk_type: string,
edit_tool: string,
...
declare interface ai$ocrBankCardResponse {
log_id: string,
result: {
...
declare interface ai$ocrDrivingLicenseResponse {
log_id: string,
words_result_num: number,
words_result: {
[key: string]: {
...
declare interface ai$ocrVehicleLicenseResponse {
log_id: string,
words_result_num: number,
words_result: {
[key: string]: {
 ...
 * 用户向服务请求识别身份证，身份证识别包括正面和背面。
 */
declare function ai$ocrIdCard(options: ai$ocrIdCardOptions): void
 ...
 * 识别银行卡并返回卡号、发卡行和卡片类型。
 */
declare function ai$ocrBankCard(options: ai$ocrBankCardOptions): void
 ...
 * 对机动车驾驶证所有关键字段进行识别。
 */
declare function ai$ocrDrivingLicense(options: ai$ocrDrivingLicenseOptions): void
 ...
 * 对机动车行驶证正本所有关键字段进行识别
 */
declare function ai$ocrVehicleLicense(options: ai$ocrVehicleLicenseOptions): void
 ...
 * 自动化、智能化的文本审核。
 */
declare type ai$textReviewOptions = {
content: string,
success(res: ai$textReviewResponse): void
} & swan$BaseOptions


declare interface ai$textReviewResponse {
log_id: string,
result: {
spam: number,
reject: any[],
 ...
 * 自动化、智能化的文本审核。
 */
declare function ai$textReview(options: ai$textReviewOptions): void
 ...
 * 将文本转换为可以播放的mp3文件。
 */
declare type ai$textToAudioOptions = {
tex: string,
ctp?: string | number,
lan?: string,
spd?: string,
...
declare interface ai$textToAudioResponse {
filePath: string
} 
 ...
 * 将文本转换为可以播放的mp3文件。
 */
declare function ai$textToAudio(options: ai$textToAudioOptions): void
 ...
 * 自定义图像审核。
 */
declare type ai$imageAuditOptions = {
image: string,
imgUrl?: string,
...
declare interface ai$imageAuditResponse {
log_id: string,
conclusion: string,
...
declare interface ai$imageAuditdata {
type: number,
msg: number,
probability: number,
stars: ai$imageAuditdata[],
words: number
} 
 ...
 * 自定义图像审核。
 */
declare function ai$imageAudit(options: ai$imageAuditOptions): void
 ...
 */
declare type ai$GeneralIdentifyOptions = {
image: string,
success(res: ai$GeneralIdentifyResponse): void
} & swan$BaseOptions


declare interface ai$GeneralIdentifyResponse {
log_id: number,
result_num: number,
result: Array<{
keyword: string,
 ...
 * 通用物体及场景识别，即对于输入的一张图片（可正常解码，且长宽比适宜），输出图片中的多个物体及场景标签。
 */
declare function ai$advancedGeneralIdentify(options: ai$GeneralIdentifyOptions): void
 ...
 * 用户向服务请求检测图像中的主体位置。
 */
declare type ai$DetectIdentifyOptions = {
image: string,
with_face?: number,
...
declare interface ai$DetectIdentifyResponse {
log_id: number,
result: {
left: number,
top: number,
 ...
 * 用户向服务请求检测图像中的主体位置。
 */
declare function ai$objectDetectIdentify(options: ai$DetectIdentifyOptions): void
 ...
 */
declare type ai$carClassifyOptions = {
image: string,
color_result?: string,
top_num?: number,
...
declare interface ai$carClassifyResponse {
log_id: number,
result: Array<{
name: string,
score: number,
 ...
 * 宽比适宜），输出图片的车辆品牌及型号、颜色及年份、位置信息。
 */
declare function ai$carClassify(options: ai$carClassifyOptions): void
 ...
 * 片的菜品名称、卡路里信息、置信度。
 */
declare type ai$dishClassifyOptions = {
image: string,
...
declare interface ai$dishClassifyResponse {
log_id: number,
result_num: number,
result: Array<{
name: string,
 ...
 * 片的菜品名称、卡路里信息、置信度。
 */
declare function ai$dishClassify(options: ai$dishClassifyOptions): void
 ...
 */
declare type ai$logoClassifyOptions = {
image: string,
custom_lib?: boolean,
...
declare interface ai$logoClassifyResponse {
log_id: number,
result_num: number,
result: Array<{
type: number,
 ...
 * 用于检测和识别图片中的品牌 LOGO 信息
 */
declare function ai$logoClassify(options: ai$logoClassifyOptions): void
 ...
 * 用于检测和识别图片中的动物信息
 */
declare type ai$animalClassifyOptions = {
image: string,
top_num?: number,
...
declare interface ai$animalClassifyResponse {
log_id: number,
result_num: number,
result: Array<{
name: number,
 ...
 * 用于检测和识别图片中的动物信息
 */
declare function ai$animalClassify(options: ai$animalClassifyOptions): void
 ...
 * 用于检测和识别图片中的植物信息
 */
declare type ai$plantClassifyOptions = {
image: string,
success(res: ai$plantClassifyResponse): void
} & swan$BaseOptions


declare interface ai$plantClassifyResponse {
log_id: number,
result: Array<{
name: number,
score: number
 ...
 * 用于检测和识别图片中的植物信息
 */
declare function ai$plantClassify(options: ai$plantClassifyOptions): void
 ...
 */
declare interface ai$VoiceRecognizerStart {
mode?: string,
longSpeech?: boolean,
context?: string
} 

declare interface ai$VoiceRecognizeResponse {
result: string
} 

declare interface ai$VoiceErrorResponse {
result: string
} 

declare interface ai$VoiceRecognizerTask {
start(options: ai$VoiceRecognizerStart): void,
stop(): void,
cancel(): void,
onStart(callback: () => void): void,
onRecognize(callback: (res: ai$VoiceRecognizeResponse) => void): void,
onFinish(callback: (res: swan$DataResponse) => void): void,
onError(callback: (res: ai$VoiceErrorResponse) => void): void
} 
 ...
 * 获取全局唯一的语音识别器voiceRecognizer。
 */
declare function ai$getVoiceRecognizer(): ai$VoiceRecognizerTask
 ...
 * @version 1.2.0
 */
declare function swan$saveImageToPhotosAlbum(options: swan$SaveImageToPhotosAlbumOptions): void
 ...
 * @deprecated 1.6.0
 */
declare function swan$startRecord(options: swan$StartRecordAudioOptions): void
...
declare type swan$EncodeBitRate = 8000
| 11025
| 12000
| 16000
| 22050
 ...
 * 录音停止事件，会回调文件地址
 */
onStop(callback?: (options: swan$OnRecorderManagerStopOptions) => void): void,

/**
 * 已录制完指定帧大小的文件，会回调录音分片结果数据。如果设置了 frameSize ，则会回调此事件
 */
onFrameRecorded(callback?: (options: swan$OnFrameRecordedOptions) => void): void,
 ...
 * @deprecated 1.2.0
 */
declare function swan$getBackgroundAudioPlayerState(options: swan$GetBackgroundAudioPlayerStateOptions): void
 ...
 * @deprecated 1.2.0
 */
declare function swan$playBackgroundAudio(options: swan$PlayBackgroundAudioOptions): void
 ...
 * @deprecated 1.2.0
 */
declare function swan$pauseBackgroundAudio(options?: swan$PlayBackgroundAudioOptions): void
 ...
 * @deprecated 1.2.0
 */
declare function swan$seekBackgroundAudio(options: swan$SeekBackgroundAudioOptions): void
 ...
 * @deprecated 1.2.0
 */
declare function swan$stopBackgroundAudio(options?: swan$PlayBackgroundAudioOptions): void
 ...
 */
declare function swan$saveVideoToPhotosAlbum(options: swan$SaveVideoOptions): void
 ...
 * @version 1.7.0
 */
declare function swan$createLivePlayerContext(id: string, instance: any): swan$LivePlayerContext
 ...
 * 获取本地已保存的文件列表
 */
declare function swan$getSavedFileList(options: swan$GetSavedFileListOptions): void
 ...
 * 获取本地文件的文件信息
 */
declare function swan$getSavedFileInfo(options: swan$GetSavedFileInfoOptions): void
 ...
 * 删除本地存储的文件
 */
declare function swan$removeSavedFile(options: swan$RemoveSavedFileOptions): void
 ...
 * 异步获取当前storage的相关信息
 */
declare function swan$getStorageInfo(options: swan$GetStorageInfoOptions): void
 ...
 * 打开地图选择位置
 */
declare function swan$chooseLocation(options: swan$ChooseLocationOptions): void
 ...
 */
getCenterLocation(options: swan$GetCenterLocationOptions): swan$OpenLocationOptions,
...
declare type swan$networkType = "2g"
| "3g"
| "4g"
| "wifi"
| "unknown"
 ...
 * 返回网络类型2g，3g，4g，wifi
 */
swan$networkType: swan$networkType
} 
 ...
 * 获取网络类型。
 */
declare function swan$getNetworkType(options: swan$GetNetworkTypeOptions): void
...
declare type swan$AccelerometerChangeCallback = (res: swan$AccelerometerData) => void;


/**
 * 监听重力感应数据，频率：5次/秒
 */
declare function swan$onAccelerometerChange(callback: swan$AccelerometerChangeCallback): void
 ...
 * @version 1.1.0
 */
declare function swan$startAccelerometer(options: swan$AccelerometerOptions): void
 ...
 * @version 1.1.0
 */
declare function swan$stopAccelerometer(options?: swan$AccelerometerOptions): void
 ...
 */
declare function swan$onCompassChange(callback: swan$CompassChangeCallback): void
 ...
 * @version 1.1.0
 */
declare function swan$setClipboardData(options: swan$SetClipboardDataOptions): void
 ...
 * @version 1.1.0
 */
declare function swan$openBluetoothAdapter(options: swan$OpenBluetoothAdapterOptions): void
 ...
 * @version 1.1.0
 */
declare function swan$closeBluetoothAdapter(options: swan$CloseBluetoothAdapterOptions): void
 ...
 * @version 1.1.0
 */
declare function swan$getBluetoothAdapterState(options: swan$GetBluetoothAdapterStateOptions): void
 ...
 * @version 1.1.0
 */
declare function swan$onBluetoothAdapterStateChange(callback: (res: swan$BluetoothAdapterState) => void): void
 ...
 * @version 1.1.0
 */
declare function swan$stopBluetoothDevicesDiscovery(options: swan$StopBluetoothDevicesDiscoveryOptions): void
 ...
 */
declare function swan$getBluetoothDevices(options: swan$GetBluetoothDevicesOptions): void
 ...
 * @version 1.1.0
 */
declare function swan$onBluetoothDeviceFound(callback: (res: {
devices: swan$BluetoothDevice[]
}) => void): void
 ...
 * @version 1.1.0
 */
declare function swan$getConnectedBluetoothDevices(options: swan$GetConnectedBluetoothDevicesOptions): void
 ...
 * @version 1.1.0
 */
declare function swan$createBLEConnection(options: swan$CreateBLEConnectionOptions): void
 ...
 * @version 1.1.0
 */
declare function swan$closeBLEConnection(options: swan$CloseBLEConnectionOptions): void
 ...
 * 获取蓝牙设备所有 service（服务）
 */
declare function swan$getBLEDeviceServices(options: swan$GetBLEDeviceServicesOptions): void
 ...
 */
declare function swan$getBLEDeviceCharacteristics(options: swan$GetBLEDeviceCharacteristicsOptions): void
 ...
 */
declare function swan$readBLECharacteristicValue(options: swan$ReadBLECharacteristicValue): void
 ...
 */
declare function swan$writeBLECharacteristicValue(options: swan$WriteBLECharacteristicValue): void
 ...
 */
declare function swan$notifyBLECharacteristicValueChanged(options: swan$NotifyBLECharacteristicValueChanged): void
 ...
 * @version 1.2.0
 */
declare function swan$startBeaconDiscovery(options: swan$StartBeaconDiscoveryOptions): void
 ...
 * @version 1.2.0
 */
declare function swan$stopBeaconDiscovery(options: swan$StopBeaconDiscoveryOptions): void
 ...
 * @version 1.2.0
 */
declare function swan$onBeaconUpdate(callback?: (beacons: swan$Beacon[]) => void): void
 ...
 * @version 1.2.0
 */
declare function swan$onBeaconServiceChange(callback?: (available: boolean, discovering: boolean) => void): void
 ...
 * @version 1.2.0
 */
declare function swan$setScreenBrightness(options: swan$SetScreenBrightnessOptions): void
 ...
 * @version 1.2.0
 */
declare function swan$getScreenBrightness(options?: swan$GetScreenBrightnessOptions): void
 ...
 * @version 1.4.0
 */
declare function swan$setKeepScreenOn(options?: swan$SetKeepScreenOnOptions): void
 ...
 * @version 1.4.0
 */
declare function swan$onUserCaptureScreen(callback?: (res: any) => void): void
 ...
 * @version 1.6.0
 */
declare function swan$onGetWifiList(callback?: (res: swan$GetWifiListOptions) => void): void
 ...
 * @version 1.6.0
 */
declare function swan$onWifiConnected(callback?: (wifi: swan$WiFi) => void): void
 ...
 * @version 1.6.0
 */
declare function swan$getConnectedWifi(options?: swan$GetConnectedWifiOptions): void
 ...
 * @version 1.4.3
 */
declare function swan$setTopBarText(options?: swan$SetTopBarTextOptions): void
 ...
 * @version 1.4.3
 */
declare function swan$setNavigationBarTitle(options: swan$SetNavigationBarTitleOptions): void
 ...
 * @version 1.4.3
 */
declare function swan$setNavigationBarColor(options: swan$SetNavigationBarColorOptions): void
 ...
 * @version 1.9.0
 */
declare function swan$setTabBarBadge(options: swan$SetTabBarBadgeOptions): void
 ...
 * @version 1.9.0
 */
declare function swan$removeTabBarBadge(options: swan$TabBarBadgeOptions): void
 ...
 * @version 1.9.0
 */
declare function swan$setTabBarStyle(options: swan$SetTabBarStyleOptions): void
...
declare type swan$TimingFunction = "linear"
| "ease"
| "ease-in"
| "ease-in-out"
| "ease-out"
 ...
 */
declare function swan$createAnimation(options?: swan$CreateAnimationOptions): swan$Animation
...
relativeTo(selector?: string, margins?: swan$Margins): swan$IntersectionObserver,
relativeToViewport(margins?: swan$Margins): swan$IntersectionObserver,
observe(
selector?: string,
callback?: (response: swan$ObserveResponse) => void): swan$IntersectionObserver,
disconnect(): void
} 

declare function swan$createIntersectionObserver(
context: swan$Component<any, any>,
options?: swan$CreateIntersectionObserverOption): swan$IntersectionObserver
 ...
 */
boundingClientRect(
callback?: (rect: swan$NodesRefRect | swan$NodesRefRect[]) => void): swan$SelectorQuery,
 ...
 */
scrollOffset(callback?: (rect: swan$NodeRefOffset) => void): swan$SelectorQuery,
...
callback?: (result: any) => void): swan$SelectorQuery
} 
 ...
 */
in(
component: swan$Component<{[key: string]: any}, {[key: string]: any}>): swan$SelectorQuery,
 ...
 * @param y1 终点的y坐标
 */
createLinearGradient(x0: number, y0: number, x1: number, y1: number): swan$CanvasGradient,
 ...
 * @param r 圆的半径
 */
createCircularGradient(x: number, y: number, r: number): swan$CanvasGradient,
 ...
 */
declare function swan$createCanvasContext(selector: string): swan$CanvasContext
 ...
 */
declare function swan$canvasToTempFilePath(options: $Shape<swan$CanvasToTempFilePathOptions>): void
 ...
 * @version 1.9.0
 */
declare function swan$canvasGetImageData(options: swan$CanvasImageDataOptions): void
 ...
 * @version 1.9.0
 */
declare function swan$canvasPutImageData(options: swan$CanvasPutImageDataOptions): void
 ...
 * 发起微信支付。
 */
declare function swan$requestPayment(options: swan$RequestPaymentOptions): void
 ...
 * @version 1.2.0
 */
declare function swan$updateShareMenu(options?: swan$UpdateShareMenuOptions): void
...
declare type swan$Scope = "scope.userInfo"
| "scope.userLocation"
| "scope.address"
| "scope.invoiceTitle"
| "scope.werun"
 ...
 * @version 1.8.5
 */
declare function swan$requestPolymerPayment(options: swan$requestPolymerPaymentOptions): void
 ...
 * 打开另一个小程序。
 */
declare function swan$navigateToSmartProgram(options: swan$navigateToSmartProgramOptions): void
 ...
 * 返回上一个小程序
 */
declare function swan$navigateBackSmartProgram(options: swan$navigateBackSmartProgramOptions): void
 ...
 * 程序专用方法，使用前需判断方法是否存在。
 */
declare function swan$setMetaDescription(content?: swan$MetaDescription): void
 ...
 */
declare function swan$loadSubPackage(options: swan$LoadSubPackageOptions): void


declare interface swan$UpdateManager {
onCheckForUpdate(callback: (res: {
hasUpdate: boolean
}) => void): void,
onUpdateReady(callback: (res: {
confirm: boolean
}) => void): void,
applyUpdate(): void,
 ...
 * 选择用户的发票抬头。
 */
declare function swan$chooseInvoiceTitle(options: swan$ChooseInvoiceTitleOptions): void
 ...
 * 打开同一公众号下关联的另一个小程序。
 */
declare function swan$navigateToMiniProgram(options: swan$NavigateToMiniProgramOptions): void
 ...
 */
declare function swan$navigateBackMiniProgram(options: swan$NavigateBackMiniProgramOptions): void
...
declare type swan$TouchEventType = "tap"
| "touchstart"
| "touchmove"
| "touchcancel"
| "touchend"
...
declare type swan$TransitionEventType = "transitionend" | "animationstart" | "animationiteration" | "animationend";

declare type swan$EventType = "input"
| "form"
| "submit"
| "scroll"
| swan$TouchEventType
...
declare type swan$BuiltInEvent<T: swan$EventType, Detail> = {} & swan$BaseEvent<T, Detail>


declare type swan$CustomEvent<T: string, Detail> = {} & swan$BaseEvent<T, Detail>
 ...
 * @version 1.5.0
 */
declare type swan$InputEvent = {} & swan$BuiltInEvent<"input", {
value: string,
cursor: number
}>


declare type swan$FormEvent = {} & swan$BuiltInEvent<"form", {
value: {
...
declare type swan$TouchForceChangeEvent = {} & swan$TouchEvent<"touchforcechange">
 ...
 * @param data 上报的自定义数据
 */
declare function swan$reportAnalytics(eventName: string, data: {[key: string]: any}): void
...
declare type swan$DefaultData<V> = {[key: string]: any} | (() => {[key: string]: any});

declare type swan$DefaultProps = {[key: string]: any} | Record<string, any>;

declare type swan$ExtendedComponent<Instance: swan$Component<Data, Props>, Data, Methods, Props> = swan$CombinedInstance<Instance, Data, Methods, Props> & swan$Component<Data, Props>;

declare type swan$CombinedInstance<Instance: swan$Component<Data, Props>, Data, Methods, Props> = Methods & Instance;

declare type swan$Prop<T> = (() => T) | {
new (...args: any[]): T & {[key: string]: any}
};

declare type swan$PropValidator<T> = swan$PropOptions<T> | swan$Prop<T> | Array<swan$Prop<T>>;

declare interface swan$DefaultMethods<V> {
[key: string]: (...args: any[]) => any
} 

declare interface swan$PropOptions<T> {
type?: swan$Prop<T> | Array<swan$Prop<T>>,
value?: T | null | (() => {[key: string]: any}),
observer(value: T, old: T, changedPath: string): void
} 

declare type swan$RecordPropsDefinition<T> = $ObjMapi<T, <K>(K) => swan$PropValidator<$ElementType<T, K>>>;

declare type swan$ArrayPropsDefinition<T> = Array<$Keys<T>>;

declare type swan$PropsDefinition<T> = swan$ArrayPropsDefinition<T> | swan$RecordPropsDefinition<T>;

declare interface swan$ComponentRelation<D, P> {
...
declare type swan$ThisTypedComponentOptionsWithRecordProps<V: swan$Component<Data, Props>, Data, Methods, Props> = {[key: string]: any} & swan$ComponentOptions<V, Data | (() => Data), Methods, Props> & ThisType<swan$CombinedInstance<V, Data, Methods, $ReadOnly<Props>>>;
 ...
 * Component组件参数
 */
declare type swan$ComponentOptions<Instance: swan$Component<Data, Props>, Data, Methods, Props> = {
 ...
 */
behaviors?: Array<(swan$ComponentOptions<swan$Component<{[key: string]: any}, {[key: string]: any}>>) | string>,
 ...
 */
declare type swan$DataValueType<Def> = "There was Conditional Type, use $Call utility type";
 ...
 * 组件数据，包括内部数据和属性值
 */
data: $ObjMapi<(D & P), <key>(key) => swan$DataValueType<$ElementType<(D & P), key>>>,

/**
 * 组件数据，包括内部数据和属性值（与 data 一致）
 */
properties: $ObjMapi<(D & P), <key>(key) => swan$DataValueType<$ElementType<(D & P), key>>>,
 ...
 */
setData(
key: string | $ObjMapi<D, <key>(key) => string
| number
| boolean
| Symbol
| {[key: string]: any}
 ...
 */
createIntersectionObserver(options?: swan$CreateIntersectionObserverOption): swan$IntersectionObserver,
 ...
 */
onShareAppMessage?: (options?: swan$PageShareAppMessageOptions) => swan$ShareAppMessage,
 ...
 */
declare function App<T: swan$swan$AppOptions>(app: T & ThisType<T & swan$swan$App>): void

	
/**
 * 获取小程序实例
 */
declare function getApp(): swan$swan$App

	declare function Component<D, M, P>(
options?: swan$swan$ThisTypedComponentOptionsWithRecordProps<swan$swan$Component<D, P>, D, M, P>): swan$swan$ExtendedComponent<swan$swan$Component<D, P>, D, M, P>
 ...
 */
declare function Page<T: swan$swan$PageOptions & {[key: string]: any}>(
page: T & ThisType<T & swan$swan$Page>): void
 ...
 */
declare function getCurrentPages(): swan$swan$Page[]
