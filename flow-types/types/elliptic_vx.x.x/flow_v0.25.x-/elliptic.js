declare module "elliptic" {
  ...
  declare export type BNInput = string | BN | number | Buffer | number[];
  ...
  declare class curve$edwards mixins curve$base {
    ...
    point(
      ...
      z?: BNInput,
      t?: BNInput
    ): curve$edwards.edwards$EdwardsPoint;
  ...
  declare export class ec {
    ...
    keyFromPrivate(
      priv: Buffer | string | ec$eddsa$KeyPair,
      enc?: string
    ): ec$eddsa$KeyPair;
    keyFromPublic(
      pub: Buffer | string | ec$eddsa$KeyPair,
      enc?: string
    ): ec$eddsa$KeyPair;
  ...
  declare class ec$KeyPair {
    ...
    verify(
      msg: BNInput,
      signature: eddsa$Signature | ec$SignatureOptions
    ): boolean;
    inspect(): string;
  }
  ...
  declare class ec$Signature {
    ...
    constructor(
      options: ec$SignatureOptions | ec$Signature,
      enc?: string
    ): this;
