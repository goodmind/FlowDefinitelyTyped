...
declare module "Validate" {
   ...
   */
  declare export function isValidHDInsightCreationObject(
  ...
  declare export function isValidUuid(
    uuid: string,
    callback: ErrorCallback
  ): void;
   ...
   */
  declare export function isValidFunction(
    functionObject: any,
    functionName: string
  ): void;
  ...
  declare export function namespaceNameIsValid(
    name: string,
    callback: ErrorCallback
  ): boolean;
  ...
  declare export function containerNameIsValid(
   ...
   */
  declare export function blobNameIsValid(
    containerName: string,
    blob: string
  ): boolean;
  ...
  declare export function tableNameIsValid(
    tableName: string,
    callback: ErrorCallback
  ): boolean;
  ...
  declare export function queueNameIsValid(
    queueName: string,
    callback: ErrorCallback
  ): boolean;
  ...
  declare export function validateArgs(
    functionName: string,
...
declare module "ServiceSettings" {
   ...
   * available formats.
   */
  declare export function noMatchConnectionString(
   ...
   */
  declare export function parseAndValidateKeys(
    connectionString: string,
    validKeys: string[]
  ): string[];
   ...
   */
  declare export function settingWithFunc(
    name: string,
    predicate: Function
  ): Requirement[];
   ...
   */
  declare export function matchedSpecification(
...
declare module "azure" {
  declare export class TableService mixins BatchServiceClient {
     ...
     * @param {{[key: string]: any}} authenticationProvider The authentication provider.
     */
    constructor(
    ...
    getServiceProperties(
      ...
      callback: StorageServicePropertiesCallback
    ): void;
  ...
  declare export class BlobService mixins StorageServiceClient {
     ...
     * @param {string} storageAccessKey The storage access key.
     * @param {string} host The host address.
     * @param {{[key: string]: any}} sasToken The Shared Access Signature token.
     */
    constructor(
      storageAccount: string,
      storageAccessKey: string,
    ...
    listContainers(
      ...
      callback: ListContainersCallback
    ): void;
  ...
  declare type RoleEnvironmentInterface = {
    ...
    getConfigurationSettings(
      callback: SimpleCallback<Dictionary<string>>
    ): void,
     ...
     */
    getLocalResources(
      callback: SimpleCallback<Dictionary<RoleLocalResource>>
    ): void,
  ...
  declare export class StorageServiceSettings {
     ...
     * name.
     */
    static _getDefaultServiceEndpoint(
  ...
  declare export type StorageServiceStatsCallback = {} & StorageCallback<StorageServiceStats>;

  declare export type StorageServicePropertiesCallback = {} & StorageCallback<StorageServiceProperties>;
  ...
  declare export interface Entity {
    ...
    Timestamp?: Date;
    etag?: string;
    [property: string]: string | number | boolean | Date | void;
  }
