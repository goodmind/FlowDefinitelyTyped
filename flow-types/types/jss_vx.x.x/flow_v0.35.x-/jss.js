declare module 'jss' {
	...
	declare export type Styles<Name: string> = Record<Name, Style>;
	declare export type Classes<Name: string> = Record<Name, string>;
...
toJSON(): string
	...
	declare export interface StyleSheet<RuleName: string> {
 ...
 */
addRules(styles: $Shape<Styles<RuleName>>, options?: $Shape<RuleOptions>): Rule[],
...
toString(options?: ToCssOptions): string
	...
	declare export type GenerateClassName<Name: string> = (rule: Rule, sheet?: StyleSheet<Name>) => string;
...
insertionPoint: string | HTMLElement
	...
	declare export interface RuleFactoryOptions<Name: string> {
selector: string,
...
toString(options?: ToCssOptions): string
	...
	declare export type CreateStyleSheetOptions<Name: string> = $Shape<{
media: string,
meta: string,
link: boolean,
...
options?: CreateStyleSheetOptions<Name>): StyleSheet<Name>;
...
name: Name,
style: Style,
options?: RuleFactoryOptions<Name>): Rule
}
