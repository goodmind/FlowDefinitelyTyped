declare var jsts: typeof npm$namespace$jsts;

declare var npm$namespace$jsts: {
  version: typeof jsts$version,

  geom: typeof npm$namespace$jsts$geom,
  io: typeof npm$namespace$jsts$io
};
declare export var jsts$version: string;

declare var npm$namespace$jsts$geom: {
  PrecisionModel: typeof jsts$geom$PrecisionModel,
  GeometryFactory: typeof jsts$geom$GeometryFactory,
  GeometryCollection: typeof jsts$geom$GeometryCollection,
  Coordinate: typeof jsts$geom$Coordinate,
  Envelope: typeof jsts$geom$Envelope,
  Geometry: typeof jsts$geom$Geometry,
  LinearRing: typeof jsts$geom$LinearRing,
  LineString: typeof jsts$geom$LineString,
  Point: typeof jsts$geom$Point,
  Polygon: typeof jsts$geom$Polygon
};
 ...
 */
declare export class jsts$geom$PrecisionModel {
  static FIXED: string;
   ...
   * @param modelType
   */
  constructor(modelType?: number | string): this;
}
 ...
 */
declare export class jsts$geom$GeometryFactory {
  /**
   * Constructs a GeometryFactory that generates Geometries having a floating PrecisionModel and a spatial-reference ID of 0.
   */
  constructor(precisionModel?: jsts$geom$PrecisionModel): this;

  /**
   * Creates a LineString using the given Coordinates; a null or empty array will
   * create an empty LineString. Consecutive points must not be equal.
   * @param {jsts$geom$Coordinate[]} coordinates an array without null elements, or an empty array, or
   * null.
   * @return {jsts$geom$LineString} A new LineString.
   */
  createLineString(
    coordinates: Array<jsts$geom$Coordinate>
  ): jsts$geom$LineString;

  /**
   * Creates a Point using the given Coordinate; a null Coordinate will create an
   * empty Geometry.
   * @param {jsts$geom$Coordinate} coordinate Coordinate to base this Point on.
   * @return {jsts$geom$Point} A new Point.
   */
  createPoint(coordinates: jsts$geom$Coordinate): jsts$geom$Point;
}

declare export class jsts$geom$GeometryCollection mixins jsts$geom$Geometry {
  constructor(
    geometries?: Array<jsts$geom$Geometry>,
    factory?: jsts$geom$GeometryFactory
  ): this;
}
 ...
 */
declare export class jsts$geom$Coordinate {
  /**
   * @constructor
   */
   ...
   * @constructor
   */
  constructor(c: jsts$geom$Coordinate): this;
   ...
   * @param {jsts$geom$Coordinate} other the <code>Coordinate</code> with which this
   * <code>Coordinate</code> is being compared.
   * @return {number} -1, zero, or 1 as explained above.
   */
  compareTo(other: jsts$geom$Coordinate): number;
}
 ...
 */
declare export class jsts$geom$Envelope {
  /**
   * Test the point q to see whether it intersects the Envelope defined by p1-p2
   *
   * NOTE: calls intersectsEnvelope if four arguments are given to simulate
   * overloaded function
   * @param {jsts$geom$Coordinate} p1 one extremal point of the envelope.
   * @param {jsts$geom$Coordinate} p2 another extremal point of the envelope.
   * @param {jsts$geom$Coordinate} q the point to test for intersection.
   * @return {boolean} <code>true</code> if q intersects the envelope p1-p2.
   */
  static intersects(
    p1: jsts$geom$Coordinate,
    p2: jsts$geom$Coordinate,
    q: jsts$geom$Coordinate
  ): boolean;

  /**
   * Test the envelope defined by p1-p2 for intersection with the envelope defined
   * by q1-q2
   * @param {jsts$geom$Coordinate} p1 one extremal point of the envelope P.
   * @param {jsts$geom$Coordinate} p2 another extremal point of the envelope P.
   * @param {jsts$geom$Coordinate} q1 one extremal point of the envelope Q.
   * @param {jsts$geom$Coordinate} q2 another extremal point of the envelope Q.
   * @return {boolean} <code>true</code> if Q intersects P.
   */
  static intersectsEnvelope(
    p1: jsts$geom$Coordinate,
    p2: jsts$geom$Coordinate,
    q1: jsts$geom$Coordinate,
    q2: jsts$geom$Coordinate
  ): boolean;
   ...
   */
  constructor(p1: jsts$geom$Coordinate, p2: jsts$geom$Coordinate): this;
   ...
   */
  constructor(p: jsts$geom$Coordinate): this;

  /**
   * Initialize an <code>Envelope</code> from an existing Envelope.
   * @param {jsts$geom$Envelope} env the Envelope to initialize from.
   */
  constructor(env: jsts$geom$Envelope): this;
   ...
   */
  expandToInclude(p: jsts$geom$Coordinate): void;
   ...
   */
  expandToInclude(other: jsts$geom$Envelope): void;
   ...
   * Expands this envelope by a given distance in all directions. Both positive
   * and negative distances are supported.
   * @param {number} deltaX the distance to expand the envelope along the the X axis.
   * @param {number} deltaY the distance to expand the envelope along the the Y axis.
   */
  expandBy(deltaX: number, deltaY: number): void;

  /**
   * Translates this envelope by given amounts in the X and Y direction.
   * @param {number} transX the amount to translate along the X axis.
   * @param {number} transY the amount to translate along the Y axis.
   */
   ...
   * @param {jsts$geom$Envelope} env the envelope to intersect with.
   ...
   * @param {jsts$geom$Envelope} other the <code>Envelope</code> to check.
   * @return {boolean} true if <code>other</code> is contained in this
   * <code>Envelope.</code>
   * @see covers(Envelope)
   */
  contains(other: jsts$geom$Envelope): boolean;
   ...
   * Note that this is <b>not</b> the same definition as the SFS
   * <tt>contains</tt>, which would exclude the envelope boundary.
   * @param {jsts$geom$Coordinate} p the point which this <code>Envelope</code> is being checked for
   * containing.
   ...
   */
  contains(p: jsts$geom$Coordinate): boolean;
   ...
   * Note that this is <b>not</b> the same definition as the SFS
   * <tt>contains</tt>, which would exclude the envelope boundary.
   * @param {number} x the x-coordinate of the point which this <code>Envelope</code>
   * is being checked for containing.
   * @param {number} y the y-coordinate of the point which this <code>Envelope</code>
   * is being checked for containing.
   ...
   * the boundary of this <code>Envelope</code>.
   */
  covers(p: jsts$geom$Coordinate): boolean;
   ...
   * <code>other.</code>
   */
  covers(other: jsts$geom$Envelope): boolean;

  /**
   * Computes the distance between this and another <code>Envelope</code>.
   * @param {jsts$geom$Envelope} env The <code>Envelope</code> to test this <code>Envelope</code>
   * against.
   ...
   */
  distance(env: jsts$geom$Envelope): number;

  /**
   * @param {jsts$geom$Envelope} other the <code>Envelope</code> to check against.
   * @return {boolean} true if envelopes are equal.
   */
  equals(other: jsts$geom$Envelope): boolean;
 ...
 */
declare export class jsts$geom$Geometry {
  /**
   ...
   * @return {jsts$geom$Geometry} the n'th geometry contained in this geometry.
   */
  getGeometryN(n: number): jsts$geom$Geometry;

  /**
   * Returns the <code>PrecisionModel</code> used by the <code>Geometry</code>.
   * @return {jsts$geom$PrecisionModel} the specification of the grid of allowable points, for this
   * <code>Geometry</code> and all other <code>Geometry</code>s.
   */
  getPrecisionModel(): jsts$geom$PrecisionModel;
   ...
   * @return {jsts$geom$Coordinate} a {@link Coordinate} which is a vertex of this
   ...
   * @return {jsts$geom$Coordinate[]} the vertices of this <code>Geometry.</code>
   * @see geometryChanged
   * @see CoordinateSequence#setOrdinate
   */
  getCoordinates(): jsts$geom$Coordinate[];
   ...
   * @param {jsts$geom$Geometry} g the <code>Geometry</code> from which to compute the distance.
   * @return {number} the distance between the geometries. 0 if either input
   * geometry is empty.
   * @throws IllegalArgumentException
   * if g is null
   */
  distance(g: jsts$geom$Geometry): number;

  /**
   * Tests whether the distance from this <code>Geometry</code> to another is
   * less than or equal to a specified value.
   * @param {jsts$geom$Geometry} geom the Geometry to check the distance to.
   * @param {number} distance the distance value to compare.
   * @return {boolean} <code>true</code> if the geometries are less than
   * <code>distance</code> apart.
   */
  isWithinDistance(geom: jsts$geom$Geometry, distance: number): boolean;
  isRectangle(): boolean;
   ...
   * of the geometry.
   * @return {jsts$geom$Point} a {@link Point} which is in the interior of this Geometry.
   */
  getInteriorPoint(): jsts$geom$Point;
   ...
   * @return {jsts$geom$Geometry} the closure of the combinatorial boundary of this
   * <code>Geometry.</code>
   */
  getBoundary(): jsts$geom$Geometry;
   ...
   * (minx, miny).
   * @return {jsts$geom$Geometry} an empty <code>Point</code> (for empty
   * <code>Geometry</code>s), a <code>Point</code> (for
   * <code>Point</code>s) or a <code>Polygon</code> (in all other
   * cases).
   */
  getEnvelope(): jsts$geom$Geometry;

  /**
   * Returns the minimum and maximum x and y values in this <code>Geometry</code>,
   * or a null <code>Envelope</code> if this <code>Geometry</code> is empty.
   * @return {jsts$geom$Envelope} this <code>Geometry</code>s bounding box; if the
   * <code>Geometry</code> is empty, <code>Envelope#isNull</code> will
   * return <code>true.</code>
   */
  getEnvelopeInternal(): jsts$geom$Envelope;
   ...
   * </ul>
   * @param {jsts$geom$Geometry} g the <code>Geometry</code> with which to compare this
   * <code>Geometry.</code>
   * @return {boolean} <code>true</code> if the two <code>Geometry</code>s
   * are disjoint.
   * @see Geometry#intersects
   */
  disjoint(g: jsts$geom$Geometry): boolean;
   ...
   * are points.
   */
  touches(g: jsts$geom$Geometry): boolean;
   ...
   */
  intersects(g: jsts$geom$Geometry): boolean;
   ...
   * cross.
   */
  crosses(g: jsts$geom$Geometry): boolean;
   ...
   */
  within(g: jsts$geom$Geometry): boolean;
   ...
   * @see Geometry#within
   */
  contains(g: jsts$geom$Geometry): boolean;
   ...
   * overlap.
   */
  overlaps(g: jsts$geom$Geometry): boolean;
   ...
   */
  covers(g: jsts$geom$Geometry): boolean;
   ...
   * @see Geometry#covers
   */
  coveredBy(g: jsts$geom$Geometry): boolean;
   ...
   * Specification</i>.
   * @param {jsts$geom$Geometry} other the <code>Geometry</code> with which to compare this
   * <code>Geometry.</code>
   * @param {string} intersectionPattern the pattern against which to check the
   ...
   */
  relate(g: jsts$geom$Geometry, intersectionPattern: string): boolean;
   ...
   * <code>Geometry</code>s.
   */
  relate2(g: jsts$geom$Geometry): any;
   ...
   */
  equalsTopo(g: jsts$geom$Geometry): boolean;
   ...
   * @param {number} distance the width of the buffer (may be positive, negative or 0).
   * @param {number} quadrantSegments the number of line segments used to represent a
   * quadrant of a circle.
   * @param {number} endCapStyle the end cap style to use.
   * @return {jsts$geom$Geometry} a polygonal geometry representing the buffer region (which
   * may be empty).
   ...
   * </TR>
   * </TABLE>
   * @return {jsts$geom$Geometry} the minimum-area convex polygon containing this
   * <code>Geometry</code>' s points.
   */
  convexHull(): jsts$geom$Geometry;
   ...
   * @param {jsts$geom$Geometry} other the <code>Geometry</code> with which to compute the
   * intersection.
   * @return {jsts$geom$Geometry} the points common to the two <code>Geometry</code>s.
   * @throws TopologyException
   * if a robustness error occurs
   * @throws IllegalArgumentException
   * if the argument is a non-empty GeometryCollection
   */
  intersection(other: jsts$geom$Geometry): jsts$geom$Geometry;
   ...
   * </ul>
   * @param {jsts$geom$Geometry} other the <code>Geometry</code> with which to compute the union.
   * @return {jsts$geom$Geometry} a set combining the points of this <code>Geometry</code>
   ...
   */
  union(other: jsts$geom$Geometry): jsts$geom$Geometry;
   ...
   * @param {jsts$geom$Geometry} other the <code>Geometry</code> with which to compute the
   * difference.
   * @return {jsts$geom$Geometry} the point set difference of this <code>Geometry</code>
   ...
   * if either input is a non-empty GeometryCollection
   */
  difference(other: jsts$geom$Geometry): jsts$geom$Geometry;
   ...
   * @return {jsts$geom$Geometry} the point set symmetric difference of this
   ...
   * if either input is a non-empty GeometryCollection
   */
  symDifference(other: jsts$geom$Geometry): jsts$geom$Geometry;
   ...
   * @param {jsts$geom$Geometry} other the <code>Geometry</code> with which to compare this
   * <code>Geometry.</code>
   * @param {number} tolerance distance at or below which two <code>Coordinate</code>s
   * are considered equal.
   * @return {boolean}
   */
  equalsExact(other: jsts$geom$Geometry, tolerance: number): boolean;
   ...
   * execution.
   * @param {jsts$geom$Geometry} g a Geometry.
   * @return {boolean} true if the input geometries are exactly equal in their
   * normalized form.
   */
  equalsNorm(g: jsts$geom$Geometry): boolean;
   ...
   * compared, etc.
   * @param {jsts$geom$Geometry} other a <code>Geometry</code> with which to compare this
   * <code>Geometry.</code>
   ...
   */
  compareTo(o: jsts$geom$Geometry): number;
   ...
   * return <code>true.</code>
   */
  computeEnvelopeInternal(): jsts$geom$Envelope;
   ...
   * Specifications.
   */
  compareToSameClass(o: jsts$geom$Geometry): number;
   ...
   * negative number.
   * @param {Array} a a <code>Collection</code> of <code>Comparable</code>s.
   * @param {Array} b a <code>Collection</code> of <code>Comparable</code>s.
  ...
  /**
   * @param {jsts$geom$Coordinate} a first Coordinate to compare.
   * @param {jsts$geom$Coordinate} b second Coordinate to compare.
   * @param {number} tolerance tolerance when comparing.
   * @return {boolean} true if equal.
   */
  equal(
    a: jsts$geom$Coordinate,
    b: jsts$geom$Coordinate,
    tolerance: number
  ): boolean;
 ...
 */
declare export class jsts$geom$LinearRing mixins jsts$geom$LineString {}

declare export class jsts$geom$LineString mixins jsts$geom$Geometry {
  /**
   * @constructor
   */
  constructor(points: Array<jsts$geom$Coordinate>, factory?: any): this;
   ...
   * @param {int} n index.
   */
  getCoordinateN(n: number): jsts$geom$Coordinate;
...
declare export class jsts$geom$Point mixins jsts$geom$Geometry {
  /**
   * @constructor
   */
  constructor(coordinate: jsts$geom$Coordinate, factory?: any): this;
  ...
  /**
   * @return {jsts$geom$Point} Reversed point is a cloned point.
   */
  reverse(): jsts$geom$Point;
}
 ...
 */
declare export class jsts$geom$Polygon mixins jsts$geom$Geometry {
  /**
   * @constructor
   */
  constructor(
    shell: jsts$geom$LinearRing,
    holes?: Array<jsts$geom$LinearRing>,
    factory?: any
  ): this;

  /**
   * Gets the exterior ring.
   * @return {jsts$geom$LinearRing} The exterior ring.
   */
  getExteriorRing(): jsts$geom$LinearRing;

  /**
   * Gets the interior ring at the specified index.
   * @param {number} n The interior ring index.
   * @returns {jsts$geom$LinearRing} The interior ring at the specified index.
   */
  getInteriorRingN(n: number): jsts$geom$LinearRing;
...
declare var npm$namespace$jsts$io: {
  OL3Parser: typeof jsts$io$OL3Parser,
  GeoJSONReader: typeof jsts$io$GeoJSONReader,
  GeoJSONWriter: typeof jsts$io$GeoJSONWriter,
  WKTReader: typeof jsts$io$WKTReader,
  WKTWriter: typeof jsts$io$WKTWriter
};

/**
 * OpenLayers 3 Geometry parser and writer
 */
declare export class jsts$io$OL3Parser {
  constructor(geometryFactory?: jsts$geom$GeometryFactory): this;
  read(geometry: any): jsts$geom$Geometry;
  write(geometry: jsts$geom$Geometry): any;
}

declare export class jsts$io$GeoJSONReader {
  constructor(): this;

  /**
   * Converts a GeoJSON to its <code>Geometry</code> representation.
   * @param {Object} The GeoJSON representation of the Geometry.
   * @return {jsts$geom$Geometry} geometry a <code>Geometry</code> to process.
   */
  read(geometry: Object): jsts$geom$Geometry;
}

declare export class jsts$io$GeoJSONWriter {
  /**
   ...
   * @param {jsts$geom$Geometry} geometry a <code>Geometry</code> to process.
   * @return {Object} The GeoJSON representation of the Geometry.
   */
  write(geometry: jsts$geom$Geometry): Object;
}
 ...
 * <P>
 */
declare export class jsts$io$WKTReader {
  /**
   * @constructor
   */
  constructor(geometryFactory?: jsts$geom$GeometryFactory): this;
   ...
   * @param {string} wkt a <Geometry Tagged Text> string (see the OpenGIS Simple Features
   * Specification).
   * @return {jsts$geom$Geometry} a <code>Geometry</code> read from
   * <code>string.</code>
   */
  read(wkt: string): jsts$geom$Geometry;
  reducePrecision(geometry: jsts$geom$Geometry): void;
}

declare export class jsts$io$WKTWriter {
  /**
   * @constructor
   */
  constructor(geometryFactory?: jsts$geom$GeometryFactory): this;
...
declare module "jsts" {
  declare export default typeof jsts;
}
