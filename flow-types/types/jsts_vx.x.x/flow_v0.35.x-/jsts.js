 ...
 */
declare export class geom$PrecisionModel  {
static FIXED: string;
 ...
 */
declare export class geom$GeometryFactory  {

/**
 * Constructs a GeometryFactory that generates Geometries having a floating PrecisionModel and a spatial-reference ID of 0.
 */
constructor(precisionModel?: geom$PrecisionModel): this;

/**
 * Creates a LineString using the given Coordinates; a null or empty array will
 * create an empty LineString. Consecutive points must not be equal.
 * @param {geom$Coordinate[]} coordinates an array without null elements, or an empty array, or
null.
 * @return {geom$LineString} A new LineString.
 */
createLineString(coordinates: Array<geom$Coordinate>): geom$LineString;

/**
 * Creates a Point using the given Coordinate; a null Coordinate will create an
 * empty Geometry.
 * @param {geom$Coordinate} coordinate Coordinate to base this Point on.
 * @return {geom$Point} A new Point.
 */
createPoint(coordinates: geom$Coordinate): geom$Point
}

declare export class geom$GeometryCollection mixins undefined.geom$Geometry {
constructor(geometries?: Array<geom$Geometry>, factory?: geom$GeometryFactory): this
}
 ...
 */
declare export class geom$Coordinate  {
 ...
 * <code>other</code>.
 * @param {geom$Coordinate} other the <code>Coordinate</code> to copy.
 */
setCoordinate(other: geom$Coordinate): void;

/**
 * Clones this instance.
 * @return {geom$Coordinate} A point instance cloned from this.
 */
 ...
 * @param {geom$Coordinate} p a point.
 ...
 * are equal.
 * @param {geom$Coordinate} other a <code>Coordinate</code> with which to do the 2D
comparison.
 ...
 * @param {geom$Coordinate} other a <code>Coordinate</code> with which to do the comparison.
 ...
 * @param {geom$Coordinate} other the <code>Coordinate</code> with which this
 ...
 */
declare export class geom$Envelope  {
 ...
 * overloaded function
 * @param {jsts$geom.geom$Coordinate} p1 one extremal point of the envelope.
 * @param {jsts$geom.geom$Coordinate} p2 another extremal point of the envelope.
 * @param {jsts$geom.geom$Coordinate} q the point to test for intersection.
 * @return {boolean} <code>true</code> if q intersects the envelope p1-p2.
 */
static intersects(p1: geom$Coordinate, p2: geom$Coordinate, q: geom$Coordinate): boolean;

/**
 * Test the envelope defined by p1-p2 for intersection with the envelope defined
 * by q1-q2
 * @param {jsts$geom.geom$Coordinate} p1 one extremal point of the envelope P.
 * @param {jsts$geom.geom$Coordinate} p2 another extremal point of the envelope P.
 * @param {jsts$geom.geom$Coordinate} q1 one extremal point of the envelope Q.
 * @param {jsts$geom.geom$Coordinate} q2 another extremal point of the envelope Q.
 ...
 * @param {jsts$geom.geom$Coordinate} p1 the first Coordinate.
 * @param {jsts$geom.geom$Coordinate} p2 the second Coordinate.
 */
 ...
 * Coordinate.
 * @param {jsts$geom.geom$Coordinate} p the Coordinate.
 */
constructor(p: geom$Coordinate): this;

/**
 * Initialize an <code>Envelope</code> from an existing Envelope.
 * @param {jsts$geom.geom$Envelope} env the Envelope to initialize from.
 */
 ...
 * envelope.
 * @param {jsts$geom.geom$Coordinate} p the Coordinate to expand to include.
 */
 ...
 * @param {jsts$geom.geom$Envelope} other the <code>Envelope</code> to expand to include.
 */
 ...
 * non-null
 * @return {jsts$geom.geom$Coordinate} the centre coordinate of this envelope <code>null</code>
 ...
 * @param {jsts$geom.geom$Envelope} env the envelope to intersect with.
 * @return {jsts$geom.geom$Envelope} a new Envelope representing the intersection of
 ...
 * @param {jsts$geom.geom$Envelope} other the <code>Envelope</code> which this <code>Envelope</code>
 ...
 * <code>Envelope</code>.
 * @param {jsts$geom.geom$Coordinate} p the <code>Coordinate</code> to be tested.
 ...
 * @param {jsts$geom.geom$Envelope} other the <code>Envelope</code> to check.
 ...
 * Note that this is <b>not</b> the same definition as the SFS
 * <tt>contains</tt>, which would exclude the envelope boundary.
 * @param {jsts$geom.geom$Coordinate} p the point which this <code>Envelope</code> is being checked for
containing.
 ...
 * @param {jsts$geom.geom$Envelope} env The <code>Envelope</code> to test this <code>Envelope</code>
against.
...
/**
 * @param {jsts$geom.geom$Envelope} other the <code>Envelope</code> to check against.
...
/**
 * @return {jsts$geom.geom$Envelope} A new instance copied from this.
 */
clone(): geom$Envelope
}
 ...
 */
declare export class geom$Geometry  {
 ...
 * @return {jsts$geom.geom$GeometryFactory} the factory for this geometry.
 */
getFactory(): any;
 ...
 * @return {geom$Geometry} the n'th geometry contained in this geometry.
 */
getGeometryN(n: number): geom$Geometry;

/**
 * Returns the <code>PrecisionModel</code> used by the <code>Geometry</code>.
 * @return {geom$PrecisionModel} the specification of the grid of allowable points, for this
<code>Geometry</code> and all other <code>Geometry</code>s.
 */
getPrecisionModel(): geom$PrecisionModel;
 ...
 * @return {geom$Coordinate} a {@link Coordinate} which is a vertex of this
 ...
 * @return {geom$Coordinate[]} the vertices of this <code>Geometry.</code>
 * @see geometryChanged
 ...
 * @param {geom$Geometry} g the <code>Geometry</code> from which to compute the distance.
 ...
 * @param {geom$Geometry} geom the Geometry to check the distance to.
 ...
 * of the geometry.
 * @return {geom$Point} a {@link Point} which is in the interior of this Geometry.
 */
 ...
 * @return {geom$Geometry} the closure of the combinatorial boundary of this
<code>Geometry.</code>
 */
 ...
 * (minx, miny).
 * @return {geom$Geometry} an empty <code>Point</code> (for empty
 ...
 * @return {geom$Envelope} this <code>Geometry</code>s bounding box; if the
 ...
 * </ul>
 * @param {geom$Geometry} g the <code>Geometry</code> with which to compare this
<code>Geometry.</code>
 ...
 * Specification</i>.
 * @param {geom$Geometry} other the <code>Geometry</code> with which to compare this
<code>Geometry.</code>
 ...
 * @return {geom$Geometry} a polygonal geometry representing the buffer region (which
may be empty).
 ...
 * </TR>
 * </TABLE>
 * @return {geom$Geometry} the minimum-area convex polygon containing this
 ...
 * @param {geom$Geometry} other the <code>Geometry</code> with which to compute the
intersection.
 * @return {geom$Geometry} the points common to the two <code>Geometry</code>s.
 * @throws TopologyException
if a robustness error occurs
 * @throws IllegalArgumentException
 ...
 * </ul>
 * @param {geom$Geometry} other the <code>Geometry</code> with which to compute the union.
 * @return {geom$Geometry} a set combining the points of this <code>Geometry</code>
 ...
 * @param {geom$Geometry} other the <code>Geometry</code> with which to compute the
difference.
 * @return {geom$Geometry} the point set difference of this <code>Geometry</code>
 ...
 * @return {geom$Geometry} the point set symmetric difference of this
 ...
 * execution.
 * @param {geom$Geometry} g a Geometry.
 ...
 * compared, etc.
 * @param {geom$Geometry} other a <code>Geometry</code> with which to compare this
<code>Geometry.</code>
 ...
 * exception).
 * @param {geom$Geometry} g the <code>Geometry</code> to check.
 * @throws Error
...
/**
 * @param {jsts$geom.geom$Coordinate} a first Coordinate to compare.
 * @param {jsts$geom.geom$Coordinate} b second Coordinate to compare.
 ...
 */
declare export class geom$LinearRing mixins geom$LineString {}

declare export class geom$LineString mixins geom$Geometry {
...
/**
 * @return {jsts$geom.geom$Coordinate} The n'th coordinate of this
...
/**
 * @return {jsts$geom.geom$Point} The n'th point of this
jsts.geom.LineString.
 * @param {int} n index.
 */
...
/**
 * @return {jsts$geom.geom$Point} The first point of this
jsts.geom.LineString.
 */
getStartPoint(): geom$Point;

/**
 * @return {jsts$geom.geom$Point} The last point of this
jsts.geom.LineString.
 */
...
declare export class geom$Point mixins geom$Geometry {
...
/**
 * @return {geom$Point} Reversed point is a cloned point.
 */
reverse(): geom$Point
}
 ...
 */
declare export class geom$Polygon mixins geom$Geometry {
 ...
 * @return {geom$LinearRing} The exterior ring.
 */
 ...
 * @returns {geom$LinearRing} The interior ring at the specified index.
 */
 ...
 */
declare export class io$OL3Parser  {
constructor(geometryFactory?: jsts$geom.geom$GeometryFactory): this;
read(geometry: any): jsts$geom.geom$Geometry;
write(geometry: jsts$geom.geom$Geometry): any
}

declare export class io$GeoJSONReader  {
constructor(): this;

/**
 * Converts a GeoJSON to its <code>Geometry</code> representation.
 * @param {Object} The GeoJSON representation of the Geometry.
 * @return {jsts$geom.geom$Geometry} geometry a <code>Geometry</code> to process.
 */
read(geometry: Object): geom$geom$Geometry
}

declare export class io$GeoJSONWriter  {
 ...
 * @param {jsts$geom.geom$Geometry} geometry a <code>Geometry</code> to process.
 * @return {Object} The GeoJSON representation of the Geometry.
 */
write(geometry: geom$geom$Geometry): Object
}
 ...
 * <P>
 */
declare export class io$WKTReader  {
...
Specification).
 * @return {jsts$geom.geom$Geometry} a <code>Geometry</code> read from
<code>string.</code>
 */
read(wkt: string): geom$geom$Geometry;
reducePrecision(geometry: geom$geom$Geometry): void
}

declare export class io$WKTWriter  {
