declare module 'motor-hat' {
        declare export type Direction = "fwd" | "back";
	declare type Callback = (err?: Error, result?: any) => void;
	declare export interface PinDefinitionObject {
...
IN2: number
	...
	declare export type PinDefinition = PinDefinitionObject | number[];
	declare export interface DCOptions {
 ...
 */
declare export interface ServoOptions {
 ...
 */
declare export interface Servo {
 ...
 */
declare export interface StepperOptions {
...
sps?: number
	...
	declare export interface StepResult {
...
retried: number
	...
	declare export interface StepSyncResult {
 ...
 */
declare export interface StepperSpeed {
 ...
 */
declare export interface Stepper {
...
dir: Direction,
steps: number,
cb: (err?: Error, result?: StepResult) => void): void,
 ...
 */
declare export interface MotorHat {
+pins: {
M1: MotorPins,
M2: MotorPins,
M3: MotorPins,
 ...
 */
+servos: $ReadOnlyArray<Servo>,

/**
 * Array of initialized Stepper controllers
 */
+steppers: $ReadOnlyArray<Stepper>,

/**
 * Array of initialized DC controllers
 */
+dcs: $ReadOnlyArray<DC>,
...
init(cb: Callback): void
	...
	declare export type Motor = "M1" | "M2" | "M3" | "M4";
	declare export interface MotorHatOptions {
...
declare function motorhat(options: MotorHatOptions): MotorHat
	...
	declare export default typeof motorhat
