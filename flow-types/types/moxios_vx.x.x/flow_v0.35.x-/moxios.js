 ...
 */
constructor(resolve: (arg: any) => void, reject: (arg: any) => void, config: AxiosRequestConfig): this;
 ...
 * @param res The data representing the result of the request
 */
constructor(req: Request, res: any): this;
config: AxiosRequestConfig;
data: any;
status: number;
statusText: string;
...
wait(fn: () => void, delay?: number): void
	...
	declare module.exports: typeof moxios
