declare module 'dynatrace' {
        declare interface dynaTrace {

/**
 * @description disable automatic detection
Use in conjuction with enterAction
 * @example dynaTrace.setAutomaticActionDetection(false);
...
type: string,
time?: number,
parentAction?: number | boolean): number,
...
type: "_info_" | "_warn_" | "_error_"): void,
...
setMetaData(key: string, value: string): void
	...
	declare var dynaTrace: dynaTrace;
    }
