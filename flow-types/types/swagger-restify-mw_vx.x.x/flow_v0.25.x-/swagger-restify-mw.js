declare module "swagger-restify-mw" {
  import type { Config, RestifyMiddleware } from "swagger-node-runner";

  declare export { Config, RestifyMiddleware } from "swagger-node-runner";
  ...
  declare export function create(
    config: Config,
    cb: (err: Error | void, middleware: RestifyMiddleware) => void
  ): void;
}
