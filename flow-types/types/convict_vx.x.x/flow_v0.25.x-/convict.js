declare module "convict" {
  declare type convict$Overwrite<T, U> = $ObjMapi<
  ...
  declare interface convict$Parser {
    ...
    parse: (definition$content: string) => any;
  }
  ...
  declare interface convict$SchemaObj<T = any> {
    default: T;
    doc?: string;
  ...
  declare type convict$Schema<T> = $ObjMapi<
    T,
    <P>(
      P
    ) =>
      | convict$Schema<$ElementType<T, P>>
      | convict$SchemaObj<$ElementType<T, P>>
  >;

  declare interface convict$InternalSchema<T> {
    properties: $ObjMapi<
      T,
      <K>(K) => "There was Conditional Type, use $Call utility type"
    >;
  }
 ...
 */
    priorities$get<K: $Keys<T> | string | null | void>(
      skin$name?: K
    ): "There was Conditional Type, use $Call utility type";
    priorities$get<K: $Keys<T>, K2: $Keys<$ElementType<T, K>>>(
      skin$name: string
    ): $ElementType<$ElementType<T, K>, K2>;
    priorities$get<
      K: $Keys<T>,
      K2: $Keys<$ElementType<T, K>>,
      K3: $Keys<$ElementType<$ElementType<T, K>, K2>>
    >(
      skin$name: K
    ): $ElementType<$ElementType<$ElementType<T, K>, K2>, K3>;
    priorities$get<
      K: $Keys<T>,
      K2: $Keys<$ElementType<T, K>>,
      K3: $Keys<$ElementType<$ElementType<T, K>, K2>>,
      K4: $Keys<$ElementType<$ElementType<$ElementType<T, K>, K2>, K3>>
    >(
      skin$name: string
    ): $ElementType<$ElementType<$ElementType<$ElementType<T, K>, K2>, K3>, K4>;
 ...
 */
    ...
    default<K: $Keys<T>>(skin$name?: K): $ElementType<T, K>;
     ...
     */
    has<K: $Keys<T> | string>(skin$name: K): boolean;
    has<K: $Keys<T>, K2: $Keys<$ElementType<T, K>>>(skin$name: string): boolean;
    has<
      K: $Keys<T>,
      K2: $Keys<$ElementType<T, K>>,
      K3: $Keys<$ElementType<$ElementType<T, K>, K2>>
    ...
    set<
      K: $Keys<T>,
      K2: $Keys<$ElementType<T, K>>,
      K3: $Keys<$ElementType<$ElementType<T, K>, K2>> | string
    >(
      skin$name: K,
      value: "There was Conditional Type, use $Call utility type"
    ): convict$Config<T>;
    set<
      ...
      K2: $Keys<$ElementType<T, K>>,
      K3: $Keys<$ElementType<$ElementType<T, K>, K2>>,
      K4: $Keys<$ElementType<$ElementType<$ElementType<T, K>, K2>, K3>> | string
    >(
      skin$name: K,
      value: "There was Conditional Type, use $Call utility type"
    ): convict$Config<T>;
     ...
     */
    scriptLoader$load<U>(conf: U): convict$Config<convict$Overwrite<T, U>>;
    ...
    loadFile<U>(
      files: string | string[]
    ): convict$Config<convict$Overwrite<T, U>>;

    /**
     * Validates config against the schema used to initialize it
     */
    validate(notification$options?: convict$ValidateOptions): convict$Config<T>;
  ...
  declare interface convict {
    ...
    addFormats(formats: {
      [skin$name: string]: convict$convict$Format
    }): void;
    addParser(parsers: convict$convict$Parser | convict$convict$Parser[]): void;
    <T>(
      CKEDITOR$config: convict$convict$Schema<T> | string
    ): convict$convict$Config<T>;
  }
