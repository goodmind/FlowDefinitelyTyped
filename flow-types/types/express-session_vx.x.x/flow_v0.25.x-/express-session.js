...
declare interface session$BaseMemoryStore {
  get: (
    sid: string,
    callback: (err: any, session?: Express$Express$SessionData | null) => void
  ) => void;
  set: (
    sid: string,
...
declare class session$Store mixins node.EventEmitter {
  ...
  load: (
    sid: string,
    fn: (err: any, session?: Express$Express$SessionData | null) => any
  ) => void;
  createSession: (
    req: express.Express$Request,
    sess: Express$Express$SessionData
  ) => void;
  get: (
    sid: string,
    callback: (err: any, session?: Express$Express$SessionData | null) => void
...
declare module "express-session" {
  declare function session(
    options?: session$session$SessionOptions
