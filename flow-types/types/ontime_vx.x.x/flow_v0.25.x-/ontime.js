declare module "ontime" {
  declare export interface OntimeSchedule {
    /**
  ...
  declare export interface OntimeReport {
    /**
  ...
  declare export type OntimeJob = (ot: OntimeReport) => void;
  declare export function ontime(sched: OntimeSchedule, job: OntimeJob): void;
}
