declare module "gl-react" {
  ...
  declare export class Surface<T>
    mixins React.Component<SurfaceProps, SurfaceState> {
    id: number;
  ...
  declare function Shaders$getShortName(
  ...
  declare function Uniform$backbufferFrom(
    node: Node | Bus
  ): {
    type: string,
    node: Node | Bus
  ...
  declare function Uniform$textureSize(
    obj: any
  ): {
    type: string,
    obj: any
  ...
  declare function Uniform$textureSizeRatio(
    obj: any
  ): {
    type: string,
    obj: any,
