declare module 'react-swipeable' {
	...
	declare class ReactSwipeable<T: Element> mixins React.Component<ReactSwipeable$ReactSwipeable$SwipeableProps<T>> {}
	declare type ReactSwipeable$OnSwipingCallback<T: Element> = (
...
declare type ReactSwipeable$OnSwipedCallback<T: Element> = (
event: React.TouchEvent<T>,
deltaX: number,
deltaY: number,
isFlick: boolean,
...
declare type ReactSwipeable$OnSwipedDirectionCallback<T: Element> = (event: React.TouchEvent<T>, delta: number, isFlick: boolean) => void;

declare type ReactSwipeable$OnSwipingDirectionCallback<T: Element> = (event: React.TouchEvent<T>, delta: number) => void;

declare type ReactSwipeable$OnTapCallback<T: Element> = (event: React.TouchEvent<T>) => void;

declare type ReactSwipeable$SwipeableProps<T: Element> = {
...
} & React.ClassAttributes<ReactSwipeable<T>> & React.HTMLAttributes<T>
