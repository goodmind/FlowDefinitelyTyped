...
constructor(context: string | CanvasRenderingContext2D | HTMLCanvasElement | ArrayLike<CanvasRenderingContext2D | HTMLCanvasElement>, options: Chart$Chart$ChartConfiguration): this;
...
register(
plugin: PluginServiceGlobalRegistration & PluginServiceRegistrationOptions): void;
unregister(
plugin: PluginServiceGlobalRegistration & PluginServiceRegistrationOptions): void
}
...
resize(chartInstance: Chart, newChartSize: Chart$Chart$ChartSize, options?: any): void,
...
head: number
	...
	declare type Chart$ChartType = "line"
| "bar"
| "horizontalBar"
| "radar"
| "doughnut"
...
declare type Chart$TimeUnit = "millisecond"
| "second"
| "minute"
| "hour"
| "day"
...
declare type Chart$ScaleType = "category"
| "linear"
| "logarithmic"
| "time"
| "radialLinear";

declare type Chart$PointStyle = "circle"
| "cross"
| "crossRot"
| "dash"
| "line"
...
declare type Chart$InteractionMode = "point"
| "nearest"
| "single"
| "label"
| "index"
...
beforeLabel(tooltipItem: Chart$ChartTooltipItem, data: Chart$ChartData): string | string[],
label(tooltipItem: Chart$ChartTooltipItem, data: Chart$ChartData): string | string[],
labelColor(
tooltipItem: Chart$ChartTooltipItem,
chart: Chart): Chart$ChartTooltipLabelColor,
labelTextColor(tooltipItem: Chart$ChartTooltipItem, chart: Chart): string,
afterLabel(tooltipItem: Chart$ChartTooltipItem, data: Chart$ChartData): string | string[],
afterBody(item: Chart$ChartTooltipItem[], data: Chart$ChartData): string | string[],
beforeFooter(item: Chart$ChartTooltipItem[], data: Chart$ChartData): string | string[],
footer(item: Chart$ChartTooltipItem[], data: Chart$ChartData): string | string[],
afterFooter(item: Chart$ChartTooltipItem[], data: Chart$ChartData): string | string[]
} 
...
onHover(event: MouseEvent, legendItem: Chart$ChartLegendLabelItem): void,
...
filter(legendItem: Chart$ChartLegendLabelItem, data: Chart$ChartData): any,
...
declare type Chart$ChartTooltipPositioner = (elements: any[], eventPosition: Chart$Point) => Chart$Point;
...
declare type Chart$ChartColor = string | CanvasGradient | CanvasPattern | string[];
...
pointStyle?: Chart$PointStyle | HTMLImageElement | HTMLCanvasElement | Array<Chart$PointStyle | HTMLImageElement | HTMLCanvasElement>,
xAxisID?: string,
yAxisID?: string,
type?: Chart$ChartType | string,
hidden?: boolean,
