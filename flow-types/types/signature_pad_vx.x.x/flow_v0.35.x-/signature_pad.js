 ...
 */
fromData: (pointGroups: Array<Array<SignaturePad$SignaturePad$Point>>) => void;
...
_addPoint: (
point: SignaturePad$SignaturePad$Point) => SignaturePad$SignaturePad$Bezier | null;
...
_toSVG: () => string;
constructor(canvas: HTMLCanvasElement, options?: SignaturePad$SignaturePad$SignaturePadOptions): this
}
