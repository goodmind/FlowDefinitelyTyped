declare module "ethereumjs-util" {
  ...
  declare export function baToJSON(
  ...
  declare export function fromRpcSig(
    sig: string
  ): {
    [k: string]: any
  };
  ...
  declare export function generateAddress(
    from: Buffer | Uint8Array,
    nonce: Buffer | Uint8Array
  ): Buffer | Uint8Array;

  declare export function hashPersonalMessage(
    message: Buffer | Uint8Array | any[]
  ): Buffer | Uint8Array;

  declare export function importPublic(
  ...
  declare export function isValidChecksumAddress(
    address: Buffer | Uint8Array
  ): boolean;

  declare export function isValidPrivate(
    privateKey: Buffer | Uint8Array
  ): boolean;

  declare export function isValidPublic(
    publicKey: Buffer | Uint8Array,
    sanitize?: boolean
  ): any;
  ...
  declare export function keccak256(
    a: Buffer | Uint8Array | any[] | string | number
  ): Buffer | Uint8Array;

  declare export function privateToAddress(
    privateKey: Buffer | Uint8Array
  ): Buffer | Uint8Array;

  declare export function privateToPublic(
    privateKey: Buffer | Uint8Array
  ): Buffer | Uint8Array;

  declare export function pubToAddress(
  ...
  declare export function rlphash(
    a: Buffer | Uint8Array | any[] | string | number
  ): Buffer | Uint8Array;
  ...
  declare export function setLengthRight(
    msg: Buffer | Uint8Array | any[],
    length: number
  ): Buffer | Uint8Array | any[];
  ...
  declare export function toRpcSig(
    v: number,
    r: Buffer | Uint8Array,
    s: Buffer | Uint8Array
  ): string;
  ...
  declare export function unpad<T: Buffer | Uint8Array | any[] | string>(
    a: T
  ): T;
