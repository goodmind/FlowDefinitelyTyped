declare module 'falcor' {
        import type {
          Path,PathSet,PathValue,JSONEnvelope,JSONGraph,JSONGraphEnvelope
        } from 'falcor-json-graph';

	declare export {
          HttpDataSource
        }from 'falcor-http-datasource';

	declare export {
          Atom,Error,Key,KeySet,Path,PathSet,PathValue,JSONEnvelope,JSONGraph,JSONGraphEnvelope,Range,Reference,ref,atom,error,pathValue
        }from 'falcor-json-graph';
...
args?: any[],
refSuffixes?: PathSet[],
thisPaths?: PathSet[]): Observable<JSONGraphEnvelope>
}
	declare export interface ModelOptions {
source?: DataSource,
cache?: JSONGraph,
maxSize?: number,
collectRatio?: number,
 ...
 */
declare export type ModelOnChange = () => void;
	
/**
 * This function is invoked on every JSONGraph Error retrieved from the DataSource. This function allows Error objects to be transformed before being stored in the Model's cache.
 */
declare export type ModelErrorSelector = (jsonGraphError: any) => any;
 ...
 */
declare export type ModelComparator = (existingValue: any, newValue: any) => boolean;
...
args?: any[],
refPaths?: PathSet,
thisPaths?: PathSet[]): ModelResponse<JSONEnvelope<any>>;
call<T>(
functionPath: string | Path,
args?: any[],
refPaths?: PathSet,
thisPaths?: PathSet[]): ModelResponse<JSONEnvelope<T>>;
...
getPath(): Path
	...
	declare export class ModelResponse<T> mixins Observable<T> {
...
onRejected?: (error: any) => void): Thenable<any>;
then<U>(
...
then<U>(
onFulfilled?: (value: T) => U | Thenable<U>,
onRejected?: (error: any) => U | Thenable<U> | void): Thenable<U>
} 
...
onCompleted?: ObservableOnCompletedCallback): Subscription;
 ...
 */
declare export type ObservableOnNextCallback<T> = (value: T) => void;
 ...
 */
declare export type ObservableOnErrorCallback = (error: Error) => void;
 ...
 */
declare export type ObservableOnCompletedCallback = () => void;
