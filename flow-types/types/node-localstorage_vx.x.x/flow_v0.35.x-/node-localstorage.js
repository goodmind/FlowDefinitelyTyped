 ...
 * (MIT License)
 */
declare export class LocalStorage mixins EventEmitter {
 ...
 */
constructor(location: string, quota?: number): this
}
	declare export class JSONStorage mixins LocalStorage {
 ...
 */
declare export class StorageEvent  {
 ...
 */
constructor(key: string, oldValue: string, newValue: string, url: string, storageArea: string): this
}
	
/**
 * Provides a specific `Error` object for **Quota Exceeded Errors**.
 */
declare export class QUOTA_EXCEEDED_ERR mixins Error {
