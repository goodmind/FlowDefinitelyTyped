 ...
 */
declare function client$load(name: "deploymentmanager", version: "v2"): PromiseLike<void>


declare function client$load(name: "deploymentmanager", version: "v2", callback: () => any): void
