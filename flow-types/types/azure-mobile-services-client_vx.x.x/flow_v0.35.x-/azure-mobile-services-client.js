...
applicationKey?: string): WindowsAzure$MobileServiceClient,
applicationUrl: string,
...
provider: string,
token: string,
callback: (error: any, user: WindowsAzure$User) => void): void,
...
callback: (error: any, response: any) => void) => void): WindowsAzure$MobileServiceClient,
...
callback?: (error: any, results: any) => void): WindowsAzure$asyncPromise
} 
...
onError?: (error: any) => any): WindowsAzure$asyncPromise,
...
new (
tableName: string,
client: WindowsAzure$MobileServiceClient): WindowsAzure$MobileServiceTable,
getTableName(): string,
...
read(query: WindowsAzure$IQuery, paramsQS: Object): WindowsAzure$asyncPromise,
...
...qValues: any[]): WindowsAzure$IQuery,
