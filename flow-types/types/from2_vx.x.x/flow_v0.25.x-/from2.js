declare module "from2" {
  ...
  declare function from2$ctor(
    opts?: from2$Options
  ): from2$From2Ctor<from2$ReadInput>;

  declare function from2$ctor(
    opts: from2$ObjectModeOptions
  ): from2$From2Ctor<from2$ReadObjectInput>;
  ...
  declare type from2$From2Ctor<R: from2$ReadInput | from2$ReadObjectInput> = (
    read: R
  ) => NodeJS.ReadableStream;

  declare type from2$ReadObjectInput =
    | from2$ReadCallback<from2$NextObjectCallback>
    | any[];

  declare type from2$ReadInput =
    | from2$ReadCallback<from2$NextCallback>
    | from2$Chunk[];

  declare type from2$ReadCallback<
    N: from2$NextCallback | from2$NextObjectCallback
  > = (size: number, next: N) => void;

  declare type from2$NextCallback = (
    err: any | void,
    chunk: from2$Chunk
  ) => void;
