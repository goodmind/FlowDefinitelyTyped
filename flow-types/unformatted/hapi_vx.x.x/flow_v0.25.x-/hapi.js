declare module 'hapi' {
	...
	import type {
          SealOptions,SealOptionsSub
        } from 'iron';

	import type {
          ValidationOptions,SchemaMap,Schema
        } from 'joi';

	import type {
          PolicyOptionVariants,EnginePrototypeOrObject,PolicyOptions,EnginePrototype,Policy,ClientApi,ClientOptions
        } from 'catbox';
 ...
 *   plugin version.
 */
declare export type Dependencies = string | string[] | {
[key: string]: string
};
 ...
 */
declare export interface PluginsListRegistered {} 
 ...
 * [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-serverregistrations)
 */
declare export interface PluginRegistered {
...
options: {[key: string]: any}
	...
	declare export interface PluginNameVersion {
 ...
 */
declare export interface PluginBase<T> {
...
once?: boolean
	...
	declare export type Plugin<T> = PluginBase<T> & (PluginNameVersion | PluginPackage);
 ...
 */
declare export interface AppCredentials {} 
	
/**
 * User-extensible type for request.auth credentials.
 */
declare export interface AuthCredentials {
 ...
 */
declare export interface RequestAuth {
 ...
 */
declare export type RequestEventType = "peek" | "finish" | "disconnect";
 ...
 */
declare export type RequestEvents = {
 ...
 */
declare export interface RequestRoute {
 ...
 */
+payload: stream.Readable | Buffer | string | {[key: string]: any},
 ...
 */
+state: Util$Util$Dictionary<any>,
...
log(
tags: string | string[],
data?: string | {[key: string]: any} | (() => string | {[key: string]: any})): void,
...
name: string,
value: string,
options?: ResponseObjectHeaderOptions): ResponseObject,
...
options?: ServerStateCookieOptions): ResponseObject,
 ...
 * [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-responsesettings)
 */
declare export interface ResponseSettings {
 ...
 */
+stringify: Json$Json$StringifyArguments,
 ...
 */
declare export type ResponseValue = string | {[key: string]: any};
	declare export interface AuthenticationData {
credentials: AuthCredentials,
artifacts?: {[key: string]: any}
} 
 ...
 */
declare export interface ResponseToolkit {
...
options?: ServerStateCookieOptions): void,
...
unstate(name: string, options?: ServerStateCookieOptions): void
	...
	declare export interface RouteOptionsAccessScopeObject {
scope: RouteOptionsAccessScope
} 
	declare export interface RouteOptionsAccessEntityObject {
entity: RouteOptionsAccessEntity
} 
	declare export type RouteOptionsAccessObject = RouteOptionsAccessScopeObject | RouteOptionsAccessEntityObject | (RouteOptionsAccessScopeObject & RouteOptionsAccessEntityObject);
	
/**
 * Route Authentication Options
 */
declare export interface RouteOptionsAccess {
 ...
 */
declare export type RouteOptionsCache = {
 ...
 */
declare export interface RouteOptionsCors {
 ...
 */
declare export type PayloadOutput = "data" | "stream" | "file";
	
/**
 * [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-routeoptionspayloadcompression)
 */
declare export type PayloadCompressionDecoderSettings = {[key: string]: any};
 ...
 */
declare export interface RouteOptionsPayload {
 ...
 */
declare export type RouteOptionsPreArray = RouteOptionsPreAllOptions[];
	
/**
 * For context [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-routeoptionspre)
 */
declare export type RouteOptionsPreAllOptions = RouteOptionsPreObject | RouteOptionsPreObject[] | Lifecycle$Lifecycle$Method;
 ...
 * For context [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-routeoptionspre)
 */
declare export interface RouteOptionsPreObject {
 ...
 * * * options - options.
 */
declare export type RouteOptionsResponseSchema = boolean | ValidationObject | Schema | ((
value: {[key: string]: any} | Buffer | string,
options: ValidationOptions) => Promise<any>);
	
/**
 * Processing rules for the outgoing response.
 * [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-routeoptionsresponse)
 */
declare export interface RouteOptionsResponse {
 ...
 */
status?: Util$Util$Dictionary<RouteOptionsResponseSchema>,
 ...
 */
declare export type ReferrerPolicy = ""
| "no-referrer"
 ...
 */
declare export interface RouteOptionsSecureObject {
...
referrer?: false | ReferrerPolicy
	...
	declare export type RouteOptionsSecure = boolean | RouteOptionsSecureObject;
 ...
 */
declare export interface RouteOptionsValidate {
 ...
 */
declare export type RouteCompressionEncoderSettings = {[key: string]: any};
	
/**
 * Empty interface to allow for user-defined augmentations.
 */
declare export interface RouteOptionsApp {} 
 ...
 */
declare export interface RouteOptions {
 ...
 */
ext?: $ObjMapi<{[k: RouteRequestExtType]: any}, <key>(key) => RouteExtObject | RouteExtObject[]>,
 ...
 */
handler?: Lifecycle$Lifecycle$Method | {[key: string]: any},
 ...
 */
json?: Json$Json$StringifyArguments,
 ...
 */
declare export type ServerAuthSchemeOptions = {[key: string]: any};
 ...
 */
declare export type ServerAuthScheme = (server: Server, options?: ServerAuthSchemeOptions) => ServerAuthSchemeObject;
 ...
 */
declare export interface ServerAuthSchemeObject {
 ...
 */
authenticate(request: Request, h: ResponseToolkit): Lifecycle$Lifecycle$ReturnValue,
 ...
 * @return the Lifecycle.ReturnValue
 */
payload?: (request: Request, h: ResponseToolkit) => Lifecycle$Lifecycle$ReturnValue,
 ...
 * @return the Lifecycle.ReturnValue
 */
response?: (request: Request, h: ResponseToolkit) => Lifecycle$Lifecycle$ReturnValue,
 ...
 */
declare export type ServerAuthConfig = {} & RouteOptionsAccess

	declare export interface ServerAuth {
 ...
 */
strategy(name: string, scheme: string, options?: {[key: string]: any}): void,
...
[See docs](https://github.com/hapijs/hapi/blob/master/API.md#-servercacheoptions)
 */
<T, O: CachePolicyOptions<T>= CachePolicyOptions<T>>(options: O): Policy<T, O>,
 ...
 */
declare export type ServerEventsApplication = string | ServerEventsApplicationObject | Podium;
	
/**
 * Object that it will be used in Event
 * [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-servereventevents)
 */
declare export interface ServerEventsApplicationObject {
 ...
 */
declare export interface ServerEventCriteria<T> {
...
error: {[key: string]: any}
	...
	declare export type LogEventHandler = (event: LogEvent, tags: {
[key: string]: true
}) => void;
	declare export type RequestEventHandler = (request: Request, event: RequestEvent, tags: {
[key: string]: true
}) => void;
 ...
 */
declare export type ServerExtType = "onPreStart" | "onPostStart" | "onPreStop" | "onPostStop";
	declare export type RouteRequestExtType = "onPreAuth"
| "onCredentials"
| "onPostAuth"
| "onPreHandler"
| "onPostHandler"
 ...
 */
declare export interface ServerExtOptions {
 ...
 */
declare export type ServerInjectOptions = {
 ...
 * For context [Shot module](https://github.com/hapijs/shot)
 */
declare export type ServerInjectResponse = {
 ...
 */
declare export type ServerMethod = (...args: any[]) => any;
 ...
 */
declare export type ServerMethodCache = {
 ...
 */
declare export interface ServerMethodOptions {
 ...
 */
declare export interface ServerMethodConfigurationObject {
...
options?: ServerMethodOptions
	...
	declare export type CacheProvider<T: ClientOptions= ClientOptions> = EnginePrototype<any> | {
 ...
 */
declare export type ServerOptionsCache = {
...
[s: string]: any
	...
	declare export interface ServerOptionsCompression {
minBytes: number
} 
 ...
 */
declare export interface ServerOptionsApp {} 
 ...
 */
parser(raw: Util$Util$Dictionary<string>): Util$Util$Dictionary<any>
}
} 
 ...
 */
declare export interface ServerRealm {
 ...
 */
declare export interface ServerRegisterOptions {
 ...
 */
declare export type ServerRegisterPluginObject<T> = {
...
} & Array<ServerRegisterPluginObject<T>
...
| void>
	...
	declare export interface HandlerDecorations {} 
 ...
 */
declare export interface ServerRoute {
 ...
 * result as adding the same route with different methods manually.
 */
method: Util$Util$HTTP_METHODS_PARTIAL | Util$Util$HTTP_METHODS_PARTIAL[] | string | string[],
 ...
 */
handler?: Lifecycle$Lifecycle$Method | HandlerDecorations,
 ...
 */
declare export interface ServerStateCookieOptions {
 ...
 */
declare export interface ServerState {
 ...
 */
+settings: ServerStateCookieOptions,
 ...
 */
parse(header: string): Promise<Util$Util$Dictionary<string>>
} 
...
(route: RouteOptions, options: any): Lifecycle$Lifecycle$Method,
 ...
 */
declare export type DecorationMethod<T> = (...args: any[]) => any;
	
/**
 * An empty interface to allow typings of custom plugin properties.
 */
declare export interface PluginProperties {} 
	declare export type DecorateName = string | Symbol;
 ...
 * [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-serverregistrations)
 */
registrations: PluginsListRegistered;
...
decoder(
encoding: string,
decoder: ((options: PayloadCompressionDecoderSettings) => zlib.Gunzip)): void;
...
property: DecorateName,
method: (
existing: ((...args: any[]) => any)) => (request: Request) => DecorationMethod<Request>,
options: {
apply: true,
extend: true
}): void;
...
encoder(
encoding: string,
encoder: ((options: RouteCompressionEncoderSettings) => zlib.Gzip)): void;
 ...
 */
ext(
events: ServerExtEventsObject | ServerExtEventsObject[] | ServerExtEventsRequestObject | ServerExtEventsRequestObject[]): void;
 ...
 */
method(
methods: ServerMethodConfigurationObject | ServerMethodConfigurationObject[]): void;
...
options?: ServerRegisterOptions): Promise<void>;
 ...
 */
declare export interface ApplicationState {} 
	declare export type PeekListener = (chunk: string, encoding: string) => void;
 ...
 */
declare type Lifecycle$Method = (request: Request, h: ResponseToolkit, err?: Error) => Lifecycle$ReturnValue;
 ...
 */
declare type Lifecycle$ReturnValue = Lifecycle$ReturnValueTypes | (Promise<Lifecycle$ReturnValueTypes>);

declare type Lifecycle$ReturnValueTypes = (null | string | number | boolean)
| (Buffer)
| (Error | Boom)
| (stream.Stream)
 ...
 */
declare type Lifecycle$FailAction = "error" | "log" | "ignore" | Lifecycle$Method;
	declare interface Util$Dictionary<T> {
[key: string]: T
} 

declare type Util$HTTP_METHODS_PARTIAL_LOWERCASE = "get"
| "post"
| "put"
| "patch"
| "delete"
...
declare type Util$HTTP_METHODS_PARTIAL = "GET"
| "POST"
| "PUT"
| "PATCH"
| "DELETE"
| "OPTIONS"
| Util$HTTP_METHODS_PARTIAL_LOWERCASE;

declare type Util$HTTP_METHODS = "HEAD" | "head" | Util$HTTP_METHODS_PARTIAL;
    }
