declare module 'bootstrap.v3.datetimepicker' {
	...
	declare export type InputParser = (input: string | Date | moment.Moment) => moment.Moment;
 ...
 */
parseInputDate(): InputParser | void,
...
defaults: DatetimepickerOptions
	...
	declare export interface DatetimepickerOptions {
...
decrementSecond?: string
	...
	declare export interface WidgetPositioningOptions {
...
oldDate: moment.Moment | boolean
	...
	declare export type UpdateEvent = {
...
viewDate: moment.Moment
	...
	declare export type EventName = "dp.show" | "dp.hide" | "dp.error";
...
events: "dp.change",
selector: string,
handler: (eventobject: ChangeEvent) => any): JQuery,
on(
events: "dp.change",
selector: string,
data: any,
...
events: "dp.update",
selector: string,
handler: (eventobject: UpdateEvent) => any): JQuery,
on(
events: "dp.update",
selector: string,
data: any,
...
events: EventName,
selector: string,
handler: (eventobject: Event) => any): JQuery,
on(
events: EventName,
selector: string,
data: any,
