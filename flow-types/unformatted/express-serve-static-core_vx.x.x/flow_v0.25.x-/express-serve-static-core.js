...
declare interface Express$Application {} 
    }
	...
	import type {
          Options as RangeParserOptions,Result as RangeParserResult,Ranges as RangeParserRanges
        } from 'range-parser';

	declare export interface NextFunction {
(err?: any): void
} 
	declare export interface RequestHandler {
(req: Express$Request, res: Express$Response, next: NextFunction): any
} 
	declare export type ErrorRequestHandler = (
err: any,
req: Express$Request,
res: Express$Response,
next: NextFunction) => any;
	declare export type PathParams = string | RegExp | Array<string | RegExp>;
	declare export type RequestHandlerParams = RequestHandler | ErrorRequestHandler | Array<RequestHandler | ErrorRequestHandler>;
	declare export interface IRouterMatcher<T> {
(path: PathParams, ...handlers: RequestHandler[]): T,
(path: PathParams, ...handlers: RequestHandlerParams[]): T,
(path: PathParams, subApplication: Express$Application): T
} 
	declare export interface IRouterHandler<T> {
(...handlers: RequestHandler[]): T,
(...handlers: RequestHandlerParams[]): T
} 
	declare export type IRouter = {
...
start: number,
	...
	declare export type RequestRanges = {} & RangeParserRanges

	declare export type Errback = (err: Error) => void;
 ...
 */
get(name: "set-cookie"): string[] | void,
get(name: string): string | void,
header(name: "set-cookie"): string[] | void,
...
range(
size: number,
options?: RangeParserOptions): RangeParserRanges | RangeParserResult | void,
...
res?: Express$Response,
next?: NextFunction
} & http.IncomingMessage & Express$Express$Request
...
subtype: string
	...
	declare export type Send = (body?: any) => Express$Response;
 ...
 */
req?: Express$Request
} & http.ServerResponse & Express$Express$Response

	declare export type Handler = {} & RequestHandler

	declare export type RequestParamHandler = (
req: Express$Request,
res: Express$Response,
next: NextFunction,
value: any,
name: string) => any;
	declare export type ApplicationRequestHandler<T> = IRouterHandler<T> & IRouterMatcher<T> & ((...handlers: RequestHandlerParams[]) => T);
 ...
 * third argument.
 */
(req: Express$Request | http.IncomingMessage, res: Express$Response | http.ServerResponse): any,
 ...
 *       }
 */
configure(fn: Function): Express$Application,
configure(env0: string, fn: Function): Express$Application,
configure(env0: string, env1: string, fn: Function): Express$Application,
configure(env0: string, env1: string, env2: string, fn: Function): Express$Application,
configure(
env0: string,
env1: string,
env2: string,
env3: string,
fn: Function): Express$Application,
configure(
env0: string,
env1: string,
env2: string,
 ...
 */
on: (event: string, callback: (parent: Express$Application) => void) => this,

/**
 * The app.mountpath property contains one or more path patterns on which a sub-app was mounted.
 */
mountpath: string | string[]
} & EventEmitter & IRouter & Express$Express$Application

	declare export type Express = {
