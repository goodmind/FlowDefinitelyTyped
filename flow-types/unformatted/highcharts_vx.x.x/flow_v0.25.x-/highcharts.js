declare module 'highcharts' {
        declare interface Highcharts$Position {
align?: string,
...
declare interface Highcharts$DateTimeFormats {
...
declare type Highcharts$AxisEvent = {
min: number,
max: number
} & Event


declare interface Highcharts$AxisLabelFormatterOptions {
value: any,
isFirst: number,
isLast: number,
chart: Highcharts$ChartObject,
axis: Highcharts$AxisObject
} 

declare interface Highcharts$AxisLabels {
...
declare interface Highcharts$MousePlotEvents {
 ...
 */
declare interface Highcharts$PlotLabel {
...
declare interface Highcharts$PlotBands {
 ...
 * @default null
 */
borderColor?: Highcharts$Color | null,
 ...
 * @since 1.2
 */
events?: Highcharts$MousePlotEvents,
 ...
 * on one of the axes.
 */
declare interface Highcharts$PlotLines {
...
declare interface Highcharts$AnnotationsPoint {
...
declare interface Highcharts$AnnotationsLabelOptions {
...
declare type Highcharts$AnnotationsLabel = {
 ...
 * @since 6.0.0
 */
point?: string | Highcharts$AnnotationsPoint
} & Highcharts$AnnotationsLabelOptions


declare interface Highcharts$AnnotationsShapeOptions {
...
declare type Highcharts$AnnotationsShape = {
 ...
 * @since 6.0.0
 */
points?: Array<string | Highcharts$AnnotationsPoint>
} & Highcharts$AnnotationsShapeOptions
 ...
 */
declare interface Highcharts$AnnotationsOptions {
 ...
 */
declare interface Highcharts$AccessibilityOptions {
 ...
 * @since 5.0.0
 */
declare interface Highcharts$KeyboardNavigationOptions {
...
declare interface Highcharts$AnimationOptions {
...
declare interface Highcharts$AxisTitle {
...
declare interface Highcharts$AxisBreak {
...
declare interface Highcharts$AxisOptions {
 ...
 */
crosshair?: Highcharts$CrosshairObject | boolean,
 ...
 */
dateTimeLabelFormats?: Highcharts$DateTimeFormats,
 ...
 * @since 2.3
 */
afterSetExtremes?: (event: Highcharts$AxisEvent) => void,
 ...
 * @since 1.2.0
 */
setExtremes?: (event: Highcharts$AxisEvent) => void
},
 ...
 */
plotBands?: Highcharts$PlotBands[],

/**
 * An array of lines stretching across the plot area, marking a specific value on one of the axes.
 */
plotLines?: Highcharts$PlotLines[],
 ...
 */
title?: Highcharts$AxisTitle | null,
...
declare interface Highcharts$ColorAxisDataClass {
from?: number,
to?: number,
color?: string | Highcharts$Gradient,
name?: string
 ...
 */
declare interface Highcharts$ColorAxisOptions {
 ...
 */
dataClasses?: Highcharts$ColorAxisDataClass[],
 ...
 * @default {duration: 50}
 */
animation?: boolean | Highcharts$Animation,
...
declare interface Highcharts$Extremes {
...
declare interface Highcharts$Animation {
...
declare type Highcharts$AddSeriesEvent = {
...
declare type Highcharts$AxisValueOptions = {
...
declare type Highcharts$ChartClickEvent = {

/**
 * Array containing the axes of each dimension and each axis' value at the clicked spot
 */
xAxis: Highcharts$AxisValueOptions[],

/**
 * Array containing the axes of each dimension and each axis' value at the clicked spot
 */
yAxis: Highcharts$AxisValueOptions[]
} & Event


declare type Highcharts$ChartDrilldownEvent = {
 ...
 */
point?: Highcharts$PointObject,

/**
 * If a category label was clicked, this array holds all points corresponing to the category.
 */
points?: Highcharts$PointObject[],

/**
 * Options for the new series.
 */
seriesOptions?: Highcharts$IndividualSeriesOptions
} & Event


declare type Highcharts$ChartSelectionEvent = {
...
declare interface Highcharts$ChartEvents {
 ...
 * @since 1.2.0
 */
addSeries?: (event: Highcharts$AddSeriesEvent) => boolean | void,
 ...
 * @since 1.2.0
 */
click?: (event: Highcharts$ChartClickEvent) => void,

/**
 * Fires when a drilldown point is clicked, before the new series is added.
 * @since 3.0.8
 */
drilldown?: (event: Highcharts$ChartDrilldownEvent) => void,
 ...
 * }
 */
selection?: (event: Highcharts$ChartSelectionEvent) => void
} 

declare interface Highcharts$LinearGradient {
x1: number,
y1: number,
x2: number,
y2: number
...
declare interface Highcharts$Gradient {
linearGradient?: Highcharts$LinearGradient | number[],
radialGradient?: {
cx: number,
cy: number,
r: number
 ...
 * Brighten the color
 */
brighten?: (alpha: number) => Highcharts$Gradient,
 ...
 */
setOpacity?: (alpha: number) => Highcharts$Gradient
} 
 ...
 */
declare type Highcharts$Color = string | Highcharts$Gradient;

declare interface Highcharts$ChartOptions3dFrame {
...
declare interface Highcharts$ChartOptions3d {
...
declare interface Highcharts$Shadow {
...
declare interface Highcharts$ChartResetZoomButton {
 ...
 * @since 2.2
 */
theme?: Highcharts$ButtonStatesTheme
} 

declare interface Highcharts$ButtonTheme {
display?: string,

/**
 * The button fill color, SVG color definition
 */
fill?: string | Highcharts$Gradient,
...
declare type Highcharts$ButtonStatesTheme = {
 ...
 */
hover?: Highcharts$ButtonTheme,

/**
 * Attributes and styles applied when button is selected (tri-state).
 */
select?: Highcharts$ButtonTheme
}
} & Highcharts$ButtonTheme


declare interface Highcharts$ChartOptions {
 ...
 */
plotBackgroundColor?: string | Highcharts$Gradient,
 ...
 * @default false
 */
plotShadow?: boolean | Highcharts$Shadow,
 ...
 */
scrollablePlotArea?: Highcharts$ScrollablePropArea,
 ...
 * @default false
 */
shadow?: boolean | Highcharts$Shadow,
...
declare interface Highcharts$CSSObject {
background?: string,
border?: string,
color?: string | Highcharts$Gradient,
cursor?: string,
...
declare interface Highcharts$CreditsOptions {
...
declare type Highcharts$CreditsObject = {
update(options: Highcharts$CreditsOptions): void
} & Highcharts$CreditsOptions


declare interface Highcharts$DataSeriesMapping {
 ...
 * series.data option.
 */
declare interface Highcharts$DataOptions {
 ...
 * @since 4.0
 */
complete?: (options: Highcharts$Options) => void,
 ...
 * @since 4.0.4
 */
seriesMapping?: Highcharts$DataSeriesMapping[],
 ...
 */
declare interface Highcharts$DrilldownOptions {
...
declare interface Highcharts$MenuItem {
...
declare interface Highcharts$Button {
...
declare type Highcharts$ExportingContextButton = {
 ...
 * @since 2.0
 */
menuItems?: string[] | Highcharts$MenuItem[],
...
declare interface Highcharts$ExportingOptions {
 ...
 */
buttons?: {
contextButton?: Highcharts$ExportingContextButton
},
 ...
 */
declare interface Highcharts$GlobalObject {
...
declare interface Highcharts$LabelItem {
html: string,
style: Highcharts$CSSObject
} 

declare interface Highcharts$LabelsOptions {
items?: Highcharts$LabelItem[],
style?: Highcharts$CSSObject
} 

declare interface Highcharts$LangObject {
...
declare interface Highcharts$LegendNavigationOptions {
...
declare interface Highcharts$LegendTitleOptions {
...
declare interface Highcharts$LegendOptions {
 ...
 */
navigation?: Highcharts$LegendNavigationOptions,
 ...
 * @since 3.0
 */
title?: Highcharts$LegendTitleOptions,
 ...
 */
declare interface Highcharts$LoadingOptions {
 ...
 */
declare interface Highcharts$NavigationOptions {

/**
 * A collection of options for buttons appearing in the exporting module.
 */
buttonOptions?: Highcharts$Button,
 ...
 */
declare interface Highcharts$NoDataOptions {
...
declare interface Highcharts$PaneBackground {
 ...
 */
declare interface Highcharts$PaneOptions {
 ...
 * @since 2.3.0
 */
background?: Highcharts$PaneBackground | Highcharts$PaneBackground[],
 ...
 * @since 5.0.0
 */
declare interface Highcharts$ResponsiveOptions {
 ...
 * A set of rules for responsive settings. The rules are executed from the top down.
 */
declare interface Highcharts$RulesOptions {
...
declare type Highcharts$TitleObject = {

/**
 * Update method that points back to Chart.setTitle.
 * @since 5.0.0
 */
update(options: Highcharts$TitleOptions): void
} & Highcharts$TitleOptions


declare interface Highcharts$ScrollablePropArea {
minWidth?: number,
 ...
 * Under which conditions the rule applies.
 */
declare interface Highcharts$ConditionOptions {
...
declare interface Highcharts$DataLabels {
 ...
 * @default null
 */
color?: string | Highcharts$Gradient | null,
...
declare type Highcharts$PieDataLabels = {
...
declare type Highcharts$AreaCheckboxEvent = {
 ...
 * The checked item
 */
item: Highcharts$SeriesObject | Highcharts$PointObject
} & Event


declare type Highcharts$AreaClickEvent = {
...
declare interface Highcharts$PlotEvents {
 ...
 * @since 1.2.0
 */
checkboxClick?: (event: Highcharts$AreaCheckboxEvent) => boolean | void,
 ...
 * The this keyword refers to the Series object.
 */
click?: (event: Highcharts$AreaClickEvent) => void,
...
declare interface Highcharts$MarkerState {
 ...
 */
lineColor?: string | Highcharts$Gradient | null,
...
declare type Highcharts$MarkerHoverState = {
...
declare type Highcharts$Marker = {
...
declare interface Highcharts$PointEvents {
...
declare interface Highcharts$Halo {
...
declare interface Highcharts$LineStates {
...
declare interface Highcharts$BarStates {
...
declare type Highcharts$PieStates = {} & Highcharts$BarStates & Highcharts$LineStates


declare interface Highcharts$AreaZone {
...
declare interface Highcharts$RangeDataLabels {
...
declare interface Highcharts$Dial {
...
declare interface Highcharts$Pivot {
 ...
 */
declare interface Highcharts$TreeMapLevel {
 ...
 */
declare interface Highcharts$SeriesChart {
 ...
 * @since 2.3
 */
tooltip?: Highcharts$SeriesTooltipOptions,
 ...
 */
zones?: Highcharts$AreaZone[]
} 

declare type Highcharts$AreaChart = {

/**
 * Fill color or gradient for the area. When null, the series' color is used with the series' fillOpacity.
 */
fillColor?: string | Highcharts$Gradient | null,
 ...
 */
trackByArea?: boolean
} & Highcharts$SeriesChart


declare type Highcharts$AreaRangeChart = {
 ...
 * @since 2.3.0
 */
dataLabels?: Highcharts$RangeDataLabels
} & Highcharts$AreaChart


declare type Highcharts$AreaSplineChart = {} & Highcharts$AreaChart


declare type Highcharts$AreaSplineRangeChart = {} & Highcharts$AreaRangeChart


declare type Highcharts$BarChart = {
 ...
 * maximum).
 */
declare type Highcharts$BoxPlotChart = {
 ...
 * the Z value.
 */
declare type Highcharts$BubbleChart = {
...
declare type Highcharts$ColumnChart = {} & Highcharts$BarChart
 ...
 */
declare type Highcharts$ColumnRangeChart = {
dataLabels?: Highcharts$RangeDataLabels
 ...
 */
declare type Highcharts$ErrorBarChart = {
 ...
 */
declare type Highcharts$FunnelChart = {
 ...
 */
colors?: Highcharts$Color[],
dataLabels?: Highcharts$PieDataLabels,
 ...
 */
declare type Highcharts$GaugeChart = {
 ...
 */
declare type Highcharts$HeatMapChart = {
...
declare type Highcharts$LineChart = {
 ...
 */
declare type Highcharts$PieChart = {
 ...
 * @default '#FFFFFF'
 */
borderColor?: string | Highcharts$Gradient | null,
 ...
 * file.
 */
declare type Highcharts$PolygonChart = {
...
declare type Highcharts$PyramidChart = {
...
declare type Highcharts$ScatterChart = {
 ...
 * itself.
 */
declare type Highcharts$SolidGaugeChart = {
...
declare type Highcharts$SplineChart = {
 ...
 */
declare type Highcharts$TreeMapChart = {
 ...
 * Set options on specific levels. Takes precedence over series options, but not point options.
 */
levels?: Highcharts$TreeMapLevel[],
...
declare type Highcharts$WaterFallChart = {
 ...
 */
declare interface Highcharts$PlotOptions {
area?: Highcharts$AreaChart,
arearange?: Highcharts$AreaRangeChart,
areaspline?: Highcharts$AreaSplineChart,
areasplinerange?: Highcharts$AreaSplineRangeChart,
bar?: Highcharts$BarChart,
boxplot?: Highcharts$BoxPlotChart,
bubble?: Highcharts$BubbleChart,
column?: Highcharts$ColumnChart,
columnrange?: Highcharts$ColumnRangeChart,
errorbar?: Highcharts$ErrorBarChart,
funnel?: Highcharts$FunnelChart,
gauge?: Highcharts$GaugeChart,
heatmap?: Highcharts$HeatMapChart,
line?: Highcharts$LineChart,
pie?: Highcharts$PieChart,
polygon?: Highcharts$PolygonChart,
pyramid?: Highcharts$PyramidChart,
scatter?: Highcharts$ScatterChart,
series?: Highcharts$SeriesChart,
solidgauge?: Highcharts$SolidGaugeChart,
spline?: Highcharts$SplineChart,
treemap?: Highcharts$TreeMapChart,
waterfall?: Highcharts$WaterFallChart
} 

declare interface Highcharts$IndividualSeriesOptions {
size?: number | string,
innerSize?: number | string,
type?: string,
...
declare type Highcharts$SeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$SeriesChart


declare type Highcharts$AreaChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$AreaChart


declare type Highcharts$AreaRangeChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$AreaRangeChart


declare type Highcharts$AreaSplineChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$AreaSplineChart


declare type Highcharts$AreaSplineRangeChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$AreaSplineRangeChart


declare type Highcharts$BarChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$BarChart


declare type Highcharts$BoxPlotChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$BoxPlotChart


declare type Highcharts$BubbleChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$BubbleChart


declare type Highcharts$ColumnChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$ColumnChart


declare type Highcharts$ColumnRangeChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$ColumnRangeChart


declare type Highcharts$ErrorBarChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$ErrorBarChart


declare type Highcharts$FunnelChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$FunnelChart


declare type Highcharts$GaugeChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$GaugeChart


declare type Highcharts$HeatMapSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$HeatMapChart


declare type Highcharts$LineChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$LineChart


declare type Highcharts$PieChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$PieChart


declare type Highcharts$PolygonChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$PolygonChart


declare type Highcharts$PyramidChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$PyramidChart


declare type Highcharts$ScatterChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$ScatterChart


declare type Highcharts$SolidGaugeChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$SolidGaugeChart


declare type Highcharts$SplineChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$SplineChart


declare type Highcharts$TreeMapChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$TreeMapChart


declare type Highcharts$WaterFallChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$WaterFallChart


declare type Highcharts$WordCloudChartSeriesOptions = {} & Highcharts$IndividualSeriesOptions & Highcharts$WordCloudChart


declare interface Highcharts$DataPoint {
 ...
 */
declare interface Highcharts$SubtitleOptions {
...
declare interface Highcharts$TimeOptions {
...
declare interface Highcharts$TitleOptions {
...
declare interface Highcharts$CrosshairObject {
...
declare interface Highcharts$PlotPoint {
plotX: number,
plotY: number
} 

declare type Highcharts$TooltipOptions = {
...
crosshairs?: boolean
| [boolean, boolean]
| Highcharts$CrosshairObject
| [Highcharts$CrosshairObject, Highcharts$CrosshairObject]
| null,
...
declare interface Highcharts$SeriesTooltipOptions {
...
declare interface Highcharts$Options {
 ...
 */
labels?: Highcharts$LabelsOptions,
lang?: Highcharts$LangObject,
 ...
 */
xAxis?: Highcharts$AxisOptions[] | Highcharts$AxisOptions,
 ...
 */
yAxis?: Highcharts$AxisOptions[] | Highcharts$AxisOptions
} 

declare type Highcharts$GlobalOptions = {

/**
 * Global options that don't apply to each chart. These options, like the lang options, must be set using the
 * Highcharts.setOptions method.
 */
global?: Highcharts$GlobalObject,
...
declare interface Highcharts$DateFormatSpecifiers {
 ...
 */
declare interface Highcharts$AxisObject {
dataMin: number,
dataMax: number,
userMin: number,
userMax: number,
 ...
 * @since 1.2.0
 */
addPlotBand(options: Highcharts$PlotBands): void,
 ...
 * @since 1.2.0
 */
addPlotLine(options: Highcharts$PlotLines): void,
 ...
 * @since 2.2
 */
setTitle(title: Highcharts$AxisTitle, redraw?: boolean): void,
 ...
 * @since 3.0
 */
update(options: Highcharts$AxisOptions, redraw?: boolean): void
} 
 ...
 */
declare interface Highcharts$ChartObject {
...
isX?: boolean,
redraw?: boolean,
animation?: boolean | Highcharts$Animation): Highcharts$AxisObject,
 ...
 * @since 1.2.0
 */
addSeries<T: Highcharts$IndividualSeriesOptions>(
options: T,
redraw?: boolean,
animation?: boolean | Highcharts$Animation): Highcharts$SeriesObject,
...
point: Highcharts$PointObject,
seriesOptions: Highcharts$IndividualSeriesOptions): void,
chartHeight?: number,
chartWidth?: number,
 ...
 */
credits: Highcharts$CreditsObject,
 ...
 */
get(
id: string): Highcharts$AxisObject | Highcharts$SeriesObject | Highcharts$PointObject,
 ...
 * @since 1.2.0
 */
getSelectedPoints(): Highcharts$PointObject[],
 ...
 * @since 1.2.0
 */
getSelectedSeries(): Highcharts$SeriesObject[],
 ...
 * @since 1.2.0
 */
redraw(animation?: boolean | Highcharts$Animation): void,
...
width: number,
height: number,
animation?: boolean | Highcharts$Animation): void,
...
redraw?: boolean,
oneToOne?: boolean,
animation?: boolean | Highcharts$AnimationOptions): void,
 ...
 * @since 1.2.0
 */
xAxis: Highcharts$AxisObject[],

/**
 * An array of the chart's y axes. If only one y axis, it is referenced by chart.yAxis[0].
 * @since 1.2.0
 */
yAxis: Highcharts$AxisObject[],
renderer: Highcharts$RendererObject,
legend: Highcharts$LegendObject
} 

declare interface Highcharts$Chart {
...
new (
options: Highcharts$Options,
callback?: (chart: Highcharts$ChartObject) => void): Highcharts$ChartObject,
 ...
 */
declare interface Highcharts$ElementObject {
 ...
 * @since 2.0
 */
add(parent?: Highcharts$ElementObject): Highcharts$ElementObject,
 ...
 * @since 2.0
 */
animate(attributes: any, animation?: any): Highcharts$ElementObject,
 ...
 * @since 2.0
 */
attr(hash: any): Highcharts$ElementObject,
 ...
 * @since 2.0
 */
css(hash: Object): Highcharts$ElementObject,
 ...
 * @since 2.0
 */
on(eventType: string, handler: () => void): Highcharts$ElementObject,
 ...
 * @since 2.0
 */
toFront(): Highcharts$ElementObject
} 
 ...
 */
declare interface Highcharts$RendererObject {
...
innerRadius: number,
start: number,
end: number): Highcharts$ElementObject,
 ...
 * @since 2.0
 */
circle(centerX: number, centerY: number, radius: number): Highcharts$ElementObject,
 ...
 * @since 5.0.0
 */
definition(def: {[key: string]: any}): Highcharts$ElementObject,
 ...
 */
fontMetrics(fontSize: string, elem: Highcharts$ElementObject): Highcharts$FontMetrics,
 ...
 * @since 2.0
 */
g(name?: string): Highcharts$ElementObject,
...
y: number,
width: number,
height: number): Highcharts$ElementObject,
...
useHTML?: boolean,
baseline?: boolean,
className?: string): Highcharts$ElementObject,
 ...
 */
path(path: Array<string | number>): Highcharts$ElementObject,
...
width: number,
height: number,
cornerRadius: number): Highcharts$ElementObject,
 ...
 * @since 2.0
 */
text(str: string, x: number, y: number): Highcharts$ElementObject
} 

declare interface Highcharts$FontMetrics {
...
declare interface Highcharts$Renderer {
new (
parentNode: HTMLElement,
width: number,
height: number): Highcharts$RendererObject
} 

declare interface Highcharts$Static {
Highcharts$Chart: Highcharts$Chart,
Highcharts$Renderer: Highcharts$Renderer,
Highcharts$Color(color: string | Highcharts$Gradient): string | Highcharts$Gradient,
 ...
 * of the date.
 */
dateFormats: Highcharts$DateFormatSpecifiers,
 ...
 */
setOptions(options: Highcharts$GlobalOptions): Highcharts$Options,
 ...
 */
addEvent(
element: HTMLElement | Highcharts$ElementObject | {[key: string]: any},
type: string,
 ...
 * @see {@link https://www.highcharts.com/docs/extending-highcharts/extending-highcharts}
 */
Tooltip: Highcharts$TooltipPrototype
} 
 ...
 */
declare interface Highcharts$PointObject {
 ...
 * @since 1.2.0
 */
remove(redraw?: boolean, animation?: boolean | Highcharts$Animation): void,
 ...
 */
update(
options: number | [number, number] | Highcharts$DataPoint,
redraw?: boolean,
animation?: boolean | Highcharts$Animation): void,
 ...
 * for example plotOptions.line. Next, options for one single series are given in the series array.
 */
declare interface Highcharts$SeriesObject {
 ...
 */
setData(
data: number[] | number[][] | Highcharts$DataPoint[],
redraw?: boolean,
animation?: boolean | Highcharts$Animation,
 ...
 * @since 1.2.0
 */
update(options: Highcharts$IndividualSeriesOptions, redraw?: boolean): void,
...
declare interface Highcharts$LegendObject {
 ...
 * @since 5.0.0
 */
update(options: Highcharts$LegendOptions, redraw?: boolean): void
} 
 ...
 * @see {@link https://www.highcharts.com/docs/extending-highcharts/extending-highcharts}
 */
declare interface Highcharts$TooltipPrototype {
...
highcharts(): Highcharts$Highcharts$ChartObject,
...
callback?: (chart: Highcharts$Highcharts$ChartObject) => void): JQuery
} 
    }

	declare var Highcharts: Highcharts$Highcharts$Static;
	declare module.exports: typeof Highcharts
