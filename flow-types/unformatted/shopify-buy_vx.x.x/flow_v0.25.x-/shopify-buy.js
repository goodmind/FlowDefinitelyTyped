...
declare export function ShopifyBuy$buildClient(config: ShopifyBuy$Config): ShopifyBuy$Client


declare export interface ShopifyBuy$Client {
...
declare export interface ShopifyBuy$Config {
domain: string,
storefrontAccessToken: string
} 

declare export interface ShopifyBuy$ProductResource {
...
options: ShopifyBuy$Option): ShopifyBuy$ProductVariant
} 

declare export interface ShopifyBuy$CollectionResource {
fetch(id: string): Promise<ShopifyBuy$Product[]>,
...
declare export interface ShopifyBuy$CheckoutResource {
create(
email?: string,
lineItems?: ShopifyBuy$LineItem[],
shippingAddress?: ShopifyBuy$Address,
note?: string,
customAttributes?: ShopifyBuy$AttributeInput[]): Promise<ShopifyBuy$Cart>,
fetch(id: string): Promise<ShopifyBuy$Cart>,
addLineItems(
checkoutId: string | number,
lineItems: ShopifyBuy$LineItem[]): Promise<ShopifyBuy$Cart>,
...
nextItem?: Array<ShopifyBuy$Item>): Promise<ShopifyBuy$Cart>,

/**
 * Remove a line item from cart based on line item id
 */
removeLineItem(checkoutId: string | number, lineItemIds: string[]): Promise<ShopifyBuy$Cart>,
...
updateLineItem(
checkoutId: string | number,
lineItems: ShopifyBuy$AttributeInput[]): Promise<ShopifyBuy$Cart>
} 

declare export interface ShopifyBuy$ShopResource {
fetchInfo(): Promise<ShopifyBuy$Shop>,
fetchPolicies(): Promise<ShopifyBuy$Shop>
} 

declare export interface ShopifyBuy$Query {
...
declare export type ShopifyBuy$Product = {
...
declare export type ShopifyBuy$ProductVariant = {
...
declare export interface ShopifyBuy$Option {
...
declare export interface ShopifyBuy$OptionValue {
name: string,
option_id: string,
value: any
} 

declare export interface ShopifyBuy$Collection {
handle: string,
body_html: string,
image: ShopifyBuy$Image,
id: string,
...
declare export type ShopifyBuy$Cart = {
...
declare export type ShopifyBuy$LineItem = {
...
declare export interface ShopifyBuy$Item {
variant: ShopifyBuy$ProductVariant,
quantity: number
} 

declare export interface ShopifyBuy$Address {
address1: String,
address2: String,
city: String,
company: String,
 ...
 */
declare export interface ShopifyBuy$AttributeInput {
key?: string,
value?: string,
id?: string | number,
quantity?: number,
 ...
 */
declare export interface ShopifyBuy$Shop {
description: string,
moneyFormat: string,
name: string,
 ...
 */
declare export type ShopifyBuy$Image = {
id: string | number,
created_at: string,
position: number,
updated_at: string,
...
declare export type ShopifyBuy$ImageVariant = {
name: string,
dimensions: string,
src: string,
 ...
 */
imageForSize(image: ShopifyBuy$Image, options: ShopifyBuy$ImageOptions): string
} & ShopifyBuy$Image


declare export interface ShopifyBuy$ImageOptions {
maxWidth: number,
maxHeight: number
} 
...
declare export interface ShopifyBuy$GraphModel {
attrs?: any,
