...
static +UNKNOWN_FAILURE: Class<Viewing$ErrorCodes__UNKNOWN_FAILURE> & Viewing$ErrorCodes__UNKNOWN_FAILURE & 1;// 1
static +BAD_DATA: Class<Viewing$ErrorCodes__BAD_DATA> & Viewing$ErrorCodes__BAD_DATA & 2;// 2
static +NETWORK_FAILURE: Class<Viewing$ErrorCodes__NETWORK_FAILURE> & Viewing$ErrorCodes__NETWORK_FAILURE & 3;// 3
static +NETWORK_ACCESS_DENIED: Class<Viewing$ErrorCodes__NETWORK_ACCESS_DENIED> & Viewing$ErrorCodes__NETWORK_ACCESS_DENIED & 4;// 4
static +NETWORK_FILE_NOT_FOUND: Class<Viewing$ErrorCodes__NETWORK_FILE_NOT_FOUND> & Viewing$ErrorCodes__NETWORK_FILE_NOT_FOUND & 5;// 5
static +NETWORK_SERVER_ERROR: Class<Viewing$ErrorCodes__NETWORK_SERVER_ERROR> & Viewing$ErrorCodes__NETWORK_SERVER_ERROR & 6;// 6
static +NETWORK_UNHANDLED_RESPONSE_CODE: Class<Viewing$ErrorCodes__NETWORK_UNHANDLED_RESPONSE_CODE> & Viewing$ErrorCodes__NETWORK_UNHANDLED_RESPONSE_CODE & 7;// 7
static +BROWSER_WEBGL_NOT_SUPPORTED: Class<Viewing$ErrorCodes__BROWSER_WEBGL_NOT_SUPPORTED> & Viewing$ErrorCodes__BROWSER_WEBGL_NOT_SUPPORTED & 8;// 8
static +BAD_DATA_NO_VIEWABLE_CONTENT: Class<Viewing$ErrorCodes__BAD_DATA_NO_VIEWABLE_CONTENT> & Viewing$ErrorCodes__BAD_DATA_NO_VIEWABLE_CONTENT & 9;// 9
static +BROWSER_WEBGL_DISABLED: Class<Viewing$ErrorCodes__BROWSER_WEBGL_DISABLED> & Viewing$ErrorCodes__BROWSER_WEBGL_DISABLED & 10;// 10
static +BAD_DATA_MODEL_IS_EMPTY: Class<Viewing$ErrorCodes__BAD_DATA_MODEL_IS_EMPTY> & Viewing$ErrorCodes__BAD_DATA_MODEL_IS_EMPTY & 11;// 11
static +RTC_ERROR: Class<Viewing$ErrorCodes__RTC_ERROR> & Viewing$ErrorCodes__RTC_ERROR & 12;// 12
static +UNSUPORTED_FILE_EXTENSION: Class<Viewing$ErrorCodes__UNSUPORTED_FILE_EXTENSION> & Viewing$ErrorCodes__UNSUPORTED_FILE_EXTENSION & 13;// 13
static +VIEWER_INTERNAL_ERROR: Class<Viewing$ErrorCodes__VIEWER_INTERNAL_ERROR> & Viewing$ErrorCodes__VIEWER_INTERNAL_ERROR & 14;// 14
...
declare class Viewing$ErrorCodes__NETWORK_ACCESS_DENIED mixins Viewing$ErrorCodes {}
declare class Viewing$ErrorCodes__NETWORK_FILE_NOT_FOUND mixins Viewing$ErrorCodes {}
declare class Viewing$ErrorCodes__NETWORK_SERVER_ERROR mixins Viewing$ErrorCodes {}
declare class Viewing$ErrorCodes__NETWORK_UNHANDLED_RESPONSE_CODE mixins Viewing$ErrorCodes {}
declare class Viewing$ErrorCodes__BROWSER_WEBGL_NOT_SUPPORTED mixins Viewing$ErrorCodes {}
declare class Viewing$ErrorCodes__BAD_DATA_NO_VIEWABLE_CONTENT mixins Viewing$ErrorCodes {}
declare class Viewing$ErrorCodes__BROWSER_WEBGL_DISABLED mixins Viewing$ErrorCodes {}
declare class Viewing$ErrorCodes__BAD_DATA_MODEL_IS_EMPTY mixins Viewing$ErrorCodes {}
declare class Viewing$ErrorCodes__RTC_ERROR mixins Viewing$ErrorCodes {}
declare class Viewing$ErrorCodes__UNSUPORTED_FILE_EXTENSION mixins Viewing$ErrorCodes {}
declare class Viewing$ErrorCodes__VIEWER_INTERNAL_ERROR mixins Viewing$ErrorCodes {}


declare  class Viewing$SelectionMode {
  constructor(...args: empty): mixed;
static +MIXED: Class<Viewing$SelectionMode__MIXED> & Viewing$SelectionMode__MIXED & 0;// 0
static +REGULAR: Class<Viewing$SelectionMode__REGULAR> & Viewing$SelectionMode__REGULAR & 1;// 1
static +OVERLAYED: Class<Viewing$SelectionMode__OVERLAYED> & Viewing$SelectionMode__OVERLAYED & 2;// 2
static +LEAF_OBJECT: Class<Viewing$SelectionMode__LEAF_OBJECT> & Viewing$SelectionMode__LEAF_OBJECT & 3;// 3
static +FIRST_OBJECT: Class<Viewing$SelectionMode__FIRST_OBJECT> & Viewing$SelectionMode__FIRST_OBJECT & 4;// 4
static +LAST_OBJECT: Class<Viewing$SelectionMode__LAST_OBJECT> & Viewing$SelectionMode__LAST_OBJECT & 5;// 5
...
declare  class Viewing$ProgressState {
  constructor(...args: empty): mixed;
static +ROOT_LOADED: Class<Viewing$ProgressState__ROOT_LOADED> & Viewing$ProgressState__ROOT_LOADED & 0;// 0
static +LOADING: Class<Viewing$ProgressState__LOADING> & Viewing$ProgressState__LOADING & 1;// 1
static +RENDERING: Class<Viewing$ProgressState__RENDERING> & Viewing$ProgressState__RENDERING & 2;// 2
...
declare  class Viewing$KeyCode {
  constructor(...args: empty): mixed;
static +BACKSPACE: Class<Viewing$KeyCode__BACKSPACE> & Viewing$KeyCode__BACKSPACE & 8;// 8
...
static +CONTROL: Class<Viewing$KeyCode__CONTROL> & Viewing$KeyCode__CONTROL & 17;// 17
...
static +PAGEDOWN: Class<Viewing$KeyCode__PAGEDOWN> & Viewing$KeyCode__PAGEDOWN & 34;// 34
...
static +SEMICOLONMOZ: Class<Viewing$KeyCode__SEMICOLONMOZ> & Viewing$KeyCode__SEMICOLONMOZ & 59;// 59
static +EQUALSMOZ: Class<Viewing$KeyCode__EQUALSMOZ> & Viewing$KeyCode__EQUALSMOZ & 61;// 61
...
static +LCOMMAND: Class<Viewing$KeyCode__LCOMMAND> & Viewing$KeyCode__LCOMMAND & 91;// 91
static +RCOMMAND: Class<Viewing$KeyCode__RCOMMAND> & Viewing$KeyCode__RCOMMAND & 93;// 93
static +PLUS: Class<Viewing$KeyCode__PLUS> & Viewing$KeyCode__PLUS & 107;// 107
static +PLUSMOZ: Class<Viewing$KeyCode__PLUSMOZ> & Viewing$KeyCode__PLUSMOZ & 171;// 171
static +DASHMOZ: Class<Viewing$KeyCode__DASHMOZ> & Viewing$KeyCode__DASHMOZ & 109;// 109
...
static +DASHMOZNEW: Class<Viewing$KeyCode__DASHMOZNEW> & Viewing$KeyCode__DASHMOZNEW & 173;// 173
static +SEMICOLON: Class<Viewing$KeyCode__SEMICOLON> & Viewing$KeyCode__SEMICOLON & 186;// 186
static +EQUALS: Class<Viewing$KeyCode__EQUALS> & Viewing$KeyCode__EQUALS & 187;// 187
...
static +PERIOD: Class<Viewing$KeyCode__PERIOD> & Viewing$KeyCode__PERIOD & 190;// 190
static +SLASH: Class<Viewing$KeyCode__SLASH> & Viewing$KeyCode__SLASH & 191;// 191
static +LBRACKET: Class<Viewing$KeyCode__LBRACKET> & Viewing$KeyCode__LBRACKET & 219;// 219
static +RBRACKET: Class<Viewing$KeyCode__RBRACKET> & Viewing$KeyCode__RBRACKET & 221;// 221
static +SINGLEQUOTE: Class<Viewing$KeyCode__SINGLEQUOTE> & Viewing$KeyCode__SINGLEQUOTE & 222;// 222
static +COMMANDMOZ: Class<Viewing$KeyCode__COMMANDMOZ> & Viewing$KeyCode__COMMANDMOZ & 224;// 224
...
declare var Viewing$AGGREGATE_SELECTION_CHANGED_EVENT: ;

declare var Viewing$ANIMATION_READY_EVENT: ;

declare var Viewing$CAMERA_CHANGE_EVENT: ;

declare var Viewing$CUTPLANES_CHANGE_EVENT: ;

declare var Viewing$ESCAPE_EVENT: ;

declare var Viewing$EXPLODE_CHANGE_EVENT: ;

declare var Viewing$EXTENSION_LOADED_EVENT: ;

declare var Viewing$EXTENSION_UNLOADED_EVENT: ;

declare var Viewing$FINAL_FRAME_RENDERED_CHANGED_EVENT: ;

declare var Viewing$FIT_TO_VIEW_EVENT: ;

declare var Viewing$FRAGMENTS_LOADED_EVENT: ;

declare var Viewing$FULLSCREEN_MODE_EVENT: ;

declare var Viewing$GEOMETRY_LOADED_EVENT: ;

declare var Viewing$HIDE_EVENT: ;

declare var Viewing$HYPERLINK_EVENT: ;

declare var Viewing$ISOLATE_EVENT: ;

declare var Viewing$LAYER_VISIBILITY_CHANGED_EVENT: ;

declare var Viewing$LOAD_MISSING_GEOMETRY: ;

declare var Viewing$MODEL_ROOT_LOADED_EVENT: ;

declare var Viewing$MODEL_UNLOADED_EVENT: ;

declare var Viewing$NAVIGATION_MODE_CHANGED_EVENT: ;

declare var Viewing$OBJECT_TREE_CREATED_EVENT: ;

declare var Viewing$OBJECT_TREE_UNAVAILABLE_EVENT: ;

declare var Viewing$PREF_CHANGED_EVENT: ;

declare var Viewing$PREF_RESET_EVENT: ;

declare var Viewing$PROGRESS_UPDATE_EVENT: ;

declare var Viewing$RENDER_OPTION_CHANGED_EVENT: ;

declare var Viewing$RENDER_PRESENTED_EVENT: ;

declare var Viewing$RESET_EVENT: ;

declare var Viewing$RESTORE_DEFAULT_SETTINGS_EVENT: ;

declare var Viewing$SELECTION_CHANGED_EVENT: ;

declare var Viewing$SHOW_EVENT: ;

declare var Viewing$TEXTURES_LOADED_EVENT: ;

declare var Viewing$TOOL_CHANGE_EVENT: ;

declare var Viewing$TOOLBAR_CREATED_EVENT: ;

declare var Viewing$VIEWER_INITIALIZED: ;

declare var Viewing$VIEWER_RESIZE_EVENT: ;

declare var Viewing$VIEWER_STATE_RESTORED_EVENT: ;

declare var Viewing$VIEWER_UNINITIALIZED: ;
...
constructor(rawNode: {[key: string]: any}, parent?: Viewing$BubbleNode): this;
...
constructor(dataJSON: {[key: string]: any}, path: string, acmsession: string): this;
static load(
documentId: string,
successCallback: (doc: Viewing$Document) => void,
errorCallback: (errorCode: Viewing$ErrorCodes, errorMsg: string, messages: any[]) => void,
...
registerExtension(extensionId: string, extension: {[key: string]: any}): boolean;
...
constructor(viewer: Viewing$Viewer3D): this;
doScreenModeChange(oldMode: Viewing$ScreenMode, newMode: Viewing$ScreenMode): void;
...
onScreenModeChanged(oldMode: Viewing$ScreenMode, newMode: Viewing$ScreenMode): void;
...
setSelectionColor(color: THREE.Color, selectionType: Viewing$SelectionMode): void;
...
onSuccessCallback?: () => void,
onErrorCallback?: () => void): number | Viewing$ErrorCodes;
tearDown(): void;
...
constructor(containerId: string, options?: Viewing$ViewingApplicationOptions): this;
...
accessControlProperties?: {[key: string]: any}): void;
registerViewer(viewableType: string, viewerClass: any, config?: Viewing$ViewerConfig): void;
selectItem(
item: Viewing$ViewerItem | Viewing$BubbleNode,
onSuccessCallback: (viewer: Viewing$Viewer3D, item: Viewing$ViewerItem) => void,
onErrorCallback: (
errorCode: Viewing$ErrorCodes,
errorMsg: string,
statusCode: string,
statusText: string,
messages: string) => void): boolean;
selectItemById(
itemId: number,
onItemSelectedCallback: (item: {[key: string]: any}, viewGeometryItem: {[key: string]: any}) => void,
...
declare function Private$formatValueWithUnits(value: number, units: string, type: number, precision: number): string
...
constructor(viewer: Viewing$Viewer3D, options: Private$PreferencesOptions): this;
...
setModelStructurePanel(modelStructurePanel: UI$UI$ModelStructurePanel): boolean;
...
declare var UI$COLLAPSED_CHANGED: ;

declare var UI$VISIBILITY_CHANGED: ;

declare var UI$CONTROL_ADDED: ;

declare var UI$CONTROL_REMOVED: ;

declare var UI$SIZE_CHANGED: ;

declare class UI$DockingPanel  {
constructor(parentContainer: HTMLElement, id: string, title: string, options?: UI$DockingPanelOptions): this;
closer: HTMLElement;
container: HTMLElement;
content: Node;
title: HTMLElement;
titleLabel: string;
addEventListener(target: {[key: string]: any}, eventId: string, callback: () => void): void;
...
removeEventListener(target: {[key: string]: any}, eventId: string, callback: () => void): boolean;
...
value: string,
category: string,
options?: UI$AddPropertyOptions): boolean;
areDefaultPropertiesShown(): void;
displayCategory(
category: {[key: string]: any},
parent: HTMLElement,
options: UI$DisplayCategoryOptions): HTMLElement[];
displayProperty(
...
setCategoryCollapsed(category: {[key: string]: any}, collapsed: boolean): void;
setProperties(
properties: Array<{
displayName: string,
displayValue: any
...
options: {[key: string]: any} | void): string;
addDropDownMenu(
tabId: string,
caption: string,
items: UI$MenuItem[],
...
onchange: () => void,
options: {[key: string]: any} | void): string;
addTab(tabId: string, tabTitle: string, options: {[key: string]: any} | void): boolean;
...
declare  class UI$ControlStates {
  constructor(...args: empty): mixed;
static +ACTIVE: Class<UI$ControlStates__ACTIVE> & UI$ControlStates__ACTIVE & 0;// 0
static +INACTIVE: Class<UI$ControlStates__INACTIVE> & UI$ControlStates__INACTIVE & 1;// 1
static +DISABLED: Class<UI$ControlStates__DISABLED> & UI$ControlStates__DISABLED & 2;// 2
