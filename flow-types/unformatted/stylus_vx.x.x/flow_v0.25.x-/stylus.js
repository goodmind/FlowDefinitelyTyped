...
alpha: Stylus$Nodes.Unit): Stylus$Nodes.HSLA,
...
hue: Stylus$Nodes.Unit,
saturation: Stylus$Nodes.Unit,
lightness: Stylus$Nodes.Unit): Stylus$Nodes.HSLA,
 ...
 */
component(color: Stylus$Nodes.RGBA, name: Stylus$Nodes.String): Stylus$Nodes.Unit,
component(color: Stylus$Nodes.HSLA, name: Stylus$Nodes.String): Stylus$Nodes.Unit,
...
saturation(color: Stylus$Nodes.RGBA, value: Stylus$Nodes.Unit): Stylus$Nodes.RGBA,
saturation(color: Stylus$Nodes.HSLA, value: Stylus$Nodes.Unit): Stylus$Nodes.RGBA,
...
lightness(color: Stylus$Nodes.RGBA, value: Stylus$Nodes.Unit): Stylus$Nodes.RGBA,
lightness(color: Stylus$Nodes.HSLA, value: Stylus$Nodes.Unit): Stylus$Nodes.RGBA,
...
saturation: Stylus$Nodes.Unit,
lightness: Stylus$Nodes.Unit,
alpha: Stylus$Nodes.Unit): Stylus$Nodes.RGBA,
...
contrast(top: Stylus$Nodes.RGBA, bottom: Stylus$Nodes.RGBA): Stylus$Nodes.Object,
contrast(top: Stylus$Nodes.RGBA, bottom: Stylus$Nodes.HSLA): Stylus$Nodes.Object,
contrast(top: Stylus$Nodes.HSLA): Stylus$Nodes.Object,
contrast(top: Stylus$Nodes.HSLA, bottom: Stylus$Nodes.RGBA): Stylus$Nodes.Object,
contrast(top: Stylus$Nodes.HSLA, bottom: Stylus$Nodes.HSLA): Stylus$Nodes.Object,
...
alpha?: Stylus$Nodes.Unit): Stylus$Nodes.Object,
transparentify(
top: Stylus$Nodes.RGBA,
...
namePrefix: Stylus$Nodes.String): any,
 ...
 */
define(name: Stylus$Nodes.String, expr: Stylus$Nodes.Expression): Stylus$Nodes.Node,
...
right: Stylus$Nodes.Node): Stylus$Nodes.Node,

/**
 * Test if `val` matches the given `pattern`.
 */
match(pattern: Stylus$Nodes.String, val: Stylus$Nodes.String): Stylus$Nodes.Boolean,
match(pattern: Stylus$Nodes.String, val: Stylus$Nodes.Ident): Stylus$Nodes.Boolean,
...
length: Stylus$Nodes.Number): Stylus$Nodes.String,
substr(
val: Stylus$Nodes.Ident,
start: Stylus$Nodes.Number,
length: Stylus$Nodes.Number): Stylus$Nodes.Ident,
...
val: Stylus$Nodes.String): Stylus$Nodes.String,
replace(
pattern: Stylus$Nodes.String,
replacement: Stylus$Nodes.String,
val: Stylus$Nodes.Ident): Stylus$Nodes.Ident,
...
split(
pattern: Stylus$Nodes.String,
val: Stylus$Nodes.String): Stylus$Nodes.Expression,
split(pattern: Stylus$Nodes.String, val: Stylus$Nodes.Ident): Stylus$Nodes.Expression,
...
...nodes: Stylus$Nodes.Node[]): Stylus$Nodes.Unit,
 ...
 */
s(fmt: Stylus$Nodes.String, ...nodes: Stylus$Nodes.Node[]): Stylus$Nodes.Literal,
...
width: Stylus$Nodes.Number): Stylus$Nodes.Literal,

/**
 * Return the opposites of the given `positions`.
 */
"opposite-position"(positions: Stylus$Nodes.Expression): Stylus$Nodes.Expression,
...
ignoreErr: Stylus$Nodes.Boolean): Stylus$Nodes.Expression,
...
amount: Stylus$Nodes.Unit): Stylus$Nodes.RGBA,
adjust(
...
expr: Stylus$Nodes.Expression): Stylus$Nodes.Property,

/**
 * Merge the object `dest` with the given args.
 */
merge(dest: Stylus$Nodes.Object, ...objs: Stylus$Nodes.Object[]): Stylus$Nodes.Object,

/**
 * Merge the object `dest` with the given args.
 */
extend(dest: Stylus$Nodes.Object, ...objs: Stylus$Nodes.Object[]): Stylus$Nodes.Object,
 ...
 */
"-prefix-classes"(prefix: Stylus$Nodes.String, block: Stylus$Nodes.Block): Stylus$Nodes.Block,
...
declare export type Stylus$Middleware = (req: any, res: any, next: (...args: any[]) => any) => void;
...
declare export type Stylus$RenderCallback = (err: Error, css: string, js: string) => void;
