 ...
 */
onDidChange(callback: (event: Events$Events$MarkerChanged) => void): Disposable,
 ...
 * Invoke the given callback when the state of the marker changes.
 */
onDidChange(callback: (event: Events$Events$DisplayMarkerChanged) => void): Disposable,
 ...
 */
onDidCreateMarker(
callback: (marker: TextBuffer$DisplayMarker | TextBuffer$Marker) => void): Disposable,
 ...
 */
findMarkers(properties: Options$Options$FindDisplayMarker): TextBuffer$DisplayMarker[]
} 
 ...
 * row and column.
 */
fromObject(object: TextBuffer$PointCompatible, copy?: boolean): TextBuffer$Point,
...
point2: TextBuffer$PointCompatible): TextBuffer$Point
} 
 ...
 */
declare type TextBuffer$PointCompatible = TextBuffer$PointLike | [number, number];
...
endDelta?: TextBuffer$PointCompatible): TextBuffer$Range,
 ...
 */
intersectsWith(otherRange: TextBuffer$RangeLike, exclusive?: boolean): boolean,

/**
 * Returns a boolean indicating whether this range contains the given range.
 */
containsRange(otherRange: TextBuffer$RangeCompatible, exclusive?: boolean): boolean,

/**
 * Returns a boolean indicating whether this range contains the given point.
 */
containsPoint(point: TextBuffer$PointCompatible, exclusive?: boolean): boolean,
 ...
 */
fromObject(object: TextBuffer$RangeCompatible, copy?: boolean): TextBuffer$Range,
...
pointB?: TextBuffer$PointCompatible): TextBuffer$Range,
 ...
 */
declare type TextBuffer$RangeCompatible = TextBuffer$RangeLike
 ...
 * changes.
 */
onWillChange(callback: (event: Events$Events$BufferChanging) => void): Disposable,
 ...
 */
onDidChange(callback: (event: Events$Events$BufferChanged) => void): Disposable,

/**
 * Invoke the given callback synchronously when a transaction finishes with
 * a list of all the changes in the transaction.
 */
onDidChangeText(callback: (event: Events$Events$BufferStoppedChanging) => void): Disposable,
 ...
 */
onDidStopChanging(callback: (event: Events$Events$BufferStoppedChanging) => void): Disposable,
 ...
 */
onWillThrowWatchError(callback: (errorObject: Events$Events$BufferWatchError) => void): Disposable,
...
scan(
regex: RegExp,
iterator: (params: Structures$Structures$BufferScanResult) => void): void,
...
iterator: (params: Structures$Structures$ContextualBufferScanResult) => void): void,
 ...
 */
characterIndexForPosition(position: TextBuffer$Point | [number, number]): number,
...
load(
source: string,
params?: Options$Options$BufferLoad): Promise<TextBuffer$TextBuffer>,

/**
 * Create a new buffer backed by the given file path. For better performance,
 * use TextBuffer.load instead.
 */
loadSync(filePath: string, params?: Options$Options$BufferLoad): TextBuffer$TextBuffer,
