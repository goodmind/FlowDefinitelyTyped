declare module 'in-app-purchase' {
        declare export var UNITY: ;
	declare export var APPLE: ;
	declare export var GOOGLE: ;
	declare export var WINDOWS: ;
	declare export var AMAZON: ;
	declare export var ROKU: ;
	...
	declare export function validate(receipt: Receipt): Promise<ValidationResponse>

	declare export function validate(receipt: Receipt, callback: (err: any, res: ValidationResponse) => void): void

	declare export function validate(
service: Service,
receipt: Receipt,
callback: (err: any, res: ValidationResponse) => void): void

	declare export function validateOnce(receipt: Receipt, secretOrPubKey: any): Promise<ValidationResponse>
...
ignoreExpired: boolean
	...
	declare export function refreshGoogleToken(callback: (err: any) => void): void
...
verbose?: boolean
	...
	declare export type Service = typeof UNITY
| typeof APPLE
| typeof GOOGLE
| typeof WINDOWS
| typeof AMAZON
...
signature: string
	...
	declare export type Receipt = UnityReceipt
| AppleReceipt
| GoogleReceipt
| WindowsReceipt
| AmazonReceipt
