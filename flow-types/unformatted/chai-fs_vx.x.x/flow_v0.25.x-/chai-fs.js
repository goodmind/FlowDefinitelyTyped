...
directoryDeepContent(path: string, array: any[], msg?: string): Chai$Assertion,
notDirectoryDeepContent(path: string, array: any[], msg?: string): Chai$Assertion,
...
notDirectoryDeepFiles(path: string, array: any[], msg?: string): Chai$Assertion,
directoryIncludeFiles(path: string, array: any[], msg?: string): Chai$Assertion,
notDirectoryIncludeFiles(path: string, array: any[], msg?: string): Chai$Assertion,
subDirs(array: any[], msg?: string): Chai$Assertion,
...
directoryDeepSubDirs(path: string, array: any[], msg?: string): Chai$Assertion,
notDirectoryDeepSubDirs(path: string, array: any[], msg?: string): Chai$Assertion,
directoryIncludeSubDirs(path: string, array: any[], msg?: string): Chai$Assertion,
notDirectoryIncludeSubDirs(path: string, array: any[], msg?: string): Chai$Assertion,
directoryEqual(path: string, otherPath: string, msg?: string): Chai$Assertion,
notDirectoryEqual(path: string, otherPath: string, msg?: string): Chai$Assertion,
directoryDeepEqual(path: string, otherPath: string, msg?: string): Chai$Assertion,
notDirectoryDeepEqual(path: string, otherPath: string, msg?: string): Chai$Assertion,
...
notFileContentMatch(path: string, regExp: RegExp, msg?: string): Chai$Assertion,
...
} & Chai$LanguageChains & NumericComparison & Chai$TypeComparison
