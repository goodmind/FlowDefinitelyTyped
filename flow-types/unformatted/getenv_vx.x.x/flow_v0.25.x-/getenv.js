...
getenv$url: UrlWithStringQuery
	...
	declare type ParseWithFallback = [string, $ElementType<ParseMappings, "string">];
	declare type ParseWithType<T: ParseTypes> = [string, $ElementType<ParseMappings, T>, T];
	declare type ParseWithEachType = ParseWithType<"string">
| ParseWithType<"int">
| ParseWithType<"float">
| ParseWithType<"bool">
 ...
 */
declare function getenv(name: string, fallback?: string): $ElementType<ParseMappings, "string">
...
name: string,
fallback?: $ElementType<ParseMappings, "string">): $ElementType<ParseMappings, "string">
...
name: string,
fallback?: $ElementType<ParseMappings, "int">): $ElementType<ParseMappings, "int">
...
name: string,
fallback?: $ElementType<ParseMappings, "float">): $ElementType<ParseMappings, "float">
...
name: string,
fallback?: $ElementType<ParseMappings, "bool">): $ElementType<ParseMappings, "bool">
...
name: string,
fallback?: $ElementType<ParseMappings, "boolish">): $ElementType<ParseMappings, "boolish">
 ...
 */
declare function getenv$array<T: ParseTypes= "string">(
name: string,
type?: T,
fallback?: Array<$ElementType<ParseMappings, T>>): Array<$ElementType<ParseMappings, T>>
 ...
 *      * ```
 */
declare function getenv$multi<S: {
[k: string]: string | ParseWithFallback | ParseWithEachType
}>(
spec: S): $ObjMapi<S, <P>(P) => "There was Conditional Type, use $Call utility type">
...
name: string,
fallback?: $ElementType<ParseMappings, "url">): $ElementType<ParseMappings, "url">
