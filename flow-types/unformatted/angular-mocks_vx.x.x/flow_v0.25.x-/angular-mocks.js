...
(...fns: Array<Injectable<(...args: any[]) => void>>): any,
strictDi(val?: boolean): any
} 
...
<T>(controllerConstructor: ((...args: any[]) => T) | ((...args: any[]) => T) | string, locals?: any, bindings?: any): T
} 
	declare interface IComponentControllerService {
<T, TBinding>(componentName: string, locals: {
$scope?: IScope,
[key: string]: any
...
data?: string | RegExp | {[key: string]: any} | ((data: string) => boolean),
headers?: mock$mock$IHttpHeaders | ((headers: mock$mock$IHttpHeaders) => boolean),
keys?: string[]): mock$mock$IRequestHandler,
 ...
 */
expectRoute(method: string, url: string): mock$mock$IRequestHandler,
 ...
 * @param url HTTP url string that supports colon param matching.
 */
whenRoute(method: string, url: string): mock$mock$IRequestHandler
} 
	declare interface IFlushPendingTasksService {
...
(delay?: number): void
	...
	declare interface IVerifyNoPendingTasksService {
...
(taskType?: string): void
	...
	declare interface animate$IAnimateService {
 ...
 */
declare interface mock$IRequestHandler {
...
headers: mock$IHttpHeaders,
params: {
[key: string]: string
}) => [number, string | {[key: string]: any}, mock$IHttpHeaders, string])): mock$IRequestHandler,
...
data?: string | {[key: string]: any},
headers?: mock$IHttpHeaders,
responseText?: string): mock$IRequestHandler,
 ...
 */
passThrough(): mock$IRequestHandler
} 

declare interface mock$IHttpHeaders {
 ...
 */
declare interface mock$IBrowserTriggerEventData {
...
event.
 */
declare function browserTrigger(
element: JQuery | Element,
eventType?: string,
eventData?: angular.mock.mock$IBrowserTriggerEventData): void
