...
declare export type Q$IWhenable<T> = PromiseLike<T> | T;

declare export type Q$IPromise<T> = PromiseLike<T>;

declare export interface Q$Deferred<T> {
promise: Q$Promise<T>,
...
declare export interface Q$Promise<T> {
...
onProgress?: ((progress: any) => any) | null): Q$Promise<U>,
then<U= T, V= empty>(
onFulfill?: ((value: T) => Q$IWhenable<U>) | null,
onReject?: ((error: any) => Q$IWhenable<V>) | null,
onProgress?: ((progress: any) => any) | null): Q$Promise<U | V>,
...
onProgress?: ((progress: any) => any) | null): void,
 ...
 */
thenReject<U= T>(reason?: any): Q$Promise<U>,
...
declare export interface Q$PromiseState<T> {
 ...
 */
declare export function Q$nfapply<T>(nodeFunction: (...args: any[]) => any, args: any[]): Q$Promise<T>
 ...
 */
declare export function Q$nfcall<T>(nodeFunction: (...args: any[]) => any, ...args: any[]): Q$Promise<T>
...
promises: Q$IWhenable<[Q$IWhenable<A>, Q$IWhenable<B>, Q$IWhenable<C>, Q$IWhenable<D>, Q$IWhenable<E>]>): Q$Promise<[A, B, C, D, E]>
...
promises: Q$IWhenable<[Q$IWhenable<A>, Q$IWhenable<B>, Q$IWhenable<C>, Q$IWhenable<D>]>): Q$Promise<[A, B, C, D]>
...
promises: Q$IWhenable<[Q$IWhenable<A>, Q$IWhenable<B>, Q$IWhenable<C>]>): Q$Promise<[A, B, C]>
 ...
 * Returns a promise that is fulfilled with an array containing the fulfillment value of each promise, or is rejected with the same rejection reason as the first promise to be rejected.
 */
declare export function Q$all<A, B>(promises: Q$IWhenable<[Q$IPromise<A>, Q$IPromise<B>]>): Q$Promise<[A, B]>


declare export function Q$all<A, B>(promises: Q$IWhenable<[A, Q$IPromise<B>]>): Q$Promise<[A, B]>


declare export function Q$all<A, B>(promises: Q$IWhenable<[Q$IPromise<A>, B]>): Q$Promise<[A, B]>


declare export function Q$all<A, B>(promises: Q$IWhenable<[A, B]>): Q$Promise<[A, B]>
 ...
 * Returns a promise that is fulfilled with an array containing the fulfillment value of each promise, or is rejected with the same rejection reason as the first promise to be rejected.
 */
declare export function Q$all<T>(promises: Q$IWhenable<Array<Q$IWhenable<T>>>): Q$Promise<T[]>
 ...
 */
declare export function Q$race<T>(promises: Array<Q$IWhenable<T>>): Q$Promise<T>
...
promises: Q$IWhenable<Array<Q$IWhenable<T>>>): Q$Promise<Array<Q$PromiseState<T>>>
...
promises: Q$IWhenable<Array<Q$IWhenable<T>>>): Q$Promise<Array<Q$Promise<T>>>
 ...
 */
declare export function Q$delay<T>(promiseOrValue: Q$Promise<T> | T, ms: number): Q$Promise<T>
 ...
 */
declare export function Q$isPending(promiseOrObject: Q$Promise<any> | any): boolean
...
Q$reject: (reason?: any) => void,
notify: (progress: any) => void) => void): Q$Promise<T>
