 ...
 * @see Quad
 */
quad<Q: BaseQuad= Quad>(
subject: $ElementType<Q, "subject">,
predicate: $ElementType<Q, "predicate">,
object: $ElementType<Q, "object">,
graph?: $ElementType<Q, "graph">): Q
} 
...
predicate?: Term | RegExp,
object?: Term | RegExp,
graph?: Term | RegExp): EventEmitter,
 ...
 * @return The resulting event emitter.
 */
deleteGraph(graph: $ElementType<Q, "graph"> | string): EventEmitter
} & Source & Sink
