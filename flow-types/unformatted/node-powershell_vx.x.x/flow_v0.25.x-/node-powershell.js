...
noProfile?: boolean
	...
	declare export interface ShellStream {
 ...
 */
constructor(options: NodePowershell.ShellOptions): this;
...
on(eventName: string, callback: (output: string) => void): void
	...
	declare module.exports: typeof NodePowershell
