 ...
 */
declare export function keyboardjs$pressKey(keyCombo: string | number, event?: keyboardjs$KeyEvent): void
 ...
 * @param event The KeyEvent, can be null.
 */
declare export function keyboardjs$releaseKey(keyCombo: string | number, event?: keyboardjs$KeyEvent): void
 ...
 * @param myDoc The document or form to attach to.
 */
declare export function keyboardjs$watch(myDoc: Document | HTMLFormElement): void
