declare module 'react-svg-pan-zoom' {
	...
	declare export var MODE_IDLE: ;
	declare export var MODE_PANNING: ;
	declare export var MODE_ZOOMING: ;
	declare export var TOOL_AUTO: ;
	declare export var TOOL_NONE: ;
	declare export var TOOL_PAN: ;
	declare export var TOOL_ZOOM_IN: ;
	declare export var TOOL_ZOOM_OUT: ;
	declare export var POSITION_NONE: ;
	declare export var POSITION_TOP: ;
	declare export var POSITION_RIGHT: ;
	declare export var POSITION_BOTTOM: ;
	declare export var POSITION_LEFT: ;
	declare export type Mode = typeof MODE_IDLE | typeof MODE_PANNING | typeof MODE_ZOOMING;
...
endY?: number | null
	...
	declare export type Tool = typeof TOOL_AUTO
| typeof TOOL_NONE
| typeof TOOL_PAN
| typeof TOOL_ZOOM_IN
| typeof TOOL_ZOOM_OUT;
	declare export type ToolbarPosition = typeof POSITION_NONE
| typeof POSITION_TOP
...
stopPropagation(): void
	...
	declare export function pan(value: Value, SVGDeltaX: number, SVGDeltaY: number, panLimit?: number): Value

	declare export function zoom(value: Value, SVGPointX: number, SVGPointY: number, scaleFactor: number): Value
...
selectionSVGPointY: number,
selectionWidth: number,
selectionHeight: number): Value

	declare export function fitToViewer(value: Value): Value

	declare export function zoomOnViewerCenter(value: Value, scaleFactor: number): Value

	declare export function setPointOnViewerCenter(value: Value, SVGPointX: number, SVGPointY: number, zoomLevel: number): Value
