 ...
 */
addCollection<F: {[key: string]: any}= any>(
name: string,
 ...
 */
getCollection<F: {[key: string]: any}= any>(collectionName: string): Collection<F>;
...
localStorage: _LokiLocalStorageAdapter
	...
	declare export class Collection<E: {[key: string]: any}= any> mixins _Collection<E> {}
