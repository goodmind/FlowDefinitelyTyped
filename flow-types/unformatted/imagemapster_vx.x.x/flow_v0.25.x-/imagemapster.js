 ...
 * the page.
 */
mapster(options?: ImageMapster$ImageMapster$Options): JQuery,
 ...
 */
mapster(method: ImageMapster$ImageMapster$Select): void,
 ...
 */
mapster(method: ImageMapster$ImageMapster$Deselect): void,
 ...
 */
mapster(
method: ImageMapster$ImageMapster$Set,
selected: boolean,
options: ImageMapster$ImageMapster$RenderingOptions): JQuery,
mapster(
method: ImageMapster$ImageMapster$Set,
options: ImageMapster$ImageMapster$RenderingOptions): JQuery,
 ...
 */
mapster(method: ImageMapster$ImageMapster$Get, key?: string): string | boolean,
 ...
 */
mapster(method: ImageMapster$ImageMapster$Highlight, flag?: string | boolean): void,
 ...
 * using "preserveState."
 */
mapster(method: ImageMapster$ImageMapster$Unbind, preserveState?: boolean): JQuery,
 ...
 */
mapster(method: ImageMapster$ImageMapster$Snapshot): JQuery,
 ...
 */
mapster(
method: ImageMapster$ImageMapster$Rebind,
options: ImageMapster$ImageMapster$Options): JQuery,
 ...
 */
mapster(
method: ImageMapster$ImageMapster$Resize,
width: number,
height: number,
 ...
 */
mapster(
method: ImageMapster$ImageMapster$Keys,
key: string,
all?: boolean): string | string[],
mapster(method: ImageMapster$ImageMapster$Keys, all: boolean): string | string[],
 ...
 */
mapster(
method: ImageMapster$ImageMapster$SetOptions,
options?: ImageMapster$ImageMapster$Options): JQuery,
 ...
 */
mapster(
method: ImageMapster$ImageMapster$GetOptions,
key?: string,
effective?: boolean): ImageMapster$ImageMapster$Options | ImageMapster$ImageMapster$AreaRenderingOptions,
 ...
 */
mapster(method: ImageMapster$ImageMapster$Tooltip, key?: string): JQuery
} 
    }
