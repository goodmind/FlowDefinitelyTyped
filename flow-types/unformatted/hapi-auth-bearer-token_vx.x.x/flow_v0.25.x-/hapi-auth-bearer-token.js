declare module 'hapi-auth-bearer-token' {
        import type {
          Request,Plugin,ResponseToolkit,AuthenticationData
        } from 'hapi';
...
options: BearerToken$BearerToken$SchemaOptions): void
} 
    }
...
request: Request,
token: string,
h: ResponseToolkit) => Promise<ValidateReturn> | ValidateReturn;
