...
tick(): void
	...
	declare export interface Component<T: {[key: string]: any}= any, S: System= System> {
attrName?: string,
data: T,
dependencies?: string[],
el: Entity,
...
init(data: any): void
	...
	declare export interface GeometryConstructor<T: {[key: string]: any}= {[key: string]: any}> {
new (): T & Geometry
} 
...
addEventListener(type: SceneEvents, listener: EventListener, useCapture?: boolean): void
	...
	declare export type Schema<T: {[key: string]: any}= {[key: string]: any}> = SinglePropertySchema<T> | MultiPropertySchema<T>;
...
tick?: (t: number, dt: number) => void
	...
	declare export interface SystemConstructor<T: {[key: string]: any}= {[key: string]: any}> {
...
optionalContext?: {}): (t: number, dt: number) => void
	...
	declare export type ComponentDefinition<T: {[key: string]: any}= {[key: string]: any}> = T & $Shape<Component> & ThisType<T & Component>;
	declare export type GeometryDefinition<T: {[key: string]: any}= {[key: string]: any}, U= any> = T & $Shape<Geometry<U>>;
	declare export type NodeDefinition<T: {[key: string]: any}= {[key: string]: any}> = T & $Shape<ANode>;
...
schema: $ElementType<Shader, "schema">
	...
	declare export type ShaderDefinition<T: {[key: string]: any}= MinimalShaderDefinition & {[key: string]: any}> = T & $Shape<Shader>;
	declare export type SystemDefinition<T: {[key: string]: any}= {[key: string]: any}> = T & $Shape<System>;
