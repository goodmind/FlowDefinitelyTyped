 ...
 * map[string, number] - metrics associated with this page, displayed in Metrics Explorer on the portal. Defaults to empty.
 * @param duration
 * number - the number of milliseconds it took to load the page. Defaults to undefined. If set to default value, page load time is calculated internally.
 */
trackPageView(
name?: string,
url?: string,
 ...
 * @param name
 * A string to identify this event in the portal.
 * @param properties
 * map[string, string] - additional data used to filter events and metrics in the portal. Defaults to empty.
 * @param measurements
 * map[string, number] - metrics associated with this event, displayed in Metrics Explorer on the portal. Defaults to empty.
 ...
 * @param id
 * unique id, this is used by the backend o correlate server requests. Use Util.newId() to generate a unique Id.
 * @param method
 * represents request verb (GET, POST, etc.)
 * @param absoluteUrl
 * absolute url used to make the dependency request
 * @param pathName
 * the path part of the absolute url
 * @param totalTime
 * total request time
 * @param success
 * indicates if the request was sessessful
 * @param resultCode
 * response code returned by the dependency request
 * @param properties
 * map[string, string] - additional data used to filter events and metrics in the portal. Defaults to empty.
 * @param measurements
 * map[string, number] - metrics associated with this event, displayed in Metrics Explorer on the portal. Defaults to empty.
 ...
 * @param exception
 * An Error from a catch clause, or the string error message.
 * @param properties
 * map[string, string] - additional data used to filter events and metrics in the portal. Defaults to empty.
 * @param measurements
 * map[string, number] - metrics associated with this event, displayed in Metrics Explorer on the portal. Defaults to empty.
 ...
 * @param average
 * Number representing either a single measurement, or the average of several measurements.
 * @param sampleCount
 * The number of measurements represented by the average. Defaults to 1.
 * @param min
 * The smallest measurement in the sample. Defaults to the average.
 * @param max
 * The largest measurement in the sample. Defaults to the average.
 */
trackMetric(
name: string,
average: number,
 ...
 * A message string
 * @param properties
 * map[string, string] - additional data used to filter traces in the portal. Defaults to empty.
 */
trackTrace(
message: string,
properties?: {
 ...
 * - An optional string to represent the account associated with the authenticated user.
 */
 ...
 * - The error message
 * @param {string} url
 * - The url where the error was raised
 * @param {number} lineNumber
 * - The line number where the error was raised
 * @param {number} columnNumber
 * - The column number for the line where the error was raised
 * @param {Error} error
 * - The Error object
 */
_onerror(
