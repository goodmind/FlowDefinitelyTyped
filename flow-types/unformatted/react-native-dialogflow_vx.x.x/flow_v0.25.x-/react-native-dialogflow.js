...
declare var Dialogflow$LANG_CHINESE_CHINA: ;
...
declare function Dialogflow$setConfiguration(accessToken: string, languageTag: string): void
...
resultCallback: (result: {[key: string]: any}) => void,
errorCallback: (error: Error) => void): Promise<any>
...
declare function Dialogflow$onAudioLevel(callback: (level: number) => void): void
...
declare var Dialogflow_V2$LANG_CHINESE_CHINA: ;
...
declare function Dialogflow_V2$onListeningFinished(callback: () => void): void


declare function Dialogflow_V2$onAudioLevel(callback: (level: number) => void): void
