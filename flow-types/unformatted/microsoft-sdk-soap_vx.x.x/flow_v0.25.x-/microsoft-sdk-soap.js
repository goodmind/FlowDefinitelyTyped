...
entityId: string,
relationship: string,
relatedEntities: Sdk$Sdk$Collection<Sdk$Sdk$EntityReference>): Sdk$Q.Promise<void>;
 ...
 */
static execute(request: Sdk$Sdk$OrganizationRequest): Sdk$Q.Promise<Sdk$OrganizationResponse>;
...
entityName: string,
id: string,
columnSet: Sdk$Sdk$ColumnSet): Sdk$Q.Promise<Sdk$Entity>;
...
query: Sdk$Sdk$Query.Query$QueryByAttribute): Sdk$Q.Promise<Sdk$Sdk$EntityCollection>;
 ...
 */
static retrieveMultiple(
query: Sdk$Sdk$Query.Query$QueryExpression): Sdk$Q.Promise<Sdk$Sdk$EntityCollection>;
 ...
 */
static retrieveMultiple(
query: Sdk$Sdk$Query.Query$FetchExpression): Sdk$Q.Promise<Sdk$Sdk$EntityCollection>;
 ...
 */
constructor(entityReferences?: Sdk$Sdk$Collection<Sdk$EntityReference>): this;
 ...
 */
setEntityReferences(entityReferences: Sdk$Sdk$Collection<Sdk$EntityReference>): void;
...
declare class Sdk$AttributeCollection mixins Sdk$Collection<Sdk$AttributeBase> {
constructor(): this;
 ...
 */
containsAttribute(predicate: (attribute: Sdk$Sdk$AttributeBase) => boolean): boolean;
 ...
 */
setRelatedEntities(relatedEntities: Sdk$Sdk$RelatedEntitiesCollection): void;
 ...
 */
addRelatedEntity(relationshipSchemaName: string, entity: Sdk$Sdk$Entity): void;
 ...
 */
declare class Sdk$FetchXmlToQueryExpressionRequest mixins Sdk$Sdk$OrganizationRequest {
 ...
 */
declare class Sdk$FetchXmlToQueryExpressionResponse mixins Sdk$Sdk$OrganizationResponse {
 ...
 */
declare class Sdk$QueryExpressionToFetchXmlRequest mixins Sdk$Sdk$OrganizationRequest {
 ...
 */
declare class Sdk$QueryExpressionToFetchXmlResponse mixins Sdk$Sdk$OrganizationResponse {
constructor(responseXml: string): this;
 ...
 */
declare class Sdk$RetrieveMetadataChangesRequest mixins Sdk$Sdk$OrganizationRequest {
constructor(query: Sdk$Sdk$Mdq.Mdq$EntityQueryExpression, clientVersionStamp?: string, deletedMetadataFilters?: Sdk$Sdk$Mdq.Mdq$DeletedMetadataFilters): this;
...
constructor(entityMoniker: Sdk$EntityReference, state: number, status: number): this;
 ...
 */
setOrders(orders: Sdk$Sdk$Collection<Sdk$Sdk$Query.Query$OrderExpression>): void;
 ...
 */
removeAttributeValue(attributeValue: Sdk$Sdk$AttributeBase, errorIfNotFound?: boolean): void
}
...
values: Sdk$Sdk$Query.Query$ValueBase): void;
...
joinOperator: Sdk$Sdk$Query.Query$JoinOperator): void;
 ...
 */
addOrder(attributeName: string, orderType: Sdk$Sdk$Query.Query$OrderType): void
}
 ...
 */
constructor(entityName: string, attributeName: string, operator: Query$ConditionOperator, values?: Query$ValueBase): this;
 ...
 */
constructor(linkFromEntityName: string, linkToEntityName: string, linkFromAttributeName: string, linkToAttributeName: string, joinOperator: Sdk$Sdk$Query.Query$JoinOperator, entityAlias: string): this;
...
static +Equal: Class<Query$ConditionOperator__Equal> & Query$ConditionOperator__Equal & 0;// 0
static +NotEqual: Class<Query$ConditionOperator__NotEqual> & Query$ConditionOperator__NotEqual & 1;// 1
static +GreaterThan: Class<Query$ConditionOperator__GreaterThan> & Query$ConditionOperator__GreaterThan & 2;// 2
static +LessThan: Class<Query$ConditionOperator__LessThan> & Query$ConditionOperator__LessThan & 3;// 3
static +GreaterEqual: Class<Query$ConditionOperator__GreaterEqual> & Query$ConditionOperator__GreaterEqual & 4;// 4
static +LessEqual: Class<Query$ConditionOperator__LessEqual> & Query$ConditionOperator__LessEqual & 5;// 5
static +Like: Class<Query$ConditionOperator__Like> & Query$ConditionOperator__Like & 6;// 6
static +NotLike: Class<Query$ConditionOperator__NotLike> & Query$ConditionOperator__NotLike & 7;// 7
static +In: Class<Query$ConditionOperator__In> & Query$ConditionOperator__In & 8;// 8
static +NotIn: Class<Query$ConditionOperator__NotIn> & Query$ConditionOperator__NotIn & 9;// 9
static +Between: Class<Query$ConditionOperator__Between> & Query$ConditionOperator__Between & 10;// 10
static +NotBetween: Class<Query$ConditionOperator__NotBetween> & Query$ConditionOperator__NotBetween & 11;// 11
static +Null: Class<Query$ConditionOperator__Null> & Query$ConditionOperator__Null & 12;// 12
static +NotNull: Class<Query$ConditionOperator__NotNull> & Query$ConditionOperator__NotNull & 13;// 13
static +Yesterday: Class<Query$ConditionOperator__Yesterday> & Query$ConditionOperator__Yesterday & 14;// 14
static +Today: Class<Query$ConditionOperator__Today> & Query$ConditionOperator__Today & 15;// 15
static +Tomorrow: Class<Query$ConditionOperator__Tomorrow> & Query$ConditionOperator__Tomorrow & 16;// 16
static +Last7Days: Class<Query$ConditionOperator__Last7Days> & Query$ConditionOperator__Last7Days & 17;// 17
static +Next7Days: Class<Query$ConditionOperator__Next7Days> & Query$ConditionOperator__Next7Days & 18;// 18
static +LastWeek: Class<Query$ConditionOperator__LastWeek> & Query$ConditionOperator__LastWeek & 19;// 19
static +ThisWeek: Class<Query$ConditionOperator__ThisWeek> & Query$ConditionOperator__ThisWeek & 20;// 20
static +NextWeek: Class<Query$ConditionOperator__NextWeek> & Query$ConditionOperator__NextWeek & 21;// 21
static +LastMonth: Class<Query$ConditionOperator__LastMonth> & Query$ConditionOperator__LastMonth & 22;// 22
static +ThisMonth: Class<Query$ConditionOperator__ThisMonth> & Query$ConditionOperator__ThisMonth & 23;// 23
static +NextMonth: Class<Query$ConditionOperator__NextMonth> & Query$ConditionOperator__NextMonth & 24;// 24
static +On: Class<Query$ConditionOperator__On> & Query$ConditionOperator__On & 25;// 25
static +OnOrBefore: Class<Query$ConditionOperator__OnOrBefore> & Query$ConditionOperator__OnOrBefore & 26;// 26
static +OnOrAfter: Class<Query$ConditionOperator__OnOrAfter> & Query$ConditionOperator__OnOrAfter & 27;// 27
static +LastYear: Class<Query$ConditionOperator__LastYear> & Query$ConditionOperator__LastYear & 28;// 28
static +ThisYear: Class<Query$ConditionOperator__ThisYear> & Query$ConditionOperator__ThisYear & 29;// 29
static +NextYear: Class<Query$ConditionOperator__NextYear> & Query$ConditionOperator__NextYear & 30;// 30
static +LastXHours: Class<Query$ConditionOperator__LastXHours> & Query$ConditionOperator__LastXHours & 31;// 31
static +NextXHours: Class<Query$ConditionOperator__NextXHours> & Query$ConditionOperator__NextXHours & 32;// 32
static +LastXDays: Class<Query$ConditionOperator__LastXDays> & Query$ConditionOperator__LastXDays & 33;// 33
static +NextXDays: Class<Query$ConditionOperator__NextXDays> & Query$ConditionOperator__NextXDays & 34;// 34
static +LastXWeeks: Class<Query$ConditionOperator__LastXWeeks> & Query$ConditionOperator__LastXWeeks & 35;// 35
static +NextXWeeks: Class<Query$ConditionOperator__NextXWeeks> & Query$ConditionOperator__NextXWeeks & 36;// 36
static +LastXMonths: Class<Query$ConditionOperator__LastXMonths> & Query$ConditionOperator__LastXMonths & 37;// 37
static +NextXMonths: Class<Query$ConditionOperator__NextXMonths> & Query$ConditionOperator__NextXMonths & 38;// 38
static +LastXYears: Class<Query$ConditionOperator__LastXYears> & Query$ConditionOperator__LastXYears & 39;// 39
static +NextXYears: Class<Query$ConditionOperator__NextXYears> & Query$ConditionOperator__NextXYears & 40;// 40
static +EqualUserId: Class<Query$ConditionOperator__EqualUserId> & Query$ConditionOperator__EqualUserId & 41;// 41
static +NotEqualUserId: Class<Query$ConditionOperator__NotEqualUserId> & Query$ConditionOperator__NotEqualUserId & 42;// 42
static +EqualBusinessId: Class<Query$ConditionOperator__EqualBusinessId> & Query$ConditionOperator__EqualBusinessId & 43;// 43
static +NotEqualBusinessId: Class<Query$ConditionOperator__NotEqualBusinessId> & Query$ConditionOperator__NotEqualBusinessId & 44;// 44
static +Mask: Class<Query$ConditionOperator__Mask> & Query$ConditionOperator__Mask & 45;// 45
static +NotMask: Class<Query$ConditionOperator__NotMask> & Query$ConditionOperator__NotMask & 46;// 46
static +Contains: Class<Query$ConditionOperator__Contains> & Query$ConditionOperator__Contains & 47;// 47
static +DoesNotContain: Class<Query$ConditionOperator__DoesNotContain> & Query$ConditionOperator__DoesNotContain & 48;// 48
static +EqualUserLanguage: Class<Query$ConditionOperator__EqualUserLanguage> & Query$ConditionOperator__EqualUserLanguage & 49;// 49
static +NotOn: Class<Query$ConditionOperator__NotOn> & Query$ConditionOperator__NotOn & 50;// 50
static +OlderThanXMonths: Class<Query$ConditionOperator__OlderThanXMonths> & Query$ConditionOperator__OlderThanXMonths & 51;// 51
static +BeginsWith: Class<Query$ConditionOperator__BeginsWith> & Query$ConditionOperator__BeginsWith & 52;// 52
static +DoesNotBeginWith: Class<Query$ConditionOperator__DoesNotBeginWith> & Query$ConditionOperator__DoesNotBeginWith & 53;// 53
static +EndsWith: Class<Query$ConditionOperator__EndsWith> & Query$ConditionOperator__EndsWith & 54;// 54
static +DoesNotEndWith: Class<Query$ConditionOperator__DoesNotEndWith> & Query$ConditionOperator__DoesNotEndWith & 55;// 55
static +ThisFiscalYear: Class<Query$ConditionOperator__ThisFiscalYear> & Query$ConditionOperator__ThisFiscalYear & 56;// 56
static +ThisFiscalPeriod: Class<Query$ConditionOperator__ThisFiscalPeriod> & Query$ConditionOperator__ThisFiscalPeriod & 57;// 57
static +NextFiscalYear: Class<Query$ConditionOperator__NextFiscalYear> & Query$ConditionOperator__NextFiscalYear & 58;// 58
static +NextFiscalPeriod: Class<Query$ConditionOperator__NextFiscalPeriod> & Query$ConditionOperator__NextFiscalPeriod & 59;// 59
static +LastFiscalYear: Class<Query$ConditionOperator__LastFiscalYear> & Query$ConditionOperator__LastFiscalYear & 60;// 60
static +LastFiscalPeriod: Class<Query$ConditionOperator__LastFiscalPeriod> & Query$ConditionOperator__LastFiscalPeriod & 61;// 61
static +LastXFiscalYears: Class<Query$ConditionOperator__LastXFiscalYears> & Query$ConditionOperator__LastXFiscalYears & 62;// 62
static +LastXFiscalPeriods: Class<Query$ConditionOperator__LastXFiscalPeriods> & Query$ConditionOperator__LastXFiscalPeriods & 63;// 63
static +NextXFiscalYears: Class<Query$ConditionOperator__NextXFiscalYears> & Query$ConditionOperator__NextXFiscalYears & 64;// 64
static +NextXFiscalPeriods: Class<Query$ConditionOperator__NextXFiscalPeriods> & Query$ConditionOperator__NextXFiscalPeriods & 65;// 65
static +InFiscalYear: Class<Query$ConditionOperator__InFiscalYear> & Query$ConditionOperator__InFiscalYear & 66;// 66
static +InFiscalPeriod: Class<Query$ConditionOperator__InFiscalPeriod> & Query$ConditionOperator__InFiscalPeriod & 67;// 67
static +InFiscalPeriodAndYear: Class<Query$ConditionOperator__InFiscalPeriodAndYear> & Query$ConditionOperator__InFiscalPeriodAndYear & 68;// 68
static +InOrBeforeFiscalPeriodAndYear: Class<Query$ConditionOperator__InOrBeforeFiscalPeriodAndYear> & Query$ConditionOperator__InOrBeforeFiscalPeriodAndYear & 69;// 69
static +InOrAfterFiscalPeriodAndYear: Class<Query$ConditionOperator__InOrAfterFiscalPeriodAndYear> & Query$ConditionOperator__InOrAfterFiscalPeriodAndYear & 70;// 70
static +EqualUserOrUserTeams: Class<Query$ConditionOperator__EqualUserOrUserTeams> & Query$ConditionOperator__EqualUserOrUserTeams & 71;// 71
static +EqualUserTeams: Class<Query$ConditionOperator__EqualUserTeams> & Query$ConditionOperator__EqualUserTeams & 72;// 72

}

declare class Query$ConditionOperator__Equal mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NotEqual mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__GreaterThan mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LessThan mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__GreaterEqual mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LessEqual mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__Like mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NotLike mixins Query$ConditionOperator {}
...
declare class Query$ConditionOperator__Between mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NotBetween mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__Null mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NotNull mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__Yesterday mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__Today mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__Tomorrow mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__Last7Days mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__Next7Days mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastWeek mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__ThisWeek mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextWeek mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastMonth mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__ThisMonth mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextMonth mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__On mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__OnOrBefore mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__OnOrAfter mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastYear mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__ThisYear mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextYear mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastXHours mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextXHours mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastXDays mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextXDays mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastXWeeks mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextXWeeks mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastXMonths mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextXMonths mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastXYears mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextXYears mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__EqualUserId mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NotEqualUserId mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__EqualBusinessId mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NotEqualBusinessId mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__Mask mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NotMask mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__Contains mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__DoesNotContain mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__EqualUserLanguage mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NotOn mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__OlderThanXMonths mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__BeginsWith mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__DoesNotBeginWith mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__EndsWith mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__DoesNotEndWith mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__ThisFiscalYear mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__ThisFiscalPeriod mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextFiscalYear mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextFiscalPeriod mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastFiscalYear mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastFiscalPeriod mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastXFiscalYears mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__LastXFiscalPeriods mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextXFiscalYears mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__NextXFiscalPeriods mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__InFiscalYear mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__InFiscalPeriod mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__InFiscalPeriodAndYear mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__InOrBeforeFiscalPeriodAndYear mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__InOrAfterFiscalPeriodAndYear mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__EqualUserOrUserTeams mixins Query$ConditionOperator {}
declare class Query$ConditionOperator__EqualUserTeams mixins Query$ConditionOperator {}


declare export  class Query$JoinOperator {
  constructor(...args: empty): mixed;
static +Inner: Class<Query$JoinOperator__Inner> & Query$JoinOperator__Inner & 0;// 0
static +LeftOuter: Class<Query$JoinOperator__LeftOuter> & Query$JoinOperator__LeftOuter & 1;// 1
static +Natural: Class<Query$JoinOperator__Natural> & Query$JoinOperator__Natural & 2;// 2
...
declare export  class Query$OrderType {
  constructor(...args: empty): mixed;
static +Ascending: Class<Query$OrderType__Ascending> & Query$OrderType__Ascending & 0;// 0
static +Descending: Class<Query$OrderType__Descending> & Query$OrderType__Descending & 1;// 1
...
declare export  class Query$LogicalOperator {
  constructor(...args: empty): mixed;
static +Or: Class<Query$LogicalOperator__Or> & Query$LogicalOperator__Or & 0;// 0
static +And: Class<Query$LogicalOperator__And> & Query$LogicalOperator__And & 1;// 1
