...
declare interface passport$Authenticator<InitializeRet= express.Handler, AuthenticateRet= any, AuthorizeRet= AuthenticateRet, AuthorizeOptions= passport$AuthenticateOptions> {
use(strategy: passport$Strategy): this,
use(name: string, strategy: passport$Strategy): this,
unuse(name: string): this,
framework<X, Y, Z>(fw: passport$Framework<X, Y, Z>): passport$Authenticator<X, Y, Z>,
initialize(options?: {
userProperty: string
}): InitializeRet,
session(options?: {
...
callback?: (...args: any[]) => any): AuthenticateRet,
authenticate(
strategy: string | string[],
...
fn: (user: TUser, done: (err: any, id?: TID) => void) => void): void,
deserializeUser<TUser, TID>(
fn: (id: TID, done: (err: any, user?: TUser) => void) => void): void,
...
declare type passport$StrategyCreated<T, O= T & passport$StrategyCreatedStatic> = $ObjMapi<O, <P>(P) => $ElementType<O, P>>;
...
declare interface passport$Framework<InitializeRet= any, AuthenticateRet= any, AuthorizeRet= AuthenticateRet> {
initialize(
passport: passport$Authenticator<InitializeRet, AuthenticateRet, AuthorizeRet>,
options?: any): (...args: any[]) => InitializeRet,
authenticate(
passport: passport$Authenticator<InitializeRet, AuthenticateRet, AuthorizeRet>,
name: string,
options?: any,
callback?: (...args: any[]) => any): (...args: any[]) => AuthenticateRet,
authorize?: (
passport: passport$Authenticator<InitializeRet, AuthenticateRet, AuthorizeRet>,
name: string,
options?: any,
callback?: (...args: any[]) => any) => (...args: any[]) => AuthorizeRet
} 
