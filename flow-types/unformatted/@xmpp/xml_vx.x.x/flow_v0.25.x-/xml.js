...
...children: xml$xml$ElementChild[]): xml$JSX$Element
...
...children: xml$ElementChild[]): JSX$Element
...
declare type xml$ElementChild = xml$Element
| xml$Element[]
| string
| number
| boolean;
...
onStartElement(name: string, attrs?: string | {
[attrName: string]: any
}): void;
