...
language: string,
value: string,
options?: lowlight$lowlight$HighlightOptions): lowlight$lowlight$HighlightResult

	declare export function highlightAuto(
value: string,
options?: lowlight$lowlight$HighlightAutoOptions): lowlight$lowlight$HighlightAutoResult
...
declare type lowlight$HastNode = AST$AST$Root
| AST$AST$Element
| AST$AST$Doctype
| AST$AST$Comment
| AST$AST$Text;
