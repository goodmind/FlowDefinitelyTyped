...
cb: (url: string, type: string, willNavigate: boolean, main: boolean) => void): Nightmare;
on(
event: "resourceRequested",
cb: (
requestData: Nightmare$Nightmare$IRequest,
networkRequest: Nightmare$Nightmare$INetwordRequest) => void): Nightmare;
on(
event: "resourceReceived",
cb: (response: Nightmare$Nightmare$IResponse) => void): Nightmare;
on(
event: "resourceError",
cb: (resourceError: Nightmare$Nightmare$IResourceError) => void): Nightmare;
on(
event: "consoleMessage",
cb: (msg: string, lineNumber: number, sourceId: number) => void): Nightmare;
...
on(
event: "error",
cb: (msg: string, trace?: Nightmare$Nightmare$IStackTrace[]) => void): Nightmare;
...
done?: (err: any, buffer: Buffer) => void): Nightmare;
screenshot(
path: string,
clip?: {
x: number,
...
declare export interface Nightmare$ICookieQuery {
url?: string,
name?: string,
domain?: string,
path?: string,
...
declare export interface Nightmare$ICookie {
name: string,
value: string,
url?: string,
domain?: string,
