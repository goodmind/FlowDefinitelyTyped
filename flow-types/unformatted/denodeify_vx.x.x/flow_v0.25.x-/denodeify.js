...
transformer?: _.M): (a: A, b: B, c: C, d: D, e: E, f: F) => Promise<R>

	declare function _<A, B, C, D, E, F, G, R>(
fn: _.F7<A, B, C, D, E, F, G, R>,
transformer?: _.M): (a: A, b: B, c: C, d: D, e: E, f: F, g: G) => Promise<R>

	declare function _<A, B, C, D, E, F, G, H, R>(
fn: _.F8<A, B, C, D, E, F, G, H, R>,
transformer?: _.M): (a: A, b: B, c: C, d: D, e: E, f: F, g: G, h: H) => Promise<R>
