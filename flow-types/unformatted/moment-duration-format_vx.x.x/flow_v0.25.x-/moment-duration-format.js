...
| "yy"
| "yyy");
	declare type DurationLabelDef = $ObjMapi<{[k: DurationToken]: any}, <duration>(duration) => string>;
	declare type DurationTimeDef = $ObjMapi<{[k: DurationTemplate]: any}, <template>(template) => string>;
