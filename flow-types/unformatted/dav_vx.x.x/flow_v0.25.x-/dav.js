 ...
 */
declare export function createAccount(options: CreateAccountOptions): Promise<Account>
...
calendar: Calendar,
options: CreateCalendarObjectOptions): Promise<CalendarObject>
...
options: UpdateCalendarObjectOptions): Promise<CalendarObject>
...
calendarObject: CalendarObject,
options: DeleteCalendarObjectOptions): Promise<CalendarObject>
 ...
 */
declare export function syncCalendar(calendar: Calendar, options: SyncCalendarOptions): Promise<Calendar>
 ...
 */
declare export function syncCaldavAccount(account: Account, options: SyncCaldavAccountOptions): Promise<Account>
 ...
 */
declare export function createCard(addressBook: AddressBook, options: CreateCardOptions): Promise<AddressBook>
 ...
 */
declare export function updateCard(card: VCard, options: UpdateCardOptions): Promise<VCard>
 ...
 */
declare export function deleteCard(card: VCard, options: DeleteCardOptions): Promise<VCard>
...
options: SyncAddressBookOptions): Promise<AddressBook>
 ...
 */
declare export function syncCarddavAccount(account: Account, options: SyncCarddavAccountOptions): Promise<Account>
...
request: Request,
url: string,
options?: transport$TransportOptions): Promise<any>
}
 ...
 * @returns
 */
declare function request$addressBookQuery(options: request$AddressBookQueryOptions): string
 ...
 * @returns
 */
declare function request$calendarQuery(options: request$CalendarQueryOptions): string
 ...
 * @returns
 */
declare function request$syncCollection(options: request$SyncCollectionOptions): string
 ...
 * @param options
 */
constructor(xhr: transport$transport$Transport, options?: ClientOptions): this;
...
declare var ns$CALENDAR_SERVER: ;

declare var ns$CALDAV_APPLE: ;

declare var ns$CALDAV: ;

declare var ns$CARDDAV: ;
