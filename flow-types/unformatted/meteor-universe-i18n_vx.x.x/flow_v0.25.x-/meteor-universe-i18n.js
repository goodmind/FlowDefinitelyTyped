...
type?: any): () => React.Component<ReactComponentProps>


declare function i18n$createTranslator(namespace: string, options?: TranslaterOptions): Translator


declare function i18n$createReactiveTranslator(namespace: string, locale: string): () => React.Component


declare function i18n$addTranslation(locale: string, namespace: string, translation: string): void


declare function i18n$addTranslation(locale: string, namespace: string, key: string, translation: string): void


declare function i18n$addTranslations(locale: string, translationsMap: {}): void


declare function i18n$addTranslations(locale: string, namespace: string, translationsMap: {}): void


declare function i18n$getTranslation(key: string, params?: GetTranslationParams): string


declare function i18n$getTranslation(namespace: string, key: string, params: GetTranslationParams): string
...
declare function i18n$__(namespace: string, key: string, params: GetTranslationParams): string


declare function i18n$__(...key: string[]): string


declare function i18n$getTranslations(namespace: string, locale?: string): string[]
...
declare function i18n$setLocale(locale: string, params?: LocateParams): Promise<void>


declare function i18n$setLocaleOnConnection(locale: string, connectionId?: number): void


declare function i18n$getLocale(): string


declare function i18n$loadLocale(locale: string, params?: LoadLocaleParams): void


declare function i18n$runWithLocale(locale: string, func: (...keys: any[]) => void): void


declare function i18n$getLanguages(type?: "code" | "name" | "nativeNames"): string[]
...
declare function i18n$getAllKeysForLocale(locale?: string, excactlyThis?: boolean): string[]
