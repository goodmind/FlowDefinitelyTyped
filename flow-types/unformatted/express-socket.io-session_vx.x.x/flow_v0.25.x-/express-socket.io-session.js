...
options?: sharedsession$sharedsession$SharedSessionOptions): sharedsession$sharedsession$SocketIoSharedSessionMiddleware
...
declare type sharedsession$SocketIoSharedSessionMiddleware = (socket: socketio.Socket, next: (err?: any) => void) => void;
