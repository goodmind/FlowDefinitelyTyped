...
static createSelfSigned(subjectOrSubjects: string, key: SshPK$Key, options: any): SshPK$Certificate;
static create(
subjectOrSubjects: string,
key: SshPK$Key,
issuer: string,
issuerKey: SshPK$PrivateKey,
options: any): SshPK$Certificate;
static parse(data: string | Buffer, format: string, options: any): SshPK$Certificate;
...
static parse(data: string | Buffer, format: string, options: any): SshPK$Key;
...
static parse(data: string | Buffer, format: string, options: any): SshPK$PrivateKey;
...
toString(format: string): string;
static parse(data: string | Buffer, type: string, format: string): SshPK$Signature;
...
declare function SshPK$calculateDSAPublic(g: Buffer, p: Buffer, x: Buffer): Buffer
...
declare function SshPK$assertCompatible(obj: any, klass: any, needVer: string, name: string): void


declare function SshPK$isCompatible(obj: any, klass: any, needVer: string): boolean
...
salt: string,
passphrase: string,
count: number): SshPK$OpenSllKeyDeriv
...
declare function SshPK$opensshCipherInfo(cipber: string): SshPK$OpensshCipherInfo


declare function SshPK$parseKey(data: string | Buffer, format: string, options?: any): SshPK$Key


declare function SshPK$parseFingerprint(fp: string, options?: any): SshPK$Fingerprint


declare function SshPK$parseSignature(data: string | Buffer, type: string, format: string): SshPK$Signature


declare function SshPK$parsePrivateKey(data: string | Buffer, format: string, options?: any): SshPK$PrivateKey


declare function SshPK$parseCertificate(data: string | Buffer, format: string, options?: any): SshPK$Certificate


declare function SshPK$createSelfSignedCertificate(subjectOrSubjects: string, key: SshPK$Key, options?: any): SshPK$Certificate
...
declare function SshPK$identityForEmail(email: string): SshPK$Identity
	...
	declare module.exports: typeof SshPK
