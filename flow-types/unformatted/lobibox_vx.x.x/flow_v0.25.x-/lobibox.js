...
alert: {
<T: LobiboxModule$MessageBoxesDefault>(type: string, options?: T): LobiboxModule$LobiboxStatic,
...
confirm: {
<T: LobiboxModule$MessageBoxesDefault>(options?: LobiboxModule$ConfirmOptions): T,
DEFAULTS: LobiboxModule$ConfirmOptions
},
progress: {
<T: LobiboxModule$MessageBoxesDefault>(options: LobiboxModule$ProgressOptions): T,
DEFAULTS: LobiboxModule$ProgressOptions
},
window: {
<T: LobiboxModule$MessageBoxesDefault>(options: LobiboxModule$WindowOptions): T,
DEFAULTS: LobiboxModule$WindowOptions
},
notify: {
<T: LobiboxModule$NotifyDefault>(type: string, options?: LobiboxModule$NotifyOptions): T,
