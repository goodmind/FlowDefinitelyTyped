 ...
 */
CreateObject<K: $Keys<ActiveXObjectNameMap>= any>(
strProgID: K,
strPrefix?: string): $ElementType<ActiveXObjectNameMap, K>,
 ...
 * @param strPrefix Function names in the form prefix_event will be bound to this object's COM events.
 */
GetObject<K: $Keys<ActiveXObjectNameMap>>(
strPathname: string,
strProgID: K,
strPrefix?: string): $ElementType<ActiveXObjectNameMap, K>,
