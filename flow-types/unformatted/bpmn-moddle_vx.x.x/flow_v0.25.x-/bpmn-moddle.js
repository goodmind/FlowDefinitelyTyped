...
declare type BPMNModdle$ChoreographyLoopType = "None" | "Standard" | "MultiInstanceSequential" | "MultiInstanceParallel";

declare type BPMNModdle$EventBasedGatewayType = "Parallel" | "Exclusive";

declare type BPMNModdle$GatewayDirection = "Unspecified" | "Converging" | "Diverging" | "Mixed";

declare type BPMNModdle$ItemKind = "Physical" | "Information";

declare type BPMNModdle$MultiInstanceBehaviour = "None" | "One" | "All" | "Complex";

declare type BPMNModdle$ProcessType = "None" | "Public" | "Private";

declare type BPMNModdle$RelationshipDirection = "None" | "Forward" | "Backward" | "Both";
...
} & BPMNModdle$FlowElementsContainer & BPMNModdle$CallableElement
...
properties: BPMNModdle$Property[]
} & BPMNModdle$FlowNode & BPMNModdle$InteractionNode
 ...
 */
isCollection: boolean
} & BPMNModdle$FlowElement & BPMNModdle$ItemAwareElement
...
capacity: number,
isUnlimited: boolean
} & BPMNModdle$RootElement & BPMNModdle$ItemAwareElement
...
} & BPMNModdle$ItemAwareElement & BPMNModdle$FlowElement
...
} & BPMNModdle$InteractionNode & BPMNModdle$BaseElement
...
name: string,
type: BPMNModdle$ItemDefinition
} & BPMNModdle$RootElement
...
artifacts: BPMNModdle$Artifact[]
} & BPMNModdle$ChoreographyActivity & BPMNModdle$FlowElementsContainer
...
declare type BPMNModdle$Choreography = {} & BPMNModdle$FlowElementsContainer & BPMNModdle$Collaboration
...
artifacts: BPMNModdle$Artifact[]
} & BPMNModdle$Activity & BPMNModdle$FlowElementsContainer & BPMNModdle$InteractionNode
...
declare type BPMNModdle$Task = {} & BPMNModdle$Activity & BPMNModdle$InteractionNode
...
er: string,
relationship: BPMNModdle$Relationship[],
erVersion: string
} & BPMNModdle$BaseElement
...
declare type BPMNModdle$ImportFn = (err: Error, definitions: BPMNModdle$Definitions, parseContext: any) => void;
 ...
 */
create<T= BPMNModdle$ElementTypes, K: $Keys<T>= $Keys<T>>(
descriptor: K,
attrs?: any): $ElementType<T, K>,
 ...
 * @param done done callback
 */
fromXML(xmlStr: string, options: BPMNModdle$Option, done: BPMNModdle$ImportFn): void,
