...
data: any,
error: any
} declare type LoginStatus = "connected" | "not_authorized" | "unknown";declare type ApiMethod = "get" | "post" | "delete";declare interface AuthResponse {
accessToken: string,
expiresIn: number,
...
handler: (fbResponseObject: LiveDialogResponse) => any): void,
getLoginStatus(
