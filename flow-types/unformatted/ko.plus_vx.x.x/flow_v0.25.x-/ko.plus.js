...
command: (param: Function | KoPlus$KoPlus$CommandOptions) => KoPlus$KoPlus$Command,
...
declare export type KoPlus$Editable<T> = {} & KnockoutObservable<T> & KoPlus$EditableFunctions


declare export type KoPlus$EditableArray<T> = {} & KnockoutObservableArray<T> & KoPlus$EditableFunctions
declare var ko: KnockoutStatic;declare module 'ko.plus' {
