 ...
 */
get<K: $Keys<T> | string | null | void= void>(
...
notation to reference nested values
 */
default<K: $Keys<T> | string | null | void= void>(
name?: K): "There was Conditional Type, use $Call utility type",
 ...
 */
has<K: $Keys<T> | string= string>(name: K): boolean,
...
<T>(config: convict$convict$Schema<T> | string): convict$convict$Config<T>
} 
