 ...
 */
declare export class decorum$CustomValidator<TModel> mixins decorum$BaseValidator {
 ...
 * An email validator.
 */
declare export class decorum$EmailValidator mixins decorum$PatternValidator {
 ...
 */
declare export class decorum$LengthValidator mixins decorum$BaseValidator {
length: number;
 ...
 */
declare export class decorum$MaxLengthValidator mixins decorum$BaseValidator {
maxLength: number;
 ...
 */
declare export class decorum$MinLengthValidator mixins decorum$BaseValidator {
minLength: number;
 ...
 */
declare export class decorum$PatternValidator mixins decorum$BaseValidator {
pattern: RegExp;
 ...
 */
declare export class decorum$RequiredFieldValidator mixins decorum$BaseValidator {
