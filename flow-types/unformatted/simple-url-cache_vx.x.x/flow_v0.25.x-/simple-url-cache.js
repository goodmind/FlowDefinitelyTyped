...
declare module 'RedisPool' {
	...
	declare export class FileStorage mixins privateN$privateN$CacheCategory, privateN$privateN$CacheStorage {
...
destroy(): void
	...
	declare export class RedisStorage mixins privateN$privateN$CacheCategory, privateN$privateN$CacheStorage {
