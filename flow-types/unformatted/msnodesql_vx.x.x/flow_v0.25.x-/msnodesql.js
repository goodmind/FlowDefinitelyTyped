...
query: string,
callback: QueryCallback<any>): StreamEvents
...
connectionString: string,
query: string,
callback: QueryCallback<T>): StreamEvents
...
connectionString: string,
query: string,
callback: QueryRawCallback): StreamEvents
...
beginTransaction<<UNKNOWN PARAM FORMAT>>,
commit<<UNKNOWN PARAM FORMAT>>,
rollback<<UNKNOWN PARAM FORMAT>>,
close<<UNKNOWN PARAM FORMAT>>,
close<<UNKNOWN PARAM FORMAT>>
} 
	declare type StreamEvents = {} & events.EventEmitter
