...
apply1<B, C>(ob: scalike$Optional<B>, f: (a: A, b: B) => C): scalike$Optional<C>,
apply2<B, C, D>(
...
chain<F>(of: scalike$Optional<F>): scalike$OptionalBuilder5<A, B, C, D, E, F>
}
...
toOptional(): scalike$Optional<A>,
Future$failed(): scalike$Try<A>,
transform<B>(
fs: (a: A) => scalike$Try<B>,
ff: (e: Error) => scalike$Try<B>): scalike$Try<B>,
recover<B: A>(f: (e: Error) => scalike$Optional<scalike$Try<B>>): scalike$Try<A>,
...
Future$failed(): scalike$Future<Error>,
...
recoverWith<B: A>(f: (e: Error) => scalike$Optional<scalike$Future<B>>): scalike$Future<A>,
zip<B>(fu: scalike$Future<B>): scalike$Future<[A, B]>,
zipWith<B, C>(fu: scalike$Future<B>, f: (a: A, b: B) => C): scalike$Future<C>,
fallbackTo<B: A>(fu: scalike$Future<B>): scalike$Future<A>,
andThen<B>(f: (t: scalike$Try<A>) => B): scalike$Future<A>,
apply1<B, C>(ob: scalike$Future<B>, f: (a: A, b: B) => C): scalike$Future<C>,
apply2<B, C, D>(
ob: scalike$Future<B>,
oc: scalike$Future<C>,
...
declare export function scalike$Future<A>(f: Promise<A> | (() => A)): scalike$Future<A>
