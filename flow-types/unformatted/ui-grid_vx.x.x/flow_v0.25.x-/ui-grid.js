 ...
 */
(rowEntity: TEntity, colDef: uiGrid$IColumnDefOf<TEntity>, newValue: any, oldValue: any): void
} 
...
(rowEntity: TEntity, colDef: uiGrid$IColumnDefOf<TEntity>, triggerEvent: JQueryEventObject): void
} 
 ...
 */
importerDataAddCallback?: (grid: uiGrid$IGridInstanceOf<TEntity>, newObjects: Array<TEntity>) => void,
 ...
 */
importerObjectCallback?: (grid: uiGrid$IGridInstanceOf<TEntity>, newObject: TEntity) => TEntity,
...
grid: uiGrid$IGridInstanceOf<TEntity>,
headerArray: Array<string>) => Array<string>,
 ...
 * @param {ng.IAngularEvent} event object if raised from event
 */
(row: Array<uiGrid$uiGrid$IGridRowOf<TEntity>>, event?: ng.IAngularEvent): void
} 
    }
...
declare export type uiGrid$IGridRow = uiGrid$IGridRowOf<any>;
...
} & cellNav.uiGrid$IGridRow & edit.uiGrid$IGridRow & exporter.uiGrid$IGridRow & selection.uiGrid$IGridRow & expandable.uiGrid$IGridRow
 ...
 */
declare export type uiGrid$IColumnDef = uiGrid$IColumnDefOf<any>;
 ...
 */
width?: number | string
} & cellNav.uiGrid$IColumnDef & edit.uiGrid$IColumnDef<TEntity> & exporter.uiGrid$IColumnDef & grouping.uiGrid$IColumnDef & moveColumns.uiGrid$IColumnDef & pinning.uiGrid$IColumnDef & resizeColumns.uiGrid$IColumnDef & treeBase.uiGrid$IColumnDef<TEntity>
