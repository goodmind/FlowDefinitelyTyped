...
static +read_public: Class<PDK$OAuthScopes__read_public> & PDK$OAuthScopes__read_public & 0;// 0
static +write_public: Class<PDK$OAuthScopes__write_public> & PDK$OAuthScopes__write_public & 1;// 1
static +read_relationships: Class<PDK$OAuthScopes__read_relationships> & PDK$OAuthScopes__read_relationships & 2;// 2
static +write_relationships: Class<PDK$OAuthScopes__write_relationships> & PDK$OAuthScopes__write_relationships & 3;// 3
 ...
 * @param cb the callback export function to handle the response
 */
declare export function PDK$me(path: string, params: Object, callback: Function): void
 ...
 */
declare export function PDK$pin(imageUrl: string, note: string, url: string, callback: Function): void
