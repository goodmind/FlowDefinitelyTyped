...
declare type l$CallbackWithMultipleResults<T, G> = (err: Error | null, arg0: T, arg1: G) => any;
 ...
 */
static configureModel(ModelCtor: l$Model, config: {
dataSource: any,
relations?: any
}): void;
 ...
 */
static createDataSource(name: string, options: {
connector: any,
properties?: any
}): void;
 ...
 * @header loopback.configureModel(ModelCtor, config
 */
configureModel(ModelCtor: l$Model, config: {
dataSource: any,
relations?: any
}): void;
...
See the relevant connector documentation
 */
createDataSource(name: string, options: {
connector: any,
properties?: any
}): void;
...
constructor(model: string, property: string, accessType: string, permission: string): this;
...
sharedMethod: any,
ctx: any,
callback: (err: string | Error, allowed: boolean) => void): void;
 ...
 */
static bulkUpdate(updates: any[], options: any, callback: l$CallbackWithoutResult): void;
 ...
 */
static changes(since: number, filter: any, callback: l$CallbackWithResult<any>): void;
...
static create<T= any>(
data: any | any[],
callback: l$CallbackWithResult<T | T[] | null>): void;
...
where: any
}, callback: l$CallbackWithResult<any>): void;
 ...
 * @param {() => void} callback
 */
static createUpdates(deltas: any[], callback: l$CallbackWithoutResult): void;
 ...
 */
static destroyAll(where: any, callback: l$CallbackWithMultipleResults<any, number>): void;
 ...
 */
static destroyAll(where?: any): Promise<{
info: any,
infoCount: number
}>;
 ...
 */
static diff(since: number, remoteChanges: any[], callback: l$CallbackWithResult<any>): void;
...
callback: l$CallbackWithResult<T[]>): void;
 ...
 */
static findById<T= any>(id: any, callback: l$CallbackWithResult<T>): void;
 ...
 */
static findOne<T= any>(callback: l$CallbackWithResult<T>): void;
 ...
 */
static findOrCreate<T= any>(data: any, callback: l$CallbackWithMultipleResults<T, boolean>): void;
...
callback: l$CallbackWithMultipleResults<T, boolean>): void;
 ...
 */
static replaceById<T= any>(id: any, data: any, callback: l$CallbackWithResult<T>): void;
 ...
 * @property {boolean} validate Perform validation before saving.  Default is true.
 */
static replaceById<T= any>(id: any, data: any, options?: {
validate: boolean
}): Promise<T>;
 ...
 * @callback {() => void} callback Callback function called with `cb(err, obj)` signature.
 */
static replaceOrCreate<T= any>(data: any, callback: l$CallbackWithResult<T>): void;
 ...
 * @property {boolean} validate Perform validation before saving.  Default is true.
 */
static replaceOrCreate<T= any>(data: any, options?: {
validate: boolean
}): Promise<T>;
...
options?: any,
optionsFilter?: any,
callback?: (err: Error, conflicts: l$Conflict[], param: any) => void): Promise<{
 ...
 */
static updateAll(callback: l$CallbackWithMultipleResults<any, number>): void;
 ...
 * @callback {() => void} callback Callback function called with `(err, info)` arguments.  Required.
 */
static updateAll(whereOrData: any, callback: l$CallbackWithMultipleResults<any, number>): void;
...
where: any,
data: any,
callback: l$CallbackWithMultipleResults<any, number>): void;
 ...
 * @callback {() => void} callback Callback function called with `cb(err, obj)` signature.
 */
static upsert<T= any>(data: any, callback: l$CallbackWithResult<T>): void;
 ...
 * @callback {() => void} callback Callback function called with `cb(err, obj)` signature.
 */
static upsertWithWhere<T= any>(data: any, callback: l$CallbackWithResult<T>): void;
 ...
 * @callback {() => void} callback Callback function called with `(err, instance)` arguments.  Required.
 */
reload<T= any>(callback: l$CallbackWithResult<T>): void;
 ...
 * @callback {() => void} callback Callback function called with `(err, instance)` arguments.
 */
replaceAttributes<T= any>(data: any, callback: l$CallbackWithResult<T>): void;
 ...
 * @property {boolean} validate Perform validation before saving.  Default is true.
 */
replaceAttributes<T= any>(data: any, options?: {
validate: boolean
}): Promise<T>;
 ...
 */
save<T= any>(callback: l$CallbackWithResult<T>): void;
 ...
 *              *
 */
updateAttribute<T= any>(name: string, value: any, callback: l$CallbackWithResult<T>): void;
 ...
 * @callback {() => void} callback Callback function called with `(err, instance)` arguments.  Required.
 */
updateAttributes<T= any>(data: any, callback: l$CallbackWithResult<T>): void;
 ...
 * @callback {() => void} callback
 */
static createAccessTokenId(callback: (err: Error, l$token: string) => void): void;
...
req: any,
options?: any,
callback?: (err: Error, l$token: l$AccessToken) => void): void;
...
property: string,
accessType: string,
callback: (err: string | Error, result: l$AccessRequest) => void): void;
...
modelName: string,
modelId: string,
callback: (err: Error, change: l$Change) => void): void;
...
modelName: string,
modelIds: any[],
callback: (err: Error, changes: any[]) => void): void;
...
source: any;
target: any;
constructor(modelId: any, SourceModel: l$PersistedModel, TargetModel: l$PersistedModel): this;
 ...
 */
changes(
callback: (err: Error, sourceChange: l$Change, targetChange: l$Change) => void): void;
 ...
 */
models(
callback: (err: Error, source: l$PersistedModel, target: l$PersistedModel) => void): void;
...
key: string,
option?: any,
callback?: (err: Error, result: any) => void): PromiseLike<any>;
...
value: any,
options?: number | any,
callback?: (err: Error) => void): PromiseLike<any>;
...
role: string,
context: any,
callback: (err: Error, isInRole: boolean) => void): void;
...
role: string,
ctx: l$Context,
callback?: (err: Error, resolved: boolean) => void) => Promise<boolean> | void): void
}
 ...
 * @callback {() => void} callback
 */
application(callback: (err: Error, application: l$Application) => void): void;
...
l$token: string,
redirect: string,
callback?: (err: Error) => void): Promise<void> | void;
...
callback?: (err: Error, l$token: l$AccessToken) => void): Promise<l$AccessToken> | void;
...
ttl: number,
options?: any,
callback?: (err: string | Error, l$token: l$AccessToken) => void): Promise<l$AccessToken> | void;
...
hasPassword(
password: string,
callback?: (err: Error, isMatch: boolean) => void): Promise<boolean> | void;
