declare module 'redux-first-router' {
	...
	declare export type StateGetter<TState= any> = () => TState;
	...
	declare export type RouteThunk<TState= any> = (dispatch: Dispatch<any>, getState: StateGetter<TState>) => any | Promise<any>;
	declare export type RouteObject<TKeys= {}, TState= any> = TKeys & {
...
meta?: Meta
	...
	declare export type Route<TKeys= {}, TState= any> = RouteString | RouteObject<TKeys, TState>;
	declare export interface RoutesMap<TKeys= {}, TState= any> {
...
search?: string
	...
	declare export interface LocationState<TKeys= {}, TState= any> {
pathname: string,
type: string,
payload: Payload,
query?: {[key: string]: any},
...
search?: string
	...
	declare export interface Router<TState= any> {
...
getActionForPathAndParams(path: string): Nullable<{[key: string]: any}>
	...
	declare export interface Navigator<TState= any> {
router: Router<TState>
} 
	declare export interface Navigators<TState= any> {
[key: string]: Navigator<TState>
} 
	declare export type SelectLocationState<TKeys= {}, TState= any> = (state: TState) => LocationState<TKeys, TState>;
	declare export type SelectTitleState<TState= any> = (state: TState) => string;
	declare export interface QuerySerializer {
stringify(params: Params): string,
parse(queryString: string): {[key: string]: any}
} 
	declare export interface NavigatorsConfig<TKeys= {}, TState= any> {
...
extra: any
	...
	declare export interface Options<TKeys= {}, TState= any> {
...
extra?: any
	...
	declare export function actionToPath<TKeys= {}, TState= any>(
...
querySerializer?: QuerySerializer): string
	...
	declare export function connectRoutes<TKeys= {}, TState= any>(
routesMap: RoutesMap<TKeys, TState>,
...
initialDispatch?: () => void
	...
	declare export function pathToAction<TKeys= {}, TState= any>(
pathname: string,
routesMap: RoutesMap<TKeys, TState>,
