 ...
 */
length: 4
} & Array<QuadtreeInternalNode<T> | QuadtreeLeaf<T> | void>
 ...
 */
declare export function quadtree<T= [number, number]>(): Quadtree<T>
 ...
 * @param y The y-coordinate accessor.
 */
declare export function quadtree<T= [number, number]>(
data: T[],
x?: (d: T) => number,
y?: (d: T) => number): Quadtree<T>
