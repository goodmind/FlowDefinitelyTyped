 ...
 */
declare export function watchPath(
rootPath: string,
options: {},
eventCallback: (events: FilesystemChangeEvent) => void): Promise<PathWatcher>
 ...
 */
declare export interface AtomEnvironment {
 ...
 */
getCurrentWindow(): {[key: string]: any},
...
callback: (response: number, checkboxChecked: boolean) => void): void,
 ...
 * using CSS selectors.
 */
declare export interface CommandRegistry {

/**
 * Register a single command.
 */
add<T: $Keys<CommandRegistryTargetMap>>(
target: T,
commandName: string,
listener: CommandRegistryListener<$ElementType<CommandRegistryTargetMap, T>>): Disposable,
...
target: T,
commandName: string,
listener: CommandRegistryListener<T>): Disposable,
...
target: T,
commands: {
[key: string]: CommandRegistryListener<$ElementType<CommandRegistryTargetMap, T>>
}): CompositeDisposable,
 ...
 */
observe<T: $Keys<ConfigValues>>(
keyPath: T,
callback: (value: $ElementType<ConfigValues, T>) => void): Disposable,
 ...
 * callback will be called on changes to any key.
 */
onDidChange<T: $Keys<ConfigValues>>(
keyPath: T,
callback: (
values: {
newValue: $ElementType<ConfigValues, T>,
oldValue?: $ElementType<ConfigValues, T>
}) => void): Disposable,
 ...
 */
get<T: $Keys<ConfigValues>>(
keyPath: T,
options?: {
sources?: string[],
excludeSources?: string[],
scope?: string[] | ScopeDescriptor
}): $ElementType<ConfigValues, T>,

/**
 * Sets the value for a configuration setting.
 * This value is stored in Atom's internal configuration file.
 */
set<T: $Keys<ConfigValues>>(
keyPath: T,
value: $ElementType<ConfigValues, T>,
options?: {
 ...
 */
getSchema(keyPath: string): {[key: string]: any} | null,
 ...
 * of text.
 */
declare export interface Decoration {
 ...
 */
declare export interface DisplayMarker {
 ...
 */
setBufferRange(bufferRange: RangeCompatible, properties?: {
reversed: boolean
}): void,
 ...
 */
declare export interface DisplayMarkerLayer {
 ...
 */
declare export class Emitter<OptionalEmissions= {
[key: string]: any
}, RequiredEmissions= {}> mixins DisposableLike {
 ...
 */
declare export interface LayerDecoration {
 ...
 */
declare export interface MarkerLayer {
 ...
 * Get an existing marker by its id.
 */
getMarker(id: number): Marker | void,
...
constructor(type: "warning" | "info" | "success", message: string, options?: NotificationOptions): this;
constructor(type: "fatal" | "error", message: string, options?: ErrorNotificationOptions): this;
 ...
 */
constructor(pointA?: PointCompatible, pointB?: PointCompatible): this;

/**
 * Call this with the result of Range::serialize to construct a new Range.
 */
static deserialize(array: {[key: string]: any}): Range;
...
range: RangeCompatible,
text: string,
options?: TextEditOptions & ReadonlyEditOptions): Range;
insertText(
text: string,
options?: TextInsertionOptions & ReadonlyEditOptions): Range | false;
 ...
 */
getMarkerLayer(id: number): DisplayMarkerLayer | void;
 ...
 */
setCursorBufferPosition(position: PointCompatible, options?: {
autoscroll?: boolean
}): void;
 ...
 */
getCursorAtScreenPosition(position: PointCompatible): Cursor | void;
 ...
 * If there are multiple cursors, they will be consolidated to a single cursor.
 */
setCursorScreenPosition(position: PointCompatible, options?: {
autoscroll?: boolean
}): void;
 ...
 * they are reduced to a single selection with the given range.
 */
setSelectedScreenRange(screenRange: RangeCompatible, options?: {
reversed?: boolean
}): void;
 ...
 */
selectMarker(marker: DisplayMarker): Range | void;
 ...
 */
scrollToBufferPosition(bufferPosition: PointCompatible, options?: {
center?: boolean
}): void;
 ...
 */
scrollToScreenPosition(screenPosition: PointCompatible, options?: {
center?: boolean
}): void;
...
scopes: string[]
	...
	declare export interface GutterOptions {
...
onMouseMove?: (lineData: LineData) => void
	...
	declare export interface LineData {
 ...
 */
declare export type LineDataExtended = {
...
maxDigits: number
	...
	declare export interface PixelPosition {
left: number,
top: number
} 
 ...
 */
declare export interface TextEditorComponent {
 ...
 */
declare export type TextEditorElement = {
getModel(): TextEditor,
 ...
 */
declare export interface TextEditorRegistry {
...
observe(callback: (editor: TextEditor) => void): Disposable
	...
	declare export type TooltipPlacement = "top"
| "bottom"
| "left"
| "right"
| "auto"
 ...
 */
declare export interface TooltipManager {
 ...
 */
declare export interface ViewRegistry {
 ...
 */
addViewProvider(createView: (model: {[key: string]: any}) => HTMLElement | void): Disposable,
 ...
 * workspace.
 */
observePaneItems(callback: (item: {[key: string]: any}) => void): Disposable,

/**
 * Invoke the given callback when the active pane item changes.
 */
onDidChangeActivePaneItem(callback: (item: {[key: string]: any}) => void): Disposable,

/**
 * Invoke the given callback when the active pane item stops changing.
 */
onDidStopChangingActivePaneItem(callback: (item: {[key: string]: any}) => void): Disposable,
 ...
 */
observeActivePaneItem(callback: (item: {[key: string]: any}) => void): Disposable,
 ...
 */
open(uri: string, options?: WorkspaceOpenOptions): Promise<{[key: string]: any}>,
 ...
 */
hide(itemOrURI: {[key: string]: any} | string): boolean,
 ...
 */
toggle(itemOrURI: {[key: string]: any} | string): Promise<void>,
 ...
 * will be created.
 */
createItemForURI(uri: string): Promise<{[key: string]: any} | TextEditor>,

/**
 * Returns a boolean that is true if object is a TextEditor.
 */
isTextEditor(object: {[key: string]: any}): boolean,

/**
 * Asynchronously reopens the last-closed item's URI if it hasn't already
 * been reopened.
 */
reopenItem(): Promise<{[key: string]: any} | void>,

/**
 * Register an opener for a URI.
 */
addOpener(
opener: (uri: string, options?: WorkspaceOpenOptions) => ViewModel | void): Disposable,

/**
 * Create a new text editor.
 */
buildTextEditor(params: {[key: string]: any}): TextEditor,

/**
 * Get all pane items in the workspace.
 */
getPaneItems(): {[key: string]: any}[],

/**
 * Get the active Pane's active item.
 */
getActivePaneItem(): {[key: string]: any},
 ...
 */
paneContainerForURI(uri: string): Dock | WorkspaceCenter | void,

/**
 * Get the first pane container that contains the given item.
 */
paneContainerForItem(item: {[key: string]: any}): Dock | WorkspaceCenter | void,

/**
 * Get the first Pane with an item for the given URI.
 */
paneForURI(uri: string): Pane | void,

/**
 * Get the Pane containing the given item.
 */
paneForItem(item: {[key: string]: any}): Pane | void,
...
scan(
regex: RegExp,
iterator: (result: ScandalResult) => void): CancellablePromise<string | null>,
 ...
 */
declare export interface WorkspaceCenter {
 ...
 * Get the active Pane's active item.
 */
getActivePaneItem(): {[key: string]: any} | void,
...
constructor(options: ProcessOptions): this;
 ...
 */
declare export class BufferedNodeProcess mixins BufferedProcess {

/**
 * Runs the given Node script by spawning a new child process.
 */
constructor(options: NodeProcessOptions): this
}
 ...
 */
write(text: string, metadata?: {[key: string]: any}): void,
 ...
 */
declare export interface ContextMenuManager {
 ...
 */
setScreenPosition(screenPosition: PointCompatible, options?: {
autoscroll?: boolean
}): void,
 ...
 */
setBufferPosition(bufferPosition: PointCompatible, options?: {
autoscroll?: boolean
}): void,
 ...
 */
declare export interface DeserializerManager {
 ...
 */
deserialize(state: {[key: string]: any}): {[key: string]: any} | void
} 
 ...
 */
getEntries(
callback: (error: Error | null, entries: Array<File | Directory>) => void): void;
 ...
 */
declare export interface Grammar {
 ...
 */
declare export interface GrammarRegistry {
 ...
 */
declare export interface Gutter {
 ...
 */
onDidChangeProjects(callback: (args: {
reloaded: boolean
}) => void): Disposable
} 
 ...
 */
declare export interface KeymapManager {
 ...
 * it changes.
 */
watchKeymap(filePath: string, options?: {
priority: number
}): void,
 ...
 */
declare export interface MenuManager {
 ...
 */
declare export interface Package {
 ...
 */
declare export interface PackageManager {
 ...
 */
resolvePackagePath(name: string): string | void,
 ...
 */
enablePackage(name: string): Package | void,

/**
 * Disable the package with the given name.
 */
disablePackage(name: string): Package | void,
 ...
 */
getActivePackage(name: string): Package | void,
 ...
 */
getLoadedPackage(name: string): Package | void,
 ...
 */
observeItems(callback: (item: {[key: string]: any}) => void): Disposable,

/**
 * Invoke the given callback when the value of ::getActiveItem changes.
 */
onDidChangeActiveItem(callback: (activeItem: {[key: string]: any}) => void): Disposable,
 ...
 */
onChooseNextMRUItem(callback: (nextRecentlyUsedItem: {[key: string]: any}) => void): Disposable,
 ...
 */
onChooseLastMRUItem(callback: (previousRecentlyUsedItem: {[key: string]: any}) => void): Disposable,
 ...
 */
observeActiveItem(callback: (activeItem: {[key: string]: any}) => void): Disposable,
 ...
 */
getActiveItem(): {[key: string]: any},

/**
 * Return the item at the given index.
 */
itemAtIndex(index: number): {[key: string]: any} | void,
 ...
 */
activateItem(item: {[key: string]: any}, options?: {
pending: boolean
}): void,
 ...
 */
addItems(items: {[key: string]: any}[], index?: number): {[key: string]: any}[],

/**
 * Move the given item to the given index.
 */
moveItem(item: {[key: string]: any}, index: number): void,

/**
 * Move the given item to the given index on another pane.
 */
moveItemToPane(item: {[key: string]: any}, pane: Pane, index: number): void,
 ...
 */
destroyItem(item: {[key: string]: any}, force?: boolean): Promise<boolean>,
 ...
 */
itemForURI(uri: string): {[key: string]: any} | void,
 ...
 */
declare export interface Panel<T= {[key: string]: any}> {
 ...
 */
declare export type PathWatcher = {
 ...
 */
declare export interface Project {
 ...
 */
onDidReplace(
callback: (projectSpec: ProjectSpecification | null | void) => void): Disposable,
 ...
 */
declare export interface ScopeDescriptor {
...
fullLine?: boolean,
options?: ReadonlyEditOptions): void,
 ...
 */
declare export interface StyleManager {
 ...
 */
declare export class TextBuffer  {
 ...
 */
static deserialize(params: {[key: string]: any}): Promise<TextBuffer>;
 ...
 */
getMarkerLayer(id: string): MarkerLayer | void;
 ...
 */
declare export interface ThemeManager {
...
getEnabledThemeNames(): string[]
	...
	declare export interface AddedKeystrokeResolverEvent {
...
keymap: {[key: string]: any}
	...
	declare export interface BufferChangingEvent {
...
oldRange: Range
	...
	declare export interface BufferChangedEvent {
...
newText: string
	...
	declare export interface BufferStoppedChangingEvent {
changes: TextChange[]
} 
 ...
 * detached elements.
 */
declare export type CommandEvent<CurrentTarget: EventTarget= EventTarget> = {
...
currentTarget: CurrentTarget
	...
	declare export interface CursorPositionChangedEvent {
...
cursor: Cursor
	...
	declare export interface DecorationPropsChangedEvent {
...
newProperties: DecorationOptions
	...
	declare export interface DisplayMarkerChangedEvent {
...
textChanged: boolean
	...
	declare export interface EditorChangedEvent {
...
newExtent: Point
	...
	declare export interface ExceptionThrownEvent {
originalError: Error,
message: string,
url: string,
line: number,
column: number
	...
	declare export interface FailedKeybindingMatchEvent {
...
keyboardEventTarget: Element
	...
	declare export interface FailedKeymapFileReadEvent {
...
stack: string
	...
	declare export interface FileSavedEvent {
...
path: string
	...
	declare export interface FilesystemChangeBasic<Action: "created" | "modified" | "deleted" | "renamed"= "created" | "modified" | "deleted"> {
...
path: string
	...
	declare export type FilesystemChangeRename = {
...
keyboardEventTarget: Element
	...
	declare export interface HandleableErrorEvent {
...
handle(): void
	...
	declare export interface KeymapLoadedEvent {
...
path: string
	...
	declare export interface MarkerChangedEvent {
...
textChanged: boolean
	...
	declare export interface PaneItemObservedEvent {
item: {[key: string]: any},
pane: Pane,
index: number
} 
	declare export interface PaneListItemShiftedEvent {
...
index: number
	...
	declare export interface PaneItemMovedEvent {
...
newIndex: number
	...
	declare export type PaneItemOpenedEvent = {
uri: string
} & PaneItemObservedEvent

	declare export interface PartialKeybindingMatchEvent {
...
handle(): void
	...
	declare export type PreventableExceptionThrownEvent = {
preventDefault(): void
} & ExceptionThrownEvent

	declare export interface RepoStatusChangedEvent {
path: string,
...
pathStatus: number
	...
	declare export interface SelectionChangedEvent {
...
selection: Selection
	...
	declare export type StyleElementObservedEvent = {
sourcePath: string,
context: string
} & HTMLStyleElement

	declare export interface TextEditorObservedEvent {
 ...
 */
declare export interface ConfigValues {
...
[key: string]: any
	...
	declare export interface BufferLoadOptions {
...
shouldDestroyOnFileDelete?: () => boolean
	...
	declare export interface BuildEnvironmentOptions {
 ...
 */
applicationDelegate?: {[key: string]: any},
...
enablePersistence?: boolean
	...
	declare export interface ConfirmationOptions {
...
normalizeAccessKeys?: boolean
	...
	declare export interface ContextMenuItemOptions {
...
afterGroupContaining?: $ReadOnlyArray<string>
	...
	declare export type ContextMenuOptions = ContextMenuItemOptions | {
type: "separator"
};
	declare export interface CopyMarkerOptions {
...
properties?: {[key: string]: any}
	...
	declare export type DecorationLayerOptions = {
...
type?: "line" | "line-number" | "highlight" | "block"
	...
	declare export type DecorationOptions = {
...
gutterName?: string
	...
	declare export type ErrorNotificationOptions = {
stack?: string
} & NotificationOptions

	declare export interface FindDisplayMarkerOptions {
...
intersectsScreenRange?: RangeCompatible
	...
	declare export interface FindMarkerOptions {
...
intersectsRow?: number
	...
	declare export interface HistoryTransactionOptions {
...
selectionsMarkerLayer?: MarkerLayer
	...
	declare export interface HistoryTraversalOptions {
...
command?: string
	...
	declare export interface NodeProcessOptions {
...
exit?: (code: number) => void
	...
	declare export interface NotificationOptions {
buttons?: Array<{
className?: string,
...
icon?: string
	...
	declare export type ProcessOptions = {
...
autoStart?: boolean
	...
	declare export interface ReadonlyEditOptions {
...
bypassReadOnly?: boolean
	...
	declare export interface ScanContextOptions {
...
trailingContextLineCount?: number
	...
	declare export interface SharedDecorationOptions {
...
avoidOverflow?: boolean
	...
	declare export interface SpawnProcessOptions {
...
shell?: boolean | string
	...
	declare export interface TextEditOptions {
...
undo?: "skip"
	...
	declare export type TextInsertionOptions = {
...
trigger?: string
	...
	declare export interface WorkspaceOpenOptions {
...
location?: "left" | "right" | "bottom" | "center"
	...
	declare export interface WorkspaceScanOptions {
...
name: string,
deserialize(state: {[key: string]: any}): {[key: string]: any}
} 
	declare export interface DisposableLike {
dispose(): void
} 
	declare export type JQueryCompatible<Element: Node= HTMLElement> = {
jquery: string
} & Iterable<Element>
 ...
 */
declare export type PointCompatible = PointLike | [number, number];
	
/**
 * The interface that should be implemented for all "point-compatible" objects.
 */
declare export interface PointLike {
 ...
 */
declare export type RangeCompatible = RangeLike
| [PointLike, PointLike]
 ...
 */
declare export interface RangeLike {
 ...
 */
declare export type TestRunner = (params: TestRunnerParams) => Promise<number>;
	declare export interface BufferScanResult {
buffer: TextBuffer,
lineText: string,
...
stopped: boolean
	...
	declare export type CancellablePromise<T> = {
cancel(): void
} & Promise<T>

	declare export type ContextualBufferScanResult = {
leadingContextLines: string[],
trailingContextLines: string[]
} & BufferScanResult

	declare export type FileEncoding = "iso88596"
| "windows1256"
| "iso88594"
| "windows1257"
| "iso885914"
...
scopes: string[]
	...
	declare export interface Invisibles {
...
compare(other: KeyBinding): number
	...
	declare export interface ProjectHistory {
paths: string[],
lastOpened: Date
} 
	declare export interface ProjectSpecification {
paths: string[],
originPath: string,
config?: ConfigValues
} 
	declare export interface ScandalResult {
filePath: string,
matches: Array<{
matchText: string,
lineText: string,
...
trailingContextLines: string[]
	...
	declare export interface TestRunnerParams {
 ...
 */
buildDefaultApplicationDelegate(): {[key: string]: any},
...
recalculatePosition(): void
	...
	declare export interface ViewModel {
getTitle: () => string
} 
	declare export interface WindowLoadSettings {
+appVersion: string,
+atomHome: string,
+devMode: boolean,
+resourcePath: string,
