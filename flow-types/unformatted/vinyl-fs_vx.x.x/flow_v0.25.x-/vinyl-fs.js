...
write(buffer: any, cb?: (err?: Error | null) => void): boolean
	...
	import typeof * as _events from 'events';

	import typeof * as File from 'vinyl';

	import typeof * as globStream from 'glob-stream';

	declare export type SrcOptions = {
...
removeBOM?: boolean
	...
	declare export interface DestOptions {
 ...
 */
declare export function src(globs: string | string[], opt?: SrcOptions): NodeJS$ReadWriteStream
 ...
 */
declare export function dest(folder: string, opt?: DestOptions): NodeJS$ReadWriteStream
 ...
 */
declare export function dest(getFolderPath: (file: File) => string): NodeJS$ReadWriteStream
