declare module 'storage-helper' {
	...
	declare export function setItem(key: string, value: string, permanent?: boolean): void

	declare export function getItem<T: boolean | void= false, U= void>(
key: string,
parse?: T,
fallback?: U): "There was Conditional Type, use $Call utility type"
