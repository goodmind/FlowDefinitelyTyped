...
declare interface animate$IAnimateCallbackObject {
eventFn?: (
element: JQuery,
doneFunction: Function,
options: animate$IAnimationOptions) => any,
beforeSetClass?: (
element: JQuery,
addedClasses: string,
...
declare type animate$IAnimationPromise = {} & IPromise<void>
 ...
 */
cancel(animationPromise: animate$IAnimationPromise): void,
...
to: any,
className?: string,
options?: animate$IAnimationOptions): animate$IAnimationPromise,
...
element: JQuery,
parentElement: JQuery,
afterElement?: JQuery): animate$IAnimationPromise,
 ...
 */
declare interface animate$IAnimateProvider {
 ...
 */
declare interface animate$IAnimationOptions {
...
declare interface animate$IAnimateCssRunner {
...
declare type animate$IAnimateCssRunnerStart = {
 ...
 */
declare interface animate$IAnimateCssService {
(element: JQuery, animateCssOptions: animate$IAnimationOptions): animate$IAnimateCssRunner
} 
	declare interface IModule {
animation(
name: string,
animationFactory: angular.animate.animate$IAnimateFactory): IModule,
