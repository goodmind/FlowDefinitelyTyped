declare module 'jotform-css.js' {
        declare module 'global' {
        declare var cssjs: CssJsConstructor;
    }

	declare export interface CssJsConstructor {
new (): CssJs
} 
	declare export var cssjs: CssJsConstructor;
	declare export default typeof cssjs

	declare export interface CssJs {
