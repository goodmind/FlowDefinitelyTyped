 ...
 */
declare function move<T: PromiseLike<void>= Promise<void>>(
from: string,
to: string,
opts?: move$move$Options<T>): T

	declare interface move$Options<T: PromiseLike<void>= Promise<void>> {
...
getuid?: any
	...
	declare module.exports: typeof move
