 ...
 * perform the change.
 */
declare export function wrapInList<S: Schema= any>(
listType: NodeType<S>,
attrs?: {
[key: string]: any
 ...
 */
declare export function splitListItem<S: Schema= any>(
 ...
 * a wrapping list.
 */
declare export function liftListItem<S: Schema= any>(
itemType: NodeType<S>): (state: EditorState<S>, dispatch?: (tr: Transaction<S>) => void) => boolean
 ...
 * into an inner list.
 */
declare export function sinkListItem<S: Schema= any>(
itemType: NodeType<S>): (state: EditorState<S>, dispatch?: (tr: Transaction<S>) => void) => boolean
