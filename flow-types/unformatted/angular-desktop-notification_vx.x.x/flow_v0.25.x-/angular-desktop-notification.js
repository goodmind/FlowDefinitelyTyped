 ...
 */
declare type desktopNotification$AugmentedNotificationOptions = {
...
declare interface desktopNotification$IDesktopNotificationOptions {
autoClose?: boolean,
duration?: number,
showOnPageHidden?: boolean
} 

declare interface desktopNotification$IDesktopNotificationProvider {

/**
 * Set the default app-wide configuration for desktopNotification
 */
config(options: desktopNotification$IDesktopNotificationOptions): void
} 

declare interface desktopNotification$IDesktopNotificationService {
permissions: {
default: "default",
denied: "denied",
granted: "granted"
