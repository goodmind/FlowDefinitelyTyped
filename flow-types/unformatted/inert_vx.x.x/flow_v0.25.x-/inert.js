declare module 'inert' {
	...
	declare type inert$RequestHandler<T> = (request: Request) => T;

declare interface inert$ReplyFileHandlerOptions {
...
declare type inert$FileHandlerRouteObject = {

/**
 * path - a path string or function as described above (required).
 */
path: string | inert$RequestHandler<string>
} & inert$ReplyFileHandlerOptions


declare interface inert$DirectoryHandlerRouteObject {
 ...
 */
path: string | string[] | inert$RequestHandler<string | string[] | Error>,
 ...
 */
declare interface inert$OptionalRegistrationOptions {
...
etagsCacheMaxSize?: number
	...
	declare var inert: Plugin<inert$inert$OptionalRegistrationOptions>;
	declare module.exports: typeof inert
 ...
 */
file?: string | inert$inert$RequestHandler<string> | inert$inert$FileHandlerRouteObject,
 ...
 */
directory?: inert$inert$DirectoryHandlerRouteObject,
files?: {
 ...
 */
file(path: string, options?: inert$inert$ReplyFileHandlerOptions): ResponseObject
} 
    }
