 ...
 */
isCached?: boolean
} & vision$ViewHandlerOrReplyOptions & vision$EnginesConfiguration
 ...
 */
context?: {[key: string]: any} | ((request: Request) => {[key: string]: any})
} 
 ...
 */
declare type vision$ServerViewCompileSync = (template: string, options: any) => (context: any, options: any) => void;

declare type vision$ServerViewCompileAsync = (template: string, options: any, next: vision$ServerViewCompileNext) => void;

declare type vision$ServerViewCompile = vision$ServerViewCompileSync | vision$ServerViewCompileAsync;
...
context: any,
options: any,
callback: (err: null | Error, rendered: string | null) => void) => void) => void;
 ...
 */
prepare?: (config: vision$EngineConfigurationObject, next: (err?: Error) => void) => void,
...
template: string,
context?: any,
options?: vision$ServerViewsConfiguration) => Promise<string>;
 ...
 */
views(options: vision$vision$ServerViewsConfiguration): vision$vision$ViewManager,
...
templatePath: string,
context?: any,
options?: vision$vision$ViewHandlerOrReplyOptions): ResponseObject
} 
