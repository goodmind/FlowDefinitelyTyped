...
bSuppressStroke?: boolean): void,
addNewRectangle<<UNKNOWN PARAM FORMAT>>,
addNewPrimitiveRectangle<<UNKNOWN PARAM FORMAT>>,
...
getTextAttr<<UNKNOWN PARAM FORMAT>>,
getTextString<<UNKNOWN PARAM FORMAT>>,
setTextAttr<<UNKNOWN PARAM FORMAT>>,
setTextString<<UNKNOWN PARAM FORMAT>>,
accName: string,
...
getCustomEase<<UNKNOWN PARAM FORMAT>>,
setCustomEase<<UNKNOWN PARAM FORMAT>>,
...
getHalfEdge(): FlashHalfEdge,
setLocation<<UNKNOWN PARAM FORMAT>>,
x: number,
y: number
} 
 ...
 */
addNewLayer<<UNKNOWN PARAM FORMAT>>,
...
accept<<UNKNOWN PARAM FORMAT>>,
cancel<<UNKNOWN PARAM FORMAT>>,
get<<UNKNOWN PARAM FORMAT>>,
getControlItemElement<<UNKNOWN PARAM FORMAT>>,
getEnabled<<UNKNOWN PARAM FORMAT>>,
getVisible<<UNKNOWN PARAM FORMAT>>,
set<<UNKNOWN PARAM FORMAT>>,
setControItemElement<<UNKNOWN PARAM FORMAT>>,
setControItemElements<<UNKNOWN PARAM FORMAT>>,
setEnabled<<UNKNOWN PARAM FORMAT>>,
setVisible<<UNKNOWN PARAM FORMAT>>
} 
	declare interface FlashActionsPanel {
getClassForObject<<UNKNOWN PARAM FORMAT>>,
getScriptAssistMode<<UNKNOWN PARAM FORMAT>>,
getSelectedText<<UNKNOWN PARAM FORMAT>>,
getText<<UNKNOWN PARAM FORMAT>>,
hasSelection<<UNKNOWN PARAM FORMAT>>,
replaceSelectedText<<UNKNOWN PARAM FORMAT>>,
setScriptAssistMode<<UNKNOWN PARAM FORMAT>>,
setSelection<<UNKNOWN PARAM FORMAT>>,
setText<<UNKNOWN PARAM FORMAT>>
} 
	declare interface FlashCompilerErrors {
clear<<UNKNOWN PARAM FORMAT>>,
save<<UNKNOWN PARAM FORMAT>>
} 
	declare interface FlashComponentsPanel {
addItemToDocument<<UNKNOWN PARAM FORMAT>>,
reload<<UNKNOWN PARAM FORMAT>>
} 
	declare interface FlashPresetPanel {
addNewItem<<UNKNOWN PARAM FORMAT>>,
applyPreset<<UNKNOWN PARAM FORMAT>>,
deleteFolder<<UNKNOWN PARAM FORMAT>>,
deleteItem<<UNKNOWN PARAM FORMAT>>,
expandFolder<<UNKNOWN PARAM FORMAT>>,
exportItem<<UNKNOWN PARAM FORMAT>>,
findItemIndex<<UNKNOWN PARAM FORMAT>>,
getSelectedItems<<UNKNOWN PARAM FORMAT>>,
importItem<<UNKNOWN PARAM FORMAT>>,
moveToFolder<<UNKNOWN PARAM FORMAT>>,
newFolder<<UNKNOWN PARAM FORMAT>>,
renameItem<<UNKNOWN PARAM FORMAT>>,
selectItem<<UNKNOWN PARAM FORMAT>>
} 
	declare interface FlashSwfPanel {
call<<UNKNOWN PARAM FORMAT>>,
setFocus<<UNKNOWN PARAM FORMAT>>,
name: <<UNKNOWN PARAM FORMAT>>,
path: <<UNKNOWN PARAM FORMAT>>
} 
	declare interface FlashTools {
constraintPoint<<UNKNOWN PARAM FORMAT>>,
getKeyDown<<UNKNOWN PARAM FORMAT>>,
setCreatingBbox<<UNKNOWN PARAM FORMAT>>,
setCursor<<UNKNOWN PARAM FORMAT>>,
snapPoint<<UNKNOWN PARAM FORMAT>>,
...
addEventListener<<UNKNOWN PARAM FORMAT>>,
browseForFileURL<<UNKNOWN PARAM FORMAT>>,
browseForFolderURL<<UNKNOWN PARAM FORMAT>>,
...
closeDocument<<UNKNOWN PARAM FORMAT>>,
...
getAppMemoryInfo<<UNKNOWN PARAM FORMAT>>,
getDocumentDOM(): FlashDocument,
getSwfPanel<<UNKNOWN PARAM FORMAT>>,
isFontInstalled<<UNKNOWN PARAM FORMAT>>,
...
toggleBreakpoint<<UNKNOWN PARAM FORMAT>>,
