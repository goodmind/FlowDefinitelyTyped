 ...
 */
declare function fileContent(file: string | string[], reg: string | RegExp): void
 ...
 */
declare function equalsFileContent(file: string, expectedContent: string): void
 ...
 */
declare function noFileContent(file: string | string[], reg: RegExp | string): void
 ...
 */
declare function implement(subject: {[key: string]: any}, methods: {[key: string]: any} | string[]): void
 ...
 */
declare function notImplement(subject: {[key: string]: any}, methods: {[key: string]: any} | string[]): void
 ...
 */
declare function objectContent(obj: {[key: string]: any}, content: {[key: string]: any}): void
 ...
 */
declare function noObjectContent(obj: {[key: string]: any}, content: {[key: string]: any}): void
 ...
 */
declare function JSONFileContent(filename: string, content: {[key: string]: any}): void
 ...
 */
declare function noJSONFileContent(filename: string, content: {[key: string]: any}): void
