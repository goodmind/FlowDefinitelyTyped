...
declare function CSG$parseOption(options: any, optionname: any, defaultvalue: any): any


declare function CSG$parseOptionAs3DVector(options: any, optionname: any, defaultvalue: any): CSG$Vector3D


declare function CSG$parseOptionAs3DVectorList(options: any, optionname: any, defaultvalue: any): any


declare function CSG$parseOptionAs2DVector(options: any, optionname: any, defaultvalue: any): any


declare function CSG$parseOptionAsFloat(options: any, optionname: any, defaultvalue: any): any


declare function CSG$parseOptionAsInt(options: any, optionname: any, defaultvalue: any): any


declare function CSG$parseOptionAsBool(options: any, optionname: any, defaultvalue: any): any
...
declare function CSG$solve2Linear(a: any, b: any, c: any, d: any, u: any, v: any): number[]
...
static fromVector3Ds(a: CSG$Vector3D, b: CSG$Vector3D, c: CSG$Vector3D): CSG$Plane;
static anyPlaneFromVector3Ds(a: CSG$Vector3D, b: CSG$Vector3D, c: CSG$Vector3D): CSG$Plane;
static fromPoints(a: CSG$Vector3D, b: CSG$Vector3D, c: CSG$Vector3D): CSG$Plane;
static fromNormalAndPoint(normal: CSG$Vector3D, point: CSG$Vector3D): CSG$Plane;
...
splitPolygon(polygon: CSG$Polygon): {
type: any,
front: any,
back: any
};
...
constructor(vertices: CSG$Vector3D, shared?: CSG$Polygon.Polygon$Shared, plane?: CSG$Plane): this;
constructor(vertices: CSG$Vertex[], shared?: CSG$Polygon.Polygon$Shared, plane?: CSG$Plane): this;
...
declare function CSG$interpolateBetween2DPointsForY(point1: CSG$Vector2D, point2: CSG$Vector2D, y: number): number


declare function CSG$reTesselateCoplanarPolygons(sourcepolygons: CSG$CSG$Polygon[], destpolygons: CSG$CSG$Polygon[]): void
...
constructor(): this;
getPolygonShared(sourceshared: CSG$Polygon.Polygon$Shared): CSG$Polygon.Polygon$Shared;
...
constructor(point: number[], axisvector: CSG$Vector3D, normalvector: number[]): this;
constructor(point: number[], axisvector: number[], normalvector: number[]): this;
constructor(point: number[], axisvector: number[], normalvector: CSG$Vector3D): this;
constructor(point: CSG$Vector3D, axisvector: number[], normalvector: CSG$Vector3D): this;
constructor(point: CSG$Vector3D, axisvector: number[], normalvector: number[]): this;
constructor(point: CSG$Vector3D, axisvector: CSG$Vector3D, normalvector: CSG$Vector3D): this;
normalized(): CSG$Connector;
transform(matrix4x4: CSG$Matrix4x4): CSG$Connector;
getTransformationTo(other: CSG$Connector, mirror: boolean, normalrotation: number): CSG$Matrix4x4;
axisLine(): CSG$Line3D;
...
static fromPath2D(path2D: CSG$CSG$Path2D, arg1: any, arg2: any): CSG$ConnectorList;
static _fromPath2DTangents(path2D: any, start: any, end: any): CSG$ConnectorList;
...
appendArc(endpoint: CSG$Vector2D, options: CSG$IEllpiticalArcOptions): CSG$Path2D
}
...
p1end: CSG$CSG$Vector2D): boolean;
...
extrudeInOrthonormalBasis(orthonormalbasis: CSG$CSG$OrthoNormalBasis, depth: number, options?: any): CSG;
