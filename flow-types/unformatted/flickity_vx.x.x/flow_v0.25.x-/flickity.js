declare module 'flickity' {
        declare module.exports: typeof Flickity
...
flickity(command: string, ...params: any[]): this
	...
	declare type Flickity$FlickityEvents = "select"
| "cellSelect"
| "settle"
| "scroll"
| "dragStart"
 ...
 */
constructor(selector: string | Element, options?: FlickityOptions): this;
 ...
 * @see Flickity.FlickityEvents class for filckity supported events)
 * @param callback callback funtion to execute when event fires
 */
on(
eventname: Flickity$Flickity$FlickityEvents,
callback: (
event?: Event,
