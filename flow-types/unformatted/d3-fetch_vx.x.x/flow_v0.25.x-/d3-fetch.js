declare module 'd3-fetch' {
        import type {
          DSVParsedArray,DSVRowArray,DSVRowString
        } from 'd3-dsv';
 ...
 */
declare export function blob(url: string, init?: RequestInit): Promise<Blob>
 ...
 * @param init An optional request initialization object.
 */
declare export function buffer(url: string, init?: RequestInit): Promise<ArrayBuffer>
 ...
 * @param init An optional request initialization object.
 */
declare export function csv<Columns: string>(
url: string,
init?: RequestInit): Promise<DSVRowArray<Columns>>
 ...
 */
declare export function csv<ParsedRow: {[key: string]: any}, Columns: string= string>(
url: string,
row: (
rawRow: DSVRowString<Columns>,
index: number,
columns: Columns[]) => ParsedRow | void | null): Promise<DSVParsedArray<ParsedRow>>
 ...
 * @param init An optional request initialization object.
 */
declare export function dsv<Columns: string>(
delimiter: string,
url: string,
init?: RequestInit): Promise<DSVRowArray<Columns>>
...
In effect, row is similar to applying a map and filter operator to the returned rows.
 */
declare export function dsv<ParsedRow: {[key: string]: any}, Columns: string= string>(
delimiter: string,
url: string,
row: (
rawRow: DSVRowString<Columns>,
 ...
 * @param init An optional request initialization object.
 */
declare export function html(url: string, init?: RequestInit): Promise<Document>
 ...
 */
declare export function image(url: string, init?: $Shape<HTMLImageElement>): Promise<HTMLImageElement>
 ...
 * @param init An optional request initialization object.
 */
declare export function json<ParsedJSONObject: any>(
url: string,
init?: RequestInit): Promise<ParsedJSONObject>
 ...
 * @param init An optional request initialization object.
 */
declare export function svg(url: string, init?: RequestInit): Promise<Document>
 ...
 * @param init An optional request initialization object.
 */
declare export function text(url: string, init?: RequestInit): Promise<string>
 ...
 * @param init An optional request initialization object.
 */
declare export function tsv<Columns: string>(
url: string,
init?: RequestInit): Promise<DSVRowArray<Columns>>
...
In effect, row is similar to applying a map and filter operator to the returned rows.
 */
declare export function tsv<ParsedRow: {[key: string]: any}, Columns: string= string>(
url: string,
row: (
rawRow: DSVRowString<Columns>,
index: number,
 ...
 * @param init An optional request initialization object.
 */
declare export function xml(url: string, init?: RequestInit): Promise<XMLDocument>
