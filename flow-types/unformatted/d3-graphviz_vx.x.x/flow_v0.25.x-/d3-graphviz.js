 ...
 */
graphviz(
options?: GraphvizOptions | boolean): Graphviz<GElement, Datum, BaseType, PDatum>,
 ...
 */
declare export function graphviz(
selector: string | BaseType,
options?: GraphvizOptions | boolean): Graphviz<BaseType, any, BaseType, any>
 ...
 */
declare export interface Graphviz<GElement: BaseType, Datum, PElement: BaseType, PDatum> {
...
transition(
name?: (
) => Transition<GElement, Datum, PElement, PDatum> | string | Transition<GElement, Datum, PElement, PDatum>): this,
 ...
 */
declare export type Engine = "circo"
| "dot"
| "fdp"
| "neato"
| "osage"
 ...
 */
declare export type TypeNames = "initEnd"
| "start"
| "layoutStart"
| "layoutEnd"
| "dataExtractEnd"
 ...
 */
declare export type KeyMode = "title" | "id" | "tag-index" | "index";
 ...
 */
declare export interface GraphvizOptions {
useWorker?: boolean,
engine?: Engine,
totalMemory?: number,
keyMode?: KeyMode,
 ...
 */
declare export interface DotAttributes {
style?: any,
URL?: any,
tooltip?: any
} 
