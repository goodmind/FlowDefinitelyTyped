declare module 'prosemirror-state' {
        import type {
          Mark,MarkType,Node as ProsemirrorNode,ResolvedPos,Schema,Slice
 ...
 */
declare export interface PluginSpec<S: Schema= any> {
 ...
 */
declare export class Plugin<S: Schema= any>  {
 ...
 */
declare export interface StateField<T, S: Schema= Schema> {
 ...
 */
declare export class PluginKey<S: Schema= any>  {
 ...
 */
declare export class Selection<S: Schema= any>  {
 ...
 */
static near<S: Schema= any>($pos: ResolvedPos<S>, bias?: number): Selection<S>;
 ...
 * exists.
 */
static atStart<S: Schema= any>(doc: ProsemirrorNode<S>): Selection<S>;

/**
 * Find the cursor or leaf node selection closest to the end of the
 * given document.
 */
static atEnd<S: Schema= any>(doc: ProsemirrorNode<S>): Selection<S>;
 ...
 */
declare export interface SelectionBookmark<S: Schema= any> {
 ...
 */
declare export class SelectionRange<S: Schema= any>  {
 ...
 * position).
 */
declare export class TextSelection<S: Schema= any> mixins Selection<S> {
 ...
 */
declare export class NodeSelection<S: Schema= any> mixins Selection<S> {
 ...
 */
static create<S: Schema= any>(doc: ProsemirrorNode<S>, from: number): NodeSelection<S>;
 ...
 * document).
 */
declare export class AllSelection<S: Schema= any> mixins Selection<S> {
 ...
 */
declare export class EditorState<S: Schema= any>  {
 ...
 */
declare export class Transaction<S: Schema= any> mixins Transform<S> {
