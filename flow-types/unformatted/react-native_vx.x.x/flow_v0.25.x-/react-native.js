 ...
 * Console polyfill
 * @see
 * https://facebook.github.io/react-native/docs/javascript-environment.html#polyfills
 */
 ...
 */
declare var originalXMLHttpRequest: any;
	declare var __BUNDLE_START_TIME__: number;
	declare var ErrorUtils: ErrorUtils;
...
declare var __DEV__: boolean;
	declare function require(name: string): any
      ...
      declare var npm$namespace$addons: {
        
        TestModule: typeof addons$TestModule,
      }
...
declare export var addons$TestModule: addons$TestModuleStatic;

export type addons$TestModule = addons$TestModuleStatic;
      declare var npm$namespace$Animated: {
        decay: typeof Animated$decay,
add: typeof Animated$add,
subtract: typeof Animated$subtract,
divide: typeof Animated$divide,
multiply: typeof Animated$multiply,
modulo: typeof Animated$modulo,
diffClamp: typeof Animated$diffClamp,
delay: typeof Animated$delay,
sequence: typeof Animated$sequence,
stagger: typeof Animated$stagger,
loop: typeof Animated$loop,
spring: typeof Animated$spring,
parallel: typeof Animated$parallel,
event: typeof Animated$event,
createAnimatedComponent: typeof Animated$createAnimatedComponent,
        timing: typeof Animated$timing,
View: typeof Animated$View,
Image: typeof Animated$Image,
Text: typeof Animated$Text,
ScrollView: typeof Animated$ScrollView,
FlatList: typeof Animated$FlatList,
SectionList: typeof Animated$SectionList,
      }
declare type Animated$AnimatedValue = Animated$Value;

declare type Animated$AnimatedValueXY = Animated$ValueXY;

declare type Animated$Base = Animated$Animated;

declare class Animated$Animated  {}

declare class Animated$AnimatedWithChildren mixins Animated$Animated {}

declare class Animated$AnimatedInterpolation mixins Animated$AnimatedWithChildren {
interpolate(config: Animated$InterpolationConfigType): Animated$AnimatedInterpolation
}

declare type Animated$ExtrapolateType = "extend" | "identity" | "clamp";

declare type Animated$InterpolationConfigType = {
inputRange: number[],
outputRange: number[] | string[],
easing?: ((input: number) => number),
extrapolate?: Animated$ExtrapolateType,
extrapolateLeft?: Animated$ExtrapolateType,
extrapolateRight?: Animated$ExtrapolateType
};

declare type Animated$ValueListenerCallback = (state: {
value: number
}) => void;
 ...
 */
declare export class Animated$Value mixins Animated$AnimatedWithChildren {
 ...
 */
addListener(callback: Animated$ValueListenerCallback): string;
...
declare type Animated$ValueXYListenerCallback = (value: {
x: number,
y: number
}) => void;
 ...
 */
declare export class Animated$ValueXY mixins Animated$AnimatedWithChildren {
...
addListener(callback: Animated$ValueXYListenerCallback): string;
removeListener(id: string): void;
 ...
 */
getLayout(): {
[key: string]: Animated$AnimatedValue
};
...
declare type Animated$EndResult = {
finished: boolean
};

declare type Animated$EndCallback = (result: Animated$EndResult) => void;

export interface Animated$CompositeAnimation {
...
declare interface Animated$AnimationConfig {
 ...
 * coefficient.
 */
declare export function Animated$decay(
value: Animated$AnimatedValue | Animated$AnimatedValueXY,
config: Animated$DecayAnimationConfig): Animated$CompositeAnimation


declare type Animated$DecayAnimationConfig = {
velocity: number | {
x: number,
y: number
},
 ...
 */
declare export var Animated$timing: (
value: Animated$AnimatedValue | Animated$AnimatedValueXY,
config: Animated$TimingAnimationConfig) => Animated$CompositeAnimation;

declare type Animated$TimingAnimationConfig = {
...
declare type Animated$SpringAnimationConfig = {
toValue: number | Animated$AnimatedValue | {
x: number,
y: number
} | Animated$AnimatedValueXY,
...
declare interface Animated$LoopAnimationConfig {
iterations?: number,
iterations?: number
} 
 ...
 * together.
 */
declare export function Animated$add(a: Animated$Animated, b: Animated$Animated): Animated$AnimatedAddition


declare class Animated$AnimatedAddition mixins Animated$AnimatedInterpolation {}
 ...
 */
declare export function Animated$subtract(a: Animated$Animated, b: Animated$Animated): Animated$AnimatedSubtraction


declare class Animated$AnimatedSubtraction mixins Animated$AnimatedInterpolation {}
 ...
 */
declare export function Animated$divide(a: Animated$Animated, b: Animated$Animated): Animated$AnimatedDivision


declare class Animated$AnimatedDivision mixins Animated$AnimatedInterpolation {}
 ...
 * together.
 */
declare export function Animated$multiply(a: Animated$Animated, b: Animated$Animated): Animated$AnimatedMultiplication


declare class Animated$AnimatedMultiplication mixins Animated$AnimatedInterpolation {}
 ...
 */
declare export function Animated$modulo(a: Animated$Animated, modulus: number): Animated$AnimatedModulo


declare class Animated$AnimatedModulo mixins Animated$AnimatedInterpolation {}
 ...
 */
declare export function Animated$diffClamp(a: Animated$Animated, min: number, max: number): Animated$AnimatedDiffClamp


declare class Animated$AnimatedDiffClamp mixins Animated$AnimatedInterpolation {}


/**
 * Starts an animation after the given delay.
 */
declare export function Animated$delay(time: number): Animated$CompositeAnimation
 ...
 */
declare export function Animated$sequence(animations: Array<Animated$CompositeAnimation>): Animated$CompositeAnimation
 ...
 */
declare export function Animated$stagger(
time: number,
animations: Array<Animated$CompositeAnimation>): Animated$CompositeAnimation
 ...
 */
declare export function Animated$loop(
animation: Animated$CompositeAnimation,
config?: Animated$LoopAnimationConfig): Animated$CompositeAnimation
 ...
 */
declare export function Animated$spring(
value: Animated$AnimatedValue | Animated$AnimatedValueXY,
config: Animated$SpringAnimationConfig): Animated$CompositeAnimation


declare type Animated$ParallelConfig = {
 ...
 */
declare export function Animated$parallel(
animations: Array<Animated$CompositeAnimation>,
config?: Animated$ParallelConfig): Animated$CompositeAnimation


declare type Animated$Mapping = {
[key: string]: Animated$Mapping
} | Animated$AnimatedValue;

declare interface Animated$EventConfig<T> {
listener?: (Animated$event: NativeSyntheticEvent<T>) => void,
useNativeDriver?: boolean,
listener?: (Animated$event: NativeSyntheticEvent<T>) => void,
useNativeDriver?: boolean
} 
 ...
 *      *```
 */
declare export function Animated$event<T>(
argMapping: Array<Animated$Mapping | null>,
config?: Animated$EventConfig<T>): (...args: any[]) => void
 ...
 */
declare export function Animated$createAnimatedComponent(component: any): any
 ...
 * props and style.
 */
declare export var Animated$View: any;

declare export var Animated$Image: any;

declare export var Animated$Text: any;

declare export var Animated$ScrollView: any;

declare export var Animated$FlatList: any;

declare export var Animated$SectionList: any;
...
declare type StyleSheet$NamedStyles<T> = $ObjMapi<T, <P>(P) => ViewStyle | TextStyle | ImageStyle>;


/**
 * Creates a StyleSheet style reference from the given object.
 */
declare export function StyleSheet$create<T: StyleSheet$NamedStyles<T> | StyleSheet$NamedStyles<any>>(styles: T): T
 ...
 * the alternative use.
 */
declare export function StyleSheet$flatten<T>(style?: RegisteredStyle<T>): T


declare export function StyleSheet$flatten(style?: StyleProp<TextStyle>): TextStyle


declare export function StyleSheet$flatten(style?: StyleProp<ImageStyle>): ImageStyle


declare export function StyleSheet$flatten(style?: StyleProp<ViewStyle>): ViewStyle
 ...
 */
declare export function StyleSheet$setStyleAttributePreprocessor(property: string, process: (nextProp: any) => any): void
 ...
 */
declare export var StyleSheet$hairlineWidth: number;

declare interface StyleSheet$AbsoluteFillStyle {
position: "absolute",
left: 0,
right: 0,
top: 0,
 ...
 *    });
 */
declare export var StyleSheet$absoluteFillObject: StyleSheet$AbsoluteFillStyle;
 ...
 * styles.
 */
declare export var StyleSheet$absoluteFill: RegisteredStyle<StyleSheet$AbsoluteFillStyle>;
      declare var npm$namespace$AppRegistry: {
        registerConfig: typeof AppRegistry$registerConfig,
registerComponent: typeof AppRegistry$registerComponent,
registerRunnable: typeof AppRegistry$registerRunnable,
getAppKeys: typeof AppRegistry$getAppKeys,
unmountApplicationComponentAtRootTag: typeof AppRegistry$unmountApplicationComponentAtRootTag,
runApplication: typeof AppRegistry$runApplication,
registerHeadlessTask: typeof AppRegistry$registerHeadlessTask,
getRunnable: typeof AppRegistry$getRunnable,
        
      }
declare function AppRegistry$registerConfig(config: AppConfig[]): void


declare function AppRegistry$registerComponent(appKey: string, getComponentFunc: ComponentProvider): string


declare function AppRegistry$registerRunnable(appKey: string, func: Runnable): string


declare function AppRegistry$getAppKeys(): string[]


declare function AppRegistry$unmountApplicationComponentAtRootTag(rootTag: number): void


declare function AppRegistry$runApplication(appKey: string, appParameters: any): void


declare function AppRegistry$registerHeadlessTask(appKey: string, task: TaskProvider): void


declare function AppRegistry$getRunnable(appKey: string): Runnable | void
...
remove(): void
	...
	declare interface EventEmitterListener {
 ...
 * @throws
 * {Error} When called not during an eventing cycle
 * @example
...
...children: React.ReactNode[]): React.ReactElement<P>
	...
	declare export type NativeSyntheticEvent<T> = {} & React.BaseSyntheticEvent<T, NodeHandle, NodeHandle>
...
touches: NativeTouchEvent[]
	...
	declare export type GestureResponderEvent = {} & NativeSyntheticEvent<NativeTouchEvent>

	declare export interface PointPropType {
x: number,
y: number
} 
...
onTouchStart?: (Animated$event: GestureResponderEvent) => void,
onTouchMove?: (Animated$event: GestureResponderEvent) => void,
onTouchEnd?: (Animated$event: GestureResponderEvent) => void,
onTouchCancel?: (Animated$event: GestureResponderEvent) => void,
onTouchEndCapture?: (Animated$event: GestureResponderEvent) => void
} 
	declare export type ComponentProvider = () => React.ComponentType<any>;
...
duration: number,
StyleSheet$create?: LayoutAnimationAnim,
...
duration: number,
type?: string,
creationProp?: string) => LayoutAnimationConfig,
...
Animated$spring: LayoutAnimationConfig
},
easeInEaseOut: (onAnimationDidEnd?: () => void) => void,
linear: (onAnimationDidEnd?: () => void) => void,
Animated$spring: (onAnimationDidEnd?: () => void) => void
} 
	declare type FlexAlignType = "flex-start"
| "flex-end"
| "center"
| "stretch"
| "baseline";
...
shadowRadius: number
	...
	declare type GeoConfiguration = {
skipPermissionRequests: boolean
};
	declare type GeoOptions = {
timeout?: number,
maximumAge?: number,
...
StyleSheet$hairlineWidth: number,
StyleSheet$flatten<T: string>(style: T): T
} 
...
layout: LayoutRectangle
	...
	declare export type TextStyleIOS = {
...
writingDirection?: "auto" | "ltr" | "rtl"
	...
	declare export type TextStyleAndroid = {
...
testID?: string
} & TextStyleIOS & TextStyleAndroid & ViewStyle

	declare export interface TextPropsIOS {
...
suppressHighlighting?: boolean
	...
	declare export interface TextPropsAndroid {
 ...
 */
onLayout?: (Animated$event: LayoutChangeEvent) => void,

/**
 * This function is called on press.
 * Text intrinsically supports press handling with a default highlight state (which can be disabled with suppressHighlighting).
 */
onPress?: (Animated$event: GestureResponderEvent) => void,
 ...
 *      *
 */
onLongPress?: (Animated$event: GestureResponderEvent) => void,
 ...
 */
nativeID?: string
} & TextPropsIOS & TextPropsAndroid & AccessibilityProps

	
/**
 * A React component for displaying text which supports nesting, styling, and touch handling.
 */
declare class TextComponent mixins React.Component<TextProps> {}
	declare var TextBase: Constructor<NativeMethodsMixin> & typeof TextComponent;
	declare export class Text mixins TextBase {}
	declare type DataDetectorTypes = "phoneNumber"
| "link"
| "address"
| "calendarEvent"
| "none"
 ...
 */
declare export type DocumentSelectionState = {
 ...
 */
declare export interface TextInputIOSProps {
 ...
 * https://facebook.github.io/react-native/docs/textinput.html#props
 */
declare export interface TextInputAndroidProps {
...
underlineColorAndroid?: string
	...
	declare export type KeyboardTypeIOS = "ascii-capable"
...
| "twitter"
| "web-search";
	declare export type KeyboardTypeAndroid = "visible-password";
	declare export type KeyboardTypeOptions = KeyboardType | KeyboardTypeAndroid | KeyboardTypeIOS;
	declare export type ReturnKeyType = "done"
| "go"
| "next"
| "search"
| "send";
	declare export type ReturnKeyTypeAndroid = "none" | "previous";
	declare export type ReturnKeyTypeIOS = "default"
| "google"
| "join"
| "route"
| "yahoo"
| "emergency-call";
	declare export type ReturnKeyTypeOptions = ReturnKeyType | ReturnKeyTypeAndroid | ReturnKeyTypeIOS;
	
/**
 * @see
 * TextInputProps.onFocus
 */
declare export interface TextInputFocusEventData {
target: number,
text: string,
eventCount: number
} 
 ...
 */
declare export interface TextInputScrollEventData {
contentOffset: {
x: number,
y: number
}
 ...
 */
declare export interface TextInputSelectionChangeEventData {
selection: {
start: number,
end: number
},
 ...
 */
declare export interface TextInputKeyPressEventData {
key: string
} 
 ...
 */
declare export interface TextInputChangeEventData {
eventCount: number,
target: number,
text: string
} 
 ...
 */
declare export interface TextInputContentSizeChangeEventData {
contentSize: {
width: number,
height: number
}
 ...
 */
declare export interface TextInputEndEditingEventData {
text: string
} 
 ...
 */
declare export interface TextInputSubmitEditingEventData {
text: string
} 
 ...
 */
value?: string
} & ViewProps & TextInputIOSProps & TextInputAndroidProps & AccessibilityProps
...
/**
 * @see
 * https://facebook.github.io/react-native/docs/textinput.html#methods
 */
declare class TextInputComponent mixins React.Component<TextInputProps> {}
	declare var TextInputBase: Constructor<NativeMethodsMixin> & Constructor<TimerMixin> & typeof TextInputComponent;
	declare export class TextInput mixins TextInputBase {
...
showWithText?: boolean
	...
	declare export type ToolbarAndroidProps = {
 ...
 */
declare class ToolbarAndroidComponent mixins React.Component<ToolbarAndroidProps> {}
	declare var ToolbarAndroidBase: Constructor<NativeMethodsMixin> & typeof ToolbarAndroidComponent;
	declare export class ToolbarAndroid mixins ToolbarAndroidBase {}
 ...
 */
onStartShouldSetResponder?: (Animated$event: GestureResponderEvent) => boolean,

/**
 * Called for every touch move on the View when it is not the responder: does this view want to "claim" touch responsiveness?
 */
onMoveShouldSetResponder?: (Animated$event: GestureResponderEvent) => boolean,

/**
 * If the View returns true and attempts to become the responder, one of the following will happen:
 */
onResponderEnd?: (Animated$event: GestureResponderEvent) => void,

/**
 * The View is now responding for touch events.
 * This is the time to highlight and show the user what is happening
 */
onResponderGrant?: (Animated$event: GestureResponderEvent) => void,

/**
 * Something else is the responder right now and will not release it
 */
onResponderReject?: (Animated$event: GestureResponderEvent) => void,

/**
 * If the view is responding, the following handlers can be called:
 * The user is moving their finger
 */
onResponderMove?: (Animated$event: GestureResponderEvent) => void,

/**
 * Fired at the end of the touch, ie "touchUp"
 */
onResponderRelease?: (Animated$event: GestureResponderEvent) => void,
onResponderStart?: (Animated$event: GestureResponderEvent) => void,

/**
 * Something else wants to become responder.
 * Should this view release the responder? Returning true allows release
 */
onResponderTerminationRequest?: (Animated$event: GestureResponderEvent) => boolean,
 ...
 */
onResponderTerminate?: (Animated$event: GestureResponderEvent) => void,
 ...
 */
onStartShouldSetResponderCapture?: (Animated$event: GestureResponderEvent) => boolean,
 ...
 * it should have a onStartShouldSetResponderCapture handler which returns true.
 */
onMoveShouldSetResponderCapture?: (Animated$event: GestureResponderEvent) => boolean
} 
 ...
 */
elevation?: number
} & FlexStyle & ShadowStyleIOS & TransformsStyle

	declare export interface ViewPropsIOS {
...
shouldRasterizeIOS?: boolean
	...
	declare export interface ViewPropsAndroid {
 ...
 */
declare type RegisteredStyle<T> = number & {
__registeredStyleBrand: T
};
	declare export type StyleProp<T> = T | RegisteredStyle<T> | RecursiveArray<T | RegisteredStyle<T> | Falsy> | Falsy;
	
/**
 * @see
 * https://facebook.github.io/react-native/docs/accessibility.html#accessibility-properties
 */
declare export type AccessibilityProps = {
...
accessibilityHint?: string
	...
	declare export type AccessibilityState = "selected" | "disabled";
	declare export type AccessibilityRole = "none"
| "button"
| "link"
| "search"
| "image"
...
| "summary"
| "imagebutton";
	declare export interface AccessibilityPropsAndroid {
...
importantForAccessibility?: "auto" | "yes" | "no" | "no-hide-descendants"
	...
	declare export interface AccessibilityPropsIOS {
...
accessibilityIgnoresInvertColors?: boolean
	...
	declare type AccessibilityTrait = "none"
| "button"
| "link"
| "header"
| "search"
...
/**
 * @see
 * https://facebook.github.io/react-native/docs/view.html#props
 */
 ...
 */
nativeID?: string
} & ViewPropsAndroid & ViewPropsIOS & GestureResponderHandlers & Touchable & AccessibilityProps
 ...
 */
declare class ViewComponent mixins React.Component<ViewProps> {}
	declare var ViewBase: Constructor<NativeMethodsMixin> & typeof ViewComponent;
	declare export class View mixins ViewBase {
...
/**
 * @see
 * https://facebook.github.io/react-native/docs/viewpagerandroid.html#props
 */
...
position: number
	...
	declare export type ViewPagerAndroidProps = {
 ...
 */
onPageScroll?: (
Animated$event: NativeSyntheticEvent<ViewPagerAndroidOnPageScrollEventData>) => void,
 ...
 */
onPageSelected?: (
Animated$event: NativeSyntheticEvent<ViewPagerAndroidOnPageSelectedEventData>) => void,
...
pageMargin?: number
	...
	declare class ViewPagerAndroidComponent mixins React.Component<ViewPagerAndroidProps> {}
	declare var ViewPagerAndroidBase: Constructor<NativeMethodsMixin> & typeof ViewPagerAndroidComponent;
	declare export class ViewPagerAndroid mixins ViewPagerAndroidBase {
 ...
 */
declare class KeyboardAvoidingViewComponent mixins React.Component<KeyboardAvoidingViewProps> {}
	declare var KeyboardAvoidingViewBase: Constructor<TimerMixin> & typeof KeyboardAvoidingViewComponent;
	declare export class KeyboardAvoidingView mixins KeyboardAvoidingViewBase {}
	declare export type KeyboardAvoidingViewProps = {
 ...
 */
declare export interface WebViewMessageEventData {
...
data: string
	...
	declare export interface WebViewPropsAndroid {
...
url: string
	...
	declare export interface WebViewPropsIOS {
 ...
 * request.
 */
onShouldStartLoadWithRequest?: (Animated$event: WebViewIOSLoadRequestEvent) => boolean,
...
baseUrl?: string
	...
	declare export interface WebViewNativeConfig {
component?: any,
props?: {[key: string]: any},
viewManager?: {[key: string]: any}
} 
 ...
 */
declare export type WebViewProps = {
 ...
 */
onError?: (Animated$event: NavState) => void,

/**
 * Invoked when load finish
 */
onLoad?: (Animated$event: NavState) => void,

/**
 * Invoked when load either succeeds or fails
 */
onLoadEnd?: (Animated$event: NavState) => void,

/**
 * Invoked on load start
 */
onLoadStart?: (Animated$event: NavState) => void,

/**
 * Invoked when window.postMessage is called from WebView.
 */
onMessage?: (Animated$event: NativeSyntheticEvent<WebViewMessageEventData>) => void,

/**
 * Function that is invoked when the `WebView` loading starts or ends.
 */
onNavigationStateChange?: (Animated$event: NavState) => void,
...
} & ViewProps & WebViewPropsAndroid & WebViewPropsIOS

	declare export class WebView mixins React.Component<WebViewProps> {
...
target: number
	...
	declare export type SegmentedControlIOSProps = {
 ...
 */
onChange?: (
Animated$event: NativeSyntheticEvent<NativeSegmentedControlIOSChangeEvent>) => void,
 ...
 */
declare class SafeAreaViewComponent mixins React.Component<ViewProps> {}
	declare var SafeAreaViewBase: Constructor<NativeMethodsMixin> & typeof SafeAreaViewComponent;
	declare export class SafeAreaView mixins SafeAreaViewBase {}
 ...
 */
declare export class InputAccessoryView mixins React.Component<InputAccessoryViewProps> {}
	declare export interface InputAccessoryViewProps {
backgroundColor?: string,
 ...
 * ````
 */
declare class SegmentedControlIOSComponent mixins React.Component<SegmentedControlIOSProps> {}
	declare var SegmentedControlIOSBase: Constructor<NativeMethodsMixin> & typeof SegmentedControlIOSComponent;
	declare export class SegmentedControlIOS mixins SegmentedControlIOSBase {}
	declare export interface NavigatorIOSProps {
 ...
 * @see
 * https://facebook.github.io/react-native/docs/navigatorios.html#navigator
 */
declare export class NavigatorIOS mixins React.Component<NavigatorIOSProps> {
...
/**
 * @see
 * https://facebook.github.io/react-native/docs/activityindicator.html#props
 */
declare export type ActivityIndicatorProps = {
...
style?: StyleProp<ViewStyle>
	...
	declare class ActivityIndicatorComponent mixins React.Component<ActivityIndicatorProps> {}
	declare var ActivityIndicatorBase: Constructor<NativeMethodsMixin> & typeof ActivityIndicatorComponent;
	declare export class ActivityIndicator mixins ActivityIndicatorBase {}
	
/**
 * @see
 * https://facebook.github.io/react-native/docs/activityindicatorios.html#props
 */
declare export type ActivityIndicatorIOSProps = {
 ...
 */
declare export class ActivityIndicatorIOS mixins React.Component<ActivityIndicatorIOSProps> {}
	declare export type DatePickerIOSProps = {
...
timeZoneOffsetInMinutes?: number
	...
	declare class DatePickerIOSComponent mixins React.Component<DatePickerIOSProps> {}
	declare var DatePickerIOSBase: Constructor<NativeMethodsMixin> & typeof DatePickerIOSComponent;
	declare export class DatePickerIOS mixins DatePickerIOSBase {}
	declare export type DrawerSlideEvent = {} & NativeSyntheticEvent<NativeTouchEvent>
 ...
 */
declare export type DrawerLayoutAndroidProps = {
 ...
 */
onDrawerSlide?: (Animated$event: DrawerSlideEvent) => void,
 ...
 */
onDrawerStateChanged?: (Animated$event: "Idle" | "Dragging" | "Settling") => void,
...
statusBarBackgroundColor?: string
	...
	declare interface DrawerPosition {
Left: number,
Right: number
} 
	declare class DrawerLayoutAndroidComponent mixins React.Component<DrawerLayoutAndroidProps> {}
	declare var DrawerLayoutAndroidBase: Constructor<NativeMethodsMixin> & typeof DrawerLayoutAndroidComponent;
	declare export class DrawerLayoutAndroid mixins DrawerLayoutAndroidBase {
 ...
 * PickerIOS.ios.js
 */
declare export class PickerIOSItem mixins React.Component<PickerIOSItemProps> {}
...
value?: any
	...
	declare export type PickerPropsIOS = {
...
itemStyle?: StyleProp<ViewStyle>
	...
	declare export type PickerPropsAndroid = {
 ...
 */
testId?: string
} & PickerPropsIOS & PickerPropsAndroid
 ...
 * PickerIOS.ios.js
 */
declare export type PickerIOSProps = {
 ...
 * PickerIOS.ios.js
 */
declare class PickerIOSComponent mixins React.Component<PickerIOSProps> {}
	declare var PickerIOSBase: Constructor<NativeMethodsMixin> & typeof PickerIOSComponent;
	declare export class PickerIOS mixins PickerIOSBase {
 ...
 */
declare export type ProgressBarAndroidProps = {
 ...
 */
declare class ProgressBarAndroidComponent mixins React.Component<ProgressBarAndroidProps> {}
	declare var ProgressBarAndroidBase: Constructor<NativeMethodsMixin> & typeof ProgressBarAndroidComponent;
	declare export class ProgressBarAndroid mixins ProgressBarAndroidBase {}
 ...
 */
declare export type ProgressViewIOSProps = {
...
trackImage?: ImageURISource | ImageURISource[]
	...
	declare class ProgressViewIOSComponent mixins React.Component<ProgressViewIOSProps> {}
	declare var ProgressViewIOSBase: Constructor<NativeMethodsMixin> & typeof ProgressViewIOSComponent;
	declare export class ProgressViewIOS mixins ProgressViewIOSBase {}
	declare export type RefreshControlPropsIOS = {
...
titleColor?: string
	...
	declare export type RefreshControlPropsAndroid = {
...
progressViewOffset?: number
	...
	declare export type RefreshControlProps = {
 ...
 */
refreshing: boolean
} & RefreshControlPropsIOS & RefreshControlPropsAndroid
 ...
 */
declare class RefreshControlComponent mixins React.Component<RefreshControlProps> {}
	declare var RefreshControlBase: Constructor<NativeMethodsMixin> & typeof RefreshControlComponent;
	declare export class RefreshControl mixins RefreshControlBase {
static SIZE: Object
}
	declare export type RecyclerViewBackedScrollViewProps = {} & ScrollViewProps
 ...
 */
declare class RecyclerViewBackedScrollViewComponent mixins React.Component<RecyclerViewBackedScrollViewProps> {}
	declare var RecyclerViewBackedScrollViewBase: Constructor<ScrollResponderMixin> & typeof RecyclerViewBackedScrollViewComponent;
	declare export class RecyclerViewBackedScrollView mixins RecyclerViewBackedScrollViewBase {
...
getScrollResponder(): JSX.Element
	...
	declare export type SliderPropsAndroid = {
...
thumbTintColor?: string
	...
	declare export type SliderPropsIOS = {
 ...
 */
value?: number
} & SliderPropsIOS & SliderPropsAndroid

	
/**
 * A component used to select a single value from a range of values.
 */
declare class SliderComponent mixins React.Component<SliderProps> {}
	declare var SliderBase: Constructor<NativeMethodsMixin> & typeof SliderComponent;
	declare export class Slider mixins SliderBase {}
	declare export type SliderIOS = Slider;
	
/**
 * https://facebook.github.io/react-native/docs/switchios.html#props
 */
declare export type SwitchIOSProps = {
 ...
 * @see
 * https://facebook.github.io/react-native/docs/switchios.html
 */
declare export class SwitchIOS mixins React.Component<SwitchIOSProps> {}
	declare export type ImageResizeMode = "cover"
| "contain"
| "stretch"
| "repeat"
| "center";
 ...
 */
declare export type ImageStyle = {
...
opacity?: number
	...
	declare export interface ImageURISource {
...
scale?: number
	...
	declare export type ImageRequireSource = number;
	
/**
 * @see
 * ImagePropsIOS.onProgress
 */
declare export interface ImageProgressEventDataIOS {
loaded: number,
total: number
} 
	declare export interface ImagePropsIOS {
 ...
 */
onProgress?: (Animated$event: NativeSyntheticEvent<ImageProgressEventDataIOS>) => void,
...
onPartialLoad?: () => void
	...
	declare interface ImagePropsAndroid {
 ...
 */
declare export type ImageSourcePropType = ImageURISource | ImageURISource[] | ImageRequireSource;
	
/**
 * @see
 * ImagePropsBase.onLoad
 */
declare export interface ImageLoadEventDataAndroid {
uri?: string
} 
	declare export type ImageLoadEventData = {
source: {
height: number,
width: number,
url: string
	...
	declare export interface ImageErrorEventData {
error: any
} 
	
/**
 * @see
 * https://facebook.github.io/react-native/docs/image.html#resolveassetsource
 */
declare export interface ImageResolvedAssetSource {
height: number,
width: number,
scale: number,
uri: string
 ...
 */
declare export type ImagePropsBase = {
 ...
 */
onLoad?: (Animated$event: NativeSyntheticEvent<ImageLoadEventData>) => void,
...
} & ImagePropsIOS & ImagePropsAndroid & AccessibilityProps
...
style?: StyleProp<ImageStyle>
	...
	declare class ImageComponent mixins React.Component<ImageProps> {}
	declare var ImageBase: Constructor<NativeMethodsMixin> & typeof ImageComponent;
	declare export class Image mixins ImageBase {
static getSize(
uri: string,
...
static resolveAssetSource(source: ImageSourcePropType): ImageResolvedAssetSource
	...
	declare export type ImageBackgroundProps = {
imageStyle?: StyleProp<ImageStyle>,
style?: StyleProp<ViewStyle>,
imageRef?: (image: Animated$Image) => void
} & ImagePropsBase

	declare class ImageBackgroundComponent mixins React.Component<ImageBackgroundProps> {}
	declare var ImageBackgroundBase: Constructor<NativeMethodsMixin> & typeof ImageBackgroundComponent;
	declare export class ImageBackground mixins ImageBackgroundBase {
resizeMode: ImageResizeMode;
getSize(
uri: string,
success: (width: number, height: number) => void,
...
queryCache(urls: string[]): Promise<Map<string, "memory" | "disk">>
	...
	declare export interface ViewToken {
item: any,
key: string,
index: number | null,
isViewable: boolean,
section?: any
	...
	declare export interface ViewabilityConfig {
...
waitForInteraction?: boolean
	...
	declare export interface ViewabilityConfigCallbackPair {
...
changed: Array<ViewToken>
	...
	declare export type ViewabilityConfigCallbackPairs = ViewabilityConfigCallbackPair[];
	
/**
 * @see
 * https://facebook.github.io/react-native/docs/flatlist.html#props
 */
declare export interface ListRenderItemInfo<ItemT> {
item: ItemT,
index: number,
separators: {
highlight: () => void,
...
updateProps: (select: "leading" | "trailing", newProps: any) => void
	...
	declare export type ListRenderItem<ItemT> = (info: ListRenderItemInfo<ItemT>) => React.ReactElement<any> | null;
	declare export type FlatListProps<ItemT> = {
...
removeClippedSubviews?: boolean
	...
	declare export class FlatList<ItemT> mixins React.Component<FlatListProps<ItemT>> {
 ...
 */
declare export interface SectionBase<ItemT> {
data: ItemT[],
key?: string,
...
keyExtractor?: (item: ItemT, index: number) => string
	...
	declare export type SectionListData<ItemT> = {
[key: string]: any
} & SectionBase<ItemT>
 ...
 */
declare export type SectionListRenderItemInfo<ItemT> = {
section: SectionListData<ItemT>
} & ListRenderItemInfo<ItemT>

	declare export type SectionListRenderItem<ItemT> = (info: SectionListRenderItemInfo<ItemT>) => React.ReactElement<any> | null;
	declare export type SectionListProps<ItemT> = {
...
legacyImplementation?: boolean
	...
	declare export interface SectionListScrollParams {
animated?: boolean,
itemIndex: number,
sectionIndex: number,
viewOffset?: number,
viewPosition?: number
	...
	declare export type SectionListStatic<SectionT> = {
...
} & React.ComponentClass<SectionListProps<SectionT>>

	
/**
 * @see
 * https://facebook.github.io/react-native/docs/virtualizedlist.html#props
 */
declare export type VirtualizedListProps<ItemT> = {
renderItem: ListRenderItem<ItemT>
} & VirtualizedListWithoutRenderItemProps<ItemT>

	declare export type VirtualizedListWithoutRenderItemProps<ItemT> = {
 ...
 */
declare export type ListViewProps = {
...
cancelAnimationFrame: typeof cancelAnimationFrame
	...
	declare class ListViewComponent mixins React.Component<ListViewProps> {}
	declare var ListViewBase: Constructor<ScrollResponderMixin> & Constructor<TimerMixin> & typeof ListViewComponent;
	declare export class ListView mixins ListViewBase {
...
id?: string
	...
	declare export type MapViewProps = {
 ...
 */
declare class MapViewComponent mixins React.Component<MapViewProps> {}
	declare var MapViewBase: Constructor<NativeMethodsMixin> & typeof MapViewComponent;
	declare export class MapView mixins MapViewBase {
static PinColors: {
RED: string,
GREEN: string,
PURPLE: string
	...
	declare type MaskedViewIOSProps = {
 ...
 */
declare class MaskedViewComponent mixins React.Component<MaskedViewIOSProps> {}
	declare var MaskedViewBase: Constructor<NativeMethodsMixin> & typeof MaskedViewComponent;
	declare export class MaskedViewIOS mixins MaskedViewBase {}
	declare export interface ModalBaseProps {
animated?: boolean,
 ...
 */
onShow?: (Animated$event: NativeSyntheticEvent<any>) => void
} 
	declare export interface ModalPropsIOS {
 ...
 */
supportedOrientations?: Array<"portrait"
 ...
 */
onOrientationChange?: (Animated$event: NativeSyntheticEvent<any>) => void
} 
	declare export interface ModalPropsAndroid {
...
hardwareAccelerated?: boolean
	...
	declare export type ModalProps = ModalBaseProps & ModalPropsIOS & ModalPropsAndroid;
	declare export class Modal mixins React.Component<ModalProps> {}
 ...
 */
declare export type TouchableWithoutFeedbackProps = {
 ...
 */
onPress?: (Animated$event: GestureResponderEvent) => void,
onPressIn?: (Animated$event: GestureResponderEvent) => void,
onPressOut?: (Animated$event: GestureResponderEvent) => void,
 ...
 */
declare class TouchableWithoutFeedbackComponent mixins React.Component<TouchableWithoutFeedbackProps> {}
	declare var TouchableWithoutFeedbackBase: Constructor<TimerMixin> & Constructor<TouchableMixin> & typeof TouchableWithoutFeedbackComponent;
	declare export class TouchableWithoutFeedback mixins TouchableWithoutFeedbackBase {}
	
/**
 * @see
 * https://facebook.github.io/react-native/docs/touchablehighlight.html#props
 */
declare export type TouchableHighlightProps = {
 ...
 */
declare class TouchableHighlightComponent mixins React.Component<TouchableHighlightProps> {}
	declare var TouchableHighlightBase: Constructor<NativeMethodsMixin> & Constructor<TimerMixin> & Constructor<TouchableMixin> & typeof TouchableHighlightComponent;
	declare export class TouchableHighlight mixins TouchableHighlightBase {}
	
/**
 * @see
 * https://facebook.github.io/react-native/docs/touchableopacity.html#props
 */
declare export type TouchableOpacityProps = {
 ...
 */
declare class TouchableOpacityComponent mixins React.Component<TouchableOpacityProps> {}
	declare var TouchableOpacityBase: Constructor<TimerMixin> & Constructor<TouchableMixin> & Constructor<NativeMethodsMixin> & typeof TouchableOpacityComponent;
	declare export class TouchableOpacity mixins TouchableOpacityBase {
...
type: string
	...
	declare type RippleBackgroundPropType = {
type: "RippleAndroid",
color?: number,
borderless?: boolean
} & BaseBackgroundPropType

	declare type ThemeAttributeBackgroundPropType = {
 ...
 * https://facebook.github.io/react-native/docs/touchableopacity.html#props
 */
declare export type TouchableNativeFeedbackProps = {
 ...
 */
declare class TouchableNativeFeedbackComponent mixins React.Component<TouchableNativeFeedbackProps> {}
	declare var TouchableNativeFeedbackBase: Constructor<TouchableMixin> & typeof TouchableNativeFeedbackComponent;
	declare export class TouchableNativeFeedback mixins TouchableNativeFeedbackBase {
 ...
 * @param methodNames
 * Map from method names to method display names.
 */
 ...
 */
measure<T: Function>(objName: string, fnName: string, func: T): T
} 
...
rowIdentities?: Array<string | number>): ListViewDataSource,
...
rowIdentities?: Array<Array<string | number>>): ListViewDataSource,
getRowCount(): number,
...
/**
 * @see
 * https://facebook.github.io/react-native/docs/tabbarios-item.html#props
 */
declare export type TabBarIOSItemProps = {
...
title?: string
	...
	declare export class TabBarIOSItem mixins React.Component<TabBarIOSItemProps> {}
	
/**
 * @see
 * https://facebook.github.io/react-native/docs/tabbarios.html#props
 */
declare export type TabBarIOSProps = {
...
unselectedItemTintColor?: string
	...
	declare export class TabBarIOS mixins React.Component<TabBarIOSProps> {
 ...
 */
declare export type PlatformOSType = "ios"
| "android"
| "macos"
| "windows"
| "web";
...
specifics: $ObjMapi<{[k: PlatformOSType | "default"]: any}, <platform>(platform) => T>): T
	...
	declare type PlatformIOSStatic = {
isPad: boolean,
isTVOS: boolean
} & PlatformStatic
 ...
 */
declare type DeviceEventEmitterStatic = {
...
gen: () => Promise<any>
	...
	declare export type InteractionManagerStatic = {
Events: {
...
setDeadline(deadline: number): void
	...
	declare export type ScrollResponderEvent = {} & NativeSyntheticEvent<NativeTouchEvent>

	declare type ScrollResponderMixin = {
 ...
 * Default is 0.
 * @param preventNegativeScrolling
...
scrollResponderKeyboardDidHide(e: ScrollResponderEvent): void
	...
	declare export interface ScrollViewPropsIOS {
...
zoomScale?: number
	...
	declare export interface ScrollViewPropsAndroid {
...
nestedScrollEnabled?: boolean
	...
	declare export type ScrollViewProps = {
 ...
 */
onScroll?: (Animated$event: NativeSyntheticEvent<NativeScrollEvent>) => void,

/**
 * Fires if a user initiates a scroll gesture.
 */
onScrollBeginDrag?: (Animated$event: NativeSyntheticEvent<NativeScrollEvent>) => void,

/**
 * Fires when a user has finished scrolling.
 */
onScrollEndDrag?: (Animated$event: NativeSyntheticEvent<NativeScrollEvent>) => void,

/**
 * Fires when scroll view has finished moving
 */
onMomentumScrollEnd?: (Animated$event: NativeSyntheticEvent<NativeScrollEvent>) => void,

/**
 * Fires when scroll view has begun moving
 */
onMomentumScrollBegin?: (Animated$event: NativeSyntheticEvent<NativeScrollEvent>) => void,
...
} & ViewProps & ScrollViewPropsIOS & ScrollViewPropsAndroid & Touchable

	declare class ScrollViewComponent mixins React.Component<ScrollViewProps> {}
	declare var ScrollViewBase: Constructor<ScrollResponderMixin> & typeof ScrollViewComponent;
	declare export class ScrollView mixins ScrollViewBase {
...
y: number
	...
	declare export interface NativeScrollVelocity {
x: number,
y: number
} 
...
zoomScale: number
	...
	declare export type SnapshotViewIOSProps = {
onSnapshotReady(): any,
testIdentifier: string
} & ViewProps

	declare class SnapshotViewIOSComponent mixins React.Component<SnapshotViewIOSProps> {}
	declare var SnapshotViewIOSBase: Constructor<NativeMethodsMixin> & typeof SnapshotViewIOSComponent;
	declare export class SnapshotViewIOS mixins SnapshotViewIOSBase {}
 ...
 * - More to come
 */
declare export class SwipeableListView mixins React.Component<SwipeableListViewProps> {
static getNewDataSource(): SwipeableListViewDataSource
}
	
/**
 * @see
 * : http://facebook.github.io/react-native/docs/actionsheetios.html#content
 */
...
tintColor?: string
	...
	declare export type ShareSharedAction = {
action: "sharedAction",
activityType?: string
};
	declare export type ShareDismissedAction = {
action: "dismissedAction"
};
	declare export type ShareAction = ShareSharedAction | ShareDismissedAction;
...
dismissedAction: "dismissedAction"
	...
	declare type AccessibilityEventName = "change" | "announcementFinished";
	declare type AccessibilityChangeEvent = boolean;
	declare type AccessibilityAnnoucementFinishedEvent = {
announcement: string,
success: boolean
};
	declare type AccessibilityEvent = AccessibilityChangeEvent | AccessibilityAnnoucementFinishedEvent;
	
/**
 * @see
 * https://facebook.github.io/react-native/docs/accessibilityinfo.html
 */
declare export interface AccessibilityInfoStatic {
...
handler: (Animated$event: AccessibilityEvent) => void) => void,
...
/**
 * @see
 * https://facebook.github.io/react-native/docs/alert.html#content
 */
 ...
 * @see
 * https://facebook.github.io/react-native/docs/alertios.html#content
 */
...
type?: AlertType,
defaultValue?: string,
keyboardType?: KeyboardType | KeyboardTypeIOS) => void
} 
 ...
 * @see
 * https://facebook.github.io/react-native/docs/appstateios.html#content
 */
...
getItem(
key: string,
callback?: (error?: Error, result?: string) => void): Promise<string | null>,
...
multiGet(
keys: string[],
callback?: (errors?: Error[], result?: [string, string][]) => void): Promise<[string, string][]>,
...
callback?: (errors?: Error[]) => void): Promise<void>,
 ...
 * Methods don't have more detailed documentation as of 0.25.
 */
declare export interface BackHandlerStatic {
exitApp(): void,
...
testID?: string
	...
	declare export type CameraRollGroupType = "Album"
| "All"
| "Event"
| "Faces"
| "Library"
...
setString(content: string): void
	...
	declare export interface DatePickerAndroidOpenOptions {
date?: Date | number,
minDate?: Date | number,
maxDate?: Date | number,
mode?: "calendar" | "spinner" | "default"
} 
	declare export interface DatePickerAndroidDateSetAction {
action: "dateSetAction",
year: number,
month: number,
day: number
} 
	declare export interface DatePickerAndroidDismissedAction {
action: "dismissedAction"
} 
	declare export type DatePickerAndroidOpenReturn = DatePickerAndroidDateSetAction | DatePickerAndroidDismissedAction;
 ...
 */
addEventListener(type: string, handler: (Animated$event: {
url: string
}) => void): void,
 ...
 */
removeEventListener(type: string, handler: (Animated$event: {
url: string
}) => void): void,
 ...
 */
declare export type ConnectionType = "none"
| "wifi"
| "cell"
| "unknown"
| "NONE"
...
| "VPN"
| "UNKNOWN";
	declare export type EffectiveConnectionType = "2g" | "3g" | "4g" | "unknown";
	declare export interface ConnectionInfo {
type: ConnectionType,
...
addEventListener: (
eventName: string,
listener: (result: ConnectionInfo | ConnectionType) => void) => void,
 ...
 * are the responder.
 */
StyleSheet$create(config: PanResponderCallbacks): PanResponderInstance
} 
	declare export interface Rationale {
title: string,
message: string
} 
	declare export type Permission = "android.permission.READ_CALENDAR"
...
| "android.permission.WRITE_EXTERNAL_STORAGE";
	declare export type PermissionStatus = "granted" | "denied" | "never_ask_again";
 ...
 */
requestMultiple(
permissions: Array<string>): Promise<{
...
handler: (notification: PushNotification) => void): void,
...
handler: ((notification: PushNotification) => void) | ((deviceToken: string) => void) | ((error: {
message: string,
code: number,
details: any
}) => void)): void,
 ...
 */
requestPermissions(
permissions?: PushNotificationPermissions): Promise<PushNotificationPermissions>,
...
clearWatch(watchId: number): void
	...
	declare export type StatusBarStyle = "default" | "light-content" | "dark-content";
	declare export type StatusBarAnimation = "none" | "fade" | "slide";
	declare export interface StatusBarPropsIOS {
...
showHideTransition?: "fade" | "slide"
	...
	declare export interface StatusBarPropsAndroid {
...
translucent?: boolean
	...
	declare export type StatusBarProps = {
 ...
 */
hidden?: boolean
} & StatusBarPropsIOS & StatusBarPropsAndroid

	declare export class StatusBar mixins React.Component<StatusBarProps> {
 ...
 */
declare export type StatusBarIOSStatic = {} & NativeEventEmitter

	declare export interface TimePickerAndroidOpenOptions {
hour?: number,
minute?: number,
is24Hour?: boolean,
mode?: "clock" | "spinner" | "default"
} 
	declare export interface TimePickerAndroidTimeSetAction {
action: "timeSetAction",
hour: number,
minute: number
} 
	declare export interface TimePickerAndroidDismissedAction {
action: "dismissedAction"
} 
	declare export type TimePickerAndroidOpenReturn = TimePickerAndroidTimeSetAction | TimePickerAndroidDismissedAction;
...
relativeToNativeNode: number,
onFail: () => void,
onSuccess: MeasureLayoutOnSuccessCallback): void,
...
items: string[],
error: () => void,
success: (item: string, index: number | void) => void): void
} 
	declare export type SwitchPropsIOS = {
 ...
 */
declare class SwitchComponent mixins React.Component<SwitchProps> {}
	declare var SwitchBase: Constructor<NativeMethodsMixin> & typeof SwitchComponent;
	declare export class Switch mixins SwitchBase {}
 ...
 * @see
 * https://facebook.github.io/react-native/docs/vibrationios.html#content
 */
...
failure: (error: Object) => void): void
	...
	declare export interface ARTNodeMixin {
opacity?: number,
originX?: number,
originY?: number,
scaleX?: number,
...
visible?: boolean
	...
	declare export type ARTGroupProps = {
width?: number,
height?: number
} & ARTNodeMixin

	declare export type ARTClippingRectangleProps = {
width?: number,
height?: number
} & ARTNodeMixin

	declare export type ARTRenderableMixin = {
fill?: string,
stroke?: string,
...
strokeWidth?: number
	...
	declare export type ARTShapeProps = {
d: string,
width?: number,
height?: number
} & ARTRenderableMixin

	declare export type ARTTextProps = {
font?: string,
alignment?: string
} & ARTRenderableMixin

	declare export interface ARTSurfaceProps {
style?: StyleProp<ViewStyle>,
width: number,
height: number
} 
	declare export class ClippingRectangle mixins React.Component<ARTClippingRectangleProps> {}
	declare export class Group mixins React.Component<ARTGroupProps> {}
	declare export class Shape mixins React.Component<ARTShapeProps> {}
	declare export class Surface mixins React.Component<ARTSurfaceProps> {}
	declare export class ARTText mixins React.Component<ARTTextProps> {}
	declare export interface ARTStatic {
ClippingRectangle: typeof ClippingRectangle,
Group: typeof Group,
Shape: typeof Shape,
Surface: typeof Surface,
Animated$Text: typeof ARTText
} 
	declare export type KeyboardEventName = "keyboardWillShow"
| "keyboardDidShow"
| "keyboardWillHide"
| "keyboardDidHide"
| "keyboardWillChangeFrame"
| "keyboardDidChangeFrame";
	declare export type KeyboardEventEasing = "easeIn"
| "easeInEaseOut"
| "easeOut"
| "linear"
| "keyboard";
	declare type ScreenRect = {
screenX: number,
screenY: number,
width: number,
height: number
...
isEventFromThisApp: boolean
	...
	declare type KeyboardEventListener = (Animated$event: KeyboardEvent) => void;
	declare export type KeyboardStatic = {
dismiss: () => void,
addListener(
eventType: KeyboardEventName,
listener: KeyboardEventListener): EmitterSubscription
} & NativeEventEmitter

	declare export var ART: ARTStatic;
	declare export type ART = ARTStatic;
	declare export var ImagePickerIOS: ImagePickerIOSStatic;
	declare export type ImagePickerIOS = ImagePickerIOSStatic;
	declare export var LayoutAnimation: LayoutAnimationStatic;
	declare export type LayoutAnimation = LayoutAnimationStatic;
	declare export var Animated$SectionList: SectionListStatic<any>;
	declare export type SectionList<ItemT> = SectionListStatic<ItemT>;
	declare export var Systrace: SystraceStatic;
	declare export type Systrace = SystraceStatic;
	declare export var ActionSheetIOS: ActionSheetIOSStatic;
	declare export type ActionSheetIOS = ActionSheetIOSStatic;
	declare export var Share: ShareStatic;
	declare export type Share = ShareStatic;
	declare export var AdSupportIOS: AdSupportIOSStatic;
	declare export type AdSupportIOS = AdSupportIOSStatic;
	declare export var AccessibilityInfo: AccessibilityInfoStatic;
	declare export type AccessibilityInfo = AccessibilityInfoStatic;
	declare export var Alert: AlertStatic;
	declare export type Alert = AlertStatic;
	declare export var AlertAndroid: AlertAndroidStatic;
	declare export type AlertAndroid = AlertAndroidStatic;
	declare export var AlertIOS: AlertIOSStatic;
	declare export type AlertIOS = AlertIOSStatic;
	declare export var AppState: AppStateStatic;
	declare export type AppState = AppStateStatic;
	declare export var AppStateIOS: AppStateStatic;
	declare export type AppStateIOS = AppStateStatic;
	declare export var AsyncStorage: AsyncStorageStatic;
	declare export type AsyncStorage = AsyncStorageStatic;
	declare export var BackAndroid: BackAndroidStatic;
	declare export type BackAndroid = BackAndroidStatic;
	declare export var BackHandler: BackHandlerStatic;
	declare export type BackHandler = BackHandlerStatic;
	declare export var CameraRoll: CameraRollStatic;
	declare export type CameraRoll = CameraRollStatic;
	declare export var Clipboard: ClipboardStatic;
	declare export type Clipboard = ClipboardStatic;
	declare export var DatePickerAndroid: DatePickerAndroidStatic;
	declare export type DatePickerAndroid = DatePickerAndroidStatic;
	declare export var Geolocation: GeolocationStatic;
 ...
 */
declare export var I18nManager: I18nManagerStatic;
	declare export type I18nManager = I18nManagerStatic;
	declare export var ImageEditor: ImageEditorStatic;
	declare export type ImageEditor = ImageEditorStatic;
	declare export var ImageStore: ImageStoreStatic;
	declare export type ImageStore = ImageStoreStatic;
	declare export var InteractionManager: InteractionManagerStatic;
	declare export var IntentAndroid: IntentAndroidStatic;
	declare export type IntentAndroid = IntentAndroidStatic;
	declare export var Keyboard: KeyboardStatic;
	declare export var Linking: LinkingStatic;
	declare export type Linking = LinkingStatic;
	declare export var LinkingIOS: LinkingIOSStatic;
	declare export type LinkingIOS = LinkingIOSStatic;
	declare export var NativeMethodsMixin: NativeMethodsMixinStatic;
	declare export type NativeMethodsMixin = NativeMethodsMixinStatic;
	declare export var NativeComponent: NativeMethodsMixinStatic;
	declare export type NativeComponent = NativeMethodsMixinStatic;
	declare export var NetInfo: NetInfoStatic;
	declare export type NetInfo = NetInfoStatic;
	declare export var PanResponder: PanResponderStatic;
	declare export type PanResponder = PanResponderStatic;
	declare export var PermissionsAndroid: PermissionsAndroidStatic;
	declare export type PermissionsAndroid = PermissionsAndroidStatic;
	declare export var PushNotificationIOS: PushNotificationIOSStatic;
	declare export type PushNotificationIOS = PushNotificationIOSStatic;
	declare export var Settings: SettingsStatic;
	declare export type Settings = SettingsStatic;
	declare export var StatusBarIOS: StatusBarIOSStatic;
	declare export type StatusBarIOS = StatusBarIOSStatic;
	declare export var TimePickerAndroid: TimePickerAndroidStatic;
	declare export type TimePickerAndroid = TimePickerAndroidStatic;
	declare export var ToastAndroid: ToastAndroidStatic;
	declare export type ToastAndroid = ToastAndroidStatic;
	declare export var UIManager: UIManagerStatic;
	declare export type UIManager = UIManagerStatic;
	declare export var VibrationIOS: VibrationIOSStatic;
	declare export type VibrationIOS = VibrationIOSStatic;
	declare export var Vibration: VibrationStatic;
	declare export type Vibration = VibrationStatic;
	declare export var Dimensions: Dimensions;
	declare export var ShadowPropTypesIOS: ShadowPropTypesIOSStatic;
	declare export type Easing = EasingStatic;
	declare export var Easing: EasingStatic;
	declare export var DeviceEventEmitter: DeviceEventEmitterStatic;
	
/**
 * Abstract base class for implementing event-emitting modules. This implements
 * a subset of the standard EventEmitter node module API.
 */
declare export type NativeEventEmitter = {} & EventEmitter

	declare export var NativeEventEmitter: NativeEventEmitter;
	
/**
 * Deprecated - subclass NativeEventEmitter to create granular event modules instead of
 * adding all event listeners directly to RCTNativeAppEventEmitter.
 */
declare export var NativeAppEventEmitter: RCTNativeAppEventEmitter;
 ...
 */
declare interface NativeModulesStatic {
[name: string]: any
} 
 ...
 */
declare export var NativeModules: NativeModulesStatic;
	declare export var Platform: PlatformStatic;
	declare export var PlatformIOS: PlatformIOSStatic;
	declare export var PixelRatio: PixelRatioStatic;
 ...
 *  *
 */
declare export function requireNativeComponent(viewName: string): any

	declare export function findNodeHandle(
componentOrHandle: null | number | React.Component<any, any> | React.ComponentClass<any>): null | number

	declare export function processColor(color: any): number

	declare export var YellowBox: React.Component<any, any> & {
ignoreWarnings: (warnings: string[]) => void
};
	declare export function __spread(target: any, ...sources: any[]): any

	declare type ErrorHandlerCallback = (error: any, isFatal?: boolean) => void;
	declare export interface ErrorUtils {
...
export type addons$TestModule = addons$TestModuleStatic;
	declare export var ColorPropType: React.Validator<string>;
	declare export var EdgeInsetsPropType: React.Validator<Insets>;
	declare export var PointPropType: React.Validator<PointPropType>;
	declare export var ViewPropTypes: React.ValidationMap<ViewProps>;
	declare module 'global' {
        declare function require(name: string): any
