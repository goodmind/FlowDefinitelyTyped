...
static fromJS(object: {[key: string]: any}): Data
	...
	declare export interface RulesByNodeType {
[key: string]: Rules
} 
	declare export interface ObjectAndType {
object?: string,
type?: string
} 
...
text?: RegExp
	...
	declare export interface SchemaProperties {
document?: Rules,
blocks?: RulesByNodeType,
inlines?: RulesByNodeType
} 
	declare export interface ValueProperties {
document?: Document,
selection?: Selection,
data?: Data,
decorations?: Immutable.List<Decoration> | null
} 
	declare export interface ValueJSON {
...
object?: "value"
	...
	declare export type Path = Immutable.List<number> | string | number;
	declare export class Value mixins "NO PRINT IMPLEMENTED: CallExpression" {
document: Document;
selection: Selection;
data: Data;
object: "value";
...
length: number,
mark: Mark,
properties: MarkProperties): Value;
...
clearAtomicRanges(key: string, from: number, to?: number): Value
	...
	declare export interface DocumentProperties {
...
[key: string]: any
	...
	declare export interface DocumentJSON {
nodes?: NodeJSON[],
key?: string,
data?: {
[key: string]: any
...
object?: "document"
	...
	declare export class Document<DataMap= {
[key: string]: any
}> mixins BaseNode<DataMap> {
object: "document";
nodes: Immutable.List<Block>;
static create(
properties: DocumentProperties | Document | Immutable.List<Node> | Node[]): Document;
...
toJSON(): DocumentJSON
	...
	declare export interface BlockProperties {
type: string,
key?: string,
...
[key: string]: any
	...
	declare export interface BlockJSON {
type: string,
key?: string,
...
object: "block"
	...
	declare export class Block mixins BaseNode {
object: "block";
...
static isBlockList(maybeBlockList: any): boolean;
toJSON(): BlockJSON
}
	declare export interface InlineProperties {
type: string,
key?: string,
nodes?: Immutable.List<Node>,
data?: Immutable.Map<string, any> | {
[key: string]: any
	...
	declare export interface InlineJSON {
type: string,
key?: string,
nodes?: NodeJSON[],
data?: {
...
object: "inline"
	...
	declare export class Inline mixins BaseNode {
object: "inline";
...
static isInlineList(maybeInlineList: any): boolean;
toJSON(): InlineJSON
}
...
marks?: Mark[]
	...
	declare export interface TextJSON {
key?: string,
leaves: LeafJSON[],
object: "text"
} 
	declare export interface LeafAndOffset {
startOffset: number,
endOffset: number,
index: number,
leaf: Leaf
} 
	declare export class Text mixins "NO PRINT IMPLEMENTED: CallExpression" {
object: "text";
key: string;
text: string;
static create(properties: TextProperties | Text | string): Text;
static createList(
elements?: Text[] | TextProperties[] | Immutable.List<Text> | Immutable.List<TextProperties>): Immutable.List<Text>;
...
toJSON(): TextJSON;
getKeysToPathsTable(): {[key: string]: any};
getString(): string;
...
setLeaves(leaves: Immutable.List<Leaf>): Text
	...
	declare export interface LeafProperties {
marks?: Immutable.Set<Mark>,
text?: string
} 
	declare export interface LeafJSON {
marks?: MarkJSON[],
text?: string,
object: "leaf"
} 
	declare export class Leaf mixins "NO PRINT IMPLEMENTED: CallExpression" {
object: "leaf";
...
static createList(
attrs?: Leaf[] | LeafProperties[] | Immutable.List<Leaf> | Immutable.List<LeafProperties>): Immutable.List<Leaf>;
static fromJSON(properties: LeafJSON): Leaf;
static fromJS(properties: LeafJSON): Leaf;
static isLeaf(maybeLeaf: any): boolean;
static isLeafList(maybeLeafList: any): boolean;
...
toJSON(): LeafProperties
	...
	declare export type Node = Document | Block | Inline | Text;
	declare export type NodeJSON = DocumentJSON | BlockJSON | InlineJSON | TextJSON;
	declare export type NodeProperties = DocumentProperties | BlockProperties | InlineProperties | TextProperties;
	declare class BaseNode<DataMap= {
[key: string]: any
}> mixins "NO PRINT IMPLEMENTED: CallExpression" {
data: Immutable.Map<$Keys<DataMap>, $ElementType<DataMap, $Keys<DataMap>>>;
type: string;
key: string;
object: "document" | "block" | "inline" | "text";
nodes: Immutable.List<Node>;
text: string;
static isNode(maybeNode: any): boolean;
static isNodeList(maybeNodeList: any): boolean;
...
startOffset: number,
endKey: string,
endOffset: number): Immutable.OrderedSet<Mark>;
...
getSelectionIndexes(range: Range, isSelected?: boolean): {
start: number,
end: number
} | null;
getText(): string;
...
length: number,
mark: Mark,
properties: MarkProperties): Node;
splitNode(path: Path, position: number, properties: NodeProperties): Node;
validate(editor: Editor): Error | void
}
	declare export interface MarkProperties {
type: string,
data?: Immutable.Map<string, any> | {
[key: string]: any
}
} 
	declare export interface MarkJSON {
type: string,
data?: {
[key: string]: any
},
object: "mark"
	...
	declare export class Mark mixins "NO PRINT IMPLEMENTED: CallExpression" {
object: "mark";
type: string;
data: Immutable.Map<string, any>;
...
toJSON(): MarkProperties
	...
	declare export interface SelectionProperties {
anchor?: Point,
focus?: Point,
isFocused?: boolean,
marks?: Immutable.Set<Mark> | null
} 
	declare export interface SelectionJSON {
anchor?: PointJSON,
focus?: PointJSON,
isFocused?: boolean,
...
marks?: MarkJSON[] | null
	...
	declare export class Selection mixins BaseRange {
object: "selection";
anchor: Point;
focus: Point;
isFocused: boolean;
...
isSelection(maybeSelection: any): boolean;
...
setProperties(properties: Selection | SelectionProperties): Selection
	...
	declare export interface RangeProperties {
anchor?: Point,
focus?: Point
} 
	declare export interface RangeJSON {
anchor?: PointJSON,
focus?: PointJSON
} 
	declare export class Range mixins BaseRange {
object: "range";
anchor: Point;
static create(properties: RangeProperties | Range): Range;
static createList(
elements?: Range[] | RangeProperties[] | Immutable.List<Range> | Immutable.List<RangeProperties>): Immutable.List<Range>;
...
toJSON(): RangeJSON
	...
	declare export interface DecorationProperties {
anchor?: Point,
focus?: Point,
mark?: Mark | null
} 
	declare export interface DecorationJSON {
anchor?: PointJSON,
focus?: PointJSON,
mark?: MarkJSON | null
} 
	declare export class Decoration mixins BaseRange {
object: "decoration";
anchor: Point;
focus: Point;
mark: Mark | null;
...
static createList(
elements?: Decoration[] | DecorationProperties[] | Immutable.List<Decoration> | Immutable.List<DecorationProperties>): Immutable.List<Decoration>;
...
static isDecoration(maybeDecoration: any): boolean;
toJSON(): DecorationJSON;
setProperties(properties: Decoration | DecorationProperties): Decoration
}
	declare export type RangeTypeProperties = RangeProperties | SelectionProperties | DecorationProperties;
	declare export type RangeTypeJSON = RangeJSON | SelectionJSON | DecorationJSON;
	declare export type RangeType = Range | Selection | Decoration;
	declare class BaseRange mixins "NO PRINT IMPLEMENTED: CallExpression" {
isCollapsed: boolean;
isExpanded: boolean;
isBackward: boolean;
isForward: boolean;
...
path?: Path | null
	...
	declare export interface PointJSON {
key?: string | null,
offset?: number,
path?: Path | null,
object: "point"
} 
	declare export class Point mixins "NO PRINT IMPLEMENTED: CallExpression" {
object: "point";
key: string | null;
offset: number;
path: Path | null;
...
toJSON(options: any): {[key: string]: any};
unset(): Point
}
	declare export type Operation = InsertTextOperation
| RemoveTextOperation
| AddMarkOperation
| RemoveMarkOperation
| SetMarkOperation
...
| SetValueOperation;
	declare export interface InsertTextOperation {
type: "insert_text",
path: number[],
offset: number,
text: string,
marks: Mark[]
	...
	declare export interface RemoveTextOperation {
type: "remove_text",
path: number[],
offset: number,
text: string
} 
	declare export interface AddMarkOperation {
type: "add_mark",
path: number[],
offset: number,
length: number,
mark: Mark
	...
	declare export interface RemoveMarkOperation {
type: "remove_mark",
path: number[],
offset: number,
length: number,
mark: Mark
	...
	declare export interface SetMarkOperation {
type: "set_mark",
path: number[],
offset: number,
length: number,
...
properties: MarkProperties
	...
	declare export interface InsertNodeOperation {
type: "insert_node",
path: number[],
node: Node
} 
	declare export interface MergeNodeOperation {
type: "merge_node",
path: number[],
position: number
} 
	declare export interface MoveNodeOperation {
type: "move_node",
path: number[],
newPath: number[]
} 
	declare export interface RemoveNodeOperation {
type: "remove_node",
path: number[],
node: Node
} 
	declare export interface SetNodeOperation {
type: "set_node",
path: number[],
properties: BlockProperties | InlineProperties | TextProperties
} 
	declare export interface SplitNodeOperation {
type: "split_node",
path: number[],
position: number,
target: number
} 
	declare export interface SetSelectionOperation {
type: "set_selection",
properties: RangeProperties,
selection: Range
} 
	declare export interface SetValueOperation {
type: "set_value",
properties: ValueProperties,
value: Value
} 
	declare export interface Operations {
apply: (value: Value, operation: Operation) => Value,
invert: (operation: Operation) => Operation
} 
	declare export type ErrorCode = "child_object_invalid"
| "child_required"
| "child_type_invalid"
| "child_unknown"
...
| "previous_sibling_type_invalid";
	declare export class SlateError mixins Error {
code: ErrorCode;
[key: string]: any
}
...
KeyUtils$create(attrs: Immutable.List<number> | string): Immutable.List<number>,
crop(
a: Immutable.List<number>,
b: Immutable.List<number>,
size?: number): Array<Immutable.List<number>>,
decrement(
path: Immutable.List<number>,
n?: number,
index?: number): Immutable.List<number>,
increment(
path: Immutable.List<number>,
n?: number,
index?: number): Immutable.List<number>,
...
relate(a: Immutable.List<number>, b: Immutable.List<number>): Immutable.List<number>
	...
	declare export interface EditorProperties {
onChange?: (change: {
...
value?: Value
	...
	declare export class Editor mixins Controller {
object: "editor";
onChange: (change: {
operations: Immutable.List<Operation>,
value: Value
...
readOnly: boolean;
value: Value;
constructor(attributes: EditorProperties): this;
...
newMark: Mark | MarkProperties | string): Editor;
...
offset: number,
length: number,
mark: MarkProperties | Mark | string): Editor;
addMarkByPath(
path: Path,
offset: number,
length: number,
...
offset: number,
text: string,
marks?: Immutable.Set<Mark> | Mark[]): Editor;
insertTextByPath(
path: Path,
offset: number,
text: string,
...
length: number,
mark: Mark,
properties: MarkProperties): Editor;
setMarksByPath(
path: Path,
offset: number,
length: number,
...
replaceMark(
mark: Mark | MarkProperties | string,
newMark: Mark | MarkProperties | string): Controller,
...
offset: number,
length: number,
mark: MarkProperties | Mark | string): Controller,
...
offset: number,
text: string,
marks?: Immutable.Set<Mark> | Mark[]): Controller,
...
offset: number,
length: number,
mark: Mark | Mark | string): Controller,
...
length: number,
mark: Mark,
properties: MarkProperties): Controller,
...
setNodeByKey(
key: string,
properties: BlockProperties | InlineProperties | string): Controller,
