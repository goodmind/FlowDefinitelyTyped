declare module 'd3-contour' {
	...
	import type {
          ThresholdNumberArrayGenerator,ThresholdCountGenerator
        } from 'd3-array';
 ...
 */
declare export type ContourMultiPolygon = {
 ...
 */
declare export interface Contours {
 ...
 */
thresholds(
thresholds: ThresholdCountGenerator<number> | ThresholdNumberArrayGenerator<number>): this
} 
	
/**
 * Construct a new contour generator with the default settings.
 */
declare export function contours(): Contours
 ...
 */
declare export interface ContourDensity<Datum= [number, number]> {
 ...
 */
declare export function contourDensity<Datum= [number, number]>(): ContourDensity<Datum>
