...
declare interface SequelizeCursorPagination$WithPaginationOptions<MethodName: string> {
methodName?: MethodName,
primaryKeyField?: string
} 

declare type SequelizeCursorPagination$WithPaginationModel<MethodName: string, Model, ModelInst, ModelAttrs> = Model & $ObjMapi<{[k: MethodName]: any}, <key>(key) => {
...
declare function SequelizeCursorPagination$withPagination<MethodName: string= "paginate">(
options?: SequelizeCursorPagination$WithPaginationOptions<MethodName>): (<Model: Sequelize.Model<ModelInst, ModelAttrs>, ModelInst, ModelAttrs>(
model: Model) => SequelizeCursorPagination$WithPaginationModel<MethodName, Model, ModelInst, ModelAttrs>)
