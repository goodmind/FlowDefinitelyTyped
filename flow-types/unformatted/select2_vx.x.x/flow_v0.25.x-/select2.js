...
id?: void
	...
	declare export interface ProcessedResult<Result= DataFormat | GroupedDataFormat> {
results: Result[],
pagination?: {
more: boolean
}
...
data: IdTextPair
	...
	declare export type AjaxOptions<Result= DataFormat | GroupedDataFormat, RemoteResult= any> = {
delay?: number,
...
processResults?: (data: RemoteResult, params: QueryOptions) => ProcessedResult<Result>
	...
	declare export interface Options<Result= DataFormat | GroupedDataFormat, RemoteResult= any> {
