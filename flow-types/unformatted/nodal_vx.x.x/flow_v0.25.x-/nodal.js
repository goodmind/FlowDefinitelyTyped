...
| Array
| Nodal.Model
| Nodal.ModelArray} data Object to be formatted for API response
 ...
 * @param {Nodal.Composer} parent The composer's parent (another composer instance)
 */
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} )} callback The method to execute when the query is complete
 */
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} )} callback The callback for the update query
 */
update(
fields: IAnyObject,
callback: (err: Error, modelArray: ModelArray<T>) => void): void
}
 ...
 * @param {Nodal.Model} Model The Model to base your query around (used for testing)
 */
...
newTableName: string,
renameModel: string,
newModelName: string): any;
alterColumn(
table: string,
column: string,
type: DataType,
properties: IColumnProperties): any;
addColumn(
table: string,
column: string,
type: DataType,
...
constructor(modelData: Object, fromStorage?: boolean, fromSeed?: boolean): this;
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} model_1 , ... {Nodal.Model|Nodal.ModelArray} model_n)}
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} model )} callback
...
field: string,
value: any,
callback: (err: IExtendedError, model?: Model) => void): void;

/**
 * Creates a new model instance using the provided data.
 * @param {{[key: string]: any}} data The data to load into the object.
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} model )} callback The callback to execute upon completion
 */
 ...
 * @param {{[key: string]: any}} data Key-value pairs of Model creation data. Will use appropriate value to query for based on "field" parametere.
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} model )} callback The callback to execute upon completion
 */
static findOrCreateBy(
field: string,
data: IAnyObject,
callback: (err: IExtendedError | null, model?: Model) => void): void;
 ...
 * @param {optional} } db Deprecated - provide a database to query from. Set the model's db in its constructor file, instead.
 ...
 * @param {class} } Model The Model class which your current model belongs to
 * @param {Object} options "name": The string name of the parent in the relationship (default to camelCase of Model name)
 ...
 * @param {"NO PRINT IMPLEMENTED: JSDocFunctionType"} fnAction the validation to run - first parameter is the value you're testing.
 */
...
options: IOptions;
constructor(parent: RelationshipNode, child: RelationshipNode, options: IOptions): this;
toString(): string;
...
[item: string]: [string]
	...
	declare export type DataType = "serial"
| "int"
| "currency"
| "float"
| "string"
