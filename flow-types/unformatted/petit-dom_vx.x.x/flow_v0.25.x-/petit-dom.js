 ...
 */
declare export function h<T: $Keys<ElementTagNameMap>, E: $ElementType<ElementTagNameMap, T>>(
type: T,
props?: PetitDom$PetitDom$Props<E> | null,
...children: PetitDom$PetitDom$Content[]): PetitDom$PetitDom$ElementNode<T, E>
 ...
 * @returns A new VNode object
 */
declare export function h<P: PetitDom$PetitDom$ComponentProps= PetitDom$PetitDom$ComponentProps>(
type: PetitDom$PetitDom$Component<P>,
props?: P | null,
...children: PetitDom$PetitDom$Content[]): PetitDom$PetitDom$ComponentNode<P>
...
props?: P | null,
...children: PetitDom$PetitDom$Content[]): PetitDom$PetitDom$ComponentClassNode<P>
...
props?: P | null,
...children: PetitDom$PetitDom$Content[]): PetitDom$PetitDom$FunctionComponentNode<P>
...
declare type PetitDom$DOMElementProps<E: JSX$Element> = $ObjMapi<E, <P>(P) => $ElementType<E, P>>;

declare interface PetitDom$IntrinsicProps {
key?: PetitDom$Key
} 

declare type PetitDom$Props<E: JSX$Element= JSX$Element> = PetitDom$IntrinsicProps & PetitDom$DOMElementProps<E>;

declare type PetitDom$ShouldUpdate<P: PetitDom$ComponentProps> = (
newProps: P,
oldProps: P,
newContent: $ReadOnlyArray<PetitDom$VNode>,
oldContent: $ReadOnlyArray<PetitDom$VNode>) => boolean;

declare interface PetitDom$FunctionComponent<P: PetitDom$ComponentProps> {
(props: P, content: $ReadOnlyArray<PetitDom$Content>): PetitDom$FunctionComponentNode<P>,
shouldUpdate?: PetitDom$ShouldUpdate<P>
} 

declare interface PetitDom$ComponentClass<P: PetitDom$ComponentProps> {
new (props: P, content: $ReadOnlyArray<PetitDom$Content>): PetitDom$Component<P>
} 
...
oldProps: P,
newContent: $ReadOnlyArray<PetitDom$VNode>,
oldContent: $ReadOnlyArray<PetitDom$VNode>): JSX$Element,
...
declare type PetitDom$ElementNode<T: $Keys<PetitDom$DomElements>, E: $ElementType<PetitDom$DomElements, T>> = {
+type: T,
...
declare type JSX$IntrinsicElements = $ObjMapi<PetitDom$PetitDom$DomElements, <P>(P) => PetitDom$PetitDom$Props<$ElementType<PetitDom$PetitDom$DomElements, P>> & {
content?: PetitDom$PetitDom$Content | $ReadOnlyArray<PetitDom$PetitDom$Content>
}>;
    }
