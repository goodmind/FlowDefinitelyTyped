...
declare export function PreludeLS$pairsToObj<A>(object: [number, A][]): {
[key: number]: A
}
...
declare export function PreludeLS$listsToObj<A>(PreludeLS$keys: string[]): (PreludeLS$values: A[]) => {
[key: string]: A
}
...
declare export function PreludeLS$listsToObj<A>(PreludeLS$keys: number[]): (PreludeLS$values: A[]) => {
[key: number]: A
}
...
declare export function PreludeLS$each<A>(f: (x: A) => void): (object: {
[key: string]: A
}) => {
[key: string]: A
}
...
declare export function PreludeLS$map<A, B>(f: (x: A) => B): (object: {
[key: string]: A
}) => {
[key: string]: B
}
...
declare export function PreludeLS$filter<A>(f: (x: A) => boolean, object: {
[key: string]: A
}): {
[key: string]: A
}
...
declare export function PreludeLS$reject<A>(f: (x: A) => boolean, object: {
[key: string]: A
}): {
[key: string]: A
}
...
declare export function PreludeLS$find<A>(f: (x: A) => boolean): (object: {
[key: string]: A
}) => A
...
[key: string]: A
	...
	declare export function filter<A>(f: (x: A) => boolean, object: {
[key: string]: A
}): {
[key: string]: A
}
...
[key: string]: A
	...
	declare export function reject<A>(f: (x: A) => boolean, object: {
[key: string]: A
}): {
[key: string]: A
}
...
declare export function PreludeLS$slice(x: number): (y: number) => (str: string) => string
...
declare export function PreludeLS$splitAt(n: number): (str: string) => [string, string]


declare export function PreludeLS$splitAt(n: number, str: string): [string, string]


declare export function PreludeLS$takeWhile(f: (str: string) => boolean): (str: string) => string


declare export function PreludeLS$takeWhile(f: (str: string) => boolean, str: string): string


declare export function PreludeLS$dropWhile(f: (str: string) => boolean): (str: string) => string


declare export function PreludeLS$dropWhile(f: (str: string) => boolean, str: string): string


declare export function PreludeLS$span(f: (str: string) => boolean): (str: string) => [string, string]
