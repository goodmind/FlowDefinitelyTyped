declare module 'angular-block-ui' {
        import typeof * as angular from 'angular';

	declare module 'angular' {
        declare interface blockUI$BlockUIConfig {
...
declare interface blockUI$BlockUIService {
 ...
 * @param messageOrOptions Either supply the message (string) to be show in the
 ...
 */
start(messageOrOptions?: (string | blockUI$BlockUIConfig)): void,
 ...
 */
isBlocking(): boolean,
instances: blockUI$BlockUIInstances
} 

declare interface blockUI$BlockUIInstances {
get(id: string): blockUI$BlockUIService
} 
    }
