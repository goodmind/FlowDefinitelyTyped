...
declare type Neuron$SquashingFunction = (x: number, derivate: boolean) => number;
      ...
      declare var npm$namespace$squash: {
        
        LOGISTIC: typeof squash$LOGISTIC,
TANH: typeof squash$TANH,
IDENTITY: typeof squash$IDENTITY,
HLIM: typeof squash$HLIM,
ReLU: typeof squash$ReLU,
      }
declare var squash$LOGISTIC: Neuron$SquashingFunction;

declare var squash$TANH: Neuron$SquashingFunction;

declare var squash$IDENTITY: Neuron$SquashingFunction;

declare var squash$HLIM: Neuron$SquashingFunction;

declare var squash$ReLU: Neuron$SquashingFunction;
 ...
 * @default LOGISTIC
 */
squash: Neuron$Neuron$SquashingFunction;
 ...
 */
project(neuron: Neuron, weight?: number): Neuron$Neuron$Connection;
 ...
 * @param connection
 */
gate(Neuron$connection: Neuron$Neuron$Connection): void;
 ...
 */
declare  class Layer$connectionType {
  constructor(...args: empty): mixed;
static +ALL_TO_ALL: Class<Layer$connectionType__ALL_TO_ALL> & Layer$connectionType__ALL_TO_ALL & 0;// 0
static +ONE_TO_ONE: Class<Layer$connectionType__ONE_TO_ONE> & Layer$connectionType__ONE_TO_ONE & 1;// 1
static +ALL_TO_ELSE: Class<Layer$connectionType__ALL_TO_ELSE> & Layer$connectionType__ALL_TO_ELSE & 2;// 2

}

declare class Layer$connectionType__ALL_TO_ALL mixins Layer$connectionType {}
declare class Layer$connectionType__ONE_TO_ONE mixins Layer$connectionType {}
declare class Layer$connectionType__ALL_TO_ELSE mixins Layer$connectionType {}
 ...
 * Types of gates.
 */
declare  class Layer$gateType {
  constructor(...args: empty): mixed;
static +INPUT: Class<Layer$gateType__INPUT> & Layer$gateType__INPUT & 0;// 0
static +OUTPUT: Class<Layer$gateType__OUTPUT> & Layer$gateType__OUTPUT & 1;// 1
static +ONE_TO_ONE: Class<Layer$gateType__ONE_TO_ONE> & Layer$gateType__ONE_TO_ONE & 2;// 2

}

declare class Layer$gateType__INPUT mixins Layer$gateType {}
declare class Layer$gateType__OUTPUT mixins Layer$gateType {}
declare class Layer$gateType__ONE_TO_ONE mixins Layer$gateType {}
...
project(
layer: Layer | Network,
Layer$connectionType?: Layer$Layer$connectionType,
weights?: any): Layer$Layer$LayerConnection;

/**
 * A layer can gate a connection between two other layers, or a layers's self-connection.
 */
gate(
Layer$connection: Layer$Layer$LayerConnection,
Layer$gateType: Layer$Layer$gateType): void;
 ...
 * @param options
 */
set(options: Layer$Layer$Options): this;
...
layers: Network$Network$Options;
optimized: Network$Network$Optimized;

/**
 * Networks are basically an array of layers. They have an input layer, a number of hidden layers, and an output layer.
 */
constructor(options?: Network$Network$Options): this;
 ...
 */
gate(
layerConnection: Layer$Layer$LayerConnection,
Layer$gateType: Layer$Layer$gateType): void;
 ...
 */
set(options: Network$Network$Options): void;
...
declare type Trainer$CostFunction = (targetValues: number[], outputValues: number[]) => number;
      ...
      declare var npm$namespace$cost: {
        
        CROSS_ENTROPY: typeof cost$CROSS_ENTROPY,
MSE: typeof cost$MSE,
BINARY: typeof cost$BINARY,
      }
declare var cost$CROSS_ENTROPY: Trainer$CostFunction;

declare var cost$MSE: Trainer$CostFunction;

declare var cost$BINARY: Trainer$CostFunction;
 ...
 */
train(
trainingSet: Trainer$Trainer$TrainingSet,
trainingOptions?: Trainer$Trainer$TrainingOptions): Trainer$Trainer$TrainingResult;
...
trainAsync(
trainingSet: Trainer$Trainer$TrainingSet,
trainingOptions?: Trainer$Trainer$TrainingOptions): Promise<Trainer$Trainer$TrainingResult>;
 ...
 */
XOR(options?: Trainer$Trainer$XOROptions): Trainer$Trainer$TrainingResult;
 ...
 */
DSR(options?: Trainer$Trainer$DSROptions): Trainer$Trainer$DSRTrainingResult;

/**
 * This method trains the network to pass an Embedded Reber Grammar test.
 */
ERG(options?: Trainer$Trainer$ERGOptions): Trainer$Trainer$ERGTrainingResult;
