declare module 'yar' {
        import type {
          Server,ServerOptionsCache,Request,Plugin,CachePolicyOptions
        } from 'hapi';
	...
	declare interface yar$YarOptions {
...
declare interface yar$ServerYar {
revoke(id: Id): Promise<void>
} 
	declare var yar: Plugin<yar$yar$YarOptions>;
	declare module.exports: typeof yar
