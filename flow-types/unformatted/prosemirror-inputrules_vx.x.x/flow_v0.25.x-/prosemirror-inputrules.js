 ...
 */
declare export class InputRule<S: Schema= any>  {
 ...
 * action.
 */
declare export function inputRules<S: Schema= any>(config: {
 ...
 */
declare export function undoInputRule<S: Schema= any>(
state: EditorState<S>,
 ...
 */
declare export function wrappingInputRule<S: Schema= any>(
regexp: RegExp,
nodeType: NodeType<S>,
getAttrs?: {
[key: string]: any
 ...
 */
declare export function textblockTypeInputRule<S: Schema= any>(
regexp: RegExp,
nodeType: NodeType<S>,
getAttrs?: {
[key: string]: any
