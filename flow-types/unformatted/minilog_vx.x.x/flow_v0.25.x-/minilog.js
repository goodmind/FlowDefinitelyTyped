...
declare export var Minilog$backends: Minilog$Minilog$MinilogBackends;

declare export var Minilog$defaultBackend: any;

declare export var Minilog$defaultFormatter: string;

declare export class Minilog$Filter mixins Minilog$Transform {
...
declare export class Minilog$Console mixins Minilog$Transform {
