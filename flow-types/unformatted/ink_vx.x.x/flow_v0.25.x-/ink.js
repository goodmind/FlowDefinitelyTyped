...
_children: InkNode[]
	...
	declare export type InkNode = $ReadOnlyArray<InkElement | string | number | null>
| InkElement
| string
| number
| null;
...
...children: InkNode[]): InkElement
	...
	declare export function render(tree: InkElement, stream?: NodeJS.WriteStream): (() => void)

	declare export function renderToString(tree: InkElement, prevTree?: InkElement): string

	declare export type InkComponent<P: Record<string, any>= {}> = ComponentClass<P, any, any> | StatelessComponent<P, any>;
	declare export interface StatelessComponent<P: Record<string, any>= {}, C: Record<string, any>= {}> {
(props: P, context: C): InkElement,
defaultProps?: Record<string, any>,
propTypes?: ValidationMap<Record<string, any>>
} 
	declare export interface Component<P: Record<string, any>= {}, S: Record<string, any>= {}, C: Record<string, any>= {}> {
state: S,
render(
props: $ElementType<Component, "props">,
state: $ElementType<Component, "state">,
context: $ElementType<Component, "state">): InkElement,
componentWillMount?: () => void,
componentDidMount?: () => void,
componentWillUnmount?: () => void,
componentWillReceiveProps?: (
nextProps: $ElementType<Component, "props">,
nextState: $ElementType<Component, "state">) => void,
...
getChildContext?: () => (() => Record<string, any>)
	...
	declare export interface ComponentClass<P: Record<string, any>= {}, S: Record<string, any>= {}, C: Record<string, any>= {}> {
new (
props: $ElementType<Component, "props">,
context: $ElementType<Component, "state">): Component<P, S, C>,
defaultProps?: Record<string, any>,
propTypes?: ValidationMap<Record<string, any>>
} 
