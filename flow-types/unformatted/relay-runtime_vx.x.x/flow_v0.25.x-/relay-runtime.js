...
operation: any
	...
	declare export function getRequest(taggedNode: GraphQLTaggedNode): ConcreteRequest
 ...
 */
declare export type SelectorStoreUpdater<T= any> = (store: RecordSourceSelectorProxy, data: T) => void;
...
updater?: SelectorStoreUpdater<$ElementType<T, "response">>
	...
	declare export function commitRelayModernMutation<T: OperationBase= OperationDefaults>(
