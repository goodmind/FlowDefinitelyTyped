...
declare type ArangoDB$Document<T: {[key: string]: any}= any> = $ObjMapi<T, <K>(K) => $ElementType<T, K>> & ArangoDB$DocumentMetadata & {
_from?: string,
_to?: string
} & {
[key: string]: any
...
declare type ArangoDB$DocumentData<T: {[key: string]: any}= any> = $ObjMapi<T, <K>(K) => $ElementType<T, K>> & $Shape<ArangoDB$DocumentMetadata>;

declare type ArangoDB$Edge<T: {[key: string]: any}= any> = ArangoDB$Document<T> & {
_from: string,
_to: string
};
...
all(script?: Script): string[]
	...
	declare export {
        createQueue as create,deleteQueue as delete,get,JobOptions,Job,Queue,QueueItem,Script
      }
...
[key: string]: number | void
	...
	declare interface Path<A: {[key: string]: any}= any, B: {[key: string]: any}= any, E: {[key: string]: any}= any, V: {[key: string]: any}= empty> {
