declare module '@feathersjs/authentication-oauth2' {
	...
	declare var feathersAuthenticationOAuth2: ((options?: FeathersAuthenticationOAuth2Options) => () => void) & typeof self;
	declare export default typeof feathersAuthenticationOAuth2

	declare export interface FeathersAuthenticationOAuth2Options<VerifierType= typeof Verifier, ServiceType= any> {
...
refreshToken: string
	...
	declare export class Verifier<DataType= any, OptionType: FeathersAuthenticationOAuth2Options= FeathersAuthenticationOAuth2Options, ProfileType: Profile= Profile>  {
constructor(app: Application, options: OptionType): this;
options: OptionType;
service: Service<DataType>;
_updateEntity(entity: any, data: FeathersAuthenticationOAuth2Data<ProfileType>): Promise<any>;
_createEntity(data: FeathersAuthenticationOAuth2Data<ProfileType>): Promise<any>;
_normalizeResult<T= DataType>(results: T[] | Paginated<T>): Promise<T>;
_setPayloadAndDone(
entity: any,
done: (
err: Error | null,
user: {[key: string]: any},
info: {[key: string]: any}) => void): Promise<any>;
verify(
req: Request,
accessToken: string,
refreshToken: string,
