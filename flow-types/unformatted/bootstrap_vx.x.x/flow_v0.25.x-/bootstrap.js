declare module 'bootstrap' {
        import typeof * as Popper from 'popper.js';

	declare export type Placement = "auto"
| "top"
| "bottom"
| "left"
| "right";
	declare export type Trigger = "click"
| "hover"
| "focus"
| "manual"
| "click hover"
...
hide: number
	...
	declare export interface TooltipInstance<T: TooltipOption> {
config: T,
element: Element,
tip: HTMLElement
} 
	declare export interface OffsetsExtend {
popper?: $Shape<Popper.Offset>,
reference?: $Shape<Popper.Offset>
} 
	declare export interface CarouselOption {
...
touch?: boolean
	...
	declare export interface CollapseOption {
...
toggle?: boolean
	...
	declare export interface DropdownOption {
 ...
 * @default 0
 */
offset?: number | string | ((offset: OffsetsExtend) => OffsetsExtend),
...
display?: "dynamic" | "static"
	...
	declare export interface ModalOption {
...
show?: boolean
	...
	declare export type PopoverOption = {
...
content?: string | Element | (() => string | Element)
	...
	declare export interface ScrollspyOption {
...
target?: string | Element
	...
	declare export interface ToastOption {
...
delay?: number
	...
	declare export interface TooltipOption {
 ...
 */
placement?: Placement | ((node: HTMLElement, trigger: Element) => Placement),
...
boundary?: Popper.Boundary | HTMLElement
	...
	declare export type CarouselEventHandler<TElement> = {
 ...
 */
to: number
} & JQuery.TriggeredEvent<TElement, void, HTMLElement, HTMLElement>

	declare export type DropdownsEventHandler<TElement> = {
...
relatedTarget: HTMLElement
	...
	declare export type ModalEventHandler<TElement> = {
...
relatedTarget: HTMLElement | void
	...
	declare export type TapEventHandler<TElement> = {
...
relatedTarget: HTMLElement
	...
	declare export type AlertEvent = "close.bs.alert" | "closed.bs.alert";
	declare export type CarouselEvent = "slide.bs.carousel" | "slid.bs.carousel";
	declare export type CollapseEvent = "show.bs.collapse" | "shown.bs.collapse" | "hide.bs.collapse" | "hidden.bs.collapse";
	declare export type DropdownEvent = "show.bs.dropdown" | "shown.bs.dropdown" | "hide.bs.dropdown" | "hidden.bs.dropdown";
	declare export type ModalEvent = "show.bs.modal" | "shown.bs.modal" | "hide.bs.modal" | "hidden.bs.modal";
	declare export type PopoverEvent = "show.bs.popover"
| "shown.bs.popover"
| "hide.bs.popover"
| "hidden.bs.popover"
| "inserted.bs.popover";
	declare export type ScrollspyEvent = "activate.bs.scrollspy";
	declare export type TapEvent = "show.bs.tab" | "shown.bs.tab" | "hide.bs.tab" | "hidden.bs.tab";
	declare export type ToastEvent = "show.bs.toast" | "shown.bs.toast" | "hide.bs.toast" | "hidden.bs.toast";
	declare export type TooltipEvent = "show.bs.tooltip"
| "shown.bs.tooltip"
| "hide.bs.tooltip"
| "hidden.bs.tooltip"
| "inserted.bs.tooltip";
...
handler: JQuery.EventHandlerBase<TElement, CarouselEventHandler<TElement>>): this,
on(
events: DropdownEvent,
handler: JQuery.EventHandlerBase<TElement, DropdownsEventHandler<TElement>>): this,
on(
events: ModalEvent,
handler: JQuery.EventHandlerBase<TElement, ModalEventHandler<TElement>>): this,
on(
events: TapEvent,
handler: JQuery.EventHandlerBase<TElement, TapEventHandler<TElement>>): this,
on(
events: AlertEvent
| CollapseEvent
| PopoverEvent
