 ...
 */
constructor(family?: string, major?: string, minor?: string, patch?: string, source?: string): this;
 ...
 */
constructor(family?: string, major?: string, minor?: string, patch?: string): this;
 ...
 */
declare export function Useragent$parse(userAgent?: string, jsAgent?: string): Useragent$Agent
 ...
 * @param jsAgent Optional UA from js to detect chrome frame
 */
declare export function Useragent$lookup(userAgent?: string, jsAgent?: string): Useragent$Agent
...
declare export var Useragent$version: number;
	declare module.exports: typeof Useragent
