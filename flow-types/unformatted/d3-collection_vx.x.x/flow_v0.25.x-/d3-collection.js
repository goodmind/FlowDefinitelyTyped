 ...
 * @param obj An object.
 */
declare export function entries<T>(obj: {
[key: string]: T
} | ArrayLike<T>): Array<{
key: string,
value: T
 ...
 * @param obj An object.
 */
declare export function entries(obj: {[key: string]: any}): Array<{
key: string,
value: any
}>
 ...
 * The generic refers to the data type of the map entry values.
 */
declare export function map<T= any>(): Map<T>
 ...
 */
declare export function map<T>(d3Map: Map<T>): Map<T>
 ...
 */
declare export function map<T>(array: T[], key?: (value: T, i?: number, array?: T[]) => string): Map<T>
 ...
 * @param obj Object to construct the map from.
 */
declare export function map(obj: {[key: string]: any}): Map<any>
 ...
 * @param set A D3 set.
 */
declare export function set(d3Set: Set): Set
 ...
 */
declare export function set(array: Array<string | Stringifiable>): Set
 ...
 */
declare export function set<T>(array: T[], key: (value: T, index: number, array: T[]) => string): Set
 ...
 */
declare export type NestedArray<Datum, RollupType> = {} & Array<{
key: string,
 ...
 * to use in practice.
 */
declare export type NestedMap<Datum, RollupType> = {} & Map<NestedMap<Datum, RollupType> | Datum[] | RollupType>
 ...
 */
declare export function nest<Datum, RollupType= void>(): Nest<Datum, RollupType>
