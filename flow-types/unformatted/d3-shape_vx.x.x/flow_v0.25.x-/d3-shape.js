...
/**
 * @deprecated This interface is used to bridge the gap between two incompatible versions of TypeScript (see [#25944](https://github.com/Microsoft/TypeScript/pull/25944)).
Use `CanvasPathMethods` instead with TS <= 3.0 and `CanvasPath` with TS >= 3.1.
 */
declare export interface CanvasPath_D3Shape {
arc(
x: number,
y: number,
radius: number,
 ...
 */
declare export interface DefaultArcObject {
 ...
 */
declare export interface Arc<This, Datum> {
...
receives the same arguments that were passed into the arc generator.
 */
outerRadius(radius: (d: Datum, ...args: any[]) => number): this,
...
receives the same arguments that were passed into the arc generator.
 */
cornerRadius(radius: (d: Datum, ...args: any[]) => number): this,
...
receives the same arguments that were passed into the arc generator.
 */
startAngle(angle: (d: Datum, ...args: any[]) => number): this,
...
receives the same arguments that were passed into the arc generator.
 */
endAngle(angle: (d: Datum, ...args: any[]) => number): this,
 ...
 */
padAngle(): (d: Datum, ...args: any[]) => number | void,
 ...
 * @param angle Constant angle in radians.
 */
padAngle(angle: number | void): this,
...
receives the same arguments that were passed into the arc generator.
 */
padAngle(angle: (d: Datum, ...args: any[]) => number | void): this,
...
padRadius(radius: (d: Datum, ...args: any[]) => number): this,
 ...
 */
declare export function arc(): Arc<any, DefaultArcObject>
 ...
 */
declare export function arc<Datum>(): Arc<any, Datum>
 ...
 */
declare export function arc<This, Datum>(): Arc<This, Datum>
 ...
 */
declare export interface PieArcDatum<T> {
 ...
 */
declare export interface Pie<This, Datum> {
 ...
 */
startAngle(): (data: Datum[], ...args: any[]) => number,
 ...
 * @param angle An angle accessor function, which is invoked once, being passed the same arguments and this context as the pie generator.
 */
padAngle(angle: (data: Datum[], ...args: any[]) => number): this
} 
 ...
 * or set them to constants as appropriate.
 */
declare export function pie(): Pie<any, number | {
valueOf(): number
}>
 ...
 * The generic refers to the data type of an element in the input array passed into the Pie generator.
 */
declare export function pie<Datum>(): Pie<any, Datum>
 ...
 * The second generic refers to the data type of an element in the input array passed into the Pie generator.
 */
declare export function pie<This, Datum>(): Pie<This, Datum>
 ...
 */
declare export interface Line<Datum> {
 ...
 */
curve<C: CurveFactory | CurveFactoryLineOnly>(): C,
 ...
 * The generic refers to the data type of an element in the input array passed into the line generator.
 */
declare export function line<Datum>(): Line<Datum>
 ...
 * The generic refers to the data type of an element in the input array passed into the line generator.
 */
declare export interface LineRadial<Datum> {
 ...
 * or set them to constants as appropriate.
 */
declare export function lineRadial(): LineRadial<[number, number]>
 ...
 */
declare export function lineRadial<Datum>(): LineRadial<Datum>

	
/**
 * @deprecated Use LineRadial<Datum>
 */
declare export type RadialLine<Datum> = LineRadial<Datum>;
	
/**
 * @deprecated Use lineRadial()
 */
declare export function radialLine(): RadialLine<[number, number]>

	
/**
 * @deprecated Use lineRadial<Datum>()
 */
declare export function radialLine<Datum>(): RadialLine<Datum>
 ...
 */
declare export interface Area<Datum> {
 ...
 * The generic refers to the data type of an element in the input array passed into the area generator.
 */
declare export function area<Datum>(): Area<Datum>
 ...
 * The generic refers to the data type of an element in the input array passed into the area generator.
 */
declare export interface AreaRadial<Datum> {
 ...
 * or set them to constants as appropriate.
 */
declare export function areaRadial(): AreaRadial<[number, number]>
 ...
 */
declare export function areaRadial<Datum>(): AreaRadial<Datum>

	
/**
 * @deprecated Use AreaRadial interface
 */
declare export type RadialArea<Datum> = AreaRadial<Datum>;
	
/**
 * @deprecated Use areaRadial()
 */
declare export function radialArea(): RadialArea<[number, number]>

	
/**
 * @deprecated Use areaRadial<Datum>()
 */
declare export function radialArea<Datum>(): RadialArea<Datum>
 ...
 */
declare export interface CurveGeneratorLineOnly {
 ...
 */
declare export type CurveFactoryLineOnly = (context: CanvasRenderingContext2D | Path) => CurveGeneratorLineOnly;
 ...
 */
declare export type CurveGenerator = {
 ...
 */
declare export type CurveFactory = (context: CanvasRenderingContext2D | Path) => CurveGenerator;
 ...
 */
declare export var curveBasis: CurveFactory;
 ...
 */
declare export var curveBasisClosed: CurveFactory;
 ...
 */
declare export var curveBasisOpen: CurveFactory;
 ...
 */
declare export type CurveBundleFactory = {
 ...
 * This curve does not implement curve.areaStart and curve.areaEnd; it is intended to work with d3.line, not d3.area.
 */
declare export var curveBundle: CurveBundleFactory;
	
/**
 * A curve factory for cubic cardinal spline generators.
 */
declare export type CurveCardinalFactory = {
 ...
 */
declare export var curveCardinal: CurveCardinalFactory;
 ...
 * The default tension is 0.
 */
declare export var curveCardinalClosed: CurveCardinalFactory;
 ...
 * The default tension is 0.
 */
declare export var curveCardinalOpen: CurveCardinalFactory;
	
/**
 * A curve factory for cubic Catmull–Rom spline generators.
 */
declare export type CurveCatmullRomFactory = {
 ...
 */
declare export var curveCatmullRom: CurveCatmullRomFactory;
 ...
 */
declare export var curveCatmullRomClosed: CurveCatmullRomFactory;
 ...
 * and thus the curve starts at the second point and ends at the penultimate point.
 */
declare export var curveCatmullRomOpen: CurveCatmullRomFactory;
 ...
 */
declare export var curveLinear: CurveFactory;
 ...
 */
declare export var curveLinearClosed: CurveFactory;
 ...
 */
declare export var curveMonotoneX: CurveFactory;
 ...
 * Local extrema can occur only at grid points where they are given by the data, but not in between two adjacent grid points.”
 */
declare export var curveMonotoneY: CurveFactory;
 ...
 */
declare export var curveNatural: CurveFactory;
 ...
 */
declare export var curveStep: CurveFactory;
 ...
 */
declare export var curveStepAfter: CurveFactory;
 ...
 */
declare export interface Link<This, LinkDatum, NodeDatum> {
 ...
 */
source(): (d: LinkDatum, ...args: any[]) => NodeDatum,
...
receives the same arguments that were passed into the link generator. The default target accessor function returns a two element array [x, y].
 */
target(target: (d: LinkDatum, ...args: any[]) => NodeDatum): this,
 ...
 */
x(): (node: NodeDatum, ...args: any[]) => number,
 ...
 */
x(x: (node: NodeDatum, ...args: any[]) => number): this,
 ...
 */
y(): (node: NodeDatum, ...args: any[]) => number,
...
receives as its first argument a node object followed by all additional arguments that were passed into the link generator.
 */
y(y: (node: NodeDatum, ...args: any[]) => number): this,
 ...
 */
declare export function linkHorizontal(): Link<any, DefaultLinkObject, [number, number]>
 ...
 */
declare export function linkHorizontal<LinkDatum, NodeDatum>(): Link<any, LinkDatum, NodeDatum>
 ...
 * The third generic corresponds to the datum type of the source/target node contained in the link object.
 */
declare export function linkHorizontal<This, LinkDatum, NodeDatum>(): Link<This, LinkDatum, NodeDatum>
 ...
 * With the default settings the link generator accepts a link object conforming to the DefaultLinkObject interface.
 */
declare export function linkVertical(): Link<any, DefaultLinkObject, [number, number]>
 ...
 * The second generic corresponds to the datum type of the source/target node contained in the link object.
 */
declare export function linkVertical<LinkDatum, NodeDatum>(): Link<any, LinkDatum, NodeDatum>
 ...
 * The third generic corresponds to the datum type of the source/target node contained in the link object.
 */
declare export function linkVertical<This, LinkDatum, NodeDatum>(): Link<This, LinkDatum, NodeDatum>
 ...
 * The third generic corresponds to the datum type of the source/target node contained in the link object.
 */
declare export interface LinkRadial<This, LinkDatum, NodeDatum> {
 ...
 * as its argument an returning the first element of the array.
 */
angle(): (node: NodeDatum, ...args: any[]) => number,
...
receives as its first argument a node object followed by all additional arguments that were passed into the radial link generator.
 */
radius(radius: (node: NodeDatum, ...args: any[]) => number): this,
 ...
 */
declare export type RadialLink<This, LinkDatum, NodeDatum> = LinkRadial<This, LinkDatum, NodeDatum>;
 ...
 * With the default settings the link generator accepts a link object conforming to the DefaultLinkObject interface.
 */
declare export function linkRadial(): LinkRadial<any, DefaultLinkObject, [number, number]>
 ...
 * The second generic corresponds to the datum type of the source/target node contained in the link object.
 */
declare export function linkRadial<LinkDatum, NodeDatum>(): LinkRadial<any, LinkDatum, NodeDatum>
 ...
 * The third generic corresponds to the datum type of the source/target node contained in the link object.
 */
declare export function linkRadial<This, LinkDatum, NodeDatum>(): LinkRadial<This, LinkDatum, NodeDatum>
 ...
 */
declare export interface SymbolType {
 ...
 */
declare export interface Symbol<This, Datum> {
 ...
 */
type(type: (d: Datum, ...args: any[]) => SymbolType): this,
 ...
 */
declare export function symbol(): Symbol<any, any>
 ...
 */
declare export function symbol<Datum>(): Symbol<any, Datum>
 ...
 * The second generic corresponds to the data type of the datum underlying the symbol.
 */
declare export function symbol<This, Datum>(): Symbol<This, Datum>
 ...
 */
declare export var symbols: SymbolType[];
	
/**
 * The circle symbol type.
 */
declare export var symbolCircle: SymbolType;
	
/**
 * The Greek cross symbol type, with arms of equal length.
 */
declare export var symbolCross: SymbolType;
	
/**
 * The rhombus symbol type.
 */
declare export var symbolDiamond: SymbolType;
	
/**
 * The square symbol type.
 */
declare export var symbolSquare: SymbolType;
	
/**
 * The pentagonal star (pentagram) symbol type.
 */
declare export var symbolStar: SymbolType;
	
/**
 * he up-pointing triangle symbol type.
 */
declare export var symbolTriangle: SymbolType;
	
/**
 * The Y-shape symbol type.
 */
declare export var symbolWye: SymbolType;
 ...
 * @param radius Radius.
 */
declare export function pointRadial(angle: number, radius: number): [number, number]
 ...
 */
declare export type SeriesPoint<Datum> = {
 ...
 */
declare export type Series<Datum, Key> = {
 ...
 */
declare export interface Stack<This, Datum, Key> {
 ...
 */
keys(keys: (data: Datum[], ...args: any[]) => Key[]): this,
 ...
 */
declare export function stack(): Stack<any, {
[key: string]: number
}, string>
 ...
 */
declare export function stack<Datum>(): Stack<any, Datum, string>
 ...
 */
declare export function stack<Datum, Key>(): Stack<any, Datum, Key>
 ...
 * The third generic corresponds to the data type of key used to identify a series.
 */
declare export function stack<This, Datum, Key>(): Stack<This, Datum, Key>
 ...
 */
declare export function stackOrderAppearance(series: Series<any, any>): number[]
 ...
 * @param series A series generated by a stack generator.
 */
declare export function stackOrderAscending(series: Series<any, any>): number[]
 ...
 * @param series A series generated by a stack generator.
 */
declare export function stackOrderDescending(series: Series<any, any>): number[]
 ...
 * @param series A series generated by a stack generator.
 */
declare export function stackOrderInsideOut(series: Series<any, any>): number[]
 ...
 * @param series A series generated by a stack generator.
 */
declare export function stackOrderNone(series: Series<any, any>): number[]
 ...
 * @param series A series generated by a stack generator.
 */
declare export function stackOrderReverse(series: Series<any, any>): number[]
 ...
 * @param order An array of numeric indexes representing the stack order.
 */
declare export function stackOffsetExpand(series: Series<any, any>, order: number[]): void
 ...
 * @param order An array of numeric indexes representing the stack order.
 */
declare export function stackOffsetDiverging(series: Series<any, any>, order: number[]): void
 ...
 * @param order An array of numeric indexes representing the stack order.
 */
declare export function stackOffsetNone(series: Series<any, any>, order: number[]): void
 ...
 * @param order An array of numeric indexes representing the stack order.
 */
declare export function stackOffsetSilhouette(series: Series<any, any>, order: number[]): void
 ...
 * @param order An array of numeric indexes representing the stack order.
 */
declare export function stackOffsetWiggle(series: Series<any, any>, order: number[]): void
