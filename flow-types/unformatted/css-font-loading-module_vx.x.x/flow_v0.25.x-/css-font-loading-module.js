declare module 'css-font-loading-module' {
        declare export type FontFaceLoadStatus = "unloaded" | "loading" | "loaded" | "error";
...
constructor(family: string, source: string | BinaryData, descriptors?: FontFaceDescriptors): this;
