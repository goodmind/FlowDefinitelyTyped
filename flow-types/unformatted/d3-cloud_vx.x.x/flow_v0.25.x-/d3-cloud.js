declare module 'd3-cloud' {
	...
	declare module.exports: typeof undefined.layout$cloud
...
declare export function layout$cloud(): layout$Cloud<layout$cloud.cloud$Word>


declare export function layout$cloud<T: layout$cloud.cloud$Word>(): layout$Cloud<T>
...
declare interface layout$Cloud<T: layout$cloud.cloud$Word> {
