...
getChildByName<T: PIXI$DisplayObject= PIXI$Container>(name: string): T;
...
getChildAt<T: PIXI$DisplayObject= PIXI$Container>(index: number): T;
removeChild<T: PIXI$DisplayObject= PIXI$Container>(child: PIXI$DisplayObject): T;
removeChildAt<T: PIXI$DisplayObject= PIXI$Container>(index: number): T;
removeChildren<T: PIXI$DisplayObject= PIXI$Container>(
beginIndex?: number,
endIndex?: number): T[];
