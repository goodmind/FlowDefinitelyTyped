...
static +Always: Class<Pathfinding$DiagonalMovement__Always> & Pathfinding$DiagonalMovement__Always & 1;// 1
static +Never: Class<Pathfinding$DiagonalMovement__Never> & Pathfinding$DiagonalMovement__Never & 2;// 2
static +IfAtMostOneObstacle: Class<Pathfinding$DiagonalMovement__IfAtMostOneObstacle> & Pathfinding$DiagonalMovement__IfAtMostOneObstacle & 3;// 3
static +OnlyWhenNoObstacle: Class<Pathfinding$DiagonalMovement__OnlyWhenNoObstacle> & Pathfinding$DiagonalMovement__OnlyWhenNoObstacle & 4;// 4

}

declare class Pathfinding$DiagonalMovement__Always mixins Pathfinding$DiagonalMovement {}
declare class Pathfinding$DiagonalMovement__Never mixins Pathfinding$DiagonalMovement {}
declare class Pathfinding$DiagonalMovement__IfAtMostOneObstacle mixins Pathfinding$DiagonalMovement {}
declare class Pathfinding$DiagonalMovement__OnlyWhenNoObstacle mixins Pathfinding$DiagonalMovement {}
...
diagonalMovement: Pathfinding$DiagonalMovement): Pathfinding$Pathfinding$Node[],
