...
constructor(address: string, options?: WebSocket$WebSocket$IClientOptions): this;
constructor(address: string, protocols?: string | string[], options?: WebSocket$WebSocket$IClientOptions): this;
...
cb?: (err: Error, final: boolean) => void): void;
...
requestListener?: (request: http.IncomingMessage, response: http.ServerResponse) => void): http.WebSocket$Server,
