 ...
 * @returns The command-line parser.
 */
option(name: string, spec: NomnomInternal$Parser.Parser$Option): NomnomInternal$Parser,
...
} declare var _nomnom: NomnomInternal$NomnomInternal$Parser;declare module 'nomnom' {
