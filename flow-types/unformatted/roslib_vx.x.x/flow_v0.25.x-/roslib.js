declare module 'roslib' {
	...
	declare export class ROSLIB$Ros  {
...
declare export class ROSLIB$Message  {
...
declare export class ROSLIB$Param  {
...
declare export class ROSLIB$Service  {
...
declare export class ROSLIB$ServiceRequest  {
...
declare export class ROSLIB$ServiceResponse  {
...
declare export class ROSLIB$Topic  {
 ...
 */
unsubscribe(callback?: (callback: (message: ROSLIB$Message) => void) => void): void;
...
declare export class ROSLIB$TFClient  {
 ...
 */
subscribe(frameId: string, callback: (transform: ROSLIB$Transform) => void): void;
 ...
 */
unsubscribe(frameId: string, callback?: (transform: ROSLIB$Transform) => void): void;
...
declare export class ROSLIB$Transform  {
 ...
 */
constructor(options: {
translation: ROSLIB$Vector3,
rotation: ROSLIB$Quaternion
}): this;
translation: ROSLIB$Vector3;
rotation: ROSLIB$Quaternion;
 ...
 */
clone(): ROSLIB$Transform
}

declare export class ROSLIB$Vector3  {
 ...
 */
add(v: ROSLIB$Vector3): void;

/**
 * Clone a copy of this vector.
 */
clone(): ROSLIB$Vector3;

/**
 * Multiply the given Quaternion with this vector.
 * @param q - the quaternion to multiply with
 */
multiplyQuaternion(q: ROSLIB$Quaternion): void;

/**
 * Set the values of this vector to the difference of itself and the given vector.
 * @param v - the vector to subtract with
 */
subtract(v: ROSLIB$Vector3): void
}

declare export class ROSLIB$Quaternion  {
 ...
 * @param q - the quaternion to multiply with
 */
multiply(q: ROSLIB$Quaternion): void;
...
declare class ROSLIB$ActionClient  {
