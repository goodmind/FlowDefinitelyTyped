...
declare class Routing$Control mixins Routing$Itinerary {
...
...wayPoints: Routing$Waypoint[]): Routing$Waypoint[];
...
routeLine?: (route: Routing$IRoute, options: Routing$LineOptions) => Routing$Line,
autoRoute?: boolean,
...
} & Routing$ItineraryOptions


declare class Routing$Itinerary mixins L.Routing$Control {
...
show?: boolean,
routing$formatter?: Routing$Formatter,
itineraryFormatter?: Routing$ItineraryBuilder,
collapsible?: boolean,
collapseBtn?: (routing$itinerary: Routing$Itinerary) => void,
collapseBtnClass?: string,
totalDistanceRoundingSensitivity?: number
} 

declare class Routing$Plan mixins Layer {
constructor(waypoints: Routing$Waypoint[] | LatLng[], options?: Routing$PlanOptions): this;
isReady(): boolean;
getWaypoints(): Routing$Waypoint[];
...
createMarker?: (
waypointIndex: number,
routing$waypoint: Routing$Waypoint,
numberWaypoints: number) => Marker,
routeWhileDragging?: boolean,
...
declare class Routing$OSRMv1 mixins Routing$IRouter {
...
buildRouteUrl(waypoints: Routing$Waypoint[], options: Routing$RoutingOptions): string
}
...
declare function Routing$control(options?: Routing$RoutingControlOptions): Routing$Control


declare function Routing$itinerary(options?: Routing$ItineraryOptions): Routing$Itinerary


declare function Routing$line(route: Routing$IRoute, options?: Routing$LineOptions): Routing$Line


declare function Routing$plan(
waypoints: Routing$Waypoint[] | LatLng[],
options?: Routing$PlanOptions): Routing$Plan


declare function Routing$osrmv1(options?: Routing$OSRMOptions): Routing$OSRMv1


declare function Routing$formatter(options?: Routing$FormatterOptions): Routing$Formatter


declare function Routing$waypoint(
latLng: LatLng,
name?: string,
options?: Routing$WaypointOptions): Routing$Waypoint
...
declare function routing$control(options?: Routing$Routing$RoutingControlOptions): Routing$Routing$Control


declare function routing$itinerary(options?: Routing$Routing$ItineraryOptions): Routing$Routing$Itinerary


declare function routing$line(
route: Routing$Routing$IRoute,
options?: Routing$Routing$LineOptions): Routing$Routing$Line


declare function routing$plan(
waypoints: Routing$Routing$Waypoint[] | LatLng[],
options?: Routing$Routing$PlanOptions): Routing$Routing$Plan


declare function routing$osrmv1(options?: Routing$Routing$OSRMOptions): Routing$Routing$OSRMv1


declare function routing$formatter(options?: Routing$Routing$FormatterOptions): Routing$Routing$Formatter


declare function routing$waypoint(
latLng: LatLng,
name?: string,
options?: Routing$Routing$WaypointOptions): Routing$Routing$Waypoint
