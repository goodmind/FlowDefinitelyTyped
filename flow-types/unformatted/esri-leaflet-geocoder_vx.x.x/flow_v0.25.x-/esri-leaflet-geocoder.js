...
declare type Geocoding$GeosearchConstructor = (options?: Geocoding$GeosearchObject) => Geocoding$Geosearch;
...
declare function Geocoding$geosearch(options?: Geocoding$GeosearchObject): Geocoding$Geosearch
...
declare function Geocoding$geocodeService(options?: Geocoding$GeocodeServiceOptions): Geocoding$GeocodeService
...
run(
callback: (error: any | void, results: {
results: any[]
}, response: any) => void,
context?: any): this
}

declare function Geocoding$geocode(options?: TaskOptions | Service): Geocoding$Geocode
...
declare function Geocoding$suggest(options?: TaskOptions | Service): Geocoding$Suggest
...
declare function Geocoding$reverseGeocode(options?: TaskOptions | Service): Geocoding$ReverseGeocode
...
callback: Geocoding$GeosearchCallback): Task,
results(
text: string,
key: string,
bounds: LatLngBoundsExpression | void | null,
...
declare type Geocoding$GeosearchCallback = (error: any | void, results: any) => void;
...
declare class Geocoding$ArcgisOnlineProvider mixins Geocoding$GeocodeService, Geocoding$GeosearchProvider {
constructor(options?: Geocoding$ArcgisOnlineProviderOptions): this;
suggestions(
text: string,
bounds: LatLngBoundsExpression | void | null,
callback: Geocoding$GeosearchCallback): Geocoding$Suggest;
results(
text: string,
key: string,
bounds: LatLngBoundsExpression | void | null,
callback: Geocoding$GeosearchCallback): Geocoding$Geocode
}

declare function Geocoding$arcgisOnlineProvider(
options?: Geocoding$ArcgisOnlineProviderOptions): Geocoding$ArcgisOnlineProvider
...
declare class Geocoding$GeocodeServiceProvider mixins Geocoding$GeocodeService, Geocoding$GeosearchProvider {
...
options?: Geocoding$GeocodeServiceProviderOptions): Geocoding$GeocodeServiceProvider
...
declare class Geocoding$FeatureLayerProvider mixins FeatureLayerService, Geocoding$GeosearchProvider {
constructor(options?: Geocoding$FeatureLayerProviderOptions): this;
suggestions(
text: string,
bounds: LatLngBoundsExpression | void | null,
callback: Geocoding$GeosearchCallback): Query;
results(
text: string,
key: string,
bounds: LatLngBoundsExpression | void | null,
...
options?: Geocoding$FeatureLayerProviderOptions): Geocoding$FeatureLayerProvider
...
declare class Geocoding$MapServiceProvider mixins MapService, Geocoding$GeosearchProvider {
constructor(options?: Geocoding$MapServiceProviderOptions): this;
suggestions(
text: string,
bounds: LatLngBoundsExpression | void | null,
callback: Geocoding$GeosearchCallback): Find;
results(
text: string,
key: string,
bounds: LatLngBoundsExpression | void | null,
callback: Geocoding$GeosearchCallback): Query | Find
}

declare function Geocoding$mapServiceProvider(options?: Geocoding$MapServiceProviderOptions): Geocoding$MapServiceProvider
