...
fn: (input: string, i: number) => Parsimmon$Parsimmon$Reply<T>): Parsimmon$Parsimmon$Parser<T>
...
declare type Parsimmon$TypedRule<TLanguageSpec> = $ObjMapi<TLanguageSpec, <P>(P) => (
r: Parsimmon$TypedLanguage<TLanguageSpec>) => Parsimmon$Parser<$ElementType<TLanguageSpec, P>>>;

declare type Parsimmon$TypedLanguage<TLanguageSpec> = $ObjMapi<TLanguageSpec, <P>(P) => Parsimmon$Parser<$ElementType<TLanguageSpec, P>>>;
...
promap<U, V>(
inputFn: (input: T) => U,
outputFn: (output: U) => V): Parsimmon$Parser<V>,
 ...
 */
thru<U>(
call: (wrapper: Parsimmon$Parser<T>) => Parsimmon$Parser<U>): Parsimmon$Parser<U>,
...
after: Parsimmon$Parser<any>): Parsimmon$Parser<T>,
 ...
 */
Parsimmon$notFollowedBy(anotherParser: Parsimmon$Parser<any>): Parsimmon$Parser<T>,
 ...
 */
Parsimmon$lookahead(arg: Parsimmon$Parser<any> | string | RegExp): Parsimmon$Parser<T>,
...
fn: (input: string, i: number) => Parsimmon$Parsimmon$Reply<T>): Parsimmon$Parser<T>
 ...
 */
declare function Parsimmon$createLanguage(rules: Parsimmon$Rule): Parsimmon$Language


declare function Parsimmon$createLanguage<TLanguageSpec>(
rules: Parsimmon$TypedRule<TLanguageSpec>): Parsimmon$TypedLanguage<TLanguageSpec>
 ...
 */
declare function Parsimmon$makeSuccess<T>(index: number, value: T): Parsimmon$SuccessReply<T>
 ...
 */
declare function Parsimmon$makeFailure(furthest: number, expectation: string | string[]): Parsimmon$FailureReply
 ...
 */
declare function Parsimmon$string(Parsimmon$string: string): Parsimmon$Parser<string>
 ...
 */
declare function Parsimmon$oneOf(Parsimmon$string: string): Parsimmon$Parser<string>
 ...
 */
declare function Parsimmon$noneOf(Parsimmon$string: string): Parsimmon$Parser<string>
 ...
 */
declare function Parsimmon$range(begin: string, end: string): Parsimmon$Parser<string>
 ...
 */
declare function Parsimmon$regexp(myregex: RegExp, group?: number): Parsimmon$Parser<string>
 ...
 */
declare function Parsimmon$regex(myregex: RegExp, group?: number): Parsimmon$Parser<string>
 ...
 */
declare function Parsimmon$notFollowedBy(parser: Parsimmon$Parser<any>): Parsimmon$Parser<null>
 ...
 */
declare function Parsimmon$lookahead(arg: Parsimmon$Parser<any> | string | RegExp): Parsimmon$Parser<"">
 ...
 */
declare function Parsimmon$seq<T>(p1: Parsimmon$Parser<T>): Parsimmon$Parser<[T]>


declare function Parsimmon$seq<T, U>(
p1: Parsimmon$Parser<T>,
p2: Parsimmon$Parser<U>): Parsimmon$Parser<[T, U]>


declare function Parsimmon$seq<T, U, V>(
p1: Parsimmon$Parser<T>,
p2: Parsimmon$Parser<U>,
p3: Parsimmon$Parser<V>): Parsimmon$Parser<[T, U, V]>
...
p4: Parsimmon$Parser<W>): Parsimmon$Parser<[T, U, V, W]>
...
p5: Parsimmon$Parser<X>): Parsimmon$Parser<[T, U, V, W, X]>
...
p6: Parsimmon$Parser<Y>): Parsimmon$Parser<[T, U, V, W, X, Y]>
...
p7: Parsimmon$Parser<Z>): Parsimmon$Parser<[T, U, V, W, X, Y, Z]>


declare function Parsimmon$seq<T>(...parsers: Array<Parsimmon$Parser<T>>): Parsimmon$Parser<T[]>


declare function Parsimmon$seq(...parsers: Array<Parsimmon$Parser<any>>): Parsimmon$Parser<any[]>
 ...
 */
declare function Parsimmon$formatError<T>(Parsimmon$string: string, error: Parsimmon$Result<T>): string
 ...
 */
declare function Parsimmon$seqMap<T, U>(p1: Parsimmon$Parser<T>, cb: (a1: T) => U): Parsimmon$Parser<U>


declare function Parsimmon$seqMap<T, U, V>(
p1: Parsimmon$Parser<T>,
p2: Parsimmon$Parser<U>,
cb: (a1: T, a2: U) => V): Parsimmon$Parser<V>
...
p2: Parsimmon$Parser<U>,
p3: Parsimmon$Parser<V>,
cb: (a1: T, a2: U, a3: V) => W): Parsimmon$Parser<W>
...
p3: Parsimmon$Parser<V>,
p4: Parsimmon$Parser<W>,
cb: (a1: T, a2: U, a3: V, a4: W) => X): Parsimmon$Parser<X>
...
p4: Parsimmon$Parser<W>,
p5: Parsimmon$Parser<X>,
cb: (a1: T, a2: U, a3: V, a4: W, a5: X) => Y): Parsimmon$Parser<Y>
...
p5: Parsimmon$Parser<X>,
p6: Parsimmon$Parser<Y>,
cb: (a1: T, a2: U, a3: V, a4: W, a5: X, a6: Y) => Z): Parsimmon$Parser<Z>
...
cb: (a1: T, a2: U, a3: V, a4: W, a5: X, a6: Y, a7: Z) => A): Parsimmon$Parser<A>
...
cb: (a1: T, a2: U, a3: V, a4: W, a5: X, a6: Y, a7: Z, a8: A) => B): Parsimmon$Parser<B>


declare function Parsimmon$seqObj<T, Key: $Keys<T>= $Keys<T>>(
...args: Array<[Key, Parsimmon$Parser<$ElementType<T, Key>>] | Parsimmon$Parser<any>>): Parsimmon$Parser<$ObjMapi<{[k: Key]: any}, <K>(K) => $ElementType<T, K>>>
...
declare type Parsimmon$Reply<T> = Parsimmon$SuccessReply<T> | Parsimmon$FailureReply;

declare type Parsimmon$SuccessFunctionType<U> = (index: number, result: U) => Parsimmon$Reply<U>;

declare type Parsimmon$FailureFunctionType<U> = (index: number, msg: string) => Parsimmon$Reply<U>;

declare type Parsimmon$ParseFunctionType<U> = (stream: Parsimmon$StreamType, index: number) => Parsimmon$Reply<U>;
 ...
 */
declare function Parsimmon$alt<U>(...parsers: Array<Parsimmon$Parser<U>>): Parsimmon$Parser<U>


declare function Parsimmon$alt(...parsers: Array<Parsimmon$Parser<any>>): Parsimmon$Parser<any>
...
separator: Parsimmon$Parser<U>): Parsimmon$Parser<T[]>
 ...
 */
declare function Parsimmon$lazy<U>(f: () => Parsimmon$Parser<U>): Parsimmon$Parser<U>


declare function Parsimmon$lazy<U>(description: string, f: () => Parsimmon$Parser<U>): Parsimmon$Parser<U>
 ...
 */
declare function Parsimmon$test(predicate: (char: string) => boolean): Parsimmon$Parser<string>
 ...
 */
declare function Parsimmon$takeWhile(predicate: (char: string) => boolean): Parsimmon$Parser<string>
 ...
 * similar to Parsimmon.digit and Parsimmon.letter.
 */
declare function Parsimmon$bitSeq(alignments: number[]): Parsimmon$Parser<number[]>
...
namedAlignments: Array<[Key, number] | number>): Parsimmon$Parser<$ObjMapi<{[k: Key]: any}, <K>(K) => number>>
