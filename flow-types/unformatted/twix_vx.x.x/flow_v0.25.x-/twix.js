declare module 'twix' {
	...
	declare export interface TwixFormatOptions {
...
hideYear?: boolean
	...
	declare export type TwixParseAndFormatOptions = {
parseStrict?: boolean
} & TwixFormatOptions

	declare export interface TwixSimpleFormatOptions {
allDay?: string,
template?: (left: any, right: any) => any
} 
	declare export interface TwixIter {
hasNext(): boolean,
next(): Twix
} 
	declare export interface Twix {
isPast(): boolean,
isFuture(): boolean,
isCurrent(): boolean,
...
toDate(): Date
	...
	declare export interface TwixStatic {
...
twix(date: string, format: string, options: TwixParseAndFormatOptions): Twix
	...
	declare function twix(start: Moment, end: Moment): Twix

	declare var twixClass: TwixStatic;
