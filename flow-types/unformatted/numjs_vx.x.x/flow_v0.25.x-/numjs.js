 ...
 */
declare export function abs<T= number>(x: NjParam<T>): NdArray<T>

	
/**
 * Add arguments, element-wise.
 */
declare export function add<T= number>(a: NjParam<T>, b: NjParam<T>): NdArray<T>
 ...
 */
declare export function arange<T= number>(start: number, stop?: number, dtype?: NdType<T>): NdArray<T>

	declare export function arange<T= number>(stop: number, dtype: NdType<T>): NdArray<T>

	declare export function arange<T= number>(
start: number,
stop: number,
step: number,
dtype?: NdType<T>): NdArray<T>

	
/**
 * Return trigonometric inverse cosine of the input array, element-wise.
 */
declare export function arccos<T= number>(x: NjParam<T>): NdArray<T>

	
/**
 * Return trigonometric inverse sine of the input array, element-wise.
 */
declare export function arcsin<T= number>(x: NjParam<T>): NdArray<T>

	
/**
 * Return trigonometric inverse tangent of the input array, element-wise.
 */
declare export function arctan<T= number>(x: NjParam<T>): NdArray<T>

	
/**
 * Clip (limit) the values in an array between min and max, element-wise.
 */
declare export function clip<T= number>(x: NjParam<T>, min?: number, max?: number): NdArray<T>

	
/**
 * Join given arrays along the last axis.
 */
declare export function concatenate<T= number>(...arrays: Array<NjArray<T>>): NdArray<T>

	
/**
 * Convolve 2 N-dimensionnal arrays
 */
declare export function convolve<T= number>(a: NjArray<T>, b: NjArray<T>): NdArray<T>

	
/**
 * Return trigonometric cosine of the input array, element-wise.
 */
declare export function cos<T= number>(x: NjParam<T>): NdArray<T>

	
/**
 * Divide `a` by `b`, element-wise.
 */
declare export function divide<T= number>(a: NjArray<T>, b: NjParam<T>): NdArray<T>
 ...
 */
declare export function dot<T= number>(a: NjArray<T>, b: NjArray<T>): NdArray<T>
 ...
 */
declare export function empty<T= number>(shape: NdArrayData<T> | number, dtype?: NdType<T>): NdArray<T>

	
/**
 * Return true if two arrays have the same shape and elements, false otherwise.
 */
declare export function equal<T= number>(a: NjArray<T>, b: NjArray<T>): boolean

	
/**
 * Calculate the exponential of all elements in the input array, element-wise.
 */
declare export function exp<T= number>(x: NjParam<T>): NdArray<T>

	
/**
 * Convolve 2 N-dimensionnal arrays using Fast Fourier Transform (FFT)
 */
declare export function fftconvolve<T= number>(a: NjArray<T>, b: NjArray<T>): NdArray<T>

	
/**
 * Return a copy of the array collapsed into one dimension using row-major order (C-style)
 */
declare export function flatten<T= number>(array: NjArray<T>): NdArray<T>

	declare export function getRawData<T= number>(array: NdArrayData<T>): Uint8Array

	declare export function setRawData<T= number>(array: NdArrayData<T>, data: NdArrayData<T>): Uint8Array

	
/**
 * Return the maximum value of the array
 */
declare export function max<T= number>(x: NjParam<T>): T

	
/**
 * Return the arithmetic mean of input array elements.
 */
declare export function mean<T= number>(x: NjParam<T>): T

	
/**
 * Return the minimum value of the array
 */
declare export function min<T= number>(x: NjParam<T>): T

	
/**
 * Multiply arguments, element-wise.
 */
declare export function multiply<T= number>(a: NjArray<T>, b: NjParam<T>): NdArray<T>

	
/**
 * Return the inverse of the input array, element-wise.
 */
declare export function negative<T= number>(x: NjParam<T>): NdArray<T>
 ...
 */
declare export function ones<T= number>(
shape: NdArrayData<T> | number,
dtype?: BaseNdArray.DataType): NdArray<T>

	
/**
 * Raise first array elements to powers from second array, element-wise.
 */
declare export function power<T= number>(x1: NjParam<T>, x2: NjParam<T>): NdArray<T>
 ...
 */
declare export function random<T= number>(shape?: NdArrayData<T> | number): NdArray<T>
 ...
 */
declare export function reshape<T= number>(array: NjArray<T>, shape: NdArray<T>): NdArray<T>

	
/**
 * Round an array to the to the nearest integer.
 */
declare export function round<T= number>(x: NjArray<T>): NdArray<T>
 ...
 */
declare export function sigmoid<T= number>(x: NjParam<T>, t?: number): NdArray<T>

	
/**
 * Return trigonometric sine of the input array, element-wise.
 */
declare export function sin<T= number>(x: NjParam<T>): NdArray<T>

	
/**
 * Return the softmax, or normalized exponential, of the input array, element-wise.
 */
declare export function softmax<T= number>(x: NjParam<T>): NdArray<T>

	
/**
 * Calculate the positive square-root of all elements in the input array, element-wise.
 */
declare export function sqrt<T= number>(x: NjParam<T>): NdArray<T>

	
/**
 * Returns the standard deviation, a measure of the spread of a distribution, of the input array elements.
 */
declare export function std<T= number>(x: NjParam<T>): T

	
/**
 * Subtract second argument from the first, element-wise.
 */
declare export function subtract<T= number>(a: NjParam<T>, b: NjParam<T>): T

	
/**
 * Return the sum of input array elements.
 */
declare export function sum<T= number>(x: NjParam<T>): T

	
/**
 * Return trigonometric tangent of the input array, element-wise.
 */
declare export function tan<T= number>(x: NjParam<T>): NdArray<T>

	
/**
 * Return hyperbolic tangent of the input array, element-wise.
 */
declare export function tanh<T= number>(x: NjParam<T>): NdArray<T>
...
//        [[ 3, 4, 5]]])
 */
declare export function transpose<T= number>(x: NjParam<T>, axes?: number): NdArray<T>
 ...
 */
declare export function zeros<T= number>(
shape: NdArrayData<T> | number,
dtype?: BaseNdArray.DataType): NdArray<T>
...
declare function errors$NotImplementedError(message?: string): Error
	...
	declare export function broadcast<T, U>(shape1: T[], shape2: U[]): Array<T | U>

	declare export function fft<T= number>(x: NjArray<T>): NdArray<T>

	declare export function ifft<T= number>(x: NjArray<T>): NdArray<T>
 ...
 */
declare export function diag<T= number>(x: NjArray<T>): NdArray<T>
 ...
 */
declare export function identity<T= number>(n: T, dtype?: BaseNdArray.DataType): NdArray<T>
 ...
 */
declare export function stack<T= number>(arrays: Array<NdArray<T>>, axis?: number): NdArray<T>
...
declare function images$save<T= number>(img: NdArray<T>, dest: string): void


declare function images$resize<T= number>(img: NdArray<T>, height: number, width: number): NdArray<Uint8Array>


declare function images$sat<T= number>(img: NdArray<T>): NdArray<Uint32Array>


declare function images$ssat<T= number>(img: NdArray<T>): NdArray<Uint32Array>


declare function images$sobel<T= number>(img: NdArray<T>): NdArray<Float32Array>


declare function images$scharr<T= number>(img: NdArray<T>): NdArray<Float32Array>


declare function images$areaSum<T= number>(
h0: number,
w0: number,
H: number,
W: number,
SAT: NdArray<T>): number


declare function images$areaValue<T= number>(img: NdArray<T>): number


declare function images$rgb2gray<T= number>(img: NdArray<T>): NdArray<Uint8Array>


declare function images$flip<T= number, O= T>(img: NdArray<T>): NdArray<O>

	declare export function array<T= number>(arr: NjArray<T>, dtype?: BaseNdArray.DataType): NdArray<T>

	declare export function int8<T= number>(arr: NjArray<T>): NjArray<Int8Array>

	declare export function uint8<T= number>(arr: NjArray<T>): NjArray<Uint8Array>

	declare export function int16<T= number>(arr: NjArray<T>): NjArray<Int16Array>

	declare export function uint16<T= number>(arr: NjArray<T>): NjArray<Uint16Array>

	declare export function int32<T= number>(arr: NjArray<T>): NjArray<Int32Array>

	declare export function uint32<T= number>(arr: NjArray<T>): NjArray<Uint32Array>

	declare export function float32<T= number>(arr: NjArray<T>): NjArray<Float32Array>

	declare export function float64<T= number>(arr: NjArray<T>): NjArray<Float64Array>
