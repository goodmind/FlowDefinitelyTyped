...
vm: VueConstructor,
options: OktaVuePlugin$OktaVueOptions): PluginFunction<VueConstructor>
...
loginRedirect(
fromUri?: string,
additionalParams?: OktaVuePlugin$OktaVuePlugin$OktaOpenIDOptions): void,
logout(): Promise<void>,
