...
curCol: string;
createWriteStream(
options?: GridFSStream$GridFSStream$Options): GridFSStream$GridFSStream$WriteStream;
createReadStream(
options?: GridFSStream$GridFSStream$Options): GridFSStream$GridFSStream$ReadStream;
