...
var heatmapInstance = h337.create(config);
 */
declare export function create<V: string= "value", X: string= "x", Y: string= "y">(
configObject: HeatmapConfiguration<V, X, Y>): Heatmap<V, X, Y>

	declare export function register(pluginKey: string, plugin: any): void
 ...
 */
declare export class Heatmap<V: string, X: string, Y: string>  {
 ...
 * rerendering.
 * @example heatmapInstance.setDataMax(200);
 ...
 * rerendering.
 * @example heatmapInstance.setDataMin(10);
 ...
 */
configure<Vn: string= V, Xn: string= X, Yn: string= Y>(
 ...
 * @example heatmapInstance.addData({ x: 10, y: 10, value: 100});
 ...
 * @example var currentData = heatmapInstance.getData();
 ...
 * @example heatmapInstance.getDataURL(); // data:image/png;base64...
...
repaint(): this
	...
	declare export interface BaseHeatmapConfiguration<V: string= "value"> {
 ...
 */
declare export type HeatmapConfiguration<V: string= "value", X: string= "x", Y: string= "y"> = {
...
yField?: Y
	...
	declare export type HeatmapOverlayConfiguration<V: string= "value", TLat: string= "lat", TLong: string= "lng"> = {
 ...
 * config object.
 */
declare export type DataPoint<V: string= "value", X: string= "x", Y: string= "y"> = Record<V | X | Y, number>;
	
/**
 * Type of data returned by `Heatmap#hello`, which ignores custom `xField`,
 * `yField` and `valueField`.
 */
declare export interface DataCircle {
x: number,
y: number,
value: number,
radius: number
 ...
 */
declare export interface HeatmapData<T> {
 ...
 */
declare class HeatmapOverlay<V: string, TLat: string, TLng: string> mixins Leaflet.ILayer {

/**
 * Initialization function
 */
constructor(configuration: HeatmapOverlayConfiguration<V, TLat, TLng>): this;
 ...
 */
addData(
data: DataPoint<V, TLat, TLng> | $ReadOnlyArray<DataPoint<V, TLat, TLng>>): void;
