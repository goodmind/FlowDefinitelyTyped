...
callback?: daterangepicker$daterangepicker$DataRangePickerCallback) => JQuery) & {
...
constructor(element: HTMLElement, options?: daterangepicker$daterangepicker$Options, callback?: daterangepicker$daterangepicker$DataRangePickerCallback): this;
...
remove(): void
	...
	declare type daterangepicker$DataRangePickerCallback = (start: moment.Moment, end: moment.Moment, label: string | null) => void;
 ...
 */
ranges?: {
[name: string]: [daterangepicker$DateOrString, daterangepicker$DateOrString]
},
...
isInvalidDate?: (
startDate: daterangepicker$DateOrString,
endDate?: daterangepicker$DateOrString) => boolean,
 ...
 */
isCustomDate?: (date: daterangepicker$DateOrString) => string | string[] | void,
