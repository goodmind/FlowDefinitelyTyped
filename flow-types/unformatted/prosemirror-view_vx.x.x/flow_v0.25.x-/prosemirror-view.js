declare module 'prosemirror-view' {
        import type {
          DOMParser,DOMSerializer,Node as ProsemirrorNode,ResolvedPos,Slice,Schema,Mark
 ...
 */
declare export class DecorationSet<S: Schema= any>  {
...
doc: ProsemirrorNode<S>,
decorations: Decoration[]): DecorationSet<S>;
 ...
 */
declare export class EditorView<S: Schema= any>  {
...
mount: Node
} | void, props: DirectEditorProps<S>): this;
 ...
 */
nodeDOM(pos: number): Node | null | void;
 ...
 */
declare export interface EditorProps<S: Schema= any> {
 ...
 */
handleDOMEvents?: {
[name: string]: (view: EditorView<S>, event: Event) => boolean
} | null,
...
head: ResolvedPos<S>) => Selection<S> | null | void) | null,
...
view: EditorView<S>,
getPos: () => number,
decorations: Decoration[]) => NodeView<S>
} | null,
 ...
 */
declare export type DirectEditorProps<S: Schema= any> = {
 ...
 */
declare export interface NodeView<S: Schema= any> {
