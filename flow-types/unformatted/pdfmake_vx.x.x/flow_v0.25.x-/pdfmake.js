...
[name: string]: TFontFamilyTypes
	...
	declare function createPdf(documentDefinitions: TDocumentDefinitions): TCreatedPdf
...
static +EXECUTIVE: Class<PageSize__EXECUTIVE> & PageSize__EXECUTIVE & "EXECUTIVE";// "EXECUTIVE"
...
declare class PageSize__TABLOID mixins PageSize {}
  ...
  constructor(...args: empty): mixed;
static +PORTRAIT: Class<PageOrientation__PORTRAIT> & PageOrientation__PORTRAIT & "PORTRAIT";// "PORTRAIT"
static +LANDSCAPE: Class<PageOrientation__LANDSCAPE> & PageOrientation__LANDSCAPE & "LANDSCAPE";// "LANDSCAPE"
...
keywords?: string
	...
	declare type TDocumentHeaderFooterFunction = (currentPage: number, pageCount: number) => any;
	declare type Margins = number | [number, number] | [number, number, number, number];
	declare type Alignment = "left"
| "right"
| "justify"
| "center"
| string;
...
defaultStyle?: Style
	...
	declare type CreatedPdfParams = (defaultFileName?: string, cb?: string, options?: string) => void;
