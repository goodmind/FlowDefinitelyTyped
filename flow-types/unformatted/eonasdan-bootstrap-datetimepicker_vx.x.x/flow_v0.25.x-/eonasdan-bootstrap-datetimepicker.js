declare module 'eonasdan-bootstrap-datetimepicker' {
	...
	declare export type DateComparable = string | Date | moment.Moment;
	declare export type UseCurrent = "year"
| "month"
| "day"
| "hour"
| "minute";
	declare export interface Icons {
...
declare class DayOfWeek__Saturday mixins DayOfWeek {}
	...
	declare export type ViewMode = "days" | "months" | "years" | "decades";
	declare export type ToolbarPlacement = "default" | "top" | "bottom";
	declare export interface WidgetPositioning {
horizontal?: "auto" | "left" | "right",
vertical?: "auto" | "top" | "bottom"
} 
	declare export interface KeyBinds {
...
delete?: () => any
	...
	declare export type FromTo = [moment.Moment, moment.Moment];
	declare export interface Tooltips {
...
selectTime?: string
	...
	declare export type ParseInputDateFunction = (inputDate: string) => moment.Moment;
	declare export interface OptionsBase {
...
parseInputDate?: ParseInputDateFunction
	...
	declare export type IndexedDates = {
[date: string]: boolean
};
	declare export type IndexedHours = {
[hour: string]: boolean
};
...
disabledHours?: number[] | boolean
	...
	declare export interface Datetimepicker {
...
tooltips(tooltips: Tooltips): Datetimepicker
	...
	declare export type HideEventObject = {
...
date: moment.Moment
	...
	declare export type ChangeEventObject = {
...
oldDate: moment.Moment | boolean
	...
	declare export type ErrorEventObject = {
...
date: moment.Moment
	...
	declare export type UpdateEventObject = {
...
events: "dp.change",
selector?: string,
handler?: (eventobject: ChangeEventObject) => any): JQuery,
...
events: "dp.hide",
selector?: string,
handler?: (eventobject: HideEventObject) => any): JQuery,
...
events: "dp.error",
selector?: string,
handler?: (eventobject: ErrorEventObject) => any): JQuery,
...
events: "dp.update",
selector?: string,
handler?: (eventobject: UpdateEventObject) => any): JQuery,
