...
declare function pem$encode(msg: pem$ObjectPEM, options?: pem$EncodeOptions): string
...
declare type pki$PublicKey = rsa$pki$PublicKey | ed25519$ed25519$Key;

declare type pki$PrivateKey = rsa$pki$PrivateKey | ed25519$ed25519$Key;
...
declare function pki$pemToDer(pem: pki$PEM): util$util$ByteStringBuffer


declare function pki$privateKeyToPem(key: pki$PrivateKey, maxline?: number): pki$PEM


declare function pki$privateKeyInfoToPem(key: Bytes, maxline?: number): pki$PEM


declare function pki$publicKeyToPem(key: pki$PublicKey, maxline?: number): pki$PEM
...
declare function pki$certificateToPem(cert: pki$Certificate, maxline?: number): pki$PEM


declare function pki$certificateFromPem(pem: pki$PEM, computeHash?: boolean, strict?: boolean): pki$Certificate


declare function pki$createCaStore(certs?: $ReadOnlyArray<pki$Certificate | pki$pki$PEM>): pki$CAStore


declare function pki$verifyCertificateChain(
caStore: pki$CAStore,
chain: pki$Certificate[],
customVerifyCallback?: (verified: boolean | string, depth: number, chain: pki$Certificate[]) => boolean): boolean
...
declare var constants$PUBLIC_KEY_BYTE_LENGTH: ;

declare var constants$PRIVATE_KEY_BYTE_LENGTH: ;

declare var constants$SEED_BYTE_LENGTH: ;

declare var constants$SIGN_BYTE_LENGTH: ;

declare var constants$HASH_BYTE_LENGTH: ;

declare function ed25519$generateKeyPair(
options?: {
...
declare function ed25519$verify(
options: {
message: string,
encoding: string,
signature: Buffer | Uint8Array | util$util$ByteBuffer | string,
publicKey: ed25519$NativeBuffer
}): boolean
...
declare type rsa$EncryptionScheme = "RSAES-PKCS1-V1_5"
| "RSA-OAEP"
| "RAW"
| "NONE"
| null;

declare type rsa$SignatureScheme = "RSASSA-PKCS1-V1_5" | pss$pss$PSS | "NONE" | null;

declare type rsa$PublicKey = rsa$rsa$PublicKey | ed25519$ed25519$Key;

declare type rsa$PrivateKey = rsa$rsa$PrivateKey | ed25519$ed25519$Key;
...
bits?: number,
e?: number,
callback?: (err: Error, keypair: rsa$KeyPair) => void): rsa$KeyPair
 ...
 */
ed25519$sign(key: pki$rsa$PrivateKey, md?: md$md$MessageDigest): void,
...
listAllCertificates(): pki$pki$Certificate[],
getIssuer(subject: pki$Certificate): pki$Certificate | null,
getBySubject(subject: string): pki$Certificate | null
} 

declare function pki$certificateFromAsn1(obj: asn1$asn1$Asn1, computeHash?: boolean): pki$Certificate


declare function pki$decryptRsaPrivateKey(pem: pki$PEM, passphrase?: string): rsa$PrivateKey


declare function pki$createCertificate(): pki$Certificate


declare function pki$certificationRequestToPem(cert: pki$Certificate, maxline?: number): pki$PEM


declare function pki$certificationRequestFromPem(pem: pki$PEM, computeHash?: boolean, strict?: boolean): pki$Certificate
...
declare function random$getBytes(count: number, callback?: (bytes: Bytes) => any): Bytes
 ...
 */
declare function ssh$privateKeyToOpenSSH(privateKey: pki$rsa$PrivateKey, passphrase?: string): string
 ...
 */
declare function ssh$privateKeyToPutty(privateKey: pki$rsa$PrivateKey, passphrase?: string, comment?: string): string
 ...
 */
declare function ssh$publicKeyToOpenSSH(publicKey: pki$rsa$PublicKey, comment?: string): string | pki$pki$PEM
...
options?: ssh$FingerprintOptions): util$util$ByteStringBuffer | Hex | string
...
static +APPLICATION: Class<asn1$Class__APPLICATION> & asn1$Class__APPLICATION & 64;// 64
static +CONTEXT_SPECIFIC: Class<asn1$Class__CONTEXT_SPECIFIC> & asn1$Class__CONTEXT_SPECIFIC & 128;// 128
...
static +OCTETSTRING: Class<asn1$Type__OCTETSTRING> & asn1$Type__OCTETSTRING & 4;// 4
...
static +ENUMERATED: Class<asn1$Type__ENUMERATED> & asn1$Type__ENUMERATED & 10;// 10
...
static +PRINTABLESTRING: Class<asn1$Type__PRINTABLESTRING> & asn1$Type__PRINTABLESTRING & 19;// 19
...
static +GENERALIZEDTIME: Class<asn1$Type__GENERALIZEDTIME> & asn1$Type__GENERALIZEDTIME & 24;// 24
...
type: asn1$Type,
constructed: boolean,
value: Bytes | asn1$Asn1[]): asn1$Asn1


declare function asn1$fromDer(bytes: Bytes | util$util$ByteBuffer, strict?: boolean): asn1$Asn1


declare function asn1$toDer(obj: asn1$Asn1): util$util$ByteBuffer


declare function asn1$oidToDer(oid: OID): util$util$ByteStringBuffer


declare function asn1$derToOid(der: util$util$ByteStringBuffer): OID
...
constructor(bytes?: Bytes | ArrayBuffer | util$ArrayBufferView | util$ByteStringBuffer): this;
data: string;
read: number;
length(): number;
isEmpty(): boolean;
...
declare function util$xorBytes(bytes1: string, bytes2: string, count: number): string
...
encoding?: Encoding): util$ByteBuffer
...
declare function raw$decode(str: Bytes, output?: Uint8Array, offset?: number): Uint8Array
...
declare function hex$encode(bytes: Bytes | ArrayBuffer | util$ArrayBufferView | util$ByteStringBuffer): Hex


declare function hex$decode(hex: Hex, output?: Uint8Array, offset?: number): Uint8Array
...
declare function base64$decode(input: Base64, output?: Uint8Array, offset?: number): Uint8Array
...
declare function utf8$encode(str: string, output?: Uint8Array, offset?: number): Uint8Array
...
declare function utf16$encode(str: string, output?: Uint8Array, offset?: number): Uint8Array
...
getBagsByFriendlyName: (fiendlyName: string, bagType: string) => pkcs12$Bag[],
getBagsByLocalKeyId: (localKeyId: string, bagType: string) => pkcs12$Bag[]
} 

declare function pkcs12$pkcs12FromAsn1(obj: any, strict?: boolean, password?: string): pkcs12$Pkcs12Pfx


declare function pkcs12$pkcs12FromAsn1(obj: any, password?: string): pkcs12$Pkcs12Pfx


declare function pkcs12$toPkcs12Asn1(
key: pki$rsa$PrivateKey,
cert: pki$pki$Certificate | pki$pki$Certificate[],
...
salt: util$util$ByteBuffer,
id: Byte,
iter: number,
n: number,
md?: md$md$MessageDigest): util$util$ByteBuffer
...
content?: string | util$util$ByteBuffer,
contentInfo?: {
value: any[]
},
addCertificate(certificate: pki$pki$Certificate): void,
addSigner(
options: {
key: string,
certificate: pki$pki$Certificate,
...
declare function pkcs5$pbkdf2(password: string, salt: string, iterations: number, keySize: number): string

	declare interface md$MessageDigest {
update(msg: string, encoding?: Encoding): md$MessageDigest,
digest(): util$util$ByteStringBuffer
} 
...
declare type cipher$Algorithm = "AES-ECB"
| "AES-CBC"
| "AES-CFB"
| "AES-OFB"
| "AES-CTR"
...
payload: util$util$ByteBuffer | Bytes): cipher$BlockCipher
...
iv?: Bytes,
tag?: util$util$ByteStringBuffer,
tagLength?: number,
...
update: (payload: util$util$ByteBuffer) => void,
finish: () => boolean,
output: util$util$ByteStringBuffer,
mode: cipher$Mode
} 
...
declare  class tls$ConnectionEnd {
  constructor(...args: empty): mixed;
static +server: Class<tls$ConnectionEnd__server> & tls$ConnectionEnd__server & 0;// 0
static +client: Class<tls$ConnectionEnd__client> & tls$ConnectionEnd__client & 1;// 1
...
declare  class tls$PRFAlgorithm {
  constructor(...args: empty): mixed;
static +tls_prf_sha256: Class<tls$PRFAlgorithm__tls_prf_sha256> & tls$PRFAlgorithm__tls_prf_sha256 & 0;// 0
...
declare  class tls$BulkCipherAlgorithm {
  constructor(...args: empty): mixed;
static +rc4: Class<tls$BulkCipherAlgorithm__rc4> & tls$BulkCipherAlgorithm__rc4 & 0;// 0
static +des3: Class<tls$BulkCipherAlgorithm__des3> & tls$BulkCipherAlgorithm__des3 & 1;// 1
static +aes: Class<tls$BulkCipherAlgorithm__aes> & tls$BulkCipherAlgorithm__aes & 2;// 2
...
declare  class tls$MACAlgorithm {
  constructor(...args: empty): mixed;
static +hmac_md5: Class<tls$MACAlgorithm__hmac_md5> & tls$MACAlgorithm__hmac_md5 & 0;// 0
static +hmac_sha1: Class<tls$MACAlgorithm__hmac_sha1> & tls$MACAlgorithm__hmac_sha1 & 1;// 1
static +hmac_sha256: Class<tls$MACAlgorithm__hmac_sha256> & tls$MACAlgorithm__hmac_sha256 & 2;// 2
static +hmac_sha384: Class<tls$MACAlgorithm__hmac_sha384> & tls$MACAlgorithm__hmac_sha384 & 3;// 3
static +hmac_sha512: Class<tls$MACAlgorithm__hmac_sha512> & tls$MACAlgorithm__hmac_sha512 & 4;// 4
...
declare  class tls$CompressionMethod {
  constructor(...args: empty): mixed;
static +none: Class<tls$CompressionMethod__none> & tls$CompressionMethod__none & 0;// 0
static +deflate: Class<tls$CompressionMethod__deflate> & tls$CompressionMethod__deflate & 1;// 1
...
declare  class tls$ContentType {
  constructor(...args: empty): mixed;
static +change_cipher_spec: Class<tls$ContentType__change_cipher_spec> & tls$ContentType__change_cipher_spec & 20;// 20
static +alert: Class<tls$ContentType__alert> & tls$ContentType__alert & 21;// 21
static +handshake: Class<tls$ContentType__handshake> & tls$ContentType__handshake & 22;// 22
static +application_data: Class<tls$ContentType__application_data> & tls$ContentType__application_data & 23;// 23
static +heartbeat: Class<tls$ContentType__heartbeat> & tls$ContentType__heartbeat & 24;// 24
...
declare  class tls$HandshakeType {
  constructor(...args: empty): mixed;
static +hello_request: Class<tls$HandshakeType__hello_request> & tls$HandshakeType__hello_request & 0;// 0
static +client_hello: Class<tls$HandshakeType__client_hello> & tls$HandshakeType__client_hello & 1;// 1
static +server_hello: Class<tls$HandshakeType__server_hello> & tls$HandshakeType__server_hello & 2;// 2
static +certificate: Class<tls$HandshakeType__certificate> & tls$HandshakeType__certificate & 11;// 11
static +server_key_exchange: Class<tls$HandshakeType__server_key_exchange> & tls$HandshakeType__server_key_exchange & 12;// 12
static +certificate_request: Class<tls$HandshakeType__certificate_request> & tls$HandshakeType__certificate_request & 13;// 13
static +server_hello_done: Class<tls$HandshakeType__server_hello_done> & tls$HandshakeType__server_hello_done & 14;// 14
static +certificate_verify: Class<tls$HandshakeType__certificate_verify> & tls$HandshakeType__certificate_verify & 15;// 15
static +client_key_exchange: Class<tls$HandshakeType__client_key_exchange> & tls$HandshakeType__client_key_exchange & 16;// 16
static +finished: Class<tls$HandshakeType__finished> & tls$HandshakeType__finished & 20;// 20
...
declare class tls$HandshakeType__server_key_exchange mixins tls$HandshakeType {}
declare class tls$HandshakeType__certificate_request mixins tls$HandshakeType {}
declare class tls$HandshakeType__server_hello_done mixins tls$HandshakeType {}
declare class tls$HandshakeType__certificate_verify mixins tls$HandshakeType {}
declare class tls$HandshakeType__client_key_exchange mixins tls$HandshakeType {}
...
declare  class Alert$Description {
  constructor(...args: empty): mixed;
static +close_notify: Class<Alert$Description__close_notify> & Alert$Description__close_notify & 0;// 0
static +unexpected_message: Class<Alert$Description__unexpected_message> & Alert$Description__unexpected_message & 10;// 10
static +bad_record_mac: Class<Alert$Description__bad_record_mac> & Alert$Description__bad_record_mac & 20;// 20
static +decryption_failed: Class<Alert$Description__decryption_failed> & Alert$Description__decryption_failed & 21;// 21
static +record_overflow: Class<Alert$Description__record_overflow> & Alert$Description__record_overflow & 22;// 22
static +decompression_failure: Class<Alert$Description__decompression_failure> & Alert$Description__decompression_failure & 30;// 30
static +handshake_failure: Class<Alert$Description__handshake_failure> & Alert$Description__handshake_failure & 40;// 40
static +bad_certificate: Class<Alert$Description__bad_certificate> & Alert$Description__bad_certificate & 42;// 42
static +unsupported_certificate: Class<Alert$Description__unsupported_certificate> & Alert$Description__unsupported_certificate & 43;// 43
static +certificate_revoked: Class<Alert$Description__certificate_revoked> & Alert$Description__certificate_revoked & 44;// 44
static +certificate_expired: Class<Alert$Description__certificate_expired> & Alert$Description__certificate_expired & 45;// 45
static +certificate_unknown: Class<Alert$Description__certificate_unknown> & Alert$Description__certificate_unknown & 46;// 46
static +illegal_parameter: Class<Alert$Description__illegal_parameter> & Alert$Description__illegal_parameter & 47;// 47
static +unknown_ca: Class<Alert$Description__unknown_ca> & Alert$Description__unknown_ca & 48;// 48
static +access_denied: Class<Alert$Description__access_denied> & Alert$Description__access_denied & 49;// 49
static +decode_error: Class<Alert$Description__decode_error> & Alert$Description__decode_error & 50;// 50
static +decrypt_error: Class<Alert$Description__decrypt_error> & Alert$Description__decrypt_error & 51;// 51
static +export_restriction: Class<Alert$Description__export_restriction> & Alert$Description__export_restriction & 60;// 60
static +protocol_version: Class<Alert$Description__protocol_version> & Alert$Description__protocol_version & 70;// 70
static +insufficient_security: Class<Alert$Description__insufficient_security> & Alert$Description__insufficient_security & 71;// 71
static +internal_error: Class<Alert$Description__internal_error> & Alert$Description__internal_error & 80;// 80
static +user_canceled: Class<Alert$Description__user_canceled> & Alert$Description__user_canceled & 90;// 90
static +no_renegotiation: Class<Alert$Description__no_renegotiation> & Alert$Description__no_renegotiation & 100;// 100

}

declare class Alert$Description__close_notify mixins Alert$Description {}
declare class Alert$Description__unexpected_message mixins Alert$Description {}
...
declare class Alert$Description__decompression_failure mixins Alert$Description {}
...
declare class Alert$Description__unsupported_certificate mixins Alert$Description {}
declare class Alert$Description__certificate_revoked mixins Alert$Description {}
declare class Alert$Description__certificate_expired mixins Alert$Description {}
declare class Alert$Description__certificate_unknown mixins Alert$Description {}
...
declare class Alert$Description__export_restriction mixins Alert$Description {}
declare class Alert$Description__protocol_version mixins Alert$Description {}
declare class Alert$Description__insufficient_security mixins Alert$Description {}
...
declare  class tls$HeartbeatMessageType {
  constructor(...args: empty): mixed;
static +heartbeat_request: Class<tls$HeartbeatMessageType__heartbeat_request> & tls$HeartbeatMessageType__heartbeat_request & 1;// 1
static +heartbeat_response: Class<tls$HeartbeatMessageType__heartbeat_response> & tls$HeartbeatMessageType__heartbeat_response & 2;// 2

}

declare class tls$HeartbeatMessageType__heartbeat_request mixins tls$HeartbeatMessageType {}
declare class tls$HeartbeatMessageType__heartbeat_response mixins tls$HeartbeatMessageType {}
...
certificate_types: util$util$ByteBuffer,
certificate_authorities: util$util$ByteBuffer
} 
...
depth: number,
certs: pki$pki$Certificate[]): tls$Verified,
getCertificate: ((
conn: tls$Connection,
hint: tls$CertificateRequest | string[]) => pki$pki$PEM | $ReadOnlyArray<pki$pki$PEM>) | null,
getPrivateKey: ((conn: tls$Connection, certificate: pki$pki$Certificate) => pki$pki$PEM) | null,
getSignature: ((
conn: tls$Connection,
bytes: Bytes,
callback: (conn: tls$Connection, bytes: Bytes) => void) => void) | null,
input: util$util$ByteBuffer,
tlsData: util$util$ByteBuffer,
data: util$util$ByteBuffer,
tlsDataReady(conn: tls$Connection): void,
dataReady(conn: tls$Connection): void,
heartbeatReceived: ((conn: tls$Connection, payload: util$util$ByteBuffer) => void) | void,
...
peerCertificate: pki$pki$Certificate | null,
state: {
...
prepareHeartbeatRequest(payload: Bytes | util$util$ByteBuffer, payloadLength?: number): boolean,
...
serverCertificate: pki$pki$Certificate | null,
clientCertificate: pki$pki$Certificate | null,
md5: md$md$MessageDigest,
sha1: md$md$MessageDigest
} 
...
cache?: tls$SessionCache | {
[key: string]: tls$Session
},
capacity?: number): tls$SessionCache


declare interface tls$Alert {
level: tls$Alert.Alert$Level,
description: tls$Alert.Alert$Description
} 
...
declare type tls$Verified = true | {
message?: string,
alert?: tls$Alert.Alert$Description
};

declare function tls$createConnection(
options: {
server?: boolean,
sessionId?: Bytes | null,
caStore?: pki$pki$CAStore | $ReadOnlyArray<pki$pki$Certificate>,
sessionCache?: tls$SessionCache | {
[key: string]: tls$Session
},
cipherSuites?: tls$CipherSuite[],
connected(conn: tls$Connection): void,
...
getCertificate?: (
conn: tls$Connection,
hint: tls$CertificateRequest | string[]) => pki$pki$PEM | $ReadOnlyArray<pki$pki$PEM>,
getPrivateKey?: (conn: tls$Connection, certificate: pki$pki$Certificate) => pki$pki$PEM,
getSignature?: (
conn: tls$Connection,
bytes: Bytes,
callback: (conn: tls$Connection, bytes: Bytes) => void) => void,
tlsDataReady(conn: tls$Connection): void,
dataReady(conn: tls$Connection): void,
heartbeatReceived?: (conn: tls$Connection, payload: util$util$ByteBuffer) => void,
closed(conn: tls$Connection): void,
error(conn: tls$Connection, error: tls$TLSError): void,
...
label: string,
seed: string,
length: number): util$util$ByteBuffer


declare function tls$hmac_sha1(
key: string | $ReadOnlyArray<Byte> | util$util$ByteBuffer,
seqNum: [number, number],
record: tls$Record): Bytes
