declare module 'angular-local-storage' {
	...
	declare export type ILocalStorageServiceProvider = angular.local.storage.storage$ILocalStorageServiceProvider;
	declare export type ILocalStorageService = angular.local.storage.storage$ILocalStorageService;
	declare export type ICookie = angular.local.storage.storage$ICookie;
	declare module 'angular' {
        declare type storage$ILocalStorageServiceProvider = {
 ...
 */
setPrefix(prefix: string): storage$ILocalStorageServiceProvider,

/**
 * Setter for the storageType
 * @param storageType localstorage or sessionStorage. default: localStorage
 */
setStorageType(storageType: string): storage$ILocalStorageServiceProvider,
 ...
 */
setDefaultToCookie(shouldDefault: boolean): storage$ILocalStorageServiceProvider,
...
exp: number,
path: string,
secure: boolean): storage$ILocalStorageServiceProvider,
 ...
 * No default value
 */
setStorageCookieDomain(domain: string): storage$ILocalStorageServiceProvider,
 ...
 */
setNotify(setItem: boolean, removeItem: boolean): storage$ILocalStorageServiceProvider
} & angular.IServiceProvider


declare interface storage$ICookie {
...
declare type storage$StorageType = "localStorage" | "sessionStorage";

declare interface storage$ILocalStorageService {
 ...
 * @param value
 */
set<T>(key: string, value: T, storageType?: storage$StorageType): boolean,
 ...
 * @param key
 */
get<T>(key: string, storageType?: storage$StorageType): T,

/**
 * Return array of keys for local storage, ignore keys that not owned.
 * Returns: value from local storage
 */
keys(storageType?: storage$StorageType): string[],
 ...
 */
clearAll(regularExpression?: RegExp, storageType?: storage$StorageType): boolean,
...
value?: any,
key?: string,
storageType?: storage$StorageType): Function,
 ...
 * Returns Number
 */
length(storageType?: storage$StorageType): number,

/**
 * Deal with browser's cookies directly.
 */
cookie: storage$ICookie
} 
    }
