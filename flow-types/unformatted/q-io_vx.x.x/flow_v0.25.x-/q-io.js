...
declare export function QioFS$write(path: string, content: string, options?: any): Q.Promise<void>


declare export function QioFS$append(path: string, content: Buffer, options?: any): Q.Promise<void>


declare export function QioFS$append(path: string, content: string, options?: any): Q.Promise<void>
...
path: string,
guard?: (path: string, QioFS$stat: any) => boolean): Q.Promise<string[]>
...
declare export function QioFS$makeDirectory(path: string, mode?: number): Q.Promise<void>


declare export function QioFS$makeTree(path: string, mode?: string): Q.Promise<void>


declare export function QioFS$makeTree(path: string, mode?: number): Q.Promise<void>
...
declare export function QioFS$symbolicLink(target: string, QioFS$link: string, type: string): Q.Promise<void>
...
declare export function QioFS$chmod(path: string, mode?: number): Q.Promise<void>
...
declare export function QioFS$base(path: string, QioFS$extension: string): string
...
QioFS$isFile(): boolean,
QioFS$isDirectory(): boolean,
isBlockDevice(): boolean,
isCharacterDevice(): boolean,
QioFS$isSymbolicLink(): boolean,
isFIFO(): boolean,
isSocket(): boolean,
node: QioFS$NodeStats,
dev: number,
...
declare export function QioHTTP$request(QioHTTP$request: QioHTTP$Request): Q.Promise<QioHTTP$Response>


declare export function QioHTTP$request(url: string): Q.Promise<QioHTTP$Response>


declare export function QioHTTP$read(QioHTTP$request: QioHTTP$Request): Q.Promise<string>


declare export function QioHTTP$read(url: string): Q.Promise<string>


declare export function QioHTTP$normalizeRequest(QioHTTP$request: QioHTTP$Request): QioHTTP$Request


declare export function QioHTTP$normalizeRequest(url: string): QioHTTP$Request
...
declare type QioHTTP$Body = {} & Qio$Qio$Stream
...
QioHTTP$read(charset: string): Q.Promise<string>,
QioHTTP$read(): Q.Promise<Buffer>,
close(): void,
...
QioFS$write(content: string): void,
QioFS$write(content: Buffer): void,
...
new (): Qio$Qio$Reader,
QioHTTP$read(stream: Qio$Qio$Reader, charset: string): string,
QioHTTP$read(stream: Qio$Qio$Reader): Buffer,
QioFS$join(buffers: Buffer[]): Buffer
} 
	declare interface QioBufferWriter {
(writer: Buffer): Qio$Qio$Writer,
Qio$Writer: Qio$Qio$Writer
} 
	declare interface QioBufferStream {
(buffer: Buffer, encoding: string): Qio$Qio$Stream
} 
