declare module 'd3-transition' {
        import type {
          ArrayLike,BaseType,Selection,ValueFn
        } from 'd3-selection';
 ...
 */
declare interface Selection<GElement: BaseType, Datum, PElement: BaseType, PDatum> {
 ...
 */
transition(
transition: Transition<BaseType, any, any, any>): Transition<GElement, Datum, PElement, PDatum>
} 
    }
 ...
 * @param name Name of the transition.
 */
declare export function active<GElement: BaseType, Datum, PElement: BaseType, PDatum>(
node: GElement,
name?: string): Transition<GElement, Datum, PElement, PDatum> | null
 ...
 */
declare export function interrupt(node: BaseType, name?: string): void
 ...
 */
declare export interface Transition<GElement: BaseType, Datum, PElement: BaseType, PDatum> {
...
selector: string): Transition<DescElement, Datum, PElement, PDatum>,
 ...
 */
select<DescElement: BaseType>(
selector: ValueFn<GElement, Datum, DescElement>): Transition<DescElement, Datum, PElement, PDatum>,
...
selector: string): Transition<DescElement, OldDatum, GElement, Datum>,
 ...
 */
selectAll<DescElement: BaseType, OldDatum>(
selector: ValueFn<GElement, Datum, DescElement[] | ArrayLike<DescElement>>): Transition<DescElement, OldDatum, GElement, Datum>,
 ...
 */
attrTween(name: string): ValueFn<GElement, Datum, (t: number) => string> | void,
 ...
 */
styleTween(name: string): ValueFn<GElement, Datum, (t: number) => string> | void,
 ...
 */
tween(name: string): ValueFn<GElement, Datum, (t: number) => void> | void,
 ...
 */
merge(
other: Transition<GElement, Datum, PElement, PDatum>): Transition<GElement, Datum, PElement, PDatum>,
...
filter: string): Transition<FilteredElement, Datum, PElement, PDatum>,
 ...
 */
filter(
filter: ValueFn<GElement, Datum, boolean>): Transition<GElement, Datum, PElement, PDatum>,
 ...
 */
filter<FilteredElement: BaseType>(
filter: ValueFn<GElement, Datum, boolean>): Transition<FilteredElement, Datum, PElement, PDatum>,
 ...
 */
on(type: string): ValueFn<GElement, Datum, void> | void,
 ...
 */
declare export type SelectionOrTransition<GElement: BaseType, Datum, PElement: BaseType, PDatum> = Selection<GElement, Datum, PElement, PDatum> | Transition<GElement, Datum, PElement, PDatum>;
 ...
 * @param name Name of the transition.
 */
declare export function transition<OldDatum>(name?: string): Transition<HTMLElement, OldDatum, null, void>
 ...
 * @param transition A transition instance.
 */
declare export function transition<OldDatum>(
transition: Transition<BaseType, any, BaseType, any>): Transition<HTMLElement, OldDatum, null, void>
