 ...
 * A structure containing a range of cells.
 * @constructor
 * @param {Editors$Integer} fromRow
 * Starting row.
 * @param {Editors$Integer} fromCell
 * Starting cell.
 * @param {Editors$Integer} toRow
 * Optional. Ending row. Defaults to <code>fromRow</code>.
 * @param {Editors$Integer} toCell
 * Optional. Ending cell. Defaults to <code>fromCell</code>.
 */
 ...
 */
export interface Slick$Column<T: Slick$Slick$SlickData> {
...
export interface Slick$FormatterFactory<T: Slick$SlickData> {
getFormatter(column: Slick$Column<T>): Slick$Formatter<any>
} 

export interface Slick$GridOptions<T: Slick$SlickData> {
...
export interface Slick$DataProvider<T: Slick$SlickData> {
...
export interface Slick$ColumnMetadata<T: Slick$SlickData> {
...
export interface Slick$GridEventArgs<T: Slick$SlickData> {
grid: Slick$Grid<T>
} 

export type Slick$OnCellCssStylesChangedEventArgs<T: Slick$SlickData> = {
key: string,
hash: Slick$CellCssStylesHash
} & Slick$GridEventArgs<T>


export type Slick$OnSelectedRowsChangedEventArgs<T: Slick$SlickData> = {
rows: number[]
} & Slick$GridEventArgs<T>


export type Slick$OnDragEndEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnDragEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnDragStartEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnDragInitEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnActiveCellPositionChangedEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnActiveCellChangedEventArgs<T: Slick$SlickData> = {
row: number,
cell: number
} & Slick$GridEventArgs<T>


export type Slick$OnBeforeDestroyEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnBeforeCellEditorDestroyEventArgs<T: Slick$SlickData> = {
editor: Editors$Editors$Editor<T>
} & Slick$GridEventArgs<T>


export type Slick$OnBeforeEditCellEventArgs<T: Slick$SlickData> = {
row: number,
cell: number,
item: T,
...
export type Slick$OnCellChangeEventArgs<T: Slick$SlickData> = {
row: number,
cell: number,
item: T
} & Slick$GridEventArgs<T>
...
export type Slick$OnColumnsResizedEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnColumnsReorderedEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnValidationErrorEventArgs<T: Slick$SlickData> = {
editor: Editors$Editors$Editor<T>,
...
export type Slick$OnAddNewRowEventArgs<T: Slick$SlickData> = {
item: T,
column: Slick$Column<T>
} & Slick$GridEventArgs<T>


export type Slick$OnKeyDownEventArgs<T: Slick$SlickData> = {
row: number,
cell: number
} & Slick$GridEventArgs<T>


export type Slick$OnContextMenuEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnDblClickEventArgs<T: Slick$SlickData> = {
row: number,
cell: number
} & Slick$GridEventArgs<T>


export type Slick$OnClickEventArgs<T: Slick$SlickData> = {
row: number,
cell: number
} & Slick$GridEventArgs<T>


export type Slick$OnMouseLeaveEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnMouseEnterEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export type Slick$OnBeforeHeaderRowCellDestroyEventArgs<T: Slick$SlickData> = {
node: HTMLElement,
column: Slick$Column<T>
} & Slick$GridEventArgs<T>


export type Slick$OnHeaderRowCellRenderedEventArgs<T: Slick$SlickData> = {
node: HTMLElement,
column: Slick$Column<T>
} & Slick$GridEventArgs<T>


export type Slick$OnBeforeHeaderCellDestroyEventArgs<T: Slick$SlickData> = {
node: HTMLElement,
column: Slick$Column<T>
} & Slick$GridEventArgs<T>


export type Slick$OnHeaderCellRenderedEventArgs<T: Slick$SlickData> = {
node: HTMLElement,
column: Slick$Column<T>
} & Slick$GridEventArgs<T>


export type Slick$OnHeaderClickEventArgs<T: Slick$SlickData> = {
column: Slick$Column<T>
} & Slick$GridEventArgs<T>


export type Slick$OnHeaderContextMenuEventArgs<T: Slick$SlickData> = {
column: Slick$Column<T>
} & Slick$GridEventArgs<T>


export type Slick$OnHeaderMouseEventArgs<T: Slick$SlickData> = {
column: Slick$Column<T>
} & Slick$GridEventArgs<T>


export type Slick$OnSortEventArgs<T: Slick$SlickData> = {
multiColumnSort: boolean,
...
export type Slick$OnScrollEventArgs<T: Slick$SlickData> = {
scrollLeft: number,
scrollTop: number
} & Slick$GridEventArgs<T>


export type Slick$OnViewportChangedEventArgs<T: Slick$SlickData> = {} & Slick$GridEventArgs<T>


export interface Slick$SortColumn<T: Slick$SlickData> {
sortCol: Slick$Column<T>,
sortAsc: boolean
} 
...
export interface Editors$EditorOptions<T: Slick$Slick$SlickData> {
column: Slick$Column<T>,
...
export interface Slick$Formatter<T: Slick$SlickData> {
...
export interface Slick$PluginOptions {} declare module 'slickgrid' {
