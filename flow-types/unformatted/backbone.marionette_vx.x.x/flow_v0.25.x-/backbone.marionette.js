declare module 'backbone.marionette' {
	...
	import typeof * as JQuery from 'jquery';

	import typeof * as Radio from 'backbone.radio';

	import typeof * as _ from 'underscore';

	declare export interface CommonMixin {
...
unbindEvents: any
	...
	declare export interface RadioMixinOptions {
...
radioRequests?: any
	...
	declare export interface RadioMixin {
getChannel: any,
bindEvents: any,
unbindEvents: any,
bindRequests: any,
unbindRequests: any
	...
	declare export interface DomMixin {
createBuffer: any,
appendChildren: any,
beforeEl: any,
replaceEl: any,
...
findEls: any
	...
	declare export interface ViewMixinOptions {
...
triggerMethod: any
} & DomMixin & CommonMixin

	declare export interface RegionsMixin {
regionClass: any,
addRegion: any,
addRegions: any,
removeRegion: any,
...
getChildView: any
	...
	declare export class Container<TView>  {
 ...
 */
declare export function extend(properties: any, classProperties?: any): any

	
/**
 * Determines whether the passed-in node is a child of the document or not.
 */
declare export function isNodeAttached(el: HTMLElement): boolean
 ...
 * instance.
 */
declare export function mergeOptions(target: any, options: any, keys: any): void
 ...
 */
declare export function getOption(target: any, optionName: string): any
 ...
 */
declare export function triggerMethod(target: any, name: string, ...args: any[]): any
 ...
 */
declare export function triggerMethodOn(ctx: any, name: string, ...args: any[]): any
 ...
 * object.
 */
declare export function bindRequests(target: any, channel: Radio.Channel, bindings: any): void
 ...
 * object.
 */
declare export function unbindRequests(target: any, channel: Radio.Channel, bindings: any): void
 ...
 */
declare export function normalizeMethods<T>(target: any, hash: any): T
 ...
 * application.
 */
declare export function noConflict(): void
 ...
 */
declare export type EventsHash = {
[selector: string]: string | ((eventObject: JQuery.Event) => void)
} & Backbone.EventsHash

	declare export type ObjectOptions = {
 ...
 */
declare export class Object mixins Backbone.EventsMixin, CommonMixin, RadioMixin, Backbone.Events {
constructor(options?: ObjectOptions): this;
 ...
 */
declare export class TemplateCache mixins DomMixin {
...
compileTemplate(rawTemplate: any, options?: any): any
	...
	declare export interface RegionConstructionOptions {
...
replaceElement?: string
	...
	declare export interface RegionViewOptions {
 ...
 */
declare export class Region mixins Object, DomMixin {
 ...
 */
destroyView<TModel: Backbone.Model>(view: Backbone.View<TModel>): Backbone.View<TModel>;
 ...
 */
templateContext?: any
} & Backbone.ViewOptions<TModel> & ViewMixinOptions
 ...
 */
declare export class View<TModel: Backbone.Model> mixins Backbone.View<TModel>, ViewMixin, RegionsMixin {
 ...
 */
detachChildView<TModel: Backbone.Model>(regionName: string): Backbone.View<TModel>;

/**
 * Get the view from a region.
 */
getChildView<TModel: Backbone.Model>(regionName: string): Backbone.View<TModel>;
...
getUI(ui: string): JQuery
	...
	declare export type CollectionViewOptions<TModel: Backbone.Model, TCollection: Backbone.Collection<TModel>= Backbone.Collection<TModel>> = {
 ...
 */
viewComparator?: string | ((element: TModel) => number | string) | ((compare: TModel, to?: TModel) => number)
} & Backbone.ViewOptions<TModel> & ViewMixinOptions
 ...
 * initialize.
 */
declare export class CollectionView<TModel: Backbone.Model, TView: View<TModel>, TCollection: Backbone.Collection<TModel>= Backbone.Collection<TModel>> mixins View<TModel> {
constructor(options?: CollectionViewOptions<TModel, TCollection>): this;

/**
 * Specify a child view to use.
 */
childView: ((model: TModel) => {
new (...args: any[]): TView
}) | {
new (...args: any[]): TView
};
 ...
 */
getViewComparator: (
) => (string | ((element: TModel) => number | string) | ((compare: TModel, to?: TModel) => number));
...
childViewOptions: ViewOptions<TModel>): void;
...
destroy(...args: any[]): CollectionView<TModel, TView, TCollection>
	...
	declare export interface AppRoutes {
[index: string]: string
} 
	declare export interface AppRouterOptions {
 ...
 */
declare export class AppRouter mixins Backbone.Router {
...
onRoute(name: string, path: string, args: any[]): void
	...
	declare export type ApplicationOptions = {
 ...
 *    your app
 */
declare export class Application mixins Object {
constructor(options?: ApplicationOptions): this;
 ...
 */
declare export class Behavior mixins Object {
