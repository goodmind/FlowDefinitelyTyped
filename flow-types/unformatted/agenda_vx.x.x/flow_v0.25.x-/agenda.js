...
(err?: Error, result?: T): void
	...
	declare class Agenda mixins EventEmitter {
 ...
 */
constructor(config?: Agenda$Agenda$AgendaConfiguration, cb?: ResultCallback<Collection>): this;
...
collection?: string,
options?: any,
cb?: ResultCallback<Collection>): this;
 ...
 */
create<T: Agenda$Agenda$JobAttributesData= Agenda$Agenda$JobAttributesData>(
name: string,
data?: T): Agenda$Agenda$Job<T>;

/**
 * Find all Jobs matching `query` and pass same back in cb().
 * @param query
 */
jobs<T: Agenda$Agenda$JobAttributesData= Agenda$Agenda$JobAttributesData>(
query: any): Promise<Agenda$Agenda$Job<T>[]>;
 ...
 */
define<T: Agenda$Agenda$JobAttributesData= Agenda$Agenda$JobAttributesData>(
name: string,
handler: (job: Agenda$Agenda$Job<T>, done: (err?: Error) => void) => void): void;
define<T: Agenda$Agenda$JobAttributesData= Agenda$Agenda$JobAttributesData>(
name: string,
options: Agenda$Agenda$JobOptions,
handler: (job: Agenda$Agenda$Job<T>, done: (err?: Error) => void) => void): void;
 ...
 */
every<T: Agenda$Agenda$JobAttributesData= Agenda$Agenda$JobAttributesData>(
interval: number | string,
names: string,
data?: T,
options?: any): Promise<Agenda$Agenda$Job<T>>;
every<T: Agenda$Agenda$JobAttributesData= Agenda$Agenda$JobAttributesData>(
interval: number | string,
names: string[],
data?: T,
 ...
 * @param data An optional argument that will be passed to the processing function under job.attrs.data.
 */
schedule<T: Agenda$Agenda$JobAttributesData= Agenda$Agenda$JobAttributesData>(
when: Date | string,
names: string,
data?: T): Promise<Agenda$Agenda$Job<T>>;
schedule<T: Agenda$Agenda$JobAttributesData= Agenda$Agenda$JobAttributesData>(
when: Date | string,
names: string[],
data?: T): Promise<Agenda$Agenda$Job<T>[]>;
 ...
 * @param data An optional argument that will be passed to the processing function under job.attrs.data.
 */
now<T: Agenda$Agenda$JobAttributesData= Agenda$Agenda$JobAttributesData>(
name: string,
data?: T): Promise<Agenda$Agenda$Job<T>>;
...
declare interface Agenda$JobAttributesData {
[key: string]: any
} 
 ...
 */
declare interface Agenda$JobAttributes<T: Agenda$JobAttributesData= Agenda$JobAttributesData> {
 ...
 * A scheduled job.
 */
declare interface Agenda$Job<T: Agenda$JobAttributesData= Agenda$JobAttributesData> {

/**
 * The database record associated with the job.
 */
attrs: Agenda$JobAttributes<T>,
