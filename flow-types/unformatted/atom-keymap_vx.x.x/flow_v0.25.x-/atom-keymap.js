...
declare interface Events$FullKeybindingMatch {
...
declare interface Events$PartialKeybindingMatch {
...
declare interface Events$FailedKeybindingMatch {
...
declare interface Events$FailedKeymapFileRead {
...
declare interface Events$KeymapLoaded {
...
declare interface Events$AddedKeystrokeResolver {
...
declare interface Options$BuildKeyEvent {
ctrl?: boolean,
alt?: boolean,
shift?: boolean,
cmd?: boolean,
 ...
 */
compare(other: AtomKeymap$KeyBinding): number
} 
 ...
 * key binding.
 */
onDidMatchBinding(callback: (event: Events$Events$FullKeybindingMatch) => void): Disposable,

/**
 * Invoke the given callback when one or more keystrokes partially match a binding.
 */
onDidPartiallyMatchBindings(callback: (event: Events$Events$PartialKeybindingMatch) => void): Disposable,

/**
 * Invoke the given callback when one or more keystrokes fail to match any bindings.
 */
onDidFailToMatchBinding(callback: (event: Events$Events$FailedKeybindingMatch) => void): Disposable,

/**
 * Invoke the given callback when a keymap file is reloaded.
 */
onDidReloadKeymap(callback: (event: Events$Events$KeymapLoaded) => void): Disposable,

/**
 * Invoke the given callback when a keymap file is unloaded.
 */
onDidUnloadKeymap(callback: (event: Events$Events$KeymapLoaded) => void): Disposable,

/**
 * Invoke the given callback when a keymap file not able to be loaded.
 */
onDidFailToReadFile(callback: (error: Events$Events$FailedKeymapFileRead) => void): Disposable,
...
priority?: number): AtomKeymap$KeyBinding[],
 ...
 */
addKeystrokeResolver(resolver: (event: Events$Events$AddedKeystrokeResolver) => string): Disposable,
 ...
 */
buildKeydownEvent(key: string, options?: Options$Options$BuildKeyEvent): void,

/**
 * Create a keyup DOM event.
 */
buildKeyupEvent(key: string, options?: Options$Options$BuildKeyEvent): void,
...
defaultTarget?: HTMLElement
	...
	declare var AtomKeymap$KeymapManager: AtomKeymap$AtomKeymap$KeymapManagerStatic;
	declare module.exports: typeof AtomKeymap$KeymapManager
