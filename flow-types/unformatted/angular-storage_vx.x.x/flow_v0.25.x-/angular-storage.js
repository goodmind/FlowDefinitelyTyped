 ...
 * - The name of the storage service. Defaults to local storage.
 * @param {String} delimiter
 * - The delimiter to use to separate the namespace and the keys.
 ...
 * @param {String} name
 * - The key name for the location of the value
 * @param value
 * - The value to store
 */
 ...
 * - The key name for the location of the value
 * @returns
 * The saved value; if you saved an object, you get an object
 */
get(name: string): any,
 ...
 * @param {String} name
 * - The key name for the location of the value to remove
 */
